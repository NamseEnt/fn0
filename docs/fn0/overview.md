...
|---|---|---|
| `fn0` | 0.6.1 | Core FaaS runtime (`ExecutionContext`, `Bundle`, `build_engine`) |
| `fn0-cli` | 0.1.17 | Local development CLI |
| `fn0-worker` | 0.4.4 | Worker binary (distributed execution node) |
...
| `fn0-deploy` | 0.3.0 | fn0 Cloud deployment client |

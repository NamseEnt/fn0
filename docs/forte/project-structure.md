...
### `rs/src/env_generated.rs` — Auto-generated Environment Accessors

Generated by `forte_codegen::generate_env()` (optional call in `build.rs`). Contains one typed accessor function per variable found in the project-root `.env` file. Never edit this file by hand. See [codegen.md](codegen.md#generate_env-optional) for details.

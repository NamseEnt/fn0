...
|---|---|---|---|
| `forte-sdk` | 0.8.1 | `forte/sdk` | Runtime library for wasm components (HTTP types, `ForteRequest`, cookie utilities, metrics, etc.) |
| `forte-cli` | 0.6.3 | `forte/cli` | Developer CLI (`forte dev`, `forte build`, `forte deploy`, etc.) |

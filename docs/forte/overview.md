...
| `forte-cli` | 0.4.4 | `forte/cli` | Developer CLI (`forte dev`, `forte build`, `forte deploy`, etc.) |
...
| `forte-codegen` | 0.2.0 | `forte/codegen` | Build-script library that generates `route_generated.rs` |

...
| `forte-test-runner` | 0.1.0 | `forte/test-runner` | WASM test runner: executes `wasm32-wasip2` test binaries via wasmtime; configured as `runner` in `.cargo/config.toml` |

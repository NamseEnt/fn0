...
|---|---|---|---|
| `forte-sdk` | 0.11.0 | `forte/sdk` | Runtime library for wasm components (HTTP types, `ForteRequest`, cookie utilities, metrics, etc.) |
| `forte-cli` | 0.6.11 | `forte/cli` | Developer CLI (`forte dev`, `forte build`, `forte deploy`, etc.) |

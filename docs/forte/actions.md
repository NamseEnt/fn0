...
> **Scaffold note:** The TypeScript file generated by `forte add action` uses the wrong route prefix (`/_action/...`). The correct prefix is `/__forte_action/...`. Update the generated file before deploying.

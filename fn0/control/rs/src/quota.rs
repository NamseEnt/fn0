...
//!
//! Compute egress is accounted: every new project gets a `ProjectEgressQuotaDoc` with
//! [`DEFAULT_MONTHLY_EGRESS_BYTES`], matching the published launch limit of 20 GB a month.

pub const DEFAULT_MONTHLY_EGRESS_BYTES: u64 = 20_000_000_000;

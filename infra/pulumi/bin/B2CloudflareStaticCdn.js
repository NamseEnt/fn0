...
exports.B2CloudflareStaticCdn = void 0;
const pulumi = require("@pulumi/pulumi");
const b2 = require("@pulumi/b2");
const random = require("@pulumi/random");
const aws = require("@pulumi/aws");
const cloudflare = require("@pulumi/cloudflare");
class B2CloudflareStaticCdn extends pulumi.ComponentResource {
    constructor(name, args, opts) {
        ...
        const bucketName = pulumi.interpolate `fn0-${new random.RandomString("b2-bucket-name", {
            length: 32,
            special: false,
            upper: false,
        }, { parent: this }).result}`;
        ...
        new aws.s3.BucketLogging("b2-bucket-logging", {
            bucket: bucketName,
        ...
        new cloudflare.Ruleset("cache-ruleset", {
            zoneId: zone.id,
            name: "cache-ruleset",
            kind: "zone",
        ...
        new cloudflare.DnsRecord("cdn-dns-record", {
            ...
            name: "cdn",
            type: "CNAME",
            content: accountInfo.then((info) => info.downloadUrl.replace("https://", "")),
            ttl: 1,
            proxied: true,
        }, { parent: this });
    }
}
exports.B2CloudflareStaticCdn = B2CloudflareStaticCdn;
//# sourceMappingURL=B2CloudflareStaticCdn.js.map
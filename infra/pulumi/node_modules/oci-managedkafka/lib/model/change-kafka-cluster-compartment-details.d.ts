 ...
 */
export interface ChangeKafkaClusterCompartmentDetails {
    /**
...
export declare namespace ChangeKafkaClusterCompartmentDetails {
    function getJsonObj(obj: ChangeKafkaClusterCompartmentDetails): object;
    function getDeserializedJsonObj(obj: ChangeKafkaClusterCompartmentDetails): object;
}

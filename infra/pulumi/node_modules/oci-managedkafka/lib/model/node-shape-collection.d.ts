 ...
 */
export interface NodeShapeCollection {
    /**
     * List of NodeShapeSummary.
     */
    "items": Array<model.NodeShapeSummary>;
}
export declare namespace NodeShapeCollection {
    function getJsonObj(obj: NodeShapeCollection): object;
    function getDeserializedJsonObj(obj: NodeShapeCollection): object;
}

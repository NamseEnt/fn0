 ...
 */
export interface UpdateKafkaClusterConfigDetails {
    /**
...
export declare namespace UpdateKafkaClusterConfigDetails {
    function getJsonObj(obj: UpdateKafkaClusterConfigDetails): object;
    function getDeserializedJsonObj(obj: UpdateKafkaClusterConfigDetails): object;
}

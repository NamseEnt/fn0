...
export declare namespace UpdateKafkaSchemaRegistryConnectionDetails {
    function getJsonObj(obj: UpdateKafkaSchemaRegistryConnectionDetails, isParentJsonObj?: boolean): object;
    const connectionType = "KAFKA_SCHEMA_REGISTRY";
    function getDeserializedJsonObj(obj: UpdateKafkaSchemaRegistryConnectionDetails, isParentJsonObj?: boolean): object;
}

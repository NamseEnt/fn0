...
export declare namespace UpdateJavaMessageServiceConnectionDetails {
    function getJsonObj(obj: UpdateJavaMessageServiceConnectionDetails, isParentJsonObj?: boolean): object;
    const connectionType = "JAVA_MESSAGE_SERVICE";
    function getDeserializedJsonObj(obj: UpdateJavaMessageServiceConnectionDetails, isParentJsonObj?: boolean): object;
}

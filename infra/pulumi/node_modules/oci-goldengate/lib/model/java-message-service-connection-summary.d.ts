 ...
 *
 */
export interface JavaMessageServiceConnectionSummary extends model.ConnectionSummary {
    /**
...
export declare namespace JavaMessageServiceConnectionSummary {
    function getJsonObj(obj: JavaMessageServiceConnectionSummary, isParentJsonObj?: boolean): object;
    const connectionType = "JAVA_MESSAGE_SERVICE";
    function getDeserializedJsonObj(obj: JavaMessageServiceConnectionSummary, isParentJsonObj?: boolean): object;
}

...
export declare namespace CreateOracleConnectionDetails {
    function getJsonObj(obj: CreateOracleConnectionDetails, isParentJsonObj?: boolean): object;
    const connectionType = "ORACLE";
    function getDeserializedJsonObj(obj: CreateOracleConnectionDetails, isParentJsonObj?: boolean): object;
}

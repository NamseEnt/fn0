...
export declare namespace Db2ConnectionSummary {
    function getJsonObj(obj: Db2ConnectionSummary, isParentJsonObj?: boolean): object;
    const connectionType = "DB2";
    function getDeserializedJsonObj(obj: Db2ConnectionSummary, isParentJsonObj?: boolean): object;
}

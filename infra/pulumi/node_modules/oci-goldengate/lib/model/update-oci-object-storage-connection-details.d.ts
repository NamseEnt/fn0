...
export declare namespace UpdateOciObjectStorageConnectionDetails {
    function getJsonObj(obj: UpdateOciObjectStorageConnectionDetails, isParentJsonObj?: boolean): object;
    const connectionType = "OCI_OBJECT_STORAGE";
    function getDeserializedJsonObj(obj: UpdateOciObjectStorageConnectionDetails, isParentJsonObj?: boolean): object;
}

...
export declare namespace GoogleBigQueryConnection {
    enum TechnologyType {
    ...
    function getJsonObj(obj: GoogleBigQueryConnection, isParentJsonObj?: boolean): object;
    const connectionType = "GOOGLE_BIGQUERY";
    function getDeserializedJsonObj(obj: GoogleBigQueryConnection, isParentJsonObj?: boolean): object;
}

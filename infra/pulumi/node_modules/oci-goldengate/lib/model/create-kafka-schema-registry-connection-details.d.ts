...
export declare namespace CreateKafkaSchemaRegistryConnectionDetails {
    function getJsonObj(obj: CreateKafkaSchemaRegistryConnectionDetails, isParentJsonObj?: boolean): object;
    const connectionType = "KAFKA_SCHEMA_REGISTRY";
    function getDeserializedJsonObj(obj: CreateKafkaSchemaRegistryConnectionDetails, isParentJsonObj?: boolean): object;
}

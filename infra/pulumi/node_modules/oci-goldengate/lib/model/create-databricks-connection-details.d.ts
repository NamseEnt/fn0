...
export declare namespace CreateDatabricksConnectionDetails {
    function getJsonObj(obj: CreateDatabricksConnectionDetails, isParentJsonObj?: boolean): object;
    const connectionType = "DATABRICKS";
    function getDeserializedJsonObj(obj: CreateDatabricksConnectionDetails, isParentJsonObj?: boolean): object;
}

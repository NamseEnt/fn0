...
export declare namespace PipelineInitializationStep {
    function getJsonObj(obj: PipelineInitializationStep): object;
    function getDeserializedJsonObj(obj: PipelineInitializationStep): object;
}

...
export declare namespace MongoDbConnectionSummary {
    function getJsonObj(obj: MongoDbConnectionSummary, isParentJsonObj?: boolean): object;
    const connectionType = "MONGODB";
    function getDeserializedJsonObj(obj: MongoDbConnectionSummary, isParentJsonObj?: boolean): object;
}

...
export declare namespace CreateGoldenGateConnectionDetails {
    function getJsonObj(obj: CreateGoldenGateConnectionDetails, isParentJsonObj?: boolean): object;
    const connectionType = "GOLDENGATE";
    function getDeserializedJsonObj(obj: CreateGoldenGateConnectionDetails, isParentJsonObj?: boolean): object;
}

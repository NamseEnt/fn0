...
export declare namespace RedisConnectionSummary {
    function getJsonObj(obj: RedisConnectionSummary, isParentJsonObj?: boolean): object;
    const connectionType = "REDIS";
    function getDeserializedJsonObj(obj: RedisConnectionSummary, isParentJsonObj?: boolean): object;
}

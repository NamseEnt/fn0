...
export declare namespace CreateOracleNosqlConnectionDetails {
    function getJsonObj(obj: CreateOracleNosqlConnectionDetails, isParentJsonObj?: boolean): object;
    const connectionType = "ORACLE_NOSQL";
    function getDeserializedJsonObj(obj: CreateOracleNosqlConnectionDetails, isParentJsonObj?: boolean): object;
}

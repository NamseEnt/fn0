 ...
 *
 */
export interface PolarisIcebergCatalogSummary extends model.IcebergCatalogSummary {
    /**
...
export declare namespace PolarisIcebergCatalogSummary {
    function getJsonObj(obj: PolarisIcebergCatalogSummary, isParentJsonObj?: boolean): object;
    const catalogType = "POLARIS";
    function getDeserializedJsonObj(obj: PolarisIcebergCatalogSummary, isParentJsonObj?: boolean): object;
}

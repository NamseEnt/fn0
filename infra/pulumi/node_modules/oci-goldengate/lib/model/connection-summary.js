        ...
        if (obj && "connectionType" in obj && obj.connectionType) {
            switch (obj.connectionType) {
                ...
                case "ORACLE_AI_DATA_PLATFORM":
                    return model.OracleAiDataPlatformConnectionSummary.getJsonObj(jsonObj, true);
                case "MONGODB":
    ...
    function getDeserializedJsonObj(obj) {
        ...
        if (obj && "connectionType" in obj && obj.connectionType) {
            switch (obj.connectionType) {
                ...
                case "ORACLE_AI_DATA_PLATFORM":
                    return model.OracleAiDataPlatformConnectionSummary.getDeserializedJsonObj(jsonObj, true);
                case "MONGODB":

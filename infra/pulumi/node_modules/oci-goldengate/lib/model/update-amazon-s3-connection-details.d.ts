...
export declare namespace UpdateAmazonS3ConnectionDetails {
    function getJsonObj(obj: UpdateAmazonS3ConnectionDetails, isParentJsonObj?: boolean): object;
    const connectionType = "AMAZON_S3";
    function getDeserializedJsonObj(obj: UpdateAmazonS3ConnectionDetails, isParentJsonObj?: boolean): object;
}

 ...
 *
 */
export interface CreateDatabaseRegistrationDetails {
    /**
...
export declare namespace CreateDatabaseRegistrationDetails {
    enum SessionMode {
        Direct = "DIRECT",
        Redirect = "REDIRECT"
    }
    function getJsonObj(obj: CreateDatabaseRegistrationDetails): object;
    function getDeserializedJsonObj(obj: CreateDatabaseRegistrationDetails): object;
}

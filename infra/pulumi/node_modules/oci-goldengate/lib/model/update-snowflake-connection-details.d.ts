...
export declare namespace UpdateSnowflakeConnectionDetails {
    function getJsonObj(obj: UpdateSnowflakeConnectionDetails, isParentJsonObj?: boolean): object;
    const connectionType = "SNOWFLAKE";
    function getDeserializedJsonObj(obj: UpdateSnowflakeConnectionDetails, isParentJsonObj?: boolean): object;
}

...
export declare namespace UpdateAmazonKinesisConnectionDetails {
    function getJsonObj(obj: UpdateAmazonKinesisConnectionDetails, isParentJsonObj?: boolean): object;
    const connectionType = "AMAZON_KINESIS";
    function getDeserializedJsonObj(obj: UpdateAmazonKinesisConnectionDetails, isParentJsonObj?: boolean): object;
}

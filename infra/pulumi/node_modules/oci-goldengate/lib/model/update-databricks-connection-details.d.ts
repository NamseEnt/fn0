...
export declare namespace UpdateDatabricksConnectionDetails {
    function getJsonObj(obj: UpdateDatabricksConnectionDetails, isParentJsonObj?: boolean): object;
    const connectionType = "DATABRICKS";
    function getDeserializedJsonObj(obj: UpdateDatabricksConnectionDetails, isParentJsonObj?: boolean): object;
}

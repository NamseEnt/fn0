...
export declare namespace CreateKafkaConnectionDetails {
    function getJsonObj(obj: CreateKafkaConnectionDetails, isParentJsonObj?: boolean): object;
    const connectionType = "KAFKA";
    function getDeserializedJsonObj(obj: CreateKafkaConnectionDetails, isParentJsonObj?: boolean): object;
}

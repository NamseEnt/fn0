...
export declare namespace AmazonS3IcebergStorage {
    enum SchemeType {
        S3 = "S3",
        S3A = "S3A",
        /**
    ...
    function getJsonObj(obj: AmazonS3IcebergStorage, isParentJsonObj?: boolean): object;
    const storageType = "AMAZON_S3";
    function getDeserializedJsonObj(obj: AmazonS3IcebergStorage, isParentJsonObj?: boolean): object;
}

 ...
 *
 **/
export declare enum TechnologyType {
...
export declare namespace TechnologyType {
    function getJsonObj(obj: TechnologyType): TechnologyType;
    function getDeserializedJsonObj(obj: TechnologyType): TechnologyType;
}

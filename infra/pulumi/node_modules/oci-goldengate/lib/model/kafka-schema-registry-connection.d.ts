...
export declare namespace KafkaSchemaRegistryConnection {
    enum TechnologyType {
    ...
    function getJsonObj(obj: KafkaSchemaRegistryConnection, isParentJsonObj?: boolean): object;
    const connectionType = "KAFKA_SCHEMA_REGISTRY";
    function getDeserializedJsonObj(obj: KafkaSchemaRegistryConnection, isParentJsonObj?: boolean): object;
}

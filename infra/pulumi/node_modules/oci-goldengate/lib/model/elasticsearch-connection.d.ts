...
export declare namespace ElasticsearchConnection {
    enum TechnologyType {
    ...
    function getJsonObj(obj: ElasticsearchConnection, isParentJsonObj?: boolean): object;
    const connectionType = "ELASTICSEARCH";
    function getDeserializedJsonObj(obj: ElasticsearchConnection, isParentJsonObj?: boolean): object;
}

 ...
 *
 */
export interface CreateMicrosoftSqlserverConnectionDetails extends model.CreateConnectionDetails {
    /**
...
export declare namespace CreateMicrosoftSqlserverConnectionDetails {
    function getJsonObj(obj: CreateMicrosoftSqlserverConnectionDetails, isParentJsonObj?: boolean): object;
    const connectionType = "MICROSOFT_SQLSERVER";
    function getDeserializedJsonObj(obj: CreateMicrosoftSqlserverConnectionDetails, isParentJsonObj?: boolean): object;
}

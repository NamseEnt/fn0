 ...
 *
 */
export interface AzureDataLakeStorageIcebergStorage extends model.IcebergStorage {
    /**
...
export declare namespace AzureDataLakeStorageIcebergStorage {
    function getJsonObj(obj: AzureDataLakeStorageIcebergStorage, isParentJsonObj?: boolean): object;
    const storageType = "AZURE_DATA_LAKE_STORAGE";
    function getDeserializedJsonObj(obj: AzureDataLakeStorageIcebergStorage, isParentJsonObj?: boolean): object;
}

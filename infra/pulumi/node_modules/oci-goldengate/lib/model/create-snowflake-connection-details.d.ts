...
export declare namespace CreateSnowflakeConnectionDetails {
    function getJsonObj(obj: CreateSnowflakeConnectionDetails, isParentJsonObj?: boolean): object;
    const connectionType = "SNOWFLAKE";
    function getDeserializedJsonObj(obj: CreateSnowflakeConnectionDetails, isParentJsonObj?: boolean): object;
}

...
export declare namespace CreateRestIcebergCatalogDetails {
    function getJsonObj(obj: CreateRestIcebergCatalogDetails, isParentJsonObj?: boolean): object;
    const catalogType = "REST";
    function getDeserializedJsonObj(obj: CreateRestIcebergCatalogDetails, isParentJsonObj?: boolean): object;
}

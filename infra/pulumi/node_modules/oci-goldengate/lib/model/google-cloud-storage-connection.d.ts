...
export declare namespace GoogleCloudStorageConnection {
    enum TechnologyType {
    ...
    function getJsonObj(obj: GoogleCloudStorageConnection, isParentJsonObj?: boolean): object;
    const connectionType = "GOOGLE_CLOUD_STORAGE";
    function getDeserializedJsonObj(obj: GoogleCloudStorageConnection, isParentJsonObj?: boolean): object;
}

...
export declare namespace TrailFileCollection {
    function getJsonObj(obj: TrailFileCollection): object;
    function getDeserializedJsonObj(obj: TrailFileCollection): object;
}

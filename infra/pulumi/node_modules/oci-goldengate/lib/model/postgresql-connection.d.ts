...
export declare namespace PostgresqlConnection {
    enum TechnologyType {
    ...
    function getJsonObj(obj: PostgresqlConnection, isParentJsonObj?: boolean): object;
    const connectionType = "POSTGRESQL";
    function getDeserializedJsonObj(obj: PostgresqlConnection, isParentJsonObj?: boolean): object;
}

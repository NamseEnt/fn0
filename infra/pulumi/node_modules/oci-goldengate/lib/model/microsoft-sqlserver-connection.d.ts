...
export declare namespace MicrosoftSqlserverConnection {
    enum TechnologyType {
    ...
    function getJsonObj(obj: MicrosoftSqlserverConnection, isParentJsonObj?: boolean): object;
    const connectionType = "MICROSOFT_SQLSERVER";
    function getDeserializedJsonObj(obj: MicrosoftSqlserverConnection, isParentJsonObj?: boolean): object;
}

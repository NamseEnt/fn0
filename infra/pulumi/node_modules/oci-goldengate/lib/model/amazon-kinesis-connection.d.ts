...
export declare namespace AmazonKinesisConnection {
    enum TechnologyType {
    ...
    function getJsonObj(obj: AmazonKinesisConnection, isParentJsonObj?: boolean): object;
    const connectionType = "AMAZON_KINESIS";
    function getDeserializedJsonObj(obj: AmazonKinesisConnection, isParentJsonObj?: boolean): object;
}

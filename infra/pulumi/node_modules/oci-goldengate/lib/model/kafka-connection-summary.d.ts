...
export declare namespace KafkaConnectionSummary {
    function getJsonObj(obj: KafkaConnectionSummary, isParentJsonObj?: boolean): object;
    const connectionType = "KAFKA";
    function getDeserializedJsonObj(obj: KafkaConnectionSummary, isParentJsonObj?: boolean): object;
}

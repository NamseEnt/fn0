...
export declare namespace GoogleBigQueryConnectionSummary {
    function getJsonObj(obj: GoogleBigQueryConnectionSummary, isParentJsonObj?: boolean): object;
    const connectionType = "GOOGLE_BIGQUERY";
    function getDeserializedJsonObj(obj: GoogleBigQueryConnectionSummary, isParentJsonObj?: boolean): object;
}

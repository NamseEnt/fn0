...
export declare namespace TestPipelineConnectionResult {
    enum ResultType {
        Succeeded = "SUCCEEDED",
        Failed = "FAILED",
        TimedOut = "TIMED_OUT",
    ...
    function getJsonObj(obj: TestPipelineConnectionResult): object;
    function getDeserializedJsonObj(obj: TestPipelineConnectionResult): object;
}

 ...
 *
 */
export interface CreateOracleAiDataPlatformConnectionDetails extends model.CreateConnectionDetails {
    /**
...
export declare namespace CreateOracleAiDataPlatformConnectionDetails {
    function getJsonObj(obj: CreateOracleAiDataPlatformConnectionDetails, isParentJsonObj?: boolean): object;
    const connectionType = "ORACLE_AI_DATA_PLATFORM";
    function getDeserializedJsonObj(obj: CreateOracleAiDataPlatformConnectionDetails, isParentJsonObj?: boolean): object;
}

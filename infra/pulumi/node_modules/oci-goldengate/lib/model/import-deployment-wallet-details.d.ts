...
export declare namespace ImportDeploymentWalletDetails {
    function getJsonObj(obj: ImportDeploymentWalletDetails): object;
    function getDeserializedJsonObj(obj: ImportDeploymentWalletDetails): object;
}

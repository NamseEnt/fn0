...
export declare namespace AmazonS3IcebergStorageSummary {
    function getJsonObj(obj: AmazonS3IcebergStorageSummary, isParentJsonObj?: boolean): object;
    const storageType = "AMAZON_S3";
    function getDeserializedJsonObj(obj: AmazonS3IcebergStorageSummary, isParentJsonObj?: boolean): object;
}

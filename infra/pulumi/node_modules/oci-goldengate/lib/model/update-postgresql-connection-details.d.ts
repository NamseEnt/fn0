...
export declare namespace UpdatePostgresqlConnectionDetails {
    function getJsonObj(obj: UpdatePostgresqlConnectionDetails, isParentJsonObj?: boolean): object;
    const connectionType = "POSTGRESQL";
    function getDeserializedJsonObj(obj: UpdatePostgresqlConnectionDetails, isParentJsonObj?: boolean): object;
}

...
export declare namespace JavaMessageServiceConnection {
    enum TechnologyType {
    ...
    function getJsonObj(obj: JavaMessageServiceConnection, isParentJsonObj?: boolean): object;
    const connectionType = "JAVA_MESSAGE_SERVICE";
    function getDeserializedJsonObj(obj: JavaMessageServiceConnection, isParentJsonObj?: boolean): object;
}

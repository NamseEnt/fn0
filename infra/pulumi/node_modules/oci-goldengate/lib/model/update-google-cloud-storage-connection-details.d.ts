...
export declare namespace UpdateGoogleCloudStorageConnectionDetails {
    function getJsonObj(obj: UpdateGoogleCloudStorageConnectionDetails, isParentJsonObj?: boolean): object;
    const connectionType = "GOOGLE_CLOUD_STORAGE";
    function getDeserializedJsonObj(obj: UpdateGoogleCloudStorageConnectionDetails, isParentJsonObj?: boolean): object;
}

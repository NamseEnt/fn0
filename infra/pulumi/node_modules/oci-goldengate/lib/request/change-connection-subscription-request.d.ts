...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/goldengate/ChangeConnectionSubscription.ts.html |here} to see how to use ChangeConnectionSubscriptionRequest.
 */
export interface ChangeConnectionSubscriptionRequest extends common.BaseRequest {
    /**
     * Associate a GoldenGate connection with a different subscription.
     *
     */
    "changeConnectionSubscriptionDetails": model.ChangeConnectionSubscriptionDetails;
    /**

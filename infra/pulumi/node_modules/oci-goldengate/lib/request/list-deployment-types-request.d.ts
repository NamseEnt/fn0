...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/goldengate/ListDeploymentTypes.ts.html |here} to see how to use ListDeploymentTypesRequest.
 */
export interface ListDeploymentTypesRequest extends common.BaseRequest {
    /**
...
export declare namespace ListDeploymentTypesRequest {
    enum SortBy {

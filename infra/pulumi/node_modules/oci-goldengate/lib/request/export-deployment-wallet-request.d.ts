...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/goldengate/ExportDeploymentWallet.ts.html |here} to see how to use ExportDeploymentWalletRequest.
 */
export interface ExportDeploymentWalletRequest extends common.BaseRequest {
    /**
     ...
     *
     */
    "exportDeploymentWalletDetails": model.ExportDeploymentWalletDetails;
    /**

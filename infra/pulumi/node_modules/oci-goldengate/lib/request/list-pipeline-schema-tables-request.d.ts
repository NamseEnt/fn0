...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/goldengate/ListPipelineSchemaTables.ts.html |here} to see how to use ListPipelineSchemaTablesRequest.
 */
export interface ListPipelineSchemaTablesRequest extends common.BaseRequest {
    /**
...
export declare namespace ListPipelineSchemaTablesRequest {
    enum SortBy {

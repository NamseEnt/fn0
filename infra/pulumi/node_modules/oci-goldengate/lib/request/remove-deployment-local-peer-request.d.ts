...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/goldengate/RemoveDeploymentLocalPeer.ts.html |here} to see how to use RemoveDeploymentLocalPeerRequest.
 */
export interface RemoveDeploymentLocalPeerRequest extends common.BaseRequest {
    /**
     ...
     *
     */
    "removeDeploymentLocalPeerDetails": model.RemoveDeploymentLocalPeerDetails;
    /**

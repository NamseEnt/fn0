...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/goldengate/StartDeployment.ts.html |here} to see how to use StartDeploymentRequest.
 */
export interface StartDeploymentRequest extends common.BaseRequest {
    /**
     ...
     *
     */
    "startDeploymentDetails": model.DefaultStartDeploymentDetails;
    /**

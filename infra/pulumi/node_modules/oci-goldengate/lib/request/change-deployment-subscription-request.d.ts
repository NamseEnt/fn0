...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/goldengate/ChangeDeploymentSubscription.ts.html |here} to see how to use ChangeDeploymentSubscriptionRequest.
 */
export interface ChangeDeploymentSubscriptionRequest extends common.BaseRequest {
    /**
     * Associate a GoldenGate deployment with a different subscription.
     *
     */
    "changeDeploymentSubscriptionDetails": model.ChangeDeploymentSubscriptionDetails;
    /**

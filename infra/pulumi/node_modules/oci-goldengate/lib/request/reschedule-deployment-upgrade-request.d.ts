...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/goldengate/RescheduleDeploymentUpgrade.ts.html |here} to see how to use RescheduleDeploymentUpgradeRequest.
 */
export interface RescheduleDeploymentUpgradeRequest extends common.BaseRequest {
    /**
     ...
     *
     */
    "rescheduleDeploymentUpgradeDetails": model.RescheduleDeploymentUpgradeToDateDetails;
    /**

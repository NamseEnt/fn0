...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/goldengate/ListDeploymentEnvironments.ts.html |here} to see how to use ListDeploymentEnvironmentsRequest.
 */
export interface ListDeploymentEnvironmentsRequest extends common.BaseRequest {
    /**
...
export declare namespace ListDeploymentEnvironmentsRequest {
    enum SortBy {

...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/goldengate/PausePipeline.ts.html |here} to see how to use PausePipelineRequest.
 */
export interface PausePipelineRequest extends common.BaseRequest {
    /**
     ...
     *
     */
    "pausePipelineDetails": model.DefaultPausePipelineDetails;
    /**

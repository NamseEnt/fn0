...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/goldengate/ListDeploymentUpgrades.ts.html |here} to see how to use ListDeploymentUpgradesRequest.
 */
export interface ListDeploymentUpgradesRequest extends common.BaseRequest {
    /**
...
export declare namespace ListDeploymentUpgradesRequest {
    enum SortBy {

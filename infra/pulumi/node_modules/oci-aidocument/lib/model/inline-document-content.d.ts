...
export declare namespace InlineDocumentContent {
    function getJsonObj(obj: InlineDocumentContent, isParentJsonObj?: boolean): object;
    const sourceType = "INLINE_DOCUMENT_CONTENT";
    function getDeserializedJsonObj(obj: InlineDocumentContent, isParentJsonObj?: boolean): object;
}

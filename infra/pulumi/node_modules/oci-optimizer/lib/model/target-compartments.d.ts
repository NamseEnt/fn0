...
export declare namespace TargetCompartments {
    function getJsonObj(obj: TargetCompartments): object;
    function getDeserializedJsonObj(obj: TargetCompartments): object;
}

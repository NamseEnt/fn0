...
export declare namespace CategoryCollection {
    function getJsonObj(obj: CategoryCollection): object;
    function getDeserializedJsonObj(obj: CategoryCollection): object;
}

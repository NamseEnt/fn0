...
export declare namespace StrategyParameter {
    function getJsonObj(obj: StrategyParameter): object;
    function getDeserializedJsonObj(obj: StrategyParameter): object;
}

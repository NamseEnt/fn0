...
export declare namespace LevelsConfiguration {
    function getJsonObj(obj: LevelsConfiguration): object;
    function getDeserializedJsonObj(obj: LevelsConfiguration): object;
}

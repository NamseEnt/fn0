 ...
 *
 */
export interface SupportedLevel {
    /**
     * The name of the profile level.
     */
    "name"?: string;
}
export declare namespace SupportedLevel {
    function getJsonObj(obj: SupportedLevel): object;
    function getDeserializedJsonObj(obj: SupportedLevel): object;
}

...
export declare namespace RecommendationCount {
    function getJsonObj(obj: RecommendationCount): object;
    function getDeserializedJsonObj(obj: RecommendationCount): object;
}

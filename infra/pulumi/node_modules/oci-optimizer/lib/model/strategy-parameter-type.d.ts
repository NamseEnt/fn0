...
export declare namespace StrategyParameterType {
    function getJsonObj(obj: StrategyParameterType): StrategyParameterType;
    function getDeserializedJsonObj(obj: StrategyParameterType): StrategyParameterType;
}

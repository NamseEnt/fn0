...
export declare namespace EnrollmentStatusSummary {
    function getJsonObj(obj: EnrollmentStatusSummary): object;
    function getDeserializedJsonObj(obj: EnrollmentStatusSummary): object;
}

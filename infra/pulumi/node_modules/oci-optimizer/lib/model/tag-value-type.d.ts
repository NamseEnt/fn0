...
*
**/
export declare enum TagValueType {
    Value = "VALUE",
    Any = "ANY",
    /**
...
export declare namespace TagValueType {
    function getJsonObj(obj: TagValueType): TagValueType;
    function getDeserializedJsonObj(obj: TagValueType): TagValueType;
}

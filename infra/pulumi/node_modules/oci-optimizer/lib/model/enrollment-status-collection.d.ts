...
export interface EnrollmentStatusCollection {
     ...
     */
    "items": Array<model.EnrollmentStatusSummary>;
}
export declare namespace EnrollmentStatusCollection {
    function getJsonObj(obj: EnrollmentStatusCollection): object;
    function getDeserializedJsonObj(obj: EnrollmentStatusCollection): object;
}

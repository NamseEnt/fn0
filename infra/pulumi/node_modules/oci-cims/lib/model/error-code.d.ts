...
export declare enum ErrorCode {
    ...
    CmosUnauthorizedPermission = "CMOS_UNAUTHORIZED_PERMISSION",
    CmosSupportAccountExists = "CMOS_SUPPORT_ACCOUNT_EXISTS",
    CmosInvalidUserGroupId = "CMOS_INVALID_USER_GROUP_ID",
    UnsupportedOperation = "UNSUPPORTED_OPERATION",
    Notauthorizedornotfound = "NOTAUTHORIZEDORNOTFOUND",
    ListSubscriptionFailure = "LIST_SUBSCRIPTION_FAILURE",
    /**
...
export declare namespace ErrorCode {
    function getJsonObj(obj: ErrorCode): ErrorCode;
    function getDeserializedJsonObj(obj: ErrorCode): ErrorCode;
}

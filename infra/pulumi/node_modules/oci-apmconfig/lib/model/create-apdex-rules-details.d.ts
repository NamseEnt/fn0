...
export declare namespace CreateApdexRulesDetails {
    function getJsonObj(obj: CreateApdexRulesDetails, isParentJsonObj?: boolean): object;
    const configType = "APDEX";
    function getDeserializedJsonObj(obj: CreateApdexRulesDetails, isParentJsonObj?: boolean): object;
}

 ...
 *
 */
export interface AgentConfig extends model.Config {
    /**
...
export declare namespace AgentConfig {
    function getJsonObj(obj: AgentConfig, isParentJsonObj?: boolean): object;
    const configType = "AGENT";
    function getDeserializedJsonObj(obj: AgentConfig, isParentJsonObj?: boolean): object;
}

...
export interface AgentConfigMap {
     ...
     */
    "configMap"?: {
        [key: string]: model.AgentConfigFile;
    };
}
export declare namespace AgentConfigMap {
    function getJsonObj(obj: AgentConfigMap): object;
    function getDeserializedJsonObj(obj: AgentConfigMap): object;
}

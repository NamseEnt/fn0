...
export declare namespace CreateAgentConfigDetails {
    function getJsonObj(obj: CreateAgentConfigDetails, isParentJsonObj?: boolean): object;
    const configType = "AGENT";
    function getDeserializedJsonObj(obj: CreateAgentConfigDetails, isParentJsonObj?: boolean): object;
}

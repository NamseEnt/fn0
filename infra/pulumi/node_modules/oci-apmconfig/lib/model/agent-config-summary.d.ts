...
export declare namespace AgentConfigSummary {
    function getJsonObj(obj: AgentConfigSummary, isParentJsonObj?: boolean): object;
    const configType = "AGENT";
    function getDeserializedJsonObj(obj: AgentConfigSummary, isParentJsonObj?: boolean): object;
}

 ...
 */
export interface MacsApmExtensionSummary extends model.ConfigSummary {
    /**
...
export declare namespace MacsApmExtensionSummary {
    function getJsonObj(obj: MacsApmExtensionSummary, isParentJsonObj?: boolean): object;
    const configType = "MACS_APM_EXTENSION";
    function getDeserializedJsonObj(obj: MacsApmExtensionSummary, isParentJsonObj?: boolean): object;
}

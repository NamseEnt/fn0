 ...
 */
export interface UpdateMacsApmExtensionDetails extends model.UpdateConfigDetails {
    /**
...
export declare namespace UpdateMacsApmExtensionDetails {
    function getJsonObj(obj: UpdateMacsApmExtensionDetails, isParentJsonObj?: boolean): object;
    const configType = "MACS_APM_EXTENSION";
    function getDeserializedJsonObj(obj: UpdateMacsApmExtensionDetails, isParentJsonObj?: boolean): object;
}

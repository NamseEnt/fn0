...
export declare namespace MacsApmExtension {
    function getJsonObj(obj: MacsApmExtension, isParentJsonObj?: boolean): object;
    const configType = "MACS_APM_EXTENSION";
    function getDeserializedJsonObj(obj: MacsApmExtension, isParentJsonObj?: boolean): object;
}

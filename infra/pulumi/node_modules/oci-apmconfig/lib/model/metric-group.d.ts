...
export declare namespace MetricGroup {
    function getJsonObj(obj: MetricGroup, isParentJsonObj?: boolean): object;
    const configType = "METRIC_GROUP";
    function getDeserializedJsonObj(obj: MetricGroup, isParentJsonObj?: boolean): object;
}

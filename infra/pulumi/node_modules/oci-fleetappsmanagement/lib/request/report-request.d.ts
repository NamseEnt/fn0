...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/fleetappsmanagement/Report.ts.html |here} to see how to use ReportRequest.
 */
export interface ReportRequest extends common.BaseRequest {
    /**

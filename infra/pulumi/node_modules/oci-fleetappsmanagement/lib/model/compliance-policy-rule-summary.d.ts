 ...
 */
export interface CompliancePolicyRuleSummary {
    /**
  ...
  *
     ...
     */
    "severity"?: Array<CompliancePolicyRuleSummary.Severity>;
...
export declare namespace CompliancePolicyRuleSummary {
    enum Severity {
        Critical = "CRITICAL",
        High = "HIGH",
        Medium = "MEDIUM",
    ...
    function getJsonObj(obj: CompliancePolicyRuleSummary): object;
    function getDeserializedJsonObj(obj: CompliancePolicyRuleSummary): object;
}

...
export declare namespace EnvironmentConfigCategoryDetails {
    function getJsonObj(obj: EnvironmentConfigCategoryDetails, isParentJsonObj?: boolean): object;
    const configCategory = "ENVIRONMENT";
    function getDeserializedJsonObj(obj: EnvironmentConfigCategoryDetails, isParentJsonObj?: boolean): object;
}

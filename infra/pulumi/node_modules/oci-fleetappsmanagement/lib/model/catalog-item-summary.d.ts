...
export declare namespace CatalogItemSummary {
    function getJsonObj(obj: CatalogItemSummary): object;
    function getDeserializedJsonObj(obj: CatalogItemSummary): object;
}

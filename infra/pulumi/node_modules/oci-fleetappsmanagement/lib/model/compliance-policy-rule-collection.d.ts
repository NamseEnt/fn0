...
export declare namespace CompliancePolicyRuleCollection {
    function getJsonObj(obj: CompliancePolicyRuleCollection): object;
    function getDeserializedJsonObj(obj: CompliancePolicyRuleCollection): object;
}

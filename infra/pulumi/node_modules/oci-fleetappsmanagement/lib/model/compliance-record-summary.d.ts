...
export declare namespace ComplianceRecordSummary {
    function getJsonObj(obj: ComplianceRecordSummary): object;
    function getDeserializedJsonObj(obj: ComplianceRecordSummary): object;
}

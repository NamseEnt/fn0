 ...
 *
 */
export interface ProductStackAsProductSubCategoryDetails extends model.ProductStackSubCategoryDetails {
    /**
...
export declare namespace ProductStackAsProductSubCategoryDetails {
    function getJsonObj(obj: ProductStackAsProductSubCategoryDetails, isParentJsonObj?: boolean): object;
    const subCategory = "PRODUCT_STACK_AS_PRODUCT";
    function getDeserializedJsonObj(obj: ProductStackAsProductSubCategoryDetails, isParentJsonObj?: boolean): object;
}

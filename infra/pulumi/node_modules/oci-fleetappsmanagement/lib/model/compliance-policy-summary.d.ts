...
export declare namespace CompliancePolicySummary {
    function getJsonObj(obj: CompliancePolicySummary): object;
    function getDeserializedJsonObj(obj: CompliancePolicySummary): object;
}

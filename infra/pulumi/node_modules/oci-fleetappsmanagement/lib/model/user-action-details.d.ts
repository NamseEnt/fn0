...
export declare namespace UserActionDetails {
    enum Action {
        Retry = "RETRY",
        Resume = "RESUME",
        Ignore = "IGNORE",
    ...
    function getJsonObj(obj: UserActionDetails): object;
    function getDeserializedJsonObj(obj: UserActionDetails): object;
}

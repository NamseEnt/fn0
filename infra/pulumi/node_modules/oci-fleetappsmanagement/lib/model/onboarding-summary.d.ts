...
export declare namespace OnboardingSummary {
    function getJsonObj(obj: OnboardingSummary): object;
    function getDeserializedJsonObj(obj: OnboardingSummary): object;
}

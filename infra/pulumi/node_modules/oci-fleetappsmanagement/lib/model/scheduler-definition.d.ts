...
export interface SchedulerDefinition {
  ...
  *
     ...
     */
    "lifecycleState": SchedulerDefinition.LifecycleState;
    /**
...
export declare namespace SchedulerDefinition {
    enum LifecycleState {
        Creating = "CREATING",
        Updating = "UPDATING",
        Active = "ACTIVE",
    ...
    function getJsonObj(obj: SchedulerDefinition): object;
    function getDeserializedJsonObj(obj: SchedulerDefinition): object;
}

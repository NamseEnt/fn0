...
export declare namespace UpdateDatasetDetails {
    function getJsonObj(obj: UpdateDatasetDetails): object;
    function getDeserializedJsonObj(obj: UpdateDatasetDetails): object;
}

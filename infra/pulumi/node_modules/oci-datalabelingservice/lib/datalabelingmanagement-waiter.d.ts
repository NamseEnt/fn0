...
export declare class DataLabelingManagementWaiter {
    private client;
    private readonly config?;
    constructor(client: DataLabelingManagementClient, config?: Partial<import("oci-common/lib/waiter").WaiterConfigurationDetails> | undefined);
    /**

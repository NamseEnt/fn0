...
export declare namespace BasicAuthSecret {
    function getJsonObj(obj: BasicAuthSecret, isParentJsonObj?: boolean): object;
    const type = "BASIC_AUTH_SECRET";
    function getDeserializedJsonObj(obj: BasicAuthSecret, isParentJsonObj?: boolean): object;
}

...
export declare namespace ChangeKnowledgeBaseCompartmentDetails {
    function getJsonObj(obj: ChangeKnowledgeBaseCompartmentDetails): object;
    function getDeserializedJsonObj(obj: ChangeKnowledgeBaseCompartmentDetails): object;
}

...
(function (DatabaseConnection) {
        ...
        if (obj && "connectionType" in obj && obj.connectionType) {
            switch (obj.connectionType) {
                case "DATABASE_TOOL_CONNECTION":
                    return model.DatabaseToolConnection.getJsonObj(jsonObj, true);
                default:
    ...
    DatabaseConnection.getJsonObj = getJsonObj;
    function getDeserializedJsonObj(obj) {
        const jsonObj = Object.assign(Object.assign({}, obj), {});
        if (obj && "connectionType" in obj && obj.connectionType) {
            switch (obj.connectionType) {
                case "DATABASE_TOOL_CONNECTION":
                    return model.DatabaseToolConnection.getDeserializedJsonObj(jsonObj, true);
                default:
                    if (common.LOG.logger)
                        common.LOG.logger.info(`Unknown value for: ${obj.connectionType}`);
            }
    ...
    DatabaseConnection.getDeserializedJsonObj = getDeserializedJsonObj;
})(DatabaseConnection = exports.DatabaseConnection || (exports.DatabaseConnection = {}));

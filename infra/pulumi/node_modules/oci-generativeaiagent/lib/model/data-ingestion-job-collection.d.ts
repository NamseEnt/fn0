...
export interface DataIngestionJobCollection {
     ...
     */
    "items": Array<model.DataIngestionJobSummary>;
}
export declare namespace DataIngestionJobCollection {
    function getJsonObj(obj: DataIngestionJobCollection): object;
    function getDeserializedJsonObj(obj: DataIngestionJobCollection): object;
}

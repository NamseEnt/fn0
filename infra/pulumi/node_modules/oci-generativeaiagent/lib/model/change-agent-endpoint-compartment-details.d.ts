...
export declare namespace ChangeAgentEndpointCompartmentDetails {
    function getJsonObj(obj: ChangeAgentEndpointCompartmentDetails): object;
    function getDeserializedJsonObj(obj: ChangeAgentEndpointCompartmentDetails): object;
}

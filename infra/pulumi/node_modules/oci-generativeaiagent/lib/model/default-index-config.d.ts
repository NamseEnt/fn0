...
export declare namespace DefaultIndexConfig {
    function getJsonObj(obj: DefaultIndexConfig, isParentJsonObj?: boolean): object;
    const indexConfigType = "DEFAULT_INDEX_CONFIG";
    function getDeserializedJsonObj(obj: DefaultIndexConfig, isParentJsonObj?: boolean): object;
}

...
export declare namespace AgentEndpointSummary {
    function getJsonObj(obj: AgentEndpointSummary): object;
    function getDeserializedJsonObj(obj: AgentEndpointSummary): object;
}

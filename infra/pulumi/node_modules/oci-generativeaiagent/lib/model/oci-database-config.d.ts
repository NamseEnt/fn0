...
export declare namespace OciDatabaseConfig {
    function getJsonObj(obj: OciDatabaseConfig, isParentJsonObj?: boolean): object;
    const indexConfigType = "OCI_DATABASE_CONFIG";
    function getDeserializedJsonObj(obj: OciDatabaseConfig, isParentJsonObj?: boolean): object;
}

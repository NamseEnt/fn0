 ...
 *
 */
export interface ObjectStoragePrefix {
    /**
...
export declare namespace ObjectStoragePrefix {
    function getJsonObj(obj: ObjectStoragePrefix): object;
    function getDeserializedJsonObj(obj: ObjectStoragePrefix): object;
}

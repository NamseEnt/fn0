...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/generativeaiagent/ListProvisionedCapacities.ts.html |here} to see how to use ListProvisionedCapacitiesRequest.
 */
export interface ListProvisionedCapacitiesRequest extends common.BaseRequest {
    /**
...
export declare namespace ListProvisionedCapacitiesRequest {
    enum SortBy {

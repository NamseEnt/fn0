...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/psql/BackupCopy.ts.html |here} to see how to use BackupCopyRequest.
 */
export interface BackupCopyRequest extends common.BaseRequest {
    /**
     ...
     */
    "backupCopyDetails": model.BackupCopyDetails;
    /**

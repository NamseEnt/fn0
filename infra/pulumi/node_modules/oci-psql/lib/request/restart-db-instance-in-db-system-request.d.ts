...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/psql/RestartDbInstanceInDbSystem.ts.html |here} to see how to use RestartDbInstanceInDbSystemRequest.
 */
export interface RestartDbInstanceInDbSystemRequest extends common.BaseRequest {
    /**

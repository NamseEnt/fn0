...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/psql/RestoreDbSystem.ts.html |here} to see how to use RestoreDbSystemRequest.
 */
export interface RestoreDbSystemRequest extends common.BaseRequest {
    /**
     ...
     */
    "restoreDbSystemDetails": model.RestoreDbSystemDetails;
    /**

...
export declare namespace UpdateDbConfigParams {
    enum ApplyConfig {
        Restart = "RESTART",
        Reload = "RELOAD"
    }
    function getJsonObj(obj: UpdateDbConfigParams): object;
    function getDeserializedJsonObj(obj: UpdateDbConfigParams): object;
}

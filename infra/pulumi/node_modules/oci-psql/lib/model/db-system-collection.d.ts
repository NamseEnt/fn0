 ...
 */
export interface DbSystemCollection {
    /**
     * List of database systems.
     */
    "items": Array<model.DbSystemSummary>;
}
export declare namespace DbSystemCollection {
    function getJsonObj(obj: DbSystemCollection): object;
    function getDeserializedJsonObj(obj: DbSystemCollection): object;
}

...
export declare namespace DbInstanceEndpoint {
    function getJsonObj(obj: DbInstanceEndpoint): object;
    function getDeserializedJsonObj(obj: DbInstanceEndpoint): object;
}

...
(function (SourceDetails) {
    function getJsonObj(obj) {
        ...
        if (obj && "sourceType" in obj && obj.sourceType) {
            switch (obj.sourceType) {
                case "BACKUP":
                    return model.BackupSourceDetails.getJsonObj(jsonObj, true);
                case "NONE":
                    return model.NoneSourceDetails.getJsonObj(jsonObj, true);
                default:
    ...
    function getDeserializedJsonObj(obj) {
        ...
        if (obj && "sourceType" in obj && obj.sourceType) {
            switch (obj.sourceType) {
                case "BACKUP":
                    return model.BackupSourceDetails.getDeserializedJsonObj(jsonObj, true);
                case "NONE":
                    return model.NoneSourceDetails.getDeserializedJsonObj(jsonObj, true);
                default:
                    if (common.LOG.logger)
                        common.LOG.logger.info(`Unknown value for: ${obj.sourceType}`);
            }

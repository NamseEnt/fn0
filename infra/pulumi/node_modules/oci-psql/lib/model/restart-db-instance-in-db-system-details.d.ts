...
export declare namespace RestartDbInstanceInDbSystemDetails {
    enum RestartType {
        Normal = "NORMAL",
        NodeReboot = "NODE_REBOOT"
    }
    function getJsonObj(obj: RestartDbInstanceInDbSystemDetails): object;
    function getDeserializedJsonObj(obj: RestartDbInstanceInDbSystemDetails): object;
}

...
export declare namespace UpdateDbSystemDbInstanceDetails {
    function getJsonObj(obj: UpdateDbSystemDbInstanceDetails): object;
    function getDeserializedJsonObj(obj: UpdateDbSystemDbInstanceDetails): object;
}

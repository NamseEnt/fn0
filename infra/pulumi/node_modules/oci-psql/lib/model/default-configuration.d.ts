...
export declare namespace DefaultConfiguration {
    enum LifecycleState {
        Active = "ACTIVE",
        Inactive = "INACTIVE",
        Deleting = "DELETING",
    ...
    function getJsonObj(obj: DefaultConfiguration): object;
    function getDeserializedJsonObj(obj: DefaultConfiguration): object;
}

 ...
 */
export interface SourceBackupDetails {
    /**
...
export declare namespace SourceBackupDetails {
    function getJsonObj(obj: SourceBackupDetails): object;
    function getDeserializedJsonObj(obj: SourceBackupDetails): object;
}

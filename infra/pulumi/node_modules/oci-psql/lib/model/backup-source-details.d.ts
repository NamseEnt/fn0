...
export declare namespace BackupSourceDetails {
    function getJsonObj(obj: BackupSourceDetails, isParentJsonObj?: boolean): object;
    const sourceType = "BACKUP";
    function getDeserializedJsonObj(obj: BackupSourceDetails, isParentJsonObj?: boolean): object;
}

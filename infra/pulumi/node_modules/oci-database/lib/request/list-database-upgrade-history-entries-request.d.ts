...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/database/ListDatabaseUpgradeHistoryEntries.ts.html |here} to see how to use ListDatabaseUpgradeHistoryEntriesRequest.
 */
...
export declare namespace ListDatabaseUpgradeHistoryEntriesRequest {
    enum SortBy {

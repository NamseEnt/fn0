...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/database/ListSchedulingPlans.ts.html |here} to see how to use ListSchedulingPlansRequest.
 */
export interface ListSchedulingPlansRequest extends common.BaseRequest {
    /**
...
export declare namespace ListSchedulingPlansRequest {
    enum SortBy {

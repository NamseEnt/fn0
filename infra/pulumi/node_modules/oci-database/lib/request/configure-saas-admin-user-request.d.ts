...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/database/ConfigureSaasAdminUser.ts.html |here} to see how to use ConfigureSaasAdminUserRequest.
 */
export interface ConfigureSaasAdminUserRequest extends common.BaseRequest {
    /**

...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/database/ListDbnodeSnapshots.ts.html |here} to see how to use ListDbnodeSnapshotsRequest.
 */
export interface ListDbnodeSnapshotsRequest extends common.BaseRequest {
    /**
...
export declare namespace ListDbnodeSnapshotsRequest {
    enum SortBy {

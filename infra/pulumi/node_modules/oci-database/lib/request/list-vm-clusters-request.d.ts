...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/database/ListVmClusters.ts.html |here} to see how to use ListVmClustersRequest.
 */
export interface ListVmClustersRequest extends common.BaseRequest {
    /**
...
export declare namespace ListVmClustersRequest {
    enum SortBy {

...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/database/ListExecutionActions.ts.html |here} to see how to use ListExecutionActionsRequest.
 */
export interface ListExecutionActionsRequest extends common.BaseRequest {
    /**
...
export declare namespace ListExecutionActionsRequest {
    enum SortBy {

...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/database/ListFlexComponents.ts.html |here} to see how to use ListFlexComponentsRequest.
 */
export interface ListFlexComponentsRequest extends common.BaseRequest {
    /**
...
export declare namespace ListFlexComponentsRequest {
    enum SortOrder {
        Asc = "ASC",
        Desc = "DESC"
    }

...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/database/ListMaintenanceRunHistory.ts.html |here} to see how to use ListMaintenanceRunHistoryRequest.
 */
export interface ListMaintenanceRunHistoryRequest extends common.BaseRequest {
    /**
...
export declare namespace ListMaintenanceRunHistoryRequest {
    enum SortBy {

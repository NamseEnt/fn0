...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/database/ChangeAutonomousDatabaseSoftwareImageCompartment.ts.html |here} to see how to use ChangeAutonomousDatabaseSoftwareImageCompartmentRequest.
 */
export interface ChangeAutonomousDatabaseSoftwareImageCompartmentRequest extends common.BaseRequest {
    /**

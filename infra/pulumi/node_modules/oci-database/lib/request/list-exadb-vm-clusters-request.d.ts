...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/database/ListExadbVmClusters.ts.html |here} to see how to use ListExadbVmClustersRequest.
 */
export interface ListExadbVmClustersRequest extends common.BaseRequest {
    /**
...
export declare namespace ListExadbVmClustersRequest {
    enum SortBy {

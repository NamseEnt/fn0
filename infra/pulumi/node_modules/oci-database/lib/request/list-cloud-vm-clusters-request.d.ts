...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/database/ListCloudVmClusters.ts.html |here} to see how to use ListCloudVmClustersRequest.
 */
export interface ListCloudVmClustersRequest extends common.BaseRequest {
    /**
...
export declare namespace ListCloudVmClustersRequest {
    enum SortBy {

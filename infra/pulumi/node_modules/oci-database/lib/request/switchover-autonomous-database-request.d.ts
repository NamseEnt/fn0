...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/database/SwitchoverAutonomousDatabase.ts.html |here} to see how to use SwitchoverAutonomousDatabaseRequest.
 */
export interface SwitchoverAutonomousDatabaseRequest extends common.BaseRequest {
    /**

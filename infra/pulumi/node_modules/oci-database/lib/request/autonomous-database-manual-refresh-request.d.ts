...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/database/AutonomousDatabaseManualRefresh.ts.html |here} to see how to use AutonomousDatabaseManualRefreshRequest.
 */
export interface AutonomousDatabaseManualRefreshRequest extends common.BaseRequest {
    /**

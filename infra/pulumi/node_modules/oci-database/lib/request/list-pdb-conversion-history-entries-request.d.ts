...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/database/ListPdbConversionHistoryEntries.ts.html |here} to see how to use ListPdbConversionHistoryEntriesRequest.
 */
...
export declare namespace ListPdbConversionHistoryEntriesRequest {
    enum SortBy {

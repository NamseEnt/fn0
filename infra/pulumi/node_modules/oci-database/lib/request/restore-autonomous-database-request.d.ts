...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/database/RestoreAutonomousDatabase.ts.html |here} to see how to use RestoreAutonomousDatabaseRequest.
 */
export interface RestoreAutonomousDatabaseRequest extends common.BaseRequest {
    /**

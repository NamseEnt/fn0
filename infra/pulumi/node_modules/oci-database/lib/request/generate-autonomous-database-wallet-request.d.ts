...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/database/GenerateAutonomousDatabaseWallet.ts.html |here} to see how to use GenerateAutonomousDatabaseWalletRequest.
 */
export interface GenerateAutonomousDatabaseWalletRequest extends common.BaseRequest {
    /**

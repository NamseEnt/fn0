...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/database/ListAdvancedClusterFileSystems.ts.html |here} to see how to use ListAdvancedClusterFileSystemsRequest.
 */
export interface ListAdvancedClusterFileSystemsRequest extends common.BaseRequest {
    /**
...
export declare namespace ListAdvancedClusterFileSystemsRequest {
    enum SortBy {

...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/database/ListExadataInfrastructures.ts.html |here} to see how to use ListExadataInfrastructuresRequest.
 */
export interface ListExadataInfrastructuresRequest extends common.BaseRequest {
     ...
     */
    "excludedFields"?: Array<ListExadataInfrastructuresRequest.ExcludedFields>;
}
export declare namespace ListExadataInfrastructuresRequest {
    enum SortBy {

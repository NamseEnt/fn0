...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/database/RegisterAutonomousDatabaseDataSafe.ts.html |here} to see how to use RegisterAutonomousDatabaseDataSafeRequest.
 */
export interface RegisterAutonomousDatabaseDataSafeRequest extends common.BaseRequest {
    /**

...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/database/ActivateExadataInfrastructure.ts.html |here} to see how to use ActivateExadataInfrastructureRequest.
 */
export interface ActivateExadataInfrastructureRequest extends common.BaseRequest {
    /**

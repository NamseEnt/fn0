...
export interface MigrateExadataDbSystemResourceModelResponse {
    /**
    ...
    "etag": string;
    /**
     * The returned model.ExadataDbSystemMigration instance.
     */
    "exadataDbSystemMigration": model.ExadataDbSystemMigration;
}

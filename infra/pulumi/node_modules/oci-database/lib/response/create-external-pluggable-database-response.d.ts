...
export interface CreateExternalPluggableDatabaseResponse {
    /**
    ...
    "opcRequestId": string;
    /**
     * The returned model.ExternalPluggableDatabase instance.
     */
    "externalPluggableDatabase": model.ExternalPluggableDatabase;
}

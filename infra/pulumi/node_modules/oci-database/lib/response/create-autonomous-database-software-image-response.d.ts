...
export interface CreateAutonomousDatabaseSoftwareImageResponse {
    /**
    ...
    "opcRequestId": string;
    /**
     * The returned model.AutonomousDatabaseSoftwareImage instance.
     */
    "autonomousDatabaseSoftwareImage": model.AutonomousDatabaseSoftwareImage;
}

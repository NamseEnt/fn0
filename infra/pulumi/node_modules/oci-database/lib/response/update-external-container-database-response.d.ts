...
export interface UpdateExternalContainerDatabaseResponse {
    /**
    ...
    "etag": string;
    /**
     * The returned model.ExternalContainerDatabase instance.
     */
    "externalContainerDatabase": model.ExternalContainerDatabase;
}

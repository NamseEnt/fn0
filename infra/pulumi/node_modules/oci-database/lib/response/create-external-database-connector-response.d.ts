...
export interface CreateExternalDatabaseConnectorResponse {
    /**
    ...
    "opcRequestId": string;
    /**
     * The returned model.ExternalDatabaseConnector instance.
     */
    "externalDatabaseConnector": model.ExternalDatabaseConnector;
}

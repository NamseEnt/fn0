...
export interface UpdateExternalNonContainerDatabaseResponse {
    /**
    ...
    "opcRequestId": string;
    /**
     * The returned model.ExternalNonContainerDatabase instance.
     */
    "externalNonContainerDatabase": model.ExternalNonContainerDatabase;
}

...
export interface RotateAutonomousContainerDatabaseEncryptionKeyResponse {
    /**
    ...
    "opcRequestId": string;
    /**
     * The returned model.AutonomousContainerDatabase instance.
     */
    "autonomousContainerDatabase": model.AutonomousContainerDatabase;
}

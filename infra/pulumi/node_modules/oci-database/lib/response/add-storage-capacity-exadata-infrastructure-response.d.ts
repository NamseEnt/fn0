...
export interface AddStorageCapacityExadataInfrastructureResponse {
    /**
    ...
    "opcRequestId": string;
    /**
     * The returned model.ExadataInfrastructure instance.
     */
    "exadataInfrastructure": model.ExadataInfrastructure;
}

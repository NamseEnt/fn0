...
export declare namespace VmClusterNetworkSummary {
    enum LifecycleState {
        Creating = "CREATING",
    ...
    function getJsonObj(obj: VmClusterNetworkSummary): object;
    function getDeserializedJsonObj(obj: VmClusterNetworkSummary): object;
}

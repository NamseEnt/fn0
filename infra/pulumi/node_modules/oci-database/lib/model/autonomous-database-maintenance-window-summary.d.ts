...
export declare namespace AutonomousDatabaseMaintenanceWindowSummary {
    function getJsonObj(obj: AutonomousDatabaseMaintenanceWindowSummary): object;
    function getDeserializedJsonObj(obj: AutonomousDatabaseMaintenanceWindowSummary): object;
}

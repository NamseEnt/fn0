...
export interface CreateVmClusterDetails {
  ...
  *
     ...
     */
    "vmClusterType"?: CreateVmClusterDetails.VmClusterType;
...
export declare namespace CreateVmClusterDetails {
    enum LicenseModel {
    ...
    function getJsonObj(obj: CreateVmClusterDetails): object;
    function getDeserializedJsonObj(obj: CreateVmClusterDetails): object;
}

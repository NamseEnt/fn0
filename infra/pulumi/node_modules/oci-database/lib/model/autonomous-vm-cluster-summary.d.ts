...
export declare namespace AutonomousVmClusterSummary {
    enum LifecycleState {
    ...
    function getJsonObj(obj: AutonomousVmClusterSummary): object;
    function getDeserializedJsonObj(obj: AutonomousVmClusterSummary): object;
}

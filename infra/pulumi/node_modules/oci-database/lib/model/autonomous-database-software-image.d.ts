...
export declare namespace AutonomousDatabaseSoftwareImage {
    enum LifecycleState {
        Available = "AVAILABLE",
        Failed = "FAILED",
    ...
    function getJsonObj(obj: AutonomousDatabaseSoftwareImage): object;
    function getDeserializedJsonObj(obj: AutonomousDatabaseSoftwareImage): object;
}

...
export declare namespace ResizeVmClusterNetworkDetails {
    enum Action {
        AddDbserverNetwork = "ADD_DBSERVER_NETWORK",
        RemoveDbserverNetwork = "REMOVE_DBSERVER_NETWORK"
    }
    function getJsonObj(obj: ResizeVmClusterNetworkDetails): object;
    function getDeserializedJsonObj(obj: ResizeVmClusterNetworkDetails): object;
}

...
export declare namespace AutonomousContainerDatabaseVersionSummary {
    function getJsonObj(obj: AutonomousContainerDatabaseVersionSummary): object;
    function getDeserializedJsonObj(obj: AutonomousContainerDatabaseVersionSummary): object;
}

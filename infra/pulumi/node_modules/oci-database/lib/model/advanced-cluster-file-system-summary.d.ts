 ...
 *
 */
export interface AdvancedClusterFileSystemSummary {
    /**
...
export declare namespace AdvancedClusterFileSystemSummary {
    function getJsonObj(obj: AdvancedClusterFileSystemSummary): object;
    function getDeserializedJsonObj(obj: AdvancedClusterFileSystemSummary): object;
}

...
export declare namespace DisasterRecoveryConfiguration {
    ...
    function getJsonObj(obj: DisasterRecoveryConfiguration): object;
    function getDeserializedJsonObj(obj: DisasterRecoveryConfiguration): object;
}

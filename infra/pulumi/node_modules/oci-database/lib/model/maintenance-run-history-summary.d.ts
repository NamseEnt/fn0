...
export declare namespace MaintenanceRunHistorySummary {
    function getJsonObj(obj: MaintenanceRunHistorySummary): object;
    function getDeserializedJsonObj(obj: MaintenanceRunHistorySummary): object;
}

 ...
 *
 */
export interface CreateCrossRegionAutonomousDatabaseDataGuardDetails extends model.CreateAutonomousDatabaseBase {
    /**
...
export declare namespace CreateCrossRegionAutonomousDatabaseDataGuardDetails {
    function getJsonObj(obj: CreateCrossRegionAutonomousDatabaseDataGuardDetails, isParentJsonObj?: boolean): object;
    const source = "CROSS_REGION_DATAGUARD";
    function getDeserializedJsonObj(obj: CreateCrossRegionAutonomousDatabaseDataGuardDetails, isParentJsonObj?: boolean): object;
}

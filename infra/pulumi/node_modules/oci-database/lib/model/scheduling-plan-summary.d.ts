 ...
 */
export interface SchedulingPlanSummary {
    /**
     ...
     *
     */
    "lifecycleState": SchedulingPlanSummary.LifecycleState;
    /**
     ...
     *
     */
    "planIntent"?: SchedulingPlanSummary.PlanIntent;
    /**
     * The estimated time for the Scheduling Plan. Note: Numbers greater than Number.MAX_SAFE_INTEGER will result in rounding issues.
     */
    "estimatedTimeInMins"?: number;
    /**
     * The service type of the Scheduling Plan.
     */
    "serviceType": SchedulingPlanSummary.ServiceType;
    /**
...
export declare namespace SchedulingPlanSummary {
    enum LifecycleState {
        Creating = "CREATING",
    ...
    function getJsonObj(obj: SchedulingPlanSummary): object;
    function getDeserializedJsonObj(obj: SchedulingPlanSummary): object;
}

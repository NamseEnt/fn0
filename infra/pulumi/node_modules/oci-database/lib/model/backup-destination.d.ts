...
export declare namespace BackupDestination {
    enum Type {
        Nfs = "NFS",
    ...
    function getJsonObj(obj: BackupDestination): object;
    function getDeserializedJsonObj(obj: BackupDestination): object;
}

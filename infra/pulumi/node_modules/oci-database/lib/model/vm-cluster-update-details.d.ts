...
export declare namespace VmClusterUpdateDetails {
    enum UpdateAction {
        RollingApply = "ROLLING_APPLY",
        Precheck = "PRECHECK",
        Rollback = "ROLLBACK"
    }
    function getJsonObj(obj: VmClusterUpdateDetails): object;
    function getDeserializedJsonObj(obj: VmClusterUpdateDetails): object;
}

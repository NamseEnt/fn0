...
export declare namespace AutonomousExadataInfrastructure {
    enum LifecycleState {
    ...
    function getJsonObj(obj: AutonomousExadataInfrastructure): object;
    function getDeserializedJsonObj(obj: AutonomousExadataInfrastructure): object;
}

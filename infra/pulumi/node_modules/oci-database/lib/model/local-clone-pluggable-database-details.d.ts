...
export declare namespace LocalClonePluggableDatabaseDetails {
    function getJsonObj(obj: LocalClonePluggableDatabaseDetails): object;
    function getDeserializedJsonObj(obj: LocalClonePluggableDatabaseDetails): object;
}

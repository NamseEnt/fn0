...
export declare namespace ExecutionActionSummary {
    enum LifecycleState {
        Scheduled = "SCHEDULED",
    ...
    function getJsonObj(obj: ExecutionActionSummary): object;
    function getDeserializedJsonObj(obj: ExecutionActionSummary): object;
}

...
export declare namespace DbSystemUpgradeSummary {
    enum Component {
        Os = "OS",
        OsGi = "OS_GI",
        Gi = "GI",
    ...
    function getJsonObj(obj: DbSystemUpgradeSummary): object;
    function getDeserializedJsonObj(obj: DbSystemUpgradeSummary): object;
}

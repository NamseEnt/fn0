...
export declare namespace AutonomousDatabaseConnectionUrls {
    function getJsonObj(obj: AutonomousDatabaseConnectionUrls): object;
    function getDeserializedJsonObj(obj: AutonomousDatabaseConnectionUrls): object;
}

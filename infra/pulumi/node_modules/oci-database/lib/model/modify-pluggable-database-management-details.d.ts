 ...
 *
 */
export interface ModifyPluggableDatabaseManagementDetails {
     ...
     */
    "protocol"?: ModifyPluggableDatabaseManagementDetails.Protocol;
    /**
     ...
     */
    "role"?: ModifyPluggableDatabaseManagementDetails.Role;
}
export declare namespace ModifyPluggableDatabaseManagementDetails {
    enum Protocol {
        Tcp = "TCP",
        Tcps = "TCPS"
    }
    ...
    function getJsonObj(obj: ModifyPluggableDatabaseManagementDetails): object;
    function getDeserializedJsonObj(obj: ModifyPluggableDatabaseManagementDetails): object;
}

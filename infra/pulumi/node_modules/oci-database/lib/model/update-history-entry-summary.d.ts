...
export declare namespace UpdateHistoryEntrySummary {
    enum UpdateAction {
    ...
    function getJsonObj(obj: UpdateHistoryEntrySummary): object;
    function getDeserializedJsonObj(obj: UpdateHistoryEntrySummary): object;
}

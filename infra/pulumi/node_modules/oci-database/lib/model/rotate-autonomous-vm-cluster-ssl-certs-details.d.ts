...
export declare namespace RotateAutonomousVmClusterSslCertsDetails {
    enum CertificateGenerationType {
        System = "SYSTEM",
        Byoc = "BYOC"
    }
    function getJsonObj(obj: RotateAutonomousVmClusterSslCertsDetails): object;
    function getDeserializedJsonObj(obj: RotateAutonomousVmClusterSslCertsDetails): object;
}

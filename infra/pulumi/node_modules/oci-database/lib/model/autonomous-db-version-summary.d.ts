...
export declare namespace AutonomousDbVersionSummary {
    enum DbWorkload {
        Oltp = "OLTP",
        Dw = "DW",
        Ajd = "AJD",
    ...
    function getJsonObj(obj: AutonomousDbVersionSummary): object;
    function getDeserializedJsonObj(obj: AutonomousDbVersionSummary): object;
}

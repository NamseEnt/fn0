...
export declare namespace ExadataInfrastructureSummary {
    enum LifecycleState {
        Creating = "CREATING",
    ...
    function getJsonObj(obj: ExadataInfrastructureSummary): object;
    function getDeserializedJsonObj(obj: ExadataInfrastructureSummary): object;
}

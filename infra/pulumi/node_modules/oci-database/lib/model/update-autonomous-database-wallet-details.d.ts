...
export declare namespace UpdateAutonomousDatabaseWalletDetails {
    function getJsonObj(obj: UpdateAutonomousDatabaseWalletDetails): object;
    function getDeserializedJsonObj(obj: UpdateAutonomousDatabaseWalletDetails): object;
}

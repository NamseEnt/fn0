...
export declare namespace AutonomousContainerDatabaseBackupConfig {
    function getJsonObj(obj: AutonomousContainerDatabaseBackupConfig): object;
    function getDeserializedJsonObj(obj: AutonomousContainerDatabaseBackupConfig): object;
}

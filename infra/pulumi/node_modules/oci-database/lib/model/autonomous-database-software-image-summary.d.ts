...
export declare namespace AutonomousDatabaseSoftwareImageSummary {
    function getJsonObj(obj: AutonomousDatabaseSoftwareImageSummary): object;
    function getDeserializedJsonObj(obj: AutonomousDatabaseSoftwareImageSummary): object;
}

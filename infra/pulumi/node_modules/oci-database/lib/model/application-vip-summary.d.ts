...
export declare namespace ApplicationVipSummary {
    enum LifecycleState {
    ...
    function getJsonObj(obj: ApplicationVipSummary): object;
    function getDeserializedJsonObj(obj: ApplicationVipSummary): object;
}

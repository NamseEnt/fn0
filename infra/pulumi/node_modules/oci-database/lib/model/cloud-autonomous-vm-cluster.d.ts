...
export declare namespace CloudAutonomousVmCluster {
    enum LifecycleState {
    ...
    function getJsonObj(obj: CloudAutonomousVmCluster): object;
    function getDeserializedJsonObj(obj: CloudAutonomousVmCluster): object;
}

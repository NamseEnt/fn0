...
export declare namespace CreateCloudVmClusterDetails {
    enum LicenseModel {
    ...
    function getJsonObj(obj: CreateCloudVmClusterDetails): object;
    function getDeserializedJsonObj(obj: CreateCloudVmClusterDetails): object;
}

...
export declare namespace PatchHistoryEntry {
    enum Action {
        Apply = "APPLY",
        Precheck = "PRECHECK",
        /**
    ...
    function getJsonObj(obj: PatchHistoryEntry): object;
    function getDeserializedJsonObj(obj: PatchHistoryEntry): object;
}

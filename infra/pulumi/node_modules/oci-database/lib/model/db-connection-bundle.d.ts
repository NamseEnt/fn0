...
export declare namespace DbConnectionBundle {
    enum LifecycleState {
        Creating = "CREATING",
        Active = "ACTIVE",
        Inactive = "INACTIVE",
    ...
    function getJsonObj(obj: DbConnectionBundle): object;
    function getDeserializedJsonObj(obj: DbConnectionBundle): object;
}

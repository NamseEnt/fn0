...
export declare namespace AutonomousVmClusterResourceUsage {
    function getJsonObj(obj: AutonomousVmClusterResourceUsage): object;
    function getDeserializedJsonObj(obj: AutonomousVmClusterResourceUsage): object;
}

...
export declare namespace CreateDbHomeFromDbSystemDetails {
    function getJsonObj(obj: CreateDbHomeFromDbSystemDetails): object;
    function getDeserializedJsonObj(obj: CreateDbHomeFromDbSystemDetails): object;
}

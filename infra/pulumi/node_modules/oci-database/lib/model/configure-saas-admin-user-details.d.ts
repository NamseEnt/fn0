...
export declare namespace ConfigureSaasAdminUserDetails {
    enum AccessType {
        ReadOnly = "READ_ONLY",
        ReadWrite = "READ_WRITE",
        Admin = "ADMIN"
    }
    function getJsonObj(obj: ConfigureSaasAdminUserDetails): object;
    function getDeserializedJsonObj(obj: ConfigureSaasAdminUserDetails): object;
}

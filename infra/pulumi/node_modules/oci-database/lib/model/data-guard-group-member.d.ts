...
export declare namespace DataGuardGroupMember {
    enum Role {
        Primary = "PRIMARY",
        Standby = "STANDBY",
    ...
    function getJsonObj(obj: DataGuardGroupMember): object;
    function getDeserializedJsonObj(obj: DataGuardGroupMember): object;
}

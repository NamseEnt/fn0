...
export declare namespace ExascaleConfigDetails {
    function getJsonObj(obj: ExascaleConfigDetails): object;
    function getDeserializedJsonObj(obj: ExascaleConfigDetails): object;
}

...
export declare namespace ExadataDbSystemMigration {
    function getJsonObj(obj: ExadataDbSystemMigration): object;
    function getDeserializedJsonObj(obj: ExadataDbSystemMigration): object;
}

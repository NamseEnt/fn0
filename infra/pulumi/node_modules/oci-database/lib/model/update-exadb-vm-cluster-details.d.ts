...
export declare namespace UpdateExadbVmClusterDetails {
    enum LicenseModel {
    ...
    function getJsonObj(obj: UpdateExadbVmClusterDetails): object;
    function getDeserializedJsonObj(obj: UpdateExadbVmClusterDetails): object;
}

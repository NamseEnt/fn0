...
export declare namespace ConsoleConnectionSummary {
    enum LifecycleState {
        Active = "ACTIVE",
        Creating = "CREATING",
        Deleted = "DELETED",
    ...
    function getJsonObj(obj: ConsoleConnectionSummary): object;
    function getDeserializedJsonObj(obj: ConsoleConnectionSummary): object;
}

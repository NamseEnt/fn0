...
export declare namespace PluggableDatabaseSnapshot {
    enum LifecycleState {
        Creating = "CREATING",
        Available = "AVAILABLE",
    ...
    function getJsonObj(obj: PluggableDatabaseSnapshot): object;
    function getDeserializedJsonObj(obj: PluggableDatabaseSnapshot): object;
}

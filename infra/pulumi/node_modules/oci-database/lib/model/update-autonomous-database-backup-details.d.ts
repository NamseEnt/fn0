 ...
 *
 */
export interface UpdateAutonomousDatabaseBackupDetails {
    /**
...
export declare namespace UpdateAutonomousDatabaseBackupDetails {
    function getJsonObj(obj: UpdateAutonomousDatabaseBackupDetails): object;
    function getDeserializedJsonObj(obj: UpdateAutonomousDatabaseBackupDetails): object;
}

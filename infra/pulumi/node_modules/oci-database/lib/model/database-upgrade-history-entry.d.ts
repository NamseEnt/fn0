...
export interface DatabaseUpgradeHistoryEntry {
     ...
     */
    "action": DatabaseUpgradeHistoryEntry.Action;
    /**
     ...
     */
    "lifecycleState": DatabaseUpgradeHistoryEntry.LifecycleState;
    /**
...
export declare namespace DatabaseUpgradeHistoryEntry {
    enum Action {
        Precheck = "PRECHECK",
        Upgrade = "UPGRADE",
        Rollback = "ROLLBACK",
    ...
    function getJsonObj(obj: DatabaseUpgradeHistoryEntry): object;
    function getDeserializedJsonObj(obj: DatabaseUpgradeHistoryEntry): object;
}

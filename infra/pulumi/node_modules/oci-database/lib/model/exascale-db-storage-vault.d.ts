...
export declare namespace ExascaleDbStorageVault {
    enum LifecycleState {
    ...
    function getJsonObj(obj: ExascaleDbStorageVault): object;
    function getDeserializedJsonObj(obj: ExascaleDbStorageVault): object;
}

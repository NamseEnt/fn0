...
export declare namespace BackupDestinationSummary {
    enum Type {
        Nfs = "NFS",
    ...
    function getJsonObj(obj: BackupDestinationSummary): object;
    function getDeserializedJsonObj(obj: BackupDestinationSummary): object;
}

...
export declare namespace ExternalDatabaseConnectorSummary {
    function getJsonObj(obj: ExternalDatabaseConnectorSummary): object;
    function getDeserializedJsonObj(obj: ExternalDatabaseConnectorSummary): object;
}

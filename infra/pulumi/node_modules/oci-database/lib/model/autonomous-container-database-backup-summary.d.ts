...
export declare namespace AutonomousContainerDatabaseBackupSummary {
    enum Type {
    ...
    function getJsonObj(obj: AutonomousContainerDatabaseBackupSummary): object;
    function getDeserializedJsonObj(obj: AutonomousContainerDatabaseBackupSummary): object;
}

...
export declare namespace ResourcePoolMemberSummary {
    function getJsonObj(obj: ResourcePoolMemberSummary): object;
    function getDeserializedJsonObj(obj: ResourcePoolMemberSummary): object;
}

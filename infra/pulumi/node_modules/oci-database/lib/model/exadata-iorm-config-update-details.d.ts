...
export declare namespace ExadataIormConfigUpdateDetails {
    enum Objective {
    ...
    function getJsonObj(obj: ExadataIormConfigUpdateDetails): object;
    function getDeserializedJsonObj(obj: ExadataIormConfigUpdateDetails): object;
}

...
export declare namespace RotateCloudAutonomousVmClusterSslCertsDetails {
    enum CertificateGenerationType {
        System = "SYSTEM",
        Byoc = "BYOC"
    }
    function getJsonObj(obj: RotateCloudAutonomousVmClusterSslCertsDetails): object;
    function getDeserializedJsonObj(obj: RotateCloudAutonomousVmClusterSslCertsDetails): object;
}

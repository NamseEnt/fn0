...
export declare namespace CreateAutonomousDatabaseBase {
    enum ComputeModel {
        Ecpu = "ECPU",
        Ocpu = "OCPU"
    }
    ...
    function getJsonObj(obj: CreateAutonomousDatabaseBase): object;
    function getDeserializedJsonObj(obj: CreateAutonomousDatabaseBase): object;
}

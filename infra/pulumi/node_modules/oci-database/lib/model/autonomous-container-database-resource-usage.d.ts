...
export declare namespace AutonomousContainerDatabaseResourceUsage {
    function getJsonObj(obj: AutonomousContainerDatabaseResourceUsage): object;
    function getDeserializedJsonObj(obj: AutonomousContainerDatabaseResourceUsage): object;
}

...
export declare namespace CreateNFSBackupDestinationDetails {
    function getJsonObj(obj: CreateNFSBackupDestinationDetails, isParentJsonObj?: boolean): object;
    const type = "NFS";
    function getDeserializedJsonObj(obj: CreateNFSBackupDestinationDetails, isParentJsonObj?: boolean): object;
}

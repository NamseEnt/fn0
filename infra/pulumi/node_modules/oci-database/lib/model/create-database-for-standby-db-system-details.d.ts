...
export declare namespace CreateDatabaseForStandbyDbSystemDetails {
    enum ProtectionMode {
    ...
    function getJsonObj(obj: CreateDatabaseForStandbyDbSystemDetails): object;
    function getDeserializedJsonObj(obj: CreateDatabaseForStandbyDbSystemDetails): object;
}

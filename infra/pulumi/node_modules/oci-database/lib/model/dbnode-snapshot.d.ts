...
export interface DbnodeSnapshot {
     ...
     */
    "lifecycleState"?: DbnodeSnapshot.LifecycleState;
    /**
...
export declare namespace DbnodeSnapshot {
    enum LifecycleState {
        Creating = "CREATING",
        Available = "AVAILABLE",
    ...
    function getJsonObj(obj: DbnodeSnapshot): object;
    function getDeserializedJsonObj(obj: DbnodeSnapshot): object;
}

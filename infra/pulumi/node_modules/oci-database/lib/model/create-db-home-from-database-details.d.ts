 ...
 *
 */
export interface CreateDbHomeFromDatabaseDetails {
    /**
...
export declare namespace CreateDbHomeFromDatabaseDetails {
    function getJsonObj(obj: CreateDbHomeFromDatabaseDetails): object;
    function getDeserializedJsonObj(obj: CreateDbHomeFromDatabaseDetails): object;
}

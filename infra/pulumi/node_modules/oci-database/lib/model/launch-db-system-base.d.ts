...
export declare namespace LaunchDbSystemBase {
    ...
    function getJsonObj(obj: LaunchDbSystemBase): object;
    function getDeserializedJsonObj(obj: LaunchDbSystemBase): object;
}

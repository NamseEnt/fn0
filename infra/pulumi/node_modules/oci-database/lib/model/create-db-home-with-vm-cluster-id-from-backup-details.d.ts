...
export declare namespace CreateDbHomeWithVmClusterIdFromBackupDetails {
    function getJsonObj(obj: CreateDbHomeWithVmClusterIdFromBackupDetails, isParentJsonObj?: boolean): object;
    const source = "VM_CLUSTER_BACKUP";
    function getDeserializedJsonObj(obj: CreateDbHomeWithVmClusterIdFromBackupDetails, isParentJsonObj?: boolean): object;
}

 ...
 *
 */
export interface VmClusterUpdateHistoryEntrySummary {
    /**
     ...
     */
    "lifecycleState": VmClusterUpdateHistoryEntrySummary.LifecycleState;
    /**
...
export declare namespace VmClusterUpdateHistoryEntrySummary {
    enum UpdateAction {
    ...
    function getJsonObj(obj: VmClusterUpdateHistoryEntrySummary): object;
    function getDeserializedJsonObj(obj: VmClusterUpdateHistoryEntrySummary): object;
}

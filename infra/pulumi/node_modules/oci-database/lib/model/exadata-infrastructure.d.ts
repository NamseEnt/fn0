...
export interface ExadataInfrastructure {
  ...
  *
     ...
     */
    "computeModel"?: ExadataInfrastructure.ComputeModel;
}
export declare namespace ExadataInfrastructure {
    enum LifecycleState {
        Creating = "CREATING",
    ...
    enum AdditionalComputeSystemModel {
        X7 = "X7",
        X8 = "X8",
        X8M = "X8M",
        X9M = "X9M",
    ...
    function getJsonObj(obj: ExadataInfrastructure): object;
    function getDeserializedJsonObj(obj: ExadataInfrastructure): object;
}

...
export declare namespace UpdateCloudAutonomousVmClusterDetails {
    enum LicenseModel {
        LicenseIncluded = "LICENSE_INCLUDED",
        BringYourOwnLicense = "BRING_YOUR_OWN_LICENSE"
    }
    function getJsonObj(obj: UpdateCloudAutonomousVmClusterDetails): object;
    function getDeserializedJsonObj(obj: UpdateCloudAutonomousVmClusterDetails): object;
}

...
export declare namespace UpdateHistoryEntry {
    enum UpdateAction {
    ...
    function getJsonObj(obj: UpdateHistoryEntry): object;
    function getDeserializedJsonObj(obj: UpdateHistoryEntry): object;
}

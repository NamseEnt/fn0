...
export declare namespace EstimatedPatchingTime {
    function getJsonObj(obj: EstimatedPatchingTime): object;
    function getDeserializedJsonObj(obj: EstimatedPatchingTime): object;
}

...
export declare namespace ExternalNonContainerDatabase {
    enum LifecycleState {
    ...
    function getJsonObj(obj: ExternalNonContainerDatabase): object;
    function getDeserializedJsonObj(obj: ExternalNonContainerDatabase): object;
}

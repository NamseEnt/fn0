...
export declare namespace CreateAutonomousVmClusterDetails {
    enum LicenseModel {
    ...
    function getJsonObj(obj: CreateAutonomousVmClusterDetails): object;
    function getDeserializedJsonObj(obj: CreateAutonomousVmClusterDetails): object;
}

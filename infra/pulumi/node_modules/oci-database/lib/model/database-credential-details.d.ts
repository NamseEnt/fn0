...
export declare namespace DatabaseCredentialDetails {
    function getJsonObj(obj: DatabaseCredentialDetails): object;
    function getDeserializedJsonObj(obj: DatabaseCredentialDetails): object;
}

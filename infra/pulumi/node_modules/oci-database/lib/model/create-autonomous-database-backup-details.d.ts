...
export declare namespace CreateAutonomousDatabaseBackupDetails {
    function getJsonObj(obj: CreateAutonomousDatabaseBackupDetails): object;
    function getDeserializedJsonObj(obj: CreateAutonomousDatabaseBackupDetails): object;
}

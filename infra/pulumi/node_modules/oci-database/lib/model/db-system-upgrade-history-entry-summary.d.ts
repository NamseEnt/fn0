...
export declare namespace DbSystemUpgradeHistoryEntrySummary {
    enum Action {
        Precheck = "PRECHECK",
        Rollback = "ROLLBACK",
    ...
    function getJsonObj(obj: DbSystemUpgradeHistoryEntrySummary): object;
    function getDeserializedJsonObj(obj: DbSystemUpgradeHistoryEntrySummary): object;
}

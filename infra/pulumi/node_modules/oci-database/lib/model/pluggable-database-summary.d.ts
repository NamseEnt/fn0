...
export declare namespace PluggableDatabaseSummary {
    enum LifecycleState {
    ...
    function getJsonObj(obj: PluggableDatabaseSummary): object;
    function getDeserializedJsonObj(obj: PluggableDatabaseSummary): object;
}

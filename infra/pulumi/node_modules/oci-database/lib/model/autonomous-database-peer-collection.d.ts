...
export declare namespace AutonomousDatabasePeerCollection {
    function getJsonObj(obj: AutonomousDatabasePeerCollection): object;
    function getDeserializedJsonObj(obj: AutonomousDatabasePeerCollection): object;
}

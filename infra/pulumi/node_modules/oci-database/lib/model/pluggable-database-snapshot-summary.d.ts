...
export declare namespace PluggableDatabaseSnapshotSummary {
    function getJsonObj(obj: PluggableDatabaseSnapshotSummary): object;
    function getDeserializedJsonObj(obj: PluggableDatabaseSnapshotSummary): object;
}

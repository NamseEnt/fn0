...
export declare namespace ChangeKeyStoreTypeDetails {
    function getJsonObj(obj: ChangeKeyStoreTypeDetails): object;
    function getDeserializedJsonObj(obj: ChangeKeyStoreTypeDetails): object;
}

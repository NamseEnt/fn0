 ...
 *
 */
export interface CreateDbHomeDetails {
    /**
...
export declare namespace CreateDbHomeDetails {
    function getJsonObj(obj: CreateDbHomeDetails): object;
    function getDeserializedJsonObj(obj: CreateDbHomeDetails): object;
}

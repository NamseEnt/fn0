...
export declare namespace AutonomousDatabaseConsoleTokenDetails {
    function getJsonObj(obj: AutonomousDatabaseConsoleTokenDetails): object;
    function getDeserializedJsonObj(obj: AutonomousDatabaseConsoleTokenDetails): object;
}

...
export declare namespace AdvancedClusterFileSystem {
    enum LifecycleState {
        Available = "AVAILABLE",
        Creating = "CREATING",
        Failed = "FAILED",
    ...
    function getJsonObj(obj: AdvancedClusterFileSystem): object;
    function getDeserializedJsonObj(obj: AdvancedClusterFileSystem): object;
}

 ...
 *
 */
export interface VmClusterUpdateHistoryEntry {
    /**
     ...
     */
    "updateAction"?: VmClusterUpdateHistoryEntry.UpdateAction;
    /**
     * The type of VM cluster maintenance update.
     */
    "updateType": VmClusterUpdateHistoryEntry.UpdateType;
    /**
     * The current lifecycle state of the maintenance update operation.
     */
    "lifecycleState": VmClusterUpdateHistoryEntry.LifecycleState;
    /**
...
export declare namespace VmClusterUpdateHistoryEntry {
    enum UpdateAction {
    ...
    function getJsonObj(obj: VmClusterUpdateHistoryEntry): object;
    function getDeserializedJsonObj(obj: VmClusterUpdateHistoryEntry): object;
}

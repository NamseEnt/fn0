...
export declare namespace CreateSchedulingPlanDetails {
    enum ServiceType {
        Exacc = "EXACC",
        Exacs = "EXACS",
        Fpppcs = "FPPPCS"
    }
    function getJsonObj(obj: CreateSchedulingPlanDetails): object;
    function getDeserializedJsonObj(obj: CreateSchedulingPlanDetails): object;
}

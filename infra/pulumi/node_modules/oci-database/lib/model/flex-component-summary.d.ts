...
export declare namespace FlexComponentSummary {
    enum HardwareType {
        Compute = "COMPUTE",
        Cell = "CELL",
        /**
    ...
    function getJsonObj(obj: FlexComponentSummary): object;
    function getDeserializedJsonObj(obj: FlexComponentSummary): object;
}

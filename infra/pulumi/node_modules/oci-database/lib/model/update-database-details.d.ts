...
export declare namespace UpdateDatabaseDetails {
    function getJsonObj(obj: UpdateDatabaseDetails): object;
    function getDeserializedJsonObj(obj: UpdateDatabaseDetails): object;
}

...
export declare namespace PdbConversionHistoryEntry {
    enum Action {
        Precheck = "PRECHECK",
        Convert = "CONVERT",
        Sync = "SYNC",
    ...
    function getJsonObj(obj: PdbConversionHistoryEntry): object;
    function getDeserializedJsonObj(obj: PdbConversionHistoryEntry): object;
}

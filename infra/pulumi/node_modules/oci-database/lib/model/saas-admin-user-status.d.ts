...
export declare namespace SaasAdminUserStatus {
    enum AccessType {
        ReadOnly = "READ_ONLY",
    ...
    function getJsonObj(obj: SaasAdminUserStatus): object;
    function getDeserializedJsonObj(obj: SaasAdminUserStatus): object;
}

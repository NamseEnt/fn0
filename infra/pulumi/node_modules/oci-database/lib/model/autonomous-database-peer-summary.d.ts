...
export declare namespace AutonomousDatabasePeerSummary {
    function getJsonObj(obj: AutonomousDatabasePeerSummary): object;
    function getDeserializedJsonObj(obj: AutonomousDatabasePeerSummary): object;
}

 ...
 *
 */
export interface CreateAutonomousDatabaseFromBackupTimestampDetails extends model.CreateAutonomousDatabaseBase {
    /**
...
export declare namespace CreateAutonomousDatabaseFromBackupTimestampDetails {
    enum CloneType {
        Full = "FULL",
        Metadata = "METADATA",
        Partial = "PARTIAL"
    }
    function getJsonObj(obj: CreateAutonomousDatabaseFromBackupTimestampDetails, isParentJsonObj?: boolean): object;
    const source = "BACKUP_FROM_TIMESTAMP";
    function getDeserializedJsonObj(obj: CreateAutonomousDatabaseFromBackupTimestampDetails, isParentJsonObj?: boolean): object;
}

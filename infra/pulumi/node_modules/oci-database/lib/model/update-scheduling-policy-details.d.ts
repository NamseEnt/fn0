...
export declare namespace UpdateSchedulingPolicyDetails {
    enum Cadence {
        Halfyearly = "HALFYEARLY",
        Quarterly = "QUARTERLY",
        Monthly = "MONTHLY"
    }
    function getJsonObj(obj: UpdateSchedulingPolicyDetails): object;
    function getDeserializedJsonObj(obj: UpdateSchedulingPolicyDetails): object;
}

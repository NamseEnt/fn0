 ...
 */
export interface BackupDestinationConfigurationSummary {
    /**
     * Number of days between the current and earliest point of recoverability covered by automatic backups and manual backups, but not long term backups. Note: Numbers greater than Number.MAX_SAFE_INTEGER will result in rounding issues.
     */
     ...
     */
    "type": BackupDestinationConfigurationSummary.Type;
    /**
     ...
     *
     */
    "backupRetentionPolicyOnTerminate"?: BackupDestinationConfigurationSummary.BackupRetentionPolicyOnTerminate;
    /**
...
export declare namespace BackupDestinationConfigurationSummary {
    enum Type {
        Nfs = "NFS",
    ...
    enum BackupRetentionPolicyOnTerminate {
    ...
    function getJsonObj(obj: BackupDestinationConfigurationSummary): object;

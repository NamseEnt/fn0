...
export declare namespace ConvertToRegularPluggableDatabaseDetails {
    function getJsonObj(obj: ConvertToRegularPluggableDatabaseDetails): object;
    function getDeserializedJsonObj(obj: ConvertToRegularPluggableDatabaseDetails): object;
}

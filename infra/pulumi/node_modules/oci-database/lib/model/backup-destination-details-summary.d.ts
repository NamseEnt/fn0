...
export declare namespace BackupDestinationDetailsSummary {
    enum Type {
        Nfs = "NFS",
    ...
    function getJsonObj(obj: BackupDestinationDetailsSummary): object;
    function getDeserializedJsonObj(obj: BackupDestinationDetailsSummary): object;
}

...
export declare namespace ConfigureAutonomousDatabaseVaultKeyDetails {
    function getJsonObj(obj: ConfigureAutonomousDatabaseVaultKeyDetails): object;
    function getDeserializedJsonObj(obj: ConfigureAutonomousDatabaseVaultKeyDetails): object;
}

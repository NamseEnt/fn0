...
export declare namespace DbIormConfigUpdateDetail {
    function getJsonObj(obj: DbIormConfigUpdateDetail): object;
    function getDeserializedJsonObj(obj: DbIormConfigUpdateDetail): object;
}

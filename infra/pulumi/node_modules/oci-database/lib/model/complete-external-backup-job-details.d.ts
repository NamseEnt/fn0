...
export declare namespace CompleteExternalBackupJobDetails {
    function getJsonObj(obj: CompleteExternalBackupJobDetails): object;
    function getDeserializedJsonObj(obj: CompleteExternalBackupJobDetails): object;
}

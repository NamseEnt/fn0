...
export declare namespace AutonomousVmResourceUsage {
    function getJsonObj(obj: AutonomousVmResourceUsage): object;
    function getDeserializedJsonObj(obj: AutonomousVmResourceUsage): object;
}

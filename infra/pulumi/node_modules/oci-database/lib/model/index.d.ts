...
import * as ChangeDbConnectionBundleCompartmentDetails from "./change-db-connection-bundle-compartment-details";
export import ChangeDbConnectionBundleCompartmentDetails = ChangeDbConnectionBundleCompartmentDetails.ChangeDbConnectionBundleCompartmentDetails;
...
import * as CreateDatabaseForStandbyDbSystemDetails from "./create-database-for-standby-db-system-details";
export import CreateDatabaseForStandbyDbSystemDetails = CreateDatabaseForStandbyDbSystemDetails.CreateDatabaseForStandbyDbSystemDetails;
...
import * as CreateDbConnectionBundleDetails from "./create-db-connection-bundle-details";
export import CreateDbConnectionBundleDetails = CreateDbConnectionBundleDetails.CreateDbConnectionBundleDetails;
...
import * as CreateDbHomeForStandbyDbSystem from "./create-db-home-for-standby-db-system";
export import CreateDbHomeForStandbyDbSystem = CreateDbHomeForStandbyDbSystem.CreateDbHomeForStandbyDbSystem;
...
import * as DataPatchOptions from "./data-patch-options";
export import DataPatchOptions = DataPatchOptions.DataPatchOptions;
...
import * as DbConnectionBundle from "./db-connection-bundle";
export import DbConnectionBundle = DbConnectionBundle.DbConnectionBundle;
import * as DbConnectionBundleSummary from "./db-connection-bundle-summary";
export import DbConnectionBundleSummary = DbConnectionBundleSummary.DbConnectionBundleSummary;
...
import * as DbSystemOsPatchDetailsCollection from "./db-system-os-patch-details-collection";
export import DbSystemOsPatchDetailsCollection = DbSystemOsPatchDetailsCollection.DbSystemOsPatchDetailsCollection;
import * as DbSystemOsPatchDetailsSummary from "./db-system-os-patch-details-summary";
export import DbSystemOsPatchDetailsSummary = DbSystemOsPatchDetailsSummary.DbSystemOsPatchDetailsSummary;
import * as DbSystemOsPatchHistoryEntry from "./db-system-os-patch-history-entry";
export import DbSystemOsPatchHistoryEntry = DbSystemOsPatchHistoryEntry.DbSystemOsPatchHistoryEntry;
import * as DbSystemOsPatchHistoryEntryCollection from "./db-system-os-patch-history-entry-collection";
export import DbSystemOsPatchHistoryEntryCollection = DbSystemOsPatchHistoryEntryCollection.DbSystemOsPatchHistoryEntryCollection;
import * as DbSystemOsPatchHistoryEntrySummary from "./db-system-os-patch-history-entry-summary";
export import DbSystemOsPatchHistoryEntrySummary = DbSystemOsPatchHistoryEntrySummary.DbSystemOsPatchHistoryEntrySummary;
...
import * as DownloadDbConnectionBundleDetails from "./download-db-connection-bundle-details";
export import DownloadDbConnectionBundleDetails = DownloadDbConnectionBundleDetails.DownloadDbConnectionBundleDetails;
...
import * as ExecuteDbSystemOsPatchDetails from "./execute-db-system-os-patch-details";
export import ExecuteDbSystemOsPatchDetails = ExecuteDbSystemOsPatchDetails.ExecuteDbSystemOsPatchDetails;
...
import * as ImportTransportableTablespaceDetails from "./import-transportable-tablespace-details";
export import ImportTransportableTablespaceDetails = ImportTransportableTablespaceDetails.ImportTransportableTablespaceDetails;
...
import * as PatchOptions from "./patch-options";
export import PatchOptions = PatchOptions.PatchOptions;
...
import * as RegisterCloudAutonomousVmClusterPkcsDetails from "./register-cloud-autonomous-vm-cluster-pkcs-details";
export import RegisterCloudAutonomousVmClusterPkcsDetails = RegisterCloudAutonomousVmClusterPkcsDetails.RegisterCloudAutonomousVmClusterPkcsDetails;
...
import * as RunDataPatchDetails from "./run-data-patch-details";
export import RunDataPatchDetails = RunDataPatchDetails.RunDataPatchDetails;
...
export import UnregisterCloudAutonomousVmClusterPkcsDetails = UnregisterCloudAutonomousVmClusterPkcsDetails.UnregisterCloudAutonomousVmClusterPkcsDetails;
...
import * as UpdateDbConnectionBundleDetails from "./update-db-connection-bundle-details";
export import UpdateDbConnectionBundleDetails = UpdateDbConnectionBundleDetails.UpdateDbConnectionBundleDetails;
...
import * as CreateDatabaseFromDatabase from "./create-database-from-database";
export import CreateDatabaseFromDatabase = CreateDatabaseFromDatabase.CreateDatabaseFromDatabase;
...
import * as CreateDbHomeWithVmClusterIdFromDatabaseDetails from "./create-db-home-with-vm-cluster-id-from-database-details";
export import CreateDbHomeWithVmClusterIdFromDatabaseDetails = CreateDbHomeWithVmClusterIdFromDatabaseDetails.CreateDbHomeWithVmClusterIdFromDatabaseDetails;
...
import * as LaunchStandbyDbSystemDetails from "./launch-standby-db-system-details";
export import LaunchStandbyDbSystemDetails = LaunchStandbyDbSystemDetails.LaunchStandbyDbSystemDetails;

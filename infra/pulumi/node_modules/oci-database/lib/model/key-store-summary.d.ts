...
export interface KeyStoreSummary {
     ...
     */
    "lifecycleState": KeyStoreSummary.LifecycleState;
    /**
...
export declare namespace KeyStoreSummary {
    enum LifecycleState {
        Active = "ACTIVE",
        Deleted = "DELETED",
    ...
    function getJsonObj(obj: KeyStoreSummary): object;
    function getDeserializedJsonObj(obj: KeyStoreSummary): object;
}

 ...
 *
 */
export interface RotateCloudAutonomousVmClusterOrdsCertsDetails {
    /**
     * Specify SYSTEM to use Oracle-managed certificates. Specify BYOC when you want to bring your own certificate.
     */
    "certificateGenerationType": RotateCloudAutonomousVmClusterOrdsCertsDetails.CertificateGenerationType;
    /**
...
export declare namespace RotateCloudAutonomousVmClusterOrdsCertsDetails {
    enum CertificateGenerationType {
        System = "SYSTEM",
        Byoc = "BYOC"
    }
    function getJsonObj(obj: RotateCloudAutonomousVmClusterOrdsCertsDetails): object;
    function getDeserializedJsonObj(obj: RotateCloudAutonomousVmClusterOrdsCertsDetails): object;
}

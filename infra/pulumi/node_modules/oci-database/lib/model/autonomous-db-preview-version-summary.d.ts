...
export declare namespace AutonomousDbPreviewVersionSummary {
    enum DbWorkload {
        Oltp = "OLTP",
        Dw = "DW",
        Ajd = "AJD",
    ...
    function getJsonObj(obj: AutonomousDbPreviewVersionSummary): object;
    function getDeserializedJsonObj(obj: AutonomousDbPreviewVersionSummary): object;
}

...
export declare namespace RemoteClonePluggableDatabaseDetails {
    function getJsonObj(obj: RemoteClonePluggableDatabaseDetails): object;
    function getDeserializedJsonObj(obj: RemoteClonePluggableDatabaseDetails): object;
}

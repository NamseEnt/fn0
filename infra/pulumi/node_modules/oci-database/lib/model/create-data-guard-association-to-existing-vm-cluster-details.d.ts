 ...
 *
 */
export interface CreateDataGuardAssociationToExistingVmClusterDetails extends model.CreateDataGuardAssociationDetails {
    /**
...
export declare namespace CreateDataGuardAssociationToExistingVmClusterDetails {
    function getJsonObj(obj: CreateDataGuardAssociationToExistingVmClusterDetails, isParentJsonObj?: boolean): object;
    const creationType = "ExistingVmCluster";
    function getDeserializedJsonObj(obj: CreateDataGuardAssociationToExistingVmClusterDetails, isParentJsonObj?: boolean): object;
}

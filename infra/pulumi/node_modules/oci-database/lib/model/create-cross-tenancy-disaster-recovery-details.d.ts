 ...
 *
 */
export interface CreateCrossTenancyDisasterRecoveryDetails extends model.CreateAutonomousDatabaseBase {
    /**
...
export declare namespace CreateCrossTenancyDisasterRecoveryDetails {
    function getJsonObj(obj: CreateCrossTenancyDisasterRecoveryDetails, isParentJsonObj?: boolean): object;
    const source = "CROSS_TENANCY_DISASTER_RECOVERY";
    function getDeserializedJsonObj(obj: CreateCrossTenancyDisasterRecoveryDetails, isParentJsonObj?: boolean): object;
}

...
export declare namespace AutonomousContainerDatabaseBackup {
    enum Type {
    ...
    function getJsonObj(obj: AutonomousContainerDatabaseBackup): object;
    function getDeserializedJsonObj(obj: AutonomousContainerDatabaseBackup): object;
}

...
export declare namespace AutonomousDatabaseBackupConfig {
    enum ManualBackupType {
        None = "NONE",
    ...
    function getJsonObj(obj: AutonomousDatabaseBackupConfig): object;
    function getDeserializedJsonObj(obj: AutonomousDatabaseBackupConfig): object;
}

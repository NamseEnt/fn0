...
export declare namespace PeerAutonomousContainerDatabaseBackupConfig {
    function getJsonObj(obj: PeerAutonomousContainerDatabaseBackupConfig): object;
    function getDeserializedJsonObj(obj: PeerAutonomousContainerDatabaseBackupConfig): object;
}

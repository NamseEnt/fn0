...
export declare namespace KeyStoreTypeFromOracleKeyVaultDetails {
    function getJsonObj(obj: KeyStoreTypeFromOracleKeyVaultDetails, isParentJsonObj?: boolean): object;
    const type = "ORACLE_KEY_VAULT";
    function getDeserializedJsonObj(obj: KeyStoreTypeFromOracleKeyVaultDetails, isParentJsonObj?: boolean): object;
}

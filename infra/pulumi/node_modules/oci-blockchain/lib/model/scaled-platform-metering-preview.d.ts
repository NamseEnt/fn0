...
export declare namespace ScaledPlatformMeteringPreview {
    function getJsonObj(obj: ScaledPlatformMeteringPreview): object;
    function getDeserializedJsonObj(obj: ScaledPlatformMeteringPreview): object;
}

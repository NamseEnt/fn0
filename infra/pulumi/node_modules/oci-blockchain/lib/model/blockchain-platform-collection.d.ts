...
export declare namespace BlockchainPlatformCollection {
    function getJsonObj(obj: BlockchainPlatformCollection): object;
    function getDeserializedJsonObj(obj: BlockchainPlatformCollection): object;
}

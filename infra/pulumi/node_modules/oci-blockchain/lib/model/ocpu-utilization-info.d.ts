...
export declare namespace OcpuUtilizationInfo {
    function getJsonObj(obj: OcpuUtilizationInfo): object;
    function getDeserializedJsonObj(obj: OcpuUtilizationInfo): object;
}

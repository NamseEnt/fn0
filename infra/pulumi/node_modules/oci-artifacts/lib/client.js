...
class ArtifactsClient {
     ...
     */
    lookupContainerImageByUri(lookupContainerImageByUriRequest) {
        return __awaiter(this, void 0, void 0, function* () {
            if (this.logger)
            ...
            const apiReferenceLink = "https://docs.oracle.com/iaas/api/#/en/registry/20160918/ContainerImage/LookupContainerImageByUri";
            const pathParams = {};
            const queryParams = {};
            let headerParams = {
                "Content-Type": common.Constants.APPLICATION_JSON,
            ...
            const specRetryConfiguration = common.OciSdkDefaultRetryConfiguration;
            const retrier = oci_common_1.GenericRetrier.createPreferredRetrier(this._clientConfiguration ? this._clientConfiguration.retryConfiguration : undefined, lookupContainerImageByUriRequest.retryConfiguration, specRetryConfiguration);
            if (this.logger)
                retrier.logger = this.logger;
            const request = yield oci_common_1.composeRequest({
                baseEndpoint: this._endpoint,
                ...
                method: "POST",
                bodyContent: common.ObjectSerializer.serialize(lookupContainerImageByUriRequest.lookupContainerImageByUriDetails, "LookupContainerImageByUriDetails", model.LookupContainerImageByUriDetails.getJsonObj),
                pathParams: pathParams,
                headerParams: headerParams,
                queryParams: queryParams
            });

...
export declare class ArtifactsClient {
     ...
     */
    createWaiters(config?: common.WaiterConfiguration): ArtifactsWaiter;
    /**
     ...
     */
    lookupContainerImageByUri(lookupContainerImageByUriRequest: requests.LookupContainerImageByUriRequest): Promise<responses.LookupContainerImageByUriResponse>;
    /**

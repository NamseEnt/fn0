...
export declare namespace ContainerRepositoryReadme {
    enum Format {
    ...
    function getJsonObj(obj: ContainerRepositoryReadme): object;
    function getDeserializedJsonObj(obj: ContainerRepositoryReadme): object;
}

...
export declare namespace CreateContainerImageSignatureDetails {
    ...
    function getJsonObj(obj: CreateContainerImageSignatureDetails): object;
    function getDeserializedJsonObj(obj: CreateContainerImageSignatureDetails): object;
}

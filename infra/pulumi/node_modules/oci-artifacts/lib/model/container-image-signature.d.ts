...
export declare namespace ContainerImageSignature {
    ...
    function getJsonObj(obj: ContainerImageSignature): object;
    function getDeserializedJsonObj(obj: ContainerImageSignature): object;
}

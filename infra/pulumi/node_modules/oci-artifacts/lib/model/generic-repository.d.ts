...
export declare namespace GenericRepository {
    function getJsonObj(obj: GenericRepository, isParentJsonObj?: boolean): object;
    const repositoryType = "GENERIC";
    function getDeserializedJsonObj(obj: GenericRepository, isParentJsonObj?: boolean): object;
}

 ...
 */
export interface UpdateGenericRepositoryDetails extends model.UpdateRepositoryDetails {
    "repositoryType": string;
}
export declare namespace UpdateGenericRepositoryDetails {
    function getJsonObj(obj: UpdateGenericRepositoryDetails, isParentJsonObj?: boolean): object;
    const repositoryType = "GENERIC";
    function getDeserializedJsonObj(obj: UpdateGenericRepositoryDetails, isParentJsonObj?: boolean): object;
}

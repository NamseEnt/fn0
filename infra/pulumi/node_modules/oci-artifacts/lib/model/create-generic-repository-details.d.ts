...
export declare namespace CreateGenericRepositoryDetails {
    function getJsonObj(obj: CreateGenericRepositoryDetails, isParentJsonObj?: boolean): object;
    const repositoryType = "GENERIC";
    function getDeserializedJsonObj(obj: CreateGenericRepositoryDetails, isParentJsonObj?: boolean): object;
}

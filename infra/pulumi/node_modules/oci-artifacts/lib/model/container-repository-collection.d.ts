...
export declare namespace ContainerRepositoryCollection {
    function getJsonObj(obj: ContainerRepositoryCollection): object;
    function getDeserializedJsonObj(obj: ContainerRepositoryCollection): object;
}

...
export declare namespace ContainerRepositorySummary {
    function getJsonObj(obj: ContainerRepositorySummary): object;
    function getDeserializedJsonObj(obj: ContainerRepositorySummary): object;
}

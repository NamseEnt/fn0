...
export declare namespace GenericArtifactSummary {
    function getJsonObj(obj: GenericArtifactSummary): object;
    function getDeserializedJsonObj(obj: GenericArtifactSummary): object;
}

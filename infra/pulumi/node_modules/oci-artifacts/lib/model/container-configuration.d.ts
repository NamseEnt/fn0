...
export declare namespace ContainerConfiguration {
    function getJsonObj(obj: ContainerConfiguration): object;
    function getDeserializedJsonObj(obj: ContainerConfiguration): object;
}

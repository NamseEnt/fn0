...
export declare namespace GenericArtifactCollection {
    function getJsonObj(obj: GenericArtifactCollection): object;
    function getDeserializedJsonObj(obj: GenericArtifactCollection): object;
}

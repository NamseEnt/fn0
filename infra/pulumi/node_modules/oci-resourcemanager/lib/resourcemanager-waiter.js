...
exports.ResourceManagerWaiter = void 0;
const models = __importStar(require("./model"));
const oci_common_1 = require("oci-common");
class ResourceManagerWaiter {
     ...
     */
    forConfigurationSourceProvider(request, ...targetStates) {
        return __awaiter(this, void 0, void 0, function* () {
            return oci_common_1.genericWaiter(this.config, () => this.client.getConfigurationSourceProvider(request), response => targetStates.includes(response.configurationSourceProvider.lifecycleState));
        });
    }
    /**
     ...
     */
    forStack(request, ...targetStates) {
        return __awaiter(this, void 0, void 0, function* () {
            return oci_common_1.genericTerminalConditionWaiter(this.config, () => this.client.getStack(request), response => targetStates.includes(response.stack.lifecycleState), targetStates.includes(models.Stack.LifecycleState.Deleted));
        });
    }
    /**
    ...
    forTemplate(request, ...targetStates) {
        return __awaiter(this, void 0, void 0, function* () {
            return oci_common_1.genericWaiter(this.config, () => this.client.getTemplate(request), response => targetStates.includes(response.template.lifecycleState));
        });
    }
    /**
...
exports.ResourceManagerWaiter = ResourceManagerWaiter;
//# sourceMappingURL=resourcemanager-waiter.js.map
...
export interface ListConfigurationSourceProvidersResponse {
    /**
    ...
    "opcNextPage": string;
    /**
     * The returned model.ConfigurationSourceProviderCollection instance.
     */
    "configurationSourceProviderCollection": model.ConfigurationSourceProviderCollection;
}

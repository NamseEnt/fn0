...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/resourcemanager/UpdateTemplate.ts.html |here} to see how to use UpdateTemplateRequest.
 */
export interface UpdateTemplateRequest extends common.BaseRequest {
    /**
     ...
     *
     */
    "updateTemplateDetails": model.UpdateTemplateDetails;
    /**

...
export declare namespace CreateDevOpsConfigSourceDetails {
    function getJsonObj(obj: CreateDevOpsConfigSourceDetails, isParentJsonObj?: boolean): object;
    const configSourceType = "DEVOPS_CONFIG_SOURCE";
    function getDeserializedJsonObj(obj: CreateDevOpsConfigSourceDetails, isParentJsonObj?: boolean): object;
}

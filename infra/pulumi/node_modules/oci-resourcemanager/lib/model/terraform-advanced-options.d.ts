...
export declare namespace TerraformAdvancedOptions {
    enum DetailedLogLevel {
        Error = "ERROR",
        Warn = "WARN",
        Info = "INFO",
        Debug = "DEBUG",
    ...
    function getJsonObj(obj: TerraformAdvancedOptions): object;
    function getDeserializedJsonObj(obj: TerraformAdvancedOptions): object;
}

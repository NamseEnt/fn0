...
export interface Job {
    ...
    "jobOperationDetails"?: model.ImportTfStateJobOperationDetails | model.PlanJobOperationDetails | model.ApplyRollbackJobOperationDetails | model.PlanRollbackJobOperationDetails | model.ApplyJobOperationDetails | model.DestroyJobOperationDetails;
    ...
    "configSource"?: model.DevOpsConfigSourceRecord | model.GitConfigSourceRecord | model.ZipUploadConfigSourceRecord | model.BitbucketCloudConfigSourceRecord | model.BitbucketServerConfigSourceRecord | model.ObjectStorageConfigSourceRecord;
    /**

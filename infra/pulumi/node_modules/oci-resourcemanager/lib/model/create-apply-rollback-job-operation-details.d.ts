...
export declare namespace CreateApplyRollbackJobOperationDetails {
    function getJsonObj(obj: CreateApplyRollbackJobOperationDetails, isParentJsonObj?: boolean): object;
    const operation = "APPLY_ROLLBACK";
    function getDeserializedJsonObj(obj: CreateApplyRollbackJobOperationDetails, isParentJsonObj?: boolean): object;
}

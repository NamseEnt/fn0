...
export declare namespace CreatePlanRollbackJobOperationDetails {
    function getJsonObj(obj: CreatePlanRollbackJobOperationDetails, isParentJsonObj?: boolean): object;
    const operation = "PLAN_ROLLBACK";
    function getDeserializedJsonObj(obj: CreatePlanRollbackJobOperationDetails, isParentJsonObj?: boolean): object;
}

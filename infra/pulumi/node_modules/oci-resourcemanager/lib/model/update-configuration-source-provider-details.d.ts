...
export declare namespace UpdateConfigurationSourceProviderDetails {
    function getJsonObj(obj: UpdateConfigurationSourceProviderDetails): object;
    function getDeserializedJsonObj(obj: UpdateConfigurationSourceProviderDetails): object;
}

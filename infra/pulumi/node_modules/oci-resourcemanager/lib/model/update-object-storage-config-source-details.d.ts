...
export declare namespace UpdateObjectStorageConfigSourceDetails {
    function getJsonObj(obj: UpdateObjectStorageConfigSourceDetails, isParentJsonObj?: boolean): object;
    const configSourceType = "OBJECT_STORAGE_CONFIG_SOURCE";
    function getDeserializedJsonObj(obj: UpdateObjectStorageConfigSourceDetails, isParentJsonObj?: boolean): object;
}

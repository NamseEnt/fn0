...
export declare namespace CreateConfigurationSourceProviderDetails {
    function getJsonObj(obj: CreateConfigurationSourceProviderDetails): object;
    function getDeserializedJsonObj(obj: CreateConfigurationSourceProviderDetails): object;
}

...
export declare namespace ChangePrivateEndpointCompartmentDetails {
    function getJsonObj(obj: ChangePrivateEndpointCompartmentDetails): object;
    function getDeserializedJsonObj(obj: ChangePrivateEndpointCompartmentDetails): object;
}

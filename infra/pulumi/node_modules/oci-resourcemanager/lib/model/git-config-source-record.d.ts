...
export declare namespace GitConfigSourceRecord {
    function getJsonObj(obj: GitConfigSourceRecord, isParentJsonObj?: boolean): object;
    const configSourceRecordType = "GIT_CONFIG_SOURCE";
    function getDeserializedJsonObj(obj: GitConfigSourceRecord, isParentJsonObj?: boolean): object;
}

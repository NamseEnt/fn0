 ...
 *
 */
export interface GitConfigSource extends model.ConfigSource {
    /**
...
export declare namespace GitConfigSource {
    function getJsonObj(obj: GitConfigSource, isParentJsonObj?: boolean): object;
    const configSourceType = "GIT_CONFIG_SOURCE";
    function getDeserializedJsonObj(obj: GitConfigSource, isParentJsonObj?: boolean): object;
}

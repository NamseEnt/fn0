...
export declare namespace DetectStackDriftDetails {
    function getJsonObj(obj: DetectStackDriftDetails): object;
    function getDeserializedJsonObj(obj: DetectStackDriftDetails): object;
}

...
export declare namespace CreateBitbucketCloudConfigSourceDetails {
    function getJsonObj(obj: CreateBitbucketCloudConfigSourceDetails, isParentJsonObj?: boolean): object;
    const configSourceType = "BITBUCKET_CLOUD_CONFIG_SOURCE";
    function getDeserializedJsonObj(obj: CreateBitbucketCloudConfigSourceDetails, isParentJsonObj?: boolean): object;
}

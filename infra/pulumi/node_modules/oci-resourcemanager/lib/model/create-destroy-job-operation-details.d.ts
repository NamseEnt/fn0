...
export declare namespace CreateDestroyJobOperationDetails {
    function getJsonObj(obj: CreateDestroyJobOperationDetails, isParentJsonObj?: boolean): object;
    const operation = "DESTROY";
    function getDeserializedJsonObj(obj: CreateDestroyJobOperationDetails, isParentJsonObj?: boolean): object;
}

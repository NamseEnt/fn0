 ...
 */
export interface UpdateBitbucketServerConfigSourceDetails extends model.UpdateConfigSourceDetails {
    /**
...
export declare namespace UpdateBitbucketServerConfigSourceDetails {
    function getJsonObj(obj: UpdateBitbucketServerConfigSourceDetails, isParentJsonObj?: boolean): object;
    const configSourceType = "BITBUCKET_SERVER_CONFIG_SOURCE";
    function getDeserializedJsonObj(obj: UpdateBitbucketServerConfigSourceDetails, isParentJsonObj?: boolean): object;
}

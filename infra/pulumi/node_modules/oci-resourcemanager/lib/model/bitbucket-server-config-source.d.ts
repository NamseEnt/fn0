 ...
 *
 */
export interface BitbucketServerConfigSource extends model.ConfigSource {
    /**
...
export declare namespace BitbucketServerConfigSource {
    function getJsonObj(obj: BitbucketServerConfigSource, isParentJsonObj?: boolean): object;
    const configSourceType = "BITBUCKET_SERVER_CONFIG_SOURCE";
    function getDeserializedJsonObj(obj: BitbucketServerConfigSource, isParentJsonObj?: boolean): object;
}

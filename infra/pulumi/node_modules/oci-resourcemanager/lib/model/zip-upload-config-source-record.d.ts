...
export declare namespace ZipUploadConfigSourceRecord {
    function getJsonObj(obj: ZipUploadConfigSourceRecord, isParentJsonObj?: boolean): object;
    const configSourceRecordType = "ZIP_UPLOAD";
    function getDeserializedJsonObj(obj: ZipUploadConfigSourceRecord, isParentJsonObj?: boolean): object;
}

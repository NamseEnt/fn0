...
export declare namespace ApplyJobOperationDetailsSummary {
    function getJsonObj(obj: ApplyJobOperationDetailsSummary, isParentJsonObj?: boolean): object;
    const operation = "APPLY";
    function getDeserializedJsonObj(obj: ApplyJobOperationDetailsSummary, isParentJsonObj?: boolean): object;
}

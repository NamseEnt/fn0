...
export declare namespace CreateTemplateConfigSourceDetails {
    function getJsonObj(obj: CreateTemplateConfigSourceDetails): object;
    function getDeserializedJsonObj(obj: CreateTemplateConfigSourceDetails): object;
}

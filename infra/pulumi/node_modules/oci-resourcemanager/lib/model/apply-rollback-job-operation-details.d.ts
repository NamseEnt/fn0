 ...
 *
 */
export interface ApplyRollbackJobOperationDetails extends model.JobOperationDetails {
...
export declare namespace ApplyRollbackJobOperationDetails {
    enum ExecutionPlanRollbackStrategy {
    ...
    function getJsonObj(obj: ApplyRollbackJobOperationDetails, isParentJsonObj?: boolean): object;
    const operation = "APPLY_ROLLBACK";
    function getDeserializedJsonObj(obj: ApplyRollbackJobOperationDetails, isParentJsonObj?: boolean): object;
}

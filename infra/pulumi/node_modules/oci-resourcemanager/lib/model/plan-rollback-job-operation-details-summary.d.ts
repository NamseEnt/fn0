 ...
 *
 */
export interface PlanRollbackJobOperationDetailsSummary extends model.JobOperationDetailsSummary {
    /**
...
export declare namespace PlanRollbackJobOperationDetailsSummary {
    function getJsonObj(obj: PlanRollbackJobOperationDetailsSummary, isParentJsonObj?: boolean): object;
    const operation = "PLAN_ROLLBACK";
    function getDeserializedJsonObj(obj: PlanRollbackJobOperationDetailsSummary, isParentJsonObj?: boolean): object;
}

...
export declare namespace PlanJobOperationDetails {
    function getJsonObj(obj: PlanJobOperationDetails, isParentJsonObj?: boolean): object;
    const operation = "PLAN";
    function getDeserializedJsonObj(obj: PlanJobOperationDetails, isParentJsonObj?: boolean): object;
}

...
export declare namespace BitbucketCloudConfigSourceRecord {
    function getJsonObj(obj: BitbucketCloudConfigSourceRecord, isParentJsonObj?: boolean): object;
    const configSourceRecordType = "BITBUCKET_CLOUD_CONFIG_SOURCE";
    function getDeserializedJsonObj(obj: BitbucketCloudConfigSourceRecord, isParentJsonObj?: boolean): object;
}

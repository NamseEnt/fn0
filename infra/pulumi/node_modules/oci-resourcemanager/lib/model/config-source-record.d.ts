...
export declare namespace ConfigSourceRecord {
    function getJsonObj(obj: ConfigSourceRecord): object;
    function getDeserializedJsonObj(obj: ConfigSourceRecord): object;
}

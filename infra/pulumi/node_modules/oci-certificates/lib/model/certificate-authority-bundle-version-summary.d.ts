...
export declare namespace CertificateAuthorityBundleVersionSummary {
    enum Stages {
        Current = "CURRENT",
        Pending = "PENDING",
    ...
    function getJsonObj(obj: CertificateAuthorityBundleVersionSummary): object;
    function getDeserializedJsonObj(obj: CertificateAuthorityBundleVersionSummary): object;
}

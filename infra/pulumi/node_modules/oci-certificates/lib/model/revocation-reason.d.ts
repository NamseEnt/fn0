...
export declare namespace RevocationReason {
    function getJsonObj(obj: RevocationReason): RevocationReason;
    function getDeserializedJsonObj(obj: RevocationReason): RevocationReason;
}

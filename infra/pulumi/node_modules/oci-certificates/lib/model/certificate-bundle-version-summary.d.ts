...
export declare namespace CertificateBundleVersionSummary {
    enum Stages {
        Current = "CURRENT",
        Pending = "PENDING",
    ...
    function getJsonObj(obj: CertificateBundleVersionSummary): object;
    function getDeserializedJsonObj(obj: CertificateBundleVersionSummary): object;
}

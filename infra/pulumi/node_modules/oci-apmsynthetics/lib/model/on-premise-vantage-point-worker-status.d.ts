 ...
 **/
export declare enum OnPremiseVantagePointWorkerStatus {
    Enabled = "ENABLED",
    Disabled = "DISABLED",
    /**
...
export declare namespace OnPremiseVantagePointWorkerStatus {
    function getJsonObj(obj: OnPremiseVantagePointWorkerStatus): OnPremiseVantagePointWorkerStatus;
    function getDeserializedJsonObj(obj: OnPremiseVantagePointWorkerStatus): OnPremiseVantagePointWorkerStatus;
}

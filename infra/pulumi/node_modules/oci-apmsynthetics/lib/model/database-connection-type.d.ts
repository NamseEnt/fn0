 ...
 **/
export declare enum DatabaseConnectionType {
...
export declare namespace DatabaseConnectionType {
    function getJsonObj(obj: DatabaseConnectionType): DatabaseConnectionType;
    function getDeserializedJsonObj(obj: DatabaseConnectionType): DatabaseConnectionType;
}

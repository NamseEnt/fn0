...
export declare namespace MonitorCollection {
    function getJsonObj(obj: MonitorCollection): object;
    function getDeserializedJsonObj(obj: MonitorCollection): object;
}

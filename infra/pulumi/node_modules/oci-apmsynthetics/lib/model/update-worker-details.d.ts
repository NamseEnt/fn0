...
export declare namespace UpdateWorkerDetails {
    function getJsonObj(obj: UpdateWorkerDetails): object;
    function getDeserializedJsonObj(obj: UpdateWorkerDetails): object;
}

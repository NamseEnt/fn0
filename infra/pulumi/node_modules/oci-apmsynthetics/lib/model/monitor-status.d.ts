...
export declare namespace MonitorStatus {
    function getJsonObj(obj: MonitorStatus): MonitorStatus;
    function getDeserializedJsonObj(obj: MonitorStatus): MonitorStatus;
}

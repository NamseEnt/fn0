 ...
 **/
export declare enum RequestAuthenticationSchemesForScriptedRest {
    None = "NONE",
...
export declare namespace RequestAuthenticationSchemesForScriptedRest {
    function getJsonObj(obj: RequestAuthenticationSchemesForScriptedRest): RequestAuthenticationSchemesForScriptedRest;
    function getDeserializedJsonObj(obj: RequestAuthenticationSchemesForScriptedRest): RequestAuthenticationSchemesForScriptedRest;
}

...
export declare namespace MonitorStatusCountMap {
    function getJsonObj(obj: MonitorStatusCountMap): object;
    function getDeserializedJsonObj(obj: MonitorStatusCountMap): object;
}

...
export declare namespace BrowserMonitorConfiguration {
    function getJsonObj(obj: BrowserMonitorConfiguration, isParentJsonObj?: boolean): object;
    const configType = "BROWSER_CONFIG";
    function getDeserializedJsonObj(obj: BrowserMonitorConfiguration, isParentJsonObj?: boolean): object;
}

...
export declare namespace RequestMethods {
    function getJsonObj(obj: RequestMethods): RequestMethods;
    function getDeserializedJsonObj(obj: RequestMethods): RequestMethods;
}

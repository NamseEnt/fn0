...
export declare namespace DatabaseWalletDetails {
    function getJsonObj(obj: DatabaseWalletDetails): object;
    function getDeserializedJsonObj(obj: DatabaseWalletDetails): object;
}

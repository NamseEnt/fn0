 ...
 */
export interface UpdateOnPremiseVantagePointDetails {
    /**
...
export declare namespace UpdateOnPremiseVantagePointDetails {
    function getJsonObj(obj: UpdateOnPremiseVantagePointDetails): object;
    function getDeserializedJsonObj(obj: UpdateOnPremiseVantagePointDetails): object;
}

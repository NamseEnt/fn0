...
export declare namespace DnsSecMonitorConfiguration {
    function getJsonObj(obj: DnsSecMonitorConfiguration, isParentJsonObj?: boolean): object;
    const configType = "DNSSEC_CONFIG";
    function getDeserializedJsonObj(obj: DnsSecMonitorConfiguration, isParentJsonObj?: boolean): object;
}

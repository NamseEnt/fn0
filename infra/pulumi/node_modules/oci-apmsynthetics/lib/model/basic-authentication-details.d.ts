...
export declare namespace BasicAuthenticationDetails {
    function getJsonObj(obj: BasicAuthenticationDetails): object;
    function getDeserializedJsonObj(obj: BasicAuthenticationDetails): object;
}

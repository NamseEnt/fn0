 ...
 */
export interface VantagePointInfo {
    /**
...
export declare namespace VantagePointInfo {
    function getJsonObj(obj: VantagePointInfo): object;
    function getDeserializedJsonObj(obj: VantagePointInfo): object;
}

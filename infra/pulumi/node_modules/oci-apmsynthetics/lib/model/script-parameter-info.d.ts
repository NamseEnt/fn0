...
export declare namespace ScriptParameterInfo {
    function getJsonObj(obj: ScriptParameterInfo): object;
    function getDeserializedJsonObj(obj: ScriptParameterInfo): object;
}

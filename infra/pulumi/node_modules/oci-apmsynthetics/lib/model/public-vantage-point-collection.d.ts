...
export declare namespace PublicVantagePointCollection {
    function getJsonObj(obj: PublicVantagePointCollection): object;
    function getDeserializedJsonObj(obj: PublicVantagePointCollection): object;
}

...
export declare namespace NetworkMonitorConfiguration {
    function getJsonObj(obj: NetworkMonitorConfiguration, isParentJsonObj?: boolean): object;
    const configType = "NETWORK_CONFIG";
    function getDeserializedJsonObj(obj: NetworkMonitorConfiguration, isParentJsonObj?: boolean): object;
}

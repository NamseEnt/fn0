 ...
 */
export interface IdentityInfoDetails {
    /**
...
export declare namespace IdentityInfoDetails {
    function getJsonObj(obj: IdentityInfoDetails): object;
    function getDeserializedJsonObj(obj: IdentityInfoDetails): object;
}

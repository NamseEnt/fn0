...
export declare namespace CreateOnPremiseVantagePointDetails {
    enum Type {
        OnPremiseDockerVantagePoint = "ON_PREMISE_DOCKER_VANTAGE_POINT"
    }
    function getJsonObj(obj: CreateOnPremiseVantagePointDetails): object;
    function getDeserializedJsonObj(obj: CreateOnPremiseVantagePointDetails): object;
}

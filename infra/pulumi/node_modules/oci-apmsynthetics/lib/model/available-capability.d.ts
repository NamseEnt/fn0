...
export declare namespace AvailableCapability {
    function getJsonObj(obj: AvailableCapability): object;
    function getDeserializedJsonObj(obj: AvailableCapability): object;
}

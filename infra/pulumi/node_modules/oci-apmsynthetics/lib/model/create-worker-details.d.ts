...
export declare namespace CreateWorkerDetails {
    function getJsonObj(obj: CreateWorkerDetails): object;
    function getDeserializedJsonObj(obj: CreateWorkerDetails): object;
}

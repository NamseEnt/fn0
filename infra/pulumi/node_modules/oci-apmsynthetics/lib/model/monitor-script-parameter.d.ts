...
export declare namespace MonitorScriptParameter {
    function getJsonObj(obj: MonitorScriptParameter): object;
    function getDeserializedJsonObj(obj: MonitorScriptParameter): object;
}

...
export declare namespace PasswordInVault {
    function getJsonObj(obj: PasswordInVault, isParentJsonObj?: boolean): object;
    const passwordType = "VAULT_SECRET_ID";
    function getDeserializedJsonObj(obj: PasswordInVault, isParentJsonObj?: boolean): object;
}

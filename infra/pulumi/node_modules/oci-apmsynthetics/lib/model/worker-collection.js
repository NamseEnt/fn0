...
exports.WorkerCollection = void 0;
...
(function (WorkerCollection) {
    function getJsonObj(obj) {
        const jsonObj = Object.assign(Object.assign({}, obj), {
            "items": obj.items
                ? obj.items.map(item => {
                    return model.WorkerSummary.getJsonObj(item);
                })
                : undefined
        });
        return jsonObj;
    }
    WorkerCollection.getJsonObj = getJsonObj;
    function getDeserializedJsonObj(obj) {
        const jsonObj = Object.assign(Object.assign({}, obj), {
            "items": obj.items
                ? obj.items.map(item => {
                    return model.WorkerSummary.getDeserializedJsonObj(item);
                })
                : undefined
        });
        return jsonObj;
    }
    WorkerCollection.getDeserializedJsonObj = getDeserializedJsonObj;
})(WorkerCollection = exports.WorkerCollection || (exports.WorkerCollection = {}));
//# sourceMappingURL=worker-collection.js.map
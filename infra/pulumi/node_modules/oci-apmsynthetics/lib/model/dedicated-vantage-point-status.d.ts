 ...
 **/
export declare enum DedicatedVantagePointStatus {
    Enabled = "ENABLED",
    Disabled = "DISABLED",
    /**
...
export declare namespace DedicatedVantagePointStatus {
    function getJsonObj(obj: DedicatedVantagePointStatus): DedicatedVantagePointStatus;
    function getDeserializedJsonObj(obj: DedicatedVantagePointStatus): DedicatedVantagePointStatus;
}

...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/apmsynthetics/ListPublicVantagePoints.ts.html |here} to see how to use ListPublicVantagePointsRequest.
 */
...
export declare namespace ListPublicVantagePointsRequest {
    enum SortBy {
        Name = "name",

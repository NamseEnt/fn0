...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/apmsynthetics/ListDedicatedVantagePoints.ts.html |here} to see how to use ListDedicatedVantagePointsRequest.
 */
...
export declare namespace ListDedicatedVantagePointsRequest {
    enum SortBy {

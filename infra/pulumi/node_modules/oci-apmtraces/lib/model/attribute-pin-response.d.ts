...
export declare namespace AttributePinResponse {
    enum OperationType {
        Pin = "PIN",
        /**
    ...
    function getJsonObj(obj: AttributePinResponse): object;
    function getDeserializedJsonObj(obj: AttributePinResponse): object;
}

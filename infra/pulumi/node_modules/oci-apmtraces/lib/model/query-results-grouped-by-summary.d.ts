...
export declare namespace QueryResultsGroupedBySummary {
    function getJsonObj(obj: QueryResultsGroupedBySummary): object;
    function getDeserializedJsonObj(obj: QueryResultsGroupedBySummary): object;
}

...
exports.VnMonitoringClient = exports.VnMonitoringApiKeys = void 0;
const common = require("oci-common");
const model = __importStar(require("./model"));
const vnmonitoring_waiter_1 = require("./vnmonitoring-waiter");
const oci_common_1 = require("oci-common");
const Breaker = require("opossum");
// ===============================================
// This file is autogenerated - Please do not edit
// ===============================================
var VnMonitoringApiKeys;
(function (VnMonitoringApiKeys) {
})(VnMonitoringApiKeys = exports.VnMonitoringApiKeys || (exports.VnMonitoringApiKeys = {}));
/**
...
class VnMonitoringClient {
    constructor(params, clientConfiguration) {
        ...
        this.targetService = "VnMonitoring";
        this._regionId = "";
        ...
        if (!oci_common_1.developerToolConfiguration.isServiceEnabled("vnmonitoring")) {
    ...
    set endpoint(endpoint) {
        ...
        if (this.logger)
            this.logger.info(`VnMonitoringClient endpoint set to ${this._endpoint}`);
    }
    get logger() {
    ...
    set useRealmSpecificEndpointTemplate(realmSpecificEndpointTemplateEnabled) {
        ...
        if (this._lastSetRegionOrRegionId === common.Region.REGION_STRING) {
            this.endpoint = common.EndpointBuilder.createEndpointFromRegion(VnMonitoringClient.serviceEndpointTemplate, this._region, VnMonitoringClient.endpointServiceName);
        }
        else if (this._lastSetRegionOrRegionId === common.Region.REGION_ID_STRING) {
            this.endpoint = common.EndpointBuilder.createEndpointFromRegionId(VnMonitoringClient.serviceEndpointTemplate, this._regionId, VnMonitoringClient.endpointServiceName);
        }
    }
    /**
    ...
    set region(region) {
        this._region = region;
        this.endpoint = common.EndpointBuilder.createEndpointFromRegion(VnMonitoringClient.serviceEndpointTemplate, region, VnMonitoringClient.endpointServiceName);
    ...
    set regionId(regionId) {
        ...
        this.endpoint = common.EndpointBuilder.createEndpointFromRegionId(VnMonitoringClient.serviceEndpointTemplate, regionId, VnMonitoringClient.endpointServiceName);
    ...
    createWaiters(config) {
        this._waiters = new vnmonitoring_waiter_1.VnMonitoringWaiter(this, config);
    ...
    changePathAnalyzerTestCompartment(changePathAnalyzerTestCompartmentRequest) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const retrier = oci_common_1.GenericRetrier.createPreferredRetrier(this._clientConfiguration ? this._clientConfiguration.retryConfiguration : undefined, changePathAnalyzerTestCompartmentRequest.retryConfiguration, specRetryConfiguration);
            if (this.logger)
            ...
            const request = yield oci_common_1.composeRequest({
                ...
                method: "POST",
                bodyContent: common.ObjectSerializer.serialize(changePathAnalyzerTestCompartmentRequest.changePathAnalyzerTestCompartmentDetails, "ChangePathAnalyzerTestCompartmentDetails", model.ChangePathAnalyzerTestCompartmentDetails.getJsonObj),
    ...
    createPathAnalyzerTest(createPathAnalyzerTestRequest) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const specRetryConfiguration = common.NoRetryConfigurationDetails;
            const retrier = oci_common_1.GenericRetrier.createPreferredRetrier(this._clientConfiguration ? this._clientConfiguration.retryConfiguration : undefined, createPathAnalyzerTestRequest.retryConfiguration, specRetryConfiguration);
            if (this.logger)
                retrier.logger = this.logger;
            const request = yield oci_common_1.composeRequest({
                baseEndpoint: this._endpoint,
                ...
                method: "POST",
                bodyContent: common.ObjectSerializer.serialize(createPathAnalyzerTestRequest.createPathAnalyzerTestDetails, "CreatePathAnalyzerTestDetails", model.CreatePathAnalyzerTestDetails.getJsonObj),
                pathParams: pathParams,
                headerParams: headerParams,
                queryParams: queryParams
            });
    ...
    deletePathAnalyzerTest(deletePathAnalyzerTestRequest) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const specRetryConfiguration = common.NoRetryConfigurationDetails;
            const retrier = oci_common_1.GenericRetrier.createPreferredRetrier(this._clientConfiguration ? this._clientConfiguration.retryConfiguration : undefined, deletePathAnalyzerTestRequest.retryConfiguration, specRetryConfiguration);
            if (this.logger)
                retrier.logger = this.logger;
            const request = yield oci_common_1.composeRequest({
                baseEndpoint: this._endpoint,
  ...
  *
    ...
    getPathAnalysis(getPathAnalysisRequest) {
        return __awaiter(this, void 0, void 0, function* () {
            if (this.logger)
                this.logger.debug("Calling operation VnMonitoringClient#getPathAnalysis.");
            ...
            const specRetryConfiguration = common.NoRetryConfigurationDetails;
            const retrier = oci_common_1.GenericRetrier.createPreferredRetrier(this._clientConfiguration ? this._clientConfiguration.retryConfiguration : undefined, getPathAnalysisRequest.retryConfiguration, specRetryConfiguration);
            if (this.logger)
                retrier.logger = this.logger;
            const request = yield oci_common_1.composeRequest({
                baseEndpoint: this._endpoint,
                ...
                path: "/pathAnalysis",
                method: "POST",
                bodyContent: common.ObjectSerializer.serialize(getPathAnalysisRequest.getPathAnalysisDetails, "GetPathAnalysisDetails", model.GetPathAnalysisDetails.getJsonObj),
                pathParams: pathParams,
                headerParams: headerParams,
                queryParams: queryParams
            });
    ...
    getPathAnalyzerTest(getPathAnalyzerTestRequest) {
        return __awaiter(this, void 0, void 0, function* () {
            if (this.logger)
                this.logger.debug("Calling operation VnMonitoringClient#getPathAnalyzerTest.");
            ...
            const specRetryConfiguration = common.NoRetryConfigurationDetails;
            const retrier = oci_common_1.GenericRetrier.createPreferredRetrier(this._clientConfiguration ? this._clientConfiguration.retryConfiguration : undefined, getPathAnalyzerTestRequest.retryConfiguration, specRetryConfiguration);
            if (this.logger)
                retrier.logger = this.logger;
            const request = yield oci_common_1.composeRequest({
                baseEndpoint: this._endpoint,
    ...
    getWorkRequest(getWorkRequestRequest) {
        return __awaiter(this, void 0, void 0, function* () {
            if (this.logger)
                this.logger.debug("Calling operation VnMonitoringClient#getWorkRequest.");
    ...
    listPathAnalyzerTests(listPathAnalyzerTestsRequest) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const specRetryConfiguration = common.NoRetryConfigurationDetails;
            const retrier = oci_common_1.GenericRetrier.createPreferredRetrier(this._clientConfiguration ? this._clientConfiguration.retryConfiguration : undefined, listPathAnalyzerTestsRequest.retryConfiguration, specRetryConfiguration);
            if (this.logger)
                retrier.logger = this.logger;
            const request = yield oci_common_1.composeRequest({
                baseEndpoint: this._endpoint,
    ...
    listWorkRequestLogs(listWorkRequestLogsRequest) {
        return __awaiter(this, void 0, void 0, function* () {
            if (this.logger)
                this.logger.debug("Calling operation VnMonitoringClient#listWorkRequestLogs.");
    ...
    listWorkRequestResults(listWorkRequestResultsRequest) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const specRetryConfiguration = common.NoRetryConfigurationDetails;
            const retrier = oci_common_1.GenericRetrier.createPreferredRetrier(this._clientConfiguration ? this._clientConfiguration.retryConfiguration : undefined, listWorkRequestResultsRequest.retryConfiguration, specRetryConfiguration);
            if (this.logger)
                retrier.logger = this.logger;
            const request = yield oci_common_1.composeRequest({
                baseEndpoint: this._endpoint,
    ...
    listWorkRequests(listWorkRequestsRequest) {
        return __awaiter(this, void 0, void 0, function* () {
            if (this.logger)
                this.logger.debug("Calling operation VnMonitoringClient#listWorkRequests.");
    ...
    updatePathAnalyzerTest(updatePathAnalyzerTestRequest) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const specRetryConfiguration = common.NoRetryConfigurationDetails;
            const retrier = oci_common_1.GenericRetrier.createPreferredRetrier(this._clientConfiguration ? this._clientConfiguration.retryConfiguration : undefined, updatePathAnalyzerTestRequest.retryConfiguration, specRetryConfiguration);
            if (this.logger)
                retrier.logger = this.logger;
            const request = yield oci_common_1.composeRequest({
                baseEndpoint: this._endpoint,
                ...
                path: "/pathAnalyzerTests/{pathAnalyzerTestId}",
                method: "PUT",
                bodyContent: common.ObjectSerializer.serialize(updatePathAnalyzerTestRequest.updatePathAnalyzerTestDetails, "UpdatePathAnalyzerTestDetails", model.UpdatePathAnalyzerTestDetails.getJsonObj),
                pathParams: pathParams,
                headerParams: headerParams,
                queryParams: queryParams
            });
...
exports.VnMonitoringClient = VnMonitoringClient;
VnMonitoringClient.serviceEndpointTemplate = "https://vnca-api.{region}.oci.{secondLevelDomain}";

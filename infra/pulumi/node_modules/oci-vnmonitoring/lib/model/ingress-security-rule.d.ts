...
export declare namespace IngressSecurityRule {
    enum SourceType {
    ...
    function getJsonObj(obj: IngressSecurityRule): object;
    function getDeserializedJsonObj(obj: IngressSecurityRule): object;
}

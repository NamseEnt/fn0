 ...
 */
export interface CreateFlexTunnelDetails {
    /**
    ...
    "flexTunnelConfiguration": model.CreateGreFlexTunnelConfigurationDetails;
    /**
...
export declare namespace CreateFlexTunnelDetails {
    function getJsonObj(obj: CreateFlexTunnelDetails): object;
    function getDeserializedJsonObj(obj: CreateFlexTunnelDetails): object;
}

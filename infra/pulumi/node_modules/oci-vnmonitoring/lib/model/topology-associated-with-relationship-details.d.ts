...
export declare namespace TopologyAssociatedWithRelationshipDetails {
    function getJsonObj(obj: TopologyAssociatedWithRelationshipDetails): object;
    function getDeserializedJsonObj(obj: TopologyAssociatedWithRelationshipDetails): object;
}

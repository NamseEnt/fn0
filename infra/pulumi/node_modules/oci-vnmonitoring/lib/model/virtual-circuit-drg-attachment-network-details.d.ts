 ...
 */
export interface VirtualCircuitDrgAttachmentNetworkDetails extends model.DrgAttachmentNetworkDetails {
    /**
...
export declare namespace VirtualCircuitDrgAttachmentNetworkDetails {
    function getJsonObj(obj: VirtualCircuitDrgAttachmentNetworkDetails, isParentJsonObj?: boolean): object;
    const type = "VIRTUAL_CIRCUIT";
    function getDeserializedJsonObj(obj: VirtualCircuitDrgAttachmentNetworkDetails, isParentJsonObj?: boolean): object;
}

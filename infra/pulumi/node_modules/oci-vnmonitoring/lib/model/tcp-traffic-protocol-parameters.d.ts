...
export declare namespace TcpTrafficProtocolParameters {
    function getJsonObj(obj: TcpTrafficProtocolParameters, isParentJsonObj?: boolean): object;
    const type = "TCP";
    function getDeserializedJsonObj(obj: TcpTrafficProtocolParameters, isParentJsonObj?: boolean): object;
}

 ...
 */
export interface VcnDrgAttachmentNetworkUpdateDetails extends model.DrgAttachmentNetworkUpdateDetails {
    /**
...
export declare namespace VcnDrgAttachmentNetworkUpdateDetails {
    function getJsonObj(obj: VcnDrgAttachmentNetworkUpdateDetails, isParentJsonObj?: boolean): object;
    const type = "VCN";
    function getDeserializedJsonObj(obj: VcnDrgAttachmentNetworkUpdateDetails, isParentJsonObj?: boolean): object;
}

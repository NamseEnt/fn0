...
export declare namespace IpsecTunnelDrgAttachmentNetworkDetails {
    function getJsonObj(obj: IpsecTunnelDrgAttachmentNetworkDetails, isParentJsonObj?: boolean): object;
    const type = "IPSEC_TUNNEL";
    function getDeserializedJsonObj(obj: IpsecTunnelDrgAttachmentNetworkDetails, isParentJsonObj?: boolean): object;
}

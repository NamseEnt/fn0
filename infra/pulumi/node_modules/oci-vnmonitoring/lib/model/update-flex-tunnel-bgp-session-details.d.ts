 ...
 */
export interface UpdateFlexTunnelBgpSessionDetails {
    /**
...
export declare namespace UpdateFlexTunnelBgpSessionDetails {
    function getJsonObj(obj: UpdateFlexTunnelBgpSessionDetails): object;
    function getDeserializedJsonObj(obj: UpdateFlexTunnelBgpSessionDetails): object;
}

...
export declare namespace IcmpTrafficProtocolParameters {
    function getJsonObj(obj: IcmpTrafficProtocolParameters, isParentJsonObj?: boolean): object;
    const type = "ICMP";
    function getDeserializedJsonObj(obj: IcmpTrafficProtocolParameters, isParentJsonObj?: boolean): object;
}

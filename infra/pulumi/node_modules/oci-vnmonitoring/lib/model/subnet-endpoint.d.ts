...
export declare namespace SubnetEndpoint {
    function getJsonObj(obj: SubnetEndpoint, isParentJsonObj?: boolean): object;
    const type = "SUBNET";
    function getDeserializedJsonObj(obj: SubnetEndpoint, isParentJsonObj?: boolean): object;
}

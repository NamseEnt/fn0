...
export declare namespace EgressSecurityRule {
    ...
    function getJsonObj(obj: EgressSecurityRule): object;
    function getDeserializedJsonObj(obj: EgressSecurityRule): object;
}

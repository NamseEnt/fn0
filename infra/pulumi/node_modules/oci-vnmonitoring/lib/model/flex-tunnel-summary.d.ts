...
export declare namespace FlexTunnelSummary {
    function getJsonObj(obj: FlexTunnelSummary): object;
    function getDeserializedJsonObj(obj: FlexTunnelSummary): object;
}

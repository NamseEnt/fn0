 ...
 */
export interface CreateFlexTunnelBgpSessionDetails {
    /**
...
export declare namespace CreateFlexTunnelBgpSessionDetails {
    function getJsonObj(obj: CreateFlexTunnelBgpSessionDetails): object;
    function getDeserializedJsonObj(obj: CreateFlexTunnelBgpSessionDetails): object;
}

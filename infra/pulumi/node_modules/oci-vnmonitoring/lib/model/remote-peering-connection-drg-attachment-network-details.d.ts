 ...
 */
export interface RemotePeeringConnectionDrgAttachmentNetworkDetails extends model.DrgAttachmentNetworkDetails {
    /**
...
export declare namespace RemotePeeringConnectionDrgAttachmentNetworkDetails {
    function getJsonObj(obj: RemotePeeringConnectionDrgAttachmentNetworkDetails, isParentJsonObj?: boolean): object;
    const type = "REMOTE_PEERING_CONNECTION";
    function getDeserializedJsonObj(obj: RemotePeeringConnectionDrgAttachmentNetworkDetails, isParentJsonObj?: boolean): object;
}

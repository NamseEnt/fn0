...
export declare namespace UpdateDrgRouteDistributionStatementDetails {
    function getJsonObj(obj: UpdateDrgRouteDistributionStatementDetails): object;
    function getDeserializedJsonObj(obj: UpdateDrgRouteDistributionStatementDetails): object;
}

...
export interface TrafficNode {
    ...
    "nextHopRoutingAction"?: model.NoRouteRoutingAction | model.IndeterminateRoutingAction | model.ForwardedRoutingAction;
    "egressSecurityAction"?: model.AllowedSecurityAction | model.ZprMissingPolicySecurityAction | model.ZprDeniedSecurityAction | model.ZprPolicyNotEvaluatedMissingRouteSecurityAction | model.ZprNsgUnsupportedSecurityAction | model.ZprAllowedSecurityAction | model.DeniedSecurityAction | model.ZprCidrUnsupportedSecurityAction | model.ZprPolicyNotEvaluatedSlNsgDeniedSecurityAction;
...
export declare namespace TrafficNode {
    function getJsonObj(obj: TrafficNode): object;
    function getDeserializedJsonObj(obj: TrafficNode): object;
}

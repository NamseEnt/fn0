...
export declare namespace UdpTrafficProtocolParameters {
    function getJsonObj(obj: UdpTrafficProtocolParameters, isParentJsonObj?: boolean): object;
    const type = "UDP";
    function getDeserializedJsonObj(obj: UdpTrafficProtocolParameters, isParentJsonObj?: boolean): object;
}

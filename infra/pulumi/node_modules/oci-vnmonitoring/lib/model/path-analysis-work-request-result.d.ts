...
export declare namespace PathAnalysisWorkRequestResult {
    function getJsonObj(obj: PathAnalysisWorkRequestResult, isParentJsonObj?: boolean): object;
    const resultType = "PATH_ANALYSIS";
    function getDeserializedJsonObj(obj: PathAnalysisWorkRequestResult, isParentJsonObj?: boolean): object;
}

...
export declare namespace CrossConnectPortSpeedShape {
    function getJsonObj(obj: CrossConnectPortSpeedShape): object;
    function getDeserializedJsonObj(obj: CrossConnectPortSpeedShape): object;
}

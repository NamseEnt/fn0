...
export declare namespace ForwardedRoutingAction {
    function getJsonObj(obj: ForwardedRoutingAction, isParentJsonObj?: boolean): object;
    const action = "FORWARDED";
    function getDeserializedJsonObj(obj: ForwardedRoutingAction, isParentJsonObj?: boolean): object;
}

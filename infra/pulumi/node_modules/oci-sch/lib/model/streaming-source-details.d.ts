...
export declare namespace StreamingSourceDetails {
    function getJsonObj(obj: StreamingSourceDetails, isParentJsonObj?: boolean): object;
    const kind = "streaming";
    function getDeserializedJsonObj(obj: StreamingSourceDetails, isParentJsonObj?: boolean): object;
}

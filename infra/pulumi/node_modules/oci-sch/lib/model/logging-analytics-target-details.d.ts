...
export declare namespace LoggingAnalyticsTargetDetails {
    function getJsonObj(obj: LoggingAnalyticsTargetDetails, isParentJsonObj?: boolean): object;
    const kind = "loggingAnalytics";
    function getDeserializedJsonObj(obj: LoggingAnalyticsTargetDetails, isParentJsonObj?: boolean): object;
}

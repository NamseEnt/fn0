 ...
 *
 */
export interface PluginSourceDetails extends model.SourceDetails {
    /**
...
export declare namespace PluginSourceDetails {
    function getJsonObj(obj: PluginSourceDetails, isParentJsonObj?: boolean): object;
    const kind = "plugin";
    function getDeserializedJsonObj(obj: PluginSourceDetails, isParentJsonObj?: boolean): object;
}

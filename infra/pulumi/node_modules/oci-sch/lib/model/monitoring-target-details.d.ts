...
export declare namespace MonitoringTargetDetails {
    function getJsonObj(obj: MonitoringTargetDetails, isParentJsonObj?: boolean): object;
    const kind = "monitoring";
    function getDeserializedJsonObj(obj: MonitoringTargetDetails, isParentJsonObj?: boolean): object;
}

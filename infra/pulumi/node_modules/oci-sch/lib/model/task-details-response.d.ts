...
export declare namespace TaskDetailsResponse {
    function getJsonObj(obj: TaskDetailsResponse): object;
    function getDeserializedJsonObj(obj: TaskDetailsResponse): object;
}

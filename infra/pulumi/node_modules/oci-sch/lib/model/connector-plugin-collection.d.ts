...
export declare namespace ConnectorPluginCollection {
    function getJsonObj(obj: ConnectorPluginCollection): object;
    function getDeserializedJsonObj(obj: ConnectorPluginCollection): object;
}

...
export declare namespace LoggingSourceDetails {
    function getJsonObj(obj: LoggingSourceDetails, isParentJsonObj?: boolean): object;
    const kind = "logging";
    function getDeserializedJsonObj(obj: LoggingSourceDetails, isParentJsonObj?: boolean): object;
}

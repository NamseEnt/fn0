...
export declare namespace ConnectorPluginSummary {
    function getJsonObj(obj: ConnectorPluginSummary): object;
    function getDeserializedJsonObj(obj: ConnectorPluginSummary): object;
}

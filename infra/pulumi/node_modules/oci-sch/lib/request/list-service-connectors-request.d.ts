...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/sch/ListServiceConnectors.ts.html |here} to see how to use ListServiceConnectorsRequest.
 */
...
export declare namespace ListServiceConnectorsRequest {
    enum SortBy {

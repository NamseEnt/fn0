...
export declare namespace PerformanceTuningAnalysisSummary {
    function getJsonObj(obj: PerformanceTuningAnalysisSummary): object;
    function getDeserializedJsonObj(obj: PerformanceTuningAnalysisSummary): object;
}

...
export declare namespace ChangeConnectHarnessCompartmentDetails {
    function getJsonObj(obj: ChangeConnectHarnessCompartmentDetails): object;
    function getDeserializedJsonObj(obj: ChangeConnectHarnessCompartmentDetails): object;
}

...
export declare namespace CustomEncryptionKey {
    enum KeyState {
        Active = "ACTIVE",
        Creating = "CREATING",
        Deleting = "DELETING",
    ...
    function getJsonObj(obj: CustomEncryptionKey): object;
    function getDeserializedJsonObj(obj: CustomEncryptionKey): object;
}

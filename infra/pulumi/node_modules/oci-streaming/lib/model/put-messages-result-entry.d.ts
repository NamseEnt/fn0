...
export declare namespace PutMessagesResultEntry {
    function getJsonObj(obj: PutMessagesResultEntry): object;
    function getDeserializedJsonObj(obj: PutMessagesResultEntry): object;
}

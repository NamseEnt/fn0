...
export declare namespace CreateStreamPoolDetails {
    function getJsonObj(obj: CreateStreamPoolDetails): object;
    function getDeserializedJsonObj(obj: CreateStreamPoolDetails): object;
}

...
export declare namespace ChangeStreamPoolCompartmentDetails {
    function getJsonObj(obj: ChangeStreamPoolCompartmentDetails): object;
    function getDeserializedJsonObj(obj: ChangeStreamPoolCompartmentDetails): object;
}

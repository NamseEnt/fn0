...
export declare namespace PutMessagesResult {
    function getJsonObj(obj: PutMessagesResult): object;
    function getDeserializedJsonObj(obj: PutMessagesResult): object;
}

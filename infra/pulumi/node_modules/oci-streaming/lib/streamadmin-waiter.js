...
exports.StreamAdminWaiter = void 0;
const models = __importStar(require("./model"));
const oci_common_1 = require("oci-common");
class StreamAdminWaiter {
     ...
     */
    forConnectHarness(request, ...targetStates) {
        return __awaiter(this, void 0, void 0, function* () {
            return oci_common_1.genericTerminalConditionWaiter(this.config, () => this.client.getConnectHarness(request), response => targetStates.includes(response.connectHarness.lifecycleState), targetStates.includes(models.ConnectHarness.LifecycleState.Deleted));
        });
    }
    /**
     ...
     */
    forStream(request, ...targetStates) {
        return __awaiter(this, void 0, void 0, function* () {
            return oci_common_1.genericTerminalConditionWaiter(this.config, () => this.client.getStream(request), response => targetStates.includes(response.stream.lifecycleState), targetStates.includes(models.Stream.LifecycleState.Deleted));
        });
    }
    /**
     ...
     */
    forStreamPool(request, ...targetStates) {
        return __awaiter(this, void 0, void 0, function* () {

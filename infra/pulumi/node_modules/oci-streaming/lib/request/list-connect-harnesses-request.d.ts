...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/streaming/ListConnectHarnesses.ts.html |here} to see how to use ListConnectHarnessesRequest.
 */
...
export declare namespace ListConnectHarnessesRequest {
    enum SortBy {
        Name = "NAME",

...
class LogAnalyticsWaiter {
     ...
     */
    forIngestTimeRule(request, ...targetStates) {
        return __awaiter(this, void 0, void 0, function* () {
            return oci_common_1.genericTerminalConditionWaiter(this.config, () => this.client.getIngestTimeRule(request), response => targetStates.includes(response.ingestTimeRule.lifecycleState), targetStates.includes(models.ConfigLifecycleState.Deleted));
        });
    }
    /**
    ...
    forNamespace(request, ...targetStates) {
        return __awaiter(this, void 0, void 0, function* () {
            return oci_common_1.genericWaiter(this.config, () => this.client.getNamespace(request), response => targetStates.includes(response.namespace.lifecycleState));
        });
    }
    /**

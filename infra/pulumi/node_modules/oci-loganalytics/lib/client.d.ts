...
export declare class LogAnalyticsClient {
     ...
     */
    createWaiters(config?: common.WaiterConfiguration): LogAnalyticsWaiter;
    /**
     ...
     */
    changeLookupCompartment(changeLookupCompartmentRequest: requests.ChangeLookupCompartmentRequest): Promise<responses.ChangeLookupCompartmentResponse>;
    /**
     ...
     */
    getFieldUsages(getFieldUsagesRequest: requests.GetFieldUsagesRequest): Promise<responses.GetFieldUsagesResponse>;
    /**
     ...
     */
    listParserActions(listParserActionsRequest: requests.ListParserActionsRequest): Promise<responses.ListParserActionsResponse>;
    /**
     ...
     */
    listRecalledInfo(listRecalledInfoRequest: requests.ListRecalledInfoRequest): Promise<responses.ListRecalledInfoResponse>;
    /**
     ...
     */
    uploadOtlpLogs(uploadOtlpLogsRequest: requests.UploadOtlpLogsRequest): Promise<responses.UploadOtlpLogsResponse>;
    /**

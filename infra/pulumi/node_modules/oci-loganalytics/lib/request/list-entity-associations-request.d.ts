...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/loganalytics/ListEntityAssociations.ts.html |here} to see how to use ListEntityAssociationsRequest.
 */
...
export declare namespace ListEntityAssociationsRequest {
    enum DirectOrAllAssociations {
        Direct = "DIRECT",
        All = "ALL"
    }
    enum SortOrder {

...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/loganalytics/DisableIngestTimeRule.ts.html |here} to see how to use DisableIngestTimeRuleRequest.
 */

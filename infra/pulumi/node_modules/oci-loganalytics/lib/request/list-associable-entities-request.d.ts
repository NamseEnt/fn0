...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/loganalytics/ListAssociableEntities.ts.html |here} to see how to use ListAssociableEntitiesRequest.
 */
...
export declare namespace ListAssociableEntitiesRequest {
    enum Type {
        Eligible = "ELIGIBLE",

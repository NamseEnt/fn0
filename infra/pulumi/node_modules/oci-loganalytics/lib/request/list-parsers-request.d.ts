...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/loganalytics/ListParsers.ts.html |here} to see how to use ListParsersRequest.
 */
...
export declare namespace ListParsersRequest {
    enum SourceType {
        OsFile = "OS_FILE",
        Syslog = "SYSLOG",
        Odl = "ODL",

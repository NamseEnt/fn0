...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/loganalytics/ListSourceAssociations.ts.html |here} to see how to use ListSourceAssociationsRequest.
 */
...
export declare namespace ListSourceAssociationsRequest {
    enum LifeCycleState {
        All = "ALL",
        Accepted = "ACCEPTED",

...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/loganalytics/ListLogAnalyticsLogGroups.ts.html |here} to see how to use ListLogAnalyticsLogGroupsRequest.
 */
...
export declare namespace ListLogAnalyticsLogGroupsRequest {
    enum SortOrder {
        Asc = "ASC",
        Desc = "DESC"
    }

...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/loganalytics/ListOverlappingRecalls.ts.html |here} to see how to use ListOverlappingRecallsRequest.
 */
export interface ListOverlappingRecallsRequest extends common.BaseRequest {
    /**
...
export declare namespace ListOverlappingRecallsRequest {
    enum SortBy {

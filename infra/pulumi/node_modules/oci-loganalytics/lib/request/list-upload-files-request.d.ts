...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/loganalytics/ListUploadFiles.ts.html |here} to see how to use ListUploadFilesRequest.
 */
...
export declare namespace ListUploadFilesRequest {
    enum SortOrder {
        Asc = "ASC",
        Desc = "DESC"
    }

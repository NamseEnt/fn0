...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/loganalytics/ListParserFunctions.ts.html |here} to see how to use ListParserFunctionsRequest.
 */
...
export declare namespace ListParserFunctionsRequest {
    enum SortBy {
        Name = "name"
    }
    enum SortOrder {

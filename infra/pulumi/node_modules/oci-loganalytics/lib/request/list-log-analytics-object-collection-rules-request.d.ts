...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/loganalytics/ListLogAnalyticsObjectCollectionRules.ts.html |here} to see how to use ListLogAnalyticsObjectCollectionRulesRequest.
 */
...
export declare namespace ListLogAnalyticsObjectCollectionRulesRequest {
    enum SortOrder {
        Asc = "ASC",
        Desc = "DESC"
    }

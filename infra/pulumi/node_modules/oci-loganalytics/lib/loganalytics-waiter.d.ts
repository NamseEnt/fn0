...
export declare class LogAnalyticsWaiter {
     ...
     */
    forIngestTimeRule(request: serviceRequests.GetIngestTimeRuleRequest, ...targetStates: models.ConfigLifecycleState[]): Promise<serviceResponses.GetIngestTimeRuleResponse | null>;
    /**
     ...
     */
    forNamespace(request: serviceRequests.GetNamespaceRequest, ...targetStates: models.Namespace.LifecycleState[]): Promise<serviceResponses.GetNamespaceResponse>;
    /**

...
export declare namespace ClassifyCommandDescriptor {
    function getJsonObj(obj: ClassifyCommandDescriptor, isParentJsonObj?: boolean): object;
    const name = "CLASSIFY";
    function getDeserializedJsonObj(obj: ClassifyCommandDescriptor, isParentJsonObj?: boolean): object;
}

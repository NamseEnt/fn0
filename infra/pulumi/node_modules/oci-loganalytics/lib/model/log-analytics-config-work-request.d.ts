...
export declare namespace LogAnalyticsConfigWorkRequest {
    enum OperationType {
    ...
    function getJsonObj(obj: LogAnalyticsConfigWorkRequest): object;
    function getDeserializedJsonObj(obj: LogAnalyticsConfigWorkRequest): object;
}

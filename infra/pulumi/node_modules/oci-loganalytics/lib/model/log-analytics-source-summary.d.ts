...
export declare namespace LogAnalyticsSourceSummary {
    function getJsonObj(obj: LogAnalyticsSourceSummary): object;
    function getDeserializedJsonObj(obj: LogAnalyticsSourceSummary): object;
}

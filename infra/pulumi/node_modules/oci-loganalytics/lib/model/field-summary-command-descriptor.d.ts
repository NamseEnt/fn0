...
export declare namespace FieldSummaryCommandDescriptor {
    function getJsonObj(obj: FieldSummaryCommandDescriptor, isParentJsonObj?: boolean): object;
    const name = "FIELD_SUMMARY";
    function getDeserializedJsonObj(obj: FieldSummaryCommandDescriptor, isParentJsonObj?: boolean): object;
}

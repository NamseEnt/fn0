...
export declare namespace StatsCommandDescriptor {
    function getJsonObj(obj: StatsCommandDescriptor, isParentJsonObj?: boolean): object;
    const name = "STATS";
    function getDeserializedJsonObj(obj: StatsCommandDescriptor, isParentJsonObj?: boolean): object;
}

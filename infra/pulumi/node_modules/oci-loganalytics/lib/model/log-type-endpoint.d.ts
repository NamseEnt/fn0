...
export declare namespace LogTypeEndpoint {
    function getJsonObj(obj: LogTypeEndpoint, isParentJsonObj?: boolean): object;
    const endpointType = "LOG";
    function getDeserializedJsonObj(obj: LogTypeEndpoint, isParentJsonObj?: boolean): object;
}

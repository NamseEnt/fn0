...
export declare namespace OverlappingRecallSummary {
    function getJsonObj(obj: OverlappingRecallSummary): object;
    function getDeserializedJsonObj(obj: OverlappingRecallSummary): object;
}

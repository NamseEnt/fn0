...
export interface GeoStatsCommandDescriptor extends model.AbstractCommandDescriptor {
     ...
     *
     */
    "continentField"?: model.FieldsAddRemoveField | model.FunctionField | model.Field | model.SortField;
    /**
     * The coordinates field to use. Only applicable when include = CUSTOM.
     *
     */
    "coordinatesField"?: model.FieldsAddRemoveField | model.FunctionField | model.Field | model.SortField;
    /**
...
export declare namespace GeoStatsCommandDescriptor {
    enum Include {
        Client = "CLIENT",
        Server = "SERVER",
    ...
    function getJsonObj(obj: GeoStatsCommandDescriptor, isParentJsonObj?: boolean): object;
    const name = "GEO_STATS";
    function getDeserializedJsonObj(obj: GeoStatsCommandDescriptor, isParentJsonObj?: boolean): object;
}

...
export declare namespace LogAnalyticsExtendedField {
    function getJsonObj(obj: LogAnalyticsExtendedField): object;
    function getDeserializedJsonObj(obj: LogAnalyticsExtendedField): object;
}

...
export interface AbstractParserTestResultLogLine {
     ...
     */
    "grpNameValueMap"?: {
        [key: string]: model.NamedCaptureValue;
    };
}
export declare namespace AbstractParserTestResultLogLine {
    function getJsonObj(obj: AbstractParserTestResultLogLine): object;
    function getDeserializedJsonObj(obj: AbstractParserTestResultLogLine): object;
}

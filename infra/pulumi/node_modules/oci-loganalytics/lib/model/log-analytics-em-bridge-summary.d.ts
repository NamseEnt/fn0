...
export declare namespace LogAnalyticsEmBridgeSummary {
    function getJsonObj(obj: LogAnalyticsEmBridgeSummary): object;
    function getDeserializedJsonObj(obj: LogAnalyticsEmBridgeSummary): object;
}

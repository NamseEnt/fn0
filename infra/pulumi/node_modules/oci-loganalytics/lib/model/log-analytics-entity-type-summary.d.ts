...
export declare namespace LogAnalyticsEntityTypeSummary {
    ...
    function getJsonObj(obj: LogAnalyticsEntityTypeSummary): object;
    function getDeserializedJsonObj(obj: LogAnalyticsEntityTypeSummary): object;
}

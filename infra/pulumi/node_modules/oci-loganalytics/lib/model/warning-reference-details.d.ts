...
export declare namespace WarningReferenceDetails {
    function getJsonObj(obj: WarningReferenceDetails): object;
    function getDeserializedJsonObj(obj: WarningReferenceDetails): object;
}

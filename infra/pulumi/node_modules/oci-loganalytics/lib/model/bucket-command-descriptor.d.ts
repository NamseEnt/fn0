...
export declare namespace BucketCommandDescriptor {
    function getJsonObj(obj: BucketCommandDescriptor, isParentJsonObj?: boolean): object;
    const name = "BUCKET";
    function getDeserializedJsonObj(obj: BucketCommandDescriptor, isParentJsonObj?: boolean): object;
}

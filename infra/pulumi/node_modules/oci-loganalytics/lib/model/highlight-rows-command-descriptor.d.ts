...
export declare namespace HighlightRowsCommandDescriptor {
    function getJsonObj(obj: HighlightRowsCommandDescriptor, isParentJsonObj?: boolean): object;
    const name = "HIGHLIGHT_ROWS";
    function getDeserializedJsonObj(obj: HighlightRowsCommandDescriptor, isParentJsonObj?: boolean): object;
}

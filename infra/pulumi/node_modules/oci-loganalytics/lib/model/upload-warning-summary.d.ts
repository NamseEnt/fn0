...
export declare namespace UploadWarningSummary {
    function getJsonObj(obj: UploadWarningSummary): object;
    function getDeserializedJsonObj(obj: UploadWarningSummary): object;
}

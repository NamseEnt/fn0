...
export declare namespace DeltaCommandDescriptor {
    function getJsonObj(obj: DeltaCommandDescriptor, isParentJsonObj?: boolean): object;
    const name = "DELTA";
    function getDeserializedJsonObj(obj: DeltaCommandDescriptor, isParentJsonObj?: boolean): object;
}

...
export declare namespace IngestTimeRuleAdditionalFieldCondition {
    ...
    function getJsonObj(obj: IngestTimeRuleAdditionalFieldCondition): object;
    function getDeserializedJsonObj(obj: IngestTimeRuleAdditionalFieldCondition): object;
}

...
export declare namespace ClusterCompareCommandDescriptor {
    function getJsonObj(obj: ClusterCompareCommandDescriptor, isParentJsonObj?: boolean): object;
    const name = "CLUSTER_COMPARE";
    function getDeserializedJsonObj(obj: ClusterCompareCommandDescriptor, isParentJsonObj?: boolean): object;
}

 ...
 *
 **/
export declare enum ObjectCollectionRuleCollectionTypes {
    Live = "LIVE",
    Historic = "HISTORIC",
...
export declare namespace ObjectCollectionRuleCollectionTypes {
    function getJsonObj(obj: ObjectCollectionRuleCollectionTypes): ObjectCollectionRuleCollectionTypes;
    function getDeserializedJsonObj(obj: ObjectCollectionRuleCollectionTypes): ObjectCollectionRuleCollectionTypes;
}

...
export declare namespace EventStatsCommandDescriptor {
    function getJsonObj(obj: EventStatsCommandDescriptor, isParentJsonObj?: boolean): object;
    const name = "EVENT_STATS";
    function getDeserializedJsonObj(obj: EventStatsCommandDescriptor, isParentJsonObj?: boolean): object;
}

...
export declare namespace LogAnalyticsLabelAlias {
    enum Priority {
        None = "NONE",
        Low = "LOW",
        Medium = "MEDIUM",
    ...
    function getJsonObj(obj: LogAnalyticsLabelAlias): object;
    function getDeserializedJsonObj(obj: LogAnalyticsLabelAlias): object;
}

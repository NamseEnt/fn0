...
export declare namespace LogAnalyticsParser {
    enum Type {
        Xml = "XML",
        Json = "JSON",
        Regex = "REGEX",
    ...
    function getJsonObj(obj: LogAnalyticsParser): object;
    function getDeserializedJsonObj(obj: LogAnalyticsParser): object;
}

...
export declare namespace SourceMappingResponse {
    function getJsonObj(obj: SourceMappingResponse): object;
    function getDeserializedJsonObj(obj: SourceMappingResponse): object;
}

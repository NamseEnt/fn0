...
export declare namespace HighlightGroupsCommandDescriptor {
    function getJsonObj(obj: HighlightGroupsCommandDescriptor, isParentJsonObj?: boolean): object;
    const name = "HIGHLIGHT_GROUPS";
    function getDeserializedJsonObj(obj: HighlightGroupsCommandDescriptor, isParentJsonObj?: boolean): object;
}

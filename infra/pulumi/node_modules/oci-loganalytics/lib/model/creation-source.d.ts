...
export declare namespace CreationSource {
    function getJsonObj(obj: CreationSource): object;
    function getDeserializedJsonObj(obj: CreationSource): object;
}

...
export declare namespace SearchCommandDescriptor {
    function getJsonObj(obj: SearchCommandDescriptor, isParentJsonObj?: boolean): object;
    const name = "SEARCH";
    function getDeserializedJsonObj(obj: SearchCommandDescriptor, isParentJsonObj?: boolean): object;
}

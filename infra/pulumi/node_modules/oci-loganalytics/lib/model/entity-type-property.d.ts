...
export declare namespace EntityTypeProperty {
    function getJsonObj(obj: EntityTypeProperty): object;
    function getDeserializedJsonObj(obj: EntityTypeProperty): object;
}

...
export declare namespace ExtractLogHeaderResults {
    function getJsonObj(obj: ExtractLogHeaderResults): object;
    function getDeserializedJsonObj(obj: ExtractLogHeaderResults): object;
}

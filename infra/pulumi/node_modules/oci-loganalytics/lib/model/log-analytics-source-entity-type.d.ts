...
export declare namespace LogAnalyticsSourceEntityType {
    function getJsonObj(obj: LogAnalyticsSourceEntityType): object;
    function getDeserializedJsonObj(obj: LogAnalyticsSourceEntityType): object;
}

...
export declare namespace LogAnalyticsConfigWorkRequestSummary {
    enum OperationType {
    ...
    function getJsonObj(obj: LogAnalyticsConfigWorkRequestSummary): object;
    function getDeserializedJsonObj(obj: LogAnalyticsConfigWorkRequestSummary): object;
}

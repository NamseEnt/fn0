...
export declare namespace QueryWorkRequestSummary {
    function getJsonObj(obj: QueryWorkRequestSummary): object;
    function getDeserializedJsonObj(obj: QueryWorkRequestSummary): object;
}

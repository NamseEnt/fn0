...
export declare namespace LogAnalyticsImportCustomChangeList {
    function getJsonObj(obj: LogAnalyticsImportCustomChangeList): object;
    function getDeserializedJsonObj(obj: LogAnalyticsImportCustomChangeList): object;
}

...
export interface ListQueryWorkRequestsResponse {
    /**
    ...
    "opcPrevPage": string;
    /**
     * The returned model.QueryWorkRequestCollection instance.
     */
    "queryWorkRequestCollection": model.QueryWorkRequestCollection;
}

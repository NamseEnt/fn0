...
export interface ListSourceMetaFunctionsResponse {
    /**
    ...
    "opcRequestId": string;
    /**
     * The returned model.LogAnalyticsMetaFunctionCollection instance.
     */
    "logAnalyticsMetaFunctionCollection": model.LogAnalyticsMetaFunctionCollection;
}

...
export interface ListParserActionsResponse {
    /**
    ...
    "opcRequestId": string;
    /**
     * The returned model.ParserActionSummaryCollection instance.
     */
    "parserActionSummaryCollection": model.ParserActionSummaryCollection;
}

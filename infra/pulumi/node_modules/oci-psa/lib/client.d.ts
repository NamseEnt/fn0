...
export declare enum PrivateServiceAccessApiKeys {
}
/**
 * This service client uses {@link common.CircuitBreaker.DefaultConfiguration} for all the operations by default if no circuit breaker configuration is defined by the user.
 */
export declare class PrivateServiceAccessClient {
     ...
     */
    createWaiters(config?: common.WaiterConfiguration): PrivateServiceAccessWaiter;
    /**
     * Gets the waiters available for resources for this service.
     *
     * @return The service waiters.
     */
    getWaiters(): PrivateServiceAccessWaiter;
    /**
     ...
     */
    cancelPsaWorkRequest(cancelPsaWorkRequestRequest: requests.CancelPsaWorkRequestRequest): Promise<responses.CancelPsaWorkRequestResponse>;
    /**
     ...
     */
    changePrivateServiceAccessCompartment(changePrivateServiceAccessCompartmentRequest: requests.ChangePrivateServiceAccessCompartmentRequest): Promise<responses.ChangePrivateServiceAccessCompartmentResponse>;
    /**
     ...
     */
    createPrivateServiceAccess(createPrivateServiceAccessRequest: requests.CreatePrivateServiceAccessRequest): Promise<responses.CreatePrivateServiceAccessResponse>;
    /**
     ...
     */
    deletePrivateServiceAccess(deletePrivateServiceAccessRequest: requests.DeletePrivateServiceAccessRequest): Promise<responses.DeletePrivateServiceAccessResponse>;
    /**
     ...
     */
    getPrivateServiceAccess(getPrivateServiceAccessRequest: requests.GetPrivateServiceAccessRequest): Promise<responses.GetPrivateServiceAccessResponse>;
    /**
     ...
     */
    getPsaWorkRequest(getPsaWorkRequestRequest: requests.GetPsaWorkRequestRequest): Promise<responses.GetPsaWorkRequestResponse>;
    /**
     ...
     */
    listPrivateServiceAccesses(listPrivateServiceAccessesRequest: requests.ListPrivateServiceAccessesRequest): Promise<responses.ListPrivateServiceAccessesResponse>;
    /**
     ...
     */
    listPsaServices(listPsaServicesRequest: requests.ListPsaServicesRequest): Promise<responses.ListPsaServicesResponse>;
    /**
     ...
     */
    listPsaWorkRequestErrors(listPsaWorkRequestErrorsRequest: requests.ListPsaWorkRequestErrorsRequest): Promise<responses.ListPsaWorkRequestErrorsResponse>;
    /**
     ...
     */
    listPsaWorkRequestLogs(listPsaWorkRequestLogsRequest: requests.ListPsaWorkRequestLogsRequest): Promise<responses.ListPsaWorkRequestLogsResponse>;
    /**
     ...
     */
    listPsaWorkRequests(listPsaWorkRequestsRequest: requests.ListPsaWorkRequestsRequest): Promise<responses.ListPsaWorkRequestsResponse>;
    /**
     ...
     */
    updatePrivateServiceAccess(updatePrivateServiceAccessRequest: requests.UpdatePrivateServiceAccessRequest): Promise<responses.UpdatePrivateServiceAccessResponse>;
}
export {};

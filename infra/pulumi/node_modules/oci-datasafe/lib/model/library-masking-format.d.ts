...
export declare namespace LibraryMaskingFormat {
    function getJsonObj(obj: LibraryMaskingFormat): object;
    function getDeserializedJsonObj(obj: LibraryMaskingFormat): object;
}

...
export declare namespace PatchTargetAlertPolicyAssociationDetails {
    function getJsonObj(obj: PatchTargetAlertPolicyAssociationDetails): object;
    function getDeserializedJsonObj(obj: PatchTargetAlertPolicyAssociationDetails): object;
}

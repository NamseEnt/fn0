...
export declare namespace RandomListFormatEntry {
    function getJsonObj(obj: RandomListFormatEntry, isParentJsonObj?: boolean): object;
    const type = "RANDOM_LIST";
    function getDeserializedJsonObj(obj: RandomListFormatEntry, isParentJsonObj?: boolean): object;
}

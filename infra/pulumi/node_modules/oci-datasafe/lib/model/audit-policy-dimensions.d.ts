...
export declare namespace AuditPolicyDimensions {
    function getJsonObj(obj: AuditPolicyDimensions): object;
    function getDeserializedJsonObj(obj: AuditPolicyDimensions): object;
}

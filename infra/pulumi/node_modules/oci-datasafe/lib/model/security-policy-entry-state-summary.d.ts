...
export declare namespace SecurityPolicyEntryStateSummary {
    enum EntryType {
    ...
    function getJsonObj(obj: SecurityPolicyEntryStateSummary): object;
    function getDeserializedJsonObj(obj: SecurityPolicyEntryStateSummary): object;
}

 ...
 *
 */
export interface SensitiveTypesExportSummary {
    /**
...
export declare namespace SensitiveTypesExportSummary {
    function getJsonObj(obj: SensitiveTypesExportSummary): object;
    function getDeserializedJsonObj(obj: SensitiveTypesExportSummary): object;
}

 ...
 */
export interface UpdateUnifiedAuditPolicyDetails {
    /**
...
export declare namespace UpdateUnifiedAuditPolicyDetails {
    function getJsonObj(obj: UpdateUnifiedAuditPolicyDetails): object;
    function getDeserializedJsonObj(obj: UpdateUnifiedAuditPolicyDetails): object;
}

...
export declare namespace SensitiveColumnCollection {
    function getJsonObj(obj: SensitiveColumnCollection): object;
    function getDeserializedJsonObj(obj: SensitiveColumnCollection): object;
}

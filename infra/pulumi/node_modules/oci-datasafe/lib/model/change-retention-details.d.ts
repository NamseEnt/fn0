...
export declare namespace ChangeRetentionDetails {
    function getJsonObj(obj: ChangeRetentionDetails): object;
    function getDeserializedJsonObj(obj: ChangeRetentionDetails): object;
}

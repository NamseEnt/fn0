...
export declare namespace DiscoveryJobResult {
    enum DiscoveryType {
        New = "NEW",
        Modified = "MODIFIED",
        Deleted = "DELETED",
    ...
    function getJsonObj(obj: DiscoveryJobResult): object;
    function getDeserializedJsonObj(obj: DiscoveryJobResult): object;
}

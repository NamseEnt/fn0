...
export declare namespace UpdateSqlFirewallPolicyDetails {
    enum Status {
        Enabled = "ENABLED",
        Disabled = "DISABLED"
    }
    ...
    function getJsonObj(obj: UpdateSqlFirewallPolicyDetails): object;
    function getDeserializedJsonObj(obj: UpdateSqlFirewallPolicyDetails): object;
}

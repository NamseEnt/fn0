...
export declare namespace MaskingPolicyReferentialRelationSummary {
    enum RelationType {
        None = "NONE",
    ...
    function getJsonObj(obj: MaskingPolicyReferentialRelationSummary): object;
    function getDeserializedJsonObj(obj: MaskingPolicyReferentialRelationSummary): object;
}

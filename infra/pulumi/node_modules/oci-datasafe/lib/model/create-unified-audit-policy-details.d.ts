...
export declare namespace CreateUnifiedAuditPolicyDetails {
    function getJsonObj(obj: CreateUnifiedAuditPolicyDetails): object;
    function getDeserializedJsonObj(obj: CreateUnifiedAuditPolicyDetails): object;
}

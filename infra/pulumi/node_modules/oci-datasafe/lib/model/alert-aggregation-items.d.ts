...
export declare namespace AlertAggregationItems {
    function getJsonObj(obj: AlertAggregationItems): object;
    function getDeserializedJsonObj(obj: AlertAggregationItems): object;
}

...
export declare namespace TargetDatabaseGroup {
    function getJsonObj(obj: TargetDatabaseGroup): object;
    function getDeserializedJsonObj(obj: TargetDatabaseGroup): object;
}

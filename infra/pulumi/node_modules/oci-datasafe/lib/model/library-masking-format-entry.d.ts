...
export declare namespace LibraryMaskingFormatEntry {
    function getJsonObj(obj: LibraryMaskingFormatEntry, isParentJsonObj?: boolean): object;
    const type = "LIBRARY_MASKING_FORMAT";
    function getDeserializedJsonObj(obj: LibraryMaskingFormatEntry, isParentJsonObj?: boolean): object;
}

...
export declare namespace UpdateOnPremConnectorWalletDetails {
    function getJsonObj(obj: UpdateOnPremConnectorWalletDetails): object;
    function getDeserializedJsonObj(obj: UpdateOnPremConnectorWalletDetails): object;
}

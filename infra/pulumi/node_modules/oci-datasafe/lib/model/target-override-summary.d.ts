...
export declare namespace TargetOverrideSummary {
    function getJsonObj(obj: TargetOverrideSummary): object;
    function getDeserializedJsonObj(obj: TargetOverrideSummary): object;
}

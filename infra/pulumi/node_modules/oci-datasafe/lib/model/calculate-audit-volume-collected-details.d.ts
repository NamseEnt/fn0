 ...
 */
export interface CalculateAuditVolumeCollectedDetails {
    /**
...
export declare namespace CalculateAuditVolumeCollectedDetails {
    function getJsonObj(obj: CalculateAuditVolumeCollectedDetails): object;
    function getDeserializedJsonObj(obj: CalculateAuditVolumeCollectedDetails): object;
}

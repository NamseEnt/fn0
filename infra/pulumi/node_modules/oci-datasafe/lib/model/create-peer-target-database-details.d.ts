...
export declare namespace CreatePeerTargetDatabaseDetails {
    function getJsonObj(obj: CreatePeerTargetDatabaseDetails): object;
    function getDeserializedJsonObj(obj: CreatePeerTargetDatabaseDetails): object;
}

...
export declare namespace SecurityPolicyConfig {
    function getJsonObj(obj: SecurityPolicyConfig): object;
    function getDeserializedJsonObj(obj: SecurityPolicyConfig): object;
}

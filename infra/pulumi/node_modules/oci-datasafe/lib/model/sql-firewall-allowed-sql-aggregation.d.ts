...
export declare namespace SqlFirewallAllowedSqlAggregation {
    function getJsonObj(obj: SqlFirewallAllowedSqlAggregation): object;
    function getDeserializedJsonObj(obj: SqlFirewallAllowedSqlAggregation): object;
}

...
export declare namespace AvailableAuditVolumeSummary {
    function getJsonObj(obj: AvailableAuditVolumeSummary): object;
    function getDeserializedJsonObj(obj: AvailableAuditVolumeSummary): object;
}

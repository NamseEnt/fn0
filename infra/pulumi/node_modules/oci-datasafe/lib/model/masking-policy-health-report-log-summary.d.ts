...
export declare namespace MaskingPolicyHealthReportLogSummary {
    enum MessageType {
        Pass = "PASS",
        Warning = "WARNING",
        Error = "ERROR",
    ...
    function getJsonObj(obj: MaskingPolicyHealthReportLogSummary): object;
    function getDeserializedJsonObj(obj: MaskingPolicyHealthReportLogSummary): object;
}

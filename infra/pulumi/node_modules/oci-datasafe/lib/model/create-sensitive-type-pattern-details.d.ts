 ...
 */
export interface CreateSensitiveTypePatternDetails extends model.CreateSensitiveTypeDetails {
    /**
...
export declare namespace CreateSensitiveTypePatternDetails {
    function getJsonObj(obj: CreateSensitiveTypePatternDetails, isParentJsonObj?: boolean): object;
    const entityType = "SENSITIVE_TYPE";
    function getDeserializedJsonObj(obj: CreateSensitiveTypePatternDetails, isParentJsonObj?: boolean): object;
}

...
export declare namespace CreateSensitiveColumnDetails {
    enum ObjectType {
        Table = "TABLE",
    ...
    function getJsonObj(obj: CreateSensitiveColumnDetails): object;
    function getDeserializedJsonObj(obj: CreateSensitiveColumnDetails): object;
}

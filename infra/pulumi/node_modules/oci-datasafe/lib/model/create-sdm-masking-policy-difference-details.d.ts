...
export declare namespace CreateSdmMaskingPolicyDifferenceDetails {
    function getJsonObj(obj: CreateSdmMaskingPolicyDifferenceDetails): object;
    function getDeserializedJsonObj(obj: CreateSdmMaskingPolicyDifferenceDetails): object;
}

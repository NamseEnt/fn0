...
export declare namespace RandomDateFormatEntry {
    function getJsonObj(obj: RandomDateFormatEntry, isParentJsonObj?: boolean): object;
    const type = "RANDOM_DATE";
    function getDeserializedJsonObj(obj: RandomDateFormatEntry, isParentJsonObj?: boolean): object;
}

...
export declare namespace PrivilegeName {
    function getJsonObj(obj: PrivilegeName): PrivilegeName;
    function getDeserializedJsonObj(obj: PrivilegeName): PrivilegeName;
}

...
export declare namespace SqlFirewallPolicy {
    enum SqlLevel {
    ...
    function getJsonObj(obj: SqlFirewallPolicy): object;
    function getDeserializedJsonObj(obj: SqlFirewallPolicy): object;
}

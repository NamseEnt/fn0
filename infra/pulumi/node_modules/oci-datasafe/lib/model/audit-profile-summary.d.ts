...
export declare namespace AuditProfileSummary {
    function getJsonObj(obj: AuditProfileSummary): object;
    function getDeserializedJsonObj(obj: AuditProfileSummary): object;
}

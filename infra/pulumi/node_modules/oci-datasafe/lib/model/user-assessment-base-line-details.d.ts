...
export declare namespace UserAssessmentBaseLineDetails {
    function getJsonObj(obj: UserAssessmentBaseLineDetails): object;
    function getDeserializedJsonObj(obj: UserAssessmentBaseLineDetails): object;
}

 ...
 */
export interface SensitiveTypeGroup {
    /**
...
export declare namespace SensitiveTypeGroup {
    function getJsonObj(obj: SensitiveTypeGroup): object;
    function getDeserializedJsonObj(obj: SensitiveTypeGroup): object;
}

...
export declare namespace SensitiveTypeSummary {
    function getJsonObj(obj: SensitiveTypeSummary): object;
    function getDeserializedJsonObj(obj: SensitiveTypeSummary): object;
}

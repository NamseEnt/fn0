...
export declare namespace SensitiveTypePattern {
    enum SearchType {
        Or = "OR",
        And = "AND",
        /**
    ...
    function getJsonObj(obj: SensitiveTypePattern, isParentJsonObj?: boolean): object;
    const entityType = "SENSITIVE_TYPE";
    function getDeserializedJsonObj(obj: SensitiveTypePattern, isParentJsonObj?: boolean): object;
}

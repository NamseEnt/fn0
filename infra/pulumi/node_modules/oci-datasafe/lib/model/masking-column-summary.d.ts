...
export declare namespace MaskingColumnSummary {
    function getJsonObj(obj: MaskingColumnSummary): object;
    function getDeserializedJsonObj(obj: MaskingColumnSummary): object;
}

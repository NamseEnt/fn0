...
export declare namespace MaskingPolicyColumnsInfo {
    enum ObjectType {
        Table = "TABLE",
        /**
    ...
    function getJsonObj(obj: MaskingPolicyColumnsInfo): object;
    function getDeserializedJsonObj(obj: MaskingPolicyColumnsInfo): object;
}

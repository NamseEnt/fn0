...
export declare namespace SqlFirewallPolicySummary {
    enum SqlLevel {
    ...
    function getJsonObj(obj: SqlFirewallPolicySummary): object;
    function getDeserializedJsonObj(obj: SqlFirewallPolicySummary): object;
}

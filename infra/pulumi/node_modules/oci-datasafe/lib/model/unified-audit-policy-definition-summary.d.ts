...
export declare namespace UnifiedAuditPolicyDefinitionSummary {
    function getJsonObj(obj: UnifiedAuditPolicyDefinitionSummary): object;
    function getDeserializedJsonObj(obj: UnifiedAuditPolicyDefinitionSummary): object;
}

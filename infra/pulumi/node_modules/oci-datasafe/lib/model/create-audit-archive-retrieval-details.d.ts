...
export declare namespace CreateAuditArchiveRetrievalDetails {
    function getJsonObj(obj: CreateAuditArchiveRetrievalDetails): object;
    function getDeserializedJsonObj(obj: CreateAuditArchiveRetrievalDetails): object;
}

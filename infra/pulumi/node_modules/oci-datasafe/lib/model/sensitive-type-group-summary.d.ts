 ...
 */
export interface SensitiveTypeGroupSummary {
    /**
     ...
     */
    "lifecycleState": model.SensitiveTypeGroupLifecycleState;
    /**
     * The description of the sensitive type group.
     */
    "description"?: string;
    /**
     * The number of sensitive types in the specified sensitive type group. Note: Numbers greater than Number.MAX_SAFE_INTEGER will result in rounding issues.
     */
...
export declare namespace SensitiveTypeGroupSummary {
    function getJsonObj(obj: SensitiveTypeGroupSummary): object;
    function getDeserializedJsonObj(obj: SensitiveTypeGroupSummary): object;
}

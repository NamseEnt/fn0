...
export declare namespace TruncateTableFormatEntry {
    function getJsonObj(obj: TruncateTableFormatEntry, isParentJsonObj?: boolean): object;
    const type = "TRUNCATE_TABLE";
    function getDeserializedJsonObj(obj: TruncateTableFormatEntry, isParentJsonObj?: boolean): object;
}

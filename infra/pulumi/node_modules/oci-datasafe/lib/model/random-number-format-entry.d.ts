...
export declare namespace RandomNumberFormatEntry {
    function getJsonObj(obj: RandomNumberFormatEntry, isParentJsonObj?: boolean): object;
    const type = "RANDOM_NUMBER";
    function getDeserializedJsonObj(obj: RandomNumberFormatEntry, isParentJsonObj?: boolean): object;
}

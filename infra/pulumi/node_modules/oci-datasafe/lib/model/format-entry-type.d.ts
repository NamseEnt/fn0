 ...
 **/
export declare enum FormatEntryType {
...
export declare namespace FormatEntryType {
    function getJsonObj(obj: FormatEntryType): FormatEntryType;
    function getDeserializedJsonObj(obj: FormatEntryType): FormatEntryType;
}

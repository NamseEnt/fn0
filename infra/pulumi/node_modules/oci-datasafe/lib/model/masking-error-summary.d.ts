...
export declare namespace MaskingErrorSummary {
    enum StepName {
        Validate = "VALIDATE",
    ...
    function getJsonObj(obj: MaskingErrorSummary): object;
    function getDeserializedJsonObj(obj: MaskingErrorSummary): object;
}

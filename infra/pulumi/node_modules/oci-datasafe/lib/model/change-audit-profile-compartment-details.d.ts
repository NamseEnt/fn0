...
export declare namespace ChangeAuditProfileCompartmentDetails {
    function getJsonObj(obj: ChangeAuditProfileCompartmentDetails): object;
    function getDeserializedJsonObj(obj: ChangeAuditProfileCompartmentDetails): object;
}

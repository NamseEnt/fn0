...
export declare namespace AuditArchiveRetrieval {
    function getJsonObj(obj: AuditArchiveRetrieval): object;
    function getDeserializedJsonObj(obj: AuditArchiveRetrieval): object;
}

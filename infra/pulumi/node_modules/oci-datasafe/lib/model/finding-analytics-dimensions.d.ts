...
export declare namespace FindingAnalyticsDimensions {
    enum TopFindingStatus {
        Risk = "RISK",
        Evaluate = "EVALUATE",
        Advisory = "ADVISORY",
        Pass = "PASS",
    ...
    function getJsonObj(obj: FindingAnalyticsDimensions): object;
    function getDeserializedJsonObj(obj: FindingAnalyticsDimensions): object;
}

...
export declare namespace AuditEventSummary {
    enum DatabaseType {
    ...
    function getJsonObj(obj: AuditEventSummary): object;
    function getDeserializedJsonObj(obj: AuditEventSummary): object;
}

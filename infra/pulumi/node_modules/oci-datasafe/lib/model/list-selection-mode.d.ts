...
export declare namespace ListSelectionMode {
    function getJsonObj(obj: ListSelectionMode, isParentJsonObj?: boolean): object;
    const selectionMode = "LIST";
    function getDeserializedJsonObj(obj: ListSelectionMode, isParentJsonObj?: boolean): object;
}

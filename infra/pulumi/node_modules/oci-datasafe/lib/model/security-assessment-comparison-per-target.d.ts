...
export declare namespace SecurityAssessmentComparisonPerTarget {
    function getJsonObj(obj: SecurityAssessmentComparisonPerTarget): object;
    function getDeserializedJsonObj(obj: SecurityAssessmentComparisonPerTarget): object;
}

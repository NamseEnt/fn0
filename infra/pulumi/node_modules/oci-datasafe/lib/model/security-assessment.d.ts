...
export declare namespace SecurityAssessment {
    enum TriggeredBy {
        User = "USER",
        System = "SYSTEM",
        /**
    ...
    function getJsonObj(obj: SecurityAssessment): object;
    function getDeserializedJsonObj(obj: SecurityAssessment): object;
}

...
export declare namespace InfrastructureType {
    function getJsonObj(obj: InfrastructureType): InfrastructureType;
    function getDeserializedJsonObj(obj: InfrastructureType): InfrastructureType;
}

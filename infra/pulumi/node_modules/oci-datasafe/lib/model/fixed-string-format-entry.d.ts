...
export declare namespace FixedStringFormatEntry {
    function getJsonObj(obj: FixedStringFormatEntry, isParentJsonObj?: boolean): object;
    const type = "FIXED_STRING";
    function getDeserializedJsonObj(obj: FixedStringFormatEntry, isParentJsonObj?: boolean): object;
}

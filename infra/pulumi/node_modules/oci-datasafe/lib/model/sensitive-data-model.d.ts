...
export declare namespace SensitiveDataModel {
    function getJsonObj(obj: SensitiveDataModel): object;
    function getDeserializedJsonObj(obj: SensitiveDataModel): object;
}

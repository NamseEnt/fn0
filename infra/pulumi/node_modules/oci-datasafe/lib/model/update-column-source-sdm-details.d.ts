...
export declare namespace UpdateColumnSourceSdmDetails {
    function getJsonObj(obj: UpdateColumnSourceSdmDetails, isParentJsonObj?: boolean): object;
    const columnSource = "SENSITIVE_DATA_MODEL";
    function getDeserializedJsonObj(obj: UpdateColumnSourceSdmDetails, isParentJsonObj?: boolean): object;
}

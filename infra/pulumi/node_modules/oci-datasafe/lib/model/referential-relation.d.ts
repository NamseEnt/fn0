 ...
 *
 */
export interface ReferentialRelation {
    /**
     ...
     *
     */
    "relationType": ReferentialRelation.RelationType;
...
export declare namespace ReferentialRelation {
    enum RelationType {
        None = "NONE",
    ...
    function getJsonObj(obj: ReferentialRelation): object;
    function getDeserializedJsonObj(obj: ReferentialRelation): object;
}

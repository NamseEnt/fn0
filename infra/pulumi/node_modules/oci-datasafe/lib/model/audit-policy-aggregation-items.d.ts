...
export declare namespace AuditPolicyAggregationItems {
    function getJsonObj(obj: AuditPolicyAggregationItems): object;
    function getDeserializedJsonObj(obj: AuditPolicyAggregationItems): object;
}

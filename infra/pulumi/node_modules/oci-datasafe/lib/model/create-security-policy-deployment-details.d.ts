 ...
 */
export interface CreateSecurityPolicyDeploymentDetails {
    /**
...
export declare namespace CreateSecurityPolicyDeploymentDetails {
    function getJsonObj(obj: CreateSecurityPolicyDeploymentDetails): object;
    function getDeserializedJsonObj(obj: CreateSecurityPolicyDeploymentDetails): object;
}

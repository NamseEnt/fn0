...
export declare namespace CreateColumnSourceFromSdmDetails {
    function getJsonObj(obj: CreateColumnSourceFromSdmDetails, isParentJsonObj?: boolean): object;
    const columnSource = "SENSITIVE_DATA_MODEL";
    function getDeserializedJsonObj(obj: CreateColumnSourceFromSdmDetails, isParentJsonObj?: boolean): object;
}

...
export declare namespace SqlFirewallAllowedSqlDimensions {
    enum SqlLevel {
    ...
    function getJsonObj(obj: SqlFirewallAllowedSqlDimensions): object;
    function getDeserializedJsonObj(obj: SqlFirewallAllowedSqlDimensions): object;
}

...
export declare namespace SecurityPolicyReport {
    function getJsonObj(obj: SecurityPolicyReport): object;
    function getDeserializedJsonObj(obj: SecurityPolicyReport): object;
}

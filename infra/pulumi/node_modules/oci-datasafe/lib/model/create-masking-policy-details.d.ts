...
export interface CreateMaskingPolicyDetails {
    ...
    "columnSource": model.CreateColumnSourceFromTargetDetails | model.CreateColumnSourceFromSdmDetails;
    /**
...
export declare namespace CreateMaskingPolicyDetails {
    function getJsonObj(obj: CreateMaskingPolicyDetails): object;
    function getDeserializedJsonObj(obj: CreateMaskingPolicyDetails): object;
}

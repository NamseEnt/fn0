...
export declare namespace SdmMaskingPolicyDifferenceSummary {
    function getJsonObj(obj: SdmMaskingPolicyDifferenceSummary): object;
    function getDeserializedJsonObj(obj: SdmMaskingPolicyDifferenceSummary): object;
}

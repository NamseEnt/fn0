...
export declare namespace DeterministicSubstitutionFormatEntry {
    function getJsonObj(obj: DeterministicSubstitutionFormatEntry, isParentJsonObj?: boolean): object;
    const type = "DETERMINISTIC_SUBSTITUTION";
    function getDeserializedJsonObj(obj: DeterministicSubstitutionFormatEntry, isParentJsonObj?: boolean): object;
}

...
export declare namespace DatabaseTableAccessEntrySummary {
    function getJsonObj(obj: DatabaseTableAccessEntrySummary): object;
    function getDeserializedJsonObj(obj: DatabaseTableAccessEntrySummary): object;
}

...
export declare namespace PrivateEndpoint {
    function getJsonObj(obj: PrivateEndpoint, isParentJsonObj?: boolean): object;
    const connectionType = "PRIVATE_ENDPOINT";
    function getDeserializedJsonObj(obj: PrivateEndpoint, isParentJsonObj?: boolean): object;
}

...
export declare namespace PatternFormatEntry {
    function getJsonObj(obj: PatternFormatEntry, isParentJsonObj?: boolean): object;
    const type = "PATTERN";
    function getDeserializedJsonObj(obj: PatternFormatEntry, isParentJsonObj?: boolean): object;
}

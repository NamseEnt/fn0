...
export declare namespace SqlFirewallViolationAggregationDimensions {
    enum SqlLevel {
    ...
    function getJsonObj(obj: SqlFirewallViolationAggregationDimensions): object;
    function getDeserializedJsonObj(obj: SqlFirewallViolationAggregationDimensions): object;
}

...
class DataSafeWaiter {
     ...
     */
    forAlertPolicyRule(request, ...targetStates) {
        return __awaiter(this, void 0, void 0, function* () {
            return oci_common_1.genericWaiter(this.config, () => this.client.getAlertPolicyRule(request), response => targetStates.includes(response.alertPolicyRule.lifecycleState));
        });
    }
    /**
     ...
     */
    forAttributeSet(request, ...targetStates) {
        return __awaiter(this, void 0, void 0, function* () {
            return oci_common_1.genericWaiter(this.config, () => this.client.getAttributeSet(request), response => targetStates.includes(response.attributeSet.lifecycleState));
        });
    }
    /**
     ...
     */
    forDatabaseSecurityConfig(request, ...targetStates) {
        return __awaiter(this, void 0, void 0, function* () {
            return oci_common_1.genericTerminalConditionWaiter(this.config, () => this.client.getDatabaseSecurityConfig(request), response => targetStates.includes(response.databaseSecurityConfig.lifecycleState), targetStates.includes(models.DatabaseSecurityConfigLifecycleState.Deleted));
        });
    }
    /**
     ...
     */
    forMaskingPolicyHealthReport(request, ...targetStates) {
        return __awaiter(this, void 0, void 0, function* () {
            return oci_common_1.genericWaiter(this.config, () => this.client.getMaskingPolicyHealthReport(request), response => targetStates.includes(response.maskingPolicyHealthReport.lifecycleState));
        });
    }
    /**
    ...
    forOnPremConnector(request, ...targetStates) {
        return __awaiter(this, void 0, void 0, function* () {
            return oci_common_1.genericTerminalConditionWaiter(this.config, () => this.client.getOnPremConnector(request), response => targetStates.includes(response.onPremConnector.lifecycleState), targetStates.includes(models.OnPremConnectorLifecycleState.Deleted));
        });
    }
    /**
     ...
     */
    forPeerTargetDatabase(request, ...targetStates) {
        return __awaiter(this, void 0, void 0, function* () {
            return oci_common_1.genericTerminalConditionWaiter(this.config, () => this.client.getPeerTargetDatabase(request), response => targetStates.includes(response.peerTargetDatabase.lifecycleState), targetStates.includes(models.TargetDatabaseLifecycleState.Deleted));
        });
    }
    /**
     ...
     */
    forReferentialRelation(request, ...targetStates) {
        return __awaiter(this, void 0, void 0, function* () {
            return oci_common_1.genericWaiter(this.config, () => this.client.getReferentialRelation(request), response => targetStates.includes(response.referentialRelation.lifecycleState));
        });
    }
    /**
    ...
    forSecurityAssessmentComparison(request, ...targetStates) {
        return __awaiter(this, void 0, void 0, function* () {
            return oci_common_1.genericTerminalConditionWaiter(this.config, () => this.client.getSecurityAssessmentComparison(request), response => targetStates.includes(response.securityAssessmentComparison.lifecycleState), targetStates.includes(models.SecurityAssessmentComparison.LifecycleState.Deleted));
        });
    }
    /**
    ...
    forSecurityPolicy(request, ...targetStates) {
        return __awaiter(this, void 0, void 0, function* () {
            return oci_common_1.genericTerminalConditionWaiter(this.config, () => this.client.getSecurityPolicy(request), response => targetStates.includes(response.securityPolicy.lifecycleState), targetStates.includes(models.SecurityPolicyLifecycleState.Deleted));
        });
    }
    /**
     ...
     */
    forSecurityPolicyConfig(request, ...targetStates) {
        return __awaiter(this, void 0, void 0, function* () {
            return oci_common_1.genericTerminalConditionWaiter(this.config, () => this.client.getSecurityPolicyConfig(request), response => targetStates.includes(response.securityPolicyConfig.lifecycleState), targetStates.includes(models.SecurityPolicyConfigLifecycleState.Deleted));
        });
    }
    /**
     ...
     */
    forSecurityPolicyDeployment(request, ...targetStates) {
        return __awaiter(this, void 0, void 0, function* () {
            return oci_common_1.genericTerminalConditionWaiter(this.config, () => this.client.getSecurityPolicyDeployment(request), response => targetStates.includes(response.securityPolicyDeployment.lifecycleState), targetStates.includes(models.SecurityPolicyDeploymentLifecycleState.Deleted));
        });
    }
    /**
     ...
     */
    forSecurityPolicyReport(request, ...targetStates) {
        return __awaiter(this, void 0, void 0, function* () {
            return oci_common_1.genericTerminalConditionWaiter(this.config, () => this.client.getSecurityPolicyReport(request), response => targetStates.includes(response.securityPolicyReport.lifecycleState), targetStates.includes(models.SecurityPolicyReportLifecycleState.Deleted));
        });
    }
    /**
     ...
     */
    forSensitiveTypeGroup(request, ...targetStates) {
        return __awaiter(this, void 0, void 0, function* () {
            return oci_common_1.genericTerminalConditionWaiter(this.config, () => this.client.getSensitiveTypeGroup(request), response => targetStates.includes(response.sensitiveTypeGroup.lifecycleState), targetStates.includes(models.SensitiveTypeGroupLifecycleState.Deleted));
        });
    }
    /**
     ...
     */
    forSensitiveTypesExport(request, ...targetStates) {
        return __awaiter(this, void 0, void 0, function* () {
            return oci_common_1.genericTerminalConditionWaiter(this.config, () => this.client.getSensitiveTypesExport(request), response => targetStates.includes(response.sensitiveTypesExport.lifecycleState), targetStates.includes(models.SensitiveTypesExportLifecycleState.Deleted));
        });
    }
    /**
     ...
     */
    forSqlCollection(request, ...targetStates) {
        return __awaiter(this, void 0, void 0, function* () {
            return oci_common_1.genericTerminalConditionWaiter(this.config, () => this.client.getSqlCollection(request), response => targetStates.includes(response.sqlCollection.lifecycleState), targetStates.includes(models.SqlCollectionLifecycleState.Deleted));
        });
    }
    /**
     ...
     */
    forSqlFirewallAllowedSql(request, ...targetStates) {
        return __awaiter(this, void 0, void 0, function* () {
            return oci_common_1.genericTerminalConditionWaiter(this.config, () => this.client.getSqlFirewallAllowedSql(request), response => targetStates.includes(response.sqlFirewallAllowedSql.lifecycleState), targetStates.includes(models.SqlFirewallAllowedSqlLifecycleState.Deleted));
        });
    }
    /**
     ...
     */
    forSqlFirewallPolicy(request, ...targetStates) {
        return __awaiter(this, void 0, void 0, function* () {
            return oci_common_1.genericTerminalConditionWaiter(this.config, () => this.client.getSqlFirewallPolicy(request), response => targetStates.includes(response.sqlFirewallPolicy.lifecycleState), targetStates.includes(models.SqlFirewallPolicyLifecycleState.Deleted));
        });
    }
    /**
     ...
     */
    forTargetDatabaseGroup(request, ...targetStates) {
        return __awaiter(this, void 0, void 0, function* () {
            return oci_common_1.genericTerminalConditionWaiter(this.config, () => this.client.getTargetDatabaseGroup(request), response => targetStates.includes(response.targetDatabaseGroup.lifecycleState), targetStates.includes(models.TargetDatabaseGroupLifecycleState.Deleted));
        });
    }
    /**
     ...
     */
    forUnifiedAuditPolicy(request, ...targetStates) {
        return __awaiter(this, void 0, void 0, function* () {
            return oci_common_1.genericTerminalConditionWaiter(this.config, () => this.client.getUnifiedAuditPolicy(request), response => targetStates.includes(response.unifiedAuditPolicy.lifecycleState), targetStates.includes(models.UnifiedAuditPolicyLifecycleState.Deleted));
        });
    }
    /**
     ...
     */
    forUnifiedAuditPolicyDefinition(request, ...targetStates) {
        return __awaiter(this, void 0, void 0, function* () {
            return oci_common_1.genericWaiter(this.config, () => this.client.getUnifiedAuditPolicyDefinition(request), response => targetStates.includes(response.unifiedAuditPolicyDefinition.lifecycleState));
        });
    }
    /**

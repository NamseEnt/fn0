...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/datasafe/ListDataSafePrivateEndpoints.ts.html |here} to see how to use ListDataSafePrivateEndpointsRequest.
 */
...
export declare namespace ListDataSafePrivateEndpointsRequest {
    enum SortOrder {
        Asc = "ASC",
        Desc = "DESC"
    }

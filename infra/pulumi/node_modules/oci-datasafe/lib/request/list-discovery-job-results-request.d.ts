...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/datasafe/ListDiscoveryJobResults.ts.html |here} to see how to use ListDiscoveryJobResultsRequest.
 */
...
export declare namespace ListDiscoveryJobResultsRequest {
    enum SortOrder {
        Asc = "ASC",
        Desc = "DESC"
    }

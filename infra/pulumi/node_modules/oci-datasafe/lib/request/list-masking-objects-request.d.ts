...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/datasafe/ListMaskingObjects.ts.html |here} to see how to use ListMaskingObjectsRequest.
 */
...
export declare namespace ListMaskingObjectsRequest {
    enum SortOrder {
        Asc = "ASC",
        Desc = "DESC"
    }

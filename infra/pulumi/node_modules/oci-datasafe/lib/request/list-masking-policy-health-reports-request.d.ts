...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/datasafe/ListMaskingPolicyHealthReports.ts.html |here} to see how to use ListMaskingPolicyHealthReportsRequest.
 */
...
export declare namespace ListMaskingPolicyHealthReportsRequest {
    enum AccessLevel {

...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/datasafe/ListMaskingReports.ts.html |here} to see how to use ListMaskingReportsRequest.
 */
...
export declare namespace ListMaskingReportsRequest {
    enum SortOrder {
        Asc = "ASC",
        Desc = "DESC"
    }

...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/datasafe/ListAuditPolicies.ts.html |here} to see how to use ListAuditPoliciesRequest.
 */
export interface ListAuditPoliciesRequest extends common.BaseRequest {
    /**
...
export declare namespace ListAuditPoliciesRequest {
    enum AccessLevel {

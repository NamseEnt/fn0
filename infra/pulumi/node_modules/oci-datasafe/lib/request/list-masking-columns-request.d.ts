...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/datasafe/ListMaskingColumns.ts.html |here} to see how to use ListMaskingColumnsRequest.
 */
...
export declare namespace ListMaskingColumnsRequest {
    enum SortOrder {
        Asc = "ASC",
        Desc = "DESC"
    }

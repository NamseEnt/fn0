...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/datasafe/ListSecurityAssessments.ts.html |here} to see how to use ListSecurityAssessmentsRequest.
 */
...
export declare namespace ListSecurityAssessmentsRequest {
    enum AccessLevel {

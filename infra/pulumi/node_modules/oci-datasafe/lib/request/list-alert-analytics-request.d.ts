...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/datasafe/ListAlertAnalytics.ts.html |here} to see how to use ListAlertAnalyticsRequest.
 */
...
export declare namespace ListAlertAnalyticsRequest {
    enum SortOrder {
        Asc = "ASC",
        Desc = "DESC"
    }

...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/datasafe/ListAttributeSets.ts.html |here} to see how to use ListAttributeSetsRequest.
 */
export interface ListAttributeSetsRequest extends common.BaseRequest {
    /**
...
export declare namespace ListAttributeSetsRequest {
    enum AccessLevel {

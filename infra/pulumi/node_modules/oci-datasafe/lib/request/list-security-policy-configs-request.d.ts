...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/datasafe/ListSecurityPolicyConfigs.ts.html |here} to see how to use ListSecurityPolicyConfigsRequest.
 */
export interface ListSecurityPolicyConfigsRequest extends common.BaseRequest {
    /**
     ...
     */
    "lifecycleState"?: model.SecurityPolicyConfigLifecycleState;
    /**
...
export declare namespace ListSecurityPolicyConfigsRequest {
    enum AccessLevel {

...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/datasafe/ListMaskingAnalytics.ts.html |here} to see how to use ListMaskingAnalyticsRequest.
 */
...
export declare namespace ListMaskingAnalyticsRequest {
    enum GroupBy {
        TargetId = "targetId",
        PolicyId = "policyId",

...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/datasafe/ListAvailableAuditVolumes.ts.html |here} to see how to use ListAvailableAuditVolumesRequest.
 */
...
export declare namespace ListAvailableAuditVolumesRequest {
    enum SortOrder {
        Asc = "ASC",
        Desc = "DESC"
    }

...
export declare namespace ListSecurityFeaturesRequest {
    enum AccessLevel {
        Restricted = "RESTRICTED",
        Accessible = "ACCESSIBLE"
    }
    enum TargetsWithUnifiedAudit {
        Enabled = "ENABLED",
        Disabled = "DISABLED",
        None = "NONE"
    }
    enum TargetsWithFineGrainedAudit {
        Enabled = "ENABLED",
        Disabled = "DISABLED",
        None = "NONE"
    }
    enum TargetsWithTraditionalAudit {
        Enabled = "ENABLED",
        Disabled = "DISABLED",
        None = "NONE"
    }
    enum TargetsWithDatabaseVault {
        Enabled = "ENABLED",
        Disabled = "DISABLED",
        None = "NONE"
    }
    enum TargetsWithPrivilegeAnalysis {
        Enabled = "ENABLED",
        Disabled = "DISABLED",
        None = "NONE"
    }
    enum TargetsWithTablespaceEncryption {
        Enabled = "ENABLED",
        Disabled = "DISABLED",
        None = "NONE"
    }
    enum TargetsWithColumnEncryption {
        Enabled = "ENABLED",
        Disabled = "DISABLED",
        None = "NONE"
    }
    enum TargetsWithNetworkEncryption {
        Enabled = "ENABLED",
        Disabled = "DISABLED",
        None = "NONE"
    }
    enum TargetsWithPasswordAuthentication {
        Enabled = "ENABLED",
        Disabled = "DISABLED",
        None = "NONE"
    }
    enum TargetsWithGlobalAuthentication {
        Enabled = "ENABLED",
        Disabled = "DISABLED",
        None = "NONE"
    }
    enum TargetsWithExternalAuthentication {
        Enabled = "ENABLED",
        Disabled = "DISABLED",
        None = "NONE"
    }

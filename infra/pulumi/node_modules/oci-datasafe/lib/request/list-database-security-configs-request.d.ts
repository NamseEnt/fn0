...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/datasafe/ListDatabaseSecurityConfigs.ts.html |here} to see how to use ListDatabaseSecurityConfigsRequest.
 */
export interface ListDatabaseSecurityConfigsRequest extends common.BaseRequest {
    /**
...
export declare namespace ListDatabaseSecurityConfigsRequest {
    enum AccessLevel {

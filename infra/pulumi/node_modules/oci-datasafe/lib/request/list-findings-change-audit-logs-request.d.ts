...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/datasafe/ListFindingsChangeAuditLogs.ts.html |here} to see how to use ListFindingsChangeAuditLogsRequest.
 */
...
export declare namespace ListFindingsChangeAuditLogsRequest {
    enum Severity {
        High = "HIGH",
        Medium = "MEDIUM",
        Low = "LOW",

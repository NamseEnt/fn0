...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/datasafe/ListTargetAlertPolicyAssociations.ts.html |here} to see how to use ListTargetAlertPolicyAssociationsRequest.
 */
export interface ListTargetAlertPolicyAssociationsRequest extends common.BaseRequest {
    /**
...
export declare namespace ListTargetAlertPolicyAssociationsRequest {
    enum SortOrder {
        Asc = "ASC",
        Desc = "DESC"
    }

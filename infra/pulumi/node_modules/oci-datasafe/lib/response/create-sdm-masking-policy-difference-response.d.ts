...
export interface CreateSdmMaskingPolicyDifferenceResponse {
    /**
    ...
    "location": string;
    /**
     * The returned model.SdmMaskingPolicyDifference instance.
     */
    "sdmMaskingPolicyDifference": model.SdmMaskingPolicyDifference;
}

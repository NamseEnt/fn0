...
export interface ListAlertPolicyRulesResponse {
    /**
    ...
    "opcPrevPage": string;
    /**
     * The returned model.AlertPolicyRuleCollection instance.
     */
    "alertPolicyRuleCollection": model.AlertPolicyRuleCollection;
}

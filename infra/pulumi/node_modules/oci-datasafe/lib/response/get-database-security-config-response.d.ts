...
export interface GetDatabaseSecurityConfigResponse {
    /**
    ...
    "opcRequestId": string;
    /**
     * The returned model.DatabaseSecurityConfig instance.
     */
    "databaseSecurityConfig": model.DatabaseSecurityConfig;
}

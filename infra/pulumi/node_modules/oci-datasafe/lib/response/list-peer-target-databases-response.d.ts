...
export interface ListPeerTargetDatabasesResponse {
    /**
    ...
    "opcPrevPage": string;
    /**
     * The returned model.PeerTargetDatabaseCollection instance.
     */
    "peerTargetDatabaseCollection": model.PeerTargetDatabaseCollection;
}

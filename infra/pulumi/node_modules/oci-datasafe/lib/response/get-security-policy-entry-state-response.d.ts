...
export interface GetSecurityPolicyEntryStateResponse {
    /**
    ...
    "opcRequestId": string;
    /**
     * The returned model.SecurityPolicyEntryState instance.
     */
    "securityPolicyEntryState": model.SecurityPolicyEntryState;
}

...
export declare namespace CreateWebAppAccelerationLoadBalancerDetails {
    function getJsonObj(obj: CreateWebAppAccelerationLoadBalancerDetails, isParentJsonObj?: boolean): object;
    const backendType = "LOAD_BALANCER";
    function getDeserializedJsonObj(obj: CreateWebAppAccelerationLoadBalancerDetails, isParentJsonObj?: boolean): object;
}

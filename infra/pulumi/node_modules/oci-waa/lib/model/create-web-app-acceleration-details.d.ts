...
export declare namespace CreateWebAppAccelerationDetails {
    function getJsonObj(obj: CreateWebAppAccelerationDetails): object;
    function getDeserializedJsonObj(obj: CreateWebAppAccelerationDetails): object;
}

...
export declare namespace WebAppAccelerationPolicyCollection {
    function getJsonObj(obj: WebAppAccelerationPolicyCollection): object;
    function getDeserializedJsonObj(obj: WebAppAccelerationPolicyCollection): object;
}

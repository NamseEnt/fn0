...
export declare namespace ChangeWebAppAccelerationCompartmentDetails {
    function getJsonObj(obj: ChangeWebAppAccelerationCompartmentDetails): object;
    function getDeserializedJsonObj(obj: ChangeWebAppAccelerationCompartmentDetails): object;
}

...
export declare namespace WebAppAccelerationPolicy {
    enum LifecycleState {
        Creating = "CREATING",
        Updating = "UPDATING",
        Active = "ACTIVE",
    ...
    function getJsonObj(obj: WebAppAccelerationPolicy): object;
    function getDeserializedJsonObj(obj: WebAppAccelerationPolicy): object;
}

 ...
 **/
export declare enum DbWorkload {
    Oltp = "OLTP",
    Dw = "DW",
    /**
...
export declare namespace DbWorkload {
    function getJsonObj(obj: DbWorkload): DbWorkload;
    function getDeserializedJsonObj(obj: DbWorkload): DbWorkload;
}

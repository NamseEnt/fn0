...
export declare namespace WorkflowAction {
    function getJsonObj(obj: WorkflowAction): WorkflowAction;
    function getDeserializedJsonObj(obj: WorkflowAction): WorkflowAction;
}

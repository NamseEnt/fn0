...
export declare namespace DataflowConnections {
    function getJsonObj(obj: DataflowConnections): object;
    function getDeserializedJsonObj(obj: DataflowConnections): object;
}

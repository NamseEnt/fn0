...
export declare namespace ComponentValueOverride {
    function getJsonObj(obj: ComponentValueOverride): object;
    function getDeserializedJsonObj(obj: ComponentValueOverride): object;
}

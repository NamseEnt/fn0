...
class EmWarehouseWaiter {
     ...
     */
    forEmWarehouse(request, ...targetStates) {
        return __awaiter(this, void 0, void 0, function* () {
            return oci_common_1.genericTerminalConditionWaiter(this.config, () => this.client.getEmWarehouse(request), response => targetStates.includes(response.emWarehouse.lifecycleState), targetStates.includes(models.EmWarehouse.LifecycleState.Deleted));
        });
    }
    /**

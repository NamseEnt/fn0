...
exports.EmWarehouseClient = exports.EmWarehouseApiKeys = void 0;
const common = require("oci-common");
const model = __importStar(require("./model"));
const emwarehouse_waiter_1 = require("./emwarehouse-waiter");
const oci_common_1 = require("oci-common");
const Breaker = require("opossum");
// ===============================================
// This file is autogenerated - Please do not edit
// ===============================================
var EmWarehouseApiKeys;
(function (EmWarehouseApiKeys) {
})(EmWarehouseApiKeys = exports.EmWarehouseApiKeys || (exports.EmWarehouseApiKeys = {}));
/**
 * This service client uses {@link common.CircuitBreaker.DefaultConfiguration} for all the operations by default if no circuit breaker configuration is defined by the user.
 */
class EmWarehouseClient {
    constructor(params, clientConfiguration) {
        ...
        this.targetService = "EmWarehouse";
        this._regionId = "";
        ...
        if (!oci_common_1.developerToolConfiguration.isServiceEnabled("emwarehouse")) {
            let errmsg = "The developerToolConfiguration configuration disabled this service, this behavior is controlled by developerToolConfiguration.ociEnabledServiceSet variable. Please check if your local developer_tool_configuration file has configured the service you're targeting or contact the cloud provider on the availability of this service : ";
            throw errmsg.concat("emwarehouse");
        }
    ...
    set endpoint(endpoint) {
        ...
        if (this.logger)
            this.logger.info(`EmWarehouseClient endpoint set to ${this._endpoint}`);
    }
    get logger() {
    ...
    set useRealmSpecificEndpointTemplate(realmSpecificEndpointTemplateEnabled) {
        ...
        if (this._lastSetRegionOrRegionId === common.Region.REGION_STRING) {
            this.endpoint = common.EndpointBuilder.createEndpointFromRegion(EmWarehouseClient.serviceEndpointTemplate, this._region, EmWarehouseClient.endpointServiceName);
        }
        else if (this._lastSetRegionOrRegionId === common.Region.REGION_ID_STRING) {
            this.endpoint = common.EndpointBuilder.createEndpointFromRegionId(EmWarehouseClient.serviceEndpointTemplate, this._regionId, EmWarehouseClient.endpointServiceName);
        }
    }
    /**
    ...
    set region(region) {
        this._region = region;
        this.endpoint = common.EndpointBuilder.createEndpointFromRegion(EmWarehouseClient.serviceEndpointTemplate, region, EmWarehouseClient.endpointServiceName);
    ...
    set regionId(regionId) {
        ...
        this.endpoint = common.EndpointBuilder.createEndpointFromRegionId(EmWarehouseClient.serviceEndpointTemplate, regionId, EmWarehouseClient.endpointServiceName);
    ...
    createWaiters(config) {
        this._waiters = new emwarehouse_waiter_1.EmWarehouseWaiter(this, config);
    ...
    cancelWorkRequest(cancelWorkRequestRequest) {
        return __awaiter(this, void 0, void 0, function* () {
            if (this.logger)
                this.logger.debug("Calling operation EmWarehouseClient#cancelWorkRequest.");
    ...
    createEmWarehouse(createEmWarehouseRequest) {
        return __awaiter(this, void 0, void 0, function* () {
            if (this.logger)
                this.logger.debug("Calling operation EmWarehouseClient#createEmWarehouse.");
    ...
    deleteEmWarehouse(deleteEmWarehouseRequest) {
        return __awaiter(this, void 0, void 0, function* () {
            if (this.logger)
                this.logger.debug("Calling operation EmWarehouseClient#deleteEmWarehouse.");
    ...
    getEmWarehouse(getEmWarehouseRequest) {
        return __awaiter(this, void 0, void 0, function* () {
            if (this.logger)
                this.logger.debug("Calling operation EmWarehouseClient#getEmWarehouse.");
    ...
    getWorkRequest(getWorkRequestRequest) {
        return __awaiter(this, void 0, void 0, function* () {
            if (this.logger)
                this.logger.debug("Calling operation EmWarehouseClient#getWorkRequest.");
    ...
    listEmWarehouses(listEmWarehousesRequest) {
        return __awaiter(this, void 0, void 0, function* () {
            if (this.logger)
                this.logger.debug("Calling operation EmWarehouseClient#listEmWarehouses.");
    ...
    listEtlRuns(listEtlRunsRequest) {
        return __awaiter(this, void 0, void 0, function* () {
            if (this.logger)
                this.logger.debug("Calling operation EmWarehouseClient#listEtlRuns.");
    ...
    listWorkRequestLogs(listWorkRequestLogsRequest) {
        return __awaiter(this, void 0, void 0, function* () {
            if (this.logger)
                this.logger.debug("Calling operation EmWarehouseClient#listWorkRequestLogs.");
    ...
    listWorkRequests(listWorkRequestsRequest) {
        return __awaiter(this, void 0, void 0, function* () {
            if (this.logger)
                this.logger.debug("Calling operation EmWarehouseClient#listWorkRequests.");
    ...
    updateEmWarehouse(updateEmWarehouseRequest) {
        return __awaiter(this, void 0, void 0, function* () {
            if (this.logger)
                this.logger.debug("Calling operation EmWarehouseClient#updateEmWarehouse.");
...
exports.EmWarehouseClient = EmWarehouseClient;
EmWarehouseClient.serviceEndpointTemplate = "https://operationsinsights.{region}.oci.{secondLevelDomain}";

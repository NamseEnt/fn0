...
export declare namespace MonthlyRewardSummary {
    function getJsonObj(obj: MonthlyRewardSummary): object;
    function getDeserializedJsonObj(obj: MonthlyRewardSummary): object;
}

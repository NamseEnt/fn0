...
export interface SearchOAuth2ClientCredentialsResponse {
    /**
    ...
    "opcNextPage": string;
    /**
     * The returned model.OAuth2ClientCredentials instance.
     */
    "oAuth2ClientCredentials": model.OAuth2ClientCredentials;
}

...
export interface ListIdentityPropagationTrustsResponse {
    /**
    ...
    "opcNextPage": string;
    /**
     * The returned model.IdentityPropagationTrusts instance.
     */
    "identityPropagationTrusts": model.IdentityPropagationTrusts;
}

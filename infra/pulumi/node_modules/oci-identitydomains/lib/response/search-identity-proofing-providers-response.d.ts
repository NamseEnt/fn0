...
export interface SearchIdentityProofingProvidersResponse {
    /**
    ...
    "opcNextPage": string;
    /**
     * The returned model.IdentityProofingProviders instance.
     */
    "identityProofingProviders": model.IdentityProofingProviders;
}

...
export interface SearchSelfRegistrationProfilesResponse {
    /**
    ...
    "opcNextPage": string;
    /**
     * The returned model.SelfRegistrationProfiles instance.
     */
    "selfRegistrationProfiles": model.SelfRegistrationProfiles;
}

...
export interface SearchResourceTypeSchemaAttributesResponse {
    /**
    ...
    "opcNextPage": string;
    /**
     * The returned model.ResourceTypeSchemaAttributes instance.
     */
    "resourceTypeSchemaAttributes": model.ResourceTypeSchemaAttributes;
}

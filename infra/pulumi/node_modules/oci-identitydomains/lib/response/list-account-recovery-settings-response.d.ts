...
export interface ListAccountRecoverySettingsResponse {
    /**
    ...
    "opcNextPage": string;
    /**
     * The returned model.AccountRecoverySettings instance.
     */
    "accountRecoverySettings": model.AccountRecoverySettings;
}

...
export interface SearchSecurityQuestionSettingsResponse {
    /**
    ...
    "opcNextPage": string;
    /**
     * The returned model.SecurityQuestionSettings instance.
     */
    "securityQuestionSettings": model.SecurityQuestionSettings;
}

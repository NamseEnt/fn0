...
export interface ListMyOAuth2ClientCredentialsResponse {
    /**
    ...
    "opcNextPage": string;
    /**
     * The returned model.MyOAuth2ClientCredentials instance.
     */
    "myOAuth2ClientCredentials": model.MyOAuth2ClientCredentials;
}

...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/identitydomains/PatchUserAttributesSetting.ts.html |here} to see how to use PatchUserAttributesSettingRequest.
 */
export interface PatchUserAttributesSettingRequest extends common.BaseRequest {
    /**
     * ID of the resource
     */

...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/identitydomains/PutPolicy.ts.html |here} to see how to use PutPolicyRequest.
 */
export interface PutPolicyRequest extends common.BaseRequest {
    /**
     * ID of the resource
     */
    "policyId": string;

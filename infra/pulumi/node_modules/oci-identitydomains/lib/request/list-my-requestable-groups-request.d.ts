...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/identitydomains/ListMyRequestableGroups.ts.html |here} to see how to use ListMyRequestableGroupsRequest.
 */
export interface ListMyRequestableGroupsRequest extends common.BaseRequest {
    /**

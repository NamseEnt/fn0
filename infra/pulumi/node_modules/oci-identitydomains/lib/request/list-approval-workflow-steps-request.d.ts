...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/identitydomains/ListApprovalWorkflowSteps.ts.html |here} to see how to use ListApprovalWorkflowStepsRequest.
 */
export interface ListApprovalWorkflowStepsRequest extends common.BaseRequest {
    /**

...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/identitydomains/ListMyTrustedUserAgents.ts.html |here} to see how to use ListMyTrustedUserAgentsRequest.
 */
export interface ListMyTrustedUserAgentsRequest extends common.BaseRequest {
    /**

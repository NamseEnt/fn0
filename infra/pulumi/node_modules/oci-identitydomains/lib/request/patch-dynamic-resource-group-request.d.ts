...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/identitydomains/PatchDynamicResourceGroup.ts.html |here} to see how to use PatchDynamicResourceGroupRequest.
 */
export interface PatchDynamicResourceGroupRequest extends common.BaseRequest {
    /**
     * ID of the resource
     */

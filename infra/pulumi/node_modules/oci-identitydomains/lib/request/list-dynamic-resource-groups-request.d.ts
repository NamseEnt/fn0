...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/identitydomains/ListDynamicResourceGroups.ts.html |here} to see how to use ListDynamicResourceGroupsRequest.
 */
export interface ListDynamicResourceGroupsRequest extends common.BaseRequest {
    /**

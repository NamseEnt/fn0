...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/identitydomains/ListOAuthPartnerCertificates.ts.html |here} to see how to use ListOAuthPartnerCertificatesRequest.
 */
export interface ListOAuthPartnerCertificatesRequest extends common.BaseRequest {
    /**

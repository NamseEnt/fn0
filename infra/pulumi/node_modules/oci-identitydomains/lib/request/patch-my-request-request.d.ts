...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/identitydomains/PatchMyRequest.ts.html |here} to see how to use PatchMyRequestRequest.
 */
export interface PatchMyRequestRequest extends common.BaseRequest {
    /**
     * ID of the resource
     */
    "myRequestId": string;

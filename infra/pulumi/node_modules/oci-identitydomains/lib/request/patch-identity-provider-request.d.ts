...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/identitydomains/PatchIdentityProvider.ts.html |here} to see how to use PatchIdentityProviderRequest.
 */
export interface PatchIdentityProviderRequest extends common.BaseRequest {
    /**
     * ID of the resource
     */

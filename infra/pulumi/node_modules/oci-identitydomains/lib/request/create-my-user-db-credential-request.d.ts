...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/identitydomains/CreateMyUserDbCredential.ts.html |here} to see how to use CreateMyUserDbCredentialRequest.
 */
export interface CreateMyUserDbCredentialRequest extends common.BaseRequest {
    /**
  ...
  *
   */
    "myUserDbCredential"?: model.MyUserDbCredential;
    /**

...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/identitydomains/PatchApprovalWorkflowStep.ts.html |here} to see how to use PatchApprovalWorkflowStepRequest.
 */
export interface PatchApprovalWorkflowStepRequest extends common.BaseRequest {
    /**
     * ID of the resource
     */

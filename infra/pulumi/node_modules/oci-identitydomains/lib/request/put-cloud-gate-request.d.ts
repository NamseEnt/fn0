...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/identitydomains/PutCloudGate.ts.html |here} to see how to use PutCloudGateRequest.
 */
export interface PutCloudGateRequest extends common.BaseRequest {
    /**
     * ID of the resource
     */
    "cloudGateId": string;

...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/identitydomains/PutCloudGateServer.ts.html |here} to see how to use PutCloudGateServerRequest.
 */
export interface PutCloudGateServerRequest extends common.BaseRequest {
    /**
     * ID of the resource
     */

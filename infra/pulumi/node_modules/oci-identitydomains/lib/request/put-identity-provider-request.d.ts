...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/identitydomains/PutIdentityProvider.ts.html |here} to see how to use PutIdentityProviderRequest.
 */
export interface PutIdentityProviderRequest extends common.BaseRequest {
    /**
     * ID of the resource
     */

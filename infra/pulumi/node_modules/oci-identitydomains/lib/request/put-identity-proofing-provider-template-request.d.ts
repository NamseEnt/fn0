...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/identitydomains/PutIdentityProofingProviderTemplate.ts.html |here} to see how to use PutIdentityProofingProviderTemplateRequest.
 */
export interface PutIdentityProofingProviderTemplateRequest extends common.BaseRequest {
    /**
     * ID of the resource.
     */

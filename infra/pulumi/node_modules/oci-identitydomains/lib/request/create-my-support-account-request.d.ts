...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/identitydomains/CreateMySupportAccount.ts.html |here} to see how to use CreateMySupportAccountRequest.
 */
export interface CreateMySupportAccountRequest extends common.BaseRequest {
    /**
  ...
  *
   */
    "mySupportAccount"?: model.MySupportAccount;
    /**

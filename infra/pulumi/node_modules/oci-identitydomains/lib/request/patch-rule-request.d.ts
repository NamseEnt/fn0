...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/identitydomains/PatchRule.ts.html |here} to see how to use PatchRuleRequest.
 */
export interface PatchRuleRequest extends common.BaseRequest {
    /**
     * ID of the resource
     */
    "ruleId": string;

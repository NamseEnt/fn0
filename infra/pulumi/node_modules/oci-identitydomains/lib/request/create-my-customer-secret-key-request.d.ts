...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/identitydomains/CreateMyCustomerSecretKey.ts.html |here} to see how to use CreateMyCustomerSecretKeyRequest.
 */
export interface CreateMyCustomerSecretKeyRequest extends common.BaseRequest {
    /**
  ...
  *
   */
    "myCustomerSecretKey"?: model.MyCustomerSecretKey;
    /**

...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/identitydomains/ListAccountMgmtInfos.ts.html |here} to see how to use ListAccountMgmtInfosRequest.
 */
export interface ListAccountMgmtInfosRequest extends common.BaseRequest {
    /**

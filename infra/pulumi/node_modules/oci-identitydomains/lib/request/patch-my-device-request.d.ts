...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/identitydomains/PatchMyDevice.ts.html |here} to see how to use PatchMyDeviceRequest.
 */
export interface PatchMyDeviceRequest extends common.BaseRequest {
    /**
     * ID of the resource
     */
    "myDeviceId": string;

...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/identitydomains/CreateGrant.ts.html |here} to see how to use CreateGrantRequest.
 */
export interface CreateGrantRequest extends common.BaseRequest {
    /**

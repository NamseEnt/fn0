...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/identitydomains/PatchMappedAttribute.ts.html |here} to see how to use PatchMappedAttributeRequest.
 */
export interface PatchMappedAttributeRequest extends common.BaseRequest {
    /**
     * ID of the resource
     */

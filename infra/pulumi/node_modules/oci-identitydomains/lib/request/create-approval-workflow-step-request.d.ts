...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/identitydomains/CreateApprovalWorkflowStep.ts.html |here} to see how to use CreateApprovalWorkflowStepRequest.
 */
export interface CreateApprovalWorkflowStepRequest extends common.BaseRequest {
    /**
  ...
  *
   */
    "approvalWorkflowStep"?: model.ApprovalWorkflowStep;
    /**

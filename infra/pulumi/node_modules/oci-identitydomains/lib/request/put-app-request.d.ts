...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/identitydomains/PutApp.ts.html |here} to see how to use PutAppRequest.
 */
export interface PutAppRequest extends common.BaseRequest {
    /**
     * ID of the resource
     */
    "appId": string;

...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/identitydomains/PutUserPasswordChanger.ts.html |here} to see how to use PutUserPasswordChangerRequest.
 */
export interface PutUserPasswordChangerRequest extends common.BaseRequest {
    /**
     * ID of the resource
     */
    "userPasswordChangerId": string;
    /**
  ...
  *
   */
    "userPasswordChanger"?: model.UserPasswordChanger;
    /**

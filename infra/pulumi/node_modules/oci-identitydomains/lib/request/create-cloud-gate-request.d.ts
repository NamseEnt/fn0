...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/identitydomains/CreateCloudGate.ts.html |here} to see how to use CreateCloudGateRequest.
 */
export interface CreateCloudGateRequest extends common.BaseRequest {
    /**

...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/identitydomains/PatchSetting.ts.html |here} to see how to use PatchSettingRequest.
 */
export interface PatchSettingRequest extends common.BaseRequest {
    /**
     * ID of the resource
     */
    "settingId": string;

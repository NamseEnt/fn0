...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/identitydomains/PutAppStatusChanger.ts.html |here} to see how to use PutAppStatusChangerRequest.
 */
export interface PutAppStatusChangerRequest extends common.BaseRequest {
    /**
     * ID of the resource
     */
    "appStatusChangerId": string;
    /**
  ...
  *
   */
    "appStatusChanger"?: model.AppStatusChanger;
    /**

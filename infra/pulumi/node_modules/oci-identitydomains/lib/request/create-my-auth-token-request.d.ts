...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/identitydomains/CreateMyAuthToken.ts.html |here} to see how to use CreateMyAuthTokenRequest.
 */
export interface CreateMyAuthTokenRequest extends common.BaseRequest {
    /**

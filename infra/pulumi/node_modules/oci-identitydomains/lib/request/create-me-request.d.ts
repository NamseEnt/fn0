...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/identitydomains/CreateMe.ts.html |here} to see how to use CreateMeRequest.
 */
export interface CreateMeRequest extends common.BaseRequest {
    /**

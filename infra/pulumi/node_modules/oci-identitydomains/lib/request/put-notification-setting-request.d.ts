...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/identitydomains/PutNotificationSetting.ts.html |here} to see how to use PutNotificationSettingRequest.
 */
export interface PutNotificationSettingRequest extends common.BaseRequest {
    /**
     * ID of the resource
     */

...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/identitydomains/PatchSelfRegistrationProfile.ts.html |here} to see how to use PatchSelfRegistrationProfileRequest.
 */
export interface PatchSelfRegistrationProfileRequest extends common.BaseRequest {
    /**
     * ID of the resource
     */

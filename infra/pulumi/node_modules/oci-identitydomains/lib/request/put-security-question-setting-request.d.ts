...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/identitydomains/PutSecurityQuestionSetting.ts.html |here} to see how to use PutSecurityQuestionSettingRequest.
 */
export interface PutSecurityQuestionSettingRequest extends common.BaseRequest {
    /**
     * ID of the resource
     */
  ...
  *
   */
    "securityQuestionSetting"?: model.SecurityQuestionSetting;
    /**

...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/identitydomains/PatchApp.ts.html |here} to see how to use PatchAppRequest.
 */
export interface PatchAppRequest extends common.BaseRequest {
    /**
     * ID of the resource
     */
    "appId": string;

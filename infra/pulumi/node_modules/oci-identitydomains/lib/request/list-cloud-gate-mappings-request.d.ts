...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/identitydomains/ListCloudGateMappings.ts.html |here} to see how to use ListCloudGateMappingsRequest.
 */
export interface ListCloudGateMappingsRequest extends common.BaseRequest {
    /**

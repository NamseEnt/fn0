...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/identitydomains/CreateSecurityQuestion.ts.html |here} to see how to use CreateSecurityQuestionRequest.
 */
export interface CreateSecurityQuestionRequest extends common.BaseRequest {
    /**

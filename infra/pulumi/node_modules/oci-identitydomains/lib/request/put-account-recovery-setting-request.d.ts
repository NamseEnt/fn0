...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/identitydomains/PutAccountRecoverySetting.ts.html |here} to see how to use PutAccountRecoverySettingRequest.
 */
export interface PutAccountRecoverySettingRequest extends common.BaseRequest {
    /**
     * ID of the resource
     */

...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/identitydomains/ListApprovalWorkflowAssignments.ts.html |here} to see how to use ListApprovalWorkflowAssignmentsRequest.
 */
export interface ListApprovalWorkflowAssignmentsRequest extends common.BaseRequest {
    /**

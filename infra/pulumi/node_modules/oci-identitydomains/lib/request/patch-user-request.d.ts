...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/identitydomains/PatchUser.ts.html |here} to see how to use PatchUserRequest.
 */
export interface PatchUserRequest extends common.BaseRequest {
    /**
     * ID of the resource
     */
    "userId": string;

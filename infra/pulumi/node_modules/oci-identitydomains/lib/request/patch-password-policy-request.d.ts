...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/identitydomains/PatchPasswordPolicy.ts.html |here} to see how to use PatchPasswordPolicyRequest.
 */
export interface PatchPasswordPolicyRequest extends common.BaseRequest {
    /**
     * ID of the resource
     */

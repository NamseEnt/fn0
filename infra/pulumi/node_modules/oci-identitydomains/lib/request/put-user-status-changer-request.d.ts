...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/identitydomains/PutUserStatusChanger.ts.html |here} to see how to use PutUserStatusChangerRequest.
 */
export interface PutUserStatusChangerRequest extends common.BaseRequest {
    /**
     * ID of the resource
     */
    "userStatusChangerId": string;
    /**
  ...
  *
   */
    "userStatusChanger"?: model.UserStatusChanger;
    /**

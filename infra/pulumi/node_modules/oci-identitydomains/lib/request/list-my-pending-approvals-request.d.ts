...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/identitydomains/ListMyPendingApprovals.ts.html |here} to see how to use ListMyPendingApprovalsRequest.
 */
export interface ListMyPendingApprovalsRequest extends common.BaseRequest {
    /**

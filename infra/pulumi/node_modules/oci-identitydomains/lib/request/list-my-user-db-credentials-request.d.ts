...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/identitydomains/ListMyUserDbCredentials.ts.html |here} to see how to use ListMyUserDbCredentialsRequest.
 */
export interface ListMyUserDbCredentialsRequest extends common.BaseRequest {
    /**

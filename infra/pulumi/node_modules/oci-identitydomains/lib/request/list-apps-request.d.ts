...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/identitydomains/ListApps.ts.html |here} to see how to use ListAppsRequest.
 */
export interface ListAppsRequest extends common.BaseRequest {
    /**

...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/identitydomains/CreateCloudGateMapping.ts.html |here} to see how to use CreateCloudGateMappingRequest.
 */
export interface CreateCloudGateMappingRequest extends common.BaseRequest {
    /**
  ...
  *
   */
    "cloudGateMapping"?: model.CloudGateMapping;
    /**

...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/identitydomains/PatchIdentitySetting.ts.html |here} to see how to use PatchIdentitySettingRequest.
 */
export interface PatchIdentitySettingRequest extends common.BaseRequest {
    /**
     * ID of the resource
     */

...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/identitydomains/PutApprovalWorkflow.ts.html |here} to see how to use PutApprovalWorkflowRequest.
 */
export interface PutApprovalWorkflowRequest extends common.BaseRequest {
    /**
     * ID of the resource
     */

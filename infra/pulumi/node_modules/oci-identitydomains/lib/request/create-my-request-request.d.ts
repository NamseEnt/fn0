...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/identitydomains/CreateMyRequest.ts.html |here} to see how to use CreateMyRequestRequest.
 */
export interface CreateMyRequestRequest extends common.BaseRequest {
    /**

...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/identitydomains/PatchMyPendingApproval.ts.html |here} to see how to use PatchMyPendingApprovalRequest.
 */
export interface PatchMyPendingApprovalRequest extends common.BaseRequest {
    /**
     * ID of the resource
     */

...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/identitydomains/PatchAuthToken.ts.html |here} to see how to use PatchAuthTokenRequest.
 */
export interface PatchAuthTokenRequest extends common.BaseRequest {
    /**
     * ID of the resource
     */
    "authTokenId": string;

...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/identitydomains/PutCondition.ts.html |here} to see how to use PutConditionRequest.
 */
export interface PutConditionRequest extends common.BaseRequest {
    /**
     * ID of the resource
     */
    "conditionId": string;

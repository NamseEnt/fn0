...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/identitydomains/ListMyAuthTokens.ts.html |here} to see how to use ListMyAuthTokensRequest.
 */
export interface ListMyAuthTokensRequest extends common.BaseRequest {
    /**

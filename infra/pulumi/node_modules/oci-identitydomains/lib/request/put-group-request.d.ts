...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/identitydomains/PutGroup.ts.html |here} to see how to use PutGroupRequest.
 */
export interface PutGroupRequest extends common.BaseRequest {
    /**
     * ID of the resource
     */
    "groupId": string;

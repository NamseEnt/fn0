...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/identitydomains/CreateCloudGateServer.ts.html |here} to see how to use CreateCloudGateServerRequest.
 */
export interface CreateCloudGateServerRequest extends common.BaseRequest {
    /**
  ...
  *
   */
    "cloudGateServer"?: model.CloudGateServer;
    /**

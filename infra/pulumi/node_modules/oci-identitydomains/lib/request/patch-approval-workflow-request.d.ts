...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/identitydomains/PatchApprovalWorkflow.ts.html |here} to see how to use PatchApprovalWorkflowRequest.
 */
export interface PatchApprovalWorkflowRequest extends common.BaseRequest {
    /**
     * ID of the resource
     */

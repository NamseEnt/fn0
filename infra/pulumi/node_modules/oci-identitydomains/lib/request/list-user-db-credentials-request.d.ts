...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/identitydomains/ListUserDbCredentials.ts.html |here} to see how to use ListUserDbCredentialsRequest.
 */
export interface ListUserDbCredentialsRequest extends common.BaseRequest {
    /**

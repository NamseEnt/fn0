...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/identitydomains/PatchMyApiKey.ts.html |here} to see how to use PatchMyApiKeyRequest.
 */
export interface PatchMyApiKeyRequest extends common.BaseRequest {
    /**
     * ID of the resource
     */
    "myApiKeyId": string;

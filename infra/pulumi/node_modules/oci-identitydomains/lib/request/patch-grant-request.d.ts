...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/identitydomains/PatchGrant.ts.html |here} to see how to use PatchGrantRequest.
 */
export interface PatchGrantRequest extends common.BaseRequest {
    /**
     * ID of the resource
     */
    "grantId": string;

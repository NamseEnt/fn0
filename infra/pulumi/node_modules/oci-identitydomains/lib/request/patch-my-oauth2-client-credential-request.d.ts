...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/identitydomains/PatchMyOAuth2ClientCredential.ts.html |here} to see how to use PatchMyOAuth2ClientCredentialRequest.
 */
export interface PatchMyOAuth2ClientCredentialRequest extends common.BaseRequest {
    /**
     * ID of the resource
     */

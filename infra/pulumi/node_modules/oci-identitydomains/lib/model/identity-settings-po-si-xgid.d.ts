 ...
 *  - uniqueness: none
 */
export interface IdentitySettingsPOSIXGid {
    /**
...
export declare namespace IdentitySettingsPOSIXGid {
    function getJsonObj(obj: IdentitySettingsPOSIXGid): object;
    function getDeserializedJsonObj(obj: IdentitySettingsPOSIXGid): object;
}

 ...
 */
export interface IdentityProviderJitUserProvAssignedGroups {
    /**
     * Group identifier
     * <p>
     **Added In:** 20.1.3
...
export declare namespace IdentityProviderJitUserProvAssignedGroups {
    function getJsonObj(obj: IdentityProviderJitUserProvAssignedGroups): object;
    function getDeserializedJsonObj(obj: IdentityProviderJitUserProvAssignedGroups): object;
}

 ...
 */
export interface CloudGateExtServers {
    /**
...
export declare namespace CloudGateExtServers {
    function getJsonObj(obj: CloudGateExtServers): object;
    function getDeserializedJsonObj(obj: CloudGateExtServers): object;
}

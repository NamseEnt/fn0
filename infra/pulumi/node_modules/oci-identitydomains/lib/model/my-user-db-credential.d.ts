...
export interface MyUserDbCredential {
     ...
     *  - uniqueness: none
     */
    "idcsPreventedOperations"?: Array<MyUserDbCredential.IdcsPreventedOperations>;
    /**
     ...
     */
    "expiresOn"?: string;
    "user"?: model.MyUserDbCredentialsUser;
}
export declare namespace MyUserDbCredential {
    ...
    function getJsonObj(obj: MyUserDbCredential): object;
    function getDeserializedJsonObj(obj: MyUserDbCredential): object;
}

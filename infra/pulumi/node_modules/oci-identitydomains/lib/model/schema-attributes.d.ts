...
export declare namespace SchemaAttributes {
    enum Type {
        String = "string",
        Complex = "complex",
        Boolean = "boolean",
    ...
    function getJsonObj(obj: SchemaAttributes): object;
    function getDeserializedJsonObj(obj: SchemaAttributes): object;
}

 ...
 *  - uniqueness: none
 */
export interface AccountMgmtInfoObjectClass {
    /**
...
export declare namespace AccountMgmtInfoObjectClass {
    function getJsonObj(obj: AccountMgmtInfoObjectClass): object;
    function getDeserializedJsonObj(obj: AccountMgmtInfoObjectClass): object;
}

...
export declare namespace NotificationSettingsFromEmailAddress {
    ...
    function getJsonObj(obj: NotificationSettingsFromEmailAddress): object;
    function getDeserializedJsonObj(obj: NotificationSettingsFromEmailAddress): object;
}

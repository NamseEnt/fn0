...
(function (SmtpCredentials) {
        ...
        const jsonObj = Object.assign(Object.assign({}, obj), {
            "Resources": obj.resources
                ? obj.resources.map(item => {
                    return model.SmtpCredential.getJsonObj(item);
                })
                : undefined
        });
    ...
    SmtpCredentials.getJsonObj = getJsonObj;
    function getDeserializedJsonObj(obj) {
        const jsonObj = Object.assign(Object.assign({}, obj), {
            "resources": obj["Resources"]
                ? obj["Resources"].map((item) => {
                    return model.SmtpCredential.getDeserializedJsonObj(item);
                })
                : undefined
        });
        delete jsonObj["Resources"];
    ...
    SmtpCredentials.getDeserializedJsonObj = getDeserializedJsonObj;
})(SmtpCredentials = exports.SmtpCredentials || (exports.SmtpCredentials = {}));

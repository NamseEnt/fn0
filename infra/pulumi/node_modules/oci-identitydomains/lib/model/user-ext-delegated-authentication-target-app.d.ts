...
export declare namespace UserExtDelegatedAuthenticationTargetApp {
    enum Type {
        App = "App",
    ...
    function getJsonObj(obj: UserExtDelegatedAuthenticationTargetApp): object;
    function getDeserializedJsonObj(obj: UserExtDelegatedAuthenticationTargetApp): object;
}

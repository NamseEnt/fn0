...
export declare namespace ExtensionUserUser {
    enum Status {
    ...
    function getJsonObj(obj: ExtensionUserUser): object;
    function getDeserializedJsonObj(obj: ExtensionUserUser): object;
}

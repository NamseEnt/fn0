...
exports.NetworkPerimeter = void 0;
const model = __importStar(require("../model"));
var NetworkPerimeter;
(function (NetworkPerimeter) {
    ...
    })(IdcsPreventedOperations = NetworkPerimeter.IdcsPreventedOperations || (NetworkPerimeter.IdcsPreventedOperations = {}));
        ...
        const jsonObj = Object.assign(Object.assign({}, obj), {
            ...
            "ipAddresses": obj.ipAddresses
                ? obj.ipAddresses.map(item => {
                    return model.NetworkPerimeterIpAddresses.getJsonObj(item);
                })
                : undefined
        });
        return jsonObj;
    }
    NetworkPerimeter.getJsonObj = getJsonObj;
    function getDeserializedJsonObj(obj) {
        const jsonObj = Object.assign(Object.assign({}, obj), {
            ...
            "ipAddresses": obj.ipAddresses
                ? obj.ipAddresses.map(item => {
                    return model.NetworkPerimeterIpAddresses.getDeserializedJsonObj(item);
                })
                : undefined
        });
        return jsonObj;
    }
    NetworkPerimeter.getDeserializedJsonObj = getDeserializedJsonObj;
})(NetworkPerimeter = exports.NetworkPerimeter || (exports.NetworkPerimeter = {}));
//# sourceMappingURL=network-perimeter.js.map
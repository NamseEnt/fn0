...
export declare namespace AppGroupMembershipToReturn {
    function getJsonObj(obj: AppGroupMembershipToReturn): object;
    function getDeserializedJsonObj(obj: AppGroupMembershipToReturn): object;
}

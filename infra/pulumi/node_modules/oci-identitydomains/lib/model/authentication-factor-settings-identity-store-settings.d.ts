 ...
 *  - uniqueness: none
 */
export interface AuthenticationFactorSettingsIdentityStoreSettings {
    /**
...
export declare namespace AuthenticationFactorSettingsIdentityStoreSettings {
    function getJsonObj(obj: AuthenticationFactorSettingsIdentityStoreSettings): object;
    function getDeserializedJsonObj(obj: AuthenticationFactorSettingsIdentityStoreSettings): object;
}

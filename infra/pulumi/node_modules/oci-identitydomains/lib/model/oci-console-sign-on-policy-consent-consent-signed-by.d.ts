...
export declare namespace OciConsoleSignOnPolicyConsentConsentSignedBy {
    enum Type {
        User = "User",
        App = "App",
        /**
    ...
    function getJsonObj(obj: OciConsoleSignOnPolicyConsentConsentSignedBy): object;
    function getDeserializedJsonObj(obj: OciConsoleSignOnPolicyConsentConsentSignedBy): object;
}

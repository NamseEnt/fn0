 ...
 */
export interface DynamicResourceGroupSearchRequest {
    /**
     ...
     */
    "attributeSets"?: Array<DynamicResourceGroupSearchRequest.AttributeSets>;
    /**
...
export declare namespace DynamicResourceGroupSearchRequest {
    enum AttributeSets {
        All = "all",
        Always = "always",
        Never = "never",
    ...
    function getJsonObj(obj: DynamicResourceGroupSearchRequest): object;
    function getDeserializedJsonObj(obj: DynamicResourceGroupSearchRequest): object;
}

...
export interface UserDbCredentials {
     ...
     */
    "resources": Array<model.UserDbCredential>;
    /**
...
export declare namespace UserDbCredentials {
    function getJsonObj(obj: UserDbCredentials): object;
    function getDeserializedJsonObj(obj: UserDbCredentials): object;
}

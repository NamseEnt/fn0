...
export declare namespace UserAttributesSettingsAttributeSettings {
    function getJsonObj(obj: UserAttributesSettingsAttributeSettings): object;
    function getDeserializedJsonObj(obj: UserAttributesSettingsAttributeSettings): object;
}

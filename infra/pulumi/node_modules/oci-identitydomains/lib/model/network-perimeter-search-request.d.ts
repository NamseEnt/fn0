 ...
 */
export interface NetworkPerimeterSearchRequest {
    /**
     ...
     */
    "attributeSets"?: Array<NetworkPerimeterSearchRequest.AttributeSets>;
    /**
...
export declare namespace NetworkPerimeterSearchRequest {
    enum AttributeSets {
        All = "all",
        Always = "always",
        Never = "never",
    ...
    function getJsonObj(obj: NetworkPerimeterSearchRequest): object;
    function getDeserializedJsonObj(obj: NetworkPerimeterSearchRequest): object;
}

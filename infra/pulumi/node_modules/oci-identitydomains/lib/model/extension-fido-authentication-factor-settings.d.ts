...
export declare namespace ExtensionFidoAuthenticationFactorSettings {
    enum Attestation {
        None = "NONE",
        Direct = "DIRECT",
        Indirect = "INDIRECT",
    ...
    enum AuthenticatorSelectionAttachment {
        Platform = "PLATFORM",
    ...
    enum AuthenticatorSelectionUserVerification {
        Required = "REQUIRED",
        Preferred = "PREFERRED",
    ...
    enum AuthenticatorSelectionResidentKey {
        Required = "REQUIRED",
        Preferred = "PREFERRED",
        Discouraged = "DISCOURAGED",
        None = "NONE",
    ...
    function getJsonObj(obj: ExtensionFidoAuthenticationFactorSettings): object;
    function getDeserializedJsonObj(obj: ExtensionFidoAuthenticationFactorSettings): object;
}

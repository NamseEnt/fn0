...
export declare namespace MyTrustedUserAgentUser {
    function getJsonObj(obj: MyTrustedUserAgentUser): object;
    function getDeserializedJsonObj(obj: MyTrustedUserAgentUser): object;
}

...
export declare namespace AppExtensionEnterpriseAppApp {
    function getJsonObj(obj: AppExtensionEnterpriseAppApp): object;
    function getDeserializedJsonObj(obj: AppExtensionEnterpriseAppApp): object;
}

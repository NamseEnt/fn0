 ...
 */
export interface IdentitySettingsSearchRequest {
    /**
     ...
     */
    "attributeSets"?: Array<IdentitySettingsSearchRequest.AttributeSets>;
}
export declare namespace IdentitySettingsSearchRequest {
    enum AttributeSets {
        All = "all",
        Always = "always",
        Never = "never",
    ...
    function getJsonObj(obj: IdentitySettingsSearchRequest): object;
    function getDeserializedJsonObj(obj: IdentitySettingsSearchRequest): object;
}

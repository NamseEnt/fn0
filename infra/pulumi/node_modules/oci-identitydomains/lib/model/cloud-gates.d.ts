...
export interface CloudGates {
     ...
     */
    "resources": Array<model.CloudGate>;
    /**
...
export declare namespace CloudGates {
    function getJsonObj(obj: CloudGates): object;
    function getDeserializedJsonObj(obj: CloudGates): object;
}

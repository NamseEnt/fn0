...
export declare namespace AuthenticationFactorSettingsDuoSecuritySettings {
    enum UserMappingAttribute {
    ...
    function getJsonObj(obj: AuthenticationFactorSettingsDuoSecuritySettings): object;
    function getDeserializedJsonObj(obj: AuthenticationFactorSettingsDuoSecuritySettings): object;
}

...
(function (MyGroups) {
        ...
        const jsonObj = Object.assign(Object.assign({}, obj), {
            "Resources": obj.resources
                ? obj.resources.map(item => {
                    return model.MyGroup.getJsonObj(item);
                })
                : undefined
        });
    ...
    MyGroups.getJsonObj = getJsonObj;
    function getDeserializedJsonObj(obj) {
        const jsonObj = Object.assign(Object.assign({}, obj), {
            "resources": obj["Resources"]
                ? obj["Resources"].map((item) => {
                    return model.MyGroup.getDeserializedJsonObj(item);
                })
                : undefined
        });
        delete jsonObj["Resources"];
    ...
    MyGroups.getDeserializedJsonObj = getDeserializedJsonObj;
})(MyGroups = exports.MyGroups || (exports.MyGroups = {}));

...
(function (Apps) {
        ...
        const jsonObj = Object.assign(Object.assign({}, obj), {
            "Resources": obj.resources
                ? obj.resources.map(item => {
                    return model.App.getJsonObj(item);
                })
                : undefined
        });
    ...
    Apps.getJsonObj = getJsonObj;
    function getDeserializedJsonObj(obj) {
        const jsonObj = Object.assign(Object.assign({}, obj), {
            "resources": obj["Resources"]
                ? obj["Resources"].map((item) => {
                    return model.App.getDeserializedJsonObj(item);
                })
                : undefined
        });
        delete jsonObj["Resources"];
    ...
    Apps.getDeserializedJsonObj = getDeserializedJsonObj;

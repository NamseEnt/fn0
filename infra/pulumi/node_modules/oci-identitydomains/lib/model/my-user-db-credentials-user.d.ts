...
export declare namespace MyUserDbCredentialsUser {
    function getJsonObj(obj: MyUserDbCredentialsUser): object;
    function getDeserializedJsonObj(obj: MyUserDbCredentialsUser): object;
}

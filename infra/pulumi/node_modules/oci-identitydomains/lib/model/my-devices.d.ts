...
export interface MyDevices {
     ...
     */
    "resources": Array<model.MyDevice>;
    /**
...
export declare namespace MyDevices {
    function getJsonObj(obj: MyDevices): object;
    function getDeserializedJsonObj(obj: MyDevices): object;
}

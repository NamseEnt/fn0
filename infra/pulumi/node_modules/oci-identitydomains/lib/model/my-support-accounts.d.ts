 ...
 */
export interface MySupportAccounts {
    /**
     ...
     */
    "resources": Array<model.MySupportAccount>;
    /**
...
export declare namespace MySupportAccounts {
    function getJsonObj(obj: MySupportAccounts): object;
    function getDeserializedJsonObj(obj: MySupportAccounts): object;
}

 ...
 */
export interface CloudGateServerSearchRequest {
    /**
     ...
     */
    "attributeSets"?: Array<CloudGateServerSearchRequest.AttributeSets>;
    /**
...
export declare namespace CloudGateServerSearchRequest {
    enum AttributeSets {
        All = "all",
        Always = "always",
        Never = "never",
    ...
    function getJsonObj(obj: CloudGateServerSearchRequest): object;
    function getDeserializedJsonObj(obj: CloudGateServerSearchRequest): object;
}

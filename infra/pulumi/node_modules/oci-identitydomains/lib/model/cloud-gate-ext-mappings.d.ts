...
export declare namespace CloudGateExtMappings {
    function getJsonObj(obj: CloudGateExtMappings): object;
    function getDeserializedJsonObj(obj: CloudGateExtMappings): object;
}

 ...
 *  - type: complex
 */
export interface SelfRegistrationProfileEmailTemplate {
    /**
...
export declare namespace SelfRegistrationProfileEmailTemplate {
    function getJsonObj(obj: SelfRegistrationProfileEmailTemplate): object;
    function getDeserializedJsonObj(obj: SelfRegistrationProfileEmailTemplate): object;
}

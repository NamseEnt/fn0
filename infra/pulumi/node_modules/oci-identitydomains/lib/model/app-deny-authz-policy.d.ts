 ...
 *  - type: complex
 */
export interface AppDenyAuthzPolicy {
    /**
...
export declare namespace AppDenyAuthzPolicy {
    function getJsonObj(obj: AppDenyAuthzPolicy): object;
    function getDeserializedJsonObj(obj: AppDenyAuthzPolicy): object;
}

...
export declare namespace OciConsoleSignOnPolicyConsentModifiedResource {
    enum Type {
        Policy = "Policy",
        Rule = "Rule",
    ...
    function getJsonObj(obj: OciConsoleSignOnPolicyConsentModifiedResource): object;
    function getDeserializedJsonObj(obj: OciConsoleSignOnPolicyConsentModifiedResource): object;
}

...
export interface SecurityQuestions {
     ...
     */
    "resources": Array<model.SecurityQuestion>;
    /**
...
export declare namespace SecurityQuestions {
    function getJsonObj(obj: SecurityQuestions): object;
    function getDeserializedJsonObj(obj: SecurityQuestions): object;
}

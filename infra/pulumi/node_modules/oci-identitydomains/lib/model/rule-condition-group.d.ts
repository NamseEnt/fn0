...
export declare namespace RuleConditionGroup {
    enum Type {
        Condition = "Condition",
    ...
    function getJsonObj(obj: RuleConditionGroup): object;
    function getDeserializedJsonObj(obj: RuleConditionGroup): object;
}

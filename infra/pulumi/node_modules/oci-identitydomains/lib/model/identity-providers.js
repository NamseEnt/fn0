...
(function (IdentityProviders) {
        ...
        const jsonObj = Object.assign(Object.assign({}, obj), {
            "Resources": obj.resources
                ? obj.resources.map(item => {
                    return model.IdentityProvider.getJsonObj(item);
                })
                : undefined
        });
    ...
    IdentityProviders.getJsonObj = getJsonObj;
    function getDeserializedJsonObj(obj) {
        const jsonObj = Object.assign(Object.assign({}, obj), {
            "resources": obj["Resources"]
                ? obj["Resources"].map((item) => {
                    return model.IdentityProvider.getDeserializedJsonObj(item);
                })
                : undefined
        });
        delete jsonObj["Resources"];
    ...
    IdentityProviders.getDeserializedJsonObj = getDeserializedJsonObj;

...
export declare namespace UserExtPreferredDevice {
    function getJsonObj(obj: UserExtPreferredDevice): object;
    function getDeserializedJsonObj(obj: UserExtPreferredDevice): object;
}

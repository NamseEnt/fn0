...
export declare namespace AppDomainApp {
    function getJsonObj(obj: AppDomainApp): object;
    function getDeserializedJsonObj(obj: AppDomainApp): object;
}

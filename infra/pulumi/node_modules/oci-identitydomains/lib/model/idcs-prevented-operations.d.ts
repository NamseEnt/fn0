 ...
 **/
export declare enum IdcsPreventedOperations {
    Replace = "replace",
    Update = "update",
    Delete = "delete",
    /**
...
export declare namespace IdcsPreventedOperations {
    function getJsonObj(obj: IdcsPreventedOperations): IdcsPreventedOperations;
    function getDeserializedJsonObj(obj: IdcsPreventedOperations): IdcsPreventedOperations;
}

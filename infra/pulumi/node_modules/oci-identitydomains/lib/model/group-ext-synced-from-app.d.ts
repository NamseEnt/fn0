...
export declare namespace GroupExtSyncedFromApp {
    enum Type {
        App = "App",
        /**
    ...
    function getJsonObj(obj: GroupExtSyncedFromApp): object;
    function getDeserializedJsonObj(obj: GroupExtSyncedFromApp): object;
}

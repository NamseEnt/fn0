...
export declare namespace UserExtSyncedFromApp {
    enum Type {
    ...
    function getJsonObj(obj: UserExtSyncedFromApp): object;
    function getDeserializedJsonObj(obj: UserExtSyncedFromApp): object;
}

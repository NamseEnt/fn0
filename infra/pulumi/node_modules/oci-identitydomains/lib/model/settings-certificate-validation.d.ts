...
export declare namespace SettingsCertificateValidation {
    function getJsonObj(obj: SettingsCertificateValidation): object;
    function getDeserializedJsonObj(obj: SettingsCertificateValidation): object;
}

 ...
 */
export interface IdentityProofingProviderTemplateConfiguration {
    /**
...
export declare namespace IdentityProofingProviderTemplateConfiguration {
    function getJsonObj(obj: IdentityProofingProviderTemplateConfiguration): object;
    function getDeserializedJsonObj(obj: IdentityProofingProviderTemplateConfiguration): object;
}

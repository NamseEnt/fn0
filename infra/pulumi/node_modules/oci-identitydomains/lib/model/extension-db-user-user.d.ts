...
export declare namespace ExtensionDbUserUser {
    function getJsonObj(obj: ExtensionDbUserUser): object;
    function getDeserializedJsonObj(obj: ExtensionDbUserUser): object;
}

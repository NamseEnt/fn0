...
export declare namespace SettingsCloudGateCorsSettings {
    function getJsonObj(obj: SettingsCloudGateCorsSettings): object;
    function getDeserializedJsonObj(obj: SettingsCloudGateCorsSettings): object;
}

...
export interface AccountRecoverySettings {
     ...
     */
    "resources": Array<model.AccountRecoverySetting>;
    /**
...
export declare namespace AccountRecoverySettings {
    function getJsonObj(obj: AccountRecoverySettings): object;
    function getDeserializedJsonObj(obj: AccountRecoverySettings): object;
}

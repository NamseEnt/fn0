...
(function (Setting) {
    ...
    })(IdcsPreventedOperations = Setting.IdcsPreventedOperations || (Setting.IdcsPreventedOperations = {}));
    let ReAuthFactor;
    (function (ReAuthFactor) {
        ReAuthFactor["Password"] = "password";
        /**
         * This value is used if a service returns a value for this enum that is not recognized by this
         * version of the SDK.
         */
        ReAuthFactor["UnknownValue"] = "UNKNOWN_VALUE";
    })(ReAuthFactor = Setting.ReAuthFactor || (Setting.ReAuthFactor = {}));
    let CsrAccess;
    (function (CsrAccess) {
        CsrAccess["ReadOnly"] = "readOnly";
        CsrAccess["ReadWrite"] = "readWrite";
        CsrAccess["None"] = "none";
        /**
         * This value is used if a service returns a value for this enum that is not recognized by this
         * version of the SDK.
         */
        CsrAccess["UnknownValue"] = "UNKNOWN_VALUE";
    })(CsrAccess = Setting.CsrAccess || (Setting.CsrAccess = {}));
    let DefaultTrustScope;
    (function (DefaultTrustScope) {
        DefaultTrustScope["Explicit"] = "Explicit";
        DefaultTrustScope["Account"] = "Account";
        DefaultTrustScope["Tags"] = "Tags";
        /**
         * This value is used if a service returns a value for this enum that is not recognized by this
         * version of the SDK.
         */
        DefaultTrustScope["UnknownValue"] = "UNKNOWN_VALUE";
    })(DefaultTrustScope = Setting.DefaultTrustScope || (Setting.DefaultTrustScope = {}));
    ...
    Setting.getDeserializedJsonObj = getDeserializedJsonObj;

...
export interface PolicySearchRequest {
     ...
     */
    "attributeSets"?: Array<PolicySearchRequest.AttributeSets>;
    /**
...
export declare namespace PolicySearchRequest {
    enum AttributeSets {
        All = "all",
        Always = "always",
        Never = "never",
    ...
    function getJsonObj(obj: PolicySearchRequest): object;
    function getDeserializedJsonObj(obj: PolicySearchRequest): object;
}

...
export declare namespace AppConnectorBundle {
    enum Type {
    ...
    function getJsonObj(obj: AppConnectorBundle): object;
    function getDeserializedJsonObj(obj: AppConnectorBundle): object;
}

 ...
 *  - type: complex
 */
export interface IdcsLastModifiedBy {
    /**
...
export declare namespace IdcsLastModifiedBy {
    enum Type {
        User = "User",
        App = "App",
        /**
    ...
    function getJsonObj(obj: IdcsLastModifiedBy): object;
    function getDeserializedJsonObj(obj: IdcsLastModifiedBy): object;
}

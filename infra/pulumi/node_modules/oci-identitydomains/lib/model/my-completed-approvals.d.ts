 ...
 */
export interface MyCompletedApprovals {
    /**
     ...
     */
    "resources": Array<model.MyCompletedApproval>;
    /**
...
export declare namespace MyCompletedApprovals {
    function getJsonObj(obj: MyCompletedApprovals): object;
    function getDeserializedJsonObj(obj: MyCompletedApprovals): object;
}

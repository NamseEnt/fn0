...
export declare namespace CustomerSecretKeyUser {
    function getJsonObj(obj: CustomerSecretKeyUser): object;
    function getDeserializedJsonObj(obj: CustomerSecretKeyUser): object;
}

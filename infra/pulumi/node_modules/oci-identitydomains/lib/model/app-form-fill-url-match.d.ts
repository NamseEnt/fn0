...
export declare namespace AppFormFillUrlMatch {
    function getJsonObj(obj: AppFormFillUrlMatch): object;
    function getDeserializedJsonObj(obj: AppFormFillUrlMatch): object;
}

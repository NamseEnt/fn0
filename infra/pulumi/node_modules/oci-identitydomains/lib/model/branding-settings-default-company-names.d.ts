...
export declare namespace BrandingSettingsDefaultCompanyNames {
    function getJsonObj(obj: BrandingSettingsDefaultCompanyNames): object;
    function getDeserializedJsonObj(obj: BrandingSettingsDefaultCompanyNames): object;
}

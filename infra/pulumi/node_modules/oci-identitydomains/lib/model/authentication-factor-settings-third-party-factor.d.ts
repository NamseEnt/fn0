 ...
 *  - uniqueness: none
 */
export interface AuthenticationFactorSettingsThirdPartyFactor {
    /**
...
export declare namespace AuthenticationFactorSettingsThirdPartyFactor {
    function getJsonObj(obj: AuthenticationFactorSettingsThirdPartyFactor): object;
    function getDeserializedJsonObj(obj: AuthenticationFactorSettingsThirdPartyFactor): object;
}

...
export declare namespace UserExtBypassCodes {
    function getJsonObj(obj: UserExtBypassCodes): object;
    function getDeserializedJsonObj(obj: UserExtBypassCodes): object;
}

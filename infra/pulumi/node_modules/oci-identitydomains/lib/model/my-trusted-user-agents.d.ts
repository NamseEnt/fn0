 ...
 */
export interface MyTrustedUserAgents {
    /**
     ...
     */
    "resources": Array<model.MyTrustedUserAgent>;
    /**
...
export declare namespace MyTrustedUserAgents {
    function getJsonObj(obj: MyTrustedUserAgents): object;
    function getDeserializedJsonObj(obj: MyTrustedUserAgents): object;
}

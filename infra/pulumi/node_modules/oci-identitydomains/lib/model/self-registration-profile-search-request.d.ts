 ...
 */
export interface SelfRegistrationProfileSearchRequest {
    /**
     ...
     */
    "attributeSets"?: Array<SelfRegistrationProfileSearchRequest.AttributeSets>;
    /**
...
export declare namespace SelfRegistrationProfileSearchRequest {
    enum AttributeSets {
        All = "all",
        Always = "always",
        Never = "never",
    ...
    function getJsonObj(obj: SelfRegistrationProfileSearchRequest): object;
    function getDeserializedJsonObj(obj: SelfRegistrationProfileSearchRequest): object;
}

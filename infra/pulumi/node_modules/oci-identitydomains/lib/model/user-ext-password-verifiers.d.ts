 ...
 *  - uniqueness: none
 */
export interface UserExtPasswordVerifiers {
    /**
...
export declare namespace UserExtPasswordVerifiers {
    function getJsonObj(obj: UserExtPasswordVerifiers): object;
    function getDeserializedJsonObj(obj: UserExtPasswordVerifiers): object;
}

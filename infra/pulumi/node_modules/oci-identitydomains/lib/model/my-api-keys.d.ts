...
export interface MyApiKeys {
     ...
     */
    "resources": Array<model.MyApiKey>;
    /**
...
export declare namespace MyApiKeys {
    function getJsonObj(obj: MyApiKeys): object;
    function getDeserializedJsonObj(obj: MyApiKeys): object;
}

...
export declare namespace SelfRegistrationProfileDefaultGroups {
    function getJsonObj(obj: SelfRegistrationProfileDefaultGroups): object;
    function getDeserializedJsonObj(obj: SelfRegistrationProfileDefaultGroups): object;
}

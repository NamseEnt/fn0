 ...
 *
 */
export interface UserExtTermsOfUseConsents {
    "value": string;
    /**
...
export declare namespace UserExtTermsOfUseConsents {
    function getJsonObj(obj: UserExtTermsOfUseConsents): object;
    function getDeserializedJsonObj(obj: UserExtTermsOfUseConsents): object;
}

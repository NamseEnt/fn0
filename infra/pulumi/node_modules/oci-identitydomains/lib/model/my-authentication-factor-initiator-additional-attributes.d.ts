 ...
 */
export interface MyAuthenticationFactorInitiatorAdditionalAttributes {
    /**
...
export declare namespace MyAuthenticationFactorInitiatorAdditionalAttributes {
    function getJsonObj(obj: MyAuthenticationFactorInitiatorAdditionalAttributes): object;
    function getDeserializedJsonObj(obj: MyAuthenticationFactorInitiatorAdditionalAttributes): object;
}

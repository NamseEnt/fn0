...
export declare namespace ExtensionSecurityQuestionsUser {
    function getJsonObj(obj: ExtensionSecurityQuestionsUser): object;
    function getDeserializedJsonObj(obj: ExtensionSecurityQuestionsUser): object;
}

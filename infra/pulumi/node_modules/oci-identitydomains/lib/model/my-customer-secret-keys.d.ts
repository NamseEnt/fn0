 ...
 */
export interface MyCustomerSecretKeys {
    /**
     ...
     */
    "resources": Array<model.MyCustomerSecretKey>;
    /**
...
export declare namespace MyCustomerSecretKeys {
    function getJsonObj(obj: MyCustomerSecretKeys): object;
    function getDeserializedJsonObj(obj: MyCustomerSecretKeys): object;
}

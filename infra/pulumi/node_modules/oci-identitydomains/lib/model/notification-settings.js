...
(function (NotificationSettings) {
        ...
        const jsonObj = Object.assign(Object.assign({}, obj), {
            "Resources": obj.resources
                ? obj.resources.map(item => {
                    return model.NotificationSetting.getJsonObj(item);
                })
                : undefined
        });
    ...
    NotificationSettings.getJsonObj = getJsonObj;
    function getDeserializedJsonObj(obj) {
        const jsonObj = Object.assign(Object.assign({}, obj), {
            "resources": obj["Resources"]
                ? obj["Resources"].map((item) => {
                    return model.NotificationSetting.getDeserializedJsonObj(item);
                })
                : undefined
        });
        delete jsonObj["Resources"];
    ...
    NotificationSettings.getDeserializedJsonObj = getDeserializedJsonObj;

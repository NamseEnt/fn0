...
export declare namespace AppIdpPolicy {
    function getJsonObj(obj: AppIdpPolicy): object;
    function getDeserializedJsonObj(obj: AppIdpPolicy): object;
}

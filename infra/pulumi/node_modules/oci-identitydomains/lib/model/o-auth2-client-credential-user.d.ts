...
export declare namespace OAuth2ClientCredentialUser {
    function getJsonObj(obj: OAuth2ClientCredentialUser): object;
    function getDeserializedJsonObj(obj: OAuth2ClientCredentialUser): object;
}

...
export declare namespace AppFlatFileConnectorBundle {
    function getJsonObj(obj: AppFlatFileConnectorBundle): object;
    function getDeserializedJsonObj(obj: AppFlatFileConnectorBundle): object;
}

...
export declare namespace UserExtApplicablePasswordPolicy {
    function getJsonObj(obj: UserExtApplicablePasswordPolicy): object;
    function getDeserializedJsonObj(obj: UserExtApplicablePasswordPolicy): object;
}

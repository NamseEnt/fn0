 ...
 */
export interface CustomerSecretKeys {
    /**
     ...
     */
    "resources": Array<model.CustomerSecretKey>;
    /**
...
export declare namespace CustomerSecretKeys {
    function getJsonObj(obj: CustomerSecretKeys): object;
    function getDeserializedJsonObj(obj: CustomerSecretKeys): object;
}

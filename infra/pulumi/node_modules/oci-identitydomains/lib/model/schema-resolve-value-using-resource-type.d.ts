 ...
 */
export interface SchemaResolveValueUsingResourceType {
    /**
...
export declare namespace SchemaResolveValueUsingResourceType {
    function getJsonObj(obj: SchemaResolveValueUsingResourceType): object;
    function getDeserializedJsonObj(obj: SchemaResolveValueUsingResourceType): object;
}

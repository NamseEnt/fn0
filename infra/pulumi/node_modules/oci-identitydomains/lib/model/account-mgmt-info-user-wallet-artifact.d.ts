...
export declare namespace AccountMgmtInfoUserWalletArtifact {
    function getJsonObj(obj: AccountMgmtInfoUserWalletArtifact): object;
    function getDeserializedJsonObj(obj: AccountMgmtInfoUserWalletArtifact): object;
}

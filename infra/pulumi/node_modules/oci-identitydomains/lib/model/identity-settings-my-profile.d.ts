 ...
 *  - uniqueness: none
 */
export interface IdentitySettingsMyProfile {
    /**
...
export declare namespace IdentitySettingsMyProfile {
    function getJsonObj(obj: IdentitySettingsMyProfile): object;
    function getDeserializedJsonObj(obj: IdentitySettingsMyProfile): object;
}

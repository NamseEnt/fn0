...
export declare namespace ExtensionUserStateUser {
    function getJsonObj(obj: ExtensionUserStateUser): object;
    function getDeserializedJsonObj(obj: ExtensionUserStateUser): object;
}

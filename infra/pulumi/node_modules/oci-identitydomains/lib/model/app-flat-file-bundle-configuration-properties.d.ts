...
export declare namespace AppFlatFileBundleConfigurationProperties {
    enum IcfType {
        Long = "Long",
        String = "String",
        Character = "Character",
    ...
    function getJsonObj(obj: AppFlatFileBundleConfigurationProperties): object;
    function getDeserializedJsonObj(obj: AppFlatFileBundleConfigurationProperties): object;
}

...
export declare namespace IdentityProviderJitUserProvAttributes {
    function getJsonObj(obj: IdentityProviderJitUserProvAttributes): object;
    function getDeserializedJsonObj(obj: IdentityProviderJitUserProvAttributes): object;
}

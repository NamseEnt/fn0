...
(function (MyDevices) {
        ...
        const jsonObj = Object.assign(Object.assign({}, obj), {
            "Resources": obj.resources
                ? obj.resources.map(item => {
                    return model.MyDevice.getJsonObj(item);
                })
                : undefined
        });
    ...
    MyDevices.getJsonObj = getJsonObj;
    function getDeserializedJsonObj(obj) {
        const jsonObj = Object.assign(Object.assign({}, obj), {
            "resources": obj["Resources"]
                ? obj["Resources"].map((item) => {
                    return model.MyDevice.getDeserializedJsonObj(item);
                })
                : undefined
        });
        delete jsonObj["Resources"];
    ...
    MyDevices.getDeserializedJsonObj = getDeserializedJsonObj;
})(MyDevices = exports.MyDevices || (exports.MyDevices = {}));

...
export declare namespace AppExtensionKerberosRealmApp {
    function getJsonObj(obj: AppExtensionKerberosRealmApp): object;
    function getDeserializedJsonObj(obj: AppExtensionKerberosRealmApp): object;
}

...
export declare namespace ExtensionGroupGroup {
    ...
    function getJsonObj(obj: ExtensionGroupGroup): object;
    function getDeserializedJsonObj(obj: ExtensionGroupGroup): object;
}

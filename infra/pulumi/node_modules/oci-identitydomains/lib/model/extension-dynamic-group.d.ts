...
export declare namespace ExtensionDynamicGroup {
    enum MembershipType {
        Static = "static",
        Dynamic = "dynamic",
        /**
    ...
    function getJsonObj(obj: ExtensionDynamicGroup): object;
    function getDeserializedJsonObj(obj: ExtensionDynamicGroup): object;
}

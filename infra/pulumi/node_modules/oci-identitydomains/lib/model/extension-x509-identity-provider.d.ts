...
export declare namespace ExtensionX509IdentityProvider {
    enum EkuValues {
    ...
    function getJsonObj(obj: ExtensionX509IdentityProvider): object;
    function getDeserializedJsonObj(obj: ExtensionX509IdentityProvider): object;
}

...
export declare namespace IdentityProviderJitUserProvGroupMappings {
    function getJsonObj(obj: IdentityProviderJitUserProvGroupMappings): object;
    function getDeserializedJsonObj(obj: IdentityProviderJitUserProvGroupMappings): object;
}

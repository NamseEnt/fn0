...
export declare namespace AppExtensionWebTierPolicyApp {
    enum WebTierPolicyAZControl {
        Server = "server",
        Local = "local",
        /**
    ...
    function getJsonObj(obj: AppExtensionWebTierPolicyApp): object;
    function getDeserializedJsonObj(obj: AppExtensionWebTierPolicyApp): object;
}

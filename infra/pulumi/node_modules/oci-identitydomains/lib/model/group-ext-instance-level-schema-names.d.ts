...
export declare namespace GroupExtInstanceLevelSchemaNames {
    function getJsonObj(obj: GroupExtInstanceLevelSchemaNames): object;
    function getDeserializedJsonObj(obj: GroupExtInstanceLevelSchemaNames): object;
}

 ...
 */
export interface ConditionSearchRequest {
    /**
     ...
     */
    "attributeSets"?: Array<ConditionSearchRequest.AttributeSets>;
    /**
...
export declare namespace ConditionSearchRequest {
    enum AttributeSets {
        All = "all",
        Always = "always",
        Never = "never",
    ...
    function getJsonObj(obj: ConditionSearchRequest): object;
    function getDeserializedJsonObj(obj: ConditionSearchRequest): object;
}

 ...
 *  - type: complex
 */
export interface IdentityProofingProviderIdcsLockedBy {
    /**
     ...
     *  - uniqueness: none
     */
    "type"?: IdentityProofingProviderIdcsLockedBy.Type;
    /**
...
export declare namespace IdentityProofingProviderIdcsLockedBy {
    enum Type {
        User = "User",
        App = "App",
        /**
    ...
    function getJsonObj(obj: IdentityProofingProviderIdcsLockedBy): object;
    function getDeserializedJsonObj(obj: IdentityProofingProviderIdcsLockedBy): object;
}

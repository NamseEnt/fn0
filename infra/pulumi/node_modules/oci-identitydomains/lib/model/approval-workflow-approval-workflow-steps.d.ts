 ...
 */
export interface ApprovalWorkflowApprovalWorkflowSteps {
    /**
...
export declare namespace ApprovalWorkflowApprovalWorkflowSteps {
    function getJsonObj(obj: ApprovalWorkflowApprovalWorkflowSteps): object;
    function getDeserializedJsonObj(obj: ApprovalWorkflowApprovalWorkflowSteps): object;
}

 ...
 */
export interface DynamicResourceGroups {
    /**
     ...
     */
    "resources": Array<model.DynamicResourceGroup>;
    /**
...
export declare namespace DynamicResourceGroups {
    function getJsonObj(obj: DynamicResourceGroups): object;
    function getDeserializedJsonObj(obj: DynamicResourceGroups): object;
}

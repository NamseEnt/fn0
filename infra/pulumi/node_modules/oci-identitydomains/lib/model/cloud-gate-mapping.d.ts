 ...
 */
export interface CloudGateMapping {
    /**
     ...
     *  - uniqueness: none
     */
    "idcsPreventedOperations"?: Array<CloudGateMapping.IdcsPreventedOperations>;
    /**
     ...
     */
    "policyName": string;
    "upstreamServerGroup"?: model.CloudGateMappingUpstreamServerGroup;
    "server": model.CloudGateMappingServer;
    "gatewayApp": model.CloudGateMappingGatewayApp;
    "cloudGate": model.CloudGateMappingCloudGate;
}
export declare namespace CloudGateMapping {
    ...
    function getJsonObj(obj: CloudGateMapping): object;
    function getDeserializedJsonObj(obj: CloudGateMapping): object;
}

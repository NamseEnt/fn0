...
export declare namespace ExtensionDbcsGroup {
    function getJsonObj(obj: ExtensionDbcsGroup): object;
    function getDeserializedJsonObj(obj: ExtensionDbcsGroup): object;
}

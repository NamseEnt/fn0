...
export declare namespace OAuth2ClientCredentialScopes {
    function getJsonObj(obj: OAuth2ClientCredentialScopes): object;
    function getDeserializedJsonObj(obj: OAuth2ClientCredentialScopes): object;
}

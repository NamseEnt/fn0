...
export declare namespace AppBundleConfigurationProperties {
    enum IcfType {
        Long = "Long",
        String = "String",
        Character = "Character",
    ...
    function getJsonObj(obj: AppBundleConfigurationProperties): object;
    function getDeserializedJsonObj(obj: AppBundleConfigurationProperties): object;
}

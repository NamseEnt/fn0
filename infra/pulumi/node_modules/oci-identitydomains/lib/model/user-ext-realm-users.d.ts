...
export declare namespace UserExtRealmUsers {
    function getJsonObj(obj: UserExtRealmUsers): object;
    function getDeserializedJsonObj(obj: UserExtRealmUsers): object;
}

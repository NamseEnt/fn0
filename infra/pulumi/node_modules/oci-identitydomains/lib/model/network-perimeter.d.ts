 ...
 */
export interface NetworkPerimeter {
    /**
     ...
     *  - uniqueness: none
     */
    "idcsPreventedOperations"?: Array<NetworkPerimeter.IdcsPreventedOperations>;
    /**
     ...
     *  - uniqueness: none
     */
    "ipAddresses": Array<model.NetworkPerimeterIpAddresses>;
}
export declare namespace NetworkPerimeter {
    ...
    function getJsonObj(obj: NetworkPerimeter): object;
    function getDeserializedJsonObj(obj: NetworkPerimeter): object;
}

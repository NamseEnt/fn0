...
export interface SchemaSearchRequest {
     ...
     */
    "attributeSets"?: Array<SchemaSearchRequest.AttributeSets>;
    /**
...
export declare namespace SchemaSearchRequest {
    enum AttributeSets {
        All = "all",
        Always = "always",
        Never = "never",
    ...
    function getJsonObj(obj: SchemaSearchRequest): object;
    function getDeserializedJsonObj(obj: SchemaSearchRequest): object;
}

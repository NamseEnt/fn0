 ...
 */
export interface IdentityProofingProviders {
    /**
     ...
     */
    "resources": Array<model.IdentityProofingProvider>;
    /**
...
export declare namespace IdentityProofingProviders {
    function getJsonObj(obj: IdentityProofingProviders): object;
    function getDeserializedJsonObj(obj: IdentityProofingProviders): object;
}

...
export declare namespace CloudGateExtUpstreamServers {
    function getJsonObj(obj: CloudGateExtUpstreamServers): object;
    function getDeserializedJsonObj(obj: CloudGateExtUpstreamServers): object;
}

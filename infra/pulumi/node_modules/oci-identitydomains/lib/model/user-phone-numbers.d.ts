...
export declare namespace UserPhoneNumbers {
    enum Type {
        Work = "work",
        Home = "home",
        Mobile = "mobile",
    ...
    function getJsonObj(obj: UserPhoneNumbers): object;
    function getDeserializedJsonObj(obj: UserPhoneNumbers): object;
}

...
export declare namespace CloudGateMappingUpstreamServerGroup {
    function getJsonObj(obj: CloudGateMappingUpstreamServerGroup): object;
    function getDeserializedJsonObj(obj: CloudGateMappingUpstreamServerGroup): object;
}

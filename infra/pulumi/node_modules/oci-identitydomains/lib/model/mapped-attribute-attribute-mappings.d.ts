...
export declare namespace MappedAttributeAttributeMappings {
    enum AppliesToActions {
        Create = "create",
        Update = "update",
        /**
    ...
    function getJsonObj(obj: MappedAttributeAttributeMappings): object;
    function getDeserializedJsonObj(obj: MappedAttributeAttributeMappings): object;
}

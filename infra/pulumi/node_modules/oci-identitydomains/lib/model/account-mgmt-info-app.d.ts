...
export declare namespace AccountMgmtInfoApp {
    function getJsonObj(obj: AccountMgmtInfoApp): object;
    function getDeserializedJsonObj(obj: AccountMgmtInfoApp): object;
}

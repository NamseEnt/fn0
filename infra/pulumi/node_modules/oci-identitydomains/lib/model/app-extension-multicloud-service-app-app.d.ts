...
export declare namespace AppExtensionMulticloudServiceAppApp {
    enum MulticloudServiceType {
    ...
    function getJsonObj(obj: AppExtensionMulticloudServiceAppApp): object;
    function getDeserializedJsonObj(obj: AppExtensionMulticloudServiceAppApp): object;
}

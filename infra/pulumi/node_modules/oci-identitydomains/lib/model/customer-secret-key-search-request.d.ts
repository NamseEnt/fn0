 ...
 */
export interface CustomerSecretKeySearchRequest {
    /**
     ...
     */
    "attributeSets"?: Array<CustomerSecretKeySearchRequest.AttributeSets>;
    /**
...
export declare namespace CustomerSecretKeySearchRequest {
    enum AttributeSets {
        All = "all",
        Always = "always",
        Never = "never",
    ...
    function getJsonObj(obj: CustomerSecretKeySearchRequest): object;
    function getDeserializedJsonObj(obj: CustomerSecretKeySearchRequest): object;
}

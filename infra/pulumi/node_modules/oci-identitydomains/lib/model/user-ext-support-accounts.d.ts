...
export declare namespace UserExtSupportAccounts {
    function getJsonObj(obj: UserExtSupportAccounts): object;
    function getDeserializedJsonObj(obj: UserExtSupportAccounts): object;
}

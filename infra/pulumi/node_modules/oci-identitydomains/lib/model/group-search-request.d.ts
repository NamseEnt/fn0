...
export interface GroupSearchRequest {
     ...
     */
    "attributeSets"?: Array<GroupSearchRequest.AttributeSets>;
    /**
...
export declare namespace GroupSearchRequest {
    enum AttributeSets {
        All = "all",
        Always = "always",
        Never = "never",
    ...
    function getJsonObj(obj: GroupSearchRequest): object;
    function getDeserializedJsonObj(obj: GroupSearchRequest): object;
}

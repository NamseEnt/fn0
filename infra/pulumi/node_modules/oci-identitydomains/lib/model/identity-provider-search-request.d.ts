...
export interface IdentityProviderSearchRequest {
     ...
     */
    "attributeSets"?: Array<IdentityProviderSearchRequest.AttributeSets>;
    /**
...
export declare namespace IdentityProviderSearchRequest {
    enum AttributeSets {
        All = "all",
        Always = "always",
        Never = "never",
    ...
    function getJsonObj(obj: IdentityProviderSearchRequest): object;
    function getDeserializedJsonObj(obj: IdentityProviderSearchRequest): object;
}

 ...
 */
export interface ResourceTypeSchemaAttributeSearchRequest {
    /**
     ...
     */
    "attributeSets"?: Array<ResourceTypeSchemaAttributeSearchRequest.AttributeSets>;
    /**
...
export declare namespace ResourceTypeSchemaAttributeSearchRequest {
    enum AttributeSets {
        All = "all",
        Always = "always",
        Never = "never",
    ...
    function getJsonObj(obj: ResourceTypeSchemaAttributeSearchRequest): object;
    function getDeserializedJsonObj(obj: ResourceTypeSchemaAttributeSearchRequest): object;
}

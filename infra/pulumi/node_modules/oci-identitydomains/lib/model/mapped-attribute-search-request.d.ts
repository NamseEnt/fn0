 ...
 */
export interface MappedAttributeSearchRequest {
    /**
     ...
     */
    "attributeSets"?: Array<MappedAttributeSearchRequest.AttributeSets>;
    /**
...
export declare namespace MappedAttributeSearchRequest {
    enum AttributeSets {
        All = "all",
        Always = "always",
        Never = "never",
    ...
    function getJsonObj(obj: MappedAttributeSearchRequest): object;
    function getDeserializedJsonObj(obj: MappedAttributeSearchRequest): object;
}

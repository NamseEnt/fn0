...
export declare namespace CloudGateMappingGatewayApp {
    function getJsonObj(obj: CloudGateMappingGatewayApp): object;
    function getDeserializedJsonObj(obj: CloudGateMappingGatewayApp): object;
}

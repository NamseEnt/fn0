 ...
 *  - uniqueness: none
 */
export interface UserExtSmtpCredentials {
    /**
...
export declare namespace UserExtSmtpCredentials {
    function getJsonObj(obj: UserExtSmtpCredentials): object;
    function getDeserializedJsonObj(obj: UserExtSmtpCredentials): object;
}

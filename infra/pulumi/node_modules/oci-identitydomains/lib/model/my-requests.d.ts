...
export interface MyRequests {
     ...
     */
    "resources": Array<model.MyRequest>;
    /**
...
export declare namespace MyRequests {
    function getJsonObj(obj: MyRequests): object;
    function getDeserializedJsonObj(obj: MyRequests): object;
}

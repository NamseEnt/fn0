 ...
 */
export interface PasswordPolicySearchRequest {
    /**
     ...
     */
    "attributeSets"?: Array<PasswordPolicySearchRequest.AttributeSets>;
    /**
...
export declare namespace PasswordPolicySearchRequest {
    enum AttributeSets {
        All = "all",
        Always = "always",
        Never = "never",
    ...
    function getJsonObj(obj: PasswordPolicySearchRequest): object;
    function getDeserializedJsonObj(obj: PasswordPolicySearchRequest): object;
}

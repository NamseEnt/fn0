...
export declare namespace DynamicResourceGroupGrants {
    enum GrantMechanism {
    ...
    function getJsonObj(obj: DynamicResourceGroupGrants): object;
    function getDeserializedJsonObj(obj: DynamicResourceGroupGrants): object;
}

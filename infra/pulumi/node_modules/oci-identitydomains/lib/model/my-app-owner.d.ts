...
export declare namespace MyAppOwner {
    function getJsonObj(obj: MyAppOwner): object;
    function getDeserializedJsonObj(obj: MyAppOwner): object;
}

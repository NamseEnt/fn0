 ...
 */
export interface IdentityPropagationTrusts {
    /**
     ...
     */
    "resources": Array<model.IdentityPropagationTrust>;
    /**
...
export declare namespace IdentityPropagationTrusts {
    function getJsonObj(obj: IdentityPropagationTrusts): object;
    function getDeserializedJsonObj(obj: IdentityPropagationTrusts): object;
}

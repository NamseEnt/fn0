...
export declare namespace ApprovalWorkflowMaxDuration {
    enum Unit {
        Month = "MONTH",
        Week = "WEEK",
        Day = "DAY",
    ...
    function getJsonObj(obj: ApprovalWorkflowMaxDuration): object;
    function getDeserializedJsonObj(obj: ApprovalWorkflowMaxDuration): object;
}

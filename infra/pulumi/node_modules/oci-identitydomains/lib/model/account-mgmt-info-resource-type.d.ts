...
export declare namespace AccountMgmtInfoResourceType {
    function getJsonObj(obj: AccountMgmtInfoResourceType): object;
    function getDeserializedJsonObj(obj: AccountMgmtInfoResourceType): object;
}

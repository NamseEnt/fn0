...
export declare namespace MyOAuth2ClientCredentialUser {
    function getJsonObj(obj: MyOAuth2ClientCredentialUser): object;
    function getDeserializedJsonObj(obj: MyOAuth2ClientCredentialUser): object;
}

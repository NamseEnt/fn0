 ...
 **/
export declare enum AttributeSets {
    All = "all",
    Always = "always",
    Never = "never",
    Request = "request",
...
export declare namespace AttributeSets {
    function getJsonObj(obj: AttributeSets): AttributeSets;
    function getDeserializedJsonObj(obj: AttributeSets): AttributeSets;
}

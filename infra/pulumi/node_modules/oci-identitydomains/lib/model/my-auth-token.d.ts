...
export interface MyAuthToken {
     ...
     *  - uniqueness: none
     */
    "idcsPreventedOperations"?: Array<MyAuthToken.IdcsPreventedOperations>;
    /**
     ...
     */
    "expiresOn"?: string;
    "user"?: model.MyAuthTokenUser;
}
export declare namespace MyAuthToken {
    ...
    function getJsonObj(obj: MyAuthToken): object;
    function getDeserializedJsonObj(obj: MyAuthToken): object;
}

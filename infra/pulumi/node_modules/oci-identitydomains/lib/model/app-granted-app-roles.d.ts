...
export declare namespace AppGrantedAppRoles {
    enum Type {
        Direct = "direct",
        Indirect = "indirect",
        /**
    ...
    function getJsonObj(obj: AppGrantedAppRoles): object;
    function getDeserializedJsonObj(obj: AppGrantedAppRoles): object;
}

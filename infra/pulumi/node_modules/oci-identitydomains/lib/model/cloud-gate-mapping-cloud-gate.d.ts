 ...
 *  - uniqueness: none
 */
export interface CloudGateMappingCloudGate {
    /**
...
export declare namespace CloudGateMappingCloudGate {
    function getJsonObj(obj: CloudGateMappingCloudGate): object;
    function getDeserializedJsonObj(obj: CloudGateMappingCloudGate): object;
}

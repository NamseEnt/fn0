...
export interface MappedAttributes {
     ...
     */
    "resources": Array<model.MappedAttribute>;
    /**
...
export declare namespace MappedAttributes {
    function getJsonObj(obj: MappedAttributes): object;
    function getDeserializedJsonObj(obj: MappedAttributes): object;
}

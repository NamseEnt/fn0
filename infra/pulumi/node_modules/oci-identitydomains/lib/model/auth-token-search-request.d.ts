 ...
 */
export interface AuthTokenSearchRequest {
    /**
     ...
     */
    "attributeSets"?: Array<AuthTokenSearchRequest.AttributeSets>;
    /**
...
export declare namespace AuthTokenSearchRequest {
    enum AttributeSets {
        All = "all",
        Always = "always",
        Never = "never",
    ...
    function getJsonObj(obj: AuthTokenSearchRequest): object;
    function getDeserializedJsonObj(obj: AuthTokenSearchRequest): object;
}

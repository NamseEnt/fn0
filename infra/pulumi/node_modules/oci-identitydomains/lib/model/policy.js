...
(function (Policy) {
    ...
    })(IdcsPreventedOperations = Policy.IdcsPreventedOperations || (Policy.IdcsPreventedOperations = {}));
    function getJsonObj(obj) {
        const jsonObj = Object.assign(Object.assign({}, obj), {
            ...
            "urn:ietf:params:scim:schemas:oracle:idcs:extension:ociconsolesignonpolicyconsent:Policy": obj.urnIetfParamsScimSchemasOracleIdcsExtensionOciconsolesignonpolicyconsentPolicy
                ? model.PolicyExtensionOciconsolesignonpolicyconsentPolicy.getJsonObj(obj.urnIetfParamsScimSchemasOracleIdcsExtensionOciconsolesignonpolicyconsentPolicy)
                : undefined
        });
        delete jsonObj
    ...
    function getDeserializedJsonObj(obj) {
        const jsonObj = Object.assign(Object.assign({}, obj), {
            ...
            "rules": obj.rules
                ? obj.rules.map(item => {
                    return model.PolicyRules.getDeserializedJsonObj(item);
                })
                : undefined,
            "policyType": obj.policyType
            ...
            "urnIetfParamsScimSchemasOracleIdcsExtensionOciconsolesignonpolicyconsentPolicy": obj["urn:ietf:params:scim:schemas:oracle:idcs:extension:ociconsolesignonpolicyconsent:Policy"]
                ? model.PolicyExtensionOciconsolesignonpolicyconsentPolicy.getDeserializedJsonObj(obj["urn:ietf:params:scim:schemas:oracle:idcs:extension:ociconsolesignonpolicyconsent:Policy"])
                : undefined
        });

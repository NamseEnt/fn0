 ...
 */
export interface MyUserDbCredentials {
    /**
     ...
     */
    "resources": Array<model.MyUserDbCredential>;
    /**
...
export declare namespace MyUserDbCredentials {
    function getJsonObj(obj: MyUserDbCredentials): object;
    function getDeserializedJsonObj(obj: MyUserDbCredentials): object;
}

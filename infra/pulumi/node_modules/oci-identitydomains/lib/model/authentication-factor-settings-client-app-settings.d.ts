...
export declare namespace AuthenticationFactorSettingsClientAppSettings {
    enum RequestSigningAlgo {
    ...
    function getJsonObj(obj: AuthenticationFactorSettingsClientAppSettings): object;
    function getDeserializedJsonObj(obj: AuthenticationFactorSettingsClientAppSettings): object;
}

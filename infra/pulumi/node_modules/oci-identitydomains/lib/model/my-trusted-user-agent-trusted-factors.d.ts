...
export declare namespace MyTrustedUserAgentTrustedFactors {
    enum Category {
        Saml = "SAML",
        Local = "LOCAL",
        Social = "SOCIAL",
    ...
    function getJsonObj(obj: MyTrustedUserAgentTrustedFactors): object;
    function getDeserializedJsonObj(obj: MyTrustedUserAgentTrustedFactors): object;
}

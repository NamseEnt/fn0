 ...
 */
export interface MyOAuth2ClientCredentials {
    /**
     ...
     */
    "resources": Array<model.MyOAuth2ClientCredential>;
    /**
...
export declare namespace MyOAuth2ClientCredentials {
    function getJsonObj(obj: MyOAuth2ClientCredentials): object;
    function getDeserializedJsonObj(obj: MyOAuth2ClientCredentials): object;
}

...
export interface MyRequestSearchRequest {
     ...
     */
    "attributeSets"?: Array<MyRequestSearchRequest.AttributeSets>;
    /**
...
export declare namespace MyRequestSearchRequest {
    enum AttributeSets {
        All = "all",
        Always = "always",
        Never = "never",
    ...
    function getJsonObj(obj: MyRequestSearchRequest): object;
    function getDeserializedJsonObj(obj: MyRequestSearchRequest): object;
}

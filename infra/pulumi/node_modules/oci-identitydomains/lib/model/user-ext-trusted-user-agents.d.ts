...
export declare namespace UserExtTrustedUserAgents {
    function getJsonObj(obj: UserExtTrustedUserAgents): object;
    function getDeserializedJsonObj(obj: UserExtTrustedUserAgents): object;
}

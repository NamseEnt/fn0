 ...
 */
export interface PasswordPolicyConfiguredPasswordPolicyRules {
    /**
...
export declare namespace PasswordPolicyConfiguredPasswordPolicyRules {
    function getJsonObj(obj: PasswordPolicyConfiguredPasswordPolicyRules): object;
    function getDeserializedJsonObj(obj: PasswordPolicyConfiguredPasswordPolicyRules): object;
}

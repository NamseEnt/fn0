...
export interface MyAuthTokens {
     ...
     */
    "resources": Array<model.MyAuthToken>;
    /**
...
export declare namespace MyAuthTokens {
    function getJsonObj(obj: MyAuthTokens): object;
    function getDeserializedJsonObj(obj: MyAuthTokens): object;
}

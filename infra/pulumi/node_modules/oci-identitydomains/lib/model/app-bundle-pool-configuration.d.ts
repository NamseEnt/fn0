...
export declare namespace AppBundlePoolConfiguration {
    function getJsonObj(obj: AppBundlePoolConfiguration): object;
    function getDeserializedJsonObj(obj: AppBundlePoolConfiguration): object;
}

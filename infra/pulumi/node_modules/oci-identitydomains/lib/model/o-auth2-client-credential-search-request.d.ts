 ...
 */
export interface OAuth2ClientCredentialSearchRequest {
    /**
     ...
     */
    "attributeSets"?: Array<OAuth2ClientCredentialSearchRequest.AttributeSets>;
    /**
...
export declare namespace OAuth2ClientCredentialSearchRequest {
    enum AttributeSets {
        All = "all",
        Always = "always",
        Never = "never",
    ...
    function getJsonObj(obj: OAuth2ClientCredentialSearchRequest): object;
    function getDeserializedJsonObj(obj: OAuth2ClientCredentialSearchRequest): object;
}

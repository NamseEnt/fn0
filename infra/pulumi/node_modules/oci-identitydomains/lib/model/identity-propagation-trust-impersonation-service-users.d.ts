 ...
 */
export interface IdentityPropagationTrustImpersonationServiceUsers {
    /**
...
export declare namespace IdentityPropagationTrustImpersonationServiceUsers {
    function getJsonObj(obj: IdentityPropagationTrustImpersonationServiceUsers): object;
    function getDeserializedJsonObj(obj: IdentityPropagationTrustImpersonationServiceUsers): object;
}

...
export declare namespace GrantAppEntitlementCollection {
    function getJsonObj(obj: GrantAppEntitlementCollection): object;
    function getDeserializedJsonObj(obj: GrantAppEntitlementCollection): object;
}

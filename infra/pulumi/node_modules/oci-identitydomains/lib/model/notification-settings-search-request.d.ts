 ...
 */
export interface NotificationSettingsSearchRequest {
    /**
     ...
     */
    "attributeSets"?: Array<NotificationSettingsSearchRequest.AttributeSets>;
}
export declare namespace NotificationSettingsSearchRequest {
    enum AttributeSets {
        All = "all",
        Always = "always",
        Never = "never",
    ...
    function getJsonObj(obj: NotificationSettingsSearchRequest): object;
    function getDeserializedJsonObj(obj: NotificationSettingsSearchRequest): object;
}

 ...
 */
export interface OAuthPartnerCertificates {
    /**
     ...
     */
    "resources": Array<model.OAuthPartnerCertificate>;
    /**
...
export declare namespace OAuthPartnerCertificates {
    function getJsonObj(obj: OAuthPartnerCertificates): object;
    function getDeserializedJsonObj(obj: OAuthPartnerCertificates): object;
}

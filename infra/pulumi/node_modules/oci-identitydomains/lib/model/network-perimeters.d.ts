 ...
 */
export interface NetworkPerimeters {
    /**
     ...
     */
    "resources": Array<model.NetworkPerimeter>;
    /**
...
export declare namespace NetworkPerimeters {
    function getJsonObj(obj: NetworkPerimeters): object;
    function getDeserializedJsonObj(obj: NetworkPerimeters): object;
}

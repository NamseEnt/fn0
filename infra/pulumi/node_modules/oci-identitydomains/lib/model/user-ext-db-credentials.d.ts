...
export declare namespace UserExtDbCredentials {
    function getJsonObj(obj: UserExtDbCredentials): object;
    function getDeserializedJsonObj(obj: UserExtDbCredentials): object;
}

...
export declare namespace UserExtSelfRegistrationProfile {
    function getJsonObj(obj: UserExtSelfRegistrationProfile): object;
    function getDeserializedJsonObj(obj: UserExtSelfRegistrationProfile): object;
}

 ...
 */
export interface MyAppSearchRequest {
    /**
     ...
     */
    "attributeSets"?: Array<MyAppSearchRequest.AttributeSets>;
    /**
...
export declare namespace MyAppSearchRequest {
    enum AttributeSets {
        All = "all",
        Always = "always",
        Never = "never",
    ...
    function getJsonObj(obj: MyAppSearchRequest): object;
    function getDeserializedJsonObj(obj: MyAppSearchRequest): object;
}

...
export declare namespace SettingsTenantCustomClaims {
    enum Mode {
        Always = "always",
        Request = "request",
        Never = "never",
    ...
    function getJsonObj(obj: SettingsTenantCustomClaims): object;
    function getDeserializedJsonObj(obj: SettingsTenantCustomClaims): object;
}

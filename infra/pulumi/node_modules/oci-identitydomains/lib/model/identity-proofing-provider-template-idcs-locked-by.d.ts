 ...
 *  - type: complex
 */
export interface IdentityProofingProviderTemplateIdcsLockedBy {
    /**
     ...
     *  - uniqueness: none
     */
    "type"?: IdentityProofingProviderTemplateIdcsLockedBy.Type;
    /**
...
export declare namespace IdentityProofingProviderTemplateIdcsLockedBy {
    enum Type {
        User = "User",
        App = "App",
        /**
    ...
    function getJsonObj(obj: IdentityProofingProviderTemplateIdcsLockedBy): object;
    function getDeserializedJsonObj(obj: IdentityProofingProviderTemplateIdcsLockedBy): object;
}

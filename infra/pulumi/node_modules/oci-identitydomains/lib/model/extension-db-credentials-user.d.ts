...
export declare namespace ExtensionDbCredentialsUser {
    function getJsonObj(obj: ExtensionDbCredentialsUser): object;
    function getDeserializedJsonObj(obj: ExtensionDbCredentialsUser): object;
}

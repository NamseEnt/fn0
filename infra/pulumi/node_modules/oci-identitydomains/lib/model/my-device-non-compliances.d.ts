...
export declare namespace MyDeviceNonCompliances {
    enum Action {
        Notify = "NOTIFY",
        Block = "BLOCK",
        Allow = "ALLOW",
    ...
    function getJsonObj(obj: MyDeviceNonCompliances): object;
    function getDeserializedJsonObj(obj: MyDeviceNonCompliances): object;
}

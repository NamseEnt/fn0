...
export declare namespace BrandingSettingsDefaultLoginTexts {
    function getJsonObj(obj: BrandingSettingsDefaultLoginTexts): object;
    function getDeserializedJsonObj(obj: BrandingSettingsDefaultLoginTexts): object;
}

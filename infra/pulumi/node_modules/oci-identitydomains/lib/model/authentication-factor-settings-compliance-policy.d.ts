 ...
 */
export interface AuthenticationFactorSettingsCompliancePolicy {
    /**
     ...
     *  - uniqueness: none
     */
    "action": AuthenticationFactorSettingsCompliancePolicy.Action;
    /**
...
export declare namespace AuthenticationFactorSettingsCompliancePolicy {
    enum Action {
        Allow = "Allow",
        Block = "Block",
        Notify = "Notify",
    ...
    function getJsonObj(obj: AuthenticationFactorSettingsCompliancePolicy): object;
    function getDeserializedJsonObj(obj: AuthenticationFactorSettingsCompliancePolicy): object;
}

...
export declare namespace CreateExportDetails {
    function getJsonObj(obj: CreateExportDetails): object;
    function getDeserializedJsonObj(obj: CreateExportDetails): object;
}

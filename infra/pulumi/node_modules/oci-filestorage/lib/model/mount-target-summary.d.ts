...
export declare namespace MountTargetSummary {
    enum LifecycleState {
        Creating = "CREATING",
        Active = "ACTIVE",
        Deleting = "DELETING",
    ...
    function getJsonObj(obj: MountTargetSummary): object;
    function getDeserializedJsonObj(obj: MountTargetSummary): object;
}

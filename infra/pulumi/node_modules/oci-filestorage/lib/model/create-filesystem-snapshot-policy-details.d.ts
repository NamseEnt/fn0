...
export declare namespace CreateFilesystemSnapshotPolicyDetails {
    function getJsonObj(obj: CreateFilesystemSnapshotPolicyDetails): object;
    function getDeserializedJsonObj(obj: CreateFilesystemSnapshotPolicyDetails): object;
}

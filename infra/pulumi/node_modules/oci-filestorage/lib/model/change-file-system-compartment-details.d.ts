...
export declare namespace ChangeFileSystemCompartmentDetails {
    function getJsonObj(obj: ChangeFileSystemCompartmentDetails): object;
    function getDeserializedJsonObj(obj: ChangeFileSystemCompartmentDetails): object;
}

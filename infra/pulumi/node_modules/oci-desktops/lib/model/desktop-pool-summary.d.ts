...
export declare namespace DesktopPoolSummary {
    function getJsonObj(obj: DesktopPoolSummary): object;
    function getDeserializedJsonObj(obj: DesktopPoolSummary): object;
}

...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/datalabelingservicedataplane/ListAnnotations.ts.html |here} to see how to use ListAnnotationsRequest.
 */
...
export declare namespace ListAnnotationsRequest {
    enum SortBy {

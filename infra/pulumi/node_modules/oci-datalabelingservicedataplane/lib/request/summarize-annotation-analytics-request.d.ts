...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/datalabelingservicedataplane/SummarizeAnnotationAnalytics.ts.html |here} to see how to use SummarizeAnnotationAnalyticsRequest.
 */
export interface SummarizeAnnotationAnalyticsRequest extends common.BaseRequest {
    /**
...
export declare namespace SummarizeAnnotationAnalyticsRequest {
    enum SortBy {
        Count = "count",
        Label = "label",
        UpdatedBy = "updatedBy"
    }
    enum AnnotationGroupBy {
        UpdatedBy = "updatedBy",
        Label = "label"
    }
}

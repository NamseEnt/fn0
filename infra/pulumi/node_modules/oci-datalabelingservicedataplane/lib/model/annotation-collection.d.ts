...
export declare namespace AnnotationCollection {
    function getJsonObj(obj: AnnotationCollection): object;
    function getDeserializedJsonObj(obj: AnnotationCollection): object;
}

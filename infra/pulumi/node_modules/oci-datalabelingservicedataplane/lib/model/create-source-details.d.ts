...
export declare namespace CreateSourceDetails {
    function getJsonObj(obj: CreateSourceDetails): object;
    function getDeserializedJsonObj(obj: CreateSourceDetails): object;
}

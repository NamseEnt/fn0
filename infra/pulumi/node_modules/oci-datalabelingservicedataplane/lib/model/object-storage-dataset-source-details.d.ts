...
export declare namespace ObjectStorageDatasetSourceDetails {
    function getJsonObj(obj: ObjectStorageDatasetSourceDetails, isParentJsonObj?: boolean): object;
    const sourceType = "OBJECT_STORAGE";
    function getDeserializedJsonObj(obj: ObjectStorageDatasetSourceDetails, isParentJsonObj?: boolean): object;
}

...
export declare namespace AnnotationAnalyticsAggregation {
    function getJsonObj(obj: AnnotationAnalyticsAggregation): object;
    function getDeserializedJsonObj(obj: AnnotationAnalyticsAggregation): object;
}

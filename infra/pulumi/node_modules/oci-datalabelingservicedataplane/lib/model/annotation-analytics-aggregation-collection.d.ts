...
export declare namespace AnnotationAnalyticsAggregationCollection {
    function getJsonObj(obj: AnnotationAnalyticsAggregationCollection): object;
    function getDeserializedJsonObj(obj: AnnotationAnalyticsAggregationCollection): object;
}

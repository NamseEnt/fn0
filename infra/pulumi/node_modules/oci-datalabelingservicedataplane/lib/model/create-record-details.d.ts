...
export declare namespace CreateRecordDetails {
    function getJsonObj(obj: CreateRecordDetails): object;
    function getDeserializedJsonObj(obj: CreateRecordDetails): object;
}

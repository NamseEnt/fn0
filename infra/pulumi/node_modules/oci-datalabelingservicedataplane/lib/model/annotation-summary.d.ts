...
export declare namespace AnnotationSummary {
    function getJsonObj(obj: AnnotationSummary): object;
    function getDeserializedJsonObj(obj: AnnotationSummary): object;
}

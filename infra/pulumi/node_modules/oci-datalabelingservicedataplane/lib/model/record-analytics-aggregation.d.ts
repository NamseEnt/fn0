...
export declare namespace RecordAnalyticsAggregation {
    function getJsonObj(obj: RecordAnalyticsAggregation): object;
    function getDeserializedJsonObj(obj: RecordAnalyticsAggregation): object;
}

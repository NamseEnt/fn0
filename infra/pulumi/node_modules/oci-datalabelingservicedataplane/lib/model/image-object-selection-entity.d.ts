...
export declare namespace ImageObjectSelectionEntity {
    function getJsonObj(obj: ImageObjectSelectionEntity, isParentJsonObj?: boolean): object;
    const entityType = "IMAGEOBJECTSELECTION";
    function getDeserializedJsonObj(obj: ImageObjectSelectionEntity, isParentJsonObj?: boolean): object;
}

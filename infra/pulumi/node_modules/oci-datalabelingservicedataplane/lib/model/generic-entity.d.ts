...
export declare namespace GenericEntity {
    function getJsonObj(obj: GenericEntity, isParentJsonObj?: boolean): object;
    const entityType = "GENERIC";
    function getDeserializedJsonObj(obj: GenericEntity, isParentJsonObj?: boolean): object;
}

...
export declare namespace ImageMetadata {
    function getJsonObj(obj: ImageMetadata, isParentJsonObj?: boolean): object;
    const recordType = "IMAGE_METADATA";
    function getDeserializedJsonObj(obj: ImageMetadata, isParentJsonObj?: boolean): object;
}

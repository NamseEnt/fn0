...
export declare namespace BulkUploadTemplate {
    function getJsonObj(obj: BulkUploadTemplate): object;
    function getDeserializedJsonObj(obj: BulkUploadTemplate): object;
}

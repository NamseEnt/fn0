...
export declare namespace BulkUploadLicenseRecordsDetails {
    function getJsonObj(obj: BulkUploadLicenseRecordsDetails): object;
    function getDeserializedJsonObj(obj: BulkUploadLicenseRecordsDetails): object;
}

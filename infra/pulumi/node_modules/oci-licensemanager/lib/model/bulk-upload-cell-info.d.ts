...
export declare namespace BulkUploadCellInfo {
    function getJsonObj(obj: BulkUploadCellInfo): object;
    function getDeserializedJsonObj(obj: BulkUploadCellInfo): object;
}

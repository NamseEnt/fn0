...
import * as licensemanager_waiter from "./lib/licensemanager-waiter";
export { models };
export { requests };
export { responses };
export import LicenseManagerClient = client.LicenseManagerClient;
export import LicenseManagerWaiter = licensemanager_waiter.LicenseManagerWaiter;

...
export declare namespace ChangeKeyCompartmentDetails {
    function getJsonObj(obj: ChangeKeyCompartmentDetails): object;
    function getDeserializedJsonObj(obj: ChangeKeyCompartmentDetails): object;
}

...
export declare namespace ChangeVaultCompartmentDetails {
    function getJsonObj(obj: ChangeVaultCompartmentDetails): object;
    function getDeserializedJsonObj(obj: ChangeVaultCompartmentDetails): object;
}

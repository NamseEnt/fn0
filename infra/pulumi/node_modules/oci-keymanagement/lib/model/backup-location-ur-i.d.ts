...
export declare namespace BackupLocationURI {
    function getJsonObj(obj: BackupLocationURI, isParentJsonObj?: boolean): object;
    const destination = "PRE_AUTHENTICATED_REQUEST_URI";
    function getDeserializedJsonObj(obj: BackupLocationURI, isParentJsonObj?: boolean): object;
}

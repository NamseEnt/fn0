...
export declare namespace VaultReplicaDetails {
    function getJsonObj(obj: VaultReplicaDetails): object;
    function getDeserializedJsonObj(obj: VaultReplicaDetails): object;
}

...
export declare namespace RestoreVaultFromObjectStoreDetails {
    function getJsonObj(obj: RestoreVaultFromObjectStoreDetails): object;
    function getDeserializedJsonObj(obj: RestoreVaultFromObjectStoreDetails): object;
}

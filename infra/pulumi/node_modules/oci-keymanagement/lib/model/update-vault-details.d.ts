...
export declare namespace UpdateVaultDetails {
    function getJsonObj(obj: UpdateVaultDetails): object;
    function getDeserializedJsonObj(obj: UpdateVaultDetails): object;
}

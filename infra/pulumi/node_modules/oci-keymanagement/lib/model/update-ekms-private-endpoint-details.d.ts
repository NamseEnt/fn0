...
export declare namespace UpdateEkmsPrivateEndpointDetails {
    function getJsonObj(obj: UpdateEkmsPrivateEndpointDetails): object;
    function getDeserializedJsonObj(obj: UpdateEkmsPrivateEndpointDetails): object;
}

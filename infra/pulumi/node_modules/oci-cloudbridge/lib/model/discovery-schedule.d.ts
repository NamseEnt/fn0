...
export declare namespace DiscoverySchedule {
    function getJsonObj(obj: DiscoverySchedule): object;
    function getDeserializedJsonObj(obj: DiscoverySchedule): object;
}

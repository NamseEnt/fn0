...
export declare namespace AgentDependencySummary {
    function getJsonObj(obj: AgentDependencySummary): object;
    function getDeserializedJsonObj(obj: AgentDependencySummary): object;
}

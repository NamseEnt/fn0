...
export declare namespace AssetSourceCredentials {
    function getJsonObj(obj: AssetSourceCredentials): object;
    function getDeserializedJsonObj(obj: AssetSourceCredentials): object;
}

...
export declare namespace CreateVmwareVmAssetDetails {
    function getJsonObj(obj: CreateVmwareVmAssetDetails, isParentJsonObj?: boolean): object;
    const assetType = "VMWARE_VM";
    function getDeserializedJsonObj(obj: CreateVmwareVmAssetDetails, isParentJsonObj?: boolean): object;
}

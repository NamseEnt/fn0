...
export declare namespace ChangeAssetSourceCompartmentDetails {
    function getJsonObj(obj: ChangeAssetSourceCompartmentDetails): object;
    function getDeserializedJsonObj(obj: ChangeAssetSourceCompartmentDetails): object;
}

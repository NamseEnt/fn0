...
export declare namespace CreateAssetSourceDetails {
    function getJsonObj(obj: CreateAssetSourceDetails): object;
    function getDeserializedJsonObj(obj: CreateAssetSourceDetails): object;
}

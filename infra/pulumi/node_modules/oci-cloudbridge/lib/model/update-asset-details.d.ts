...
export declare namespace UpdateAssetDetails {
    function getJsonObj(obj: UpdateAssetDetails): object;
    function getDeserializedJsonObj(obj: UpdateAssetDetails): object;
}

...
export declare namespace QueryableFieldDescription {
    enum FieldType {
    ...
    function getJsonObj(obj: QueryableFieldDescription): object;
    function getDeserializedJsonObj(obj: QueryableFieldDescription): object;
}

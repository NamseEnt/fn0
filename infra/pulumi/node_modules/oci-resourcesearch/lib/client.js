...
exports.ResourceSearchClient = exports.ResourceSearchApiKeys = void 0;
...
class ResourceSearchClient {
    constructor(params, clientConfiguration) {
        ...
        this.targetService = "ResourceSearch";
        this._regionId = "";
        ...
        if (!oci_common_2.developerToolConfiguration.isServiceEnabled("resourcesearch")) {
    ...
    set endpoint(endpoint) {
        ...
        if (this.logger)
            this.logger.info(`ResourceSearchClient endpoint set to ${this._endpoint}`);
    }
    get logger() {
    ...
    set useRealmSpecificEndpointTemplate(realmSpecificEndpointTemplateEnabled) {
        ...
        if (this._lastSetRegionOrRegionId === common.Region.REGION_STRING) {
            this.endpoint = common.EndpointBuilder.createEndpointFromRegion(ResourceSearchClient.serviceEndpointTemplate, this._region, ResourceSearchClient.endpointServiceName);
        }
        else if (this._lastSetRegionOrRegionId === common.Region.REGION_ID_STRING) {
            this.endpoint = common.EndpointBuilder.createEndpointFromRegionId(ResourceSearchClient.serviceEndpointTemplate, this._regionId, ResourceSearchClient.endpointServiceName);
        }
    }
    /**
    ...
    set region(region) {
        this._region = region;
        this.endpoint = common.EndpointBuilder.createEndpointFromRegion(ResourceSearchClient.serviceEndpointTemplate, region, ResourceSearchClient.endpointServiceName);
    ...
    set regionId(regionId) {
        ...
        this.endpoint = common.EndpointBuilder.createEndpointFromRegionId(ResourceSearchClient.serviceEndpointTemplate, regionId, ResourceSearchClient.endpointServiceName);
    ...
    getResourceType(getResourceTypeRequest) {
        return __awaiter(this, void 0, void 0, function* () {
            if (this.logger)
                this.logger.debug("Calling operation ResourceSearchClient#getResourceType.");
            const operationName = "getResourceType";
            const apiReferenceLink = "https://docs.oracle.com/iaas/api/#/en/search/20180409/ResourceType/GetResourceType";
            const pathParams = {
    ...
    listResourceTypes(listResourceTypesRequest) {
        return __awaiter(this, void 0, void 0, function* () {
            if (this.logger)
                this.logger.debug("Calling operation ResourceSearchClient#listResourceTypes.");
            const operationName = "listResourceTypes";
            const apiReferenceLink = "https://docs.oracle.com/iaas/api/#/en/search/20180409/ResourceType/ListResourceTypes";
            const pathParams = {};
            const queryParams = {
     ...
     */
    listAllResourceTypes(request) {
        return oci_common_1.paginateRecords(request, req => this.listResourceTypes(req));
    }
    /**
     ...
     * @param request a request which can be sent to the service operation
     */
    listAllResourceTypesResponses(request) {
        return oci_common_1.paginateResponses(request, req => this.listResourceTypes(req));
    }
    /**
     * Creates a new async iterator which will iterate over the models.ResourceType objects
     * contained in responses from the listResourceTypes operation. This iterator will fetch more data from the
     ...
     * @param request a request which can be sent to the service operation
     */
    listResourceTypesRecordIterator(request) {
        return oci_common_1.paginateRecords(request, req => this.listResourceTypes(req));
    }
    /**
     * Creates a new async iterator which will iterate over the responses received from the listResourceTypes operation. This iterator
     ...
     * @param request a request which can be sent to the service operation
     */
    listResourceTypesResponseIterator(request) {
        return oci_common_1.paginateResponses(request, req => this.listResourceTypes(req));
    }
    /**
    ...
    searchResources(searchResourcesRequest) {
        return __awaiter(this, void 0, void 0, function* () {
            if (this.logger)
                this.logger.debug("Calling operation ResourceSearchClient#searchResources.");
            const operationName = "searchResources";
            const apiReferenceLink = "https://docs.oracle.com/iaas/api/#/en/search/20180409/ResourceSummary/SearchResources";
            const pathParams = {};
            const queryParams = {
            ...
            const request = yield oci_common_2.composeRequest({
                ...
                path: "/resources",
                method: "POST",
                bodyContent: common.ObjectSerializer.serialize(searchResourcesRequest.searchDetails, "SearchDetails", model.SearchDetails.getJsonObj),
                pathParams: pathParams,
                headerParams: headerParams,
                queryParams: queryParams
            });
...
exports.ResourceSearchClient = ResourceSearchClient;
ResourceSearchClient.serviceEndpointTemplate = "https://query.{region}.oci.{secondLevelDomain}";

 ...
 */
export interface MonitoredRegionSummary {
    /**
...
export declare namespace MonitoredRegionSummary {
    function getJsonObj(obj: MonitoredRegionSummary): object;
    function getDeserializedJsonObj(obj: MonitoredRegionSummary): object;
}

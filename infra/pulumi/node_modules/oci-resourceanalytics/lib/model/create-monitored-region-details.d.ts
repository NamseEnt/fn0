 ...
 */
export interface CreateMonitoredRegionDetails {
    /**
...
export declare namespace CreateMonitoredRegionDetails {
    function getJsonObj(obj: CreateMonitoredRegionDetails): object;
    function getDeserializedJsonObj(obj: CreateMonitoredRegionDetails): object;
}

...
import * as byol_waiter from "./lib/byol-waiter";
import * as byolallocation_waiter from "./lib/byolallocation-waiter";
import * as cluster_waiter from "./lib/cluster-waiter";
...
export { requests };
export { responses };
export import ByolClient = client.ByolClient;
export import ByolWaiter = byol_waiter.ByolWaiter;
export import ByolAllocationClient = client.ByolAllocationClient;
export import ByolAllocationWaiter = byolallocation_waiter.ByolAllocationWaiter;
export import ClusterClient = client.ClusterClient;
export import ClusterWaiter = cluster_waiter.ClusterWaiter;
export import DatastoreClient = client.DatastoreClient;
export import DatastoreWaiter = datastore_waiter.DatastoreWaiter;
export import DatastoreClusterClient = client.DatastoreClusterClient;

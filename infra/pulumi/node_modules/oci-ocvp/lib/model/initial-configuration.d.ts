...
export interface InitialConfiguration {
     ...
     *
     */
    "initialClusterConfigurations": Array<model.InitialClusterConfiguration>;
}
export declare namespace InitialConfiguration {
    function getJsonObj(obj: InitialConfiguration): object;
    function getDeserializedJsonObj(obj: InitialConfiguration): object;
}

 ...
 */
export interface CreateByolDetails {
    /**
...
export declare namespace CreateByolDetails {
    function getJsonObj(obj: CreateByolDetails): object;
    function getDeserializedJsonObj(obj: CreateByolDetails): object;
}

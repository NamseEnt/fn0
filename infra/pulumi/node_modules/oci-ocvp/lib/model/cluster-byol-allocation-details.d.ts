 ...
 *
 */
export interface ClusterByolAllocationDetails {
    /**
     ...
     *
     */
    "firewallByolAllocationId"?: string;
}
export declare namespace ClusterByolAllocationDetails {
    function getJsonObj(obj: ClusterByolAllocationDetails): object;
    function getDeserializedJsonObj(obj: ClusterByolAllocationDetails): object;
}

...
export declare namespace DowngradeHcxDetails {
    function getJsonObj(obj: DowngradeHcxDetails): object;
    function getDeserializedJsonObj(obj: DowngradeHcxDetails): object;
}

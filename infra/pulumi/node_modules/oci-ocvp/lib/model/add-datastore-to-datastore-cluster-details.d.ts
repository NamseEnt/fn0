 ...
 */
export interface AddDatastoreToDatastoreClusterDetails {
    /**
     * A list of datastores to be added.
     */
    "datastoreIds": Array<string>;
}
export declare namespace AddDatastoreToDatastoreClusterDetails {
    function getJsonObj(obj: AddDatastoreToDatastoreClusterDetails): object;
    function getDeserializedJsonObj(obj: AddDatastoreToDatastoreClusterDetails): object;
}

 ...
 */
export interface CreateDatastoreDetails {
    /**
...
export declare namespace CreateDatastoreDetails {
    function getJsonObj(obj: CreateDatastoreDetails): object;
    function getDeserializedJsonObj(obj: CreateDatastoreDetails): object;
}

 ...
 *
 */
export interface SddcByolAllocationDetails {
    /**
     ...
     *
     */
    "loadBalancerByolAllocationId"?: string;
    /**
     * The number of VMware Avi Load Balancer instances to be deployed on VMware SDDC.
     *  Note: Numbers greater than Number.MAX_SAFE_INTEGER will result in rounding issues.
     */
    "loadBalancerInstanceCount"?: number;
}
export declare namespace SddcByolAllocationDetails {
    function getJsonObj(obj: SddcByolAllocationDetails): object;
    function getDeserializedJsonObj(obj: SddcByolAllocationDetails): object;
}

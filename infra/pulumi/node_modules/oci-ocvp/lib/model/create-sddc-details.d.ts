...
export declare namespace CreateSddcDetails {
    function getJsonObj(obj: CreateSddcDetails): object;
    function getDeserializedJsonObj(obj: CreateSddcDetails): object;
}

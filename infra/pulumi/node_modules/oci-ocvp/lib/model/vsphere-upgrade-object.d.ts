...
export declare namespace VsphereUpgradeObject {
    function getJsonObj(obj: VsphereUpgradeObject): object;
    function getDeserializedJsonObj(obj: VsphereUpgradeObject): object;
}

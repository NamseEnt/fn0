...
export declare namespace InitialClusterConfiguration {
    function getJsonObj(obj: InitialClusterConfiguration): object;
    function getDeserializedJsonObj(obj: InitialClusterConfiguration): object;
}

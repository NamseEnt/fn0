 ...
 *
 */
export interface SupportedVmwareSoftwareVersionSummary {
    /**
     ...
     *
     */
    "esxiSoftwareVersions"?: Array<model.SupportedEsxiSoftwareVersionSummary>;
}
export declare namespace SupportedVmwareSoftwareVersionSummary {
    function getJsonObj(obj: SupportedVmwareSoftwareVersionSummary): object;
    function getDeserializedJsonObj(obj: SupportedVmwareSoftwareVersionSummary): object;
}

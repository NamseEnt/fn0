 ...
 */
export interface ManagementAppliance {
    /**
...
export declare namespace ManagementAppliance {
    function getJsonObj(obj: ManagementAppliance): object;
    function getDeserializedJsonObj(obj: ManagementAppliance): object;
}

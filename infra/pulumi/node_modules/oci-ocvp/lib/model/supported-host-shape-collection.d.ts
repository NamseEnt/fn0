 ...
 */
export interface SupportedHostShapeCollection {
    /**
     * A list of the supported compute shapes for ESXi hosts.
     */
    "items": Array<model.SupportedHostShapeSummary>;
}
export declare namespace SupportedHostShapeCollection {
    function getJsonObj(obj: SupportedHostShapeCollection): object;
    function getDeserializedJsonObj(obj: SupportedHostShapeCollection): object;
}

...
export declare namespace ManagementApplianceConfiguration {
    function getJsonObj(obj: ManagementApplianceConfiguration): object;
    function getDeserializedJsonObj(obj: ManagementApplianceConfiguration): object;
}

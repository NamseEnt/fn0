...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/ocvp/ListByols.ts.html |here} to see how to use ListByolsRequest.
 */
export interface ListByolsRequest extends common.BaseRequest {
    /**
     ...
     *
     */
    "sortBy"?: ListByolsRequest.SortBy;
    /**
...
export declare namespace ListByolsRequest {
    enum SortBy {

...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/ocvp/ListSddcs.ts.html |here} to see how to use ListSddcsRequest.
 */
...
export declare namespace ListSddcsRequest {
    enum SortBy {

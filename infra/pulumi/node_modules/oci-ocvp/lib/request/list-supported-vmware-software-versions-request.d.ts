...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/ocvp/ListSupportedVmwareSoftwareVersions.ts.html |here} to see how to use ListSupportedVmwareSoftwareVersionsRequest.
 */
export interface ListSupportedVmwareSoftwareVersionsRequest extends common.BaseRequest {
    /**

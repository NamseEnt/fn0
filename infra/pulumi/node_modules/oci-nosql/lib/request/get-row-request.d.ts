...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/nosql/GetRow.ts.html |here} to see how to use GetRowRequest.
 */
...
export declare namespace GetRowRequest {
    enum Consistency {
        Eventual = "EVENTUAL",
        Absolute = "ABSOLUTE"
    }

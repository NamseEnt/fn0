...
(function (Configuration) {
    function getJsonObj(obj) {
        ...
        if (obj && "environment" in obj && obj.environment) {
            switch (obj.environment) {
                case "MULTI_TENANCY":
                    return model.MultiTenancyConfiguration.getJsonObj(jsonObj, true);
                case "HOSTED":
                    return model.HostedConfiguration.getJsonObj(jsonObj, true);
                default:
    ...
    function getDeserializedJsonObj(obj) {
        ...
        if (obj && "environment" in obj && obj.environment) {
            switch (obj.environment) {
                case "MULTI_TENANCY":
                    return model.MultiTenancyConfiguration.getDeserializedJsonObj(jsonObj, true);
                case "HOSTED":
                    return model.HostedConfiguration.getDeserializedJsonObj(jsonObj, true);
                default:
                    if (common.LOG.logger)
                        common.LOG.logger.info(`Unknown value for: ${obj.environment}`);
            }

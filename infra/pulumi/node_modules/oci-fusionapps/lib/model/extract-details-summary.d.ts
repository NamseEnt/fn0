 ...
 */
export interface ExtractDetailsSummary {
    /**
...
export declare namespace ExtractDetailsSummary {
    function getJsonObj(obj: ExtractDetailsSummary): object;
    function getDeserializedJsonObj(obj: ExtractDetailsSummary): object;
}

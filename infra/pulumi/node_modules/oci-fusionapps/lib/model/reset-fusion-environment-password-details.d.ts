...
export declare namespace ResetFusionEnvironmentPasswordDetails {
    function getJsonObj(obj: ResetFusionEnvironmentPasswordDetails): object;
    function getDeserializedJsonObj(obj: ResetFusionEnvironmentPasswordDetails): object;
}

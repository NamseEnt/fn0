...
export declare namespace CreateFusionEnvironmentFamilyDetails {
    function getJsonObj(obj: CreateFusionEnvironmentFamilyDetails): object;
    function getDeserializedJsonObj(obj: CreateFusionEnvironmentFamilyDetails): object;
}

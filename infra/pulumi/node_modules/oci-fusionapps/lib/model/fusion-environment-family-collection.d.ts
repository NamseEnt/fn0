 ...
 */
export interface FusionEnvironmentFamilyCollection {
    /**
     * A page of FusionEnvironmentFamilySummary objects.
     */
    "items": Array<model.FusionEnvironmentFamilySummary>;
}
export declare namespace FusionEnvironmentFamilyCollection {
    function getJsonObj(obj: FusionEnvironmentFamilyCollection): object;
    function getDeserializedJsonObj(obj: FusionEnvironmentFamilyCollection): object;
}

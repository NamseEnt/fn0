...
export declare namespace SubscriptionDetail {
    function getJsonObj(obj: SubscriptionDetail): object;
    function getDeserializedJsonObj(obj: SubscriptionDetail): object;
}

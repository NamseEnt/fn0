...
export declare namespace RefreshActivitySummary {
    function getJsonObj(obj: RefreshActivitySummary): object;
    function getDeserializedJsonObj(obj: RefreshActivitySummary): object;
}

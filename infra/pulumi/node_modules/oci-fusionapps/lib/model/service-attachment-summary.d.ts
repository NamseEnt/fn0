...
export declare namespace ServiceAttachmentSummary {
    function getJsonObj(obj: ServiceAttachmentSummary): object;
    function getDeserializedJsonObj(obj: ServiceAttachmentSummary): object;
}

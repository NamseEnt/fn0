 ...
 */
export interface ExtractDetailsCollection {
    /**
     * A page of ExtractDetailsSummary objects.
     */
    "items": Array<model.ExtractDetailsSummary>;
}
export declare namespace ExtractDetailsCollection {
    function getJsonObj(obj: ExtractDetailsCollection): object;
    function getDeserializedJsonObj(obj: ExtractDetailsCollection): object;
}

...
export declare namespace CreateRefreshActivityDetails {
    function getJsonObj(obj: CreateRefreshActivityDetails): object;
    function getDeserializedJsonObj(obj: CreateRefreshActivityDetails): object;
}

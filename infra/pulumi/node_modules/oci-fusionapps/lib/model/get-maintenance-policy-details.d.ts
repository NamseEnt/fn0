...
export declare namespace GetMaintenancePolicyDetails {
    function getJsonObj(obj: GetMaintenancePolicyDetails): object;
    function getDeserializedJsonObj(obj: GetMaintenancePolicyDetails): object;
}

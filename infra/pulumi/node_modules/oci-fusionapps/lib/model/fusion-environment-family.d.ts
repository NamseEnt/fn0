...
export declare namespace FusionEnvironmentFamily {
    enum LifecycleState {
        Creating = "CREATING",
        Updating = "UPDATING",
        Active = "ACTIVE",
    ...
    function getJsonObj(obj: FusionEnvironmentFamily): object;
    function getDeserializedJsonObj(obj: FusionEnvironmentFamily): object;
}

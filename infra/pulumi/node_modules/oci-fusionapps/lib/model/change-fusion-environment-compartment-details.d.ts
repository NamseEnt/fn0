 ...
 */
export interface ChangeFusionEnvironmentCompartmentDetails {
    /**
...
export declare namespace ChangeFusionEnvironmentCompartmentDetails {
    function getJsonObj(obj: ChangeFusionEnvironmentCompartmentDetails): object;
    function getDeserializedJsonObj(obj: ChangeFusionEnvironmentCompartmentDetails): object;
}

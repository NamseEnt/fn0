...
export declare namespace VerifyServiceAttachmentDetails {
    function getJsonObj(obj: VerifyServiceAttachmentDetails): object;
    function getDeserializedJsonObj(obj: VerifyServiceAttachmentDetails): object;
}

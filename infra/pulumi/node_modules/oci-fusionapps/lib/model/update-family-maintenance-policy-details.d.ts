 ...
 */
export interface UpdateFamilyMaintenancePolicyDetails {
    /**
...
export declare namespace UpdateFamilyMaintenancePolicyDetails {
    function getJsonObj(obj: UpdateFamilyMaintenancePolicyDetails): object;
    function getDeserializedJsonObj(obj: UpdateFamilyMaintenancePolicyDetails): object;
}

 ...
 */
export interface ChangeFusionEnvironmentFamilyCompartmentDetails {
    /**
...
export declare namespace ChangeFusionEnvironmentFamilyCompartmentDetails {
    function getJsonObj(obj: ChangeFusionEnvironmentFamilyCompartmentDetails): object;
    function getDeserializedJsonObj(obj: ChangeFusionEnvironmentFamilyCompartmentDetails): object;
}

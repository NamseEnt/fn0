...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/fusionapps/ListScheduledActivities.ts.html |here} to see how to use ListScheduledActivitiesRequest.
 */
...
export declare namespace ListScheduledActivitiesRequest {
    enum SortOrder {
        Asc = "ASC",
        Desc = "DESC"
    }

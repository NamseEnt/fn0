...
export declare namespace ChangeUnifiedAgentConfigurationCompartmentDetails {
    function getJsonObj(obj: ChangeUnifiedAgentConfigurationCompartmentDetails): object;
    function getDeserializedJsonObj(obj: ChangeUnifiedAgentConfigurationCompartmentDetails): object;
}

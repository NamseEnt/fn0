...
export declare namespace OperationalMetricsConfiguration {
    function getJsonObj(obj: OperationalMetricsConfiguration): object;
    function getDeserializedJsonObj(obj: OperationalMetricsConfiguration): object;
}

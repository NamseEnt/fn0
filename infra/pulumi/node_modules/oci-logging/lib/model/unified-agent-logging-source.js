...
exports.UnifiedAgentLoggingSource = void 0;
const model = __importStar(require("../model"));
const common = require("oci-common");
var UnifiedAgentLoggingSource;
(function (UnifiedAgentLoggingSource) {
    function getJsonObj(obj) {
        ...
        if (obj && "sourceType" in obj && obj.sourceType) {
            switch (obj.sourceType) {
                ...
                case "LOG_TAIL":
                    return model.UnifiedAgentTailLogSource.getJsonObj(jsonObj, true);
                default:
    ...
    function getDeserializedJsonObj(obj) {
        ...
        if (obj && "sourceType" in obj && obj.sourceType) {
            switch (obj.sourceType) {
                ...
                case "LOG_TAIL":
                    return model.UnifiedAgentTailLogSource.getDeserializedJsonObj(jsonObj, true);
                default:
                    if (common.LOG.logger)
                        common.LOG.logger.info(`Unknown value for: ${obj.sourceType}`);
            }
    ...
    UnifiedAgentLoggingSource.getDeserializedJsonObj = getDeserializedJsonObj;
})(UnifiedAgentLoggingSource = exports.UnifiedAgentLoggingSource || (exports.UnifiedAgentLoggingSource = {}));
//# sourceMappingURL=unified-agent-logging-source.js.map
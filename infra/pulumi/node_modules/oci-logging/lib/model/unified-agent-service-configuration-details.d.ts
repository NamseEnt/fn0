...
export declare namespace UnifiedAgentServiceConfigurationDetails {
    function getJsonObj(obj: UnifiedAgentServiceConfigurationDetails): object;
    function getDeserializedJsonObj(obj: UnifiedAgentServiceConfigurationDetails): object;
}

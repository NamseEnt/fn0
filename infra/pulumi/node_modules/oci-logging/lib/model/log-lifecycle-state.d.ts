 ...
 *
 **/
export declare enum LogLifecycleState {
    Creating = "CREATING",
    Active = "ACTIVE",
    Updating = "UPDATING",
    Inactive = "INACTIVE",
...
export declare namespace LogLifecycleState {
    function getJsonObj(obj: LogLifecycleState): LogLifecycleState;
    function getDeserializedJsonObj(obj: LogLifecycleState): LogLifecycleState;
}

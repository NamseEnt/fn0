...
export declare namespace LogSavedSearchSummary {
    function getJsonObj(obj: LogSavedSearchSummary): object;
    function getDeserializedJsonObj(obj: LogSavedSearchSummary): object;
}

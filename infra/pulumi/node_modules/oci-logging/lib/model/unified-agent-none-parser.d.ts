...
export declare namespace UnifiedAgentNoneParser {
    function getJsonObj(obj: UnifiedAgentNoneParser, isParentJsonObj?: boolean): object;
    const parserType = "NONE";
    function getDeserializedJsonObj(obj: UnifiedAgentNoneParser, isParentJsonObj?: boolean): object;
}

...
export declare namespace UnifiedAgentConfigurationCollection {
    function getJsonObj(obj: UnifiedAgentConfigurationCollection): object;
    function getDeserializedJsonObj(obj: UnifiedAgentConfigurationCollection): object;
}

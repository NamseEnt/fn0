...
export declare namespace CreateUnifiedAgentConfigurationDetails {
    function getJsonObj(obj: CreateUnifiedAgentConfigurationDetails): object;
    function getDeserializedJsonObj(obj: CreateUnifiedAgentConfigurationDetails): object;
}

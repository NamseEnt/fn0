...
export declare namespace ChangeLogGroupCompartmentDetails {
    function getJsonObj(obj: ChangeLogGroupCompartmentDetails): object;
    function getDeserializedJsonObj(obj: ChangeLogGroupCompartmentDetails): object;
}

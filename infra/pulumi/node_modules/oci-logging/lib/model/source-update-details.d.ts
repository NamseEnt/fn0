...
export declare namespace SourceUpdateDetails {
    function getJsonObj(obj: SourceUpdateDetails): object;
    function getDeserializedJsonObj(obj: SourceUpdateDetails): object;
}

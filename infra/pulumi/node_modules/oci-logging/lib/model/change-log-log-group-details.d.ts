...
export declare namespace ChangeLogLogGroupDetails {
    function getJsonObj(obj: ChangeLogLogGroupDetails): object;
    function getDeserializedJsonObj(obj: ChangeLogLogGroupDetails): object;
}

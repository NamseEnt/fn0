...
export declare namespace UnifiedAgentLoggingSource {
    function getJsonObj(obj: UnifiedAgentLoggingSource): object;
    function getDeserializedJsonObj(obj: UnifiedAgentLoggingSource): object;
}

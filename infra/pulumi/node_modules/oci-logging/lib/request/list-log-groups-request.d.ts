...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/logging/ListLogGroups.ts.html |here} to see how to use ListLogGroupsRequest.
 */
...
export declare namespace ListLogGroupsRequest {
    enum SortBy {

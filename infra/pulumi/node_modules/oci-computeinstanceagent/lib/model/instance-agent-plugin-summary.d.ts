...
export declare namespace InstanceAgentPluginSummary {
    enum Status {
        Running = "RUNNING",
        Stopped = "STOPPED",
    ...
    function getJsonObj(obj: InstanceAgentPluginSummary): object;
    function getDeserializedJsonObj(obj: InstanceAgentPluginSummary): object;
}

...
export declare namespace InstanceAgentCommandExecutionOutputContent {
    function getJsonObj(obj: InstanceAgentCommandExecutionOutputContent): object;
    function getDeserializedJsonObj(obj: InstanceAgentCommandExecutionOutputContent): object;
}

...
export declare namespace CreateInstanceAgentCommandDetails {
    function getJsonObj(obj: CreateInstanceAgentCommandDetails): object;
    function getDeserializedJsonObj(obj: CreateInstanceAgentCommandDetails): object;
}

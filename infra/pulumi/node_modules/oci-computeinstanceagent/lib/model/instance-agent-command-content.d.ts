...
export declare namespace InstanceAgentCommandContent {
    function getJsonObj(obj: InstanceAgentCommandContent): object;
    function getDeserializedJsonObj(obj: InstanceAgentCommandContent): object;
}

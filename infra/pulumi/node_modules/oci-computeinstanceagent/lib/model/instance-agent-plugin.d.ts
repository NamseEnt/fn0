...
export declare namespace InstanceAgentPlugin {
    enum Status {
        Running = "RUNNING",
        Stopped = "STOPPED",
    ...
    function getJsonObj(obj: InstanceAgentPlugin): object;
    function getDeserializedJsonObj(obj: InstanceAgentPlugin): object;
}

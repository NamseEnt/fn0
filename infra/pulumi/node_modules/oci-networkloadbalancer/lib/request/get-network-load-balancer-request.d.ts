...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/networkloadbalancer/GetNetworkLoadBalancer.ts.html |here} to see how to use GetNetworkLoadBalancerRequest.
 */
export interface GetNetworkLoadBalancerRequest extends common.BaseRequest {
    /**

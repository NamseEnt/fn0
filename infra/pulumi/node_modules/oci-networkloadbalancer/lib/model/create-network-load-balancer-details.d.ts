...
export declare namespace CreateNetworkLoadBalancerDetails {
    function getJsonObj(obj: CreateNetworkLoadBalancerDetails): object;
    function getDeserializedJsonObj(obj: CreateNetworkLoadBalancerDetails): object;
}

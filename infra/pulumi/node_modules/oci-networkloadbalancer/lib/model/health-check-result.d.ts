...
export declare namespace HealthCheckResult {
    ...
    function getJsonObj(obj: HealthCheckResult): object;
    function getDeserializedJsonObj(obj: HealthCheckResult): object;
}

...
export declare namespace NetworkLoadBalancerHealth {
    enum Status {
        Ok = "OK",
        Warning = "WARNING",
        Critical = "CRITICAL",
    ...
    function getJsonObj(obj: NetworkLoadBalancerHealth): object;
    function getDeserializedJsonObj(obj: NetworkLoadBalancerHealth): object;
}

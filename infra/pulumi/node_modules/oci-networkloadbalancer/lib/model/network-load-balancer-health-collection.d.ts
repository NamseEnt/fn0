...
export declare namespace NetworkLoadBalancerHealthCollection {
    function getJsonObj(obj: NetworkLoadBalancerHealthCollection): object;
    function getDeserializedJsonObj(obj: NetworkLoadBalancerHealthCollection): object;
}

...
export declare namespace NetworkLoadBalancer {
    function getJsonObj(obj: NetworkLoadBalancer): object;
    function getDeserializedJsonObj(obj: NetworkLoadBalancer): object;
}

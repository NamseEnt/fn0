...
export declare namespace NetworkLoadBalancerHealthSummary {
    enum Status {
        Ok = "OK",
        Warning = "WARNING",
        Critical = "CRITICAL",
    ...
    function getJsonObj(obj: NetworkLoadBalancerHealthSummary): object;
    function getDeserializedJsonObj(obj: NetworkLoadBalancerHealthSummary): object;
}

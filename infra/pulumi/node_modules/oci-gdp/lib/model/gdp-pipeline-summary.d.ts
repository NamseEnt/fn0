...
export declare namespace GdpPipelineSummary {
    function getJsonObj(obj: GdpPipelineSummary): object;
    function getDeserializedJsonObj(obj: GdpPipelineSummary): object;
}

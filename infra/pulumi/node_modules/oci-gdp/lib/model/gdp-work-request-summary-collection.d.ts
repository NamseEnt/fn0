...
export declare namespace GdpWorkRequestSummaryCollection {
    function getJsonObj(obj: GdpWorkRequestSummaryCollection): object;
    function getDeserializedJsonObj(obj: GdpWorkRequestSummaryCollection): object;
}

 ...
 */
export interface GdpWorkRequest {
    /**
...
export declare namespace GdpWorkRequest {
    function getJsonObj(obj: GdpWorkRequest): object;
    function getDeserializedJsonObj(obj: GdpWorkRequest): object;
}

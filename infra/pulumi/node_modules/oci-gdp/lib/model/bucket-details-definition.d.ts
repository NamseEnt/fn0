...
export declare namespace BucketDetailsDefinition {
    enum BucketType {
        Source = "SOURCE",
        Transfer = "TRANSFER",
        Reject = "REJECT",
    ...
    function getJsonObj(obj: BucketDetailsDefinition): object;
    function getDeserializedJsonObj(obj: BucketDetailsDefinition): object;
}

...
class AutoScalingClient {
    constructor(params, clientConfiguration) {
        ...
        this.targetService = "AutoScaling";
        this._regionId = "";
        ...
        if (!oci_common_2.developerToolConfiguration.isServiceEnabled("autoscaling")) {
    ...
    set useRealmSpecificEndpointTemplate(realmSpecificEndpointTemplateEnabled) {
        ...
        if (this._lastSetRegionOrRegionId === common.Region.REGION_STRING) {
            this.endpoint = common.EndpointBuilder.createEndpointFromRegion(AutoScalingClient.serviceEndpointTemplate, this._region, AutoScalingClient.endpointServiceName);
        }
        else if (this._lastSetRegionOrRegionId === common.Region.REGION_ID_STRING) {
            this.endpoint = common.EndpointBuilder.createEndpointFromRegionId(AutoScalingClient.serviceEndpointTemplate, this._regionId, AutoScalingClient.endpointServiceName);
        }
    }
    /**
    ...
    set region(region) {
        this._region = region;
        this.endpoint = common.EndpointBuilder.createEndpointFromRegion(AutoScalingClient.serviceEndpointTemplate, region, AutoScalingClient.endpointServiceName);
    ...
    set regionId(regionId) {
        ...
        this.endpoint = common.EndpointBuilder.createEndpointFromRegionId(AutoScalingClient.serviceEndpointTemplate, regionId, AutoScalingClient.endpointServiceName);
  ...
  *
    ...
    changeAutoScalingConfigurationCompartment(changeAutoScalingConfigurationCompartmentRequest) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const apiReferenceLink = "https://docs.oracle.com/iaas/api/#/en/autoscaling/20181001/AutoScalingConfiguration/ChangeAutoScalingConfigurationCompartment";
            const pathParams = {
            ...
            const retrier = oci_common_2.GenericRetrier.createPreferredRetrier(this._clientConfiguration ? this._clientConfiguration.retryConfiguration : undefined, changeAutoScalingConfigurationCompartmentRequest.retryConfiguration, specRetryConfiguration);
            if (this.logger)
            ...
            const request = yield oci_common_2.composeRequest({
                ...
                method: "POST",
                bodyContent: common.ObjectSerializer.serialize(changeAutoScalingConfigurationCompartmentRequest.changeCompartmentDetails, "ChangeAutoScalingCompartmentDetails", model.ChangeAutoScalingCompartmentDetails.getJsonObj),
    ...
    createAutoScalingConfiguration(createAutoScalingConfigurationRequest) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const apiReferenceLink = "https://docs.oracle.com/iaas/api/#/en/autoscaling/20181001/AutoScalingConfiguration/CreateAutoScalingConfiguration";
            const pathParams = {};
            const queryParams = {};
            let headerParams = {
                "Content-Type": common.Constants.APPLICATION_JSON,
            ...
            const specRetryConfiguration = common.OciSdkDefaultRetryConfiguration;
            const retrier = oci_common_2.GenericRetrier.createPreferredRetrier(this._clientConfiguration ? this._clientConfiguration.retryConfiguration : undefined, createAutoScalingConfigurationRequest.retryConfiguration, specRetryConfiguration);
            if (this.logger)
                retrier.logger = this.logger;
            const request = yield oci_common_2.composeRequest({
                baseEndpoint: this._endpoint,
                ...
                method: "POST",
                bodyContent: common.ObjectSerializer.serialize(createAutoScalingConfigurationRequest.createAutoScalingConfigurationDetails, "CreateAutoScalingConfigurationDetails", model.CreateAutoScalingConfigurationDetails.getJsonObj),
                pathParams: pathParams,
                headerParams: headerParams,
                queryParams: queryParams
            });
  ...
  *
    ...
    createAutoScalingPolicy(createAutoScalingPolicyRequest) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const apiReferenceLink = "https://docs.oracle.com/iaas/api/#/en/autoscaling/20181001/AutoScalingPolicy/CreateAutoScalingPolicy";
            const pathParams = {
            ...
            const specRetryConfiguration = common.OciSdkDefaultRetryConfiguration;
            const retrier = oci_common_2.GenericRetrier.createPreferredRetrier(this._clientConfiguration ? this._clientConfiguration.retryConfiguration : undefined, createAutoScalingPolicyRequest.retryConfiguration, specRetryConfiguration);
            if (this.logger)
                retrier.logger = this.logger;
            const request = yield oci_common_2.composeRequest({
                baseEndpoint: this._endpoint,
                ...
                method: "POST",
                bodyContent: common.ObjectSerializer.serialize(createAutoScalingPolicyRequest.createAutoScalingPolicyDetails, "CreateAutoScalingPolicyDetails", model.CreateAutoScalingPolicyDetails.getJsonObj),
                pathParams: pathParams,
                headerParams: headerParams,
                queryParams: queryParams
            });
    ...
    deleteAutoScalingConfiguration(deleteAutoScalingConfigurationRequest) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const apiReferenceLink = "https://docs.oracle.com/iaas/api/#/en/autoscaling/20181001/AutoScalingConfiguration/DeleteAutoScalingConfiguration";
            const pathParams = {
            ...
            const specRetryConfiguration = common.OciSdkDefaultRetryConfiguration;
            const retrier = oci_common_2.GenericRetrier.createPreferredRetrier(this._clientConfiguration ? this._clientConfiguration.retryConfiguration : undefined, deleteAutoScalingConfigurationRequest.retryConfiguration, specRetryConfiguration);
            if (this.logger)
                retrier.logger = this.logger;
            const request = yield oci_common_2.composeRequest({
                baseEndpoint: this._endpoint,
    ...
    deleteAutoScalingPolicy(deleteAutoScalingPolicyRequest) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const apiReferenceLink = "https://docs.oracle.com/iaas/api/#/en/autoscaling/20181001/AutoScalingPolicy/DeleteAutoScalingPolicy";
            const pathParams = {
            ...
            const specRetryConfiguration = common.OciSdkDefaultRetryConfiguration;
            const retrier = oci_common_2.GenericRetrier.createPreferredRetrier(this._clientConfiguration ? this._clientConfiguration.retryConfiguration : undefined, deleteAutoScalingPolicyRequest.retryConfiguration, specRetryConfiguration);
            if (this.logger)
                retrier.logger = this.logger;
            const request = yield oci_common_2.composeRequest({
                baseEndpoint: this._endpoint,
    ...
    getAutoScalingConfiguration(getAutoScalingConfigurationRequest) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const apiReferenceLink = "https://docs.oracle.com/iaas/api/#/en/autoscaling/20181001/AutoScalingConfiguration/GetAutoScalingConfiguration";
            const pathParams = {
    ...
    getAutoScalingPolicy(getAutoScalingPolicyRequest) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const apiReferenceLink = "https://docs.oracle.com/iaas/api/#/en/autoscaling/20181001/AutoScalingPolicy/GetAutoScalingPolicy";
            const pathParams = {
            ...
            const specRetryConfiguration = common.OciSdkDefaultRetryConfiguration;
            const retrier = oci_common_2.GenericRetrier.createPreferredRetrier(this._clientConfiguration ? this._clientConfiguration.retryConfiguration : undefined, getAutoScalingPolicyRequest.retryConfiguration, specRetryConfiguration);
            if (this.logger)
                retrier.logger = this.logger;
            const request = yield oci_common_2.composeRequest({
                baseEndpoint: this._endpoint,
    ...
    listAutoScalingConfigurations(listAutoScalingConfigurationsRequest) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const apiReferenceLink = "https://docs.oracle.com/iaas/api/#/en/autoscaling/20181001/AutoScalingConfigurationSummary/ListAutoScalingConfigurations";
            const pathParams = {};
            const queryParams = {
    ...
    listAutoScalingPolicies(listAutoScalingPoliciesRequest) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const apiReferenceLink = "https://docs.oracle.com/iaas/api/#/en/autoscaling/20181001/AutoScalingPolicySummary/ListAutoScalingPolicies";
            const pathParams = {
            ...
            const specRetryConfiguration = common.OciSdkDefaultRetryConfiguration;
            const retrier = oci_common_2.GenericRetrier.createPreferredRetrier(this._clientConfiguration ? this._clientConfiguration.retryConfiguration : undefined, listAutoScalingPoliciesRequest.retryConfiguration, specRetryConfiguration);
            if (this.logger)
                retrier.logger = this.logger;
            const request = yield oci_common_2.composeRequest({
                baseEndpoint: this._endpoint,
     ...
     * @param request a request which can be sent to the service operation
     */
    listAutoScalingPoliciesRecordIterator(request) {
        return oci_common_1.paginateRecords(request, req => this.listAutoScalingPolicies(req));
    }
    /**
     * Creates a new async iterator which will iterate over the responses received from the listAutoScalingPolicies operation. This iterator
     ...
     * @param request a request which can be sent to the service operation
     */
    listAutoScalingPoliciesResponseIterator(request) {
        return oci_common_1.paginateResponses(request, req => this.listAutoScalingPolicies(req));
    }
    /**
    ...
    updateAutoScalingConfiguration(updateAutoScalingConfigurationRequest) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const apiReferenceLink = "https://docs.oracle.com/iaas/api/#/en/autoscaling/20181001/AutoScalingConfiguration/UpdateAutoScalingConfiguration";
            const pathParams = {
            ...
            const request = yield oci_common_2.composeRequest({
                ...
                path: "/autoScalingConfigurations/{autoScalingConfigurationId}",
                method: "PUT",
                bodyContent: common.ObjectSerializer.serialize(updateAutoScalingConfigurationRequest.updateAutoScalingConfigurationDetails, "UpdateAutoScalingConfigurationDetails", model.UpdateAutoScalingConfigurationDetails.getJsonObj),
                pathParams: pathParams,
                headerParams: headerParams,
                queryParams: queryParams
            });
    ...
    updateAutoScalingPolicy(updateAutoScalingPolicyRequest) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const apiReferenceLink = "https://docs.oracle.com/iaas/api/#/en/autoscaling/20181001/AutoScalingPolicy/UpdateAutoScalingPolicy";
            const pathParams = {
            ...
            const specRetryConfiguration = common.OciSdkDefaultRetryConfiguration;
            const retrier = oci_common_2.GenericRetrier.createPreferredRetrier(this._clientConfiguration ? this._clientConfiguration.retryConfiguration : undefined, updateAutoScalingPolicyRequest.retryConfiguration, specRetryConfiguration);
            if (this.logger)
                retrier.logger = this.logger;
            const request = yield oci_common_2.composeRequest({
                baseEndpoint: this._endpoint,
                ...
                path: "/autoScalingConfigurations/{autoScalingConfigurationId}/policies/{autoScalingPolicyId}",
                method: "PUT",
                bodyContent: common.ObjectSerializer.serialize(updateAutoScalingPolicyRequest.updateAutoScalingPolicyDetails, "UpdateAutoScalingPolicyDetails", model.UpdateAutoScalingPolicyDetails.getJsonObj),
                pathParams: pathParams,
                headerParams: headerParams,
                queryParams: queryParams
            });

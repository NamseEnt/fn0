...
export declare namespace CreateAutoScalingPolicyDetails {
    function getJsonObj(obj: CreateAutoScalingPolicyDetails): object;
    function getDeserializedJsonObj(obj: CreateAutoScalingPolicyDetails): object;
}

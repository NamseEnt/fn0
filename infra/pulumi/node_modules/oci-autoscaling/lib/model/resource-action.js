...
(function (ResourceAction) {
    function getJsonObj(obj) {
        ...
        if (obj && "actionType" in obj && obj.actionType) {
            switch (obj.actionType) {
                case "power":
                    return model.ResourcePowerAction.getJsonObj(jsonObj, true);
                default:
    ...
    ResourceAction.getJsonObj = getJsonObj;
    function getDeserializedJsonObj(obj) {
        const jsonObj = Object.assign(Object.assign({}, obj), {});
        if (obj && "actionType" in obj && obj.actionType) {
            switch (obj.actionType) {
                case "power":
                    return model.ResourcePowerAction.getDeserializedJsonObj(jsonObj, true);
                default:
                    if (common.LOG.logger)
                        common.LOG.logger.info(`Unknown value for: ${obj.actionType}`);
            }
    ...
    ResourceAction.getDeserializedJsonObj = getDeserializedJsonObj;
})(ResourceAction = exports.ResourceAction || (exports.ResourceAction = {}));
//# sourceMappingURL=resource-action.js.map
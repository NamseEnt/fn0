...
export declare namespace UpdateThresholdPolicyDetails {
    function getJsonObj(obj: UpdateThresholdPolicyDetails, isParentJsonObj?: boolean): object;
    const policyType = "threshold";
    function getDeserializedJsonObj(obj: UpdateThresholdPolicyDetails, isParentJsonObj?: boolean): object;
}

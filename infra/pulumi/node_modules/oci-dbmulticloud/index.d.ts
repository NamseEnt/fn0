...
import * as dbmulticloudawsprovider_waiter from "./lib/dbmulticloudawsprovider-waiter";
...
export { requests };
export { responses };
export import DbMulticloudAwsProviderClient = client.DbMulticloudAwsProviderClient;
export import DbMulticloudAwsProviderWaiter = dbmulticloudawsprovider_waiter.DbMulticloudAwsProviderWaiter;

...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/dbmulticloud/CreateOracleDbAzureConnector.ts.html |here} to see how to use CreateOracleDbAzureConnectorRequest.
 */
export interface CreateOracleDbAzureConnectorRequest extends common.BaseRequest {
    /**
     * Details for to Create Oracle DB Azure Connector resource
     * and configured Azure Identity in Oracle Database resource.
     *
     */
    "createOracleDbAzureConnectorDetails": model.CreateOracleDbAzureConnectorDetails;
    /**

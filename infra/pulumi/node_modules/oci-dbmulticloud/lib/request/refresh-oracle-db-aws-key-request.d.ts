...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/dbmulticloud/RefreshOracleDbAwsKey.ts.html |here} to see how to use RefreshOracleDbAwsKeyRequest.
 */
export interface RefreshOracleDbAwsKeyRequest extends common.BaseRequest {
    /**
     ...
     */
    "refreshOracleDbAwsKeyDetails": model.RefreshOracleDbAwsKeyDetails;
    /**

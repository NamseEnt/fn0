...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/dbmulticloud/ChangeOracleDbAzureVaultAssociationCompartment.ts.html |here} to see how to use ChangeOracleDbAzureVaultAssociationCompartmentRequest.
 */
export interface ChangeOracleDbAzureVaultAssociationCompartmentRequest extends common.BaseRequest {
    /**
     ...
     */
    "changeOracleDbAzureVaultAssociationCompartmentDetails": model.ChangeOracleDbAzureVaultAssociationCompartmentDetails;
    /**

...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/dbmulticloud/CreateOracleDbGcpKeyRing.ts.html |here} to see how to use CreateOracleDbGcpKeyRingRequest.
 */
export interface CreateOracleDbGcpKeyRingRequest extends common.BaseRequest {
    /**
     * Details for to Create GCP Key Ring Details.
     */
    "createOracleDbGcpKeyRingDetails": model.CreateOracleDbGcpKeyRingDetails;
    /**

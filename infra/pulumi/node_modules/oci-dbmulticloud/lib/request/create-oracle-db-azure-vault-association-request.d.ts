...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/dbmulticloud/CreateOracleDbAzureVaultAssociation.ts.html |here} to see how to use CreateOracleDbAzureVaultAssociationRequest.
 */
export interface CreateOracleDbAzureVaultAssociationRequest extends common.BaseRequest {
    /**
     * Details for to Create Oracle DB Azure Vault Association details.
     */
    "createOracleDbAzureVaultAssociationDetails": model.CreateOracleDbAzureVaultAssociationDetails;
    /**

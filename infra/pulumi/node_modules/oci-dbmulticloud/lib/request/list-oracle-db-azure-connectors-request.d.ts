...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/dbmulticloud/ListOracleDbAzureConnectors.ts.html |here} to see how to use ListOracleDbAzureConnectorsRequest.
 */
export interface ListOracleDbAzureConnectorsRequest extends common.BaseRequest {
    /**
...
export declare namespace ListOracleDbAzureConnectorsRequest {
    enum SortBy {

...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/dbmulticloud/CreateOracleDbAzureVault.ts.html |here} to see how to use CreateOracleDbAzureVaultRequest.
 */
export interface CreateOracleDbAzureVaultRequest extends common.BaseRequest {
    /**
     * Details for to Create Oracle DB Azure Vault details.
     */
    "createOracleDbAzureVaultDetails": model.CreateOracleDbAzureVaultDetails;
    /**

...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/dbmulticloud/CreateOracleDbGcpIdentityConnector.ts.html |here} to see how to use CreateOracleDbGcpIdentityConnectorRequest.
 */
export interface CreateOracleDbGcpIdentityConnectorRequest extends common.BaseRequest {
    /**
     * Details for to Create Oracle DB GCP  Identity Connector resource.
     *
     */
    "createOracleDbGcpIdentityConnectorDetails": model.CreateOracleDbGcpIdentityConnectorDetails;
    /**

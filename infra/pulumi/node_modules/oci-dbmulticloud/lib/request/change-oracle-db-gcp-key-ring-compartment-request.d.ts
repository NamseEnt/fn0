...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/dbmulticloud/ChangeOracleDbGcpKeyRingCompartment.ts.html |here} to see how to use ChangeOracleDbGcpKeyRingCompartmentRequest.
 */
export interface ChangeOracleDbGcpKeyRingCompartmentRequest extends common.BaseRequest {
    /**
     ...
     */
    "changeOracleDbGcpKeyRingCompartmentDetails": model.ChangeOracleDbGcpKeyRingCompartmentDetails;
    /**

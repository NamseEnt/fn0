...
import { OracleDBAzureBlobContainerClient } from "./client";
export declare class OracleDBAzureBlobContainerWaiter {
    private client;
    private readonly config?;
    constructor(client: OracleDBAzureBlobContainerClient, config?: Partial<import("oci-common/lib/waiter").WaiterConfigurationDetails> | undefined);
    /**
     ...
     */
    forOracleDbAzureBlobContainer(request: serviceRequests.GetOracleDbAzureBlobContainerRequest, ...targetStates: models.OracleDbAzureBlobContainer.LifecycleState[]): Promise<serviceResponses.GetOracleDbAzureBlobContainerResponse | null>;
}

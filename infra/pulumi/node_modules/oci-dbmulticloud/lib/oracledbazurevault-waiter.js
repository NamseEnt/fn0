...
exports.OracleDbAzureVaultWaiter = void 0;
const models = __importStar(require("./model"));
const oci_common_1 = require("oci-common");
class OracleDbAzureVaultWaiter {
    constructor(client, config) {
        this.client = client;
        this.config = config;
    }
    /**
     * Waits forOracleDbAzureVault till it reaches any of the provided states
     *
     * @param request the request to send
     * @param targetStates the desired states to wait for. The waiter will return once the resource reaches any of the provided states
     * @return response returns GetOracleDbAzureVaultResponse | null (null in case of 404 response)
     */
    forOracleDbAzureVault(request, ...targetStates) {
        return __awaiter(this, void 0, void 0, function* () {
            return oci_common_1.genericTerminalConditionWaiter(this.config, () => this.client.getOracleDbAzureVault(request), response => targetStates.includes(response.oracleDbAzureVault.lifecycleState), targetStates.includes(models.OracleDbAzureVault.LifecycleState.Deleted));
        });
    }
}
exports.OracleDbAzureVaultWaiter = OracleDbAzureVaultWaiter;
//# sourceMappingURL=oracledbazurevault-waiter.js.map
...
import { OracleDbAzureVaultClient } from "./client";
export declare class OracleDbAzureVaultWaiter {
    private client;
    private readonly config?;
    constructor(client: OracleDbAzureVaultClient, config?: Partial<import("oci-common/lib/waiter").WaiterConfigurationDetails> | undefined);
    /**
     ...
     */
    forOracleDbAzureVault(request: serviceRequests.GetOracleDbAzureVaultRequest, ...targetStates: models.OracleDbAzureVault.LifecycleState[]): Promise<serviceResponses.GetOracleDbAzureVaultResponse | null>;
}

...
exports.OracleDbAzureKeyWaiter = void 0;
const models = __importStar(require("./model"));
const oci_common_1 = require("oci-common");
class OracleDbAzureKeyWaiter {
     ...
     */
    forOracleDbAzureKey(request, ...targetStates) {
        return __awaiter(this, void 0, void 0, function* () {
            return oci_common_1.genericTerminalConditionWaiter(this.config, () => this.client.getOracleDbAzureKey(request), response => targetStates.includes(response.oracleDbAzureKey.lifecycleState), targetStates.includes(models.OracleDbAzureKey.LifecycleState.Deleted));
        });
    }
}
exports.OracleDbAzureKeyWaiter = OracleDbAzureKeyWaiter;
//# sourceMappingURL=oracledbazurekey-waiter.js.map
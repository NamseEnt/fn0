...
exports.OracleDBAzureBlobContainerWaiter = void 0;
const models = __importStar(require("./model"));
const oci_common_1 = require("oci-common");
class OracleDBAzureBlobContainerWaiter {
    constructor(client, config) {
        this.client = client;
        this.config = config;
    }
    /**
     * Waits forOracleDbAzureBlobContainer till it reaches any of the provided states
     *
     * @param request the request to send
     * @param targetStates the desired states to wait for. The waiter will return once the resource reaches any of the provided states
     * @return response returns GetOracleDbAzureBlobContainerResponse | null (null in case of 404 response)
     */
    forOracleDbAzureBlobContainer(request, ...targetStates) {
        return __awaiter(this, void 0, void 0, function* () {
            return oci_common_1.genericTerminalConditionWaiter(this.config, () => this.client.getOracleDbAzureBlobContainer(request), response => targetStates.includes(response.oracleDbAzureBlobContainer.lifecycleState), targetStates.includes(models.OracleDbAzureBlobContainer.LifecycleState.Deleted));
        });
    }
}
exports.OracleDBAzureBlobContainerWaiter = OracleDBAzureBlobContainerWaiter;
//# sourceMappingURL=oracledbazureblobcontainer-waiter.js.map
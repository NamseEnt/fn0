 ...
 */
export interface ChangeOracleDbGcpIdentityConnectorCompartmentDetails {
    /**
     * The OCID of the compartment that contains the Oracle DB GCP Identity Connector resource.
     */
    "compartmentId"?: string;
}
export declare namespace ChangeOracleDbGcpIdentityConnectorCompartmentDetails {
    function getJsonObj(obj: ChangeOracleDbGcpIdentityConnectorCompartmentDetails): object;
    function getDeserializedJsonObj(obj: ChangeOracleDbGcpIdentityConnectorCompartmentDetails): object;
}

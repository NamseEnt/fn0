 ...
 *
 */
export interface OracleDbAzureVaultSummary {
    /**
...
export declare namespace OracleDbAzureVaultSummary {
    function getJsonObj(obj: OracleDbAzureVaultSummary): object;
    function getDeserializedJsonObj(obj: OracleDbAzureVaultSummary): object;
}

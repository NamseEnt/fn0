...
exports.OracleDbAwsIdentityConnectorSummaryCollection = void 0;
const model = __importStar(require("../model"));
var OracleDbAwsIdentityConnectorSummaryCollection;
(function (OracleDbAwsIdentityConnectorSummaryCollection) {
    function getJsonObj(obj) {
        const jsonObj = Object.assign(Object.assign({}, obj), {
            "items": obj.items
                ? obj.items.map(item => {
                    return model.OracleDbAwsIdentityConnectorSummary.getJsonObj(item);
                })
                : undefined
        });
        return jsonObj;
    }
    OracleDbAwsIdentityConnectorSummaryCollection.getJsonObj = getJsonObj;
    function getDeserializedJsonObj(obj) {
        const jsonObj = Object.assign(Object.assign({}, obj), {
            "items": obj.items
                ? obj.items.map(item => {
                    return model.OracleDbAwsIdentityConnectorSummary.getDeserializedJsonObj(item);
                })
                : undefined
        });
        return jsonObj;
    }
    OracleDbAwsIdentityConnectorSummaryCollection.getDeserializedJsonObj = getDeserializedJsonObj;
})(OracleDbAwsIdentityConnectorSummaryCollection = exports.OracleDbAwsIdentityConnectorSummaryCollection || (exports.OracleDbAwsIdentityConnectorSummaryCollection = {}));
//# sourceMappingURL=oracle-db-aws-identity-connector-summary-collection.js.map
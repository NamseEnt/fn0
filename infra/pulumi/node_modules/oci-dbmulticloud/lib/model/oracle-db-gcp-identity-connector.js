...
exports.OracleDbGcpIdentityConnector = void 0;
const model = __importStar(require("../model"));
var OracleDbGcpIdentityConnector;
(function (OracleDbGcpIdentityConnector) {
    let GcpIdentityConnectivityStatus;
    (function (GcpIdentityConnectivityStatus) {
        GcpIdentityConnectivityStatus["Connected"] = "CONNECTED";
        GcpIdentityConnectivityStatus["Disconnected"] = "DISCONNECTED";
        GcpIdentityConnectivityStatus["PartiallyConnected"] = "PARTIALLY_CONNECTED";
        GcpIdentityConnectivityStatus["Unknown"] = "UNKNOWN";
        /**
         * This value is used if a service returns a value for this enum that is not recognized by this
         * version of the SDK.
         */
        GcpIdentityConnectivityStatus["UnknownValue"] = "UNKNOWN_VALUE";
    })(GcpIdentityConnectivityStatus = OracleDbGcpIdentityConnector.GcpIdentityConnectivityStatus || (OracleDbGcpIdentityConnector.GcpIdentityConnectivityStatus = {}));
    let LifecycleState;
    ...
    })(LifecycleState = OracleDbGcpIdentityConnector.LifecycleState || (OracleDbGcpIdentityConnector.LifecycleState = {}));
    function getJsonObj(obj) {
        const jsonObj = Object.assign(Object.assign({}, obj), {
            "gcpNodes": obj.gcpNodes
                ? obj.gcpNodes.map(item => {
                    return model.GcpNodes.getJsonObj(item);
                })
                : undefined
        });
        return jsonObj;
    }
    OracleDbGcpIdentityConnector.getJsonObj = getJsonObj;
    function getDeserializedJsonObj(obj) {
        const jsonObj = Object.assign(Object.assign({}, obj), {
            "gcpNodes": obj.gcpNodes
                ? obj.gcpNodes.map(item => {
                    return model.GcpNodes.getDeserializedJsonObj(item);
                })
                : undefined
        });
        return jsonObj;
    }
    OracleDbGcpIdentityConnector.getDeserializedJsonObj = getDeserializedJsonObj;
})(OracleDbGcpIdentityConnector = exports.OracleDbGcpIdentityConnector || (exports.OracleDbGcpIdentityConnector = {}));
//# sourceMappingURL=oracle-db-gcp-identity-connector.js.map
 ...
 */
export interface RefreshOracleDbGcpKeyRingDetails {
    /**
...
export declare namespace RefreshOracleDbGcpKeyRingDetails {
    function getJsonObj(obj: RefreshOracleDbGcpKeyRingDetails): object;
    function getDeserializedJsonObj(obj: RefreshOracleDbGcpKeyRingDetails): object;
}

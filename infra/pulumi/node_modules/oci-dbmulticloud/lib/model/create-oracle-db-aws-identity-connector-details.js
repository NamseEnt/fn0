...
exports.CreateOracleDbAwsIdentityConnectorDetails = void 0;
const model = __importStar(require("../model"));
var CreateOracleDbAwsIdentityConnectorDetails;
(function (CreateOracleDbAwsIdentityConnectorDetails) {
    function getJsonObj(obj) {
        const jsonObj = Object.assign(Object.assign({}, obj), {
            "serviceRoleDetails": obj.serviceRoleDetails
                ? obj.serviceRoleDetails.map(item => {
                    return model.ServiceRoleDetail.getJsonObj(item);
                })
                : undefined
        });
        return jsonObj;
    }
    CreateOracleDbAwsIdentityConnectorDetails.getJsonObj = getJsonObj;
    function getDeserializedJsonObj(obj) {
        const jsonObj = Object.assign(Object.assign({}, obj), {
            "serviceRoleDetails": obj.serviceRoleDetails
                ? obj.serviceRoleDetails.map(item => {
                    return model.ServiceRoleDetail.getDeserializedJsonObj(item);
                })
                : undefined
        });
        return jsonObj;
    }
    CreateOracleDbAwsIdentityConnectorDetails.getDeserializedJsonObj = getDeserializedJsonObj;
})(CreateOracleDbAwsIdentityConnectorDetails = exports.CreateOracleDbAwsIdentityConnectorDetails || (exports.CreateOracleDbAwsIdentityConnectorDetails = {}));
//# sourceMappingURL=create-oracle-db-aws-identity-connector-details.js.map
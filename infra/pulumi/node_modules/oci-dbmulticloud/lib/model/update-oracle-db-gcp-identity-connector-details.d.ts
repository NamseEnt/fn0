 ...
 *
 */
export interface UpdateOracleDbGcpIdentityConnectorDetails {
    /**
...
export declare namespace UpdateOracleDbGcpIdentityConnectorDetails {
    function getJsonObj(obj: UpdateOracleDbGcpIdentityConnectorDetails): object;
    function getDeserializedJsonObj(obj: UpdateOracleDbGcpIdentityConnectorDetails): object;
}

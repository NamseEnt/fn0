...
export declare namespace MultiCloudResourceDiscoverySummary {
    function getJsonObj(obj: MultiCloudResourceDiscoverySummary): object;
    function getDeserializedJsonObj(obj: MultiCloudResourceDiscoverySummary): object;
}

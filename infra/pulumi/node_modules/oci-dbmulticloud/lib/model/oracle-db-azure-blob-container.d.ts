 ...
 *
 */
export interface OracleDbAzureBlobContainer {
    /**
     ...
     */
    "lifecycleState"?: OracleDbAzureBlobContainer.LifecycleState;
    /**
...
export declare namespace OracleDbAzureBlobContainer {
    enum LifecycleState {
        Creating = "CREATING",
        Active = "ACTIVE",
        Updating = "UPDATING",
    ...
    function getJsonObj(obj: OracleDbAzureBlobContainer): object;
    function getDeserializedJsonObj(obj: OracleDbAzureBlobContainer): object;
}

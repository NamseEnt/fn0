...
exports.OracleDbGcpKeyRingSummaryCollection = void 0;
const model = __importStar(require("../model"));
var OracleDbGcpKeyRingSummaryCollection;
(function (OracleDbGcpKeyRingSummaryCollection) {
    function getJsonObj(obj) {
        const jsonObj = Object.assign(Object.assign({}, obj), {
            "items": obj.items
                ? obj.items.map(item => {
                    return model.OracleDbGcpKeyRingSummary.getJsonObj(item);
                })
                : undefined
        });
        return jsonObj;
    }
    OracleDbGcpKeyRingSummaryCollection.getJsonObj = getJsonObj;
    function getDeserializedJsonObj(obj) {
        const jsonObj = Object.assign(Object.assign({}, obj), {
            "items": obj.items
                ? obj.items.map(item => {
                    return model.OracleDbGcpKeyRingSummary.getDeserializedJsonObj(item);
                })
                : undefined
        });
        return jsonObj;
    }
    OracleDbGcpKeyRingSummaryCollection.getDeserializedJsonObj = getDeserializedJsonObj;
})(OracleDbGcpKeyRingSummaryCollection = exports.OracleDbGcpKeyRingSummaryCollection || (exports.OracleDbGcpKeyRingSummaryCollection = {}));
//# sourceMappingURL=oracle-db-gcp-key-ring-summary-collection.js.map
 ...
 *
 */
export interface OracleDbAwsIdentityConnectorSummary {
    /**
...
export declare namespace OracleDbAwsIdentityConnectorSummary {
    function getJsonObj(obj: OracleDbAwsIdentityConnectorSummary): object;
    function getDeserializedJsonObj(obj: OracleDbAwsIdentityConnectorSummary): object;
}

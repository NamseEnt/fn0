 ...
 *
 */
export interface OracleDbGcpKeyRing {
    /**
     ...
     */
    "lifecycleState"?: OracleDbGcpKeyRing.LifecycleState;
    /**
...
export declare namespace OracleDbGcpKeyRing {
    enum LifecycleState {
        Creating = "CREATING",
        Active = "ACTIVE",
        Updating = "UPDATING",
    ...
    function getJsonObj(obj: OracleDbGcpKeyRing): object;
    function getDeserializedJsonObj(obj: OracleDbGcpKeyRing): object;
}

 ...
 *
 */
export interface CreateOracleDbAzureVaultAssociationDetails {
    /**
...
export declare namespace CreateOracleDbAzureVaultAssociationDetails {
    function getJsonObj(obj: CreateOracleDbAzureVaultAssociationDetails): object;
    function getDeserializedJsonObj(obj: CreateOracleDbAzureVaultAssociationDetails): object;
}

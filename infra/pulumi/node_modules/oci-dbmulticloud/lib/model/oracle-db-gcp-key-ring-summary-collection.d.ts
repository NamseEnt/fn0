 ...
 */
export interface OracleDbGcpKeyRingSummaryCollection {
    /**
     * This list contains the summary of Oracle DB GCP Key-Ring resources.
     */
    "items": Array<model.OracleDbGcpKeyRingSummary>;
}
export declare namespace OracleDbGcpKeyRingSummaryCollection {
    function getJsonObj(obj: OracleDbGcpKeyRingSummaryCollection): object;
    function getDeserializedJsonObj(obj: OracleDbGcpKeyRingSummaryCollection): object;
}

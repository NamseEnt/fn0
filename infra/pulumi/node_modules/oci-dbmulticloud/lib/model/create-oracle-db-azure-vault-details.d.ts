 ...
 *
 */
export interface CreateOracleDbAzureVaultDetails {
    /**
...
export declare namespace CreateOracleDbAzureVaultDetails {
    function getJsonObj(obj: CreateOracleDbAzureVaultDetails): object;
    function getDeserializedJsonObj(obj: CreateOracleDbAzureVaultDetails): object;
}

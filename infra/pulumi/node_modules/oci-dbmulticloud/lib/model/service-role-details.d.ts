 ...
 */
export interface ServiceRoleDetails {
    /**
     ...
     * Type of service.
     */
    "serviceType": ServiceRoleDetails.ServiceType;
    /**
     * Assume role  status.
     */
    "assumeRoleStatus"?: ServiceRoleDetails.AssumeRoleStatus;
    /**
     * List of all VMs where AWS Identity Connector is configured for Oracle DB Cloud VM Cluster.
     */
    "awsNodes"?: Array<model.AwsNodes>;
}
export declare namespace ServiceRoleDetails {
    enum ServiceType {
        Kms = "KMS",
        /**
    ...
    function getJsonObj(obj: ServiceRoleDetails): object;
    function getDeserializedJsonObj(obj: ServiceRoleDetails): object;
}

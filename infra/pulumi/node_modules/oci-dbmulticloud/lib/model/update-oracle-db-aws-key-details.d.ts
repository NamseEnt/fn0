 ...
 *
 */
export interface UpdateOracleDbAwsKeyDetails {
    /**
...
export declare namespace UpdateOracleDbAwsKeyDetails {
    function getJsonObj(obj: UpdateOracleDbAwsKeyDetails): object;
    function getDeserializedJsonObj(obj: UpdateOracleDbAwsKeyDetails): object;
}

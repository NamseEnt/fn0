...
/**
 * List of OracleDbAzureBlobMountSummary resources.
 */
export interface OracleDbAzureBlobMountSummaryCollection {
    /**
     * This list contains Oracle DB Azure Blob Mount resources.
     */
    "items": Array<model.OracleDbAzureBlobMountSummary>;
}
export declare namespace OracleDbAzureBlobMountSummaryCollection {
    function getJsonObj(obj: OracleDbAzureBlobMountSummaryCollection): object;
    function getDeserializedJsonObj(obj: OracleDbAzureBlobMountSummaryCollection): object;
}

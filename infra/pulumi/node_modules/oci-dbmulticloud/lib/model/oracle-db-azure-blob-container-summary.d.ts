 ...
 *
 */
export interface OracleDbAzureBlobContainerSummary {
    /**
...
export declare namespace OracleDbAzureBlobContainerSummary {
    function getJsonObj(obj: OracleDbAzureBlobContainerSummary): object;
    function getDeserializedJsonObj(obj: OracleDbAzureBlobContainerSummary): object;
}

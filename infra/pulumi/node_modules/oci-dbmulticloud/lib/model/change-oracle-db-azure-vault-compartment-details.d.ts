 ...
 */
export interface ChangeOracleDbAzureVaultCompartmentDetails {
    /**
...
export declare namespace ChangeOracleDbAzureVaultCompartmentDetails {
    function getJsonObj(obj: ChangeOracleDbAzureVaultCompartmentDetails): object;
    function getDeserializedJsonObj(obj: ChangeOracleDbAzureVaultCompartmentDetails): object;
}

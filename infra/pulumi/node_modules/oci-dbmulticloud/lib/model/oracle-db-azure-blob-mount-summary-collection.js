...
exports.OracleDbAzureBlobMountSummaryCollection = void 0;
const model = __importStar(require("../model"));
var OracleDbAzureBlobMountSummaryCollection;
(function (OracleDbAzureBlobMountSummaryCollection) {
    function getJsonObj(obj) {
        const jsonObj = Object.assign(Object.assign({}, obj), {
            "items": obj.items
                ? obj.items.map(item => {
                    return model.OracleDbAzureBlobMountSummary.getJsonObj(item);
                })
                : undefined
        });
        return jsonObj;
    }
    OracleDbAzureBlobMountSummaryCollection.getJsonObj = getJsonObj;
    function getDeserializedJsonObj(obj) {
        const jsonObj = Object.assign(Object.assign({}, obj), {
            "items": obj.items
                ? obj.items.map(item => {
                    return model.OracleDbAzureBlobMountSummary.getDeserializedJsonObj(item);
                })
                : undefined
        });
        return jsonObj;
    }
    OracleDbAzureBlobMountSummaryCollection.getDeserializedJsonObj = getDeserializedJsonObj;
})(OracleDbAzureBlobMountSummaryCollection = exports.OracleDbAzureBlobMountSummaryCollection || (exports.OracleDbAzureBlobMountSummaryCollection = {}));
//# sourceMappingURL=oracle-db-azure-blob-mount-summary-collection.js.map
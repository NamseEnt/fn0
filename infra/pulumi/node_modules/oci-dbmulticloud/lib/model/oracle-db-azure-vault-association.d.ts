...
export declare namespace OracleDbAzureVaultAssociation {
    enum LifecycleState {
        Creating = "CREATING",
        Active = "ACTIVE",
        Updating = "UPDATING",
    ...
    function getJsonObj(obj: OracleDbAzureVaultAssociation): object;
    function getDeserializedJsonObj(obj: OracleDbAzureVaultAssociation): object;
}

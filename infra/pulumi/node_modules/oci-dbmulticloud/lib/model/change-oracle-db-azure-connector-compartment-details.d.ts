 ...
 */
export interface ChangeOracleDbAzureConnectorCompartmentDetails {
    /**
...
export declare namespace ChangeOracleDbAzureConnectorCompartmentDetails {
    function getJsonObj(obj: ChangeOracleDbAzureConnectorCompartmentDetails): object;
    function getDeserializedJsonObj(obj: ChangeOracleDbAzureConnectorCompartmentDetails): object;
}

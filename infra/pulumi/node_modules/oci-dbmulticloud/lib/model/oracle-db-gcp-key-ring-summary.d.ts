 ...
 *
 */
export interface OracleDbGcpKeyRingSummary {
    /**
...
export declare namespace OracleDbGcpKeyRingSummary {
    function getJsonObj(obj: OracleDbGcpKeyRingSummary): object;
    function getDeserializedJsonObj(obj: OracleDbGcpKeyRingSummary): object;
}

 ...
 *
 */
export interface OracleDbAwsIdentityConnector {
    /**
     ...
     *
     */
    "serviceRoleDetails": Array<model.ServiceRoleDetails>;
    /**
     ...
     */
    "lifecycleState"?: OracleDbAwsIdentityConnector.LifecycleState;
    /**
...
export declare namespace OracleDbAwsIdentityConnector {
    enum LifecycleState {
        Creating = "CREATING",
        Active = "ACTIVE",
        Updating = "UPDATING",
    ...
    function getJsonObj(obj: OracleDbAwsIdentityConnector): object;
    function getDeserializedJsonObj(obj: OracleDbAwsIdentityConnector): object;
}

 ...
 *
 */
export interface UpdateOracleDbAzureConnectorDetails {
    /**
...
export declare namespace UpdateOracleDbAzureConnectorDetails {
    function getJsonObj(obj: UpdateOracleDbAzureConnectorDetails): object;
    function getDeserializedJsonObj(obj: UpdateOracleDbAzureConnectorDetails): object;
}

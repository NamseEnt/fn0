 ...
 *
 */
export interface UpdateOracleDbGcpKeyRingDetails {
    /**
...
export declare namespace UpdateOracleDbGcpKeyRingDetails {
    function getJsonObj(obj: UpdateOracleDbGcpKeyRingDetails): object;
    function getDeserializedJsonObj(obj: UpdateOracleDbGcpKeyRingDetails): object;
}

...
import { MultiCloudResourceDiscoveryClient } from "./client";
export declare class MultiCloudResourceDiscoveryWaiter {
    private client;
    private readonly config?;
    constructor(client: MultiCloudResourceDiscoveryClient, config?: Partial<import("oci-common/lib/waiter").WaiterConfigurationDetails> | undefined);
    /**
     * Waits forMultiCloudResourceDiscovery till it reaches any of the provided states
     *
     * @param request the request to send
     * @param targetStates the desired states to wait for. The waiter will return once the resource reaches any of the provided states
     * @return response returns GetMultiCloudResourceDiscoveryResponse
     */
    forMultiCloudResourceDiscovery(request: serviceRequests.GetMultiCloudResourceDiscoveryRequest, ...targetStates: models.MultiCloudResourceDiscovery.LifecycleState[]): Promise<serviceResponses.GetMultiCloudResourceDiscoveryResponse>;
}

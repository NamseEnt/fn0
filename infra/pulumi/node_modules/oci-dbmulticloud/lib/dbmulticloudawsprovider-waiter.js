...
exports.DbMulticloudAwsProviderWaiter = void 0;
const models = __importStar(require("./model"));
const oci_common_1 = require("oci-common");
class DbMulticloudAwsProviderWaiter {
    constructor(client, config) {
        this.client = client;
        this.config = config;
    }
    /**
     * Waits forOracleDbAwsIdentityConnector till it reaches any of the provided states
     *
     * @param request the request to send
     * @param targetStates the desired states to wait for. The waiter will return once the resource reaches any of the provided states
     * @return response returns GetOracleDbAwsIdentityConnectorResponse | null (null in case of 404 response)
     */
    forOracleDbAwsIdentityConnector(request, ...targetStates) {
        return __awaiter(this, void 0, void 0, function* () {
            return oci_common_1.genericTerminalConditionWaiter(this.config, () => this.client.getOracleDbAwsIdentityConnector(request), response => targetStates.includes(response.oracleDbAwsIdentityConnector.lifecycleState), targetStates.includes(models.OracleDbAwsIdentityConnector.LifecycleState.Deleted));
        });
    }
    /**
     * Waits forOracleDbAwsKey till it reaches any of the provided states
     *
     * @param request the request to send
     * @param targetStates the desired states to wait for. The waiter will return once the resource reaches any of the provided states
     * @return response returns GetOracleDbAwsKeyResponse | null (null in case of 404 response)
     */
    forOracleDbAwsKey(request, ...targetStates) {
        return __awaiter(this, void 0, void 0, function* () {
            return oci_common_1.genericTerminalConditionWaiter(this.config, () => this.client.getOracleDbAwsKey(request), response => targetStates.includes(response.oracleDbAwsKey.lifecycleState), targetStates.includes(models.OracleDbAwsKey.LifecycleState.Deleted));
        });
    }
}
exports.DbMulticloudAwsProviderWaiter = DbMulticloudAwsProviderWaiter;
//# sourceMappingURL=dbmulticloudawsprovider-waiter.js.map
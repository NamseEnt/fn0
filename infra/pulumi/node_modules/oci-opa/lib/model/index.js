...
exports.CreateOpaInstanceDetails = CreateOpaInstanceDetails.CreateOpaInstanceDetails;
const OpaInstance = __importStar(require("./opa-instance"));
exports.OpaInstance = OpaInstance.OpaInstance;
const OpaInstanceCollection = __importStar(require("./opa-instance-collection"));
exports.OpaInstanceCollection = OpaInstanceCollection.OpaInstanceCollection;
const OpaInstanceSummary = __importStar(require("./opa-instance-summary"));
exports.OpaInstanceSummary = OpaInstanceSummary.OpaInstanceSummary;
...
const UpdateOpaInstanceDetails = __importStar(require("./update-opa-instance-details"));
exports.UpdateOpaInstanceDetails = UpdateOpaInstanceDetails.UpdateOpaInstanceDetails;

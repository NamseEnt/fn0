...
export declare enum OpaInstanceApiKeys {
}
/**
 * This service client uses {@link common.CircuitBreaker.DefaultConfiguration} for all the operations by default if no circuit breaker configuration is defined by the user.
 */
export declare class OpaInstanceClient {
     ...
     */
    createWaiters(config?: common.WaiterConfiguration): OpaInstanceWaiter;
    /**
     * Gets the waiters available for resources for this service.
     *
     * @return The service waiters.
     */
    getWaiters(): OpaInstanceWaiter;
    /**
     ...
     */
    startOpaInstance(startOpaInstanceRequest: requests.StartOpaInstanceRequest): Promise<responses.StartOpaInstanceResponse>;
    /**
     ...
     */
    stopOpaInstance(stopOpaInstanceRequest: requests.StopOpaInstanceRequest): Promise<responses.StopOpaInstanceResponse>;
    /**

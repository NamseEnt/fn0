...
import * as opainstance_waiter from "./lib/opainstance-waiter";
export { models };
export { requests };
export { responses };
export import OpaInstanceClient = client.OpaInstanceClient;
export import OpaInstanceWaiter = opainstance_waiter.OpaInstanceWaiter;

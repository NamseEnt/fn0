...
export declare namespace PingProbeResultSummary {
    enum ErrorCategory {
        None = "NONE",
        Dns = "DNS",
        Transport = "TRANSPORT",
    ...
    function getJsonObj(obj: PingProbeResultSummary): object;
    function getDeserializedJsonObj(obj: PingProbeResultSummary): object;
}

...
export declare namespace ChangePingMonitorCompartmentDetails {
    function getJsonObj(obj: ChangePingMonitorCompartmentDetails): object;
    function getDeserializedJsonObj(obj: ChangePingMonitorCompartmentDetails): object;
}

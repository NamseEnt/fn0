 ...
 */
export interface CreateOnDemandPingProbeDetails {
    /**
...
export declare namespace CreateOnDemandPingProbeDetails {
    function getJsonObj(obj: CreateOnDemandPingProbeDetails): object;
    function getDeserializedJsonObj(obj: CreateOnDemandPingProbeDetails): object;
}

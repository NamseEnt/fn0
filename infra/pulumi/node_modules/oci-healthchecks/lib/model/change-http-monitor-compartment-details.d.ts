...
export declare namespace ChangeHttpMonitorCompartmentDetails {
    function getJsonObj(obj: ChangeHttpMonitorCompartmentDetails): object;
    function getDeserializedJsonObj(obj: ChangeHttpMonitorCompartmentDetails): object;
}

...
export declare namespace HttpMonitorSummary {
    function getJsonObj(obj: HttpMonitorSummary): object;
    function getDeserializedJsonObj(obj: HttpMonitorSummary): object;
}

...
export declare namespace PingMonitorSummary {
    function getJsonObj(obj: PingMonitorSummary): object;
    function getDeserializedJsonObj(obj: PingMonitorSummary): object;
}

...
export declare namespace CreateOnDemandHttpProbeDetails {
    function getJsonObj(obj: CreateOnDemandHttpProbeDetails): object;
    function getDeserializedJsonObj(obj: CreateOnDemandHttpProbeDetails): object;
}

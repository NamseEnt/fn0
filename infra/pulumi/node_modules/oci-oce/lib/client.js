...
exports.OceInstanceClient = exports.OceInstanceApiKeys = void 0;
const common = require("oci-common");
const model = __importStar(require("./model"));
const oci_common_1 = require("oci-common");
const oceinstance_waiter_1 = require("./oceinstance-waiter");
const oci_common_2 = require("oci-common");
const Breaker = require("opossum");
// ===============================================
// This file is autogenerated - Please do not edit
// ===============================================
var OceInstanceApiKeys;
(function (OceInstanceApiKeys) {
})(OceInstanceApiKeys = exports.OceInstanceApiKeys || (exports.OceInstanceApiKeys = {}));
/**
 * This service client uses {@link common.CircuitBreaker.DefaultConfiguration} for all the operations by default if no circuit breaker configuration is defined by the user.
 */
class OceInstanceClient {
    constructor(params, clientConfiguration) {
        ...
        this.targetService = "OceInstance";
        this._regionId = "";
        ...
        if (!oci_common_2.developerToolConfiguration.isServiceEnabled("oce")) {
            let errmsg = "The developerToolConfiguration configuration disabled this service, this behavior is controlled by developerToolConfiguration.ociEnabledServiceSet variable. Please check if your local developer_tool_configuration file has configured the service you're targeting or contact the cloud provider on the availability of this service : ";
            throw errmsg.concat("oce");
        }
    ...
    set endpoint(endpoint) {
        ...
        if (this.logger)
            this.logger.info(`OceInstanceClient endpoint set to ${this._endpoint}`);
    }
    get logger() {
    ...
    set useRealmSpecificEndpointTemplate(realmSpecificEndpointTemplateEnabled) {
        ...
        if (this._lastSetRegionOrRegionId === common.Region.REGION_STRING) {
            this.endpoint = common.EndpointBuilder.createEndpointFromRegion(OceInstanceClient.serviceEndpointTemplate, this._region, OceInstanceClient.endpointServiceName);
        }
        else if (this._lastSetRegionOrRegionId === common.Region.REGION_ID_STRING) {
            this.endpoint = common.EndpointBuilder.createEndpointFromRegionId(OceInstanceClient.serviceEndpointTemplate, this._regionId, OceInstanceClient.endpointServiceName);
        }
    }
    /**
    ...
    set region(region) {
        this._region = region;
        this.endpoint = common.EndpointBuilder.createEndpointFromRegion(OceInstanceClient.serviceEndpointTemplate, region, OceInstanceClient.endpointServiceName);
    ...
    set regionId(regionId) {
        ...
        this.endpoint = common.EndpointBuilder.createEndpointFromRegionId(OceInstanceClient.serviceEndpointTemplate, regionId, OceInstanceClient.endpointServiceName);
    ...
    createWaiters(config) {
        this._waiters = new oceinstance_waiter_1.OceInstanceWaiter(this, config);
     ...
     */
    changeOceInstanceCompartment(changeOceInstanceCompartmentRequest) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const retrier = oci_common_2.GenericRetrier.createPreferredRetrier(this._clientConfiguration ? this._clientConfiguration.retryConfiguration : undefined, changeOceInstanceCompartmentRequest.retryConfiguration, specRetryConfiguration);
            if (this.logger)
            ...
            const request = yield oci_common_2.composeRequest({
                ...
                method: "POST",
                bodyContent: common.ObjectSerializer.serialize(changeOceInstanceCompartmentRequest.changeOceInstanceCompartmentDetails, "ChangeOceInstanceCompartmentDetails", model.ChangeOceInstanceCompartmentDetails.getJsonObj),
     ...
     */
    createOceInstance(createOceInstanceRequest) {
        return __awaiter(this, void 0, void 0, function* () {
            if (this.logger)
                this.logger.debug("Calling operation OceInstanceClient#createOceInstance.");
            ...
            const specRetryConfiguration = common.OciSdkDefaultRetryConfiguration;
            const retrier = oci_common_2.GenericRetrier.createPreferredRetrier(this._clientConfiguration ? this._clientConfiguration.retryConfiguration : undefined, createOceInstanceRequest.retryConfiguration, specRetryConfiguration);
            if (this.logger)
                retrier.logger = this.logger;
            const request = yield oci_common_2.composeRequest({
                baseEndpoint: this._endpoint,
                ...
                path: "/oceInstances",
                method: "POST",
                bodyContent: common.ObjectSerializer.serialize(createOceInstanceRequest.createOceInstanceDetails, "CreateOceInstanceDetails", model.CreateOceInstanceDetails.getJsonObj),
                pathParams: pathParams,
                headerParams: headerParams,
                queryParams: queryParams
            });
     ...
     */
    deleteOceInstance(deleteOceInstanceRequest) {
        return __awaiter(this, void 0, void 0, function* () {
            if (this.logger)
                this.logger.debug("Calling operation OceInstanceClient#deleteOceInstance.");
            ...
            const specRetryConfiguration = common.OciSdkDefaultRetryConfiguration;
            const retrier = oci_common_2.GenericRetrier.createPreferredRetrier(this._clientConfiguration ? this._clientConfiguration.retryConfiguration : undefined, deleteOceInstanceRequest.retryConfiguration, specRetryConfiguration);
            if (this.logger)
                retrier.logger = this.logger;
            const request = yield oci_common_2.composeRequest({
                baseEndpoint: this._endpoint,
     ...
     */
    getOceInstance(getOceInstanceRequest) {
        return __awaiter(this, void 0, void 0, function* () {
            if (this.logger)
                this.logger.debug("Calling operation OceInstanceClient#getOceInstance.");
            ...
            const specRetryConfiguration = common.OciSdkDefaultRetryConfiguration;
            const retrier = oci_common_2.GenericRetrier.createPreferredRetrier(this._clientConfiguration ? this._clientConfiguration.retryConfiguration : undefined, getOceInstanceRequest.retryConfiguration, specRetryConfiguration);
            if (this.logger)
                retrier.logger = this.logger;
            const request = yield oci_common_2.composeRequest({
                baseEndpoint: this._endpoint,
    ...
    getWorkRequest(getWorkRequestRequest) {
        return __awaiter(this, void 0, void 0, function* () {
            if (this.logger)
                this.logger.debug("Calling operation OceInstanceClient#getWorkRequest.");
     ...
     */
    listOceInstances(listOceInstancesRequest) {
        return __awaiter(this, void 0, void 0, function* () {
            if (this.logger)
                this.logger.debug("Calling operation OceInstanceClient#listOceInstances.");
            ...
            const specRetryConfiguration = common.OciSdkDefaultRetryConfiguration;
            const retrier = oci_common_2.GenericRetrier.createPreferredRetrier(this._clientConfiguration ? this._clientConfiguration.retryConfiguration : undefined, listOceInstancesRequest.retryConfiguration, specRetryConfiguration);
            if (this.logger)
                retrier.logger = this.logger;
            const request = yield oci_common_2.composeRequest({
                baseEndpoint: this._endpoint,
     ...
     */
    listAllOceInstances(request) {
        return oci_common_1.paginateRecords(request, req => this.listOceInstances(req));
    }
    /**
     ...
     * @param request a request which can be sent to the service operation
     */
    listAllOceInstancesResponses(request) {
        return oci_common_1.paginateResponses(request, req => this.listOceInstances(req));
    }
    /**
     * Creates a new async iterator which will iterate over the models.OceInstanceSummary objects
     * contained in responses from the listOceInstances operation. This iterator will fetch more data from the
     ...
     * @param request a request which can be sent to the service operation
     */
    listOceInstancesRecordIterator(request) {
        return oci_common_1.paginateRecords(request, req => this.listOceInstances(req));
    }
    /**
     * Creates a new async iterator which will iterate over the responses received from the listOceInstances operation. This iterator
     ...
     * @param request a request which can be sent to the service operation
     */
    listOceInstancesResponseIterator(request) {
        return oci_common_1.paginateResponses(request, req => this.listOceInstances(req));
    }
    /**
    ...
    listWorkRequestLogs(listWorkRequestLogsRequest) {
        return __awaiter(this, void 0, void 0, function* () {
            if (this.logger)
                this.logger.debug("Calling operation OceInstanceClient#listWorkRequestLogs.");
    ...
    listWorkRequests(listWorkRequestsRequest) {
        return __awaiter(this, void 0, void 0, function* () {
            if (this.logger)
                this.logger.debug("Calling operation OceInstanceClient#listWorkRequests.");
     ...
     */
    updateOceInstance(updateOceInstanceRequest) {
        return __awaiter(this, void 0, void 0, function* () {
            if (this.logger)
                this.logger.debug("Calling operation OceInstanceClient#updateOceInstance.");
            ...
            const specRetryConfiguration = common.OciSdkDefaultRetryConfiguration;
            const retrier = oci_common_2.GenericRetrier.createPreferredRetrier(this._clientConfiguration ? this._clientConfiguration.retryConfiguration : undefined, updateOceInstanceRequest.retryConfiguration, specRetryConfiguration);
            if (this.logger)
                retrier.logger = this.logger;
            const request = yield oci_common_2.composeRequest({
                baseEndpoint: this._endpoint,
                ...
                path: "/oceInstances/{oceInstanceId}",
                method: "PUT",
                bodyContent: common.ObjectSerializer.serialize(updateOceInstanceRequest.updateOceInstanceDetails, "UpdateOceInstanceDetails", model.UpdateOceInstanceDetails.getJsonObj),
                pathParams: pathParams,
                headerParams: headerParams,
                queryParams: queryParams
            });
...
exports.OceInstanceClient = OceInstanceClient;
OceInstanceClient.serviceEndpointTemplate = "https://cp.oce.{region}.ocp.{secondLevelDomain}";

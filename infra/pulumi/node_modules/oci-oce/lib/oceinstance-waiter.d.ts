...
export declare class OceInstanceWaiter {
    private client;
    private readonly config?;
    constructor(client: OceInstanceClient, config?: Partial<import("oci-common/lib/waiter").WaiterConfigurationDetails> | undefined);
    /**
     ...
     */
    forOceInstance(request: serviceRequests.GetOceInstanceRequest, ...targetStates: models.LifecycleState[]): Promise<serviceResponses.GetOceInstanceResponse | null>;
    /**

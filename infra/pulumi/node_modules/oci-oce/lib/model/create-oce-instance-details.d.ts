...
export declare namespace CreateOceInstanceDetails {
    ...
    function getJsonObj(obj: CreateOceInstanceDetails): object;
    function getDeserializedJsonObj(obj: CreateOceInstanceDetails): object;
}

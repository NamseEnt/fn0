...
exports.OceInstanceWaiter = void 0;
const models = __importStar(require("./model"));
const oci_common_1 = require("oci-common");
class OceInstanceWaiter {
     ...
     */
    forOceInstance(request, ...targetStates) {
        return __awaiter(this, void 0, void 0, function* () {
            return oci_common_1.genericTerminalConditionWaiter(this.config, () => this.client.getOceInstance(request), response => targetStates.includes(response.oceInstance.lifecycleState), targetStates.includes(models.LifecycleState.Deleted));
        });
    }
    /**
...
exports.OceInstanceWaiter = OceInstanceWaiter;
//# sourceMappingURL=oceinstance-waiter.js.map
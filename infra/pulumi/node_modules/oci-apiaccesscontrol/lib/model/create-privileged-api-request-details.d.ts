...
export declare namespace CreatePrivilegedApiRequestDetails {
    function getJsonObj(obj: CreatePrivilegedApiRequestDetails): object;
    function getDeserializedJsonObj(obj: CreatePrivilegedApiRequestDetails): object;
}

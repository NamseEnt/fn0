 ...
 */
export interface PrivilegedApiRequestCollection {
    /**
     * contains PrivilegedApiRequestSummary
     */
    "items": Array<model.PrivilegedApiRequestSummary>;
}
export declare namespace PrivilegedApiRequestCollection {
    function getJsonObj(obj: PrivilegedApiRequestCollection): object;
    function getDeserializedJsonObj(obj: PrivilegedApiRequestCollection): object;
}

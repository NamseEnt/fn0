...
export declare namespace ApiMetadataByEntityTypeSummary {
    function getJsonObj(obj: ApiMetadataByEntityTypeSummary): object;
    function getDeserializedJsonObj(obj: ApiMetadataByEntityTypeSummary): object;
}

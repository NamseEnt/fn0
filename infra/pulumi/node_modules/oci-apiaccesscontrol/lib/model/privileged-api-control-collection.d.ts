 ...
 */
export interface PrivilegedApiControlCollection {
    /**
     * List of privilegedApiControls.
     */
    "items": Array<model.PrivilegedApiControlSummary>;
}
export declare namespace PrivilegedApiControlCollection {
    function getJsonObj(obj: PrivilegedApiControlCollection): object;
    function getDeserializedJsonObj(obj: PrivilegedApiControlCollection): object;
}

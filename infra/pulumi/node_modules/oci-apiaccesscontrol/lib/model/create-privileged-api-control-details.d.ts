...
export declare namespace CreatePrivilegedApiControlDetails {
    function getJsonObj(obj: CreatePrivilegedApiControlDetails): object;
    function getDeserializedJsonObj(obj: CreatePrivilegedApiControlDetails): object;
}

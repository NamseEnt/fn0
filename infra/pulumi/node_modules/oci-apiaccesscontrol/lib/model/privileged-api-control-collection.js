...
exports.PrivilegedApiControlCollection = void 0;
const model = __importStar(require("../model"));
var PrivilegedApiControlCollection;
(function (PrivilegedApiControlCollection) {
    function getJsonObj(obj) {
        const jsonObj = Object.assign(Object.assign({}, obj), {
            "items": obj.items
                ? obj.items.map(item => {
                    return model.PrivilegedApiControlSummary.getJsonObj(item);
                })
                : undefined
        });
        return jsonObj;
    }
    PrivilegedApiControlCollection.getJsonObj = getJsonObj;
    function getDeserializedJsonObj(obj) {
        const jsonObj = Object.assign(Object.assign({}, obj), {
            "items": obj.items
                ? obj.items.map(item => {
                    return model.PrivilegedApiControlSummary.getDeserializedJsonObj(item);
                })
                : undefined
        });
        return jsonObj;
    }
    PrivilegedApiControlCollection.getDeserializedJsonObj = getDeserializedJsonObj;
})(PrivilegedApiControlCollection = exports.PrivilegedApiControlCollection || (exports.PrivilegedApiControlCollection = {}));
//# sourceMappingURL=privileged-api-control-collection.js.map
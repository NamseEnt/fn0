 ...
 **/
export declare enum PrivilegedApiRequestSeverity {
    Sev1 = "SEV_1",
    Sev2 = "SEV_2",
    Sev3 = "SEV_3",
    Sev4 = "SEV_4",
...
export declare namespace PrivilegedApiRequestSeverity {
    function getJsonObj(obj: PrivilegedApiRequestSeverity): PrivilegedApiRequestSeverity;
    function getDeserializedJsonObj(obj: PrivilegedApiRequestSeverity): PrivilegedApiRequestSeverity;
}

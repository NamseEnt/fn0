 ...
 */
export interface ChangePrivilegedApiControlCompartmentDetails {
    /**
...
export declare namespace ChangePrivilegedApiControlCompartmentDetails {
    function getJsonObj(obj: ChangePrivilegedApiControlCompartmentDetails): object;
    function getDeserializedJsonObj(obj: ChangePrivilegedApiControlCompartmentDetails): object;
}

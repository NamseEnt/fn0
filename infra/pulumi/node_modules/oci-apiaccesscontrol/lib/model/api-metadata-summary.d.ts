 ...
 */
export interface ApiMetadataSummary {
    /**
...
export declare namespace ApiMetadataSummary {
    function getJsonObj(obj: ApiMetadataSummary): object;
    function getDeserializedJsonObj(obj: ApiMetadataSummary): object;
}

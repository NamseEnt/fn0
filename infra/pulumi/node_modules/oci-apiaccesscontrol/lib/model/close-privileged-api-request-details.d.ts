 ...
 */
export interface ClosePrivilegedApiRequestDetails {
    /**
     * description about why the request is closed
     */
    "description"?: string;
}
export declare namespace ClosePrivilegedApiRequestDetails {
    function getJsonObj(obj: ClosePrivilegedApiRequestDetails): object;
    function getDeserializedJsonObj(obj: ClosePrivilegedApiRequestDetails): object;
}

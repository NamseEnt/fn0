...
import { PrivilegedApiControlClient } from "./client";
export declare class PrivilegedApiControlWaiter {
    private client;
    private readonly config?;
    constructor(client: PrivilegedApiControlClient, config?: Partial<import("oci-common/lib/waiter").WaiterConfigurationDetails> | undefined);
    /**
     ...
     */
    forPrivilegedApiControl(request: serviceRequests.GetPrivilegedApiControlRequest, ...targetStates: models.PrivilegedApiControl.LifecycleState[]): Promise<serviceResponses.GetPrivilegedApiControlResponse | null>;
}

...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/apiaccesscontrol/ListPrivilegedApiControls.ts.html |here} to see how to use ListPrivilegedApiControlsRequest.
 */
export interface ListPrivilegedApiControlsRequest extends common.BaseRequest {
    /**
...
export declare namespace ListPrivilegedApiControlsRequest {
    enum SortBy {

...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/apiaccesscontrol/DeletePrivilegedApiControl.ts.html |here} to see how to use DeletePrivilegedApiControlRequest.
 */
export interface DeletePrivilegedApiControlRequest extends common.BaseRequest {
    /**

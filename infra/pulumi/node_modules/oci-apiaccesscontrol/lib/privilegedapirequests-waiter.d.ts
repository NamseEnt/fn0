...
import { PrivilegedApiRequestsClient } from "./client";
export declare class PrivilegedApiRequestsWaiter {
    private client;
    private readonly config?;
    constructor(client: PrivilegedApiRequestsClient, config?: Partial<import("oci-common/lib/waiter").WaiterConfigurationDetails> | undefined);
    /**
     * Waits forPrivilegedApiRequest till it reaches any of the provided states
     *
     * @param request the request to send
     * @param targetStates the desired states to wait for. The waiter will return once the resource reaches any of the provided states
     * @return response returns GetPrivilegedApiRequestResponse
     */
    forPrivilegedApiRequest(request: serviceRequests.GetPrivilegedApiRequestRequest, ...targetStates: models.PrivilegedApiRequest.LifecycleState[]): Promise<serviceResponses.GetPrivilegedApiRequestResponse>;
}

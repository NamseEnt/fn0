...
exports.ApiMetadataWaiter = void 0;
const models = __importStar(require("./model"));
const oci_common_1 = require("oci-common");
class ApiMetadataWaiter {
     ...
     */
    forApiMetadata(request, ...targetStates) {
        return __awaiter(this, void 0, void 0, function* () {
            return oci_common_1.genericTerminalConditionWaiter(this.config, () => this.client.getApiMetadata(request), response => targetStates.includes(response.apiMetadata.lifecycleState), targetStates.includes(models.ApiMetadata.LifecycleState.Deleted));
        });
    }
}
exports.ApiMetadataWaiter = ApiMetadataWaiter;
//# sourceMappingURL=apimetadata-waiter.js.map
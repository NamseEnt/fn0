...
export declare namespace ScheduleSecretVersionDeletionDetails {
    function getJsonObj(obj: ScheduleSecretVersionDeletionDetails): object;
    function getDeserializedJsonObj(obj: ScheduleSecretVersionDeletionDetails): object;
}

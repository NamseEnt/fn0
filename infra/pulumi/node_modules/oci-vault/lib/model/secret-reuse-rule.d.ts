...
export declare namespace SecretReuseRule {
    function getJsonObj(obj: SecretReuseRule, isParentJsonObj?: boolean): object;
    const ruleType = "SECRET_REUSE_RULE";
    function getDeserializedJsonObj(obj: SecretReuseRule, isParentJsonObj?: boolean): object;
}

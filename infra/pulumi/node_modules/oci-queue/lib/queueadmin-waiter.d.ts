...
export declare class QueueAdminWaiter {
    private client;
     ...
     */
    forQueue(request: serviceRequests.GetQueueRequest, ...targetStates: models.Queue.LifecycleState[]): Promise<serviceResponses.GetQueueResponse | null>;
    /**

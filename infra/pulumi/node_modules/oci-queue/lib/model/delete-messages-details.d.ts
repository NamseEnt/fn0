 ...
 */
export interface DeleteMessagesDetails {
    /**
     * The array of messages to delete from a queue.
     */
    "entries": Array<model.DeleteMessagesDetailsEntry>;
}
export declare namespace DeleteMessagesDetails {
    function getJsonObj(obj: DeleteMessagesDetails): object;
    function getDeserializedJsonObj(obj: DeleteMessagesDetails): object;
}

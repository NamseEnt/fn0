...
export declare namespace CreateQueueDetails {
    function getJsonObj(obj: CreateQueueDetails): object;
    function getDeserializedJsonObj(obj: CreateQueueDetails): object;
}

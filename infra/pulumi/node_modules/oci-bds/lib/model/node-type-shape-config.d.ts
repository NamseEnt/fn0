...
export declare namespace NodeTypeShapeConfig {
    function getJsonObj(obj: NodeTypeShapeConfig): object;
    function getDeserializedJsonObj(obj: NodeTypeShapeConfig): object;
}

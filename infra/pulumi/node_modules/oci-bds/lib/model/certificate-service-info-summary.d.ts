...
export declare namespace CertificateServiceInfoSummary {
    enum Service {
        Zookeeper = "ZOOKEEPER",
        Ams = "AMS",
        Hdfs = "HDFS",
    ...
    function getJsonObj(obj: CertificateServiceInfoSummary): object;
    function getDeserializedJsonObj(obj: CertificateServiceInfoSummary): object;
}

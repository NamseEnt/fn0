...
export declare namespace MetricThresholdRule {
    enum Operator {
        Gt = "GT",
        Lt = "LT",
        /**
    ...
    function getJsonObj(obj: MetricThresholdRule): object;
    function getDeserializedJsonObj(obj: MetricThresholdRule): object;
}

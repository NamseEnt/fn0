...
export declare namespace EnableCertificateDetails {
    function getJsonObj(obj: EnableCertificateDetails): object;
    function getDeserializedJsonObj(obj: EnableCertificateDetails): object;
}

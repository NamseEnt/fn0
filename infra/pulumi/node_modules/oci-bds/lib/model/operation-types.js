...
(function (OperationTypes) {
    OperationTypes["CreateBds"] = "CREATE_BDS";
    OperationTypes["UpdateBds"] = "UPDATE_BDS";
    OperationTypes["DeleteBds"] = "DELETE_BDS";
    OperationTypes["AddBlockStorage"] = "ADD_BLOCK_STORAGE";
    OperationTypes["AddMasterNodes"] = "ADD_MASTER_NODES";
    OperationTypes["AddUtilityNodes"] = "ADD_UTILITY_NODES";
    OperationTypes["AddWorkerNodes"] = "ADD_WORKER_NODES";
    OperationTypes["AddCloudSql"] = "ADD_CLOUD_SQL";
    OperationTypes["RemoveCloudSql"] = "REMOVE_CLOUD_SQL";
    OperationTypes["ChangeCompartmentForBds"] = "CHANGE_COMPARTMENT_FOR_BDS";
    ...
    OperationTypes["RemoveNodes"] = "REMOVE_NODES";
    ...
    OperationTypes["PatchOs"] = "PATCH_OS";
    OperationTypes["StopBds"] = "STOP_BDS";
    OperationTypes["StartBds"] = "START_BDS";
    ...
    OperationTypes["CreateResourcePrincipalConfiguration"] = "CREATE_RESOURCE_PRINCIPAL_CONFIGURATION";
    OperationTypes["DeleteResourcePrincipalConfiguration"] = "DELETE_RESOURCE_PRINCIPAL_CONFIGURATION";
    OperationTypes["UpdateResourcePrincipalConfiguration"] = "UPDATE_RESOURCE_PRINCIPAL_CONFIGURATION";
    OperationTypes["RefreshResourcePrincipal"] = "REFRESH_RESOURCE_PRINCIPAL";
    OperationTypes["CreateIdentityConfig"] = "CREATE_IDENTITY_CONFIG";
    OperationTypes["DeleteIdentityConfig"] = "DELETE_IDENTITY_CONFIG";
    OperationTypes["UpdateIdentityConfig"] = "UPDATE_IDENTITY_CONFIG";
    OperationTypes["ActivateUpstConfig"] = "ACTIVATE_UPST_CONFIG";
    OperationTypes["DeactivateUpstConfig"] = "DEACTIVATE_UPST_CONFIG";
    OperationTypes["RefreshConfidentialApplication"] = "REFRESH_CONFIDENTIAL_APPLICATION";
    ...
    OperationTypes["ResetPassword"] = "RESET_PASSWORD";
    OperationTypes["GenerateCertificate"] = "GENERATE_CERTIFICATE";
    OperationTypes["RenewCertificate"] = "RENEW_CERTIFICATE";
    OperationTypes["CreateCertConfig"] = "CREATE_CERT_CONFIG";
    OperationTypes["SetDefaultCertConfig"] = "SET_DEFAULT_CERT_CONFIG";
    OperationTypes["DeleteCertConfig"] = "DELETE_CERT_CONFIG";
    /**

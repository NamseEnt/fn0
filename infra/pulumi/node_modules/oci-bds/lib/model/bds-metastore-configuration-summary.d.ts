...
export declare namespace BdsMetastoreConfigurationSummary {
    function getJsonObj(obj: BdsMetastoreConfigurationSummary): object;
    function getDeserializedJsonObj(obj: BdsMetastoreConfigurationSummary): object;
}

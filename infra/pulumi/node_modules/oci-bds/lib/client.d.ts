...
export declare class BdsClient {
     ...
     * @param request a request which can be sent to the service operation
     */
    listAllPatchHistories(request: requests.ListPatchHistoriesRequest): AsyncIterableIterator<model.PatchHistorySummary>;
    /**
     ...
     * @param request a request which can be sent to the service operation
     */
    listAllPatchHistoriesResponses(request: requests.ListPatchHistoriesRequest): AsyncIterableIterator<responses.ListPatchHistoriesResponse>;
    /**
     * Creates a new async iterator which will iterate over the models.PatchHistorySummary objects
     * contained in responses from the listPatchHistories operation. This iterator will fetch more data from the
     * server as needed.
     ...
     * @param request a request which can be sent to the service operation
     */
    listPatchHistoriesRecordIterator(request: requests.ListPatchHistoriesRequest): AsyncIterableIterator<model.PatchHistorySummary>;
    /**
     * Creates a new async iterator which will iterate over the responses received from the listPatchHistories operation. This iterator
     * will fetch more data from the server as needed.
     *
     * @param request a request which can be sent to the service operation
     */
    listPatchHistoriesResponseIterator(request: requests.ListPatchHistoriesRequest): AsyncIterableIterator<responses.ListPatchHistoriesResponse>;
    /**
     ...
     * @param request a request which can be sent to the service operation
     */
    listAllPatches(request: requests.ListPatchesRequest): AsyncIterableIterator<model.PatchSummary>;
    /**
     ...
     * @param request a request which can be sent to the service operation
     */
    listAllPatchesResponses(request: requests.ListPatchesRequest): AsyncIterableIterator<responses.ListPatchesResponse>;
    /**
     * Creates a new async iterator which will iterate over the models.PatchSummary objects
     * contained in responses from the listPatches operation. This iterator will fetch more data from the
     * server as needed.
     ...
     * @param request a request which can be sent to the service operation
     */
    listPatchesRecordIterator(request: requests.ListPatchesRequest): AsyncIterableIterator<model.PatchSummary>;
    /**
     * Creates a new async iterator which will iterate over the responses received from the listPatches operation. This iterator
     * will fetch more data from the server as needed.
     *

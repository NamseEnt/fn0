...
export declare namespace SubscriptionToken {
    function getJsonObj(obj: SubscriptionToken): object;
    function getDeserializedJsonObj(obj: SubscriptionToken): object;
}

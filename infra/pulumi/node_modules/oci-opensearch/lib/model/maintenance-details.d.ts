...
export declare namespace MaintenanceDetails {
    function getJsonObj(obj: MaintenanceDetails): object;
    function getDeserializedJsonObj(obj: MaintenanceDetails): object;
}

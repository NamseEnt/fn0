...
export declare namespace BackupEventDetails {
    function getJsonObj(obj: BackupEventDetails): object;
    function getDeserializedJsonObj(obj: BackupEventDetails): object;
}

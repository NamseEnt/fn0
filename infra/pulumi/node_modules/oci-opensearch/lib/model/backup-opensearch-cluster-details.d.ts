...
export declare namespace BackupOpensearchClusterDetails {
    function getJsonObj(obj: BackupOpensearchClusterDetails): object;
    function getDeserializedJsonObj(obj: BackupOpensearchClusterDetails): object;
}

...
export declare namespace CreateOpensearchClusterDetails {
    function getJsonObj(obj: CreateOpensearchClusterDetails): object;
    function getDeserializedJsonObj(obj: CreateOpensearchClusterDetails): object;
}

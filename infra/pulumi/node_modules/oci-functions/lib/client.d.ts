...
export declare class FunctionsManagementClient {
     ...
     * @param request a request which can be sent to the service operation
     */
    listAllFunctions(request: requests.ListFunctionsRequest): AsyncIterableIterator<model.FunctionSummary>;
    /**
     ...
     * @param request a request which can be sent to the service operation
     */
    listFunctionsRecordIterator(request: requests.ListFunctionsRequest): AsyncIterableIterator<model.FunctionSummary>;
    /**
     * Creates a new async iterator which will iterate over the responses received from the listFunctions operation. This iterator
     * will fetch more data from the server as needed.
     *

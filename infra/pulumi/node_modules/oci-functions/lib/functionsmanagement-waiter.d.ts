...
export declare class FunctionsManagementWaiter {
    private client;
    private readonly config?;
    constructor(client: FunctionsManagementClient, config?: Partial<import("oci-common/lib/waiter").WaiterConfigurationDetails> | undefined);
    /**
     ...
     */
    forFunction(request: serviceRequests.GetFunctionRequest, ...targetStates: models.Function.LifecycleState[]): Promise<serviceResponses.GetFunctionResponse | null>;
    /**
     ...
     */
    forPbfListing(request: serviceRequests.GetPbfListingRequest, ...targetStates: models.PbfListing.LifecycleState[]): Promise<serviceResponses.GetPbfListingResponse | null>;
    /**
     ...
     */
    forPbfListingVersion(request: serviceRequests.GetPbfListingVersionRequest, ...targetStates: models.PbfListingVersion.LifecycleState[]): Promise<serviceResponses.GetPbfListingVersionResponse | null>;
}

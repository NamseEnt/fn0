...
export declare namespace ApplicationTraceConfig {
    function getJsonObj(obj: ApplicationTraceConfig): object;
    function getDeserializedJsonObj(obj: ApplicationTraceConfig): object;
}

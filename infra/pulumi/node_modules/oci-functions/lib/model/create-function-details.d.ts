...
export declare namespace CreateFunctionDetails {
    function getJsonObj(obj: CreateFunctionDetails): object;
    function getDeserializedJsonObj(obj: CreateFunctionDetails): object;
}

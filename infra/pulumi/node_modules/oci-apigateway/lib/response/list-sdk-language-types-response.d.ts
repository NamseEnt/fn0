...
export interface ListSdkLanguageTypesResponse {
    /**
    ...
    "opcPrevPage": string;
    /**
     * The returned model.SdkLanguageTypeCollection instance.
     */
    "sdkLanguageTypeCollection": model.SdkLanguageTypeCollection;
}

...
export declare namespace ApiSpecificationRouteResponsePolicies {
    function getJsonObj(obj: ApiSpecificationRouteResponsePolicies): object;
    function getDeserializedJsonObj(obj: ApiSpecificationRouteResponsePolicies): object;
}

...
export declare namespace RouteAuthorizationPolicy {
    function getJsonObj(obj: RouteAuthorizationPolicy): object;
    function getDeserializedJsonObj(obj: RouteAuthorizationPolicy): object;
}

...
export declare namespace HeaderValidationItem {
    function getJsonObj(obj: HeaderValidationItem): object;
    function getDeserializedJsonObj(obj: HeaderValidationItem): object;
}

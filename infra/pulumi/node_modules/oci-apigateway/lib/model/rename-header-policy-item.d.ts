...
export declare namespace RenameHeaderPolicyItem {
    function getJsonObj(obj: RenameHeaderPolicyItem): object;
    function getDeserializedJsonObj(obj: RenameHeaderPolicyItem): object;
}

...
export declare namespace NoCache {
    function getJsonObj(obj: NoCache, isParentJsonObj?: boolean): object;
    const type = "NONE";
    function getDeserializedJsonObj(obj: NoCache, isParentJsonObj?: boolean): object;
}

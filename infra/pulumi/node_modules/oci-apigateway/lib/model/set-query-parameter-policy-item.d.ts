...
export declare namespace SetQueryParameterPolicyItem {
    enum IfExists {
        Overwrite = "OVERWRITE",
        Append = "APPEND",
        Skip = "SKIP",
    ...
    function getJsonObj(obj: SetQueryParameterPolicyItem): object;
    function getDeserializedJsonObj(obj: SetQueryParameterPolicyItem): object;
}

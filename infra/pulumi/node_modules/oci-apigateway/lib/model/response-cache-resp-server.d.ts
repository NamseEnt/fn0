...
export declare namespace ResponseCacheRespServer {
    function getJsonObj(obj: ResponseCacheRespServer): object;
    function getDeserializedJsonObj(obj: ResponseCacheRespServer): object;
}

 ...
 */
export interface CreateSdkDetails {
    /**
...
export declare namespace CreateSdkDetails {
    function getJsonObj(obj: CreateSdkDetails): object;
    function getDeserializedJsonObj(obj: CreateSdkDetails): object;
}

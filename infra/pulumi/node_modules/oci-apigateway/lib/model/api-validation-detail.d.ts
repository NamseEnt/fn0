...
export interface ApiValidationDetail {
     ...
     */
    "severity"?: ApiValidationDetail.Severity;
    /**
     * Position of the issue in the specification file (line, column).
     */
    "src"?: Array<Array<number>>;
}
export declare namespace ApiValidationDetail {
    enum Severity {
        Info = "INFO",
        Warning = "WARNING",
        Error = "ERROR",
    ...
    function getJsonObj(obj: ApiValidationDetail): object;
    function getDeserializedJsonObj(obj: ApiValidationDetail): object;
}

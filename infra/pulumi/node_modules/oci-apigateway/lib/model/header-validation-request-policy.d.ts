...
export declare namespace HeaderValidationRequestPolicy {
    enum ValidationMode {
        Enforcing = "ENFORCING",
    ...
    function getJsonObj(obj: HeaderValidationRequestPolicy): object;
    function getDeserializedJsonObj(obj: HeaderValidationRequestPolicy): object;
}

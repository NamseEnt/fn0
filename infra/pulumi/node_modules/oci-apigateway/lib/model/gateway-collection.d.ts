...
export declare namespace GatewayCollection {
    function getJsonObj(obj: GatewayCollection): object;
    function getDeserializedJsonObj(obj: GatewayCollection): object;
}

...
exports.ResponseCacheDetails = void 0;
const model = __importStar(require("../model"));
const common = require("oci-common");
var ResponseCacheDetails;
(function (ResponseCacheDetails) {
    function getJsonObj(obj) {
        ...
        if (obj && "type" in obj && obj.type) {
            switch (obj.type) {
                ...
                case "NONE":
                    return model.NoCache.getJsonObj(jsonObj, true);
                default:
    ...
    function getDeserializedJsonObj(obj) {
        ...
        if (obj && "type" in obj && obj.type) {
            switch (obj.type) {
                ...
                case "NONE":
                    return model.NoCache.getDeserializedJsonObj(jsonObj, true);
                default:
                    if (common.LOG.logger)
                        common.LOG.logger.info(`Unknown value for: ${obj.type}`);
            }
    ...
    ResponseCacheDetails.getDeserializedJsonObj = getDeserializedJsonObj;
})(ResponseCacheDetails = exports.ResponseCacheDetails || (exports.ResponseCacheDetails = {}));
//# sourceMappingURL=response-cache-details.js.map
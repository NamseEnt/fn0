 ...
 *
 */
export interface FilterHeaderPolicy {
    /**
     ...
     *
     */
    "type": FilterHeaderPolicy.Type;
    /**
     * The list of headers.
     *
     */
    "items": Array<model.FilterHeaderPolicyItem>;
}
export declare namespace FilterHeaderPolicy {
    enum Type {
        Allow = "ALLOW",
        Block = "BLOCK",
        /**
    ...
    function getJsonObj(obj: FilterHeaderPolicy): object;
    function getDeserializedJsonObj(obj: FilterHeaderPolicy): object;
}

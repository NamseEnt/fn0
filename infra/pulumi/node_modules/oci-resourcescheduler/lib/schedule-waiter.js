...
class ScheduleWaiter {
    ...
    forSchedule(request, ...targetStates) {
        return __awaiter(this, void 0, void 0, function* () {
            return oci_common_1.genericTerminalConditionWaiter(this.config, () => this.client.getSchedule(request), response => targetStates.includes(response.schedule.lifecycleState), targetStates.includes(models.Schedule.LifecycleState.Deleted));
        });
    }
    /**
...
exports.ScheduleWaiter = ScheduleWaiter;
//# sourceMappingURL=schedule-waiter.js.map
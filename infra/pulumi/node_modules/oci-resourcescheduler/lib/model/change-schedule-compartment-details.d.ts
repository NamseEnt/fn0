...
export declare namespace ChangeScheduleCompartmentDetails {
    function getJsonObj(obj: ChangeScheduleCompartmentDetails): object;
    function getDeserializedJsonObj(obj: ChangeScheduleCompartmentDetails): object;
}

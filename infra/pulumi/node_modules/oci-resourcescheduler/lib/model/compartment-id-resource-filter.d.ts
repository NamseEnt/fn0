...
export declare namespace CompartmentIdResourceFilter {
    function getJsonObj(obj: CompartmentIdResourceFilter, isParentJsonObj?: boolean): object;
    const attribute = "COMPARTMENT_ID";
    function getDeserializedJsonObj(obj: CompartmentIdResourceFilter, isParentJsonObj?: boolean): object;
}

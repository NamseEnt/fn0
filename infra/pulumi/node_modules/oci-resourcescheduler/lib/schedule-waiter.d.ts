...
export declare class ScheduleWaiter {
    private client;
    private readonly config?;
    constructor(client: ScheduleClient, config?: Partial<import("oci-common/lib/waiter").WaiterConfigurationDetails> | undefined);
    /**
     ...
     */
    forSchedule(request: serviceRequests.GetScheduleRequest, ...targetStates: models.Schedule.LifecycleState[]): Promise<serviceResponses.GetScheduleResponse | null>;
    /**

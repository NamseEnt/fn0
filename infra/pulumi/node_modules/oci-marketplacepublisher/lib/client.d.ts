...
export declare class MarketplacePublisherClient {
  ...
  *
     ...
     */
    getLead(getLeadRequest: requests.GetLeadRequest): Promise<responses.GetLeadResponse>;
    /**
     ...
     */
    getListingRevisionAttachmentContent(getListingRevisionAttachmentContentRequest: requests.GetListingRevisionAttachmentContentRequest): Promise<responses.GetListingRevisionAttachmentContentResponse>;
    /**
     ...
     */
    getListingRevisionIconContent(getListingRevisionIconContentRequest: requests.GetListingRevisionIconContentRequest): Promise<responses.GetListingRevisionIconContentResponse>;
    /**
     ...
     */
    getSupportDoc(getSupportDocRequest: requests.GetSupportDocRequest): Promise<responses.GetSupportDocResponse>;
    /**
     ...
     */
    getSupportDocContent(getSupportDocContentRequest: requests.GetSupportDocContentRequest): Promise<responses.GetSupportDocContentResponse>;
    /**
     ...
     */
    getTermVersionContent(getTermVersionContentRequest: requests.GetTermVersionContentRequest): Promise<responses.GetTermVersionContentResponse>;
    /**
     ...
     */
    listAvailableServices(listAvailableServicesRequest: requests.ListAvailableServicesRequest): Promise<responses.ListAvailableServicesResponse>;
    /**
     ...
     */
    listCustomerInstanceReportRecords(listCustomerInstanceReportRecordsRequest: requests.ListCustomerInstanceReportRecordsRequest): Promise<responses.ListCustomerInstanceReportRecordsResponse>;
    /**
     ...
     */
    listDisbursementReportRecords(listDisbursementReportRecordsRequest: requests.ListDisbursementReportRecordsRequest): Promise<responses.ListDisbursementReportRecordsResponse>;
    /**
     ...
     */
    listLeads(listLeadsRequest: requests.ListLeadsRequest): Promise<responses.ListLeadsResponse>;
    /**
  ...
  *
     ...
     */
    listSupportDocs(listSupportDocsRequest: requests.ListSupportDocsRequest): Promise<responses.ListSupportDocsResponse>;
    /**
     ...
     */
    listSupportedCurrencies(listSupportedCurrenciesRequest: requests.ListSupportedCurrenciesRequest): Promise<responses.ListSupportedCurrenciesResponse>;
    /**
     ...
     */
    listSupportedShapes(listSupportedShapesRequest: requests.ListSupportedShapesRequest): Promise<responses.ListSupportedShapesResponse>;
    /**
     ...
     */
    updateListingRevisionNote(updateListingRevisionNoteRequest: requests.UpdateListingRevisionNoteRequest): Promise<responses.UpdateListingRevisionNoteResponse>;
    /**

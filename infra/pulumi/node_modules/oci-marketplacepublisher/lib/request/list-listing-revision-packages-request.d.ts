...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/marketplacepublisher/ListListingRevisionPackages.ts.html |here} to see how to use ListListingRevisionPackagesRequest.
 */
...
export declare namespace ListListingRevisionPackagesRequest {
    enum SortBy {

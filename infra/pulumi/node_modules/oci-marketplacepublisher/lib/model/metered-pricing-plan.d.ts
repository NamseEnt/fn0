...
export declare namespace MeteredPricingPlan {
    enum Name {
    ...
    function getJsonObj(obj: MeteredPricingPlan, isParentJsonObj?: boolean): object;
    const planType = "METERED";
    function getDeserializedJsonObj(obj: MeteredPricingPlan, isParentJsonObj?: boolean): object;
}

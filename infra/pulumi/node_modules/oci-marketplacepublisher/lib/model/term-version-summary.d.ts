...
export declare namespace TermVersionSummary {
    function getJsonObj(obj: TermVersionSummary): object;
    function getDeserializedJsonObj(obj: TermVersionSummary): object;
}

...
export declare namespace ListingRevisionSummary {
    function getJsonObj(obj: ListingRevisionSummary): object;
    function getDeserializedJsonObj(obj: ListingRevisionSummary): object;
}

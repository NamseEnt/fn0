...
export declare namespace CreateListingRevisionPackageDetails {
    function getJsonObj(obj: CreateListingRevisionPackageDetails): object;
    function getDeserializedJsonObj(obj: CreateListingRevisionPackageDetails): object;
}

...
export declare namespace PublicationStatus {
    function getJsonObj(obj: PublicationStatus): PublicationStatus;
    function getDeserializedJsonObj(obj: PublicationStatus): PublicationStatus;
}

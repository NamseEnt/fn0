...
export declare namespace ListingRevisionNote {
    enum NoteSource {
        Publisher = "PUBLISHER",
    ...
    function getJsonObj(obj: ListingRevisionNote): object;
    function getDeserializedJsonObj(obj: ListingRevisionNote): object;
}

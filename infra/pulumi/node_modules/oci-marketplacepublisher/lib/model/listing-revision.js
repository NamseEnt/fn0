...
(function (ListingRevision) {
    ...
    function getJsonObj(obj) {
        ...
        if (obj && "listingType" in obj && obj.listingType) {
            switch (obj.listingType) {
                case "SERVICE":
                    return model.ServiceListingRevision.getJsonObj(jsonObj, true);
                case "LEAD_GENERATION":
                    return model.LeadGenListingRevision.getJsonObj(jsonObj, true);
                case "OCI_APPLICATION":
                    return model.OciListingRevision.getJsonObj(jsonObj, true);
                default:
    ...
    function getDeserializedJsonObj(obj) {
        ...
        if (obj && "listingType" in obj && obj.listingType) {
            switch (obj.listingType) {
                case "SERVICE":
                    return model.ServiceListingRevision.getDeserializedJsonObj(jsonObj, true);
                case "LEAD_GENERATION":
                    return model.LeadGenListingRevision.getDeserializedJsonObj(jsonObj, true);
                case "OCI_APPLICATION":
                    return model.OciListingRevision.getDeserializedJsonObj(jsonObj, true);
                default:
                    if (common.LOG.logger)
                        common.LOG.logger.info(`Unknown value for: ${obj.listingType}`);
            }

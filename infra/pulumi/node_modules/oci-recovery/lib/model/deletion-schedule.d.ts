 ...
 *
 **/
export declare enum DeletionSchedule {
    DeleteAfterRetentionPeriod = "DELETE_AFTER_RETENTION_PERIOD",
    DeleteAfter72Hours = "DELETE_AFTER_72_HOURS"
}
export declare namespace DeletionSchedule {
    function getJsonObj(obj: DeletionSchedule): DeletionSchedule;
    function getDeserializedJsonObj(obj: DeletionSchedule): DeletionSchedule;
}

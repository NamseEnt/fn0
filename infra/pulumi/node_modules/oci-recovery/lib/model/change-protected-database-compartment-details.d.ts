...
export declare namespace ChangeProtectedDatabaseCompartmentDetails {
    function getJsonObj(obj: ChangeProtectedDatabaseCompartmentDetails): object;
    function getDeserializedJsonObj(obj: ChangeProtectedDatabaseCompartmentDetails): object;
}

...
export declare namespace GenerateUserSecurityTokenDetails {
    function getJsonObj(obj: GenerateUserSecurityTokenDetails): object;
    function getDeserializedJsonObj(obj: GenerateUserSecurityTokenDetails): object;
}

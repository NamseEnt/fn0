...
export declare class OrganizationSubscriptionClient {
     ...
     */
    listAllOrganizationSubscriptions(request: requests.ListOrganizationSubscriptionsRequest): AsyncIterableIterator<model.SubscriptionSummary>;
    /**
     ...
     * @param request a request which can be sent to the service operation
     */
    listOrganizationSubscriptionsRecordIterator(request: requests.ListOrganizationSubscriptionsRequest): AsyncIterableIterator<model.SubscriptionSummary>;
    /**
     * Creates a new async iterator which will iterate over the responses received from the listOrganizationSubscriptions operation. This iterator
     * will fetch more data from the server as needed.
     *

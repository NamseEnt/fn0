...
exports.DashboardWaiter = void 0;
const models = __importStar(require("./model"));
const oci_common_1 = require("oci-common");
class DashboardWaiter {
     ...
     */
    forDashboard(request, ...targetStates) {
        return __awaiter(this, void 0, void 0, function* () {
            return oci_common_1.genericTerminalConditionWaiter(this.config, () => this.client.getDashboard(request), response => targetStates.includes(response.dashboard.lifecycleState), targetStates.includes(models.Dashboard.LifecycleState.Deleted));
        });
    }
}
exports.DashboardWaiter = DashboardWaiter;
//# sourceMappingURL=dashboard-waiter.js.map
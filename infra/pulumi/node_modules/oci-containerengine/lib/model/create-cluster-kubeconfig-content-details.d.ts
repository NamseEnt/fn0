...
export declare namespace CreateClusterKubeconfigContentDetails {
    enum Endpoint {
    ...
    function getJsonObj(obj: CreateClusterKubeconfigContentDetails): object;
    function getDeserializedJsonObj(obj: CreateClusterKubeconfigContentDetails): object;
}

 ...
 */
export interface UpdateVirtualNodePoolDetails {
    /**
...
export declare namespace UpdateVirtualNodePoolDetails {
    function getJsonObj(obj: UpdateVirtualNodePoolDetails): object;
    function getDeserializedJsonObj(obj: UpdateVirtualNodePoolDetails): object;
}

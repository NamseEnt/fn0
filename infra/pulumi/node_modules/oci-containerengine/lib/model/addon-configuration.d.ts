...
export declare namespace AddonConfiguration {
    function getJsonObj(obj: AddonConfiguration): object;
    function getDeserializedJsonObj(obj: AddonConfiguration): object;
}

...
export declare namespace ClusterMigrateToNativeVcnDetails {
    function getJsonObj(obj: ClusterMigrateToNativeVcnDetails): object;
    function getDeserializedJsonObj(obj: ClusterMigrateToNativeVcnDetails): object;
}

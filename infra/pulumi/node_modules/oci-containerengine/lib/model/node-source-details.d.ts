...
export declare namespace NodeSourceDetails {
    function getJsonObj(obj: NodeSourceDetails): object;
    function getDeserializedJsonObj(obj: NodeSourceDetails): object;
}

...
export declare namespace ClusterEndpointConfig {
    function getJsonObj(obj: ClusterEndpointConfig): object;
    function getDeserializedJsonObj(obj: ClusterEndpointConfig): object;
}

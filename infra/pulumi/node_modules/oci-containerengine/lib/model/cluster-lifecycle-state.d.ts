 ...
 **/
export declare enum ClusterLifecycleState {
    Creating = "CREATING",
    Active = "ACTIVE",
    Failed = "FAILED",
    Deleting = "DELETING",
...
export declare namespace ClusterLifecycleState {
    function getJsonObj(obj: ClusterLifecycleState): ClusterLifecycleState;
    function getDeserializedJsonObj(obj: ClusterLifecycleState): ClusterLifecycleState;
}

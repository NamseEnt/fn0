...
export declare namespace ClusterCreateOptions {
    enum IpFamilies {
        IPv4 = "IPv4",
        IPv6 = "IPv6",
        /**
    ...
    function getJsonObj(obj: ClusterCreateOptions): object;
    function getDeserializedJsonObj(obj: ClusterCreateOptions): object;
}

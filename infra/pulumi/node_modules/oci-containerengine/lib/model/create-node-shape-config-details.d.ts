 ...
 */
export interface CreateNodeShapeConfigDetails {
    /**
...
export declare namespace CreateNodeShapeConfigDetails {
    function getJsonObj(obj: CreateNodeShapeConfigDetails): object;
    function getDeserializedJsonObj(obj: CreateNodeShapeConfigDetails): object;
}

...
export declare namespace PublicApiEndpointDecommissionStatus {
    enum Status {
        Pending = "PENDING",
    ...
    function getJsonObj(obj: PublicApiEndpointDecommissionStatus): object;
    function getDeserializedJsonObj(obj: PublicApiEndpointDecommissionStatus): object;
}

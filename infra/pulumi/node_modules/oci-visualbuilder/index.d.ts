...
import * as vbinstance_waiter from "./lib/vbinstance-waiter";
export { models };
export { requests };
export { responses };
export import VbInstanceClient = client.VbInstanceClient;
export import VbInstanceWaiter = vbinstance_waiter.VbInstanceWaiter;

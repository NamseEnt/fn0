...
export declare class VbInstanceWaiter {
    private client;
    private readonly config?;
    constructor(client: VbInstanceClient, config?: Partial<import("oci-common/lib/waiter").WaiterConfigurationDetails> | undefined);
    /**
     ...
     */
    forVbInstance(request: serviceRequests.GetVbInstanceRequest, ...targetStates: models.VbInstance.LifecycleState[]): Promise<serviceResponses.GetVbInstanceResponse | null>;
    /**

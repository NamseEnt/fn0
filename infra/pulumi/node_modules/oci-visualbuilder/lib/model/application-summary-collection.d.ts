...
export declare namespace ApplicationSummaryCollection {
    function getJsonObj(obj: ApplicationSummaryCollection): object;
    function getDeserializedJsonObj(obj: ApplicationSummaryCollection): object;
}

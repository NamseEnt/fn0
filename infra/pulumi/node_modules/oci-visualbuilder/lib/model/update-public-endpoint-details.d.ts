 ...
 *
 */
export interface UpdatePublicEndpointDetails extends model.UpdateNetworkEndpointDetails {
    /**
...
export declare namespace UpdatePublicEndpointDetails {
    function getJsonObj(obj: UpdatePublicEndpointDetails, isParentJsonObj?: boolean): object;
    const networkEndpointType = "PUBLIC";
    function getDeserializedJsonObj(obj: UpdatePublicEndpointDetails, isParentJsonObj?: boolean): object;
}

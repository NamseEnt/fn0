...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/visualbuilder/ListVbInstances.ts.html |here} to see how to use ListVbInstancesRequest.
 */
export interface ListVbInstancesRequest extends common.BaseRequest {
    /**
...
export declare namespace ListVbInstancesRequest {
    enum LifecycleState {
        Creating = "CREATING",
        Updating = "UPDATING",
        Active = "ACTIVE",

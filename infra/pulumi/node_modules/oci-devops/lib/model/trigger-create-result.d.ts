...
export declare namespace TriggerCreateResult {
    function getJsonObj(obj: TriggerCreateResult): object;
    function getDeserializedJsonObj(obj: TriggerCreateResult): object;
}

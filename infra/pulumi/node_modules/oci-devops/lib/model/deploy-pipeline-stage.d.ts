...
export declare namespace DeployPipelineStage {
    function getJsonObj(obj: DeployPipelineStage): object;
    function getDeserializedJsonObj(obj: DeployPipelineStage): object;
}

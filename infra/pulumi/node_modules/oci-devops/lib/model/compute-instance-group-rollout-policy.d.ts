...
export declare namespace ComputeInstanceGroupRolloutPolicy {
    function getJsonObj(obj: ComputeInstanceGroupRolloutPolicy): object;
    function getDeserializedJsonObj(obj: ComputeInstanceGroupRolloutPolicy): object;
}

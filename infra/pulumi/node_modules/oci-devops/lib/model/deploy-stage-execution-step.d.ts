...
export declare namespace DeployStageExecutionStep {
    enum State {
        Waiting = "WAITING",
    ...
    function getJsonObj(obj: DeployStageExecutionStep): object;
    function getDeserializedJsonObj(obj: DeployStageExecutionStep): object;
}

...
export declare namespace UpdateGithubAccessTokenConnectionDetails {
    function getJsonObj(obj: UpdateGithubAccessTokenConnectionDetails, isParentJsonObj?: boolean): object;
    const connectionType = "GITHUB_ACCESS_TOKEN";
    function getDeserializedJsonObj(obj: UpdateGithubAccessTokenConnectionDetails, isParentJsonObj?: boolean): object;
}

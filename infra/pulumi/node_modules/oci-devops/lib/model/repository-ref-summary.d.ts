...
export declare namespace RepositoryRefSummary {
    function getJsonObj(obj: RepositoryRefSummary): object;
    function getDeserializedJsonObj(obj: RepositoryRefSummary): object;
}

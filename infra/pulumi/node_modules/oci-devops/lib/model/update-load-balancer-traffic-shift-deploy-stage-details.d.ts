 ...
 */
export interface UpdateLoadBalancerTrafficShiftDeployStageDetails extends model.UpdateDeployStageDetails {
...
export declare namespace UpdateLoadBalancerTrafficShiftDeployStageDetails {
    function getJsonObj(obj: UpdateLoadBalancerTrafficShiftDeployStageDetails, isParentJsonObj?: boolean): object;
    const deployStageType = "LOAD_BALANCER_TRAFFIC_SHIFT";
    function getDeserializedJsonObj(obj: UpdateLoadBalancerTrafficShiftDeployStageDetails, isParentJsonObj?: boolean): object;
}

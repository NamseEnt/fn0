 ...
 */
export interface UpdateComputeInstanceGroupBlueGreenDeployStageDetails extends model.UpdateDeployStageDetails {
    /**
...
export declare namespace UpdateComputeInstanceGroupBlueGreenDeployStageDetails {
    function getJsonObj(obj: UpdateComputeInstanceGroupBlueGreenDeployStageDetails, isParentJsonObj?: boolean): object;
    const deployStageType = "COMPUTE_INSTANCE_GROUP_BLUE_GREEN_DEPLOYMENT";
    function getDeserializedJsonObj(obj: UpdateComputeInstanceGroupBlueGreenDeployStageDetails, isParentJsonObj?: boolean): object;
}

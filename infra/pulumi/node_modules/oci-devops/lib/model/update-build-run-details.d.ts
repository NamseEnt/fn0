 ...
 */
export interface UpdateBuildRunDetails {
    /**
...
export declare namespace UpdateBuildRunDetails {
    function getJsonObj(obj: UpdateBuildRunDetails): object;
    function getDeserializedJsonObj(obj: UpdateBuildRunDetails): object;
}

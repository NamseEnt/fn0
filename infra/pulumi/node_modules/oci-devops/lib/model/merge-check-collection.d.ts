...
export declare namespace MergeCheckCollection {
    function getJsonObj(obj: MergeCheckCollection): object;
    function getDeserializedJsonObj(obj: MergeCheckCollection): object;
}

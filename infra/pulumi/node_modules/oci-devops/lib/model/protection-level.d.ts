...
export declare namespace ProtectionLevel {
    function getJsonObj(obj: ProtectionLevel): ProtectionLevel;
    function getDeserializedJsonObj(obj: ProtectionLevel): ProtectionLevel;
}

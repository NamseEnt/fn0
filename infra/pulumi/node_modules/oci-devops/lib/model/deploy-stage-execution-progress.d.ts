...
export declare namespace DeployStageExecutionProgress {
    enum Status {
        Accepted = "ACCEPTED",
    ...
    function getJsonObj(obj: DeployStageExecutionProgress): object;
    function getDeserializedJsonObj(obj: DeployStageExecutionProgress): object;
}

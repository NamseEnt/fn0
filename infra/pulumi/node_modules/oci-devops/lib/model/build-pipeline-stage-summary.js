...
(function (BuildPipelineStageSummary) {
    function getJsonObj(obj) {
        ...
        if (obj && "buildPipelineStageType" in obj && obj.buildPipelineStageType) {
            switch (obj.buildPipelineStageType) {
                case "WAIT":
                    return model.WaitStageSummary.getJsonObj(jsonObj, true);
                case "BUILD":
                    return model.BuildStageSummary.getJsonObj(jsonObj, true);
                case "DELIVER_ARTIFACT":
                    return model.DeliverArtifactStageSummary.getJsonObj(jsonObj, true);
    ...
    BuildPipelineStageSummary.getJsonObj = getJsonObj;
    function getDeserializedJsonObj(obj) {
        ...
        if (obj && "buildPipelineStageType" in obj && obj.buildPipelineStageType) {
            switch (obj.buildPipelineStageType) {
                case "WAIT":
                    return model.WaitStageSummary.getDeserializedJsonObj(jsonObj, true);
                case "BUILD":
                    return model.BuildStageSummary.getDeserializedJsonObj(jsonObj, true);
                case "DELIVER_ARTIFACT":
                    return model.DeliverArtifactStageSummary.getDeserializedJsonObj(jsonObj, true);
                case "TRIGGER_DEPLOYMENT_PIPELINE":
    ...
    BuildPipelineStageSummary.getDeserializedJsonObj = getDeserializedJsonObj;
})(BuildPipelineStageSummary = exports.BuildPipelineStageSummary || (exports.BuildPipelineStageSummary = {}));
//# sourceMappingURL=build-pipeline-stage-summary.js.map
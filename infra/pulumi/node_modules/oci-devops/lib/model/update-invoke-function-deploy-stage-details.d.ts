 ...
 */
export interface UpdateInvokeFunctionDeployStageDetails extends model.UpdateDeployStageDetails {
    /**
...
export declare namespace UpdateInvokeFunctionDeployStageDetails {
    function getJsonObj(obj: UpdateInvokeFunctionDeployStageDetails, isParentJsonObj?: boolean): object;
    const deployStageType = "INVOKE_FUNCTION";
    function getDeserializedJsonObj(obj: UpdateInvokeFunctionDeployStageDetails, isParentJsonObj?: boolean): object;
}

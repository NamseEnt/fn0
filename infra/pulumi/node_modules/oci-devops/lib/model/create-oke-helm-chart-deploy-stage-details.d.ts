...
export interface CreateOkeHelmChartDeployStageDetails extends model.CreateDeployStageDetails {
    ...
    "namespace"?: string;
    /**
     * Time to wait for execution of a helm stage. Defaults to 300 seconds. Maximum allowed is 10800 seconds (3 hours). Note: Numbers greater than Number.MAX_SAFE_INTEGER will result in rounding issues.
     */
...
export declare namespace CreateOkeHelmChartDeployStageDetails {
    enum Purpose {
        ExecuteHelmUpgrade = "EXECUTE_HELM_UPGRADE",
        ExecuteHelmCommand = "EXECUTE_HELM_COMMAND"
    }
    function getJsonObj(obj: CreateOkeHelmChartDeployStageDetails, isParentJsonObj?: boolean): object;
    const deployStageType = "OKE_HELM_CHART_DEPLOYMENT";
    function getDeserializedJsonObj(obj: CreateOkeHelmChartDeployStageDetails, isParentJsonObj?: boolean): object;
}

 ...
 */
export interface CreateComputeInstanceGroupDeployStageDetails extends model.CreateDeployStageDetails {
    /**
...
export declare namespace CreateComputeInstanceGroupDeployStageDetails {
    function getJsonObj(obj: CreateComputeInstanceGroupDeployStageDetails, isParentJsonObj?: boolean): object;
    const deployStageType = "COMPUTE_INSTANCE_GROUP_ROLLING_DEPLOYMENT";
    function getDeserializedJsonObj(obj: CreateComputeInstanceGroupDeployStageDetails, isParentJsonObj?: boolean): object;
}

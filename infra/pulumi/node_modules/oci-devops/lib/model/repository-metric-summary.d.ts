...
export declare namespace RepositoryMetricSummary {
    function getJsonObj(obj: RepositoryMetricSummary): object;
    function getDeserializedJsonObj(obj: RepositoryMetricSummary): object;
}

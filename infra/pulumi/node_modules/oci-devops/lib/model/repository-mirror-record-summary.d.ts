...
export declare namespace RepositoryMirrorRecordSummary {
    enum MirrorStatus {
        None = "NONE",
        Queued = "QUEUED",
        Running = "RUNNING",
    ...
    function getJsonObj(obj: RepositoryMirrorRecordSummary): object;
    function getDeserializedJsonObj(obj: RepositoryMirrorRecordSummary): object;
}

...
export declare namespace GitlabServerAccessTokenConnectionSummary {
    function getJsonObj(obj: GitlabServerAccessTokenConnectionSummary, isParentJsonObj?: boolean): object;
    const connectionType = "GITLAB_SERVER_ACCESS_TOKEN";
    function getDeserializedJsonObj(obj: GitlabServerAccessTokenConnectionSummary, isParentJsonObj?: boolean): object;
}

...
export declare namespace BackendSetIpCollection {
    function getJsonObj(obj: BackendSetIpCollection): object;
    function getDeserializedJsonObj(obj: BackendSetIpCollection): object;
}

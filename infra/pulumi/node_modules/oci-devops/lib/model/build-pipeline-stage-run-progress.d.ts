...
export declare namespace BuildPipelineStageRunProgress {
    enum Status {
        Accepted = "ACCEPTED",
    ...
    function getJsonObj(obj: BuildPipelineStageRunProgress): object;
    function getDeserializedJsonObj(obj: BuildPipelineStageRunProgress): object;
}

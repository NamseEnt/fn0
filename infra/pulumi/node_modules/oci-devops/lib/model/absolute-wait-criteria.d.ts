...
export declare namespace AbsoluteWaitCriteria {
    function getJsonObj(obj: AbsoluteWaitCriteria, isParentJsonObj?: boolean): object;
    const waitType = "ABSOLUTE_WAIT";
    function getDeserializedJsonObj(obj: AbsoluteWaitCriteria, isParentJsonObj?: boolean): object;
}

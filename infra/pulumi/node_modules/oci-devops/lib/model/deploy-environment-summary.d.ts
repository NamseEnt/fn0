...
export declare namespace DeployEnvironmentSummary {
    function getJsonObj(obj: DeployEnvironmentSummary): object;
    function getDeserializedJsonObj(obj: DeployEnvironmentSummary): object;
}

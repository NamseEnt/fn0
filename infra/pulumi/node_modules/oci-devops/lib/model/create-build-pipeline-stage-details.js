...
(function (CreateBuildPipelineStageDetails) {
        ...
        if (obj && "buildPipelineStageType" in obj && obj.buildPipelineStageType) {
            switch (obj.buildPipelineStageType) {
                case "DELIVER_ARTIFACT":
                    return model.CreateDeliverArtifactStageDetails.getJsonObj(jsonObj, true);
                case "TRIGGER_DEPLOYMENT_PIPELINE":
                    return model.CreateTriggerDeploymentStageDetails.getJsonObj(jsonObj, true);
                case "WAIT":
                    return model.CreateWaitStageDetails.getJsonObj(jsonObj, true);
                case "BUILD":
    ...
    CreateBuildPipelineStageDetails.getJsonObj = getJsonObj;
    function getDeserializedJsonObj(obj) {
        ...
        if (obj && "buildPipelineStageType" in obj && obj.buildPipelineStageType) {
            switch (obj.buildPipelineStageType) {
                case "DELIVER_ARTIFACT":
                    return model.CreateDeliverArtifactStageDetails.getDeserializedJsonObj(jsonObj, true);
                case "TRIGGER_DEPLOYMENT_PIPELINE":
                    return model.CreateTriggerDeploymentStageDetails.getDeserializedJsonObj(jsonObj, true);
                case "WAIT":
                    return model.CreateWaitStageDetails.getDeserializedJsonObj(jsonObj, true);
                case "BUILD":
    ...
    CreateBuildPipelineStageDetails.getDeserializedJsonObj = getDeserializedJsonObj;
})(CreateBuildPipelineStageDetails = exports.CreateBuildPipelineStageDetails || (exports.CreateBuildPipelineStageDetails = {}));
//# sourceMappingURL=create-build-pipeline-stage-details.js.map
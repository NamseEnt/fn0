...
export declare namespace GitlabTriggerCreateResult {
    function getJsonObj(obj: GitlabTriggerCreateResult, isParentJsonObj?: boolean): object;
    const triggerSource = "GITLAB";
    function getDeserializedJsonObj(obj: GitlabTriggerCreateResult, isParentJsonObj?: boolean): object;
}

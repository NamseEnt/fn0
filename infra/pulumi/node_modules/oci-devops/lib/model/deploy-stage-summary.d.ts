...
export declare namespace DeployStageSummary {
    function getJsonObj(obj: DeployStageSummary): object;
    function getDeserializedJsonObj(obj: DeployStageSummary): object;
}

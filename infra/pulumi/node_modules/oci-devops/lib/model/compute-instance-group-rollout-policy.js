...
(function (ComputeInstanceGroupRolloutPolicy) {
        ...
        if (obj && "policyType" in obj && obj.policyType) {
            switch (obj.policyType) {
                case "COMPUTE_INSTANCE_GROUP_LINEAR_ROLLOUT_POLICY_BY_PERCENTAGE":
                    return model.ComputeInstanceGroupLinearRolloutPolicyByPercentage.getJsonObj(jsonObj, true);
    ...
    ComputeInstanceGroupRolloutPolicy.getJsonObj = getJsonObj;
    function getDeserializedJsonObj(obj) {
        const jsonObj = Object.assign(Object.assign({}, obj), {});
        if (obj && "policyType" in obj && obj.policyType) {
            switch (obj.policyType) {
                case "COMPUTE_INSTANCE_GROUP_LINEAR_ROLLOUT_POLICY_BY_PERCENTAGE":
                    return model.ComputeInstanceGroupLinearRolloutPolicyByPercentage.getDeserializedJsonObj(jsonObj, true);
                case "COMPUTE_INSTANCE_GROUP_LINEAR_ROLLOUT_POLICY_BY_COUNT":
    ...
    ComputeInstanceGroupRolloutPolicy.getDeserializedJsonObj = getDeserializedJsonObj;
})(ComputeInstanceGroupRolloutPolicy = exports.ComputeInstanceGroupRolloutPolicy || (exports.ComputeInstanceGroupRolloutPolicy = {}));
//# sourceMappingURL=compute-instance-group-rollout-policy.js.map
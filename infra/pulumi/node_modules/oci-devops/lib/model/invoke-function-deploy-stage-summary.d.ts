...
export declare namespace InvokeFunctionDeployStageSummary {
    function getJsonObj(obj: InvokeFunctionDeployStageSummary, isParentJsonObj?: boolean): object;
    const deployStageType = "INVOKE_FUNCTION";
    function getDeserializedJsonObj(obj: InvokeFunctionDeployStageSummary, isParentJsonObj?: boolean): object;
}

...
export interface DeploymentExecutionProgress {
    ...
    "deployStageExecutionProgress"?: {
        [key: string]: model.DeployStageExecutionProgress;
    };
}
export declare namespace DeploymentExecutionProgress {
    function getJsonObj(obj: DeploymentExecutionProgress): object;
    function getDeserializedJsonObj(obj: DeploymentExecutionProgress): object;
}

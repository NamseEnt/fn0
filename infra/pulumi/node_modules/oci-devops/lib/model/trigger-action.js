...
(function (TriggerAction) {
        ...
        if (obj && "type" in obj && obj.type) {
            switch (obj.type) {
                case "TRIGGER_BUILD_PIPELINE":
                    return model.TriggerBuildPipelineAction.getJsonObj(jsonObj, true);
                default:
    ...
    TriggerAction.getJsonObj = getJsonObj;
    function getDeserializedJsonObj(obj) {
        ...
        if (obj && "type" in obj && obj.type) {
            switch (obj.type) {
                case "TRIGGER_BUILD_PIPELINE":
                    return model.TriggerBuildPipelineAction.getDeserializedJsonObj(jsonObj, true);
                default:
                    if (common.LOG.logger)
                        common.LOG.logger.info(`Unknown value for: ${obj.type}`);
            }
    ...
    TriggerAction.getDeserializedJsonObj = getDeserializedJsonObj;

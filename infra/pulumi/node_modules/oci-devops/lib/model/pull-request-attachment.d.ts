...
export declare namespace PullRequestAttachment {
    function getJsonObj(obj: PullRequestAttachment): object;
    function getDeserializedJsonObj(obj: PullRequestAttachment): object;
}

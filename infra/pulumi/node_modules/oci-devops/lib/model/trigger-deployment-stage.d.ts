...
export declare namespace TriggerDeploymentStage {
    function getJsonObj(obj: TriggerDeploymentStage, isParentJsonObj?: boolean): object;
    const buildPipelineStageType = "TRIGGER_DEPLOYMENT_PIPELINE";
    function getDeserializedJsonObj(obj: TriggerDeploymentStage, isParentJsonObj?: boolean): object;
}

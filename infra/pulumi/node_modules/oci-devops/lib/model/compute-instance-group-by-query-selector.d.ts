...
export declare namespace ComputeInstanceGroupByQuerySelector {
    function getJsonObj(obj: ComputeInstanceGroupByQuerySelector, isParentJsonObj?: boolean): object;
    const selectorType = "INSTANCE_QUERY";
    function getDeserializedJsonObj(obj: ComputeInstanceGroupByQuerySelector, isParentJsonObj?: boolean): object;
}

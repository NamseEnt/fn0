...
export interface OkeHelmChartDeployStageSummary extends model.DeployStageSummary {
     ...
     */
    "purpose"?: OkeHelmChartDeployStageSummary.Purpose;
    /**
...
export declare namespace OkeHelmChartDeployStageSummary {
    enum Purpose {
    ...
    function getJsonObj(obj: OkeHelmChartDeployStageSummary, isParentJsonObj?: boolean): object;
    const deployStageType = "OKE_HELM_CHART_DEPLOYMENT";
    function getDeserializedJsonObj(obj: OkeHelmChartDeployStageSummary, isParentJsonObj?: boolean): object;
}

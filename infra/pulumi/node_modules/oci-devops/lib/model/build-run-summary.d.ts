...
export interface BuildRunSummary {
    ...
    "buildRunSource": model.GitlabServerBuildRunSource | model.BitbucketServerBuildRunSource | model.GithubBuildRunSource | model.DevopsCodeRepositoryBuildRunSource | model.VbsBuildRunSource | model.ManualBuildRunSource | model.BitbucketCloudBuildRunSource | model.GitlabBuildRunSource;
...
export declare namespace BuildRunSummary {
    function getJsonObj(obj: BuildRunSummary): object;
    function getDeserializedJsonObj(obj: BuildRunSummary): object;
}

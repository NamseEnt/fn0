...
export declare namespace ComputeInstanceGroupDeployEnvironment {
    function getJsonObj(obj: ComputeInstanceGroupDeployEnvironment, isParentJsonObj?: boolean): object;
    const deployEnvironmentType = "COMPUTE_INSTANCE_GROUP";
    function getDeserializedJsonObj(obj: ComputeInstanceGroupDeployEnvironment, isParentJsonObj?: boolean): object;
}

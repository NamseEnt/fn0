...
export interface RepositoryPathSummary {
    ...
    "lastCommitDetails"?: model.RepositoryPathCommitDetails;
    /**
...
export declare namespace RepositoryPathSummary {
    function getJsonObj(obj: RepositoryPathSummary): object;
    function getDeserializedJsonObj(obj: RepositoryPathSummary): object;
}

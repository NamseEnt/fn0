 ...
 */
export interface CreateBuildRunDetails {
    /**
...
export declare namespace CreateBuildRunDetails {
    function getJsonObj(obj: CreateBuildRunDetails): object;
    function getDeserializedJsonObj(obj: CreateBuildRunDetails): object;
}

 ...
 */
export interface CreateComputeInstanceGroupCanaryDeployStageDetails extends model.CreateDeployStageDetails {
    /**
...
export declare namespace CreateComputeInstanceGroupCanaryDeployStageDetails {
    function getJsonObj(obj: CreateComputeInstanceGroupCanaryDeployStageDetails, isParentJsonObj?: boolean): object;
    const deployStageType = "COMPUTE_INSTANCE_GROUP_CANARY_DEPLOYMENT";
    function getDeserializedJsonObj(obj: CreateComputeInstanceGroupCanaryDeployStageDetails, isParentJsonObj?: boolean): object;
}

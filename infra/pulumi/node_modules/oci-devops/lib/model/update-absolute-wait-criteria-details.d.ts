...
export declare namespace UpdateAbsoluteWaitCriteriaDetails {
    function getJsonObj(obj: UpdateAbsoluteWaitCriteriaDetails, isParentJsonObj?: boolean): object;
    const waitType = "ABSOLUTE_WAIT";
    function getDeserializedJsonObj(obj: UpdateAbsoluteWaitCriteriaDetails, isParentJsonObj?: boolean): object;
}

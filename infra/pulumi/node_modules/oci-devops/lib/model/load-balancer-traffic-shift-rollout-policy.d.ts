...
export declare namespace LoadBalancerTrafficShiftRolloutPolicy {
    function getJsonObj(obj: LoadBalancerTrafficShiftRolloutPolicy): object;
    function getDeserializedJsonObj(obj: LoadBalancerTrafficShiftRolloutPolicy): object;
}

...
export interface MergeChecks {
     ...
     */
    "lastBuildSucceeded": model.MergeCheckSettingsValue;
}
export declare namespace MergeChecks {
    function getJsonObj(obj: MergeChecks): object;
    function getDeserializedJsonObj(obj: MergeChecks): object;
}

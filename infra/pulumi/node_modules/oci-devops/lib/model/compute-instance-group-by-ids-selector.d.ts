...
export declare namespace ComputeInstanceGroupByIdsSelector {
    function getJsonObj(obj: ComputeInstanceGroupByIdsSelector, isParentJsonObj?: boolean): object;
    const selectorType = "INSTANCE_IDS";
    function getDeserializedJsonObj(obj: ComputeInstanceGroupByIdsSelector, isParentJsonObj?: boolean): object;
}

 ...
 */
export interface UpdateComputeInstanceGroupDeployStageDetails extends model.UpdateDeployStageDetails {
    /**
...
export declare namespace UpdateComputeInstanceGroupDeployStageDetails {
    function getJsonObj(obj: UpdateComputeInstanceGroupDeployStageDetails, isParentJsonObj?: boolean): object;
    const deployStageType = "COMPUTE_INSTANCE_GROUP_ROLLING_DEPLOYMENT";
    function getDeserializedJsonObj(obj: UpdateComputeInstanceGroupDeployStageDetails, isParentJsonObj?: boolean): object;
}

 ...
 */
export interface RepositoryAuthorSummary {
    /**
     * Author name.
     */
    "authorName": string;
...
export declare namespace RepositoryAuthorSummary {
    function getJsonObj(obj: RepositoryAuthorSummary): object;
    function getDeserializedJsonObj(obj: RepositoryAuthorSummary): object;
}

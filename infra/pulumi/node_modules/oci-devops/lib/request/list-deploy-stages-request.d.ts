...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/devops/ListDeployStages.ts.html |here} to see how to use ListDeployStagesRequest.
 */
export interface ListDeployStagesRequest extends common.BaseRequest {
    /**
...
export declare namespace ListDeployStagesRequest {
    enum SortBy {

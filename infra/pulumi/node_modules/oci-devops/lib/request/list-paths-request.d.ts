...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/devops/ListPaths.ts.html |here} to see how to use ListPathsRequest.
 */
...
export declare namespace ListPathsRequest {
    enum SortBy {
        Type = "type",

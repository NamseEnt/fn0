...
export interface ListBuildPipelineStagesResponse {
    /**
    ...
    "opcNextPage": string;
    /**
     * The returned model.BuildPipelineStageCollection instance.
     */
    "buildPipelineStageCollection": model.BuildPipelineStageCollection;
}

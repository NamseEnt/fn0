...
export interface ListPullRequestActivitiesResponse {
    /**
    ...
    "opcNextPage": string;
    /**
     * The returned model.PullRequestActivityCollection instance.
     */
    "pullRequestActivityCollection": model.PullRequestActivityCollection;
}

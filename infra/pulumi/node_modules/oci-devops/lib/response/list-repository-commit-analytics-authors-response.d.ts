...
export interface ListRepositoryCommitAnalyticsAuthorsResponse {
    /**
    ...
    "opcNextPage": string;
    /**
     * The returned model.CommitAnalyticsAuthorCollection instance.
     */
    "commitAnalyticsAuthorCollection": model.CommitAnalyticsAuthorCollection;
}

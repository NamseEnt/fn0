...
export interface ListBuildRunSnapshotsResponse {
    /**
    ...
    "opcNextPage": string;
    /**
     * The returned model.BuildRunSnapshotCollection instance.
     */
    "buildRunSnapshotCollection": model.BuildRunSnapshotCollection;
}

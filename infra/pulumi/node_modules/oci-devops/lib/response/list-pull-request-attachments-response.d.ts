...
export interface ListPullRequestAttachmentsResponse {
    /**
    ...
    "opcNextPage": string;
    /**
     * The returned model.PullRequestAttachmentCollection instance.
     */
    "pullRequestAttachmentCollection": model.PullRequestAttachmentCollection;
}

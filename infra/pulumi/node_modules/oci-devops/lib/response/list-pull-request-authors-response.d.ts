...
export interface ListPullRequestAuthorsResponse {
    /**
    ...
    "opcNextPage": string;
    /**
     * The returned model.PullRequestAuthorCollection instance.
     */
    "pullRequestAuthorCollection": model.PullRequestAuthorCollection;
}

...
export declare class DevopsWaiter {
    private client;
    private readonly config?;
    constructor(client: DevopsClient, config?: Partial<import("oci-common/lib/waiter").WaiterConfigurationDetails> | undefined);
    /**
     ...
     */
    forBuildPipeline(request: serviceRequests.GetBuildPipelineRequest, ...targetStates: models.BuildPipeline.LifecycleState[]): Promise<serviceResponses.GetBuildPipelineResponse | null>;
    /**
     ...
     */
    forBuildPipelineStage(request: serviceRequests.GetBuildPipelineStageRequest, ...targetStates: models.BuildPipelineStage.LifecycleState[]): Promise<serviceResponses.GetBuildPipelineStageResponse | null>;
    /**
     ...
     */
    forBuildRun(request: serviceRequests.GetBuildRunRequest, ...targetStates: models.BuildRun.LifecycleState[]): Promise<serviceResponses.GetBuildRunResponse>;
    /**
     ...
     */
    forConnection(request: serviceRequests.GetConnectionRequest, ...targetStates: models.Connection.LifecycleState[]): Promise<serviceResponses.GetConnectionResponse>;
    /**
     ...
     */
    forDeployArtifact(request: serviceRequests.GetDeployArtifactRequest, ...targetStates: models.DeployArtifact.LifecycleState[]): Promise<serviceResponses.GetDeployArtifactResponse | null>;
    /**
     ...
     */
    forDeployEnvironment(request: serviceRequests.GetDeployEnvironmentRequest, ...targetStates: models.DeployEnvironment.LifecycleState[]): Promise<serviceResponses.GetDeployEnvironmentResponse | null>;
    /**
     ...
     */
    forDeployPipeline(request: serviceRequests.GetDeployPipelineRequest, ...targetStates: models.DeployPipeline.LifecycleState[]): Promise<serviceResponses.GetDeployPipelineResponse | null>;
    /**
     ...
     */
    forDeployStage(request: serviceRequests.GetDeployStageRequest, ...targetStates: models.DeployStage.LifecycleState[]): Promise<serviceResponses.GetDeployStageResponse | null>;
    /**
     ...
     */
    forDeployment(request: serviceRequests.GetDeploymentRequest, ...targetStates: models.Deployment.LifecycleState[]): Promise<serviceResponses.GetDeploymentResponse>;
    /**
     ...
     */
    forPullRequest(request: serviceRequests.GetPullRequestRequest, ...targetStates: models.PullRequest.LifecycleState[]): Promise<serviceResponses.GetPullRequestResponse | null>;
    /**
     ...
     */
    forTrigger(request: serviceRequests.GetTriggerRequest, ...targetStates: models.Trigger.LifecycleState[]): Promise<serviceResponses.GetTriggerResponse>;
    /**

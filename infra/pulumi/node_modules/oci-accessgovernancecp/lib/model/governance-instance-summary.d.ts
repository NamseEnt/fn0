...
export declare namespace GovernanceInstanceSummary {
    function getJsonObj(obj: GovernanceInstanceSummary): object;
    function getDeserializedJsonObj(obj: GovernanceInstanceSummary): object;
}

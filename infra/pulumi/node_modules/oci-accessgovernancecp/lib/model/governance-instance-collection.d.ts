...
export declare namespace GovernanceInstanceCollection {
    function getJsonObj(obj: GovernanceInstanceCollection): object;
    function getDeserializedJsonObj(obj: GovernanceInstanceCollection): object;
}

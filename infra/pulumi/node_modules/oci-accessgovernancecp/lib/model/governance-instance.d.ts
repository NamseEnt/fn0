...
export declare namespace GovernanceInstance {
    function getJsonObj(obj: GovernanceInstance): object;
    function getDeserializedJsonObj(obj: GovernanceInstance): object;
}

...
export declare namespace MetricPropertyCollection {
    function getJsonObj(obj: MetricPropertyCollection): object;
    function getDeserializedJsonObj(obj: MetricPropertyCollection): object;
}

...
export declare namespace ComputeInstanceVnicMappingDetails {
    function getJsonObj(obj: ComputeInstanceVnicMappingDetails): object;
    function getDeserializedJsonObj(obj: ComputeInstanceVnicMappingDetails): object;
}

 ...
 */
export interface RunObjectStoreScriptUserDefinedCustomPrecheckStep extends model.DrPlanUserDefinedStep {
    /**
...
export declare namespace RunObjectStoreScriptUserDefinedCustomPrecheckStep {
    function getJsonObj(obj: RunObjectStoreScriptUserDefinedCustomPrecheckStep, isParentJsonObj?: boolean): object;
    const stepType = "RUN_OBJECTSTORE_SCRIPT_USER_DEFINED_CUSTOM_PRECHECK";
    function getDeserializedJsonObj(obj: RunObjectStoreScriptUserDefinedCustomPrecheckStep, isParentJsonObj?: boolean): object;
}

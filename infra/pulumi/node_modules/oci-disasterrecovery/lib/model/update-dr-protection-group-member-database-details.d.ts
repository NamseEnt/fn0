...
export declare namespace UpdateDrProtectionGroupMemberDatabaseDetails {
    function getJsonObj(obj: UpdateDrProtectionGroupMemberDatabaseDetails, isParentJsonObj?: boolean): object;
    const memberType = "DATABASE";
    function getDeserializedJsonObj(obj: UpdateDrProtectionGroupMemberDatabaseDetails, isParentJsonObj?: boolean): object;
}

 ...
 *
 **/
export declare enum DrProtectionGroupLifecycleState {
    Creating = "CREATING",
    Active = "ACTIVE",
    Updating = "UPDATING",
    Inactive = "INACTIVE",
...
export declare namespace DrProtectionGroupLifecycleState {
    function getJsonObj(obj: DrProtectionGroupLifecycleState): DrProtectionGroupLifecycleState;
    function getDeserializedJsonObj(obj: DrProtectionGroupLifecycleState): DrProtectionGroupLifecycleState;
}

...
export declare namespace UpdateDrProtectionGroupDetails {
    function getJsonObj(obj: UpdateDrProtectionGroupDetails): object;
    function getDeserializedJsonObj(obj: UpdateDrProtectionGroupDetails): object;
}

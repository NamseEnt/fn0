...
export declare namespace OkeClusterBackupConfig {
    function getJsonObj(obj: OkeClusterBackupConfig): object;
    function getDeserializedJsonObj(obj: OkeClusterBackupConfig): object;
}

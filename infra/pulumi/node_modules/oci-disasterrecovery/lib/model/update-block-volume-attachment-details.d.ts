...
export declare namespace UpdateBlockVolumeAttachmentDetails {
    function getJsonObj(obj: UpdateBlockVolumeAttachmentDetails): object;
    function getDeserializedJsonObj(obj: UpdateBlockVolumeAttachmentDetails): object;
}

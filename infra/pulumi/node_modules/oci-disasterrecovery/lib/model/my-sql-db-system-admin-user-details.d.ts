 ...
 */
export interface MySqlDbSystemAdminUserDetails {
    /**
...
export declare namespace MySqlDbSystemAdminUserDetails {
    function getJsonObj(obj: MySqlDbSystemAdminUserDetails): object;
    function getDeserializedJsonObj(obj: MySqlDbSystemAdminUserDetails): object;
}

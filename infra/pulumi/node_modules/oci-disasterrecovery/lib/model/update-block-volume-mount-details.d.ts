 ...
 *
 */
export interface UpdateBlockVolumeMountDetails {
    /**
...
export declare namespace UpdateBlockVolumeMountDetails {
    function getJsonObj(obj: UpdateBlockVolumeMountDetails): object;
    function getDeserializedJsonObj(obj: UpdateBlockVolumeMountDetails): object;
}

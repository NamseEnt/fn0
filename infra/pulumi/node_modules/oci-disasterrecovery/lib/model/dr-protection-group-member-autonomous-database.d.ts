...
export declare namespace DrProtectionGroupMemberAutonomousDatabase {
    function getJsonObj(obj: DrProtectionGroupMemberAutonomousDatabase, isParentJsonObj?: boolean): object;
    const memberType = "AUTONOMOUS_DATABASE";
    function getDeserializedJsonObj(obj: DrProtectionGroupMemberAutonomousDatabase, isParentJsonObj?: boolean): object;
}

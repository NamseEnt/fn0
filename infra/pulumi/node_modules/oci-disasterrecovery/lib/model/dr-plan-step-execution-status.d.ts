 ...
 *
 **/
export declare enum DrPlanStepExecutionStatus {
    Queued = "QUEUED",
    Disabled = "DISABLED",
...
export declare namespace DrPlanStepExecutionStatus {
    function getJsonObj(obj: DrPlanStepExecutionStatus): DrPlanStepExecutionStatus;
    function getDeserializedJsonObj(obj: DrPlanStepExecutionStatus): DrPlanStepExecutionStatus;
}

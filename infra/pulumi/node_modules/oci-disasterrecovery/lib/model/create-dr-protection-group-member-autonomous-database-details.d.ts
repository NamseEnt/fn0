 ...
 */
export interface CreateDrProtectionGroupMemberAutonomousDatabaseDetails extends model.CreateDrProtectionGroupMemberDetails {
    /**
...
export declare namespace CreateDrProtectionGroupMemberAutonomousDatabaseDetails {
    function getJsonObj(obj: CreateDrProtectionGroupMemberAutonomousDatabaseDetails, isParentJsonObj?: boolean): object;
    const memberType = "AUTONOMOUS_DATABASE";
    function getDeserializedJsonObj(obj: CreateDrProtectionGroupMemberAutonomousDatabaseDetails, isParentJsonObj?: boolean): object;
}

...
export declare namespace RunObjectStoreScriptUserDefinedStep {
    function getJsonObj(obj: RunObjectStoreScriptUserDefinedStep, isParentJsonObj?: boolean): object;
    const stepType = "RUN_OBJECTSTORE_SCRIPT";
    function getDeserializedJsonObj(obj: RunObjectStoreScriptUserDefinedStep, isParentJsonObj?: boolean): object;
}

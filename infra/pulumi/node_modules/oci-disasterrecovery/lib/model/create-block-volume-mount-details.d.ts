...
export declare namespace CreateBlockVolumeMountDetails {
    function getJsonObj(obj: CreateBlockVolumeMountDetails): object;
    function getDeserializedJsonObj(obj: CreateBlockVolumeMountDetails): object;
}

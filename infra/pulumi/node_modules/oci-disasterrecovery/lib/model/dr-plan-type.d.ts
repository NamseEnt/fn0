 ...
 *
 **/
export declare enum DrPlanType {
...
export declare namespace DrPlanType {
    function getJsonObj(obj: DrPlanType): DrPlanType;
    function getDeserializedJsonObj(obj: DrPlanType): DrPlanType;
}

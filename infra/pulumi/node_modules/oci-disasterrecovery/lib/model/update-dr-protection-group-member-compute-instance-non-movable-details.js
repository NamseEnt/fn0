...
(function (UpdateDrProtectionGroupMemberComputeInstanceNonMovableDetails) {
        ...
        const jsonObj = Object.assign(Object.assign({}, (isParentJsonObj
            ...
            "fileSystemOperations": obj.fileSystemOperations
                ? obj.fileSystemOperations.map(item => {
                    return model.UpdateComputeInstanceNonMovableFileSystemOperationDetails.getJsonObj(item);
                })
                : undefined,
    ...
    function getDeserializedJsonObj(obj, isParentJsonObj) {
        const jsonObj = Object.assign(Object.assign({}, (isParentJsonObj
            ...
            "fileSystemOperations": obj.fileSystemOperations
                ? obj.fileSystemOperations.map(item => {
                    return model.UpdateComputeInstanceNonMovableFileSystemOperationDetails.getDeserializedJsonObj(item);
                })
                : undefined,
            "blockVolumeOperations": obj.blockVolumeOperations
                ? obj.blockVolumeOperations.map(item => {

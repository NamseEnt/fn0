...
export declare namespace DrProtectionGroupMemberFileSystem {
    function getJsonObj(obj: DrProtectionGroupMemberFileSystem, isParentJsonObj?: boolean): object;
    const memberType = "FILE_SYSTEM";
    function getDeserializedJsonObj(obj: DrProtectionGroupMemberFileSystem, isParentJsonObj?: boolean): object;
}

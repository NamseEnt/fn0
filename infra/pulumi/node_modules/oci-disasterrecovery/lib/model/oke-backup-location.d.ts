...
export declare namespace OkeBackupLocation {
    function getJsonObj(obj: OkeBackupLocation): object;
    function getDeserializedJsonObj(obj: OkeBackupLocation): object;
}

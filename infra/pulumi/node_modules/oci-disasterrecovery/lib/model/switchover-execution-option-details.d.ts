...
export declare namespace SwitchoverExecutionOptionDetails {
    function getJsonObj(obj: SwitchoverExecutionOptionDetails, isParentJsonObj?: boolean): object;
    const planExecutionType = "SWITCHOVER";
    function getDeserializedJsonObj(obj: SwitchoverExecutionOptionDetails, isParentJsonObj?: boolean): object;
}

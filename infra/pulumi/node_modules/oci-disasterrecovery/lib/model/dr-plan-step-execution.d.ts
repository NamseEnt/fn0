...
export declare namespace DrPlanStepExecution {
    function getJsonObj(obj: DrPlanStepExecution): object;
    function getDeserializedJsonObj(obj: DrPlanStepExecution): object;
}

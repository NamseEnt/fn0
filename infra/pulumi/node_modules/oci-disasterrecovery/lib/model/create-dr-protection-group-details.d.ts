...
export declare namespace CreateDrProtectionGroupDetails {
    function getJsonObj(obj: CreateDrProtectionGroupDetails): object;
    function getDeserializedJsonObj(obj: CreateDrProtectionGroupDetails): object;
}

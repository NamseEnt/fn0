...
export declare namespace CreateDrProtectionGroupMemberDatabaseDetails {
    function getJsonObj(obj: CreateDrProtectionGroupMemberDatabaseDetails, isParentJsonObj?: boolean): object;
    const memberType = "DATABASE";
    function getDeserializedJsonObj(obj: CreateDrProtectionGroupMemberDatabaseDetails, isParentJsonObj?: boolean): object;
}

...
export declare namespace StopDrillExecutionOptionDetails {
    function getJsonObj(obj: StopDrillExecutionOptionDetails, isParentJsonObj?: boolean): object;
    const planExecutionType = "STOP_DRILL";
    function getDeserializedJsonObj(obj: StopDrillExecutionOptionDetails, isParentJsonObj?: boolean): object;
}

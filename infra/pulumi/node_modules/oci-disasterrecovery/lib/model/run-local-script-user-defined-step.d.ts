...
export declare namespace RunLocalScriptUserDefinedStep {
    function getJsonObj(obj: RunLocalScriptUserDefinedStep, isParentJsonObj?: boolean): object;
    const stepType = "RUN_LOCAL_SCRIPT";
    function getDeserializedJsonObj(obj: RunLocalScriptUserDefinedStep, isParentJsonObj?: boolean): object;
}

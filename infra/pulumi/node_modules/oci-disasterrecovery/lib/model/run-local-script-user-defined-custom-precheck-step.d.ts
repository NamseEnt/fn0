 ...
 */
export interface RunLocalScriptUserDefinedCustomPrecheckStep extends model.DrPlanUserDefinedStep {
    /**
...
export declare namespace RunLocalScriptUserDefinedCustomPrecheckStep {
    function getJsonObj(obj: RunLocalScriptUserDefinedCustomPrecheckStep, isParentJsonObj?: boolean): object;
    const stepType = "RUN_LOCAL_SCRIPT_USER_DEFINED_CUSTOM_PRECHECK";
    function getDeserializedJsonObj(obj: RunLocalScriptUserDefinedCustomPrecheckStep, isParentJsonObj?: boolean): object;
}

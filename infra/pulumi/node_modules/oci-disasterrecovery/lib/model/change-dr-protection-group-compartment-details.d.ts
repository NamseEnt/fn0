...
export declare namespace ChangeDrProtectionGroupCompartmentDetails {
    function getJsonObj(obj: ChangeDrProtectionGroupCompartmentDetails): object;
    function getDeserializedJsonObj(obj: ChangeDrProtectionGroupCompartmentDetails): object;
}

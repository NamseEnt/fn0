...
export declare namespace DrProtectionGroupMemberNetworkLoadBalancer {
    function getJsonObj(obj: DrProtectionGroupMemberNetworkLoadBalancer, isParentJsonObj?: boolean): object;
    const memberType = "NETWORK_LOAD_BALANCER";
    function getDeserializedJsonObj(obj: DrProtectionGroupMemberNetworkLoadBalancer, isParentJsonObj?: boolean): object;
}

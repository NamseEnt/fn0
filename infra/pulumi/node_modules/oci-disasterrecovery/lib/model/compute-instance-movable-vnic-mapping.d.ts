...
export declare namespace ComputeInstanceMovableVnicMapping {
    function getJsonObj(obj: ComputeInstanceMovableVnicMapping): object;
    function getDeserializedJsonObj(obj: ComputeInstanceMovableVnicMapping): object;
}

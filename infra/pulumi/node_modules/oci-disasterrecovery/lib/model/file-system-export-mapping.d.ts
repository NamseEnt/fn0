...
export declare namespace FileSystemExportMapping {
    function getJsonObj(obj: FileSystemExportMapping): object;
    function getDeserializedJsonObj(obj: FileSystemExportMapping): object;
}

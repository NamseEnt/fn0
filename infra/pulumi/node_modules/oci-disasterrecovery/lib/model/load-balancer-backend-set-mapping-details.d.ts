 ...
 */
export interface LoadBalancerBackendSetMappingDetails {
    /**
...
export declare namespace LoadBalancerBackendSetMappingDetails {
    function getJsonObj(obj: LoadBalancerBackendSetMappingDetails): object;
    function getDeserializedJsonObj(obj: LoadBalancerBackendSetMappingDetails): object;
}

...
export declare namespace BulkActionResourceType {
    function getJsonObj(obj: BulkActionResourceType): object;
    function getDeserializedJsonObj(obj: BulkActionResourceType): object;
}

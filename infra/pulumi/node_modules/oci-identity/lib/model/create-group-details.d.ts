...
export declare namespace CreateGroupDetails {
    function getJsonObj(obj: CreateGroupDetails): object;
    function getDeserializedJsonObj(obj: CreateGroupDetails): object;
}

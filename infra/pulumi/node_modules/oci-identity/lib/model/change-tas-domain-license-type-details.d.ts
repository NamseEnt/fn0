...
export declare namespace ChangeTasDomainLicenseTypeDetails {
    function getJsonObj(obj: ChangeTasDomainLicenseTypeDetails): object;
    function getDeserializedJsonObj(obj: ChangeTasDomainLicenseTypeDetails): object;
}

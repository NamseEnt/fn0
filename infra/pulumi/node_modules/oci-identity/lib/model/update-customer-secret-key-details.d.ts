...
export declare namespace UpdateCustomerSecretKeyDetails {
    function getJsonObj(obj: UpdateCustomerSecretKeyDetails): object;
    function getDeserializedJsonObj(obj: UpdateCustomerSecretKeyDetails): object;
}

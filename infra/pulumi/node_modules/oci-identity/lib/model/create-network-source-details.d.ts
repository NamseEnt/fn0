...
export declare namespace CreateNetworkSourceDetails {
    function getJsonObj(obj: CreateNetworkSourceDetails): object;
    function getDeserializedJsonObj(obj: CreateNetworkSourceDetails): object;
}

 ...
 */
export interface CreateCustomerSecretKeyDetails {
    /**
...
export declare namespace CreateCustomerSecretKeyDetails {
    function getJsonObj(obj: CreateCustomerSecretKeyDetails): object;
    function getDeserializedJsonObj(obj: CreateCustomerSecretKeyDetails): object;
}

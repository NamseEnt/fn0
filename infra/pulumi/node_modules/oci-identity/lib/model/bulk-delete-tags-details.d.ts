 ...
 */
export interface BulkDeleteTagsDetails {
    /**
     * The OCIDs of the tag definitions to delete
     */
    "tagDefinitionIds": Array<string>;
}
export declare namespace BulkDeleteTagsDetails {
    function getJsonObj(obj: BulkDeleteTagsDetails): object;
    function getDeserializedJsonObj(obj: BulkDeleteTagsDetails): object;
}

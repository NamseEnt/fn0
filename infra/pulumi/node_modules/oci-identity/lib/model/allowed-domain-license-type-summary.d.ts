...
export declare namespace AllowedDomainLicenseTypeSummary {
    function getJsonObj(obj: AllowedDomainLicenseTypeSummary): object;
    function getDeserializedJsonObj(obj: AllowedDomainLicenseTypeSummary): object;
}

...
export declare namespace StandardTagNamespaceTemplateSummary {
    function getJsonObj(obj: StandardTagNamespaceTemplateSummary): object;
    function getDeserializedJsonObj(obj: StandardTagNamespaceTemplateSummary): object;
}

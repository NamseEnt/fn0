 ...
 *
 */
export interface ScimClientCredentials {
    /**
...
export declare namespace ScimClientCredentials {
    function getJsonObj(obj: ScimClientCredentials): object;
    function getDeserializedJsonObj(obj: ScimClientCredentials): object;
}

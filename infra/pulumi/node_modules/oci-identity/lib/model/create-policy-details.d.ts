...
export declare namespace CreatePolicyDetails {
    function getJsonObj(obj: CreatePolicyDetails): object;
    function getDeserializedJsonObj(obj: CreatePolicyDetails): object;
}

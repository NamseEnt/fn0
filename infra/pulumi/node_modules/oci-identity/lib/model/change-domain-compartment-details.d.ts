...
export declare namespace ChangeDomainCompartmentDetails {
    function getJsonObj(obj: ChangeDomainCompartmentDetails): object;
    function getDeserializedJsonObj(obj: ChangeDomainCompartmentDetails): object;
}

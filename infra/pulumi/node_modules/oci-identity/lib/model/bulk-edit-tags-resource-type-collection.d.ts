...
export declare namespace BulkEditTagsResourceTypeCollection {
    function getJsonObj(obj: BulkEditTagsResourceTypeCollection): object;
    function getDeserializedJsonObj(obj: BulkEditTagsResourceTypeCollection): object;
}

...
export declare namespace CreateIdpGroupMappingDetails {
    function getJsonObj(obj: CreateIdpGroupMappingDetails): object;
    function getDeserializedJsonObj(obj: CreateIdpGroupMappingDetails): object;
}

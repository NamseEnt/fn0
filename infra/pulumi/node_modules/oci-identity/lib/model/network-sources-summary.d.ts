...
export declare namespace NetworkSourcesSummary {
    function getJsonObj(obj: NetworkSourcesSummary): object;
    function getDeserializedJsonObj(obj: NetworkSourcesSummary): object;
}

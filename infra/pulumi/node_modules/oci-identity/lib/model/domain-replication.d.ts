...
export declare namespace DomainReplication {
    function getJsonObj(obj: DomainReplication): object;
    function getDeserializedJsonObj(obj: DomainReplication): object;
}

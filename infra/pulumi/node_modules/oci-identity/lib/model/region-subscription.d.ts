...
export declare namespace RegionSubscription {
    enum Status {
        Ready = "READY",
    ...
    function getJsonObj(obj: RegionSubscription): object;
    function getDeserializedJsonObj(obj: RegionSubscription): object;
}

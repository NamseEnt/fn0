...
export declare namespace BulkActionResource {
    function getJsonObj(obj: BulkActionResource): object;
    function getDeserializedJsonObj(obj: BulkActionResource): object;
}

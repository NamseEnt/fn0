 ...
 *
 */
export interface TaggingWorkRequestErrorSummary {
    /**
...
export declare namespace TaggingWorkRequestErrorSummary {
    function getJsonObj(obj: TaggingWorkRequestErrorSummary): object;
    function getDeserializedJsonObj(obj: TaggingWorkRequestErrorSummary): object;
}

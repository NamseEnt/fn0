...
export declare namespace UpdateUserDetails {
    function getJsonObj(obj: UpdateUserDetails): object;
    function getDeserializedJsonObj(obj: UpdateUserDetails): object;
}

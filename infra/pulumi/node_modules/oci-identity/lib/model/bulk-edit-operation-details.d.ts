...
export declare namespace BulkEditOperationDetails {
    enum OperationType {
    ...
    function getJsonObj(obj: BulkEditOperationDetails): object;
    function getDeserializedJsonObj(obj: BulkEditOperationDetails): object;
}

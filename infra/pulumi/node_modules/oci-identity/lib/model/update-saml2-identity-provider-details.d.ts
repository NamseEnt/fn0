...
export declare namespace UpdateSaml2IdentityProviderDetails {
    function getJsonObj(obj: UpdateSaml2IdentityProviderDetails, isParentJsonObj?: boolean): object;
    const protocol = "SAML2";
    function getDeserializedJsonObj(obj: UpdateSaml2IdentityProviderDetails, isParentJsonObj?: boolean): object;
}

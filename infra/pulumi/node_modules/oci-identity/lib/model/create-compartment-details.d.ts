...
export declare namespace CreateCompartmentDetails {
    function getJsonObj(obj: CreateCompartmentDetails): object;
    function getDeserializedJsonObj(obj: CreateCompartmentDetails): object;
}

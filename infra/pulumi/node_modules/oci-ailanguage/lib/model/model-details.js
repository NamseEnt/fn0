        ...
        if (obj && "modelType" in obj && obj.modelType) {
            switch (obj.modelType) {
                ...
                case "PRE_TRAINED_TRANSLATION":
                    return model.PreTrainedTranslationModelDetails.getJsonObj(jsonObj, true);
                ...
                case "HEALTH_NLU":
                    return model.HealthNluModelDetails.getJsonObj(jsonObj, true);
    ...
    function getDeserializedJsonObj(obj) {
        ...
        if (obj && "modelType" in obj && obj.modelType) {
            switch (obj.modelType) {
                ...
                case "PRE_TRAINED_TRANSLATION":
                    return model.PreTrainedTranslationModelDetails.getDeserializedJsonObj(jsonObj, true);
                case "PRE_TRAINED_HEALTH_NLU":
                ...
                case "HEALTH_NLU":
                    return model.HealthNluModelDetails.getDeserializedJsonObj(jsonObj, true);
                case "PRE_TRAINED_SUMMARIZATION":

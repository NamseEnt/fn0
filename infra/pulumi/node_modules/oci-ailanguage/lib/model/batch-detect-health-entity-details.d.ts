...
export declare namespace BatchDetectHealthEntityDetails {
    function getJsonObj(obj: BatchDetectHealthEntityDetails): object;
    function getDeserializedJsonObj(obj: BatchDetectHealthEntityDetails): object;
}

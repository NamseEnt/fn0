...
export declare namespace NamedEntityRecognitionEvaluationResult {
    function getJsonObj(obj: NamedEntityRecognitionEvaluationResult, isParentJsonObj?: boolean): object;
    const modelType = "NAMED_ENTITY_RECOGNITION";
    function getDeserializedJsonObj(obj: NamedEntityRecognitionEvaluationResult, isParentJsonObj?: boolean): object;
}

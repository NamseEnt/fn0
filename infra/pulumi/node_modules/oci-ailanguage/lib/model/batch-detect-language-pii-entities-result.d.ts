...
export declare namespace BatchDetectLanguagePiiEntitiesResult {
    function getJsonObj(obj: BatchDetectLanguagePiiEntitiesResult): object;
    function getDeserializedJsonObj(obj: BatchDetectLanguagePiiEntitiesResult): object;
}

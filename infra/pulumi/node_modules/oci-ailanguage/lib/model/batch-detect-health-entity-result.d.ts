...
export declare namespace BatchDetectHealthEntityResult {
    function getJsonObj(obj: BatchDetectHealthEntityResult): object;
    function getDeserializedJsonObj(obj: BatchDetectHealthEntityResult): object;
}

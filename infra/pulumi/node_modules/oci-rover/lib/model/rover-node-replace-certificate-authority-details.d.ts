 ...
 */
export interface RoverNodeReplaceCertificateAuthorityDetails {
    /**
...
export declare namespace RoverNodeReplaceCertificateAuthorityDetails {
    function getJsonObj(obj: RoverNodeReplaceCertificateAuthorityDetails): object;
    function getDeserializedJsonObj(obj: RoverNodeReplaceCertificateAuthorityDetails): object;
}

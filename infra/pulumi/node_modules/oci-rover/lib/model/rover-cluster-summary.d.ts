...
export declare namespace RoverClusterSummary {
    function getJsonObj(obj: RoverClusterSummary): object;
    function getDeserializedJsonObj(obj: RoverClusterSummary): object;
}

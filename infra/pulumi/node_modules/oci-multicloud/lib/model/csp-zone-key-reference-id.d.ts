...
export declare namespace CspZoneKeyReferenceId {
    function getJsonObj(obj: CspZoneKeyReferenceId): object;
    function getDeserializedJsonObj(obj: CspZoneKeyReferenceId): object;
}

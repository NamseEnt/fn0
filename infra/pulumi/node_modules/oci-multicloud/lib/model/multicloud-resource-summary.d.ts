...
export declare namespace MulticloudResourceSummary {
    enum LifecycleState {
        Active = "ACTIVE",
        Inactive = "INACTIVE",
        /**
    ...
    function getJsonObj(obj: MulticloudResourceSummary): object;
    function getDeserializedJsonObj(obj: MulticloudResourceSummary): object;
}

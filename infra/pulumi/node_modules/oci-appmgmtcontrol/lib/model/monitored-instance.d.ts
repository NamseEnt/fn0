...
export declare namespace MonitoredInstance {
    ...
    function getJsonObj(obj: MonitoredInstance): object;
    function getDeserializedJsonObj(obj: MonitoredInstance): object;
}

...
exports.AppmgmtControlWaiter = void 0;
const models = __importStar(require("./model"));
const oci_common_1 = require("oci-common");
class AppmgmtControlWaiter {
     ...
     */
    forMonitoredInstance(request, ...targetStates) {
        return __awaiter(this, void 0, void 0, function* () {
            return oci_common_1.genericTerminalConditionWaiter(this.config, () => this.client.getMonitoredInstance(request), response => targetStates.includes(response.monitoredInstance.lifecycleState), targetStates.includes(models.MonitoredInstance.LifecycleState.Deleted));
        });
    }
    /**
...
exports.AppmgmtControlWaiter = AppmgmtControlWaiter;
//# sourceMappingURL=appmgmtcontrol-waiter.js.map
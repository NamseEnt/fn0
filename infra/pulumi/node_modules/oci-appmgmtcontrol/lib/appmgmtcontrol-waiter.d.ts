...
export declare class AppmgmtControlWaiter {
    private client;
    private readonly config?;
    constructor(client: AppmgmtControlClient, config?: Partial<import("oci-common/lib/waiter").WaiterConfigurationDetails> | undefined);
    /**
     ...
     */
    forMonitoredInstance(request: serviceRequests.GetMonitoredInstanceRequest, ...targetStates: models.MonitoredInstance.LifecycleState[]): Promise<serviceResponses.GetMonitoredInstanceResponse | null>;
    /**

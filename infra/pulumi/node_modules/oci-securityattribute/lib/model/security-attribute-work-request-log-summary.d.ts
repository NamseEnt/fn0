...
export declare namespace SecurityAttributeWorkRequestLogSummary {
    function getJsonObj(obj: SecurityAttributeWorkRequestLogSummary): object;
    function getDeserializedJsonObj(obj: SecurityAttributeWorkRequestLogSummary): object;
}

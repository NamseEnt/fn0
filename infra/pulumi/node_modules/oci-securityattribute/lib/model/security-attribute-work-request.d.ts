...
export declare namespace SecurityAttributeWorkRequest {
    function getJsonObj(obj: SecurityAttributeWorkRequest): object;
    function getDeserializedJsonObj(obj: SecurityAttributeWorkRequest): object;
}

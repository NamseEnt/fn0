 ...
 *
 */
export interface SecurityAttributeWorkRequestSummary {
    /**
...
export declare namespace SecurityAttributeWorkRequestSummary {
    function getJsonObj(obj: SecurityAttributeWorkRequestSummary): object;
    function getDeserializedJsonObj(obj: SecurityAttributeWorkRequestSummary): object;
}

...
export declare namespace SecurityAttributeNamespace {
    enum LifecycleState {
        Active = "ACTIVE",
        Inactive = "INACTIVE",
        Deleting = "DELETING",
    ...
    function getJsonObj(obj: SecurityAttributeNamespace): object;
    function getDeserializedJsonObj(obj: SecurityAttributeNamespace): object;
}

 ...
 *
 */
export interface SecurityAttributeWorkRequestErrorSummary {
    /**
...
export declare namespace SecurityAttributeWorkRequestErrorSummary {
    function getJsonObj(obj: SecurityAttributeWorkRequestErrorSummary): object;
    function getDeserializedJsonObj(obj: SecurityAttributeWorkRequestErrorSummary): object;
}

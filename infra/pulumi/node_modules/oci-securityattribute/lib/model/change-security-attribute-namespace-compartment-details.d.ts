 ...
 *
 */
export interface ChangeSecurityAttributeNamespaceCompartmentDetails {
    /**
     * The Oracle Cloud ID (OCID) of the destination compartment.
     */
    "compartmentId": string;
}
export declare namespace ChangeSecurityAttributeNamespaceCompartmentDetails {
    function getJsonObj(obj: ChangeSecurityAttributeNamespaceCompartmentDetails): object;
    function getDeserializedJsonObj(obj: ChangeSecurityAttributeNamespaceCompartmentDetails): object;
}

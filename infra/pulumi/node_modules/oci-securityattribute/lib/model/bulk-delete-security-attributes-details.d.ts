...
export declare namespace BulkDeleteSecurityAttributesDetails {
    function getJsonObj(obj: BulkDeleteSecurityAttributesDetails): object;
    function getDeserializedJsonObj(obj: BulkDeleteSecurityAttributesDetails): object;
}

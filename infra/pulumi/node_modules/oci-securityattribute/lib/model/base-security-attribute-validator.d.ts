...
export declare namespace BaseSecurityAttributeValidator {
    function getJsonObj(obj: BaseSecurityAttributeValidator): object;
    function getDeserializedJsonObj(obj: BaseSecurityAttributeValidator): object;
}

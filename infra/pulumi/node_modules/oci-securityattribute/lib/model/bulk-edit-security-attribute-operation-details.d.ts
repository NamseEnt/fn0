...
export declare namespace BulkEditSecurityAttributeOperationDetails {
    enum OperationType {
    ...
    function getJsonObj(obj: BulkEditSecurityAttributeOperationDetails): object;
    function getDeserializedJsonObj(obj: BulkEditSecurityAttributeOperationDetails): object;
}

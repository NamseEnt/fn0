 ...
 * ```
 */
export declare class StackServiceAccountToken extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: StackServiceAccountTokenState, opts?: pulumi.CustomResourceOptions): StackServiceAccountToken;
    /**
     * Returns true if the given object is an instance of StackServiceAccountToken.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is StackServiceAccountToken;
    /**

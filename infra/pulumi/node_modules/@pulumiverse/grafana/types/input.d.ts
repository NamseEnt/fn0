...
export declare namespace alerting {
    ...
    interface NotificationPolicyPolicyPolicyPolicyPolicy {
         ...
         * Routing rules for specific label sets.
         */
        policies?: pulumi.Input<pulumi.Input<inputs.alerting.NotificationPolicyPolicyPolicyPolicyPolicyPolicy>[]>;
        /**
         * Minimum time interval for re-sending a notification if an alert is still firing. Default is 4 hours.
         */
        repeatInterval?: pulumi.Input<string>;
    ...
    interface NotificationPolicyPolicyPolicyPolicyPolicyPolicy {
         ...
         * Describes which labels this rule should match. When multiple matchers are supplied, an alert must match ALL matchers to be accepted by this policy. When no matchers are supplied, the rule will match all alert instances.
         */
        matchers?: pulumi.Input<pulumi.Input<inputs.alerting.NotificationPolicyPolicyPolicyPolicyPolicyPolicyMatcher>[]>;
        /**
         * A list of time intervals to apply to alerts that match this policy to mute them for the specified time.
         */
        muteTimings?: pulumi.Input<pulumi.Input<string>[]>;
...
export declare namespace slo {
    interface SLOAlerting {
         ...
         */
        fastburn?: pulumi.Input<inputs.slo.SLOAlertingFastburn>;
        /**
         ...
         */
        slowburn?: pulumi.Input<inputs.slo.SLOAlertingSlowburn>;
    }

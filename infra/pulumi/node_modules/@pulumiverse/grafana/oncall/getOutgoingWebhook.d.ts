 ...
 * ```
 */
export declare function getOutgoingWebhook(args: GetOutgoingWebhookArgs, opts?: pulumi.InvokeOptions): Promise<GetOutgoingWebhookResult>;
/**
 ...
 * ```
 */
export declare function getOutgoingWebhookOutput(args: GetOutgoingWebhookOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetOutgoingWebhookResult>;
/**
 * A collection of arguments for invoking getOutgoingWebhook.
 */

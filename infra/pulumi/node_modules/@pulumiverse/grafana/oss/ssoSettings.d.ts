...
export declare class SsoSettings extends pulumi.CustomResource {
     ...
     */
    readonly ldapSettings: pulumi.Output<outputs.oss.SsoSettingsLdapSettings | undefined>;
    /**
     * The OAuth2 settings set. Required for github, gitlab, google, azuread, okta, generic*oauth providers.
     */
    readonly oauth2Settings: pulumi.Output<outputs.oss.SsoSettingsOauth2Settings | undefined>;
    /**
     ...
     */
    readonly samlSettings: pulumi.Output<outputs.oss.SsoSettingsSamlSettings | undefined>;
    /**

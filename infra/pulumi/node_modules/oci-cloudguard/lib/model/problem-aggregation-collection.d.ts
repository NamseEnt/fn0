...
export declare namespace ProblemAggregationCollection {
    function getJsonObj(obj: ProblemAggregationCollection): object;
    function getDeserializedJsonObj(obj: ProblemAggregationCollection): object;
}

...
export declare namespace TargetResponderRecipeResponderRule {
    enum SupportedModes {
    ...
    function getJsonObj(obj: TargetResponderRecipeResponderRule): object;
    function getDeserializedJsonObj(obj: TargetResponderRecipeResponderRule): object;
}

...
export declare namespace ProblemAggregation {
    function getJsonObj(obj: ProblemAggregation): object;
    function getDeserializedJsonObj(obj: ProblemAggregation): object;
}

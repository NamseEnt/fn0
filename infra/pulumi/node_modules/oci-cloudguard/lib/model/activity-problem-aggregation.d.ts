...
export declare namespace ActivityProblemAggregation {
    function getJsonObj(obj: ActivityProblemAggregation): object;
    function getDeserializedJsonObj(obj: ActivityProblemAggregation): object;
}

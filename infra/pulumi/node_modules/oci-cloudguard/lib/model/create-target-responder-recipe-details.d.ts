...
export declare namespace CreateTargetResponderRecipeDetails {
    function getJsonObj(obj: CreateTargetResponderRecipeDetails): object;
    function getDeserializedJsonObj(obj: CreateTargetResponderRecipeDetails): object;
}

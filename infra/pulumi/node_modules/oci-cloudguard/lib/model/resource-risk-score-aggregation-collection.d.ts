...
export declare namespace ResourceRiskScoreAggregationCollection {
    function getJsonObj(obj: ResourceRiskScoreAggregationCollection): object;
    function getDeserializedJsonObj(obj: ResourceRiskScoreAggregationCollection): object;
}

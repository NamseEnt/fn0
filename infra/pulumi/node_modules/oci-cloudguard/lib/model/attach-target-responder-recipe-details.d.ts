...
export declare namespace AttachTargetResponderRecipeDetails {
    function getJsonObj(obj: AttachTargetResponderRecipeDetails): object;
    function getDeserializedJsonObj(obj: AttachTargetResponderRecipeDetails): object;
}

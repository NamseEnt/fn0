...
export declare namespace CandidateResponderRule {
    function getJsonObj(obj: CandidateResponderRule): object;
    function getDeserializedJsonObj(obj: CandidateResponderRule): object;
}

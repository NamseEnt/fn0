...
export declare namespace SecurityScoreAggregation {
    function getJsonObj(obj: SecurityScoreAggregation): object;
    function getDeserializedJsonObj(obj: SecurityScoreAggregation): object;
}

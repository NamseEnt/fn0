...
export declare namespace ResponderExecutionAggregation {
    function getJsonObj(obj: ResponderExecutionAggregation): object;
    function getDeserializedJsonObj(obj: ResponderExecutionAggregation): object;
}

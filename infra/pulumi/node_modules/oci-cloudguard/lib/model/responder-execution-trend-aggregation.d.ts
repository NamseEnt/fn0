...
export declare namespace ResponderExecutionTrendAggregation {
    function getJsonObj(obj: ResponderExecutionTrendAggregation): object;
    function getDeserializedJsonObj(obj: ResponderExecutionTrendAggregation): object;
}

...
export declare namespace ResourceProfileSummary {
    function getJsonObj(obj: ResourceProfileSummary): object;
    function getDeserializedJsonObj(obj: ResourceProfileSummary): object;
}

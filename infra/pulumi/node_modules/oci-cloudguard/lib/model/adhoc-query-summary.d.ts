...
export declare namespace AdhocQuerySummary {
    function getJsonObj(obj: AdhocQuerySummary): object;
    function getDeserializedJsonObj(obj: AdhocQuerySummary): object;
}

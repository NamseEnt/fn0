...
export declare namespace ConditionMetadataType {
    function getJsonObj(obj: ConditionMetadataType): object;
    function getDeserializedJsonObj(obj: ConditionMetadataType): object;
}

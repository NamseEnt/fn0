...
export declare namespace SecurityScoreTrendAggregation {
    function getJsonObj(obj: SecurityScoreTrendAggregation): object;
    function getDeserializedJsonObj(obj: SecurityScoreTrendAggregation): object;
}

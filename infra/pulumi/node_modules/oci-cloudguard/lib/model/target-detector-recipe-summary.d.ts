...
export declare namespace TargetDetectorRecipeSummary {
    function getJsonObj(obj: TargetDetectorRecipeSummary): object;
    function getDeserializedJsonObj(obj: TargetDetectorRecipeSummary): object;
}

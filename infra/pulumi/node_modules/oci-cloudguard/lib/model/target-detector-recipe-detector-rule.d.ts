...
export declare namespace TargetDetectorRecipeDetectorRule {
    ...
    function getJsonObj(obj: TargetDetectorRecipeDetectorRule): object;
    function getDeserializedJsonObj(obj: TargetDetectorRecipeDetectorRule): object;
}

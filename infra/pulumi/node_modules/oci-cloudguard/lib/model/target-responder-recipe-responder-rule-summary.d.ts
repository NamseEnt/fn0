...
export declare namespace TargetResponderRecipeResponderRuleSummary {
    enum SupportedModes {
    ...
    function getJsonObj(obj: TargetResponderRecipeResponderRuleSummary): object;
    function getDeserializedJsonObj(obj: TargetResponderRecipeResponderRuleSummary): object;
}

...
export declare namespace UpdateBulkProblemStatusDetails {
    function getJsonObj(obj: UpdateBulkProblemStatusDetails): object;
    function getDeserializedJsonObj(obj: UpdateBulkProblemStatusDetails): object;
}

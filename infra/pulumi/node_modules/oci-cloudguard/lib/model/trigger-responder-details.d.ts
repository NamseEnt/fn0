...
export declare namespace TriggerResponderDetails {
    function getJsonObj(obj: TriggerResponderDetails): object;
    function getDeserializedJsonObj(obj: TriggerResponderDetails): object;
}

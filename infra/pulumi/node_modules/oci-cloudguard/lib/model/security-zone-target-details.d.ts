...
export declare namespace SecurityZoneTargetDetails {
    function getJsonObj(obj: SecurityZoneTargetDetails, isParentJsonObj?: boolean): object;
    const targetResourceType = "SECURITY_ZONE";
    function getDeserializedJsonObj(obj: SecurityZoneTargetDetails, isParentJsonObj?: boolean): object;
}

...
export declare namespace UpdateTargetDetectorRecipeDetails {
    function getJsonObj(obj: UpdateTargetDetectorRecipeDetails): object;
    function getDeserializedJsonObj(obj: UpdateTargetDetectorRecipeDetails): object;
}

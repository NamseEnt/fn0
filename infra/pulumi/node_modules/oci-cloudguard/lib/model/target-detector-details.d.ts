...
export declare namespace TargetDetectorDetails {
    function getJsonObj(obj: TargetDetectorDetails): object;
    function getDeserializedJsonObj(obj: TargetDetectorDetails): object;
}

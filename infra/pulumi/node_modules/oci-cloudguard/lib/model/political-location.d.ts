...
export declare namespace PoliticalLocation {
    function getJsonObj(obj: PoliticalLocation): object;
    function getDeserializedJsonObj(obj: PoliticalLocation): object;
}

...
export declare namespace SimpleCondition {
    function getJsonObj(obj: SimpleCondition, isParentJsonObj?: boolean): object;
    const kind = "SIMPLE";
    function getDeserializedJsonObj(obj: SimpleCondition, isParentJsonObj?: boolean): object;
}

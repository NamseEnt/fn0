...
export declare namespace UpdateTargetResponderRecipeDetails {
    function getJsonObj(obj: UpdateTargetResponderRecipeDetails): object;
    function getDeserializedJsonObj(obj: UpdateTargetResponderRecipeDetails): object;
}

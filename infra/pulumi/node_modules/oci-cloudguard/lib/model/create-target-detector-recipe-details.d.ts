...
export declare namespace CreateTargetDetectorRecipeDetails {
    function getJsonObj(obj: CreateTargetDetectorRecipeDetails): object;
    function getDeserializedJsonObj(obj: CreateTargetDetectorRecipeDetails): object;
}

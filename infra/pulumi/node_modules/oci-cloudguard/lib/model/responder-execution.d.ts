...
export declare namespace ResponderExecution {
    function getJsonObj(obj: ResponderExecution): object;
    function getDeserializedJsonObj(obj: ResponderExecution): object;
}

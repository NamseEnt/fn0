...
export interface ListDigitalAssistantParametersResponse {
    /**
    ...
    /**
     * The returned model.DigitalAssistantParameterCollection instance.
     */
    "digitalAssistantParameterCollection": model.DigitalAssistantParameterCollection;
}

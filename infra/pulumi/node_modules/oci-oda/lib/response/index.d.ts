...
import * as CreateOdaPrivateEndpointResponse from "./create-oda-private-endpoint-response";
export import CreateOdaPrivateEndpointResponse = CreateOdaPrivateEndpointResponse.CreateOdaPrivateEndpointResponse;
import * as CreateOdaPrivateEndpointAttachmentResponse from "./create-oda-private-endpoint-attachment-response";
export import CreateOdaPrivateEndpointAttachmentResponse = CreateOdaPrivateEndpointAttachmentResponse.CreateOdaPrivateEndpointAttachmentResponse;
import * as CreateOdaPrivateEndpointScanProxyResponse from "./create-oda-private-endpoint-scan-proxy-response";
export import CreateOdaPrivateEndpointScanProxyResponse = CreateOdaPrivateEndpointScanProxyResponse.CreateOdaPrivateEndpointScanProxyResponse;
...
import * as DeleteOdaPrivateEndpointResponse from "./delete-oda-private-endpoint-response";
export import DeleteOdaPrivateEndpointResponse = DeleteOdaPrivateEndpointResponse.DeleteOdaPrivateEndpointResponse;
import * as DeleteOdaPrivateEndpointAttachmentResponse from "./delete-oda-private-endpoint-attachment-response";
export import DeleteOdaPrivateEndpointAttachmentResponse = DeleteOdaPrivateEndpointAttachmentResponse.DeleteOdaPrivateEndpointAttachmentResponse;
import * as DeleteOdaPrivateEndpointScanProxyResponse from "./delete-oda-private-endpoint-scan-proxy-response";
export import DeleteOdaPrivateEndpointScanProxyResponse = DeleteOdaPrivateEndpointScanProxyResponse.DeleteOdaPrivateEndpointScanProxyResponse;
...
import * as GetOdaPrivateEndpointResponse from "./get-oda-private-endpoint-response";
export import GetOdaPrivateEndpointResponse = GetOdaPrivateEndpointResponse.GetOdaPrivateEndpointResponse;
import * as GetOdaPrivateEndpointAttachmentResponse from "./get-oda-private-endpoint-attachment-response";
export import GetOdaPrivateEndpointAttachmentResponse = GetOdaPrivateEndpointAttachmentResponse.GetOdaPrivateEndpointAttachmentResponse;
import * as GetOdaPrivateEndpointScanProxyResponse from "./get-oda-private-endpoint-scan-proxy-response";
export import GetOdaPrivateEndpointScanProxyResponse = GetOdaPrivateEndpointScanProxyResponse.GetOdaPrivateEndpointScanProxyResponse;
...
import * as ListOdaPrivateEndpointAttachmentsResponse from "./list-oda-private-endpoint-attachments-response";
export import ListOdaPrivateEndpointAttachmentsResponse = ListOdaPrivateEndpointAttachmentsResponse.ListOdaPrivateEndpointAttachmentsResponse;
import * as ListOdaPrivateEndpointScanProxiesResponse from "./list-oda-private-endpoint-scan-proxies-response";
export import ListOdaPrivateEndpointScanProxiesResponse = ListOdaPrivateEndpointScanProxiesResponse.ListOdaPrivateEndpointScanProxiesResponse;
import * as ListOdaPrivateEndpointsResponse from "./list-oda-private-endpoints-response";
export import ListOdaPrivateEndpointsResponse = ListOdaPrivateEndpointsResponse.ListOdaPrivateEndpointsResponse;
...
import * as UpdateOdaPrivateEndpointResponse from "./update-oda-private-endpoint-response";
export import UpdateOdaPrivateEndpointResponse = UpdateOdaPrivateEndpointResponse.UpdateOdaPrivateEndpointResponse;

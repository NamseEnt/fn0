...
export interface ListOdaPrivateEndpointsResponse {
    /**
    ...
    /**
     * The returned model.OdaPrivateEndpointCollection instance.
     */
    "odaPrivateEndpointCollection": model.OdaPrivateEndpointCollection;
}

...
export interface CreateOdaPrivateEndpointAttachmentResponse {
    /**
    ...
    /**
     * The returned model.OdaPrivateEndpointAttachment instance.
     */
    "odaPrivateEndpointAttachment": model.OdaPrivateEndpointAttachment;
}

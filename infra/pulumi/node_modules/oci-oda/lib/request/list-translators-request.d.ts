...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/oda/ListTranslators.ts.html |here} to see how to use ListTranslatorsRequest.
 */
...
export declare namespace ListTranslatorsRequest {
    enum SortOrder {
        Asc = "ASC",
        Desc = "DESC"
    }

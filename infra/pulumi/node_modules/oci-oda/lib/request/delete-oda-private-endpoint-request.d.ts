...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/oda/DeleteOdaPrivateEndpoint.ts.html |here} to see how to use DeleteOdaPrivateEndpointRequest.
 */
export interface DeleteOdaPrivateEndpointRequest extends common.BaseRequest {
    /**

...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/oda/GetSkill.ts.html |here} to see how to use GetSkillRequest.
 */
export interface GetSkillRequest extends common.BaseRequest {
    /**

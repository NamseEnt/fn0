...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/oda/ListDigitalAssistantParameters.ts.html |here} to see how to use ListDigitalAssistantParametersRequest.
 */
...
export declare namespace ListDigitalAssistantParametersRequest {
    enum SortOrder {
        Asc = "ASC",
        Desc = "DESC"
    }

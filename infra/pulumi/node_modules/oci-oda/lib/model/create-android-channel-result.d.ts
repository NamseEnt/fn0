...
export declare namespace CreateAndroidChannelResult {
    function getJsonObj(obj: CreateAndroidChannelResult, isParentJsonObj?: boolean): object;
    const type = "ANDROID";
    function getDeserializedJsonObj(obj: CreateAndroidChannelResult, isParentJsonObj?: boolean): object;
}

...
export declare namespace OdaInstanceAttachment {
    enum AttachmentType {
        Fusion = "FUSION",
        Max = "MAX",
        /**
    ...
    function getJsonObj(obj: OdaInstanceAttachment): object;
    function getDeserializedJsonObj(obj: OdaInstanceAttachment): object;
}

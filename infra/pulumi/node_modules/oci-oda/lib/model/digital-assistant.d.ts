 ...
 */
export interface DigitalAssistant {
    /**
...
export declare namespace DigitalAssistant {
    function getJsonObj(obj: DigitalAssistant): object;
    function getDeserializedJsonObj(obj: DigitalAssistant): object;
}

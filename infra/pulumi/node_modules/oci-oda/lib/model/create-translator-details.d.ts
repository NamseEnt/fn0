...
export declare namespace CreateTranslatorDetails {
    function getJsonObj(obj: CreateTranslatorDetails): object;
    function getDeserializedJsonObj(obj: CreateTranslatorDetails): object;
}

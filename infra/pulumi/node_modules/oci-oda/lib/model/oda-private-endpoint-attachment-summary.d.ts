...
export declare namespace OdaPrivateEndpointAttachmentSummary {
    function getJsonObj(obj: OdaPrivateEndpointAttachmentSummary): object;
    function getDeserializedJsonObj(obj: OdaPrivateEndpointAttachmentSummary): object;
}

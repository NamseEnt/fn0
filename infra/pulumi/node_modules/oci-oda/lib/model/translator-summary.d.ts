 ...
 */
export interface TranslatorSummary {
    /**
...
export declare namespace TranslatorSummary {
    function getJsonObj(obj: TranslatorSummary): object;
    function getDeserializedJsonObj(obj: TranslatorSummary): object;
}

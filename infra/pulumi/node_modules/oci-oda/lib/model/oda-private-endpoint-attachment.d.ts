...
export declare namespace OdaPrivateEndpointAttachment {
    enum LifecycleState {
        Creating = "CREATING",
        Updating = "UPDATING",
        Active = "ACTIVE",
    ...
    function getJsonObj(obj: OdaPrivateEndpointAttachment): object;
    function getDeserializedJsonObj(obj: OdaPrivateEndpointAttachment): object;
}

...
export declare namespace UpdateServiceCloudChannelDetails {
    function getJsonObj(obj: UpdateServiceCloudChannelDetails, isParentJsonObj?: boolean): object;
    const type = "SERVICECLOUD";
    function getDeserializedJsonObj(obj: UpdateServiceCloudChannelDetails, isParentJsonObj?: boolean): object;
}

...
export declare namespace ImportedPackageSummary {
    function getJsonObj(obj: ImportedPackageSummary): object;
    function getDeserializedJsonObj(obj: ImportedPackageSummary): object;
}

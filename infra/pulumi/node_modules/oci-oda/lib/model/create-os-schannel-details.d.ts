 ...
 */
export interface CreateOSSChannelDetails extends model.CreateChannelDetails {
    /**
...
export declare namespace CreateOSSChannelDetails {
    function getJsonObj(obj: CreateOSSChannelDetails, isParentJsonObj?: boolean): object;
    const type = "OSS";
    function getDeserializedJsonObj(obj: CreateOSSChannelDetails, isParentJsonObj?: boolean): object;
}

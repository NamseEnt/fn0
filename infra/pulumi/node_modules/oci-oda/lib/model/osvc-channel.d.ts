 ...
 */
export interface OsvcChannel extends model.Channel {
    /**
     * The host.
     *
...
export declare namespace OsvcChannel {
    function getJsonObj(obj: OsvcChannel, isParentJsonObj?: boolean): object;
    const type = "OSVC";
    function getDeserializedJsonObj(obj: OsvcChannel, isParentJsonObj?: boolean): object;
}

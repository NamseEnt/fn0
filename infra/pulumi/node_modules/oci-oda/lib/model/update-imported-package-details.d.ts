...
export declare namespace UpdateImportedPackageDetails {
    function getJsonObj(obj: UpdateImportedPackageDetails): object;
    function getDeserializedJsonObj(obj: UpdateImportedPackageDetails): object;
}

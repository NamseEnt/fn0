...
export declare namespace AndroidChannel {
    function getJsonObj(obj: AndroidChannel, isParentJsonObj?: boolean): object;
    const type = "ANDROID";
    function getDeserializedJsonObj(obj: AndroidChannel, isParentJsonObj?: boolean): object;
}

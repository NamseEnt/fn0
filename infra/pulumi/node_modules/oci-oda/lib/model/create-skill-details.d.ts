...
export declare namespace CreateSkillDetails {
    function getJsonObj(obj: CreateSkillDetails): object;
    function getDeserializedJsonObj(obj: CreateSkillDetails): object;
}

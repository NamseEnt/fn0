 ...
 */
export interface ExtendSkillDetails extends model.CreateSkillDetails {
    /**
...
export declare namespace ExtendSkillDetails {
    function getJsonObj(obj: ExtendSkillDetails, isParentJsonObj?: boolean): object;
    const kind = "EXTEND";
    function getDeserializedJsonObj(obj: ExtendSkillDetails, isParentJsonObj?: boolean): object;
}

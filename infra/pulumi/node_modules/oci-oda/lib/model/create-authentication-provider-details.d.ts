 ...
 */
export interface CreateAuthenticationProviderDetails {
    /**
...
export declare namespace CreateAuthenticationProviderDetails {
    function getJsonObj(obj: CreateAuthenticationProviderDetails): object;
    function getDeserializedJsonObj(obj: CreateAuthenticationProviderDetails): object;
}

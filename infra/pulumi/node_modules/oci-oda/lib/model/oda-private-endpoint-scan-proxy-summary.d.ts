...
export declare namespace OdaPrivateEndpointScanProxySummary {
    function getJsonObj(obj: OdaPrivateEndpointScanProxySummary): object;
    function getDeserializedJsonObj(obj: OdaPrivateEndpointScanProxySummary): object;
}

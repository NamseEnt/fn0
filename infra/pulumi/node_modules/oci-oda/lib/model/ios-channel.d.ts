 ...
 */
export interface IosChannel extends model.Channel {
    /**
...
export declare namespace IosChannel {
    function getJsonObj(obj: IosChannel, isParentJsonObj?: boolean): object;
    const type = "IOS";
    function getDeserializedJsonObj(obj: IosChannel, isParentJsonObj?: boolean): object;
}

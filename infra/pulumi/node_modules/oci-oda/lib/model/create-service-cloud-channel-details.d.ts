 ...
 */
export interface CreateServiceCloudChannelDetails extends model.CreateChannelDetails {
    /**
     * The domain name.
     *
...
export declare namespace CreateServiceCloudChannelDetails {
    function getJsonObj(obj: CreateServiceCloudChannelDetails, isParentJsonObj?: boolean): object;
    const type = "SERVICECLOUD";
    function getDeserializedJsonObj(obj: CreateServiceCloudChannelDetails, isParentJsonObj?: boolean): object;
}

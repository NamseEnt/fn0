...
export declare namespace ManagementAgentPluginAggregation {
    function getJsonObj(obj: ManagementAgentPluginAggregation): object;
    function getDeserializedJsonObj(obj: ManagementAgentPluginAggregation): object;
}

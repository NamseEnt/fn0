...
export declare namespace ManagementAgentInstallKey {
    function getJsonObj(obj: ManagementAgentInstallKey): object;
    function getDeserializedJsonObj(obj: ManagementAgentInstallKey): object;
}

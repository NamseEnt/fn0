 ...
 *
 **/
export declare enum ValueCategoryType {
...
export declare namespace ValueCategoryType {
    function getJsonObj(obj: ValueCategoryType): ValueCategoryType;
    function getDeserializedJsonObj(obj: ValueCategoryType): ValueCategoryType;
}

...
export declare namespace UpdateManagementAgentInstallKeyDetails {
    function getJsonObj(obj: UpdateManagementAgentInstallKeyDetails): object;
    function getDeserializedJsonObj(obj: UpdateManagementAgentInstallKeyDetails): object;
}

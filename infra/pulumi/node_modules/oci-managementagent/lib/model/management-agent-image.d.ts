...
export declare namespace ManagementAgentImage {
    function getJsonObj(obj: ManagementAgentImage): object;
    function getDeserializedJsonObj(obj: ManagementAgentImage): object;
}

...
export declare namespace ManagementAgentSummary {
    function getJsonObj(obj: ManagementAgentSummary): object;
    function getDeserializedJsonObj(obj: ManagementAgentSummary): object;
}

...
export declare namespace ManagementAgentAggregation {
    function getJsonObj(obj: ManagementAgentAggregation): object;
    function getDeserializedJsonObj(obj: ManagementAgentAggregation): object;
}

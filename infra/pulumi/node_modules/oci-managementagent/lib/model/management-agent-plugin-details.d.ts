...
export declare namespace ManagementAgentPluginDetails {
    function getJsonObj(obj: ManagementAgentPluginDetails): object;
    function getDeserializedJsonObj(obj: ManagementAgentPluginDetails): object;
}

...
export declare namespace WorkSubmissionKey {
    function getJsonObj(obj: WorkSubmissionKey): object;
    function getDeserializedJsonObj(obj: WorkSubmissionKey): object;
}

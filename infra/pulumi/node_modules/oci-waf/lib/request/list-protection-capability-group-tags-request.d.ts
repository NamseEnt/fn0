...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/waf/ListProtectionCapabilityGroupTags.ts.html |here} to see how to use ListProtectionCapabilityGroupTagsRequest.
 */
...
export declare namespace ListProtectionCapabilityGroupTagsRequest {
    enum SortBy {
        Name = "name"
    }
}

...
export declare namespace ProtectionCapabilitySummary {
    enum Type {
    ...
    function getJsonObj(obj: ProtectionCapabilitySummary): object;
    function getDeserializedJsonObj(obj: ProtectionCapabilitySummary): object;
}

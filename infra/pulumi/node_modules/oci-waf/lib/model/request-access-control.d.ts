...
export declare namespace RequestAccessControl {
    function getJsonObj(obj: RequestAccessControl): object;
    function getDeserializedJsonObj(obj: RequestAccessControl): object;
}

 ...
 */
export interface UpdateWebAppFirewallDetails {
    /**
...
export declare namespace UpdateWebAppFirewallDetails {
    function getJsonObj(obj: UpdateWebAppFirewallDetails): object;
    function getDeserializedJsonObj(obj: UpdateWebAppFirewallDetails): object;
}

...
export declare namespace WebAppFirewallLoadBalancer {
    function getJsonObj(obj: WebAppFirewallLoadBalancer, isParentJsonObj?: boolean): object;
    const backendType = "LOAD_BALANCER";
    function getDeserializedJsonObj(obj: WebAppFirewallLoadBalancer, isParentJsonObj?: boolean): object;
}

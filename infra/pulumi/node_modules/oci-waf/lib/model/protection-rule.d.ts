...
export declare namespace ProtectionRule {
    function getJsonObj(obj: ProtectionRule, isParentJsonObj?: boolean): object;
    const type = "PROTECTION";
    function getDeserializedJsonObj(obj: ProtectionRule, isParentJsonObj?: boolean): object;
}

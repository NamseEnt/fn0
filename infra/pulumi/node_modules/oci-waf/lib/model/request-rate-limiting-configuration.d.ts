 ...
 */
export interface RequestRateLimitingConfiguration {
    /**
...
export declare namespace RequestRateLimitingConfiguration {
    function getJsonObj(obj: RequestRateLimitingConfiguration): object;
    function getDeserializedJsonObj(obj: RequestRateLimitingConfiguration): object;
}

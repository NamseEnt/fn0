...
export declare namespace WebAppFirewallPolicy {
    enum LifecycleState {
        Creating = "CREATING",
        Updating = "UPDATING",
        Active = "ACTIVE",
    ...
    function getJsonObj(obj: WebAppFirewallPolicy): object;
    function getDeserializedJsonObj(obj: WebAppFirewallPolicy): object;
}

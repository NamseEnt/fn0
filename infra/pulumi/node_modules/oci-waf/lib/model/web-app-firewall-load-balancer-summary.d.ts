...
export declare namespace WebAppFirewallLoadBalancerSummary {
    function getJsonObj(obj: WebAppFirewallLoadBalancerSummary, isParentJsonObj?: boolean): object;
    const backendType = "LOAD_BALANCER";
    function getDeserializedJsonObj(obj: WebAppFirewallLoadBalancerSummary, isParentJsonObj?: boolean): object;
}

...
export declare namespace CreateWebAppFirewallLoadBalancerDetails {
    function getJsonObj(obj: CreateWebAppFirewallLoadBalancerDetails, isParentJsonObj?: boolean): object;
    const backendType = "LOAD_BALANCER";
    function getDeserializedJsonObj(obj: CreateWebAppFirewallLoadBalancerDetails, isParentJsonObj?: boolean): object;
}

...
export declare namespace ProtectionCapabilitySettings {
    function getJsonObj(obj: ProtectionCapabilitySettings): object;
    function getDeserializedJsonObj(obj: ProtectionCapabilitySettings): object;
}

...
export declare namespace CreateWebAppFirewallDetails {
    function getJsonObj(obj: CreateWebAppFirewallDetails): object;
    function getDeserializedJsonObj(obj: CreateWebAppFirewallDetails): object;
}

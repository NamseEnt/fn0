...
export declare namespace RequestProtection {
    function getJsonObj(obj: RequestProtection): object;
    function getDeserializedJsonObj(obj: RequestProtection): object;
}

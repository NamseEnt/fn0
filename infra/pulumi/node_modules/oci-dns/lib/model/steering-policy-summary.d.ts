 ...
 *
 */
export interface SteeringPolicySummary {
    /**
...
export declare namespace SteeringPolicySummary {
    enum Template {
        Failover = "FAILOVER",
    ...
    function getJsonObj(obj: SteeringPolicySummary): object;
    function getDeserializedJsonObj(obj: SteeringPolicySummary): object;
}

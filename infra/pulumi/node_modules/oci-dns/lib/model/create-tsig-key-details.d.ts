...
export declare namespace CreateTsigKeyDetails {
    function getJsonObj(obj: CreateTsigKeyDetails): object;
    function getDeserializedJsonObj(obj: CreateTsigKeyDetails): object;
}

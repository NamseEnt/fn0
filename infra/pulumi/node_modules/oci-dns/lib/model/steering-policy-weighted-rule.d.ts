...
export interface SteeringPolicyWeightedRule extends model.SteeringPolicyRule {
    /**
     ...
     *
     */
    "cases"?: Array<model.SteeringPolicyWeightedRuleCase>;
    /**
     ...
     *
     */
    "defaultAnswerData"?: Array<model.SteeringPolicyWeightedAnswerData>;
    "ruleType": string;
}
export declare namespace SteeringPolicyWeightedRule {
    function getJsonObj(obj: SteeringPolicyWeightedRule, isParentJsonObj?: boolean): object;
    const ruleType = "WEIGHTED";
    function getDeserializedJsonObj(obj: SteeringPolicyWeightedRule, isParentJsonObj?: boolean): object;
}

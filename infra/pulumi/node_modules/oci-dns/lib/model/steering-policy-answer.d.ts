...
export declare namespace SteeringPolicyAnswer {
    function getJsonObj(obj: SteeringPolicyAnswer): object;
    function getDeserializedJsonObj(obj: SteeringPolicyAnswer): object;
}

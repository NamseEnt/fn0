...
export declare namespace SteeringPolicyAttachmentSummary {
    enum LifecycleState {
        Creating = "CREATING",
        Active = "ACTIVE",
        Deleting = "DELETING",
    ...
    function getJsonObj(obj: SteeringPolicyAttachmentSummary): object;
    function getDeserializedJsonObj(obj: SteeringPolicyAttachmentSummary): object;
}

...
export declare namespace ChangeSteeringPolicyCompartmentDetails {
    function getJsonObj(obj: ChangeSteeringPolicyCompartmentDetails): object;
    function getDeserializedJsonObj(obj: ChangeSteeringPolicyCompartmentDetails): object;
}

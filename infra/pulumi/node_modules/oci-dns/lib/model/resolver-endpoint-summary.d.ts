...
export declare namespace ResolverEndpointSummary {
    enum LifecycleState {
        Active = "ACTIVE",
        Creating = "CREATING",
        Deleted = "DELETED",
    ...
    function getJsonObj(obj: ResolverEndpointSummary): object;
    function getDeserializedJsonObj(obj: ResolverEndpointSummary): object;
}

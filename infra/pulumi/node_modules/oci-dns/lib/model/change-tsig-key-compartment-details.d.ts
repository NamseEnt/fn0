...
export declare namespace ChangeTsigKeyCompartmentDetails {
    function getJsonObj(obj: ChangeTsigKeyCompartmentDetails): object;
    function getDeserializedJsonObj(obj: ChangeTsigKeyCompartmentDetails): object;
}

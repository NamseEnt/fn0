...
export interface DynectMigrationDetails {
    ...
    "httpRedirectReplacements"?: {
        [key: string]: Array<model.MigrationReplacement>;
    };
}
export declare namespace DynectMigrationDetails {
    function getJsonObj(obj: DynectMigrationDetails): object;
    function getDeserializedJsonObj(obj: DynectMigrationDetails): object;
}

...
export declare namespace ResolverForwardRuleDetails {
    function getJsonObj(obj: ResolverForwardRuleDetails, isParentJsonObj?: boolean): object;
    const action = "FORWARD";
    function getDeserializedJsonObj(obj: ResolverForwardRuleDetails, isParentJsonObj?: boolean): object;
}

...
*
*/
export interface UpdateSteeringPolicyDetails {
    /**
...
export declare namespace UpdateSteeringPolicyDetails {
    enum Template {
        Failover = "FAILOVER",
    ...
    function getJsonObj(obj: UpdateSteeringPolicyDetails): object;
    function getDeserializedJsonObj(obj: UpdateSteeringPolicyDetails): object;
}

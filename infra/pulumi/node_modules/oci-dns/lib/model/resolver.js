...
(function (Resolver) {
    ...
    })(LifecycleState = Resolver.LifecycleState || (Resolver.LifecycleState = {}));
    function getJsonObj(obj) {
        const jsonObj = Object.assign(Object.assign({}, obj), {
            "endpoints": obj.endpoints
                ? obj.endpoints.map(item => {
                    return model.ResolverEndpointSummary.getJsonObj(item);
                })
                : undefined,
            "attachedViews": obj.attachedViews
                ? obj.attachedViews.map(item => {
                    return model.AttachedView.getJsonObj(item);
                })
                : undefined,
            "rules": obj.rules
                ? obj.rules.map(item => {
                    return model.ResolverRule.getJsonObj(item);
                })
                : undefined
        });
        return jsonObj;
    }
    Resolver.getJsonObj = getJsonObj;
    ...
    Resolver.getDeserializedJsonObj = getDeserializedJsonObj;

...
export declare namespace UpdateSteeringPolicyAttachmentDetails {
    function getJsonObj(obj: UpdateSteeringPolicyAttachmentDetails): object;
    function getDeserializedJsonObj(obj: UpdateSteeringPolicyAttachmentDetails): object;
}

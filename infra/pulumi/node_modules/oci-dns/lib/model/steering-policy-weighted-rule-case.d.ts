...
export declare namespace SteeringPolicyWeightedRuleCase {
    function getJsonObj(obj: SteeringPolicyWeightedRuleCase): object;
    function getDeserializedJsonObj(obj: SteeringPolicyWeightedRuleCase): object;
}

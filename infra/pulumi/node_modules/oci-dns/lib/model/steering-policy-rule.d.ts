...
export declare namespace SteeringPolicyRule {
    function getJsonObj(obj: SteeringPolicyRule): object;
    function getDeserializedJsonObj(obj: SteeringPolicyRule): object;
}

...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/dns/GetZoneRecords.ts.html |here} to see how to use GetZoneRecordsRequest.
 */
...
export declare namespace GetZoneRecordsRequest {
    enum SortBy {
        Domain = "domain",
        Rtype = "rtype",
        Ttl = "ttl"

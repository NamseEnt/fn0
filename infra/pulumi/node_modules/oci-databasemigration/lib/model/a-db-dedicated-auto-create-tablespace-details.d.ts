...
export declare namespace ADBDedicatedAutoCreateTablespaceDetails {
    function getJsonObj(obj: ADBDedicatedAutoCreateTablespaceDetails, isParentJsonObj?: boolean): object;
    const targetType = "ADB_D_AUTOCREATE";
    function getDeserializedJsonObj(obj: ADBDedicatedAutoCreateTablespaceDetails, isParentJsonObj?: boolean): object;
}

 ...
 *
 */
export interface UpdateNonADBAutoCreateTablespaceDetails extends model.UpdateTargetTypeTablespaceDetails {
    /**
...
export declare namespace UpdateNonADBAutoCreateTablespaceDetails {
    function getJsonObj(obj: UpdateNonADBAutoCreateTablespaceDetails, isParentJsonObj?: boolean): object;
    const targetType = "NON_ADB_AUTOCREATE";
    function getDeserializedJsonObj(obj: UpdateNonADBAutoCreateTablespaceDetails, isParentJsonObj?: boolean): object;
}

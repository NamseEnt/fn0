...
export declare namespace MigrationPhaseSummary {
    function getJsonObj(obj: MigrationPhaseSummary): object;
    function getDeserializedJsonObj(obj: MigrationPhaseSummary): object;
}

...
export declare namespace UpdateHostDumpTransferDetails {
    function getJsonObj(obj: UpdateHostDumpTransferDetails): object;
    function getDeserializedJsonObj(obj: UpdateHostDumpTransferDetails): object;
}

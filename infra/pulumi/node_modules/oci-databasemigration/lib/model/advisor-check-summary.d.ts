...
export declare namespace AdvisorCheckSummary {
    function getJsonObj(obj: AdvisorCheckSummary): object;
    function getDeserializedJsonObj(obj: AdvisorCheckSummary): object;
}

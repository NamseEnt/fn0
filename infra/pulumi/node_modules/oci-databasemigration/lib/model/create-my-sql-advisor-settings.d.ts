 ...
 */
export interface CreateMySqlAdvisorSettings {
    /**
...
export declare namespace CreateMySqlAdvisorSettings {
    function getJsonObj(obj: CreateMySqlAdvisorSettings): object;
    function getDeserializedJsonObj(obj: CreateMySqlAdvisorSettings): object;
}

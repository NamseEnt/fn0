...
(function (MigrationObjectCollection) {
    function getJsonObj(obj) {
        ...
        if (obj && "databaseCombination" in obj && obj.databaseCombination) {
            switch (obj.databaseCombination) {
                case "MYSQL":
                    return model.MySqlMigrationObjectCollection.getJsonObj(jsonObj, true);
                case "ORACLE":
                    return model.OracleMigrationObjectCollection.getJsonObj(jsonObj, true);
                default:
    ...
    function getDeserializedJsonObj(obj) {
        ...
        if (obj && "databaseCombination" in obj && obj.databaseCombination) {
            switch (obj.databaseCombination) {
                case "MYSQL":
                    return model.MySqlMigrationObjectCollection.getDeserializedJsonObj(jsonObj, true);
                case "ORACLE":
                    return model.OracleMigrationObjectCollection.getDeserializedJsonObj(jsonObj, true);
                default:
                    if (common.LOG.logger)
                        common.LOG.logger.info(`Unknown value for: ${obj.databaseCombination}`);
            }

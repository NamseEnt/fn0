 ...
 */
export interface OracleAdvisorSettings {
    /**
...
export declare namespace OracleAdvisorSettings {
    function getJsonObj(obj: OracleAdvisorSettings): object;
    function getDeserializedJsonObj(obj: OracleAdvisorSettings): object;
}

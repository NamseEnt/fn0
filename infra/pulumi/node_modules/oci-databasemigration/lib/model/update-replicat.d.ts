 ...
 *
 */
export interface UpdateReplicat {
    /**
...
export declare namespace UpdateReplicat {
    function getJsonObj(obj: UpdateReplicat): object;
    function getDeserializedJsonObj(obj: UpdateReplicat): object;
}

 ...
 */
export interface CreateDataPumpParameters {
    /**
...
export declare namespace CreateDataPumpParameters {
    function getJsonObj(obj: CreateDataPumpParameters): object;
    function getDeserializedJsonObj(obj: CreateDataPumpParameters): object;
}

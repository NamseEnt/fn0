 ...
 */
export interface UpdateOracleAdvisorSettings {
    /**
...
export declare namespace UpdateOracleAdvisorSettings {
    function getJsonObj(obj: UpdateOracleAdvisorSettings): object;
    function getDeserializedJsonObj(obj: UpdateOracleAdvisorSettings): object;
}

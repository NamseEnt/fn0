...
export declare namespace HostDumpTransferDetails {
    function getJsonObj(obj: HostDumpTransferDetails): object;
    function getDeserializedJsonObj(obj: HostDumpTransferDetails): object;
}

...
export declare namespace AssessmentSummary {
    function getJsonObj(obj: AssessmentSummary): object;
    function getDeserializedJsonObj(obj: AssessmentSummary): object;
}

...
export declare namespace CloneMigrationDetails {
    function getJsonObj(obj: CloneMigrationDetails): object;
    function getDeserializedJsonObj(obj: CloneMigrationDetails): object;
}

...
export declare namespace CreateParameterFileVersionDetails {
    function getJsonObj(obj: CreateParameterFileVersionDetails): object;
    function getDeserializedJsonObj(obj: CreateParameterFileVersionDetails): object;
}

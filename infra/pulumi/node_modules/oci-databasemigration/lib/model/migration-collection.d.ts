...
export declare namespace MigrationCollection {
    function getJsonObj(obj: MigrationCollection): object;
    function getDeserializedJsonObj(obj: MigrationCollection): object;
}

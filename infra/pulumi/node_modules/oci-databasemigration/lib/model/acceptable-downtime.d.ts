 ...
 **/
export declare enum AcceptableDowntime {
...
export declare namespace AcceptableDowntime {
    function getJsonObj(obj: AcceptableDowntime): AcceptableDowntime;
    function getDeserializedJsonObj(obj: AcceptableDowntime): AcceptableDowntime;
}

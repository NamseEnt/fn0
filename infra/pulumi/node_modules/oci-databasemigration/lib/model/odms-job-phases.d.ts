 ...
 *
 **/
export declare enum OdmsJobPhases {
...
export declare namespace OdmsJobPhases {
    function getJsonObj(obj: OdmsJobPhases): OdmsJobPhases;
    function getDeserializedJsonObj(obj: OdmsJobPhases): OdmsJobPhases;
}

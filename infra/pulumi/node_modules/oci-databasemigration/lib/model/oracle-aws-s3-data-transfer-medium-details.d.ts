 ...
 *
 */
export interface OracleAwsS3DataTransferMediumDetails extends model.OracleDataTransferMediumDetails {
    /**
     * S3 bucket name.
     */
    "name"?: string;
...
export declare namespace OracleAwsS3DataTransferMediumDetails {
    function getJsonObj(obj: OracleAwsS3DataTransferMediumDetails, isParentJsonObj?: boolean): object;
    const type = "AWS_S3";
    function getDeserializedJsonObj(obj: OracleAwsS3DataTransferMediumDetails, isParentJsonObj?: boolean): object;
}

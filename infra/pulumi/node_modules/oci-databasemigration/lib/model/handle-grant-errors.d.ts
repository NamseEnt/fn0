 ...
 *
 **/
export declare enum HandleGrantErrors {
    Abort = "ABORT",
...
export declare namespace HandleGrantErrors {
    function getJsonObj(obj: HandleGrantErrors): HandleGrantErrors;
    function getDeserializedJsonObj(obj: HandleGrantErrors): HandleGrantErrors;
}

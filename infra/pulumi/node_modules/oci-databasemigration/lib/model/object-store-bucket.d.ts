...
export declare namespace ObjectStoreBucket {
    function getJsonObj(obj: ObjectStoreBucket): object;
    function getDeserializedJsonObj(obj: ObjectStoreBucket): object;
}

...
export declare namespace ADBServerlesTablespaceDetails {
    enum RemapTarget {
        Data = "DATA",
        /**
    ...
    function getJsonObj(obj: ADBServerlesTablespaceDetails, isParentJsonObj?: boolean): object;
    const targetType = "ADB_S_REMAP";
    function getDeserializedJsonObj(obj: ADBServerlesTablespaceDetails, isParentJsonObj?: boolean): object;
}

 ...
 */
export interface MySqlAdvisorSettings {
    /**
...
export declare namespace MySqlAdvisorSettings {
    function getJsonObj(obj: MySqlAdvisorSettings): object;
    function getDeserializedJsonObj(obj: MySqlAdvisorSettings): object;
}

...
export declare class DatabaseMigrationWaiter {
    private client;
    private readonly config?;
    constructor(client: DatabaseMigrationClient, config?: Partial<import("oci-common/lib/waiter").WaiterConfigurationDetails> | undefined);
    /**
     ...
     */
    forAssessment(request: serviceRequests.GetAssessmentRequest, ...targetStates: models.AssessmentLifecycleStates[]): Promise<serviceResponses.GetAssessmentResponse | null>;
    /**
     ...
     */
    forAssessor(request: serviceRequests.GetAssessorRequest, ...targetStates: models.AssessorLifecycleStates[]): Promise<serviceResponses.GetAssessorResponse>;
    /**
     ...
     */
    forJob(request: serviceRequests.GetJobRequest, ...targetStates: models.JobLifecycleStates[]): Promise<serviceResponses.GetJobResponse | null>;
    /**

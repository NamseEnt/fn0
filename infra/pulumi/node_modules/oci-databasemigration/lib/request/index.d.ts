...
import * as AddAssessmentObjectsRequest from "./add-assessment-objects-request";
export import AddAssessmentObjectsRequest = AddAssessmentObjectsRequest.AddAssessmentObjectsRequest;
...
import * as ChangeAssessmentCompartmentRequest from "./change-assessment-compartment-request";
export import ChangeAssessmentCompartmentRequest = ChangeAssessmentCompartmentRequest.ChangeAssessmentCompartmentRequest;
...
import * as CloneAssessmentRequest from "./clone-assessment-request";
export import CloneAssessmentRequest = CloneAssessmentRequest.CloneAssessmentRequest;
...
import * as CreateAssessmentRequest from "./create-assessment-request";
export import CreateAssessmentRequest = CreateAssessmentRequest.CreateAssessmentRequest;
...
import * as DeleteAssessmentRequest from "./delete-assessment-request";
export import DeleteAssessmentRequest = DeleteAssessmentRequest.DeleteAssessmentRequest;
...
import * as GetAssessmentRequest from "./get-assessment-request";
export import GetAssessmentRequest = GetAssessmentRequest.GetAssessmentRequest;
import * as GetAssessorRequest from "./get-assessor-request";
export import GetAssessorRequest = GetAssessorRequest.GetAssessorRequest;
import * as GetAssessorCheckRequest from "./get-assessor-check-request";
export import GetAssessorCheckRequest = GetAssessorCheckRequest.GetAssessorCheckRequest;
...
import * as ListAdvisorReportCheckObjectsRequest from "./list-advisor-report-check-objects-request";
export import ListAdvisorReportCheckObjectsRequest = ListAdvisorReportCheckObjectsRequest.ListAdvisorReportCheckObjectsRequest;
import * as ListAdvisorReportChecksRequest from "./list-advisor-report-checks-request";
export import ListAdvisorReportChecksRequest = ListAdvisorReportChecksRequest.ListAdvisorReportChecksRequest;
import * as ListAffectedObjectsRequest from "./list-affected-objects-request";
export import ListAffectedObjectsRequest = ListAffectedObjectsRequest.ListAffectedObjectsRequest;
import * as ListAssessmentObjectTypesRequest from "./list-assessment-object-types-request";
export import ListAssessmentObjectTypesRequest = ListAssessmentObjectTypesRequest.ListAssessmentObjectTypesRequest;
import * as ListAssessmentObjectsRequest from "./list-assessment-objects-request";
export import ListAssessmentObjectsRequest = ListAssessmentObjectsRequest.ListAssessmentObjectsRequest;
import * as ListAssessmentsRequest from "./list-assessments-request";
export import ListAssessmentsRequest = ListAssessmentsRequest.ListAssessmentsRequest;
import * as ListAssessorChecksRequest from "./list-assessor-checks-request";
export import ListAssessorChecksRequest = ListAssessorChecksRequest.ListAssessorChecksRequest;
import * as ListAssessorsRequest from "./list-assessors-request";
export import ListAssessorsRequest = ListAssessorsRequest.ListAssessorsRequest;
...
import * as ListDatabaseConnectionTypeRequest from "./list-database-connection-type-request";
export import ListDatabaseConnectionTypeRequest = ListDatabaseConnectionTypeRequest.ListDatabaseConnectionTypeRequest;
...
import * as PerformAssessorActionRequest from "./perform-assessor-action-request";
export import PerformAssessorActionRequest = PerformAssessorActionRequest.PerformAssessorActionRequest;
import * as PerformAssessorActionDownloadSqlRequest from "./perform-assessor-action-download-sql-request";
export import PerformAssessorActionDownloadSqlRequest = PerformAssessorActionDownloadSqlRequest.PerformAssessorActionDownloadSqlRequest;
import * as PerformAssessorCheckActionRequest from "./perform-assessor-check-action-request";
export import PerformAssessorCheckActionRequest = PerformAssessorCheckActionRequest.PerformAssessorCheckActionRequest;
import * as RemoveAssessmentObjectsRequest from "./remove-assessment-objects-request";
export import RemoveAssessmentObjectsRequest = RemoveAssessmentObjectsRequest.RemoveAssessmentObjectsRequest;
...
import * as UpdateAdvisorReportCheckRequest from "./update-advisor-report-check-request";
export import UpdateAdvisorReportCheckRequest = UpdateAdvisorReportCheckRequest.UpdateAdvisorReportCheckRequest;
import * as UpdateAdvisorReportCheckObjectsRequest from "./update-advisor-report-check-objects-request";
export import UpdateAdvisorReportCheckObjectsRequest = UpdateAdvisorReportCheckObjectsRequest.UpdateAdvisorReportCheckObjectsRequest;
import * as UpdateAssessmentRequest from "./update-assessment-request";
export import UpdateAssessmentRequest = UpdateAssessmentRequest.UpdateAssessmentRequest;
import * as UpdateCheckActionUpdateObjectRequest from "./update-check-action-update-object-request";
export import UpdateCheckActionUpdateObjectRequest = UpdateCheckActionUpdateObjectRequest.UpdateCheckActionUpdateObjectRequest;

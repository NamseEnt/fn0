...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/datacatalog/GetTermRelationship.ts.html |here} to see how to use GetTermRelationshipRequest.
 */
export interface GetTermRelationshipRequest extends common.BaseRequest {
     ...
     *
     */
    "fields"?: Array<GetTermRelationshipRequest.Fields>;
    /**
     * The client request ID for tracing.
     */
    "opcRequestId"?: string;
}
export declare namespace GetTermRelationshipRequest {
    enum Fields {
        Key = "key",

...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/datacatalog/GetJobDefinition.ts.html |here} to see how to use GetJobDefinitionRequest.
 */
...
export declare namespace GetJobDefinitionRequest {
    enum Fields {
        Key = "key",

...
(function (ListCustomPropertiesRequest) {
    ...
    (function (TypeName) {
        ...
        TypeName["OracleAnalyticsSubjectAreaColumn"] = "ORACLE_ANALYTICS_SUBJECT_AREA_COLUMN";
        TypeName["OracleAnalyticsLogicalColumn"] = "ORACLE_ANALYTICS_LOGICAL_COLUMN";
        TypeName["OracleAnalyticsPhysicalColumn"] = "ORACLE_ANALYTICS_PHYSICAL_COLUMN";
        TypeName["OracleAnalyticsAnalysisColumn"] = "ORACLE_ANALYTICS_ANALYSIS_COLUMN";
        TypeName["OracleAnalyticsServer"] = "ORACLE_ANALYTICS_SERVER";
        TypeName["OracleAnalyticsCloud"] = "ORACLE_ANALYTICS_CLOUD";
        TypeName["OracleAnalyticsSubjectArea"] = "ORACLE_ANALYTICS_SUBJECT_AREA";
        TypeName["OracleAnalyticsDashboard"] = "ORACLE_ANALYTICS_DASHBOARD";
        TypeName["OracleAnalyticsBusinessModel"] = "ORACLE_ANALYTICS_BUSINESS_MODEL";
        TypeName["OracleAnalyticsPhysicalDatabase"] = "ORACLE_ANALYTICS_PHYSICAL_DATABASE";
        TypeName["OracleAnalyticsPhysicalSchema"] = "ORACLE_ANALYTICS_PHYSICAL_SCHEMA";
        TypeName["OracleAnalyticsPresentationTable"] = "ORACLE_ANALYTICS_PRESENTATION_TABLE";
        TypeName["OracleAnalyticsLogicalTable"] = "ORACLE_ANALYTICS_LOGICAL_TABLE";
        TypeName["OracleAnalyticsPhysicalTable"] = "ORACLE_ANALYTICS_PHYSICAL_TABLE";
        TypeName["OracleAnalyticsAnalysis"] = "ORACLE_ANALYTICS_ANALYSIS";
        TypeName["DatabaseSchema"] = "DATABASE_SCHEMA";
        TypeName["Topic"] = "TOPIC";

...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/datacatalog/ListTermRelationships.ts.html |here} to see how to use ListTermRelationshipsRequest.
 */
...
export declare namespace ListTermRelationshipsRequest {
    enum Fields {
        Key = "key",

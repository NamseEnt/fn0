...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/datacatalog/ListJobMetrics.ts.html |here} to see how to use ListJobMetricsRequest.
 */
...
export declare namespace ListJobMetricsRequest {
    enum Fields {
        Key = "key",

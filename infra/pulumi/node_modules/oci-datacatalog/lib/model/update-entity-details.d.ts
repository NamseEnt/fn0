...
export declare namespace UpdateEntityDetails {
    function getJsonObj(obj: UpdateEntityDetails): object;
    function getDeserializedJsonObj(obj: UpdateEntityDetails): object;
}

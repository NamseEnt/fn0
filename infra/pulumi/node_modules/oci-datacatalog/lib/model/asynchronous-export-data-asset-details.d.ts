...
export declare namespace AsynchronousExportDataAssetDetails {
    function getJsonObj(obj: AsynchronousExportDataAssetDetails): object;
    function getDeserializedJsonObj(obj: AsynchronousExportDataAssetDetails): object;
}

...
export declare namespace ValidatePatternDetails {
    function getJsonObj(obj: ValidatePatternDetails): object;
    function getDeserializedJsonObj(obj: ValidatePatternDetails): object;
}

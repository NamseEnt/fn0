...
export declare namespace CatalogPrivateEndpoint {
    function getJsonObj(obj: CatalogPrivateEndpoint): object;
    function getDeserializedJsonObj(obj: CatalogPrivateEndpoint): object;
}

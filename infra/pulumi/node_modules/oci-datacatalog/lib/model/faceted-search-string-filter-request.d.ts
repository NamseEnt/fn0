...
export declare namespace FacetedSearchStringFilterRequest {
    function getJsonObj(obj: FacetedSearchStringFilterRequest): object;
    function getDeserializedJsonObj(obj: FacetedSearchStringFilterRequest): object;
}

...
export declare namespace CustomPropertySummary {
    function getJsonObj(obj: CustomPropertySummary): object;
    function getDeserializedJsonObj(obj: CustomPropertySummary): object;
}

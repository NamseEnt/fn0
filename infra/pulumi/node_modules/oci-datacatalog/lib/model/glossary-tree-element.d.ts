...
export declare namespace GlossaryTreeElement {
    function getJsonObj(obj: GlossaryTreeElement): object;
    function getDeserializedJsonObj(obj: GlossaryTreeElement): object;
}

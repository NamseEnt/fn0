 ...
 */
export interface UpdatePatternDetails {
    /**
...
export declare namespace UpdatePatternDetails {
    function getJsonObj(obj: UpdatePatternDetails): object;
    function getDeserializedJsonObj(obj: UpdatePatternDetails): object;
}

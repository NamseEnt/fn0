...
export declare namespace ObjectRelationship {
    function getJsonObj(obj: ObjectRelationship): object;
    function getDeserializedJsonObj(obj: ObjectRelationship): object;
}

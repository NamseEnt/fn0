...
export declare namespace CreateGlossaryDetails {
    function getJsonObj(obj: CreateGlossaryDetails): object;
    function getDeserializedJsonObj(obj: CreateGlossaryDetails): object;
}

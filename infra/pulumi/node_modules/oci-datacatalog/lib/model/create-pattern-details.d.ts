...
export declare namespace CreatePatternDetails {
    function getJsonObj(obj: CreatePatternDetails): object;
    function getDeserializedJsonObj(obj: CreatePatternDetails): object;
}

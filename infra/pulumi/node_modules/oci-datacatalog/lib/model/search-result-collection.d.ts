...
export declare namespace SearchResultCollection {
    function getJsonObj(obj: SearchResultCollection): object;
    function getDeserializedJsonObj(obj: SearchResultCollection): object;
}

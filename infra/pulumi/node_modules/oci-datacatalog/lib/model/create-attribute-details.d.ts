...
export declare namespace CreateAttributeDetails {
    function getJsonObj(obj: CreateAttributeDetails): object;
    function getDeserializedJsonObj(obj: CreateAttributeDetails): object;
}

...
export declare namespace PatternCollection {
    function getJsonObj(obj: PatternCollection): object;
    function getDeserializedJsonObj(obj: PatternCollection): object;
}

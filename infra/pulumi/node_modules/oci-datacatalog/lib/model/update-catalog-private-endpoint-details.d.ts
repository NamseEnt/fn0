...
export declare namespace UpdateCatalogPrivateEndpointDetails {
    function getJsonObj(obj: UpdateCatalogPrivateEndpointDetails): object;
    function getDeserializedJsonObj(obj: UpdateCatalogPrivateEndpointDetails): object;
}

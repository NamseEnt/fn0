...
export declare namespace RecommendationStatus {
    function getJsonObj(obj: RecommendationStatus): RecommendationStatus;
    function getDeserializedJsonObj(obj: RecommendationStatus): RecommendationStatus;
}

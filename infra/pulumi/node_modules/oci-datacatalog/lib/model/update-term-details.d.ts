...
export declare namespace UpdateTermDetails {
    function getJsonObj(obj: UpdateTermDetails): object;
    function getDeserializedJsonObj(obj: UpdateTermDetails): object;
}

...
export declare namespace SearchTermSummary {
    function getJsonObj(obj: SearchTermSummary): object;
    function getDeserializedJsonObj(obj: SearchTermSummary): object;
}

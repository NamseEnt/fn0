...
export declare namespace CatalogPrivateEndpointSummary {
    function getJsonObj(obj: CatalogPrivateEndpointSummary): object;
    function getDeserializedJsonObj(obj: CatalogPrivateEndpointSummary): object;
}

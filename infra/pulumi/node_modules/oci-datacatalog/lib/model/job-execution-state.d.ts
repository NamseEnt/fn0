 ...
 *
 **/
export declare enum JobExecutionState {
    Created = "CREATED",
...
export declare namespace JobExecutionState {
    function getJsonObj(obj: JobExecutionState): JobExecutionState;
    function getDeserializedJsonObj(obj: JobExecutionState): JobExecutionState;
}

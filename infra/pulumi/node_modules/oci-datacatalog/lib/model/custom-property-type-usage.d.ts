...
export declare namespace CustomPropertyTypeUsage {
    function getJsonObj(obj: CustomPropertyTypeUsage): object;
    function getDeserializedJsonObj(obj: CustomPropertyTypeUsage): object;
}

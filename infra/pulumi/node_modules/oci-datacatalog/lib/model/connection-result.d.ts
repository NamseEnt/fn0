...
export declare namespace ConnectionResult {
    function getJsonObj(obj: ConnectionResult): ConnectionResult;
    function getDeserializedJsonObj(obj: ConnectionResult): ConnectionResult;
}

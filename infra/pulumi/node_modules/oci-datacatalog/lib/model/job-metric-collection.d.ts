...
export declare namespace JobMetricCollection {
    function getJsonObj(obj: JobMetricCollection): object;
    function getDeserializedJsonObj(obj: JobMetricCollection): object;
}

 ...
 *
 */
export interface DataAssetTagCollection {
    /**
     ...
     */
    "items": Array<model.DataAssetTagSummary>;
}
export declare namespace DataAssetTagCollection {
    function getJsonObj(obj: DataAssetTagCollection): object;
    function getDeserializedJsonObj(obj: DataAssetTagCollection): object;
}

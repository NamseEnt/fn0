 ...
 */
export interface DataAssetTagSummary {
    /**
...
export declare namespace DataAssetTagSummary {
    function getJsonObj(obj: DataAssetTagSummary): object;
    function getDeserializedJsonObj(obj: DataAssetTagSummary): object;
}

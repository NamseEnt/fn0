...
export declare namespace CustomPropertyDataType {
    function getJsonObj(obj: CustomPropertyDataType): CustomPropertyDataType;
    function getDeserializedJsonObj(obj: CustomPropertyDataType): CustomPropertyDataType;
}

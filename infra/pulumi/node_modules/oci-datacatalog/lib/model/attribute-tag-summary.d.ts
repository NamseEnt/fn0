 ...
 */
export interface AttributeTagSummary {
    /**
...
export declare namespace AttributeTagSummary {
    function getJsonObj(obj: AttributeTagSummary): object;
    function getDeserializedJsonObj(obj: AttributeTagSummary): object;
}

...
export declare namespace JobDefinitionCollection {
    function getJsonObj(obj: JobDefinitionCollection): object;
    function getDeserializedJsonObj(obj: JobDefinitionCollection): object;
}

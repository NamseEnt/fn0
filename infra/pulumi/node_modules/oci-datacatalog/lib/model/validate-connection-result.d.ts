...
export declare namespace ValidateConnectionResult {
    function getJsonObj(obj: ValidateConnectionResult): object;
    function getDeserializedJsonObj(obj: ValidateConnectionResult): object;
}

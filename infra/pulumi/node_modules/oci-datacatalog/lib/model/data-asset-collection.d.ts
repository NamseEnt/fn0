...
export declare namespace DataAssetCollection {
    function getJsonObj(obj: DataAssetCollection): object;
    function getDeserializedJsonObj(obj: DataAssetCollection): object;
}

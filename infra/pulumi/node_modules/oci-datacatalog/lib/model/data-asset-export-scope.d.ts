...
export declare namespace DataAssetExportScope {
    function getJsonObj(obj: DataAssetExportScope): object;
    function getDeserializedJsonObj(obj: DataAssetExportScope): object;
}

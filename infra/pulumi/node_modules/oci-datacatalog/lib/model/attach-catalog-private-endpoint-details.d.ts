...
export declare namespace AttachCatalogPrivateEndpointDetails {
    function getJsonObj(obj: AttachCatalogPrivateEndpointDetails): object;
    function getDeserializedJsonObj(obj: AttachCatalogPrivateEndpointDetails): object;
}

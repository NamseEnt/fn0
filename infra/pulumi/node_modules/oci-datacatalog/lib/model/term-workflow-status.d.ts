 ...
 *
 **/
export declare enum TermWorkflowStatus {
    New = "NEW",
    Approved = "APPROVED",
...
export declare namespace TermWorkflowStatus {
    function getJsonObj(obj: TermWorkflowStatus): TermWorkflowStatus;
    function getDeserializedJsonObj(obj: TermWorkflowStatus): TermWorkflowStatus;
}

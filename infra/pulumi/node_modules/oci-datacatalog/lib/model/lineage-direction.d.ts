 ...
 *
 **/
export declare enum LineageDirection {
    Upstream = "UPSTREAM",
    Both = "BOTH",
...
export declare namespace LineageDirection {
    function getJsonObj(obj: LineageDirection): LineageDirection;
    function getDeserializedJsonObj(obj: LineageDirection): LineageDirection;
}

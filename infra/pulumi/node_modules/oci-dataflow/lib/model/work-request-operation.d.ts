 ...
 *
 **/
export declare enum WorkRequestOperation {
...
export declare namespace WorkRequestOperation {
    function getJsonObj(obj: WorkRequestOperation): WorkRequestOperation;
    function getDeserializedJsonObj(obj: WorkRequestOperation): WorkRequestOperation;
}

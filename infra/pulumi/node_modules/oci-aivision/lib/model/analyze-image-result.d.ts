...
export declare namespace AnalyzeImageResult {
    function getJsonObj(obj: AnalyzeImageResult): object;
    function getDeserializedJsonObj(obj: AnalyzeImageResult): object;
}

...
export declare namespace ValueNumber {
    function getJsonObj(obj: ValueNumber, isParentJsonObj?: boolean): object;
    const valueType = "NUMBER";
    function getDeserializedJsonObj(obj: ValueNumber, isParentJsonObj?: boolean): object;
}

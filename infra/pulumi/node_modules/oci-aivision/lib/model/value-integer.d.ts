...
export declare namespace ValueInteger {
    function getJsonObj(obj: ValueInteger, isParentJsonObj?: boolean): object;
    const valueType = "INTEGER";
    function getDeserializedJsonObj(obj: ValueInteger, isParentJsonObj?: boolean): object;
}

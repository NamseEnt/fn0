...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/datascience/ListMlApplicationImplementations.ts.html |here} to see how to use ListMlApplicationImplementationsRequest.
 */
export interface ListMlApplicationImplementationsRequest extends common.BaseRequest {
    /**
...
export declare namespace ListMlApplicationImplementationsRequest {
    enum SortOrder {
        Asc = "ASC",
        Desc = "DESC"
    }

...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/datascience/ListModelGroupVersionHistories.ts.html |here} to see how to use ListModelGroupVersionHistoriesRequest.
 */
export interface ListModelGroupVersionHistoriesRequest extends common.BaseRequest {
    /**
...
export declare namespace ListModelGroupVersionHistoriesRequest {
    enum SortOrder {
        Asc = "ASC",
        Desc = "DESC"
    }

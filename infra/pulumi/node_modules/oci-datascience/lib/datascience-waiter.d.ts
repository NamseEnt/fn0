...
export declare class DataScienceWaiter {
     ...
     */
    forModelGroup(request: serviceRequests.GetModelGroupRequest, ...targetStates: models.ModelGroupLifecycleState[]): Promise<serviceResponses.GetModelGroupResponse | null>;
    /**
     ...
     */
    forModelGroupVersionHistory(request: serviceRequests.GetModelGroupVersionHistoryRequest, ...targetStates: models.ModelGroupVersionHistoryLifecycleState[]): Promise<serviceResponses.GetModelGroupVersionHistoryResponse | null>;
    /**
     ...
     */
    forSchedule(request: serviceRequests.GetScheduleRequest, ...targetStates: models.ScheduleLifecycleState[]): Promise<serviceResponses.GetScheduleResponse | null>;
    /**

...
(function (PatchInstruction) {
    function getJsonObj(obj) {
        ...
        if (obj && "operation" in obj && obj.operation) {
            switch (obj.operation) {
                case "REMOVE":
                    return model.PatchRemoveMemberModels.getJsonObj(jsonObj, true);
                case "INSERT":
                    return model.PatchInsertNewMemberModels.getJsonObj(jsonObj, true);
                default:
    ...
    function getDeserializedJsonObj(obj) {
        ...
        if (obj && "operation" in obj && obj.operation) {
            switch (obj.operation) {
                case "REMOVE":
                    return model.PatchRemoveMemberModels.getDeserializedJsonObj(jsonObj, true);
                case "INSERT":
                    return model.PatchInsertNewMemberModels.getDeserializedJsonObj(jsonObj, true);
                default:
                    if (common.LOG.logger)
                        common.LOG.logger.info(`Unknown value for: ${obj.operation}`);
            }

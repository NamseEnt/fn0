 ...
 */
export interface InstancePoolInfrastructureConfigurationDetails extends model.InfrastructureConfigurationDetails {
...
export declare namespace InstancePoolInfrastructureConfigurationDetails {
    function getJsonObj(obj: InstancePoolInfrastructureConfigurationDetails, isParentJsonObj?: boolean): object;
    const infrastructureType = "INSTANCE_POOL";
    function getDeserializedJsonObj(obj: InstancePoolInfrastructureConfigurationDetails, isParentJsonObj?: boolean): object;
}

...
export declare namespace IdcsCustomServiceAuthConfiguration {
    function getJsonObj(obj: IdcsCustomServiceAuthConfiguration, isParentJsonObj?: boolean): object;
    const type = "IDCS_CUSTOM_SERVICE";
    function getDeserializedJsonObj(obj: IdcsCustomServiceAuthConfiguration, isParentJsonObj?: boolean): object;
}

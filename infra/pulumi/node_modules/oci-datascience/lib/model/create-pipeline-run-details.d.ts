...
export declare namespace CreatePipelineRunDetails {
    function getJsonObj(obj: CreatePipelineRunDetails): object;
    function getDeserializedJsonObj(obj: CreatePipelineRunDetails): object;
}

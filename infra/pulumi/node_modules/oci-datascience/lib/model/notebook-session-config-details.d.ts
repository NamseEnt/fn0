...
export declare namespace NotebookSessionConfigDetails {
    function getJsonObj(obj: NotebookSessionConfigDetails): object;
    function getDeserializedJsonObj(obj: NotebookSessionConfigDetails): object;
}

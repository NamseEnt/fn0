 ...
 */
export interface OcirModelDeploymentEnvironmentConfigurationDetails extends model.ModelDeploymentEnvironmentConfigurationDetails {
    /**
...
export declare namespace OcirModelDeploymentEnvironmentConfigurationDetails {
    function getJsonObj(obj: OcirModelDeploymentEnvironmentConfigurationDetails, isParentJsonObj?: boolean): object;
    const environmentConfigurationType = "OCIR_CONTAINER";
    function getDeserializedJsonObj(obj: OcirModelDeploymentEnvironmentConfigurationDetails, isParentJsonObj?: boolean): object;
}

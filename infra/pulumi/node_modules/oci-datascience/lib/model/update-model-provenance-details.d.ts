 ...
 */
export interface UpdateModelProvenanceDetails {
    /**
...
export declare namespace UpdateModelProvenanceDetails {
    function getJsonObj(obj: UpdateModelProvenanceDetails): object;
    function getDeserializedJsonObj(obj: UpdateModelProvenanceDetails): object;
}

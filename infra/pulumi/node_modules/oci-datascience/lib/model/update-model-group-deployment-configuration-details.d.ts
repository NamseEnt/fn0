 ...
 */
export interface UpdateModelGroupDeploymentConfigurationDetails extends model.UpdateModelDeploymentConfigurationDetails {
    /**
...
export declare namespace UpdateModelGroupDeploymentConfigurationDetails {
    enum UpdateType {
        Zdt = "ZDT",
        Live = "LIVE"
    }
    function getJsonObj(obj: UpdateModelGroupDeploymentConfigurationDetails, isParentJsonObj?: boolean): object;
    const deploymentType = "MODEL_GROUP";
    function getDeserializedJsonObj(obj: UpdateModelGroupDeploymentConfigurationDetails, isParentJsonObj?: boolean): object;
}

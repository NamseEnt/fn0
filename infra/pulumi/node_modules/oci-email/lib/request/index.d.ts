...
import * as AddEmailIpPoolLockRequest from "./add-email-ip-pool-lock-request";
export import AddEmailIpPoolLockRequest = AddEmailIpPoolLockRequest.AddEmailIpPoolLockRequest;
import * as AddEmailOutboundIpRequest from "./add-email-outbound-ip-request";
export import AddEmailOutboundIpRequest = AddEmailOutboundIpRequest.AddEmailOutboundIpRequest;
...
import * as ChangeEmailIpPoolCompartmentRequest from "./change-email-ip-pool-compartment-request";
export import ChangeEmailIpPoolCompartmentRequest = ChangeEmailIpPoolCompartmentRequest.ChangeEmailIpPoolCompartmentRequest;
...
import * as CreateEmailIpPoolRequest from "./create-email-ip-pool-request";
export import CreateEmailIpPoolRequest = CreateEmailIpPoolRequest.CreateEmailIpPoolRequest;
import * as CreateEmailReturnPathRequest from "./create-email-return-path-request";
export import CreateEmailReturnPathRequest = CreateEmailReturnPathRequest.CreateEmailReturnPathRequest;
...
import * as DeleteEmailIpPoolRequest from "./delete-email-ip-pool-request";
export import DeleteEmailIpPoolRequest = DeleteEmailIpPoolRequest.DeleteEmailIpPoolRequest;
import * as DeleteEmailReturnPathRequest from "./delete-email-return-path-request";
export import DeleteEmailReturnPathRequest = DeleteEmailReturnPathRequest.DeleteEmailReturnPathRequest;
...
import * as GetEmailIpPoolRequest from "./get-email-ip-pool-request";
export import GetEmailIpPoolRequest = GetEmailIpPoolRequest.GetEmailIpPoolRequest;
import * as GetEmailReturnPathRequest from "./get-email-return-path-request";
export import GetEmailReturnPathRequest = GetEmailReturnPathRequest.GetEmailReturnPathRequest;
...
import * as ListEmailIpPoolsRequest from "./list-email-ip-pools-request";
export import ListEmailIpPoolsRequest = ListEmailIpPoolsRequest.ListEmailIpPoolsRequest;
import * as ListEmailOutboundIpsRequest from "./list-email-outbound-ips-request";
export import ListEmailOutboundIpsRequest = ListEmailOutboundIpsRequest.ListEmailOutboundIpsRequest;
import * as ListEmailReturnPathsRequest from "./list-email-return-paths-request";
export import ListEmailReturnPathsRequest = ListEmailReturnPathsRequest.ListEmailReturnPathsRequest;
...
import * as RemoveEmailIpPoolLockRequest from "./remove-email-ip-pool-lock-request";
export import RemoveEmailIpPoolLockRequest = RemoveEmailIpPoolLockRequest.RemoveEmailIpPoolLockRequest;
import * as RemoveEmailOutboundIpRequest from "./remove-email-outbound-ip-request";
export import RemoveEmailOutboundIpRequest = RemoveEmailOutboundIpRequest.RemoveEmailOutboundIpRequest;
...
import * as UpdateEmailIpPoolRequest from "./update-email-ip-pool-request";
export import UpdateEmailIpPoolRequest = UpdateEmailIpPoolRequest.UpdateEmailIpPoolRequest;
import * as UpdateEmailReturnPathRequest from "./update-email-return-path-request";
export import UpdateEmailReturnPathRequest = UpdateEmailReturnPathRequest.UpdateEmailReturnPathRequest;

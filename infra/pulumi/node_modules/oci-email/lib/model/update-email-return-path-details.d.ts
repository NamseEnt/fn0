 ...
 *
 */
export interface UpdateEmailReturnPathDetails {
    /**
...
export declare namespace UpdateEmailReturnPathDetails {
    function getJsonObj(obj: UpdateEmailReturnPathDetails): object;
    function getDeserializedJsonObj(obj: UpdateEmailReturnPathDetails): object;
}

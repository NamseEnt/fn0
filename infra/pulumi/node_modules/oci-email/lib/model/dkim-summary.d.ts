...
export interface DkimSummary {
  ...
  *
    ...
    "isImported"?: boolean;
    /**
     * Length of the RSA key used in the DKIM. Note: Numbers greater than Number.MAX_SAFE_INTEGER will result in rounding issues.
     */
    "keyLength"?: number;
    /**
...
export declare namespace DkimSummary {
    function getJsonObj(obj: DkimSummary): object;
    function getDeserializedJsonObj(obj: DkimSummary): object;
}

...
export declare namespace UpdateDkimDetails {
    function getJsonObj(obj: UpdateDkimDetails): object;
    function getDeserializedJsonObj(obj: UpdateDkimDetails): object;
}

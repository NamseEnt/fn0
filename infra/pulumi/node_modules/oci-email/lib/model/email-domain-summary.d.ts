...
export declare namespace EmailDomainSummary {
    function getJsonObj(obj: EmailDomainSummary): object;
    function getDeserializedJsonObj(obj: EmailDomainSummary): object;
}

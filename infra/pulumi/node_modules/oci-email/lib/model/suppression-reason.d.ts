...
export declare namespace SuppressionReason {
    function getJsonObj(obj: SuppressionReason): SuppressionReason;
    function getDeserializedJsonObj(obj: SuppressionReason): SuppressionReason;
}

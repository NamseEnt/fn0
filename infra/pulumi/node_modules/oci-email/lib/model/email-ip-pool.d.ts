...
export interface EmailIpPool {
  ...
  *
     ...
     */
    "lifecycleState"?: EmailIpPool.LifecycleState;
    /**
...
export declare namespace EmailIpPool {
    enum LifecycleState {
        Creating = "CREATING",
        Updating = "UPDATING",
        Active = "ACTIVE",
    ...
    function getJsonObj(obj: EmailIpPool): object;
    function getDeserializedJsonObj(obj: EmailIpPool): object;
}

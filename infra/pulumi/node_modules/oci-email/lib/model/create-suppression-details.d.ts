...
export declare namespace CreateSuppressionDetails {
    function getJsonObj(obj: CreateSuppressionDetails): object;
    function getDeserializedJsonObj(obj: CreateSuppressionDetails): object;
}

 ...
 */
export interface EmailIpPoolCollection {
    /**
     * List of IpPools.
     */
    "items": Array<model.EmailIpPoolSummary>;
}
export declare namespace EmailIpPoolCollection {
    function getJsonObj(obj: EmailIpPoolCollection): object;
    function getDeserializedJsonObj(obj: EmailIpPoolCollection): object;
}

...
export declare namespace SuppressionSummary {
    function getJsonObj(obj: SuppressionSummary): object;
    function getDeserializedJsonObj(obj: SuppressionSummary): object;
}

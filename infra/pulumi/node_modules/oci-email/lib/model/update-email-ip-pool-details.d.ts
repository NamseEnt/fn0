...
export declare namespace UpdateEmailIpPoolDetails {
    function getJsonObj(obj: UpdateEmailIpPoolDetails): object;
    function getDeserializedJsonObj(obj: UpdateEmailIpPoolDetails): object;
}

...
export declare namespace CreateDkimDetails {
    function getJsonObj(obj: CreateDkimDetails): object;
    function getDeserializedJsonObj(obj: CreateDkimDetails): object;
}

 ...
 */
export interface ChangeEmailIpPoolCompartmentDetails {
    /**
...
export declare namespace ChangeEmailIpPoolCompartmentDetails {
    function getJsonObj(obj: ChangeEmailIpPoolCompartmentDetails): object;
    function getDeserializedJsonObj(obj: ChangeEmailIpPoolCompartmentDetails): object;
}

...
export declare namespace CreateEmailIpPoolDetails {
    function getJsonObj(obj: CreateEmailIpPoolDetails): object;
    function getDeserializedJsonObj(obj: CreateEmailIpPoolDetails): object;
}

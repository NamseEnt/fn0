 ...
 *
 */
export interface UpdateSenderDetails {
    /**
...
export declare namespace UpdateSenderDetails {
    function getJsonObj(obj: UpdateSenderDetails): object;
    function getDeserializedJsonObj(obj: UpdateSenderDetails): object;
}

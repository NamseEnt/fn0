...
export declare namespace EmailOutboundIpSummary {
    enum LifecycleState {
        Updating = "UPDATING",
        Active = "ACTIVE",
        Failed = "FAILED",
    ...
    function getJsonObj(obj: EmailOutboundIpSummary): object;
    function getDeserializedJsonObj(obj: EmailOutboundIpSummary): object;
}

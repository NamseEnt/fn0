 ...
 */
export interface EmailReturnPathCollection {
    /**
     * List of email return paths.
     */
    "items": Array<model.EmailReturnPathSummary>;
}
export declare namespace EmailReturnPathCollection {
    function getJsonObj(obj: EmailReturnPathCollection): object;
    function getDeserializedJsonObj(obj: EmailReturnPathCollection): object;
}

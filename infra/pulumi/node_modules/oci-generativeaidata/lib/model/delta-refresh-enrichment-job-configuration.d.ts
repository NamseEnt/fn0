...
export declare namespace DeltaRefreshEnrichmentJobConfiguration {
    function getJsonObj(obj: DeltaRefreshEnrichmentJobConfiguration, isParentJsonObj?: boolean): object;
    const enrichmentJobType = "DELTA_REFRESH";
    function getDeserializedJsonObj(obj: DeltaRefreshEnrichmentJobConfiguration, isParentJsonObj?: boolean): object;
}

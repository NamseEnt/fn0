...
export declare namespace GenerateSqlFromNlDetails {
    function getJsonObj(obj: GenerateSqlFromNlDetails): object;
    function getDeserializedJsonObj(obj: GenerateSqlFromNlDetails): object;
}

 ...
 **/
export declare enum EnrichmentJobType {
...
export declare namespace EnrichmentJobType {
    function getJsonObj(obj: EnrichmentJobType): EnrichmentJobType;
    function getDeserializedJsonObj(obj: EnrichmentJobType): EnrichmentJobType;
}

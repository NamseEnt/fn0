...
export declare namespace EnrichmentJobSummary {
    function getJsonObj(obj: EnrichmentJobSummary): object;
    function getDeserializedJsonObj(obj: EnrichmentJobSummary): object;
}

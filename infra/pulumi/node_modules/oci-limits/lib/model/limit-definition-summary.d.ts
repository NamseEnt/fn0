...
export declare namespace LimitDefinitionSummary {
    enum ScopeType {
        Global = "GLOBAL",
        Region = "REGION",
        Ad = "AD",
    ...
    function getJsonObj(obj: LimitDefinitionSummary): object;
    function getDeserializedJsonObj(obj: LimitDefinitionSummary): object;
}

 ...
 *
 **/
export declare enum OperatorActionCategories {
...
export declare namespace OperatorActionCategories {
    function getJsonObj(obj: OperatorActionCategories): OperatorActionCategories;
    function getDeserializedJsonObj(obj: OperatorActionCategories): OperatorActionCategories;
}

...
export declare namespace CreateOperatorControlAssignmentDetails {
    function getJsonObj(obj: CreateOperatorControlAssignmentDetails): object;
    function getDeserializedJsonObj(obj: CreateOperatorControlAssignmentDetails): object;
}

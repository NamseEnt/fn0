...
export declare namespace InteractionCollection {
    function getJsonObj(obj: InteractionCollection): object;
    function getDeserializedJsonObj(obj: InteractionCollection): object;
}

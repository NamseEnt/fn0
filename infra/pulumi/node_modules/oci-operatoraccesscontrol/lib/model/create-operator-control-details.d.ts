...
export declare namespace CreateOperatorControlDetails {
    function getJsonObj(obj: CreateOperatorControlDetails): object;
    function getDeserializedJsonObj(obj: CreateOperatorControlDetails): object;
}

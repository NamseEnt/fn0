...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/operatoraccesscontrol/ListOperatorControlAssignments.ts.html |here} to see how to use ListOperatorControlAssignmentsRequest.
 */
...
export declare namespace ListOperatorControlAssignmentsRequest {
    enum SortBy {

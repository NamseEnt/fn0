...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/operatoraccesscontrol/ListOperatorControls.ts.html |here} to see how to use ListOperatorControlsRequest.
 */
...
export declare namespace ListOperatorControlsRequest {
    enum SortBy {

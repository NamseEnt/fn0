...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/lockbox/ExportAccessRequests.ts.html |here} to see how to use ExportAccessRequestsRequest.
 */
...
export declare namespace ExportAccessRequestsRequest {
    enum SortBy {

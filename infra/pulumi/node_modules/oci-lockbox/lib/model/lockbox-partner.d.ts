 ...
 **/
export declare enum LockboxPartner {
    Faaas = "FAAAS",
    Canary = "CANARY",
    /**
...
export declare namespace LockboxPartner {
    function getJsonObj(obj: LockboxPartner): LockboxPartner;
    function getDeserializedJsonObj(obj: LockboxPartner): LockboxPartner;
}

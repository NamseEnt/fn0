 ...
 */
export interface AccessRequestCollection {
    /**
     * List of AccessRequestSummary.
     */
    "items": Array<model.AccessRequestSummary>;
}
export declare namespace AccessRequestCollection {
    function getJsonObj(obj: AccessRequestCollection): object;
    function getDeserializedJsonObj(obj: AccessRequestCollection): object;
}

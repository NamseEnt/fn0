 ...
 **/
export declare enum AccessRequestActionType {
    Approve = "APPROVE",
    Deny = "DENY",
    Revoke = "REVOKE",
    Cancel = "CANCEL",
...
export declare namespace AccessRequestActionType {
    function getJsonObj(obj: AccessRequestActionType): AccessRequestActionType;
    function getDeserializedJsonObj(obj: AccessRequestActionType): AccessRequestActionType;
}

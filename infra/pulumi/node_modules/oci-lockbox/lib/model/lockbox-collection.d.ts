...
export declare namespace LockboxCollection {
    function getJsonObj(obj: LockboxCollection): object;
    function getDeserializedJsonObj(obj: LockboxCollection): object;
}

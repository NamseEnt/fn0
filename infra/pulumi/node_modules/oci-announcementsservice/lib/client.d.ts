...
export declare class AnnouncementClient {
  ...
  *
     ...
     */
    getAnnouncementCompartment(getAnnouncementCompartmentRequest: requests.GetAnnouncementCompartmentRequest): Promise<responses.GetAnnouncementCompartmentResponse>;
    /**
...
export declare class AnnouncementsPreferencesClient {
  ...
  *
     ...
     */
    listAllAnnouncementsPreferences(request: requests.ListAnnouncementsPreferencesRequest): AsyncIterableIterator<model.AnnouncementsPreferencesSummary>;
    /**
     ...
     * @param request a request which can be sent to the service operation
     */
    listAnnouncementsPreferencesRecordIterator(request: requests.ListAnnouncementsPreferencesRequest): AsyncIterableIterator<model.AnnouncementsPreferencesSummary>;
    /**
     * Creates a new async iterator which will iterate over the responses received from the listAnnouncementsPreferences operation. This iterator
     * will fetch more data from the server as needed.
     *
...
export declare enum ServiceApiKeys {
}
/**
 * This service client uses {@link common.CircuitBreaker.DefaultConfiguration} for all the operations by default if no circuit breaker configuration is defined by the user.
 */

...
export declare namespace OccDemandSignalSummary {
    function getJsonObj(obj: OccDemandSignalSummary): object;
    function getDeserializedJsonObj(obj: OccDemandSignalSummary): object;
}

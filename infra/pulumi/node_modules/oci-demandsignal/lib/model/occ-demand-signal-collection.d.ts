 ...
 */
export interface OccDemandSignalCollection {
    /**
     * List of occDemandSignals.
     */
    "items": Array<model.OccDemandSignalSummary>;
}
export declare namespace OccDemandSignalCollection {
    function getJsonObj(obj: OccDemandSignalCollection): object;
    function getDeserializedJsonObj(obj: OccDemandSignalCollection): object;
}

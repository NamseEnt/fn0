...
export interface CreateClusterPlacementGroupRequest extends common.BaseRequest {
     ...
     */
    "createClusterPlacementGroupDetails": model.CreateClusterPlacementGroupDetails;
    /**
    ...
    "opcRequestId"?: string;
    /**
     * When set to {@code true}, the request performs validation on the submitted data without modifying configuration item details.
     *
     */
    "opcDryRun"?: boolean;
}

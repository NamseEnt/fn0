...
export declare class VirtualNetworkWaiter {
     ...
     */
    forAddIpv4SubnetCidr(request: serviceRequests.AddIpv4SubnetCidrRequest): Promise<{
     ...
     */
    forBulkCreateIpv6s(request: serviceRequests.BulkCreateIpv6sRequest): Promise<{
     ...
     */
    forBulkCreatePrivateIps(request: serviceRequests.BulkCreatePrivateIpsRequest): Promise<{
     ...
     */
    forBulkDeleteIpv6s(request: serviceRequests.BulkDeleteIpv6sRequest): Promise<{
     ...
     */
    forBulkDeletePrivateIps(request: serviceRequests.BulkDeletePrivateIpsRequest): Promise<{
     ...
     */
    forBulkDetachIpv6s(request: serviceRequests.BulkDetachIpv6sRequest): Promise<{
     ...
     */
    forBulkDetachPrivateIps(request: serviceRequests.BulkDetachPrivateIpsRequest): Promise<{
     ...
     */
    forBulkUpdateIpv6s(request: serviceRequests.BulkUpdateIpv6sRequest): Promise<{
     ...
     */
    forBulkUpdatePrivateIps(request: serviceRequests.BulkUpdatePrivateIpsRequest): Promise<{
     ...
     */
    forByoasn(request: serviceRequests.GetByoasnRequest, ...targetStates: models.Byoasn.LifecycleState[]): Promise<serviceResponses.GetByoasnResponse | null>;
    /**
     ...
     */
    forGetVcnOverlap(request: serviceRequests.GetVcnOverlapRequest): Promise<{
     ...
     */
    forListIpInventory(request: serviceRequests.ListIpInventoryRequest): Promise<{
     ...
     */
    forModifyIpv4SubnetCidr(request: serviceRequests.ModifyIpv4SubnetCidrRequest): Promise<{
     ...
     */
    forRemoveIpv4SubnetCidr(request: serviceRequests.RemoveIpv4SubnetCidrRequest): Promise<{
     ...
     */
    forSetOriginAsn(request: serviceRequests.SetOriginAsnRequest): Promise<{
     ...
     */
    forValidateByoasn(request: serviceRequests.ValidateByoasnRequest): Promise<{

...
export declare class ComputeWaiter {
     ...
     */
    forApplyHostConfiguration(request: serviceRequests.ApplyHostConfigurationRequest): Promise<{
     ...
     */
    forComputeImageCapabilitySchema(request: serviceRequests.GetComputeImageCapabilitySchemaRequest, ...targetStates: models.ComputeImageCapabilitySchema.LifecycleState[]): Promise<serviceResponses.GetComputeImageCapabilitySchemaResponse | null>;
    /**
     ...
     */
    forFirmwareBundle(request: serviceRequests.GetFirmwareBundleRequest, ...targetStates: models.FirmwareBundle.LifecycleState[]): Promise<serviceResponses.GetFirmwareBundleResponse>;
    /**
     ...
     */
    forUpdateComputeHosts(request: serviceRequests.UpdateComputeHostsRequest): Promise<{

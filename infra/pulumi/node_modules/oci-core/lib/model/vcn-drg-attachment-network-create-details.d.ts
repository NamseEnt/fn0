 ...
 */
export interface VcnDrgAttachmentNetworkCreateDetails extends model.DrgAttachmentNetworkCreateDetails {
    /**
...
export declare namespace VcnDrgAttachmentNetworkCreateDetails {
    function getJsonObj(obj: VcnDrgAttachmentNetworkCreateDetails, isParentJsonObj?: boolean): object;
    const type = "VCN";
    function getDeserializedJsonObj(obj: VcnDrgAttachmentNetworkCreateDetails, isParentJsonObj?: boolean): object;
}

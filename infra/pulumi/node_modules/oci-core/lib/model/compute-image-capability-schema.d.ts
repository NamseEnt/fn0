...
export declare namespace ComputeImageCapabilitySchema {
    enum LifecycleState {
        Creating = "CREATING",
        Active = "ACTIVE",
        Deleted = "DELETED",
    ...
    function getJsonObj(obj: ComputeImageCapabilitySchema): object;
    function getDeserializedJsonObj(obj: ComputeImageCapabilitySchema): object;
}

...
export declare namespace ShapeNetworkingBandwidthOptions {
    function getJsonObj(obj: ShapeNetworkingBandwidthOptions): object;
    function getDeserializedJsonObj(obj: ShapeNetworkingBandwidthOptions): object;
}

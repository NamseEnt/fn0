...
export declare namespace CreateByoipRangeDetails {
    function getJsonObj(obj: CreateByoipRangeDetails): object;
    function getDeserializedJsonObj(obj: CreateByoipRangeDetails): object;
}

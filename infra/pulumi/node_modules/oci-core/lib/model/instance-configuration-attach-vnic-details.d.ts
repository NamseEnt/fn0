...
export declare namespace InstanceConfigurationAttachVnicDetails {
    function getJsonObj(obj: InstanceConfigurationAttachVnicDetails): object;
    function getDeserializedJsonObj(obj: InstanceConfigurationAttachVnicDetails): object;
}

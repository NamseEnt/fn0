...
export declare namespace AttachVnicDetails {
    function getJsonObj(obj: AttachVnicDetails): object;
    function getDeserializedJsonObj(obj: AttachVnicDetails): object;
}

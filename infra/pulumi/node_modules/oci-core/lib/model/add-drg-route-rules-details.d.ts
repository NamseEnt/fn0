...
export declare namespace AddDrgRouteRulesDetails {
    function getJsonObj(obj: AddDrgRouteRulesDetails): object;
    function getDeserializedJsonObj(obj: AddDrgRouteRulesDetails): object;
}

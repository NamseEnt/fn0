...
export declare namespace VolumeGroupReplicaDetails {
    function getJsonObj(obj: VolumeGroupReplicaDetails): object;
    function getDeserializedJsonObj(obj: VolumeGroupReplicaDetails): object;
}

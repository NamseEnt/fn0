 ...
 */
export interface CreateInstancePoolPlacementConfigurationDetails {
    /**
...
export declare namespace CreateInstancePoolPlacementConfigurationDetails {
    function getJsonObj(obj: CreateInstancePoolPlacementConfigurationDetails): object;
    function getDeserializedJsonObj(obj: CreateInstancePoolPlacementConfigurationDetails): object;
}

 ...
 *
 */
export interface AmdMilanBmGpuLaunchInstancePlatformConfig extends model.LaunchInstancePlatformConfig {
    /**
     * The number of NUMA nodes per socket (NPS).
     *
     */
    "numaNodesPerSocket"?: AmdMilanBmGpuLaunchInstancePlatformConfig.NumaNodesPerSocket;
    /**
...
export declare namespace AmdMilanBmGpuLaunchInstancePlatformConfig {
    ...
    function getJsonObj(obj: AmdMilanBmGpuLaunchInstancePlatformConfig, isParentJsonObj?: boolean): object;
    const type = "AMD_MILAN_BM_GPU";
    function getDeserializedJsonObj(obj: AmdMilanBmGpuLaunchInstancePlatformConfig, isParentJsonObj?: boolean): object;
}

...
export declare namespace TopologyContainsEntityRelationship {
    function getJsonObj(obj: TopologyContainsEntityRelationship, isParentJsonObj?: boolean): object;
    const type = "CONTAINS";
    function getDeserializedJsonObj(obj: TopologyContainsEntityRelationship, isParentJsonObj?: boolean): object;
}

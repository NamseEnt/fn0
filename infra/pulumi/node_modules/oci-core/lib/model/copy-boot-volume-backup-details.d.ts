 ...
 */
export interface CopyBootVolumeBackupDetails {
    /**
...
export declare namespace CopyBootVolumeBackupDetails {
    function getJsonObj(obj: CopyBootVolumeBackupDetails): object;
    function getDeserializedJsonObj(obj: CopyBootVolumeBackupDetails): object;
}

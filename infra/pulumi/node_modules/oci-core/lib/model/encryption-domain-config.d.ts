...
export declare namespace EncryptionDomainConfig {
    function getJsonObj(obj: EncryptionDomainConfig): object;
    function getDeserializedJsonObj(obj: EncryptionDomainConfig): object;
}

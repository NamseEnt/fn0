 ...
 *
 */
export interface ComputeHpcIslandSummary {
    /**
...
export declare namespace ComputeHpcIslandSummary {
    function getJsonObj(obj: ComputeHpcIslandSummary): object;
    function getDeserializedJsonObj(obj: ComputeHpcIslandSummary): object;
}

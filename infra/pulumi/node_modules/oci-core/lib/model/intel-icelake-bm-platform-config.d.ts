 ...
 *
 */
export interface IntelIcelakeBmPlatformConfig extends model.PlatformConfig {
    /**
     * The number of NUMA nodes per socket (NPS).
     *
     */
    "numaNodesPerSocket"?: IntelIcelakeBmPlatformConfig.NumaNodesPerSocket;
    /**
...
export declare namespace IntelIcelakeBmPlatformConfig {
    ...
    function getJsonObj(obj: IntelIcelakeBmPlatformConfig, isParentJsonObj?: boolean): object;
    const type = "INTEL_ICELAKE_BM";
    function getDeserializedJsonObj(obj: IntelIcelakeBmPlatformConfig, isParentJsonObj?: boolean): object;
}

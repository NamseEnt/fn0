 ...
 *
 */
export interface UpdateVolumeBackupPolicyDetails {
    /**
...
export declare namespace UpdateVolumeBackupPolicyDetails {
    function getJsonObj(obj: UpdateVolumeBackupPolicyDetails): object;
    function getDeserializedJsonObj(obj: UpdateVolumeBackupPolicyDetails): object;
}

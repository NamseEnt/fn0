 ...
 *
 */
export interface AmdRomeBmGpuLaunchInstancePlatformConfig extends model.LaunchInstancePlatformConfig {
    /**
...
export declare namespace AmdRomeBmGpuLaunchInstancePlatformConfig {
    ...
    function getJsonObj(obj: AmdRomeBmGpuLaunchInstancePlatformConfig, isParentJsonObj?: boolean): object;
    const type = "AMD_ROME_BM_GPU";
    function getDeserializedJsonObj(obj: AmdRomeBmGpuLaunchInstancePlatformConfig, isParentJsonObj?: boolean): object;
}

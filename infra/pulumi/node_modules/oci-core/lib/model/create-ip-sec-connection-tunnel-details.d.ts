...
export declare namespace CreateIPSecConnectionTunnelDetails {
    enum Routing {
        Bgp = "BGP",
        Static = "STATIC",
        Policy = "POLICY"
    ...
    function getJsonObj(obj: CreateIPSecConnectionTunnelDetails): object;
    function getDeserializedJsonObj(obj: CreateIPSecConnectionTunnelDetails): object;
}

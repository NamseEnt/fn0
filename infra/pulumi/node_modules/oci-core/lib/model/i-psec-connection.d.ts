...
export declare namespace IPSecConnection {
    enum LifecycleState {
    ...
    function getJsonObj(obj: IPSecConnection): object;
    function getDeserializedJsonObj(obj: IPSecConnection): object;
}

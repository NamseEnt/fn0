...
export declare namespace CreateSecurityListDetails {
    function getJsonObj(obj: CreateSecurityListDetails): object;
    function getDeserializedJsonObj(obj: CreateSecurityListDetails): object;
}

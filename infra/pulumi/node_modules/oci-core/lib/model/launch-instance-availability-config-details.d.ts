 ...
 *
 */
export interface LaunchInstanceAvailabilityConfigDetails {
    /**
     ...
     *
     */
    "recoveryAction"?: LaunchInstanceAvailabilityConfigDetails.RecoveryAction;
}
export declare namespace LaunchInstanceAvailabilityConfigDetails {
    enum RecoveryAction {
        RestoreInstance = "RESTORE_INSTANCE",
        StopInstance = "STOP_INSTANCE"
    }
    function getJsonObj(obj: LaunchInstanceAvailabilityConfigDetails): object;
    function getDeserializedJsonObj(obj: LaunchInstanceAvailabilityConfigDetails): object;
}

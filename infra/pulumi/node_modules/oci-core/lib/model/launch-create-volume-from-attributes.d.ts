...
export declare namespace LaunchCreateVolumeFromAttributes {
    function getJsonObj(obj: LaunchCreateVolumeFromAttributes, isParentJsonObj?: boolean): object;
    const volumeCreationType = "ATTRIBUTES";
    function getDeserializedJsonObj(obj: LaunchCreateVolumeFromAttributes, isParentJsonObj?: boolean): object;
}

...
export declare namespace ComputeGlobalImageCapabilitySchemaSummary {
    function getJsonObj(obj: ComputeGlobalImageCapabilitySchemaSummary): object;
    function getDeserializedJsonObj(obj: ComputeGlobalImageCapabilitySchemaSummary): object;
}

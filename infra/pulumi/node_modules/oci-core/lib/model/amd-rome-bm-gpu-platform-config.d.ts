...
export declare namespace AmdRomeBmGpuPlatformConfig {
    ...
    function getJsonObj(obj: AmdRomeBmGpuPlatformConfig, isParentJsonObj?: boolean): object;
    const type = "AMD_ROME_BM_GPU";
    function getDeserializedJsonObj(obj: AmdRomeBmGpuPlatformConfig, isParentJsonObj?: boolean): object;
}

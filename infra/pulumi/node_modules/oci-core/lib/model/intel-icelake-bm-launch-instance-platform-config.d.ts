 ...
 *
 */
export interface IntelIcelakeBmLaunchInstancePlatformConfig extends model.LaunchInstancePlatformConfig {
    /**
     * The number of NUMA nodes per socket (NPS).
     *
     */
    "numaNodesPerSocket"?: IntelIcelakeBmLaunchInstancePlatformConfig.NumaNodesPerSocket;
    /**
...
export declare namespace IntelIcelakeBmLaunchInstancePlatformConfig {
    enum NumaNodesPerSocket {
        Nps1 = "NPS1",
        Nps2 = "NPS2"
    }
    function getJsonObj(obj: IntelIcelakeBmLaunchInstancePlatformConfig, isParentJsonObj?: boolean): object;
    const type = "INTEL_ICELAKE_BM";
    function getDeserializedJsonObj(obj: IntelIcelakeBmLaunchInstancePlatformConfig, isParentJsonObj?: boolean): object;
}

 ...
 *
 */
export interface GenericBmPlatformConfig extends model.PlatformConfig {
    /**
     * The number of NUMA nodes per socket (NPS).
     *
     */
    "numaNodesPerSocket"?: GenericBmPlatformConfig.NumaNodesPerSocket;
    /**
...
export declare namespace GenericBmPlatformConfig {
    ...
    function getJsonObj(obj: GenericBmPlatformConfig, isParentJsonObj?: boolean): object;
    const type = "GENERIC_BM";
    function getDeserializedJsonObj(obj: GenericBmPlatformConfig, isParentJsonObj?: boolean): object;
}

...
export declare namespace ComputeHostConfigurationCheckDetails {
    enum Type {
        Firmware = "FIRMWARE",
        Recycle = "RECYCLE",
        /**
    ...
    function getJsonObj(obj: ComputeHostConfigurationCheckDetails): object;
    function getDeserializedJsonObj(obj: ComputeHostConfigurationCheckDetails): object;
}

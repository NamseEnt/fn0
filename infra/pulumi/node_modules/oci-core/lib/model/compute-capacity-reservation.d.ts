...
export declare namespace ComputeCapacityReservation {
    enum LifecycleState {
        Active = "ACTIVE",
        Creating = "CREATING",
        Updating = "UPDATING",
    ...
    function getJsonObj(obj: ComputeCapacityReservation): object;
    function getDeserializedJsonObj(obj: ComputeCapacityReservation): object;
}

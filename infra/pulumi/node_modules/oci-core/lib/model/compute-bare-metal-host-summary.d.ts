 ...
 *
 */
export interface ComputeBareMetalHostSummary {
    /**
...
export declare namespace ComputeBareMetalHostSummary {
    function getJsonObj(obj: ComputeBareMetalHostSummary): object;
    function getDeserializedJsonObj(obj: ComputeBareMetalHostSummary): object;
}

...
export declare namespace InstanceConfigurationInstanceOptions {
    function getJsonObj(obj: InstanceConfigurationInstanceOptions): object;
    function getDeserializedJsonObj(obj: InstanceConfigurationInstanceOptions): object;
}

...
export declare namespace IPSecConnectionTunnelErrorDetails {
    function getJsonObj(obj: IPSecConnectionTunnelErrorDetails): object;
    function getDeserializedJsonObj(obj: IPSecConnectionTunnelErrorDetails): object;
}

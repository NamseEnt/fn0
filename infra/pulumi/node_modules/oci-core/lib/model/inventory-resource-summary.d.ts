...
export interface InventoryResourceSummary {
     ...
     *
     */
    "ipAddressCollection"?: Array<model.InventoryIpAddressSummary>;
    /**
...
export declare namespace InventoryResourceSummary {
    enum ResourceType {
        Resource = "Resource",
        /**
    ...
    function getJsonObj(obj: InventoryResourceSummary): object;
    function getDeserializedJsonObj(obj: InventoryResourceSummary): object;
}

 ...
 *
 */
export interface UpdateComputeCapacityReservationDetails {
    /**
...
export declare namespace UpdateComputeCapacityReservationDetails {
    function getJsonObj(obj: UpdateComputeCapacityReservationDetails): object;
    function getDeserializedJsonObj(obj: UpdateComputeCapacityReservationDetails): object;
}

...
export declare namespace PublicIpPoolSummary {
    function getJsonObj(obj: PublicIpPoolSummary): object;
    function getDeserializedJsonObj(obj: PublicIpPoolSummary): object;
}

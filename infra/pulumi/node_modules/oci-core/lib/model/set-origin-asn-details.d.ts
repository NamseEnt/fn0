 ...
 */
export interface SetOriginAsnDetails {
    /**
...
export declare namespace SetOriginAsnDetails {
    function getJsonObj(obj: SetOriginAsnDetails): object;
    function getDeserializedJsonObj(obj: SetOriginAsnDetails): object;
}

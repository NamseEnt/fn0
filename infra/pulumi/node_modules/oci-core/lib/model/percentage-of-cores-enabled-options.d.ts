...
export declare namespace PercentageOfCoresEnabledOptions {
    function getJsonObj(obj: PercentageOfCoresEnabledOptions): object;
    function getDeserializedJsonObj(obj: PercentageOfCoresEnabledOptions): object;
}

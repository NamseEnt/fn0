...
export declare namespace Ipv6AddressIpv6SubnetCidrPairDetails {
    function getJsonObj(obj: Ipv6AddressIpv6SubnetCidrPairDetails): object;
    function getDeserializedJsonObj(obj: Ipv6AddressIpv6SubnetCidrPairDetails): object;
}

...
export declare namespace AddPublicIpPoolCapacityDetails {
    function getJsonObj(obj: AddPublicIpPoolCapacityDetails): object;
    function getDeserializedJsonObj(obj: AddPublicIpPoolCapacityDetails): object;
}

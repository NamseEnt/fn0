...
export declare namespace PhaseOneConfigDetails {
    ...
    function getJsonObj(obj: PhaseOneConfigDetails): object;
    function getDeserializedJsonObj(obj: PhaseOneConfigDetails): object;
}

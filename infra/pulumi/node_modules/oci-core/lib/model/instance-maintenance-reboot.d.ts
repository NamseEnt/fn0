...
export declare namespace InstanceMaintenanceReboot {
    function getJsonObj(obj: InstanceMaintenanceReboot): object;
    function getDeserializedJsonObj(obj: InstanceMaintenanceReboot): object;
}

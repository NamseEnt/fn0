...
export declare namespace CreateClusterNetworkInstancePoolDetails {
    function getJsonObj(obj: CreateClusterNetworkInstancePoolDetails): object;
    function getDeserializedJsonObj(obj: CreateClusterNetworkInstancePoolDetails): object;
}

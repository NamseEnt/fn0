...
export declare namespace DedicatedVmHostInstanceSummary {
    function getJsonObj(obj: DedicatedVmHostInstanceSummary): object;
    function getDeserializedJsonObj(obj: DedicatedVmHostInstanceSummary): object;
}

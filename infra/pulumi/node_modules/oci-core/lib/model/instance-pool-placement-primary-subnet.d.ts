 ...
 */
export interface InstancePoolPlacementPrimarySubnet {
    /**
     ...
     *
     */
    "ipv6AddressIpv6SubnetCidrPairDetails"?: Array<model.InstancePoolPlacementIpv6AddressIpv6SubnetCidrDetails>;
    /**
     * The subnet [OCID](https://docs.oracle.com/iaas/Content/General/Concepts/identifiers.htm) for the secondary VNIC.
     */
    "subnetId": string;
}
export declare namespace InstancePoolPlacementPrimarySubnet {
    function getJsonObj(obj: InstancePoolPlacementPrimarySubnet): object;
    function getDeserializedJsonObj(obj: InstancePoolPlacementPrimarySubnet): object;
}

...
export declare namespace BootVolumeAttachment {
    enum LifecycleState {
        Attaching = "ATTACHING",
        Attached = "ATTACHED",
        Detaching = "DETACHING",
    ...
    function getJsonObj(obj: BootVolumeAttachment): object;
    function getDeserializedJsonObj(obj: BootVolumeAttachment): object;
}

...
export declare namespace UpdateVlanDetails {
    function getJsonObj(obj: UpdateVlanDetails): object;
    function getDeserializedJsonObj(obj: UpdateVlanDetails): object;
}

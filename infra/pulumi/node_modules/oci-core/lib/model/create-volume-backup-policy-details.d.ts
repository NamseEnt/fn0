...
export declare namespace CreateVolumeBackupPolicyDetails {
    function getJsonObj(obj: CreateVolumeBackupPolicyDetails): object;
    function getDeserializedJsonObj(obj: CreateVolumeBackupPolicyDetails): object;
}

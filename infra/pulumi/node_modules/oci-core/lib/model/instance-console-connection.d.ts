...
export declare namespace InstanceConsoleConnection {
    enum LifecycleState {
        Active = "ACTIVE",
        Creating = "CREATING",
        Deleted = "DELETED",
    ...
    function getJsonObj(obj: InstanceConsoleConnection): object;
    function getDeserializedJsonObj(obj: InstanceConsoleConnection): object;
}

...
export declare namespace InstanceConfigurationLaunchInstanceAgentConfigDetails {
    function getJsonObj(obj: InstanceConfigurationLaunchInstanceAgentConfigDetails): object;
    function getDeserializedJsonObj(obj: InstanceConfigurationLaunchInstanceAgentConfigDetails): object;
}

...
export declare namespace InstanceAgentPluginConfigDetails {
    enum DesiredState {
        Enabled = "ENABLED",
        Disabled = "DISABLED",
        /**
    ...
    function getJsonObj(obj: InstanceAgentPluginConfigDetails): object;
    function getDeserializedJsonObj(obj: InstanceAgentPluginConfigDetails): object;
}

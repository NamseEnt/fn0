 ...
 *
 */
export interface ComputeCapacityTopology {
    /**
  ...
  *
    ...
    "capacitySource": model.DedicatedCapacitySource;
    /**
  ...
  *
     ...
     */
    "lifecycleState": ComputeCapacityTopology.LifecycleState;
    /**
...
export declare namespace ComputeCapacityTopology {
    enum LifecycleState {
        Active = "ACTIVE",
        Creating = "CREATING",
        Updating = "UPDATING",
    ...
    function getJsonObj(obj: ComputeCapacityTopology): object;
    function getDeserializedJsonObj(obj: ComputeCapacityTopology): object;
}

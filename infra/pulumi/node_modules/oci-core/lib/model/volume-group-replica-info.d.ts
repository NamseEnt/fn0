 ...
 */
export interface VolumeGroupReplicaInfo {
    /**
...
export declare namespace VolumeGroupReplicaInfo {
    function getJsonObj(obj: VolumeGroupReplicaInfo): object;
    function getDeserializedJsonObj(obj: VolumeGroupReplicaInfo): object;
}

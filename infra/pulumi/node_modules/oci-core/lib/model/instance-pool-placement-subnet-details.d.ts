...
export declare namespace InstancePoolPlacementSubnetDetails {
    function getJsonObj(obj: InstancePoolPlacementSubnetDetails): object;
    function getDeserializedJsonObj(obj: InstancePoolPlacementSubnetDetails): object;
}

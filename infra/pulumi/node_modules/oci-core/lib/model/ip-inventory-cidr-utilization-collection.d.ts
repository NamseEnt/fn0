...
export declare namespace IpInventoryCidrUtilizationCollection {
    function getJsonObj(obj: IpInventoryCidrUtilizationCollection): object;
    function getDeserializedJsonObj(obj: IpInventoryCidrUtilizationCollection): object;
}

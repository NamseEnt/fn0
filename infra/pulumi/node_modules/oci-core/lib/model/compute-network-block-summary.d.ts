...
export declare namespace ComputeNetworkBlockSummary {
    function getJsonObj(obj: ComputeNetworkBlockSummary): object;
    function getDeserializedJsonObj(obj: ComputeNetworkBlockSummary): object;
}

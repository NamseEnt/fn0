...
export declare namespace InstancePoolPlacementConfiguration {
    function getJsonObj(obj: InstancePoolPlacementConfiguration): object;
    function getDeserializedJsonObj(obj: InstancePoolPlacementConfiguration): object;
}

 ...
 */
export interface CreateByoasnDetails {
    /**
...
export declare namespace CreateByoasnDetails {
    function getJsonObj(obj: CreateByoasnDetails): object;
    function getDeserializedJsonObj(obj: CreateByoasnDetails): object;
}

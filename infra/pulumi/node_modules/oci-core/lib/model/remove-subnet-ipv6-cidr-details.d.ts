...
export declare namespace RemoveSubnetIpv6CidrDetails {
    function getJsonObj(obj: RemoveSubnetIpv6CidrDetails): object;
    function getDeserializedJsonObj(obj: RemoveSubnetIpv6CidrDetails): object;
}

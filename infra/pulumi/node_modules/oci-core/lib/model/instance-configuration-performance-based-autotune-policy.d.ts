 ...
 *
 */
export interface InstanceConfigurationPerformanceBasedAutotunePolicy extends model.InstanceConfigurationAutotunePolicy {
    /**
...
export declare namespace InstanceConfigurationPerformanceBasedAutotunePolicy {
    function getJsonObj(obj: InstanceConfigurationPerformanceBasedAutotunePolicy, isParentJsonObj?: boolean): object;
    const autotuneType = "PERFORMANCE_BASED";
    function getDeserializedJsonObj(obj: InstanceConfigurationPerformanceBasedAutotunePolicy, isParentJsonObj?: boolean): object;
}

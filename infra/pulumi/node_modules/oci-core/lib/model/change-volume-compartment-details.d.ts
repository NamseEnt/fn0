...
export declare namespace ChangeVolumeCompartmentDetails {
    function getJsonObj(obj: ChangeVolumeCompartmentDetails): object;
    function getDeserializedJsonObj(obj: ChangeVolumeCompartmentDetails): object;
}

...
export declare namespace DetachInstancePoolInstanceDetails {
    function getJsonObj(obj: DetachInstancePoolInstanceDetails): object;
    function getDeserializedJsonObj(obj: DetachInstancePoolInstanceDetails): object;
}

...
export interface AmdRomeBmPlatformConfig extends model.PlatformConfig {
     ...
     *
     */
    "numaNodesPerSocket"?: AmdRomeBmPlatformConfig.NumaNodesPerSocket;
    /**
...
export declare namespace AmdRomeBmPlatformConfig {
    ...
    function getJsonObj(obj: AmdRomeBmPlatformConfig, isParentJsonObj?: boolean): object;
    const type = "AMD_ROME_BM";
    function getDeserializedJsonObj(obj: AmdRomeBmPlatformConfig, isParentJsonObj?: boolean): object;
}

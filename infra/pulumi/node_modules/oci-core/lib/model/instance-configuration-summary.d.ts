 ...
 *
 */
export interface InstanceConfigurationSummary {
    /**
...
export declare namespace InstanceConfigurationSummary {
    function getJsonObj(obj: InstanceConfigurationSummary): object;
    function getDeserializedJsonObj(obj: InstanceConfigurationSummary): object;
}

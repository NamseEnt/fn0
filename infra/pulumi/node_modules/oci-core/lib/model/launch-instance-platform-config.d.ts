...
export declare namespace LaunchInstancePlatformConfig {
    function getJsonObj(obj: LaunchInstancePlatformConfig): object;
    function getDeserializedJsonObj(obj: LaunchInstancePlatformConfig): object;
}

...
export declare namespace InstanceConfigurationLaunchInstancePlatformConfig {
    function getJsonObj(obj: InstanceConfigurationLaunchInstancePlatformConfig): object;
    function getDeserializedJsonObj(obj: InstanceConfigurationLaunchInstancePlatformConfig): object;
}

...
export declare namespace InstanceAvailabilityConfig {
    enum RecoveryAction {
    ...
    function getJsonObj(obj: InstanceAvailabilityConfig): object;
    function getDeserializedJsonObj(obj: InstanceAvailabilityConfig): object;
}

 ...
 */
export interface CreateAppCatalogSubscriptionDetails {
    /**
...
export declare namespace CreateAppCatalogSubscriptionDetails {
    function getJsonObj(obj: CreateAppCatalogSubscriptionDetails): object;
    function getDeserializedJsonObj(obj: CreateAppCatalogSubscriptionDetails): object;
}

...
export declare namespace DrgAttachmentInfo {
    function getJsonObj(obj: DrgAttachmentInfo): object;
    function getDeserializedJsonObj(obj: DrgAttachmentInfo): object;
}

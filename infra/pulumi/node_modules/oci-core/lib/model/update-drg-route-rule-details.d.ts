...
export declare namespace UpdateDrgRouteRuleDetails {
    enum DestinationType {
        CidrBlock = "CIDR_BLOCK"
    }
    function getJsonObj(obj: UpdateDrgRouteRuleDetails): object;
    function getDeserializedJsonObj(obj: UpdateDrgRouteRuleDetails): object;
}

...
export interface VolumeGroup {
  ...
  *
     ...
     */
    "sizeInGBs"?: number;
    "sourceDetails"?: model.VolumeGroupSourceFromVolumeGroupReplicaDetails | model.VolumeGroupSourceFromVolumeGroupDetails | model.VolumeGroupSourceFromVolumesDetails | model.VolumeGroupSourceFromVolumeGroupBackupDetails;
    /**
...
export declare namespace VolumeGroup {
    enum LifecycleState {
    ...
    function getJsonObj(obj: VolumeGroup): object;
    function getDeserializedJsonObj(obj: VolumeGroup): object;
}

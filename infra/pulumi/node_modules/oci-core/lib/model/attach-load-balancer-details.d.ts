...
export declare namespace AttachLoadBalancerDetails {
    function getJsonObj(obj: AttachLoadBalancerDetails): object;
    function getDeserializedJsonObj(obj: AttachLoadBalancerDetails): object;
}

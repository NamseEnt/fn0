...
export declare namespace ComputeNetworkBlock {
    enum LifecycleState {
        Active = "ACTIVE",
        Inactive = "INACTIVE",
        /**
    ...
    function getJsonObj(obj: ComputeNetworkBlock): object;
    function getDeserializedJsonObj(obj: ComputeNetworkBlock): object;
}

...
export declare namespace InstanceAgentConfig {
    function getJsonObj(obj: InstanceAgentConfig): object;
    function getDeserializedJsonObj(obj: InstanceAgentConfig): object;
}

...
export interface CreateImageDetails {
  ...
  *
    ...
    "imageSourceDetails"?: model.ImageSourceViaObjectStorageTupleDetails | model.ImageSourceViaObjectStorageUriDetails;
    /**
...
export declare namespace CreateImageDetails {
    enum LaunchMode {
        Native = "NATIVE",
        Emulated = "EMULATED",
    ...
    function getJsonObj(obj: CreateImageDetails): object;
    function getDeserializedJsonObj(obj: CreateImageDetails): object;
}

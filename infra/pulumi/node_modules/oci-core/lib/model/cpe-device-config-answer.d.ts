...
export declare namespace CpeDeviceConfigAnswer {
    function getJsonObj(obj: CpeDeviceConfigAnswer): object;
    function getDeserializedJsonObj(obj: CpeDeviceConfigAnswer): object;
}

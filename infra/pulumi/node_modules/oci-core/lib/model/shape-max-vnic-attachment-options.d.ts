...
export declare namespace ShapeMaxVnicAttachmentOptions {
    function getJsonObj(obj: ShapeMaxVnicAttachmentOptions): object;
    function getDeserializedJsonObj(obj: ShapeMaxVnicAttachmentOptions): object;
}

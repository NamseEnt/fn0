...
export declare namespace FastConnectProviderServiceKey {
    function getJsonObj(obj: FastConnectProviderServiceKey): object;
    function getDeserializedJsonObj(obj: FastConnectProviderServiceKey): object;
}

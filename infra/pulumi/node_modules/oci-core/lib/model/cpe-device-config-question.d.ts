...
export declare namespace CpeDeviceConfigQuestion {
    function getJsonObj(obj: CpeDeviceConfigQuestion): object;
    function getDeserializedJsonObj(obj: CpeDeviceConfigQuestion): object;
}

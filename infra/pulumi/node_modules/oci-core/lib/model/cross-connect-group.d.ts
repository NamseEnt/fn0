...
export declare namespace CrossConnectGroup {
    enum LifecycleState {
    ...
    function getJsonObj(obj: CrossConnectGroup): object;
    function getDeserializedJsonObj(obj: CrossConnectGroup): object;
}

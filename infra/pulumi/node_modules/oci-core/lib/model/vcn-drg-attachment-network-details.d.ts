...
export declare namespace VcnDrgAttachmentNetworkDetails {
    enum VcnRouteType {
        VcnCidrs = "VCN_CIDRS",
    ...
    function getJsonObj(obj: VcnDrgAttachmentNetworkDetails, isParentJsonObj?: boolean): object;
    const type = "VCN";
    function getDeserializedJsonObj(obj: VcnDrgAttachmentNetworkDetails, isParentJsonObj?: boolean): object;
}

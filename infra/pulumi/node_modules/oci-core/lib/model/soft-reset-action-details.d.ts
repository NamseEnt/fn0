...
export declare namespace SoftResetActionDetails {
    function getJsonObj(obj: SoftResetActionDetails, isParentJsonObj?: boolean): object;
    const actionType = "softreset";
    function getDeserializedJsonObj(obj: SoftResetActionDetails, isParentJsonObj?: boolean): object;
}

...
export declare namespace ShapeMeasuredBootOptions {
    function getJsonObj(obj: ShapeMeasuredBootOptions): object;
    function getDeserializedJsonObj(obj: ShapeMeasuredBootOptions): object;
}

...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/core/ListInstanceDevices.ts.html |here} to see how to use ListInstanceDevicesRequest.
 */
...
export declare namespace ListInstanceDevicesRequest {
    enum SortBy {

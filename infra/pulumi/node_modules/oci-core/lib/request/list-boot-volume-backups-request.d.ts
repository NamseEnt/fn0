...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/core/ListBootVolumeBackups.ts.html |here} to see how to use ListBootVolumeBackupsRequest.
 */
export interface ListBootVolumeBackupsRequest extends common.BaseRequest {
    /**
...
export declare namespace ListBootVolumeBackupsRequest {
    enum SortBy {

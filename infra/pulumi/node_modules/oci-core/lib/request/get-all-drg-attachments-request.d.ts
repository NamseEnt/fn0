...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/core/GetAllDrgAttachments.ts.html |here} to see how to use GetAllDrgAttachmentsRequest.
 */
export interface GetAllDrgAttachmentsRequest extends common.BaseRequest {
    /**
...
export declare namespace GetAllDrgAttachmentsRequest {
    enum AttachmentType {
        Vcn = "VCN",

...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/core/ListVirtualCircuits.ts.html |here} to see how to use ListVirtualCircuitsRequest.
 */
...
export declare namespace ListVirtualCircuitsRequest {
    enum SortBy {

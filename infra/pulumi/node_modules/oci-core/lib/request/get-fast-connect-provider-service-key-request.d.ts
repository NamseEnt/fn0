...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/core/GetFastConnectProviderServiceKey.ts.html |here} to see how to use GetFastConnectProviderServiceKeyRequest.
 */
export interface GetFastConnectProviderServiceKeyRequest extends common.BaseRequest {
    /**

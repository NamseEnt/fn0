...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/core/ListCaptureFilters.ts.html |here} to see how to use ListCaptureFiltersRequest.
 */
export interface ListCaptureFiltersRequest extends common.BaseRequest {
    /**
...
export declare namespace ListCaptureFiltersRequest {
    enum SortBy {

...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/core/ListComputeCapacityTopologyComputeBareMetalHosts.ts.html |here} to see how to use ListComputeCapacityTopologyComputeBareMetalHostsRequest.
 */
export interface ListComputeCapacityTopologyComputeBareMetalHostsRequest extends common.BaseRequest {
    /**
...
export declare namespace ListComputeCapacityTopologyComputeBareMetalHostsRequest {
    enum SortBy {

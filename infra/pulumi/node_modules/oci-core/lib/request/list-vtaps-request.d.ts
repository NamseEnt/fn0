...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/core/ListVtaps.ts.html |here} to see how to use ListVtapsRequest.
 */
export interface ListVtapsRequest extends common.BaseRequest {
    /**
...
export declare namespace ListVtapsRequest {
    enum SortBy {

...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/dataintegration/GetFunctionLibrary.ts.html |here} to see how to use GetFunctionLibraryRequest.
 */
...
export declare namespace GetFunctionLibraryRequest {
    enum Projection {

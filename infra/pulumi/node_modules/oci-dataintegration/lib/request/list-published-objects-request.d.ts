...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/dataintegration/ListPublishedObjects.ts.html |here} to see how to use ListPublishedObjectsRequest.
 */
...
export declare namespace ListPublishedObjectsRequest {
    enum SortOrder {
        Asc = "ASC",
        Desc = "DESC"
    }

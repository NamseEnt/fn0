...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/dataintegration/ListDisApplicationTaskRunLineages.ts.html |here} to see how to use ListDisApplicationTaskRunLineagesRequest.
 */
...
export declare namespace ListDisApplicationTaskRunLineagesRequest {
    enum SortOrder {
        Asc = "ASC",
        Desc = "DESC"
    }

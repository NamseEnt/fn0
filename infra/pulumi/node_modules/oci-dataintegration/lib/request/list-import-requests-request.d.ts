...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/dataintegration/ListImportRequests.ts.html |here} to see how to use ListImportRequestsRequest.
 */
...
export declare namespace ListImportRequestsRequest {
    enum SortOrder {
        Asc = "ASC",
        Desc = "DESC"
    }

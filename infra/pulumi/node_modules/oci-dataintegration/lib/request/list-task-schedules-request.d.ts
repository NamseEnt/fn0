...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/dataintegration/ListTaskSchedules.ts.html |here} to see how to use ListTaskSchedulesRequest.
 */
...
export declare namespace ListTaskSchedulesRequest {
    enum SortBy {

...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/dataintegration/ListUserDefinedFunctionValidations.ts.html |here} to see how to use ListUserDefinedFunctionValidationsRequest.
 */
...
export declare namespace ListUserDefinedFunctionValidationsRequest {
    enum SortBy {

...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/dataintegration/ListDisApplications.ts.html |here} to see how to use ListDisApplicationsRequest.
 */
...
export declare namespace ListDisApplicationsRequest {
    enum SortOrder {
        Asc = "ASC",
        Desc = "DESC"
    }

...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/dataintegration/ListTaskRunLogs.ts.html |here} to see how to use ListTaskRunLogsRequest.
 */
...
export declare namespace ListTaskRunLogsRequest {
    enum SortOrder {
        Asc = "ASC",
        Desc = "DESC"
    }

...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/dataintegration/ListDataAssets.ts.html |here} to see how to use ListDataAssetsRequest.
 */
...
export declare namespace ListDataAssetsRequest {
    enum SortBy {

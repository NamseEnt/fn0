...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/dataintegration/ListPatchChanges.ts.html |here} to see how to use ListPatchChangesRequest.
 */
...
export declare namespace ListPatchChangesRequest {
    enum SortOrder {
        Asc = "ASC",
        Desc = "DESC"
    }

...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/dataintegration/ListUserDefinedFunctions.ts.html |here} to see how to use ListUserDefinedFunctionsRequest.
 */
...
export declare namespace ListUserDefinedFunctionsRequest {
    enum SortOrder {
        Asc = "ASC",
        Desc = "DESC"
    }

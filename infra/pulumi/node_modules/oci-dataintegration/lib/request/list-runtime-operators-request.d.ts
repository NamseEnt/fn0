...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/dataintegration/ListRuntimeOperators.ts.html |here} to see how to use ListRuntimeOperatorsRequest.
 */
...
export declare namespace ListRuntimeOperatorsRequest {
    enum SortOrder {
        Asc = "ASC",
        Desc = "DESC"
    }

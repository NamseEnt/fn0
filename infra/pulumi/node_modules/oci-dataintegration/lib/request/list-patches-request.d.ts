...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/dataintegration/ListPatches.ts.html |here} to see how to use ListPatchesRequest.
 */
...
export declare namespace ListPatchesRequest {
    enum SortOrder {
        Asc = "ASC",
        Desc = "DESC"
    }

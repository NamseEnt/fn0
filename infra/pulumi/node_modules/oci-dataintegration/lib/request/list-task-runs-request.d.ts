...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/dataintegration/ListTaskRuns.ts.html |here} to see how to use ListTaskRunsRequest.
 */
...
export declare namespace ListTaskRunsRequest {
    enum SortOrder {
        Asc = "ASC",
        Desc = "DESC"
    }

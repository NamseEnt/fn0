...
export interface ListPipelineValidationsResponse {
    /**
    ...
    /**
     * The returned model.PipelineValidationSummaryCollection instance.
     */
    "pipelineValidationSummaryCollection": model.PipelineValidationSummaryCollection;
}

...
export interface ListImportRequestsResponse {
    /**
    ...
    "opcNextPage": string;
    /**
     * The returned model.ImportRequestSummaryCollection instance.
     */
    "importRequestSummaryCollection": model.ImportRequestSummaryCollection;
}

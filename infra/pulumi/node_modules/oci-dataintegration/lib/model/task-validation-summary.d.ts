...
export declare namespace TaskValidationSummary {
    function getJsonObj(obj: TaskValidationSummary): object;
    function getDeserializedJsonObj(obj: TaskValidationSummary): object;
}

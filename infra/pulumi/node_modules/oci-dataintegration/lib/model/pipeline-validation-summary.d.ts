...
export declare namespace PipelineValidationSummary {
    function getJsonObj(obj: PipelineValidationSummary): object;
    function getDeserializedJsonObj(obj: PipelineValidationSummary): object;
}

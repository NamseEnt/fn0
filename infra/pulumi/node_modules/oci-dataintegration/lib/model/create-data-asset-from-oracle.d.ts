...
export declare namespace CreateDataAssetFromOracle {
    function getJsonObj(obj: CreateDataAssetFromOracle, isParentJsonObj?: boolean): object;
    const modelType = "ORACLE_DATA_ASSET";
    function getDeserializedJsonObj(obj: CreateDataAssetFromOracle, isParentJsonObj?: boolean): object;
}

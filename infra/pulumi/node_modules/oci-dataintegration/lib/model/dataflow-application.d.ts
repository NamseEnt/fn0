...
export declare namespace DataflowApplication {
    function getJsonObj(obj: DataflowApplication): object;
    function getDeserializedJsonObj(obj: DataflowApplication): object;
}

...
export declare namespace PublishedObjectFromPipelineTask {
    function getJsonObj(obj: PublishedObjectFromPipelineTask, isParentJsonObj?: boolean): object;
    const modelType = "PIPELINE_TASK";
    function getDeserializedJsonObj(obj: PublishedObjectFromPipelineTask, isParentJsonObj?: boolean): object;
}

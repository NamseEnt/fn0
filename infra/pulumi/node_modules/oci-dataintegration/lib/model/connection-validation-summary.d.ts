...
export declare namespace ConnectionValidationSummary {
    function getJsonObj(obj: ConnectionValidationSummary): object;
    function getDeserializedJsonObj(obj: ConnectionValidationSummary): object;
}

...
export declare namespace DataEntityFromTableEntityDetails {
    enum EntityType {
        Table = "TABLE",
        View = "VIEW",
        File = "FILE",
    ...
    function getJsonObj(obj: DataEntityFromTableEntityDetails, isParentJsonObj?: boolean): object;
    const modelType = "TABLE_ENTITY";
    function getDeserializedJsonObj(obj: DataEntityFromTableEntityDetails, isParentJsonObj?: boolean): object;
}

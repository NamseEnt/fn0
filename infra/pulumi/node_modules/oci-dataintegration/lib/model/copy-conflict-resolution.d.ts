...
export declare namespace CopyConflictResolution {
    enum RequestType {
        Retain = "RETAIN",
        Duplicate = "DUPLICATE",
        Replace = "REPLACE",
    ...
    function getJsonObj(obj: CopyConflictResolution): object;
    function getDeserializedJsonObj(obj: CopyConflictResolution): object;
}

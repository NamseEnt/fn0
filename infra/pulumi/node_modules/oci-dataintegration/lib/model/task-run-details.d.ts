...
export interface TaskRunDetails {
     ...
     */
    "reRunType"?: TaskRunDetails.ReRunType;
    /**
...
export declare namespace TaskRunDetails {
    enum Status {
    ...
    function getJsonObj(obj: TaskRunDetails): object;
    function getDeserializedJsonObj(obj: TaskRunDetails): object;
}

 ...
 */
export interface UserDefinedFunctionSummary {
    /**
     ...
     */
    "modelType"?: UserDefinedFunctionSummary.ModelType;
    /**
...
export declare namespace UserDefinedFunctionSummary {
    enum ModelType {
    ...
    function getJsonObj(obj: UserDefinedFunctionSummary): object;
    function getDeserializedJsonObj(obj: UserDefinedFunctionSummary): object;
}

...
export declare namespace ExpressionOperator {
    enum TriggerRule {
    ...
    function getJsonObj(obj: ExpressionOperator, isParentJsonObj?: boolean): object;
    const modelType = "EXPRESSION_OPERATOR";
    function getDeserializedJsonObj(obj: ExpressionOperator, isParentJsonObj?: boolean): object;
}

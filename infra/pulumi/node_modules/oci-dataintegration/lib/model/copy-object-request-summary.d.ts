...
export declare namespace CopyObjectRequestSummary {
    enum CopyMetadataObjectRequestStatus {
    ...
    function getJsonObj(obj: CopyObjectRequestSummary): object;
    function getDeserializedJsonObj(obj: CopyObjectRequestSummary): object;
}

 ...
 */
export interface ConnectionSummaryFromOAuth2 extends model.ConnectionSummary {
    /**
     ...
     */
    "grantType"?: ConnectionSummaryFromOAuth2.GrantType;
    "modelType": string;
}
export declare namespace ConnectionSummaryFromOAuth2 {
    enum GrantType {
    ...
    function getJsonObj(obj: ConnectionSummaryFromOAuth2, isParentJsonObj?: boolean): object;
    const modelType = "OAUTH2_CONNECTION";
    function getDeserializedJsonObj(obj: ConnectionSummaryFromOAuth2, isParentJsonObj?: boolean): object;
}

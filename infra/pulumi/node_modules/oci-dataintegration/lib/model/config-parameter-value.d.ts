...
export declare namespace ConfigParameterValue {
    function getJsonObj(obj: ConfigParameterValue): object;
    function getDeserializedJsonObj(obj: ConfigParameterValue): object;
}

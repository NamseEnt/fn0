...
export declare namespace TaskFromDataLoaderTaskDetails {
    function getJsonObj(obj: TaskFromDataLoaderTaskDetails, isParentJsonObj?: boolean): object;
    const modelType = "DATA_LOADER_TASK";
    function getDeserializedJsonObj(obj: TaskFromDataLoaderTaskDetails, isParentJsonObj?: boolean): object;
}

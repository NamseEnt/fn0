...
export declare namespace DataFlowValidation {
    function getJsonObj(obj: DataFlowValidation): object;
    function getDeserializedJsonObj(obj: DataFlowValidation): object;
}

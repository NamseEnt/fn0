...
export declare namespace Aggregator {
    function getJsonObj(obj: Aggregator, isParentJsonObj?: boolean): object;
    const modelType = "AGGREGATOR_OPERATOR";
    function getDeserializedJsonObj(obj: Aggregator, isParentJsonObj?: boolean): object;
}

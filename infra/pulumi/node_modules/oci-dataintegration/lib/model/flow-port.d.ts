...
export declare namespace FlowPort {
    function getJsonObj(obj: FlowPort, isParentJsonObj?: boolean): object;
    const modelType = "FLOW_PORT";
    function getDeserializedJsonObj(obj: FlowPort, isParentJsonObj?: boolean): object;
}

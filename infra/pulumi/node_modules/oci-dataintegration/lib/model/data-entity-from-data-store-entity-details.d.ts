...
export declare namespace DataEntityFromDataStoreEntityDetails {
    enum EntityType {
        Table = "TABLE",
        View = "VIEW",
        File = "FILE",
    ...
    function getJsonObj(obj: DataEntityFromDataStoreEntityDetails, isParentJsonObj?: boolean): object;
    const modelType = "DATA_STORE_ENTITY";
    function getDeserializedJsonObj(obj: DataEntityFromDataStoreEntityDetails, isParentJsonObj?: boolean): object;
}

...
export declare namespace NamePatternRule {
    ...
    function getJsonObj(obj: NamePatternRule, isParentJsonObj?: boolean): object;
    const modelType = "NAME_PATTERN_RULE";
    function getDeserializedJsonObj(obj: NamePatternRule, isParentJsonObj?: boolean): object;
}

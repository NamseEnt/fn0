...
export declare namespace TaskFromSQLTaskDetails {
    enum SqlScriptType {
    ...
    function getJsonObj(obj: TaskFromSQLTaskDetails, isParentJsonObj?: boolean): object;
    const modelType = "SQL_TASK";
    function getDeserializedJsonObj(obj: TaskFromSQLTaskDetails, isParentJsonObj?: boolean): object;
}

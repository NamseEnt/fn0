...
export declare namespace PublishedObjectFromIntegrationTask {
    function getJsonObj(obj: PublishedObjectFromIntegrationTask, isParentJsonObj?: boolean): object;
    const modelType = "INTEGRATION_TASK";
    function getDeserializedJsonObj(obj: PublishedObjectFromIntegrationTask, isParentJsonObj?: boolean): object;
}

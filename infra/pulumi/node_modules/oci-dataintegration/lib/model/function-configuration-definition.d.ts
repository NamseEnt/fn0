...
export interface FunctionConfigurationDefinition {
     ...
     */
    "configParamDefs"?: {
        [key: string]: model.ConfigParameterDefinition;
    };
}
export declare namespace FunctionConfigurationDefinition {
    enum ModelType {
    ...
    function getJsonObj(obj: FunctionConfigurationDefinition): object;
    function getDeserializedJsonObj(obj: FunctionConfigurationDefinition): object;
}

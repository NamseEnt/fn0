...
export declare namespace ConditionalOutputPort {
    enum PortType {
        Data = "DATA",
        Control = "CONTROL",
        Model = "MODEL",
    ...
    function getJsonObj(obj: ConditionalOutputPort, isParentJsonObj?: boolean): object;
    const modelType = "CONDITIONAL_OUTPUT_PORT";
    function getDeserializedJsonObj(obj: ConditionalOutputPort, isParentJsonObj?: boolean): object;
}

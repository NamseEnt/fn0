 ...
 */
export interface DisApplicationSummary {
    /**
    ...
    "publishedObjectMetadata"?: {
        [key: string]: model.PatchObjectMetadata;
    };
     ...
     */
    "lifecycleState"?: DisApplicationSummary.LifecycleState;
...
export declare namespace DisApplicationSummary {
    enum LifecycleState {
        Creating = "CREATING",
        Active = "ACTIVE",
        Updating = "UPDATING",
    ...
    function getJsonObj(obj: DisApplicationSummary): object;
    function getDeserializedJsonObj(obj: DisApplicationSummary): object;
}

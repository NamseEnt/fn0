...
export declare namespace CreateTaskDetails {
    function getJsonObj(obj: CreateTaskDetails): object;
    function getDeserializedJsonObj(obj: CreateTaskDetails): object;
}

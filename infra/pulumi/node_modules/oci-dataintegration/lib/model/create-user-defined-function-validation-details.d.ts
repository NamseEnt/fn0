...
export declare namespace CreateUserDefinedFunctionValidationDetails {
    enum ModelType {
        DisUserDefinedFunction = "DIS_USER_DEFINED_FUNCTION"
    }
    function getJsonObj(obj: CreateUserDefinedFunctionValidationDetails): object;
    function getDeserializedJsonObj(obj: CreateUserDefinedFunctionValidationDetails): object;
}

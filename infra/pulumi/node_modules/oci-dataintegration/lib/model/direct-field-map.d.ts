...
export declare namespace DirectFieldMap {
    function getJsonObj(obj: DirectFieldMap, isParentJsonObj?: boolean): object;
    const modelType = "DIRECT_FIELD_MAP";
    function getDeserializedJsonObj(obj: DirectFieldMap, isParentJsonObj?: boolean): object;
}

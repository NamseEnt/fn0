...
export interface Target extends model.Operator {
    "entity"?: model.DataEntityFromTable | model.DataEntityFromDataStore | model.DataEntityFromObject | model.DataEntityFromView | model.DataEntityFromSql | model.DataEntityFromFile | model.DerivedEntity;
    /**
...
export declare namespace Target {
    ...
    function getJsonObj(obj: Target, isParentJsonObj?: boolean): object;
    const modelType = "TARGET_OPERATOR";
    function getDeserializedJsonObj(obj: Target, isParentJsonObj?: boolean): object;
}

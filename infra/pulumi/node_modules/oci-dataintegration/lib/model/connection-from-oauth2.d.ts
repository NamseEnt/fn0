...
export declare namespace ConnectionFromOAuth2 {
    enum GrantType {
    ...
    function getJsonObj(obj: ConnectionFromOAuth2, isParentJsonObj?: boolean): object;
    const modelType = "OAUTH2_CONNECTION";
    function getDeserializedJsonObj(obj: ConnectionFromOAuth2, isParentJsonObj?: boolean): object;
}

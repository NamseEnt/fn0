...
export declare namespace CreateDisApplicationDetails {
    enum ModelType {
    ...
    function getJsonObj(obj: CreateDisApplicationDetails): object;
    function getDeserializedJsonObj(obj: CreateDisApplicationDetails): object;
}

...
export declare namespace Select {
    function getJsonObj(obj: Select, isParentJsonObj?: boolean): object;
    const modelType = "SELECT";
    function getDeserializedJsonObj(obj: Select, isParentJsonObj?: boolean): object;
}

...
export declare namespace TaskSummaryFromRestTask {
    enum MethodType {
        Get = "GET",
        Post = "POST",
        Patch = "PATCH",
    ...
    function getJsonObj(obj: TaskSummaryFromRestTask, isParentJsonObj?: boolean): object;
    const modelType = "REST_TASK";
    function getDeserializedJsonObj(obj: TaskSummaryFromRestTask, isParentJsonObj?: boolean): object;
}

...
export declare namespace ExternalPublicationValidation {
    function getJsonObj(obj: ExternalPublicationValidation): object;
    function getDeserializedJsonObj(obj: ExternalPublicationValidation): object;
}

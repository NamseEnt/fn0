...
export declare namespace PatchObjectMetadata {
    enum Type {
    ...
    function getJsonObj(obj: PatchObjectMetadata): object;
    function getDeserializedJsonObj(obj: PatchObjectMetadata): object;
}

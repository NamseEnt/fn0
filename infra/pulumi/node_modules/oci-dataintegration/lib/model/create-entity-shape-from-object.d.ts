...
export declare namespace CreateEntityShapeFromObject {
    enum EntityType {
        Table = "TABLE",
        View = "VIEW",
        File = "FILE",
    ...
    function getJsonObj(obj: CreateEntityShapeFromObject, isParentJsonObj?: boolean): object;
    const modelType = "OBJECT_ENTITY";
    function getDeserializedJsonObj(obj: CreateEntityShapeFromObject, isParentJsonObj?: boolean): object;
}

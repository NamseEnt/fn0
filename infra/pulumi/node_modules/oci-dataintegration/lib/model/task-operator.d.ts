...
export interface TaskOperator extends model.Operator {
    ...
    "task"?: model.TaskFromPipelineTaskDetails | model.TaskFromIntegrationTaskDetails | model.TaskFromSQLTaskDetails | model.TaskFromRestTaskDetails | model.TaskFromOCIDataflowTaskDetails | model.TaskFromDataLoaderTaskDetails;
    /**
...
export declare namespace TaskOperator {
    ...
    function getDeserializedJsonObj(obj: TaskOperator, isParentJsonObj?: boolean): object;
}

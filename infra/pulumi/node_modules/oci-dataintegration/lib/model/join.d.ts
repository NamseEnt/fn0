...
export declare namespace Join {
    ...
    function getJsonObj(obj: Join, isParentJsonObj?: boolean): object;
    const modelType = "JOIN";
    function getDeserializedJsonObj(obj: Join, isParentJsonObj?: boolean): object;
}

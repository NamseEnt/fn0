...
export declare namespace CreateExternalPublicationDetails {
    function getJsonObj(obj: CreateExternalPublicationDetails): object;
    function getDeserializedJsonObj(obj: CreateExternalPublicationDetails): object;
}

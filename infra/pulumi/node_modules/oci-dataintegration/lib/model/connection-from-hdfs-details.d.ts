 ...
 */
export interface ConnectionFromHdfsDetails extends model.ConnectionDetails {
    /**
     * The HDFS principal.
     */
...
export declare namespace ConnectionFromHdfsDetails {
    function getJsonObj(obj: ConnectionFromHdfsDetails, isParentJsonObj?: boolean): object;
    const modelType = "HDFS_CONNECTION";
    function getDeserializedJsonObj(obj: ConnectionFromHdfsDetails, isParentJsonObj?: boolean): object;
}

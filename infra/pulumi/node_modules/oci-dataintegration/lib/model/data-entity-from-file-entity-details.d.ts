...
export declare namespace DataEntityFromFileEntityDetails {
    enum EntityType {
        Table = "TABLE",
        View = "VIEW",
        File = "FILE",
    ...
    function getJsonObj(obj: DataEntityFromFileEntityDetails, isParentJsonObj?: boolean): object;
    const modelType = "FILE_ENTITY";
    function getDeserializedJsonObj(obj: DataEntityFromFileEntityDetails, isParentJsonObj?: boolean): object;
}

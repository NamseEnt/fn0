 ...
 */
export interface CreateUserDefinedFunctionDetails {
    /**
...
export declare namespace CreateUserDefinedFunctionDetails {
    function getJsonObj(obj: CreateUserDefinedFunctionDetails): object;
    function getDeserializedJsonObj(obj: CreateUserDefinedFunctionDetails): object;
}

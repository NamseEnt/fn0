...
export declare namespace CancelRestCallConfig {
    enum MethodType {
        Get = "GET",
        Post = "POST",
        Patch = "PATCH",
    ...
    function getJsonObj(obj: CancelRestCallConfig): object;
    function getDeserializedJsonObj(obj: CancelRestCallConfig): object;
}

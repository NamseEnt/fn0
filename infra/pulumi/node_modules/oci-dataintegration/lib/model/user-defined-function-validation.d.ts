 ...
 */
export interface UserDefinedFunctionValidation {
    /**
...
export declare namespace UserDefinedFunctionValidation {
    function getJsonObj(obj: UserDefinedFunctionValidation): object;
    function getDeserializedJsonObj(obj: UserDefinedFunctionValidation): object;
}

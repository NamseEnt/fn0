...
export declare namespace DataAssetFromMySQL {
    function getJsonObj(obj: DataAssetFromMySQL, isParentJsonObj?: boolean): object;
    const modelType = "MYSQL_DATA_ASSET";
    function getDeserializedJsonObj(obj: DataAssetFromMySQL, isParentJsonObj?: boolean): object;
}

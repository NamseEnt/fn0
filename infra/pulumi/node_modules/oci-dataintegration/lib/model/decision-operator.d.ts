...
export declare namespace DecisionOperator {
    enum TriggerRule {
    ...
    function getJsonObj(obj: DecisionOperator, isParentJsonObj?: boolean): object;
    const modelType = "DECISION_OPERATOR";
    function getDeserializedJsonObj(obj: DecisionOperator, isParentJsonObj?: boolean): object;
}

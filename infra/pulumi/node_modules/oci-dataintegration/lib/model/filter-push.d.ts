...
export declare namespace FilterPush {
    function getJsonObj(obj: FilterPush, isParentJsonObj?: boolean): object;
    const modelType = "FILTER";
    function getDeserializedJsonObj(obj: FilterPush, isParentJsonObj?: boolean): object;
}

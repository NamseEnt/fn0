...
export declare namespace CreateCopyObjectRequestDetails {
    function getJsonObj(obj: CreateCopyObjectRequestDetails): object;
    function getDeserializedJsonObj(obj: CreateCopyObjectRequestDetails): object;
}

...
export declare namespace CertificateVersion {
    function getJsonObj(obj: CertificateVersion): object;
    function getDeserializedJsonObj(obj: CertificateVersion): object;
}

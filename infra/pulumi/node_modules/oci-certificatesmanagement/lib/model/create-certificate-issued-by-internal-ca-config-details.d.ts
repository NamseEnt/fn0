 ...
 */
export interface CreateCertificateIssuedByInternalCaConfigDetails extends model.CreateCertificateConfigDetails {
    /**
...
export declare namespace CreateCertificateIssuedByInternalCaConfigDetails {
    function getJsonObj(obj: CreateCertificateIssuedByInternalCaConfigDetails, isParentJsonObj?: boolean): object;
    const configType = "ISSUED_BY_INTERNAL_CA";
    function getDeserializedJsonObj(obj: CreateCertificateIssuedByInternalCaConfigDetails, isParentJsonObj?: boolean): object;
}

...
export declare namespace CertificateAuthorityIssuanceExpiryRule {
    function getJsonObj(obj: CertificateAuthorityIssuanceExpiryRule, isParentJsonObj?: boolean): object;
    const ruleType = "CERTIFICATE_AUTHORITY_ISSUANCE_EXPIRY_RULE";
    function getDeserializedJsonObj(obj: CertificateAuthorityIssuanceExpiryRule, isParentJsonObj?: boolean): object;
}

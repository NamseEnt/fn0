 ...
 */
export interface UpdateCertificateByImportingConfigDetails extends model.UpdateCertificateConfigDetails {
    /**
...
export declare namespace UpdateCertificateByImportingConfigDetails {
    function getJsonObj(obj: UpdateCertificateByImportingConfigDetails, isParentJsonObj?: boolean): object;
    const configType = "IMPORTED";
    function getDeserializedJsonObj(obj: UpdateCertificateByImportingConfigDetails, isParentJsonObj?: boolean): object;
}

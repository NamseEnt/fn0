...
export declare namespace CertificateSubject {
    function getJsonObj(obj: CertificateSubject): object;
    function getDeserializedJsonObj(obj: CertificateSubject): object;
}

...
export declare namespace UpdateCertificateAuthorityConfigDetails {
    enum Stage {
        Current = "CURRENT",
        Pending = "PENDING"
    }
    function getJsonObj(obj: UpdateCertificateAuthorityConfigDetails): object;
    function getDeserializedJsonObj(obj: UpdateCertificateAuthorityConfigDetails): object;
}

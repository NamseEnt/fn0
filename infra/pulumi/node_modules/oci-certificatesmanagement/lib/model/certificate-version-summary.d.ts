...
export declare namespace CertificateVersionSummary {
    function getJsonObj(obj: CertificateVersionSummary): object;
    function getDeserializedJsonObj(obj: CertificateVersionSummary): object;
}

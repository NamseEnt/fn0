...
export declare namespace DelegationControl {
    enum NotificationMessageFormat {
        Json = "JSON",
        Html = "HTML",
        /**
    ...
    function getJsonObj(obj: DelegationControl): object;
    function getDeserializedJsonObj(obj: DelegationControl): object;
}

...
export declare namespace DelegationSubscription {
    enum LifecycleState {
        Creating = "CREATING",
        Active = "ACTIVE",
        Updating = "UPDATING",
    ...
    function getJsonObj(obj: DelegationSubscription): object;
    function getDeserializedJsonObj(obj: DelegationSubscription): object;
}

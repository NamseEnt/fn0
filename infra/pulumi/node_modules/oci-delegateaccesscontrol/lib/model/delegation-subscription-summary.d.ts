 ...
 *
 */
export interface DelegationSubscriptionSummary {
    /**
...
export declare namespace DelegationSubscriptionSummary {
    function getJsonObj(obj: DelegationSubscriptionSummary): object;
    function getDeserializedJsonObj(obj: DelegationSubscriptionSummary): object;
}

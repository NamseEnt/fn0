...
export declare namespace UpdateDelegationControlDetails {
    function getJsonObj(obj: UpdateDelegationControlDetails): object;
    function getDeserializedJsonObj(obj: UpdateDelegationControlDetails): object;
}

...
export interface ServiceProvider {
     ...
     */
    "serviceTypes": Array<ServiceProvider.ServiceTypes>;
    /**
     * Resource types for which this provider will provide service. Default to all if not specified.
     */
    "supportedResourceTypes": Array<ServiceProvider.SupportedResourceTypes>;
    /**
     * The current lifecycle state of the Service Provider.
     */
    "lifecycleState"?: ServiceProvider.LifecycleState;
    /**
...
export declare namespace ServiceProvider {
    enum ServiceProviderType {
        OracleProvided = "ORACLE_PROVIDED",
        /**
    ...
    function getJsonObj(obj: ServiceProvider): object;
    function getDeserializedJsonObj(obj: ServiceProvider): object;
}

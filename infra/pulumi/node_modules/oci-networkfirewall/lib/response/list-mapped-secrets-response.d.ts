...
export interface ListMappedSecretsResponse {
    /**
    ...
    /**
     * The returned model.MappedSecretSummaryCollection instance.
     */
    "mappedSecretSummaryCollection": model.MappedSecretSummaryCollection;
}

...
export interface ListDecryptionRulesResponse {
    /**
    ...
    /**
     * The returned model.DecryptionRuleSummaryCollection instance.
     */
    "decryptionRuleSummaryCollection": model.DecryptionRuleSummaryCollection;
}

...
export interface ListNetworkFirewallsResponse {
    /**
    ...
    /**
     * The returned model.NetworkFirewallCollection instance.
     */
    "networkFirewallCollection": model.NetworkFirewallCollection;
}

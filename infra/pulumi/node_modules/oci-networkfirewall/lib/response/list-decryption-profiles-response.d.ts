...
export interface ListDecryptionProfilesResponse {
    /**
    ...
    /**
     * The returned model.DecryptionProfileSummaryCollection instance.
     */
    "decryptionProfileSummaryCollection": model.DecryptionProfileSummaryCollection;
}

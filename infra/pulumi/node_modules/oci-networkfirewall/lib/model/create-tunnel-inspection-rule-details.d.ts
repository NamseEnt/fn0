...
export declare namespace CreateTunnelInspectionRuleDetails {
    function getJsonObj(obj: CreateTunnelInspectionRuleDetails): object;
    function getDeserializedJsonObj(obj: CreateTunnelInspectionRuleDetails): object;
}

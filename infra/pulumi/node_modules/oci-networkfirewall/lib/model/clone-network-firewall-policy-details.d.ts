 ...
 */
export interface CloneNetworkFirewallPolicyDetails {
    /**
...
export declare namespace CloneNetworkFirewallPolicyDetails {
    function getJsonObj(obj: CloneNetworkFirewallPolicyDetails): object;
    function getDeserializedJsonObj(obj: CloneNetworkFirewallPolicyDetails): object;
}

...
export declare namespace SecurityRuleSummary {
    function getJsonObj(obj: SecurityRuleSummary): object;
    function getDeserializedJsonObj(obj: SecurityRuleSummary): object;
}

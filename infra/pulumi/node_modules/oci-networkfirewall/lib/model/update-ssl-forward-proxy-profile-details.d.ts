...
export declare namespace UpdateSslForwardProxyProfileDetails {
    function getJsonObj(obj: UpdateSslForwardProxyProfileDetails, isParentJsonObj?: boolean): object;
    const type = "SSL_FORWARD_PROXY";
    function getDeserializedJsonObj(obj: UpdateSslForwardProxyProfileDetails, isParentJsonObj?: boolean): object;
}

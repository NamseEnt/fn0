 ...
 */
export interface CreateIcmp6ApplicationDetails extends model.CreateApplicationDetails {
    /**
...
export declare namespace CreateIcmp6ApplicationDetails {
    function getJsonObj(obj: CreateIcmp6ApplicationDetails, isParentJsonObj?: boolean): object;
    const type = "ICMP_V6";
    function getDeserializedJsonObj(obj: CreateIcmp6ApplicationDetails, isParentJsonObj?: boolean): object;
}

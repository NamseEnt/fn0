...
export declare namespace CreateVaultMappedSecretDetails {
    function getJsonObj(obj: CreateVaultMappedSecretDetails, isParentJsonObj?: boolean): object;
    const source = "OCI_VAULT";
    function getDeserializedJsonObj(obj: CreateVaultMappedSecretDetails, isParentJsonObj?: boolean): object;
}

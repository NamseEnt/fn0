 ...
 */
export interface CreateNetworkFirewallPolicyDetails {
    /**
...
export declare namespace CreateNetworkFirewallPolicyDetails {
    function getJsonObj(obj: CreateNetworkFirewallPolicyDetails): object;
    function getDeserializedJsonObj(obj: CreateNetworkFirewallPolicyDetails): object;
}

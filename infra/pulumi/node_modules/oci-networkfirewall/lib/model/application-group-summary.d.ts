...
export declare namespace ApplicationGroupSummary {
    function getJsonObj(obj: ApplicationGroupSummary): object;
    function getDeserializedJsonObj(obj: ApplicationGroupSummary): object;
}

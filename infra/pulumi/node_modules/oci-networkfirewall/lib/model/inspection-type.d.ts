...
export declare namespace InspectionType {
    function getJsonObj(obj: InspectionType): InspectionType;
    function getDeserializedJsonObj(obj: InspectionType): InspectionType;
}

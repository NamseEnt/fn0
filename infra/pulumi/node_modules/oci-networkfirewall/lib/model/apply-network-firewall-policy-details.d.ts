...
export declare namespace ApplyNetworkFirewallPolicyDetails {
    function getJsonObj(obj: ApplyNetworkFirewallPolicyDetails): object;
    function getDeserializedJsonObj(obj: ApplyNetworkFirewallPolicyDetails): object;
}

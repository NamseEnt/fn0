 ...
 *
 */
export interface UpdateIcmp6ApplicationDetails extends model.UpdateApplicationDetails {
    /**
...
export declare namespace UpdateIcmp6ApplicationDetails {
    function getJsonObj(obj: UpdateIcmp6ApplicationDetails, isParentJsonObj?: boolean): object;
    const type = "ICMP_V6";
    function getDeserializedJsonObj(obj: UpdateIcmp6ApplicationDetails, isParentJsonObj?: boolean): object;
}

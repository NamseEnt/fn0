...
export declare namespace DecryptionActionType {
    function getJsonObj(obj: DecryptionActionType): DecryptionActionType;
    function getDeserializedJsonObj(obj: DecryptionActionType): DecryptionActionType;
}

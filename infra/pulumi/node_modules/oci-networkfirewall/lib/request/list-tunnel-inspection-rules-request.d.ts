...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/networkfirewall/ListTunnelInspectionRules.ts.html |here} to see how to use ListTunnelInspectionRulesRequest.
 */
export interface ListTunnelInspectionRulesRequest extends common.BaseRequest {
    /**
...
export declare namespace ListTunnelInspectionRulesRequest {
    enum SortBy {

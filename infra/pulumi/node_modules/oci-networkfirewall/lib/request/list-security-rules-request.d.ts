...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/networkfirewall/ListSecurityRules.ts.html |here} to see how to use ListSecurityRulesRequest.
 */
...
export declare namespace ListSecurityRulesRequest {
    enum SortBy {

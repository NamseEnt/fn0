...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/networkfirewall/ListDecryptionProfiles.ts.html |here} to see how to use ListDecryptionProfilesRequest.
 */
...
export declare namespace ListDecryptionProfilesRequest {
    enum SortBy {

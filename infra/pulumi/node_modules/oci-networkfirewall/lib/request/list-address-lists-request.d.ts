...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/networkfirewall/ListAddressLists.ts.html |here} to see how to use ListAddressListsRequest.
 */
...
export declare namespace ListAddressListsRequest {
    enum SortBy {

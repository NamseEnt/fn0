...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/networkfirewall/ListUrlLists.ts.html |here} to see how to use ListUrlListsRequest.
 */
...
export declare namespace ListUrlListsRequest {
    enum SortBy {

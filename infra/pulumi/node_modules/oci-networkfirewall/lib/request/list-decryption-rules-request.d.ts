...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/networkfirewall/ListDecryptionRules.ts.html |here} to see how to use ListDecryptionRulesRequest.
 */
...
export declare namespace ListDecryptionRulesRequest {
    enum SortBy {

...
export declare namespace ResourcesPatchComplianceSummary {
    function getJsonObj(obj: ResourcesPatchComplianceSummary): object;
    function getDeserializedJsonObj(obj: ResourcesPatchComplianceSummary): object;
}

...
export declare namespace PatchActivityDetails {
    enum DeployStatus {
        Scheduled = "SCHEDULED",
        Running = "RUNNING",
        Completed = "COMPLETED",
    ...
    function getJsonObj(obj: PatchActivityDetails): object;
    function getDeserializedJsonObj(obj: PatchActivityDetails): object;
}

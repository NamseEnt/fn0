...
export declare namespace AdditionalPatches {
    enum Category {
    ...
    function getJsonObj(obj: AdditionalPatches): object;
    function getDeserializedJsonObj(obj: AdditionalPatches): object;
}

...
export interface ConfigurationAggregation {
     ...
     */
    "items": Array<model.Configuration>;
}
export declare namespace ConfigurationAggregation {
    function getJsonObj(obj: ConfigurationAggregation): object;
    function getDeserializedJsonObj(obj: ConfigurationAggregation): object;
}

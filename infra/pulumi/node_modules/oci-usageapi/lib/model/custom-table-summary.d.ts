...
export declare namespace CustomTableSummary {
    function getJsonObj(obj: CustomTableSummary): object;
    function getDeserializedJsonObj(obj: CustomTableSummary): object;
}

...
export declare namespace DynamicDateRange {
    ...
    function getJsonObj(obj: DynamicDateRange, isParentJsonObj?: boolean): object;
    const dateRangeType = "DYNAMIC";
    function getDeserializedJsonObj(obj: DynamicDateRange, isParentJsonObj?: boolean): object;
}

...
export interface QueryCollection {
     ...
     * Query list.
     */
    "items": Array<model.QuerySummary>;
}
export declare namespace QueryCollection {
    function getJsonObj(obj: QueryCollection): object;
    function getDeserializedJsonObj(obj: QueryCollection): object;
}

...
export declare namespace UpdateQueryDetails {
    function getJsonObj(obj: UpdateQueryDetails): object;
    function getDeserializedJsonObj(obj: UpdateQueryDetails): object;
}

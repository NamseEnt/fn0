 ...
 */
export interface CreateUsageCarbonEmissionsQueryDetails {
    /**
...
export declare namespace CreateUsageCarbonEmissionsQueryDetails {
    function getJsonObj(obj: CreateUsageCarbonEmissionsQueryDetails): object;
    function getDeserializedJsonObj(obj: CreateUsageCarbonEmissionsQueryDetails): object;
}

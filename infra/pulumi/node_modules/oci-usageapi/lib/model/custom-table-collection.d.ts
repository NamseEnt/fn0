 ...
 * A custom table list.
 */
export interface CustomTableCollection {
    /**
     * Custom tables list.
     */
    "items": Array<model.CustomTableSummary>;
}
export declare namespace CustomTableCollection {
    function getJsonObj(obj: CustomTableCollection): object;
    function getDeserializedJsonObj(obj: CustomTableCollection): object;
}

...
export declare class UsageapiWaiter {
     ...
     */
    forEmailRecipientsGroup(request: serviceRequests.GetEmailRecipientsGroupRequest, ...targetStates: models.EmailRecipientsGroup.LifecycleState[]): Promise<serviceResponses.GetEmailRecipientsGroupResponse>;
    /**

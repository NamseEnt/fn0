...
export declare namespace CreateMonitoredResourceTypeDetails {
    function getJsonObj(obj: CreateMonitoredResourceTypeDetails): object;
    function getDeserializedJsonObj(obj: CreateMonitoredResourceTypeDetails): object;
}

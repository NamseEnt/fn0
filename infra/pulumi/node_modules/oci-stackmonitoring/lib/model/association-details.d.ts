...
export declare namespace AssociationDetails {
    function getJsonObj(obj: AssociationDetails): object;
    function getDeserializedJsonObj(obj: AssociationDetails): object;
}

 ...
 *
 */
export interface CreateMaintenanceWindowResourceDetails {
    /**
...
export declare namespace CreateMaintenanceWindowResourceDetails {
    function getJsonObj(obj: CreateMaintenanceWindowResourceDetails): object;
    function getDeserializedJsonObj(obj: CreateMaintenanceWindowResourceDetails): object;
}

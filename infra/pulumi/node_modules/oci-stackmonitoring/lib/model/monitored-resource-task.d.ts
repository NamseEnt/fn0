...
export declare namespace MonitoredResourceTask {
    function getJsonObj(obj: MonitoredResourceTask): object;
    function getDeserializedJsonObj(obj: MonitoredResourceTask): object;
}

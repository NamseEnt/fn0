...
export declare namespace SearchMonitoredResourceMembersDetails {
    function getJsonObj(obj: SearchMonitoredResourceMembersDetails): object;
    function getDeserializedJsonObj(obj: SearchMonitoredResourceMembersDetails): object;
}

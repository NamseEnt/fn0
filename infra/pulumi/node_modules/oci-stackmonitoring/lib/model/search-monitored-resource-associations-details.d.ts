...
export declare namespace SearchMonitoredResourceAssociationsDetails {
    enum SortBy {
        TimeCreated = "TIME_CREATED",
        AssocType = "ASSOC_TYPE"
    }
    function getJsonObj(obj: SearchMonitoredResourceAssociationsDetails): object;
    function getDeserializedJsonObj(obj: SearchMonitoredResourceAssociationsDetails): object;
}

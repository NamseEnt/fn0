...
export declare namespace MonitoredResourceAliasSourceCredential {
    function getJsonObj(obj: MonitoredResourceAliasSourceCredential): object;
    function getDeserializedJsonObj(obj: MonitoredResourceAliasSourceCredential): object;
}

...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/stackmonitoring/RequestMonitoredResourcesSummarizedCount.ts.html |here} to see how to use RequestMonitoredResourcesSummarizedCountRequest.
 */
...
export declare namespace RequestMonitoredResourcesSummarizedCountRequest {
    enum GroupBy {

...
export declare namespace AssignedSubscriptionLineItemSummary {
    function getJsonObj(obj: AssignedSubscriptionLineItemSummary): object;
    function getDeserializedJsonObj(obj: AssignedSubscriptionLineItemSummary): object;
}

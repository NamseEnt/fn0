...
export declare namespace ActivateOrderDetails {
    function getJsonObj(obj: ActivateOrderDetails): object;
    function getDeserializedJsonObj(obj: ActivateOrderDetails): object;
}

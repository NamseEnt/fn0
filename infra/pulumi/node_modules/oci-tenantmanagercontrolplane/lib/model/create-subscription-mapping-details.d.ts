...
export declare namespace CreateSubscriptionMappingDetails {
    function getJsonObj(obj: CreateSubscriptionMappingDetails): object;
    function getDeserializedJsonObj(obj: CreateSubscriptionMappingDetails): object;
}

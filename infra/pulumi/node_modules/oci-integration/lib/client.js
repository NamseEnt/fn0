...
class IntegrationInstanceClient {
     ...
     */
    addLogAnalyticsLogGroup(addLogAnalyticsLogGroupRequest) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const apiReferenceLink = "https://docs.oracle.com/iaas/api/#/en/integration/20190131/IntegrationInstance/AddLogAnalyticsLogGroup";
            const pathParams = {
            ...
            const retrier = oci_common_2.GenericRetrier.createPreferredRetrier(this._clientConfiguration ? this._clientConfiguration.retryConfiguration : undefined, addLogAnalyticsLogGroupRequest.retryConfiguration, specRetryConfiguration);
            if (this.logger)
            ...
            const request = yield oci_common_2.composeRequest({
                ...
                method: "POST",
                bodyContent: common.ObjectSerializer.serialize(addLogAnalyticsLogGroupRequest.addLogAnalyticsLogGroupDetails, "AddLogAnalyticsLogGroupDetails", model.AddLogAnalyticsLogGroupDetails.getJsonObj),
     ...
     */
    convertInstance(convertInstanceRequest) {
        return __awaiter(this, void 0, void 0, function* () {
            if (this.logger)
                this.logger.debug("Calling operation IntegrationInstanceClient#convertInstance.");
            const operationName = "convertInstance";
            const apiReferenceLink = "https://docs.oracle.com/iaas/api/#/en/integration/20190131/IntegrationInstance/ConvertInstance";
            const pathParams = {
            ...
            const specRetryConfiguration = common.OciSdkDefaultRetryConfiguration;
            const retrier = oci_common_2.GenericRetrier.createPreferredRetrier(this._clientConfiguration ? this._clientConfiguration.retryConfiguration : undefined, convertInstanceRequest.retryConfiguration, specRetryConfiguration);
            if (this.logger)
                retrier.logger = this.logger;
            const request = yield oci_common_2.composeRequest({
                baseEndpoint: this._endpoint,
                ...
                method: "POST",
                bodyContent: common.ObjectSerializer.serialize(convertInstanceRequest.convertInstanceDetails, "ConvertInstanceDetails", model.ConvertInstanceDetails.getJsonObj),
                pathParams: pathParams,
                headerParams: headerParams,
                queryParams: queryParams
            });
     ...
     */
    disableProcessAutomation(disableProcessAutomationRequest) {
        return __awaiter(this, void 0, void 0, function* () {
            if (this.logger)
            ...
            const apiReferenceLink = "https://docs.oracle.com/iaas/api/#/en/integration/20190131/IntegrationInstance/DisableProcessAutomation";
            const pathParams = {
            ...
            const specRetryConfiguration = common.OciSdkDefaultRetryConfiguration;
            const retrier = oci_common_2.GenericRetrier.createPreferredRetrier(this._clientConfiguration ? this._clientConfiguration.retryConfiguration : undefined, disableProcessAutomationRequest.retryConfiguration, specRetryConfiguration);
            if (this.logger)
                retrier.logger = this.logger;
            const request = yield oci_common_2.composeRequest({
                baseEndpoint: this._endpoint,
     ...
     */
    removeLogAnalyticsLogGroup(removeLogAnalyticsLogGroupRequest) {
        return __awaiter(this, void 0, void 0, function* () {
            if (this.logger)
            ...
            const apiReferenceLink = "https://docs.oracle.com/iaas/api/#/en/integration/20190131/IntegrationInstance/RemoveLogAnalyticsLogGroup";
            const pathParams = {
            ...
            const specRetryConfiguration = common.OciSdkDefaultRetryConfiguration;
            const retrier = oci_common_2.GenericRetrier.createPreferredRetrier(this._clientConfiguration ? this._clientConfiguration.retryConfiguration : undefined, removeLogAnalyticsLogGroupRequest.retryConfiguration, specRetryConfiguration);
            if (this.logger)
                retrier.logger = this.logger;
            const request = yield oci_common_2.composeRequest({
                baseEndpoint: this._endpoint,

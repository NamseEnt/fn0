...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/loadbalancer/UpdateHealthChecker.ts.html |here} to see how to use UpdateHealthCheckerRequest.
 */
export interface UpdateHealthCheckerRequest extends common.BaseRequest {
    /**
     * The health check policy configuration details.
     */
    "healthChecker": model.UpdateHealthCheckerDetails;
    /**

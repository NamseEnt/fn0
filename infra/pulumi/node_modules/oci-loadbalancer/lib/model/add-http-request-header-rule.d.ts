...
export declare namespace AddHttpRequestHeaderRule {
    function getJsonObj(obj: AddHttpRequestHeaderRule, isParentJsonObj?: boolean): object;
    const action = "ADD_HTTP_REQUEST_HEADER";
    function getDeserializedJsonObj(obj: AddHttpRequestHeaderRule, isParentJsonObj?: boolean): object;
}

...
export declare namespace AddHttpResponseHeaderRule {
    function getJsonObj(obj: AddHttpResponseHeaderRule, isParentJsonObj?: boolean): object;
    const action = "ADD_HTTP_RESPONSE_HEADER";
    function getDeserializedJsonObj(obj: AddHttpResponseHeaderRule, isParentJsonObj?: boolean): object;
}

...
export declare namespace LoadBalancerShape {
    function getJsonObj(obj: LoadBalancerShape): object;
    function getDeserializedJsonObj(obj: LoadBalancerShape): object;
}

...
export declare namespace CreateBackendSetDetails {
    function getJsonObj(obj: CreateBackendSetDetails): object;
    function getDeserializedJsonObj(obj: CreateBackendSetDetails): object;
}

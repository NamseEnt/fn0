...
export declare namespace RemoveHttpRequestHeaderRule {
    function getJsonObj(obj: RemoveHttpRequestHeaderRule, isParentJsonObj?: boolean): object;
    const action = "REMOVE_HTTP_REQUEST_HEADER";
    function getDeserializedJsonObj(obj: RemoveHttpRequestHeaderRule, isParentJsonObj?: boolean): object;
}

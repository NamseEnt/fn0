...
export declare namespace BackendSetDetails {
    function getJsonObj(obj: BackendSetDetails): object;
    function getDeserializedJsonObj(obj: BackendSetDetails): object;
}

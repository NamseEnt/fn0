...
export declare namespace AllowRule {
    function getJsonObj(obj: AllowRule, isParentJsonObj?: boolean): object;
    const action = "ALLOW";
    function getDeserializedJsonObj(obj: AllowRule, isParentJsonObj?: boolean): object;
}

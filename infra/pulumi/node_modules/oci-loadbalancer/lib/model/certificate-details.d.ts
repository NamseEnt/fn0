...
export declare namespace CertificateDetails {
    function getJsonObj(obj: CertificateDetails): object;
    function getDeserializedJsonObj(obj: CertificateDetails): object;
}

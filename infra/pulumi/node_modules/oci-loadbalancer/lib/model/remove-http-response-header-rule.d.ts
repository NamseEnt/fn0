...
export declare namespace RemoveHttpResponseHeaderRule {
    function getJsonObj(obj: RemoveHttpResponseHeaderRule, isParentJsonObj?: boolean): object;
    const action = "REMOVE_HTTP_RESPONSE_HEADER";
    function getDeserializedJsonObj(obj: RemoveHttpResponseHeaderRule, isParentJsonObj?: boolean): object;
}

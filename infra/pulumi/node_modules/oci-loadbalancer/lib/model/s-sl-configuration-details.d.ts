...
export declare namespace SSLConfigurationDetails {
    enum ServerOrderPreference {
        Enabled = "ENABLED",
        Disabled = "DISABLED"
    }
    function getJsonObj(obj: SSLConfigurationDetails): object;
    function getDeserializedJsonObj(obj: SSLConfigurationDetails): object;
}

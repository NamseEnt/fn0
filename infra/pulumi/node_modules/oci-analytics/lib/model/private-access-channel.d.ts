...
export declare namespace PrivateAccessChannel {
    function getJsonObj(obj: PrivateAccessChannel): object;
    function getDeserializedJsonObj(obj: PrivateAccessChannel): object;
}

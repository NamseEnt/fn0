...
export declare namespace AuthenticationMode {
    function getJsonObj(obj: AuthenticationMode): object;
    function getDeserializedJsonObj(obj: AuthenticationMode): object;
}

 ...
 */
export interface ChangeOciCacheUserCompartmentDetails {
    /**
     * OCID of the compartment into which the OCI cache user will be moved.
     */
    "compartmentId": string;
}
export declare namespace ChangeOciCacheUserCompartmentDetails {
    function getJsonObj(obj: ChangeOciCacheUserCompartmentDetails): object;
    function getDeserializedJsonObj(obj: ChangeOciCacheUserCompartmentDetails): object;
}

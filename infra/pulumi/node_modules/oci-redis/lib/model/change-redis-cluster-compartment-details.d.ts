...
export declare namespace ChangeRedisClusterCompartmentDetails {
    function getJsonObj(obj: ChangeRedisClusterCompartmentDetails): object;
    function getDeserializedJsonObj(obj: ChangeRedisClusterCompartmentDetails): object;
}

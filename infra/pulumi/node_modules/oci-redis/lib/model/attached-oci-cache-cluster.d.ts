 ...
 */
export interface AttachedOciCacheCluster {
    /**
...
export declare namespace AttachedOciCacheCluster {
    function getJsonObj(obj: AttachedOciCacheCluster): object;
    function getDeserializedJsonObj(obj: AttachedOciCacheCluster): object;
}

 ...
 */
export interface AttachedOciCacheUser {
    /**
...
export declare namespace AttachedOciCacheUser {
    function getJsonObj(obj: AttachedOciCacheUser): object;
    function getDeserializedJsonObj(obj: AttachedOciCacheUser): object;
}

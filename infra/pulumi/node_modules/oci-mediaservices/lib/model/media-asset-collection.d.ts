...
export interface MediaAssetCollection {
     ...
     * List of mediaAssets.
     */
    "items": Array<model.MediaAssetSummary>;
}
export declare namespace MediaAssetCollection {
    function getJsonObj(obj: MediaAssetCollection): object;
    function getDeserializedJsonObj(obj: MediaAssetCollection): object;
}

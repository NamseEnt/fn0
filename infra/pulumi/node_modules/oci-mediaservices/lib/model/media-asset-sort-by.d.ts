 ...
 **/
export declare enum MediaAssetSortBy {
...
export declare namespace MediaAssetSortBy {
    function getJsonObj(obj: MediaAssetSortBy): MediaAssetSortBy;
    function getDeserializedJsonObj(obj: MediaAssetSortBy): MediaAssetSortBy;
}

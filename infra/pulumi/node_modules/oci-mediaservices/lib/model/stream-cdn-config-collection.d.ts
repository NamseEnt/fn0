...
export declare namespace StreamCdnConfigCollection {
    function getJsonObj(obj: StreamCdnConfigCollection): object;
    function getDeserializedJsonObj(obj: StreamCdnConfigCollection): object;
}

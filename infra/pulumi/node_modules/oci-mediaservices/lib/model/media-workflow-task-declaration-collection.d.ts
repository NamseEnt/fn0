...
export declare namespace MediaWorkflowTaskDeclarationCollection {
    function getJsonObj(obj: MediaWorkflowTaskDeclarationCollection): object;
    function getDeserializedJsonObj(obj: MediaWorkflowTaskDeclarationCollection): object;
}

...
export declare namespace StreamCdnConfigSummary {
    function getJsonObj(obj: StreamCdnConfigSummary): object;
    function getDeserializedJsonObj(obj: StreamCdnConfigSummary): object;
}

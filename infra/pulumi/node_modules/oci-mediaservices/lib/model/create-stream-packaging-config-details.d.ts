...
export declare namespace CreateStreamPackagingConfigDetails {
    enum StreamPackagingFormat {
        Hls = "HLS",
        Dash = "DASH"
    }
    function getJsonObj(obj: CreateStreamPackagingConfigDetails): object;
    function getDeserializedJsonObj(obj: CreateStreamPackagingConfigDetails): object;
}

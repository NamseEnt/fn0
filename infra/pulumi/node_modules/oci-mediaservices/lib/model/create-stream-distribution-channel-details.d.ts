...
export declare namespace CreateStreamDistributionChannelDetails {
    function getJsonObj(obj: CreateStreamDistributionChannelDetails): object;
    function getDeserializedJsonObj(obj: CreateStreamDistributionChannelDetails): object;
}

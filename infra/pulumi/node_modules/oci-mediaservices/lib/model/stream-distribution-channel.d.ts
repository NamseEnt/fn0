...
export declare namespace StreamDistributionChannel {
    enum LifecycleState {
        Active = "ACTIVE",
    ...
    function getJsonObj(obj: StreamDistributionChannel): object;
    function getDeserializedJsonObj(obj: StreamDistributionChannel): object;
}

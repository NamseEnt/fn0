 ...
 *
 */
export interface StreamDistributionChannelCollection {
    /**
     * List of Stream Distribution Channels.
     */
    "items": Array<model.StreamDistributionChannelSummary>;
}
export declare namespace StreamDistributionChannelCollection {
    function getJsonObj(obj: StreamDistributionChannelCollection): object;
    function getDeserializedJsonObj(obj: StreamDistributionChannelCollection): object;
}

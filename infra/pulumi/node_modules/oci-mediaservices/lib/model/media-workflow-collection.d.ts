...
export declare namespace MediaWorkflowCollection {
    function getJsonObj(obj: MediaWorkflowCollection): object;
    function getDeserializedJsonObj(obj: MediaWorkflowCollection): object;
}

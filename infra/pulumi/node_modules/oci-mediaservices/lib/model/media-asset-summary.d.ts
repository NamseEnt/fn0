...
export declare namespace MediaAssetSummary {
    function getJsonObj(obj: MediaAssetSummary): object;
    function getDeserializedJsonObj(obj: MediaAssetSummary): object;
}

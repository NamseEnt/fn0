 ...
 */
export interface UpdateMediaWorkflowJobDetails {
    /**
...
export declare namespace UpdateMediaWorkflowJobDetails {
    function getJsonObj(obj: UpdateMediaWorkflowJobDetails): object;
    function getDeserializedJsonObj(obj: UpdateMediaWorkflowJobDetails): object;
}

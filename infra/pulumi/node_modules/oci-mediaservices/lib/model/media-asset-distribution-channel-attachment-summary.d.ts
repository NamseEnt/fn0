...
export declare namespace MediaAssetDistributionChannelAttachmentSummary {
    enum LifecycleState {
        Creating = "CREATING",
        Active = "ACTIVE",
    ...
    function getJsonObj(obj: MediaAssetDistributionChannelAttachmentSummary): object;
    function getDeserializedJsonObj(obj: MediaAssetDistributionChannelAttachmentSummary): object;
}

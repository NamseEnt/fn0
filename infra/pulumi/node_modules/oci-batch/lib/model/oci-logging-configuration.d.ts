...
export declare namespace OciLoggingConfiguration {
    function getJsonObj(obj: OciLoggingConfiguration, isParentJsonObj?: boolean): object;
    const type = "OCI_LOGGING";
    function getDeserializedJsonObj(obj: OciLoggingConfiguration, isParentJsonObj?: boolean): object;
}

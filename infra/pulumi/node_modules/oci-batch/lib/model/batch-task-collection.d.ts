...
export declare namespace BatchTaskCollection {
    function getJsonObj(obj: BatchTaskCollection): object;
    function getDeserializedJsonObj(obj: BatchTaskCollection): object;
}

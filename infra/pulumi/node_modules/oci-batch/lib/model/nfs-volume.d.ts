...
export declare namespace NfsVolume {
    function getJsonObj(obj: NfsVolume, isParentJsonObj?: boolean): object;
    const type = "NFS";
    function getDeserializedJsonObj(obj: NfsVolume, isParentJsonObj?: boolean): object;
}

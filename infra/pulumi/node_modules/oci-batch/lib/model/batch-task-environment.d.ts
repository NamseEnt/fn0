...
*
*/
export interface BatchTaskEnvironment {
    /**
     ...
     *
     */
    "lifecycleState": BatchTaskEnvironment.LifecycleState;
    /**
...
export declare namespace BatchTaskEnvironment {
    enum LifecycleState {
        Active = "ACTIVE",
        Deleted = "DELETED",
        /**
    ...
    function getJsonObj(obj: BatchTaskEnvironment): object;
    function getDeserializedJsonObj(obj: BatchTaskEnvironment): object;
}

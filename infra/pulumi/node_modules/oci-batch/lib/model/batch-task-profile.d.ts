...
*
*/
export interface BatchTaskProfile {
    /**
     ...
     *
     */
    "lifecycleState": BatchTaskProfile.LifecycleState;
    /**
...
export declare namespace BatchTaskProfile {
    enum LifecycleState {
        Active = "ACTIVE",
        Deleted = "DELETED",
        /**
    ...
    function getJsonObj(obj: BatchTaskProfile): object;
    function getDeserializedJsonObj(obj: BatchTaskProfile): object;
}

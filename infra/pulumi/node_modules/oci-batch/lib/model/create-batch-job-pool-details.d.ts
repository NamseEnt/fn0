 ...
 *
 */
export interface CreateBatchJobPoolDetails {
    /**
...
export declare namespace CreateBatchJobPoolDetails {
    function getJsonObj(obj: CreateBatchJobPoolDetails): object;
    function getDeserializedJsonObj(obj: CreateBatchJobPoolDetails): object;
}

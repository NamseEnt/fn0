...
export declare namespace CreateBatchTaskProfileDetails {
    function getJsonObj(obj: CreateBatchTaskProfileDetails): object;
    function getDeserializedJsonObj(obj: CreateBatchTaskProfileDetails): object;
}

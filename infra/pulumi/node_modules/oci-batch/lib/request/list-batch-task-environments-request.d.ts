...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/batch/ListBatchTaskEnvironments.ts.html |here} to see how to use ListBatchTaskEnvironmentsRequest.
 */
export interface ListBatchTaskEnvironmentsRequest extends common.BaseRequest {
    /**

...
exports.ApmDomainWaiter = void 0;
const models = __importStar(require("./model"));
const oci_common_1 = require("oci-common");
class ApmDomainWaiter {
     ...
     */
    forApmDomain(request, ...targetStates) {
        return __awaiter(this, void 0, void 0, function* () {
            return oci_common_1.genericTerminalConditionWaiter(this.config, () => this.client.getApmDomain(request), response => targetStates.includes(response.apmDomain.lifecycleState), targetStates.includes(models.LifecycleStates.Deleted));
        });
    }
    /**
...
exports.ApmDomainWaiter = ApmDomainWaiter;
//# sourceMappingURL=apmdomain-waiter.js.map
...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/iot/ListIotDomainGroups.ts.html |here} to see how to use ListIotDomainGroupsRequest.
 */
export interface ListIotDomainGroupsRequest extends common.BaseRequest {
    /**
...
export declare namespace ListIotDomainGroupsRequest {
    enum SortOrder {
        Asc = "ASC",
        Desc = "DESC"
    }

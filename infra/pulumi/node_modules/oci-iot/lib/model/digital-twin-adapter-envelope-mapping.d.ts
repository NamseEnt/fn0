...
export declare namespace DigitalTwinAdapterEnvelopeMapping {
    function getJsonObj(obj: DigitalTwinAdapterEnvelopeMapping): object;
    function getDeserializedJsonObj(obj: DigitalTwinAdapterEnvelopeMapping): object;
}

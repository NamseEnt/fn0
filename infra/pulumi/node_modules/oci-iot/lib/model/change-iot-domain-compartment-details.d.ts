...
export declare namespace ChangeIotDomainCompartmentDetails {
    function getJsonObj(obj: ChangeIotDomainCompartmentDetails): object;
    function getDeserializedJsonObj(obj: ChangeIotDomainCompartmentDetails): object;
}

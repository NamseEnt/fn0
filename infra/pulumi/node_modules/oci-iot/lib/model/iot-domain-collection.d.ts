...
export declare namespace IotDomainCollection {
    function getJsonObj(obj: IotDomainCollection): object;
    function getDeserializedJsonObj(obj: IotDomainCollection): object;
}

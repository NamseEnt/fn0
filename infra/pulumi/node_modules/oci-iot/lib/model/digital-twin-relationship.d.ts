...
export declare namespace DigitalTwinRelationship {
    function getJsonObj(obj: DigitalTwinRelationship): object;
    function getDeserializedJsonObj(obj: DigitalTwinRelationship): object;
}

 ...
 */
export interface UpdateIotDomainGroupDetails {
    /**
...
export declare namespace UpdateIotDomainGroupDetails {
    function getJsonObj(obj: UpdateIotDomainGroupDetails): object;
    function getDeserializedJsonObj(obj: UpdateIotDomainGroupDetails): object;
}

...
export declare namespace IotDomainGroup {
    enum Type {
        Standard = "STANDARD",
    ...
    function getJsonObj(obj: IotDomainGroup): object;
    function getDeserializedJsonObj(obj: IotDomainGroup): object;
}

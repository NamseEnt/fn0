...
export declare namespace DigitalTwinAdapterInboundRoute {
    function getJsonObj(obj: DigitalTwinAdapterInboundRoute): object;
    function getDeserializedJsonObj(obj: DigitalTwinAdapterInboundRoute): object;
}

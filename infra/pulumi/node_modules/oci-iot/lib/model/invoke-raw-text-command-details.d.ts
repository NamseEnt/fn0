...
export declare namespace InvokeRawTextCommandDetails {
    function getJsonObj(obj: InvokeRawTextCommandDetails, isParentJsonObj?: boolean): object;
    const requestDataFormat = "TEXT";
    function getDeserializedJsonObj(obj: InvokeRawTextCommandDetails, isParentJsonObj?: boolean): object;
}

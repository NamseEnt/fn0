...
export declare namespace IotDomainGroupSummary {
    enum Type {
        Standard = "STANDARD",
    ...
    function getJsonObj(obj: IotDomainGroupSummary): object;
    function getDeserializedJsonObj(obj: IotDomainGroupSummary): object;
}

 ...
 */
/**
 * Vcn resource for validation of dbAllowListedVcns
 */
export interface Vcn {
}
export declare namespace Vcn {
    function getJsonObj(obj: Vcn): object;
    function getDeserializedJsonObj(obj: Vcn): object;
}

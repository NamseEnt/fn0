 ...
 */
export interface UpdateIotDomainDetails {
    /**
...
export declare namespace UpdateIotDomainDetails {
    function getJsonObj(obj: UpdateIotDomainDetails): object;
    function getDeserializedJsonObj(obj: UpdateIotDomainDetails): object;
}

 ...
 */
export interface CreateDigitalTwinModelDetails {
    /**
...
export declare namespace CreateDigitalTwinModelDetails {
    function getJsonObj(obj: CreateDigitalTwinModelDetails): object;
    function getDeserializedJsonObj(obj: CreateDigitalTwinModelDetails): object;
}

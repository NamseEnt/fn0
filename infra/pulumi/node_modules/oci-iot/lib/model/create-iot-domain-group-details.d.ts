 ...
 */
export interface CreateIotDomainGroupDetails {
    /**
...
export declare namespace CreateIotDomainGroupDetails {
    enum Type {
        Standard = "STANDARD",
        Lightweight = "LIGHTWEIGHT"
    }
    function getJsonObj(obj: CreateIotDomainGroupDetails): object;
    function getDeserializedJsonObj(obj: CreateIotDomainGroupDetails): object;
}

...
class DbManagementWaiter {
     ...
     */
    forCloudAsm(request, ...targetStates) {
        return __awaiter(this, void 0, void 0, function* () {
            return oci_common_1.genericTerminalConditionWaiter(this.config, () => this.client.getCloudAsm(request), response => targetStates.includes(response.cloudAsm.lifecycleState), targetStates.includes(models.CloudAsm.LifecycleState.Deleted));
        });
    }
    /**
     ...
     */
    forCloudAsmInstance(request, ...targetStates) {
        return __awaiter(this, void 0, void 0, function* () {
            return oci_common_1.genericTerminalConditionWaiter(this.config, () => this.client.getCloudAsmInstance(request), response => targetStates.includes(response.cloudAsmInstance.lifecycleState), targetStates.includes(models.CloudAsmInstance.LifecycleState.Deleted));
        });
    }
    /**
     ...
     */
    forCloudCluster(request, ...targetStates) {
        return __awaiter(this, void 0, void 0, function* () {
            return oci_common_1.genericTerminalConditionWaiter(this.config, () => this.client.getCloudCluster(request), response => targetStates.includes(response.cloudCluster.lifecycleState), targetStates.includes(models.CloudCluster.LifecycleState.Deleted));
        });
    }
    /**
     ...
     */
    forCloudClusterInstance(request, ...targetStates) {
        return __awaiter(this, void 0, void 0, function* () {
            return oci_common_1.genericTerminalConditionWaiter(this.config, () => this.client.getCloudClusterInstance(request), response => targetStates.includes(response.cloudClusterInstance.lifecycleState), targetStates.includes(models.CloudClusterInstance.LifecycleState.Deleted));
        });
    }
    /**
     ...
     */
    forCloudDbHome(request, ...targetStates) {
        return __awaiter(this, void 0, void 0, function* () {
            return oci_common_1.genericTerminalConditionWaiter(this.config, () => this.client.getCloudDbHome(request), response => targetStates.includes(response.cloudDbHome.lifecycleState), targetStates.includes(models.CloudDbHome.LifecycleState.Deleted));
        });
    }
    /**
     ...
     */
    forCloudDbNode(request, ...targetStates) {
        return __awaiter(this, void 0, void 0, function* () {
            return oci_common_1.genericTerminalConditionWaiter(this.config, () => this.client.getCloudDbNode(request), response => targetStates.includes(response.cloudDbNode.lifecycleState), targetStates.includes(models.CloudDbNode.LifecycleState.Deleted));
        });
    }
    /**
     ...
     */
    forCloudDbSystem(request, ...targetStates) {
        return __awaiter(this, void 0, void 0, function* () {
            return oci_common_1.genericTerminalConditionWaiter(this.config, () => this.client.getCloudDbSystem(request), response => targetStates.includes(response.cloudDbSystem.lifecycleState), targetStates.includes(models.CloudDbSystem.LifecycleState.Deleted));
        });
    }
    /**
     ...
     */
    forCloudDbSystemConnector(request, ...targetStates) {
        return __awaiter(this, void 0, void 0, function* () {
            return oci_common_1.genericTerminalConditionWaiter(this.config, () => this.client.getCloudDbSystemConnector(request), response => targetStates.includes(response.cloudDbSystemConnector.lifecycleState), targetStates.includes(models.CloudDbSystemConnector.LifecycleState.Deleted));
        });
    }
    /**
     ...
     */
    forCloudDbSystemDiscovery(request, ...targetStates) {
        return __awaiter(this, void 0, void 0, function* () {
            return oci_common_1.genericTerminalConditionWaiter(this.config, () => this.client.getCloudDbSystemDiscovery(request), response => targetStates.includes(response.cloudDbSystemDiscovery.lifecycleState), targetStates.includes(models.CloudDbSystemDiscovery.LifecycleState.Deleted));
        });
    }
    /**
     ...
     */
    forCloudListener(request, ...targetStates) {
        return __awaiter(this, void 0, void 0, function* () {
            return oci_common_1.genericTerminalConditionWaiter(this.config, () => this.client.getCloudListener(request), response => targetStates.includes(response.cloudListener.lifecycleState), targetStates.includes(models.CloudListener.LifecycleState.Deleted));
        });
    }
    /**

 ...
 */
export interface CloudAsmConnectionCredentialsByDetails extends model.CloudAsmConnectionCredentials {
    /**
...
export declare namespace CloudAsmConnectionCredentialsByDetails {
    enum Role {
        Sysasm = "SYSASM",
        Sysdba = "SYSDBA",
        Sysoper = "SYSOPER",
    ...
    function getJsonObj(obj: CloudAsmConnectionCredentialsByDetails, isParentJsonObj?: boolean): object;
    const credentialType = "DETAILS";
    function getDeserializedJsonObj(obj: CloudAsmConnectionCredentialsByDetails, isParentJsonObj?: boolean): object;
}

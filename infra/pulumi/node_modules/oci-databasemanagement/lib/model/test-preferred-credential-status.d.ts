...
export declare namespace TestPreferredCredentialStatus {
    enum Status {
        Succeeded = "SUCCEEDED",
        Failed = "FAILED",
        /**
    ...
    function getJsonObj(obj: TestPreferredCredentialStatus): object;
    function getDeserializedJsonObj(obj: TestPreferredCredentialStatus): object;
}

...
export declare namespace DatabaseUsageMetrics {
    function getJsonObj(obj: DatabaseUsageMetrics): object;
    function getDeserializedJsonObj(obj: DatabaseUsageMetrics): object;
}

...
export declare namespace ConsumerGroupPrivilegeCollection {
    function getJsonObj(obj: ConsumerGroupPrivilegeCollection): object;
    function getDeserializedJsonObj(obj: ConsumerGroupPrivilegeCollection): object;
}

...
export interface CloudDbHome {
     ...
     */
    "lifecycleState": CloudDbHome.LifecycleState;
    /**
...
export declare namespace CloudDbHome {
    enum LifecycleState {
        Creating = "CREATING",
        Active = "ACTIVE",
        Inactive = "INACTIVE",
    ...
    function getJsonObj(obj: CloudDbHome): object;
    function getDeserializedJsonObj(obj: CloudDbHome): object;
}

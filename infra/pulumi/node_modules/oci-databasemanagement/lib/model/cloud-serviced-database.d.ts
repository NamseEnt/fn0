 ...
 */
export interface CloudServicedDatabase {
    /**
...
export declare namespace CloudServicedDatabase {
    function getJsonObj(obj: CloudServicedDatabase): object;
    function getDeserializedJsonObj(obj: CloudServicedDatabase): object;
}

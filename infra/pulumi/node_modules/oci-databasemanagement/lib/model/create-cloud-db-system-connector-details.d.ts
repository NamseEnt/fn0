 ...
 */
export interface CreateCloudDbSystemConnectorDetails {
    /**
...
export declare namespace CreateCloudDbSystemConnectorDetails {
    function getJsonObj(obj: CreateCloudDbSystemConnectorDetails): object;
    function getDeserializedJsonObj(obj: CreateCloudDbSystemConnectorDetails): object;
}

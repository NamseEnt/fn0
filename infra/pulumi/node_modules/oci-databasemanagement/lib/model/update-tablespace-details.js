...
exports.UpdateTablespaceDetails = void 0;
const model = __importStar(require("../model"));
var UpdateTablespaceDetails;
(function (UpdateTablespaceDetails) {
    let Type;
    (function (Type) {
        Type["Permanent"] = "PERMANENT";
        Type["Temporary"] = "TEMPORARY";
    })(Type = UpdateTablespaceDetails.Type || (UpdateTablespaceDetails.Type = {}));
    let Status;
    (function (Status) {
        Status["ReadOnly"] = "READ_ONLY";
        Status["ReadWrite"] = "READ_WRITE";
    })(Status = UpdateTablespaceDetails.Status || (UpdateTablespaceDetails.Status = {}));
    ...
    UpdateTablespaceDetails.getJsonObj = getJsonObj;
    ...
    UpdateTablespaceDetails.getDeserializedJsonObj = getDeserializedJsonObj;
})(UpdateTablespaceDetails = exports.UpdateTablespaceDetails || (exports.UpdateTablespaceDetails = {}));
//# sourceMappingURL=update-tablespace-details.js.map
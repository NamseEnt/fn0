...
export declare namespace ExadataInfrastructureFleetHealthMetrics {
    function getJsonObj(obj: ExadataInfrastructureFleetHealthMetrics): object;
    function getDeserializedJsonObj(obj: ExadataInfrastructureFleetHealthMetrics): object;
}

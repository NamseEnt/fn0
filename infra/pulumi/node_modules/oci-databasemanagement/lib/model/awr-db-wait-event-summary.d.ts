...
export declare namespace AwrDbWaitEventSummary {
    function getJsonObj(obj: AwrDbWaitEventSummary): object;
    function getDeserializedJsonObj(obj: AwrDbWaitEventSummary): object;
}

...
export declare namespace AwrDbSnapshotCollection {
    function getJsonObj(obj: AwrDbSnapshotCollection, isParentJsonObj?: boolean): object;
    const awrResultType = "AWRDB_SNAPSHOT_SET";
    function getDeserializedJsonObj(obj: AwrDbSnapshotCollection, isParentJsonObj?: boolean): object;
}

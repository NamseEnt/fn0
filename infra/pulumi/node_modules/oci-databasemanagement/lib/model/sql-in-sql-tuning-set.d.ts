...
export declare namespace SqlInSqlTuningSet {
    function getJsonObj(obj: SqlInSqlTuningSet): object;
    function getDeserializedJsonObj(obj: SqlInSqlTuningSet): object;
}

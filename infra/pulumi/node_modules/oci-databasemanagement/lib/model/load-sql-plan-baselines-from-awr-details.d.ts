...
export declare namespace LoadSqlPlanBaselinesFromAwrDetails {
    function getJsonObj(obj: LoadSqlPlanBaselinesFromAwrDetails): object;
    function getDeserializedJsonObj(obj: LoadSqlPlanBaselinesFromAwrDetails): object;
}

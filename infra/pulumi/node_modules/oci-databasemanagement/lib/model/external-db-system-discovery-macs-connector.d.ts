 ...
 *
 */
export interface ExternalDbSystemDiscoveryMacsConnector extends model.ExternalDbSystemDiscoveryConnector {
    /**
...
export declare namespace ExternalDbSystemDiscoveryMacsConnector {
    function getJsonObj(obj: ExternalDbSystemDiscoveryMacsConnector, isParentJsonObj?: boolean): object;
    const connectorType = "MACS";
    function getDeserializedJsonObj(obj: ExternalDbSystemDiscoveryMacsConnector, isParentJsonObj?: boolean): object;
}

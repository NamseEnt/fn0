...
export declare namespace MemoryAggregateMetrics {
    function getJsonObj(obj: MemoryAggregateMetrics): object;
    function getDeserializedJsonObj(obj: MemoryAggregateMetrics): object;
}

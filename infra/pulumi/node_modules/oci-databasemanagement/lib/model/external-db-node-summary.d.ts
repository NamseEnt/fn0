 ...
 */
export interface ExternalDbNodeSummary {
    /**
...
export declare namespace ExternalDbNodeSummary {
    function getJsonObj(obj: ExternalDbNodeSummary): object;
    function getDeserializedJsonObj(obj: ExternalDbNodeSummary): object;
}

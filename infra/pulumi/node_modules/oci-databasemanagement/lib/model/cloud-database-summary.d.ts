...
export declare namespace CloudDatabaseSummary {
    enum LifecycleState {
        Creating = "CREATING",
        Active = "ACTIVE",
        Inactive = "INACTIVE",
    ...
    function getJsonObj(obj: CloudDatabaseSummary): object;
    function getDeserializedJsonObj(obj: CloudDatabaseSummary): object;
}

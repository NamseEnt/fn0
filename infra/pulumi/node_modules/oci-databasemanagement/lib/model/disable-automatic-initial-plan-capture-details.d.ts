 ...
 *
 */
export interface DisableAutomaticInitialPlanCaptureDetails {
...
export declare namespace DisableAutomaticInitialPlanCaptureDetails {
    function getJsonObj(obj: DisableAutomaticInitialPlanCaptureDetails): object;
    function getDeserializedJsonObj(obj: DisableAutomaticInitialPlanCaptureDetails): object;
}

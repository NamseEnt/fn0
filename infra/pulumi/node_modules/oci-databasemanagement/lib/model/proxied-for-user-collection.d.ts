...
export declare namespace ProxiedForUserCollection {
    function getJsonObj(obj: ProxiedForUserCollection): object;
    function getDeserializedJsonObj(obj: ProxiedForUserCollection): object;
}

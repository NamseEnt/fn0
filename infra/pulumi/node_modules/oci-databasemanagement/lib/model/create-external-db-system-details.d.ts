...
export declare namespace CreateExternalDbSystemDetails {
    function getJsonObj(obj: CreateExternalDbSystemDetails): object;
    function getDeserializedJsonObj(obj: CreateExternalDbSystemDetails): object;
}

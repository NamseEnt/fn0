...
export declare namespace CloudDbSystemDiscovery {
    enum LifecycleState {
        Creating = "CREATING",
        Active = "ACTIVE",
        Inactive = "INACTIVE",
    ...
    function getJsonObj(obj: CloudDbSystemDiscovery): object;
    function getDeserializedJsonObj(obj: CloudDbSystemDiscovery): object;
}

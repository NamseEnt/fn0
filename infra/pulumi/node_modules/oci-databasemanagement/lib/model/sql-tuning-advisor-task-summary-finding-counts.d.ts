...
export declare namespace SqlTuningAdvisorTaskSummaryFindingCounts {
    function getJsonObj(obj: SqlTuningAdvisorTaskSummaryFindingCounts): object;
    function getDeserializedJsonObj(obj: SqlTuningAdvisorTaskSummaryFindingCounts): object;
}

 ...
 */
export interface CloudDbNodeSummary {
    /**
...
export declare namespace CloudDbNodeSummary {
    function getJsonObj(obj: CloudDbNodeSummary): object;
    function getDeserializedJsonObj(obj: CloudDbNodeSummary): object;
}

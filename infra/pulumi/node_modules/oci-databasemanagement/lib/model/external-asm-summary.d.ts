...
export declare namespace ExternalAsmSummary {
    function getJsonObj(obj: ExternalAsmSummary): object;
    function getDeserializedJsonObj(obj: ExternalAsmSummary): object;
}

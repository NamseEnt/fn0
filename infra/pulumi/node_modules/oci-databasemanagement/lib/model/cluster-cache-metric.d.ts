...
export declare namespace ClusterCacheMetric {
    function getJsonObj(obj: ClusterCacheMetric): object;
    function getDeserializedJsonObj(obj: ClusterCacheMetric): object;
}

 ...
 */
export interface CloudAsmSummary {
    /**
...
export declare namespace CloudAsmSummary {
    function getJsonObj(obj: CloudAsmSummary): object;
    function getDeserializedJsonObj(obj: CloudAsmSummary): object;
}

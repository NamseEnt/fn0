...
export declare namespace DatabaseHaMetrics {
    function getJsonObj(obj: DatabaseHaMetrics): object;
    function getDeserializedJsonObj(obj: DatabaseHaMetrics): object;
}

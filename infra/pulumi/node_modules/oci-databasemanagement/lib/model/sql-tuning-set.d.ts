...
export declare namespace SqlTuningSet {
    enum AllSqlStatementsFetched {
        Yes = "YES",
        No = "NO",
        /**
    ...
    function getJsonObj(obj: SqlTuningSet): object;
    function getDeserializedJsonObj(obj: SqlTuningSet): object;
}

...
export declare namespace AwrDbParameterChangeCollection {
    function getJsonObj(obj: AwrDbParameterChangeCollection, isParentJsonObj?: boolean): object;
    const awrResultType = "AWRDB_DB_PARAMETER_CHANGE";
    function getDeserializedJsonObj(obj: AwrDbParameterChangeCollection, isParentJsonObj?: boolean): object;
}

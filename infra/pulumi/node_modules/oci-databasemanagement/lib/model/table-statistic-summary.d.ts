 ...
 *
 */
export interface TableStatisticSummary {
    /**
     * The valid status categories of table statistics.
     */
    "type": model.TableStatisticsStatusCategory;
    /**
...
export declare namespace TableStatisticSummary {
    function getJsonObj(obj: TableStatisticSummary): object;
    function getDeserializedJsonObj(obj: TableStatisticSummary): object;
}

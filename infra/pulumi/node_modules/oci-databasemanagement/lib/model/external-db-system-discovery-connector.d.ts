...
export declare namespace ExternalDbSystemDiscoveryConnector {
    function getJsonObj(obj: ExternalDbSystemDiscoveryConnector): object;
    function getDeserializedJsonObj(obj: ExternalDbSystemDiscoveryConnector): object;
}

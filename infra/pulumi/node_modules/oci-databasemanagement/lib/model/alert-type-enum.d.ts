...
export declare namespace AlertTypeEnum {
    function getJsonObj(obj: AlertTypeEnum): AlertTypeEnum;
    function getDeserializedJsonObj(obj: AlertTypeEnum): AlertTypeEnum;
}

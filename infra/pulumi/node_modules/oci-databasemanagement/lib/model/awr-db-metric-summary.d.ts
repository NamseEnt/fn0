...
export declare namespace AwrDbMetricSummary {
    function getJsonObj(obj: AwrDbMetricSummary): object;
    function getDeserializedJsonObj(obj: AwrDbMetricSummary): object;
}

...
export interface CloudListener {
     ...
     */
    "listenerType"?: CloudListener.ListenerType;
    /**
     ...
     */
    "lifecycleState": CloudListener.LifecycleState;
    /**
     ...
     */
    "servicedDatabases"?: Array<model.CloudListenerServicedDatabase>;
    /**
     * The list of ASMs that are serviced by the listener.
     */
    "servicedAsms"?: Array<model.CloudServicedAsm>;
    /**
...
export declare namespace CloudListener {
    enum ListenerType {
        Asm = "ASM",
        Local = "LOCAL",
        Scan = "SCAN",
    ...
    function getJsonObj(obj: CloudListener): object;
    function getDeserializedJsonObj(obj: CloudListener): object;
}

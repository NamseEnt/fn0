 ...
 *
 */
export interface CloudAsmConnectionCredentialsByName extends model.CloudAsmConnectionCredentials {
    /**
...
export declare namespace CloudAsmConnectionCredentialsByName {
    function getJsonObj(obj: CloudAsmConnectionCredentialsByName, isParentJsonObj?: boolean): object;
    const credentialType = "NAME_REFERENCE";
    function getDeserializedJsonObj(obj: CloudAsmConnectionCredentialsByName, isParentJsonObj?: boolean): object;
}

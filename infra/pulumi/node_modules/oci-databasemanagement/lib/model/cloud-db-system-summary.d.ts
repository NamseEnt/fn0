...
export declare namespace CloudDbSystemSummary {
    function getJsonObj(obj: CloudDbSystemSummary): object;
    function getDeserializedJsonObj(obj: CloudDbSystemSummary): object;
}

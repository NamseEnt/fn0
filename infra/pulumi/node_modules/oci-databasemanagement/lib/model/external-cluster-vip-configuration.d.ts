...
export declare namespace ExternalClusterVipConfiguration {
    function getJsonObj(obj: ExternalClusterVipConfiguration): object;
    function getDeserializedJsonObj(obj: ExternalClusterVipConfiguration): object;
}

...
export declare namespace DatabaseTimeAggregateMetrics {
    function getJsonObj(obj: DatabaseTimeAggregateMetrics): object;
    function getDeserializedJsonObj(obj: DatabaseTimeAggregateMetrics): object;
}

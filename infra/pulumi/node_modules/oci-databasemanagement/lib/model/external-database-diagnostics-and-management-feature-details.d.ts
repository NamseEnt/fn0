 ...
 */
export interface ExternalDatabaseDiagnosticsAndManagementFeatureDetails extends model.ExternalDatabaseFeatureDetails {
    /**
...
export declare namespace ExternalDatabaseDiagnosticsAndManagementFeatureDetails {
    enum LicenseModel {
        LicenseIncluded = "LICENSE_INCLUDED",
        BringYourOwnLicense = "BRING_YOUR_OWN_LICENSE"
    }
    function getJsonObj(obj: ExternalDatabaseDiagnosticsAndManagementFeatureDetails, isParentJsonObj?: boolean): object;
    const feature = "DIAGNOSTICS_AND_MANAGEMENT";
    function getDeserializedJsonObj(obj: ExternalDatabaseDiagnosticsAndManagementFeatureDetails, isParentJsonObj?: boolean): object;
}

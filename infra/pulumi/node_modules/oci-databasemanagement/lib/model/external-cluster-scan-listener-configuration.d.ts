...
export declare namespace ExternalClusterScanListenerConfiguration {
    enum ScanProtocol {
        Tcp = "TCP",
        Tcps = "TCPS",
        /**
    ...
    function getJsonObj(obj: ExternalClusterScanListenerConfiguration): object;
    function getDeserializedJsonObj(obj: ExternalClusterScanListenerConfiguration): object;
}

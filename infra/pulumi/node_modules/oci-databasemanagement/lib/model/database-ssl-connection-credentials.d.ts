...
export declare namespace DatabaseSslConnectionCredentials {
    enum Role {
        Sysdba = "SYSDBA",
        Normal = "NORMAL",
        Sysdg = "SYSDG",
    ...
    function getJsonObj(obj: DatabaseSslConnectionCredentials, isParentJsonObj?: boolean): object;
    const credentialType = "SSL_DETAILS";
    function getDeserializedJsonObj(obj: DatabaseSslConnectionCredentials, isParentJsonObj?: boolean): object;
}

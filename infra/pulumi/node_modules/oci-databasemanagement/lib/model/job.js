...
(function (Job) {
    ...
    (function (ScheduleType) {
        ...
        ScheduleType["Later"] = "LATER";
        /**
         * This value is used if a service returns a value for this enum that is not recognized by this
         * version of the SDK.
         */
        ScheduleType["UnknownValue"] = "UNKNOWN_VALUE";
    })(ScheduleType = Job.ScheduleType || (Job.ScheduleType = {}));
    let LifecycleState;
    ...
    function getJsonObj(obj) {
        ...
        if (obj && "jobType" in obj && obj.jobType) {
            switch (obj.jobType) {
                case "SQL":
                    return model.SqlJob.getJsonObj(jsonObj, true);
                default:
    ...
    function getDeserializedJsonObj(obj) {
        ...
        if (obj && "jobType" in obj && obj.jobType) {
            switch (obj.jobType) {
                case "SQL":
                    return model.SqlJob.getDeserializedJsonObj(jsonObj, true);
                default:
                    if (common.LOG.logger)
                        common.LOG.logger.info(`Unknown value for: ${obj.jobType}`);
            }

...
export declare namespace DiscoveredExternalDatabase {
    enum DbRole {
    ...
    function getJsonObj(obj: DiscoveredExternalDatabase, isParentJsonObj?: boolean): object;
    const componentType = "DATABASE";
    function getDeserializedJsonObj(obj: DiscoveredExternalDatabase, isParentJsonObj?: boolean): object;
}

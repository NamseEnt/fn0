...
export declare namespace DatabaseIOAggregateMetrics {
    function getJsonObj(obj: DatabaseIOAggregateMetrics): object;
    function getDeserializedJsonObj(obj: DatabaseIOAggregateMetrics): object;
}

...
export declare namespace ExternalServicedAsm {
    function getJsonObj(obj: ExternalServicedAsm): object;
    function getDeserializedJsonObj(obj: ExternalServicedAsm): object;
}

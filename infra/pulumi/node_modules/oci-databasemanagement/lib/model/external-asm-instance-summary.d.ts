...
export declare namespace ExternalAsmInstanceSummary {
    function getJsonObj(obj: ExternalAsmInstanceSummary): object;
    function getDeserializedJsonObj(obj: ExternalAsmInstanceSummary): object;
}

...
export declare namespace CloudAsmDiskGroupSummary {
    enum RedundancyType {
        Extend = "EXTEND",
        Extern = "EXTERN",
        Flex = "FLEX",
    ...
    function getJsonObj(obj: CloudAsmDiskGroupSummary): object;
    function getDeserializedJsonObj(obj: CloudAsmDiskGroupSummary): object;
}

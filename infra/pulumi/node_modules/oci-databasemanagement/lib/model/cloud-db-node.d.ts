...
export interface CloudDbNode {
    ...
    /**
     * The additional details of the cloud DB node defined in {@code {\"key\": \"value\"}} format.
     ...
     */
    "lifecycleState": CloudDbNode.LifecycleState;
    /**
...
export declare namespace CloudDbNode {
    enum LifecycleState {
        Creating = "CREATING",
    ...
    function getJsonObj(obj: CloudDbNode): object;
    function getDeserializedJsonObj(obj: CloudDbNode): object;
}

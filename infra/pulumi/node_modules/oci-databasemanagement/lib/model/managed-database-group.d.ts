...
export declare namespace ManagedDatabaseGroup {
    function getJsonObj(obj: ManagedDatabaseGroup): object;
    function getDeserializedJsonObj(obj: ManagedDatabaseGroup): object;
}

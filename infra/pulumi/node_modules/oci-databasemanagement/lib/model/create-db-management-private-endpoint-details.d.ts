...
export declare namespace CreateDbManagementPrivateEndpointDetails {
    function getJsonObj(obj: CreateDbManagementPrivateEndpointDetails): object;
    function getDeserializedJsonObj(obj: CreateDbManagementPrivateEndpointDetails): object;
}

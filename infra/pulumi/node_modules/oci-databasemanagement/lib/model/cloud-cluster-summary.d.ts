...
export declare namespace CloudClusterSummary {
    function getJsonObj(obj: CloudClusterSummary): object;
    function getDeserializedJsonObj(obj: CloudClusterSummary): object;
}

...
export declare namespace AwrDbWaitEventBucketCollection {
    function getJsonObj(obj: AwrDbWaitEventBucketCollection, isParentJsonObj?: boolean): object;
    const awrResultType = "AWRDB_EVENT_HISTOGRAM_SET";
    function getDeserializedJsonObj(obj: AwrDbWaitEventBucketCollection, isParentJsonObj?: boolean): object;
}

...
export declare namespace DbManagementAnalyticsMetric {
    function getJsonObj(obj: DbManagementAnalyticsMetric): object;
    function getDeserializedJsonObj(obj: DbManagementAnalyticsMetric): object;
}

...
export declare namespace ExternalExadataInfrastructureDiscoverySummary {
    enum RackSize {
        Full = "FULL",
        Half = "HALF",
        Quarter = "QUARTER",
    ...
    function getDeserializedJsonObj(obj: ExternalExadataInfrastructureDiscoverySummary, isParentJsonObj?: boolean): object;
}

 ...
 */
export interface CloudExadataStorageServerSummary extends model.DbmResource {
    /**
...
export declare namespace CloudExadataStorageServerSummary {
    function getJsonObj(obj: CloudExadataStorageServerSummary, isParentJsonObj?: boolean): object;
    const resourceType = "CLOUD_STORAGE_SERVER_SUMMARY";
    function getDeserializedJsonObj(obj: CloudExadataStorageServerSummary, isParentJsonObj?: boolean): object;
}

...
export declare namespace ManagedDatabaseSecretCredential {
    function getJsonObj(obj: ManagedDatabaseSecretCredential, isParentJsonObj?: boolean): object;
    const credentialType = "SECRET";
    function getDeserializedJsonObj(obj: ManagedDatabaseSecretCredential, isParentJsonObj?: boolean): object;
}

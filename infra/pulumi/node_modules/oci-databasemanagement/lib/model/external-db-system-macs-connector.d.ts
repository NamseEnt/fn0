 ...
 *
 */
export interface ExternalDbSystemMacsConnector extends model.ExternalDbSystemConnector {
    /**
...
export declare namespace ExternalDbSystemMacsConnector {
    function getJsonObj(obj: ExternalDbSystemMacsConnector, isParentJsonObj?: boolean): object;
    const connectorType = "MACS";
    function getDeserializedJsonObj(obj: ExternalDbSystemMacsConnector, isParentJsonObj?: boolean): object;
}

...
export declare namespace ChangeSpaceBudgetDetails {
    function getJsonObj(obj: ChangeSpaceBudgetDetails): object;
    function getDeserializedJsonObj(obj: ChangeSpaceBudgetDetails): object;
}

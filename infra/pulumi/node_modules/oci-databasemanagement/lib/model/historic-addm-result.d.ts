...
export declare namespace HistoricAddmResult {
    enum Status {
        Initial = "INITIAL",
        Executing = "EXECUTING",
    ...
    function getJsonObj(obj: HistoricAddmResult): object;
    function getDeserializedJsonObj(obj: HistoricAddmResult): object;
}

 ...
 */
export interface CreateMySqlDatabaseConnectorDetails {
    /**
...
export declare namespace CreateMySqlDatabaseConnectorDetails {
    function getJsonObj(obj: CreateMySqlDatabaseConnectorDetails): object;
    function getDeserializedJsonObj(obj: CreateMySqlDatabaseConnectorDetails): object;
}

...
export declare namespace ExternalExadataInfrastructure {
    enum RackSize {
        Full = "FULL",
        Half = "HALF",
        Quarter = "QUARTER",
    ...
    function getJsonObj(obj: ExternalExadataInfrastructure, isParentJsonObj?: boolean): object;
    const resourceType = "INFRASTRUCTURE";
    function getDeserializedJsonObj(obj: ExternalExadataInfrastructure, isParentJsonObj?: boolean): object;
}

 ...
 */
export interface WorkRequestSubResource {
    /**
...
export declare namespace WorkRequestSubResource {
    function getJsonObj(obj: WorkRequestSubResource): object;
    function getDeserializedJsonObj(obj: WorkRequestSubResource): object;
}

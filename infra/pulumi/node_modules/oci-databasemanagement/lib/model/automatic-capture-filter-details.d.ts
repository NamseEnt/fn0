...
export declare namespace AutomaticCaptureFilterDetails {
    enum Name {
    ...
    function getJsonObj(obj: AutomaticCaptureFilterDetails): object;
    function getDeserializedJsonObj(obj: AutomaticCaptureFilterDetails): object;
}

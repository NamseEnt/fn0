...
export declare namespace SqlTuningSetSummary {
    function getJsonObj(obj: SqlTuningSetSummary): object;
    function getDeserializedJsonObj(obj: SqlTuningSetSummary): object;
}

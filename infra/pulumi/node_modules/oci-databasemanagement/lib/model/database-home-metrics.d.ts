...
export declare namespace DatabaseHomeMetrics {
    function getJsonObj(obj: DatabaseHomeMetrics): object;
    function getDeserializedJsonObj(obj: DatabaseHomeMetrics): object;
}

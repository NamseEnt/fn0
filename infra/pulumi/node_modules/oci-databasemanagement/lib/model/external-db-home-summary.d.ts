...
export declare namespace ExternalDbHomeSummary {
    function getJsonObj(obj: ExternalDbHomeSummary): object;
    function getDeserializedJsonObj(obj: ExternalDbHomeSummary): object;
}

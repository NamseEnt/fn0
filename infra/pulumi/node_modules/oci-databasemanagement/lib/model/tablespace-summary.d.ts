...
export declare namespace TablespaceSummary {
    enum Type {
        Undo = "UNDO",
    ...
    function getJsonObj(obj: TablespaceSummary): object;
    function getDeserializedJsonObj(obj: TablespaceSummary): object;
}

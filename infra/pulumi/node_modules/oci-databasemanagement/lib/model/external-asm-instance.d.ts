 ...
 */
export interface ExternalAsmInstance {
    /**
     ...
     */
    "lifecycleState": ExternalAsmInstance.LifecycleState;
    /**
...
export declare namespace ExternalAsmInstance {
    enum LifecycleState {
        Creating = "CREATING",
        Active = "ACTIVE",
        Inactive = "INACTIVE",
    ...
    function getJsonObj(obj: ExternalAsmInstance): object;
    function getDeserializedJsonObj(obj: ExternalAsmInstance): object;
}

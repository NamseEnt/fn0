...
export declare namespace AutonomousDatabaseFeatureDetails {
    function getJsonObj(obj: AutonomousDatabaseFeatureDetails): object;
    function getDeserializedJsonObj(obj: AutonomousDatabaseFeatureDetails): object;
}

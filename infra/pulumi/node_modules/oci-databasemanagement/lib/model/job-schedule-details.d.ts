...
export declare namespace JobScheduleDetails {
    enum IntervalType {
        Daily = "DAILY",
        Hourly = "HOURLY",
        Weekly = "WEEKLY",
    ...
    function getJsonObj(obj: JobScheduleDetails): object;
    function getDeserializedJsonObj(obj: JobScheduleDetails): object;
}

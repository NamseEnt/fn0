 ...
 */
export interface AsmConnectionCredentialsByDetails extends model.AsmConnectionCredentials {
    /**
  ...
  *
     ...
     */
    "role": AsmConnectionCredentialsByDetails.Role;
    "credentialType": string;
}
export declare namespace AsmConnectionCredentialsByDetails {
    enum Role {
        Sysasm = "SYSASM",
        Sysdba = "SYSDBA",
        Sysoper = "SYSOPER",
    ...
    function getJsonObj(obj: AsmConnectionCredentialsByDetails, isParentJsonObj?: boolean): object;
    const credentialType = "DETAILS";
    function getDeserializedJsonObj(obj: AsmConnectionCredentialsByDetails, isParentJsonObj?: boolean): object;
}

...
export declare namespace OptimizerStatisticsOperationTask {
    enum TargetType {
        Table = "TABLE",
    ...
    function getJsonObj(obj: OptimizerStatisticsOperationTask): object;
    function getDeserializedJsonObj(obj: OptimizerStatisticsOperationTask): object;
}

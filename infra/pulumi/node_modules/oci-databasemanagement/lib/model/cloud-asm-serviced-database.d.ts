 ...
 */
export interface CloudAsmServicedDatabase {
    /**
...
export declare namespace CloudAsmServicedDatabase {
    function getJsonObj(obj: CloudAsmServicedDatabase): object;
    function getDeserializedJsonObj(obj: CloudAsmServicedDatabase): object;
}

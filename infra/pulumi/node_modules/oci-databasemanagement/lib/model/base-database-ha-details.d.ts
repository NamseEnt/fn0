...
export declare namespace BaseDatabaseHaDetails {
    function getJsonObj(obj: BaseDatabaseHaDetails): object;
    function getDeserializedJsonObj(obj: BaseDatabaseHaDetails): object;
}

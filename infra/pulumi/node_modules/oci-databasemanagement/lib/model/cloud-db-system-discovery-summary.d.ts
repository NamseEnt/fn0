 ...
 */
export interface CloudDbSystemDiscoverySummary {
    /**
...
export declare namespace CloudDbSystemDiscoverySummary {
    function getJsonObj(obj: CloudDbSystemDiscoverySummary): object;
    function getDeserializedJsonObj(obj: CloudDbSystemDiscoverySummary): object;
}

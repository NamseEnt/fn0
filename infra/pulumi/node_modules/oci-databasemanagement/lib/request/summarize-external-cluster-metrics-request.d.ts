...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/databasemanagement/SummarizeExternalClusterMetrics.ts.html |here} to see how to use SummarizeExternalClusterMetricsRequest.
 */
export interface SummarizeExternalClusterMetricsRequest extends common.BaseRequest {
    /**

...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/databasemanagement/AddmTasks.ts.html |here} to see how to use AddmTasksRequest.
 */
...
export declare namespace AddmTasksRequest {
    enum SortBy {
        TaskName = "TASK_NAME",
        TaskId = "TASK_ID",

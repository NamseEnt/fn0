...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/databasemanagement/ListCloudClusters.ts.html |here} to see how to use ListCloudClustersRequest.
 */
export interface ListCloudClustersRequest extends common.BaseRequest {
    /**
...
export declare namespace ListCloudClustersRequest {
    enum SortBy {

...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/databasemanagement/SummarizeAwrDbSysstats.ts.html |here} to see how to use SummarizeAwrDbSysstatsRequest.
 */
export interface SummarizeAwrDbSysstatsRequest extends common.BaseRequest {
    /**
...
export declare namespace SummarizeAwrDbSysstatsRequest {
    enum SortBy {

...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/databasemanagement/SummarizeAwrDbMetrics.ts.html |here} to see how to use SummarizeAwrDbMetricsRequest.
 */
export interface SummarizeAwrDbMetricsRequest extends common.BaseRequest {
    /**
...
export declare namespace SummarizeAwrDbMetricsRequest {
    enum SortBy {
        Timestamp = "TIMESTAMP",
        Name = "NAME"
    }

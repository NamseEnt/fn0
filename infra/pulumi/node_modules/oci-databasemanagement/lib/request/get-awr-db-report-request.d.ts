...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/databasemanagement/GetAwrDbReport.ts.html |here} to see how to use GetAwrDbReportRequest.
 */
...
export declare namespace GetAwrDbReportRequest {
    enum ReportType {
        Awr = "AWR",
        Ash = "ASH"
    }

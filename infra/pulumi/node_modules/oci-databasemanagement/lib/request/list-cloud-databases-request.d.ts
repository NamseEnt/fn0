...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/databasemanagement/ListCloudDatabases.ts.html |here} to see how to use ListCloudDatabasesRequest.
 */
export interface ListCloudDatabasesRequest extends common.BaseRequest {
    /**
...
export declare namespace ListCloudDatabasesRequest {
    enum SortBy {

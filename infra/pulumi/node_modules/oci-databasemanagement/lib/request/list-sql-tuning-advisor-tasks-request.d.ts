...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/databasemanagement/ListSqlTuningAdvisorTasks.ts.html |here} to see how to use ListSqlTuningAdvisorTasksRequest.
 */
...
export declare namespace ListSqlTuningAdvisorTasksRequest {
    enum Status {
        Initial = "INITIAL",
        Executing = "EXECUTING",

...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/databasemanagement/ListCloudListeners.ts.html |here} to see how to use ListCloudListenersRequest.
 */
export interface ListCloudListenersRequest extends common.BaseRequest {
    /**
...
export declare namespace ListCloudListenersRequest {
    enum SortBy {

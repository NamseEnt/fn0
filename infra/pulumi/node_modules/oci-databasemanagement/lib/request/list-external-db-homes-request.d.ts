...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/databasemanagement/ListExternalDbHomes.ts.html |here} to see how to use ListExternalDbHomesRequest.
 */
export interface ListExternalDbHomesRequest extends common.BaseRequest {
    /**
...
export declare namespace ListExternalDbHomesRequest {
    enum SortBy {

...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/databasemanagement/SummarizeCloudDbNodeMetrics.ts.html |here} to see how to use SummarizeCloudDbNodeMetricsRequest.
 */
export interface SummarizeCloudDbNodeMetricsRequest extends common.BaseRequest {
    /**

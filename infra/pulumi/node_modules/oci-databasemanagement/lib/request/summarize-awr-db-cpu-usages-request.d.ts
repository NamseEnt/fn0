...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/databasemanagement/SummarizeAwrDbCpuUsages.ts.html |here} to see how to use SummarizeAwrDbCpuUsagesRequest.
 */
export interface SummarizeAwrDbCpuUsagesRequest extends common.BaseRequest {
    /**
...
export declare namespace SummarizeAwrDbCpuUsagesRequest {
    enum SessionType {

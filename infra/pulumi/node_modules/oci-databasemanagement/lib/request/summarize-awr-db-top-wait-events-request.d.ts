...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/databasemanagement/SummarizeAwrDbTopWaitEvents.ts.html |here} to see how to use SummarizeAwrDbTopWaitEventsRequest.
 */
export interface SummarizeAwrDbTopWaitEventsRequest extends common.BaseRequest {
    /**
...
export declare namespace SummarizeAwrDbTopWaitEventsRequest {
    enum SessionType {

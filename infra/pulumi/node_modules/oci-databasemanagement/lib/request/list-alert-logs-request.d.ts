...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/databasemanagement/ListAlertLogs.ts.html |here} to see how to use ListAlertLogsRequest.
 */
...
export declare namespace ListAlertLogsRequest {
    enum LevelFilter {
        Critical = "CRITICAL",
        Severe = "SEVERE",
        Important = "IMPORTANT",

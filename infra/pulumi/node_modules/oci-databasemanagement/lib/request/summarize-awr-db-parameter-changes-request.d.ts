...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/databasemanagement/SummarizeAwrDbParameterChanges.ts.html |here} to see how to use SummarizeAwrDbParameterChangesRequest.
 */
export interface SummarizeAwrDbParameterChangesRequest extends common.BaseRequest {
    /**
...
export declare namespace SummarizeAwrDbParameterChangesRequest {
    enum SortBy {

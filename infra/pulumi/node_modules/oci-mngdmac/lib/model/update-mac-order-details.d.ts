...
export declare namespace UpdateMacOrderDetails {
    function getJsonObj(obj: UpdateMacOrderDetails): object;
    function getDeserializedJsonObj(obj: UpdateMacOrderDetails): object;
}

...
export declare namespace OpsActionUpdateMacOrderDetails {
    function getJsonObj(obj: OpsActionUpdateMacOrderDetails): object;
    function getDeserializedJsonObj(obj: OpsActionUpdateMacOrderDetails): object;
}

...
export declare namespace OpsActionCreateMacDeviceDetails {
    function getJsonObj(obj: OpsActionCreateMacDeviceDetails): object;
    function getDeserializedJsonObj(obj: OpsActionCreateMacDeviceDetails): object;
}

...
export interface UpdateBudgetDetails {
    ...
    "startDate"?: Date;
    /**
     * The time when the one-time budget concludes. For example, {@code 2023-08-12T16:01:19.847222+05:30}. The date-time format conforms to RFC 3339, and will be truncated to the starting point of the date provided after being converted to UTC time.
     */
    "endDate"?: Date;
    /**
...
export declare namespace UpdateBudgetDetails {
    function getJsonObj(obj: UpdateBudgetDetails): object;
    function getDeserializedJsonObj(obj: UpdateBudgetDetails): object;
}

...
export declare namespace ThresholdType {
    function getJsonObj(obj: ThresholdType): ThresholdType;
    function getDeserializedJsonObj(obj: ThresholdType): ThresholdType;
}

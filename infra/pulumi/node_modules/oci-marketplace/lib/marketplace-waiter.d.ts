...
export declare class MarketplaceWaiter {
    private client;
    private readonly config?;
    constructor(client: MarketplaceClient, config?: Partial<import("oci-common/lib/waiter").WaiterConfigurationDetails> | undefined);
    /**
     ...
     */
    forPublication(request: serviceRequests.GetPublicationRequest, ...targetStates: models.Publication.LifecycleState[]): Promise<serviceResponses.GetPublicationResponse | null>;
    /**

...
export declare namespace AcceptedAgreement {
    function getJsonObj(obj: AcceptedAgreement): object;
    function getDeserializedJsonObj(obj: AcceptedAgreement): object;
}

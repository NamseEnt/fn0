...
export declare namespace ListingSummary {
    enum CompatibleArchitectures {
        X86 = "X86",
        Arm = "ARM",
        /**
    ...
    function getJsonObj(obj: ListingSummary): object;
    function getDeserializedJsonObj(obj: ListingSummary): object;
}

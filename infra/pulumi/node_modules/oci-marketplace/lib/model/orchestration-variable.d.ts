...
export declare namespace OrchestrationVariable {
    function getJsonObj(obj: OrchestrationVariable): object;
    function getDeserializedJsonObj(obj: OrchestrationVariable): object;
}

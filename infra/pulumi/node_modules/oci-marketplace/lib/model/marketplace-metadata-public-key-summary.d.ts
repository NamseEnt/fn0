...
export declare namespace MarketplaceMetadataPublicKeySummary {
    function getJsonObj(obj: MarketplaceMetadataPublicKeySummary): object;
    function getDeserializedJsonObj(obj: MarketplaceMetadataPublicKeySummary): object;
}

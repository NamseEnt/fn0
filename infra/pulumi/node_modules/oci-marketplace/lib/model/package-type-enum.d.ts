...
export declare namespace PackageTypeEnum {
    function getJsonObj(obj: PackageTypeEnum): PackageTypeEnum;
    function getDeserializedJsonObj(obj: PackageTypeEnum): PackageTypeEnum;
}

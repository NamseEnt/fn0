...
export declare namespace ArchitectureType {
    function getJsonObj(obj: ArchitectureType): ArchitectureType;
    function getDeserializedJsonObj(obj: ArchitectureType): ArchitectureType;
}

 ...
 *
 **/
export declare enum SearchDetailsTypeEnum {
    FreeText = "FreeText",
    Structured = "Structured"
}
export declare namespace SearchDetailsTypeEnum {
    function getJsonObj(obj: SearchDetailsTypeEnum): SearchDetailsTypeEnum;
    function getDeserializedJsonObj(obj: SearchDetailsTypeEnum): SearchDetailsTypeEnum;
}

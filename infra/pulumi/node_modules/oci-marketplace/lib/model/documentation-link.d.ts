...
export declare namespace DocumentationLink {
    function getJsonObj(obj: DocumentationLink): object;
    function getDeserializedJsonObj(obj: DocumentationLink): object;
}

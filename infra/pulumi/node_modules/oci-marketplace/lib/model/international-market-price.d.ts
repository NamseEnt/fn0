...
export declare namespace InternationalMarketPrice {
    function getJsonObj(obj: InternationalMarketPrice): object;
    function getDeserializedJsonObj(obj: InternationalMarketPrice): object;
}

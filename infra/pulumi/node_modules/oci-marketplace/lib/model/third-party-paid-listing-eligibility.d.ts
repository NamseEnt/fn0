 ...
 */
export interface ThirdPartyPaidListingEligibility {
    /**
     * Whether the tenant is permitted to use paid listings
     */
    "isPaidListingEligible": boolean;
    /**
     * Whether the tenant is currently prevented from using paid listings because of throttling
     */
    "isPaidListingThrottled": boolean;
    /**
     * Reason the account is ineligible to launch paid listings
     */
    "eligibilityReason": ThirdPartyPaidListingEligibility.EligibilityReason;
}
export declare namespace ThirdPartyPaidListingEligibility {
    ...
    function getJsonObj(obj: ThirdPartyPaidListingEligibility): object;
    function getDeserializedJsonObj(obj: ThirdPartyPaidListingEligibility): object;
}

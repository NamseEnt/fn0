...
exports.MarketplaceWaiter = void 0;
const models = __importStar(require("./model"));
const oci_common_1 = require("oci-common");
class MarketplaceWaiter {
     ...
     */
    forPublication(request, ...targetStates) {
        return __awaiter(this, void 0, void 0, function* () {
            return oci_common_1.genericTerminalConditionWaiter(this.config, () => this.client.getPublication(request), response => targetStates.includes(response.publication.lifecycleState), targetStates.includes(models.Publication.LifecycleState.Deleted));
        });
    }
    /**
...
exports.MarketplaceWaiter = MarketplaceWaiter;
//# sourceMappingURL=marketplace-waiter.js.map
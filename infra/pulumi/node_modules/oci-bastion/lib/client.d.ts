...
export declare enum BastionApiKeys {
}
/**
...
export declare class BastionClient {
     ...
     */
    changeBastionCompartment(changeBastionCompartmentRequest: requests.ChangeBastionCompartmentRequest): Promise<responses.ChangeBastionCompartmentResponse>;
    /**
     ...
     */
    createBastion(createBastionRequest: requests.CreateBastionRequest): Promise<responses.CreateBastionResponse>;
    /**
     ...
     */
    deleteBastion(deleteBastionRequest: requests.DeleteBastionRequest): Promise<responses.DeleteBastionResponse>;
    /**
     ...
     */
    getBastion(getBastionRequest: requests.GetBastionRequest): Promise<responses.GetBastionResponse>;
    /**
     ...
     */
    listBastions(listBastionsRequest: requests.ListBastionsRequest): Promise<responses.ListBastionsResponse>;
    /**
     ...
     */
    listAllBastions(request: requests.ListBastionsRequest): AsyncIterableIterator<model.BastionSummary>;
    /**
     ...
     * @param request a request which can be sent to the service operation
     */
    listAllBastionsResponses(request: requests.ListBastionsRequest): AsyncIterableIterator<responses.ListBastionsResponse>;
    /**
     * Creates a new async iterator which will iterate over the models.BastionSummary objects
     * contained in responses from the listBastions operation. This iterator will fetch more data from the
     * server as needed.
     ...
     * @param request a request which can be sent to the service operation
     */
    listBastionsRecordIterator(request: requests.ListBastionsRequest): AsyncIterableIterator<model.BastionSummary>;
    /**
     * Creates a new async iterator which will iterate over the responses received from the listBastions operation. This iterator
     * will fetch more data from the server as needed.
     *
     * @param request a request which can be sent to the service operation
     */
    listBastionsResponseIterator(request: requests.ListBastionsRequest): AsyncIterableIterator<responses.ListBastionsResponse>;
    /**
     ...
     */
    listSessions(listSessionsRequest: requests.ListSessionsRequest): Promise<responses.ListSessionsResponse>;
    /**
     ...
     * @param request a request which can be sent to the service operation
     */
    listAllSessions(request: requests.ListSessionsRequest): AsyncIterableIterator<model.SessionSummary>;
    /**
     ...
     * @param request a request which can be sent to the service operation
     */
    listAllSessionsResponses(request: requests.ListSessionsRequest): AsyncIterableIterator<responses.ListSessionsResponse>;
    /**
     * Creates a new async iterator which will iterate over the models.SessionSummary objects
     * contained in responses from the listSessions operation. This iterator will fetch more data from the
     * server as needed.
     ...
     * @param request a request which can be sent to the service operation
     */
    listSessionsRecordIterator(request: requests.ListSessionsRequest): AsyncIterableIterator<model.SessionSummary>;
    /**
     * Creates a new async iterator which will iterate over the responses received from the listSessions operation. This iterator
     * will fetch more data from the server as needed.
     *
     * @param request a request which can be sent to the service operation
     */
    listSessionsResponseIterator(request: requests.ListSessionsRequest): AsyncIterableIterator<responses.ListSessionsResponse>;
    /**
     ...
     */
    updateBastion(updateBastionRequest: requests.UpdateBastionRequest): Promise<responses.UpdateBastionResponse>;
    /**

...
export declare namespace CreateSessionTargetResourceDetails {
    function getJsonObj(obj: CreateSessionTargetResourceDetails): object;
    function getDeserializedJsonObj(obj: CreateSessionTargetResourceDetails): object;
}

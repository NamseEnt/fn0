...
export declare namespace ManagedSshSessionTargetResourceDetails {
    function getJsonObj(obj: ManagedSshSessionTargetResourceDetails, isParentJsonObj?: boolean): object;
    const sessionType = "MANAGED_SSH";
    function getDeserializedJsonObj(obj: ManagedSshSessionTargetResourceDetails, isParentJsonObj?: boolean): object;
}

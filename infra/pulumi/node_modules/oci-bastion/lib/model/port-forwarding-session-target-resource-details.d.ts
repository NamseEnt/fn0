 ...
 */
export interface PortForwardingSessionTargetResourceDetails extends model.TargetResourceDetails {
    /**
...
export declare namespace PortForwardingSessionTargetResourceDetails {
    function getJsonObj(obj: PortForwardingSessionTargetResourceDetails, isParentJsonObj?: boolean): object;
    const sessionType = "PORT_FORWARDING";
    function getDeserializedJsonObj(obj: PortForwardingSessionTargetResourceDetails, isParentJsonObj?: boolean): object;
}

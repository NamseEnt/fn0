...
export declare namespace CreateBastionDetails {
    function getJsonObj(obj: CreateBastionDetails): object;
    function getDeserializedJsonObj(obj: CreateBastionDetails): object;
}

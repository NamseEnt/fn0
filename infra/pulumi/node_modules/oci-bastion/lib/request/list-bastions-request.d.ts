...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/bastion/ListBastions.ts.html |here} to see how to use ListBastionsRequest.
 */
export interface ListBastionsRequest extends common.BaseRequest {
    /**
     ...
     */
    "bastionLifecycleState"?: model.BastionLifecycleState;
    /**
...
export declare namespace ListBastionsRequest {
    enum SortBy {

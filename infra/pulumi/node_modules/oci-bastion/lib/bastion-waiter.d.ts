...
export declare class BastionWaiter {
    private client;
    private readonly config?;
    constructor(client: BastionClient, config?: Partial<import("oci-common/lib/waiter").WaiterConfigurationDetails> | undefined);
    /**
     ...
     */
    forBastion(request: serviceRequests.GetBastionRequest, ...targetStates: models.BastionLifecycleState[]): Promise<serviceResponses.GetBastionResponse | null>;
    /**
     ...
     */
    forSession(request: serviceRequests.GetSessionRequest, ...targetStates: models.SessionLifecycleState[]): Promise<serviceResponses.GetSessionResponse | null>;
    /**

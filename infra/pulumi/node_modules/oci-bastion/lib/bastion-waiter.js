...
class BastionWaiter {
     ...
     */
    forBastion(request, ...targetStates) {
        return __awaiter(this, void 0, void 0, function* () {
            return oci_common_1.genericTerminalConditionWaiter(this.config, () => this.client.getBastion(request), response => targetStates.includes(response.bastion.lifecycleState), targetStates.includes(models.BastionLifecycleState.Deleted));
        });
    }
    /**
     ...
     */
    forSession(request, ...targetStates) {
        return __awaiter(this, void 0, void 0, function* () {
            return oci_common_1.genericTerminalConditionWaiter(this.config, () => this.client.getSession(request), response => targetStates.includes(response.session.lifecycleState), targetStates.includes(models.SessionLifecycleState.Deleted));
        });
    }
    /**
...
exports.BastionWaiter = BastionWaiter;
//# sourceMappingURL=bastion-waiter.js.map
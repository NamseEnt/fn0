...
export declare namespace CreatePrivateApplicationPackage {
    function getJsonObj(obj: CreatePrivateApplicationPackage): object;
    function getDeserializedJsonObj(obj: CreatePrivateApplicationPackage): object;
}

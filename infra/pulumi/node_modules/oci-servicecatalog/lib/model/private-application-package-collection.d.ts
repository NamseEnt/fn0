...
export declare namespace PrivateApplicationPackageCollection {
    function getJsonObj(obj: PrivateApplicationPackageCollection): object;
    function getDeserializedJsonObj(obj: PrivateApplicationPackageCollection): object;
}

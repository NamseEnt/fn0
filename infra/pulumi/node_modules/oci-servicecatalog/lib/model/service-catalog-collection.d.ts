 ...
 */
export interface ServiceCatalogCollection {
    /**
     * Collection of catalog summaries.
     */
    "items": Array<model.ServiceCatalogSummary>;
}
export declare namespace ServiceCatalogCollection {
    function getJsonObj(obj: ServiceCatalogCollection): object;
    function getDeserializedJsonObj(obj: ServiceCatalogCollection): object;
}

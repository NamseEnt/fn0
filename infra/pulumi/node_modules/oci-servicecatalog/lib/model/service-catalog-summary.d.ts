...
export declare namespace ServiceCatalogSummary {
    function getJsonObj(obj: ServiceCatalogSummary): object;
    function getDeserializedJsonObj(obj: ServiceCatalogSummary): object;
}

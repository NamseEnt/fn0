 ...
 **/
export declare enum ServiceCatalogStatusEnum {
    Active = "ACTIVE",
    Inactive = "INACTIVE",
    /**
...
export declare namespace ServiceCatalogStatusEnum {
    function getJsonObj(obj: ServiceCatalogStatusEnum): ServiceCatalogStatusEnum;
    function getDeserializedJsonObj(obj: ServiceCatalogStatusEnum): ServiceCatalogStatusEnum;
}

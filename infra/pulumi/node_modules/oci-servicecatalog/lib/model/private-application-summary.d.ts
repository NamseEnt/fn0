...
export declare namespace PrivateApplicationSummary {
    function getJsonObj(obj: PrivateApplicationSummary): object;
    function getDeserializedJsonObj(obj: PrivateApplicationSummary): object;
}

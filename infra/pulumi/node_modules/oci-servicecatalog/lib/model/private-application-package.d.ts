...
export declare namespace PrivateApplicationPackage {
    function getJsonObj(obj: PrivateApplicationPackage): object;
    function getDeserializedJsonObj(obj: PrivateApplicationPackage): object;
}

...
export declare namespace BackoffRetryPolicy {
    enum PolicyType {
    ...
    function getJsonObj(obj: BackoffRetryPolicy): object;
    function getDeserializedJsonObj(obj: BackoffRetryPolicy): object;
}

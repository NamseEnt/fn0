...
export declare namespace ConfirmationResult {
    function getJsonObj(obj: ConfirmationResult): object;
    function getDeserializedJsonObj(obj: ConfirmationResult): object;
}

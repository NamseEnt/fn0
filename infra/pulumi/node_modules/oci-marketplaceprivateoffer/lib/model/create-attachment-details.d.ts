...
export declare namespace CreateAttachmentDetails {
    function getJsonObj(obj: CreateAttachmentDetails): object;
    function getDeserializedJsonObj(obj: CreateAttachmentDetails): object;
}

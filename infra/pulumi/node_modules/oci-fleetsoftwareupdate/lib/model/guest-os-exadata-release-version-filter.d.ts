...
export declare namespace GuestOsExadataReleaseVersionFilter {
    enum ExadataReleases {
    ...
    function getJsonObj(obj: GuestOsExadataReleaseVersionFilter, isParentJsonObj?: boolean): object;
    const type = "EXADATA_RELEASE_VERSION";
    function getDeserializedJsonObj(obj: GuestOsExadataReleaseVersionFilter, isParentJsonObj?: boolean): object;
}

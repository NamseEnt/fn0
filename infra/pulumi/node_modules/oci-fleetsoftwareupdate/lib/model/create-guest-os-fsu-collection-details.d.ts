...
export declare namespace CreateGuestOsFsuCollectionDetails {
    function getJsonObj(obj: CreateGuestOsFsuCollectionDetails, isParentJsonObj?: boolean): object;
    const type = "GUEST_OS";
    function getDeserializedJsonObj(obj: CreateGuestOsFsuCollectionDetails, isParentJsonObj?: boolean): object;
}

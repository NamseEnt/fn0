...
export declare namespace StartTimeScheduleDetails {
    function getJsonObj(obj: StartTimeScheduleDetails, isParentJsonObj?: boolean): object;
    const type = "START_TIME";
    function getDeserializedJsonObj(obj: StartTimeScheduleDetails, isParentJsonObj?: boolean): object;
}

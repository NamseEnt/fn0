...
export declare namespace PrecheckFsuJob {
    function getJsonObj(obj: PrecheckFsuJob, isParentJsonObj?: boolean): object;
    const type = "PRECHECK";
    function getDeserializedJsonObj(obj: PrecheckFsuJob, isParentJsonObj?: boolean): object;
}

...
export interface FsuCollectionTarget {
    "target": model.ExadbVmClusterTargetSummary | model.VmClusterTargetSummary | model.CloudVmClusterTargetSummary | model.DatabaseTargetSummary;
    /**
...
export declare namespace FsuCollectionTarget {
    enum Status {
        Idle = "IDLE",
    ...
    function getJsonObj(obj: FsuCollectionTarget): object;
    function getDeserializedJsonObj(obj: FsuCollectionTarget): object;
}

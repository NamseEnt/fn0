 ...
 *
 */
export interface StageAction extends model.FsuAction {
    /**
...
export declare namespace StageAction {
    function getJsonObj(obj: StageAction, isParentJsonObj?: boolean): object;
    const type = "STAGE";
    function getDeserializedJsonObj(obj: StageAction, isParentJsonObj?: boolean): object;
}

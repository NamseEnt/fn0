 ...
 *
 */
export interface CleanupFsuJob extends model.FsuJob {
    /**
...
export declare namespace CleanupFsuJob {
    function getJsonObj(obj: CleanupFsuJob, isParentJsonObj?: boolean): object;
    const type = "CLEANUP";
    function getDeserializedJsonObj(obj: CleanupFsuJob, isParentJsonObj?: boolean): object;
}

...
export interface MembershipSummary {
     ...
     *
     */
    "fsuCollectionType": model.CollectionTypes;
    /**
     * The user-friendly name for the Exadata Fleet Update Collection.
     */
    "fsuCollectionName": string;
}
export declare namespace MembershipSummary {
    function getJsonObj(obj: MembershipSummary): object;
    function getDeserializedJsonObj(obj: MembershipSummary): object;
}

...
(function (UpdateScheduleDetails) {
    function getJsonObj(obj) {
        ...
        if (obj && "type" in obj && obj.type) {
            switch (obj.type) {
                case "NONE":
                    return model.NoneScheduleDetails.getJsonObj(jsonObj, true);
                case "START_TIME":
                    return model.UpdateStartTimeScheduleDetails.getJsonObj(jsonObj, true);
                default:
    ...
    function getDeserializedJsonObj(obj) {
        ...
        if (obj && "type" in obj && obj.type) {
            switch (obj.type) {
                case "NONE":
                    return model.NoneScheduleDetails.getDeserializedJsonObj(jsonObj, true);
                case "START_TIME":
                    return model.UpdateStartTimeScheduleDetails.getDeserializedJsonObj(jsonObj, true);
                default:
                    if (common.LOG.logger)
                        common.LOG.logger.info(`Unknown value for: ${obj.type}`);
            }

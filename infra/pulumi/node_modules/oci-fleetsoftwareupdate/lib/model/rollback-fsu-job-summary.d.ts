 ...
 *
 */
export interface RollbackFsuJobSummary extends model.FsuJobSummary {
    /**
...
export declare namespace RollbackFsuJobSummary {
    function getJsonObj(obj: RollbackFsuJobSummary, isParentJsonObj?: boolean): object;
    const type = "ROLLBACK_AND_REMOVE_TARGET";
    function getDeserializedJsonObj(obj: RollbackFsuJobSummary, isParentJsonObj?: boolean): object;
}

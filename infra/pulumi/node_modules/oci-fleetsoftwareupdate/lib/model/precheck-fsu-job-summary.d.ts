 ...
 *
 */
export interface PrecheckFsuJobSummary extends model.FsuJobSummary {
    /**
...
export declare namespace PrecheckFsuJobSummary {
    function getJsonObj(obj: PrecheckFsuJobSummary, isParentJsonObj?: boolean): object;
    const type = "PRECHECK";
    function getDeserializedJsonObj(obj: PrecheckFsuJobSummary, isParentJsonObj?: boolean): object;
}

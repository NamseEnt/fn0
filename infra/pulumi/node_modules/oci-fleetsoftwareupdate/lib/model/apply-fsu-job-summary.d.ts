...
export declare namespace ApplyFsuJobSummary {
    function getJsonObj(obj: ApplyFsuJobSummary, isParentJsonObj?: boolean): object;
    const type = "APPLY";
    function getDeserializedJsonObj(obj: ApplyFsuJobSummary, isParentJsonObj?: boolean): object;
}

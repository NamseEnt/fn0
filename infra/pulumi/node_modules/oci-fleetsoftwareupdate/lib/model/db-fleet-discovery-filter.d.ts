...
export declare namespace DbFleetDiscoveryFilter {
    enum Mode {
        Include = "INCLUDE",
        Exclude = "EXCLUDE",
        /**
    ...
    function getJsonObj(obj: DbFleetDiscoveryFilter): object;
    function getDeserializedJsonObj(obj: DbFleetDiscoveryFilter): object;
}

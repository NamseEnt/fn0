...
export declare namespace PrecheckAction {
    function getJsonObj(obj: PrecheckAction, isParentJsonObj?: boolean): object;
    const type = "PRECHECK";
    function getDeserializedJsonObj(obj: PrecheckAction, isParentJsonObj?: boolean): object;
}

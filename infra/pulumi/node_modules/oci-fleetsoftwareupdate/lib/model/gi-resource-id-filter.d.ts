...
export declare namespace GiResourceIdFilter {
    enum EntityType {
    ...
    function getJsonObj(obj: GiResourceIdFilter, isParentJsonObj?: boolean): object;
    const type = "RESOURCE_ID";
    function getDeserializedJsonObj(obj: GiResourceIdFilter, isParentJsonObj?: boolean): object;
}

...
export declare namespace GuestOsResourceIdFilter {
    enum EntityType {
    ...
    function getJsonObj(obj: GuestOsResourceIdFilter, isParentJsonObj?: boolean): object;
    const type = "RESOURCE_ID";
    function getDeserializedJsonObj(obj: GuestOsResourceIdFilter, isParentJsonObj?: boolean): object;
}

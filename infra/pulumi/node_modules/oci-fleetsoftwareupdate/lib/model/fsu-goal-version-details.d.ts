...
export declare namespace FsuGoalVersionDetails {
    enum HomePolicy {
    ...
    function getJsonObj(obj: FsuGoalVersionDetails): object;
    function getDeserializedJsonObj(obj: FsuGoalVersionDetails): object;
}

 ...
 *
 */
export interface ApplyActionSummary extends model.FsuActionSummary {
    /**
...
export declare namespace ApplyActionSummary {
    function getJsonObj(obj: ApplyActionSummary, isParentJsonObj?: boolean): object;
    const type = "APPLY";
    function getDeserializedJsonObj(obj: ApplyActionSummary, isParentJsonObj?: boolean): object;
}

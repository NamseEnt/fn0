...
export declare namespace TargetIdsRemoveTargetsDetails {
    function getJsonObj(obj: TargetIdsRemoveTargetsDetails, isParentJsonObj?: boolean): object;
    const removalStrategy = "TARGET_IDS";
    function getDeserializedJsonObj(obj: TargetIdsRemoveTargetsDetails, isParentJsonObj?: boolean): object;
}

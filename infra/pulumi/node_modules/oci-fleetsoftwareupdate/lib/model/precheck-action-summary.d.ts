 ...
 *
 */
export interface PrecheckActionSummary extends model.FsuActionSummary {
    /**
...
export declare namespace PrecheckActionSummary {
    function getJsonObj(obj: PrecheckActionSummary, isParentJsonObj?: boolean): object;
    const type = "PRECHECK";
    function getDeserializedJsonObj(obj: PrecheckActionSummary, isParentJsonObj?: boolean): object;
}

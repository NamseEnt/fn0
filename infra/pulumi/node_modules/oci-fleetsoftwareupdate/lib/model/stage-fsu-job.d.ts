 ...
 *
 */
export interface StageFsuJob extends model.FsuJob {
    /**
...
export declare namespace StageFsuJob {
    function getJsonObj(obj: StageFsuJob, isParentJsonObj?: boolean): object;
    const type = "STAGE";
    function getDeserializedJsonObj(obj: StageFsuJob, isParentJsonObj?: boolean): object;
}

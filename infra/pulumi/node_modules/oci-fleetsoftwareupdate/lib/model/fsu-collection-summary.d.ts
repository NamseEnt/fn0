...
export declare namespace FsuCollectionSummary {
    function getJsonObj(obj: FsuCollectionSummary): object;
    function getDeserializedJsonObj(obj: FsuCollectionSummary): object;
}

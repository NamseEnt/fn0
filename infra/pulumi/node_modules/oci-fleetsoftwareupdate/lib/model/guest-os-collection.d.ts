 ...
 *
 */
export interface GuestOsCollection extends model.FsuCollection {
    /**
...
export declare namespace GuestOsCollection {
    function getJsonObj(obj: GuestOsCollection, isParentJsonObj?: boolean): object;
    const type = "GUEST_OS";
    function getDeserializedJsonObj(obj: GuestOsCollection, isParentJsonObj?: boolean): object;
}

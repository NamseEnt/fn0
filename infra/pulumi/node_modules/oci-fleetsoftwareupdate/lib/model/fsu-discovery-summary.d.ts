...
export declare namespace FsuDiscoverySummary {
    function getJsonObj(obj: FsuDiscoverySummary): object;
    function getDeserializedJsonObj(obj: FsuDiscoverySummary): object;
}

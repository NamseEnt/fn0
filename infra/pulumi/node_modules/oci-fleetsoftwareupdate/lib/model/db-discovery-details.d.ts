...
export interface DbDiscoveryDetails extends model.DiscoveryDetails {
    ...
    "criteria": model.DbDiscoveryResults | model.DbSearchQueryDiscovery | model.DbTargetListDiscovery | model.DbFiltersDiscovery;
    "type": string;
}
export declare namespace DbDiscoveryDetails {
    function getJsonObj(obj: DbDiscoveryDetails, isParentJsonObj?: boolean): object;
    const type = "DB";
    function getDeserializedJsonObj(obj: DbDiscoveryDetails, isParentJsonObj?: boolean): object;
}

 ...
 *
 */
export interface ApplyFsuJob extends model.FsuJob {
    /**
...
export declare namespace ApplyFsuJob {
    function getJsonObj(obj: ApplyFsuJob, isParentJsonObj?: boolean): object;
    const type = "APPLY";
    function getDeserializedJsonObj(obj: ApplyFsuJob, isParentJsonObj?: boolean): object;
}

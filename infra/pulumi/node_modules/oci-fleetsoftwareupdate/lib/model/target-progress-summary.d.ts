...
export declare namespace TargetProgressSummary {
    enum OperationType {
        Stage = "STAGE",
        Precheck = "PRECHECK",
        Apply = "APPLY",
    ...
    function getJsonObj(obj: TargetProgressSummary): object;
    function getDeserializedJsonObj(obj: TargetProgressSummary): object;
}

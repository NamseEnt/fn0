...
export declare enum FleetSoftwareUpdateApiKeys {
}
/**
 * This service client uses {@link common.CircuitBreaker.DefaultConfiguration} for all the operations by default if no circuit breaker configuration is defined by the user.
 */
export declare class FleetSoftwareUpdateClient {
     ...
     */
    createWaiters(config?: common.WaiterConfiguration): FleetSoftwareUpdateWaiter;
    /**
     * Gets the waiters available for resources for this service.
     *
     * @return The service waiters.
     */
    getWaiters(): FleetSoftwareUpdateWaiter;
    /**
     ...
     */
    abortFsuDiscovery(abortFsuDiscoveryRequest: requests.AbortFsuDiscoveryRequest): Promise<responses.AbortFsuDiscoveryResponse>;
    /**
     ...
     */
    addFsuCollectionTargets(addFsuCollectionTargetsRequest: requests.AddFsuCollectionTargetsRequest): Promise<responses.AddFsuCollectionTargetsResponse>;
    /**
     ...
     */
    cancelFsuAction(cancelFsuActionRequest: requests.CancelFsuActionRequest): Promise<responses.CancelFsuActionResponse>;
    /**
     ...
     */
    changeFsuActionCompartment(changeFsuActionCompartmentRequest: requests.ChangeFsuActionCompartmentRequest): Promise<responses.ChangeFsuActionCompartmentResponse>;
    /**
     ...
     */
    changeFsuCollectionCompartment(changeFsuCollectionCompartmentRequest: requests.ChangeFsuCollectionCompartmentRequest): Promise<responses.ChangeFsuCollectionCompartmentResponse>;
    /**
     ...
     */
    changeFsuCycleCompartment(changeFsuCycleCompartmentRequest: requests.ChangeFsuCycleCompartmentRequest): Promise<responses.ChangeFsuCycleCompartmentResponse>;
    /**
     ...
     */
    cloneFsuCycle(cloneFsuCycleRequest: requests.CloneFsuCycleRequest): Promise<responses.CloneFsuCycleResponse>;
    /**
     ...
     */
    createFsuAction(createFsuActionRequest: requests.CreateFsuActionRequest): Promise<responses.CreateFsuActionResponse>;
    /**
     ...
     */
    createFsuCollection(createFsuCollectionRequest: requests.CreateFsuCollectionRequest): Promise<responses.CreateFsuCollectionResponse>;
    /**
     ...
     */
    createFsuCycle(createFsuCycleRequest: requests.CreateFsuCycleRequest): Promise<responses.CreateFsuCycleResponse>;
    /**
     ...
     */
    deleteFsuAction(deleteFsuActionRequest: requests.DeleteFsuActionRequest): Promise<responses.DeleteFsuActionResponse>;
    /**
     ...
     */
    deleteFsuCollection(deleteFsuCollectionRequest: requests.DeleteFsuCollectionRequest): Promise<responses.DeleteFsuCollectionResponse>;
    /**
     ...
     */
    deleteFsuCollectionTarget(deleteFsuCollectionTargetRequest: requests.DeleteFsuCollectionTargetRequest): Promise<responses.DeleteFsuCollectionTargetResponse>;
    /**
     ...
     */
    deleteFsuCycle(deleteFsuCycleRequest: requests.DeleteFsuCycleRequest): Promise<responses.DeleteFsuCycleResponse>;
    /**
     ...
     */
    deleteFsuDiscovery(deleteFsuDiscoveryRequest: requests.DeleteFsuDiscoveryRequest): Promise<responses.DeleteFsuDiscoveryResponse>;
    /**
     ...
     */
    getFsuAction(getFsuActionRequest: requests.GetFsuActionRequest): Promise<responses.GetFsuActionResponse>;
    /**
     ...
     */
    getFsuActionOutputContent(getFsuActionOutputContentRequest: requests.GetFsuActionOutputContentRequest): Promise<responses.GetFsuActionOutputContentResponse>;
    /**
     ...
     */
    getFsuCollection(getFsuCollectionRequest: requests.GetFsuCollectionRequest): Promise<responses.GetFsuCollectionResponse>;
    /**
     ...
     */
    getFsuCollectionTarget(getFsuCollectionTargetRequest: requests.GetFsuCollectionTargetRequest): Promise<responses.GetFsuCollectionTargetResponse>;
    /**
     ...
     */
    getFsuCycle(getFsuCycleRequest: requests.GetFsuCycleRequest): Promise<responses.GetFsuCycleResponse>;
    /**
     ...
     */
    getFsuDiscovery(getFsuDiscoveryRequest: requests.GetFsuDiscoveryRequest): Promise<responses.GetFsuDiscoveryResponse>;
    /**
     ...
     */
    getFsuJob(getFsuJobRequest: requests.GetFsuJobRequest): Promise<responses.GetFsuJobResponse>;
    /**
     ...
     */
    listFsuActions(listFsuActionsRequest: requests.ListFsuActionsRequest): Promise<responses.ListFsuActionsResponse>;
    /**
     ...
     */
    listFsuCollectionTargets(listFsuCollectionTargetsRequest: requests.ListFsuCollectionTargetsRequest): Promise<responses.ListFsuCollectionTargetsResponse>;
    /**
     ...
     */
    listFsuCollections(listFsuCollectionsRequest: requests.ListFsuCollectionsRequest): Promise<responses.ListFsuCollectionsResponse>;
    /**
     ...
     */
    listFsuCycles(listFsuCyclesRequest: requests.ListFsuCyclesRequest): Promise<responses.ListFsuCyclesResponse>;
    /**
     ...
     */
    listFsuDiscoveries(listFsuDiscoveriesRequest: requests.ListFsuDiscoveriesRequest): Promise<responses.ListFsuDiscoveriesResponse>;
    /**
     ...
     */
    listFsuDiscoveryTargets(listFsuDiscoveryTargetsRequest: requests.ListFsuDiscoveryTargetsRequest): Promise<responses.ListFsuDiscoveryTargetsResponse>;
    /**
     ...
     */
    listFsuJobOutputs(listFsuJobOutputsRequest: requests.ListFsuJobOutputsRequest): Promise<responses.ListFsuJobOutputsResponse>;
    /**
     ...
     */
    removeFsuCollectionTargets(removeFsuCollectionTargetsRequest: requests.RemoveFsuCollectionTargetsRequest): Promise<responses.RemoveFsuCollectionTargetsResponse>;
    /**
     ...
     */
    resumeFsuAction(resumeFsuActionRequest: requests.ResumeFsuActionRequest): Promise<responses.ResumeFsuActionResponse>;
    /**
     ...
     */
    retryFsuJob(retryFsuJobRequest: requests.RetryFsuJobRequest): Promise<responses.RetryFsuJobResponse>;
    /**
     ...
     */
    updateFsuAction(updateFsuActionRequest: requests.UpdateFsuActionRequest): Promise<responses.UpdateFsuActionResponse>;
    /**
     ...
     */
    updateFsuCollection(updateFsuCollectionRequest: requests.UpdateFsuCollectionRequest): Promise<responses.UpdateFsuCollectionResponse>;
    /**
     ...
     */
    updateFsuCycle(updateFsuCycleRequest: requests.UpdateFsuCycleRequest): Promise<responses.UpdateFsuCycleResponse>;
    /**
     ...
     */
    updateFsuDiscovery(updateFsuDiscoveryRequest: requests.UpdateFsuDiscoveryRequest): Promise<responses.UpdateFsuDiscoveryResponse>;
    /**

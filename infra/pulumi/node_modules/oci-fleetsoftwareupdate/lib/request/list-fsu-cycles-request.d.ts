...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/fleetsoftwareupdate/ListFsuCycles.ts.html |here} to see how to use ListFsuCyclesRequest.
 */
...
export declare namespace ListFsuCyclesRequest {
    enum SortBy {

...
export declare namespace SearchLogsDetails {
    function getJsonObj(obj: SearchLogsDetails): object;
    function getDeserializedJsonObj(obj: SearchLogsDetails): object;
}

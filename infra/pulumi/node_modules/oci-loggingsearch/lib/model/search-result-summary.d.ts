...
export declare namespace SearchResultSummary {
    function getJsonObj(obj: SearchResultSummary): object;
    function getDeserializedJsonObj(obj: SearchResultSummary): object;
}

...
export declare enum MigrationApiKeys {
}
/**
...
export declare class MigrationClient {
     ...
     */
    createWaiters(config?: common.WaiterConfiguration): MigrationWaiter;
    /**
     * Gets the waiters available for resources for this service.
     *
     * @return The service waiters.
     */
    getWaiters(): MigrationWaiter;
    /**
     ...
     */
    changeMigrationPlanCompartment(changeMigrationPlanCompartmentRequest: requests.ChangeMigrationPlanCompartmentRequest): Promise<responses.ChangeMigrationPlanCompartmentResponse>;
    /**
     * Moves a resource into a different compartment. When provided, If-Match is checked against ETag values of the resource.
     * This operation uses {@link common.OciSdkDefaultRetryConfiguration} by default if no retry configuration is defined by the user.
     ...
     */
    changeReplicationScheduleCompartment(changeReplicationScheduleCompartmentRequest: requests.ChangeReplicationScheduleCompartmentRequest): Promise<responses.ChangeReplicationScheduleCompartmentResponse>;
    /**
     * Creates a migration.
     *
     * This operation uses {@link common.OciSdkDefaultRetryConfiguration} by default if no retry configuration is defined by the user.
     ...
     */
    createMigrationAsset(createMigrationAssetRequest: requests.CreateMigrationAssetRequest): Promise<responses.CreateMigrationAssetResponse>;
    /**
     ...
     */
    createMigrationPlan(createMigrationPlanRequest: requests.CreateMigrationPlanRequest): Promise<responses.CreateMigrationPlanResponse>;
    /**
     ...
     */
    createReplicationSchedule(createReplicationScheduleRequest: requests.CreateReplicationScheduleRequest): Promise<responses.CreateReplicationScheduleResponse>;
    /**
     ...
     */
    createTargetAsset(createTargetAssetRequest: requests.CreateTargetAssetRequest): Promise<responses.CreateTargetAssetResponse>;
    /**
     ...
     */
    deleteMigrationAsset(deleteMigrationAssetRequest: requests.DeleteMigrationAssetRequest): Promise<responses.DeleteMigrationAssetResponse>;
    /**
     ...
     */
    deleteMigrationPlan(deleteMigrationPlanRequest: requests.DeleteMigrationPlanRequest): Promise<responses.DeleteMigrationPlanResponse>;
    /**
     ...
     */
    deleteReplicationSchedule(deleteReplicationScheduleRequest: requests.DeleteReplicationScheduleRequest): Promise<responses.DeleteReplicationScheduleResponse>;
    /**
     ...
     */
    deleteTargetAsset(deleteTargetAssetRequest: requests.DeleteTargetAssetRequest): Promise<responses.DeleteTargetAssetResponse>;
    /**
     ...
     */
    executeMigrationPlan(executeMigrationPlanRequest: requests.ExecuteMigrationPlanRequest): Promise<responses.ExecuteMigrationPlanResponse>;
    /**
     ...
     */
    exportMigrationPlan(exportMigrationPlanRequest: requests.ExportMigrationPlanRequest): Promise<responses.ExportMigrationPlanResponse>;
    /**
     ...
     */
    getMigrationAsset(getMigrationAssetRequest: requests.GetMigrationAssetRequest): Promise<responses.GetMigrationAssetResponse>;
    /**
     ...
     */
    getMigrationPlan(getMigrationPlanRequest: requests.GetMigrationPlanRequest): Promise<responses.GetMigrationPlanResponse>;
    /**
     ...
     */
    getReplicationProgress(getReplicationProgressRequest: requests.GetReplicationProgressRequest): Promise<responses.GetReplicationProgressResponse>;
    /**
     ...
     */
    getReplicationSchedule(getReplicationScheduleRequest: requests.GetReplicationScheduleRequest): Promise<responses.GetReplicationScheduleResponse>;
    /**
     ...
     */
    getTargetAsset(getTargetAssetRequest: requests.GetTargetAssetRequest): Promise<responses.GetTargetAssetResponse>;
    /**
     ...
     */
    importMigrationPlan(importMigrationPlanRequest: requests.ImportMigrationPlanRequest): Promise<responses.ImportMigrationPlanResponse>;
    /**
     ...
     */
    listAvailableShapes(listAvailableShapesRequest: requests.ListAvailableShapesRequest): Promise<responses.ListAvailableShapesResponse>;
    /**
     ...
     */
    listMigrationAssets(listMigrationAssetsRequest: requests.ListMigrationAssetsRequest): Promise<responses.ListMigrationAssetsResponse>;
    /**
     ...
     */
    listMigrationPlans(listMigrationPlansRequest: requests.ListMigrationPlansRequest): Promise<responses.ListMigrationPlansResponse>;
    /**
     ...
     */
    listReplicationSchedules(listReplicationSchedulesRequest: requests.ListReplicationSchedulesRequest): Promise<responses.ListReplicationSchedulesResponse>;
    /**
     ...
     */
    listTargetAssets(listTargetAssetsRequest: requests.ListTargetAssetsRequest): Promise<responses.ListTargetAssetsResponse>;
    /**
     ...
     */
    refreshMigration(refreshMigrationRequest: requests.RefreshMigrationRequest): Promise<responses.RefreshMigrationResponse>;
    /**
     ...
     */
    refreshMigrationAsset(refreshMigrationAssetRequest: requests.RefreshMigrationAssetRequest): Promise<responses.RefreshMigrationAssetResponse>;
    /**
     ...
     */
    refreshMigrationPlan(refreshMigrationPlanRequest: requests.RefreshMigrationPlanRequest): Promise<responses.RefreshMigrationPlanResponse>;
    /**
     ...
     */
    startAssetReplication(startAssetReplicationRequest: requests.StartAssetReplicationRequest): Promise<responses.StartAssetReplicationResponse>;
    /**
     ...
     */
    startMigrationReplication(startMigrationReplicationRequest: requests.StartMigrationReplicationRequest): Promise<responses.StartMigrationReplicationResponse>;
    /**
     ...
     */
    updateMigrationAsset(updateMigrationAssetRequest: requests.UpdateMigrationAssetRequest): Promise<responses.UpdateMigrationAssetResponse>;
    /**
     ...
     */
    updateMigrationPlan(updateMigrationPlanRequest: requests.UpdateMigrationPlanRequest): Promise<responses.UpdateMigrationPlanResponse>;
    /**
     ...
     */
    updateReplicationSchedule(updateReplicationScheduleRequest: requests.UpdateReplicationScheduleRequest): Promise<responses.UpdateReplicationScheduleResponse>;
    /**
     ...
     */
    updateTargetAsset(updateTargetAssetRequest: requests.UpdateTargetAssetRequest): Promise<responses.UpdateTargetAssetResponse>;
}
export {};

...
export declare namespace MigrationPlanSummary {
    function getJsonObj(obj: MigrationPlanSummary): object;
    function getDeserializedJsonObj(obj: MigrationPlanSummary): object;
}

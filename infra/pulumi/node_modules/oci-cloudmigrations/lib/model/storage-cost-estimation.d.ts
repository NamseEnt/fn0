 ...
 */
export interface StorageCostEstimation {
    /**
     * Volume estimation
     */
    "volumes": Array<model.VolumeCostEstimation>;
    /**
...
export declare namespace StorageCostEstimation {
    function getJsonObj(obj: StorageCostEstimation): object;
    function getDeserializedJsonObj(obj: StorageCostEstimation): object;
}

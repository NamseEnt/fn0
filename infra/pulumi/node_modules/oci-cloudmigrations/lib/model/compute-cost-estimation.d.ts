...
export declare namespace ComputeCostEstimation {
    function getJsonObj(obj: ComputeCostEstimation): object;
    function getDeserializedJsonObj(obj: ComputeCostEstimation): object;
}

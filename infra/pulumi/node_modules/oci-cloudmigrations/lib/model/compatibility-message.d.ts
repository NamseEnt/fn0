...
export declare namespace CompatibilityMessage {
    enum Severity {
        Error = "ERROR",
        Warning = "WARNING",
        Info = "INFO",
    ...
    function getJsonObj(obj: CompatibilityMessage): object;
    function getDeserializedJsonObj(obj: CompatibilityMessage): object;
}

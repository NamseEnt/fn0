...
export declare namespace CreateMigrationAssetDetails {
    function getJsonObj(obj: CreateMigrationAssetDetails): object;
    function getDeserializedJsonObj(obj: CreateMigrationAssetDetails): object;
}

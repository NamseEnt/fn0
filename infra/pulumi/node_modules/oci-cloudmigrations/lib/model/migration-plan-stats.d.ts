...
export declare namespace MigrationPlanStats {
    function getJsonObj(obj: MigrationPlanStats): object;
    function getDeserializedJsonObj(obj: MigrationPlanStats): object;
}

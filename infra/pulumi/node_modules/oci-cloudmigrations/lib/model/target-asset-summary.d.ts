...
export declare namespace TargetAssetSummary {
    function getJsonObj(obj: TargetAssetSummary): object;
    function getDeserializedJsonObj(obj: TargetAssetSummary): object;
}

...
export declare namespace ReplicationProgress {
    enum Status {
        None = "NONE",
    ...
    function getJsonObj(obj: ReplicationProgress): object;
    function getDeserializedJsonObj(obj: ReplicationProgress): object;
}

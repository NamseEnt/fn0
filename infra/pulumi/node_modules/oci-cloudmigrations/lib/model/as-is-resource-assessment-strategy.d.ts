...
export declare namespace AsIsResourceAssessmentStrategy {
    function getJsonObj(obj: AsIsResourceAssessmentStrategy, isParentJsonObj?: boolean): object;
    const strategyType = "AS_IS";
    function getDeserializedJsonObj(obj: AsIsResourceAssessmentStrategy, isParentJsonObj?: boolean): object;
}

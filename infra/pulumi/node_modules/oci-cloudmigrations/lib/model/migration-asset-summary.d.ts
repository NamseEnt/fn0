...
export interface MigrationAssetSummary {
     ...
     */
    "destinationDisks"?: {
        [key: string]: model.DestinationDisk;
    };
}
export declare namespace MigrationAssetSummary {
    enum Notifications {
    ...
    function getJsonObj(obj: MigrationAssetSummary): object;
    function getDeserializedJsonObj(obj: MigrationAssetSummary): object;
}

...
export declare namespace VmTargetAsset {
    enum PreferredShapeType {
        Vm = "VM",
        VmIntel = "VM_INTEL",
    ...
    function getJsonObj(obj: VmTargetAsset, isParentJsonObj?: boolean): object;
    const type = "INSTANCE";
    function getDeserializedJsonObj(obj: VmTargetAsset, isParentJsonObj?: boolean): object;
}

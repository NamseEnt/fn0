...
export declare namespace ReplicationScheduleSummary {
    function getJsonObj(obj: ReplicationScheduleSummary): object;
    function getDeserializedJsonObj(obj: ReplicationScheduleSummary): object;
}

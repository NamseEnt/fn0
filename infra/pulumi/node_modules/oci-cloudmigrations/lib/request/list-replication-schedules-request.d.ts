...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/cloudmigrations/ListReplicationSchedules.ts.html |here} to see how to use ListReplicationSchedulesRequest.
 */
...
export declare namespace ListReplicationSchedulesRequest {
    enum SortBy {

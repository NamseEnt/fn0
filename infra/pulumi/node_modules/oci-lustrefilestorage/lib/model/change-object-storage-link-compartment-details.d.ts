 ...
 */
export interface ChangeObjectStorageLinkCompartmentDetails {
    /**
...
export declare namespace ChangeObjectStorageLinkCompartmentDetails {
    function getJsonObj(obj: ChangeObjectStorageLinkCompartmentDetails): object;
    function getDeserializedJsonObj(obj: ChangeObjectStorageLinkCompartmentDetails): object;
}

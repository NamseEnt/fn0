...
export declare class OperationsInsightsWaiter {
     ...
     */
    forChargebackPlan(request: serviceRequests.GetChargebackPlanRequest, ...targetStates: models.LifecycleState[]): Promise<serviceResponses.GetChargebackPlanResponse | null>;
    /**

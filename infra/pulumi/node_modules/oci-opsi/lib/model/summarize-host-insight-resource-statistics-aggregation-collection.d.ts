 ...
 *
 */
export interface SummarizeHostInsightResourceStatisticsAggregationCollection {
    /**
     ...
     *
     */
    "resourceMetric": SummarizeHostInsightResourceStatisticsAggregationCollection.ResourceMetric;
    /**
     * Displays usage unit ( CORES, GB , PERCENT, MBPS)
     */
    "usageUnit": SummarizeHostInsightResourceStatisticsAggregationCollection.UsageUnit;
    /**
     * Collection of Resource Statistics items
     */
    "items": Array<model.HostInsightResourceStatisticsAggregation>;
}
export declare namespace SummarizeHostInsightResourceStatisticsAggregationCollection {
    enum ResourceMetric {
        Cpu = "CPU",
        Memory = "MEMORY",
    ...
    function getJsonObj(obj: SummarizeHostInsightResourceStatisticsAggregationCollection): object;
    function getDeserializedJsonObj(obj: SummarizeHostInsightResourceStatisticsAggregationCollection): object;
}

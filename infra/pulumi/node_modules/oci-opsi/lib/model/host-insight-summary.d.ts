...
export declare namespace HostInsightSummary {
    function getJsonObj(obj: HostInsightSummary): object;
    function getDeserializedJsonObj(obj: HostInsightSummary): object;
}

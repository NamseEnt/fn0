...
(function (DataObjectQuery) {
    function getJsonObj(obj) {
        ...
        if (obj && "queryType" in obj && obj.queryType) {
            switch (obj.queryType) {
                case "STANDARD_QUERY":
                    return model.DataObjectStandardQuery.getJsonObj(jsonObj, true);
                case "TEMPLATIZED_QUERY":
                    return model.DataObjectTemplatizedQuery.getJsonObj(jsonObj, true);
                default:
                    if (common.LOG.logger)
                        common.LOG.logger.info(`Unknown value for: ${obj.queryType}`);
            }
        }
        return jsonObj;
    }
    ...
    function getDeserializedJsonObj(obj) {
        ...
        if (obj && "queryType" in obj && obj.queryType) {
            switch (obj.queryType) {
                case "STANDARD_QUERY":
                    return model.DataObjectStandardQuery.getDeserializedJsonObj(jsonObj, true);
                case "TEMPLATIZED_QUERY":

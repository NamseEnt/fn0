...
exports.EnableHostInsightDetails = void 0;
const model = __importStar(require("../model"));
const common = require("oci-common");
var EnableHostInsightDetails;
(function (EnableHostInsightDetails) {
        ...
        if (obj && "entitySource" in obj && obj.entitySource) {
            switch (obj.entitySource) {
                ...
                case "MACS_MANAGED_CLOUD_HOST":
                    return model.EnableMacsManagedCloudHostInsightDetails.getJsonObj(jsonObj, true);
    ...
    function getDeserializedJsonObj(obj) {
        ...
        if (obj && "entitySource" in obj && obj.entitySource) {
            switch (obj.entitySource) {
                ...
                case "MACS_MANAGED_CLOUD_HOST":
                    return model.EnableMacsManagedCloudHostInsightDetails.getDeserializedJsonObj(jsonObj, true);
                case "EM_MANAGED_EXTERNAL_HOST":
    ...
    EnableHostInsightDetails.getDeserializedJsonObj = getDeserializedJsonObj;
})(EnableHostInsightDetails = exports.EnableHostInsightDetails || (exports.EnableHostInsightDetails = {}));
//# sourceMappingURL=enable-host-insight-details.js.map
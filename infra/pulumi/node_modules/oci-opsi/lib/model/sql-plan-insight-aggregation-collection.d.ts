...
export declare namespace SqlPlanInsightAggregationCollection {
    function getJsonObj(obj: SqlPlanInsightAggregationCollection): object;
    function getDeserializedJsonObj(obj: SqlPlanInsightAggregationCollection): object;
}

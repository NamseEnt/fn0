 ...
 **/
export declare enum AwrHubSourceType {
    AdwS = "ADW_S",
    AtpS = "ATP_S",
    AdwD = "ADW_D",
    AtpD = "ATP_D",
...
export declare namespace AwrHubSourceType {
    function getJsonObj(obj: AwrHubSourceType): AwrHubSourceType;
    function getDeserializedJsonObj(obj: AwrHubSourceType): AwrHubSourceType;
}

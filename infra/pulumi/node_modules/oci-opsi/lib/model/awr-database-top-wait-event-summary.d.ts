...
export declare namespace AwrDatabaseTopWaitEventSummary {
    function getJsonObj(obj: AwrDatabaseTopWaitEventSummary): object;
    function getDeserializedJsonObj(obj: AwrDatabaseTopWaitEventSummary): object;
}

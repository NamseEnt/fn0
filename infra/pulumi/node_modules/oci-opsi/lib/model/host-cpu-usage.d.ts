...
export declare namespace HostCpuUsage {
    function getJsonObj(obj: HostCpuUsage, isParentJsonObj?: boolean): object;
    const metricName = "HOST_CPU_USAGE";
    function getDeserializedJsonObj(obj: HostCpuUsage, isParentJsonObj?: boolean): object;
}

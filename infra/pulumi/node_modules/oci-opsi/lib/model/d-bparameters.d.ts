...
export declare namespace DBParameters {
    function getJsonObj(obj: DBParameters, isParentJsonObj?: boolean): object;
    const metricName = "DB_PARAMETERS";
    function getDeserializedJsonObj(obj: DBParameters, isParentJsonObj?: boolean): object;
}

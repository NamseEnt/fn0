...
export declare namespace HostMemoryConfiguration {
    function getJsonObj(obj: HostMemoryConfiguration, isParentJsonObj?: boolean): object;
    const metricName = "HOST_MEMORY_CONFIGURATION";
    function getDeserializedJsonObj(obj: HostMemoryConfiguration, isParentJsonObj?: boolean): object;
}

 ...
 */
export interface AwrDatabaseSummary {
    /**
...
export declare namespace AwrDatabaseSummary {
    function getJsonObj(obj: AwrDatabaseSummary): object;
    function getDeserializedJsonObj(obj: AwrDatabaseSummary): object;
}

...
export declare namespace CreateOperationsInsightsWarehouseDetails {
    function getJsonObj(obj: CreateOperationsInsightsWarehouseDetails): object;
    function getDeserializedJsonObj(obj: CreateOperationsInsightsWarehouseDetails): object;
}

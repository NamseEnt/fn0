 ...
 */
export interface MacsManagedAutonomousDatabaseInsight extends model.DatabaseInsight {
    /**
...
export declare namespace MacsManagedAutonomousDatabaseInsight {
    function getJsonObj(obj: MacsManagedAutonomousDatabaseInsight, isParentJsonObj?: boolean): object;
    const entitySource = "MACS_MANAGED_AUTONOMOUS_DATABASE";
    function getDeserializedJsonObj(obj: MacsManagedAutonomousDatabaseInsight, isParentJsonObj?: boolean): object;
}

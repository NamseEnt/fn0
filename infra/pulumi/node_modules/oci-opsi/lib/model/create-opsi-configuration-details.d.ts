 ...
 */
export interface CreateOpsiConfigurationDetails {
    /**
     ...
     *
     */
    "configItems"?: Array<model.CreateConfigurationItemDetails>;
    "opsiConfigType": string;
}
export declare namespace CreateOpsiConfigurationDetails {
    function getJsonObj(obj: CreateOpsiConfigurationDetails): object;
    function getDeserializedJsonObj(obj: CreateOpsiConfigurationDetails): object;
}

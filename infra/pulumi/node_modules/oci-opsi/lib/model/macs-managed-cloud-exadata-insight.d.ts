 ...
 */
export interface MacsManagedCloudExadataInsight extends model.ExadataInsight {
    /**
...
export declare namespace MacsManagedCloudExadataInsight {
    function getJsonObj(obj: MacsManagedCloudExadataInsight, isParentJsonObj?: boolean): object;
    const entitySource = "MACS_MANAGED_CLOUD_EXADATA";
    function getDeserializedJsonObj(obj: MacsManagedCloudExadataInsight, isParentJsonObj?: boolean): object;
}

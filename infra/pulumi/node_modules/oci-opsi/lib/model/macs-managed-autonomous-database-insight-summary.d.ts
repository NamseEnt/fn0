 ...
 */
export interface MacsManagedAutonomousDatabaseInsightSummary extends model.DatabaseInsightSummary {
    /**
...
export declare namespace MacsManagedAutonomousDatabaseInsightSummary {
    function getJsonObj(obj: MacsManagedAutonomousDatabaseInsightSummary, isParentJsonObj?: boolean): object;
    const entitySource = "MACS_MANAGED_AUTONOMOUS_DATABASE";
    function getDeserializedJsonObj(obj: MacsManagedAutonomousDatabaseInsightSummary, isParentJsonObj?: boolean): object;
}

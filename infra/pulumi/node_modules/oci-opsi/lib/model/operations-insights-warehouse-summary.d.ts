 ...
 */
export interface OperationsInsightsWarehouseSummary {
    /**
     * OPSI Warehouse OCID
     */
    "id": string;
...
export declare namespace OperationsInsightsWarehouseSummary {
    function getJsonObj(obj: OperationsInsightsWarehouseSummary): object;
    function getDeserializedJsonObj(obj: OperationsInsightsWarehouseSummary): object;
}

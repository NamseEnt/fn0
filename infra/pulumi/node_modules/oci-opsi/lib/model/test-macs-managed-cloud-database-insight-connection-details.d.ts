 ...
 */
export interface TestMacsManagedCloudDatabaseInsightConnectionDetails {
    /**
...
export declare namespace TestMacsManagedCloudDatabaseInsightConnectionDetails {
    function getJsonObj(obj: TestMacsManagedCloudDatabaseInsightConnectionDetails): object;
    function getDeserializedJsonObj(obj: TestMacsManagedCloudDatabaseInsightConnectionDetails): object;
}

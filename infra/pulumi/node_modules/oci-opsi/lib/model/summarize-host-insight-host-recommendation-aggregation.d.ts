...
export interface SummarizeHostInsightHostRecommendationAggregation {
    ...
    "details"?: model.HostCpuRecommendations | model.HostNetworkRecommendations | model.HostMemoryRecommendations | model.HostStorageRecommendations;
}
export declare namespace SummarizeHostInsightHostRecommendationAggregation {
    enum ResourceMetric {
        Cpu = "CPU",
        Memory = "MEMORY",
    ...
    function getJsonObj(obj: SummarizeHostInsightHostRecommendationAggregation): object;
    function getDeserializedJsonObj(obj: SummarizeHostInsightHostRecommendationAggregation): object;
}

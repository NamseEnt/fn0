...
exports.HostConfigurationSummary = void 0;
const model = __importStar(require("../model"));
const common = require("oci-common");
var HostConfigurationSummary;
(function (HostConfigurationSummary) {
    let PlatformType;
        ...
        if (obj && "entitySource" in obj && obj.entitySource) {
            switch (obj.entitySource) {
                ...
                case "MACS_MANAGED_CLOUD_HOST":
                    return model.MacsManagedCloudHostConfigurationSummary.getJsonObj(jsonObj, true);
                default:
    ...
    function getDeserializedJsonObj(obj) {
        ...
        if (obj && "entitySource" in obj && obj.entitySource) {
            switch (obj.entitySource) {
                ...
                case "MACS_MANAGED_CLOUD_HOST":
                    return model.MacsManagedCloudHostConfigurationSummary.getDeserializedJsonObj(jsonObj, true);
                default:
                    if (common.LOG.logger)
                        common.LOG.logger.info(`Unknown value for: ${obj.entitySource}`);
            }
    ...
    HostConfigurationSummary.getDeserializedJsonObj = getDeserializedJsonObj;
})(HostConfigurationSummary = exports.HostConfigurationSummary || (exports.HostConfigurationSummary = {}));
//# sourceMappingURL=host-configuration-summary.js.map
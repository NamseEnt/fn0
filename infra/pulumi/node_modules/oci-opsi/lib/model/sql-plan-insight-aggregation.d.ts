...
export declare namespace SqlPlanInsightAggregation {
    function getJsonObj(obj: SqlPlanInsightAggregation): object;
    function getDeserializedJsonObj(obj: SqlPlanInsightAggregation): object;
}

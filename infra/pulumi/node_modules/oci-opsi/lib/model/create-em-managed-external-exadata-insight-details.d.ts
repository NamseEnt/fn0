 ...
 */
export interface CreateEmManagedExternalExadataInsightDetails extends model.CreateExadataInsightDetails {
    /**
...
export declare namespace CreateEmManagedExternalExadataInsightDetails {
    function getJsonObj(obj: CreateEmManagedExternalExadataInsightDetails, isParentJsonObj?: boolean): object;
    const entitySource = "EM_MANAGED_EXTERNAL_EXADATA";
    function getDeserializedJsonObj(obj: CreateEmManagedExternalExadataInsightDetails, isParentJsonObj?: boolean): object;
}

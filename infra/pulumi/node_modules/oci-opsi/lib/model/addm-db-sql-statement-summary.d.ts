 ...
 */
export interface AddmDbSqlStatementSummary {
    /**
...
export declare namespace AddmDbSqlStatementSummary {
    function getJsonObj(obj: AddmDbSqlStatementSummary): object;
    function getDeserializedJsonObj(obj: AddmDbSqlStatementSummary): object;
}

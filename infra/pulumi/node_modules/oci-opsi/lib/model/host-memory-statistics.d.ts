...
export declare namespace HostMemoryStatistics {
    function getJsonObj(obj: HostMemoryStatistics, isParentJsonObj?: boolean): object;
    const resourceName = "HOST_MEMORY_STATISTICS";
    function getDeserializedJsonObj(obj: HostMemoryStatistics, isParentJsonObj?: boolean): object;
}

 ...
 */
export interface OperationsInsightsPrivateEndpoint {
    /**
...
export declare namespace OperationsInsightsPrivateEndpoint {
    function getJsonObj(obj: OperationsInsightsPrivateEndpoint): object;
    function getDeserializedJsonObj(obj: OperationsInsightsPrivateEndpoint): object;
}

...
export declare namespace CreateAutonomousDatabaseInsightDetails {
    function getJsonObj(obj: CreateAutonomousDatabaseInsightDetails, isParentJsonObj?: boolean): object;
    const entitySource = "AUTONOMOUS_DATABASE";
    function getDeserializedJsonObj(obj: CreateAutonomousDatabaseInsightDetails, isParentJsonObj?: boolean): object;
}

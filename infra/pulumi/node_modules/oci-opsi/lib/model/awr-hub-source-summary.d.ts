...
export declare namespace AwrHubSourceSummary {
    function getJsonObj(obj: AwrHubSourceSummary): object;
    function getDeserializedJsonObj(obj: AwrHubSourceSummary): object;
}

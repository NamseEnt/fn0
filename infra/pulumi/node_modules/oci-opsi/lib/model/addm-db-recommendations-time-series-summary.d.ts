...
export interface AddmDbRecommendationsTimeSeriesSummary {
    ...
    "relatedObject"?: model.SqlTypeDetails | model.SchemaObjectTypeDetails | model.DatabaseParameterTypeDetails;
}
export declare namespace AddmDbRecommendationsTimeSeriesSummary {
    function getJsonObj(obj: AddmDbRecommendationsTimeSeriesSummary): object;
    function getDeserializedJsonObj(obj: AddmDbRecommendationsTimeSeriesSummary): object;
}

...
export declare namespace HostCpuHardwareConfiguration {
    function getJsonObj(obj: HostCpuHardwareConfiguration, isParentJsonObj?: boolean): object;
    const metricName = "HOST_CPU_HARDWARE_CONFIGURATION";
    function getDeserializedJsonObj(obj: HostCpuHardwareConfiguration, isParentJsonObj?: boolean): object;
}

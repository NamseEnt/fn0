...
export declare namespace MacsManagedExternalHostInsightSummary {
    enum PlatformType {
        Linux = "LINUX",
        Solaris = "SOLARIS",
        Sunos = "SUNOS",
    ...
    function getJsonObj(obj: MacsManagedExternalHostInsightSummary, isParentJsonObj?: boolean): object;
    const entitySource = "MACS_MANAGED_EXTERNAL_HOST";
    function getDeserializedJsonObj(obj: MacsManagedExternalHostInsightSummary, isParentJsonObj?: boolean): object;
}

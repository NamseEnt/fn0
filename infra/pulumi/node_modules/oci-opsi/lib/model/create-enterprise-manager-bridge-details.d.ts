...
export declare namespace CreateEnterpriseManagerBridgeDetails {
    function getJsonObj(obj: CreateEnterpriseManagerBridgeDetails): object;
    function getDeserializedJsonObj(obj: CreateEnterpriseManagerBridgeDetails): object;
}

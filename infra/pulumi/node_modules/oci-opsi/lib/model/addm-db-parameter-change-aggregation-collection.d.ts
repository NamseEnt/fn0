...
export declare namespace AddmDbParameterChangeAggregationCollection {
    function getJsonObj(obj: AddmDbParameterChangeAggregationCollection): object;
    function getDeserializedJsonObj(obj: AddmDbParameterChangeAggregationCollection): object;
}

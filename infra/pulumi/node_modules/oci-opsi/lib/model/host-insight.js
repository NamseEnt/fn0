...
(function (HostInsight) {
        ...
        if (obj && "entitySource" in obj && obj.entitySource) {
            switch (obj.entitySource) {
                ...
                case "MACS_MANAGED_EXTERNAL_HOST":
                    return model.MacsManagedExternalHostInsight.getJsonObj(jsonObj, true);
                default:
    ...
    function getDeserializedJsonObj(obj) {
        ...
        if (obj && "entitySource" in obj && obj.entitySource) {
            switch (obj.entitySource) {
                ...
                case "MACS_MANAGED_EXTERNAL_HOST":
                    return model.MacsManagedExternalHostInsight.getDeserializedJsonObj(jsonObj, true);
                default:
                    if (common.LOG.logger)
                        common.LOG.logger.info(`Unknown value for: ${obj.entitySource}`);
            }
    ...
    HostInsight.getDeserializedJsonObj = getDeserializedJsonObj;
})(HostInsight = exports.HostInsight || (exports.HostInsight = {}));
//# sourceMappingURL=host-insight.js.map
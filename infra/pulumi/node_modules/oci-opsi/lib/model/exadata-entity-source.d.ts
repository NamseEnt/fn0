...
export declare namespace ExadataEntitySource {
    function getJsonObj(obj: ExadataEntitySource): ExadataEntitySource;
    function getDeserializedJsonObj(obj: ExadataEntitySource): ExadataEntitySource;
}

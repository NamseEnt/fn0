...
export declare namespace OperationsInsightsPrivateEndpointSummary {
    function getJsonObj(obj: OperationsInsightsPrivateEndpointSummary): object;
    function getDeserializedJsonObj(obj: OperationsInsightsPrivateEndpointSummary): object;
}

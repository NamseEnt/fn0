...
export interface HostInsightResourceStatisticsAggregation {
    ...
    "currentStatistics": model.HostNetworkStatistics | model.HostStorageStatistics | model.HostMemoryStatistics | model.HostIoStatistics | model.HostCpuStatistics;
}
export declare namespace HostInsightResourceStatisticsAggregation {
    ...
    function getDeserializedJsonObj(obj: HostInsightResourceStatisticsAggregation): object;
}

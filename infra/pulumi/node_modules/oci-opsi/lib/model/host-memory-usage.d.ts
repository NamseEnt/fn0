...
export declare namespace HostMemoryUsage {
    function getJsonObj(obj: HostMemoryUsage, isParentJsonObj?: boolean): object;
    const metricName = "HOST_MEMORY_USAGE";
    function getDeserializedJsonObj(obj: HostMemoryUsage, isParentJsonObj?: boolean): object;
}

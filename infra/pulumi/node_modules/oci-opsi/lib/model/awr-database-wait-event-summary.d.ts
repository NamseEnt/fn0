...
export declare namespace AwrDatabaseWaitEventSummary {
    function getJsonObj(obj: AwrDatabaseWaitEventSummary): object;
    function getDeserializedJsonObj(obj: AwrDatabaseWaitEventSummary): object;
}

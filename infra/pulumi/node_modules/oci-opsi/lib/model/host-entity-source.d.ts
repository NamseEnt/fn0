 ...
 **/
export declare enum HostEntitySource {
...
export declare namespace HostEntitySource {
    function getJsonObj(obj: HostEntitySource): HostEntitySource;
    function getDeserializedJsonObj(obj: HostEntitySource): HostEntitySource;
}

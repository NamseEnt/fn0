...
export declare namespace DatabaseConfigurationSummary {
    function getJsonObj(obj: DatabaseConfigurationSummary): object;
    function getDeserializedJsonObj(obj: DatabaseConfigurationSummary): object;
}

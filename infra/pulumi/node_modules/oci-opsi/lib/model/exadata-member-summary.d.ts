...
export declare namespace ExadataMemberSummary {
    enum EntityType {
        Database = "DATABASE",
    ...
    function getJsonObj(obj: ExadataMemberSummary): object;
    function getDeserializedJsonObj(obj: ExadataMemberSummary): object;
}

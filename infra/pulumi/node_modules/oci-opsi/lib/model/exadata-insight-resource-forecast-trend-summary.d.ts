...
export declare namespace ExadataInsightResourceForecastTrendSummary {
    enum Pattern {
        Linear = "LINEAR",
    ...
    function getJsonObj(obj: ExadataInsightResourceForecastTrendSummary): object;
    function getDeserializedJsonObj(obj: ExadataInsightResourceForecastTrendSummary): object;
}

...
export declare namespace EmManagedExternalDatabaseInsightSummary {
    function getJsonObj(obj: EmManagedExternalDatabaseInsightSummary, isParentJsonObj?: boolean): object;
    const entitySource = "EM_MANAGED_EXTERNAL_DATABASE";
    function getDeserializedJsonObj(obj: EmManagedExternalDatabaseInsightSummary, isParentJsonObj?: boolean): object;
}

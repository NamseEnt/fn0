...
export declare namespace ProjectedDataItem {
    function getJsonObj(obj: ProjectedDataItem): object;
    function getDeserializedJsonObj(obj: ProjectedDataItem): object;
}

...
export declare namespace SummarizeHostInsightResourceUsageAggregation {
    enum ResourceMetric {
        Cpu = "CPU",
        Memory = "MEMORY",
    ...
    function getJsonObj(obj: SummarizeHostInsightResourceUsageAggregation): object;
    function getDeserializedJsonObj(obj: SummarizeHostInsightResourceUsageAggregation): object;
}

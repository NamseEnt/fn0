...
export declare namespace HostNetworkConfiguration {
    function getJsonObj(obj: HostNetworkConfiguration, isParentJsonObj?: boolean): object;
    const metricName = "HOST_NETWORK_CONFIGURATION";
    function getDeserializedJsonObj(obj: HostNetworkConfiguration, isParentJsonObj?: boolean): object;
}

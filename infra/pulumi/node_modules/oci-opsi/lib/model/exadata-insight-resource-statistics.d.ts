...
export declare namespace ExadataInsightResourceStatistics {
    function getJsonObj(obj: ExadataInsightResourceStatistics): object;
    function getDeserializedJsonObj(obj: ExadataInsightResourceStatistics): object;
}

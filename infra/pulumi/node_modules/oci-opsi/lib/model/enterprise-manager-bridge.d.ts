 ...
 */
export interface EnterpriseManagerBridge {
    /**
...
export declare namespace EnterpriseManagerBridge {
    function getJsonObj(obj: EnterpriseManagerBridge): object;
    function getDeserializedJsonObj(obj: EnterpriseManagerBridge): object;
}

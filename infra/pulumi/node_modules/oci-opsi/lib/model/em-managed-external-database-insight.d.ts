...
export declare namespace EmManagedExternalDatabaseInsight {
    function getJsonObj(obj: EmManagedExternalDatabaseInsight, isParentJsonObj?: boolean): object;
    const entitySource = "EM_MANAGED_EXTERNAL_DATABASE";
    function getDeserializedJsonObj(obj: EmManagedExternalDatabaseInsight, isParentJsonObj?: boolean): object;
}

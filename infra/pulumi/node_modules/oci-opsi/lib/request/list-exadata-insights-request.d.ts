...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/opsi/ListExadataInsights.ts.html |here} to see how to use ListExadataInsightsRequest.
 */
...
export declare namespace ListExadataInsightsRequest {
    enum SortBy {

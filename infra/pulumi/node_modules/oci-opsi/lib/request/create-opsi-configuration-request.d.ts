...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/opsi/CreateOpsiConfiguration.ts.html |here} to see how to use CreateOpsiConfigurationRequest.
 */
...
export declare namespace CreateOpsiConfigurationRequest {
    enum OpsiConfigField {
        ConfigItems = "configItems"
    }
    enum ConfigItemCustomStatus {

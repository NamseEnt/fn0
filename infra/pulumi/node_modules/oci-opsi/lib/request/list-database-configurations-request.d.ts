...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/opsi/ListDatabaseConfigurations.ts.html |here} to see how to use ListDatabaseConfigurationsRequest.
 */
export interface ListDatabaseConfigurationsRequest extends common.BaseRequest {
     ...
     *
     */
    "databaseType"?: Array<ListDatabaseConfigurationsRequest.DatabaseType>;
    /**
...
export declare namespace ListDatabaseConfigurationsRequest {
    enum DatabaseType {
        AdwS = "ADW-S",
        AtpS = "ATP-S",
        AdwD = "ADW-D",

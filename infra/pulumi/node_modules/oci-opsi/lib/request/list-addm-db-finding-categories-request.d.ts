...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/opsi/ListAddmDbFindingCategories.ts.html |here} to see how to use ListAddmDbFindingCategoriesRequest.
 */
...
export declare namespace ListAddmDbFindingCategoriesRequest {
    enum SortBy {
        Name = "name"
    }
}

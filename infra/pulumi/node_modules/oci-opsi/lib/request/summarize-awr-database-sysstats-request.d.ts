...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/opsi/SummarizeAwrDatabaseSysstats.ts.html |here} to see how to use SummarizeAwrDatabaseSysstatsRequest.
 */
...
export declare namespace SummarizeAwrDatabaseSysstatsRequest {
    enum SortBy {

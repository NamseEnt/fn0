...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/opsi/GetAwrDatabaseSqlReport.ts.html |here} to see how to use GetAwrDatabaseSqlReportRequest.
 */
...
export declare namespace GetAwrDatabaseSqlReportRequest {
    enum ReportFormat {
        Html = "HTML",
        Text = "TEXT"
    }

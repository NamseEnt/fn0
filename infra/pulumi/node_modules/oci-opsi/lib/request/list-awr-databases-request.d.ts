...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/opsi/ListAwrDatabases.ts.html |here} to see how to use ListAwrDatabasesRequest.
 */
...
export declare namespace ListAwrDatabasesRequest {
    enum SortBy {

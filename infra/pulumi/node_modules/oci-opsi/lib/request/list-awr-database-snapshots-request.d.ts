...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/opsi/ListAwrDatabaseSnapshots.ts.html |here} to see how to use ListAwrDatabaseSnapshotsRequest.
 */
...
export declare namespace ListAwrDatabaseSnapshotsRequest {
    enum SortBy {

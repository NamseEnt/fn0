...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/opsi/ListAwrSnapshots.ts.html |here} to see how to use ListAwrSnapshotsRequest.
 */
...
export declare namespace ListAwrSnapshotsRequest {
    enum SortBy {
        TimeBegin = "timeBegin",

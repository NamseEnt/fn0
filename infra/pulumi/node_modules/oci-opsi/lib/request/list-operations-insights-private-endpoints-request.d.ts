...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/opsi/ListOperationsInsightsPrivateEndpoints.ts.html |here} to see how to use ListOperationsInsightsPrivateEndpointsRequest.
 */
...
export declare namespace ListOperationsInsightsPrivateEndpointsRequest {
    enum SortBy {

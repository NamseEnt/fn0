...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/managementdashboard/ListOobManagementDashboards.ts.html |here} to see how to use ListOobManagementDashboardsRequest.
 */
export interface ListOobManagementDashboardsRequest extends common.BaseRequest {
    /**
...
export declare namespace ListOobManagementDashboardsRequest {
    enum SortBy {

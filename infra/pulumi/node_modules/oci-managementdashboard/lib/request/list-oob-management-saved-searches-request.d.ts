...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/managementdashboard/ListOobManagementSavedSearches.ts.html |here} to see how to use ListOobManagementSavedSearchesRequest.
 */
export interface ListOobManagementSavedSearchesRequest extends common.BaseRequest {
    /**
...
export declare namespace ListOobManagementSavedSearchesRequest {
    enum SortBy {

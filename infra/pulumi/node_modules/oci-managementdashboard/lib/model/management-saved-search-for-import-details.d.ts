 ...
 */
export interface ManagementSavedSearchForImportDetails {
    /**
...
export declare namespace ManagementSavedSearchForImportDetails {
    function getJsonObj(obj: ManagementSavedSearchForImportDetails): object;
    function getDeserializedJsonObj(obj: ManagementSavedSearchForImportDetails): object;
}

...
export declare namespace ManagementSavedSearchSummary {
    function getJsonObj(obj: ManagementSavedSearchSummary): object;
    function getDeserializedJsonObj(obj: ManagementSavedSearchSummary): object;
}

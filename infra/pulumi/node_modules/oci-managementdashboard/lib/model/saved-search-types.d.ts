 ...
 **/
export declare enum SavedSearchTypes {
...
export declare namespace SavedSearchTypes {
    function getJsonObj(obj: SavedSearchTypes): SavedSearchTypes;
    function getDeserializedJsonObj(obj: SavedSearchTypes): SavedSearchTypes;
}

...
export declare namespace ManagementDashboard {
    function getJsonObj(obj: ManagementDashboard): object;
    function getDeserializedJsonObj(obj: ManagementDashboard): object;
}

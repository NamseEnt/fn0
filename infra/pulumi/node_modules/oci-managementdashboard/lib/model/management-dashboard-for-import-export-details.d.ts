...
export declare namespace ManagementDashboardForImportExportDetails {
    function getJsonObj(obj: ManagementDashboardForImportExportDetails): object;
    function getDeserializedJsonObj(obj: ManagementDashboardForImportExportDetails): object;
}

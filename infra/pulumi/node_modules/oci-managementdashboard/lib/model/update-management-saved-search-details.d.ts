...
export declare namespace UpdateManagementSavedSearchDetails {
    function getJsonObj(obj: UpdateManagementSavedSearchDetails): object;
    function getDeserializedJsonObj(obj: UpdateManagementSavedSearchDetails): object;
}

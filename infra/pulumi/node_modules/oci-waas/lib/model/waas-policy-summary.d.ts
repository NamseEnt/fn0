...
export declare namespace WaasPolicySummary {
    function getJsonObj(obj: WaasPolicySummary): object;
    function getDeserializedJsonObj(obj: WaasPolicySummary): object;
}

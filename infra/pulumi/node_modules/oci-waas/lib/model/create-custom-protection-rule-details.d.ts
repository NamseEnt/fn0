...
export declare namespace CreateCustomProtectionRuleDetails {
    function getJsonObj(obj: CreateCustomProtectionRuleDetails): object;
    function getDeserializedJsonObj(obj: CreateCustomProtectionRuleDetails): object;
}

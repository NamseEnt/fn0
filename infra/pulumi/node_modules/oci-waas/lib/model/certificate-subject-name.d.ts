...
export declare namespace CertificateSubjectName {
    function getJsonObj(obj: CertificateSubjectName): object;
    function getDeserializedJsonObj(obj: CertificateSubjectName): object;
}

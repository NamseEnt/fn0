...
export declare namespace AddressRateLimiting {
    function getJsonObj(obj: AddressRateLimiting): object;
    function getDeserializedJsonObj(obj: AddressRateLimiting): object;
}

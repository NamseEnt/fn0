...
export declare namespace WafBlockedRequest {
    enum WafFeature {
    ...
    function getJsonObj(obj: WafBlockedRequest): object;
    function getDeserializedJsonObj(obj: WafBlockedRequest): object;
}

...
export declare namespace HumanInteractionChallenge {
    enum Action {
        Detect = "DETECT",
        Block = "BLOCK",
        /**
    ...
    function getJsonObj(obj: HumanInteractionChallenge): object;
    function getDeserializedJsonObj(obj: HumanInteractionChallenge): object;
}

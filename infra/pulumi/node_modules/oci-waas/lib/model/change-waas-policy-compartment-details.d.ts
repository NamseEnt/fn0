...
export declare namespace ChangeWaasPolicyCompartmentDetails {
    function getJsonObj(obj: ChangeWaasPolicyCompartmentDetails): object;
    function getDeserializedJsonObj(obj: ChangeWaasPolicyCompartmentDetails): object;
}

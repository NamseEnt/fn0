...
export declare namespace ProtectionRuleExclusion {
    enum Target {
    ...
    function getJsonObj(obj: ProtectionRuleExclusion): object;
    function getDeserializedJsonObj(obj: ProtectionRuleExclusion): object;
}

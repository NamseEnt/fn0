 ...
 **/
export declare enum WorkRequestOperationTypes {
...
export declare namespace WorkRequestOperationTypes {
    function getJsonObj(obj: WorkRequestOperationTypes): WorkRequestOperationTypes;
    function getDeserializedJsonObj(obj: WorkRequestOperationTypes): WorkRequestOperationTypes;
}

...
export declare namespace CertificatePublicKeyInfo {
    function getJsonObj(obj: CertificatePublicKeyInfo): object;
    function getDeserializedJsonObj(obj: CertificatePublicKeyInfo): object;
}

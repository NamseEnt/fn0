...
export declare namespace BlockChallengeSettings {
    enum BlockAction {
    ...
    function getJsonObj(obj: BlockChallengeSettings): object;
    function getDeserializedJsonObj(obj: BlockChallengeSettings): object;
}

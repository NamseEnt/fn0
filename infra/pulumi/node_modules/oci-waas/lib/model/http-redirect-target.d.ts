...
export declare namespace HttpRedirectTarget {
    enum Protocol {
        Http = "HTTP",
        Https = "HTTPS",
        /**
    ...
    function getJsonObj(obj: HttpRedirectTarget): object;
    function getDeserializedJsonObj(obj: HttpRedirectTarget): object;
}

...
export declare namespace ExtendHttpResponseHeaderAction {
    function getJsonObj(obj: ExtendHttpResponseHeaderAction, isParentJsonObj?: boolean): object;
    const action = "EXTEND_HTTP_RESPONSE_HEADER";
    function getDeserializedJsonObj(obj: ExtendHttpResponseHeaderAction, isParentJsonObj?: boolean): object;
}

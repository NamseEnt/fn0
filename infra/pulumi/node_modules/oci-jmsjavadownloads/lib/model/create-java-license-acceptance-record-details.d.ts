...
export declare namespace CreateJavaLicenseAcceptanceRecordDetails {
    function getJsonObj(obj: CreateJavaLicenseAcceptanceRecordDetails): object;
    function getDeserializedJsonObj(obj: CreateJavaLicenseAcceptanceRecordDetails): object;
}

 ...
 **/
export declare enum LicenseAcceptanceSortBy {
    TimeAccepted = "timeAccepted",
    TimeLastUpdated = "timeLastUpdated",
    LicenseAcceptanceStatus = "licenseAcceptanceStatus"
}
export declare namespace LicenseAcceptanceSortBy {
    function getJsonObj(obj: LicenseAcceptanceSortBy): LicenseAcceptanceSortBy;
    function getDeserializedJsonObj(obj: LicenseAcceptanceSortBy): LicenseAcceptanceSortBy;
}

 ...
 **/
export declare enum JavaDownloadRecordSortBy {
...
export declare namespace JavaDownloadRecordSortBy {
    function getJsonObj(obj: JavaDownloadRecordSortBy): JavaDownloadRecordSortBy;
    function getDeserializedJsonObj(obj: JavaDownloadRecordSortBy): JavaDownloadRecordSortBy;
}

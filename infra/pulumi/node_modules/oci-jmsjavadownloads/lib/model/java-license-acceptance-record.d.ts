 ...
 */
export interface JavaLicenseAcceptanceRecord {
    /**
...
export declare namespace JavaLicenseAcceptanceRecord {
    function getJsonObj(obj: JavaLicenseAcceptanceRecord): object;
    function getDeserializedJsonObj(obj: JavaLicenseAcceptanceRecord): object;
}

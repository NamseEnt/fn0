...
export declare namespace JavaDownloadReport {
    function getJsonObj(obj: JavaDownloadReport): object;
    function getDeserializedJsonObj(obj: JavaDownloadReport): object;
}

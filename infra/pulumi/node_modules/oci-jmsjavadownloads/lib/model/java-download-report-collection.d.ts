...
export declare namespace JavaDownloadReportCollection {
    function getJsonObj(obj: JavaDownloadReportCollection): object;
    function getDeserializedJsonObj(obj: JavaDownloadReportCollection): object;
}

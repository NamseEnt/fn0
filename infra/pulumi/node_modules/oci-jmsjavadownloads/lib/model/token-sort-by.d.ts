 ...
 **/
export declare enum TokenSortBy {
...
export declare namespace TokenSortBy {
    function getJsonObj(obj: TokenSortBy): TokenSortBy;
    function getDeserializedJsonObj(obj: TokenSortBy): TokenSortBy;
}

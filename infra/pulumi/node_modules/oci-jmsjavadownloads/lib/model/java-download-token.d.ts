...
export declare namespace JavaDownloadToken {
    function getJsonObj(obj: JavaDownloadToken): object;
    function getDeserializedJsonObj(obj: JavaDownloadToken): object;
}

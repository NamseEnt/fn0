...
export declare namespace JavaDownloadTokenCollection {
    function getJsonObj(obj: JavaDownloadTokenCollection): object;
    function getDeserializedJsonObj(obj: JavaDownloadTokenCollection): object;
}

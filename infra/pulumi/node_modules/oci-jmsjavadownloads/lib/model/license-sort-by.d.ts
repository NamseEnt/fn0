 ...
 **/
export declare enum LicenseSortBy {
    LicenseType = "licenseType",
    DisplayName = "displayName"
}
export declare namespace LicenseSortBy {
    function getJsonObj(obj: LicenseSortBy): LicenseSortBy;
    function getDeserializedJsonObj(obj: LicenseSortBy): LicenseSortBy;
}

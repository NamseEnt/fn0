...
export declare namespace UpdateJavaDownloadTokenDetails {
    function getJsonObj(obj: UpdateJavaDownloadTokenDetails): object;
    function getDeserializedJsonObj(obj: UpdateJavaDownloadTokenDetails): object;
}

 ...
 */
export interface UpdateJavaLicenseAcceptanceRecordDetails {
    /**
...
export declare namespace UpdateJavaLicenseAcceptanceRecordDetails {
    function getJsonObj(obj: UpdateJavaLicenseAcceptanceRecordDetails): object;
    function getDeserializedJsonObj(obj: UpdateJavaLicenseAcceptanceRecordDetails): object;
}

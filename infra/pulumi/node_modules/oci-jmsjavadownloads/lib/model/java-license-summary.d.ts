...
export declare namespace JavaLicenseSummary {
    function getJsonObj(obj: JavaLicenseSummary): object;
    function getDeserializedJsonObj(obj: JavaLicenseSummary): object;
}

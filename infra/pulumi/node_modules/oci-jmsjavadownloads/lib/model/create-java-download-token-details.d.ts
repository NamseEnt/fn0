...
export declare namespace CreateJavaDownloadTokenDetails {
    function getJsonObj(obj: CreateJavaDownloadTokenDetails): object;
    function getDeserializedJsonObj(obj: CreateJavaDownloadTokenDetails): object;
}

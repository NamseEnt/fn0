 ...
 *
 */
export interface OccmDemandSignalCatalogResource {
    /**
     ...
     *
     */
    "lifecycleState": OccmDemandSignalCatalogResource.LifecycleState;
    /**
...
export declare namespace OccmDemandSignalCatalogResource {
    enum LifecycleState {
        Creating = "CREATING",
        Active = "ACTIVE",
        Updating = "UPDATING",
    ...
    function getJsonObj(obj: OccmDemandSignalCatalogResource): object;
    function getDeserializedJsonObj(obj: OccmDemandSignalCatalogResource): object;
}

...
export declare namespace OccOverviewCollection {
    function getJsonObj(obj: OccOverviewCollection): object;
    function getDeserializedJsonObj(obj: OccOverviewCollection): object;
}

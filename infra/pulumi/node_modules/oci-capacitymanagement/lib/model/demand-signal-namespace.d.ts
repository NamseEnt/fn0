 ...
 *
 **/
export declare enum DemandSignalNamespace {
    Compute = "COMPUTE",
    Network = "NETWORK",
    Gpu = "GPU",
    Storage = "STORAGE",
...
export declare namespace DemandSignalNamespace {
    function getJsonObj(obj: DemandSignalNamespace): DemandSignalNamespace;
    function getDeserializedJsonObj(obj: DemandSignalNamespace): DemandSignalNamespace;
}

...
export declare namespace OccAvailabilityCatalog {
    enum CatalogState {
    ...
    function getJsonObj(obj: OccAvailabilityCatalog): object;
    function getDeserializedJsonObj(obj: OccAvailabilityCatalog): object;
}

 ...
 *
 */
export interface InternalOccmDemandSignalDelivery {
    /**
     ...
     *
     */
    "lifecycleState": InternalOccmDemandSignalDelivery.LifecycleState;
    /**
  ...
  *
      */
    "lifecycleDetails": InternalOccmDemandSignalDelivery.LifecycleDetails;
    /**
...
export declare namespace InternalOccmDemandSignalDelivery {
    enum LifecycleState {
        Creating = "CREATING",
        Active = "ACTIVE",
        Updating = "UPDATING",
    ...
    function getJsonObj(obj: InternalOccmDemandSignalDelivery): object;
    function getDeserializedJsonObj(obj: InternalOccmDemandSignalDelivery): object;
}

...
export declare namespace UpdateOccCustomerDetails {
    enum Status {
        Enabled = "ENABLED",
        Disabled = "DISABLED"
    }
    function getJsonObj(obj: UpdateOccCustomerDetails): object;
    function getDeserializedJsonObj(obj: UpdateOccCustomerDetails): object;
}

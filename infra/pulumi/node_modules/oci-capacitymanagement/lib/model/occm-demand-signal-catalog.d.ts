 ...
 *
 */
export interface OccmDemandSignalCatalog {
    /**
     ...
     *
     */
    "lifecycleState": OccmDemandSignalCatalog.LifecycleState;
    /**
...
export declare namespace OccmDemandSignalCatalog {
    enum LifecycleState {
        Creating = "CREATING",
        Active = "ACTIVE",
        Updating = "UPDATING",
    ...
    function getJsonObj(obj: OccmDemandSignalCatalog): object;
    function getDeserializedJsonObj(obj: OccmDemandSignalCatalog): object;
}

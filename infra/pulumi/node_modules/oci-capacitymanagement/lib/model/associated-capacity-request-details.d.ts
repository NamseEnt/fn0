...
export declare namespace AssociatedCapacityRequestDetails {
    function getJsonObj(obj: AssociatedCapacityRequestDetails): object;
    function getDeserializedJsonObj(obj: AssociatedCapacityRequestDetails): object;
}

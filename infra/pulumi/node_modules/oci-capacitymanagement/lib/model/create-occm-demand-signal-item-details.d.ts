 ...
 *
 */
export interface CreateOccmDemandSignalItemDetails {
    /**
...
export declare namespace CreateOccmDemandSignalItemDetails {
    function getJsonObj(obj: CreateOccmDemandSignalItemDetails): object;
    function getDeserializedJsonObj(obj: CreateOccmDemandSignalItemDetails): object;
}

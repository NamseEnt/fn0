...
export declare namespace OccmDemandSignalDeliveryCollection {
    function getJsonObj(obj: OccmDemandSignalDeliveryCollection): object;
    function getDeserializedJsonObj(obj: OccmDemandSignalDeliveryCollection): object;
}

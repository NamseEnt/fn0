 ...
 *
 */
export interface OccmDemandSignalCatalogResourceSummary {
    /**
...
export declare namespace OccmDemandSignalCatalogResourceSummary {
    function getJsonObj(obj: OccmDemandSignalCatalogResourceSummary): object;
    function getDeserializedJsonObj(obj: OccmDemandSignalCatalogResourceSummary): object;
}

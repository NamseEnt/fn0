 ...
 */
export interface InternalOccmDemandSignalCatalogResourceCollection {
    /**
     * An array of items containing detailed information about different resources.
     *
     */
    "items": Array<model.InternalOccmDemandSignalCatalogResourceSummary>;
}
export declare namespace InternalOccmDemandSignalCatalogResourceCollection {
    function getJsonObj(obj: InternalOccmDemandSignalCatalogResourceCollection): object;
    function getDeserializedJsonObj(obj: InternalOccmDemandSignalCatalogResourceCollection): object;
}

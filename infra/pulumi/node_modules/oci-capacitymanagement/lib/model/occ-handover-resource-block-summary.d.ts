...
export declare namespace OccHandoverResourceBlockSummary {
    function getJsonObj(obj: OccHandoverResourceBlockSummary): object;
    function getDeserializedJsonObj(obj: OccHandoverResourceBlockSummary): object;
}

 ...
 */
export interface OccmDemandSignalCatalogResourceCollection {
    /**
     * An array of items containing detailed information about different resources.
     *
     */
    "items": Array<model.OccmDemandSignalCatalogResourceSummary>;
}
export declare namespace OccmDemandSignalCatalogResourceCollection {
    function getJsonObj(obj: OccmDemandSignalCatalogResourceCollection): object;
    function getDeserializedJsonObj(obj: OccmDemandSignalCatalogResourceCollection): object;
}

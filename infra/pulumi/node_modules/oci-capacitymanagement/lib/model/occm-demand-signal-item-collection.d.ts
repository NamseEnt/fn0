 ...
 */
export interface OccmDemandSignalItemCollection {
    /**
     * An array of items containing detailed information about different resource demanded as part of a demand signal.
     *
     */
    "items": Array<model.OccmDemandSignalItemSummary>;
}
export declare namespace OccmDemandSignalItemCollection {
    function getJsonObj(obj: OccmDemandSignalItemCollection): object;
    function getDeserializedJsonObj(obj: OccmDemandSignalItemCollection): object;
}

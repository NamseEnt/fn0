 ...
 */
export interface UpdateOccAvailabilityCatalogDetails {
    /**
...
export declare namespace UpdateOccAvailabilityCatalogDetails {
    function getJsonObj(obj: UpdateOccAvailabilityCatalogDetails): object;
    function getDeserializedJsonObj(obj: UpdateOccAvailabilityCatalogDetails): object;
}

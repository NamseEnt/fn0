...
export declare namespace CreateOccCustomerGroupDetails {
    enum Status {
        Enabled = "ENABLED",
        Disabled = "DISABLED"
    }
    function getJsonObj(obj: CreateOccCustomerGroupDetails): object;
    function getDeserializedJsonObj(obj: CreateOccCustomerGroupDetails): object;
}

...
export declare namespace OccCapacityRequestCollection {
    function getJsonObj(obj: OccCapacityRequestCollection): object;
    function getDeserializedJsonObj(obj: OccCapacityRequestCollection): object;
}

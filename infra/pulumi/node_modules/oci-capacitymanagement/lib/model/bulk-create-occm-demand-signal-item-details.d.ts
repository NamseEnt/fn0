...
export declare namespace BulkCreateOccmDemandSignalItemDetails {
    function getJsonObj(obj: BulkCreateOccmDemandSignalItemDetails): object;
    function getDeserializedJsonObj(obj: BulkCreateOccmDemandSignalItemDetails): object;
}

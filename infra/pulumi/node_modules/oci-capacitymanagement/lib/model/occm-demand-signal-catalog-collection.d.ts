 ...
 */
export interface OccmDemandSignalCatalogCollection {
    /**
     * An array of items containing demand signal catalogs.
     *
     */
    "items": Array<model.OccmDemandSignalCatalogSummary>;
}
export declare namespace OccmDemandSignalCatalogCollection {
    function getJsonObj(obj: OccmDemandSignalCatalogCollection): object;
    function getDeserializedJsonObj(obj: OccmDemandSignalCatalogCollection): object;
}

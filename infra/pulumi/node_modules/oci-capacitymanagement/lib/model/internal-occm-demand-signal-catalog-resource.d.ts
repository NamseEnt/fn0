 ...
 *
 */
export interface InternalOccmDemandSignalCatalogResource {
    /**
     ...
     *
     */
    "lifecycleState": InternalOccmDemandSignalCatalogResource.LifecycleState;
    /**
...
export declare namespace InternalOccmDemandSignalCatalogResource {
    enum LifecycleState {
        Creating = "CREATING",
        Active = "ACTIVE",
        Updating = "UPDATING",
    ...
    function getJsonObj(obj: InternalOccmDemandSignalCatalogResource): object;
    function getDeserializedJsonObj(obj: InternalOccmDemandSignalCatalogResource): object;
}

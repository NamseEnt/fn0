...
export declare namespace CreateOccCustomerDetails {
    enum Status {
        Enabled = "ENABLED",
        Disabled = "DISABLED"
    }
    function getJsonObj(obj: CreateOccCustomerDetails): object;
    function getDeserializedJsonObj(obj: CreateOccCustomerDetails): object;
}

...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/capacitymanagement/ListOccAvailabilityCatalogs.ts.html |here} to see how to use ListOccAvailabilityCatalogsRequest.
 */
...
export declare namespace ListOccAvailabilityCatalogsRequest {
    enum SortBy {

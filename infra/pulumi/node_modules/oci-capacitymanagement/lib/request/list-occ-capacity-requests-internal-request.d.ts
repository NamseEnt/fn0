...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/capacitymanagement/ListOccCapacityRequestsInternal.ts.html |here} to see how to use ListOccCapacityRequestsInternalRequest.
 */
...
export declare namespace ListOccCapacityRequestsInternalRequest {
    enum SortBy {

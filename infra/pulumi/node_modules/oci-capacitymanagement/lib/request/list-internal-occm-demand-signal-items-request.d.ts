...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/capacitymanagement/ListInternalOccmDemandSignalItems.ts.html |here} to see how to use ListInternalOccmDemandSignalItemsRequest.
 */
export interface ListInternalOccmDemandSignalItemsRequest extends common.BaseRequest {
    /**
...
export declare namespace ListInternalOccmDemandSignalItemsRequest {
    enum SortBy {

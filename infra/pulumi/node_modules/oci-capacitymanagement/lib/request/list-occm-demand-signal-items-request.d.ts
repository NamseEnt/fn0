...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/capacitymanagement/ListOccmDemandSignalItems.ts.html |here} to see how to use ListOccmDemandSignalItemsRequest.
 */
export interface ListOccmDemandSignalItemsRequest extends common.BaseRequest {
    /**
...
export declare namespace ListOccmDemandSignalItemsRequest {
    enum SortBy {

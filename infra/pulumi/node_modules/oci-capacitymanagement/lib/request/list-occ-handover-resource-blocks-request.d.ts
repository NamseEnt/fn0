...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/capacitymanagement/ListOccHandoverResourceBlocks.ts.html |here} to see how to use ListOccHandoverResourceBlocksRequest.
 */
...
export declare namespace ListOccHandoverResourceBlocksRequest {
    enum SortBy {

...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/capacitymanagement/ListOccOverviews.ts.html |here} to see how to use ListOccOverviewsRequest.
 */
export interface ListOccOverviewsRequest extends common.BaseRequest {
    /**
...
export declare namespace ListOccOverviewsRequest {
    enum SortBy {

...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/capacitymanagement/ListOccmDemandSignals.ts.html |here} to see how to use ListOccmDemandSignalsRequest.
 */
export interface ListOccmDemandSignalsRequest extends common.BaseRequest {
    /**
...
export declare namespace ListOccmDemandSignalsRequest {
    enum SortBy {

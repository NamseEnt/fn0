...
export declare class InternalDemandSignalWaiter {
    private client;
    private readonly config?;
    constructor(client: InternalDemandSignalClient, config?: Partial<import("oci-common/lib/waiter").WaiterConfigurationDetails> | undefined);
    /**
     ...
     */
    forInternalOccmDemandSignalDelivery(request: serviceRequests.GetInternalOccmDemandSignalDeliveryRequest, ...targetStates: models.InternalOccmDemandSignalDelivery.LifecycleState[]): Promise<serviceResponses.GetInternalOccmDemandSignalDeliveryResponse | null>;
}

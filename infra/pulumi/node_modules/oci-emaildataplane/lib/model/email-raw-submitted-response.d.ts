 ...
 */
export interface EmailRawSubmittedResponse {
    /**
...
export declare namespace EmailRawSubmittedResponse {
    function getJsonObj(obj: EmailRawSubmittedResponse): object;
    function getDeserializedJsonObj(obj: EmailRawSubmittedResponse): object;
}

 ...
 * ```
 */
export declare function getZeroTrustGatewayPolicy(args: GetZeroTrustGatewayPolicyArgs, opts?: pulumi.InvokeOptions): Promise<GetZeroTrustGatewayPolicyResult>;
/**
 ...
 * ```
 */
export declare function getZeroTrustGatewayPolicyOutput(args: GetZeroTrustGatewayPolicyOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetZeroTrustGatewayPolicyResult>;
/**
 * A collection of arguments for invoking getZeroTrustGatewayPolicy.
 */

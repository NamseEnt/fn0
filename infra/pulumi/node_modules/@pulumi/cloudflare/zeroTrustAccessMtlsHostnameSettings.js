...
exports.ZeroTrustAccessMtlsHostnameSettings = void 0;
 ...
 * ```
 */
class ZeroTrustAccessMtlsHostnameSettings extends pulumi.CustomResource {
    /**
    ...
    static get(name, id, state, opts) {
        return new ZeroTrustAccessMtlsHostnameSettings(name, state, { ...opts, id: id });
    }
    /**
...
/** @internal */
ZeroTrustAccessMtlsHostnameSettings.__pulumiType = 'cloudflare:index/zeroTrustAccessMtlsHostnameSettings:ZeroTrustAccessMtlsHostnameSettings';
//# sourceMappingURL=zeroTrustAccessMtlsHostnameSettings.js.map
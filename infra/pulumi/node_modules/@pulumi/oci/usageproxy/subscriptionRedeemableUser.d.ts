 ...
 * ```
 */
export declare class SubscriptionRedeemableUser extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: SubscriptionRedeemableUserState, opts?: pulumi.CustomResourceOptions): SubscriptionRedeemableUser;
    /**
     ...
     */
    static isInstance(obj: any): obj is SubscriptionRedeemableUser;
    /**
     * The list of new user to be added to the list of user that can redeem rewards.
     */
    readonly items: pulumi.Output<outputs.UsageProxy.SubscriptionRedeemableUserItem[]>;
    /**

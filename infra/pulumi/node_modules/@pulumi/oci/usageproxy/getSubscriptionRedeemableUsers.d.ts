 ...
 * ```
 */
export declare function getSubscriptionRedeemableUsers(args: GetSubscriptionRedeemableUsersArgs, opts?: pulumi.InvokeOptions): Promise<GetSubscriptionRedeemableUsersResult>;
/**
 ...
 * ```
 */
export declare function getSubscriptionRedeemableUsersOutput(args: GetSubscriptionRedeemableUsersOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetSubscriptionRedeemableUsersResult>;
/**
 * A collection of arguments for invoking getSubscriptionRedeemableUsers.
 */

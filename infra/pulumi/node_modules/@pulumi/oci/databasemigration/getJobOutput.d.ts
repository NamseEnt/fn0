 ...
 * ```
 */
export declare function getJobOutput(args: GetJobOutputArgs, opts?: pulumi.InvokeOptions): Promise<GetJobOutputResult>;
/**
 ...
 * ```
 */
export declare function getJobOutputOutput(args: GetJobOutputOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetJobOutputResult>;
/**
 * A collection of arguments for invoking getJobOutput.
 */

 ...
 * ```
 */
class ContainerInstance extends pulumi.CustomResource {
    /**
    ...
    static get(name, id, state, opts) {
        return new ContainerInstance(name, state, { ...opts, id: id });
    }
    /**
...
/** @internal */
ContainerInstance.__pulumiType = 'oci:ContainerEngine/containerInstance:ContainerInstance';

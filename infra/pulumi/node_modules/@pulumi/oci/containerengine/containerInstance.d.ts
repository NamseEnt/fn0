 ...
 * ```
 */
export declare class ContainerInstance extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ContainerInstanceState, opts?: pulumi.CustomResourceOptions): ContainerInstance;
    /**

 ...
 * ```
 */
export declare function getFleetJavaMigrationAnalysisResults(args: GetFleetJavaMigrationAnalysisResultsArgs, opts?: pulumi.InvokeOptions): Promise<GetFleetJavaMigrationAnalysisResultsResult>;
/**
 ...
 * ```
 */
export declare function getFleetJavaMigrationAnalysisResultsOutput(args: GetFleetJavaMigrationAnalysisResultsOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetFleetJavaMigrationAnalysisResultsResult>;
/**
 * A collection of arguments for invoking getFleetJavaMigrationAnalysisResults.
 */

 ...
 * ```
 */
export declare function getFleetAgentConfiguration(args: GetFleetAgentConfigurationArgs, opts?: pulumi.InvokeOptions): Promise<GetFleetAgentConfigurationResult>;
/**
 ...
 * ```
 */
export declare function getFleetAgentConfigurationOutput(args: GetFleetAgentConfigurationOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetFleetAgentConfigurationResult>;
/**
 * A collection of arguments for invoking getFleetAgentConfiguration.
 */

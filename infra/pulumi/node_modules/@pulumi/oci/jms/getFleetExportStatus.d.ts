 ...
 * ```
 */
export declare function getFleetExportStatus(args: GetFleetExportStatusArgs, opts?: pulumi.InvokeOptions): Promise<GetFleetExportStatusResult>;
/**
 ...
 * ```
 */
export declare function getFleetExportStatusOutput(args: GetFleetExportStatusOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetFleetExportStatusResult>;
/**
 * A collection of arguments for invoking getFleetExportStatus.
 */

 ...
 * ```
 */
export declare function getFleetCryptoAnalysisResults(args: GetFleetCryptoAnalysisResultsArgs, opts?: pulumi.InvokeOptions): Promise<GetFleetCryptoAnalysisResultsResult>;
/**
 ...
 * ```
 */
export declare function getFleetCryptoAnalysisResultsOutput(args: GetFleetCryptoAnalysisResultsOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetFleetCryptoAnalysisResultsResult>;
/**
 * A collection of arguments for invoking getFleetCryptoAnalysisResults.
 */

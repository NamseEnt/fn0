 ...
 * ```
 */
export declare function getFleetPerformanceTuningAnalysisResult(args: GetFleetPerformanceTuningAnalysisResultArgs, opts?: pulumi.InvokeOptions): Promise<GetFleetPerformanceTuningAnalysisResultResult>;
/**
 ...
 * ```
 */
export declare function getFleetPerformanceTuningAnalysisResultOutput(args: GetFleetPerformanceTuningAnalysisResultOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetFleetPerformanceTuningAnalysisResultResult>;
/**
 * A collection of arguments for invoking getFleetPerformanceTuningAnalysisResult.
 */

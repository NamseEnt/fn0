 ...
 * ```
 */
export declare function getAppAcceleration(args: GetAppAccelerationArgs, opts?: pulumi.InvokeOptions): Promise<GetAppAccelerationResult>;
/**
 ...
 * ```
 */
export declare function getAppAccelerationOutput(args: GetAppAccelerationOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetAppAccelerationResult>;
/**
 * A collection of arguments for invoking getAppAcceleration.
 */

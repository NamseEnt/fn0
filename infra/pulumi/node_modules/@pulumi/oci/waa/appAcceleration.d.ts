 ...
 * ```
 */
export declare class AppAcceleration extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: AppAccelerationState, opts?: pulumi.CustomResourceOptions): AppAcceleration;
    /**
     * Returns true if the given object is an instance of AppAcceleration.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is AppAcceleration;
    /**
     ...
     */
    readonly webAppAccelerationPolicyId: pulumi.Output<string>;
    /**

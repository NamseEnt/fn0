...
export declare class Certificate extends pulumi.CustomResource {
     ...
     */
    readonly certificateConfig: pulumi.Output<outputs.CertificatesManagement.CertificateCertificateConfig>;
    /**
     * The name of the profile used to create the certificate, which depends on the type of certificate you need.
     */
    readonly certificateProfileType: pulumi.Output<string>;
    /**
     * The details of the certificate revocation list (CRL).
     */
    readonly certificateRevocationListDetails: pulumi.Output<outputs.CertificatesManagement.CertificateCertificateRevocationListDetail[]>;
    /**
     * (Updatable) An optional list of rules that control how the certificate is used and managed.
     */
    readonly certificateRules: pulumi.Output<outputs.CertificatesManagement.CertificateCertificateRule[] | undefined>;
    /**
     ...
     */
    readonly currentVersions: pulumi.Output<outputs.CertificatesManagement.CertificateCurrentVersion[]>;
    /**
     ...
     */
    readonly subjects: pulumi.Output<outputs.CertificatesManagement.CertificateSubject[]>;
    /**

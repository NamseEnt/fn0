 ...
 * ```
 */
export declare class CaBundle extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: CaBundleState, opts?: pulumi.CustomResourceOptions): CaBundle;
    /**
     * Returns true if the given object is an instance of CaBundle.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is CaBundle;
    /**
     * (Updatable) Certificates (in PEM format) to include in the CA bundle.
     */
    readonly caBundlePem: pulumi.Output<string>;
    /**

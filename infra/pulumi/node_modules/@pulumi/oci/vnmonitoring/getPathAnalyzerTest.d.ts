 ...
 * ```
 */
export declare function getPathAnalyzerTest(args: GetPathAnalyzerTestArgs, opts?: pulumi.InvokeOptions): Promise<GetPathAnalyzerTestResult>;
/**
 ...
 * ```
 */
export declare function getPathAnalyzerTestOutput(args: GetPathAnalyzerTestOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetPathAnalyzerTestResult>;
/**
 * A collection of arguments for invoking GetPathAnalyzerTest.
 */

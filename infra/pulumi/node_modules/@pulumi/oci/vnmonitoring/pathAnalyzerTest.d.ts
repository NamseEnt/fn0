 ...
 * ```
 */
export declare class PathAnalyzerTest extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: PathAnalyzerTestState, opts?: pulumi.CustomResourceOptions): PathAnalyzerTest;
    /**
     * Returns true if the given object is an instance of PathAnalyzerTest.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is PathAnalyzerTest;
    /**
     ...
     */
    readonly destinationEndpoint: pulumi.Output<outputs.VnMonitoring.PathAnalyzerTestDestinationEndpoint>;
    /**
     ...
     */
    readonly protocolParameters: pulumi.Output<outputs.VnMonitoring.PathAnalyzerTestProtocolParameters>;
    /**
     * (Updatable) Defines the query options required for a `PathAnalyzerTest` resource.
     */
    readonly queryOptions: pulumi.Output<outputs.VnMonitoring.PathAnalyzerTestQueryOptions>;
    /**
     * (Updatable) Information describing a source or destination in a `PathAnalyzerTest` resource.
     */
    readonly sourceEndpoint: pulumi.Output<outputs.VnMonitoring.PathAnalyzerTestSourceEndpoint>;
    /**

...
export { adm, aidocument, ailanguage, aivision, analytics, announcementsservice, apigateway, apm, apmconfig, apmsynthetics, apmtraces, appmgmtcontrol, artifacts, audit, autoscaling, bastion, bigdataservice, blockchain, budget, capacitymanagement, certificatesmanagement, cloudbridge, cloudguard, cloudmigrations, clusterplacementgroups, computecloud, computeinstanceagent, config, containerengine, containerinstances, core, database, databasemanagement, databasemigration, databasetools, datacatalog, dataflow, dataintegration, datalabellingservice, datasafe, datascience, dblm, delegateaccesscontrol, demandsignal, desktops, devops, disasterrecovery, dns, email, events, filestorage, fleetappsmanagement, fleetsoftwareupdate, functions, fusionapps, generativeai, genericartifactscontent, globallydistributeddatabase, goldengate, healthchecks, identity, identitydataplane, integration, jms, kms, licensemanager, limits, loadbalancer, loganalytics, logging, lustre, managementagent, managementdashboard, marketplace, mediaservices, meteringcomputation, monitoring, mysql, networkfirewall, networkloadbalancer, nosql, objectstorage, oce, oci, ocvp, oda, onesubsription, ons, opa, opensearch, operatoraccesscontrol, opsi, optimizer, osmanagementhub, ospgateway, osubbillingschedule, osuborganizationsubscription, osubsubscription, osubusage, psql, queue, recoverymod, redis, resourcemanager, resourcescheduler, sch, secrets, securityattribute, servicecatalog, servicemanagerproxy, stackmonitoring, streaming, tenantmanagercontrolplane, types, usageproxy, vault, vbs, visualbuilder, vnmonitoring, vulnerabilityscanning, waa, waas, waf, zpr, };

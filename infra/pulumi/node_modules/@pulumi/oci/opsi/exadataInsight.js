 ...
 * ```
 */
class ExadataInsight extends pulumi.CustomResource {
    /**
    ...
    static get(name, id, state, opts) {
        return new ExadataInsight(name, state, { ...opts, id: id });
    }
    /**
...
exports.ExadataInsight = ExadataInsight;
/** @internal */
ExadataInsight.__pulumiType = 'oci:Opsi/exadataInsight:ExadataInsight';
//# sourceMappingURL=exadataInsight.js.map
 ...
 * ```
 */
class HostInsight extends pulumi.CustomResource {
    /**
    ...
    static get(name, id, state, opts) {
        return new HostInsight(name, state, { ...opts, id: id });
    }
    /**
...
exports.HostInsight = HostInsight;
/** @internal */
HostInsight.__pulumiType = 'oci:Opsi/hostInsight:HostInsight';
//# sourceMappingURL=hostInsight.js.map
 ...
 * ```
 */
export declare class ExadataInsight extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ExadataInsightState, opts?: pulumi.CustomResourceOptions): ExadataInsight;
    /**
     * Returns true if the given object is an instance of ExadataInsight.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is ExadataInsight;
    /**
     ...
     */
    readonly exadataDisplayName: pulumi.Output<string>;
    /**
     * The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the Exadata Infrastructure.
     */
    readonly exadataInfraId: pulumi.Output<string>;
    readonly exadataInfraResourceType: pulumi.Output<string>;
    /**
     * The Exadata system name. If the Exadata systems managed by Enterprise Manager, the name is unique amongst the Exadata systems managed by the same Enterprise Manager.
     */
    readonly exadataName: pulumi.Output<string>;
    /**
     * Exadata rack type.
     */
    readonly exadataRackType: pulumi.Output<string>;
    readonly exadataShape: pulumi.Output<string>;
    /**
     * Operations Insights internal representation of the the Exadata system type.
     */
    readonly exadataType: pulumi.Output<string>;
    /**
     ...
     */
    readonly isAutoSyncEnabled: pulumi.Output<boolean>;
    /**
     * true if virtualization is used in the Exadata system
     */
    readonly isVirtualizedExadata: pulumi.Output<boolean>;
    /**
     * A message describing the current state in more detail. For example, can be used to provide actionable information for a resource in Failed state.
     */
    readonly lifecycleDetails: pulumi.Output<string>;
    readonly memberVmClusterDetails: pulumi.Output<outputs.Opsi.ExadataInsightMemberVmClusterDetail[]>;
    /**

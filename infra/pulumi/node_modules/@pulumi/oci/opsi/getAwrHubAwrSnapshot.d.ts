 ...
 * ```
 */
export declare function getAwrHubAwrSnapshot(args: GetAwrHubAwrSnapshotArgs, opts?: pulumi.InvokeOptions): Promise<GetAwrHubAwrSnapshotResult>;
/**
 ...
 * ```
 */
export declare function getAwrHubAwrSnapshotOutput(args: GetAwrHubAwrSnapshotOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetAwrHubAwrSnapshotResult>;
/**
 * A collection of arguments for invoking getAwrHubAwrSnapshot.
 */

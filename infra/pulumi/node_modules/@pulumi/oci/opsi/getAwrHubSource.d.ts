 ...
 * ```
 */
export declare function getAwrHubSource(args: GetAwrHubSourceArgs, opts?: pulumi.InvokeOptions): Promise<GetAwrHubSourceResult>;
/**
 ...
 * ```
 */
export declare function getAwrHubSourceOutput(args: GetAwrHubSourceOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetAwrHubSourceResult>;
/**
 * A collection of arguments for invoking getAwrHubSource.
 */

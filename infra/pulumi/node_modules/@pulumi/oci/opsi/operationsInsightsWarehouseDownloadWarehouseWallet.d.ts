 ...
 * ```
 */
export declare class OperationsInsightsWarehouseDownloadWarehouseWallet extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: OperationsInsightsWarehouseDownloadWarehouseWalletState, opts?: pulumi.CustomResourceOptions): OperationsInsightsWarehouseDownloadWarehouseWallet;
    /**
     ...
     */
    static isInstance(obj: any): obj is OperationsInsightsWarehouseDownloadWarehouseWallet;
    /**
     ...
     */
    readonly operationsInsightsWarehouseWalletPassword: pulumi.Output<string>;
    /**

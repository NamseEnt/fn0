 ...
 * ```
 */
export declare function getNewsReport(args: GetNewsReportArgs, opts?: pulumi.InvokeOptions): Promise<GetNewsReportResult>;
/**
 ...
 * ```
 */
export declare function getNewsReportOutput(args: GetNewsReportOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetNewsReportResult>;
/**
 * A collection of arguments for invoking getNewsReport.
 */

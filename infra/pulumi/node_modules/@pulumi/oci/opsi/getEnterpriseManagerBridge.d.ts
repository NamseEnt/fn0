 ...
 * ```
 */
export declare function getEnterpriseManagerBridge(args: GetEnterpriseManagerBridgeArgs, opts?: pulumi.InvokeOptions): Promise<GetEnterpriseManagerBridgeResult>;
/**
 ...
 * ```
 */
export declare function getEnterpriseManagerBridgeOutput(args: GetEnterpriseManagerBridgeOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetEnterpriseManagerBridgeResult>;
/**
 * A collection of arguments for invoking getEnterpriseManagerBridge.
 */

 ...
 * ```
 */
export declare function getHostInsight(args: GetHostInsightArgs, opts?: pulumi.InvokeOptions): Promise<GetHostInsightResult>;
/**
 ...
 * ```
 */
export declare function getHostInsightOutput(args: GetHostInsightOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetHostInsightResult>;
/**
 * A collection of arguments for invoking getHostInsight.
 */

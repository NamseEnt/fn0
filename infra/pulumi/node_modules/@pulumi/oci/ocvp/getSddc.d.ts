 ...
 * ```
 */
export declare function getSddc(args: GetSddcArgs, opts?: pulumi.InvokeOptions): Promise<GetSddcResult>;
/**
 ...
 * ```
 */
export declare function getSddcOutput(args: GetSddcOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetSddcResult>;
/**
 * A collection of arguments for invoking getSddc.
 */

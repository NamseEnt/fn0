 ...
 * ```
 */
export declare function getExsiHost(args: GetExsiHostArgs, opts?: pulumi.InvokeOptions): Promise<GetExsiHostResult>;
/**
 ...
 * ```
 */
export declare function getExsiHostOutput(args: GetExsiHostOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetExsiHostResult>;
/**
 * A collection of arguments for invoking getExsiHost.
 */

 ...
 * ```
 */
export declare function getSddcs(args: GetSddcsArgs, opts?: pulumi.InvokeOptions): Promise<GetSddcsResult>;
/**
 ...
 * ```
 */
export declare function getSddcsOutput(args: GetSddcsOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetSddcsResult>;
/**
 * A collection of arguments for invoking getSddcs.
 */

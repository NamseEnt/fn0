 ...
 * ```
 */
export declare function getSupportedCommitments(args: GetSupportedCommitmentsArgs, opts?: pulumi.InvokeOptions): Promise<GetSupportedCommitmentsResult>;
/**
 ...
 * ```
 */
export declare function getSupportedCommitmentsOutput(args: GetSupportedCommitmentsOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetSupportedCommitmentsResult>;
/**
 * A collection of arguments for invoking getSupportedCommitments.
 */

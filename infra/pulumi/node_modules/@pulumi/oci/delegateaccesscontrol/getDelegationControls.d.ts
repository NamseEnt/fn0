 ...
 * ```
 */
export declare function getDelegationControls(args: GetDelegationControlsArgs, opts?: pulumi.InvokeOptions): Promise<GetDelegationControlsResult>;
/**
 ...
 * ```
 */
export declare function getDelegationControlsOutput(args: GetDelegationControlsOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetDelegationControlsResult>;
/**
 * A collection of arguments for invoking getDelegationControls.
 */

 ...
 * ```
 */
export declare function getDelegationSubscriptions(args: GetDelegationSubscriptionsArgs, opts?: pulumi.InvokeOptions): Promise<GetDelegationSubscriptionsResult>;
/**
 ...
 * ```
 */
export declare function getDelegationSubscriptionsOutput(args: GetDelegationSubscriptionsOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetDelegationSubscriptionsResult>;
/**
 * A collection of arguments for invoking getDelegationSubscriptions.
 */

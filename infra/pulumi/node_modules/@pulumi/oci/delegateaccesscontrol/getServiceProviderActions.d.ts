 ...
 * ```
 */
export declare function getServiceProviderActions(args: GetServiceProviderActionsArgs, opts?: pulumi.InvokeOptions): Promise<GetServiceProviderActionsResult>;
/**
 ...
 * ```
 */
export declare function getServiceProviderActionsOutput(args: GetServiceProviderActionsOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetServiceProviderActionsResult>;
/**
 * A collection of arguments for invoking getServiceProviderActions.
 */

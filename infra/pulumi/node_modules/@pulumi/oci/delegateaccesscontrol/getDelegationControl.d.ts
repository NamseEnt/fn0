 ...
 * ```
 */
export declare function getDelegationControl(args: GetDelegationControlArgs, opts?: pulumi.InvokeOptions): Promise<GetDelegationControlResult>;
/**
 ...
 * ```
 */
export declare function getDelegationControlOutput(args: GetDelegationControlOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetDelegationControlResult>;
/**
 * A collection of arguments for invoking getDelegationControl.
 */

 ...
 * ```
 */
export declare function getEncryptedData(args: GetEncryptedDataArgs, opts?: pulumi.InvokeOptions): Promise<GetEncryptedDataResult>;
/**
 ...
 * ```
 */
export declare function getEncryptedDataOutput(args: GetEncryptedDataOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetEncryptedDataResult>;
/**
 * A collection of arguments for invoking getEncryptedData.
 */

 ...
 * ```
 */
export declare class EkmsPrivateEndpoint extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: EkmsPrivateEndpointState, opts?: pulumi.CustomResourceOptions): EkmsPrivateEndpoint;
    /**
     * Returns true if the given object is an instance of EkmsPrivateEndpoint.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is EkmsPrivateEndpoint;
    /**
     * CABundle to validate TLS certificate of the external key manager system in PEM format
     */
    readonly caBundle: pulumi.Output<string>;
    /**
     ...
     */
    readonly externalKeyManagerIp: pulumi.Output<string>;
    /**

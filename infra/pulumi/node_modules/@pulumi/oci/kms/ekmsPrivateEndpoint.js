 ...
 * ```
 */
class EkmsPrivateEndpoint extends pulumi.CustomResource {
    /**
    ...
    static get(name, id, state, opts) {
        return new EkmsPrivateEndpoint(name, state, { ...opts, id: id });
    }
    /**
...
exports.EkmsPrivateEndpoint = EkmsPrivateEndpoint;
/** @internal */
EkmsPrivateEndpoint.__pulumiType = 'oci:Kms/ekmsPrivateEndpoint:EkmsPrivateEndpoint';
//# sourceMappingURL=ekmsPrivateEndpoint.js.map
 ...
 */
class EncryptedData extends pulumi.CustomResource {
    /**
    ...
    static get(name, id, state, opts) {
        return new EncryptedData(name, state, { ...opts, id: id });
    }
    /**
...
/** @internal */
EncryptedData.__pulumiType = 'oci:Kms/encryptedData:EncryptedData';

 ...
 * ```
 */
export declare class Sign extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: SignState, opts?: pulumi.CustomResourceOptions): Sign;
    /**
     * Returns true if the given object is an instance of Sign.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is Sign;
    /**

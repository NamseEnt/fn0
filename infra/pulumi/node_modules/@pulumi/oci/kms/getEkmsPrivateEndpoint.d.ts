 ...
 * ```
 */
export declare function getEkmsPrivateEndpoint(args: GetEkmsPrivateEndpointArgs, opts?: pulumi.InvokeOptions): Promise<GetEkmsPrivateEndpointResult>;
/**
 ...
 * ```
 */
export declare function getEkmsPrivateEndpointOutput(args: GetEkmsPrivateEndpointOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetEkmsPrivateEndpointResult>;
/**
 * A collection of arguments for invoking getEkmsPrivateEndpoint.
 */

 ...
 * ```
 */
export declare class KeyVersion extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: KeyVersionState, opts?: pulumi.CustomResourceOptions): KeyVersion;
    /**
     * Returns true if the given object is an instance of KeyVersion.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is KeyVersion;
    /**
     ...
     */
    readonly externalKeyReferenceDetails: pulumi.Output<outputs.Kms.KeyVersionExternalKeyReferenceDetail[]>;
    /**
     * Key version ID associated with the external key.
     */
    readonly externalKeyVersionId: pulumi.Output<string>;
    /**
     * An optional property indicating whether this keyversion is generated from auto rotatation.
     */
    readonly isAutoRotated: pulumi.Output<boolean>;
    /**
    ...
    readonly keyVersionId: pulumi.Output<string>;
    /**
     ...
     */
    readonly replicaDetails: pulumi.Output<outputs.Kms.KeyVersionReplicaDetail[]>;
    readonly restoredFromKeyId: pulumi.Output<string>;
    /**
     * The OCID of the key version from which this key version was restored.
     */
    readonly restoredFromKeyVersionId: pulumi.Output<string>;
    /**

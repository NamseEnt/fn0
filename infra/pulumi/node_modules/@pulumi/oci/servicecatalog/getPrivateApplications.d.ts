 ...
 * ```
 */
export declare function getPrivateApplications(args: GetPrivateApplicationsArgs, opts?: pulumi.InvokeOptions): Promise<GetPrivateApplicationsResult>;
/**
 ...
 * ```
 */
export declare function getPrivateApplicationsOutput(args: GetPrivateApplicationsOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetPrivateApplicationsResult>;
/**
 * A collection of arguments for invoking getPrivateApplications.
 */

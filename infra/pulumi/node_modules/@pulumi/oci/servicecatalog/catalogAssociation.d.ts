 ...
 * ```
 */
export declare class CatalogAssociation extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: CatalogAssociationState, opts?: pulumi.CustomResourceOptions): CatalogAssociation;
    /**
     * Returns true if the given object is an instance of CatalogAssociation.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is CatalogAssociation;
    /**
     ...
     */
    readonly serviceCatalogId: pulumi.Output<string>;
    /**

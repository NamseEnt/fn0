 ...
 * ```
 */
export declare function getPrivateApplicationPackage(args: GetPrivateApplicationPackageArgs, opts?: pulumi.InvokeOptions): Promise<GetPrivateApplicationPackageResult>;
/**
 ...
 * ```
 */
export declare function getPrivateApplicationPackageOutput(args: GetPrivateApplicationPackageOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetPrivateApplicationPackageResult>;
/**
 * A collection of arguments for invoking getPrivateApplicationPackage.
 */

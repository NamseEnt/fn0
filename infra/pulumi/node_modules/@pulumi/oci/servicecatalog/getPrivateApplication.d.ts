 ...
 * ```
 */
export declare function getPrivateApplication(args: GetPrivateApplicationArgs, opts?: pulumi.InvokeOptions): Promise<GetPrivateApplicationResult>;
/**
 ...
 * ```
 */
export declare function getPrivateApplicationOutput(args: GetPrivateApplicationOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetPrivateApplicationResult>;
/**
 * A collection of arguments for invoking getPrivateApplication.
 */

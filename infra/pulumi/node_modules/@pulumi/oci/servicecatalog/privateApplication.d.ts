 ...
 * ```
 */
export declare class PrivateApplication extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: PrivateApplicationState, opts?: pulumi.CustomResourceOptions): PrivateApplication;
    /**
     * Returns true if the given object is an instance of PrivateApplication.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is PrivateApplication;
    /**
     ...
     */
    readonly logoFileBase64encoded: pulumi.Output<string>;
    /**
     * The model for uploaded binary data, like logos and images.
     */
    readonly logos: pulumi.Output<outputs.ServiceCatalog.PrivateApplicationLogo[]>;
    /**
     * (Updatable) A long description of the private application.
     */
    readonly longDescription: pulumi.Output<string>;
    /**
     * A base object for creating a private application package.
     */
    readonly packageDetails: pulumi.Output<outputs.ServiceCatalog.PrivateApplicationPackageDetails>;
    /**

 ...
 * ```
 */
export declare class SecurityZone extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: SecurityZoneState, opts?: pulumi.CustomResourceOptions): SecurityZone;
    /**
     * Returns true if the given object is an instance of SecurityZone.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is SecurityZone;
    /**
     ...
     */
    readonly securityZoneRecipeId: pulumi.Output<string>;
    /**
     * The OCID of the target associated with the security zone
     */
    readonly securityZoneTargetId: pulumi.Output<string>;
    /**

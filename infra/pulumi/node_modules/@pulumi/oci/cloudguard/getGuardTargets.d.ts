 ...
 * ```
 */
export declare function getGuardTargets(args: GetGuardTargetsArgs, opts?: pulumi.InvokeOptions): Promise<GetGuardTargetsResult>;
/**
 ...
 * ```
 */
export declare function getGuardTargetsOutput(args: GetGuardTargetsOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetGuardTargetsResult>;
/**
 * A collection of arguments for invoking getGuardTargets.
 */

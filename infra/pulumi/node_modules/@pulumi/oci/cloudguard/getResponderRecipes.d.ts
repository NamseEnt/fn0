 ...
 * ```
 */
export declare function getResponderRecipes(args: GetResponderRecipesArgs, opts?: pulumi.InvokeOptions): Promise<GetResponderRecipesResult>;
/**
 ...
 * ```
 */
export declare function getResponderRecipesOutput(args: GetResponderRecipesOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetResponderRecipesResult>;
/**
 * A collection of arguments for invoking getResponderRecipes.
 */

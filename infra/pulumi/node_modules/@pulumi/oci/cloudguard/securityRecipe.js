 ...
 * ```
 */
class SecurityRecipe extends pulumi.CustomResource {
    /**
    ...
    static get(name, id, state, opts) {
        return new SecurityRecipe(name, state, { ...opts, id: id });
    }
    /**
...
exports.SecurityRecipe = SecurityRecipe;
/** @internal */
SecurityRecipe.__pulumiType = 'oci:CloudGuard/securityRecipe:SecurityRecipe';
//# sourceMappingURL=securityRecipe.js.map
...
exports.getDetectorRecipesOutput = exports.getDetectorRecipes = void 0;
 ...
 * ```
 */
function getDetectorRecipes(args, opts) {
...
exports.getDetectorRecipes = getDetectorRecipes;
/**
 * This data source provides the list of Detector Recipes in Oracle Cloud Infrastructure Cloud Guard service.
 *
 * Returns a list of all detector recipes (DetectorRecipe resources) in a compartment, identified by compartmentId.
 ...
 * ```
 */
function getDetectorRecipesOutput(args, opts) {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
...
exports.getDetectorRecipesOutput = getDetectorRecipesOutput;
//# sourceMappingURL=getDetectorRecipes.js.map
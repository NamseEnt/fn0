 ...
 * ```
 */
export declare function getManagedList(args: GetManagedListArgs, opts?: pulumi.InvokeOptions): Promise<GetManagedListResult>;
/**
 ...
 * ```
 */
export declare function getManagedListOutput(args: GetManagedListOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetManagedListResult>;
/**
 * A collection of arguments for invoking getManagedList.
 */

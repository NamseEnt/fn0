 ...
 * ```
 */
export declare function getCloudGuardConfiguration(args: GetCloudGuardConfigurationArgs, opts?: pulumi.InvokeOptions): Promise<GetCloudGuardConfigurationResult>;
/**
 ...
 * ```
 */
export declare function getCloudGuardConfigurationOutput(args: GetCloudGuardConfigurationOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetCloudGuardConfigurationResult>;
/**
 * A collection of arguments for invoking getCloudGuardConfiguration.
 */

 ...
 * ```
 */
export declare function getDataMaskRules(args: GetDataMaskRulesArgs, opts?: pulumi.InvokeOptions): Promise<GetDataMaskRulesResult>;
/**
 ...
 * ```
 */
export declare function getDataMaskRulesOutput(args: GetDataMaskRulesOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetDataMaskRulesResult>;
/**
 * A collection of arguments for invoking getDataMaskRules.
 */

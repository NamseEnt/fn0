 ...
 * ```
 */
export declare function getSecurityRecipe(args: GetSecurityRecipeArgs, opts?: pulumi.InvokeOptions): Promise<GetSecurityRecipeResult>;
/**
 ...
 * ```
 */
export declare function getSecurityRecipeOutput(args: GetSecurityRecipeOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetSecurityRecipeResult>;
/**
 * A collection of arguments for invoking getSecurityRecipe.
 */

...
exports.getResponderRecipesOutput = exports.getResponderRecipes = void 0;
 ...
 * ```
 */
function getResponderRecipes(args, opts) {
...
exports.getResponderRecipes = getResponderRecipes;
/**
 * This data source provides the list of Responder Recipes in Oracle Cloud Infrastructure Cloud Guard service.
 *
 * Returns a list (ResponderRecipeCollection resource, with a page of ResponderRecipeSummary resources)
 ...
 * ```
 */
function getResponderRecipesOutput(args, opts) {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
...
exports.getResponderRecipesOutput = getResponderRecipesOutput;
//# sourceMappingURL=getResponderRecipes.js.map
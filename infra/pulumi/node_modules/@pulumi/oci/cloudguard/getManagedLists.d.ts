 ...
 * ```
 */
export declare function getManagedLists(args: GetManagedListsArgs, opts?: pulumi.InvokeOptions): Promise<GetManagedListsResult>;
/**
 ...
 * ```
 */
export declare function getManagedListsOutput(args: GetManagedListsOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetManagedListsResult>;
/**
 * A collection of arguments for invoking getManagedLists.
 */

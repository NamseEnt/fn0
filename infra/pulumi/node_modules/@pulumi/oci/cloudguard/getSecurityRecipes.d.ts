 ...
 * ```
 */
export declare function getSecurityRecipes(args: GetSecurityRecipesArgs, opts?: pulumi.InvokeOptions): Promise<GetSecurityRecipesResult>;
/**
 ...
 * ```
 */
export declare function getSecurityRecipesOutput(args: GetSecurityRecipesOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetSecurityRecipesResult>;
/**
 * A collection of arguments for invoking getSecurityRecipes.
 */

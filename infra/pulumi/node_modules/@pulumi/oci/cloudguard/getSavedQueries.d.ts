 ...
 * ```
 */
export declare function getSavedQueries(args: GetSavedQueriesArgs, opts?: pulumi.InvokeOptions): Promise<GetSavedQueriesResult>;
/**
 ...
 * ```
 */
export declare function getSavedQueriesOutput(args: GetSavedQueriesOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetSavedQueriesResult>;
/**
 * A collection of arguments for invoking getSavedQueries.
 */

 ...
 * ```
 */
export declare function getSavedQuery(args: GetSavedQueryArgs, opts?: pulumi.InvokeOptions): Promise<GetSavedQueryResult>;
/**
 ...
 * ```
 */
export declare function getSavedQueryOutput(args: GetSavedQueryOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetSavedQueryResult>;
/**
 * A collection of arguments for invoking getSavedQuery.
 */

 ...
 * ```
 */
export declare function getAdhocQueries(args: GetAdhocQueriesArgs, opts?: pulumi.InvokeOptions): Promise<GetAdhocQueriesResult>;
/**
 ...
 * ```
 */
export declare function getAdhocQueriesOutput(args: GetAdhocQueriesOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetAdhocQueriesResult>;
/**
 * A collection of arguments for invoking getAdhocQueries.
 */

 ...
 * ```
 */
export declare class WlpAgent extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: WlpAgentState, opts?: pulumi.CustomResourceOptions): WlpAgent;
    /**
     * Returns true if the given object is an instance of WlpAgent.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is WlpAgent;
    /**
     ...
     */
    readonly certificateSignedRequest: pulumi.Output<string>;
    /**
     ...
     */
    readonly osInfo: pulumi.Output<string>;
    /**

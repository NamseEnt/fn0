 ...
 * ```
 */
export declare function getDetectorRecipe(args: GetDetectorRecipeArgs, opts?: pulumi.InvokeOptions): Promise<GetDetectorRecipeResult>;
/**
 ...
 * ```
 */
export declare function getDetectorRecipeOutput(args: GetDetectorRecipeOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetDetectorRecipeResult>;
/**
 * A collection of arguments for invoking getDetectorRecipe.
 */

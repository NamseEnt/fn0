 ...
 * ```
 */
export declare function getResponderRecipe(args: GetResponderRecipeArgs, opts?: pulumi.InvokeOptions): Promise<GetResponderRecipeResult>;
/**
 ...
 * ```
 */
export declare function getResponderRecipeOutput(args: GetResponderRecipeOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetResponderRecipeResult>;
/**
 * A collection of arguments for invoking getResponderRecipe.
 */

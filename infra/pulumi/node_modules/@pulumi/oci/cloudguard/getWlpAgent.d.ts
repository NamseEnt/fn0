 ...
 * ```
 */
export declare function getWlpAgent(args: GetWlpAgentArgs, opts?: pulumi.InvokeOptions): Promise<GetWlpAgentResult>;
/**
 ...
 * ```
 */
export declare function getWlpAgentOutput(args: GetWlpAgentOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetWlpAgentResult>;
/**
 * A collection of arguments for invoking getWlpAgent.
 */

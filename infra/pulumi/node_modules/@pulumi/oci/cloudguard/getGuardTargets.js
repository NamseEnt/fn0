...
exports.getGuardTargetsOutput = exports.getGuardTargets = void 0;
 ...
 * ```
 */
function getGuardTargets(args, opts) {
...
exports.getGuardTargets = getGuardTargets;
/**
 * This data source provides the list of Targets in Oracle Cloud Infrastructure Cloud Guard service.
 *
 * Returns a list of targets (TargetCollection resource with page of TargetSummary
 ...
 * ```
 */
function getGuardTargetsOutput(args, opts) {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
...
exports.getGuardTargetsOutput = getGuardTargetsOutput;
//# sourceMappingURL=getGuardTargets.js.map
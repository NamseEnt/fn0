...
export declare class LoadBalancer extends pulumi.CustomResource {
     ...
     */
    readonly ipAddressDetails: pulumi.Output<outputs.LoadBalancer.LoadBalancerIpAddressDetail[]>;
    /**
     ...
     */
    readonly ipv6subnetCidr: pulumi.Output<string>;
    /**
     ...
     */
    readonly isDeleteProtectionEnabled: pulumi.Output<boolean>;
    /**
     ...
     * Example: `true`
     */
    readonly isRequestIdEnabled: pulumi.Output<boolean>;
    /**
     ...
     */
    readonly requestIdHeader: pulumi.Output<string>;
    /**
     ...
     */
    readonly reservedIps: pulumi.Output<outputs.LoadBalancer.LoadBalancerReservedIp[] | undefined>;
    /**
     ...
     */
    readonly shapeDetails: pulumi.Output<outputs.LoadBalancer.LoadBalancerShapeDetails>;
    /**

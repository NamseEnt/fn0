 ...
 * ```
 */
export declare class PathRouteSet extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: PathRouteSetState, opts?: pulumi.CustomResourceOptions): PathRouteSet;
    /**
     * Returns true if the given object is an instance of PathRouteSet.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is PathRouteSet;
    /**
     ...
     */
    readonly pathRoutes: pulumi.Output<outputs.LoadBalancer.PathRouteSetPathRoute[]>;

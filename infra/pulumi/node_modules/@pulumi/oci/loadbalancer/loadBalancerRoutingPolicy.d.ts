 ...
 * ```
 */
export declare class LoadBalancerRoutingPolicy extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: LoadBalancerRoutingPolicyState, opts?: pulumi.CustomResourceOptions): LoadBalancerRoutingPolicy;
    /**
     ...
     */
    static isInstance(obj: any): obj is LoadBalancerRoutingPolicy;
    /**
     * (Updatable) The version of the language in which `condition` of `rules` are composed.
     */
    readonly conditionLanguageVersion: pulumi.Output<string>;
    /**
     ...
     */
    readonly rules: pulumi.Output<outputs.LoadBalancer.LoadBalancerRoutingPolicyRule[]>;

 ...
 * ```
 */
export declare function getLoadBalancerRoutingPolicies(args: GetLoadBalancerRoutingPoliciesArgs, opts?: pulumi.InvokeOptions): Promise<GetLoadBalancerRoutingPoliciesResult>;
/**
 ...
 * ```
 */
export declare function getLoadBalancerRoutingPoliciesOutput(args: GetLoadBalancerRoutingPoliciesOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetLoadBalancerRoutingPoliciesResult>;
/**
 * A collection of arguments for invoking getLoadBalancerRoutingPolicies.
 */

 ...
 * ```
 */
export declare class SslCipherSuite extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: SslCipherSuiteState, opts?: pulumi.CustomResourceOptions): SslCipherSuite;
    /**
     * Returns true if the given object is an instance of SslCipherSuite.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is SslCipherSuite;

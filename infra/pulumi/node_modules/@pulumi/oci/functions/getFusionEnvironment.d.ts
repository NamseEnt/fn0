 ...
 * ```
 */
export declare function getFusionEnvironment(args: GetFusionEnvironmentArgs, opts?: pulumi.InvokeOptions): Promise<GetFusionEnvironmentResult>;
/**
 ...
 * ```
 */
export declare function getFusionEnvironmentOutput(args: GetFusionEnvironmentOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetFusionEnvironmentResult>;
/**
 * A collection of arguments for invoking getFusionEnvironment.
 */

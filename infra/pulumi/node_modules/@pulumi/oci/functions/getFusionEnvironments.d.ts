 ...
 * ```
 */
export declare function getFusionEnvironmentsOutput(args: GetFusionEnvironmentsOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetFusionEnvironmentsResult>;
/**
 * A collection of arguments for invoking getFusionEnvironments.
 */

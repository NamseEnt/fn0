 ...
 * ```
 */
export declare function getPbfListingVersion(args: GetPbfListingVersionArgs, opts?: pulumi.InvokeOptions): Promise<GetPbfListingVersionResult>;
/**
 ...
 * ```
 */
export declare function getPbfListingVersionOutput(args: GetPbfListingVersionOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetPbfListingVersionResult>;
/**
 * A collection of arguments for invoking getPbfListingVersion.
 */

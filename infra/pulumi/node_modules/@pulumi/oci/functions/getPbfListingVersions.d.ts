 ...
 * ```
 */
export declare function getPbfListingVersions(args: GetPbfListingVersionsArgs, opts?: pulumi.InvokeOptions): Promise<GetPbfListingVersionsResult>;
/**
 ...
 * ```
 */
export declare function getPbfListingVersionsOutput(args: GetPbfListingVersionsOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetPbfListingVersionsResult>;
/**
 * A collection of arguments for invoking getPbfListingVersions.
 */

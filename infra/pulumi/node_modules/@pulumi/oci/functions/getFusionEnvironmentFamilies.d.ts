 ...
 * ```
 */
export declare function getFusionEnvironmentFamiliesOutput(args: GetFusionEnvironmentFamiliesOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetFusionEnvironmentFamiliesResult>;
/**
 * A collection of arguments for invoking getFusionEnvironmentFamilies.
 */

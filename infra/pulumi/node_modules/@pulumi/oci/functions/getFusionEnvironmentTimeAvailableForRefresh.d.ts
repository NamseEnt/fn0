 ...
 * ```
 */
export declare function getFusionEnvironmentTimeAvailableForRefreshOutput(args: GetFusionEnvironmentTimeAvailableForRefreshOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetFusionEnvironmentTimeAvailableForRefreshResult>;
/**
 * A collection of arguments for invoking getFusionEnvironmentTimeAvailableForRefresh.
 */

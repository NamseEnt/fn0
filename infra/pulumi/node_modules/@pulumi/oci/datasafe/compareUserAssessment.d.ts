 ...
 * ```
 */
export declare class CompareUserAssessment extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: CompareUserAssessmentState, opts?: pulumi.CustomResourceOptions): CompareUserAssessment;
    /**
     * Returns true if the given object is an instance of CompareUserAssessment.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is CompareUserAssessment;
    /**
     ...
     */
    readonly comparisonUserAssessmentId: pulumi.Output<string>;
    /**

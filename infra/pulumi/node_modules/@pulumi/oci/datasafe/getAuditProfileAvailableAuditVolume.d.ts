 ...
 * ```
 */
export declare function getAuditProfileAvailableAuditVolume(args: GetAuditProfileAvailableAuditVolumeArgs, opts?: pulumi.InvokeOptions): Promise<GetAuditProfileAvailableAuditVolumeResult>;
/**
 ...
 * ```
 */
export declare function getAuditProfileAvailableAuditVolumeOutput(args: GetAuditProfileAvailableAuditVolumeOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetAuditProfileAvailableAuditVolumeResult>;
/**
 * A collection of arguments for invoking getAuditProfileAvailableAuditVolume.
 */

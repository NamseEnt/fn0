 ...
 * ```
 */
export declare function getAuditProfileCollectedAuditVolume(args: GetAuditProfileCollectedAuditVolumeArgs, opts?: pulumi.InvokeOptions): Promise<GetAuditProfileCollectedAuditVolumeResult>;
/**
 ...
 * ```
 */
export declare function getAuditProfileCollectedAuditVolumeOutput(args: GetAuditProfileCollectedAuditVolumeOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetAuditProfileCollectedAuditVolumeResult>;
/**
 * A collection of arguments for invoking getAuditProfileCollectedAuditVolume.
 */

 ...
 * ```
 */
export declare function getAuditProfileAnalytic(args: GetAuditProfileAnalyticArgs, opts?: pulumi.InvokeOptions): Promise<GetAuditProfileAnalyticResult>;
/**
 ...
 * ```
 */
export declare function getAuditProfileAnalyticOutput(args: GetAuditProfileAnalyticOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetAuditProfileAnalyticResult>;
/**
 * A collection of arguments for invoking getAuditProfileAnalytic.
 */

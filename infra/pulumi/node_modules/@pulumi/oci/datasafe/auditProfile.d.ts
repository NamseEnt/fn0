 ...
 * ```
 */
export declare class AuditProfile extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: AuditProfileState, opts?: pulumi.CustomResourceOptions): AuditProfile;
    /**

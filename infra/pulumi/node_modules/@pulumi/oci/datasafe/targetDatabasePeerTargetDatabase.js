...
exports.TargetDatabasePeerTargetDatabase = void 0;
 ...
 * ```
 */
class TargetDatabasePeerTargetDatabase extends pulumi.CustomResource {
    /**
    ...
    static get(name, id, state, opts) {
        return new TargetDatabasePeerTargetDatabase(name, state, { ...opts, id: id });
    }
    /**
...
exports.TargetDatabasePeerTargetDatabase = TargetDatabasePeerTargetDatabase;
/** @internal */
TargetDatabasePeerTargetDatabase.__pulumiType = 'oci:DataSafe/targetDatabasePeerTargetDatabase:TargetDatabasePeerTargetDatabase';
//# sourceMappingURL=targetDatabasePeerTargetDatabase.js.map
 ...
 * ```
 */
export declare function getMaskingPoliciesMaskingColumns(args: GetMaskingPoliciesMaskingColumnsArgs, opts?: pulumi.InvokeOptions): Promise<GetMaskingPoliciesMaskingColumnsResult>;
/**
 ...
 * ```
 */
export declare function getMaskingPoliciesMaskingColumnsOutput(args: GetMaskingPoliciesMaskingColumnsOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetMaskingPoliciesMaskingColumnsResult>;
/**
 * A collection of arguments for invoking getMaskingPoliciesMaskingColumns.
 */

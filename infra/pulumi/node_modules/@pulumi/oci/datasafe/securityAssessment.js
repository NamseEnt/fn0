 ...
 * ```
 */
class SecurityAssessment extends pulumi.CustomResource {
    /**
    ...
    static get(name, id, state, opts) {
        return new SecurityAssessment(name, state, { ...opts, id: id });
    }
    /**
...
exports.SecurityAssessment = SecurityAssessment;
/** @internal */
SecurityAssessment.__pulumiType = 'oci:DataSafe/securityAssessment:SecurityAssessment';

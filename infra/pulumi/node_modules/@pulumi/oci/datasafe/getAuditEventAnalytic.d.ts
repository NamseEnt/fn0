 ...
 * ```
 */
export declare function getAuditEventAnalytic(args: GetAuditEventAnalyticArgs, opts?: pulumi.InvokeOptions): Promise<GetAuditEventAnalyticResult>;
/**
 ...
 * ```
 */
export declare function getAuditEventAnalyticOutput(args: GetAuditEventAnalyticOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetAuditEventAnalyticResult>;
/**
 * A collection of arguments for invoking getAuditEventAnalytic.
 */

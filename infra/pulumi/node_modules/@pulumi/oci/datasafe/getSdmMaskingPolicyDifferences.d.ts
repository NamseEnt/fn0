 ...
 * ```
 */
export declare function getSdmMaskingPolicyDifferences(args: GetSdmMaskingPolicyDifferencesArgs, opts?: pulumi.InvokeOptions): Promise<GetSdmMaskingPolicyDifferencesResult>;
/**
 ...
 * ```
 */
export declare function getSdmMaskingPolicyDifferencesOutput(args: GetSdmMaskingPolicyDifferencesOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetSdmMaskingPolicyDifferencesResult>;
/**
 * A collection of arguments for invoking getSdmMaskingPolicyDifferences.
 */

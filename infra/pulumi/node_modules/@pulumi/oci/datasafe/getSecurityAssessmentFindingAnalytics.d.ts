 ...
 * ```
 */
export declare function getSecurityAssessmentFindingAnalytics(args: GetSecurityAssessmentFindingAnalyticsArgs, opts?: pulumi.InvokeOptions): Promise<GetSecurityAssessmentFindingAnalyticsResult>;
/**
 ...
 * ```
 */
export declare function getSecurityAssessmentFindingAnalyticsOutput(args: GetSecurityAssessmentFindingAnalyticsOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetSecurityAssessmentFindingAnalyticsResult>;
/**
 * A collection of arguments for invoking getSecurityAssessmentFindingAnalytics.
 */

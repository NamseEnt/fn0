 ...
 * ```
 */
export declare function getSdmMaskingPolicyDifference(args: GetSdmMaskingPolicyDifferenceArgs, opts?: pulumi.InvokeOptions): Promise<GetSdmMaskingPolicyDifferenceResult>;
/**
 ...
 * ```
 */
export declare function getSdmMaskingPolicyDifferenceOutput(args: GetSdmMaskingPolicyDifferenceOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetSdmMaskingPolicyDifferenceResult>;
/**
 * A collection of arguments for invoking getSdmMaskingPolicyDifference.
 */

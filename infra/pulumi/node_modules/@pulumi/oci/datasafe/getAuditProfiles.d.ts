 ...
 * ```
 */
export declare function getAuditProfiles(args: GetAuditProfilesArgs, opts?: pulumi.InvokeOptions): Promise<GetAuditProfilesResult>;
/**
 ...
 * ```
 */
export declare function getAuditProfilesOutput(args: GetAuditProfilesOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetAuditProfilesResult>;
/**
 * A collection of arguments for invoking getAuditProfiles.
 */

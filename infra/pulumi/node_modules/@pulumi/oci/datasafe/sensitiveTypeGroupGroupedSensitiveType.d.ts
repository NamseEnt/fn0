 ...
 * ```
 */
export declare class SensitiveTypeGroupGroupedSensitiveType extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: SensitiveTypeGroupGroupedSensitiveTypeState, opts?: pulumi.CustomResourceOptions): SensitiveTypeGroupGroupedSensitiveType;
    /**
     ...
     */
    static isInstance(obj: any): obj is SensitiveTypeGroupGroupedSensitiveType;
    /**
     * List of sensitive type id summary objects present in the sensitive type group.
     */
    readonly items: pulumi.Output<outputs.DataSafe.SensitiveTypeGroupGroupedSensitiveTypeItem[]>;
    /**
     * (Updatable)
     */
    readonly patchOperations: pulumi.Output<outputs.DataSafe.SensitiveTypeGroupGroupedSensitiveTypePatchOperation[] | undefined>;
    /**
     * ** IMPORTANT **
     * Any change to a property that does not support update will force the destruction and recreation of the resource with the new property values
     */
    readonly sensitiveTypeGroupId: pulumi.Output<string>;
    /**

 ...
 * ```
 */
export declare function getSensitiveTypesExport(args: GetSensitiveTypesExportArgs, opts?: pulumi.InvokeOptions): Promise<GetSensitiveTypesExportResult>;
/**
 ...
 * ```
 */
export declare function getSensitiveTypesExportOutput(args: GetSensitiveTypesExportOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetSensitiveTypesExportResult>;
/**
 * A collection of arguments for invoking getSensitiveTypesExport.
 */

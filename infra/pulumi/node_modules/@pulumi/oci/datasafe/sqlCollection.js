 ...
 * ```
 */
class SqlCollection extends pulumi.CustomResource {
    /**
    ...
    static get(name, id, state, opts) {
        return new SqlCollection(name, state, { ...opts, id: id });
    }
    /**
...
/** @internal */
SqlCollection.__pulumiType = 'oci:DataSafe/sqlCollection:SqlCollection';
//# sourceMappingURL=sqlCollection.js.map
 ...
 * ```
 */
export declare function getAuditTrailAnalytic(args: GetAuditTrailAnalyticArgs, opts?: pulumi.InvokeOptions): Promise<GetAuditTrailAnalyticResult>;
/**
 ...
 * ```
 */
export declare function getAuditTrailAnalyticOutput(args: GetAuditTrailAnalyticOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetAuditTrailAnalyticResult>;
/**
 * A collection of arguments for invoking getAuditTrailAnalytic.
 */

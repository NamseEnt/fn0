 ...
 * ```
 */
export declare function getSecurityAssessmentSecurityFeatures(args: GetSecurityAssessmentSecurityFeaturesArgs, opts?: pulumi.InvokeOptions): Promise<GetSecurityAssessmentSecurityFeaturesResult>;
/**
 ...
 * ```
 */
export declare function getSecurityAssessmentSecurityFeaturesOutput(args: GetSecurityAssessmentSecurityFeaturesOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetSecurityAssessmentSecurityFeaturesResult>;
/**
 * A collection of arguments for invoking getSecurityAssessmentSecurityFeatures.
 */

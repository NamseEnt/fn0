 ...
 */
export declare class DatabaseSecurityConfigManagement extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: DatabaseSecurityConfigManagementState, opts?: pulumi.CustomResourceOptions): DatabaseSecurityConfigManagement;
    /**
     ...
     */
    static isInstance(obj: any): obj is DatabaseSecurityConfigManagement;
    /**
     ...
     */
    readonly refreshTrigger: pulumi.Output<boolean | undefined>;
    /**
     * (Updatable) Details to update the SQL firewall config.
     */
    readonly sqlFirewallConfig: pulumi.Output<outputs.DataSafe.DatabaseSecurityConfigManagementSqlFirewallConfig>;
    /**
     ...
     */
    readonly timeLastRefreshed: pulumi.Output<string>;
    /**

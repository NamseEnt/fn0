...
exports.AddSdmColumns = void 0;
const pulumi = require("@pulumi/pulumi");
const utilities = require("../utilities");
class AddSdmColumns extends pulumi.CustomResource {
    /**
    ...
    static get(name, id, state, opts) {
        return new AddSdmColumns(name, state, { ...opts, id: id });
    }
    /**
...
exports.AddSdmColumns = AddSdmColumns;
/** @internal */
AddSdmColumns.__pulumiType = 'oci:DataSafe/addSdmColumns:AddSdmColumns';
//# sourceMappingURL=addSdmColumns.js.map
 ...
 * ```
 */
export declare function getSensitiveTypeGroups(args: GetSensitiveTypeGroupsArgs, opts?: pulumi.InvokeOptions): Promise<GetSensitiveTypeGroupsResult>;
/**
 ...
 * ```
 */
export declare function getSensitiveTypeGroupsOutput(args: GetSensitiveTypeGroupsOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetSensitiveTypeGroupsResult>;
/**
 * A collection of arguments for invoking getSensitiveTypeGroups.
 */

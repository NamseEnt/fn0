 ...
 * ```
 */
export declare function getMaskingPolicyHealthReports(args: GetMaskingPolicyHealthReportsArgs, opts?: pulumi.InvokeOptions): Promise<GetMaskingPolicyHealthReportsResult>;
/**
 ...
 * ```
 */
export declare function getMaskingPolicyHealthReportsOutput(args: GetMaskingPolicyHealthReportsOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetMaskingPolicyHealthReportsResult>;
/**
 * A collection of arguments for invoking getMaskingPolicyHealthReports.
 */

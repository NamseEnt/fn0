 ...
 * ```
 */
export declare function getAuditPolicies(args: GetAuditPoliciesArgs, opts?: pulumi.InvokeOptions): Promise<GetAuditPoliciesResult>;
/**
 ...
 * ```
 */
export declare function getAuditPoliciesOutput(args: GetAuditPoliciesOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetAuditPoliciesResult>;
/**
 * A collection of arguments for invoking getAuditPolicies.
 */

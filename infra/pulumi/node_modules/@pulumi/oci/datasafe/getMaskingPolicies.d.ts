 ...
 * ```
 */
export declare function getMaskingPoliciesOutput(args: GetMaskingPoliciesOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetMaskingPoliciesResult>;
/**
 * A collection of arguments for invoking getMaskingPolicies.
 */

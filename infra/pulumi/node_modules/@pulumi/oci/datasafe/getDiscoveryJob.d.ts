 ...
 * ```
 */
export declare function getDiscoveryJob(args: GetDiscoveryJobArgs, opts?: pulumi.InvokeOptions): Promise<GetDiscoveryJobResult>;
/**
 ...
 * ```
 */
export declare function getDiscoveryJobOutput(args: GetDiscoveryJobOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetDiscoveryJobResult>;
/**
 * A collection of arguments for invoking getDiscoveryJob.
 */

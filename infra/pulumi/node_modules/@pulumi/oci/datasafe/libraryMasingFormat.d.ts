 ...
 * ```
 */
export declare class LibraryMasingFormat extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: LibraryMasingFormatState, opts?: pulumi.CustomResourceOptions): LibraryMasingFormat;
    /**
     * Returns true if the given object is an instance of LibraryMasingFormat.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is LibraryMasingFormat;
    /**
     ...
     */
    readonly formatEntries: pulumi.Output<outputs.DataSafe.LibraryMasingFormatFormatEntry[]>;
    /**
     ...
     */
    readonly sensitiveTypeIds: pulumi.Output<string[]>;
    /**

 ...
 * ```
 */
export declare class SensitiveDataModelsSensitiveColumn extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: SensitiveDataModelsSensitiveColumnState, opts?: pulumi.CustomResourceOptions): SensitiveDataModelsSensitiveColumn;
    /**
     ...
     */
    static isInstance(obj: any): obj is SensitiveDataModelsSensitiveColumn;
    /**
     ...
     */
    readonly columnGroups: pulumi.Output<string[]>;
    /**

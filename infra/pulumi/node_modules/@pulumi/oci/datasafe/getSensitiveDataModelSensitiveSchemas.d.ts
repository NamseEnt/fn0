 ...
 * ```
 */
export declare function getSensitiveDataModelSensitiveSchemas(args: GetSensitiveDataModelSensitiveSchemasArgs, opts?: pulumi.InvokeOptions): Promise<GetSensitiveDataModelSensitiveSchemasResult>;
/**
 ...
 * ```
 */
export declare function getSensitiveDataModelSensitiveSchemasOutput(args: GetSensitiveDataModelSensitiveSchemasOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetSensitiveDataModelSensitiveSchemasResult>;
/**
 * A collection of arguments for invoking getSensitiveDataModelSensitiveSchemas.
 */

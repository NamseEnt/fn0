 ...
 * ```
 */
export declare function getSensitiveTypeGroup(args: GetSensitiveTypeGroupArgs, opts?: pulumi.InvokeOptions): Promise<GetSensitiveTypeGroupResult>;
/**
 ...
 * ```
 */
export declare function getSensitiveTypeGroupOutput(args: GetSensitiveTypeGroupOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetSensitiveTypeGroupResult>;
/**
 * A collection of arguments for invoking getSensitiveTypeGroup.
 */

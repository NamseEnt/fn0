 ...
 * ```
 */
export declare class AuditArchiveRetrieval extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: AuditArchiveRetrievalState, opts?: pulumi.CustomResourceOptions): AuditArchiveRetrieval;
    /**
     * Returns true if the given object is an instance of AuditArchiveRetrieval.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is AuditArchiveRetrieval;
    /**
     * Total count of audit events to be retrieved from the archive for the specified date range.
     */
    readonly auditEventCount: pulumi.Output<string>;
    /**
     ...
     */
    readonly errorInfo: pulumi.Output<string>;
    /**
     ...
     */
    readonly timeCompleted: pulumi.Output<string>;
    /**
     * The date time when retrieved archive data will be deleted from Data Safe and unloaded back into archival.
     */
    readonly timeOfExpiry: pulumi.Output<string>;
    /**
     * The date time when archive retrieval was requested, in the format defined by RFC3339.
     */
    readonly timeRequested: pulumi.Output<string>;
    /**

 ...
 * ```
 */
export declare function getMaskingReportsMaskedColumn(args: GetMaskingReportsMaskedColumnArgs, opts?: pulumi.InvokeOptions): Promise<GetMaskingReportsMaskedColumnResult>;
/**
 ...
 * ```
 */
export declare function getMaskingReportsMaskedColumnOutput(args: GetMaskingReportsMaskedColumnOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetMaskingReportsMaskedColumnResult>;
/**
 * A collection of arguments for invoking getMaskingReportsMaskedColumn.
 */

 ...
 * ```
 */
export declare function getTargetDatabasesSchemas(args: GetTargetDatabasesSchemasArgs, opts?: pulumi.InvokeOptions): Promise<GetTargetDatabasesSchemasResult>;
/**
 ...
 * ```
 */
export declare function getTargetDatabasesSchemasOutput(args: GetTargetDatabasesSchemasOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetTargetDatabasesSchemasResult>;
/**
 * A collection of arguments for invoking getTargetDatabasesSchemas.
 */

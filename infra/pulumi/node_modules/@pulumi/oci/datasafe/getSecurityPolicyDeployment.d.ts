 ...
 * ```
 */
export declare function getSecurityPolicyDeploymentOutput(args: GetSecurityPolicyDeploymentOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetSecurityPolicyDeploymentResult>;
/**
 * A collection of arguments for invoking getSecurityPolicyDeployment.
 */

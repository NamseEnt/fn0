 ...
 * ```
 */
class SqlFirewallPolicy extends pulumi.CustomResource {
    /**
    ...
    static get(name, id, state, opts) {
        return new SqlFirewallPolicy(name, state, { ...opts, id: id });
    }
    /**
...
exports.SqlFirewallPolicy = SqlFirewallPolicy;
/** @internal */
SqlFirewallPolicy.__pulumiType = 'oci:DataSafe/sqlFirewallPolicy:SqlFirewallPolicy';
//# sourceMappingURL=sqlFirewallPolicy.js.map
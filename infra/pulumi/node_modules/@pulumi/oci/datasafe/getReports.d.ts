 ...
 * ```
 */
export declare function getReports(args: GetReportsArgs, opts?: pulumi.InvokeOptions): Promise<GetReportsResult>;
/**
 ...
 * ```
 */
export declare function getReportsOutput(args: GetReportsOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetReportsResult>;
/**
 * A collection of arguments for invoking getReports.
 */

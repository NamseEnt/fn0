 ...
 * ```
 */
export declare class AuditPolicy extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: AuditPolicyState, opts?: pulumi.CustomResourceOptions): AuditPolicy;
    /**
     * Returns true if the given object is an instance of AuditPolicy.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is AuditPolicy;
    /**
     * Lists the audit policy provisioning conditions for the target database.
     */
    readonly auditConditions: pulumi.Output<outputs.DataSafe.AuditPolicyAuditCondition[]>;
    /**
     * Unique audit policy identifier.
     */
    readonly auditPolicyId: pulumi.Output<string>;
    /**
     ...
     */
    readonly auditSpecifications: pulumi.Output<outputs.DataSafe.AuditPolicyAuditSpecification[]>;
    /**
     ...
     */
    readonly provisionTrigger: pulumi.Output<number | undefined>;
    /**
     ...
     */
    readonly retrieveFromTargetTrigger: pulumi.Output<number | undefined>;
    /**

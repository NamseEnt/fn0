...
export declare class Alert extends pulumi.CustomResource {
     ...
     * The OCID of alert.
     */
    readonly alertId: pulumi.Output<string>;
    /**
     * The key of the rule of alert policy that triggered alert.
     */
    readonly alertPolicyRuleKey: pulumi.Output<string>;
    /**
     * The display name of the rule of alert policy that triggered alert.
     */
    readonly alertPolicyRuleName: pulumi.Output<string>;
    /**
     ...
     */
    readonly featureDetails: pulumi.Output<{
        [key: string]: string;
    }>;
    /**
     ...
     */
    readonly operationTime: pulumi.Output<string>;
    /**
     ...
     */
    readonly targetNames: pulumi.Output<string[]>;
    /**

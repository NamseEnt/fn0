 ...
 * ```
 */
export declare function getSecurityPolicyReportRoleGrantPaths(args: GetSecurityPolicyReportRoleGrantPathsArgs, opts?: pulumi.InvokeOptions): Promise<GetSecurityPolicyReportRoleGrantPathsResult>;
/**
 ...
 * ```
 */
export declare function getSecurityPolicyReportRoleGrantPathsOutput(args: GetSecurityPolicyReportRoleGrantPathsOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetSecurityPolicyReportRoleGrantPathsResult>;
/**
 * A collection of arguments for invoking getSecurityPolicyReportRoleGrantPaths.
 */

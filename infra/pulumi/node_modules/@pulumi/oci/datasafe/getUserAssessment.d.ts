 ...
 * ```
 */
export declare function getUserAssessment(args: GetUserAssessmentArgs, opts?: pulumi.InvokeOptions): Promise<GetUserAssessmentResult>;
/**
 ...
 * ```
 */
export declare function getUserAssessmentOutput(args: GetUserAssessmentOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetUserAssessmentResult>;
/**
 * A collection of arguments for invoking getUserAssessment.
 */

 ...
 * ```
 */
export declare function getUserAssessmentUserAnalytics(args: GetUserAssessmentUserAnalyticsArgs, opts?: pulumi.InvokeOptions): Promise<GetUserAssessmentUserAnalyticsResult>;
/**
 ...
 * ```
 */
export declare function getUserAssessmentUserAnalyticsOutput(args: GetUserAssessmentUserAnalyticsOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetUserAssessmentUserAnalyticsResult>;
/**
 * A collection of arguments for invoking getUserAssessmentUserAnalytics.
 */

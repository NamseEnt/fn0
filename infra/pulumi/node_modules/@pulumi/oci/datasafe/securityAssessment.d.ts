 ...
 * ```
 */
export declare class SecurityAssessment extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: SecurityAssessmentState, opts?: pulumi.CustomResourceOptions): SecurityAssessment;
    /**
     ...
     * List containing maps as values. Example: `{"Operations": [ {"CostCenter": "42"} ] }`
     */
    readonly ignoredTargets: pulumi.Output<string[]>;
    /**
     ...
     */
    readonly scheduleSecurityAssessmentId: pulumi.Output<string>;
    /**
     ...
     */
    readonly statistics: pulumi.Output<outputs.DataSafe.SecurityAssessmentStatistic[]>;
    /**

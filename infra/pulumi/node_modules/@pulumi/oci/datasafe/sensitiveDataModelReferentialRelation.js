...
exports.SensitiveDataModelReferentialRelation = void 0;
 ...
 * ```
 */
class SensitiveDataModelReferentialRelation extends pulumi.CustomResource {
    /**
    ...
    static get(name, id, state, opts) {
        return new SensitiveDataModelReferentialRelation(name, state, { ...opts, id: id });
    }
    /**
...
exports.SensitiveDataModelReferentialRelation = SensitiveDataModelReferentialRelation;
/** @internal */
SensitiveDataModelReferentialRelation.__pulumiType = 'oci:DataSafe/sensitiveDataModelReferentialRelation:SensitiveDataModelReferentialRelation';
//# sourceMappingURL=sensitiveDataModelReferentialRelation.js.map
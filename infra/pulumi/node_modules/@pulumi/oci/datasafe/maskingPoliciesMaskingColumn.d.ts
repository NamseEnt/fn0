 ...
 * ```
 */
export declare class MaskingPoliciesMaskingColumn extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: MaskingPoliciesMaskingColumnState, opts?: pulumi.CustomResourceOptions): MaskingPoliciesMaskingColumn;
    /**
     ...
     */
    static isInstance(obj: any): obj is MaskingPoliciesMaskingColumn;
    /**
     * An array of child columns that are in referential relationship with the masking column.
     */
    readonly childColumns: pulumi.Output<string[]>;
    /**
     ...
     */
    readonly isMaskingEnabled: pulumi.Output<boolean>;
    /**
     ...
     */
    readonly maskingColumnGroup: pulumi.Output<string>;
    /**
     ...
     */
    readonly maskingFormats: pulumi.Output<outputs.DataSafe.MaskingPoliciesMaskingColumnMaskingFormat[]>;
    /**

 ...
 * ```
 */
class UserAssessment extends pulumi.CustomResource {
    /**
    ...
    static get(name, id, state, opts) {
        return new UserAssessment(name, state, { ...opts, id: id });
    }
    /**
...
/** @internal */
UserAssessment.__pulumiType = 'oci:DataSafe/userAssessment:UserAssessment';

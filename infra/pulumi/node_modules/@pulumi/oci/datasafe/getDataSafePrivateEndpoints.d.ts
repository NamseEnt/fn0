 ...
 * ```
 */
export declare function getDataSafePrivateEndpoints(args: GetDataSafePrivateEndpointsArgs, opts?: pulumi.InvokeOptions): Promise<GetDataSafePrivateEndpointsResult>;
/**
 ...
 * ```
 */
export declare function getDataSafePrivateEndpointsOutput(args: GetDataSafePrivateEndpointsOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetDataSafePrivateEndpointsResult>;
/**
 * A collection of arguments for invoking getDataSafePrivateEndpoints.
 */

 ...
 * ```
 */
export declare function getSqlFirewallPolicyOutput(args: GetSqlFirewallPolicyOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetSqlFirewallPolicyResult>;
/**
 * A collection of arguments for invoking getSqlFirewallPolicy.
 */

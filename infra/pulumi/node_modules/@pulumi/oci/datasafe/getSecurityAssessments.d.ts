 ...
 * ```
 */
export declare function getSecurityAssessments(args: GetSecurityAssessmentsArgs, opts?: pulumi.InvokeOptions): Promise<GetSecurityAssessmentsResult>;
/**
 ...
 * ```
 */
export declare function getSecurityAssessmentsOutput(args: GetSecurityAssessmentsOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetSecurityAssessmentsResult>;
/**
 * A collection of arguments for invoking getSecurityAssessments.
 */

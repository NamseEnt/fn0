 ...
 * ```
 */
export declare class OnPremConnector extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: OnPremConnectorState, opts?: pulumi.CustomResourceOptions): OnPremConnector;
    /**
     * Returns true if the given object is an instance of OnPremConnector.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is OnPremConnector;
    /**
     * Latest available version of the on-premises connector.
     */
    readonly availableVersion: pulumi.Output<string>;
    /**
     ...
     */
    readonly createdVersion: pulumi.Output<string>;
    /**

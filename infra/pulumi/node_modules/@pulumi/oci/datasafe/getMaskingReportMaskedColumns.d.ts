 ...
 * ```
 */
export declare function getMaskingReportMaskedColumns(args: GetMaskingReportMaskedColumnsArgs, opts?: pulumi.InvokeOptions): Promise<GetMaskingReportMaskedColumnsResult>;
/**
 ...
 * ```
 */
export declare function getMaskingReportMaskedColumnsOutput(args: GetMaskingReportMaskedColumnsOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetMaskingReportMaskedColumnsResult>;
/**
 * A collection of arguments for invoking getMaskingReportMaskedColumns.
 */

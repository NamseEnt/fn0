 ...
 * ```
 */
export declare function getSensitiveColumnAnalytics(args: GetSensitiveColumnAnalyticsArgs, opts?: pulumi.InvokeOptions): Promise<GetSensitiveColumnAnalyticsResult>;
/**
 ...
 * ```
 */
export declare function getSensitiveColumnAnalyticsOutput(args: GetSensitiveColumnAnalyticsOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetSensitiveColumnAnalyticsResult>;
/**
 * A collection of arguments for invoking getSensitiveColumnAnalytics.
 */

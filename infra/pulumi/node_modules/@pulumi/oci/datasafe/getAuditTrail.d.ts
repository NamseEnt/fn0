 ...
 * ```
 */
export declare function getAuditTrail(args: GetAuditTrailArgs, opts?: pulumi.InvokeOptions): Promise<GetAuditTrailResult>;
/**
 ...
 * ```
 */
export declare function getAuditTrailOutput(args: GetAuditTrailOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetAuditTrailResult>;
/**
 * A collection of arguments for invoking getAuditTrail.
 */

 ...
 * ```
 */
export declare function getMaskingPolicy(args: GetMaskingPolicyArgs, opts?: pulumi.InvokeOptions): Promise<GetMaskingPolicyResult>;
/**
 ...
 * ```
 */
export declare function getMaskingPolicyOutput(args: GetMaskingPolicyOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetMaskingPolicyResult>;
/**
 * A collection of arguments for invoking getMaskingPolicy.
 */

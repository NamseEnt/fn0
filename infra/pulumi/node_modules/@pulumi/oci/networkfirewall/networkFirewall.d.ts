 ...
 * ```
 */
export declare class NetworkFirewall extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: NetworkFirewallState, opts?: pulumi.CustomResourceOptions): NetworkFirewall;
    /**
     * Returns true if the given object is an instance of NetworkFirewall.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is NetworkFirewall;
    /**
     ...
     */
    readonly natConfiguration: pulumi.Output<outputs.NetworkFirewall.NetworkFirewallNatConfiguration>;
    /**

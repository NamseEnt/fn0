 ...
 * ```
 */
export declare function getNetworkFirewallPolicySecurityRules(args: GetNetworkFirewallPolicySecurityRulesArgs, opts?: pulumi.InvokeOptions): Promise<GetNetworkFirewallPolicySecurityRulesResult>;
/**
 ...
 * ```
 */
export declare function getNetworkFirewallPolicySecurityRulesOutput(args: GetNetworkFirewallPolicySecurityRulesOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetNetworkFirewallPolicySecurityRulesResult>;
/**
 * A collection of arguments for invoking getNetworkFirewallPolicySecurityRules.
 */

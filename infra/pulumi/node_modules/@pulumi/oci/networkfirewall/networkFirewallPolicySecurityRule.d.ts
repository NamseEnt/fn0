 ...
 * ```
 */
export declare class NetworkFirewallPolicySecurityRule extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: NetworkFirewallPolicySecurityRuleState, opts?: pulumi.CustomResourceOptions): NetworkFirewallPolicySecurityRule;
    /**
     ...
     */
    static isInstance(obj: any): obj is NetworkFirewallPolicySecurityRule;
    /**
     ...
     */
    readonly condition: pulumi.Output<outputs.NetworkFirewall.NetworkFirewallPolicySecurityRuleCondition>;
    /**
     ...
     */
    readonly inspection: pulumi.Output<string | undefined>;
    /**
     ...
     */
    readonly positions: pulumi.Output<outputs.NetworkFirewall.NetworkFirewallPolicySecurityRulePosition[]>;

 ...
 * ```
 */
export declare class NetworkFirewallPolicyApplication extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: NetworkFirewallPolicyApplicationState, opts?: pulumi.CustomResourceOptions): NetworkFirewallPolicyApplication;
    /**
     ...
     */
    static isInstance(obj: any): obj is NetworkFirewallPolicyApplication;
    /**
     ...
     */
    readonly icmpCode: pulumi.Output<number>;
    /**
     ...
     */
    readonly icmpType: pulumi.Output<number>;
    /**

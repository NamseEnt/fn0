...
exports.NetworkFirewallPolicyServiceList = void 0;
 ...
 * ```
 */
class NetworkFirewallPolicyServiceList extends pulumi.CustomResource {
    /**
    ...
    static get(name, id, state, opts) {
        return new NetworkFirewallPolicyServiceList(name, state, { ...opts, id: id });
    }
    /**
...
exports.NetworkFirewallPolicyServiceList = NetworkFirewallPolicyServiceList;
/** @internal */
NetworkFirewallPolicyServiceList.__pulumiType = 'oci:NetworkFirewall/networkFirewallPolicyServiceList:NetworkFirewallPolicyServiceList';
//# sourceMappingURL=networkFirewallPolicyServiceList.js.map
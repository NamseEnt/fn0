...
exports.NetworkFirewallPolicyNatRule = void 0;
 ...
 * ```
 */
class NetworkFirewallPolicyNatRule extends pulumi.CustomResource {
    /**
    ...
    static get(name, id, state, opts) {
        return new NetworkFirewallPolicyNatRule(name, state, { ...opts, id: id });
    }
    /**
...
exports.NetworkFirewallPolicyNatRule = NetworkFirewallPolicyNatRule;
/** @internal */
NetworkFirewallPolicyNatRule.__pulumiType = 'oci:NetworkFirewall/networkFirewallPolicyNatRule:NetworkFirewallPolicyNatRule';
//# sourceMappingURL=networkFirewallPolicyNatRule.js.map
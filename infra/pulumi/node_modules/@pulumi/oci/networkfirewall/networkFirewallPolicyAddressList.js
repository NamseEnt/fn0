...
exports.NetworkFirewallPolicyAddressList = void 0;
 ...
 * ```
 */
class NetworkFirewallPolicyAddressList extends pulumi.CustomResource {
    /**
    ...
    static get(name, id, state, opts) {
        return new NetworkFirewallPolicyAddressList(name, state, { ...opts, id: id });
    }
    /**
...
exports.NetworkFirewallPolicyAddressList = NetworkFirewallPolicyAddressList;
/** @internal */
NetworkFirewallPolicyAddressList.__pulumiType = 'oci:NetworkFirewall/networkFirewallPolicyAddressList:NetworkFirewallPolicyAddressList';
//# sourceMappingURL=networkFirewallPolicyAddressList.js.map
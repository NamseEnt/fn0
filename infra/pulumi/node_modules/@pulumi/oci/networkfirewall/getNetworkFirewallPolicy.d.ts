 ...
 * ```
 */
export declare function getNetworkFirewallPolicy(args: GetNetworkFirewallPolicyArgs, opts?: pulumi.InvokeOptions): Promise<GetNetworkFirewallPolicyResult>;
/**
 ...
 * ```
 */
export declare function getNetworkFirewallPolicyOutput(args: GetNetworkFirewallPolicyOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetNetworkFirewallPolicyResult>;
/**
 * A collection of arguments for invoking getNetworkFirewallPolicy.
 */

...
export declare class SqlEndpoint extends pulumi.CustomResource {
     ...
     */
    readonly driverShapeConfig: pulumi.Output<outputs.DataFlow.SqlEndpointDriverShapeConfig>;
    /**
     ...
     * This is used to configure the shape of the driver or executor if a flexible shape is used.
     */
    readonly executorShapeConfig: pulumi.Output<outputs.DataFlow.SqlEndpointExecutorShapeConfig>;
    /**
     ...
     */
    readonly jdbcEndpointUrl: pulumi.Output<string>;
    /**
     * Oracle Cloud Infrastructure lake OCID
     */
    readonly lakeId: pulumi.Output<string>;
    /**
     * (Updatable) The maximum number of executors.
     */
    readonly maxExecutorCount: pulumi.Output<number>;
    /**
     * Metastore OCID
     */
     ...
     */
    readonly minExecutorCount: pulumi.Output<number>;
    /**
     * The network configuration of a SQL Endpoint.
     */
    readonly networkConfiguration: pulumi.Output<outputs.DataFlow.SqlEndpointNetworkConfiguration>;
    /**
     * (Updatable) The Spark configuration passed to the running process. See https://spark.apache.org/docs/latest/configuration.html#available-properties. Example: { "spark.app.name" : "My App Name", "spark.shuffle.io.maxRetries" : "4" } Note: Not all Spark properties are permitted to be set.  Attempting to set a property that is not allowed to be overwritten will cause a 400 status to be returned.
     */
    readonly sparkAdvancedConfigurations: pulumi.Output<{
        [key: string]: string;
    }>;
    /**
     * The version of the SQL Endpoint.
     */
    readonly sqlEndpointVersion: pulumi.Output<string>;
    /**
...
export interface SqlEndpointState {
     ...
     * (Updatable) The Spark configuration passed to the running process. See https://spark.apache.org/docs/latest/configuration.html#available-properties. Example: { "spark.app.name" : "My App Name", "spark.shuffle.io.maxRetries" : "4" } Note: Not all Spark properties are permitted to be set.  Attempting to set a property that is not allowed to be overwritten will cause a 400 status to be returned.
     */
    sparkAdvancedConfigurations?: pulumi.Input<{
        [key: string]: pulumi.Input<string>;
    }>;
    /**
     * The version of the SQL Endpoint.

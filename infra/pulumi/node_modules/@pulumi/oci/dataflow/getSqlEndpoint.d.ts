 ...
 * ```
 */
export declare function getSqlEndpoint(args: GetSqlEndpointArgs, opts?: pulumi.InvokeOptions): Promise<GetSqlEndpointResult>;
/**
 ...
 * ```
 */
export declare function getSqlEndpointOutput(args: GetSqlEndpointOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetSqlEndpointResult>;
/**
 * A collection of arguments for invoking getSqlEndpoint.
 */

 ...
 * ```
 */
export declare class RunStatement extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: RunStatementState, opts?: pulumi.CustomResourceOptions): RunStatement;
    /**
     * Returns true if the given object is an instance of RunStatement.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is RunStatement;
    /**
     ...
     */
    readonly outputs: pulumi.Output<outputs.DataFlow.RunStatementOutput[]>;
    /**
     * The execution progress.
     */
    readonly progress: pulumi.Output<number>;
    /**

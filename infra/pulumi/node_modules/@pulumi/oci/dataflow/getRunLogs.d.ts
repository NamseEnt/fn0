 ...
 * ```
 */
export declare function getRunLogs(args: GetRunLogsArgs, opts?: pulumi.InvokeOptions): Promise<GetRunLogsResult>;
/**
 ...
 * ```
 */
export declare function getRunLogsOutput(args: GetRunLogsOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetRunLogsResult>;
/**
 * A collection of arguments for invoking getRunLogs.
 */

 ...
 * ```
 */
export declare function getInvokeRun(args: GetInvokeRunArgs, opts?: pulumi.InvokeOptions): Promise<GetInvokeRunResult>;
/**
 ...
 * ```
 */
export declare function getInvokeRunOutput(args: GetInvokeRunOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetInvokeRunResult>;
/**
 * A collection of arguments for invoking getInvokeRun.
 */

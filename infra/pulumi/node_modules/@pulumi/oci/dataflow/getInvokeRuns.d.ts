 ...
 * ```
 */
export declare function getInvokeRuns(args: GetInvokeRunsArgs, opts?: pulumi.InvokeOptions): Promise<GetInvokeRunsResult>;
/**
 ...
 * ```
 */
export declare function getInvokeRunsOutput(args: GetInvokeRunsOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetInvokeRunsResult>;
/**
 * A collection of arguments for invoking getInvokeRuns.
 */

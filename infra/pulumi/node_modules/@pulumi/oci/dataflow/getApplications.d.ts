 ...
 * ```
 */
export declare function getApplications(args: GetApplicationsArgs, opts?: pulumi.InvokeOptions): Promise<GetApplicationsResult>;
/**
 ...
 * ```
 */
export declare function getApplicationsOutput(args: GetApplicationsOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetApplicationsResult>;
/**
 * A collection of arguments for invoking getApplications.
 */

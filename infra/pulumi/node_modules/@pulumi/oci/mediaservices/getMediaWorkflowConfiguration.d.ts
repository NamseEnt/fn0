 ...
 * ```
 */
export declare function getMediaWorkflowConfiguration(args: GetMediaWorkflowConfigurationArgs, opts?: pulumi.InvokeOptions): Promise<GetMediaWorkflowConfigurationResult>;
/**
 ...
 * ```
 */
export declare function getMediaWorkflowConfigurationOutput(args: GetMediaWorkflowConfigurationOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetMediaWorkflowConfigurationResult>;
/**
 * A collection of arguments for invoking getMediaWorkflowConfiguration.
 */

 ...
 * ```
 */
export declare class MediaWorkflowJob extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: MediaWorkflowJobState, opts?: pulumi.CustomResourceOptions): MediaWorkflowJob;
    /**
     * Returns true if the given object is an instance of MediaWorkflowJob.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is MediaWorkflowJob;
    /**
     ...
     */
    readonly locks: pulumi.Output<outputs.MediaServices.MediaWorkflowJobLock[]>;
    /**
     * Configurations to be applied to this run of the workflow.
     */
    readonly mediaWorkflowConfigurationIds: pulumi.Output<string[]>;
    /**
     * OCID of the MediaWorkflow that should be run.
     */
    readonly mediaWorkflowId: pulumi.Output<string>;
    /**
     * Name of the system MediaWorkflow that should be run.
     */
    readonly mediaWorkflowName: pulumi.Output<string>;
    /**
     * A list of JobOutput for the workflowJob.
     */
    readonly outputs: pulumi.Output<outputs.MediaServices.MediaWorkflowJobOutput[]>;
    /**
     ...
     */
    readonly runnable: pulumi.Output<string>;
    /**
     ...
     * Status of each task.
     */
    readonly taskLifecycleStates: pulumi.Output<outputs.MediaServices.MediaWorkflowJobTaskLifecycleState[]>;
    /**
     ...
     */
    readonly workflowIdentifierType: pulumi.Output<string>;
    /**

 ...
 * ```
 */
export declare class StreamCdnConfig extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: StreamCdnConfigState, opts?: pulumi.CustomResourceOptions): StreamCdnConfig;
    /**
     * Returns true if the given object is an instance of StreamCdnConfig.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is StreamCdnConfig;
    /**
     ...
     */
    readonly config: pulumi.Output<outputs.MediaServices.StreamCdnConfigConfig>;
    /**
     ...
     */
    readonly lifecyleDetails: pulumi.Output<string>;
    /**
     * Locks associated with this resource.
     */
    readonly locks: pulumi.Output<outputs.MediaServices.StreamCdnConfigLock[]>;
    /**

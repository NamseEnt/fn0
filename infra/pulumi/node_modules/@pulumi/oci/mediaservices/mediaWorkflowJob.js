 ...
 * ```
 */
class MediaWorkflowJob extends pulumi.CustomResource {
    /**
    ...
    static get(name, id, state, opts) {
        return new MediaWorkflowJob(name, state, { ...opts, id: id });
    }
    /**
...
exports.MediaWorkflowJob = MediaWorkflowJob;
/** @internal */
MediaWorkflowJob.__pulumiType = 'oci:MediaServices/mediaWorkflowJob:MediaWorkflowJob';
//# sourceMappingURL=mediaWorkflowJob.js.map
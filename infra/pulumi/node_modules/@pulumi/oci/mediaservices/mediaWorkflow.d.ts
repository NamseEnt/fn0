 ...
 * ```
 */
export declare class MediaWorkflow extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: MediaWorkflowState, opts?: pulumi.CustomResourceOptions): MediaWorkflow;
    /**
     * Returns true if the given object is an instance of MediaWorkflow.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is MediaWorkflow;
    /**
     ...
     */
    readonly locks: pulumi.Output<outputs.MediaServices.MediaWorkflowLock[]>;
    /**
     ...
     */
    readonly tasks: pulumi.Output<outputs.MediaServices.MediaWorkflowTask[]>;
    /**

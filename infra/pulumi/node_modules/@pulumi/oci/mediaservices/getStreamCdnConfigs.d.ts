 ...
 * ```
 */
export declare function getStreamCdnConfigs(args: GetStreamCdnConfigsArgs, opts?: pulumi.InvokeOptions): Promise<GetStreamCdnConfigsResult>;
/**
 ...
 * ```
 */
export declare function getStreamCdnConfigsOutput(args: GetStreamCdnConfigsOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetStreamCdnConfigsResult>;
/**
 * A collection of arguments for invoking getStreamCdnConfigs.
 */

 ...
 * ```
 */
export declare function getMediaWorkflowJob(args: GetMediaWorkflowJobArgs, opts?: pulumi.InvokeOptions): Promise<GetMediaWorkflowJobResult>;
/**
 ...
 * ```
 */
export declare function getMediaWorkflowJobOutput(args: GetMediaWorkflowJobOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetMediaWorkflowJobResult>;
/**
 * A collection of arguments for invoking getMediaWorkflowJob.
 */

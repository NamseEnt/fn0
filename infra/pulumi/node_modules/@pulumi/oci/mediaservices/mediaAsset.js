 ...
 * ```
 */
class MediaAsset extends pulumi.CustomResource {
    /**
    ...
    static get(name, id, state, opts) {
        return new MediaAsset(name, state, { ...opts, id: id });
    }
    /**
...
/** @internal */
MediaAsset.__pulumiType = 'oci:MediaServices/mediaAsset:MediaAsset';

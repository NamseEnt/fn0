 ...
 * ```
 */
export declare function getProductLicense(args: GetProductLicenseArgs, opts?: pulumi.InvokeOptions): Promise<GetProductLicenseResult>;
/**
 ...
 * ```
 */
export declare function getProductLicenseOutput(args: GetProductLicenseOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetProductLicenseResult>;
/**
 * A collection of arguments for invoking getProductLicense.
 */

 ...
 * ```
 */
export declare function getLicenseRecords(args: GetLicenseRecordsArgs, opts?: pulumi.InvokeOptions): Promise<GetLicenseRecordsResult>;
/**
 ...
 * ```
 */
export declare function getLicenseRecordsOutput(args: GetLicenseRecordsOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetLicenseRecordsResult>;
/**
 * A collection of arguments for invoking getLicenseRecords.
 */

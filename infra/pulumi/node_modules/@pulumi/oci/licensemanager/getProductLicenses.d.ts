 ...
 * ```
 */
export declare function getProductLicenses(args: GetProductLicensesArgs, opts?: pulumi.InvokeOptions): Promise<GetProductLicensesResult>;
/**
 ...
 * ```
 */
export declare function getProductLicensesOutput(args: GetProductLicensesOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetProductLicensesResult>;
/**
 * A collection of arguments for invoking getProductLicenses.
 */

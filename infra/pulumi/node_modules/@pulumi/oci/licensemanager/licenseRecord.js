 ...
 * ```
 */
class LicenseRecord extends pulumi.CustomResource {
    /**
    ...
    static get(name, id, state, opts) {
        return new LicenseRecord(name, state, { ...opts, id: id });
    }
    /**
...
exports.LicenseRecord = LicenseRecord;
/** @internal */
LicenseRecord.__pulumiType = 'oci:LicenseManager/licenseRecord:LicenseRecord';

 ...
 * ```
 */
class ProductLicense extends pulumi.CustomResource {
    /**
    ...
    static get(name, id, state, opts) {
        return new ProductLicense(name, state, { ...opts, id: id });
    }
    /**
...
/** @internal */
ProductLicense.__pulumiType = 'oci:LicenseManager/productLicense:ProductLicense';
//# sourceMappingURL=productLicense.js.map
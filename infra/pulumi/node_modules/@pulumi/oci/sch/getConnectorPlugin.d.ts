 ...
 * ```
 */
export declare function getConnectorPlugin(args: GetConnectorPluginArgs, opts?: pulumi.InvokeOptions): Promise<GetConnectorPluginResult>;
/**
 ...
 * ```
 */
export declare function getConnectorPluginOutput(args: GetConnectorPluginOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetConnectorPluginResult>;
/**
 * A collection of arguments for invoking getConnectorPlugin.
 */

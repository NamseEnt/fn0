 ...
 * ```
 */
export declare function getSubscribedService(args: GetSubscribedServiceArgs, opts?: pulumi.InvokeOptions): Promise<GetSubscribedServiceResult>;
/**
 ...
 * ```
 */
export declare function getSubscribedServiceOutput(args: GetSubscribedServiceOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetSubscribedServiceResult>;
/**
 * A collection of arguments for invoking getSubscribedService.
 */

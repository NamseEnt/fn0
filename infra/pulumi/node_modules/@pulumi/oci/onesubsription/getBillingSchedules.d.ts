 ...
 * ```
 */
export declare function getBillingSchedules(args: GetBillingSchedulesArgs, opts?: pulumi.InvokeOptions): Promise<GetBillingSchedulesResult>;
/**
 ...
 * ```
 */
export declare function getBillingSchedulesOutput(args: GetBillingSchedulesOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetBillingSchedulesResult>;
/**
 * A collection of arguments for invoking getBillingSchedules.
 */

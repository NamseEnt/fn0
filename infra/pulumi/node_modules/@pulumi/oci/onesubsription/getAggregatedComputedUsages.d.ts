 ...
 */
export declare function getAggregatedComputedUsages(args: GetAggregatedComputedUsagesArgs, opts?: pulumi.InvokeOptions): Promise<GetAggregatedComputedUsagesResult>;
/**
 ...
 * This is a collection API which returns a list of aggregated computed usage details (there can be multiple Parent Products under a given SubID each of which is represented under Subscription Service Line # in SPM).
 */
export declare function getAggregatedComputedUsagesOutput(args: GetAggregatedComputedUsagesOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetAggregatedComputedUsagesResult>;
/**
 * A collection of arguments for invoking getAggregatedComputedUsages.
 */

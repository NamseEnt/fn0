 ...
 * ```
 */
class IntegrationInstance extends pulumi.CustomResource {
    /**
    ...
    static get(name, id, state, opts) {
        return new IntegrationInstance(name, state, { ...opts, id: id });
    }
    /**
...
/** @internal */
IntegrationInstance.__pulumiType = 'oci:Integration/integrationInstance:IntegrationInstance';
//# sourceMappingURL=integrationInstance.js.map
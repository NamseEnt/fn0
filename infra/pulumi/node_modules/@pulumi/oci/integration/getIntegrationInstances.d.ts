 ...
 * ```
 */
export declare function getIntegrationInstances(args: GetIntegrationInstancesArgs, opts?: pulumi.InvokeOptions): Promise<GetIntegrationInstancesResult>;
/**
 ...
 * ```
 */
export declare function getIntegrationInstancesOutput(args: GetIntegrationInstancesOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetIntegrationInstancesResult>;
/**
 * A collection of arguments for invoking getIntegrationInstances.
 */

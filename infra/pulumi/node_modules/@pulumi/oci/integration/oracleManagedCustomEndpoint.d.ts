...
export declare class OracleManagedCustomEndpoint extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: OracleManagedCustomEndpointState, opts?: pulumi.CustomResourceOptions): OracleManagedCustomEndpoint;
    /**
     ...
     */
    static isInstance(obj: any): obj is OracleManagedCustomEndpoint;
    readonly dnsType: pulumi.Output<string>;
    readonly dnsZoneName: pulumi.Output<string | undefined>;
    readonly hostname: pulumi.Output<string>;
    readonly integrationInstanceId: pulumi.Output<string>;
    readonly managedType: pulumi.Output<string>;

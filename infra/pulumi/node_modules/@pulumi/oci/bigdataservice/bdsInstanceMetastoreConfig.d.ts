 ...
 * ```
 */
export declare class BdsInstanceMetastoreConfig extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: BdsInstanceMetastoreConfigState, opts?: pulumi.CustomResourceOptions): BdsInstanceMetastoreConfig;
    /**
     ...
     */
    static isInstance(obj: any): obj is BdsInstanceMetastoreConfig;
    /**
     ...
     */
    readonly activateTrigger: pulumi.Output<number | undefined>;
    /**
     * (Updatable) The ID of BDS Api Key used for Data Catalog metastore integration.
     */
    readonly bdsApiKeyId: pulumi.Output<string>;
    /**
     * (Updatable) Base-64 encoded passphrase of the BDS Api Key.
     */
    readonly bdsApiKeyPassphrase: pulumi.Output<string>;
    /**

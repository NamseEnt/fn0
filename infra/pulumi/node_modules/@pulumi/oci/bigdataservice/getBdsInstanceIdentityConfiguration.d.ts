 ...
 * ```
 */
export declare function getBdsInstanceIdentityConfiguration(args: GetBdsInstanceIdentityConfigurationArgs, opts?: pulumi.InvokeOptions): Promise<GetBdsInstanceIdentityConfigurationResult>;
/**
 ...
 * ```
 */
export declare function getBdsInstanceIdentityConfigurationOutput(args: GetBdsInstanceIdentityConfigurationOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetBdsInstanceIdentityConfigurationResult>;
/**
 * A collection of arguments for invoking getBdsInstanceIdentityConfiguration.
 */

 ...
 * ```
 */
export declare function getBdsInstanceMetastoreConfig(args: GetBdsInstanceMetastoreConfigArgs, opts?: pulumi.InvokeOptions): Promise<GetBdsInstanceMetastoreConfigResult>;
/**
 ...
 * ```
 */
export declare function getBdsInstanceMetastoreConfigOutput(args: GetBdsInstanceMetastoreConfigOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetBdsInstanceMetastoreConfigResult>;
/**
 * A collection of arguments for invoking getBdsInstanceMetastoreConfig.
 */

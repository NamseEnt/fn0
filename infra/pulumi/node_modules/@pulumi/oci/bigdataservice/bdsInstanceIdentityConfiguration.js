...
exports.BdsInstanceIdentityConfiguration = void 0;
 ...
 * ```
 */
class BdsInstanceIdentityConfiguration extends pulumi.CustomResource {
    /**
    ...
    static get(name, id, state, opts) {
        return new BdsInstanceIdentityConfiguration(name, state, { ...opts, id: id });
    }
    /**
...
exports.BdsInstanceIdentityConfiguration = BdsInstanceIdentityConfiguration;
/** @internal */
BdsInstanceIdentityConfiguration.__pulumiType = 'oci:BigDataService/bdsInstanceIdentityConfiguration:BdsInstanceIdentityConfiguration';
//# sourceMappingURL=bdsInstanceIdentityConfiguration.js.map
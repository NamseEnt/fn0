 ...
 * ```
 */
export declare class BdsCapacityReport extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: BdsCapacityReportState, opts?: pulumi.CustomResourceOptions): BdsCapacityReport;
    /**
     * Returns true if the given object is an instance of BdsCapacityReport.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is BdsCapacityReport;
    /**
     ...
     */
    readonly shapeAvailabilities: pulumi.Output<outputs.BigDataService.BdsCapacityReportShapeAvailability[]>;
    /**

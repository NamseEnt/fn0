 ...
 * ```
 */
export declare class BdsInstanceIdentityConfiguration extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: BdsInstanceIdentityConfigurationState, opts?: pulumi.CustomResourceOptions): BdsInstanceIdentityConfiguration;
    /**
     ...
     */
    static isInstance(obj: any): obj is BdsInstanceIdentityConfiguration;
    /**
     ...
     */
    readonly activateIamUserSyncConfigurationTrigger: pulumi.Output<string | undefined>;
    /**
     ...
     */
    readonly activateUpstConfigurationTrigger: pulumi.Output<string | undefined>;
    /**
     ...
     */
    readonly confidentialApplicationId: pulumi.Output<string>;
    /**
     ...
     */
    readonly iamUserSyncConfigurationDetails: pulumi.Output<outputs.BigDataService.BdsInstanceIdentityConfigurationIamUserSyncConfigurationDetails>;
    /**
     * Information about the IAM user sync configuration.
     */
    readonly iamUserSyncConfigurations: pulumi.Output<outputs.BigDataService.BdsInstanceIdentityConfigurationIamUserSyncConfiguration[]>;
    /**
     * Identity domain OCID to use for identity config, required for creating identity configuration
     */
    readonly identityDomainId: pulumi.Output<string>;
    /**
     * (Updatable) An optional property when set to "true" triggers Refresh Confidential Application.
     */
    readonly refreshConfidentialApplicationTrigger: pulumi.Output<string | undefined>;
    /**
     ...
     */
    readonly refreshUpstTokenExchangeKeytabTrigger: pulumi.Output<string | undefined>;
    /**
     ...
     */
    readonly upstConfigurationDetails: pulumi.Output<outputs.BigDataService.BdsInstanceIdentityConfigurationUpstConfigurationDetails>;
    /**
     * Information about the UPST configuration.
     */
    readonly upstConfigurations: pulumi.Output<outputs.BigDataService.BdsInstanceIdentityConfigurationUpstConfiguration[]>;
    /**

 ...
 * ```
 */
export declare function getOpensearchClusterPipeline(args: GetOpensearchClusterPipelineArgs, opts?: pulumi.InvokeOptions): Promise<GetOpensearchClusterPipelineResult>;
/**
 ...
 * ```
 */
export declare function getOpensearchClusterPipelineOutput(args: GetOpensearchClusterPipelineOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetOpensearchClusterPipelineResult>;
/**
 * A collection of arguments for invoking getOpensearchClusterPipeline.
 */

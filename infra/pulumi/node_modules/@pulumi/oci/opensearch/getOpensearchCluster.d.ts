 ...
 * ```
 */
export declare function getOpensearchCluster(args: GetOpensearchClusterArgs, opts?: pulumi.InvokeOptions): Promise<GetOpensearchClusterResult>;
/**
 ...
 * ```
 */
export declare function getOpensearchClusterOutput(args: GetOpensearchClusterOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetOpensearchClusterResult>;
/**
 * A collection of arguments for invoking getOpensearchCluster.
 */

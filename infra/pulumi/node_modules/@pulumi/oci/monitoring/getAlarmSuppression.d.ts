 ...
 * ```
 */
export declare function getAlarmSuppression(args: GetAlarmSuppressionArgs, opts?: pulumi.InvokeOptions): Promise<GetAlarmSuppressionResult>;
/**
 ...
 * ```
 */
export declare function getAlarmSuppressionOutput(args: GetAlarmSuppressionOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetAlarmSuppressionResult>;
/**
 * A collection of arguments for invoking getAlarmSuppression.
 */

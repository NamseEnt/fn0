 ...
 * ```
 */
export declare function getAlarmStatuses(args: GetAlarmStatusesArgs, opts?: pulumi.InvokeOptions): Promise<GetAlarmStatusesResult>;
/**
 ...
 * ```
 */
export declare function getAlarmStatusesOutput(args: GetAlarmStatusesOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetAlarmStatusesResult>;
/**
 * A collection of arguments for invoking getAlarmStatuses.
 */

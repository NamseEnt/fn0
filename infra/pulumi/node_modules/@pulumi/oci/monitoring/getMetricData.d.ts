 ...
 * ```
 */
export declare function getMetricData(args: GetMetricDataArgs, opts?: pulumi.InvokeOptions): Promise<GetMetricDataResult>;
/**
 ...
 * ```
 */
export declare function getMetricDataOutput(args: GetMetricDataOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetMetricDataResult>;
/**
 * A collection of arguments for invoking getMetricData.
 */

 ...
 * ```
 */
export declare class ManagedInstanceInstallWindowsUpdatesManagement extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ManagedInstanceInstallWindowsUpdatesManagementState, opts?: pulumi.CustomResourceOptions): ManagedInstanceInstallWindowsUpdatesManagement;
    /**
     ...
     */
    static isInstance(obj: any): obj is ManagedInstanceInstallWindowsUpdatesManagement;
    /**
     ...
     */
    readonly windowsUpdateNames: pulumi.Output<string[] | undefined>;
    /**
     * The types of Windows updates to be installed.
     */
    readonly windowsUpdateTypes: pulumi.Output<string[] | undefined>;
    /**
     * Provides the name and description of the job.
     */
    readonly workRequestDetails: pulumi.Output<outputs.OsManagementHub.ManagedInstanceInstallWindowsUpdatesManagementWorkRequestDetails>;
    /**

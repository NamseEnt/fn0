 ...
 * ```
 */
export declare function getWindowsUpdate(args: GetWindowsUpdateArgs, opts?: pulumi.InvokeOptions): Promise<GetWindowsUpdateResult>;
/**
 ...
 * ```
 */
export declare function getWindowsUpdateOutput(args: GetWindowsUpdateOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetWindowsUpdateResult>;
/**
 * A collection of arguments for invoking getWindowsUpdate.
 */

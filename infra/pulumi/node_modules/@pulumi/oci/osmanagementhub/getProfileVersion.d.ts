 ...
 * ```
 */
export declare function getProfileVersion(args: GetProfileVersionArgs, opts?: pulumi.InvokeOptions): Promise<GetProfileVersionResult>;
/**
 ...
 * ```
 */
export declare function getProfileVersionOutput(args: GetProfileVersionOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetProfileVersionResult>;
/**
 * A collection of arguments for invoking getProfileVersion.
 */

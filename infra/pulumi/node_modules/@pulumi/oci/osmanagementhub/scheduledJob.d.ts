 ...
 * ```
 */
export declare class ScheduledJob extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ScheduledJobState, opts?: pulumi.CustomResourceOptions): ScheduledJob;
    /**
     * Returns true if the given object is an instance of ScheduledJob.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is ScheduledJob;
    /**
     ...
     */
    readonly retryIntervals: pulumi.Output<number[]>;
    /**
     ...
     */
    readonly timeLastExecution: pulumi.Output<string>;
    /**
     ...
     */
    readonly timeNextExecution: pulumi.Output<string>;
    /**

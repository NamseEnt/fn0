 ...
 * ```
 */
export declare function getErrata(args: GetErrataArgs, opts?: pulumi.InvokeOptions): Promise<GetErrataResult>;
/**
 ...
 * ```
 */
export declare function getErrataOutput(args: GetErrataOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetErrataResult>;
/**
 * A collection of arguments for invoking getErrata.
 */

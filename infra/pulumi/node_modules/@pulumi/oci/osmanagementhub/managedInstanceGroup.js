 ...
 * ```
 */
class ManagedInstanceGroup extends pulumi.CustomResource {
    /**
    ...
    static get(name, id, state, opts) {
        return new ManagedInstanceGroup(name, state, { ...opts, id: id });
    }
    /**
...
exports.ManagedInstanceGroup = ManagedInstanceGroup;
/** @internal */
ManagedInstanceGroup.__pulumiType = 'oci:OsManagementHub/managedInstanceGroup:ManagedInstanceGroup';
//# sourceMappingURL=managedInstanceGroup.js.map
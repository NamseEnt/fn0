 ...
 * ```
 */
export declare function getSoftwareSourceModuleStreamProfiles(args: GetSoftwareSourceModuleStreamProfilesArgs, opts?: pulumi.InvokeOptions): Promise<GetSoftwareSourceModuleStreamProfilesResult>;
/**
 ...
 * ```
 */
export declare function getSoftwareSourceModuleStreamProfilesOutput(args: GetSoftwareSourceModuleStreamProfilesOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetSoftwareSourceModuleStreamProfilesResult>;
/**
 * A collection of arguments for invoking getSoftwareSourceModuleStreamProfiles.
 */

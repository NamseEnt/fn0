 ...
 * ```
 */
export declare class ManagedInstanceGroupAttachSoftwareSourcesManagement extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ManagedInstanceGroupAttachSoftwareSourcesManagementState, opts?: pulumi.CustomResourceOptions): ManagedInstanceGroupAttachSoftwareSourcesManagement;
    /**
     ...
     */
    static isInstance(obj: any): obj is ManagedInstanceGroupAttachSoftwareSourcesManagement;
    /**
     ...
     */
    readonly softwareSources: pulumi.Output<string[]>;
    /**
     * Provides the name and description of the job.
     */
    readonly workRequestDetails: pulumi.Output<outputs.OsManagementHub.ManagedInstanceGroupAttachSoftwareSourcesManagementWorkRequestDetails>;
    /**

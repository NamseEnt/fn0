 ...
 * ```
 */
export declare function getManagementStationOutput(args: GetManagementStationOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetManagementStationResult>;
/**
 * A collection of arguments for invoking getManagementStation.
 */

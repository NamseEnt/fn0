 ...
 * ```
 */
export declare class ProfileDetachSoftwareSourcesManagement extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ProfileDetachSoftwareSourcesManagementState, opts?: pulumi.CustomResourceOptions): ProfileDetachSoftwareSourcesManagement;
    /**
     ...
     */
    static isInstance(obj: any): obj is ProfileDetachSoftwareSourcesManagement;
    /**

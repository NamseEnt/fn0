 ...
 * ```
 */
export declare function getSoftwareSourceModuleStream(args: GetSoftwareSourceModuleStreamArgs, opts?: pulumi.InvokeOptions): Promise<GetSoftwareSourceModuleStreamResult>;
/**
 ...
 * ```
 */
export declare function getSoftwareSourceModuleStreamOutput(args: GetSoftwareSourceModuleStreamOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetSoftwareSourceModuleStreamResult>;
/**
 * A collection of arguments for invoking getSoftwareSourceModuleStream.
 */

 ...
 * ```
 */
export declare class LifecycleStageAttachManagedInstancesManagement extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: LifecycleStageAttachManagedInstancesManagementState, opts?: pulumi.CustomResourceOptions): LifecycleStageAttachManagedInstancesManagement;
    /**
     ...
     */
    static isInstance(obj: any): obj is LifecycleStageAttachManagedInstancesManagement;
    /**
     ...
     */
    readonly managedInstanceDetails: pulumi.Output<outputs.OsManagementHub.LifecycleStageAttachManagedInstancesManagementManagedInstanceDetails>;
    /**

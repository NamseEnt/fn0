 ...
 * ```
 */
export declare function getManagedInstanceModules(args: GetManagedInstanceModulesArgs, opts?: pulumi.InvokeOptions): Promise<GetManagedInstanceModulesResult>;
/**
 ...
 * ```
 */
export declare function getManagedInstanceModulesOutput(args: GetManagedInstanceModulesOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetManagedInstanceModulesResult>;
/**
 * A collection of arguments for invoking getManagedInstanceModules.
 */

 ...
 * ```
 */
export declare class SoftwareSourceChangeAvailabilityManagement extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: SoftwareSourceChangeAvailabilityManagementState, opts?: pulumi.CustomResourceOptions): SoftwareSourceChangeAvailabilityManagement;
    /**
     ...
     */
    static isInstance(obj: any): obj is SoftwareSourceChangeAvailabilityManagement;
    /**
     * List of vendor software sources and their availability statuses.
     */
    readonly softwareSourceAvailabilities: pulumi.Output<outputs.OsManagementHub.SoftwareSourceChangeAvailabilityManagementSoftwareSourceAvailability[]>;
    /**

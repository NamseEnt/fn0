 ...
 * ```
 */
export declare function getManagedInstanceUpdatablePackages(args: GetManagedInstanceUpdatablePackagesArgs, opts?: pulumi.InvokeOptions): Promise<GetManagedInstanceUpdatablePackagesResult>;
/**
 ...
 * ```
 */
export declare function getManagedInstanceUpdatablePackagesOutput(args: GetManagedInstanceUpdatablePackagesOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetManagedInstanceUpdatablePackagesResult>;
/**
 * A collection of arguments for invoking getManagedInstanceUpdatablePackages.
 */

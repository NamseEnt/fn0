 ...
 * ```
 */
export declare function getSoftwarePackageSoftwareSource(args: GetSoftwarePackageSoftwareSourceArgs, opts?: pulumi.InvokeOptions): Promise<GetSoftwarePackageSoftwareSourceResult>;
/**
 ...
 * ```
 */
export declare function getSoftwarePackageSoftwareSourceOutput(args: GetSoftwarePackageSoftwareSourceOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetSoftwarePackageSoftwareSourceResult>;
/**
 * A collection of arguments for invoking getSoftwarePackageSoftwareSource.
 */

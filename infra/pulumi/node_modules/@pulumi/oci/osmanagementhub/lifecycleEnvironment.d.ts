 ...
 * ```
 */
export declare class LifecycleEnvironment extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: LifecycleEnvironmentState, opts?: pulumi.CustomResourceOptions): LifecycleEnvironment;
    /**
     * Returns true if the given object is an instance of LifecycleEnvironment.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is LifecycleEnvironment;
    /**
     ...
     */
    readonly managedInstanceIds: pulumi.Output<outputs.OsManagementHub.LifecycleEnvironmentManagedInstanceId[]>;
    /**
     ...
     */
    readonly stages: pulumi.Output<outputs.OsManagementHub.LifecycleEnvironmentStage[]>;
    /**

 ...
 * ```
 */
export declare class ProfileAttachManagementStationManagement extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ProfileAttachManagementStationManagementState, opts?: pulumi.CustomResourceOptions): ProfileAttachManagementStationManagement;
    /**
     ...
     */
    static isInstance(obj: any): obj is ProfileAttachManagementStationManagement;
    /**
     ...
     */
    constructor(name: string, args: ProfileAttachManagementStationManagementArgs, opts?: pulumi.CustomResourceOptions);
}
/**
 * Input properties used for looking up and filtering ProfileAttachManagementStationManagement resources.
 */
export interface ProfileAttachManagementStationManagementState {
    /**
     * The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the management station that the instance will be associated with.
     */
 ...
 */
export interface ProfileAttachManagementStationManagementArgs {
    /**
     * The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the management station that the instance will be associated with.
     */
    managementStationId: pulumi.Input<string>;

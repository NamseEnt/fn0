 ...
 * ```
 */
export declare function getLifecycleEnvironment(args: GetLifecycleEnvironmentArgs, opts?: pulumi.InvokeOptions): Promise<GetLifecycleEnvironmentResult>;
/**
 ...
 * ```
 */
export declare function getLifecycleEnvironmentOutput(args: GetLifecycleEnvironmentOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetLifecycleEnvironmentResult>;
/**
 * A collection of arguments for invoking getLifecycleEnvironment.
 */

 ...
 * ```
 */
export declare class SoftwareSourceAddPackagesManagement extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: SoftwareSourceAddPackagesManagementState, opts?: pulumi.CustomResourceOptions): SoftwareSourceAddPackagesManagement;
    /**
     ...
     */
    static isInstance(obj: any): obj is SoftwareSourceAddPackagesManagement;
    /**
     ...
     */
    readonly isContinueOnMissingPackages: pulumi.Output<boolean>;
    /**

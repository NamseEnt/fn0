 ...
 * ```
 */
export declare class SoftwareSourceGenerateMetadataManagement extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: SoftwareSourceGenerateMetadataManagementState, opts?: pulumi.CustomResourceOptions): SoftwareSourceGenerateMetadataManagement;
    /**
     ...
     */
    static isInstance(obj: any): obj is SoftwareSourceGenerateMetadataManagement;
    /**

 ...
 * ```
 */
export declare function getManagedInstanceInstalledPackages(args: GetManagedInstanceInstalledPackagesArgs, opts?: pulumi.InvokeOptions): Promise<GetManagedInstanceInstalledPackagesResult>;
/**
 ...
 * ```
 */
export declare function getManagedInstanceInstalledPackagesOutput(args: GetManagedInstanceInstalledPackagesOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetManagedInstanceInstalledPackagesResult>;
/**
 * A collection of arguments for invoking getManagedInstanceInstalledPackages.
 */

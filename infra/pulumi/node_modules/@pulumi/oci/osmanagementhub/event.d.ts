...
export declare class Event extends pulumi.CustomResource {
     ...
     */
    readonly datas: pulumi.Output<outputs.OsManagementHub.EventData[]>;
    /**
     ...
     * Details of an event.
     */
    readonly eventDetails: pulumi.Output<string>;
    /**
     * (Updatable) The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the event.
     */
    readonly eventId: pulumi.Output<string>;
    /**
     * Summary of the event.
     */
    readonly eventSummary: pulumi.Output<string>;
    /**
     ...
     */
    readonly systemDetails: pulumi.Output<outputs.OsManagementHub.EventSystemDetail[]>;
    /**
     ...
     */
    readonly timeOccurred: pulumi.Output<string>;
    /**

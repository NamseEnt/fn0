 ...
 * ```
 */
export declare function getLifecycleStage(args: GetLifecycleStageArgs, opts?: pulumi.InvokeOptions): Promise<GetLifecycleStageResult>;
/**
 ...
 * ```
 */
export declare function getLifecycleStageOutput(args: GetLifecycleStageOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetLifecycleStageResult>;
/**
 * A collection of arguments for invoking getLifecycleStage.
 */

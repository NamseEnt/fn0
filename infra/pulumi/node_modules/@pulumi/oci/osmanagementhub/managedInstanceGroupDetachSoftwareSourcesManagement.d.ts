 ...
 * ```
 */
export declare class ManagedInstanceGroupDetachSoftwareSourcesManagement extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ManagedInstanceGroupDetachSoftwareSourcesManagementState, opts?: pulumi.CustomResourceOptions): ManagedInstanceGroupDetachSoftwareSourcesManagement;
    /**
     ...
     */
    static isInstance(obj: any): obj is ManagedInstanceGroupDetachSoftwareSourcesManagement;
    /**
     ...
     */
    readonly workRequestDetails: pulumi.Output<outputs.OsManagementHub.ManagedInstanceGroupDetachSoftwareSourcesManagementWorkRequestDetails>;
    /**

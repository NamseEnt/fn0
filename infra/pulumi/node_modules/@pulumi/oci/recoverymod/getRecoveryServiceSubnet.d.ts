 ...
 * ```
 */
export declare function getRecoveryServiceSubnet(args: GetRecoveryServiceSubnetArgs, opts?: pulumi.InvokeOptions): Promise<GetRecoveryServiceSubnetResult>;
/**
 ...
 * ```
 */
export declare function getRecoveryServiceSubnetOutput(args: GetRecoveryServiceSubnetOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetRecoveryServiceSubnetResult>;
/**
 * A collection of arguments for invoking getRecoveryServiceSubnet.
 */

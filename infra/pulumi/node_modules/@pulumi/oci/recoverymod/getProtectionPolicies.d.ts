 ...
 * ```
 */
export declare function getProtectionPolicies(args: GetProtectionPoliciesArgs, opts?: pulumi.InvokeOptions): Promise<GetProtectionPoliciesResult>;
/**
 ...
 * ```
 */
export declare function getProtectionPoliciesOutput(args: GetProtectionPoliciesOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetProtectionPoliciesResult>;
/**
 * A collection of arguments for invoking getProtectionPolicies.
 */

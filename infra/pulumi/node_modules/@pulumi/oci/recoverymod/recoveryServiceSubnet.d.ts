 ...
 * ```
 */
export declare class RecoveryServiceSubnet extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: RecoveryServiceSubnetState, opts?: pulumi.CustomResourceOptions): RecoveryServiceSubnet;
    /**
     * Returns true if the given object is an instance of RecoveryServiceSubnet.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is RecoveryServiceSubnet;
    /**

 ...
 * ```
 */
export declare function getDatabaseRegistration(args: GetDatabaseRegistrationArgs, opts?: pulumi.InvokeOptions): Promise<GetDatabaseRegistrationResult>;
/**
 ...
 * ```
 */
export declare function getDatabaseRegistrationOutput(args: GetDatabaseRegistrationOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetDatabaseRegistrationResult>;
/**
 * A collection of arguments for invoking getDatabaseRegistration.
 */

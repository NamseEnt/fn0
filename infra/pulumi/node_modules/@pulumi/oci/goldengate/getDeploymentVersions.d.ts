 ...
 * ```
 */
export declare function getDeploymentVersions(args: GetDeploymentVersionsArgs, opts?: pulumi.InvokeOptions): Promise<GetDeploymentVersionsResult>;
/**
 ...
 * ```
 */
export declare function getDeploymentVersionsOutput(args: GetDeploymentVersionsOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetDeploymentVersionsResult>;
/**
 * A collection of arguments for invoking getDeploymentVersions.
 */

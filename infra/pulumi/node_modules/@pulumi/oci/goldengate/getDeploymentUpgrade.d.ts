 ...
 * ```
 */
export declare function getDeploymentUpgrade(args: GetDeploymentUpgradeArgs, opts?: pulumi.InvokeOptions): Promise<GetDeploymentUpgradeResult>;
/**
 ...
 * ```
 */
export declare function getDeploymentUpgradeOutput(args: GetDeploymentUpgradeOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetDeploymentUpgradeResult>;
/**
 * A collection of arguments for invoking getDeploymentUpgrade.
 */

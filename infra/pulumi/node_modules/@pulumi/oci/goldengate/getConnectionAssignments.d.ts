 ...
 * ```
 */
export declare function getConnectionAssignments(args: GetConnectionAssignmentsArgs, opts?: pulumi.InvokeOptions): Promise<GetConnectionAssignmentsResult>;
/**
 ...
 * ```
 */
export declare function getConnectionAssignmentsOutput(args: GetConnectionAssignmentsOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetConnectionAssignmentsResult>;
/**
 * A collection of arguments for invoking getConnectionAssignments.
 */

...
export declare class Pipeline extends pulumi.CustomResource {
     ...
     */
    readonly locks: pulumi.Output<outputs.GoldenGate.PipelineLock[]>;
    /**
     * Mapping for source/target schema/tables for the pipeline data replication.
     */
    readonly mappingRules: pulumi.Output<outputs.GoldenGate.PipelineMappingRule[]>;
    /**
     * Information regarding the pipeline diagnostic collection
     */
    readonly pipelineDiagnosticDatas: pulumi.Output<outputs.GoldenGate.PipelinePipelineDiagnosticData[]>;
    /**
     * (Updatable) Required pipeline options to configure the replication process (Extract or Replicat).
     */
    readonly processOptions: pulumi.Output<outputs.GoldenGate.PipelineProcessOptions>;
    /**
     * (Updatable) The type of the recipe
     */
    readonly recipeType: pulumi.Output<string>;
    /**
     * The source connection details for creating a pipeline.
     */
    readonly sourceConnectionDetails: pulumi.Output<outputs.GoldenGate.PipelineSourceConnectionDetails>;
    /**
     ...
     */
    readonly targetConnectionDetails: pulumi.Output<outputs.GoldenGate.PipelineTargetConnectionDetails>;
    /**
     ...
     */
    readonly timeLastRecorded: pulumi.Output<string>;
    /**

 ...
 * ```
 */
export declare class DatabaseRegistration extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: DatabaseRegistrationState, opts?: pulumi.CustomResourceOptions): DatabaseRegistration;
    /**
     * Returns true if the given object is an instance of DatabaseRegistration.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is DatabaseRegistration;
    /**
     ...
     */
    readonly rcePrivateIp: pulumi.Output<string>;
    /**
     ...
     */
    readonly secretCompartmentId: pulumi.Output<string>;
    /**

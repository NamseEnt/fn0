 ...
 * ```
 */
export declare function getTrailSequences(args: GetTrailSequencesArgs, opts?: pulumi.InvokeOptions): Promise<GetTrailSequencesResult>;
/**
 ...
 * ```
 */
export declare function getTrailSequencesOutput(args: GetTrailSequencesOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetTrailSequencesResult>;
/**
 * A collection of arguments for invoking getTrailSequences.
 */

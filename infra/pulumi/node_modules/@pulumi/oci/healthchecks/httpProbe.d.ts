 ...
 * ```
 */
export declare class HttpProbe extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: HttpProbeState, opts?: pulumi.CustomResourceOptions): HttpProbe;
    /**
     * Returns true if the given object is an instance of HttpProbe.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is HttpProbe;
    /**

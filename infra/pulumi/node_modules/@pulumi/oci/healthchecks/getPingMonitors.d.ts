 ...
 * ```
 */
export declare function getPingMonitors(args: GetPingMonitorsArgs, opts?: pulumi.InvokeOptions): Promise<GetPingMonitorsResult>;
/**
 ...
 * ```
 */
export declare function getPingMonitorsOutput(args: GetPingMonitorsOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetPingMonitorsResult>;
/**
 * A collection of arguments for invoking getPingMonitors.
 */

 ...
 * ```
 */
export declare function getPingMonitor(args: GetPingMonitorArgs, opts?: pulumi.InvokeOptions): Promise<GetPingMonitorResult>;
/**
 ...
 * ```
 */
export declare function getPingMonitorOutput(args: GetPingMonitorOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetPingMonitorResult>;
/**
 * A collection of arguments for invoking getPingMonitor.
 */

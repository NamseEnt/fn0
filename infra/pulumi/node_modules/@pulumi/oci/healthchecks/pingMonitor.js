 ...
 * ```
 */
class PingMonitor extends pulumi.CustomResource {
    /**
    ...
    static get(name, id, state, opts) {
        return new PingMonitor(name, state, { ...opts, id: id });
    }
    /**
...
/** @internal */
PingMonitor.__pulumiType = 'oci:HealthChecks/pingMonitor:PingMonitor';

 ...
 * ```
 */
export declare function getHttpProbeResults(args: GetHttpProbeResultsArgs, opts?: pulumi.InvokeOptions): Promise<GetHttpProbeResultsResult>;
/**
 ...
 * ```
 */
export declare function getHttpProbeResultsOutput(args: GetHttpProbeResultsOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetHttpProbeResultsResult>;
/**
 * A collection of arguments for invoking getHttpProbeResults.
 */

 ...
 */
export declare class PurgeCache extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: PurgeCacheState, opts?: pulumi.CustomResourceOptions): PurgeCache;
    /**
     * Returns true if the given object is an instance of PurgeCache.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is PurgeCache;
    /**

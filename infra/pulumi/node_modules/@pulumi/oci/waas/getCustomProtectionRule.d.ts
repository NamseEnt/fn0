 ...
 * ```
 */
export declare function getCustomProtectionRule(args: GetCustomProtectionRuleArgs, opts?: pulumi.InvokeOptions): Promise<GetCustomProtectionRuleResult>;
/**
 ...
 * ```
 */
export declare function getCustomProtectionRuleOutput(args: GetCustomProtectionRuleOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetCustomProtectionRuleResult>;
/**
 * A collection of arguments for invoking getCustomProtectionRule.
 */

 ...
 * ```
 */
export declare function getHttpRedirect(args: GetHttpRedirectArgs, opts?: pulumi.InvokeOptions): Promise<GetHttpRedirectResult>;
/**
 ...
 * ```
 */
export declare function getHttpRedirectOutput(args: GetHttpRedirectOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetHttpRedirectResult>;
/**
 * A collection of arguments for invoking getHttpRedirect.
 */

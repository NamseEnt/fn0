 ...
 * ```
 */
export declare function getProtectionRule(args: GetProtectionRuleArgs, opts?: pulumi.InvokeOptions): Promise<GetProtectionRuleResult>;
/**
 ...
 * ```
 */
export declare function getProtectionRuleOutput(args: GetProtectionRuleOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetProtectionRuleResult>;
/**
 * A collection of arguments for invoking getProtectionRule.
 */

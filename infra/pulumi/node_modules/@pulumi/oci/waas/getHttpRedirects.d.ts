 ...
 * ```
 */
export declare function getHttpRedirects(args: GetHttpRedirectsArgs, opts?: pulumi.InvokeOptions): Promise<GetHttpRedirectsResult>;
/**
 ...
 * ```
 */
export declare function getHttpRedirectsOutput(args: GetHttpRedirectsOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetHttpRedirectsResult>;
/**
 * A collection of arguments for invoking getHttpRedirects.
 */

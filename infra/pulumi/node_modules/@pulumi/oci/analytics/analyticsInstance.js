 ...
 * ```
 */
class AnalyticsInstance extends pulumi.CustomResource {
    /**
    ...
    static get(name, id, state, opts) {
        return new AnalyticsInstance(name, state, { ...opts, id: id });
    }
    /**
...
exports.AnalyticsInstance = AnalyticsInstance;
/** @internal */
AnalyticsInstance.__pulumiType = 'oci:Analytics/analyticsInstance:AnalyticsInstance';
//# sourceMappingURL=analyticsInstance.js.map
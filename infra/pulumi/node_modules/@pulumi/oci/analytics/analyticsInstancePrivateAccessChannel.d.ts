 ...
 * ```
 */
export declare class AnalyticsInstancePrivateAccessChannel extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: AnalyticsInstancePrivateAccessChannelState, opts?: pulumi.CustomResourceOptions): AnalyticsInstancePrivateAccessChannel;
    /**
     ...
     */
    static isInstance(obj: any): obj is AnalyticsInstancePrivateAccessChannel;
    /**
     * The OCID of the AnalyticsInstance.
     */
    readonly analyticsInstanceId: pulumi.Output<string>;
    /**
     ...
     */
    readonly egressSourceIpAddresses: pulumi.Output<string[]>;
    /**
     ...
     */
    readonly networkSecurityGroupIds: pulumi.Output<string[]>;
    /**
     ...
     */
    readonly privateSourceDnsZones: pulumi.Output<outputs.Analytics.AnalyticsInstancePrivateAccessChannelPrivateSourceDnsZone[]>;
    /**
     * (Updatable) List of Private Source DB SCAN hosts registered with Private Access Channel for access from Analytics Instance.
     */
    readonly privateSourceScanHosts: pulumi.Output<outputs.Analytics.AnalyticsInstancePrivateAccessChannelPrivateSourceScanHost[]>;
    /**

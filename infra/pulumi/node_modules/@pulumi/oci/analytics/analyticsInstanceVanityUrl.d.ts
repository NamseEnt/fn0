 ...
 * ```
 */
export declare class AnalyticsInstanceVanityUrl extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: AnalyticsInstanceVanityUrlState, opts?: pulumi.CustomResourceOptions): AnalyticsInstanceVanityUrl;
    /**
     ...
     */
    static isInstance(obj: any): obj is AnalyticsInstanceVanityUrl;
    /**

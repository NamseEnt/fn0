 ...
 * ```
 */
class DeployEnvironment extends pulumi.CustomResource {
    /**
    ...
    static get(name, id, state, opts) {
        return new DeployEnvironment(name, state, { ...opts, id: id });
    }
    /**
...
/** @internal */
DeployEnvironment.__pulumiType = 'oci:DevOps/deployEnvironment:DeployEnvironment';
//# sourceMappingURL=deployEnvironment.js.map
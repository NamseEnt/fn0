 ...
 * ```
 */
export declare function getRepositoryRefs(args: GetRepositoryRefsArgs, opts?: pulumi.InvokeOptions): Promise<GetRepositoryRefsResult>;
/**
 ...
 * ```
 */
export declare function getRepositoryRefsOutput(args: GetRepositoryRefsOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetRepositoryRefsResult>;
/**
 * A collection of arguments for invoking getRepositoryRefs.
 */

 ...
 * ```
 */
export declare function getRepositoryRef(args: GetRepositoryRefArgs, opts?: pulumi.InvokeOptions): Promise<GetRepositoryRefResult>;
/**
 ...
 * ```
 */
export declare function getRepositoryRefOutput(args: GetRepositoryRefOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetRepositoryRefResult>;
/**
 * A collection of arguments for invoking getRepositoryRef.
 */

 ...
 * ```
 */
class DeployPipeline extends pulumi.CustomResource {
    /**
    ...
    static get(name, id, state, opts) {
        return new DeployPipeline(name, state, { ...opts, id: id });
    }
    /**
...
/** @internal */
DeployPipeline.__pulumiType = 'oci:DevOps/deployPipeline:DeployPipeline';

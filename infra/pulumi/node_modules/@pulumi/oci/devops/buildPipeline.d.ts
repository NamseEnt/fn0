 ...
 * ```
 */
export declare class BuildPipeline extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: BuildPipelineState, opts?: pulumi.CustomResourceOptions): BuildPipeline;
    /**
     * Returns true if the given object is an instance of BuildPipeline.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is BuildPipeline;
    /**
     ...
     */
    readonly buildPipelineParameters: pulumi.Output<outputs.DevOps.BuildPipelineBuildPipelineParameters>;
    /**

 ...
 * ```
 */
export declare function getRepositoryFileDiff(args: GetRepositoryFileDiffArgs, opts?: pulumi.InvokeOptions): Promise<GetRepositoryFileDiffResult>;
/**
 ...
 * ```
 */
export declare function getRepositoryFileDiffOutput(args: GetRepositoryFileDiffOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetRepositoryFileDiffResult>;
/**
 * A collection of arguments for invoking getRepositoryFileDiff.
 */

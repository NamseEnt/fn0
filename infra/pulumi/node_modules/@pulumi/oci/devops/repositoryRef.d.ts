 ...
 * ```
 */
export declare class RepositoryRef extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: RepositoryRefState, opts?: pulumi.CustomResourceOptions): RepositoryRef;
    /**
     * Returns true if the given object is an instance of RepositoryRef.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is RepositoryRef;
    /**
     ...
     */
    readonly fullRefName: pulumi.Output<string>;
    /**
     ...
     */
    readonly refName: pulumi.Output<string>;
    /**
     * (Updatable) The type of reference (BRANCH or TAG).
     */
    readonly refType: pulumi.Output<string>;
    /**

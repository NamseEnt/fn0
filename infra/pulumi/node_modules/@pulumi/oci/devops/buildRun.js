 ...
 * ```
 */
class BuildRun extends pulumi.CustomResource {
    /**
    ...
    static get(name, id, state, opts) {
        return new BuildRun(name, state, { ...opts, id: id });
    }
    /**
...
/** @internal */
BuildRun.__pulumiType = 'oci:DevOps/buildRun:BuildRun';
//# sourceMappingURL=buildRun.js.map
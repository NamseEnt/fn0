 ...
 * ```
 */
export declare function getDeployEnvironment(args: GetDeployEnvironmentArgs, opts?: pulumi.InvokeOptions): Promise<GetDeployEnvironmentResult>;
/**
 ...
 * ```
 */
export declare function getDeployEnvironmentOutput(args: GetDeployEnvironmentOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetDeployEnvironmentResult>;
/**
 * A collection of arguments for invoking getDeployEnvironment.
 */

 ...
 * ```
 */
export declare function getRepositoryCommit(args: GetRepositoryCommitArgs, opts?: pulumi.InvokeOptions): Promise<GetRepositoryCommitResult>;
/**
 ...
 * ```
 */
export declare function getRepositoryCommitOutput(args: GetRepositoryCommitOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetRepositoryCommitResult>;
/**
 * A collection of arguments for invoking getRepositoryCommit.
 */

...
exports.ProjectRepositorySetting = void 0;
 ...
 * ```
 */
class ProjectRepositorySetting extends pulumi.CustomResource {
    /**
    ...
    static get(name, id, state, opts) {
        return new ProjectRepositorySetting(name, state, { ...opts, id: id });
    }
    /**
...
exports.ProjectRepositorySetting = ProjectRepositorySetting;
/** @internal */
ProjectRepositorySetting.__pulumiType = 'oci:DevOps/projectRepositorySetting:ProjectRepositorySetting';
//# sourceMappingURL=projectRepositorySetting.js.map
 ...
 * ```
 */
class DeployStage extends pulumi.CustomResource {
    /**
    ...
    static get(name, id, state, opts) {
        return new DeployStage(name, state, { ...opts, id: id });
    }
    /**
...
/** @internal */
DeployStage.__pulumiType = 'oci:DevOps/deployStage:DeployStage';

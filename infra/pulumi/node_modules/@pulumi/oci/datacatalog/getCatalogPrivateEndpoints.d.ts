 ...
 * ```
 */
export declare function getCatalogPrivateEndpoints(args: GetCatalogPrivateEndpointsArgs, opts?: pulumi.InvokeOptions): Promise<GetCatalogPrivateEndpointsResult>;
/**
 ...
 * ```
 */
export declare function getCatalogPrivateEndpointsOutput(args: GetCatalogPrivateEndpointsOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetCatalogPrivateEndpointsResult>;
/**
 * A collection of arguments for invoking getCatalogPrivateEndpoints.
 */

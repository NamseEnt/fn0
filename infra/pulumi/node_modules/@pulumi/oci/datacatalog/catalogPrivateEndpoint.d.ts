 ...
 * ```
 */
export declare class CatalogPrivateEndpoint extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: CatalogPrivateEndpointState, opts?: pulumi.CustomResourceOptions): CatalogPrivateEndpoint;
    /**
     * Returns true if the given object is an instance of CatalogPrivateEndpoint.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is CatalogPrivateEndpoint;
    /**
     * The list of catalogs using the private reverse connection endpoint
     */
    readonly attachedCatalogs: pulumi.Output<string[]>;
    /**
     ...
     */
    readonly locks: pulumi.Output<outputs.DataCatalog.CatalogPrivateEndpointLock[]>;
    /**

 ...
 * ```
 */
export declare function getCatalogPrivateEndpoint(args: GetCatalogPrivateEndpointArgs, opts?: pulumi.InvokeOptions): Promise<GetCatalogPrivateEndpointResult>;
/**
 ...
 * ```
 */
export declare function getCatalogPrivateEndpointOutput(args: GetCatalogPrivateEndpointOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetCatalogPrivateEndpointResult>;
/**
 * A collection of arguments for invoking getCatalogPrivateEndpoint.
 */

 ...
 * ```
 */
export declare class LogAnalyticsEntityType extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: LogAnalyticsEntityTypeState, opts?: pulumi.CustomResourceOptions): LogAnalyticsEntityType;
    /**
     * Returns true if the given object is an instance of LogAnalyticsEntityType.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is LogAnalyticsEntityType;
    /**
     ...
     */
    readonly internalName: pulumi.Output<string>;
    readonly managementAgentEligibilityStatus: pulumi.Output<string>;
    /**
     ...
     */
    readonly properties: pulumi.Output<outputs.LogAnalytics.LogAnalyticsEntityTypeProperty[]>;
    /**

 ...
 */
export declare class LogAnalyticsPreferencesManagement extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: LogAnalyticsPreferencesManagementState, opts?: pulumi.CustomResourceOptions): LogAnalyticsPreferencesManagement;
    /**
     ...
     */
    static isInstance(obj: any): obj is LogAnalyticsPreferencesManagement;
    /**
     * An array of tenant preference details.
     */
    readonly items: pulumi.Output<outputs.LogAnalytics.LogAnalyticsPreferencesManagementItem[] | undefined>;
    /**

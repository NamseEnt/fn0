 ...
 * ```
 */
export declare function getLogAnalyticsCategoriesList(args: GetLogAnalyticsCategoriesListArgs, opts?: pulumi.InvokeOptions): Promise<GetLogAnalyticsCategoriesListResult>;
/**
 ...
 * ```
 */
export declare function getLogAnalyticsCategoriesListOutput(args: GetLogAnalyticsCategoriesListOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetLogAnalyticsCategoriesListResult>;
/**
 * A collection of arguments for invoking getLogAnalyticsCategoriesList.
 */

 ...
 * ```
 */
export declare function getLogAnalyticsLogGroupsSummary(args: GetLogAnalyticsLogGroupsSummaryArgs, opts?: pulumi.InvokeOptions): Promise<GetLogAnalyticsLogGroupsSummaryResult>;
/**
 ...
 * ```
 */
export declare function getLogAnalyticsLogGroupsSummaryOutput(args: GetLogAnalyticsLogGroupsSummaryOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetLogAnalyticsLogGroupsSummaryResult>;
/**
 * A collection of arguments for invoking getLogAnalyticsLogGroupsSummary.
 */

 ...
 * ```
 */
export declare function getNamespaceStorageOverlappingRecalls(args: GetNamespaceStorageOverlappingRecallsArgs, opts?: pulumi.InvokeOptions): Promise<GetNamespaceStorageOverlappingRecallsResult>;
/**
 ...
 * ```
 */
export declare function getNamespaceStorageOverlappingRecallsOutput(args: GetNamespaceStorageOverlappingRecallsOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetNamespaceStorageOverlappingRecallsResult>;
/**
 * A collection of arguments for invoking getNamespaceStorageOverlappingRecalls.
 */

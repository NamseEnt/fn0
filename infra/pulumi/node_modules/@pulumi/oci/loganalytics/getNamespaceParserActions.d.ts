 ...
 * ```
 */
export declare function getNamespaceParserActions(args: GetNamespaceParserActionsArgs, opts?: pulumi.InvokeOptions): Promise<GetNamespaceParserActionsResult>;
/**
 ...
 * ```
 */
export declare function getNamespaceParserActionsOutput(args: GetNamespaceParserActionsOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetNamespaceParserActionsResult>;
/**
 * A collection of arguments for invoking getNamespaceParserActions.
 */

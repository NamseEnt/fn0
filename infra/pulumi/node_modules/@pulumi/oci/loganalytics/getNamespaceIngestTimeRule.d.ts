 ...
 * ```
 */
export declare function getNamespaceIngestTimeRule(args: GetNamespaceIngestTimeRuleArgs, opts?: pulumi.InvokeOptions): Promise<GetNamespaceIngestTimeRuleResult>;
/**
 ...
 * ```
 */
export declare function getNamespaceIngestTimeRuleOutput(args: GetNamespaceIngestTimeRuleOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetNamespaceIngestTimeRuleResult>;
/**
 * A collection of arguments for invoking getNamespaceIngestTimeRule.
 */

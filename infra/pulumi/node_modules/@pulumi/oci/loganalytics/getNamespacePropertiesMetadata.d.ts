 ...
 * ```
 */
export declare function getNamespacePropertiesMetadata(args: GetNamespacePropertiesMetadataArgs, opts?: pulumi.InvokeOptions): Promise<GetNamespacePropertiesMetadataResult>;
/**
 ...
 * ```
 */
export declare function getNamespacePropertiesMetadataOutput(args: GetNamespacePropertiesMetadataOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetNamespacePropertiesMetadataResult>;
/**
 * A collection of arguments for invoking getNamespacePropertiesMetadata.
 */

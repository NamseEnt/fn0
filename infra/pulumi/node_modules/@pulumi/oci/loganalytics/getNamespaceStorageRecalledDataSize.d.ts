 ...
 * ```
 */
export declare function getNamespaceStorageRecalledDataSize(args: GetNamespaceStorageRecalledDataSizeArgs, opts?: pulumi.InvokeOptions): Promise<GetNamespaceStorageRecalledDataSizeResult>;
/**
 ...
 * ```
 */
export declare function getNamespaceStorageRecalledDataSizeOutput(args: GetNamespaceStorageRecalledDataSizeOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetNamespaceStorageRecalledDataSizeResult>;
/**
 * A collection of arguments for invoking getNamespaceStorageRecalledDataSize.
 */

 ...
 * ```
 */
export declare function getNamespaceFieldUsage(args: GetNamespaceFieldUsageArgs, opts?: pulumi.InvokeOptions): Promise<GetNamespaceFieldUsageResult>;
/**
 ...
 * ```
 */
export declare function getNamespaceFieldUsageOutput(args: GetNamespaceFieldUsageOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetNamespaceFieldUsageResult>;
/**
 * A collection of arguments for invoking getNamespaceFieldUsage.
 */

 ...
 * ```
 */
export declare class NamespaceStorageEnableDisableArchiving extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: NamespaceStorageEnableDisableArchivingState, opts?: pulumi.CustomResourceOptions): NamespaceStorageEnableDisableArchiving;
    /**
     ...
     */
    static isInstance(obj: any): obj is NamespaceStorageEnableDisableArchiving;
    /**
     ...
     */
    readonly enableArchivingTenant: pulumi.Output<boolean>;
    /**
     ...
     */
    constructor(name: string, args: NamespaceStorageEnableDisableArchivingArgs, opts?: pulumi.CustomResourceOptions);
}
/**
 * Input properties used for looking up and filtering NamespaceStorageEnableDisableArchiving resources.
 */
export interface NamespaceStorageEnableDisableArchivingState {
    /**
     * (Updatable) A required field when set to `true` calls enable action and when set to `false` calls disable action.
     *
     *
 ...
 */
export interface NamespaceStorageEnableDisableArchivingArgs {
    /**
     * (Updatable) A required field when set to `true` calls enable action and when set to `false` calls disable action.
     *
     *

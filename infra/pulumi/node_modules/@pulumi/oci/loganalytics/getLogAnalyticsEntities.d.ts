 ...
 * ```
 */
export declare function getLogAnalyticsEntities(args: GetLogAnalyticsEntitiesArgs, opts?: pulumi.InvokeOptions): Promise<GetLogAnalyticsEntitiesResult>;
/**
 ...
 * ```
 */
export declare function getLogAnalyticsEntitiesOutput(args: GetLogAnalyticsEntitiesOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetLogAnalyticsEntitiesResult>;
/**
 * A collection of arguments for invoking getLogAnalyticsEntities.
 */

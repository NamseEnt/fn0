 ...
 * ```
 */
export declare function getNamespaceTemplates(args: GetNamespaceTemplatesArgs, opts?: pulumi.InvokeOptions): Promise<GetNamespaceTemplatesResult>;
/**
 ...
 * ```
 */
export declare function getNamespaceTemplatesOutput(args: GetNamespaceTemplatesOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetNamespaceTemplatesResult>;
/**
 * A collection of arguments for invoking getNamespaceTemplates.
 */

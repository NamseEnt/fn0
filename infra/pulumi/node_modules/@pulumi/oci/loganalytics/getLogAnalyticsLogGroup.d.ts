 ...
 * ```
 */
export declare function getLogAnalyticsLogGroup(args: GetLogAnalyticsLogGroupArgs, opts?: pulumi.InvokeOptions): Promise<GetLogAnalyticsLogGroupResult>;
/**
 ...
 * ```
 */
export declare function getLogAnalyticsLogGroupOutput(args: GetLogAnalyticsLogGroupOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetLogAnalyticsLogGroupResult>;
/**
 * A collection of arguments for invoking getLogAnalyticsLogGroup.
 */

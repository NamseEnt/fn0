 ...
 * ```
 */
export declare function getNamespaceLookup(args: GetNamespaceLookupArgs, opts?: pulumi.InvokeOptions): Promise<GetNamespaceLookupResult>;
/**
 ...
 * ```
 */
export declare function getNamespaceLookupOutput(args: GetNamespaceLookupOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetNamespaceLookupResult>;
/**
 * A collection of arguments for invoking getNamespaceLookup.
 */

 ...
 * ```
 */
export declare function getLogAnalyticsLogGroups(args: GetLogAnalyticsLogGroupsArgs, opts?: pulumi.InvokeOptions): Promise<GetLogAnalyticsLogGroupsResult>;
/**
 ...
 * ```
 */
export declare function getLogAnalyticsLogGroupsOutput(args: GetLogAnalyticsLogGroupsOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetLogAnalyticsLogGroupsResult>;
/**
 * A collection of arguments for invoking getLogAnalyticsLogGroups.
 */

 ...
 * ```
 */
export declare function getLogSetsCount(args: GetLogSetsCountArgs, opts?: pulumi.InvokeOptions): Promise<GetLogSetsCountResult>;
/**
 ...
 * ```
 */
export declare function getLogSetsCountOutput(args: GetLogSetsCountOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetLogSetsCountResult>;
/**
 * A collection of arguments for invoking getLogSetsCount.
 */

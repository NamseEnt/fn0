 ...
 */
export declare class LogAnalyticsUnprocessedDataBucketManagement extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: LogAnalyticsUnprocessedDataBucketManagementState, opts?: pulumi.CustomResourceOptions): LogAnalyticsUnprocessedDataBucketManagement;
    /**
     ...
     */
    static isInstance(obj: any): obj is LogAnalyticsUnprocessedDataBucketManagement;
    /**

 ...
 * ```
 */
export declare class NamespaceIngestTimeRule extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: NamespaceIngestTimeRuleState, opts?: pulumi.CustomResourceOptions): NamespaceIngestTimeRule;
    /**
     * Returns true if the given object is an instance of NamespaceIngestTimeRule.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is NamespaceIngestTimeRule;
    /**
     * (Updatable) The action(s) to be performed if the ingest time rule condition(s) are satisfied.
     */
    readonly actions: pulumi.Output<outputs.LogAnalytics.NamespaceIngestTimeRuleAction[]>;
    /**
     ...
     */
    readonly conditions: pulumi.Output<outputs.LogAnalytics.NamespaceIngestTimeRuleConditions>;
    /**
    ...
    readonly ingestTimeRuleId: pulumi.Output<string>;
    /**

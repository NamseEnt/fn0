 ...
 * ```
 */
export declare function getNamespaceScheduledTask(args: GetNamespaceScheduledTaskArgs, opts?: pulumi.InvokeOptions): Promise<GetNamespaceScheduledTaskResult>;
/**
 ...
 * ```
 */
export declare function getNamespaceScheduledTaskOutput(args: GetNamespaceScheduledTaskOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetNamespaceScheduledTaskResult>;
/**
 * A collection of arguments for invoking getNamespaceScheduledTask.
 */

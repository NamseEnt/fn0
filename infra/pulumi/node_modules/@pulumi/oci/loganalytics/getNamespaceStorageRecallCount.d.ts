 ...
 * ```
 */
export declare function getNamespaceStorageRecallCount(args: GetNamespaceStorageRecallCountArgs, opts?: pulumi.InvokeOptions): Promise<GetNamespaceStorageRecallCountResult>;
/**
 ...
 * ```
 */
export declare function getNamespaceStorageRecallCountOutput(args: GetNamespaceStorageRecallCountOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetNamespaceStorageRecallCountResult>;
/**
 * A collection of arguments for invoking getNamespaceStorageRecallCount.
 */

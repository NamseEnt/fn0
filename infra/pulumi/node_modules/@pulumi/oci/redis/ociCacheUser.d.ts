 ...
 * ```
 */
export declare class OciCacheUser extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: OciCacheUserState, opts?: pulumi.CustomResourceOptions): OciCacheUser;
    /**
     * Returns true if the given object is an instance of OciCacheUser.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is OciCacheUser;
    /**
     * (Updatable) ACL string of Oracle Cloud Infrastructure cache user.
     */
    readonly aclString: pulumi.Output<string>;
    /**
     * (Updatable) These are the Authentication details of an Oracle Cloud Infrastructure cache user.
     */
    readonly authenticationMode: pulumi.Output<outputs.Redis.OciCacheUserAuthenticationMode>;
    /**

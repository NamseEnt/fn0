 ...
 */
export declare class OciCacheConfigSetlistAssociatedOciCacheCluster extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: OciCacheConfigSetlistAssociatedOciCacheClusterState, opts?: pulumi.CustomResourceOptions): OciCacheConfigSetlistAssociatedOciCacheCluster;
    /**
     ...
     */
    static isInstance(obj: any): obj is OciCacheConfigSetlistAssociatedOciCacheCluster;
    /**
     * List of clusters with the same Oracle Cloud Infrastructure Cache Config Set ID.
     */
    readonly items: pulumi.Output<outputs.Redis.OciCacheConfigSetlistAssociatedOciCacheClusterItem[]>;
    /**
     ...
     */
    readonly ociCacheConfigSetId: pulumi.Output<string>;
    /**

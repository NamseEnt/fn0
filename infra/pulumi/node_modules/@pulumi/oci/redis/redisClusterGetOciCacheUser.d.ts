 ...
 */
export declare class RedisClusterGetOciCacheUser extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: RedisClusterGetOciCacheUserState, opts?: pulumi.CustomResourceOptions): RedisClusterGetOciCacheUser;
    /**
     ...
     */
    static isInstance(obj: any): obj is RedisClusterGetOciCacheUser;
    /**
    ...
    readonly ociCacheUsers: pulumi.Output<outputs.Redis.RedisClusterGetOciCacheUserOciCacheUser[]>;
    /**

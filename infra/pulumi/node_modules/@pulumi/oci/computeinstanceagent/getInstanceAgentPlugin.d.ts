 ...
 * ```
 */
export declare function getInstanceAgentPlugin(args: GetInstanceAgentPluginArgs, opts?: pulumi.InvokeOptions): Promise<GetInstanceAgentPluginResult>;
/**
 ...
 * ```
 */
export declare function getInstanceAgentPluginOutput(args: GetInstanceAgentPluginOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetInstanceAgentPluginResult>;
/**
 * A collection of arguments for invoking getInstanceAgentPlugin.
 */

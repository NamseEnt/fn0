 ...
 * ```
 */
export declare function getInstanceAvailablePlugin(args: GetInstanceAvailablePluginArgs, opts?: pulumi.InvokeOptions): Promise<GetInstanceAvailablePluginResult>;
/**
 ...
 * ```
 */
export declare function getInstanceAvailablePluginOutput(args: GetInstanceAvailablePluginOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetInstanceAvailablePluginResult>;
/**
 * A collection of arguments for invoking getInstanceAvailablePlugin.
 */

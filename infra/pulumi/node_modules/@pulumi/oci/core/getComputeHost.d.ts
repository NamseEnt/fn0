 ...
 * ```
 */
export declare function getComputeHost(args: GetComputeHostArgs, opts?: pulumi.InvokeOptions): Promise<GetComputeHostResult>;
/**
 ...
 * ```
 */
export declare function getComputeHostOutput(args: GetComputeHostOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetComputeHostResult>;
/**
 * A collection of arguments for invoking getComputeHost.
 */

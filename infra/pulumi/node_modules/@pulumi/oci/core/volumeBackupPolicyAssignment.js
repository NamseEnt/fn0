 ...
 * ```
 */
class VolumeBackupPolicyAssignment extends pulumi.CustomResource {
    /**
    ...
    static get(name, id, state, opts) {
        return new VolumeBackupPolicyAssignment(name, state, { ...opts, id: id });
    }
    /**
...
exports.VolumeBackupPolicyAssignment = VolumeBackupPolicyAssignment;
/** @internal */
VolumeBackupPolicyAssignment.__pulumiType = 'oci:Core/volumeBackupPolicyAssignment:VolumeBackupPolicyAssignment';
//# sourceMappingURL=volumeBackupPolicyAssignment.js.map
 ...
 * ```
 */
export declare function getCaptureFilter(args: GetCaptureFilterArgs, opts?: pulumi.InvokeOptions): Promise<GetCaptureFilterResult>;
/**
 ...
 * ```
 */
export declare function getCaptureFilterOutput(args: GetCaptureFilterOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetCaptureFilterResult>;
/**
 * A collection of arguments for invoking getCaptureFilter.
 */

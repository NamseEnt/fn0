 ...
 * ```
 */
export declare function getSecurityLists(args: GetSecurityListsArgs, opts?: pulumi.InvokeOptions): Promise<GetSecurityListsResult>;
/**
 ...
 * ```
 */
export declare function getSecurityListsOutput(args: GetSecurityListsOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetSecurityListsResult>;
/**
 * A collection of arguments for invoking getSecurityLists.
 */

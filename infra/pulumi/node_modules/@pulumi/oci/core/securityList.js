 ...
 * ```
 */
class SecurityList extends pulumi.CustomResource {
    /**
    ...
    static get(name, id, state, opts) {
        return new SecurityList(name, state, { ...opts, id: id });
    }
    /**
...
exports.SecurityList = SecurityList;
/** @internal */
SecurityList.__pulumiType = 'oci:Core/securityList:SecurityList';
//# sourceMappingURL=securityList.js.map
 ...
 * ```
 */
export declare function getIpInventorySubnetCidr(args: GetIpInventorySubnetCidrArgs, opts?: pulumi.InvokeOptions): Promise<GetIpInventorySubnetCidrResult>;
/**
 ...
 * ```
 */
export declare function getIpInventorySubnetCidrOutput(args: GetIpInventorySubnetCidrOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetIpInventorySubnetCidrResult>;
/**
 * A collection of arguments for invoking getIpInventorySubnetCidr.
 */

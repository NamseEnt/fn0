 ...
 * ```
 */
class ComputeHostGroup extends pulumi.CustomResource {
    /**
    ...
    static get(name, id, state, opts) {
        return new ComputeHostGroup(name, state, { ...opts, id: id });
    }
    /**
...
exports.ComputeHostGroup = ComputeHostGroup;
/** @internal */
ComputeHostGroup.__pulumiType = 'oci:Core/computeHostGroup:ComputeHostGroup';
//# sourceMappingURL=computeHostGroup.js.map
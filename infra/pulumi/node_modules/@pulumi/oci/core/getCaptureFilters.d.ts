 ...
 * ```
 */
export declare function getCaptureFilters(args: GetCaptureFiltersArgs, opts?: pulumi.InvokeOptions): Promise<GetCaptureFiltersResult>;
/**
 ...
 * ```
 */
export declare function getCaptureFiltersOutput(args: GetCaptureFiltersOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetCaptureFiltersResult>;
/**
 * A collection of arguments for invoking getCaptureFilters.
 */

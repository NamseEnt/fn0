 ...
 * ```
 */
export declare function getDedicatedVmHostShapes(args: GetDedicatedVmHostShapesArgs, opts?: pulumi.InvokeOptions): Promise<GetDedicatedVmHostShapesResult>;
/**
 ...
 * ```
 */
export declare function getDedicatedVmHostShapesOutput(args: GetDedicatedVmHostShapesOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetDedicatedVmHostShapesResult>;
/**
 * A collection of arguments for invoking getDedicatedVmHostShapes.
 */

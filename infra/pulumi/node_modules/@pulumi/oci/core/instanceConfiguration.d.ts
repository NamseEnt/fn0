 ...
 * ```
 */
export declare class InstanceConfiguration extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: InstanceConfigurationState, opts?: pulumi.CustomResourceOptions): InstanceConfiguration;
    /**
     * Returns true if the given object is an instance of InstanceConfiguration.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is InstanceConfiguration;
    /**
     ...
     */
    readonly deferredFields: pulumi.Output<string[]>;
    /**
    ...
    readonly instanceDetails: pulumi.Output<outputs.Core.InstanceConfigurationInstanceDetails>;
    /**

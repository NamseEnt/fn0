 ...
 * ```
 */
export declare class DrgRouteDistribution extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: DrgRouteDistributionState, opts?: pulumi.CustomResourceOptions): DrgRouteDistribution;
    /**
     * Returns true if the given object is an instance of DrgRouteDistribution.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is DrgRouteDistribution;
    /**
     ...
     */
    readonly distributionType: pulumi.Output<string>;
    /**

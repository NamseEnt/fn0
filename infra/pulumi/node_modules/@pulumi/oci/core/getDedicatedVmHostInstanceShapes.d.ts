 ...
 * ```
 */
export declare function getDedicatedVmHostInstanceShapes(args: GetDedicatedVmHostInstanceShapesArgs, opts?: pulumi.InvokeOptions): Promise<GetDedicatedVmHostInstanceShapesResult>;
/**
 ...
 * ```
 */
export declare function getDedicatedVmHostInstanceShapesOutput(args: GetDedicatedVmHostInstanceShapesOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetDedicatedVmHostInstanceShapesResult>;
/**
 * A collection of arguments for invoking getDedicatedVmHostInstanceShapes.
 */

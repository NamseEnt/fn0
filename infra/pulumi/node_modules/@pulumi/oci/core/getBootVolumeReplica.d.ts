 ...
 * ```
 */
export declare function getBootVolumeReplica(args: GetBootVolumeReplicaArgs, opts?: pulumi.InvokeOptions): Promise<GetBootVolumeReplicaResult>;
/**
 ...
 * ```
 */
export declare function getBootVolumeReplicaOutput(args: GetBootVolumeReplicaOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetBootVolumeReplicaResult>;
/**
 * A collection of arguments for invoking getBootVolumeReplica.
 */

 ...
 * ```
 */
export declare class Ipsec extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: IpsecState, opts?: pulumi.CustomResourceOptions): Ipsec;
    /**
     * Returns true if the given object is an instance of Ipsec.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is Ipsec;
    /**
     ...
     */
    readonly cpeId: pulumi.Output<string>;
    /**
     ...
     */
    readonly cpeLocalIdentifier: pulumi.Output<string>;
    /**
     ...
     */
    readonly cpeLocalIdentifierType: pulumi.Output<string>;
    /**
     ...
     * Example: `10.0.1.0/24`
     */
    readonly staticRoutes: pulumi.Output<string[]>;
    /**
     ...
     */
    readonly tunnelConfigurations: pulumi.Output<outputs.Core.IpsecTunnelConfiguration[]>;
    /**

 ...
 * ```
 */
export declare function getIpv6s(args?: GetIpv6sArgs, opts?: pulumi.InvokeOptions): Promise<GetIpv6sResult>;
/**
 ...
 * ```
 */
export declare function getIpv6sOutput(args?: GetIpv6sOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetIpv6sResult>;
/**
 * A collection of arguments for invoking getIpv6s.
 */

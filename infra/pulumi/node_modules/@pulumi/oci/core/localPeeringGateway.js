 ...
 * ```
 */
class LocalPeeringGateway extends pulumi.CustomResource {
    /**
    ...
    static get(name, id, state, opts) {
        return new LocalPeeringGateway(name, state, { ...opts, id: id });
    }
    /**
...
exports.LocalPeeringGateway = LocalPeeringGateway;
/** @internal */
LocalPeeringGateway.__pulumiType = 'oci:Core/localPeeringGateway:LocalPeeringGateway';
//# sourceMappingURL=localPeeringGateway.js.map
...
export declare class Subnet extends pulumi.CustomResource {
     ...
     */
    readonly ipv4cidrBlocks: pulumi.Output<string[]>;
    /**
     ...
     */
    readonly ipv6virtualRouterIp: pulumi.Output<string>;
    /**
     ...
     * Example: `true`
     */
    readonly prohibitInternetIngress: pulumi.Output<boolean>;
    /**
     ...
     * Example: `true`
     */
    readonly prohibitPublicIpOnVnic: pulumi.Output<boolean>;
    /**
     ...
     */
    readonly securityListIds: pulumi.Output<string[]>;
    /**
     ...
     */
    readonly subnetDomainName: pulumi.Output<string>;
    /**
     ...
     */
    readonly virtualRouterIp: pulumi.Output<string>;
    /**
     * The MAC address of the virtual router.  Example: `00:00:00:00:00:01`
     */
    readonly virtualRouterMac: pulumi.Output<string>;
    /**

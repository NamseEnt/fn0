 ...
 * ```
 */
export declare function getDedicatedVmHostInstances(args: GetDedicatedVmHostInstancesArgs, opts?: pulumi.InvokeOptions): Promise<GetDedicatedVmHostInstancesResult>;
/**
 ...
 * ```
 */
export declare function getDedicatedVmHostInstancesOutput(args: GetDedicatedVmHostInstancesOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetDedicatedVmHostInstancesResult>;
/**
 * A collection of arguments for invoking getDedicatedVmHostInstances.
 */

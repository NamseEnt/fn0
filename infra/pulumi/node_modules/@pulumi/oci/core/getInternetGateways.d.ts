 ...
 * ```
 */
export declare function getInternetGateways(args: GetInternetGatewaysArgs, opts?: pulumi.InvokeOptions): Promise<GetInternetGatewaysResult>;
/**
 ...
 * ```
 */
export declare function getInternetGatewaysOutput(args: GetInternetGatewaysOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetInternetGatewaysResult>;
/**
 * A collection of arguments for invoking getInternetGateways.
 */

 ...
 * ```
 */
class InstanceConfiguration extends pulumi.CustomResource {
    /**
    ...
    static get(name, id, state, opts) {
        return new InstanceConfiguration(name, state, { ...opts, id: id });
    }
    /**
...
/** @internal */
InstanceConfiguration.__pulumiType = 'oci:Core/instanceConfiguration:InstanceConfiguration';

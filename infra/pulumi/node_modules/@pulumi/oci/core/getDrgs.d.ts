 ...
 * ```
 */
export declare function getDrgs(args: GetDrgsArgs, opts?: pulumi.InvokeOptions): Promise<GetDrgsResult>;
/**
 ...
 * ```
 */
export declare function getDrgsOutput(args: GetDrgsOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetDrgsResult>;
/**
 * A collection of arguments for invoking getDrgs.
 */

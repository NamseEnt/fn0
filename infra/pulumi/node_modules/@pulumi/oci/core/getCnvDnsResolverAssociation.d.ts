 ...
 * ```
 */
export declare function getCnvDnsResolverAssociation(args: GetCnvDnsResolverAssociationArgs, opts?: pulumi.InvokeOptions): Promise<GetCnvDnsResolverAssociationResult>;
/**
 ...
 * ```
 */
export declare function getCnvDnsResolverAssociationOutput(args: GetCnvDnsResolverAssociationOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetCnvDnsResolverAssociationResult>;
/**
 * A collection of arguments for invoking getCnvDnsResolverAssociation.
 */

 ...
 * ```
 */
export declare function getIpsecConnectionTunnelRoutes(args: GetIpsecConnectionTunnelRoutesArgs, opts?: pulumi.InvokeOptions): Promise<GetIpsecConnectionTunnelRoutesResult>;
/**
 ...
 * ```
 */
export declare function getIpsecConnectionTunnelRoutesOutput(args: GetIpsecConnectionTunnelRoutesOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetIpsecConnectionTunnelRoutesResult>;
/**
 * A collection of arguments for invoking getIpsecConnectionTunnelRoutes.
 */

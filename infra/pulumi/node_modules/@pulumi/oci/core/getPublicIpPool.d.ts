 ...
 * ```
 */
export declare function getPublicIpPool(args: GetPublicIpPoolArgs, opts?: pulumi.InvokeOptions): Promise<GetPublicIpPoolResult>;
/**
 ...
 * ```
 */
export declare function getPublicIpPoolOutput(args: GetPublicIpPoolOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetPublicIpPoolResult>;
/**
 * A collection of arguments for invoking getPublicIpPool.
 */

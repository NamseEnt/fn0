 ...
 * ```
 */
export declare class BootVolumeBackup extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: BootVolumeBackupState, opts?: pulumi.CustomResourceOptions): BootVolumeBackup;
    /**
     * Returns true if the given object is an instance of BootVolumeBackup.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is BootVolumeBackup;
    /**
     ...
     */
    readonly sourceBootVolumeBackupId: pulumi.Output<string>;
    /**
     * Details of the volume backup source in the cloud. Cannot be defined if `bootVolumeId` is defined.
     */
    readonly sourceDetails: pulumi.Output<outputs.Core.BootVolumeBackupSourceDetails | undefined>;
    /**

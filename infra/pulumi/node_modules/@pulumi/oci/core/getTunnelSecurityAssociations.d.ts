 ...
 * ```
 */
export declare function getTunnelSecurityAssociations(args: GetTunnelSecurityAssociationsArgs, opts?: pulumi.InvokeOptions): Promise<GetTunnelSecurityAssociationsResult>;
/**
 ...
 * ```
 */
export declare function getTunnelSecurityAssociationsOutput(args: GetTunnelSecurityAssociationsOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetTunnelSecurityAssociationsResult>;
/**
 * A collection of arguments for invoking getTunnelSecurityAssociations.
 */

 ...
 * ```
 */
export declare class CaptureFilter extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: CaptureFilterState, opts?: pulumi.CustomResourceOptions): CaptureFilter;
    /**
     * Returns true if the given object is an instance of CaptureFilter.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is CaptureFilter;
    /**
     ...
     */
    readonly flowLogCaptureFilterRules: pulumi.Output<outputs.Core.CaptureFilterFlowLogCaptureFilterRule[]>;
    /**
     ...
     */
    readonly vtapCaptureFilterRules: pulumi.Output<outputs.Core.CaptureFilterVtapCaptureFilterRule[]>;
    /**

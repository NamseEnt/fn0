 ...
 * ```
 */
export declare class InstancePoolInstance extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: InstancePoolInstanceState, opts?: pulumi.CustomResourceOptions): InstancePoolInstance;
    /**
     * Returns true if the given object is an instance of InstancePoolInstance.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is InstancePoolInstance;
    readonly autoTerminateInstanceOnDelete: pulumi.Output<boolean | undefined>;
    /**
    ...
    readonly decrementSizeOnDelete: pulumi.Output<boolean | undefined>;
    /**
     ...
     */
    readonly loadBalancerBackends: pulumi.Output<outputs.Core.InstancePoolInstanceLoadBalancerBackend[]>;
    /**

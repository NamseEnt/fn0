 ...
 * ```
 */
export declare class BootVolume extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: BootVolumeState, opts?: pulumi.CustomResourceOptions): BootVolume;
    /**
     * Returns true if the given object is an instance of BootVolume.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is BootVolume;
    /**
     * The number of Volume Performance Units per GB that this boot volume is effectively tuned to.
     */
    readonly autoTunedVpusPerGb: pulumi.Output<string>;
    /**
     * (Updatable) The list of autotune policies to be enabled for this volume.
     */
    readonly autotunePolicies: pulumi.Output<outputs.Core.BootVolumeAutotunePolicy[]>;
    /**
     ...
     */
    readonly bootVolumeReplicas: pulumi.Output<outputs.Core.BootVolumeBootVolumeReplica[]>;
    readonly bootVolumeReplicasDeletion: pulumi.Output<boolean | undefined>;
    /**
     ...
     */
    readonly isAutoTuneEnabled: pulumi.Output<boolean>;
    /**
    ...
    readonly sourceDetails: pulumi.Output<outputs.Core.BootVolumeSourceDetails>;
    /**

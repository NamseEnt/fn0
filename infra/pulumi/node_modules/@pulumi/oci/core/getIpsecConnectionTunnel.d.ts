 ...
 * ```
 */
export declare function getIpsecConnectionTunnel(args: GetIpsecConnectionTunnelArgs, opts?: pulumi.InvokeOptions): Promise<GetIpsecConnectionTunnelResult>;
/**
 ...
 * ```
 */
export declare function getIpsecConnectionTunnelOutput(args: GetIpsecConnectionTunnelOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetIpsecConnectionTunnelResult>;
/**
 * A collection of arguments for invoking getIpsecConnectionTunnel.
 */

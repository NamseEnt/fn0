 ...
 * ```
 */
export declare function getDedicatedVmHosts(args: GetDedicatedVmHostsArgs, opts?: pulumi.InvokeOptions): Promise<GetDedicatedVmHostsResult>;
/**
 ...
 * ```
 */
export declare function getDedicatedVmHostsOutput(args: GetDedicatedVmHostsOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetDedicatedVmHostsResult>;
/**
 * A collection of arguments for invoking getDedicatedVmHosts.
 */

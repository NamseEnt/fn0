 ...
 * ```
 */
export declare function getVnic(args: GetVnicArgs, opts?: pulumi.InvokeOptions): Promise<GetVnicResult>;
/**
 ...
 * ```
 */
export declare function getVnicOutput(args: GetVnicOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetVnicResult>;
/**
 * A collection of arguments for invoking getVnic.
 */

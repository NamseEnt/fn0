 ...
 * ```
 */
export declare function getPrivateIp(args: GetPrivateIpArgs, opts?: pulumi.InvokeOptions): Promise<GetPrivateIpResult>;
/**
 ...
 * ```
 */
export declare function getPrivateIpOutput(args: GetPrivateIpOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetPrivateIpResult>;
/**
 * A collection of arguments for invoking getPrivateIp.
 */

 ...
 * ```
 */
export declare function getFastConnectProviderService(args: GetFastConnectProviderServiceArgs, opts?: pulumi.InvokeOptions): Promise<GetFastConnectProviderServiceResult>;
/**
 ...
 * ```
 */
export declare function getFastConnectProviderServiceOutput(args: GetFastConnectProviderServiceOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetFastConnectProviderServiceResult>;
/**
 * A collection of arguments for invoking getFastConnectProviderService.
 */

 ...
 * ```
 */
export declare function getClusterNetwork(args: GetClusterNetworkArgs, opts?: pulumi.InvokeOptions): Promise<GetClusterNetworkResult>;
/**
 ...
 * ```
 */
export declare function getClusterNetworkOutput(args: GetClusterNetworkOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetClusterNetworkResult>;
/**
 * A collection of arguments for invoking getClusterNetwork.
 */

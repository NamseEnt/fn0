 ...
 * ```
 */
export declare function getVcns(args: GetVcnsArgs, opts?: pulumi.InvokeOptions): Promise<GetVcnsResult>;
/**
 ...
 * ```
 */
export declare function getVcnsOutput(args: GetVcnsOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetVcnsResult>;
/**
 * A collection of arguments for invoking getVcns.
 */

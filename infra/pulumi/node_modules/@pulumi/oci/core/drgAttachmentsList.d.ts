 ...
 */
export declare class DrgAttachmentsList extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: DrgAttachmentsListState, opts?: pulumi.CustomResourceOptions): DrgAttachmentsList;
    /**
     * Returns true if the given object is an instance of DrgAttachmentsList.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is DrgAttachmentsList;
    /**
     * The type for the network resource attached to the DRG.
     */
    readonly attachmentType: pulumi.Output<string | undefined>;
    /**
     * The list of drg_attachments.
     */
    readonly drgAllAttachments: pulumi.Output<outputs.Core.DrgAttachmentsListDrgAllAttachment[]>;
    /**
     ...
     */
    readonly isCrossTenancy: pulumi.Output<boolean | undefined>;
    /**

 ...
 * ```
 */
export declare class DedicatedVmHost extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: DedicatedVmHostState, opts?: pulumi.CustomResourceOptions): DedicatedVmHost;
    /**
     * Returns true if the given object is an instance of DedicatedVmHost.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is DedicatedVmHost;
    /**
     ...
     */
    readonly dedicatedVmHostShape: pulumi.Output<string>;
    /**
     ...
     */
    readonly remainingMemoryInGbs: pulumi.Output<number>;
    /**
     * The current available OCPUs of the dedicated VM host.
     */
    readonly remainingOcpus: pulumi.Output<number>;
    /**
     ...
     */
    readonly totalMemoryInGbs: pulumi.Output<number>;
    /**
     * The current total OCPUs of the dedicated VM host.
     */
    readonly totalOcpus: pulumi.Output<number>;
    /**

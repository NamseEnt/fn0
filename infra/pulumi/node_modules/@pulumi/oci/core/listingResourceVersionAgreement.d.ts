 ...
 * ```
 */
export declare class ListingResourceVersionAgreement extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ListingResourceVersionAgreementState, opts?: pulumi.CustomResourceOptions): ListingResourceVersionAgreement;
    /**
     ...
     */
    static isInstance(obj: any): obj is ListingResourceVersionAgreement;
    /**
     * EULA link
     */
    readonly eulaLink: pulumi.Output<string>;
    /**

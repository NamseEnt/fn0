 ...
 * ```
 */
export declare function getIpInventoryVcnOverlaps(args: GetIpInventoryVcnOverlapsArgs, opts?: pulumi.InvokeOptions): Promise<GetIpInventoryVcnOverlapsResult>;
/**
 ...
 * ```
 */
export declare function getIpInventoryVcnOverlapsOutput(args: GetIpInventoryVcnOverlapsOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetIpInventoryVcnOverlapsResult>;
/**
 * A collection of arguments for invoking getIpInventoryVcnOverlaps.
 */

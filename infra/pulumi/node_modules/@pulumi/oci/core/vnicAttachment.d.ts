 ...
 * ```
 */
export declare class VnicAttachment extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: VnicAttachmentState, opts?: pulumi.CustomResourceOptions): VnicAttachment;
    /**
     * Returns true if the given object is an instance of VnicAttachment.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is VnicAttachment;
    /**
     ...
     */
    readonly createVnicDetails: pulumi.Output<outputs.Core.VnicAttachmentCreateVnicDetails>;
    /**
     ...
     */
    readonly nicIndex: pulumi.Output<number>;
    /**
     ...
     */
    readonly vlanTag: pulumi.Output<number>;
    /**

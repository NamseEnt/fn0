 ...
 * ```
 */
export declare function getCrossConnect(args: GetCrossConnectArgs, opts?: pulumi.InvokeOptions): Promise<GetCrossConnectResult>;
/**
 ...
 * ```
 */
export declare function getCrossConnectOutput(args: GetCrossConnectOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetCrossConnectResult>;
/**
 * A collection of arguments for invoking getCrossConnect.
 */

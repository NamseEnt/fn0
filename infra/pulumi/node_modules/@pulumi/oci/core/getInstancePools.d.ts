 ...
 * ```
 */
export declare function getInstancePools(args: GetInstancePoolsArgs, opts?: pulumi.InvokeOptions): Promise<GetInstancePoolsResult>;
/**
 ...
 * ```
 */
export declare function getInstancePoolsOutput(args: GetInstancePoolsOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetInstancePoolsResult>;
/**
 * A collection of arguments for invoking getInstancePools.
 */

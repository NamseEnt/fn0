 ...
 * ```
 */
export declare function getDrgAttachments(args: GetDrgAttachmentsArgs, opts?: pulumi.InvokeOptions): Promise<GetDrgAttachmentsResult>;
/**
 ...
 * ```
 */
export declare function getDrgAttachmentsOutput(args: GetDrgAttachmentsOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetDrgAttachmentsResult>;
/**
 * A collection of arguments for invoking getDrgAttachments.
 */

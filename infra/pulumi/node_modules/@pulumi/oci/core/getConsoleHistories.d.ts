 ...
 * ```
 */
export declare function getConsoleHistories(args: GetConsoleHistoriesArgs, opts?: pulumi.InvokeOptions): Promise<GetConsoleHistoriesResult>;
/**
 ...
 * ```
 */
export declare function getConsoleHistoriesOutput(args: GetConsoleHistoriesOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetConsoleHistoriesResult>;
/**
 * A collection of arguments for invoking getConsoleHistories.
 */

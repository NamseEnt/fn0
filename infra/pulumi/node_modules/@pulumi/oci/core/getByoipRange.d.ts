 ...
 * ```
 */
export declare function getByoipRange(args: GetByoipRangeArgs, opts?: pulumi.InvokeOptions): Promise<GetByoipRangeResult>;
/**
 ...
 * ```
 */
export declare function getByoipRangeOutput(args: GetByoipRangeOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetByoipRangeResult>;
/**
 * A collection of arguments for invoking getByoipRange.
 */

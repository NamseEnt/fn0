 ...
 * ```
 */
export declare function getIpv6(args: GetIpv6Args, opts?: pulumi.InvokeOptions): Promise<GetIpv6Result>;
/**
 ...
 * ```
 */
export declare function getIpv6Output(args: GetIpv6OutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetIpv6Result>;
/**
 * A collection of arguments for invoking getIpv6.
 */

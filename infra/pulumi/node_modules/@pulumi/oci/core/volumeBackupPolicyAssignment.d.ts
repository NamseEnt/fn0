 ...
 * ```
 */
export declare class VolumeBackupPolicyAssignment extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: VolumeBackupPolicyAssignmentState, opts?: pulumi.CustomResourceOptions): VolumeBackupPolicyAssignment;
    /**
     ...
     */
    static isInstance(obj: any): obj is VolumeBackupPolicyAssignment;
    /**

 ...
 * ```
 */
export declare function getLetterOfAuthority(args: GetLetterOfAuthorityArgs, opts?: pulumi.InvokeOptions): Promise<GetLetterOfAuthorityResult>;
/**
 ...
 * ```
 */
export declare function getLetterOfAuthorityOutput(args: GetLetterOfAuthorityOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetLetterOfAuthorityResult>;
/**
 * A collection of arguments for invoking getLetterOfAuthority.
 */

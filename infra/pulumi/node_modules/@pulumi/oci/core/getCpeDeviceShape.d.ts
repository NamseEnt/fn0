 ...
 * ```
 */
export declare function getCpeDeviceShape(args: GetCpeDeviceShapeArgs, opts?: pulumi.InvokeOptions): Promise<GetCpeDeviceShapeResult>;
/**
 ...
 * ```
 */
export declare function getCpeDeviceShapeOutput(args: GetCpeDeviceShapeOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetCpeDeviceShapeResult>;
/**
 * A collection of arguments for invoking getCpeDeviceShape.
 */

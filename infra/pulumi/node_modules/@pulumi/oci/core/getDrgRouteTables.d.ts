 ...
 * ```
 */
export declare function getDrgRouteTables(args: GetDrgRouteTablesArgs, opts?: pulumi.InvokeOptions): Promise<GetDrgRouteTablesResult>;
/**
 ...
 * ```
 */
export declare function getDrgRouteTablesOutput(args: GetDrgRouteTablesOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetDrgRouteTablesResult>;
/**
 * A collection of arguments for invoking getDrgRouteTables.
 */

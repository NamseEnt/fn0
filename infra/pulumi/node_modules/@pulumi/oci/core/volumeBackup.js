 ...
 * ```
 */
class VolumeBackup extends pulumi.CustomResource {
    /**
    ...
    static get(name, id, state, opts) {
        return new VolumeBackup(name, state, { ...opts, id: id });
    }
    /**
...
/** @internal */
VolumeBackup.__pulumiType = 'oci:Core/volumeBackup:VolumeBackup';

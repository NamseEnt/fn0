 ...
 * ```
 */
export declare function getDrgRouteDistributionStatements(args: GetDrgRouteDistributionStatementsArgs, opts?: pulumi.InvokeOptions): Promise<GetDrgRouteDistributionStatementsResult>;
/**
 ...
 * ```
 */
export declare function getDrgRouteDistributionStatementsOutput(args: GetDrgRouteDistributionStatementsOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetDrgRouteDistributionStatementsResult>;
/**
 * A collection of arguments for invoking getDrgRouteDistributionStatements.
 */

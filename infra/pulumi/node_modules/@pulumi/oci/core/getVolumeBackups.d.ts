 ...
 * ```
 */
export declare function getVolumeBackups(args: GetVolumeBackupsArgs, opts?: pulumi.InvokeOptions): Promise<GetVolumeBackupsResult>;
/**
 ...
 * ```
 */
export declare function getVolumeBackupsOutput(args: GetVolumeBackupsOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetVolumeBackupsResult>;
/**
 * A collection of arguments for invoking getVolumeBackups.
 */

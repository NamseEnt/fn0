 ...
 * ```
 */
export declare class RemotePeeringConnection extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: RemotePeeringConnectionState, opts?: pulumi.CustomResourceOptions): RemotePeeringConnection;
    /**
     * Returns true if the given object is an instance of RemotePeeringConnection.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is RemotePeeringConnection;
    /**
     ...
     */
    readonly peerRegionName: pulumi.Output<string>;
    /**
     ...
     */
    readonly peerTenancyId: pulumi.Output<string>;
    /**

 ...
 * ```
 */
export declare class ComputeCapacityTopology extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ComputeCapacityTopologyState, opts?: pulumi.CustomResourceOptions): ComputeCapacityTopology;
    /**
     * Returns true if the given object is an instance of ComputeCapacityTopology.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is ComputeCapacityTopology;
    /**
     ...
     */
    readonly capacitySource: pulumi.Output<outputs.Core.ComputeCapacityTopologyCapacitySource>;
    /**

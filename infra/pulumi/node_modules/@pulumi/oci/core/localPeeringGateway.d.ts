 ...
 * ```
 */
export declare class LocalPeeringGateway extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: LocalPeeringGatewayState, opts?: pulumi.CustomResourceOptions): LocalPeeringGateway;
    /**
     * Returns true if the given object is an instance of LocalPeeringGateway.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is LocalPeeringGateway;
    /**
     ...
     */
    readonly isCrossTenancyPeering: pulumi.Output<boolean>;
    /**
     ...
     */
    readonly peerAdvertisedCidr: pulumi.Output<string>;
    /**
     ...
     */
    readonly peerAdvertisedCidrDetails: pulumi.Output<string[]>;
    /**
     ...
     */
    readonly peeringStatus: pulumi.Output<string>;
    /**
     * Additional information regarding the peering status, if applicable.
     */
    readonly peeringStatusDetails: pulumi.Output<string>;
    /**

 ...
 * ```
 */
export declare class InstanceConsoleConnection extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: InstanceConsoleConnectionState, opts?: pulumi.CustomResourceOptions): InstanceConsoleConnection;
    /**
     ...
     */
    static isInstance(obj: any): obj is InstanceConsoleConnection;
    /**
     ...
     */
    readonly serviceHostKeyFingerprint: pulumi.Output<string>;
    /**
     ...
     */
    readonly vncConnectionString: pulumi.Output<string>;
    /**

 ...
 * ```
 */
export declare function getAppCatalogSubscriptions(args: GetAppCatalogSubscriptionsArgs, opts?: pulumi.InvokeOptions): Promise<GetAppCatalogSubscriptionsResult>;
/**
 ...
 * ```
 */
export declare function getAppCatalogSubscriptionsOutput(args: GetAppCatalogSubscriptionsOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetAppCatalogSubscriptionsResult>;
/**
 * A collection of arguments for invoking getAppCatalogSubscriptions.
 */

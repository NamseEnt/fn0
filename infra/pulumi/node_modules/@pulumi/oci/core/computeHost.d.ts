 ...
 * ```
 */
export declare class ComputeHost extends pulumi.CustomResource {
    /**
     ...
     */
    readonly computeHostGroupId: pulumi.Output<string>;
    /**
     ...
     */
    readonly configurationDatas: pulumi.Output<outputs.Core.ComputeHostConfigurationData[]>;
    /**
     ...
     */
    readonly impactedComponentDetails: pulumi.Output<string>;
    /**
     ...
     */
    readonly localBlockId: pulumi.Output<string>;
    /**
     ...
     */
    readonly recycleDetails: pulumi.Output<outputs.Core.ComputeHostRecycleDetail[]>;
    /**
     * The shape of host
     */
     ...
     */
    readonly timeConfigurationCheck: pulumi.Output<string>;
    /**

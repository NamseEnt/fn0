 ...
 * ```
 */
export declare function getVtap(args: GetVtapArgs, opts?: pulumi.InvokeOptions): Promise<GetVtapResult>;
/**
 ...
 * ```
 */
export declare function getVtapOutput(args: GetVtapOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetVtapResult>;
/**
 * A collection of arguments for invoking getVtap.
 */

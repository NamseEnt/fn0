 ...
 * ```
 */
export declare function getBootVolumeBackups(args: GetBootVolumeBackupsArgs, opts?: pulumi.InvokeOptions): Promise<GetBootVolumeBackupsResult>;
/**
 ...
 * ```
 */
export declare function getBootVolumeBackupsOutput(args: GetBootVolumeBackupsOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetBootVolumeBackupsResult>;
/**
 * A collection of arguments for invoking getBootVolumeBackups.
 */

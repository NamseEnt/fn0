 ...
 * ```
 */
export declare class Patch extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: PatchState, opts?: pulumi.CustomResourceOptions): Patch;
    /**
     * Returns true if the given object is an instance of Patch.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is Patch;
    /**
     * (Updatable) Patch artifact description and content details.
     */
    readonly artifactDetails: pulumi.Output<outputs.FleetAppsManagement.PatchArtifactDetails>;
    /**
     * (Updatable)
     */
     ...
     */
    readonly dependentPatches: pulumi.Output<outputs.FleetAppsManagement.PatchDependentPatch[]>;
    /**
     ...
     */
    readonly patchType: pulumi.Output<outputs.FleetAppsManagement.PatchPatchType>;
    /**
     * (Updatable) Product
     */
    readonly product: pulumi.Output<outputs.FleetAppsManagement.PatchProduct>;
    /**
     * Associated region
     */

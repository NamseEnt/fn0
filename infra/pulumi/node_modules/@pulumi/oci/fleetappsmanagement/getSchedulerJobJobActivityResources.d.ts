 ...
 * ```
 */
export declare function getSchedulerJobJobActivityResources(args: GetSchedulerJobJobActivityResourcesArgs, opts?: pulumi.InvokeOptions): Promise<GetSchedulerJobJobActivityResourcesResult>;
/**
 ...
 * ```
 */
export declare function getSchedulerJobJobActivityResourcesOutput(args: GetSchedulerJobJobActivityResourcesOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetSchedulerJobJobActivityResourcesResult>;
/**
 * A collection of arguments for invoking getSchedulerJobJobActivityResources.
 */

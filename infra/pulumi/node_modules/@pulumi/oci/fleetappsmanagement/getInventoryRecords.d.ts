 ...
 * ```
 */
export declare function getInventoryRecords(args: GetInventoryRecordsArgs, opts?: pulumi.InvokeOptions): Promise<GetInventoryRecordsResult>;
/**
 ...
 * ```
 */
export declare function getInventoryRecordsOutput(args: GetInventoryRecordsOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetInventoryRecordsResult>;
/**
 * A collection of arguments for invoking getInventoryRecords.
 */

 ...
 * ```
 */
export declare function getMaintenanceWindowOutput(args: GetMaintenanceWindowOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetMaintenanceWindowResult>;
/**
 * A collection of arguments for invoking getMaintenanceWindow.
 */

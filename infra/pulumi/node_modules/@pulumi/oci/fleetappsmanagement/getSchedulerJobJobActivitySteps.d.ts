 ...
 * ```
 */
export declare function getSchedulerJobJobActivitySteps(args: GetSchedulerJobJobActivityStepsArgs, opts?: pulumi.InvokeOptions): Promise<GetSchedulerJobJobActivityStepsResult>;
/**
 ...
 * ```
 */
export declare function getSchedulerJobJobActivityStepsOutput(args: GetSchedulerJobJobActivityStepsOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetSchedulerJobJobActivityStepsResult>;
/**
 * A collection of arguments for invoking getSchedulerJobJobActivitySteps.
 */

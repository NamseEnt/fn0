 ...
 * ```
 */
class SchedulerDefinition extends pulumi.CustomResource {
    /**
    ...
    static get(name, id, state, opts) {
        return new SchedulerDefinition(name, state, { ...opts, id: id });
    }
    /**
...
exports.SchedulerDefinition = SchedulerDefinition;
/** @internal */
SchedulerDefinition.__pulumiType = 'oci:FleetAppsManagement/schedulerDefinition:SchedulerDefinition';
//# sourceMappingURL=schedulerDefinition.js.map
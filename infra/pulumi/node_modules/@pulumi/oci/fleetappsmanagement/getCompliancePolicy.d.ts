 ...
 * ```
 */
export declare function getCompliancePolicy(args: GetCompliancePolicyArgs, opts?: pulumi.InvokeOptions): Promise<GetCompliancePolicyResult>;
/**
 ...
 * ```
 */
export declare function getCompliancePolicyOutput(args: GetCompliancePolicyOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetCompliancePolicyResult>;
/**
 * A collection of arguments for invoking getCompliancePolicy.
 */

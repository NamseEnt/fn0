 ...
 * ```
 */
export declare class CatalogItem extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: CatalogItemState, opts?: pulumi.CustomResourceOptions): CatalogItem;
    /**
     * Returns true if the given object is an instance of CatalogItem.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is CatalogItem;
    /**
     * Catalog result payload.
     */
    readonly catalogResultPayloads: pulumi.Output<outputs.FleetAppsManagement.CatalogItemCatalogResultPayload[]>;
    /**
     ...
     */
    readonly configSourceType: pulumi.Output<string>;
    /**
     ...
     */
    readonly listingVersion: pulumi.Output<string>;
    /**
     ...
     */
    readonly shortDescription: pulumi.Output<string>;
    /**
     * The indicator to append Public Items from the root compartment to any query, when set to TRUE.
     */
    readonly shouldListPublicItems: pulumi.Output<boolean>;
    /**
     ...
     */
    readonly timeBackfillLastChecked: pulumi.Output<string>;
    /**
     ...
     */
    readonly timeLastChecked: pulumi.Output<string>;
    /**
     ...
     */
    readonly timeReleased: pulumi.Output<string>;
    /**

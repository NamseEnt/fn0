 ...
 * ```
 */
export declare function getTaskRecord(args: GetTaskRecordArgs, opts?: pulumi.InvokeOptions): Promise<GetTaskRecordResult>;
/**
 ...
 * ```
 */
export declare function getTaskRecordOutput(args: GetTaskRecordOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetTaskRecordResult>;
/**
 * A collection of arguments for invoking getTaskRecord.
 */

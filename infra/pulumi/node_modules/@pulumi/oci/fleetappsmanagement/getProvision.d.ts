 ...
 * ```
 */
export declare function getProvision(args: GetProvisionArgs, opts?: pulumi.InvokeOptions): Promise<GetProvisionResult>;
/**
 ...
 * ```
 */
export declare function getProvisionOutput(args: GetProvisionOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetProvisionResult>;
/**
 * A collection of arguments for invoking getProvision.
 */

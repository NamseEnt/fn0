 ...
 * ```
 */
export declare function getCompliancePolicyRule(args: GetCompliancePolicyRuleArgs, opts?: pulumi.InvokeOptions): Promise<GetCompliancePolicyRuleResult>;
/**
 ...
 * ```
 */
export declare function getCompliancePolicyRuleOutput(args: GetCompliancePolicyRuleOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetCompliancePolicyRuleResult>;
/**
 * A collection of arguments for invoking getCompliancePolicyRule.
 */

 ...
 * ```
 */
export declare function getLimitValues(args: GetLimitValuesArgs, opts?: pulumi.InvokeOptions): Promise<GetLimitValuesResult>;
/**
 ...
 * ```
 */
export declare function getLimitValuesOutput(args: GetLimitValuesOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetLimitValuesResult>;
/**
 * A collection of arguments for invoking getLimitValues.
 */

 ...
 * ```
 */
export declare function getLimitDefinitions(args: GetLimitDefinitionsArgs, opts?: pulumi.InvokeOptions): Promise<GetLimitDefinitionsResult>;
/**
 ...
 * ```
 */
export declare function getLimitDefinitionsOutput(args: GetLimitDefinitionsOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetLimitDefinitionsResult>;
/**
 * A collection of arguments for invoking getLimitDefinitions.
 */

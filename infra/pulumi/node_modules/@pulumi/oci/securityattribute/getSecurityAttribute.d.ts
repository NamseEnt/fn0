 ...
 * ```
 */
export declare function getSecurityAttribute(args: GetSecurityAttributeArgs, opts?: pulumi.InvokeOptions): Promise<GetSecurityAttributeResult>;
/**
 ...
 * ```
 */
export declare function getSecurityAttributeOutput(args: GetSecurityAttributeOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetSecurityAttributeResult>;
/**
 * A collection of arguments for invoking getSecurityAttribute.
 */

 ...
 * ```
 */
export declare class SecurityAttributeNamespace extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: SecurityAttributeNamespaceState, opts?: pulumi.CustomResourceOptions): SecurityAttributeNamespace;
    /**
     ...
     */
    static isInstance(obj: any): obj is SecurityAttributeNamespace;
    /**
     ...
     */
    readonly modes: pulumi.Output<string[]>;
    /**

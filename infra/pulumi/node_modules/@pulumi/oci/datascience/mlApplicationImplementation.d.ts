 ...
 * ```
 */
export declare class MlApplicationImplementation extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: MlApplicationImplementationState, opts?: pulumi.CustomResourceOptions): MlApplicationImplementation;
    /**
     ...
     */
    static isInstance(obj: any): obj is MlApplicationImplementation;
    /**
     ...
     */
    readonly allowedMigrationDestinations: pulumi.Output<string[]>;
    /**
     ...
     */
    readonly applicationComponents: pulumi.Output<outputs.DataScience.MlApplicationImplementationApplicationComponent[]>;
    /**
     ...
     */
    readonly configurationSchemas: pulumi.Output<outputs.DataScience.MlApplicationImplementationConfigurationSchema[]>;
    /**
     ...
     */
    readonly logging: pulumi.Output<outputs.DataScience.MlApplicationImplementationLogging>;
    /**
     * The OCID of the ML Application implemented by this ML Application Implementation
     */
    readonly mlApplicationId: pulumi.Output<string>;
    /**
     * The name of ML Application (based on mlApplicationId)
     */
    readonly mlApplicationName: pulumi.Output<string>;
    /**
     * (Updatable) Configuration of The ML Application Package to upload.
     */
    readonly mlApplicationPackage: pulumi.Output<{
        [key: string]: string;
    }>;
    /**
     * List of ML Application package arguments provided during ML Application package upload.
     */
    readonly mlApplicationPackageArguments: pulumi.Output<outputs.DataScience.MlApplicationImplementationMlApplicationPackageArgument[]>;
    /**
     ...
     */
    readonly opcMlAppPackageArgs: pulumi.Output<{
        [key: string]: string;
    } | undefined>;
    /**
...
export interface MlApplicationImplementationState {
     ...
     * (Updatable) Configuration of The ML Application Package to upload.
     */
    mlApplicationPackage?: pulumi.Input<{
        [key: string]: pulumi.Input<string>;
    }>;
    /**
     * List of ML Application package arguments provided during ML Application package upload.
     ...
     * (Updatable) ML Application package arguments required during ML Application package upload. Each argument is a simple key-value pair.
     */
    opcMlAppPackageArgs?: pulumi.Input<{
        [key: string]: pulumi.Input<string>;
    }>;
    /**
     * The version of ML Application Package (e.g. "1.2" or "2.0.4") defined in ML Application package descriptor. Value is not mandatory only for CREATING state otherwise it must be always presented.

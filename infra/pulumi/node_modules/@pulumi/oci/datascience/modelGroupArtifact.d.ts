 ...
 * ```
 */
export declare class ModelGroupArtifact extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ModelGroupArtifactState, opts?: pulumi.CustomResourceOptions): ModelGroupArtifact;
    /**
     * Returns true if the given object is an instance of ModelGroupArtifact.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is ModelGroupArtifact;
    /**
     ...
     */
    readonly modelGroupArtifact: pulumi.Output<string>;
    /**
     ...
     */
    readonly modelGroupId: pulumi.Output<string>;
    /**

 ...
 * ```
 */
class JobRun extends pulumi.CustomResource {
    /**
    ...
    static get(name, id, state, opts) {
        return new JobRun(name, state, { ...opts, id: id });
    }
    /**
...
/** @internal */
JobRun.__pulumiType = 'oci:DataScience/jobRun:JobRun';
//# sourceMappingURL=jobRun.js.map
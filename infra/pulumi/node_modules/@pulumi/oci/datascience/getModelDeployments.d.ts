 ...
 * ```
 */
export declare function getModelDeployments(args: GetModelDeploymentsArgs, opts?: pulumi.InvokeOptions): Promise<GetModelDeploymentsResult>;
/**
 ...
 * ```
 */
export declare function getModelDeploymentsOutput(args: GetModelDeploymentsOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetModelDeploymentsResult>;
/**
 * A collection of arguments for invoking getModelDeployments.
 */

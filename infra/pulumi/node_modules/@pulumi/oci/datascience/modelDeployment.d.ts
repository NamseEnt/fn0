 ...
 * ```
 */
export declare class ModelDeployment extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ModelDeploymentState, opts?: pulumi.CustomResourceOptions): ModelDeployment;
    /**
     * Returns true if the given object is an instance of ModelDeployment.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is ModelDeployment;
    /**
     * (Updatable) The log details for each category.
     */
    readonly categoryLogDetails: pulumi.Output<outputs.DataScience.ModelDeploymentCategoryLogDetails>;
    /**
     ...
     */
    readonly modelDeploymentConfigurationDetails: pulumi.Output<outputs.DataScience.ModelDeploymentModelDeploymentConfigurationDetails>;
    /**
     * Model deployment system data.
     */
    readonly modelDeploymentSystemDatas: pulumi.Output<outputs.DataScience.ModelDeploymentModelDeploymentSystemData[]>;
    /**
     * The URL to interact with the model deployment.
     */
    readonly modelDeploymentUrl: pulumi.Output<string>;
    /**

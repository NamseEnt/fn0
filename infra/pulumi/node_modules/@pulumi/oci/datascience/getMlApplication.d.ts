 ...
 * ```
 */
export declare function getMlApplication(args: GetMlApplicationArgs, opts?: pulumi.InvokeOptions): Promise<GetMlApplicationResult>;
/**
 ...
 * ```
 */
export declare function getMlApplicationOutput(args: GetMlApplicationOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetMlApplicationResult>;
/**
 * A collection of arguments for invoking getMlApplication.
 */

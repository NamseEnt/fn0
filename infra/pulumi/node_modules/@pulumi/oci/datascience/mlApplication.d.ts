 ...
 * ```
 */
export declare class MlApplication extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: MlApplicationState, opts?: pulumi.CustomResourceOptions): MlApplication;
    /**
     * Returns true if the given object is an instance of MlApplication.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is MlApplication;
    /**

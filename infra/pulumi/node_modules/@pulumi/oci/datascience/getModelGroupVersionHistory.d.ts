 ...
 * ```
 */
export declare function getModelGroupVersionHistory(args: GetModelGroupVersionHistoryArgs, opts?: pulumi.InvokeOptions): Promise<GetModelGroupVersionHistoryResult>;
/**
 ...
 * ```
 */
export declare function getModelGroupVersionHistoryOutput(args: GetModelGroupVersionHistoryOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetModelGroupVersionHistoryResult>;
/**
 * A collection of arguments for invoking getModelGroupVersionHistory.
 */

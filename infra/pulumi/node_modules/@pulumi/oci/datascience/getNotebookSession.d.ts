 ...
 * ```
 */
export declare function getNotebookSession(args: GetNotebookSessionArgs, opts?: pulumi.InvokeOptions): Promise<GetNotebookSessionResult>;
/**
 ...
 * ```
 */
export declare function getNotebookSessionOutput(args: GetNotebookSessionOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetNotebookSessionResult>;
/**
 * A collection of arguments for invoking getNotebookSession.
 */

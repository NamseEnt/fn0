 ...
 * ```
 */
export declare function getModelDeployment(args: GetModelDeploymentArgs, opts?: pulumi.InvokeOptions): Promise<GetModelDeploymentResult>;
/**
 ...
 * ```
 */
export declare function getModelDeploymentOutput(args: GetModelDeploymentOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetModelDeploymentResult>;
/**
 * A collection of arguments for invoking getModelDeployment.
 */

 ...
 * ```
 */
class MlApplicationImplementation extends pulumi.CustomResource {
    /**
    ...
    static get(name, id, state, opts) {
        return new MlApplicationImplementation(name, state, { ...opts, id: id });
    }
    /**
...
exports.MlApplicationImplementation = MlApplicationImplementation;
/** @internal */
MlApplicationImplementation.__pulumiType = 'oci:DataScience/mlApplicationImplementation:MlApplicationImplementation';
//# sourceMappingURL=mlApplicationImplementation.js.map
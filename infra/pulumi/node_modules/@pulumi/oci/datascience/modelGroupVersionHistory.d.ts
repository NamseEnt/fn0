 ...
 * ```
 */
export declare class ModelGroupVersionHistory extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ModelGroupVersionHistoryState, opts?: pulumi.CustomResourceOptions): ModelGroupVersionHistory;
    /**
     * Returns true if the given object is an instance of ModelGroupVersionHistory.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is ModelGroupVersionHistory;
    /**
     ...
     */
    readonly latestModelGroupId: pulumi.Output<string>;
    /**

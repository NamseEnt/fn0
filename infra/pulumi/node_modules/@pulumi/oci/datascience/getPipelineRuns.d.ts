 ...
 * ```
 */
export declare function getPipelineRuns(args: GetPipelineRunsArgs, opts?: pulumi.InvokeOptions): Promise<GetPipelineRunsResult>;
/**
 ...
 * ```
 */
export declare function getPipelineRunsOutput(args: GetPipelineRunsOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetPipelineRunsResult>;
/**
 * A collection of arguments for invoking getPipelineRuns.
 */

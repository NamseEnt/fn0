 ...
 * ```
 */
class MlApplication extends pulumi.CustomResource {
    /**
    ...
    static get(name, id, state, opts) {
        return new MlApplication(name, state, { ...opts, id: id });
    }
    /**
...
/** @internal */
MlApplication.__pulumiType = 'oci:DataScience/mlApplication:MlApplication';
//# sourceMappingURL=mlApplication.js.map
 ...
 * ```
 */
export declare function getModelVersionSet(args: GetModelVersionSetArgs, opts?: pulumi.InvokeOptions): Promise<GetModelVersionSetResult>;
/**
 ...
 * ```
 */
export declare function getModelVersionSetOutput(args: GetModelVersionSetOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetModelVersionSetResult>;
/**
 * A collection of arguments for invoking getModelVersionSet.
 */

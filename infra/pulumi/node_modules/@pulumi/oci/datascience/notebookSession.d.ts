 ...
 * ```
 */
export declare class NotebookSession extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: NotebookSessionState, opts?: pulumi.CustomResourceOptions): NotebookSession;
    /**
     * Returns true if the given object is an instance of NotebookSession.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is NotebookSession;
    /**
     ...
     */
    readonly notebookSessionConfigDetails: pulumi.Output<outputs.DataScience.NotebookSessionNotebookSessionConfigDetails>;
    /**
     * (Updatable) Details for the notebook session configuration.
     */
    readonly notebookSessionConfigurationDetails: pulumi.Output<outputs.DataScience.NotebookSessionNotebookSessionConfigurationDetails>;
    /**
     * (Updatable) Notebook Session runtime configuration details.
     */
    readonly notebookSessionRuntimeConfigDetails: pulumi.Output<outputs.DataScience.NotebookSessionNotebookSessionRuntimeConfigDetails>;
    /**
     * (Updatable) Collection of NotebookSessionStorageMountConfigurationDetails.
     */
    readonly notebookSessionStorageMountConfigurationDetailsLists: pulumi.Output<outputs.DataScience.NotebookSessionNotebookSessionStorageMountConfigurationDetailsList[]>;
    /**
     * The URL to interact with the notebook session.
     */
    readonly notebookSessionUrl: pulumi.Output<string>;
    /**

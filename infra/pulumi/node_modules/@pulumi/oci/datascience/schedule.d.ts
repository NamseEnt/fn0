...
export declare class Schedule extends pulumi.CustomResource {
     ...
     */
    readonly action: pulumi.Output<outputs.DataScience.ScheduleAction>;
    /**
     ...
     */
    readonly lastScheduleRunDetails: pulumi.Output<string>;
    /**
     ...
     */
    readonly logDetails: pulumi.Output<outputs.DataScience.ScheduleLogDetails | undefined>;
    /**
     ...
     */
    readonly trigger: pulumi.Output<outputs.DataScience.ScheduleTrigger>;
    /**

 ...
 * ```
 */
export declare function getModelGroup(args: GetModelGroupArgs, opts?: pulumi.InvokeOptions): Promise<GetModelGroupResult>;
/**
 ...
 * ```
 */
export declare function getModelGroupOutput(args: GetModelGroupOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetModelGroupResult>;
/**
 * A collection of arguments for invoking getModelGroup.
 */

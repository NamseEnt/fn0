 ...
 * ```
 */
export declare class GeneratedScopedAccessToken extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: GeneratedScopedAccessTokenState, opts?: pulumi.CustomResourceOptions): GeneratedScopedAccessToken;
    /**
     ...
     */
    static isInstance(obj: any): obj is GeneratedScopedAccessToken;
    /**

 ...
 * ```
 */
export declare function getComputedUsage(args: GetComputedUsageArgs, opts?: pulumi.InvokeOptions): Promise<GetComputedUsageResult>;
/**
...
export interface GetComputedUsageResult {
     ...
     * Product description
     */
    readonly parentProducts: outputs.OsubUsage.GetComputedUsageParentProduct[];
    /**
     ...
     * Product description
     */
    readonly products: outputs.OsubUsage.GetComputedUsageProduct[];
    /**
 ...
 * ```
 */
export declare function getComputedUsageOutput(args: GetComputedUsageOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetComputedUsageResult>;
/**
 * A collection of arguments for invoking getComputedUsage.
 */

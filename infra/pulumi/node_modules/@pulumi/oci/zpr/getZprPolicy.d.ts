 ...
 * ```
 */
export declare function getZprPolicy(args: GetZprPolicyArgs, opts?: pulumi.InvokeOptions): Promise<GetZprPolicyResult>;
/**
 ...
 * ```
 */
export declare function getZprPolicyOutput(args: GetZprPolicyOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetZprPolicyResult>;
/**
 * A collection of arguments for invoking getZprPolicy.
 */

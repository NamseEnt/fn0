 ...
 * ```
 */
export declare function getNotificationTopics(args: GetNotificationTopicsArgs, opts?: pulumi.InvokeOptions): Promise<GetNotificationTopicsResult>;
/**
 ...
 * ```
 */
export declare function getNotificationTopicsOutput(args: GetNotificationTopicsOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetNotificationTopicsResult>;
/**
 * A collection of arguments for invoking getNotificationTopics.
 */

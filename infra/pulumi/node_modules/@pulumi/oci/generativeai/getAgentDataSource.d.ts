 ...
 * ```
 */
export declare function getAgentDataSource(args: GetAgentDataSourceArgs, opts?: pulumi.InvokeOptions): Promise<GetAgentDataSourceResult>;
/**
 ...
 * ```
 */
export declare function getAgentDataSourceOutput(args: GetAgentDataSourceOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetAgentDataSourceResult>;
/**
 * A collection of arguments for invoking getAgentDataSource.
 */

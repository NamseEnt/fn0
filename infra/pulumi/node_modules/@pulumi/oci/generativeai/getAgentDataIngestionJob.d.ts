 ...
 * ```
 */
export declare function getAgentDataIngestionJob(args: GetAgentDataIngestionJobArgs, opts?: pulumi.InvokeOptions): Promise<GetAgentDataIngestionJobResult>;
/**
 ...
 * ```
 */
export declare function getAgentDataIngestionJobOutput(args: GetAgentDataIngestionJobOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetAgentDataIngestionJobResult>;
/**
 * A collection of arguments for invoking getAgentDataIngestionJob.
 */

 ...
 * ```
 */
export declare function getAgentKnowledgeBase(args: GetAgentKnowledgeBaseArgs, opts?: pulumi.InvokeOptions): Promise<GetAgentKnowledgeBaseResult>;
/**
 * A collection of arguments for invoking getAgentKnowledgeBase.
 */
export interface GetAgentKnowledgeBaseArgs {
    /**
 ...
 */
export interface GetAgentKnowledgeBaseResult {
    /**
 ...
 * ```
 */
export declare function getAgentKnowledgeBaseOutput(args: GetAgentKnowledgeBaseOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetAgentKnowledgeBaseResult>;
/**
 * A collection of arguments for invoking getAgentKnowledgeBase.
 */
export interface GetAgentKnowledgeBaseOutputArgs {
    /**
     * The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the knowledge base.
     */

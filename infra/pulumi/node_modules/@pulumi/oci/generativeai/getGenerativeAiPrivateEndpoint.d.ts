 ...
 * ```
 */
export declare function getGenerativeAiPrivateEndpoint(args: GetGenerativeAiPrivateEndpointArgs, opts?: pulumi.InvokeOptions): Promise<GetGenerativeAiPrivateEndpointResult>;
/**
 ...
 * ```
 */
export declare function getGenerativeAiPrivateEndpointOutput(args: GetGenerativeAiPrivateEndpointOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetGenerativeAiPrivateEndpointResult>;
/**
 * A collection of arguments for invoking getGenerativeAiPrivateEndpoint.
 */

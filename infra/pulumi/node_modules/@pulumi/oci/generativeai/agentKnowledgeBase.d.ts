...
export declare class AgentKnowledgeBase extends pulumi.CustomResource {
     ...
     */
    readonly indexConfig: pulumi.Output<outputs.GenerativeAi.AgentKnowledgeBaseIndexConfig>;
    /**
     * Statistics for Default Knowledge Base.
     */
    readonly knowledgeBaseStatistics: pulumi.Output<outputs.GenerativeAi.AgentKnowledgeBaseKnowledgeBaseStatistic[]>;
    /**

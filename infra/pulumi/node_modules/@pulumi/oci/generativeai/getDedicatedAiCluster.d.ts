 ...
 * ```
 */
export declare function getDedicatedAiCluster(args: GetDedicatedAiClusterArgs, opts?: pulumi.InvokeOptions): Promise<GetDedicatedAiClusterResult>;
/**
 ...
 * ```
 */
export declare function getDedicatedAiClusterOutput(args: GetDedicatedAiClusterOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetDedicatedAiClusterResult>;
/**
 * A collection of arguments for invoking getDedicatedAiCluster.
 */

 ...
 * ```
 */
export declare function getSessions(args: GetSessionsArgs, opts?: pulumi.InvokeOptions): Promise<GetSessionsResult>;
/**
 ...
 * ```
 */
export declare function getSessionsOutput(args: GetSessionsOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetSessionsResult>;
/**
 * A collection of arguments for invoking getSessions.
 */

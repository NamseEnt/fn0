 ...
 * ```
 */
export declare function getBastion(args: GetBastionArgs, opts?: pulumi.InvokeOptions): Promise<GetBastionResult>;
/**
 ...
 * ```
 */
export declare function getBastionOutput(args: GetBastionOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetBastionResult>;
/**
 * A collection of arguments for invoking getBastion.
 */

 ...
 * ```
 */
export declare function getAccessRequest(args: GetAccessRequestArgs, opts?: pulumi.InvokeOptions): Promise<GetAccessRequestResult>;
/**
 ...
 * ```
 */
export declare function getAccessRequestOutput(args: GetAccessRequestOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetAccessRequestResult>;
/**
 * A collection of arguments for invoking getAccessRequest.
 */

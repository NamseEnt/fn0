 ...
 * ```
 */
export declare class OperatorControl extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: OperatorControlState, opts?: pulumi.CustomResourceOptions): OperatorControl;
    /**
     * Returns true if the given object is an instance of OperatorControl.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is OperatorControl;
    /**
     ...
     */
    readonly approvalRequiredOpActionLists: pulumi.Output<string[]>;
    /**
     ...
     */
    readonly emailIdLists: pulumi.Output<string[]>;
    /**
     ...
     */
    readonly isDefaultOperatorControl: pulumi.Output<boolean>;
    /**
     ...
     */
    readonly isFullyPreApproved: pulumi.Output<boolean>;
    /**
     * Description associated with the latest modification of the operator control.
     */
    readonly lastModifiedInfo: pulumi.Output<string>;
    /**
     * (Updatable) Number of approvers required to approve an access request.
     */
    readonly numberOfApprovers: pulumi.Output<number>;
    /**
     * (Updatable) Name of the operator control.
     */
    readonly operatorControlName: pulumi.Output<string>;
    /**
     ...
     */
    readonly preApprovedOpActionLists: pulumi.Output<string[]>;
    /**
     ...
     */
    readonly systemMessage: pulumi.Output<string>;
    /**
     ...
     */
    readonly timeOfCreation: pulumi.Output<string>;
    /**
     ...
     */
    readonly timeOfModification: pulumi.Output<string>;
    /**

...
exports.OperatorControlAssignment = void 0;
 ...
 * ```
 */
class OperatorControlAssignment extends pulumi.CustomResource {
    /**
    ...
    static get(name, id, state, opts) {
        return new OperatorControlAssignment(name, state, { ...opts, id: id });
    }
    /**
...
exports.OperatorControlAssignment = OperatorControlAssignment;
/** @internal */
OperatorControlAssignment.__pulumiType = 'oci:OperatorAccessControl/operatorControlAssignment:OperatorControlAssignment';
//# sourceMappingURL=operatorControlAssignment.js.map
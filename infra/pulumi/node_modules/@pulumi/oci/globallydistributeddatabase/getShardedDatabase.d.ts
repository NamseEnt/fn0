 ...
 * ```
 */
export declare function getShardedDatabase(args: GetShardedDatabaseArgs, opts?: pulumi.InvokeOptions): Promise<GetShardedDatabaseResult>;
/**
 ...
 * ```
 */
export declare function getShardedDatabaseOutput(args: GetShardedDatabaseOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetShardedDatabaseResult>;
/**
 * A collection of arguments for invoking getShardedDatabase.
 */

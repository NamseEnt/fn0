 ...
 * ```
 */
export declare function getNetworkAddressList(args: GetNetworkAddressListArgs, opts?: pulumi.InvokeOptions): Promise<GetNetworkAddressListResult>;
/**
 ...
 * ```
 */
export declare function getNetworkAddressListOutput(args: GetNetworkAddressListOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetNetworkAddressListResult>;
/**
 * A collection of arguments for invoking getNetworkAddressList.
 */

 ...
 * ```
 */
export declare function getWebAppFirewallPolicy(args: GetWebAppFirewallPolicyArgs, opts?: pulumi.InvokeOptions): Promise<GetWebAppFirewallPolicyResult>;
/**
 ...
 * ```
 */
export declare function getWebAppFirewallPolicyOutput(args: GetWebAppFirewallPolicyOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetWebAppFirewallPolicyResult>;
/**
 * A collection of arguments for invoking getWebAppFirewallPolicy.
 */

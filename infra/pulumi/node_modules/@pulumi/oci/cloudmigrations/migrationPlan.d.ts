 ...
 * ```
 */
export declare class MigrationPlan extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: MigrationPlanState, opts?: pulumi.CustomResourceOptions): MigrationPlan;
    /**
     * Returns true if the given object is an instance of MigrationPlan.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is MigrationPlan;
    /**
     * Limits of the resources that are needed for migration. Example: {"BlockVolume": 2, "VCN": 1}
     */
    readonly calculatedLimits: pulumi.Output<{
        [key: string]: string;
    }>;
    /**
     ...
     */
    readonly migrationPlanStats: pulumi.Output<outputs.CloudMigrations.MigrationPlanMigrationPlanStat[]>;
    /**
     * OCID of the referenced ORM job.
     */
    readonly referenceToRmsStack: pulumi.Output<string>;
    /**
     * Source migraiton plan ID to be cloned.
     */
    readonly sourceMigrationPlanId: pulumi.Output<string>;
    /**
     ...
     */
    readonly strategies: pulumi.Output<outputs.CloudMigrations.MigrationPlanStrategy[]>;
    /**
     ...
     */
    readonly targetEnvironments: pulumi.Output<outputs.CloudMigrations.MigrationPlanTargetEnvironment[]>;
    /**

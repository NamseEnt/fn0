 ...
 * ```
 */
export declare function getMigrationAsset(args: GetMigrationAssetArgs, opts?: pulumi.InvokeOptions): Promise<GetMigrationAssetResult>;
/**
 ...
 * ```
 */
export declare function getMigrationAssetOutput(args: GetMigrationAssetOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetMigrationAssetResult>;
/**
 * A collection of arguments for invoking getMigrationAsset.
 */

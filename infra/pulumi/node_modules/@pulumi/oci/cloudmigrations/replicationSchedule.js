 ...
 * ```
 */
class ReplicationSchedule extends pulumi.CustomResource {
    /**
    ...
    static get(name, id, state, opts) {
        return new ReplicationSchedule(name, state, { ...opts, id: id });
    }
    /**
...
exports.ReplicationSchedule = ReplicationSchedule;
/** @internal */
ReplicationSchedule.__pulumiType = 'oci:CloudMigrations/replicationSchedule:ReplicationSchedule';
//# sourceMappingURL=replicationSchedule.js.map
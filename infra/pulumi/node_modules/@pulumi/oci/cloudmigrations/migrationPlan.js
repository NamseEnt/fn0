 ...
 * ```
 */
class MigrationPlan extends pulumi.CustomResource {
    /**
    ...
    static get(name, id, state, opts) {
        return new MigrationPlan(name, state, { ...opts, id: id });
    }
    /**
...
/** @internal */
MigrationPlan.__pulumiType = 'oci:CloudMigrations/migrationPlan:MigrationPlan';

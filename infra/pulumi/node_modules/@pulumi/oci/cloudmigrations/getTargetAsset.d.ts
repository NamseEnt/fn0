 ...
 * ```
 */
export declare function getTargetAsset(args: GetTargetAssetArgs, opts?: pulumi.InvokeOptions): Promise<GetTargetAssetResult>;
/**
 ...
 * ```
 */
export declare function getTargetAssetOutput(args: GetTargetAssetOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetTargetAssetResult>;
/**
 * A collection of arguments for invoking getTargetAsset.
 */

 ...
 * ```
 */
export declare function getMigrationPlan(args: GetMigrationPlanArgs, opts?: pulumi.InvokeOptions): Promise<GetMigrationPlanResult>;
/**
 ...
 * ```
 */
export declare function getMigrationPlanOutput(args: GetMigrationPlanOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetMigrationPlanResult>;
/**
 * A collection of arguments for invoking getMigrationPlan.
 */

 ...
 * ```
 */
export declare function getMigrationPlanAvailableShapes(args: GetMigrationPlanAvailableShapesArgs, opts?: pulumi.InvokeOptions): Promise<GetMigrationPlanAvailableShapesResult>;
/**
 ...
 * ```
 */
export declare function getMigrationPlanAvailableShapesOutput(args: GetMigrationPlanAvailableShapesOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetMigrationPlanAvailableShapesResult>;
/**
 * A collection of arguments for invoking getMigrationPlanAvailableShapes.
 */

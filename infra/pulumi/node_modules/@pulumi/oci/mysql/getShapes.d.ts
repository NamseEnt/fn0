 ...
 * ```
 */
export declare function getShapes(args: GetShapesArgs, opts?: pulumi.InvokeOptions): Promise<GetShapesResult>;
/**
 ...
 * ```
 */
export declare function getShapesOutput(args: GetShapesOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetShapesResult>;
/**
 * A collection of arguments for invoking getShapes.
 */

 ...
 * ```
 */
class HeatWaveCluster extends pulumi.CustomResource {
    /**
    ...
    static get(name, id, state, opts) {
        return new HeatWaveCluster(name, state, { ...opts, id: id });
    }
    /**
...
exports.HeatWaveCluster = HeatWaveCluster;
/** @internal */
HeatWaveCluster.__pulumiType = 'oci:Mysql/heatWaveCluster:HeatWaveCluster';
//# sourceMappingURL=heatWaveCluster.js.map
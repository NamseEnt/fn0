 ...
 * ```
 */
export declare function getMysqlDbSystems(args: GetMysqlDbSystemsArgs, opts?: pulumi.InvokeOptions): Promise<GetMysqlDbSystemsResult>;
/**
 ...
 * ```
 */
export declare function getMysqlDbSystemsOutput(args: GetMysqlDbSystemsOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetMysqlDbSystemsResult>;
/**
 * A collection of arguments for invoking getMysqlDbSystems.
 */

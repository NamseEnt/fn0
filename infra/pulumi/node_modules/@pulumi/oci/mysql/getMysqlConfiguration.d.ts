 ...
 * ```
 */
export declare function getMysqlConfigurationOutput(args: GetMysqlConfigurationOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetMysqlConfigurationResult>;
/**
 * A collection of arguments for invoking getMysqlConfiguration.
 */

 ...
 * ```
 */
export declare function getMysqlBackup(args: GetMysqlBackupArgs, opts?: pulumi.InvokeOptions): Promise<GetMysqlBackupResult>;
/**
 ...
 * ```
 */
export declare function getMysqlBackupOutput(args: GetMysqlBackupOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetMysqlBackupResult>;
/**
 * A collection of arguments for invoking getMysqlBackup.
 */

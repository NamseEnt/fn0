 ...
 * ```
 */
export declare function getHeatWaveCluster(args: GetHeatWaveClusterArgs, opts?: pulumi.InvokeOptions): Promise<GetHeatWaveClusterResult>;
/**
 ...
 * ```
 */
export declare function getHeatWaveClusterOutput(args: GetHeatWaveClusterOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetHeatWaveClusterResult>;
/**
 * A collection of arguments for invoking getHeatWaveCluster.
 */

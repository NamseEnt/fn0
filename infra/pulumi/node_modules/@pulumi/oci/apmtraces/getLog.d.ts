 ...
 * ```
 */
export declare function getLog(args: GetLogArgs, opts?: pulumi.InvokeOptions): Promise<GetLogResult>;
/**
 ...
 * ```
 */
export declare function getLogOutput(args: GetLogOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetLogResult>;
/**
 * A collection of arguments for invoking getLog.
 */

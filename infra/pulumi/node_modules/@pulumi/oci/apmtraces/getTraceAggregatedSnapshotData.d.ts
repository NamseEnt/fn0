 ...
 * ```
 */
export declare function getTraceAggregatedSnapshotData(args: GetTraceAggregatedSnapshotDataArgs, opts?: pulumi.InvokeOptions): Promise<GetTraceAggregatedSnapshotDataResult>;
/**
 ...
 * ```
 */
export declare function getTraceAggregatedSnapshotDataOutput(args: GetTraceAggregatedSnapshotDataOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetTraceAggregatedSnapshotDataResult>;
/**
 * A collection of arguments for invoking getTraceAggregatedSnapshotData.
 */

 ...
 * ```
 */
export declare function getTraceSnapshotData(args: GetTraceSnapshotDataArgs, opts?: pulumi.InvokeOptions): Promise<GetTraceSnapshotDataResult>;
/**
 ...
 * ```
 */
export declare function getTraceSnapshotDataOutput(args: GetTraceSnapshotDataOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetTraceSnapshotDataResult>;
/**
 * A collection of arguments for invoking getTraceSnapshotData.
 */

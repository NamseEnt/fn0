...
export declare class ScheduledQuery extends pulumi.CustomResource {
     ...
     */
    readonly opcDryRun: pulumi.Output<string>;
    /**
     * (Updatable) Description for the scheduled query.
     */
    readonly scheduledQueryDescription: pulumi.Output<string>;
    /**
     * Scheduled query instances.
     */
    readonly scheduledQueryInstances: pulumi.Output<string>;
    /**
     * (Updatable) Maximum runtime for the scheduled query in seconds.
     */
    readonly scheduledQueryMaximumRuntimeInSeconds: pulumi.Output<string>;
    /**
     * (Updatable) Name of the scheduled query.
     */
    readonly scheduledQueryName: pulumi.Output<string>;
    /**
     * Next run for the scheduled query.
     */
    readonly scheduledQueryNextRunInMs: pulumi.Output<string>;
    /**
     * (Updatable) Definition of the scheduled query processing configuration.
     */
    readonly scheduledQueryProcessingConfiguration: pulumi.Output<outputs.ApmTraces.ScheduledQueryScheduledQueryProcessingConfiguration>;
    /**
     * (Updatable) Processing sub type of the scheduled query.
     */
    readonly scheduledQueryProcessingSubType: pulumi.Output<string>;
    /**
     * (Updatable) Type of the scheduled query.
     */
    readonly scheduledQueryProcessingType: pulumi.Output<string>;
    /**
     * (Updatable) Retention criteria for the scheduled query.
     */
    readonly scheduledQueryRetentionCriteria: pulumi.Output<string>;
    /**
     * (Updatable) Retention period for the scheduled query in milliseconds.
     */
    readonly scheduledQueryRetentionPeriodInMs: pulumi.Output<string>;
    /**
     * (Updatable) Schedule for the scheduled query.
     */
    readonly scheduledQuerySchedule: pulumi.Output<string>;
    /**
     ...
     */
    readonly scheduledQueryText: pulumi.Output<string>;
    /**

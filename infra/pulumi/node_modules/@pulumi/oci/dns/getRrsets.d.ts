 ...
 * ```
 */
export declare function getRrsets(args: GetRrsetsArgs, opts?: pulumi.InvokeOptions): Promise<GetRrsetsResult>;
/**
 ...
 * ```
 */
export declare function getRrsetsOutput(args: GetRrsetsOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetRrsetsResult>;
/**
 * A collection of arguments for invoking getRrsets.
 */

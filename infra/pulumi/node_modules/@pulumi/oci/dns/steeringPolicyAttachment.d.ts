 ...
 * ```
 */
export declare class SteeringPolicyAttachment extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: SteeringPolicyAttachmentState, opts?: pulumi.CustomResourceOptions): SteeringPolicyAttachment;
    /**
     * Returns true if the given object is an instance of SteeringPolicyAttachment.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is SteeringPolicyAttachment;
    /**
     ...
     */
    readonly rtypes: pulumi.Output<string[]>;
    /**
     ...
     */
    readonly steeringPolicyId: pulumi.Output<string>;
    /**

 ...
 * ```
 */
class SteeringPolicy extends pulumi.CustomResource {
    /**
    ...
    static get(name, id, state, opts) {
        return new SteeringPolicy(name, state, { ...opts, id: id });
    }
    /**
...
exports.SteeringPolicy = SteeringPolicy;
/** @internal */
SteeringPolicy.__pulumiType = 'oci:Dns/steeringPolicy:SteeringPolicy';
//# sourceMappingURL=steeringPolicy.js.map
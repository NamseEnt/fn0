 ...
 */
export declare class ZoneStageDnssecKeyVersion extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ZoneStageDnssecKeyVersionState, opts?: pulumi.CustomResourceOptions): ZoneStageDnssecKeyVersion;
    /**
     ...
     */
    static isInstance(obj: any): obj is ZoneStageDnssecKeyVersion;
    /**
     * The UUID of the `DnssecKeyVersion` for which a new successor should be generated.
     */
    readonly predecessorDnssecKeyVersionUuid: pulumi.Output<string>;
    /**

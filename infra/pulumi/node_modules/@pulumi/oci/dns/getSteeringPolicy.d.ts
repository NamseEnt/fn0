 ...
 * ```
 */
export declare function getSteeringPolicy(args: GetSteeringPolicyArgs, opts?: pulumi.InvokeOptions): Promise<GetSteeringPolicyResult>;
/**
 ...
 * ```
 */
export declare function getSteeringPolicyOutput(args: GetSteeringPolicyOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetSteeringPolicyResult>;
/**
 * A collection of arguments for invoking getSteeringPolicy.
 */

 ...
 * ```
 */
export declare function getRrset(args: GetRrsetArgs, opts?: pulumi.InvokeOptions): Promise<GetRrsetResult>;
/**
 ...
 * ```
 */
export declare function getRrsetOutput(args: GetRrsetOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetRrsetResult>;
/**
 * A collection of arguments for invoking getRrset.
 */

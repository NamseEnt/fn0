 ...
 * ```
 */
export declare function getSender(args: GetSenderArgs, opts?: pulumi.InvokeOptions): Promise<GetSenderResult>;
/**
 ...
 * ```
 */
export declare function getSenderOutput(args: GetSenderOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetSenderResult>;
/**
 * A collection of arguments for invoking getSender.
 */

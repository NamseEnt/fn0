 ...
 * ```
 */
export declare class Dkim extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: DkimState, opts?: pulumi.CustomResourceOptions): Dkim;
    /**
     * Returns true if the given object is an instance of Dkim.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is Dkim;
    /**
     ...
     */
    readonly isImported: pulumi.Output<boolean>;
    /**
     * Length of the RSA key used in the DKIM.
     */
    readonly keyLength: pulumi.Output<number>;
    /**

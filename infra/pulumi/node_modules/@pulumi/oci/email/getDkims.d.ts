 ...
 * ```
 */
export declare function getDkims(args: GetDkimsArgs, opts?: pulumi.InvokeOptions): Promise<GetDkimsResult>;
/**
 ...
 * ```
 */
export declare function getDkimsOutput(args: GetDkimsOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetDkimsResult>;
/**
 * A collection of arguments for invoking getDkims.
 */

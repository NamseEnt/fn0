 ...
 * ```
 */
export declare class EmailReturnPath extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: EmailReturnPathState, opts?: pulumi.CustomResourceOptions): EmailReturnPath;
    /**
     * Returns true if the given object is an instance of EmailReturnPath.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is EmailReturnPath;
    /**
     ...
     */
    readonly cnameRecordValue: pulumi.Output<string>;
    /**
     ...
     */
    readonly locks: pulumi.Output<outputs.Email.EmailReturnPathLock[]>;
    /**

 ...
 * ```
 */
export declare function getSuppressions(args: GetSuppressionsArgs, opts?: pulumi.InvokeOptions): Promise<GetSuppressionsResult>;
/**
 ...
 * ```
 */
export declare function getSuppressionsOutput(args: GetSuppressionsOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetSuppressionsResult>;
/**
 * A collection of arguments for invoking getSuppressions.
 */

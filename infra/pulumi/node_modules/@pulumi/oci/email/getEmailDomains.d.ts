 ...
 * ```
 */
export declare function getEmailDomains(args: GetEmailDomainsArgs, opts?: pulumi.InvokeOptions): Promise<GetEmailDomainsResult>;
/**
 ...
 * ```
 */
export declare function getEmailDomainsOutput(args: GetEmailDomainsOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetEmailDomainsResult>;
/**
 * A collection of arguments for invoking getEmailDomains.
 */

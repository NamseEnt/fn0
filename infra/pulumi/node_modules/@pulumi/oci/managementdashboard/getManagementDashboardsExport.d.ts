 ...
 * ```
 */
export declare function getManagementDashboardsExport(args: GetManagementDashboardsExportArgs, opts?: pulumi.InvokeOptions): Promise<GetManagementDashboardsExportResult>;
/**
 ...
 * ```
 */
export declare function getManagementDashboardsExportOutput(args: GetManagementDashboardsExportOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetManagementDashboardsExportResult>;
/**
 * A collection of arguments for invoking getManagementDashboardsExport.
 */

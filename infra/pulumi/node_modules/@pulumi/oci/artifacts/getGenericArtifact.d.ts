 ...
 * ```
 */
export declare function getGenericArtifact(args: GetGenericArtifactArgs, opts?: pulumi.InvokeOptions): Promise<GetGenericArtifactResult>;
/**
 ...
 * ```
 */
export declare function getGenericArtifactOutput(args: GetGenericArtifactOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetGenericArtifactResult>;
/**
 * A collection of arguments for invoking getGenericArtifact.
 */

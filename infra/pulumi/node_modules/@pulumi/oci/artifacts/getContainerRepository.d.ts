 ...
 * ```
 */
export declare function getContainerRepositoryOutput(args: GetContainerRepositoryOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetContainerRepositoryResult>;
/**
 * A collection of arguments for invoking getContainerRepository.
 */

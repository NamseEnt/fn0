 ...
 * ```
 */
export declare function getContainerImages(args: GetContainerImagesArgs, opts?: pulumi.InvokeOptions): Promise<GetContainerImagesResult>;
/**
 ...
 * ```
 */
export declare function getContainerImagesOutput(args: GetContainerImagesOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetContainerImagesResult>;
/**
 * A collection of arguments for invoking getContainerImages.
 */

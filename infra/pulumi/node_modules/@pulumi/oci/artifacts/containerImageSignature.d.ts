 ...
 * ```
 */
export declare class ContainerImageSignature extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ContainerImageSignatureState, opts?: pulumi.CustomResourceOptions): ContainerImageSignature;
    /**
     * Returns true if the given object is an instance of ContainerImageSignature.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is ContainerImageSignature;
    /**

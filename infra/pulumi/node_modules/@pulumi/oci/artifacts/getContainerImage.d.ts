 ...
 * ```
 */
export declare function getContainerImage(args: GetContainerImageArgs, opts?: pulumi.InvokeOptions): Promise<GetContainerImageResult>;
/**
 ...
 * ```
 */
export declare function getContainerImageOutput(args: GetContainerImageOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetContainerImageResult>;
/**
 * A collection of arguments for invoking getContainerImage.
 */

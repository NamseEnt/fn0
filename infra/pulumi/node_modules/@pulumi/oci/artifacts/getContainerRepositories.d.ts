 ...
 * ```
 */
export declare function getContainerRepositories(args: GetContainerRepositoriesArgs, opts?: pulumi.InvokeOptions): Promise<GetContainerRepositoriesResult>;
/**
 ...
 * ```
 */
export declare function getContainerRepositoriesOutput(args: GetContainerRepositoriesOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetContainerRepositoriesResult>;
/**
 * A collection of arguments for invoking getContainerRepositories.
 */

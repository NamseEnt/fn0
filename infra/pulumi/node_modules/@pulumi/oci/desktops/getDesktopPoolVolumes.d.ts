 ...
 * ```
 */
export declare function getDesktopPoolVolumes(args: GetDesktopPoolVolumesArgs, opts?: pulumi.InvokeOptions): Promise<GetDesktopPoolVolumesResult>;
/**
 ...
 * ```
 */
export declare function getDesktopPoolVolumesOutput(args: GetDesktopPoolVolumesOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetDesktopPoolVolumesResult>;
/**
 * A collection of arguments for invoking getDesktopPoolVolumes.
 */

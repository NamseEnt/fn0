 ...
 * ```
 */
export declare function getDesktop(args: GetDesktopArgs, opts?: pulumi.InvokeOptions): Promise<GetDesktopResult>;
/**
 ...
 * ```
 */
export declare function getDesktopOutput(args: GetDesktopOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetDesktopResult>;
/**
 * A collection of arguments for invoking getDesktop.
 */

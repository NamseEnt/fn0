 ...
 * ```
 */
export declare function getRemediationRunStages(args: GetRemediationRunStagesArgs, opts?: pulumi.InvokeOptions): Promise<GetRemediationRunStagesResult>;
/**
 ...
 * ```
 */
export declare function getRemediationRunStagesOutput(args: GetRemediationRunStagesOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetRemediationRunStagesResult>;
/**
 * A collection of arguments for invoking getRemediationRunStages.
 */

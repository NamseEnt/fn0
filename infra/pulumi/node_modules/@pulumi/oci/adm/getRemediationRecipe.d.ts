 ...
 * ```
 */
export declare function getRemediationRecipe(args: GetRemediationRecipeArgs, opts?: pulumi.InvokeOptions): Promise<GetRemediationRecipeResult>;
/**
 ...
 * ```
 */
export declare function getRemediationRecipeOutput(args: GetRemediationRecipeOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetRemediationRecipeResult>;
/**
 * A collection of arguments for invoking getRemediationRecipe.
 */

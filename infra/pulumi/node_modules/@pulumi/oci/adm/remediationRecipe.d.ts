 ...
 * ```
 */
export declare class RemediationRecipe extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: RemediationRecipeState, opts?: pulumi.CustomResourceOptions): RemediationRecipe;
    /**
     * Returns true if the given object is an instance of RemediationRecipe.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is RemediationRecipe;
    /**
     ...
     */
    readonly detectConfiguration: pulumi.Output<outputs.Adm.RemediationRecipeDetectConfiguration>;
    /**
     ...
     */
    readonly isRunTriggeredOnKbChange: pulumi.Output<boolean>;
    /**
     ...
     */
    readonly networkConfiguration: pulumi.Output<outputs.Adm.RemediationRecipeNetworkConfiguration>;
    /**
     * (Updatable) A configuration for the Source Code Management tool/platform used by a remediation recipe.
     */
    readonly scmConfiguration: pulumi.Output<outputs.Adm.RemediationRecipeScmConfiguration>;
    /**
     ...
     */
    readonly verifyConfiguration: pulumi.Output<outputs.Adm.RemediationRecipeVerifyConfiguration>;
    /**

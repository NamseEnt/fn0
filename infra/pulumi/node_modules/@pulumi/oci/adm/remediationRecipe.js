 ...
 * ```
 */
class RemediationRecipe extends pulumi.CustomResource {
    /**
    ...
    static get(name, id, state, opts) {
        return new RemediationRecipe(name, state, { ...opts, id: id });
    }
    /**
...
exports.RemediationRecipe = RemediationRecipe;
/** @internal */
RemediationRecipe.__pulumiType = 'oci:Adm/remediationRecipe:RemediationRecipe';
//# sourceMappingURL=remediationRecipe.js.map
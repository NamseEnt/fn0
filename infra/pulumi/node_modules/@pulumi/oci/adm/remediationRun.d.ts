 ...
 * ```
 */
export declare class RemediationRun extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: RemediationRunState, opts?: pulumi.CustomResourceOptions): RemediationRun;
    /**
     * Returns true if the given object is an instance of RemediationRun.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is RemediationRun;
    /**
     ...
     */
    readonly currentStageType: pulumi.Output<string>;
    /**
     ...
     */
    readonly remediationRecipeId: pulumi.Output<string>;
    /**
     * The source that triggered the Remediation Recipe.
     */
    readonly remediationRunSource: pulumi.Output<string>;
    /**
     * The list of remediation run stage summaries.
     */
    readonly stages: pulumi.Output<outputs.Adm.RemediationRunStage[]>;
    /**

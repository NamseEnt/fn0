 ...
 * ```
 */
class OdaPrivateEndpointScanProxy extends pulumi.CustomResource {
    /**
    ...
    static get(name, id, state, opts) {
        return new OdaPrivateEndpointScanProxy(name, state, { ...opts, id: id });
    }
    /**
...
exports.OdaPrivateEndpointScanProxy = OdaPrivateEndpointScanProxy;
/** @internal */
OdaPrivateEndpointScanProxy.__pulumiType = 'oci:Oda/odaPrivateEndpointScanProxy:OdaPrivateEndpointScanProxy';
//# sourceMappingURL=odaPrivateEndpointScanProxy.js.map
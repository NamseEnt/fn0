 ...
 * ```
 */
export declare function getOdaInstances(args: GetOdaInstancesArgs, opts?: pulumi.InvokeOptions): Promise<GetOdaInstancesResult>;
/**
 ...
 * ```
 */
export declare function getOdaInstancesOutput(args: GetOdaInstancesOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetOdaInstancesResult>;
/**
 * A collection of arguments for invoking getOdaInstances.
 */

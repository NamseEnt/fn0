 ...
 * ```
 */
export declare function getOdaPrivateEndpointScanProxies(args: GetOdaPrivateEndpointScanProxiesArgs, opts?: pulumi.InvokeOptions): Promise<GetOdaPrivateEndpointScanProxiesResult>;
/**
 ...
 * ```
 */
export declare function getOdaPrivateEndpointScanProxiesOutput(args: GetOdaPrivateEndpointScanProxiesOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetOdaPrivateEndpointScanProxiesResult>;
/**
 * A collection of arguments for invoking getOdaPrivateEndpointScanProxies.
 */

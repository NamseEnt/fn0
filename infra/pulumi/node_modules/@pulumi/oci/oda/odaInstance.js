 ...
 * ```
 */
class OdaInstance extends pulumi.CustomResource {
    /**
    ...
    static get(name, id, state, opts) {
        return new OdaInstance(name, state, { ...opts, id: id });
    }
    /**
...
exports.OdaInstance = OdaInstance;
/** @internal */
OdaInstance.__pulumiType = 'oci:Oda/odaInstance:OdaInstance';
//# sourceMappingURL=odaInstance.js.map
 ...
 * ```
 */
export declare function getRecipientInvitation(args: GetRecipientInvitationArgs, opts?: pulumi.InvokeOptions): Promise<GetRecipientInvitationResult>;
/**
 ...
 * ```
 */
export declare function getRecipientInvitationOutput(args: GetRecipientInvitationOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetRecipientInvitationResult>;
/**
 * A collection of arguments for invoking getRecipientInvitation.
 */

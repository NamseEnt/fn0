 ...
 * ```
 */
export declare function getOrganizationTenancy(args: GetOrganizationTenancyArgs, opts?: pulumi.InvokeOptions): Promise<GetOrganizationTenancyResult>;
/**
 ...
 * ```
 */
export declare function getOrganizationTenancyOutput(args: GetOrganizationTenancyOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetOrganizationTenancyResult>;
/**
 * A collection of arguments for invoking getOrganizationTenancy.
 */

 ...
 * ```
 */
export declare function getDomainGovernance(args: GetDomainGovernanceArgs, opts?: pulumi.InvokeOptions): Promise<GetDomainGovernanceResult>;
/**
 ...
 * ```
 */
export declare function getDomainGovernanceOutput(args: GetDomainGovernanceOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetDomainGovernanceResult>;
/**
 * A collection of arguments for invoking getDomainGovernance.
 */

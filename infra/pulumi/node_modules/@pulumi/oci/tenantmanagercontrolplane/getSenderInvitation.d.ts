 ...
 * ```
 */
export declare function getSenderInvitation(args: GetSenderInvitationArgs, opts?: pulumi.InvokeOptions): Promise<GetSenderInvitationResult>;
/**
 ...
 * ```
 */
export declare function getSenderInvitationOutput(args: GetSenderInvitationOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetSenderInvitationResult>;
/**
 * A collection of arguments for invoking getSenderInvitation.
 */

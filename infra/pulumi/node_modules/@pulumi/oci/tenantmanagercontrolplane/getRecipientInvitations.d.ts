 ...
 * ```
 */
export declare function getRecipientInvitations(args: GetRecipientInvitationsArgs, opts?: pulumi.InvokeOptions): Promise<GetRecipientInvitationsResult>;
/**
 ...
 * ```
 */
export declare function getRecipientInvitationsOutput(args: GetRecipientInvitationsOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetRecipientInvitationsResult>;
/**
 * A collection of arguments for invoking getRecipientInvitations.
 */

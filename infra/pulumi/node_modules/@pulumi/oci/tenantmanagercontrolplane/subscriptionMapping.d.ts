 ...
 * ```
 */
export declare class SubscriptionMapping extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: SubscriptionMappingState, opts?: pulumi.CustomResourceOptions): SubscriptionMapping;
    /**
     * Returns true if the given object is an instance of SubscriptionMapping.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is SubscriptionMapping;
    /**
     ...
     */
    readonly isExplicitlyAssigned: pulumi.Output<boolean>;
    /**
     ...
     */
    readonly timeTerminated: pulumi.Output<string>;
    /**

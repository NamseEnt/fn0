 ...
 * ```
 */
export declare class DedicatedVantagePoint extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: DedicatedVantagePointState, opts?: pulumi.CustomResourceOptions): DedicatedVantagePoint;
    /**
     * Returns true if the given object is an instance of DedicatedVantagePoint.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is DedicatedVantagePoint;
    /**
     ...
     */
    readonly dvpStackDetails: pulumi.Output<outputs.ApmSynthetics.DedicatedVantagePointDvpStackDetails>;
    /**
     ...
     */
    readonly monitorStatusCountMaps: pulumi.Output<outputs.ApmSynthetics.DedicatedVantagePointMonitorStatusCountMap[]>;
    /**

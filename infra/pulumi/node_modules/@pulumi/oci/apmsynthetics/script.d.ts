...
export declare class Script extends pulumi.CustomResource {
     ...
     */
    readonly contentFileName: pulumi.Output<string>;
    /**
     * Size of the script content.
     */
    readonly contentSizeInBytes: pulumi.Output<number>;
    /**
     ...
     */
    readonly monitorStatusCountMaps: pulumi.Output<outputs.ApmSynthetics.ScriptMonitorStatusCountMap[]>;
    /**
     * (Updatable) List of script parameters. Example: `[{"paramName": "userid", "paramValue":"testuser", "isSecret": false}]`
     */
    readonly parameters: pulumi.Output<outputs.ApmSynthetics.ScriptParameter[]>;
    /**
     ...
     */
    readonly timeUploaded: pulumi.Output<string>;
    /**

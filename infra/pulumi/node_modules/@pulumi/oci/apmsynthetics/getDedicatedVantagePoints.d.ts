 ...
 * ```
 */
export declare function getDedicatedVantagePoints(args: GetDedicatedVantagePointsArgs, opts?: pulumi.InvokeOptions): Promise<GetDedicatedVantagePointsResult>;
/**
 ...
 * ```
 */
export declare function getDedicatedVantagePointsOutput(args: GetDedicatedVantagePointsOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetDedicatedVantagePointsResult>;
/**
 * A collection of arguments for invoking getDedicatedVantagePoints.
 */

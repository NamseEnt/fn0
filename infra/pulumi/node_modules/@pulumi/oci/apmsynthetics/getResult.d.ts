 ...
 * ```
 */
export declare function getResult(args: GetResultArgs, opts?: pulumi.InvokeOptions): Promise<GetResultResult>;
/**
 ...
 * ```
 */
export declare function getResultOutput(args: GetResultOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetResultResult>;
/**
 * A collection of arguments for invoking getResult.
 */

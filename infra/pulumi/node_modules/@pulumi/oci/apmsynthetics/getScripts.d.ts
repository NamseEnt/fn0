 ...
 * ```
 */
export declare function getScripts(args: GetScriptsArgs, opts?: pulumi.InvokeOptions): Promise<GetScriptsResult>;
/**
 ...
 * ```
 */
export declare function getScriptsOutput(args: GetScriptsOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetScriptsResult>;
/**
 * A collection of arguments for invoking getScripts.
 */

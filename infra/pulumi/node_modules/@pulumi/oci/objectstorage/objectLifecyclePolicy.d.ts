 ...
 * ```
 */
export declare class ObjectLifecyclePolicy extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ObjectLifecyclePolicyState, opts?: pulumi.CustomResourceOptions): ObjectLifecyclePolicy;
    /**
     * Returns true if the given object is an instance of ObjectLifecyclePolicy.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is ObjectLifecyclePolicy;
    /**
     ...
     */
    readonly rules: pulumi.Output<outputs.ObjectStorage.ObjectLifecyclePolicyRule[]>;
    /**

 ...
 * ```
 */
export declare function getObjectLifecyclePolicy(args: GetObjectLifecyclePolicyArgs, opts?: pulumi.InvokeOptions): Promise<GetObjectLifecyclePolicyResult>;
/**
 ...
 * ```
 */
export declare function getObjectLifecyclePolicyOutput(args: GetObjectLifecyclePolicyOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetObjectLifecyclePolicyResult>;
/**
 * A collection of arguments for invoking getObjectLifecyclePolicy.
 */

 ...
 * ```
 */
export declare function getObjectHead(args: GetObjectHeadArgs, opts?: pulumi.InvokeOptions): Promise<GetObjectHeadResult>;
/**
 ...
 * ```
 */
export declare function getObjectHeadOutput(args: GetObjectHeadOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetObjectHeadResult>;
/**
 * A collection of arguments for invoking getObjectHead.
 */

 ...
 * ```
 */
export declare function getNetworkLoadBalancerHealth(args: GetNetworkLoadBalancerHealthArgs, opts?: pulumi.InvokeOptions): Promise<GetNetworkLoadBalancerHealthResult>;
/**
 ...
 * ```
 */
export declare function getNetworkLoadBalancerHealthOutput(args: GetNetworkLoadBalancerHealthOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetNetworkLoadBalancerHealthResult>;
/**
 * A collection of arguments for invoking getNetworkLoadBalancerHealth.
 */

 ...
 * ```
 */
export declare function getBackendSets(args: GetBackendSetsArgs, opts?: pulumi.InvokeOptions): Promise<GetBackendSetsResult>;
/**
 ...
 * ```
 */
export declare function getBackendSetsOutput(args: GetBackendSetsOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetBackendSetsResult>;
/**
 * A collection of arguments for invoking getBackendSets.
 */

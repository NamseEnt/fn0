 ...
 * ```
 */
class ClusterPlacementGroup extends pulumi.CustomResource {
    /**
    ...
    static get(name, id, state, opts) {
        return new ClusterPlacementGroup(name, state, { ...opts, id: id });
    }
    /**
...
exports.ClusterPlacementGroup = ClusterPlacementGroup;
/** @internal */
ClusterPlacementGroup.__pulumiType = 'oci:ClusterPlacementGroups/clusterPlacementGroup:ClusterPlacementGroup';
//# sourceMappingURL=clusterPlacementGroup.js.map
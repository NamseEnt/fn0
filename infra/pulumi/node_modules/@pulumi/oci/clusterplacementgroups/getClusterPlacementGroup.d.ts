 ...
 * ```
 */
export declare function getClusterPlacementGroup(args: GetClusterPlacementGroupArgs, opts?: pulumi.InvokeOptions): Promise<GetClusterPlacementGroupResult>;
/**
 ...
 * ```
 */
export declare function getClusterPlacementGroupOutput(args: GetClusterPlacementGroupOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetClusterPlacementGroupResult>;
/**
 * A collection of arguments for invoking getClusterPlacementGroup.
 */

 ...
 * ```
 */
export declare function getAcceptedAgreements(args: GetAcceptedAgreementsArgs, opts?: pulumi.InvokeOptions): Promise<GetAcceptedAgreementsResult>;
/**
 ...
 * ```
 */
export declare function getAcceptedAgreementsOutput(args: GetAcceptedAgreementsOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetAcceptedAgreementsResult>;
/**
 * A collection of arguments for invoking getAcceptedAgreements.
 */

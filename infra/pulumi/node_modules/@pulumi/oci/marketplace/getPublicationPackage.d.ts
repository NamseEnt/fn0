 ...
 * ```
 */
export declare function getPublicationPackage(args: GetPublicationPackageArgs, opts?: pulumi.InvokeOptions): Promise<GetPublicationPackageResult>;
/**
 ...
 * ```
 */
export declare function getPublicationPackageOutput(args: GetPublicationPackageOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetPublicationPackageResult>;
/**
 * A collection of arguments for invoking getPublicationPackage.
 */

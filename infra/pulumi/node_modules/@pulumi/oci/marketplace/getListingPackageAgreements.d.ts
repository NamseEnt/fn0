 ...
 * ```
 */
export declare function getListingPackageAgreements(args: GetListingPackageAgreementsArgs, opts?: pulumi.InvokeOptions): Promise<GetListingPackageAgreementsResult>;
/**
 ...
 * ```
 */
export declare function getListingPackageAgreementsOutput(args: GetListingPackageAgreementsOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetListingPackageAgreementsResult>;
/**
 * A collection of arguments for invoking getListingPackageAgreements.
 */

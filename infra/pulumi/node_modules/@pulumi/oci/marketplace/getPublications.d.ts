 ...
 * ```
 */
export declare function getPublications(args: GetPublicationsArgs, opts?: pulumi.InvokeOptions): Promise<GetPublicationsResult>;
/**
 ...
 * ```
 */
export declare function getPublicationsOutput(args: GetPublicationsOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetPublicationsResult>;
/**
 * A collection of arguments for invoking getPublications.
 */

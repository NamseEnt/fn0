 ...
 * ```
 */
export declare function getListing(args: GetListingArgs, opts?: pulumi.InvokeOptions): Promise<GetListingResult>;
/**
 ...
 * ```
 */
export declare function getListingOutput(args: GetListingOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetListingResult>;
/**
 * A collection of arguments for invoking getListing.
 */

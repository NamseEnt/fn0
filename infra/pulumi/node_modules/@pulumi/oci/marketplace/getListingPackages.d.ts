 ...
 * ```
 */
export declare function getListingPackages(args: GetListingPackagesArgs, opts?: pulumi.InvokeOptions): Promise<GetListingPackagesResult>;
/**
 ...
 * ```
 */
export declare function getListingPackagesOutput(args: GetListingPackagesOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetListingPackagesResult>;
/**
 * A collection of arguments for invoking getListingPackages.
 */

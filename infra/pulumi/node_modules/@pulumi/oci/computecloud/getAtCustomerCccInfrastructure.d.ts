 ...
 * ```
 */
export declare function getAtCustomerCccInfrastructure(args: GetAtCustomerCccInfrastructureArgs, opts?: pulumi.InvokeOptions): Promise<GetAtCustomerCccInfrastructureResult>;
/**
 ...
 * ```
 */
export declare function getAtCustomerCccInfrastructureOutput(args: GetAtCustomerCccInfrastructureOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetAtCustomerCccInfrastructureResult>;
/**
 * A collection of arguments for invoking getAtCustomerCccInfrastructure.
 */

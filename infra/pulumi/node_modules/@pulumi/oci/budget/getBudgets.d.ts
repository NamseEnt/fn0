 ...
 * ```
 */
export declare function getBudgets(args: GetBudgetsArgs, opts?: pulumi.InvokeOptions): Promise<GetBudgetsResult>;
/**
 ...
 * ```
 */
export declare function getBudgetsOutput(args: GetBudgetsOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetBudgetsResult>;
/**
 * A collection of arguments for invoking getBudgets.
 */

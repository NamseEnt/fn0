 ...
 * ```
 */
export declare class AgentPlugin extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: AgentPluginState, opts?: pulumi.CustomResourceOptions): AgentPlugin;
    /**
     * Returns true if the given object is an instance of AgentPlugin.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is AgentPlugin;
    /**

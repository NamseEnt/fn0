 ...
 * ```
 */
export declare function getDiscoverySchedules(args: GetDiscoverySchedulesArgs, opts?: pulumi.InvokeOptions): Promise<GetDiscoverySchedulesResult>;
/**
 ...
 * ```
 */
export declare function getDiscoverySchedulesOutput(args: GetDiscoverySchedulesOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetDiscoverySchedulesResult>;
/**
 * A collection of arguments for invoking getDiscoverySchedules.
 */

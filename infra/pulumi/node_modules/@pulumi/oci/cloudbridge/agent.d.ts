...
export declare class Agent extends pulumi.CustomResource {
     ...
     */
    readonly agentPubKey: pulumi.Output<string>;
    /**
     * Agent identifier.
     */
     ...
     */
    readonly heartBeatStatus: pulumi.Output<string>;
    /**
     ...
     */
    readonly pluginLists: pulumi.Output<outputs.CloudBridge.AgentPluginList[]>;
    /**
     ...
     */
    readonly timeExpireAgentKeyInMs: pulumi.Output<string>;
    /**
     * The time when the last heartbeat of the Agent was noted. An RFC3339 formatted datetime string.
     */
    readonly timeLastSyncReceived: pulumi.Output<string>;
    /**

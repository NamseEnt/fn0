 ...
 * ```
 */
class AgentPlugin extends pulumi.CustomResource {
    /**
    ...
    static get(name, id, state, opts) {
        return new AgentPlugin(name, state, { ...opts, id: id });
    }
    /**
...
/** @internal */
AgentPlugin.__pulumiType = 'oci:CloudBridge/agentPlugin:AgentPlugin';

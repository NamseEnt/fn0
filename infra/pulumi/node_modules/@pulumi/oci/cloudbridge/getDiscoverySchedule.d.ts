 ...
 * ```
 */
export declare function getDiscoverySchedule(args: GetDiscoveryScheduleArgs, opts?: pulumi.InvokeOptions): Promise<GetDiscoveryScheduleResult>;
/**
 ...
 * ```
 */
export declare function getDiscoveryScheduleOutput(args: GetDiscoveryScheduleOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetDiscoveryScheduleResult>;
/**
 * A collection of arguments for invoking getDiscoverySchedule.
 */

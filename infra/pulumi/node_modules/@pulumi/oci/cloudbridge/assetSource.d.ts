 ...
 * ```
 */
export declare class AssetSource extends pulumi.CustomResource {
    /**
     ...
     */
    readonly discoveryCredentials: pulumi.Output<outputs.CloudBridge.AssetSourceDiscoveryCredentials>;
    /**
     ...
     */
    readonly discoveryScheduleId: pulumi.Output<string>;
    /**
     ...
     * (Updatable) Credentials for an asset source.
     */
    readonly replicationCredentials: pulumi.Output<outputs.CloudBridge.AssetSourceReplicationCredentials>;
    /**
     ...
     */
    readonly vcenterEndpoint: pulumi.Output<string>;
    /**

 ...
 * ```
 */
export declare class DiscoverySchedule extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: DiscoveryScheduleState, opts?: pulumi.CustomResourceOptions): DiscoverySchedule;
    /**
     * Returns true if the given object is an instance of DiscoverySchedule.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is DiscoverySchedule;
    /**

 ...
 * ```
 */
export declare function getAgentDependencies(args: GetAgentDependenciesArgs, opts?: pulumi.InvokeOptions): Promise<GetAgentDependenciesResult>;
/**
 ...
 * ```
 */
export declare function getAgentDependenciesOutput(args: GetAgentDependenciesOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetAgentDependenciesResult>;
/**
 * A collection of arguments for invoking getAgentDependencies.
 */

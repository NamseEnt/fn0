 ...
 * ```
 */
export declare function getAssetSources(args: GetAssetSourcesArgs, opts?: pulumi.InvokeOptions): Promise<GetAssetSourcesResult>;
/**
 ...
 * ```
 */
export declare function getAssetSourcesOutput(args: GetAssetSourcesOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetAssetSourcesResult>;
/**
 * A collection of arguments for invoking getAssetSources.
 */

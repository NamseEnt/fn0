...
export declare class Certificate extends pulumi.CustomResource {
     ...
     */
    readonly intermediateCertificates: pulumi.Output<string>;
     ...
     */
    readonly locks: pulumi.Output<outputs.ApiGateway.CertificateLock[]>;
    /**
     ...
     */
    readonly subjectNames: pulumi.Output<string[]>;
    /**

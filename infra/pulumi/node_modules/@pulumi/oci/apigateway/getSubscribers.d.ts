 ...
 * ```
 */
export declare function getSubscribers(args: GetSubscribersArgs, opts?: pulumi.InvokeOptions): Promise<GetSubscribersResult>;
/**
 ...
 * ```
 */
export declare function getSubscribersOutput(args: GetSubscribersOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetSubscribersResult>;
/**
 * A collection of arguments for invoking getSubscribers.
 */

...
export declare class Gateway extends pulumi.CustomResource {
     ...
     */
    readonly caBundles: pulumi.Output<outputs.ApiGateway.GatewayCaBundle[]>;
    /**
     ...
     */
    readonly ipAddresses: pulumi.Output<outputs.ApiGateway.GatewayIpAddress[]>;
    /**
     ...
     */
    readonly ipMode: pulumi.Output<string>;
    /**
     * IPv4 address configuration details that should be used when creating the gateway.
     */
    readonly ipv4addressConfiguration: pulumi.Output<outputs.ApiGateway.GatewayIpv4addressConfiguration>;
    /**
     * IPv6 address configuration details that should be used when creating the gateway.
     */
    readonly ipv6addressConfiguration: pulumi.Output<outputs.ApiGateway.GatewayIpv6addressConfiguration>;
     ...
     */
    readonly locks: pulumi.Output<outputs.ApiGateway.GatewayLock[]>;
    /**
     ...
     */
    readonly responseCacheDetails: pulumi.Output<outputs.ApiGateway.GatewayResponseCacheDetails>;
    /**

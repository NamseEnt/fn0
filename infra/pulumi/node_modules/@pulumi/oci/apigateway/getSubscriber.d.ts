 ...
 * ```
 */
export declare function getSubscriber(args: GetSubscriberArgs, opts?: pulumi.InvokeOptions): Promise<GetSubscriberResult>;
/**
 ...
 * ```
 */
export declare function getSubscriberOutput(args: GetSubscriberOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetSubscriberResult>;
/**
 * A collection of arguments for invoking getSubscriber.
 */

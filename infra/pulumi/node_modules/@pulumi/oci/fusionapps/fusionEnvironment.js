 ...
 * ```
 */
class FusionEnvironment extends pulumi.CustomResource {
    /**
    ...
    static get(name, id, state, opts) {
        return new FusionEnvironment(name, state, { ...opts, id: id });
    }
    /**
...
exports.FusionEnvironment = FusionEnvironment;
/** @internal */
FusionEnvironment.__pulumiType = 'oci:FusionApps/fusionEnvironment:FusionEnvironment';
//# sourceMappingURL=fusionEnvironment.js.map
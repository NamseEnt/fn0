 ...
 * ```
 */
export declare class FusionEnvironmentRefreshActivity extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: FusionEnvironmentRefreshActivityState, opts?: pulumi.CustomResourceOptions): FusionEnvironmentRefreshActivity;
    /**
     ...
     */
    static isInstance(obj: any): obj is FusionEnvironmentRefreshActivity;
    /**
     ...
     */
    readonly fusionEnvironmentId: pulumi.Output<string>;
    /**
     * Represents if the customer opted for Data Masking or not during refreshActivity.
     */
    readonly isDataMaskingOpted: pulumi.Output<boolean>;
    /**
     * A message describing the current state in more detail. For example, can be used to provide actionable information for a resource in Failed state.
     */
    readonly lifecycleDetails: pulumi.Output<string>;
    readonly refreshActivityId: pulumi.Output<string>;
    /**
     * Details of refresh investigation information, each item represents a different issue.
     */
    readonly refreshIssueDetailsLists: pulumi.Output<outputs.FusionApps.FusionEnvironmentRefreshActivityRefreshIssueDetailsList[]>;
    /**
     * Service availability / impact during refresh activity execution up down
     */
    readonly serviceAvailability: pulumi.Output<string>;
    /**
     * The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the source environment
     */
    readonly sourceFusionEnvironmentId: pulumi.Output<string>;
    /**
     ...
     */
    readonly timeExpectedFinish: pulumi.Output<string>;
    /**
     ...
     */
    readonly timeOfRestorationPoint: pulumi.Output<string>;
    /**

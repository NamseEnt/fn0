 ...
 * ```
 */
export declare class FusionEnvironmentAdminUser extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: FusionEnvironmentAdminUserState, opts?: pulumi.CustomResourceOptions): FusionEnvironmentAdminUser;
    /**
     ...
     */
    static isInstance(obj: any): obj is FusionEnvironmentAdminUser;
    /**
     ...
     */
    readonly items: pulumi.Output<outputs.FusionApps.FusionEnvironmentAdminUserItem[]>;
    /**

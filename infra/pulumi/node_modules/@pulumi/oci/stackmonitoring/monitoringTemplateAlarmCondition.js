...
exports.MonitoringTemplateAlarmCondition = void 0;
 ...
 * ```
 */
class MonitoringTemplateAlarmCondition extends pulumi.CustomResource {
    /**
    ...
    static get(name, id, state, opts) {
        return new MonitoringTemplateAlarmCondition(name, state, { ...opts, id: id });
    }
    /**
...
exports.MonitoringTemplateAlarmCondition = MonitoringTemplateAlarmCondition;
/** @internal */
MonitoringTemplateAlarmCondition.__pulumiType = 'oci:StackMonitoring/monitoringTemplateAlarmCondition:MonitoringTemplateAlarmCondition';
//# sourceMappingURL=monitoringTemplateAlarmCondition.js.map
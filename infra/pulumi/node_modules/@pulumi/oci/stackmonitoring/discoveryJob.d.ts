 ...
 * ```
 */
export declare class DiscoveryJob extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: DiscoveryJobState, opts?: pulumi.CustomResourceOptions): DiscoveryJob;
    /**
     * Returns true if the given object is an instance of DiscoveryJob.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is DiscoveryJob;
    /**
     ...
     */
    readonly discoveryClient: pulumi.Output<string>;
    /**
     * The request of DiscoveryJob Resource details.
     */
    readonly discoveryDetails: pulumi.Output<outputs.StackMonitoring.DiscoveryJobDiscoveryDetails>;
    /**
     * Add option submits new discovery Job. Add with retry option to re-submit failed discovery job. Refresh option refreshes the existing discovered resources.
     */
    readonly discoveryType: pulumi.Output<string | undefined>;
    /**
     ...
     */
    readonly shouldPropagateTagsToDiscoveredResources: pulumi.Output<boolean>;
    /**

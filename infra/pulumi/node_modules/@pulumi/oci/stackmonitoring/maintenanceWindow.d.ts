...
export declare class MaintenanceWindow extends pulumi.CustomResource {
     ...
     */
    readonly resources: pulumi.Output<outputs.StackMonitoring.MaintenanceWindowResource[]>;
    /**
     * List of resource details that are part of the Maintenance Window.
     */
    readonly resourcesDetails: pulumi.Output<outputs.StackMonitoring.MaintenanceWindowResourcesDetail[]>;
    /**
     * (Updatable) Schedule information of the Maintenance Window
     */
    readonly schedule: pulumi.Output<outputs.StackMonitoring.MaintenanceWindowSchedule>;
    /**

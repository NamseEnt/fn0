 ...
 * ```
 */
export declare function getMonitoredResourceTaskOutput(args: GetMonitoredResourceTaskOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetMonitoredResourceTaskResult>;
/**
 * A collection of arguments for invoking getMonitoredResourceTask.
 */

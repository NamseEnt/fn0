 ...
 * ```
 */
export declare class MonitoringTemplateAlarmCondition extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: MonitoringTemplateAlarmConditionState, opts?: pulumi.CustomResourceOptions): MonitoringTemplateAlarmCondition;
    /**
     ...
     */
    static isInstance(obj: any): obj is MonitoringTemplateAlarmCondition;
    /**
     * (Updatable) The OCID of the composite resource type like EBS/PEOPLE_SOFT.
     */
    readonly compositeType: pulumi.Output<string>;
    /**
     ...
     */
    readonly conditions: pulumi.Output<outputs.StackMonitoring.MonitoringTemplateAlarmConditionCondition[]>;
    /**

 ...
 * ```
 */
export declare function getMetricExtensionsOutput(args?: GetMetricExtensionsOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetMetricExtensionsResult>;
/**
 * A collection of arguments for invoking getMetricExtensions.
 */

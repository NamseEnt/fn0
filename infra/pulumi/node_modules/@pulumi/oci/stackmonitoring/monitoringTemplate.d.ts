 ...
 * ```
 */
export declare class MonitoringTemplate extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: MonitoringTemplateState, opts?: pulumi.CustomResourceOptions): MonitoringTemplate;
    /**
     * Returns true if the given object is an instance of MonitoringTemplate.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is MonitoringTemplate;
    /**
     ...
     */
    readonly isAlarmsEnabled: pulumi.Output<boolean>;
    /**
     * (Updatable) Whether the alarm notification is enabled or disabled, it will be Enabled by default.
     */
    readonly isSplitNotificationEnabled: pulumi.Output<boolean>;
    /**
     * (Updatable) List of members of this monitoring template
     */
    readonly members: pulumi.Output<outputs.StackMonitoring.MonitoringTemplateMember[]>;
    /**
     ...
     */
    readonly totalAlarmConditions: pulumi.Output<number>;
    /**
     * Total Applied Alarm Conditions
     */
    readonly totalAppliedAlarmConditions: pulumi.Output<number>;
    /**

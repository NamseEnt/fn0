 ...
 * ```
 */
export declare class ProcessSet extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ProcessSetState, opts?: pulumi.CustomResourceOptions): ProcessSet;
    /**
     * Returns true if the given object is an instance of ProcessSet.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is ProcessSet;
    /**
     ...
     */
    readonly specification: pulumi.Output<outputs.StackMonitoring.ProcessSetSpecification>;
    /**

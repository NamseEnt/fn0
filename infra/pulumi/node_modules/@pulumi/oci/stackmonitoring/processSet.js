 ...
 * ```
 */
class ProcessSet extends pulumi.CustomResource {
    /**
    ...
    static get(name, id, state, opts) {
        return new ProcessSet(name, state, { ...opts, id: id });
    }
    /**
...
/** @internal */
ProcessSet.__pulumiType = 'oci:StackMonitoring/processSet:ProcessSet';
//# sourceMappingURL=processSet.js.map
...
export declare class MonitoredResourceType extends pulumi.CustomResource {
     ...
     */
    readonly additionalNamespaceMap: pulumi.Output<{
        [key: string]: string;
    }>;
    /**
     * Availability metrics details.
     */
    readonly availabilityMetricsConfigs: pulumi.Output<outputs.StackMonitoring.MonitoredResourceTypeAvailabilityMetricsConfig[]>;
    /**
     ...
     */
    readonly handlerConfigs: pulumi.Output<outputs.StackMonitoring.MonitoredResourceTypeHandlerConfig[]>;
    /**
     * If boolean flag is true, then the resource type cannot be modified or deleted.
     */
    readonly isSystemDefined: pulumi.Output<boolean>;
    /**
...
export interface MonitoredResourceTypeState {
     ...
     * Key/Value pair for additional namespaces used by stack monitoring services for SYSTEM (SMB) resource types.
     */
    additionalNamespaceMap?: pulumi.Input<{

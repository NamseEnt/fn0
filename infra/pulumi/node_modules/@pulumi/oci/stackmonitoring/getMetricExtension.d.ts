 ...
 * ```
 */
export declare function getMetricExtensionOutput(args: GetMetricExtensionOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetMetricExtensionResult>;
/**
 * A collection of arguments for invoking getMetricExtension.
 */

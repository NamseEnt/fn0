 ...
 * ```
 */
export declare class MonitoredResourcesListMember extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: MonitoredResourcesListMemberState, opts?: pulumi.CustomResourceOptions): MonitoredResourcesListMember;
    /**
     ...
     */
    static isInstance(obj: any): obj is MonitoredResourcesListMember;
    /**
     ...
     */
    readonly items: pulumi.Output<outputs.StackMonitoring.MonitoredResourcesListMemberItem[]>;
    /**
     * The field which determines the depth of hierarchy while searching for members.
     */
    readonly limitLevel: pulumi.Output<number | undefined>;
    /**
     ...
     */
    readonly monitoredResourceId: pulumi.Output<string>;
    /**

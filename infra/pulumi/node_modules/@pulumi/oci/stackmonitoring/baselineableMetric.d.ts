 ...
 * ```
 */
export declare class BaselineableMetric extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: BaselineableMetricState, opts?: pulumi.CustomResourceOptions): BaselineableMetric;
    /**
     * Returns true if the given object is an instance of BaselineableMetric.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is BaselineableMetric;
    /**
     ...
     */
    readonly isOutOfBox: pulumi.Output<boolean>;
    /**

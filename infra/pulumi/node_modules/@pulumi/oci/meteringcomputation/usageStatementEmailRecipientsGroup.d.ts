 ...
 * ```
 */
export declare class UsageStatementEmailRecipientsGroup extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: UsageStatementEmailRecipientsGroupState, opts?: pulumi.CustomResourceOptions): UsageStatementEmailRecipientsGroup;
    /**
     ...
     */
    static isInstance(obj: any): obj is UsageStatementEmailRecipientsGroup;
    /**
     * (Updatable) The customer tenancy.
     */
    readonly compartmentId: pulumi.Output<string>;
    readonly emailRecipientsGroupId: pulumi.Output<string>;
    /**
     * (Updatable) The list of recipients that will receive usage statement emails.
     */
    readonly recipientsLists: pulumi.Output<outputs.MeteringComputation.UsageStatementEmailRecipientsGroupRecipientsList[]>;
    /**

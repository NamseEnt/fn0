 ...
 * ```
 */
class CustomTable extends pulumi.CustomResource {
    /**
    ...
    static get(name, id, state, opts) {
        return new CustomTable(name, state, { ...opts, id: id });
    }
    /**
...
/** @internal */
CustomTable.__pulumiType = 'oci:MeteringComputation/customTable:CustomTable';

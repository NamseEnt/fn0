 ...
 * ```
 */
export declare function getConnectHarnesses(args: GetConnectHarnessesArgs, opts?: pulumi.InvokeOptions): Promise<GetConnectHarnessesResult>;
/**
 ...
 * ```
 */
export declare function getConnectHarnessesOutput(args: GetConnectHarnessesOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetConnectHarnessesResult>;
/**
 * A collection of arguments for invoking getConnectHarnesses.
 */

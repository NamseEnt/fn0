 ...
 * ```
 */
export declare class ManagedKafkaKafkaCluster extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ManagedKafkaKafkaClusterState, opts?: pulumi.CustomResourceOptions): ManagedKafkaKafkaCluster;
    /**
     * Returns true if the given object is an instance of ManagedKafkaKafkaCluster.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is ManagedKafkaKafkaCluster;
    /**
     * (Updatable) Subnets where broker/coordinator VNICs will be created.
     */
    readonly accessSubnets: pulumi.Output<outputs.oci.ManagedKafkaKafkaClusterAccessSubnet[]>;
    /**
     * (Updatable) Configuration of the broker node.
     */
    readonly brokerShape: pulumi.Output<outputs.oci.ManagedKafkaKafkaClusterBrokerShape>;
    /**
     * (Updatable) CA certificate bundle for mTLS broker authentication.
     */
    readonly clientCertificateBundle: pulumi.Output<string>;
    /**
     ...
     */
    readonly clusterConfigId: pulumi.Output<string>;
    /**
     * (Updatable) The version of configuration object
     */
    readonly clusterConfigVersion: pulumi.Output<number>;
    /**
     ...
     */
    readonly coordinationType: pulumi.Output<string>;
    /**
     ...
     */
    readonly kafkaBootstrapUrls: pulumi.Output<outputs.oci.ManagedKafkaKafkaClusterKafkaBootstrapUrl[]>;
    /**

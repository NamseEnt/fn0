 ...
 * ```
 */
export declare function getIotDigitalTwinModel(args: GetIotDigitalTwinModelArgs, opts?: pulumi.InvokeOptions): Promise<GetIotDigitalTwinModelResult>;
/**
 ...
 * ```
 */
export declare function getIotDigitalTwinModelOutput(args: GetIotDigitalTwinModelOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetIotDigitalTwinModelResult>;
/**
 * A collection of arguments for invoking getIotDigitalTwinModel.
 */

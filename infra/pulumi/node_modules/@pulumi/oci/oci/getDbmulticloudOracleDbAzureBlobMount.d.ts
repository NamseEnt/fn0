 ...
 * ```
 */
export declare function getDbmulticloudOracleDbAzureBlobMount(args: GetDbmulticloudOracleDbAzureBlobMountArgs, opts?: pulumi.InvokeOptions): Promise<GetDbmulticloudOracleDbAzureBlobMountResult>;
/**
 ...
 * ```
 */
export declare function getDbmulticloudOracleDbAzureBlobMountOutput(args: GetDbmulticloudOracleDbAzureBlobMountOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetDbmulticloudOracleDbAzureBlobMountResult>;
/**
 * A collection of arguments for invoking getDbmulticloudOracleDbAzureBlobMount.
 */

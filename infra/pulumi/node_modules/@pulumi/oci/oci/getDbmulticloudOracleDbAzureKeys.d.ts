 ...
 * ```
 */
export declare function getDbmulticloudOracleDbAzureKeys(args: GetDbmulticloudOracleDbAzureKeysArgs, opts?: pulumi.InvokeOptions): Promise<GetDbmulticloudOracleDbAzureKeysResult>;
/**
 ...
 * ```
 */
export declare function getDbmulticloudOracleDbAzureKeysOutput(args: GetDbmulticloudOracleDbAzureKeysOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetDbmulticloudOracleDbAzureKeysResult>;
/**
 * A collection of arguments for invoking getDbmulticloudOracleDbAzureKeys.
 */

 ...
 * ```
 */
export declare function getWlmsWlsDomainServerBackup(args: GetWlmsWlsDomainServerBackupArgs, opts?: pulumi.InvokeOptions): Promise<GetWlmsWlsDomainServerBackupResult>;
/**
 ...
 * ```
 */
export declare function getWlmsWlsDomainServerBackupOutput(args: GetWlmsWlsDomainServerBackupOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetWlmsWlsDomainServerBackupResult>;
/**
 * A collection of arguments for invoking getWlmsWlsDomainServerBackup.
 */

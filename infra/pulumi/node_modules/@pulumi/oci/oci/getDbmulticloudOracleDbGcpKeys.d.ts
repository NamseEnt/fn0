 ...
 * ```
 */
export declare function getDbmulticloudOracleDbGcpKeys(args: GetDbmulticloudOracleDbGcpKeysArgs, opts?: pulumi.InvokeOptions): Promise<GetDbmulticloudOracleDbGcpKeysResult>;
/**
 ...
 * ```
 */
export declare function getDbmulticloudOracleDbGcpKeysOutput(args: GetDbmulticloudOracleDbGcpKeysOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetDbmulticloudOracleDbGcpKeysResult>;
/**
 * A collection of arguments for invoking getDbmulticloudOracleDbGcpKeys.
 */

 ...
 * ```
 */
export declare function getWlmsWlsDomainServerBackupContent(args: GetWlmsWlsDomainServerBackupContentArgs, opts?: pulumi.InvokeOptions): Promise<GetWlmsWlsDomainServerBackupContentResult>;
/**
 ...
 * ```
 */
export declare function getWlmsWlsDomainServerBackupContentOutput(args: GetWlmsWlsDomainServerBackupContentOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetWlmsWlsDomainServerBackupContentResult>;
/**
 * A collection of arguments for invoking getWlmsWlsDomainServerBackupContent.
 */

 ...
 * ```
 */
export declare class DbmulticloudOracleDbAzureConnector extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: DbmulticloudOracleDbAzureConnectorState, opts?: pulumi.CustomResourceOptions): DbmulticloudOracleDbAzureConnector;
    /**
     ...
     */
    static isInstance(obj: any): obj is DbmulticloudOracleDbAzureConnector;
    /**
     ...
     */
    readonly arcAgentNodes: pulumi.Output<outputs.oci.DbmulticloudOracleDbAzureConnectorArcAgentNode[]>;
    /**
     * The current Connectivity status of Azure Identity Connector resource.
     */
    readonly azureIdentityConnectivityStatus: pulumi.Output<string>;
    /**
     * (Updatable) Azure Identity mechanism.
     */
    readonly azureIdentityMechanism: pulumi.Output<string>;
    /**
     * (Updatable) Azure Resource group name.
     */
    readonly azureResourceGroup: pulumi.Output<string>;
    /**
     ...
     */
    readonly dbClusterResourceId: pulumi.Output<string>;
    /**

 ...
 * ```
 */
export declare function getApiaccesscontrolApiMetadata(args: GetApiaccesscontrolApiMetadataArgs, opts?: pulumi.InvokeOptions): Promise<GetApiaccesscontrolApiMetadataResult>;
/**
 ...
 * ```
 */
export declare function getApiaccesscontrolApiMetadataOutput(args: GetApiaccesscontrolApiMetadataOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetApiaccesscontrolApiMetadataResult>;
/**
 * A collection of arguments for invoking getApiaccesscontrolApiMetadata.
 */

 ...
 * ```
 */
export declare function getIotDigitalTwinRelationship(args: GetIotDigitalTwinRelationshipArgs, opts?: pulumi.InvokeOptions): Promise<GetIotDigitalTwinRelationshipResult>;
/**
 ...
 * ```
 */
export declare function getIotDigitalTwinRelationshipOutput(args: GetIotDigitalTwinRelationshipOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetIotDigitalTwinRelationshipResult>;
/**
 * A collection of arguments for invoking getIotDigitalTwinRelationship.
 */

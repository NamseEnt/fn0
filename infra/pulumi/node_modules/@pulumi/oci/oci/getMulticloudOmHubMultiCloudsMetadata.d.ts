 ...
 * ```
 */
export declare function getMulticloudOmHubMultiCloudsMetadata(args: GetMulticloudOmHubMultiCloudsMetadataArgs, opts?: pulumi.InvokeOptions): Promise<GetMulticloudOmHubMultiCloudsMetadataResult>;
/**
 ...
 * ```
 */
export declare function getMulticloudOmHubMultiCloudsMetadataOutput(args: GetMulticloudOmHubMultiCloudsMetadataOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetMulticloudOmHubMultiCloudsMetadataResult>;
/**
 * A collection of arguments for invoking getMulticloudOmHubMultiCloudsMetadata.
 */

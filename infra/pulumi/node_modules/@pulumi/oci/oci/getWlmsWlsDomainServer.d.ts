 ...
 * ```
 */
export declare function getWlmsWlsDomainServer(args: GetWlmsWlsDomainServerArgs, opts?: pulumi.InvokeOptions): Promise<GetWlmsWlsDomainServerResult>;
/**
 ...
 * ```
 */
export declare function getWlmsWlsDomainServerOutput(args: GetWlmsWlsDomainServerOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetWlmsWlsDomainServerResult>;
/**
 * A collection of arguments for invoking getWlmsWlsDomainServer.
 */

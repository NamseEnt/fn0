 ...
 * ```
 */
export declare function getIotIotDomain(args: GetIotIotDomainArgs, opts?: pulumi.InvokeOptions): Promise<GetIotIotDomainResult>;
/**
 ...
 * ```
 */
export declare function getIotIotDomainOutput(args: GetIotIotDomainOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetIotIotDomainResult>;
/**
 * A collection of arguments for invoking getIotIotDomain.
 */

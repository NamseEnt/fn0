 ...
 * ```
 */
export declare class ResourceAnalyticsMonitoredRegion extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ResourceAnalyticsMonitoredRegionState, opts?: pulumi.CustomResourceOptions): ResourceAnalyticsMonitoredRegion;
    /**
     ...
     */
    static isInstance(obj: any): obj is ResourceAnalyticsMonitoredRegion;
    /**

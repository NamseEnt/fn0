 ...
 * ```
 */
export declare function getDbmulticloudOracleDbAzureVaults(args: GetDbmulticloudOracleDbAzureVaultsArgs, opts?: pulumi.InvokeOptions): Promise<GetDbmulticloudOracleDbAzureVaultsResult>;
/**
 ...
 * ```
 */
export declare function getDbmulticloudOracleDbAzureVaultsOutput(args: GetDbmulticloudOracleDbAzureVaultsOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetDbmulticloudOracleDbAzureVaultsResult>;
/**
 * A collection of arguments for invoking getDbmulticloudOracleDbAzureVaults.
 */

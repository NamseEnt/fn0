 ...
 * ```
 */
export declare class IotIotDomain extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: IotIotDomainState, opts?: pulumi.CustomResourceOptions): IotIotDomain;
    /**
     * Returns true if the given object is an instance of IotIotDomain.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is IotIotDomain;
    /**
     ...
     */
    readonly dataRetentionPeriodsInDays: pulumi.Output<outputs.oci.IotIotDomainDataRetentionPeriodsInDay[]>;
    /**
     ...
     */
    readonly dbAllowListedIdentityGroupNames: pulumi.Output<string[]>;
    /**
     * Host name of identity domain that is used for authenticating connect to data host via ORDS.
     */
    readonly dbAllowedIdentityDomainHost: pulumi.Output<string>;
    /**
     ...
     */
    readonly deviceHost: pulumi.Output<string>;
    /**

 ...
 * ```
 */
export declare function getWlmsWlsDomainServerInstalledPatches(args: GetWlmsWlsDomainServerInstalledPatchesArgs, opts?: pulumi.InvokeOptions): Promise<GetWlmsWlsDomainServerInstalledPatchesResult>;
/**
 ...
 * ```
 */
export declare function getWlmsWlsDomainServerInstalledPatchesOutput(args: GetWlmsWlsDomainServerInstalledPatchesOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetWlmsWlsDomainServerInstalledPatchesResult>;
/**
 * A collection of arguments for invoking getWlmsWlsDomainServerInstalledPatches.
 */

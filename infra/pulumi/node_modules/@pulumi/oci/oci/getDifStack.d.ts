 ...
 * ```
 */
export declare function getDifStack(args: GetDifStackArgs, opts?: pulumi.InvokeOptions): Promise<GetDifStackResult>;
/**
 ...
 * ```
 */
export declare function getDifStackOutput(args: GetDifStackOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetDifStackResult>;
/**
 * A collection of arguments for invoking getDifStack.
 */

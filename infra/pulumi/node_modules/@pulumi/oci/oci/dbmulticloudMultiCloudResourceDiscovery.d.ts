 ...
 * ```
 */
export declare class DbmulticloudMultiCloudResourceDiscovery extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: DbmulticloudMultiCloudResourceDiscoveryState, opts?: pulumi.CustomResourceOptions): DbmulticloudMultiCloudResourceDiscovery;
    /**
     ...
     */
    static isInstance(obj: any): obj is DbmulticloudMultiCloudResourceDiscovery;
    /**
     ...
     */
    readonly resources: pulumi.Output<outputs.oci.DbmulticloudMultiCloudResourceDiscoveryResource[]>;
    /**
     ...
     */
    readonly resourcesFilter: pulumi.Output<{
        [key: string]: string;
    }>;
    /**

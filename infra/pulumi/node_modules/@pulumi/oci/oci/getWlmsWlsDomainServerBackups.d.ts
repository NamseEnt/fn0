 ...
 * ```
 */
export declare function getWlmsWlsDomainServerBackups(args: GetWlmsWlsDomainServerBackupsArgs, opts?: pulumi.InvokeOptions): Promise<GetWlmsWlsDomainServerBackupsResult>;
/**
 ...
 * ```
 */
export declare function getWlmsWlsDomainServerBackupsOutput(args: GetWlmsWlsDomainServerBackupsOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetWlmsWlsDomainServerBackupsResult>;
/**
 * A collection of arguments for invoking getWlmsWlsDomainServerBackups.
 */

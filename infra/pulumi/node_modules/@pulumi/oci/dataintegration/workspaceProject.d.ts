 ...
 * ```
 */
export declare class WorkspaceProject extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: WorkspaceProjectState, opts?: pulumi.CustomResourceOptions): WorkspaceProject;
    /**
     * Returns true if the given object is an instance of WorkspaceProject.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is WorkspaceProject;
    /**
     ...
     */
    readonly metadatas: pulumi.Output<outputs.DataIntegration.WorkspaceProjectMetadata[]>;
    /**
     ...
     */
    readonly parentReves: pulumi.Output<outputs.DataIntegration.WorkspaceProjectParentRef[]>;
    readonly projectKey: pulumi.Output<string>;
    /**
     * (Updatable) Information about the object and its parent.
     */
    readonly registryMetadata: pulumi.Output<outputs.DataIntegration.WorkspaceProjectRegistryMetadata>;
    /**
     * The workspace ID.
     *
     *

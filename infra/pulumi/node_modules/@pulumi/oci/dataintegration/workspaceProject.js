 ...
 * ```
 */
class WorkspaceProject extends pulumi.CustomResource {
    /**
    ...
    static get(name, id, state, opts) {
        return new WorkspaceProject(name, state, { ...opts, id: id });
    }
    /**
...
/** @internal */
WorkspaceProject.__pulumiType = 'oci:DataIntegration/workspaceProject:WorkspaceProject';
//# sourceMappingURL=workspaceProject.js.map
 ...
 * ```
 */
export declare function getWorkspaceExportRequests(args: GetWorkspaceExportRequestsArgs, opts?: pulumi.InvokeOptions): Promise<GetWorkspaceExportRequestsResult>;
/**
 ...
 * ```
 */
export declare function getWorkspaceExportRequestsOutput(args: GetWorkspaceExportRequestsOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetWorkspaceExportRequestsResult>;
/**
 * A collection of arguments for invoking getWorkspaceExportRequests.
 */

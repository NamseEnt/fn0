...
exports.WorkspaceFolder = void 0;
 ...
 * ```
 */
class WorkspaceFolder extends pulumi.CustomResource {
    /**
    ...
    static get(name, id, state, opts) {
        return new WorkspaceFolder(name, state, { ...opts, id: id });
    }
    /**
...
/** @internal */
WorkspaceFolder.__pulumiType = 'oci:DataIntegration/workspaceFolder:WorkspaceFolder';

 ...
 * ```
 */
export declare function getWorkspaceApplications(args: GetWorkspaceApplicationsArgs, opts?: pulumi.InvokeOptions): Promise<GetWorkspaceApplicationsResult>;
/**
 ...
 * ```
 */
export declare function getWorkspaceApplicationsOutput(args: GetWorkspaceApplicationsOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetWorkspaceApplicationsResult>;
/**
 * A collection of arguments for invoking getWorkspaceApplications.
 */

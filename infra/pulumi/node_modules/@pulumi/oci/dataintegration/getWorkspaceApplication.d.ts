 ...
 * ```
 */
export declare function getWorkspaceApplication(args: GetWorkspaceApplicationArgs, opts?: pulumi.InvokeOptions): Promise<GetWorkspaceApplicationResult>;
/**
 ...
 * ```
 */
export declare function getWorkspaceApplicationOutput(args: GetWorkspaceApplicationOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetWorkspaceApplicationResult>;
/**
 * A collection of arguments for invoking getWorkspaceApplication.
 */

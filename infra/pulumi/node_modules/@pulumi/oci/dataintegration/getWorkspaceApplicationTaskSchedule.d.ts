 ...
 * ```
 */
export declare function getWorkspaceApplicationTaskSchedule(args: GetWorkspaceApplicationTaskScheduleArgs, opts?: pulumi.InvokeOptions): Promise<GetWorkspaceApplicationTaskScheduleResult>;
/**
 ...
 * ```
 */
export declare function getWorkspaceApplicationTaskScheduleOutput(args: GetWorkspaceApplicationTaskScheduleOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetWorkspaceApplicationTaskScheduleResult>;
/**
 * A collection of arguments for invoking getWorkspaceApplicationTaskSchedule.
 */

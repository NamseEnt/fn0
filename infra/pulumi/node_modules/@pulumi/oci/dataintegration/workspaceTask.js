 ...
 * ```
 */
class WorkspaceTask extends pulumi.CustomResource {
    /**
    ...
    static get(name, id, state, opts) {
        return new WorkspaceTask(name, state, { ...opts, id: id });
    }
    /**
...
/** @internal */
WorkspaceTask.__pulumiType = 'oci:DataIntegration/workspaceTask:WorkspaceTask';
//# sourceMappingURL=workspaceTask.js.map
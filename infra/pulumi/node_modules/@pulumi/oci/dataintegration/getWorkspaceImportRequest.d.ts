 ...
 * ```
 */
export declare function getWorkspaceImportRequest(args: GetWorkspaceImportRequestArgs, opts?: pulumi.InvokeOptions): Promise<GetWorkspaceImportRequestResult>;
/**
 ...
 * ```
 */
export declare function getWorkspaceImportRequestOutput(args: GetWorkspaceImportRequestOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetWorkspaceImportRequestResult>;
/**
 * A collection of arguments for invoking getWorkspaceImportRequest.
 */

 ...
 * ```
 */
export declare function getWorkspaceApplicationPatches(args: GetWorkspaceApplicationPatchesArgs, opts?: pulumi.InvokeOptions): Promise<GetWorkspaceApplicationPatchesResult>;
/**
 ...
 * ```
 */
export declare function getWorkspaceApplicationPatchesOutput(args: GetWorkspaceApplicationPatchesOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetWorkspaceApplicationPatchesResult>;
/**
 * A collection of arguments for invoking getWorkspaceApplicationPatches.
 */

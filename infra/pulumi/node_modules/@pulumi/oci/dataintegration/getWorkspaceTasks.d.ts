 ...
 * ```
 */
export declare function getWorkspaceTasks(args: GetWorkspaceTasksArgs, opts?: pulumi.InvokeOptions): Promise<GetWorkspaceTasksResult>;
/**
 ...
 * ```
 */
export declare function getWorkspaceTasksOutput(args: GetWorkspaceTasksOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetWorkspaceTasksResult>;
/**
 * A collection of arguments for invoking getWorkspaceTasks.
 */

 ...
 * ```
 */
export declare class FilesystemSnapshotPolicy extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: FilesystemSnapshotPolicyState, opts?: pulumi.CustomResourceOptions): FilesystemSnapshotPolicy;
    /**
     * Returns true if the given object is an instance of FilesystemSnapshotPolicy.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is FilesystemSnapshotPolicy;
    /**
     ...
     */
    readonly locks: pulumi.Output<outputs.FileStorage.FilesystemSnapshotPolicyLock[]>;
    /**
     * (Updatable) The prefix to apply to all snapshots created by this policy.  Example: `acme`
     */
    readonly policyPrefix: pulumi.Output<string>;
    /**
     ...
     */
    readonly schedules: pulumi.Output<outputs.FileStorage.FilesystemSnapshotPolicySchedule[]>;
    /**

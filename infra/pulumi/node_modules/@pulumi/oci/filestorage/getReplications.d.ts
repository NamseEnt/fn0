 ...
 * ```
 */
export declare function getReplications(args: GetReplicationsArgs, opts?: pulumi.InvokeOptions): Promise<GetReplicationsResult>;
/**
 ...
 * ```
 */
export declare function getReplicationsOutput(args: GetReplicationsOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetReplicationsResult>;
/**
 * A collection of arguments for invoking getReplications.
 */

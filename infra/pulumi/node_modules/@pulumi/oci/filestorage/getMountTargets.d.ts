 ...
 * ```
 */
export declare function getMountTargets(args: GetMountTargetsArgs, opts?: pulumi.InvokeOptions): Promise<GetMountTargetsResult>;
/**
 ...
 * ```
 */
export declare function getMountTargetsOutput(args: GetMountTargetsOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetMountTargetsResult>;
/**
 * A collection of arguments for invoking getMountTargets.
 */

 ...
 * ```
 */
export declare function getOutboundConnectors(args: GetOutboundConnectorsArgs, opts?: pulumi.InvokeOptions): Promise<GetOutboundConnectorsResult>;
/**
 ...
 * ```
 */
export declare function getOutboundConnectorsOutput(args: GetOutboundConnectorsOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetOutboundConnectorsResult>;
/**
 * A collection of arguments for invoking getOutboundConnectors.
 */

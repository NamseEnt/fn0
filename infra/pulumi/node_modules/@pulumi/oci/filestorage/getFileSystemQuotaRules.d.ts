 ...
 * ```
 */
export declare function getFileSystemQuotaRules(args: GetFileSystemQuotaRulesArgs, opts?: pulumi.InvokeOptions): Promise<GetFileSystemQuotaRulesResult>;
/**
 ...
 * ```
 */
export declare function getFileSystemQuotaRulesOutput(args: GetFileSystemQuotaRulesOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetFileSystemQuotaRulesResult>;
/**
 * A collection of arguments for invoking getFileSystemQuotaRules.
 */

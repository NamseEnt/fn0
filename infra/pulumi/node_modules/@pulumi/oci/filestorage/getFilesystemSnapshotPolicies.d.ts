 ...
 * ```
 */
export declare function getFilesystemSnapshotPolicies(args: GetFilesystemSnapshotPoliciesArgs, opts?: pulumi.InvokeOptions): Promise<GetFilesystemSnapshotPoliciesResult>;
/**
 ...
 * ```
 */
export declare function getFilesystemSnapshotPoliciesOutput(args: GetFilesystemSnapshotPoliciesOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetFilesystemSnapshotPoliciesResult>;
/**
 * A collection of arguments for invoking getFilesystemSnapshotPolicies.
 */

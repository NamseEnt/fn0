 ...
 * ```
 */
export declare function getFilesystemSnapshotPolicy(args: GetFilesystemSnapshotPolicyArgs, opts?: pulumi.InvokeOptions): Promise<GetFilesystemSnapshotPolicyResult>;
/**
 ...
 * ```
 */
export declare function getFilesystemSnapshotPolicyOutput(args: GetFilesystemSnapshotPolicyOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetFilesystemSnapshotPolicyResult>;
/**
 * A collection of arguments for invoking getFilesystemSnapshotPolicy.
 */

 ...
 * ```
 */
export declare function getDrPlanExecution(args: GetDrPlanExecutionArgs, opts?: pulumi.InvokeOptions): Promise<GetDrPlanExecutionResult>;
/**
 ...
 * ```
 */
export declare function getDrPlanExecutionOutput(args: GetDrPlanExecutionOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetDrPlanExecutionResult>;
/**
 * A collection of arguments for invoking getDrPlanExecution.
 */

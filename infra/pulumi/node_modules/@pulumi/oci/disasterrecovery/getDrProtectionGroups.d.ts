 ...
 * ```
 */
export declare function getDrProtectionGroups(args: GetDrProtectionGroupsArgs, opts?: pulumi.InvokeOptions): Promise<GetDrProtectionGroupsResult>;
/**
 ...
 * ```
 */
export declare function getDrProtectionGroupsOutput(args: GetDrProtectionGroupsOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetDrProtectionGroupsResult>;
/**
 * A collection of arguments for invoking getDrProtectionGroups.
 */

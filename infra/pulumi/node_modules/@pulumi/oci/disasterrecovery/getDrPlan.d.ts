 ...
 * ```
 */
export declare function getDrPlan(args: GetDrPlanArgs, opts?: pulumi.InvokeOptions): Promise<GetDrPlanResult>;
/**
 ...
 * ```
 */
export declare function getDrPlanOutput(args: GetDrPlanOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetDrPlanResult>;
/**
 * A collection of arguments for invoking getDrPlan.
 */

 ...
 * ```
 */
export declare function getDrProtectionGroup(args: GetDrProtectionGroupArgs, opts?: pulumi.InvokeOptions): Promise<GetDrProtectionGroupResult>;
/**
 ...
 * ```
 */
export declare function getDrProtectionGroupOutput(args: GetDrProtectionGroupOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetDrProtectionGroupResult>;
/**
 * A collection of arguments for invoking getDrProtectionGroup.
 */

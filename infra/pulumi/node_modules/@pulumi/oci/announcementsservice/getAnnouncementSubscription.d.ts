 ...
 * ```
 */
export declare function getAnnouncementSubscriptionOutput(args: GetAnnouncementSubscriptionOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetAnnouncementSubscriptionResult>;
/**
 * A collection of arguments for invoking getAnnouncementSubscription.
 */

 ...
 * ```
 */
export declare function getFileStorageObjectStorageLinkSyncJob(args: GetFileStorageObjectStorageLinkSyncJobArgs, opts?: pulumi.InvokeOptions): Promise<GetFileStorageObjectStorageLinkSyncJobResult>;
/**
 ...
 * ```
 */
export declare function getFileStorageObjectStorageLinkSyncJobOutput(args: GetFileStorageObjectStorageLinkSyncJobOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetFileStorageObjectStorageLinkSyncJobResult>;
/**
 * A collection of arguments for invoking getFileStorageObjectStorageLinkSyncJob.
 */

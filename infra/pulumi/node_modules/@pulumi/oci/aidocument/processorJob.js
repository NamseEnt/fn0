 ...
 * ```
 */
class ProcessorJob extends pulumi.CustomResource {
    /**
    ...
    static get(name, id, state, opts) {
        return new ProcessorJob(name, state, { ...opts, id: id });
    }
    /**
...
exports.ProcessorJob = ProcessorJob;
/** @internal */
ProcessorJob.__pulumiType = 'oci:AiDocument/processorJob:ProcessorJob';
//# sourceMappingURL=processorJob.js.map
 ...
 * ```
 */
export declare function getUnifiedAgentConfigurations(args: GetUnifiedAgentConfigurationsArgs, opts?: pulumi.InvokeOptions): Promise<GetUnifiedAgentConfigurationsResult>;
/**
 ...
 * ```
 */
export declare function getUnifiedAgentConfigurationsOutput(args: GetUnifiedAgentConfigurationsOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetUnifiedAgentConfigurationsResult>;
/**
 * A collection of arguments for invoking getUnifiedAgentConfigurations.
 */

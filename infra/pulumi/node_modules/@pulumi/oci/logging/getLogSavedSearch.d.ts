 ...
 * ```
 */
export declare function getLogSavedSearch(args: GetLogSavedSearchArgs, opts?: pulumi.InvokeOptions): Promise<GetLogSavedSearchResult>;
/**
 ...
 * ```
 */
export declare function getLogSavedSearchOutput(args: GetLogSavedSearchOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetLogSavedSearchResult>;
/**
 * A collection of arguments for invoking getLogSavedSearch.
 */

 ...
 * ```
 */
export declare class LogSavedSearch extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: LogSavedSearchState, opts?: pulumi.CustomResourceOptions): LogSavedSearch;
    /**
     * Returns true if the given object is an instance of LogSavedSearch.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is LogSavedSearch;
    /**

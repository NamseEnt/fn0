 ...
 * ```
 */
export declare function getFsuCollection(args: GetFsuCollectionArgs, opts?: pulumi.InvokeOptions): Promise<GetFsuCollectionResult>;
/**
 ...
 * ```
 */
export declare function getFsuCollectionOutput(args: GetFsuCollectionOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetFsuCollectionResult>;
/**
 * A collection of arguments for invoking getFsuCollection.
 */

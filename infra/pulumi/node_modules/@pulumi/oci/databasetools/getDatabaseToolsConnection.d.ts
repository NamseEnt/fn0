 ...
 * ```
 */
export declare function getDatabaseToolsConnection(args: GetDatabaseToolsConnectionArgs, opts?: pulumi.InvokeOptions): Promise<GetDatabaseToolsConnectionResult>;
/**
 ...
 * ```
 */
export declare function getDatabaseToolsConnectionOutput(args: GetDatabaseToolsConnectionOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetDatabaseToolsConnectionResult>;
/**
 * A collection of arguments for invoking getDatabaseToolsConnection.
 */

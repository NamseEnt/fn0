 ...
 * ```
 */
export declare function getDatabaseToolsPrivateEndpoint(args: GetDatabaseToolsPrivateEndpointArgs, opts?: pulumi.InvokeOptions): Promise<GetDatabaseToolsPrivateEndpointResult>;
/**
 ...
 * ```
 */
export declare function getDatabaseToolsPrivateEndpointOutput(args: GetDatabaseToolsPrivateEndpointOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetDatabaseToolsPrivateEndpointResult>;
/**
 * A collection of arguments for invoking getDatabaseToolsPrivateEndpoint.
 */

 ...
 * ```
 */
export declare function getDatabaseToolsEndpointService(args: GetDatabaseToolsEndpointServiceArgs, opts?: pulumi.InvokeOptions): Promise<GetDatabaseToolsEndpointServiceResult>;
/**
 ...
 * ```
 */
export declare function getDatabaseToolsEndpointServiceOutput(args: GetDatabaseToolsEndpointServiceOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetDatabaseToolsEndpointServiceResult>;
/**
 * A collection of arguments for invoking getDatabaseToolsEndpointService.
 */

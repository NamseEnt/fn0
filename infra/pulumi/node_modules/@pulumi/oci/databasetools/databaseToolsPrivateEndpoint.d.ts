 ...
 * ```
 */
export declare class DatabaseToolsPrivateEndpoint extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: DatabaseToolsPrivateEndpointState, opts?: pulumi.CustomResourceOptions): DatabaseToolsPrivateEndpoint;
    /**
     ...
     */
    static isInstance(obj: any): obj is DatabaseToolsPrivateEndpoint;
    /**
     * A list of additional FQDNs that can be also be used for the private endpoint.
     */
    readonly additionalFqdns: pulumi.Output<string[]>;
    /**
     ...
     */
    readonly endpointFqdn: pulumi.Output<string>;
    /**
     ...
     */
    readonly locks: pulumi.Output<outputs.DatabaseTools.DatabaseToolsPrivateEndpointLock[]>;
    /**
     ...
     */
    readonly privateEndpointVnicId: pulumi.Output<string>;
    /**
     * Reverse connection configuration details of the private endpoint.
     */
    readonly reverseConnectionConfigurations: pulumi.Output<outputs.DatabaseTools.DatabaseToolsPrivateEndpointReverseConnectionConfiguration[]>;
    /**

 ...
 * ```
 */
export declare function getApmDomains(args: GetApmDomainsArgs, opts?: pulumi.InvokeOptions): Promise<GetApmDomainsResult>;
/**
 ...
 * ```
 */
export declare function getApmDomainsOutput(args: GetApmDomainsOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetApmDomainsResult>;
/**
 * A collection of arguments for invoking getApmDomains.
 */

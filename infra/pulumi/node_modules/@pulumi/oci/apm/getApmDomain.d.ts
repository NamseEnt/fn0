 ...
 * ```
 */
export declare function getApmDomain(args: GetApmDomainArgs, opts?: pulumi.InvokeOptions): Promise<GetApmDomainResult>;
/**
 ...
 * ```
 */
export declare function getApmDomainOutput(args: GetApmDomainOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetApmDomainResult>;
/**
 * A collection of arguments for invoking getApmDomain.
 */

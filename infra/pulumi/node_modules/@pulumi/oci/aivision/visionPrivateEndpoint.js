 ...
 * ```
 */
class VisionPrivateEndpoint extends pulumi.CustomResource {
    /**
    ...
    static get(name, id, state, opts) {
        return new VisionPrivateEndpoint(name, state, { ...opts, id: id });
    }
    /**
...
exports.VisionPrivateEndpoint = VisionPrivateEndpoint;
/** @internal */
VisionPrivateEndpoint.__pulumiType = 'oci:AiVision/visionPrivateEndpoint:VisionPrivateEndpoint';
//# sourceMappingURL=visionPrivateEndpoint.js.map
 ...
 * ```
 */
export declare function getManagementAgentCount(args: GetManagementAgentCountArgs, opts?: pulumi.InvokeOptions): Promise<GetManagementAgentCountResult>;
/**
 ...
 * ```
 */
export declare function getManagementAgentCountOutput(args: GetManagementAgentCountOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetManagementAgentCountResult>;
/**
 * A collection of arguments for invoking getManagementAgentCount.
 */

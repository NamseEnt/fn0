 ...
 * ```
 */
export declare function getManagementAgentDataSource(args: GetManagementAgentDataSourceArgs, opts?: pulumi.InvokeOptions): Promise<GetManagementAgentDataSourceResult>;
/**
 ...
 * ```
 */
export declare function getManagementAgentDataSourceOutput(args: GetManagementAgentDataSourceOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetManagementAgentDataSourceResult>;
/**
 * A collection of arguments for invoking getManagementAgentDataSource.
 */

 ...
 * ```
 */
export declare class ManagementAgentDataSource extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ManagementAgentDataSourceState, opts?: pulumi.CustomResourceOptions): ManagementAgentDataSource;
    /**
     ...
     */
    static isInstance(obj: any): obj is ManagementAgentDataSource;
    /**
     ...
     */
    readonly allowMetrics: pulumi.Output<string>;
    /**
    ...
    readonly dataSourceKey: pulumi.Output<string>;
    /**
     * If the Kubernetes cluster type is Daemon set then this will be set to true.
     */
    readonly isDaemonSet: pulumi.Output<boolean>;
    /**
     ...
     */
    readonly metricDimensions: pulumi.Output<outputs.ManagementAgent.ManagementAgentDataSourceMetricDimension[]>;
    /**
     ...
     */
    readonly scheduleMins: pulumi.Output<number>;
    /**

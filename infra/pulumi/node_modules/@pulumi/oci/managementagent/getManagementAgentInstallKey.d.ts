 ...
 * ```
 */
export declare function getManagementAgentInstallKey(args: GetManagementAgentInstallKeyArgs, opts?: pulumi.InvokeOptions): Promise<GetManagementAgentInstallKeyResult>;
/**
 ...
 * ```
 */
export declare function getManagementAgentInstallKeyOutput(args: GetManagementAgentInstallKeyOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetManagementAgentInstallKeyResult>;
/**
 * A collection of arguments for invoking getManagementAgentInstallKey.
 */

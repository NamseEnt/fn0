...
exports.DomainsIdentityProvider = void 0;
 ...
 * ```
 */
class DomainsIdentityProvider extends pulumi.CustomResource {
    /**
    ...
    static get(name, id, state, opts) {
        return new DomainsIdentityProvider(name, state, { ...opts, id: id });
    }
    /**
...
exports.DomainsIdentityProvider = DomainsIdentityProvider;
/** @internal */
DomainsIdentityProvider.__pulumiType = 'oci:Identity/domainsIdentityProvider:DomainsIdentityProvider';
//# sourceMappingURL=domainsIdentityProvider.js.map
 ...
 * ```
 */
export declare class ImportStandardTagsManagement extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ImportStandardTagsManagementState, opts?: pulumi.CustomResourceOptions): ImportStandardTagsManagement;
    /**
     ...
     */
    static isInstance(obj: any): obj is ImportStandardTagsManagement;
    /**
     ...
     */
    readonly standardTagNamespaceName: pulumi.Output<string>;

 ...
 * ```
 */
export declare function getDomainsCondition(args: GetDomainsConditionArgs, opts?: pulumi.InvokeOptions): Promise<GetDomainsConditionResult>;
/**
 ...
 * ```
 */
export declare function getDomainsConditionOutput(args: GetDomainsConditionOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetDomainsConditionResult>;
/**
 * A collection of arguments for invoking getDomainsCondition.
 */

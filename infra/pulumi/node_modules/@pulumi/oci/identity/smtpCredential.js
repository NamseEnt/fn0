 ...
 * ```
 */
class SmtpCredential extends pulumi.CustomResource {
    /**
    ...
    static get(name, id, state, opts) {
        return new SmtpCredential(name, state, { ...opts, id: id });
    }
    /**
...
exports.SmtpCredential = SmtpCredential;
/** @internal */
SmtpCredential.__pulumiType = 'oci:Identity/smtpCredential:SmtpCredential';
//# sourceMappingURL=smtpCredential.js.map
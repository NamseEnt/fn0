 ...
 * ```
 */
export declare function getTenancy(args: GetTenancyArgs, opts?: pulumi.InvokeOptions): Promise<GetTenancyResult>;
/**
 ...
 * ```
 */
export declare function getTenancyOutput(args: GetTenancyOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetTenancyResult>;
/**
 * A collection of arguments for invoking getTenancy.
 */

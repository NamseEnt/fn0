 ...
 * ```
 */
export declare class DynamicGroup extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: DynamicGroupState, opts?: pulumi.CustomResourceOptions): DynamicGroup;
    /**
     * Returns true if the given object is an instance of DynamicGroup.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is DynamicGroup;
    /**

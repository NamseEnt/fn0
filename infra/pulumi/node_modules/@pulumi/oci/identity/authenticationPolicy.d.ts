...
export declare class AuthenticationPolicy extends pulumi.CustomResource {
     ...
     */
    readonly networkPolicy: pulumi.Output<outputs.Identity.AuthenticationPolicyNetworkPolicy>;
    /**
     * (Updatable) Password policy, currently set for the given compartment.
     */
    readonly passwordPolicy: pulumi.Output<outputs.Identity.AuthenticationPolicyPasswordPolicy>;
    /**

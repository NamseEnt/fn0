 ...
 * ```
 */
export declare function getIamWorkRequest(args: GetIamWorkRequestArgs, opts?: pulumi.InvokeOptions): Promise<GetIamWorkRequestResult>;
/**
 ...
 * ```
 */
export declare function getIamWorkRequestOutput(args: GetIamWorkRequestOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetIamWorkRequestResult>;
/**
 * A collection of arguments for invoking getIamWorkRequest.
 */

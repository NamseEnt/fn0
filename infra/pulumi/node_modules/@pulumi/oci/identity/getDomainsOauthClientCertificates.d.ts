 ...
 * ```
 */
export declare function getDomainsOauthClientCertificates(args: GetDomainsOauthClientCertificatesArgs, opts?: pulumi.InvokeOptions): Promise<GetDomainsOauthClientCertificatesResult>;
/**
 * A collection of arguments for invoking getDomainsOauthClientCertificates.
 */
export interface GetDomainsOauthClientCertificatesArgs {
    /**
 ...
 */
export interface GetDomainsOauthClientCertificatesResult {
     ...
     */
    readonly oauthClientCertificates: outputs.Identity.GetDomainsOauthClientCertificatesOauthClientCertificate[];
 ...
 * ```
 */
export declare function getDomainsOauthClientCertificatesOutput(args: GetDomainsOauthClientCertificatesOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetDomainsOauthClientCertificatesResult>;
/**
 * A collection of arguments for invoking getDomainsOauthClientCertificates.
 */
export interface GetDomainsOauthClientCertificatesOutputArgs {
    /**
     * The Authorization field value consists of credentials containing the authentication information of the user agent for the realm of the resource being requested.
     */

 ...
 * ```
 */
export declare class TagNamespace extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: TagNamespaceState, opts?: pulumi.CustomResourceOptions): TagNamespace;
    /**
     * Returns true if the given object is an instance of TagNamespace.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is TagNamespace;
    /**

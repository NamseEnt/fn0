 ...
 * ```
 */
export declare function getDomainsPasswordPolicyOutput(args: GetDomainsPasswordPolicyOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetDomainsPasswordPolicyResult>;
/**
 * A collection of arguments for invoking getDomainsPasswordPolicy.
 */

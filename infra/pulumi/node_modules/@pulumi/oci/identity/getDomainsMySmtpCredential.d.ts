 ...
 * ```
 */
export declare function getDomainsMySmtpCredential(args: GetDomainsMySmtpCredentialArgs, opts?: pulumi.InvokeOptions): Promise<GetDomainsMySmtpCredentialResult>;
/**
 ...
 * ```
 */
export declare function getDomainsMySmtpCredentialOutput(args: GetDomainsMySmtpCredentialOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetDomainsMySmtpCredentialResult>;
/**
 * A collection of arguments for invoking getDomainsMySmtpCredential.
 */

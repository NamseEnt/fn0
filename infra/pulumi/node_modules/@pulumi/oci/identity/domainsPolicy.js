 ...
 * ```
 */
class DomainsPolicy extends pulumi.CustomResource {
    /**
    ...
    static get(name, id, state, opts) {
        return new DomainsPolicy(name, state, { ...opts, id: id });
    }
    /**
...
exports.DomainsPolicy = DomainsPolicy;
/** @internal */
DomainsPolicy.__pulumiType = 'oci:Identity/domainsPolicy:DomainsPolicy';
//# sourceMappingURL=domainsPolicy.js.map
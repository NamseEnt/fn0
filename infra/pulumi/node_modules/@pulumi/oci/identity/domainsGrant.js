 ...
 * ```
 */
class DomainsGrant extends pulumi.CustomResource {
    /**
    ...
    static get(name, id, state, opts) {
        return new DomainsGrant(name, state, { ...opts, id: id });
    }
    /**
...
exports.DomainsGrant = DomainsGrant;
/** @internal */
DomainsGrant.__pulumiType = 'oci:Identity/domainsGrant:DomainsGrant';
//# sourceMappingURL=domainsGrant.js.map
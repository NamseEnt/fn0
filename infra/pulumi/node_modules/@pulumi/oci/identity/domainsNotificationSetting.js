...
exports.DomainsNotificationSetting = void 0;
 ...
 * ```
 */
class DomainsNotificationSetting extends pulumi.CustomResource {
    /**
    ...
    static get(name, id, state, opts) {
        return new DomainsNotificationSetting(name, state, { ...opts, id: id });
    }
    /**
...
exports.DomainsNotificationSetting = DomainsNotificationSetting;
/** @internal */
DomainsNotificationSetting.__pulumiType = 'oci:Identity/domainsNotificationSetting:DomainsNotificationSetting';
//# sourceMappingURL=domainsNotificationSetting.js.map
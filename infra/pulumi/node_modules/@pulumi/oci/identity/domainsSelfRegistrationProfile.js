...
exports.DomainsSelfRegistrationProfile = void 0;
 ...
 * ```
 */
class DomainsSelfRegistrationProfile extends pulumi.CustomResource {
    /**
    ...
    static get(name, id, state, opts) {
        return new DomainsSelfRegistrationProfile(name, state, { ...opts, id: id });
    }
    /**
...
exports.DomainsSelfRegistrationProfile = DomainsSelfRegistrationProfile;
/** @internal */
DomainsSelfRegistrationProfile.__pulumiType = 'oci:Identity/domainsSelfRegistrationProfile:DomainsSelfRegistrationProfile';
//# sourceMappingURL=domainsSelfRegistrationProfile.js.map
 ...
 * ```
 */
export declare function getCompartment(args: GetCompartmentArgs, opts?: pulumi.InvokeOptions): Promise<GetCompartmentResult>;
/**
 ...
 * ```
 */
export declare function getCompartmentOutput(args: GetCompartmentOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetCompartmentResult>;
/**
 * A collection of arguments for invoking getCompartment.
 */

...
exports.DomainsOauthClientCertificate = void 0;
 ...
 * ```
 */
class DomainsOauthClientCertificate extends pulumi.CustomResource {
    /**
    ...
    static get(name, id, state, opts) {
        return new DomainsOauthClientCertificate(name, state, { ...opts, id: id });
    }
    /**
    ...
    static isInstance(obj) {
        ...
        return obj['__pulumiType'] === DomainsOauthClientCertificate.__pulumiType;
    }
    constructor(name, argsOrState, opts) {
        ...
        if (opts.id) {
            ...
            if (args?.x509base64certificate === undefined && !opts.urn) {
        ...
        super(DomainsOauthClientCertificate.__pulumiType, name, resourceInputs, opts);
    }
}
exports.DomainsOauthClientCertificate = DomainsOauthClientCertificate;
/** @internal */
DomainsOauthClientCertificate.__pulumiType = 'oci:Identity/domainsOauthClientCertificate:DomainsOauthClientCertificate';
//# sourceMappingURL=domainsOauthClientCertificate.js.map
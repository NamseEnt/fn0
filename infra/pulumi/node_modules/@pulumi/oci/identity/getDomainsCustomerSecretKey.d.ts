 ...
 * ```
 */
export declare function getDomainsCustomerSecretKey(args: GetDomainsCustomerSecretKeyArgs, opts?: pulumi.InvokeOptions): Promise<GetDomainsCustomerSecretKeyResult>;
/**
 ...
 * ```
 */
export declare function getDomainsCustomerSecretKeyOutput(args: GetDomainsCustomerSecretKeyOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetDomainsCustomerSecretKeyResult>;
/**
 * A collection of arguments for invoking getDomainsCustomerSecretKey.
 */

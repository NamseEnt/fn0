 ...
 * ```
 */
export declare function getIdentityProvidersOutput(args: GetIdentityProvidersOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetIdentityProvidersResult>;
/**
 * A collection of arguments for invoking getIdentityProviders.
 */

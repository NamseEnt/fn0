 ...
 * ```
 */
export declare function getDomainsApiKeysOutput(args: GetDomainsApiKeysOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetDomainsApiKeysResult>;
/**
 * A collection of arguments for invoking getDomainsApiKeys.
 */

 ...
 * ```
 */
export declare function getDomainsAppRole(args: GetDomainsAppRoleArgs, opts?: pulumi.InvokeOptions): Promise<GetDomainsAppRoleResult>;
/**
 ...
 * ```
 */
export declare function getDomainsAppRoleOutput(args: GetDomainsAppRoleOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetDomainsAppRoleResult>;
/**
 * A collection of arguments for invoking getDomainsAppRole.
 */

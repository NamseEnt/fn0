 ...
 * ```
 */
export declare function getCustomerSecretKeys(args: GetCustomerSecretKeysArgs, opts?: pulumi.InvokeOptions): Promise<GetCustomerSecretKeysResult>;
/**
 ...
 * ```
 */
export declare function getCustomerSecretKeysOutput(args: GetCustomerSecretKeysOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetCustomerSecretKeysResult>;
/**
 * A collection of arguments for invoking getCustomerSecretKeys.
 */

 ...
 * ```
 */
class DomainsApiKey extends pulumi.CustomResource {
    /**
    ...
    static get(name, id, state, opts) {
        return new DomainsApiKey(name, state, { ...opts, id: id });
    }
    /**
...
exports.DomainsApiKey = DomainsApiKey;
/** @internal */
DomainsApiKey.__pulumiType = 'oci:Identity/domainsApiKey:DomainsApiKey';
//# sourceMappingURL=domainsApiKey.js.map
 ...
 * ```
 */
export declare function getDomainsNetworkPerimeter(args: GetDomainsNetworkPerimeterArgs, opts?: pulumi.InvokeOptions): Promise<GetDomainsNetworkPerimeterResult>;
/**
 ...
 * ```
 */
export declare function getDomainsNetworkPerimeterOutput(args: GetDomainsNetworkPerimeterOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetDomainsNetworkPerimeterResult>;
/**
 * A collection of arguments for invoking getDomainsNetworkPerimeter.
 */

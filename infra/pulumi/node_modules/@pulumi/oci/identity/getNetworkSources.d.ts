 ...
 * ```
 */
export declare function getNetworkSources(args: GetNetworkSourcesArgs, opts?: pulumi.InvokeOptions): Promise<GetNetworkSourcesResult>;
/**
 ...
 * ```
 */
export declare function getNetworkSourcesOutput(args: GetNetworkSourcesOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetNetworkSourcesResult>;
/**
 * A collection of arguments for invoking getNetworkSources.
 */

...
exports.DomainsPasswordPolicy = void 0;
 ...
 * ```
 */
class DomainsPasswordPolicy extends pulumi.CustomResource {
    /**
    ...
    static get(name, id, state, opts) {
        return new DomainsPasswordPolicy(name, state, { ...opts, id: id });
    }
    /**
...
exports.DomainsPasswordPolicy = DomainsPasswordPolicy;
/** @internal */
DomainsPasswordPolicy.__pulumiType = 'oci:Identity/domainsPasswordPolicy:DomainsPasswordPolicy';
//# sourceMappingURL=domainsPasswordPolicy.js.map
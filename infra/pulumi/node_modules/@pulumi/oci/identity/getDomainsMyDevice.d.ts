 ...
 * ```
 */
export declare function getDomainsMyDeviceOutput(args: GetDomainsMyDeviceOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetDomainsMyDeviceResult>;
/**
 * A collection of arguments for invoking getDomainsMyDevice.
 */

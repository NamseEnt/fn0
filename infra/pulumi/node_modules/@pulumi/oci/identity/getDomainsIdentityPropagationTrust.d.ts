 ...
 * ```
 */
export declare function getDomainsIdentityPropagationTrust(args: GetDomainsIdentityPropagationTrustArgs, opts?: pulumi.InvokeOptions): Promise<GetDomainsIdentityPropagationTrustResult>;
/**
 ...
 * ```
 */
export declare function getDomainsIdentityPropagationTrustOutput(args: GetDomainsIdentityPropagationTrustOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetDomainsIdentityPropagationTrustResult>;
/**
 * A collection of arguments for invoking getDomainsIdentityPropagationTrust.
 */

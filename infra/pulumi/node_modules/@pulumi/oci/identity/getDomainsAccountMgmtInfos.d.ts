 ...
 * ```
 */
export declare function getDomainsAccountMgmtInfos(args: GetDomainsAccountMgmtInfosArgs, opts?: pulumi.InvokeOptions): Promise<GetDomainsAccountMgmtInfosResult>;
/**
 * A collection of arguments for invoking getDomainsAccountMgmtInfos.
 */
export interface GetDomainsAccountMgmtInfosArgs {
    /**
 ...
 */
export interface GetDomainsAccountMgmtInfosResult {
 ...
 * ```
 */
export declare function getDomainsAccountMgmtInfosOutput(args: GetDomainsAccountMgmtInfosOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetDomainsAccountMgmtInfosResult>;
/**
 * A collection of arguments for invoking getDomainsAccountMgmtInfos.
 */
export interface GetDomainsAccountMgmtInfosOutputArgs {
    /**
     * OPTIONAL. An integer that indicates the desired maximum number of query results per page. 1000 is the largest value that you can use. See the Pagination section of the System for Cross-Domain Identity Management Protocol specification for more information. (Section 3.4.2.4).
     */

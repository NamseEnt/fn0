 ...
 * ```
 */
export declare function getDomainsOauthClientCertificate(args: GetDomainsOauthClientCertificateArgs, opts?: pulumi.InvokeOptions): Promise<GetDomainsOauthClientCertificateResult>;
/**
 ...
 * ```
 */
export declare function getDomainsOauthClientCertificateOutput(args: GetDomainsOauthClientCertificateOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetDomainsOauthClientCertificateResult>;
/**
 * A collection of arguments for invoking getDomainsOauthClientCertificate.
 */

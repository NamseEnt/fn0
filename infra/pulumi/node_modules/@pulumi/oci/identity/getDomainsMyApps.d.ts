 ...
 * ```
 */
export declare function getDomainsMyApps(args: GetDomainsMyAppsArgs, opts?: pulumi.InvokeOptions): Promise<GetDomainsMyAppsResult>;
/**
 ...
 * ```
 */
export declare function getDomainsMyAppsOutput(args: GetDomainsMyAppsOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetDomainsMyAppsResult>;
/**
 * A collection of arguments for invoking getDomainsMyApps.
 */

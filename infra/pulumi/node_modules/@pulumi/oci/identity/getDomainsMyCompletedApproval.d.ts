 ...
 * ```
 */
export declare function getDomainsMyCompletedApproval(args: GetDomainsMyCompletedApprovalArgs, opts?: pulumi.InvokeOptions): Promise<GetDomainsMyCompletedApprovalResult>;
/**
 ...
 * ```
 */
export declare function getDomainsMyCompletedApprovalOutput(args: GetDomainsMyCompletedApprovalOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetDomainsMyCompletedApprovalResult>;
/**
 * A collection of arguments for invoking getDomainsMyCompletedApproval.
 */

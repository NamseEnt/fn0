 ...
 * ```
 */
export declare function getAddressRule(args: GetAddressRuleArgs, opts?: pulumi.InvokeOptions): Promise<GetAddressRuleResult>;
/**
 ...
 * ```
 */
export declare function getAddressRuleOutput(args: GetAddressRuleOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetAddressRuleResult>;
/**
 * A collection of arguments for invoking getAddressRule.
 */

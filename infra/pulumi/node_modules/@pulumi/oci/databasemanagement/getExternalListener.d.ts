 ...
 * ```
 */
export declare function getExternalListener(args: GetExternalListenerArgs, opts?: pulumi.InvokeOptions): Promise<GetExternalListenerResult>;
/**
 ...
 * ```
 */
export declare function getExternalListenerOutput(args: GetExternalListenerOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetExternalListenerResult>;
/**
 * A collection of arguments for invoking getExternalListener.
 */

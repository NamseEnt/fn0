 ...
 * ```
 */
export declare class ExternalDbSystemDiscovery extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ExternalDbSystemDiscoveryState, opts?: pulumi.CustomResourceOptions): ExternalDbSystemDiscovery;
    /**
     ...
     */
    static isInstance(obj: any): obj is ExternalDbSystemDiscovery;
    /**
     ...
     */
    readonly discoveredComponents: pulumi.Output<outputs.DatabaseManagement.ExternalDbSystemDiscoveryDiscoveredComponent[]>;
    /**
     * (Updatable) The user-friendly name for the DB system. The name does not have to be unique.
     */
    readonly displayName: pulumi.Output<string>;
    readonly externalDbSystemDiscoveryId: pulumi.Output<string>;
    /**
     ...
     * (Updatable)
     */
    readonly patchOperations: pulumi.Output<outputs.DatabaseManagement.ExternalDbSystemDiscoveryPatchOperation[] | undefined>;
    /**

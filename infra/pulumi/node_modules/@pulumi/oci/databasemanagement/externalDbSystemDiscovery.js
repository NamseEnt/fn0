 ...
 * ```
 */
class ExternalDbSystemDiscovery extends pulumi.CustomResource {
    /**
    ...
    static get(name, id, state, opts) {
        return new ExternalDbSystemDiscovery(name, state, { ...opts, id: id });
    }
    /**
...
exports.ExternalDbSystemDiscovery = ExternalDbSystemDiscovery;
/** @internal */
ExternalDbSystemDiscovery.__pulumiType = 'oci:DatabaseManagement/externalDbSystemDiscovery:ExternalDbSystemDiscovery';
//# sourceMappingURL=externalDbSystemDiscovery.js.map
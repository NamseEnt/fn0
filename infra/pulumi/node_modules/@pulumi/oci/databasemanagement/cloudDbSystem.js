 ...
 * ```
 */
class CloudDbSystem extends pulumi.CustomResource {
    /**
    ...
    static get(name, id, state, opts) {
        return new CloudDbSystem(name, state, { ...opts, id: id });
    }
    /**
...
exports.CloudDbSystem = CloudDbSystem;
/** @internal */
CloudDbSystem.__pulumiType = 'oci:DatabaseManagement/cloudDbSystem:CloudDbSystem';
//# sourceMappingURL=cloudDbSystem.js.map
 ...
 * ```
 */
export declare function getExternalMySqlDatabaseConnector(args: GetExternalMySqlDatabaseConnectorArgs, opts?: pulumi.InvokeOptions): Promise<GetExternalMySqlDatabaseConnectorResult>;
/**
 ...
 * ```
 */
export declare function getExternalMySqlDatabaseConnectorOutput(args: GetExternalMySqlDatabaseConnectorOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetExternalMySqlDatabaseConnectorResult>;
/**
 * A collection of arguments for invoking getExternalMySqlDatabaseConnector.
 */

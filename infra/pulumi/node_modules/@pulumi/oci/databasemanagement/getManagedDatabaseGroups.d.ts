 ...
 * ```
 */
export declare function getManagedDatabaseGroups(args: GetManagedDatabaseGroupsArgs, opts?: pulumi.InvokeOptions): Promise<GetManagedDatabaseGroupsResult>;
/**
 ...
 * ```
 */
export declare function getManagedDatabaseGroupsOutput(args: GetManagedDatabaseGroupsOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetManagedDatabaseGroupsResult>;
/**
 * A collection of arguments for invoking getManagedDatabaseGroups.
 */

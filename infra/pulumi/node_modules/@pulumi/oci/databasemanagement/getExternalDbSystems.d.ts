 ...
 * ```
 */
export declare function getExternalDbSystems(args: GetExternalDbSystemsArgs, opts?: pulumi.InvokeOptions): Promise<GetExternalDbSystemsResult>;
/**
 ...
 * ```
 */
export declare function getExternalDbSystemsOutput(args: GetExternalDbSystemsOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetExternalDbSystemsResult>;
/**
 * A collection of arguments for invoking getExternalDbSystems.
 */

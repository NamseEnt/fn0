 ...
 * ```
 */
export declare class ExternalExadataStorageGrid extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ExternalExadataStorageGridState, opts?: pulumi.CustomResourceOptions): ExternalExadataStorageGrid;
    /**
     ...
     */
    static isInstance(obj: any): obj is ExternalExadataStorageGrid;
    /**
     ...
     */
    readonly externalExadataStorageGridId: pulumi.Output<string>;
    /**
     ...
     */
    readonly storageServers: pulumi.Output<outputs.DatabaseManagement.ExternalExadataStorageGridStorageServer[]>;
    /**

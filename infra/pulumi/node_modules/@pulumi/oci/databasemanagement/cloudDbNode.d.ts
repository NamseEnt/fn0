 ...
 * ```
 */
export declare class CloudDbNode extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: CloudDbNodeState, opts?: pulumi.CustomResourceOptions): CloudDbNode;
    /**
     * Returns true if the given object is an instance of CloudDbNode.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is CloudDbNode;
    /**

 ...
 * ```
 */
export declare function getManagedDatabaseSqlTuningAdvisorTasks(args: GetManagedDatabaseSqlTuningAdvisorTasksArgs, opts?: pulumi.InvokeOptions): Promise<GetManagedDatabaseSqlTuningAdvisorTasksResult>;
/**
 ...
 * ```
 */
export declare function getManagedDatabaseSqlTuningAdvisorTasksOutput(args: GetManagedDatabaseSqlTuningAdvisorTasksOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetManagedDatabaseSqlTuningAdvisorTasksResult>;
/**
 * A collection of arguments for invoking getManagedDatabaseSqlTuningAdvisorTasks.
 */

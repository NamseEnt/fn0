 ...
 * ```
 */
export declare function getManagedDatabasesUserProxyUser(args: GetManagedDatabasesUserProxyUserArgs, opts?: pulumi.InvokeOptions): Promise<GetManagedDatabasesUserProxyUserResult>;
/**
 ...
 * ```
 */
export declare function getManagedDatabasesUserProxyUserOutput(args: GetManagedDatabasesUserProxyUserOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetManagedDatabasesUserProxyUserResult>;
/**
 * A collection of arguments for invoking getManagedDatabasesUserProxyUser.
 */

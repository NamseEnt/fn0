 ...
 * ```
 */
export declare class NamedCredential extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: NamedCredentialState, opts?: pulumi.CustomResourceOptions): NamedCredential;
    /**
     * Returns true if the given object is an instance of NamedCredential.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is NamedCredential;
    /**
     ...
     */
    readonly associatedResource: pulumi.Output<string | undefined>;
    /**
     ...
     */
    readonly content: pulumi.Output<outputs.DatabaseManagement.NamedCredentialContent>;
    /**

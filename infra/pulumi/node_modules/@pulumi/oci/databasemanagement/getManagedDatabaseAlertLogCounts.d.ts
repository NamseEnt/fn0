 ...
 * ```
 */
export declare function getManagedDatabaseAlertLogCounts(args: GetManagedDatabaseAlertLogCountsArgs, opts?: pulumi.InvokeOptions): Promise<GetManagedDatabaseAlertLogCountsResult>;
/**
 ...
 * ```
 */
export declare function getManagedDatabaseAlertLogCountsOutput(args: GetManagedDatabaseAlertLogCountsOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetManagedDatabaseAlertLogCountsResult>;
/**
 * A collection of arguments for invoking getManagedDatabaseAlertLogCounts.
 */

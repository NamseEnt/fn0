 ...
 * ```
 */
export declare function getManagedDatabasesDatabaseParameters(args: GetManagedDatabasesDatabaseParametersArgs, opts?: pulumi.InvokeOptions): Promise<GetManagedDatabasesDatabaseParametersResult>;
/**
 ...
 * ```
 */
export declare function getManagedDatabasesDatabaseParametersOutput(args: GetManagedDatabasesDatabaseParametersOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetManagedDatabasesDatabaseParametersResult>;
/**
 * A collection of arguments for invoking getManagedDatabasesDatabaseParameters.
 */

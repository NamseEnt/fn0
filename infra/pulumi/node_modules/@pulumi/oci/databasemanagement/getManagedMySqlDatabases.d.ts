 ...
 * ```
 */
export declare function getManagedMySqlDatabasesOutput(args: GetManagedMySqlDatabasesOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetManagedMySqlDatabasesResult>;
/**
 * A collection of arguments for invoking getManagedMySqlDatabases.
 */

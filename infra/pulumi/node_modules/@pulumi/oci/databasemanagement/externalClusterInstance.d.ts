 ...
 * ```
 */
export declare class ExternalClusterInstance extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ExternalClusterInstanceState, opts?: pulumi.CustomResourceOptions): ExternalClusterInstance;
    /**
     * Returns true if the given object is an instance of ExternalClusterInstance.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is ExternalClusterInstance;
    /**
     ...
     */
    readonly externalClusterInstanceId: pulumi.Output<string>;
    /**

 ...
 * ```
 */
class CloudDbHome extends pulumi.CustomResource {
    /**
    ...
    static get(name, id, state, opts) {
        return new CloudDbHome(name, state, { ...opts, id: id });
    }
    /**
...
exports.CloudDbHome = CloudDbHome;
/** @internal */
CloudDbHome.__pulumiType = 'oci:DatabaseManagement/cloudDbHome:CloudDbHome';
//# sourceMappingURL=cloudDbHome.js.map
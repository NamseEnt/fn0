 ...
 * ```
 */
class CloudAsm extends pulumi.CustomResource {
    /**
    ...
    static get(name, id, state, opts) {
        return new CloudAsm(name, state, { ...opts, id: id });
    }
    /**
...
exports.CloudAsm = CloudAsm;
/** @internal */
CloudAsm.__pulumiType = 'oci:DatabaseManagement/cloudAsm:CloudAsm';
//# sourceMappingURL=cloudAsm.js.map
 ...
 * ```
 */
export declare function getCloudListener(args: GetCloudListenerArgs, opts?: pulumi.InvokeOptions): Promise<GetCloudListenerResult>;
/**
 ...
 * ```
 */
export declare function getCloudListenerOutput(args: GetCloudListenerOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetCloudListenerResult>;
/**
 * A collection of arguments for invoking getCloudListener.
 */

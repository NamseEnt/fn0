 ...
 * ```
 */
export declare function getManagedMySqlDatabaseSqlDataOutput(args: GetManagedMySqlDatabaseSqlDataOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetManagedMySqlDatabaseSqlDataResult>;
/**
 * A collection of arguments for invoking getManagedMySqlDatabaseSqlData.
 */

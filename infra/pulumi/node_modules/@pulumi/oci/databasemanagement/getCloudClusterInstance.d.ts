 ...
 * ```
 */
export declare function getCloudClusterInstance(args: GetCloudClusterInstanceArgs, opts?: pulumi.InvokeOptions): Promise<GetCloudClusterInstanceResult>;
/**
 ...
 * ```
 */
export declare function getCloudClusterInstanceOutput(args: GetCloudClusterInstanceOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetCloudClusterInstanceResult>;
/**
 * A collection of arguments for invoking getCloudClusterInstance.
 */

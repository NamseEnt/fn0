 ...
 * ```
 */
class ExternalDbHome extends pulumi.CustomResource {
    /**
    ...
    static get(name, id, state, opts) {
        return new ExternalDbHome(name, state, { ...opts, id: id });
    }
    /**
    ...
    constructor(name, argsOrState, opts) {
        ...
        if (opts.id) {
            ...
            if (args?.externalDbHomeId === undefined && !opts.urn) {
                throw new Error("Missing required property 'externalDbHomeId'");
            }
            resourceInputs["definedTags"] = args?.definedTags;
            resourceInputs["externalDbHomeId"] = args?.externalDbHomeId;
...
exports.ExternalDbHome = ExternalDbHome;
/** @internal */
ExternalDbHome.__pulumiType = 'oci:DatabaseManagement/externalDbHome:ExternalDbHome';
//# sourceMappingURL=externalDbHome.js.map
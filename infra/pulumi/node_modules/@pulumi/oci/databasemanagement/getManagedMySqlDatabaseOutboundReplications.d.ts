 ...
 * ```
 */
export declare function getManagedMySqlDatabaseOutboundReplications(args: GetManagedMySqlDatabaseOutboundReplicationsArgs, opts?: pulumi.InvokeOptions): Promise<GetManagedMySqlDatabaseOutboundReplicationsResult>;
/**
 ...
 * ```
 */
export declare function getManagedMySqlDatabaseOutboundReplicationsOutput(args: GetManagedMySqlDatabaseOutboundReplicationsOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetManagedMySqlDatabaseOutboundReplicationsResult>;
/**
 * A collection of arguments for invoking getManagedMySqlDatabaseOutboundReplications.
 */

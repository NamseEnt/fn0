 ...
 * ```
 */
export declare function getManagedDatabaseUser(args: GetManagedDatabaseUserArgs, opts?: pulumi.InvokeOptions): Promise<GetManagedDatabaseUserResult>;
/**
 ...
 * ```
 */
export declare function getManagedDatabaseUserOutput(args: GetManagedDatabaseUserOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetManagedDatabaseUserResult>;
/**
 * A collection of arguments for invoking getManagedDatabaseUser.
 */

 ...
 * ```
 */
export declare function getExternalListenerServices(args: GetExternalListenerServicesArgs, opts?: pulumi.InvokeOptions): Promise<GetExternalListenerServicesResult>;
/**
 ...
 * ```
 */
export declare function getExternalListenerServicesOutput(args: GetExternalListenerServicesOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetExternalListenerServicesResult>;
/**
 * A collection of arguments for invoking getExternalListenerServices.
 */

 ...
 * ```
 */
export declare function getManagedDatabaseUserRole(args: GetManagedDatabaseUserRoleArgs, opts?: pulumi.InvokeOptions): Promise<GetManagedDatabaseUserRoleResult>;
/**
 ...
 * ```
 */
export declare function getManagedDatabaseUserRoleOutput(args: GetManagedDatabaseUserRoleOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetManagedDatabaseUserRoleResult>;
/**
 * A collection of arguments for invoking getManagedDatabaseUserRole.
 */

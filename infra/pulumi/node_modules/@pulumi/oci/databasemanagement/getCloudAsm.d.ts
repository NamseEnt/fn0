 ...
 * ```
 */
export declare function getCloudAsm(args: GetCloudAsmArgs, opts?: pulumi.InvokeOptions): Promise<GetCloudAsmResult>;
/**
 ...
 * ```
 */
export declare function getCloudAsmOutput(args: GetCloudAsmOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetCloudAsmResult>;
/**
 * A collection of arguments for invoking getCloudAsm.
 */

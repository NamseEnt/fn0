 ...
 * ```
 */
export declare function getExternalExadataStorageServer(args: GetExternalExadataStorageServerArgs, opts?: pulumi.InvokeOptions): Promise<GetExternalExadataStorageServerResult>;
/**
 ...
 * ```
 */
export declare function getExternalExadataStorageServerOutput(args: GetExternalExadataStorageServerOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetExternalExadataStorageServerResult>;
/**
 * A collection of arguments for invoking getExternalExadataStorageServer.
 */

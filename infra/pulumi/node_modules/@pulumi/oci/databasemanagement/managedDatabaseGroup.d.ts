 ...
 * ```
 */
export declare class ManagedDatabaseGroup extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ManagedDatabaseGroupState, opts?: pulumi.CustomResourceOptions): ManagedDatabaseGroup;
    /**
     * Returns true if the given object is an instance of ManagedDatabaseGroup.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is ManagedDatabaseGroup;
    /**
     ...
     */
    readonly managedDatabases: pulumi.Output<outputs.DatabaseManagement.ManagedDatabaseGroupManagedDatabase[]>;
    /**

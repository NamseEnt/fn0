 ...
 * ```
 */
class ExternalMySqlDatabase extends pulumi.CustomResource {
    /**
    ...
    static get(name, id, state, opts) {
        return new ExternalMySqlDatabase(name, state, { ...opts, id: id });
    }
    /**
...
exports.ExternalMySqlDatabase = ExternalMySqlDatabase;
/** @internal */
ExternalMySqlDatabase.__pulumiType = 'oci:DatabaseManagement/externalMySqlDatabase:ExternalMySqlDatabase';
//# sourceMappingURL=externalMySqlDatabase.js.map
 ...
 * ```
 */
export declare function getCloudAsmUsers(args: GetCloudAsmUsersArgs, opts?: pulumi.InvokeOptions): Promise<GetCloudAsmUsersResult>;
/**
 ...
 * ```
 */
export declare function getCloudAsmUsersOutput(args: GetCloudAsmUsersOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetCloudAsmUsersResult>;
/**
 * A collection of arguments for invoking getCloudAsmUsers.
 */

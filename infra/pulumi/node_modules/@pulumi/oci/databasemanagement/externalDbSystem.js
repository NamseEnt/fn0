 ...
 * ```
 */
class ExternalDbSystem extends pulumi.CustomResource {
    /**
    ...
    static get(name, id, state, opts) {
        return new ExternalDbSystem(name, state, { ...opts, id: id });
    }
    /**
...
exports.ExternalDbSystem = ExternalDbSystem;
/** @internal */
ExternalDbSystem.__pulumiType = 'oci:DatabaseManagement/externalDbSystem:ExternalDbSystem';
//# sourceMappingURL=externalDbSystem.js.map
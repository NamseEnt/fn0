 ...
 * ```
 */
export declare function getManagedDatabaseUserProxiedForUsers(args: GetManagedDatabaseUserProxiedForUsersArgs, opts?: pulumi.InvokeOptions): Promise<GetManagedDatabaseUserProxiedForUsersResult>;
/**
 ...
 * ```
 */
export declare function getManagedDatabaseUserProxiedForUsersOutput(args: GetManagedDatabaseUserProxiedForUsersOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetManagedDatabaseUserProxiedForUsersResult>;
/**
 * A collection of arguments for invoking getManagedDatabaseUserProxiedForUsers.
 */

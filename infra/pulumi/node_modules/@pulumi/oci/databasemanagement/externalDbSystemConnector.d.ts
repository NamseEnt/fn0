 ...
 * ```
 */
export declare class ExternalDbSystemConnector extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ExternalDbSystemConnectorState, opts?: pulumi.CustomResourceOptions): ExternalDbSystemConnector;
    /**
     ...
     */
    static isInstance(obj: any): obj is ExternalDbSystemConnector;
    /**
     ...
     */
    readonly connectionInfos: pulumi.Output<outputs.DatabaseManagement.ExternalDbSystemConnectorConnectionInfo[]>;
    /**

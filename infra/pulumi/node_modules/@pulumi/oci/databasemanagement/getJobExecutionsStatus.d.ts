 ...
 * ```
 */
export declare function getJobExecutionsStatus(args: GetJobExecutionsStatusArgs, opts?: pulumi.InvokeOptions): Promise<GetJobExecutionsStatusResult>;
/**
 ...
 * ```
 */
export declare function getJobExecutionsStatusOutput(args: GetJobExecutionsStatusOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetJobExecutionsStatusResult>;
/**
 * A collection of arguments for invoking getJobExecutionsStatus.
 */

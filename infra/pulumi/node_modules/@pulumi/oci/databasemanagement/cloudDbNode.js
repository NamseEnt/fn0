 ...
 * ```
 */
class CloudDbNode extends pulumi.CustomResource {
    /**
    ...
    static get(name, id, state, opts) {
        return new CloudDbNode(name, state, { ...opts, id: id });
    }
    /**
...
exports.CloudDbNode = CloudDbNode;
/** @internal */
CloudDbNode.__pulumiType = 'oci:DatabaseManagement/cloudDbNode:CloudDbNode';
//# sourceMappingURL=cloudDbNode.js.map
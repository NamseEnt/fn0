 ...
 * ```
 */
export declare class ExternalMySqlDatabaseConnector extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ExternalMySqlDatabaseConnectorState, opts?: pulumi.CustomResourceOptions): ExternalMySqlDatabaseConnector;
    /**
     ...
     */
    static isInstance(obj: any): obj is ExternalMySqlDatabaseConnector;
    /**
     * Oracle Cloud Infrastructure Services associated with this connector.
     */
    readonly associatedServices: pulumi.Output<string>;
    /**
     ...
     */
    readonly checkConnectionStatusTrigger: pulumi.Output<number | undefined>;
    /**
     ...
     */
    readonly connectorDetails: pulumi.Output<outputs.DatabaseManagement.ExternalMySqlDatabaseConnectorConnectorDetails>;
    /**
     * Connector Type.
     */
     ...
     */
    readonly externalDatabaseId: pulumi.Output<string>;
    /**
     ...
     */
    readonly isTestConnectionParam: pulumi.Output<boolean>;
    /**
     * Agent Id of the MACS agent.
     */
    readonly macsAgentId: pulumi.Output<string>;
    /**
     ...
     * Network Protocol.
     */
    readonly networkProtocol: pulumi.Output<string>;
    /**
     * Connector port.
     */
     ...
     */
    readonly sourceDatabase: pulumi.Output<string>;
    /**
     * Type of MySQL Database.
     */
    readonly sourceDatabaseType: pulumi.Output<string>;
    /**
     ...
     */
    readonly sslSecretName: pulumi.Output<string>;
    /**
     ...
     */
    readonly timeConnectionStatusUpdated: pulumi.Output<string>;
    /**

 ...
 * ```
 */
export declare function getExternalExadataStorageConnectors(args: GetExternalExadataStorageConnectorsArgs, opts?: pulumi.InvokeOptions): Promise<GetExternalExadataStorageConnectorsResult>;
/**
 ...
 * ```
 */
export declare function getExternalExadataStorageConnectorsOutput(args: GetExternalExadataStorageConnectorsOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetExternalExadataStorageConnectorsResult>;
/**
 * A collection of arguments for invoking getExternalExadataStorageConnectors.
 */

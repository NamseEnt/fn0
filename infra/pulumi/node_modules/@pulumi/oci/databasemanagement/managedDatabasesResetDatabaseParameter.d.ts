 ...
 */
export declare class ManagedDatabasesResetDatabaseParameter extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ManagedDatabasesResetDatabaseParameterState, opts?: pulumi.CustomResourceOptions): ManagedDatabasesResetDatabaseParameter;
    /**
     ...
     */
    static isInstance(obj: any): obj is ManagedDatabasesResetDatabaseParameter;
    /**
     ...
     */
    readonly credentials: pulumi.Output<outputs.DatabaseManagement.ManagedDatabasesResetDatabaseParameterCredentials>;
    /**
     * The credential to connect to the database to perform tablespace administration tasks.
     */
    readonly databaseCredential: pulumi.Output<outputs.DatabaseManagement.ManagedDatabasesResetDatabaseParameterDatabaseCredential>;
    /**

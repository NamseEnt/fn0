 ...
 * ```
 */
export declare class ExternalAsm extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ExternalAsmState, opts?: pulumi.CustomResourceOptions): ExternalAsm;
    /**
     * Returns true if the given object is an instance of ExternalAsm.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is ExternalAsm;
    /**
     ...
     */
    readonly externalAsmId: pulumi.Output<string>;
    /**
     ...
     */
    readonly isFlexEnabled: pulumi.Output<boolean>;
    /**
     ...
     */
    readonly servicedDatabases: pulumi.Output<outputs.DatabaseManagement.ExternalAsmServicedDatabase[]>;
    /**

 ...
 * ```
 */
export declare function getExternalMySqlDatabase(args: GetExternalMySqlDatabaseArgs, opts?: pulumi.InvokeOptions): Promise<GetExternalMySqlDatabaseResult>;
/**
 ...
 * ```
 */
export declare function getExternalMySqlDatabaseOutput(args: GetExternalMySqlDatabaseOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetExternalMySqlDatabaseResult>;
/**
 * A collection of arguments for invoking getExternalMySqlDatabase.
 */

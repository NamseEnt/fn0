 ...
 * ```
 */
export declare function getManagedDatabasesDatabaseParameter(args: GetManagedDatabasesDatabaseParameterArgs, opts?: pulumi.InvokeOptions): Promise<GetManagedDatabasesDatabaseParameterResult>;
/**
 ...
 * ```
 */
export declare function getManagedDatabasesDatabaseParameterOutput(args: GetManagedDatabasesDatabaseParameterOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetManagedDatabasesDatabaseParameterResult>;
/**
 * A collection of arguments for invoking getManagedDatabasesDatabaseParameter.
 */

 ...
 * ```
 */
export declare function getCloudVmClusterIormConfig(args: GetCloudVmClusterIormConfigArgs, opts?: pulumi.InvokeOptions): Promise<GetCloudVmClusterIormConfigResult>;
/**
 ...
 * ```
 */
export declare function getCloudVmClusterIormConfigOutput(args: GetCloudVmClusterIormConfigOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetCloudVmClusterIormConfigResult>;
/**
 * A collection of arguments for invoking getCloudVmClusterIormConfig.
 */

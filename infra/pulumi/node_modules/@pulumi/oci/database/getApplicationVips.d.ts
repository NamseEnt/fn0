 ...
 * ```
 */
export declare function getApplicationVips(args: GetApplicationVipsArgs, opts?: pulumi.InvokeOptions): Promise<GetApplicationVipsResult>;
/**
 ...
 * ```
 */
export declare function getApplicationVipsOutput(args: GetApplicationVipsOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetApplicationVipsResult>;
/**
 * A collection of arguments for invoking getApplicationVips.
 */

 ...
 * ```
 */
export declare function getManagedPreferredCredential(args: GetManagedPreferredCredentialArgs, opts?: pulumi.InvokeOptions): Promise<GetManagedPreferredCredentialResult>;
/**
 ...
 * ```
 */
export declare function getManagedPreferredCredentialOutput(args: GetManagedPreferredCredentialOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetManagedPreferredCredentialResult>;
/**
 * A collection of arguments for invoking getManagedPreferredCredential.
 */

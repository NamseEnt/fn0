 ...
 * ```
 */
export declare function getExadbVmCluster(args: GetExadbVmClusterArgs, opts?: pulumi.InvokeOptions): Promise<GetExadbVmClusterResult>;
/**
 ...
 * ```
 */
export declare function getExadbVmClusterOutput(args: GetExadbVmClusterOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetExadbVmClusterResult>;
/**
 * A collection of arguments for invoking getExadbVmCluster.
 */

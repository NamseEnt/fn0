 ...
 * ```
 */
export declare function getSchedulingPolicySchedulingWindows(args: GetSchedulingPolicySchedulingWindowsArgs, opts?: pulumi.InvokeOptions): Promise<GetSchedulingPolicySchedulingWindowsResult>;
/**
 ...
 * ```
 */
export declare function getSchedulingPolicySchedulingWindowsOutput(args: GetSchedulingPolicySchedulingWindowsOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetSchedulingPolicySchedulingWindowsResult>;
/**
 * A collection of arguments for invoking getSchedulingPolicySchedulingWindows.
 */

 ...
 * ```
 */
export declare function getDbVersions(args: GetDbVersionsArgs, opts?: pulumi.InvokeOptions): Promise<GetDbVersionsResult>;
/**
 ...
 * ```
 */
export declare function getDbVersionsOutput(args: GetDbVersionsOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetDbVersionsResult>;
/**
 * A collection of arguments for invoking getDbVersions.
 */

 ...
 * ```
 */
export declare function getDataGuardAssociations(args: GetDataGuardAssociationsArgs, opts?: pulumi.InvokeOptions): Promise<GetDataGuardAssociationsResult>;
/**
 ...
 * ```
 */
export declare function getDataGuardAssociationsOutput(args: GetDataGuardAssociationsOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetDataGuardAssociationsResult>;
/**
 * A collection of arguments for invoking getDataGuardAssociations.
 */

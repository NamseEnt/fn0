 ...
 * ```
 */
export declare function getApplicationVip(args: GetApplicationVipArgs, opts?: pulumi.InvokeOptions): Promise<GetApplicationVipResult>;
/**
 ...
 * ```
 */
export declare function getApplicationVipOutput(args: GetApplicationVipOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetApplicationVipResult>;
/**
 * A collection of arguments for invoking getApplicationVip.
 */

 ...
 * ```
 */
export declare class ExternalNonContainerDatabase extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ExternalNonContainerDatabaseState, opts?: pulumi.CustomResourceOptions): ExternalNonContainerDatabase;
    /**
     ...
     */
    static isInstance(obj: any): obj is ExternalNonContainerDatabase;
    /**
     ...
     */
    readonly databaseManagementConfigs: pulumi.Output<outputs.Database.ExternalNonContainerDatabaseDatabaseManagementConfig[]>;
    /**
     ...
     */
    readonly operationsInsightsConfigs: pulumi.Output<outputs.Database.ExternalNonContainerDatabaseOperationsInsightsConfig[]>;
    /**
     * The configuration of Stack Monitoring for the external database.
     */
    readonly stackMonitoringConfigs: pulumi.Output<outputs.Database.ExternalNonContainerDatabaseStackMonitoringConfig[]>;
    /**

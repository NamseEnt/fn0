 ...
 * ```
 */
class ExternalDatabaseConnector extends pulumi.CustomResource {
    /**
    ...
    static get(name, id, state, opts) {
        return new ExternalDatabaseConnector(name, state, { ...opts, id: id });
    }
    /**
...
exports.ExternalDatabaseConnector = ExternalDatabaseConnector;
/** @internal */
ExternalDatabaseConnector.__pulumiType = 'oci:Database/externalDatabaseConnector:ExternalDatabaseConnector';
//# sourceMappingURL=externalDatabaseConnector.js.map
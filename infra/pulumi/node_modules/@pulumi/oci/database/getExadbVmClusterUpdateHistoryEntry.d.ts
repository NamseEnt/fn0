 ...
 * ```
 */
export declare function getExadbVmClusterUpdateHistoryEntry(args: GetExadbVmClusterUpdateHistoryEntryArgs, opts?: pulumi.InvokeOptions): Promise<GetExadbVmClusterUpdateHistoryEntryResult>;
/**
 ...
 * ```
 */
export declare function getExadbVmClusterUpdateHistoryEntryOutput(args: GetExadbVmClusterUpdateHistoryEntryOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetExadbVmClusterUpdateHistoryEntryResult>;
/**
 * A collection of arguments for invoking getExadbVmClusterUpdateHistoryEntry.
 */

 ...
 * ```
 */
export declare function getKeyStore(args: GetKeyStoreArgs, opts?: pulumi.InvokeOptions): Promise<GetKeyStoreResult>;
/**
 ...
 * ```
 */
export declare function getKeyStoreOutput(args: GetKeyStoreOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetKeyStoreResult>;
/**
 * A collection of arguments for invoking getKeyStore.
 */

 ...
 * ```
 */
export declare function getAutonomousExadataInfrastructures(args: GetAutonomousExadataInfrastructuresArgs, opts?: pulumi.InvokeOptions): Promise<GetAutonomousExadataInfrastructuresResult>;
/**
 ...
 * ```
 */
export declare function getAutonomousExadataInfrastructuresOutput(args: GetAutonomousExadataInfrastructuresOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetAutonomousExadataInfrastructuresResult>;
/**
 * A collection of arguments for invoking getAutonomousExadataInfrastructures.
 */

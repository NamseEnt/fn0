 ...
 * ```
 */
export declare function getAutonomousVmClusters(args: GetAutonomousVmClustersArgs, opts?: pulumi.InvokeOptions): Promise<GetAutonomousVmClustersResult>;
/**
 ...
 * ```
 */
export declare function getAutonomousVmClustersOutput(args: GetAutonomousVmClustersOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetAutonomousVmClustersResult>;
/**
 * A collection of arguments for invoking getAutonomousVmClusters.
 */

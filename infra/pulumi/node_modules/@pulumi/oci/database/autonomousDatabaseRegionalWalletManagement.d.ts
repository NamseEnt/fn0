 ...
 */
export declare class AutonomousDatabaseRegionalWalletManagement extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: AutonomousDatabaseRegionalWalletManagementState, opts?: pulumi.CustomResourceOptions): AutonomousDatabaseRegionalWalletManagement;
    /**
     ...
     */
    static isInstance(obj: any): obj is AutonomousDatabaseRegionalWalletManagement;
    /**
     ...
     */
    readonly gracePeriod: pulumi.Output<number>;
    /**
     ...
     */
    readonly shouldRotate: pulumi.Output<boolean | undefined>;
    /**
     ...
     */
    readonly timeRotated: pulumi.Output<string>;
    /**

 ...
 * ```
 */
export declare function getVmClusterUpdates(args: GetVmClusterUpdatesArgs, opts?: pulumi.InvokeOptions): Promise<GetVmClusterUpdatesResult>;
/**
 ...
 * ```
 */
export declare function getVmClusterUpdatesOutput(args: GetVmClusterUpdatesOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetVmClusterUpdatesResult>;
/**
 * A collection of arguments for invoking getVmClusterUpdates.
 */

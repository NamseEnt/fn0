 ...
 * ```
 */
export declare class CloudVmClusterIormConfig extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: CloudVmClusterIormConfigState, opts?: pulumi.CustomResourceOptions): CloudVmClusterIormConfig;
    /**
     * Returns true if the given object is an instance of CloudVmClusterIormConfig.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is CloudVmClusterIormConfig;
    /**
     ...
     */
    readonly dbPlans: pulumi.Output<outputs.Database.CloudVmClusterIormConfigDbPlan[]>;
    /**
     ...
     */
    readonly objective: pulumi.Output<string>;
    /**

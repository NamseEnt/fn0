...
exports.VmClusterAddVirtualNetwork = void 0;
 ...
 * ```
 */
class VmClusterAddVirtualNetwork extends pulumi.CustomResource {
    /**
    ...
    static get(name, id, state, opts) {
        return new VmClusterAddVirtualNetwork(name, state, { ...opts, id: id });
    }
    /**
...
exports.VmClusterAddVirtualNetwork = VmClusterAddVirtualNetwork;
/** @internal */
VmClusterAddVirtualNetwork.__pulumiType = 'oci:Database/vmClusterAddVirtualNetwork:VmClusterAddVirtualNetwork';
//# sourceMappingURL=vmClusterAddVirtualNetwork.js.map
 ...
 * ```
 */
export declare function getAutonomousDbPreviewVersions(args: GetAutonomousDbPreviewVersionsArgs, opts?: pulumi.InvokeOptions): Promise<GetAutonomousDbPreviewVersionsResult>;
/**
 ...
 * ```
 */
export declare function getAutonomousDbPreviewVersionsOutput(args: GetAutonomousDbPreviewVersionsOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetAutonomousDbPreviewVersionsResult>;
/**
 * A collection of arguments for invoking getAutonomousDbPreviewVersions.
 */

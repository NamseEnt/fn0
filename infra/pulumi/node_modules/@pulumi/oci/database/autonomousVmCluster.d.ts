 ...
 * ```
 */
export declare class AutonomousVmCluster extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: AutonomousVmClusterState, opts?: pulumi.CustomResourceOptions): AutonomousVmCluster;
    /**
     * Returns true if the given object is an instance of AutonomousVmCluster.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is AutonomousVmCluster;
     ...
     */
    readonly availableDataStorageSizeInTbs: pulumi.Output<number>;
    /**
    ...
    readonly cpusLowestScaledValue: pulumi.Output<number>;
     ...
     */
    readonly isMtlsEnabled: pulumi.Output<boolean>;
    /**
     ...
     */
    readonly maintenanceWindowDetails: pulumi.Output<outputs.Database.AutonomousVmClusterMaintenanceWindowDetail[]>;
    /**
     * The scheduling details for the quarterly maintenance window. Patching and system updates take place during the maintenance window.
     */
    readonly maintenanceWindows: pulumi.Output<outputs.Database.AutonomousVmClusterMaintenanceWindow[]>;
    /**
    ...
    readonly totalAutonomousDataStorageInTbs: pulumi.Output<number>;
    /**

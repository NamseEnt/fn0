 ...
 * ```
 */
export declare function getDbNodeConsoleHistory(args: GetDbNodeConsoleHistoryArgs, opts?: pulumi.InvokeOptions): Promise<GetDbNodeConsoleHistoryResult>;
/**
 ...
 * ```
 */
export declare function getDbNodeConsoleHistoryOutput(args: GetDbNodeConsoleHistoryOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetDbNodeConsoleHistoryResult>;
/**
 * A collection of arguments for invoking getDbNodeConsoleHistory.
 */

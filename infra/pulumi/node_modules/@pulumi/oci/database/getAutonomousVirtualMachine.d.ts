 ...
 * ```
 */
export declare function getAutonomousVirtualMachine(args: GetAutonomousVirtualMachineArgs, opts?: pulumi.InvokeOptions): Promise<GetAutonomousVirtualMachineResult>;
/**
 ...
 * ```
 */
export declare function getAutonomousVirtualMachineOutput(args: GetAutonomousVirtualMachineOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetAutonomousVirtualMachineResult>;
/**
 * A collection of arguments for invoking getAutonomousVirtualMachine.
 */

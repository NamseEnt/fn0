...
export declare class Backup extends pulumi.CustomResource {
    ...
    readonly backupDestinationType: pulumi.Output<string>;
    /**
     ...
     */
    readonly databaseSizeInGbs: pulumi.Output<number>;
    /**
     ...
     */
    readonly encryptionKeyLocationDetails: pulumi.Output<outputs.Database.BackupEncryptionKeyLocationDetail[]>;
    readonly isUsingOracleManagedKeys: pulumi.Output<boolean>;
    /**
    ...
    readonly retentionPeriodInYears: pulumi.Output<number>;
    readonly secondaryKmsKeyIds: pulumi.Output<string[]>;
    /**
    ...
    readonly timeExpiryScheduled: pulumi.Output<string>;
    /**

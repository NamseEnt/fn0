 ...
 * ```
 */
export declare function getDbSystemsUpgradeHistoryEntries(args: GetDbSystemsUpgradeHistoryEntriesArgs, opts?: pulumi.InvokeOptions): Promise<GetDbSystemsUpgradeHistoryEntriesResult>;
/**
 ...
 * ```
 */
export declare function getDbSystemsUpgradeHistoryEntriesOutput(args: GetDbSystemsUpgradeHistoryEntriesOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetDbSystemsUpgradeHistoryEntriesResult>;
/**
 * A collection of arguments for invoking getDbSystemsUpgradeHistoryEntries.
 */

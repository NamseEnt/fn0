 ...
 * ```
 */
export declare function getExadbVmClusterUpdates(args: GetExadbVmClusterUpdatesArgs, opts?: pulumi.InvokeOptions): Promise<GetExadbVmClusterUpdatesResult>;
/**
 ...
 * ```
 */
export declare function getExadbVmClusterUpdatesOutput(args: GetExadbVmClusterUpdatesOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetExadbVmClusterUpdatesResult>;
/**
 * A collection of arguments for invoking getExadbVmClusterUpdates.
 */

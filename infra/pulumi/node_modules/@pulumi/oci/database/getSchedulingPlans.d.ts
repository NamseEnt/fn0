 ...
 * ```
 */
export declare function getSchedulingPlans(args: GetSchedulingPlansArgs, opts?: pulumi.InvokeOptions): Promise<GetSchedulingPlansResult>;
/**
 ...
 * ```
 */
export declare function getSchedulingPlansOutput(args: GetSchedulingPlansOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetSchedulingPlansResult>;
/**
 * A collection of arguments for invoking getSchedulingPlans.
 */

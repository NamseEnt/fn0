 ...
 * ```
 */
export declare function getDatabaseSoftwareImage(args: GetDatabaseSoftwareImageArgs, opts?: pulumi.InvokeOptions): Promise<GetDatabaseSoftwareImageResult>;
/**
 ...
 * ```
 */
export declare function getDatabaseSoftwareImageOutput(args: GetDatabaseSoftwareImageOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetDatabaseSoftwareImageResult>;
/**
 * A collection of arguments for invoking getDatabaseSoftwareImage.
 */

 ...
 * ```
 */
export declare function getVmClusterPatchHistoryEntry(args: GetVmClusterPatchHistoryEntryArgs, opts?: pulumi.InvokeOptions): Promise<GetVmClusterPatchHistoryEntryResult>;
/**
 ...
 * ```
 */
export declare function getVmClusterPatchHistoryEntryOutput(args: GetVmClusterPatchHistoryEntryOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetVmClusterPatchHistoryEntryResult>;
/**
 * A collection of arguments for invoking getVmClusterPatchHistoryEntry.
 */

 ...
 * ```
 */
export declare function getExecutionWindows(args: GetExecutionWindowsArgs, opts?: pulumi.InvokeOptions): Promise<GetExecutionWindowsResult>;
/**
 ...
 * ```
 */
export declare function getExecutionWindowsOutput(args: GetExecutionWindowsOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetExecutionWindowsResult>;
/**
 * A collection of arguments for invoking getExecutionWindows.
 */

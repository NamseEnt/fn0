 ...
 * ```
 */
export declare function getDatabasePdbConversionHistoryEntry(args: GetDatabasePdbConversionHistoryEntryArgs, opts?: pulumi.InvokeOptions): Promise<GetDatabasePdbConversionHistoryEntryResult>;
/**
 ...
 * ```
 */
export declare function getDatabasePdbConversionHistoryEntryOutput(args: GetDatabasePdbConversionHistoryEntryOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetDatabasePdbConversionHistoryEntryResult>;
/**
 * A collection of arguments for invoking getDatabasePdbConversionHistoryEntry.
 */

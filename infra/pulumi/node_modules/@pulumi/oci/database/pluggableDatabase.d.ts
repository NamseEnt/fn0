 ...
 * ```
 */
export declare class PluggableDatabase extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: PluggableDatabaseState, opts?: pulumi.CustomResourceOptions): PluggableDatabase;
    /**
     * Returns true if the given object is an instance of PluggableDatabase.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is PluggableDatabase;
    /**
     ...
     */
    readonly connectionStrings: pulumi.Output<outputs.Database.PluggableDatabaseConnectionString[]>;
    /**
     * The DB system administrator password of the Container Database.
     */
    readonly containerDatabaseAdminPassword: pulumi.Output<string>;
    /**
     * The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the CDB
     */
    readonly containerDatabaseId: pulumi.Output<string>;
    /**
     * (Updatable) An optional property when incremented triggers Convert To Regular. Could be set to any integer value.
     */
    readonly convertToRegularTrigger: pulumi.Output<number | undefined>;
    /**
     ...
     */
    readonly isRestricted: pulumi.Output<boolean>;
    /**
     ...
     */
    readonly pdbAdminPassword: pulumi.Output<string>;
    /**
     ...
     */
    readonly pdbCreationTypeDetails: pulumi.Output<outputs.Database.PluggableDatabasePdbCreationTypeDetails>;
    /**
     * The name for the pluggable database (PDB). The name is unique in the context of a [container database](https://docs.cloud.oracle.com/iaas/api/#/en/database/latest/Database/). The name must begin with an alphabetic character and can contain a maximum of thirty alphanumeric characters. Special characters are not permitted. The pluggable database name should not be same as the container database name.
     */
    readonly pdbName: pulumi.Output<string>;
    /**
     * Pluggable Database Node Level Details. Example: [{"nodeName" : "node1", "openMode" : "READ_WRITE"}, {"nodeName" : "node2", "openMode" : "READ_ONLY"}]
     */
    readonly pdbNodeLevelDetails: pulumi.Output<outputs.Database.PluggableDatabasePdbNodeLevelDetail[]>;
    /**
     * The configuration of the Pluggable Database Management service.
     */
    readonly pluggableDatabaseManagementConfigs: pulumi.Output<outputs.Database.PluggableDatabasePluggableDatabaseManagementConfig[]>;
    /**
     ...
     */
    readonly refreshableCloneConfigs: pulumi.Output<outputs.Database.PluggableDatabaseRefreshableCloneConfig[]>;
    /**
     ...
     */
    readonly rotateKeyTrigger: pulumi.Output<number | undefined>;
    /**
     * Indicates whether to take Pluggable Database Backup after the operation.
     */
    readonly shouldCreatePdbBackup: pulumi.Output<boolean>;
    /**
     * The locked mode of the pluggable database admin account. If false, the user needs to provide the PDB Admin Password to connect to it. If true, the pluggable database will be locked and user cannot login to it.
     */
    readonly shouldPdbAdminAccountBeLocked: pulumi.Output<boolean>;
    /**
     ...
     */
    readonly tdeWalletPassword: pulumi.Output<string>;
    /**

 ...
 * ```
 */
export declare class VmClusterNetwork extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: VmClusterNetworkState, opts?: pulumi.CustomResourceOptions): VmClusterNetwork;
    /**
     * Returns true if the given object is an instance of VmClusterNetwork.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is VmClusterNetwork;
     ...
     */
    readonly drScans: pulumi.Output<outputs.Database.VmClusterNetworkDrScan[]>;
    /**
     ...
     */
    readonly ntps: pulumi.Output<string[]>;
    /**
     * (Updatable) The SCAN details.
     */
    readonly scans: pulumi.Output<outputs.Database.VmClusterNetworkScan[]>;
    /**
    ...
    readonly validateVmClusterNetwork: pulumi.Output<boolean | undefined>;
    /**
     ...
     */
    readonly vmNetworks: pulumi.Output<outputs.Database.VmClusterNetworkVmNetwork[]>;
    /**

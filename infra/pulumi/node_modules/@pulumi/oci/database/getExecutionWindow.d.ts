 ...
 * ```
 */
export declare function getExecutionWindow(args: GetExecutionWindowArgs, opts?: pulumi.InvokeOptions): Promise<GetExecutionWindowResult>;
/**
 ...
 * ```
 */
export declare function getExecutionWindowOutput(args: GetExecutionWindowOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetExecutionWindowResult>;
/**
 * A collection of arguments for invoking getExecutionWindow.
 */

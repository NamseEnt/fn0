 ...
 * ```
 */
export declare function getSchedulingPolicySchedulingWindow(args: GetSchedulingPolicySchedulingWindowArgs, opts?: pulumi.InvokeOptions): Promise<GetSchedulingPolicySchedulingWindowResult>;
/**
 ...
 * ```
 */
export declare function getSchedulingPolicySchedulingWindowOutput(args: GetSchedulingPolicySchedulingWindowOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetSchedulingPolicySchedulingWindowResult>;
/**
 * A collection of arguments for invoking getSchedulingPolicySchedulingWindow.
 */

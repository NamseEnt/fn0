 ...
 * ```
 */
export declare function getDatabaseUpgradeHistoryEntry(args: GetDatabaseUpgradeHistoryEntryArgs, opts?: pulumi.InvokeOptions): Promise<GetDatabaseUpgradeHistoryEntryResult>;
/**
 ...
 * ```
 */
export declare function getDatabaseUpgradeHistoryEntryOutput(args: GetDatabaseUpgradeHistoryEntryOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetDatabaseUpgradeHistoryEntryResult>;
/**
 * A collection of arguments for invoking getDatabaseUpgradeHistoryEntry.
 */

 ...
 * ```
 */
export declare function getVmClusters(args: GetVmClustersArgs, opts?: pulumi.InvokeOptions): Promise<GetVmClustersResult>;
/**
 ...
 * ```
 */
export declare function getVmClustersOutput(args: GetVmClustersOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetVmClustersResult>;
/**
 * A collection of arguments for invoking getVmClusters.
 */

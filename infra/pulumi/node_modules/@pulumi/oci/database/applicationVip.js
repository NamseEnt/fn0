 ...
 * ```
 */
class ApplicationVip extends pulumi.CustomResource {
    /**
    ...
    static get(name, id, state, opts) {
        return new ApplicationVip(name, state, { ...opts, id: id });
    }
    /**
...
exports.ApplicationVip = ApplicationVip;
/** @internal */
ApplicationVip.__pulumiType = 'oci:Database/applicationVip:ApplicationVip';
//# sourceMappingURL=applicationVip.js.map
 ...
 * ```
 */
class ExternalNonContainerDatabase extends pulumi.CustomResource {
    /**
    ...
    static get(name, id, state, opts) {
        return new ExternalNonContainerDatabase(name, state, { ...opts, id: id });
    }
    /**
...
exports.ExternalNonContainerDatabase = ExternalNonContainerDatabase;
/** @internal */
ExternalNonContainerDatabase.__pulumiType = 'oci:Database/externalNonContainerDatabase:ExternalNonContainerDatabase';
//# sourceMappingURL=externalNonContainerDatabase.js.map
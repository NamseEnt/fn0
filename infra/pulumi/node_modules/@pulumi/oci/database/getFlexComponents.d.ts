 ...
 * ```
 */
export declare function getFlexComponents(args: GetFlexComponentsArgs, opts?: pulumi.InvokeOptions): Promise<GetFlexComponentsResult>;
/**
 ...
 * ```
 */
export declare function getFlexComponentsOutput(args: GetFlexComponentsOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetFlexComponentsResult>;
/**
 * A collection of arguments for invoking getFlexComponents.
 */

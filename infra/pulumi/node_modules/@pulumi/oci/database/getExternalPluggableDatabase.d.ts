 ...
 * ```
 */
export declare function getExternalPluggableDatabase(args: GetExternalPluggableDatabaseArgs, opts?: pulumi.InvokeOptions): Promise<GetExternalPluggableDatabaseResult>;
/**
 ...
 * ```
 */
export declare function getExternalPluggableDatabaseOutput(args: GetExternalPluggableDatabaseOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetExternalPluggableDatabaseResult>;
/**
 * A collection of arguments for invoking getExternalPluggableDatabase.
 */

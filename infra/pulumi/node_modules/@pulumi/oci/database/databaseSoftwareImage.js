 ...
 * ```
 */
class DatabaseSoftwareImage extends pulumi.CustomResource {
    /**
    ...
    static get(name, id, state, opts) {
        return new DatabaseSoftwareImage(name, state, { ...opts, id: id });
    }
    /**
...
exports.DatabaseSoftwareImage = DatabaseSoftwareImage;
/** @internal */
DatabaseSoftwareImage.__pulumiType = 'oci:Database/databaseSoftwareImage:DatabaseSoftwareImage';
//# sourceMappingURL=databaseSoftwareImage.js.map
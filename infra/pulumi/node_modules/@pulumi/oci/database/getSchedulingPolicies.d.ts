 ...
 * ```
 */
export declare function getSchedulingPolicies(args: GetSchedulingPoliciesArgs, opts?: pulumi.InvokeOptions): Promise<GetSchedulingPoliciesResult>;
/**
 ...
 * ```
 */
export declare function getSchedulingPoliciesOutput(args: GetSchedulingPoliciesOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetSchedulingPoliciesResult>;
/**
 * A collection of arguments for invoking getSchedulingPolicies.
 */

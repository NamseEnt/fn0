 ...
 * ```
 */
class VmClusterNetwork extends pulumi.CustomResource {
    /**
    ...
    static get(name, id, state, opts) {
        return new VmClusterNetwork(name, state, { ...opts, id: id });
    }
    /**
...
exports.VmClusterNetwork = VmClusterNetwork;
/** @internal */
VmClusterNetwork.__pulumiType = 'oci:Database/vmClusterNetwork:VmClusterNetwork';
//# sourceMappingURL=vmClusterNetwork.js.map
 ...
 * ```
 */
export declare function getVmClusterPatchHistoryEntries(args: GetVmClusterPatchHistoryEntriesArgs, opts?: pulumi.InvokeOptions): Promise<GetVmClusterPatchHistoryEntriesResult>;
/**
 ...
 * ```
 */
export declare function getVmClusterPatchHistoryEntriesOutput(args: GetVmClusterPatchHistoryEntriesOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetVmClusterPatchHistoryEntriesResult>;
/**
 * A collection of arguments for invoking getVmClusterPatchHistoryEntries.
 */

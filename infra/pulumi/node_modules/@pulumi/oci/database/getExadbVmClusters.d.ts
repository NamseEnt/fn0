 ...
 * ```
 */
export declare function getExadbVmClusters(args: GetExadbVmClustersArgs, opts?: pulumi.InvokeOptions): Promise<GetExadbVmClustersResult>;
/**
 ...
 * ```
 */
export declare function getExadbVmClustersOutput(args: GetExadbVmClustersOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetExadbVmClustersResult>;
/**
 * A collection of arguments for invoking getExadbVmClusters.
 */

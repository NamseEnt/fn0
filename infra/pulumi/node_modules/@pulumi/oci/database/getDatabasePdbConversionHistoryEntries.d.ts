 ...
 * ```
 */
export declare function getDatabasePdbConversionHistoryEntries(args: GetDatabasePdbConversionHistoryEntriesArgs, opts?: pulumi.InvokeOptions): Promise<GetDatabasePdbConversionHistoryEntriesResult>;
/**
 ...
 * ```
 */
export declare function getDatabasePdbConversionHistoryEntriesOutput(args: GetDatabasePdbConversionHistoryEntriesOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetDatabasePdbConversionHistoryEntriesResult>;
/**
 * A collection of arguments for invoking getDatabasePdbConversionHistoryEntries.
 */

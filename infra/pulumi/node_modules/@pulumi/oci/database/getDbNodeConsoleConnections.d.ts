 ...
 * ```
 */
export declare function getDbNodeConsoleConnections(args: GetDbNodeConsoleConnectionsArgs, opts?: pulumi.InvokeOptions): Promise<GetDbNodeConsoleConnectionsResult>;
/**
 ...
 * ```
 */
export declare function getDbNodeConsoleConnectionsOutput(args: GetDbNodeConsoleConnectionsOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetDbNodeConsoleConnectionsResult>;
/**
 * A collection of arguments for invoking getDbNodeConsoleConnections.
 */

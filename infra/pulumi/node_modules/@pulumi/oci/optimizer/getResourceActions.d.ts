 ...
 * ```
 */
export declare function getResourceActions(args: GetResourceActionsArgs, opts?: pulumi.InvokeOptions): Promise<GetResourceActionsResult>;
/**
 ...
 * ```
 */
export declare function getResourceActionsOutput(args: GetResourceActionsOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetResourceActionsResult>;
/**
 * A collection of arguments for invoking getResourceActions.
 */

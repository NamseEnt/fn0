 ...
 * ```
 */
export declare class ResourceAction extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ResourceActionState, opts?: pulumi.CustomResourceOptions): ResourceAction;
    /**
     * Returns true if the given object is an instance of ResourceAction.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is ResourceAction;
    /**
     * Details about the recommended action.
     */
    readonly actions: pulumi.Output<outputs.Optimizer.ResourceActionAction[]>;
    /**
     ...
     */
    readonly compartmentName: pulumi.Output<string>;
    /**
     ...
     */
    readonly resourceActionId: pulumi.Output<string>;
    /**

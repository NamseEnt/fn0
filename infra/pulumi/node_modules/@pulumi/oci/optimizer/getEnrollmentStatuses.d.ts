 ...
 * ```
 */
export declare function getEnrollmentStatuses(args: GetEnrollmentStatusesArgs, opts?: pulumi.InvokeOptions): Promise<GetEnrollmentStatusesResult>;
/**
 ...
 * ```
 */
export declare function getEnrollmentStatusesOutput(args: GetEnrollmentStatusesOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetEnrollmentStatusesResult>;
/**
 * A collection of arguments for invoking getEnrollmentStatuses.
 */

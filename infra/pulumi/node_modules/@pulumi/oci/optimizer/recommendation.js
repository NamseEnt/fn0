 ...
 * ```
 */
class Recommendation extends pulumi.CustomResource {
    /**
    ...
    static get(name, id, state, opts) {
        return new Recommendation(name, state, { ...opts, id: id });
    }
    /**
...
/** @internal */
Recommendation.__pulumiType = 'oci:Optimizer/recommendation:Recommendation';

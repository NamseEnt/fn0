...
exports.getProfileLevelOutput = exports.getProfileLevel = void 0;
 ...
 * ```
 */
function getProfileLevel(args, opts) {
 ...
 * ```
 */
function getProfileLevelOutput(args, opts) {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
...
exports.getProfileLevelOutput = getProfileLevelOutput;
//# sourceMappingURL=getProfileLevel.js.map
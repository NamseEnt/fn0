 ...
 * ```
 */
export declare function getCategories(args: GetCategoriesArgs, opts?: pulumi.InvokeOptions): Promise<GetCategoriesResult>;
/**
 ...
 * ```
 */
export declare function getCategoriesOutput(args: GetCategoriesOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetCategoriesResult>;
/**
 * A collection of arguments for invoking getCategories.
 */

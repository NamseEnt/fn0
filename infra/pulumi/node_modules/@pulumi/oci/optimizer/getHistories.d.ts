 ...
 * ```
 */
export declare function getHistories(args: GetHistoriesArgs, opts?: pulumi.InvokeOptions): Promise<GetHistoriesResult>;
/**
 ...
 * ```
 */
export declare function getHistoriesOutput(args: GetHistoriesOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetHistoriesResult>;
/**
 * A collection of arguments for invoking getHistories.
 */

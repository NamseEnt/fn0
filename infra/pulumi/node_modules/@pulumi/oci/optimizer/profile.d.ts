...
export declare class Profile extends pulumi.CustomResource {
     ...
     */
    readonly aggregationIntervalInDays: pulumi.Output<number>;
    /**
     ...
     */
    readonly levelsConfiguration: pulumi.Output<outputs.Optimizer.ProfileLevelsConfiguration>;
    /**
     ...
     */
    readonly targetCompartments: pulumi.Output<outputs.Optimizer.ProfileTargetCompartments>;
    /**
     * (Updatable) Optional. The tags specified in the profile override for a recommendation.
     */
    readonly targetTags: pulumi.Output<outputs.Optimizer.ProfileTargetTags>;
    /**

 ...
 * ```
 */
class OccAvailabilityCatalog extends pulumi.CustomResource {
    /**
    ...
    static get(name, id, state, opts) {
        return new OccAvailabilityCatalog(name, state, { ...opts, id: id });
    }
    /**
...
exports.OccAvailabilityCatalog = OccAvailabilityCatalog;
/** @internal */
OccAvailabilityCatalog.__pulumiType = 'oci:CapacityManagement/occAvailabilityCatalog:OccAvailabilityCatalog';
//# sourceMappingURL=occAvailabilityCatalog.js.map
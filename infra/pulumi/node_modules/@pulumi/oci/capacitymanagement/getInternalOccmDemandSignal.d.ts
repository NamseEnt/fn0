 ...
 * ```
 */
export declare function getInternalOccmDemandSignal(args: GetInternalOccmDemandSignalArgs, opts?: pulumi.InvokeOptions): Promise<GetInternalOccmDemandSignalResult>;
/**
 ...
 * ```
 */
export declare function getInternalOccmDemandSignalOutput(args: GetInternalOccmDemandSignalOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetInternalOccmDemandSignalResult>;
/**
 * A collection of arguments for invoking getInternalOccmDemandSignal.
 */

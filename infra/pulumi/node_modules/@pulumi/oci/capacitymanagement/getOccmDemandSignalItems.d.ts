 ...
 * ```
 */
export declare function getOccmDemandSignalItems(args: GetOccmDemandSignalItemsArgs, opts?: pulumi.InvokeOptions): Promise<GetOccmDemandSignalItemsResult>;
/**
 ...
 * ```
 */
export declare function getOccmDemandSignalItemsOutput(args: GetOccmDemandSignalItemsOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetOccmDemandSignalItemsResult>;
/**
 * A collection of arguments for invoking getOccmDemandSignalItems.
 */

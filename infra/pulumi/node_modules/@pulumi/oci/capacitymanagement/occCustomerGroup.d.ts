 ...
 * ```
 */
export declare class OccCustomerGroup extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: OccCustomerGroupState, opts?: pulumi.CustomResourceOptions): OccCustomerGroup;
    /**
     * Returns true if the given object is an instance of OccCustomerGroup.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is OccCustomerGroup;
    /**
     ...
     */
    readonly customersLists: pulumi.Output<outputs.CapacityManagement.OccCustomerGroupCustomersList[]>;
    /**

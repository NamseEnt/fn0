 ...
 * ```
 */
export declare function getOccCustomerGroup(args: GetOccCustomerGroupArgs, opts?: pulumi.InvokeOptions): Promise<GetOccCustomerGroupResult>;
/**
 ...
 * ```
 */
export declare function getOccCustomerGroupOutput(args: GetOccCustomerGroupOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetOccCustomerGroupResult>;
/**
 * A collection of arguments for invoking getOccCustomerGroup.
 */

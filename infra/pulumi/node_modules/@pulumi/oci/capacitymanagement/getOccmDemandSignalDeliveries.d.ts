 ...
 * ```
 */
export declare function getOccmDemandSignalDeliveries(args: GetOccmDemandSignalDeliveriesArgs, opts?: pulumi.InvokeOptions): Promise<GetOccmDemandSignalDeliveriesResult>;
/**
 ...
 * ```
 */
export declare function getOccmDemandSignalDeliveriesOutput(args: GetOccmDemandSignalDeliveriesOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetOccmDemandSignalDeliveriesResult>;
/**
 * A collection of arguments for invoking getOccmDemandSignalDeliveries.
 */

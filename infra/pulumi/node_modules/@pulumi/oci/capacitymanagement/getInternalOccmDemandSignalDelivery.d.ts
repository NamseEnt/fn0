 ...
 * ```
 */
export declare function getInternalOccmDemandSignalDelivery(args: GetInternalOccmDemandSignalDeliveryArgs, opts?: pulumi.InvokeOptions): Promise<GetInternalOccmDemandSignalDeliveryResult>;
/**
 ...
 * ```
 */
export declare function getInternalOccmDemandSignalDeliveryOutput(args: GetInternalOccmDemandSignalDeliveryOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetInternalOccmDemandSignalDeliveryResult>;
/**
 * A collection of arguments for invoking getInternalOccmDemandSignalDelivery.
 */

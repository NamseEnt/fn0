 ...
 * ```
 */
export declare class OccmDemandSignal extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: OccmDemandSignalState, opts?: pulumi.CustomResourceOptions): OccmDemandSignal;
    /**
     * Returns true if the given object is an instance of OccmDemandSignal.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is OccmDemandSignal;
    /**

 ...
 * ```
 */
export declare class InternalOccmDemandSignal extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: InternalOccmDemandSignalState, opts?: pulumi.CustomResourceOptions): InternalOccmDemandSignal;
    /**
     * Returns true if the given object is an instance of InternalOccmDemandSignal.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is InternalOccmDemandSignal;
    /**
     ...
     */
    readonly occmDemandSignalId: pulumi.Output<string>;
    /**

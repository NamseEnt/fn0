 ...
 * ```
 */
export declare class OccmDemandSignalItem extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: OccmDemandSignalItemState, opts?: pulumi.CustomResourceOptions): OccmDemandSignalItem;
    /**
     * Returns true if the given object is an instance of OccmDemandSignalItem.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is OccmDemandSignalItem;
    /**
     ...
     */
    readonly demandQuantity: pulumi.Output<string>;
    /**
     * The OCID of the correponding demand signal catalog resource.
     */
    readonly demandSignalCatalogResourceId: pulumi.Output<string>;
    /**
     * The OCID of the demand signal under which we need to create this item.
     */
    readonly demandSignalId: pulumi.Output<string>;
    /**
     ...
     */
    readonly demandSignalNamespace: pulumi.Output<string>;
    /**
     ...
     */
    readonly resourceProperties: pulumi.Output<{
        [key: string]: string;
    }>;
    /**
     ...
     */
    readonly targetCompartmentId: pulumi.Output<string>;
    /**
     ...
     */
    readonly timeNeededBefore: pulumi.Output<string>;
    /**
...
export interface OccmDemandSignalItemState {
     ...
     * (Updatable) A map of various properties associated with the Oracle Cloud Infrastructure resource.
     */
    resourceProperties?: pulumi.Input<{
        [key: string]: pulumi.Input<string>;
    }>;
    /**
     * The current lifecycle state of the resource.

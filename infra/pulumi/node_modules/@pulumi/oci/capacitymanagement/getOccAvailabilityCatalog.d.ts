 ...
 * ```
 */
export declare function getOccAvailabilityCatalog(args: GetOccAvailabilityCatalogArgs, opts?: pulumi.InvokeOptions): Promise<GetOccAvailabilityCatalogResult>;
/**
 ...
 * ```
 */
export declare function getOccAvailabilityCatalogOutput(args: GetOccAvailabilityCatalogOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetOccAvailabilityCatalogResult>;
/**
 * A collection of arguments for invoking getOccAvailabilityCatalog.
 */

 ...
 * ```
 */
export declare function getOccAvailabilityCatalogs(args: GetOccAvailabilityCatalogsArgs, opts?: pulumi.InvokeOptions): Promise<GetOccAvailabilityCatalogsResult>;
/**
 ...
 * ```
 */
export declare function getOccAvailabilityCatalogsOutput(args: GetOccAvailabilityCatalogsOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetOccAvailabilityCatalogsResult>;
/**
 * A collection of arguments for invoking getOccAvailabilityCatalogs.
 */

...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/aidataplatform/ListAiDataPlatforms.ts.html |here} to see how to use ListAiDataPlatformsRequest.
 */
export interface ListAiDataPlatformsRequest extends common.BaseRequest {
    /**
...
export declare namespace ListAiDataPlatformsRequest {
    enum SortBy {

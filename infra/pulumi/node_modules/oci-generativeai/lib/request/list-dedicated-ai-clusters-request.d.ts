...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/generativeai/ListDedicatedAiClusters.ts.html |here} to see how to use ListDedicatedAiClustersRequest.
 */
export interface ListDedicatedAiClustersRequest extends common.BaseRequest {
    /**
...
export declare namespace ListDedicatedAiClustersRequest {
    enum SortBy {

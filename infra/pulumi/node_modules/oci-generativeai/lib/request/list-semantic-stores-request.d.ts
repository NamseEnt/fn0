...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/generativeai/ListSemanticStores.ts.html |here} to see how to use ListSemanticStoresRequest.
 */
export interface ListSemanticStoresRequest extends common.BaseRequest {
    /**
     ...
     */
    "lifecycleState"?: Array<ListSemanticStoresRequest.LifecycleState>;
    /**
...
export declare namespace ListSemanticStoresRequest {
    enum LifecycleState {
        Active = "ACTIVE",
        Creating = "CREATING",
        Updating = "UPDATING",

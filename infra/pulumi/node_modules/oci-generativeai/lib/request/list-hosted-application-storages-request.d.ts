...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/generativeai/ListHostedApplicationStorages.ts.html |here} to see how to use ListHostedApplicationStoragesRequest.
 */
export interface ListHostedApplicationStoragesRequest extends common.BaseRequest {
    /**
...
export declare namespace ListHostedApplicationStoragesRequest {
    enum SortBy {

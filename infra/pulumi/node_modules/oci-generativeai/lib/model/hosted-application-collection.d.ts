 ...
 */
export interface HostedApplicationCollection {
    /**
     * List of hosted applications.
     */
    "items": Array<model.HostedApplicationSummary>;
}
export declare namespace HostedApplicationCollection {
    function getJsonObj(obj: HostedApplicationCollection): object;
    function getDeserializedJsonObj(obj: HostedApplicationCollection): object;
}

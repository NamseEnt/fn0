 ...
 *
 */
export interface ChangeImportedModelCompartmentDetails {
    /**
     * The destination compartment OCID
     */
    "compartmentId": string;
}
export declare namespace ChangeImportedModelCompartmentDetails {
    function getJsonObj(obj: ChangeImportedModelCompartmentDetails): object;
    function getDeserializedJsonObj(obj: ChangeImportedModelCompartmentDetails): object;
}

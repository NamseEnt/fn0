 ...
 *
 */
export interface ChangeGenerativeAiPrivateEndpointCompartmentDetails {
    /**
...
export declare namespace ChangeGenerativeAiPrivateEndpointCompartmentDetails {
    function getJsonObj(obj: ChangeGenerativeAiPrivateEndpointCompartmentDetails): object;
    function getDeserializedJsonObj(obj: ChangeGenerativeAiPrivateEndpointCompartmentDetails): object;
}

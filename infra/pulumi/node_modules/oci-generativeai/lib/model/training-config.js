...
(function (TrainingConfig) {
        ...
        if (obj && "trainingConfigType" in obj && obj.trainingConfigType) {
            switch (obj.trainingConfigType) {
                case "LORA_TRAINING_CONFIG":
                    return model.LoraTrainingConfig.getJsonObj(jsonObj, true);
                case "VANILLA_TRAINING_CONFIG":
                    return model.VanillaTrainingConfig.getJsonObj(jsonObj, true);
                case "TFEW_TRAINING_CONFIG":
                    return model.TFewTrainingConfig.getJsonObj(jsonObj, true);
                default:
    ...
    TrainingConfig.getJsonObj = getJsonObj;
    function getDeserializedJsonObj(obj) {
        const jsonObj = Object.assign(Object.assign({}, obj), {});
        if (obj && "trainingConfigType" in obj && obj.trainingConfigType) {
            switch (obj.trainingConfigType) {
                case "LORA_TRAINING_CONFIG":
                    return model.LoraTrainingConfig.getDeserializedJsonObj(jsonObj, true);
                case "VANILLA_TRAINING_CONFIG":
                    return model.VanillaTrainingConfig.getDeserializedJsonObj(jsonObj, true);
                case "TFEW_TRAINING_CONFIG":
                    return model.TFewTrainingConfig.getDeserializedJsonObj(jsonObj, true);
                default:
                    if (common.LOG.logger)
                        common.LOG.logger.info(`Unknown value for: ${obj.trainingConfigType}`);
            }
    ...
    TrainingConfig.getDeserializedJsonObj = getDeserializedJsonObj;
})(TrainingConfig = exports.TrainingConfig || (exports.TrainingConfig = {}));

 ...
 */
export interface RenewApiKeyDetails {
    "details": model.KeyDetails;
    /**
...
export declare namespace RenewApiKeyDetails {
    function getJsonObj(obj: RenewApiKeyDetails): object;
    function getDeserializedJsonObj(obj: RenewApiKeyDetails): object;
}

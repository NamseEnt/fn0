 ...
 */
export interface CreateDataSourceDatabaseToolsConnectionDetails extends model.CreateDataSourceDetails {
    /**
...
export declare namespace CreateDataSourceDatabaseToolsConnectionDetails {
    function getJsonObj(obj: CreateDataSourceDatabaseToolsConnectionDetails, isParentJsonObj?: boolean): object;
    const connectionType = "DATABASE_TOOLS_CONNECTION";
    function getDeserializedJsonObj(obj: CreateDataSourceDatabaseToolsConnectionDetails, isParentJsonObj?: boolean): object;
}

 ...
 */
export interface SingleDockerArtifact extends model.Artifact {
    /**
     * image url.
     */
    "containerUri"?: string;
...
export declare namespace SingleDockerArtifact {
    function getJsonObj(obj: SingleDockerArtifact, isParentJsonObj?: boolean): object;
    const artifactType = "SIMPLE_DOCKER_ARTIFACT";
    function getDeserializedJsonObj(obj: SingleDockerArtifact, isParentJsonObj?: boolean): object;
}

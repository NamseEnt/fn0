 ...
 */
export interface SetApiKeyStateDetails {
    /**
...
export declare namespace SetApiKeyStateDetails {
    function getJsonObj(obj: SetApiKeyStateDetails): object;
    function getDeserializedJsonObj(obj: SetApiKeyStateDetails): object;
}

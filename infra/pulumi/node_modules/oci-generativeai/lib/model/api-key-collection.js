...
(function (ApiKeyCollection) {
    function getJsonObj(obj) {
        const jsonObj = Object.assign(Object.assign({}, obj), {
            "items": obj.items
                ? obj.items.map(item => {
                    return model.ApiKeySummary.getJsonObj(item);
                })
                : undefined
        });
        return jsonObj;
    }
    ApiKeyCollection.getJsonObj = getJsonObj;
    function getDeserializedJsonObj(obj) {
        const jsonObj = Object.assign(Object.assign({}, obj), {
            "items": obj.items
                ? obj.items.map(item => {
                    return model.ApiKeySummary.getDeserializedJsonObj(item);
                })
                : undefined
        });
        return jsonObj;
    }
    ApiKeyCollection.getDeserializedJsonObj = getDeserializedJsonObj;
})(ApiKeyCollection = exports.ApiKeyCollection || (exports.ApiKeyCollection = {}));

...
export interface InboundAuthConfig {
    ...
    "idcsConfig"?: model.IdcsAuthConfig;
}
export declare namespace InboundAuthConfig {
    enum InboundAuthConfigType {
    ...
    function getJsonObj(obj: InboundAuthConfig): object;
    function getDeserializedJsonObj(obj: InboundAuthConfig): object;
}

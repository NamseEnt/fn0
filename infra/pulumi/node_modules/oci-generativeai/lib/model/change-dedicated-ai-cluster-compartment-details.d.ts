 ...
 */
export interface ChangeDedicatedAiClusterCompartmentDetails {
    /**
     * The OCID of the compartment to move the dedicated AI cluster to.
     */
    "compartmentId": string;
}
export declare namespace ChangeDedicatedAiClusterCompartmentDetails {
    function getJsonObj(obj: ChangeDedicatedAiClusterCompartmentDetails): object;
    function getDeserializedJsonObj(obj: ChangeDedicatedAiClusterCompartmentDetails): object;
}

 ...
 */
export interface CondenserConfig extends model.ModelConfig {
    "modelConfigType": string;
}
export declare namespace CondenserConfig {
    function getJsonObj(obj: CondenserConfig, isParentJsonObj?: boolean): object;
    const modelConfigType = "CONDENSER";
    function getDeserializedJsonObj(obj: CondenserConfig, isParentJsonObj?: boolean): object;
}

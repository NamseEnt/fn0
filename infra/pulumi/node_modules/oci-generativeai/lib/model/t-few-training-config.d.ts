 ...
 */
export interface TFewTrainingConfig extends model.TrainingConfig {
    "trainingConfigType": string;
}
export declare namespace TFewTrainingConfig {
    function getJsonObj(obj: TFewTrainingConfig, isParentJsonObj?: boolean): object;
    const trainingConfigType = "TFEW_TRAINING_CONFIG";
    function getDeserializedJsonObj(obj: TFewTrainingConfig, isParentJsonObj?: boolean): object;
}

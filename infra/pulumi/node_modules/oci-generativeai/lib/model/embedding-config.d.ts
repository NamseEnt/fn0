 ...
 */
export interface EmbeddingConfig extends model.ModelConfig {
    "modelConfigType": string;
}
export declare namespace EmbeddingConfig {
    function getJsonObj(obj: EmbeddingConfig, isParentJsonObj?: boolean): object;
    const modelConfigType = "EMBEDDING";
    function getDeserializedJsonObj(obj: EmbeddingConfig, isParentJsonObj?: boolean): object;
}

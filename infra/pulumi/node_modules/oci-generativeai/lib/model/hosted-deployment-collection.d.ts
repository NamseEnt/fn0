 ...
 */
export interface HostedDeploymentCollection {
    /**
     * List of hosted deployments.
     */
    "items": Array<model.HostedDeploymentSummary>;
}
export declare namespace HostedDeploymentCollection {
    function getJsonObj(obj: HostedDeploymentCollection): object;
    function getDeserializedJsonObj(obj: HostedDeploymentCollection): object;
}

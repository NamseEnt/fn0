...
export interface NetworkingConfig {
    "inboundNetworkingConfig": model.InboundNetworkingConfig;
    "outboundNetworkingConfig": model.OutboundNetworkingConfig;
}
export declare namespace NetworkingConfig {
    function getJsonObj(obj: NetworkingConfig): object;
    function getDeserializedJsonObj(obj: NetworkingConfig): object;
}

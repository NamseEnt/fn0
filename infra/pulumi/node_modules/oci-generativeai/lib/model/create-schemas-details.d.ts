 ...
 */
export interface CreateSchemasDetails {
    "connectionType": string;
}
export declare namespace CreateSchemasDetails {
    function getJsonObj(obj: CreateSchemasDetails): object;
    function getDeserializedJsonObj(obj: CreateSchemasDetails): object;
}

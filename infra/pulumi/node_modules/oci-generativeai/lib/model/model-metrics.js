...
(function (ModelMetrics) {
        ...
        if (obj && "modelMetricsType" in obj && obj.modelMetricsType) {
            switch (obj.modelMetricsType) {
                case "TEXT_GENERATION_MODEL_METRICS":
                    return model.TextGenerationModelMetrics.getJsonObj(jsonObj, true);
                case "CHAT_MODEL_METRICS":
                    return model.ChatModelMetrics.getJsonObj(jsonObj, true);
                default:
    ...
    function getDeserializedJsonObj(obj) {
        ...
        if (obj && "modelMetricsType" in obj && obj.modelMetricsType) {
            switch (obj.modelMetricsType) {
                case "TEXT_GENERATION_MODEL_METRICS":
                    return model.TextGenerationModelMetrics.getDeserializedJsonObj(jsonObj, true);
                case "CHAT_MODEL_METRICS":
                    return model.ChatModelMetrics.getDeserializedJsonObj(jsonObj, true);
                default:
                    if (common.LOG.logger)
                        common.LOG.logger.info(`Unknown value for: ${obj.modelMetricsType}`);
            }

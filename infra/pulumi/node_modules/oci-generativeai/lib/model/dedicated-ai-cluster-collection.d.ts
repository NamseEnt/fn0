 ...
 */
export interface DedicatedAiClusterCollection {
    /**
     * List of dedicated AI clusters.
     */
    "items": Array<model.DedicatedAiClusterSummary>;
}
export declare namespace DedicatedAiClusterCollection {
    function getJsonObj(obj: DedicatedAiClusterCollection): object;
    function getDeserializedJsonObj(obj: DedicatedAiClusterCollection): object;
}

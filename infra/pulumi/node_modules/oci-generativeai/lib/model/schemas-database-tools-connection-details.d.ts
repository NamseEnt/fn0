 ...
 */
export interface SchemasDatabaseToolsConnectionDetails extends model.SchemasDetails {
    /**
...
export declare namespace SchemasDatabaseToolsConnectionDetails {
    function getJsonObj(obj: SchemasDatabaseToolsConnectionDetails, isParentJsonObj?: boolean): object;
    const connectionType = "DATABASE_TOOLS_CONNECTION";
    function getDeserializedJsonObj(obj: SchemasDatabaseToolsConnectionDetails, isParentJsonObj?: boolean): object;
}

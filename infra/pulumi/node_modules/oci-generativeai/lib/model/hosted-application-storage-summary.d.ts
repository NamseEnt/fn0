 ...
 */
export interface HostedApplicationStorageSummary {
    /**
...
export declare namespace HostedApplicationStorageSummary {
    enum StorageType {
        Cache = "CACHE",
    ...
    function getJsonObj(obj: HostedApplicationStorageSummary): object;
    function getDeserializedJsonObj(obj: HostedApplicationStorageSummary): object;
}

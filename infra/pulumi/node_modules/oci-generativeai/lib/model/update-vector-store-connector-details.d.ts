 ...
 */
export interface UpdateVectorStoreConnectorDetails {
    /**
...
export declare namespace UpdateVectorStoreConnectorDetails {
    function getJsonObj(obj: UpdateVectorStoreConnectorDetails): object;
    function getDeserializedJsonObj(obj: UpdateVectorStoreConnectorDetails): object;
}

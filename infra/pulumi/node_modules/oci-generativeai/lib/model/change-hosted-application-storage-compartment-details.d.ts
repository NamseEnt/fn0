 ...
 */
export interface ChangeHostedApplicationStorageCompartmentDetails {
    /**
     * The OCID of the compartment to move the hosted application storage to.
     */
    "compartmentId": string;
}
export declare namespace ChangeHostedApplicationStorageCompartmentDetails {
    function getJsonObj(obj: ChangeHostedApplicationStorageCompartmentDetails): object;
    function getDeserializedJsonObj(obj: ChangeHostedApplicationStorageCompartmentDetails): object;
}

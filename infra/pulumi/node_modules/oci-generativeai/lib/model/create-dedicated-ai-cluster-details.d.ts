...
export declare namespace CreateDedicatedAiClusterDetails {
    function getJsonObj(obj: CreateDedicatedAiClusterDetails): object;
    function getDeserializedJsonObj(obj: CreateDedicatedAiClusterDetails): object;
}

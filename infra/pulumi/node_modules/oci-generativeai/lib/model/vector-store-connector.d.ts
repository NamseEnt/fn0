...
export interface VectorStoreConnector {
     ...
     */
    "lifecycleState": VectorStoreConnector.LifecycleState;
    /**
...
export declare namespace VectorStoreConnector {
    enum LifecycleState {
        Active = "ACTIVE",
        Creating = "CREATING",
        Updating = "UPDATING",
    ...
    function getJsonObj(obj: VectorStoreConnector): object;
    function getDeserializedJsonObj(obj: VectorStoreConnector): object;
}

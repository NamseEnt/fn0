 ...
 */
export interface ExtractionConfig extends model.ModelConfig {
    "modelConfigType": string;
}
export declare namespace ExtractionConfig {
    function getJsonObj(obj: ExtractionConfig, isParentJsonObj?: boolean): object;
    const modelConfigType = "EXTRACTION";
    function getDeserializedJsonObj(obj: ExtractionConfig, isParentJsonObj?: boolean): object;
}

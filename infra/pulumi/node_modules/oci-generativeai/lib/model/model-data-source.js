...
(function (ModelDataSource) {
        ...
        if (obj && "sourceType" in obj && obj.sourceType) {
            switch (obj.sourceType) {
                case "OBJECT_STORAGE_OBJECT":
                    return model.ObjectStorageObject.getJsonObj(jsonObj, true);
                case "HUGGING_FACE_MODEL":
                    return model.HuggingFaceModel.getJsonObj(jsonObj, true);
                default:
    ...
    ModelDataSource.getJsonObj = getJsonObj;
    function getDeserializedJsonObj(obj) {
        const jsonObj = Object.assign(Object.assign({}, obj), {});
        if (obj && "sourceType" in obj && obj.sourceType) {
            switch (obj.sourceType) {
                case "OBJECT_STORAGE_OBJECT":
                    return model.ObjectStorageObject.getDeserializedJsonObj(jsonObj, true);
                case "HUGGING_FACE_MODEL":
                    return model.HuggingFaceModel.getDeserializedJsonObj(jsonObj, true);
                default:
                    if (common.LOG.logger)
                        common.LOG.logger.info(`Unknown value for: ${obj.sourceType}`);
            }
    ...
    ModelDataSource.getDeserializedJsonObj = getDeserializedJsonObj;
})(ModelDataSource = exports.ModelDataSource || (exports.ModelDataSource = {}));
//# sourceMappingURL=model-data-source.js.map
 ...
 */
export interface DedicatedAiClusterHostingCapacity extends model.DedicatedAiClusterCapacity {
    /**
...
export declare namespace DedicatedAiClusterHostingCapacity {
    function getJsonObj(obj: DedicatedAiClusterHostingCapacity, isParentJsonObj?: boolean): object;
    const capacityType = "HOSTING_CAPACITY";
    function getDeserializedJsonObj(obj: DedicatedAiClusterHostingCapacity, isParentJsonObj?: boolean): object;
}

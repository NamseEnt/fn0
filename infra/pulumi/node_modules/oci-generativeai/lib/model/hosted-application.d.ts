...
export declare namespace HostedApplication {
    enum LifecycleState {
        Creating = "CREATING",
        Active = "ACTIVE",
        Updating = "UPDATING",
    ...
    function getJsonObj(obj: HostedApplication): object;
    function getDeserializedJsonObj(obj: HostedApplication): object;
}

 ...
 *
 */
export interface ImportedModelCollection {
    /**
     * Represents the result of a list operation for imported models.
     */
    "items": Array<model.ImportedModelSummary>;
}
export declare namespace ImportedModelCollection {
    function getJsonObj(obj: ImportedModelCollection): object;
    function getDeserializedJsonObj(obj: ImportedModelCollection): object;
}

 ...
 */
export interface InboundNetworkingConfig {
    /**
     * inbounding from public or private endpoint.
     */
    "endpointMode": InboundNetworkingConfig.EndpointMode;
    /**
     * The [OCID] of Private Endpoint when endpointMode=Private
     */
    "privateEndpointId"?: string;
}
export declare namespace InboundNetworkingConfig {
    enum EndpointMode {
        Public = "PUBLIC",
        Private = "PRIVATE",
        /**
    ...
    function getJsonObj(obj: InboundNetworkingConfig): object;
    function getDeserializedJsonObj(obj: InboundNetworkingConfig): object;
}

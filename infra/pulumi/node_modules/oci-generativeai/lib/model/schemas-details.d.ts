 ...
 */
export interface SchemasDetails {
    "connectionType": string;
}
export declare namespace SchemasDetails {
    function getJsonObj(obj: SchemasDetails): object;
    function getDeserializedJsonObj(obj: SchemasDetails): object;
}

...
export declare namespace CreateGenerativeAiPrivateEndpointDetails {
    function getJsonObj(obj: CreateGenerativeAiPrivateEndpointDetails): object;
    function getDeserializedJsonObj(obj: CreateGenerativeAiPrivateEndpointDetails): object;
}

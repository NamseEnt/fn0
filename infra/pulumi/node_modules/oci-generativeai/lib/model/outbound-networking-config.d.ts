 ...
 */
export interface OutboundNetworkingConfig {
    /**
     * outbounding to managed internet or customer network.
     */
    "networkMode": OutboundNetworkingConfig.NetworkMode;
    /**
...
export declare namespace OutboundNetworkingConfig {
    enum NetworkMode {
        Managed = "MANAGED",
        Custom = "CUSTOM",
        /**
    ...
    function getJsonObj(obj: OutboundNetworkingConfig): object;
    function getDeserializedJsonObj(obj: OutboundNetworkingConfig): object;
}

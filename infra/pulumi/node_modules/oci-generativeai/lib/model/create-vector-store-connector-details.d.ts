 ...
 */
export interface CreateVectorStoreConnectorDetails {
    /**
...
export declare namespace CreateVectorStoreConnectorDetails {
    function getJsonObj(obj: CreateVectorStoreConnectorDetails): object;
    function getDeserializedJsonObj(obj: CreateVectorStoreConnectorDetails): object;
}

 ...
 */
export interface UpdateApiKeyDetails {
    /**
...
export declare namespace UpdateApiKeyDetails {
    function getJsonObj(obj: UpdateApiKeyDetails): object;
    function getDeserializedJsonObj(obj: UpdateApiKeyDetails): object;
}

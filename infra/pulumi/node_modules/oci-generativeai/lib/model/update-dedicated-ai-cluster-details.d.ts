...
export declare namespace UpdateDedicatedAiClusterDetails {
    function getJsonObj(obj: UpdateDedicatedAiClusterDetails): object;
    function getDeserializedJsonObj(obj: UpdateDedicatedAiClusterDetails): object;
}

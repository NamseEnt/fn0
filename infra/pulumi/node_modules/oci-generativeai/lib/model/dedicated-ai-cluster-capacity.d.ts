...
export declare namespace DedicatedAiClusterCapacity {
    function getJsonObj(obj: DedicatedAiClusterCapacity): object;
    function getDeserializedJsonObj(obj: DedicatedAiClusterCapacity): object;
}

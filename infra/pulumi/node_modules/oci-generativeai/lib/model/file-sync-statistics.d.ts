 ...
 */
export interface FileSyncStatistics {
    /**
     * The total number of files synchronized from the datasource. Note: Numbers greater than Number.MAX_SAFE_INTEGER will result in rounding issues.
     */
...
export declare namespace FileSyncStatistics {
    function getJsonObj(obj: FileSyncStatistics): object;
    function getDeserializedJsonObj(obj: FileSyncStatistics): object;
}

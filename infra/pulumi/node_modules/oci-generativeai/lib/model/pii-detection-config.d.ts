...
export declare namespace PiiDetectionConfig {
    function getJsonObj(obj: PiiDetectionConfig): object;
    function getDeserializedJsonObj(obj: PiiDetectionConfig): object;
}

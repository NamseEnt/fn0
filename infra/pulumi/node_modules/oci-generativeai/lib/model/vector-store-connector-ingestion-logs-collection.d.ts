 ...
 */
export interface VectorStoreConnectorIngestionLogsCollection {
    /**
     * List of VectorStoreConnectorIngestionLogs objects.
     */
    "items": Array<model.VectorStoreConnectorIngestionLogs>;
}
export declare namespace VectorStoreConnectorIngestionLogsCollection {
    function getJsonObj(obj: VectorStoreConnectorIngestionLogsCollection): object;
    function getDeserializedJsonObj(obj: VectorStoreConnectorIngestionLogsCollection): object;
}

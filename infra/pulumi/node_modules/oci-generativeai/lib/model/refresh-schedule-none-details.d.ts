 ...
 */
export interface RefreshScheduleNoneDetails extends model.RefreshScheduleDetails {
    "type": string;
}
export declare namespace RefreshScheduleNoneDetails {
    function getJsonObj(obj: RefreshScheduleNoneDetails, isParentJsonObj?: boolean): object;
    const type = "NONE";
    function getDeserializedJsonObj(obj: RefreshScheduleNoneDetails, isParentJsonObj?: boolean): object;
}

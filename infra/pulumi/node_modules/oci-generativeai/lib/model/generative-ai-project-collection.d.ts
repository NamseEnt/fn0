 ...
 */
export interface GenerativeAiProjectCollection {
    /**
     * List of GenerativeAiProjects.
     */
    "items": Array<model.GenerativeAiProjectSummary>;
}
export declare namespace GenerativeAiProjectCollection {
    function getJsonObj(obj: GenerativeAiProjectCollection): object;
    function getDeserializedJsonObj(obj: GenerativeAiProjectCollection): object;
}

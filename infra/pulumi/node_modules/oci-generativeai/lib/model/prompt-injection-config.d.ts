...
export declare namespace PromptInjectionConfig {
    function getJsonObj(obj: PromptInjectionConfig): object;
    function getDeserializedJsonObj(obj: PromptInjectionConfig): object;
}

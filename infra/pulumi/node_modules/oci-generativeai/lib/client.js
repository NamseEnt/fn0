...
exports.GenerativeAiClient = exports.GenerativeAiApiKeys = void 0;
const common = require("oci-common");
const model = __importStar(require("./model"));
const generativeai_waiter_1 = require("./generativeai-waiter");
const oci_common_1 = require("oci-common");
const Breaker = require("opossum");
// ===============================================
// This file is autogenerated - Please do not edit
// ===============================================
var GenerativeAiApiKeys;
(function (GenerativeAiApiKeys) {
})(GenerativeAiApiKeys = exports.GenerativeAiApiKeys || (exports.GenerativeAiApiKeys = {}));
/**
...
class GenerativeAiClient {
    constructor(params, clientConfiguration) {
        ...
        this.targetService = "GenerativeAi";
        this._regionId = "";
        ...
        if (!oci_common_1.developerToolConfiguration.isServiceEnabled("generativeai")) {
    ...
    set endpoint(endpoint) {
        ...
        if (this.logger)
            this.logger.info(`GenerativeAiClient endpoint set to ${this._endpoint}`);
    }
    get logger() {
    ...
    set useRealmSpecificEndpointTemplate(realmSpecificEndpointTemplateEnabled) {
        ...
        if (this._lastSetRegionOrRegionId === common.Region.REGION_STRING) {
            this.endpoint = common.EndpointBuilder.createEndpointFromRegion(GenerativeAiClient.serviceEndpointTemplate, this._region, GenerativeAiClient.endpointServiceName);
        }
        else if (this._lastSetRegionOrRegionId === common.Region.REGION_ID_STRING) {
            this.endpoint = common.EndpointBuilder.createEndpointFromRegionId(GenerativeAiClient.serviceEndpointTemplate, this._regionId, GenerativeAiClient.endpointServiceName);
        }
    }
    /**
    ...
    set region(region) {
        this._region = region;
        this.endpoint = common.EndpointBuilder.createEndpointFromRegion(GenerativeAiClient.serviceEndpointTemplate, region, GenerativeAiClient.endpointServiceName);
    ...
    set regionId(regionId) {
        ...
        this.endpoint = common.EndpointBuilder.createEndpointFromRegionId(GenerativeAiClient.serviceEndpointTemplate, regionId, GenerativeAiClient.endpointServiceName);
    ...
    createWaiters(config) {
        this._waiters = new generativeai_waiter_1.GenerativeAiWaiter(this, config);
    ...
    addArtifact(addArtifactRequest) {
        return __awaiter(this, void 0, void 0, function* () {
            if (this.logger)
                this.logger.debug("Calling operation GenerativeAiClient#addArtifact.");
            ...
            const retrier = oci_common_1.GenericRetrier.createPreferredRetrier(this._clientConfiguration ? this._clientConfiguration.retryConfiguration : undefined, addArtifactRequest.retryConfiguration, specRetryConfiguration);
            if (this.logger)
            ...
            const request = yield oci_common_1.composeRequest({
                ...
                method: "POST",
                bodyContent: common.ObjectSerializer.serialize(addArtifactRequest.addArtifactDetails, "AddArtifactDetails", model.AddArtifactDetails.getJsonObj),
     ...
     */
    cancelVectorStoreConnectorFileSync(cancelVectorStoreConnectorFileSyncRequest) {
        return __awaiter(this, void 0, void 0, function* () {
            if (this.logger)
            ...
            const apiReferenceLink = "";
            const pathParams = {
                "{vectorStoreConnectorFileSyncId}": cancelVectorStoreConnectorFileSyncRequest.vectorStoreConnectorFileSyncId
            };
            const queryParams = {};
            let headerParams = {
                "Content-Type": common.Constants.APPLICATION_JSON,
            ...
            const specRetryConfiguration = common.OciSdkDefaultRetryConfiguration;
            const retrier = oci_common_1.GenericRetrier.createPreferredRetrier(this._clientConfiguration ? this._clientConfiguration.retryConfiguration : undefined, cancelVectorStoreConnectorFileSyncRequest.retryConfiguration, specRetryConfiguration);
            if (this.logger)
                retrier.logger = this.logger;
            const request = yield oci_common_1.composeRequest({
                baseEndpoint: this._endpoint,
     ...
     */
    changeApiKeyCompartment(changeApiKeyCompartmentRequest) {
        return __awaiter(this, void 0, void 0, function* () {
            if (this.logger)
            ...
            const specRetryConfiguration = common.OciSdkDefaultRetryConfiguration;
            const retrier = oci_common_1.GenericRetrier.createPreferredRetrier(this._clientConfiguration ? this._clientConfiguration.retryConfiguration : undefined, changeApiKeyCompartmentRequest.retryConfiguration, specRetryConfiguration);
            if (this.logger)
                retrier.logger = this.logger;
            const request = yield oci_common_1.composeRequest({
                baseEndpoint: this._endpoint,
                ...
                method: "POST",
                bodyContent: common.ObjectSerializer.serialize(changeApiKeyCompartmentRequest.changeApiKeyCompartmentDetails, "ChangeApiKeyCompartmentDetails", model.ChangeApiKeyCompartmentDetails.getJsonObj),
                pathParams: pathParams,
                headerParams: headerParams,
                queryParams: queryParams
            });
     ...
     */
    changeDedicatedAiClusterCompartment(changeDedicatedAiClusterCompartmentRequest) {
        return __awaiter(this, void 0, void 0, function* () {
            if (this.logger)
                this.logger.debug("Calling operation GenerativeAiClient#changeDedicatedAiClusterCompartment.");
            ...
            const specRetryConfiguration = common.OciSdkDefaultRetryConfiguration;
            const retrier = oci_common_1.GenericRetrier.createPreferredRetrier(this._clientConfiguration ? this._clientConfiguration.retryConfiguration : undefined, changeDedicatedAiClusterCompartmentRequest.retryConfiguration, specRetryConfiguration);
            if (this.logger)
                retrier.logger = this.logger;
            const request = yield oci_common_1.composeRequest({
                baseEndpoint: this._endpoint,
                ...
                method: "POST",
                bodyContent: common.ObjectSerializer.serialize(changeDedicatedAiClusterCompartmentRequest.changeDedicatedAiClusterCompartmentDetails, "ChangeDedicatedAiClusterCompartmentDetails", model.ChangeDedicatedAiClusterCompartmentDetails.getJsonObj),
                pathParams: pathParams,
                headerParams: headerParams,
                queryParams: queryParams
            });
    ...
    changeGenerativeAiPrivateEndpointCompartment(changeGenerativeAiPrivateEndpointCompartmentRequest) {
        return __awaiter(this, void 0, void 0, function* () {
            if (this.logger)
                this.logger.debug("Calling operation GenerativeAiClient#changeGenerativeAiPrivateEndpointCompartment.");
            const operationName = "changeGenerativeAiPrivateEndpointCompartment";
            const apiReferenceLink = "";
            const pathParams = {
                "{generativeAiPrivateEndpointId}": changeGenerativeAiPrivateEndpointCompartmentRequest.generativeAiPrivateEndpointId
            };
            const queryParams = {};
            let headerParams = {
                "Content-Type": common.Constants.APPLICATION_JSON,
            ...
            const specRetryConfiguration = common.OciSdkDefaultRetryConfiguration;
            const retrier = oci_common_1.GenericRetrier.createPreferredRetrier(this._clientConfiguration ? this._clientConfiguration.retryConfiguration : undefined, changeGenerativeAiPrivateEndpointCompartmentRequest.retryConfiguration, specRetryConfiguration);
            if (this.logger)
                retrier.logger = this.logger;
            const request = yield oci_common_1.composeRequest({
                baseEndpoint: this._endpoint,
                defaultHeaders: this._defaultHeaders,
                path: "/generativeAiPrivateEndpoints/{generativeAiPrivateEndpointId}/actions/changeCompartment",
                method: "POST",
                bodyContent: common.ObjectSerializer.serialize(changeGenerativeAiPrivateEndpointCompartmentRequest.changeGenerativeAiPrivateEndpointCompartmentDetails, "ChangeGenerativeAiPrivateEndpointCompartmentDetails", model.ChangeGenerativeAiPrivateEndpointCompartmentDetails.getJsonObj),
                pathParams: pathParams,
                headerParams: headerParams,
                queryParams: queryParams
            });
     ...
     */
    changeGenerativeAiProjectCompartment(changeGenerativeAiProjectCompartmentRequest) {
        return __awaiter(this, void 0, void 0, function* () {
            if (this.logger)
                this.logger.debug("Calling operation GenerativeAiClient#changeGenerativeAiProjectCompartment.");
            ...
            const specRetryConfiguration = common.OciSdkDefaultRetryConfiguration;
            const retrier = oci_common_1.GenericRetrier.createPreferredRetrier(this._clientConfiguration ? this._clientConfiguration.retryConfiguration : undefined, changeGenerativeAiProjectCompartmentRequest.retryConfiguration, specRetryConfiguration);
            if (this.logger)
                retrier.logger = this.logger;
            const request = yield oci_common_1.composeRequest({
                baseEndpoint: this._endpoint,
                ...
                method: "POST",
                bodyContent: common.ObjectSerializer.serialize(changeGenerativeAiProjectCompartmentRequest.changeGenerativeAiProjectCompartmentDetails, "ChangeGenerativeAiProjectCompartmentDetails", model.ChangeGenerativeAiProjectCompartmentDetails.getJsonObj),
                pathParams: pathParams,
                headerParams: headerParams,
                queryParams: queryParams
            });
    ...
    changeHostedApplicationCompartment(changeHostedApplicationCompartmentRequest) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const specRetryConfiguration = common.OciSdkDefaultRetryConfiguration;
            const retrier = oci_common_1.GenericRetrier.createPreferredRetrier(this._clientConfiguration ? this._clientConfiguration.retryConfiguration : undefined, changeHostedApplicationCompartmentRequest.retryConfiguration, specRetryConfiguration);
            if (this.logger)
                retrier.logger = this.logger;
            const request = yield oci_common_1.composeRequest({
                baseEndpoint: this._endpoint,
                ...
                method: "POST",
                bodyContent: common.ObjectSerializer.serialize(changeHostedApplicationCompartmentRequest.changeHostedApplicationCompartmentDetails, "ChangeHostedApplicationCompartmentDetails", model.ChangeHostedApplicationCompartmentDetails.getJsonObj),
                pathParams: pathParams,
                headerParams: headerParams,
                queryParams: queryParams
            });
     ...
     */
    changeHostedApplicationStorageCompartment(changeHostedApplicationStorageCompartmentRequest) {
        return __awaiter(this, void 0, void 0, function* () {
            if (this.logger)
                this.logger.debug("Calling operation GenerativeAiClient#changeHostedApplicationStorageCompartment.");
            const operationName = "changeHostedApplicationStorageCompartment";
            const apiReferenceLink = "";
            const pathParams = {
                "{hostedApplicationStorageId}": changeHostedApplicationStorageCompartmentRequest.hostedApplicationStorageId
            };
            const queryParams = {};
            let headerParams = {
                "Content-Type": common.Constants.APPLICATION_JSON,
            ...
            const specRetryConfiguration = common.OciSdkDefaultRetryConfiguration;
            const retrier = oci_common_1.GenericRetrier.createPreferredRetrier(this._clientConfiguration ? this._clientConfiguration.retryConfiguration : undefined, changeHostedApplicationStorageCompartmentRequest.retryConfiguration, specRetryConfiguration);
            if (this.logger)
                retrier.logger = this.logger;
            const request = yield oci_common_1.composeRequest({
                baseEndpoint: this._endpoint,
                ...
                method: "POST",
                bodyContent: common.ObjectSerializer.serialize(changeHostedApplicationStorageCompartmentRequest.changeHostedApplicationStorageCompartmentDetails, "ChangeHostedApplicationStorageCompartmentDetails", model.ChangeHostedApplicationStorageCompartmentDetails.getJsonObj),
                pathParams: pathParams,
                headerParams: headerParams,
                queryParams: queryParams
            });
     ...
     */
    changeImportedModelCompartment(changeImportedModelCompartmentRequest) {
        return __awaiter(this, void 0, void 0, function* () {
            if (this.logger)
            ...
            const specRetryConfiguration = common.OciSdkDefaultRetryConfiguration;
            const retrier = oci_common_1.GenericRetrier.createPreferredRetrier(this._clientConfiguration ? this._clientConfiguration.retryConfiguration : undefined, changeImportedModelCompartmentRequest.retryConfiguration, specRetryConfiguration);
            if (this.logger)
                retrier.logger = this.logger;
            const request = yield oci_common_1.composeRequest({
                baseEndpoint: this._endpoint,
                ...
                method: "POST",
                bodyContent: common.ObjectSerializer.serialize(changeImportedModelCompartmentRequest.changeImportedModelCompartmentDetails, "ChangeImportedModelCompartmentDetails", model.ChangeImportedModelCompartmentDetails.getJsonObj),
                pathParams: pathParams,
                headerParams: headerParams,
                queryParams: queryParams
            });
    ...
    changeSemanticStoreCompartment(changeSemanticStoreCompartmentRequest) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const specRetryConfiguration = common.OciSdkDefaultRetryConfiguration;
            const retrier = oci_common_1.GenericRetrier.createPreferredRetrier(this._clientConfiguration ? this._clientConfiguration.retryConfiguration : undefined, changeSemanticStoreCompartmentRequest.retryConfiguration, specRetryConfiguration);
            if (this.logger)
                retrier.logger = this.logger;
            const request = yield oci_common_1.composeRequest({
                baseEndpoint: this._endpoint,
                ...
                method: "POST",
                bodyContent: common.ObjectSerializer.serialize(changeSemanticStoreCompartmentRequest.changeSemanticStoreCompartmentDetails, "ChangeSemanticStoreCompartmentDetails", model.ChangeSemanticStoreCompartmentDetails.getJsonObj),
                pathParams: pathParams,
                headerParams: headerParams,
                queryParams: queryParams
            });
    ...
    createApiKey(createApiKeyRequest) {
        return __awaiter(this, void 0, void 0, function* () {
            if (this.logger)
                this.logger.debug("Calling operation GenerativeAiClient#createApiKey.");
            ...
            const request = yield oci_common_1.composeRequest({
                ...
                path: "/apikeys",
                method: "POST",
                bodyContent: common.ObjectSerializer.serialize(createApiKeyRequest.createApiKeyDetails, "CreateApiKeyDetails", model.CreateApiKeyDetails.getJsonObj),
                pathParams: pathParams,
                headerParams: headerParams,
                queryParams: queryParams
            });
     ...
     */
    createDedicatedAiCluster(createDedicatedAiClusterRequest) {
        return __awaiter(this, void 0, void 0, function* () {
            if (this.logger)
            ...
            const specRetryConfiguration = common.OciSdkDefaultRetryConfiguration;
            const retrier = oci_common_1.GenericRetrier.createPreferredRetrier(this._clientConfiguration ? this._clientConfiguration.retryConfiguration : undefined, createDedicatedAiClusterRequest.retryConfiguration, specRetryConfiguration);
            if (this.logger)
                retrier.logger = this.logger;
            const request = yield oci_common_1.composeRequest({
                baseEndpoint: this._endpoint,
                ...
                method: "POST",
                bodyContent: common.ObjectSerializer.serialize(createDedicatedAiClusterRequest.createDedicatedAiClusterDetails, "CreateDedicatedAiClusterDetails", model.CreateDedicatedAiClusterDetails.getJsonObj),
                pathParams: pathParams,
                headerParams: headerParams,
                queryParams: queryParams
            });
  ...
  *
    ...
    createEndpoint(createEndpointRequest) {
        return __awaiter(this, void 0, void 0, function* () {
            if (this.logger)
                this.logger.debug("Calling operation GenerativeAiClient#createEndpoint.");
     ...
     */
    createGenerativeAiPrivateEndpoint(createGenerativeAiPrivateEndpointRequest) {
        return __awaiter(this, void 0, void 0, function* () {
            if (this.logger)
            ...
            const specRetryConfiguration = common.OciSdkDefaultRetryConfiguration;
            const retrier = oci_common_1.GenericRetrier.createPreferredRetrier(this._clientConfiguration ? this._clientConfiguration.retryConfiguration : undefined, createGenerativeAiPrivateEndpointRequest.retryConfiguration, specRetryConfiguration);
            if (this.logger)
                retrier.logger = this.logger;
            const request = yield oci_common_1.composeRequest({
                baseEndpoint: this._endpoint,
                ...
                method: "POST",
                bodyContent: common.ObjectSerializer.serialize(createGenerativeAiPrivateEndpointRequest.createGenerativeAiPrivateEndpointDetails, "CreateGenerativeAiPrivateEndpointDetails", model.CreateGenerativeAiPrivateEndpointDetails.getJsonObj),
                pathParams: pathParams,
                headerParams: headerParams,
                queryParams: queryParams
            });
     ...
     */
    createGenerativeAiProject(createGenerativeAiProjectRequest) {
        return __awaiter(this, void 0, void 0, function* () {
            if (this.logger)
            ...
            const specRetryConfiguration = common.OciSdkDefaultRetryConfiguration;
            const retrier = oci_common_1.GenericRetrier.createPreferredRetrier(this._clientConfiguration ? this._clientConfiguration.retryConfiguration : undefined, createGenerativeAiProjectRequest.retryConfiguration, specRetryConfiguration);
            if (this.logger)
                retrier.logger = this.logger;
            const request = yield oci_common_1.composeRequest({
                baseEndpoint: this._endpoint,
                ...
                method: "POST",
                bodyContent: common.ObjectSerializer.serialize(createGenerativeAiProjectRequest.createGenerativeAiProjectDetails, "CreateGenerativeAiProjectDetails", model.CreateGenerativeAiProjectDetails.getJsonObj),
                pathParams: pathParams,
                headerParams: headerParams,
                queryParams: queryParams
            });
     ...
     */
    createHostedApplication(createHostedApplicationRequest) {
        return __awaiter(this, void 0, void 0, function* () {
            if (this.logger)
            ...
            const specRetryConfiguration = common.OciSdkDefaultRetryConfiguration;
            const retrier = oci_common_1.GenericRetrier.createPreferredRetrier(this._clientConfiguration ? this._clientConfiguration.retryConfiguration : undefined, createHostedApplicationRequest.retryConfiguration, specRetryConfiguration);
            if (this.logger)
                retrier.logger = this.logger;
            const request = yield oci_common_1.composeRequest({
                baseEndpoint: this._endpoint,
                ...
                method: "POST",
                bodyContent: common.ObjectSerializer.serialize(createHostedApplicationRequest.createHostedApplicationDetails, "CreateHostedApplicationDetails", model.CreateHostedApplicationDetails.getJsonObj),
                pathParams: pathParams,
                headerParams: headerParams,
                queryParams: queryParams
            });
     ...
     */
    createHostedApplicationStorage(createHostedApplicationStorageRequest) {
        return __awaiter(this, void 0, void 0, function* () {
            if (this.logger)
            ...
            const specRetryConfiguration = common.OciSdkDefaultRetryConfiguration;
            const retrier = oci_common_1.GenericRetrier.createPreferredRetrier(this._clientConfiguration ? this._clientConfiguration.retryConfiguration : undefined, createHostedApplicationStorageRequest.retryConfiguration, specRetryConfiguration);
            if (this.logger)
                retrier.logger = this.logger;
            const request = yield oci_common_1.composeRequest({
                baseEndpoint: this._endpoint,
                ...
                method: "POST",
                bodyContent: common.ObjectSerializer.serialize(createHostedApplicationStorageRequest.createHostedApplicationStorageDetails, "CreateHostedApplicationStorageDetails", model.CreateHostedApplicationStorageDetails.getJsonObj),
                pathParams: pathParams,
                headerParams: headerParams,
                queryParams: queryParams
            });
     ...
     */
    createHostedDeployment(createHostedDeploymentRequest) {
        return __awaiter(this, void 0, void 0, function* () {
            if (this.logger)
            ...
            const specRetryConfiguration = common.OciSdkDefaultRetryConfiguration;
            const retrier = oci_common_1.GenericRetrier.createPreferredRetrier(this._clientConfiguration ? this._clientConfiguration.retryConfiguration : undefined, createHostedDeploymentRequest.retryConfiguration, specRetryConfiguration);
            if (this.logger)
                retrier.logger = this.logger;
            const request = yield oci_common_1.composeRequest({
                baseEndpoint: this._endpoint,
                ...
                method: "POST",
                bodyContent: common.ObjectSerializer.serialize(createHostedDeploymentRequest.createHostedDeploymentDetails, "CreateHostedDeploymentDetails", model.CreateHostedDeploymentDetails.getJsonObj),
                pathParams: pathParams,
                headerParams: headerParams,
                queryParams: queryParams
            });
  ...
  *
       ...
       */
    createImportedModel(createImportedModelRequest) {
        return __awaiter(this, void 0, void 0, function* () {
            if (this.logger)
                this.logger.debug("Calling operation GenerativeAiClient#createImportedModel.");
            ...
            const specRetryConfiguration = common.OciSdkDefaultRetryConfiguration;
            const retrier = oci_common_1.GenericRetrier.createPreferredRetrier(this._clientConfiguration ? this._clientConfiguration.retryConfiguration : undefined, createImportedModelRequest.retryConfiguration, specRetryConfiguration);
            if (this.logger)
                retrier.logger = this.logger;
            const request = yield oci_common_1.composeRequest({
                baseEndpoint: this._endpoint,
                ...
                path: "/importedModels",
                method: "POST",
                bodyContent: common.ObjectSerializer.serialize(createImportedModelRequest.createImportedModelDetails, "CreateImportedModelDetails", model.CreateImportedModelDetails.getJsonObj),
                pathParams: pathParams,
                headerParams: headerParams,
                queryParams: queryParams
            });
  ...
  *
    ...
    createModel(createModelRequest) {
        return __awaiter(this, void 0, void 0, function* () {
            if (this.logger)
                this.logger.debug("Calling operation GenerativeAiClient#createModel.");
    ...
    createSemanticStore(createSemanticStoreRequest) {
        return __awaiter(this, void 0, void 0, function* () {
            if (this.logger)
                this.logger.debug("Calling operation GenerativeAiClient#createSemanticStore.");
            ...
            const specRetryConfiguration = common.OciSdkDefaultRetryConfiguration;
            const retrier = oci_common_1.GenericRetrier.createPreferredRetrier(this._clientConfiguration ? this._clientConfiguration.retryConfiguration : undefined, createSemanticStoreRequest.retryConfiguration, specRetryConfiguration);
            if (this.logger)
                retrier.logger = this.logger;
            const request = yield oci_common_1.composeRequest({
                baseEndpoint: this._endpoint,
                ...
                path: "/semanticStores",
                method: "POST",
                bodyContent: common.ObjectSerializer.serialize(createSemanticStoreRequest.createSemanticStoreDetails, "CreateSemanticStoreDetails", model.CreateSemanticStoreDetails.getJsonObj),
                pathParams: pathParams,
                headerParams: headerParams,
                queryParams: queryParams
            });
     ...
     */
    createVectorStoreConnector(createVectorStoreConnectorRequest) {
        return __awaiter(this, void 0, void 0, function* () {
            if (this.logger)
            ...
            const specRetryConfiguration = common.OciSdkDefaultRetryConfiguration;
            const retrier = oci_common_1.GenericRetrier.createPreferredRetrier(this._clientConfiguration ? this._clientConfiguration.retryConfiguration : undefined, createVectorStoreConnectorRequest.retryConfiguration, specRetryConfiguration);
            if (this.logger)
                retrier.logger = this.logger;
            const request = yield oci_common_1.composeRequest({
                baseEndpoint: this._endpoint,
                ...
                method: "POST",
                bodyContent: common.ObjectSerializer.serialize(createVectorStoreConnectorRequest.createVectorStoreConnectorDetails, "CreateVectorStoreConnectorDetails", model.CreateVectorStoreConnectorDetails.getJsonObj),
                pathParams: pathParams,
                headerParams: headerParams,
                queryParams: queryParams
            });
     ...
     */
    createVectorStoreConnectorFileSync(createVectorStoreConnectorFileSyncRequest) {
        return __awaiter(this, void 0, void 0, function* () {
            if (this.logger)
            ...
            const specRetryConfiguration = common.OciSdkDefaultRetryConfiguration;
            const retrier = oci_common_1.GenericRetrier.createPreferredRetrier(this._clientConfiguration ? this._clientConfiguration.retryConfiguration : undefined, createVectorStoreConnectorFileSyncRequest.retryConfiguration, specRetryConfiguration);
            if (this.logger)
                retrier.logger = this.logger;
            const request = yield oci_common_1.composeRequest({
                baseEndpoint: this._endpoint,
                ...
                method: "POST",
                bodyContent: common.ObjectSerializer.serialize(createVectorStoreConnectorFileSyncRequest.createVectorStoreConnectorFileSyncDetails, "CreateVectorStoreConnectorFileSyncDetails", model.CreateVectorStoreConnectorFileSyncDetails.getJsonObj),
                pathParams: pathParams,
                headerParams: headerParams,
                queryParams: queryParams
            });
    ...
    deleteApiKey(deleteApiKeyRequest) {
        return __awaiter(this, void 0, void 0, function* () {
            if (this.logger)
                this.logger.debug("Calling operation GenerativeAiClient#deleteApiKey.");
  ...
  *
       ...
       */
    deleteDedicatedAiCluster(deleteDedicatedAiClusterRequest) {
        return __awaiter(this, void 0, void 0, function* () {
            if (this.logger)
            ...
            const specRetryConfiguration = common.OciSdkDefaultRetryConfiguration;
            const retrier = oci_common_1.GenericRetrier.createPreferredRetrier(this._clientConfiguration ? this._clientConfiguration.retryConfiguration : undefined, deleteDedicatedAiClusterRequest.retryConfiguration, specRetryConfiguration);
            if (this.logger)
                retrier.logger = this.logger;
            const request = yield oci_common_1.composeRequest({
                baseEndpoint: this._endpoint,
    ...
    deleteEndpoint(deleteEndpointRequest) {
        return __awaiter(this, void 0, void 0, function* () {
            if (this.logger)
                this.logger.debug("Calling operation GenerativeAiClient#deleteEndpoint.");
     ...
     */
    deleteGenerativeAiPrivateEndpoint(deleteGenerativeAiPrivateEndpointRequest) {
        return __awaiter(this, void 0, void 0, function* () {
            if (this.logger)
            ...
            const apiReferenceLink = "";
            const pathParams = {
                "{generativeAiPrivateEndpointId}": deleteGenerativeAiPrivateEndpointRequest.generativeAiPrivateEndpointId
            };
            const queryParams = {};
            let headerParams = {
                "Content-Type": common.Constants.APPLICATION_JSON,
            ...
            const specRetryConfiguration = common.OciSdkDefaultRetryConfiguration;
            const retrier = oci_common_1.GenericRetrier.createPreferredRetrier(this._clientConfiguration ? this._clientConfiguration.retryConfiguration : undefined, deleteGenerativeAiPrivateEndpointRequest.retryConfiguration, specRetryConfiguration);
            if (this.logger)
                retrier.logger = this.logger;
            const request = yield oci_common_1.composeRequest({
                baseEndpoint: this._endpoint,
     ...
     */
    deleteGenerativeAiProject(deleteGenerativeAiProjectRequest) {
        return __awaiter(this, void 0, void 0, function* () {
            if (this.logger)
            ...
            const specRetryConfiguration = common.OciSdkDefaultRetryConfiguration;
            const retrier = oci_common_1.GenericRetrier.createPreferredRetrier(this._clientConfiguration ? this._clientConfiguration.retryConfiguration : undefined, deleteGenerativeAiProjectRequest.retryConfiguration, specRetryConfiguration);
            if (this.logger)
                retrier.logger = this.logger;
            const request = yield oci_common_1.composeRequest({
                baseEndpoint: this._endpoint,
    ...
    deleteHostedApplication(deleteHostedApplicationRequest) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const specRetryConfiguration = common.OciSdkDefaultRetryConfiguration;
            const retrier = oci_common_1.GenericRetrier.createPreferredRetrier(this._clientConfiguration ? this._clientConfiguration.retryConfiguration : undefined, deleteHostedApplicationRequest.retryConfiguration, specRetryConfiguration);
            if (this.logger)
                retrier.logger = this.logger;
            const request = yield oci_common_1.composeRequest({
                baseEndpoint: this._endpoint,
     ...
     */
    deleteHostedApplicationStorage(deleteHostedApplicationStorageRequest) {
        return __awaiter(this, void 0, void 0, function* () {
            if (this.logger)
            ...
            const apiReferenceLink = "";
            const pathParams = {
                "{hostedApplicationStorageId}": deleteHostedApplicationStorageRequest.hostedApplicationStorageId
            };
            const queryParams = {};
            let headerParams = {
                "Content-Type": common.Constants.APPLICATION_JSON,
            ...
            const specRetryConfiguration = common.OciSdkDefaultRetryConfiguration;
            const retrier = oci_common_1.GenericRetrier.createPreferredRetrier(this._clientConfiguration ? this._clientConfiguration.retryConfiguration : undefined, deleteHostedApplicationStorageRequest.retryConfiguration, specRetryConfiguration);
            if (this.logger)
                retrier.logger = this.logger;
            const request = yield oci_common_1.composeRequest({
                baseEndpoint: this._endpoint,
    ...
    deleteHostedDeployment(deleteHostedDeploymentRequest) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const specRetryConfiguration = common.OciSdkDefaultRetryConfiguration;
            const retrier = oci_common_1.GenericRetrier.createPreferredRetrier(this._clientConfiguration ? this._clientConfiguration.retryConfiguration : undefined, deleteHostedDeploymentRequest.retryConfiguration, specRetryConfiguration);
            if (this.logger)
                retrier.logger = this.logger;
            const request = yield oci_common_1.composeRequest({
                baseEndpoint: this._endpoint,
     ...
     */
    deleteHostedDeploymentArtifact(deleteHostedDeploymentArtifactRequest) {
        return __awaiter(this, void 0, void 0, function* () {
            if (this.logger)
            ...
            const specRetryConfiguration = common.OciSdkDefaultRetryConfiguration;
            const retrier = oci_common_1.GenericRetrier.createPreferredRetrier(this._clientConfiguration ? this._clientConfiguration.retryConfiguration : undefined, deleteHostedDeploymentArtifactRequest.retryConfiguration, specRetryConfiguration);
            if (this.logger)
                retrier.logger = this.logger;
            const request = yield oci_common_1.composeRequest({
                baseEndpoint: this._endpoint,
    ...
    deleteImportedModel(deleteImportedModelRequest) {
        return __awaiter(this, void 0, void 0, function* () {
            if (this.logger)
                this.logger.debug("Calling operation GenerativeAiClient#deleteImportedModel.");
            ...
            const specRetryConfiguration = common.OciSdkDefaultRetryConfiguration;
            const retrier = oci_common_1.GenericRetrier.createPreferredRetrier(this._clientConfiguration ? this._clientConfiguration.retryConfiguration : undefined, deleteImportedModelRequest.retryConfiguration, specRetryConfiguration);
            if (this.logger)
                retrier.logger = this.logger;
            const request = yield oci_common_1.composeRequest({
                baseEndpoint: this._endpoint,
    ...
    deleteModel(deleteModelRequest) {
        return __awaiter(this, void 0, void 0, function* () {
            if (this.logger)
                this.logger.debug("Calling operation GenerativeAiClient#deleteModel.");
     ...
     */
    deleteSemanticStore(deleteSemanticStoreRequest) {
        return __awaiter(this, void 0, void 0, function* () {
            if (this.logger)
                this.logger.debug("Calling operation GenerativeAiClient#deleteSemanticStore.");
            ...
            const specRetryConfiguration = common.OciSdkDefaultRetryConfiguration;
            const retrier = oci_common_1.GenericRetrier.createPreferredRetrier(this._clientConfiguration ? this._clientConfiguration.retryConfiguration : undefined, deleteSemanticStoreRequest.retryConfiguration, specRetryConfiguration);
            if (this.logger)
                retrier.logger = this.logger;
            const request = yield oci_common_1.composeRequest({
                baseEndpoint: this._endpoint,
     ...
     */
    deleteVectorStoreConnector(deleteVectorStoreConnectorRequest) {
        return __awaiter(this, void 0, void 0, function* () {
            if (this.logger)
            ...
            const specRetryConfiguration = common.OciSdkDefaultRetryConfiguration;
            const retrier = oci_common_1.GenericRetrier.createPreferredRetrier(this._clientConfiguration ? this._clientConfiguration.retryConfiguration : undefined, deleteVectorStoreConnectorRequest.retryConfiguration, specRetryConfiguration);
            if (this.logger)
                retrier.logger = this.logger;
            const request = yield oci_common_1.composeRequest({
                baseEndpoint: this._endpoint,
    ...
    getApiKey(getApiKeyRequest) {
        return __awaiter(this, void 0, void 0, function* () {
            if (this.logger)
                this.logger.debug("Calling operation GenerativeAiClient#getApiKey.");
     ...
     */
    getDedicatedAiCluster(getDedicatedAiClusterRequest) {
        return __awaiter(this, void 0, void 0, function* () {
            if (this.logger)
            ...
            const specRetryConfiguration = common.OciSdkDefaultRetryConfiguration;
            const retrier = oci_common_1.GenericRetrier.createPreferredRetrier(this._clientConfiguration ? this._clientConfiguration.retryConfiguration : undefined, getDedicatedAiClusterRequest.retryConfiguration, specRetryConfiguration);
            if (this.logger)
                retrier.logger = this.logger;
            const request = yield oci_common_1.composeRequest({
                baseEndpoint: this._endpoint,
    ...
    getEndpoint(getEndpointRequest) {
        return __awaiter(this, void 0, void 0, function* () {
            if (this.logger)
                this.logger.debug("Calling operation GenerativeAiClient#getEndpoint.");
     ...
     */
    getGenerativeAiPrivateEndpoint(getGenerativeAiPrivateEndpointRequest) {
        return __awaiter(this, void 0, void 0, function* () {
            if (this.logger)
            ...
            const apiReferenceLink = "";
            const pathParams = {
                "{generativeAiPrivateEndpointId}": getGenerativeAiPrivateEndpointRequest.generativeAiPrivateEndpointId
            };
            const queryParams = {};
            let headerParams = {
                "Content-Type": common.Constants.APPLICATION_JSON,
            ...
            const specRetryConfiguration = common.OciSdkDefaultRetryConfiguration;
            const retrier = oci_common_1.GenericRetrier.createPreferredRetrier(this._clientConfiguration ? this._clientConfiguration.retryConfiguration : undefined, getGenerativeAiPrivateEndpointRequest.retryConfiguration, specRetryConfiguration);
            if (this.logger)
                retrier.logger = this.logger;
            const request = yield oci_common_1.composeRequest({
                baseEndpoint: this._endpoint,
     ...
     */
    getGenerativeAiProject(getGenerativeAiProjectRequest) {
        return __awaiter(this, void 0, void 0, function* () {
            if (this.logger)
            ...
            const specRetryConfiguration = common.OciSdkDefaultRetryConfiguration;
            const retrier = oci_common_1.GenericRetrier.createPreferredRetrier(this._clientConfiguration ? this._clientConfiguration.retryConfiguration : undefined, getGenerativeAiProjectRequest.retryConfiguration, specRetryConfiguration);
            if (this.logger)
                retrier.logger = this.logger;
            const request = yield oci_common_1.composeRequest({
                baseEndpoint: this._endpoint,
     ...
     */
    getHostedApplication(getHostedApplicationRequest) {
        return __awaiter(this, void 0, void 0, function* () {
            if (this.logger)
            ...
            const specRetryConfiguration = common.OciSdkDefaultRetryConfiguration;
            const retrier = oci_common_1.GenericRetrier.createPreferredRetrier(this._clientConfiguration ? this._clientConfiguration.retryConfiguration : undefined, getHostedApplicationRequest.retryConfiguration, specRetryConfiguration);
            if (this.logger)
                retrier.logger = this.logger;
            const request = yield oci_common_1.composeRequest({
                baseEndpoint: this._endpoint,
     ...
     */
    getHostedApplicationStorage(getHostedApplicationStorageRequest) {
        return __awaiter(this, void 0, void 0, function* () {
            if (this.logger)
            ...
            const specRetryConfiguration = common.OciSdkDefaultRetryConfiguration;
            const retrier = oci_common_1.GenericRetrier.createPreferredRetrier(this._clientConfiguration ? this._clientConfiguration.retryConfiguration : undefined, getHostedApplicationStorageRequest.retryConfiguration, specRetryConfiguration);
            if (this.logger)
                retrier.logger = this.logger;
            const request = yield oci_common_1.composeRequest({
                baseEndpoint: this._endpoint,
     ...
     */
    getHostedDeployment(getHostedDeploymentRequest) {
        return __awaiter(this, void 0, void 0, function* () {
            if (this.logger)
                this.logger.debug("Calling operation GenerativeAiClient#getHostedDeployment.");
            ...
            const specRetryConfiguration = common.OciSdkDefaultRetryConfiguration;
            const retrier = oci_common_1.GenericRetrier.createPreferredRetrier(this._clientConfiguration ? this._clientConfiguration.retryConfiguration : undefined, getHostedDeploymentRequest.retryConfiguration, specRetryConfiguration);
            if (this.logger)
                retrier.logger = this.logger;
            const request = yield oci_common_1.composeRequest({
                baseEndpoint: this._endpoint,
    ...
    getImportedModel(getImportedModelRequest) {
        return __awaiter(this, void 0, void 0, function* () {
            if (this.logger)
                this.logger.debug("Calling operation GenerativeAiClient#getImportedModel.");
            ...
            const specRetryConfiguration = common.OciSdkDefaultRetryConfiguration;
            const retrier = oci_common_1.GenericRetrier.createPreferredRetrier(this._clientConfiguration ? this._clientConfiguration.retryConfiguration : undefined, getImportedModelRequest.retryConfiguration, specRetryConfiguration);
            if (this.logger)
                retrier.logger = this.logger;
            const request = yield oci_common_1.composeRequest({
                baseEndpoint: this._endpoint,
    ...
    getModel(getModelRequest) {
        return __awaiter(this, void 0, void 0, function* () {
            if (this.logger)
                this.logger.debug("Calling operation GenerativeAiClient#getModel.");
     ...
     */
    getSemanticStore(getSemanticStoreRequest) {
        return __awaiter(this, void 0, void 0, function* () {
            if (this.logger)
                this.logger.debug("Calling operation GenerativeAiClient#getSemanticStore.");
            ...
            const specRetryConfiguration = common.OciSdkDefaultRetryConfiguration;
            const retrier = oci_common_1.GenericRetrier.createPreferredRetrier(this._clientConfiguration ? this._clientConfiguration.retryConfiguration : undefined, getSemanticStoreRequest.retryConfiguration, specRetryConfiguration);
            if (this.logger)
                retrier.logger = this.logger;
            const request = yield oci_common_1.composeRequest({
                baseEndpoint: this._endpoint,
     ...
     */
    getVectorStoreConnector(getVectorStoreConnectorRequest) {
        return __awaiter(this, void 0, void 0, function* () {
            if (this.logger)
            ...
            const specRetryConfiguration = common.OciSdkDefaultRetryConfiguration;
            const retrier = oci_common_1.GenericRetrier.createPreferredRetrier(this._clientConfiguration ? this._clientConfiguration.retryConfiguration : undefined, getVectorStoreConnectorRequest.retryConfiguration, specRetryConfiguration);
            if (this.logger)
                retrier.logger = this.logger;
            const request = yield oci_common_1.composeRequest({
                baseEndpoint: this._endpoint,
     ...
     */
    getVectorStoreConnectorFileSync(getVectorStoreConnectorFileSyncRequest) {
        return __awaiter(this, void 0, void 0, function* () {
            if (this.logger)
            ...
            const apiReferenceLink = "";
            const pathParams = {
                "{vectorStoreConnectorFileSyncId}": getVectorStoreConnectorFileSyncRequest.vectorStoreConnectorFileSyncId
            };
            const queryParams = {};
            let headerParams = {
                "Content-Type": common.Constants.APPLICATION_JSON,
            ...
            const specRetryConfiguration = common.OciSdkDefaultRetryConfiguration;
            const retrier = oci_common_1.GenericRetrier.createPreferredRetrier(this._clientConfiguration ? this._clientConfiguration.retryConfiguration : undefined, getVectorStoreConnectorFileSyncRequest.retryConfiguration, specRetryConfiguration);
            if (this.logger)
                retrier.logger = this.logger;
            const request = yield oci_common_1.composeRequest({
                baseEndpoint: this._endpoint,
     ...
     */
    getVectorStoreConnectorStats(getVectorStoreConnectorStatsRequest) {
        return __awaiter(this, void 0, void 0, function* () {
            if (this.logger)
            ...
            const specRetryConfiguration = common.OciSdkDefaultRetryConfiguration;
            const retrier = oci_common_1.GenericRetrier.createPreferredRetrier(this._clientConfiguration ? this._clientConfiguration.retryConfiguration : undefined, getVectorStoreConnectorStatsRequest.retryConfiguration, specRetryConfiguration);
            if (this.logger)
                retrier.logger = this.logger;
            const request = yield oci_common_1.composeRequest({
                baseEndpoint: this._endpoint,
    ...
    getWorkRequest(getWorkRequestRequest) {
        return __awaiter(this, void 0, void 0, function* () {
            if (this.logger)
                this.logger.debug("Calling operation GenerativeAiClient#getWorkRequest.");
    ...
    listApiKeys(listApiKeysRequest) {
        return __awaiter(this, void 0, void 0, function* () {
            if (this.logger)
                this.logger.debug("Calling operation GenerativeAiClient#listApiKeys.");
     ...
     */
    listDedicatedAiClusters(listDedicatedAiClustersRequest) {
        return __awaiter(this, void 0, void 0, function* () {
            if (this.logger)
            ...
            const specRetryConfiguration = common.OciSdkDefaultRetryConfiguration;
            const retrier = oci_common_1.GenericRetrier.createPreferredRetrier(this._clientConfiguration ? this._clientConfiguration.retryConfiguration : undefined, listDedicatedAiClustersRequest.retryConfiguration, specRetryConfiguration);
            if (this.logger)
                retrier.logger = this.logger;
            const request = yield oci_common_1.composeRequest({
                baseEndpoint: this._endpoint,
    ...
    listEndpoints(listEndpointsRequest) {
        return __awaiter(this, void 0, void 0, function* () {
            if (this.logger)
                this.logger.debug("Calling operation GenerativeAiClient#listEndpoints.");
     ...
     */
    listGenerativeAiPrivateEndpoints(listGenerativeAiPrivateEndpointsRequest) {
        return __awaiter(this, void 0, void 0, function* () {
            if (this.logger)
            ...
            const specRetryConfiguration = common.OciSdkDefaultRetryConfiguration;
            const retrier = oci_common_1.GenericRetrier.createPreferredRetrier(this._clientConfiguration ? this._clientConfiguration.retryConfiguration : undefined, listGenerativeAiPrivateEndpointsRequest.retryConfiguration, specRetryConfiguration);
            if (this.logger)
                retrier.logger = this.logger;
            const request = yield oci_common_1.composeRequest({
                baseEndpoint: this._endpoint,
     ...
     */
    listGenerativeAiProjects(listGenerativeAiProjectsRequest) {
        return __awaiter(this, void 0, void 0, function* () {
            if (this.logger)
            ...
            const specRetryConfiguration = common.OciSdkDefaultRetryConfiguration;
            const retrier = oci_common_1.GenericRetrier.createPreferredRetrier(this._clientConfiguration ? this._clientConfiguration.retryConfiguration : undefined, listGenerativeAiProjectsRequest.retryConfiguration, specRetryConfiguration);
            if (this.logger)
                retrier.logger = this.logger;
            const request = yield oci_common_1.composeRequest({
                baseEndpoint: this._endpoint,
     ...
     */
    listHostedApplicationStorages(listHostedApplicationStoragesRequest) {
        return __awaiter(this, void 0, void 0, function* () {
            if (this.logger)
            ...
            const queryParams = {
                ...
                "hostedApplicationStorageType": listHostedApplicationStoragesRequest.hostedApplicationStorageType,
            ...
            const specRetryConfiguration = common.OciSdkDefaultRetryConfiguration;
            const retrier = oci_common_1.GenericRetrier.createPreferredRetrier(this._clientConfiguration ? this._clientConfiguration.retryConfiguration : undefined, listHostedApplicationStoragesRequest.retryConfiguration, specRetryConfiguration);
            if (this.logger)
                retrier.logger = this.logger;
            const request = yield oci_common_1.composeRequest({
                baseEndpoint: this._endpoint,
    ...
    listHostedApplications(listHostedApplicationsRequest) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const specRetryConfiguration = common.OciSdkDefaultRetryConfiguration;
            const retrier = oci_common_1.GenericRetrier.createPreferredRetrier(this._clientConfiguration ? this._clientConfiguration.retryConfiguration : undefined, listHostedApplicationsRequest.retryConfiguration, specRetryConfiguration);
            if (this.logger)
                retrier.logger = this.logger;
            const request = yield oci_common_1.composeRequest({
                baseEndpoint: this._endpoint,
     ...
     */
    listHostedDeployments(listHostedDeploymentsRequest) {
        return __awaiter(this, void 0, void 0, function* () {
            if (this.logger)
            ...
            const specRetryConfiguration = common.OciSdkDefaultRetryConfiguration;
            const retrier = oci_common_1.GenericRetrier.createPreferredRetrier(this._clientConfiguration ? this._clientConfiguration.retryConfiguration : undefined, listHostedDeploymentsRequest.retryConfiguration, specRetryConfiguration);
            if (this.logger)
                retrier.logger = this.logger;
            const request = yield oci_common_1.composeRequest({
                baseEndpoint: this._endpoint,
    ...
    listImportedModels(listImportedModelsRequest) {
        return __awaiter(this, void 0, void 0, function* () {
            if (this.logger)
                this.logger.debug("Calling operation GenerativeAiClient#listImportedModels.");
            ...
            const specRetryConfiguration = common.OciSdkDefaultRetryConfiguration;
            const retrier = oci_common_1.GenericRetrier.createPreferredRetrier(this._clientConfiguration ? this._clientConfiguration.retryConfiguration : undefined, listImportedModelsRequest.retryConfiguration, specRetryConfiguration);
            if (this.logger)
                retrier.logger = this.logger;
            const request = yield oci_common_1.composeRequest({
                baseEndpoint: this._endpoint,
    ...
    listModels(listModelsRequest) {
        return __awaiter(this, void 0, void 0, function* () {
            if (this.logger)
                this.logger.debug("Calling operation GenerativeAiClient#listModels.");
     ...
     */
    listSemanticStores(listSemanticStoresRequest) {
        return __awaiter(this, void 0, void 0, function* () {
            if (this.logger)
                this.logger.debug("Calling operation GenerativeAiClient#listSemanticStores.");
            ...
            const specRetryConfiguration = common.OciSdkDefaultRetryConfiguration;
            const retrier = oci_common_1.GenericRetrier.createPreferredRetrier(this._clientConfiguration ? this._clientConfiguration.retryConfiguration : undefined, listSemanticStoresRequest.retryConfiguration, specRetryConfiguration);
            if (this.logger)
                retrier.logger = this.logger;
            const request = yield oci_common_1.composeRequest({
                baseEndpoint: this._endpoint,
     ...
     */
    listVectorStoreConnectorFileSyncIngestionLogs(listVectorStoreConnectorFileSyncIngestionLogsRequest) {
        return __awaiter(this, void 0, void 0, function* () {
            if (this.logger)
                this.logger.debug("Calling operation GenerativeAiClient#listVectorStoreConnectorFileSyncIngestionLogs.");
            const operationName = "listVectorStoreConnectorFileSyncIngestionLogs";
            const apiReferenceLink = "";
            const pathParams = {
                "{vectorStoreConnectorFileSyncId}": listVectorStoreConnectorFileSyncIngestionLogsRequest.vectorStoreConnectorFileSyncId
            };
            const queryParams = {
            ...
            const specRetryConfiguration = common.OciSdkDefaultRetryConfiguration;
            const retrier = oci_common_1.GenericRetrier.createPreferredRetrier(this._clientConfiguration ? this._clientConfiguration.retryConfiguration : undefined, listVectorStoreConnectorFileSyncIngestionLogsRequest.retryConfiguration, specRetryConfiguration);
            if (this.logger)
                retrier.logger = this.logger;
            const request = yield oci_common_1.composeRequest({
                baseEndpoint: this._endpoint,
     ...
     */
    listVectorStoreConnectorFileSyncs(listVectorStoreConnectorFileSyncsRequest) {
        return __awaiter(this, void 0, void 0, function* () {
            if (this.logger)
            ...
            const specRetryConfiguration = common.OciSdkDefaultRetryConfiguration;
            const retrier = oci_common_1.GenericRetrier.createPreferredRetrier(this._clientConfiguration ? this._clientConfiguration.retryConfiguration : undefined, listVectorStoreConnectorFileSyncsRequest.retryConfiguration, specRetryConfiguration);
            if (this.logger)
                retrier.logger = this.logger;
            const request = yield oci_common_1.composeRequest({
                baseEndpoint: this._endpoint,
     ...
     */
    listVectorStoreConnectorIngestionLogs(listVectorStoreConnectorIngestionLogsRequest) {
        return __awaiter(this, void 0, void 0, function* () {
            if (this.logger)
                this.logger.debug("Calling operation GenerativeAiClient#listVectorStoreConnectorIngestionLogs.");
            const operationName = "listVectorStoreConnectorIngestionLogs";
            const apiReferenceLink = "";
            const pathParams = {
                "{vectorStoreConnectorId}": listVectorStoreConnectorIngestionLogsRequest.vectorStoreConnectorId
            };
            const queryParams = {
            ...
            const specRetryConfiguration = common.OciSdkDefaultRetryConfiguration;
            const retrier = oci_common_1.GenericRetrier.createPreferredRetrier(this._clientConfiguration ? this._clientConfiguration.retryConfiguration : undefined, listVectorStoreConnectorIngestionLogsRequest.retryConfiguration, specRetryConfiguration);
            if (this.logger)
                retrier.logger = this.logger;
            const request = yield oci_common_1.composeRequest({
                baseEndpoint: this._endpoint,
     ...
     */
    listVectorStoreConnectors(listVectorStoreConnectorsRequest) {
        return __awaiter(this, void 0, void 0, function* () {
            if (this.logger)
            ...
            const specRetryConfiguration = common.OciSdkDefaultRetryConfiguration;
            const retrier = oci_common_1.GenericRetrier.createPreferredRetrier(this._clientConfiguration ? this._clientConfiguration.retryConfiguration : undefined, listVectorStoreConnectorsRequest.retryConfiguration, specRetryConfiguration);
            if (this.logger)
                retrier.logger = this.logger;
            const request = yield oci_common_1.composeRequest({
                baseEndpoint: this._endpoint,
    ...
    listWorkRequestLogs(listWorkRequestLogsRequest) {
        return __awaiter(this, void 0, void 0, function* () {
            if (this.logger)
                this.logger.debug("Calling operation GenerativeAiClient#listWorkRequestLogs.");
    ...
    listWorkRequests(listWorkRequestsRequest) {
        return __awaiter(this, void 0, void 0, function* () {
            if (this.logger)
                this.logger.debug("Calling operation GenerativeAiClient#listWorkRequests.");
     ...
     */
    renewApiKey(renewApiKeyRequest) {
        return __awaiter(this, void 0, void 0, function* () {
            if (this.logger)
                this.logger.debug("Calling operation GenerativeAiClient#renewApiKey.");
            ...
            const specRetryConfiguration = common.OciSdkDefaultRetryConfiguration;
            const retrier = oci_common_1.GenericRetrier.createPreferredRetrier(this._clientConfiguration ? this._clientConfiguration.retryConfiguration : undefined, renewApiKeyRequest.retryConfiguration, specRetryConfiguration);
            if (this.logger)
                retrier.logger = this.logger;
            const request = yield oci_common_1.composeRequest({
                baseEndpoint: this._endpoint,
                ...
                method: "POST",
                bodyContent: common.ObjectSerializer.serialize(renewApiKeyRequest.renewApiKeyDetails, "RenewApiKeyDetails", model.RenewApiKeyDetails.getJsonObj),
                pathParams: pathParams,
                headerParams: headerParams,
                queryParams: queryParams
            });
     ...
     */
    setApiKeyState(setApiKeyStateRequest) {
        return __awaiter(this, void 0, void 0, function* () {
            if (this.logger)
                this.logger.debug("Calling operation GenerativeAiClient#setApiKeyState.");
            ...
            const specRetryConfiguration = common.OciSdkDefaultRetryConfiguration;
            const retrier = oci_common_1.GenericRetrier.createPreferredRetrier(this._clientConfiguration ? this._clientConfiguration.retryConfiguration : undefined, setApiKeyStateRequest.retryConfiguration, specRetryConfiguration);
            if (this.logger)
                retrier.logger = this.logger;
            const request = yield oci_common_1.composeRequest({
                baseEndpoint: this._endpoint,
                ...
                method: "POST",
                bodyContent: common.ObjectSerializer.serialize(setApiKeyStateRequest.setApiKeyStateDetails, "SetApiKeyStateDetails", model.SetApiKeyStateDetails.getJsonObj),
                pathParams: pathParams,
                headerParams: headerParams,
                queryParams: queryParams
            });
    ...
    updateApiKey(updateApiKeyRequest) {
        return __awaiter(this, void 0, void 0, function* () {
            if (this.logger)
                this.logger.debug("Calling operation GenerativeAiClient#updateApiKey.");
            ...
            const specRetryConfiguration = common.OciSdkDefaultRetryConfiguration;
            const retrier = oci_common_1.GenericRetrier.createPreferredRetrier(this._clientConfiguration ? this._clientConfiguration.retryConfiguration : undefined, updateApiKeyRequest.retryConfiguration, specRetryConfiguration);
            if (this.logger)
                retrier.logger = this.logger;
            const request = yield oci_common_1.composeRequest({
                baseEndpoint: this._endpoint,
                ...
                path: "/apikeys/{apiKeyId}",
                method: "PUT",
                bodyContent: common.ObjectSerializer.serialize(updateApiKeyRequest.updateApiKeyDetails, "UpdateApiKeyDetails", model.UpdateApiKeyDetails.getJsonObj),
                pathParams: pathParams,
                headerParams: headerParams,
                queryParams: queryParams
            });
     ...
     */
    updateDedicatedAiCluster(updateDedicatedAiClusterRequest) {
        return __awaiter(this, void 0, void 0, function* () {
            if (this.logger)
            ...
            const specRetryConfiguration = common.OciSdkDefaultRetryConfiguration;
            const retrier = oci_common_1.GenericRetrier.createPreferredRetrier(this._clientConfiguration ? this._clientConfiguration.retryConfiguration : undefined, updateDedicatedAiClusterRequest.retryConfiguration, specRetryConfiguration);
            if (this.logger)
                retrier.logger = this.logger;
            const request = yield oci_common_1.composeRequest({
                baseEndpoint: this._endpoint,
                ...
                path: "/dedicatedAiClusters/{dedicatedAiClusterId}",
                method: "PUT",
                bodyContent: common.ObjectSerializer.serialize(updateDedicatedAiClusterRequest.updateDedicatedAiClusterDetails, "UpdateDedicatedAiClusterDetails", model.UpdateDedicatedAiClusterDetails.getJsonObj),
                pathParams: pathParams,
                headerParams: headerParams,
                queryParams: queryParams
            });
    ...
    updateEndpoint(updateEndpointRequest) {
        return __awaiter(this, void 0, void 0, function* () {
            if (this.logger)
                this.logger.debug("Calling operation GenerativeAiClient#updateEndpoint.");
     ...
     */
    updateGenerativeAiPrivateEndpoint(updateGenerativeAiPrivateEndpointRequest) {
        return __awaiter(this, void 0, void 0, function* () {
            if (this.logger)
            ...
            const specRetryConfiguration = common.OciSdkDefaultRetryConfiguration;
            const retrier = oci_common_1.GenericRetrier.createPreferredRetrier(this._clientConfiguration ? this._clientConfiguration.retryConfiguration : undefined, updateGenerativeAiPrivateEndpointRequest.retryConfiguration, specRetryConfiguration);
            if (this.logger)
                retrier.logger = this.logger;
            const request = yield oci_common_1.composeRequest({
                baseEndpoint: this._endpoint,
                ...
                path: "/generativeAiPrivateEndpoints/{generativeAiPrivateEndpointId}",
                method: "PUT",
                bodyContent: common.ObjectSerializer.serialize(updateGenerativeAiPrivateEndpointRequest.updateGenerativeAiPrivateEndpointDetails, "UpdateGenerativeAiPrivateEndpointDetails", model.UpdateGenerativeAiPrivateEndpointDetails.getJsonObj),
                pathParams: pathParams,
                headerParams: headerParams,
                queryParams: queryParams
            });
     ...
     */
    updateGenerativeAiProject(updateGenerativeAiProjectRequest) {
        return __awaiter(this, void 0, void 0, function* () {
            if (this.logger)
            ...
            const specRetryConfiguration = common.OciSdkDefaultRetryConfiguration;
            const retrier = oci_common_1.GenericRetrier.createPreferredRetrier(this._clientConfiguration ? this._clientConfiguration.retryConfiguration : undefined, updateGenerativeAiProjectRequest.retryConfiguration, specRetryConfiguration);
            if (this.logger)
                retrier.logger = this.logger;
            const request = yield oci_common_1.composeRequest({
                baseEndpoint: this._endpoint,
                ...
                path: "/generativeAiProjects/{generativeAiProjectId}",
                method: "PUT",
                bodyContent: common.ObjectSerializer.serialize(updateGenerativeAiProjectRequest.updateGenerativeAiProjectDetails, "UpdateGenerativeAiProjectDetails", model.UpdateGenerativeAiProjectDetails.getJsonObj),
                pathParams: pathParams,
                headerParams: headerParams,
                queryParams: queryParams
            });
     ...
     */
    updateHostedApplication(updateHostedApplicationRequest) {
        return __awaiter(this, void 0, void 0, function* () {
            if (this.logger)
            ...
            const specRetryConfiguration = common.OciSdkDefaultRetryConfiguration;
            const retrier = oci_common_1.GenericRetrier.createPreferredRetrier(this._clientConfiguration ? this._clientConfiguration.retryConfiguration : undefined, updateHostedApplicationRequest.retryConfiguration, specRetryConfiguration);
            if (this.logger)
                retrier.logger = this.logger;
            const request = yield oci_common_1.composeRequest({
                baseEndpoint: this._endpoint,
                ...
                path: "/hostedApplications/{hostedApplicationId}",
                method: "PUT",
                bodyContent: common.ObjectSerializer.serialize(updateHostedApplicationRequest.updateHostedApplicationDetails, "UpdateHostedApplicationDetails", model.UpdateHostedApplicationDetails.getJsonObj),
                pathParams: pathParams,
                headerParams: headerParams,
                queryParams: queryParams
            });
     ...
     */
    updateHostedDeployment(updateHostedDeploymentRequest) {
        return __awaiter(this, void 0, void 0, function* () {
            if (this.logger)
            ...
            const specRetryConfiguration = common.OciSdkDefaultRetryConfiguration;
            const retrier = oci_common_1.GenericRetrier.createPreferredRetrier(this._clientConfiguration ? this._clientConfiguration.retryConfiguration : undefined, updateHostedDeploymentRequest.retryConfiguration, specRetryConfiguration);
            if (this.logger)
                retrier.logger = this.logger;
            const request = yield oci_common_1.composeRequest({
                baseEndpoint: this._endpoint,
                ...
                path: "/hostedDeployments/{hostedDeploymentId}",
                method: "PUT",
                bodyContent: common.ObjectSerializer.serialize(updateHostedDeploymentRequest.updateHostedDeploymentDetails, "UpdateHostedDeploymentDetails", model.UpdateHostedDeploymentDetails.getJsonObj),
                pathParams: pathParams,
                headerParams: headerParams,
                queryParams: queryParams
            });
     ...
     */
    updateImportedModel(updateImportedModelRequest) {
        return __awaiter(this, void 0, void 0, function* () {
            if (this.logger)
                this.logger.debug("Calling operation GenerativeAiClient#updateImportedModel.");
            ...
            const specRetryConfiguration = common.OciSdkDefaultRetryConfiguration;
            const retrier = oci_common_1.GenericRetrier.createPreferredRetrier(this._clientConfiguration ? this._clientConfiguration.retryConfiguration : undefined, updateImportedModelRequest.retryConfiguration, specRetryConfiguration);
            if (this.logger)
                retrier.logger = this.logger;
            const request = yield oci_common_1.composeRequest({
                baseEndpoint: this._endpoint,
                ...
                path: "/importedModels/{importedModelId}",
                method: "PUT",
                bodyContent: common.ObjectSerializer.serialize(updateImportedModelRequest.updateImportedModelDetails, "UpdateImportedModelDetails", model.UpdateImportedModelDetails.getJsonObj),
                pathParams: pathParams,
                headerParams: headerParams,
                queryParams: queryParams
            });
    ...
    updateModel(updateModelRequest) {
        return __awaiter(this, void 0, void 0, function* () {
            if (this.logger)
                this.logger.debug("Calling operation GenerativeAiClient#updateModel.");
     ...
     */
    updateSemanticStore(updateSemanticStoreRequest) {
        return __awaiter(this, void 0, void 0, function* () {
            if (this.logger)
                this.logger.debug("Calling operation GenerativeAiClient#updateSemanticStore.");
            ...
            const specRetryConfiguration = common.OciSdkDefaultRetryConfiguration;
            const retrier = oci_common_1.GenericRetrier.createPreferredRetrier(this._clientConfiguration ? this._clientConfiguration.retryConfiguration : undefined, updateSemanticStoreRequest.retryConfiguration, specRetryConfiguration);
            if (this.logger)
                retrier.logger = this.logger;
            const request = yield oci_common_1.composeRequest({
                baseEndpoint: this._endpoint,
                ...
                path: "/semanticStores/{semanticStoreId}",
                method: "PUT",
                bodyContent: common.ObjectSerializer.serialize(updateSemanticStoreRequest.updateSemanticStoreDetails, "UpdateSemanticStoreDetails", model.UpdateSemanticStoreDetails.getJsonObj),
                pathParams: pathParams,
                headerParams: headerParams,
                queryParams: queryParams
            });
     ...
     */
    updateVectorStoreConnector(updateVectorStoreConnectorRequest) {
        return __awaiter(this, void 0, void 0, function* () {
            if (this.logger)
            ...
            const specRetryConfiguration = common.OciSdkDefaultRetryConfiguration;
            const retrier = oci_common_1.GenericRetrier.createPreferredRetrier(this._clientConfiguration ? this._clientConfiguration.retryConfiguration : undefined, updateVectorStoreConnectorRequest.retryConfiguration, specRetryConfiguration);
            if (this.logger)
                retrier.logger = this.logger;
            const request = yield oci_common_1.composeRequest({
                baseEndpoint: this._endpoint,
                ...
                path: "/vectorStoreConnectors/{vectorStoreConnectorId}",
                method: "PUT",
                bodyContent: common.ObjectSerializer.serialize(updateVectorStoreConnectorRequest.updateVectorStoreConnectorDetails, "UpdateVectorStoreConnectorDetails", model.UpdateVectorStoreConnectorDetails.getJsonObj),
                pathParams: pathParams,
                headerParams: headerParams,
                queryParams: queryParams
            });
...
exports.GenerativeAiClient = GenerativeAiClient;
GenerativeAiClient.serviceEndpointTemplate = "https://generativeai.{region}.oci.{secondLevelDomain}";

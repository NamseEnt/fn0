...
export declare namespace AgreementRecordSummary {
    function getJsonObj(obj: AgreementRecordSummary): object;
    function getDeserializedJsonObj(obj: AgreementRecordSummary): object;
}

...
export declare namespace ManagedInstanceSummary {
    function getJsonObj(obj: ManagedInstanceSummary): object;
    function getDeserializedJsonObj(obj: ManagedInstanceSummary): object;
}

 ...
 *
 */
export interface SetRestartOrderServerSummary {
    /**
     * The name of the server.
     */
    "name": string;
    /**
     * The restart order number of the server. Note: Numbers greater than Number.MAX_SAFE_INTEGER will result in rounding issues.
     */
    "restartOrder": number;
}
export declare namespace SetRestartOrderServerSummary {
    function getJsonObj(obj: SetRestartOrderServerSummary): object;
    function getDeserializedJsonObj(obj: SetRestartOrderServerSummary): object;
}

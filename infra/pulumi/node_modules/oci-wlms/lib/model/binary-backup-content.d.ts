...
export declare namespace BinaryBackupContent {
    function getJsonObj(obj: BinaryBackupContent, isParentJsonObj?: boolean): object;
    const contentType = "BINARY";
    function getDeserializedJsonObj(obj: BinaryBackupContent, isParentJsonObj?: boolean): object;
}

...
export declare namespace StopWlsDomainDetails {
    function getJsonObj(obj: StopWlsDomainDetails): object;
    function getDeserializedJsonObj(obj: StopWlsDomainDetails): object;
}

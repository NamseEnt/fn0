 ...
 *
 */
export interface ManagedInstanceConfiguration {
    /**
...
export declare namespace ManagedInstanceConfiguration {
    function getJsonObj(obj: ManagedInstanceConfiguration): object;
    function getDeserializedJsonObj(obj: ManagedInstanceConfiguration): object;
}

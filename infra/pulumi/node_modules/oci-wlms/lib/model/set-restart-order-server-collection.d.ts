...
export declare namespace SetRestartOrderServerCollection {
    function getJsonObj(obj: SetRestartOrderServerCollection): object;
    function getDeserializedJsonObj(obj: SetRestartOrderServerCollection): object;
}

 ...
 *
 **/
export declare enum PatchReadinessStatus {
    Ok = "OK",
    Warning = "WARNING",
    Error = "ERROR",
    Unknown = "UNKNOWN",
...
export declare namespace PatchReadinessStatus {
    function getJsonObj(obj: PatchReadinessStatus): PatchReadinessStatus;
    function getDeserializedJsonObj(obj: PatchReadinessStatus): PatchReadinessStatus;
}

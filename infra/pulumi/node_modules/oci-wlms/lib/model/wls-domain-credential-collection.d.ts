 ...
 *
 */
export interface WlsDomainCredentialCollection {
    /**
     * List of WebLogic domain credentials.
     */
    "items": Array<model.WlsDomainCredentialSummary>;
}
export declare namespace WlsDomainCredentialCollection {
    function getJsonObj(obj: WlsDomainCredentialCollection): object;
    function getDeserializedJsonObj(obj: WlsDomainCredentialCollection): object;
}

...
export declare namespace MiddlewareBackupPatch {
    function getJsonObj(obj: MiddlewareBackupPatch): object;
    function getDeserializedJsonObj(obj: MiddlewareBackupPatch): object;
}

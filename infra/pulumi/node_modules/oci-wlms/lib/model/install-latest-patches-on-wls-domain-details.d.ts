...
export declare namespace InstallLatestPatchesOnWlsDomainDetails {
    function getJsonObj(obj: InstallLatestPatchesOnWlsDomainDetails): object;
    function getDeserializedJsonObj(obj: InstallLatestPatchesOnWlsDomainDetails): object;
}

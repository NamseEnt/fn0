 ...
 *
 */
export interface UpdateWlsDomainConfigurationDetails {
    /**
    ...
    /**
     * Servers shutdown timeout in seconds. If set to 0 seconds, it means there is no timeout. Note: Numbers greater than Number.MAX_SAFE_INTEGER will result in rounding issues.
     */
...
export declare namespace UpdateWlsDomainConfigurationDetails {
    function getJsonObj(obj: UpdateWlsDomainConfigurationDetails): object;
    function getDeserializedJsonObj(obj: UpdateWlsDomainConfigurationDetails): object;
}

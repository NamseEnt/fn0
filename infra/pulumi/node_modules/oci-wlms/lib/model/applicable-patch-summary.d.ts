 ...
 *
 */
export interface ApplicablePatchSummary {
    /**
     ...
     */
    "middlewareType": Array<ApplicablePatchSummary.MiddlewareType>;
    /**
     * The operating system architecture for which the patch can be applied.
     */
    "osArch": string;
}
export declare namespace ApplicablePatchSummary {
    enum MiddlewareType {
        Fmw = "FMW",
        Wls = "WLS",
        Opatch = "OPATCH",
    ...
    function getJsonObj(obj: ApplicablePatchSummary): object;
    function getDeserializedJsonObj(obj: ApplicablePatchSummary): object;
}

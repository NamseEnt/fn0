...
export declare namespace InstalledPatchSummary {
    function getJsonObj(obj: InstalledPatchSummary): object;
    function getDeserializedJsonObj(obj: InstalledPatchSummary): object;
}

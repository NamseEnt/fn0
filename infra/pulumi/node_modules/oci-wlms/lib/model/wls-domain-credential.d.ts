...
export declare namespace WlsDomainCredential {
    enum Strategy {
    ...
    function getJsonObj(obj: WlsDomainCredential): object;
    function getDeserializedJsonObj(obj: WlsDomainCredential): object;
}

 ...
 *
 */
export interface UpdateWlsDomainCredentialDetails {
    /**
...
export declare namespace UpdateWlsDomainCredentialDetails {
    function getJsonObj(obj: UpdateWlsDomainCredentialDetails): object;
    function getDeserializedJsonObj(obj: UpdateWlsDomainCredentialDetails): object;
}

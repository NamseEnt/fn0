 ...
 *
 */
export interface AgreementRecordCollection {
    /**
     * List of agreement records.
     */
    "items": Array<model.AgreementRecordSummary>;
}
export declare namespace AgreementRecordCollection {
    function getJsonObj(obj: AgreementRecordCollection): object;
    function getDeserializedJsonObj(obj: AgreementRecordCollection): object;
}

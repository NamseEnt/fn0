...
export interface ServerCollection {
     ...
     * A list of servers.
     */
    "items": Array<model.ServerSummary>;
}
export declare namespace ServerCollection {
    function getJsonObj(obj: ServerCollection): object;
    function getDeserializedJsonObj(obj: ServerCollection): object;
}

 ...
 *
 */
export interface RequiredPolicyCollection {
    /**
     * List of RequiredPolicySummary.
     */
    "items": Array<model.RequiredPolicySummary>;
}
export declare namespace RequiredPolicyCollection {
    function getJsonObj(obj: RequiredPolicyCollection): object;
    function getDeserializedJsonObj(obj: RequiredPolicyCollection): object;
}

...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/wlms/ListAgreementRecords.ts.html |here} to see how to use ListAgreementRecordsRequest.
 */
export interface ListAgreementRecordsRequest extends common.BaseRequest {
    /**
...
export declare namespace ListAgreementRecordsRequest {
    enum SortOrder {
        Asc = "ASC",
        Desc = "DESC"
    }

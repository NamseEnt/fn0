...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/wlms/GetWlsDomainServerBackup.ts.html |here} to see how to use GetWlsDomainServerBackupRequest.
 */
export interface GetWlsDomainServerBackupRequest extends common.BaseRequest {
    /**

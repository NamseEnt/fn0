...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/wlms/ListManagedInstanceServerInstalledPatches.ts.html |here} to see how to use ListManagedInstanceServerInstalledPatchesRequest.
 */
export interface ListManagedInstanceServerInstalledPatchesRequest extends common.BaseRequest {
    /**
...
export declare namespace ListManagedInstanceServerInstalledPatchesRequest {
    enum SortOrder {
        Asc = "ASC",
        Desc = "DESC"
    }

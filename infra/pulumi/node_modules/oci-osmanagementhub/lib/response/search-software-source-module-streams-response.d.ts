...
export interface SearchSoftwareSourceModuleStreamsResponse {
    /**
    ...
    "opcNextPage": string;
    /**
     * The returned model.ModuleStreamCollection instance.
     */
    "moduleStreamCollection": model.ModuleStreamCollection;
}

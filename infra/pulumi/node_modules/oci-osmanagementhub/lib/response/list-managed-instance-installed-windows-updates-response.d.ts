...
export interface ListManagedInstanceInstalledWindowsUpdatesResponse {
    /**
    ...
    "opcNextPage": string;
    /**
     * The returned model.InstalledWindowsUpdateCollection instance.
     */
    "installedWindowsUpdateCollection": model.InstalledWindowsUpdateCollection;
}

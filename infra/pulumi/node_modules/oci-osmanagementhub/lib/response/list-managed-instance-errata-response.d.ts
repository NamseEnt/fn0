...
export interface ListManagedInstanceErrataResponse {
    /**
    ...
    "opcNextPage": string;
    /**
     * The returned model.ManagedInstanceErratumSummaryCollection instance.
     */
    "managedInstanceErratumSummaryCollection": model.ManagedInstanceErratumSummaryCollection;
}

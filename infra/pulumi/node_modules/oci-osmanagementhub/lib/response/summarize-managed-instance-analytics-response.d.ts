...
export interface SummarizeManagedInstanceAnalyticsResponse {
    /**
    ...
    "opcNextPage": string;
    /**
     * The returned model.ManagedInstanceAnalyticCollection instance.
     */
    "managedInstanceAnalyticCollection": model.ManagedInstanceAnalyticCollection;
}

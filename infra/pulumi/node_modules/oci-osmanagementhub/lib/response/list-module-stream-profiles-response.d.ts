...
export interface ListModuleStreamProfilesResponse {
    /**
    ...
    "opcNextPage": string;
    /**
     * The returned model.ModuleStreamProfileCollection instance.
     */
    "moduleStreamProfileCollection": model.ModuleStreamProfileCollection;
}

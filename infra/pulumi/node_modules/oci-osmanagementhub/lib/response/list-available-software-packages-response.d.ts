...
export interface ListAvailableSoftwarePackagesResponse {
    /**
    ...
    "opcNextPage": string;
    /**
     * The returned model.SoftwarePackageCollection instance.
     */
    "softwarePackageCollection": model.SoftwarePackageCollection;
}

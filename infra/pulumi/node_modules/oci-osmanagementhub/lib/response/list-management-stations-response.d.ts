...
export interface ListManagementStationsResponse {
    /**
    ...
    "opcNextPage": string;
    /**
     * The returned model.ManagementStationCollection instance.
     */
    "managementStationCollection": model.ManagementStationCollection;
}

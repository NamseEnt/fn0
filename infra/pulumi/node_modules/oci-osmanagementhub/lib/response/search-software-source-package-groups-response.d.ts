...
export interface SearchSoftwareSourcePackageGroupsResponse {
    /**
    ...
    "opcNextPage": string;
    /**
     * The returned model.PackageGroupCollection instance.
     */
    "packageGroupCollection": model.PackageGroupCollection;
}

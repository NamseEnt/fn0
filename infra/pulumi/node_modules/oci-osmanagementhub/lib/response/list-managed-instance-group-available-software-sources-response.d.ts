...
export interface ListManagedInstanceGroupAvailableSoftwareSourcesResponse {
    /**
    ...
    "opcNextPage": string;
    /**
     * The returned model.AvailableSoftwareSourceCollection instance.
     */
    "availableSoftwareSourceCollection": model.AvailableSoftwareSourceCollection;
}

...
export interface ListManagedInstanceAvailableWindowsUpdatesResponse {
    /**
    ...
    "opcNextPage": string;
    /**
     * The returned model.AvailableWindowsUpdateCollection instance.
     */
    "availableWindowsUpdateCollection": model.AvailableWindowsUpdateCollection;
}

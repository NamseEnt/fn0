...
export declare namespace CustomSoftwareSourceFilter {
    function getJsonObj(obj: CustomSoftwareSourceFilter): object;
    function getDeserializedJsonObj(obj: CustomSoftwareSourceFilter): object;
}

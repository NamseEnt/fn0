...
export declare namespace AvailableSoftwareSourceCollection {
    function getJsonObj(obj: AvailableSoftwareSourceCollection): object;
    function getDeserializedJsonObj(obj: AvailableSoftwareSourceCollection): object;
}

...
export declare namespace CreateManagedInstanceGroupDetails {
    function getJsonObj(obj: CreateManagedInstanceGroupDetails): object;
    function getDeserializedJsonObj(obj: CreateManagedInstanceGroupDetails): object;
}

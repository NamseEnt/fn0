...
export declare namespace ScheduledJobOperation {
    function getJsonObj(obj: ScheduledJobOperation): object;
    function getDeserializedJsonObj(obj: ScheduledJobOperation): object;
}

...
export declare namespace CreateThirdPartySoftwareSourceDetails {
    function getJsonObj(obj: CreateThirdPartySoftwareSourceDetails, isParentJsonObj?: boolean): object;
    const softwareSourceType = "THIRD_PARTY";
    function getDeserializedJsonObj(obj: CreateThirdPartySoftwareSourceDetails, isParentJsonObj?: boolean): object;
}

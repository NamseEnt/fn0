...
export declare namespace CustomSoftwareSource {
    function getJsonObj(obj: CustomSoftwareSource, isParentJsonObj?: boolean): object;
    const softwareSourceType = "CUSTOM";
    function getDeserializedJsonObj(obj: CustomSoftwareSource, isParentJsonObj?: boolean): object;
}

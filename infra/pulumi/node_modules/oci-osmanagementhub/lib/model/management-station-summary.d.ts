...
export declare namespace ManagementStationSummary {
    function getJsonObj(obj: ManagementStationSummary): object;
    function getDeserializedJsonObj(obj: ManagementStationSummary): object;
}

...
export declare namespace EntitlementCollection {
    function getJsonObj(obj: EntitlementCollection): object;
    function getDeserializedJsonObj(obj: EntitlementCollection): object;
}

...
export declare namespace CreateSoftwareSourceProfileDetails {
    function getJsonObj(obj: CreateSoftwareSourceProfileDetails, isParentJsonObj?: boolean): object;
    const profileType = "SOFTWARESOURCE";
    function getDeserializedJsonObj(obj: CreateSoftwareSourceProfileDetails, isParentJsonObj?: boolean): object;
}

...
export declare namespace UpdateScheduledJobDetails {
    function getJsonObj(obj: UpdateScheduledJobDetails): object;
    function getDeserializedJsonObj(obj: UpdateScheduledJobDetails): object;
}

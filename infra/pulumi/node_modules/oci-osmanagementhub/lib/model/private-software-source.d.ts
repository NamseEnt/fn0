 ...
 */
export interface PrivateSoftwareSource extends model.SoftwareSource {
    /**
...
export declare namespace PrivateSoftwareSource {
    function getJsonObj(obj: PrivateSoftwareSource, isParentJsonObj?: boolean): object;
    const softwareSourceType = "PRIVATE";
    function getDeserializedJsonObj(obj: PrivateSoftwareSource, isParentJsonObj?: boolean): object;
}

...
export declare namespace ManagedInstanceGroupModuleSummary {
    function getJsonObj(obj: ManagedInstanceGroupModuleSummary): object;
    function getDeserializedJsonObj(obj: ManagedInstanceGroupModuleSummary): object;
}

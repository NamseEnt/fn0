 ...
 */
export interface KspliceUpdateEventData {
    /**
     * The type of Ksplice update.
     */
    "operationType": KspliceUpdateEventData.OperationType;
    /**
...
export declare namespace KspliceUpdateEventData {
    enum OperationType {
    ...
    function getJsonObj(obj: KspliceUpdateEventData): object;
    function getDeserializedJsonObj(obj: KspliceUpdateEventData): object;
}

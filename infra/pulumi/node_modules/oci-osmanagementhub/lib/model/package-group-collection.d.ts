...
export declare namespace PackageGroupCollection {
    function getJsonObj(obj: PackageGroupCollection): object;
    function getDeserializedJsonObj(obj: PackageGroupCollection): object;
}

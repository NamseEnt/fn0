...
export declare namespace AutonomousSettings {
    function getJsonObj(obj: AutonomousSettings): object;
    function getDeserializedJsonObj(obj: AutonomousSettings): object;
}

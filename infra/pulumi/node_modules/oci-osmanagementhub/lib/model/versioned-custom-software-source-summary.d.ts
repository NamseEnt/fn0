...
export declare namespace VersionedCustomSoftwareSourceSummary {
    function getJsonObj(obj: VersionedCustomSoftwareSourceSummary, isParentJsonObj?: boolean): object;
    const softwareSourceType = "VERSIONED";
    function getDeserializedJsonObj(obj: VersionedCustomSoftwareSourceSummary, isParentJsonObj?: boolean): object;
}

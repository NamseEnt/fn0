...
export declare namespace LifecycleStageSummary {
    function getJsonObj(obj: LifecycleStageSummary): object;
    function getDeserializedJsonObj(obj: LifecycleStageSummary): object;
}

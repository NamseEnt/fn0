...
export declare namespace VendorSoftwareSource {
    function getJsonObj(obj: VendorSoftwareSource, isParentJsonObj?: boolean): object;
    const softwareSourceType = "VENDOR";
    function getDeserializedJsonObj(obj: VendorSoftwareSource, isParentJsonObj?: boolean): object;
}

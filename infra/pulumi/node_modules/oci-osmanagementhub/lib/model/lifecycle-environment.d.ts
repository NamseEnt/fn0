...
export declare namespace LifecycleEnvironment {
    enum LifecycleState {
        Creating = "CREATING",
        Updating = "UPDATING",
        Active = "ACTIVE",
    ...
    function getJsonObj(obj: LifecycleEnvironment): object;
    function getDeserializedJsonObj(obj: LifecycleEnvironment): object;
}

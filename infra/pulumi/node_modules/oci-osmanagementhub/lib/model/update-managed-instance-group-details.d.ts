...
export declare namespace UpdateManagedInstanceGroupDetails {
    function getJsonObj(obj: UpdateManagedInstanceGroupDetails): object;
    function getDeserializedJsonObj(obj: UpdateManagedInstanceGroupDetails): object;
}

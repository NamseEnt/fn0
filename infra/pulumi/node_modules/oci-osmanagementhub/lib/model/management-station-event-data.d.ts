...
export declare namespace ManagementStationEventData {
    enum OperationType {
    ...
    function getJsonObj(obj: ManagementStationEventData): object;
    function getDeserializedJsonObj(obj: ManagementStationEventData): object;
}

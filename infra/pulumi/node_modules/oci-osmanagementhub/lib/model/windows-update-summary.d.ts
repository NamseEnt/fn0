...
export declare namespace WindowsUpdateSummary {
    function getJsonObj(obj: WindowsUpdateSummary): object;
    function getDeserializedJsonObj(obj: WindowsUpdateSummary): object;
}

...
export declare namespace CreateCustomSoftwareSourceDetails {
    function getJsonObj(obj: CreateCustomSoftwareSourceDetails, isParentJsonObj?: boolean): object;
    const softwareSourceType = "CUSTOM";
    function getDeserializedJsonObj(obj: CreateCustomSoftwareSourceDetails, isParentJsonObj?: boolean): object;
}

 ...
 */
export interface RebootManagedInstanceGroupDetails {
    /**
...
export declare namespace RebootManagedInstanceGroupDetails {
    function getJsonObj(obj: RebootManagedInstanceGroupDetails): object;
    function getDeserializedJsonObj(obj: RebootManagedInstanceGroupDetails): object;
}

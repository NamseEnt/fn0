...
export declare namespace CreateScheduledJobDetails {
    function getJsonObj(obj: CreateScheduledJobDetails): object;
    function getDeserializedJsonObj(obj: CreateScheduledJobDetails): object;
}

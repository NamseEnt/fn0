...
export declare namespace VersionedCustomSoftwareSource {
    function getJsonObj(obj: VersionedCustomSoftwareSource, isParentJsonObj?: boolean): object;
    const softwareSourceType = "VERSIONED";
    function getDeserializedJsonObj(obj: VersionedCustomSoftwareSource, isParentJsonObj?: boolean): object;
}

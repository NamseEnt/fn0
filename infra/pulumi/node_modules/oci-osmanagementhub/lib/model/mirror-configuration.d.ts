...
export declare namespace MirrorConfiguration {
    function getJsonObj(obj: MirrorConfiguration): object;
    function getDeserializedJsonObj(obj: MirrorConfiguration): object;
}

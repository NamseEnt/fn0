...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/osmanagementhub/ListManagedInstanceErrata.ts.html |here} to see how to use ListManagedInstanceErrataRequest.
 */
...
export declare namespace ListManagedInstanceErrataRequest {
    enum SortBy {

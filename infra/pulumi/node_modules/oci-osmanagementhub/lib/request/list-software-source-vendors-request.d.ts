...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/osmanagementhub/ListSoftwareSourceVendors.ts.html |here} to see how to use ListSoftwareSourceVendorsRequest.
 */
...
export declare namespace ListSoftwareSourceVendorsRequest {
    enum SortBy {
        Name = "name"
    }
}

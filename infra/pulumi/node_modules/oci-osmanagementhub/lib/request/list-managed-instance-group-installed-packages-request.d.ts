...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/osmanagementhub/ListManagedInstanceGroupInstalledPackages.ts.html |here} to see how to use ListManagedInstanceGroupInstalledPackagesRequest.
 */
...
export declare namespace ListManagedInstanceGroupInstalledPackagesRequest {
    enum SortBy {

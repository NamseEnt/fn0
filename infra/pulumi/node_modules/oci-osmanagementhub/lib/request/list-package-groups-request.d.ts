...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/osmanagementhub/ListPackageGroups.ts.html |here} to see how to use ListPackageGroupsRequest.
 */
...
export declare namespace ListPackageGroupsRequest {
    enum SortBy {

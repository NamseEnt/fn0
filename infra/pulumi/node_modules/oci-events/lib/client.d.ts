...
export declare class EventsClient {
     ...
     */
    listAllRules(request: requests.ListRulesRequest): AsyncIterableIterator<model.RuleSummary>;
    /**
     ...
     * @param request a request which can be sent to the service operation
     */
    listRulesRecordIterator(request: requests.ListRulesRequest): AsyncIterableIterator<model.RuleSummary>;
    /**
     * Creates a new async iterator which will iterate over the responses received from the listRules operation. This iterator
     * will fetch more data from the server as needed.
     *
     * @param request a request which can be sent to the service operation
     */
    listRulesResponseIterator(request: requests.ListRulesRequest): AsyncIterableIterator<responses.ListRulesResponse>;
    /**
     * Updates a rule.
     *
     * This operation does not retry by default if the user has not defined a retry configuration.

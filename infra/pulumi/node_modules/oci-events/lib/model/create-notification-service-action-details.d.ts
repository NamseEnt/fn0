...
export declare namespace CreateNotificationServiceActionDetails {
    function getJsonObj(obj: CreateNotificationServiceActionDetails, isParentJsonObj?: boolean): object;
    const actionType = "ONS";
    function getDeserializedJsonObj(obj: CreateNotificationServiceActionDetails, isParentJsonObj?: boolean): object;
}

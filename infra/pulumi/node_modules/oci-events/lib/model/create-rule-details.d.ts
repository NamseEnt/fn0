...
export declare namespace CreateRuleDetails {
    function getJsonObj(obj: CreateRuleDetails): object;
    function getDeserializedJsonObj(obj: CreateRuleDetails): object;
}

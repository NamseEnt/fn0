...
export declare namespace FaaSAction {
    function getJsonObj(obj: FaaSAction, isParentJsonObj?: boolean): object;
    const actionType = "FAAS";
    function getDeserializedJsonObj(obj: FaaSAction, isParentJsonObj?: boolean): object;
}

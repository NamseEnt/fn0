...
export declare namespace CreateStreamingServiceActionDetails {
    function getJsonObj(obj: CreateStreamingServiceActionDetails, isParentJsonObj?: boolean): object;
    const actionType = "OSS";
    function getDeserializedJsonObj(obj: CreateStreamingServiceActionDetails, isParentJsonObj?: boolean): object;
}

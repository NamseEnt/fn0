...
export declare namespace UpdateRuleDetails {
    function getJsonObj(obj: UpdateRuleDetails): object;
    function getDeserializedJsonObj(obj: UpdateRuleDetails): object;
}

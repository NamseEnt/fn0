...
export declare namespace ChangeRuleCompartmentDetails {
    function getJsonObj(obj: ChangeRuleCompartmentDetails): object;
    function getDeserializedJsonObj(obj: ChangeRuleCompartmentDetails): object;
}

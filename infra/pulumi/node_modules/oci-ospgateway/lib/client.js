...
class AddressRuleServiceClient {
    constructor(params, clientConfiguration) {
        ...
        if (!oci_common_1.developerToolConfiguration.isServiceEnabled("ospgateway")) {
...
AddressRuleServiceClient.serviceEndpointTemplate = "https://osp-oci-integ.osp.{region}.oci.{secondLevelDomain}";
...
AddressServiceClient.serviceEndpointTemplate = "https://osp-oci-integ.osp.{region}.oci.{secondLevelDomain}";
...
InvoiceServiceClient.serviceEndpointTemplate = "https://osp-oci-integ.osp.{region}.oci.{secondLevelDomain}";
...
SubscriptionServiceClient.serviceEndpointTemplate = "https://osp-oci-integ.osp.{region}.oci.{secondLevelDomain}";

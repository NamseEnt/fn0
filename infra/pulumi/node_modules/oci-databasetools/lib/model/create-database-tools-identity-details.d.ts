...
export declare namespace CreateDatabaseToolsIdentityDetails {
    function getJsonObj(obj: CreateDatabaseToolsIdentityDetails): object;
    function getDeserializedJsonObj(obj: CreateDatabaseToolsIdentityDetails): object;
}

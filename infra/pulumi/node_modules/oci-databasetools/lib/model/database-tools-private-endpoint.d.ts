...
export declare namespace DatabaseToolsPrivateEndpoint {
    function getJsonObj(obj: DatabaseToolsPrivateEndpoint): object;
    function getDeserializedJsonObj(obj: DatabaseToolsPrivateEndpoint): object;
}

...
export declare namespace DatabaseToolsKeyStorePostgresql {
    function getJsonObj(obj: DatabaseToolsKeyStorePostgresql): object;
    function getDeserializedJsonObj(obj: DatabaseToolsKeyStorePostgresql): object;
}

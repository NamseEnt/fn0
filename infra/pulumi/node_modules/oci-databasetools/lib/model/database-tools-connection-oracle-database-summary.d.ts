...
export interface DatabaseToolsConnectionOracleDatabaseSummary extends model.DatabaseToolsConnectionSummary {
    ...
    "proxyClient"?: model.DatabaseToolsConnectionOracleDatabaseProxyClientNoProxySummary | model.DatabaseToolsConnectionOracleDatabaseProxyClientUserNameSummary;
    "type": string;
}

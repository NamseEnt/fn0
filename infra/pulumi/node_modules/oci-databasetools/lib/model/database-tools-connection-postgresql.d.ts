...
export declare namespace DatabaseToolsConnectionPostgresql {
    function getJsonObj(obj: DatabaseToolsConnectionPostgresql, isParentJsonObj?: boolean): object;
    const type = "POSTGRESQL";
    function getDeserializedJsonObj(obj: DatabaseToolsConnectionPostgresql, isParentJsonObj?: boolean): object;
}

...
export declare namespace ValidateDatabaseToolsConnectionOracleDatabaseResult {
    function getJsonObj(obj: ValidateDatabaseToolsConnectionOracleDatabaseResult, isParentJsonObj?: boolean): object;
    const type = "ORACLE_DATABASE";
    function getDeserializedJsonObj(obj: ValidateDatabaseToolsConnectionOracleDatabaseResult, isParentJsonObj?: boolean): object;
}

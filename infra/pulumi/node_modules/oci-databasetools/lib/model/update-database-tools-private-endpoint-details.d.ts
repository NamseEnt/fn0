...
export declare namespace UpdateDatabaseToolsPrivateEndpointDetails {
    function getJsonObj(obj: UpdateDatabaseToolsPrivateEndpointDetails): object;
    function getDeserializedJsonObj(obj: UpdateDatabaseToolsPrivateEndpointDetails): object;
}

...
export declare namespace ValidateDatabaseToolsConnectionResult {
    function getJsonObj(obj: ValidateDatabaseToolsConnectionResult): object;
    function getDeserializedJsonObj(obj: ValidateDatabaseToolsConnectionResult): object;
}

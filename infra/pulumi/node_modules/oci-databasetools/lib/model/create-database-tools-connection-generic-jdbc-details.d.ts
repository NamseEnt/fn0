 ...
 */
export interface CreateDatabaseToolsConnectionGenericJdbcDetails extends model.CreateDatabaseToolsConnectionDetails {
    /**
...
export declare namespace CreateDatabaseToolsConnectionGenericJdbcDetails {
    function getJsonObj(obj: CreateDatabaseToolsConnectionGenericJdbcDetails, isParentJsonObj?: boolean): object;
    const type = "GENERIC_JDBC";
    function getDeserializedJsonObj(obj: CreateDatabaseToolsConnectionGenericJdbcDetails, isParentJsonObj?: boolean): object;
}

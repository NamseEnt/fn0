...
export declare namespace CreateDatabaseToolsConnectionDetails {
    function getJsonObj(obj: CreateDatabaseToolsConnectionDetails): object;
    function getDeserializedJsonObj(obj: CreateDatabaseToolsConnectionDetails): object;
}

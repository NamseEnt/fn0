 ...
 */
export interface UpdateDatabaseToolsConnectionMySqlDetails extends model.UpdateDatabaseToolsConnectionDetails {
...
export declare namespace UpdateDatabaseToolsConnectionMySqlDetails {
    function getJsonObj(obj: UpdateDatabaseToolsConnectionMySqlDetails, isParentJsonObj?: boolean): object;
    const type = "MYSQL";
    function getDeserializedJsonObj(obj: UpdateDatabaseToolsConnectionMySqlDetails, isParentJsonObj?: boolean): object;
}

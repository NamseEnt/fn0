...
export declare class JavaManagementServiceClient {
     ...
     */
    createWaiters(config?: common.WaiterConfiguration): JavaManagementServiceWaiter;
    /**
     * Gets the waiters available for resources for this service.
     *
     * @return The service waiters.
     */
    getWaiters(): JavaManagementServiceWaiter;
    /**
  ...
  *
     ...
     */
    listLibraryApplicationUsage(listLibraryApplicationUsageRequest: requests.ListLibraryApplicationUsageRequest): Promise<responses.ListLibraryApplicationUsageResponse>;
    /**
     ...
     */
    listLibraryManagedInstanceUsage(listLibraryManagedInstanceUsageRequest: requests.ListLibraryManagedInstanceUsageRequest): Promise<responses.ListLibraryManagedInstanceUsageResponse>;
    /**
     ...
     */
    listUncorrelatedPackageApplicationUsage(listUncorrelatedPackageApplicationUsageRequest: requests.ListUncorrelatedPackageApplicationUsageRequest): Promise<responses.ListUncorrelatedPackageApplicationUsageResponse>;
    /**
     ...
     */
    listUncorrelatedPackageManagedInstanceUsage(listUncorrelatedPackageManagedInstanceUsageRequest: requests.ListUncorrelatedPackageManagedInstanceUsageRequest): Promise<responses.ListUncorrelatedPackageManagedInstanceUsageResponse>;
    /**
     ...
     */
    listUncorrelatedPackageUsage(listUncorrelatedPackageUsageRequest: requests.ListUncorrelatedPackageUsageRequest): Promise<responses.ListUncorrelatedPackageUsageResponse>;
    /**
     ...
     */
    summarizeLibraryInventory(summarizeLibraryInventoryRequest: requests.SummarizeLibraryInventoryRequest): Promise<responses.SummarizeLibraryInventoryResponse>;
    /**

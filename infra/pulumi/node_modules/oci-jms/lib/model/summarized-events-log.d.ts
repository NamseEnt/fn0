...
export declare namespace SummarizedEventsLog {
    function getJsonObj(obj: SummarizedEventsLog): object;
    function getDeserializedJsonObj(obj: SummarizedEventsLog): object;
}

...
export declare namespace ScanJavaServerUsageDetails {
    function getJsonObj(obj: ScanJavaServerUsageDetails): object;
    function getDeserializedJsonObj(obj: ScanJavaServerUsageDetails): object;
}

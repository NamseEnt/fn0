...
export declare namespace TaskScheduleSummary {
    function getJsonObj(obj: TaskScheduleSummary): object;
    function getDeserializedJsonObj(obj: TaskScheduleSummary): object;
}

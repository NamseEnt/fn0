...
export declare namespace JavaFamilySummary {
    function getJsonObj(obj: JavaFamilySummary): object;
    function getDeserializedJsonObj(obj: JavaFamilySummary): object;
}

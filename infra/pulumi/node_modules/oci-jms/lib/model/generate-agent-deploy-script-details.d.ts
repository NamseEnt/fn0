...
export declare namespace GenerateAgentDeployScriptDetails {
    function getJsonObj(obj: GenerateAgentDeployScriptDetails): object;
    function getDeserializedJsonObj(obj: GenerateAgentDeployScriptDetails): object;
}

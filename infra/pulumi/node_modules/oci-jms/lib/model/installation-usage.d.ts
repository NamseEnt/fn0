...
export declare namespace InstallationUsage {
    function getJsonObj(obj: InstallationUsage): object;
    function getDeserializedJsonObj(obj: InstallationUsage): object;
}

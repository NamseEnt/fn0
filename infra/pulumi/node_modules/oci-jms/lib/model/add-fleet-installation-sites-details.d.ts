...
export declare namespace AddFleetInstallationSitesDetails {
    function getJsonObj(obj: AddFleetInstallationSitesDetails): object;
    function getDeserializedJsonObj(obj: AddFleetInstallationSitesDetails): object;
}

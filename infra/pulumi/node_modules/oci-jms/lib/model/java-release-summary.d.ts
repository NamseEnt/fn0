...
export declare namespace JavaReleaseSummary {
    enum ArtifactContentTypes {
        Jdk = "JDK",
        Jre = "JRE",
    ...
    function getJsonObj(obj: JavaReleaseSummary): object;
    function getDeserializedJsonObj(obj: JavaReleaseSummary): object;
}

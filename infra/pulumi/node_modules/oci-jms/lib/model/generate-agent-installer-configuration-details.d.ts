...
export declare namespace GenerateAgentInstallerConfigurationDetails {
    function getJsonObj(obj: GenerateAgentInstallerConfigurationDetails): object;
    function getDeserializedJsonObj(obj: GenerateAgentInstallerConfigurationDetails): object;
}

...
export declare namespace UpdateFleetAgentConfigurationDetails {
    function getJsonObj(obj: UpdateFleetAgentConfigurationDetails): object;
    function getDeserializedJsonObj(obj: UpdateFleetAgentConfigurationDetails): object;
}

...
export declare namespace CreateJmsPluginDetails {
    function getJsonObj(obj: CreateJmsPluginDetails): object;
    function getDeserializedJsonObj(obj: CreateJmsPluginDetails): object;
}

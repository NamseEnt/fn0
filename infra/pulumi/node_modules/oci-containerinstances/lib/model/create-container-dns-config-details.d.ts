...
export declare namespace CreateContainerDnsConfigDetails {
    function getJsonObj(obj: CreateContainerDnsConfigDetails): object;
    function getDeserializedJsonObj(obj: CreateContainerDnsConfigDetails): object;
}

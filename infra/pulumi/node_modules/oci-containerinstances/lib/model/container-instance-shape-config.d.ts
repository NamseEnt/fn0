...
export declare namespace ContainerInstanceShapeConfig {
    function getJsonObj(obj: ContainerInstanceShapeConfig): object;
    function getDeserializedJsonObj(obj: ContainerInstanceShapeConfig): object;
}

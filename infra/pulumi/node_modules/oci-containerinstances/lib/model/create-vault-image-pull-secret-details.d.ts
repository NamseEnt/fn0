...
export declare namespace CreateVaultImagePullSecretDetails {
    function getJsonObj(obj: CreateVaultImagePullSecretDetails, isParentJsonObj?: boolean): object;
    const secretType = "VAULT";
    function getDeserializedJsonObj(obj: CreateVaultImagePullSecretDetails, isParentJsonObj?: boolean): object;
}

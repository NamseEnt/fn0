...
export declare namespace ShapeMemoryOptions {
    function getJsonObj(obj: ShapeMemoryOptions): object;
    function getDeserializedJsonObj(obj: ShapeMemoryOptions): object;
}

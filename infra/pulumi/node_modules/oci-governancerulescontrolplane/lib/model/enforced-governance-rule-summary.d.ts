...
export declare namespace EnforcedGovernanceRuleSummary {
    function getJsonObj(obj: EnforcedGovernanceRuleSummary): object;
    function getDeserializedJsonObj(obj: EnforcedGovernanceRuleSummary): object;
}

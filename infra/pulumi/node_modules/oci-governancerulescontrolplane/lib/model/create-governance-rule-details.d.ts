...
export declare namespace CreateGovernanceRuleDetails {
    function getJsonObj(obj: CreateGovernanceRuleDetails): object;
    function getDeserializedJsonObj(obj: CreateGovernanceRuleDetails): object;
}

 ...
 */
export interface CreateDistributedDatabaseCatalogWithExadbXsNewVaultAndClusterDetails extends model.CreateDistributedDatabaseCatalogDetails {
    /**
...
export declare namespace CreateDistributedDatabaseCatalogWithExadbXsNewVaultAndClusterDetails {
    function getJsonObj(obj: CreateDistributedDatabaseCatalogWithExadbXsNewVaultAndClusterDetails, isParentJsonObj?: boolean): object;
    const source = "NEW_VAULT_AND_CLUSTER";
    function getDeserializedJsonObj(obj: CreateDistributedDatabaseCatalogWithExadbXsNewVaultAndClusterDetails, isParentJsonObj?: boolean): object;
}

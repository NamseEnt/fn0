...
export declare namespace CreateCatalogPeerWithDedicatedInfraDetails {
    function getJsonObj(obj: CreateCatalogPeerWithDedicatedInfraDetails): object;
    function getDeserializedJsonObj(obj: CreateCatalogPeerWithDedicatedInfraDetails): object;
}

...
export declare namespace DistributedDatabaseCatalogWithExadbXs {
    enum Status {
        Failed = "FAILED",
        Deleting = "DELETING",
        Deleted = "DELETED",
    ...
    function getJsonObj(obj: DistributedDatabaseCatalogWithExadbXs, isParentJsonObj?: boolean): object;
    const source = "EXADB_XS";
    function getDeserializedJsonObj(obj: DistributedDatabaseCatalogWithExadbXs, isParentJsonObj?: boolean): object;
}

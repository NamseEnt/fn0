...
export declare namespace DistributedDbVmCluster {
    enum LicenseModel {
    ...
    function getJsonObj(obj: DistributedDbVmCluster): object;
    function getDeserializedJsonObj(obj: DistributedDbVmCluster): object;
}

...
export declare namespace DistributedDatabaseShard {
    function getJsonObj(obj: DistributedDatabaseShard): object;
    function getDeserializedJsonObj(obj: DistributedDatabaseShard): object;
}

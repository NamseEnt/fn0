 ...
 *
 */
export interface MoveDistributedDatabaseReplicationUnitDetails {
    /**
...
export declare namespace MoveDistributedDatabaseReplicationUnitDetails {
    function getJsonObj(obj: MoveDistributedDatabaseReplicationUnitDetails): object;
    function getDeserializedJsonObj(obj: MoveDistributedDatabaseReplicationUnitDetails): object;
}

 ...
 */
export interface CreateCatalogPeerWithExadbXsDetails {
    /**
...
export declare namespace CreateCatalogPeerWithExadbXsDetails {
    function getJsonObj(obj: CreateCatalogPeerWithExadbXsDetails): object;
    function getDeserializedJsonObj(obj: CreateCatalogPeerWithExadbXsDetails): object;
}

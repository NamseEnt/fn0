...
export declare namespace DistributedDatabaseGsm {
    enum Status {
        Failed = "FAILED",
        Deleting = "DELETING",
        Deleted = "DELETED",
    ...
    function getJsonObj(obj: DistributedDatabaseGsm): object;
    function getDeserializedJsonObj(obj: DistributedDatabaseGsm): object;
}

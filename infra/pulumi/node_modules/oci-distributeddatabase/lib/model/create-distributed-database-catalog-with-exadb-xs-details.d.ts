 ...
 */
export interface CreateDistributedDatabaseCatalogWithExadbXsDetails extends model.CreateDistributedDatabaseCatalogDetails {
    /**
...
export declare namespace CreateDistributedDatabaseCatalogWithExadbXsDetails {
    function getJsonObj(obj: CreateDistributedDatabaseCatalogWithExadbXsDetails, isParentJsonObj?: boolean): object;
    const source = "EXADB_XS";
    function getDeserializedJsonObj(obj: CreateDistributedDatabaseCatalogWithExadbXsDetails, isParentJsonObj?: boolean): object;
}

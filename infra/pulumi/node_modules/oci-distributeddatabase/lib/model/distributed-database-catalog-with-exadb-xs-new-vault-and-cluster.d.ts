 ...
 */
export interface DistributedDatabaseCatalogWithExadbXsNewVaultAndCluster extends model.DistributedDatabaseCatalog {
    /**
...
export declare namespace DistributedDatabaseCatalogWithExadbXsNewVaultAndCluster {
    enum Status {
        Failed = "FAILED",
        Deleting = "DELETING",
        Deleted = "DELETED",
    ...
    function getJsonObj(obj: DistributedDatabaseCatalogWithExadbXsNewVaultAndCluster, isParentJsonObj?: boolean): object;
    const source = "NEW_VAULT_AND_CLUSTER";
    function getDeserializedJsonObj(obj: DistributedDatabaseCatalogWithExadbXsNewVaultAndCluster, isParentJsonObj?: boolean): object;
}

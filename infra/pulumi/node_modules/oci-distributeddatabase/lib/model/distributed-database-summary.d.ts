 ...
 * Globally distributed database.
 */
export interface DistributedDatabaseSummary {
    /**
    ...
    "listenerPort": number;
    /**
     * The TLS listener port number for the Globally distributed database. Note: Numbers greater than Number.MAX_SAFE_INTEGER will result in rounding issues.
     */
    "listenerPortTls"?: number;
    /**
     * Ons local port number for the Globally distributed database. Note: Numbers greater than Number.MAX_SAFE_INTEGER will result in rounding issues.
     */
    "onsPortLocal": number;
    /**
     * Ons remote port number for the Globally distributed database. Note: Numbers greater than Number.MAX_SAFE_INTEGER will result in rounding issues.
     */
     ...
     *
     */
    "dbDeploymentType": DistributedDatabaseSummary.DbDeploymentType;
...
export declare namespace DistributedDatabaseSummary {
    ...
    function getJsonObj(obj: DistributedDatabaseSummary): object;
    function getDeserializedJsonObj(obj: DistributedDatabaseSummary): object;
}

...
export declare namespace DistributedAutonomousDatabase {
    enum LifecycleState {
        Active = "ACTIVE",
        Failed = "FAILED",
    ...
    function getJsonObj(obj: DistributedAutonomousDatabase): object;
    function getDeserializedJsonObj(obj: DistributedAutonomousDatabase): object;
}

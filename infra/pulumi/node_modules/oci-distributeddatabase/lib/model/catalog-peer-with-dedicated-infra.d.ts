 ...
 */
export interface CatalogPeerWithDedicatedInfra {
    /**
     ...
     */
    "status": CatalogPeerWithDedicatedInfra.Status;
    /**
...
export declare namespace CatalogPeerWithDedicatedInfra {
    enum Status {
        Failed = "FAILED",
        Deleting = "DELETING",
        Deleted = "DELETED",
    ...
    function getJsonObj(obj: CatalogPeerWithDedicatedInfra): object;
    function getDeserializedJsonObj(obj: CatalogPeerWithDedicatedInfra): object;
}

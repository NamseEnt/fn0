...
export declare namespace DistributedDatabase {
    enum LifecycleState {
        Active = "ACTIVE",
        Failed = "FAILED",
    ...
    function getJsonObj(obj: DistributedDatabase): object;
    function getDeserializedJsonObj(obj: DistributedDatabase): object;
}

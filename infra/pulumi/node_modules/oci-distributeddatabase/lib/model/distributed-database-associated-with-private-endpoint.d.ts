 ...
 *
 */
export interface DistributedDatabaseAssociatedWithPrivateEndpoint {
    /**
...
export declare namespace DistributedDatabaseAssociatedWithPrivateEndpoint {
    function getJsonObj(obj: DistributedDatabaseAssociatedWithPrivateEndpoint): object;
    function getDeserializedJsonObj(obj: DistributedDatabaseAssociatedWithPrivateEndpoint): object;
}

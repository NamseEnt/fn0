...
export declare namespace PatchDistributedDatabaseDetails {
    function getJsonObj(obj: PatchDistributedDatabaseDetails): object;
    function getDeserializedJsonObj(obj: PatchDistributedDatabaseDetails): object;
}

...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/distributeddatabase/AddDistributedAutonomousDatabaseGdsControlNode.ts.html |here} to see how to use AddDistributedAutonomousDatabaseGdsControlNodeRequest.
 */
export interface AddDistributedAutonomousDatabaseGdsControlNodeRequest extends common.BaseRequest {
    /**

...
export declare namespace DbSystemSnapshotSummary {
    function getJsonObj(obj: DbSystemSnapshotSummary): object;
    function getDeserializedJsonObj(obj: DbSystemSnapshotSummary): object;
}

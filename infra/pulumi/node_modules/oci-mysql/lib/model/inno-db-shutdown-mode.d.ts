...
*
**/
export declare enum InnoDbShutdownMode {
    Immediate = "IMMEDIATE",
    Fast = "FAST",
    Slow = "SLOW"
}
export declare namespace InnoDbShutdownMode {
    function getJsonObj(obj: InnoDbShutdownMode): InnoDbShutdownMode;
    function getDeserializedJsonObj(obj: InnoDbShutdownMode): InnoDbShutdownMode;
}

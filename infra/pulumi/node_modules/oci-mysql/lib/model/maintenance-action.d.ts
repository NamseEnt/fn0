...
export declare namespace MaintenanceAction {
    function getJsonObj(obj: MaintenanceAction): MaintenanceAction;
    function getDeserializedJsonObj(obj: MaintenanceAction): MaintenanceAction;
}

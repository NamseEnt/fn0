...
export declare namespace CreateChannelSourceFromMysqlDetails {
    function getJsonObj(obj: CreateChannelSourceFromMysqlDetails, isParentJsonObj?: boolean): object;
    const sourceType = "MYSQL";
    function getDeserializedJsonObj(obj: CreateChannelSourceFromMysqlDetails, isParentJsonObj?: boolean): object;
}

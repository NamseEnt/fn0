...
export declare namespace HeatWaveClusterSchemaMemoryEstimate {
    function getJsonObj(obj: HeatWaveClusterSchemaMemoryEstimate): object;
    function getDeserializedJsonObj(obj: HeatWaveClusterSchemaMemoryEstimate): object;
}

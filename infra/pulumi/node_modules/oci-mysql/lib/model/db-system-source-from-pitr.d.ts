...
*
*/
export interface DbSystemSourceFromPitr extends model.DbSystemSource {
    /**
...
export declare namespace DbSystemSourceFromPitr {
    function getJsonObj(obj: DbSystemSourceFromPitr, isParentJsonObj?: boolean): object;
    const sourceType = "PITR";
    function getDeserializedJsonObj(obj: DbSystemSourceFromPitr, isParentJsonObj?: boolean): object;
}

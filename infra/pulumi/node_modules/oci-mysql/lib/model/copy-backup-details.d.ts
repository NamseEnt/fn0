...
export declare namespace CopyBackupDetails {
    function getJsonObj(obj: CopyBackupDetails): object;
    function getDeserializedJsonObj(obj: CopyBackupDetails): object;
}

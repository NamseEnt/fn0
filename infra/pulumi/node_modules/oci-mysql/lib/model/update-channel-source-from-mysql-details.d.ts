 ...
 *
 */
export interface UpdateChannelSourceFromMysqlDetails extends model.UpdateChannelSourceDetails {
    /**
...
export declare namespace UpdateChannelSourceFromMysqlDetails {
    function getJsonObj(obj: UpdateChannelSourceFromMysqlDetails, isParentJsonObj?: boolean): object;
    const sourceType = "MYSQL";
    function getDeserializedJsonObj(obj: UpdateChannelSourceFromMysqlDetails, isParentJsonObj?: boolean): object;
}

...
export declare namespace ErrorOnAnonymousHandling {
    function getJsonObj(obj: ErrorOnAnonymousHandling, isParentJsonObj?: boolean): object;
    const policy = "ERROR_ON_ANONYMOUS";
    function getDeserializedJsonObj(obj: ErrorOnAnonymousHandling, isParentJsonObj?: boolean): object;
}

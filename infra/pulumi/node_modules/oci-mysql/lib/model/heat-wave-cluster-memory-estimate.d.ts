...
export declare namespace HeatWaveClusterMemoryEstimate {
    function getJsonObj(obj: HeatWaveClusterMemoryEstimate): object;
    function getDeserializedJsonObj(obj: HeatWaveClusterMemoryEstimate): object;
}

...
*
**/
export declare enum VersionPreference {
    Oldest = "OLDEST",
...
export declare namespace VersionPreference {
    function getJsonObj(obj: VersionPreference): VersionPreference;
    function getDeserializedJsonObj(obj: VersionPreference): VersionPreference;
}

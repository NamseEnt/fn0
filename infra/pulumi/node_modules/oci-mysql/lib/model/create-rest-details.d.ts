 ...
 *
 */
export interface CreateRestDetails {
    /**
...
export declare namespace CreateRestDetails {
    function getJsonObj(obj: CreateRestDetails): object;
    function getDeserializedJsonObj(obj: CreateRestDetails): object;
}

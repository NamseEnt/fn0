...
export declare namespace ControlledUpdateDbSystemDetails {
    function getJsonObj(obj: ControlledUpdateDbSystemDetails): object;
    function getDeserializedJsonObj(obj: ControlledUpdateDbSystemDetails): object;
}

...
export declare namespace DataStorageDetails {
    function getJsonObj(obj: DataStorageDetails): object;
    function getDeserializedJsonObj(obj: DataStorageDetails): object;
}

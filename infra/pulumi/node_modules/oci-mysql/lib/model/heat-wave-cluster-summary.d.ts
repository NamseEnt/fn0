...
export declare namespace HeatWaveClusterSummary {
    function getJsonObj(obj: HeatWaveClusterSummary): object;
    function getDeserializedJsonObj(obj: HeatWaveClusterSummary): object;
}

 ...
 *
 **/
export declare enum MaintenanceScope {
    All = "ALL",
...
export declare namespace MaintenanceScope {
    function getJsonObj(obj: MaintenanceScope): MaintenanceScope;
    function getDeserializedJsonObj(obj: MaintenanceScope): MaintenanceScope;
}

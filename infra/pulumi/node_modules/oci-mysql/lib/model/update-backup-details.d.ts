...
export declare namespace UpdateBackupDetails {
    function getJsonObj(obj: UpdateBackupDetails): object;
    function getDeserializedJsonObj(obj: UpdateBackupDetails): object;
}

...
export declare namespace HeatWaveClusterTableMemoryEstimate {
    function getJsonObj(obj: HeatWaveClusterTableMemoryEstimate): object;
    function getDeserializedJsonObj(obj: HeatWaveClusterTableMemoryEstimate): object;
}

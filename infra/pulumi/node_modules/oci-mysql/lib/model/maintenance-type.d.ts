...
export declare namespace MaintenanceType {
    function getJsonObj(obj: MaintenanceType): MaintenanceType;
    function getDeserializedJsonObj(obj: MaintenanceType): MaintenanceType;
}

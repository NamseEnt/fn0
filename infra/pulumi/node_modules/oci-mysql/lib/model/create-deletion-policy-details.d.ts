...
export declare namespace CreateDeletionPolicyDetails {
    ...
    function getJsonObj(obj: CreateDeletionPolicyDetails): object;
    function getDeserializedJsonObj(obj: CreateDeletionPolicyDetails): object;
}

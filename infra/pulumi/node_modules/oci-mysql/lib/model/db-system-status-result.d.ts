...
export declare namespace DbSystemStatusResult {
    function getJsonObj(obj: DbSystemStatusResult): object;
    function getDeserializedJsonObj(obj: DbSystemStatusResult): object;
}

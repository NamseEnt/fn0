...
class ChannelsClient {
     ...
     */
    generateChannelStatus(generateChannelStatusRequest) {
        return __awaiter(this, void 0, void 0, function* () {
            if (this.logger)
                this.logger.debug("Calling operation ChannelsClient#generateChannelStatus.");
            const operationName = "generateChannelStatus";
            const apiReferenceLink = "https://docs.oracle.com/iaas/api/#/en/mysql/20190415/ChannelStatus/GenerateChannelStatus";
            const pathParams = {
            ...
            const specRetryConfiguration = common.OciSdkDefaultRetryConfiguration;
            const retrier = oci_common_2.GenericRetrier.createPreferredRetrier(this._clientConfiguration ? this._clientConfiguration.retryConfiguration : undefined, generateChannelStatusRequest.retryConfiguration, specRetryConfiguration);
            if (this.logger)
                retrier.logger = this.logger;
            const request = yield oci_common_2.composeRequest({
                baseEndpoint: this._endpoint,
     ...
     */
    getChannelStatus(getChannelStatusRequest) {
        return __awaiter(this, void 0, void 0, function* () {
            if (this.logger)
                this.logger.debug("Calling operation ChannelsClient#getChannelStatus.");
            const operationName = "getChannelStatus";
            const apiReferenceLink = "https://docs.oracle.com/iaas/api/#/en/mysql/20190415/ChannelStatus/GetChannelStatus";
            const pathParams = {
            ...
            const specRetryConfiguration = common.OciSdkDefaultRetryConfiguration;
            const retrier = oci_common_2.GenericRetrier.createPreferredRetrier(this._clientConfiguration ? this._clientConfiguration.retryConfiguration : undefined, getChannelStatusRequest.retryConfiguration, specRetryConfiguration);
            if (this.logger)
                retrier.logger = this.logger;
            const request = yield oci_common_2.composeRequest({
                baseEndpoint: this._endpoint,
...
class DbSystemClient {
     ...
     */
    generateDbSystemStatus(generateDbSystemStatusRequest) {
        return __awaiter(this, void 0, void 0, function* () {
            if (this.logger)
                this.logger.debug("Calling operation DbSystemClient#generateDbSystemStatus.");
            const operationName = "generateDbSystemStatus";
            const apiReferenceLink = "https://docs.oracle.com/iaas/api/#/en/mysql/20190415/DbSystemStatus/GenerateDbSystemStatus";
            const pathParams = {
            ...
            const specRetryConfiguration = common.OciSdkDefaultRetryConfiguration;
            const retrier = oci_common_2.GenericRetrier.createPreferredRetrier(this._clientConfiguration ? this._clientConfiguration.retryConfiguration : undefined, generateDbSystemStatusRequest.retryConfiguration, specRetryConfiguration);
            if (this.logger)
                retrier.logger = this.logger;
            const request = yield oci_common_2.composeRequest({
                baseEndpoint: this._endpoint,
                ...
                method: "POST",
                bodyContent: common.ObjectSerializer.serialize(generateDbSystemStatusRequest.generateDbSystemStatusDetails, "GenerateDbSystemStatusDetails", model.GenerateDbSystemStatusDetails.getJsonObj),
                pathParams: pathParams,
                headerParams: headerParams,
                queryParams: queryParams
            });
     ...
     */
    getDbSystemStatus(getDbSystemStatusRequest) {
        return __awaiter(this, void 0, void 0, function* () {
            if (this.logger)
                this.logger.debug("Calling operation DbSystemClient#getDbSystemStatus.");
            const operationName = "getDbSystemStatus";
            const apiReferenceLink = "https://docs.oracle.com/iaas/api/#/en/mysql/20190415/DbSystemStatus/GetDbSystemStatus";
            const pathParams = {
            ...
            const specRetryConfiguration = common.OciSdkDefaultRetryConfiguration;
            const retrier = oci_common_2.GenericRetrier.createPreferredRetrier(this._clientConfiguration ? this._clientConfiguration.retryConfiguration : undefined, getDbSystemStatusRequest.retryConfiguration, specRetryConfiguration);
            if (this.logger)
                retrier.logger = this.logger;
            const request = yield oci_common_2.composeRequest({
                baseEndpoint: this._endpoint,
     ...
     */
    listMaintenanceEvents(listMaintenanceEventsRequest) {
        return __awaiter(this, void 0, void 0, function* () {
            if (this.logger)
                this.logger.debug("Calling operation DbSystemClient#listMaintenanceEvents.");
            const operationName = "listMaintenanceEvents";
            const apiReferenceLink = "https://docs.oracle.com/iaas/api/#/en/mysql/20190415/MaintenanceEvent/ListMaintenanceEvents";
            const pathParams = {
            ...
            const specRetryConfiguration = common.OciSdkDefaultRetryConfiguration;
            const retrier = oci_common_2.GenericRetrier.createPreferredRetrier(this._clientConfiguration ? this._clientConfiguration.retryConfiguration : undefined, listMaintenanceEventsRequest.retryConfiguration, specRetryConfiguration);
            if (this.logger)
                retrier.logger = this.logger;
            const request = yield oci_common_2.composeRequest({
                baseEndpoint: this._endpoint,
     ...
     * @param request a request which can be sent to the service operation
     */
    listAllMaintenanceEvents(request) {
        return oci_common_1.paginateRecords(request, req => this.listMaintenanceEvents(req));
    }
    /**
     ...
     * @param request a request which can be sent to the service operation
     */
    listAllMaintenanceEventsResponses(request) {
        return oci_common_1.paginateResponses(request, req => this.listMaintenanceEvents(req));
    }
    /**
     * Creates a new async iterator which will iterate over the models.MaintenanceEvent objects
     * contained in responses from the listMaintenanceEvents operation. This iterator will fetch more data from the
     ...
     * @param request a request which can be sent to the service operation
     */
    listMaintenanceEventsRecordIterator(request) {
        return oci_common_1.paginateRecords(request, req => this.listMaintenanceEvents(req));
    }
    /**
     * Creates a new async iterator which will iterate over the responses received from the listMaintenanceEvents operation. This iterator
     ...
     * @param request a request which can be sent to the service operation
     */
    listMaintenanceEventsResponseIterator(request) {
        return oci_common_1.paginateResponses(request, req => this.listMaintenanceEvents(req));
    }
    /**

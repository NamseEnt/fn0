...
export declare class DbBackupsWaiter {
    private client;
    private readonly config?;
    constructor(client: DbBackupsClient, config?: Partial<import("oci-common/lib/waiter").WaiterConfigurationDetails> | undefined);
    /**

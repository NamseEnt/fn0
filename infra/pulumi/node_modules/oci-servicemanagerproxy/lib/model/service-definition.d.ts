...
export declare namespace ServiceDefinition {
    function getJsonObj(obj: ServiceDefinition): object;
    function getDeserializedJsonObj(obj: ServiceDefinition): object;
}

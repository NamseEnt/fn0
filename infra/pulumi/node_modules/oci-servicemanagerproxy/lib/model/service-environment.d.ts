...
export declare namespace ServiceEnvironment {
    function getJsonObj(obj: ServiceEnvironment): object;
    function getDeserializedJsonObj(obj: ServiceEnvironment): object;
}

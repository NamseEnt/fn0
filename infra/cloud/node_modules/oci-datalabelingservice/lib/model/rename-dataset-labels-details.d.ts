...
export declare namespace RenameDatasetLabelsDetails {
    function getJsonObj(obj: RenameDatasetLabelsDetails): object;
    function getDeserializedJsonObj(obj: RenameDatasetLabelsDetails): object;
}

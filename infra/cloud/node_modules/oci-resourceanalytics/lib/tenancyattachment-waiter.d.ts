...
export declare class TenancyAttachmentWaiter {
    private client;
    private readonly config?;
    constructor(client: TenancyAttachmentClient, config?: Partial<import("oci-common/lib/waiter").WaiterConfigurationDetails> | undefined);
    /**

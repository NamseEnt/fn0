...
export declare namespace CreateTenancyAttachmentDetails {
    function getJsonObj(obj: CreateTenancyAttachmentDetails): object;
    function getDeserializedJsonObj(obj: CreateTenancyAttachmentDetails): object;
}

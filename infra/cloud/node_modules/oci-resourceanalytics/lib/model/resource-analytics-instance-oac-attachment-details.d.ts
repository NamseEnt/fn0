...
export declare namespace ResourceAnalyticsInstanceOacAttachmentDetails {
    enum LicenseModel {
        LicenseIncluded = "LICENSE_INCLUDED",
        BringYourOwnLicense = "BRING_YOUR_OWN_LICENSE"
    }
    function getJsonObj(obj: ResourceAnalyticsInstanceOacAttachmentDetails): object;
    function getDeserializedJsonObj(obj: ResourceAnalyticsInstanceOacAttachmentDetails): object;
}

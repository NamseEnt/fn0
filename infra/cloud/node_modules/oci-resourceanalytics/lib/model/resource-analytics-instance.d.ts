...
export declare namespace ResourceAnalyticsInstance {
    enum LifecycleState {
        Creating = "CREATING",
        Updating = "UPDATING",
        Active = "ACTIVE",
    ...
    function getJsonObj(obj: ResourceAnalyticsInstance): object;
    function getDeserializedJsonObj(obj: ResourceAnalyticsInstance): object;
}

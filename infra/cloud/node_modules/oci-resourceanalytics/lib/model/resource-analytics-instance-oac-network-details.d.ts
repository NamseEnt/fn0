...
* <p>
Example: {@code {\"subnetId\":\"ocid...\", ...}}
*
*/
export interface ResourceAnalyticsInstanceOacNetworkDetails {
    /**
...
export declare namespace ResourceAnalyticsInstanceOacNetworkDetails {
    function getJsonObj(obj: ResourceAnalyticsInstanceOacNetworkDetails): object;
    function getDeserializedJsonObj(obj: ResourceAnalyticsInstanceOacNetworkDetails): object;
}

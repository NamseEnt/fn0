...
export declare namespace QueryResultRowTypeSummary {
    function getJsonObj(obj: QueryResultRowTypeSummary): object;
    function getDeserializedJsonObj(obj: QueryResultRowTypeSummary): object;
}

...
export declare namespace QueryResultResponse {
    function getJsonObj(obj: QueryResultResponse): object;
    function getDeserializedJsonObj(obj: QueryResultResponse): object;
}

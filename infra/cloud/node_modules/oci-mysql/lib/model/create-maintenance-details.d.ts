...
export declare namespace CreateMaintenanceDetails {
    function getJsonObj(obj: CreateMaintenanceDetails): object;
    function getDeserializedJsonObj(obj: CreateMaintenanceDetails): object;
}

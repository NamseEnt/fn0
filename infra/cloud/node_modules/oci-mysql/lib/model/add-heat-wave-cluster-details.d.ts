...
export declare namespace AddHeatWaveClusterDetails {
    function getJsonObj(obj: AddHeatWaveClusterDetails): object;
    function getDeserializedJsonObj(obj: AddHeatWaveClusterDetails): object;
}

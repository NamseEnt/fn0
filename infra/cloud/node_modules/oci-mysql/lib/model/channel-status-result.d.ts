...
export declare namespace ChannelStatusResult {
    function getJsonObj(obj: ChannelStatusResult): object;
    function getDeserializedJsonObj(obj: ChannelStatusResult): object;
}

...
export declare namespace ChannelTargetDbSystem {
    enum TablesWithoutPrimaryKeyHandling {
    ...
    function getJsonObj(obj: ChannelTargetDbSystem, isParentJsonObj?: boolean): object;
    const targetType = "DBSYSTEM";
    function getDeserializedJsonObj(obj: ChannelTargetDbSystem, isParentJsonObj?: boolean): object;
}

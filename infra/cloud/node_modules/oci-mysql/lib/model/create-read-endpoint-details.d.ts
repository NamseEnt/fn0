...
export declare namespace CreateReadEndpointDetails {
    function getJsonObj(obj: CreateReadEndpointDetails): object;
    function getDeserializedJsonObj(obj: CreateReadEndpointDetails): object;
}

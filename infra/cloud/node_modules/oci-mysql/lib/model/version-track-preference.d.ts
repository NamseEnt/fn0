 ...
 *
 **/
export declare enum VersionTrackPreference {
...
export declare namespace VersionTrackPreference {
    function getJsonObj(obj: VersionTrackPreference): VersionTrackPreference;
    function getDeserializedJsonObj(obj: VersionTrackPreference): VersionTrackPreference;
}

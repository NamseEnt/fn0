 ...
 *
 */
export interface ReadEndpointDetails {
    /**
...
export declare namespace ReadEndpointDetails {
    function getJsonObj(obj: ReadEndpointDetails): object;
    function getDeserializedJsonObj(obj: ReadEndpointDetails): object;
}

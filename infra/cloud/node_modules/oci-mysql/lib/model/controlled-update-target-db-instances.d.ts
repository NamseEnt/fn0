 ...
 *
 **/
export declare enum ControlledUpdateTargetDbInstances {
...
export declare namespace ControlledUpdateTargetDbInstances {
    function getJsonObj(obj: ControlledUpdateTargetDbInstances): ControlledUpdateTargetDbInstances;
    function getDeserializedJsonObj(obj: ControlledUpdateTargetDbInstances): ControlledUpdateTargetDbInstances;
}

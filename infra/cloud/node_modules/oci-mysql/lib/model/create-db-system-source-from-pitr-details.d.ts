...
export declare namespace CreateDbSystemSourceFromPitrDetails {
    function getJsonObj(obj: CreateDbSystemSourceFromPitrDetails, isParentJsonObj?: boolean): object;
    const sourceType = "PITR";
    function getDeserializedJsonObj(obj: CreateDbSystemSourceFromPitrDetails, isParentJsonObj?: boolean): object;
}

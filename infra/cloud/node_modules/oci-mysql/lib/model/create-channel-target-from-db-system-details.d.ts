...
export declare namespace CreateChannelTargetFromDbSystemDetails {
    function getJsonObj(obj: CreateChannelTargetFromDbSystemDetails, isParentJsonObj?: boolean): object;
    const targetType = "DBSYSTEM";
    function getDeserializedJsonObj(obj: CreateChannelTargetFromDbSystemDetails, isParentJsonObj?: boolean): object;
}

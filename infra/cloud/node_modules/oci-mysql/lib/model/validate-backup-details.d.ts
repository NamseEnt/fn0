 ...
 */
export interface ValidateBackupDetails {
    /**
...
export declare namespace ValidateBackupDetails {
    function getJsonObj(obj: ValidateBackupDetails): object;
    function getDeserializedJsonObj(obj: ValidateBackupDetails): object;
}

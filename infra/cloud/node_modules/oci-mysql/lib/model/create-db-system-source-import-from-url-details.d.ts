 ...
 *
 */
export interface CreateDbSystemSourceImportFromUrlDetails extends model.CreateDbSystemSourceDetails {
    /**
...
export declare namespace CreateDbSystemSourceImportFromUrlDetails {
    function getJsonObj(obj: CreateDbSystemSourceImportFromUrlDetails, isParentJsonObj?: boolean): object;
    const sourceType = "IMPORTURL";
    function getDeserializedJsonObj(obj: CreateDbSystemSourceImportFromUrlDetails, isParentJsonObj?: boolean): object;
}

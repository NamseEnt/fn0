...
export declare namespace UpdateChannelTargetFromDbSystemDetails {
    function getJsonObj(obj: UpdateChannelTargetFromDbSystemDetails, isParentJsonObj?: boolean): object;
    const targetType = "DBSYSTEM";
    function getDeserializedJsonObj(obj: UpdateChannelTargetFromDbSystemDetails, isParentJsonObj?: boolean): object;
}

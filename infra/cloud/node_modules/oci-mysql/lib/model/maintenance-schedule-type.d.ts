...
export declare namespace MaintenanceScheduleType {
    function getJsonObj(obj: MaintenanceScheduleType): MaintenanceScheduleType;
    function getDeserializedJsonObj(obj: MaintenanceScheduleType): MaintenanceScheduleType;
}

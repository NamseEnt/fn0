...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/aidataplatform/DeleteAiDataPlatform.ts.html |here} to see how to use DeleteAiDataPlatformRequest.
 */
export interface DeleteAiDataPlatformRequest extends common.BaseRequest {
    /**

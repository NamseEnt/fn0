 ...
 */
export interface AiDataPlatformSummary {
    /**
...
export declare namespace AiDataPlatformSummary {
    function getJsonObj(obj: AiDataPlatformSummary): object;
    function getDeserializedJsonObj(obj: AiDataPlatformSummary): object;
}

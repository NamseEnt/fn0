...
exports.DashboardGroupWaiter = void 0;
const models = __importStar(require("./model"));
const oci_common_1 = require("oci-common");
class DashboardGroupWaiter {
     ...
     */
    forDashboardGroup(request, ...targetStates) {
        return __awaiter(this, void 0, void 0, function* () {
            return oci_common_1.genericTerminalConditionWaiter(this.config, () => this.client.getDashboardGroup(request), response => targetStates.includes(response.dashboardGroup.lifecycleState), targetStates.includes(models.DashboardGroup.LifecycleState.Deleted));
        });
    }
}
exports.DashboardGroupWaiter = DashboardGroupWaiter;
//# sourceMappingURL=dashboardgroup-waiter.js.map
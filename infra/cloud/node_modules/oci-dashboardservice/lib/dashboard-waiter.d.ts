...
export declare class DashboardWaiter {
    private client;
    private readonly config?;
    constructor(client: DashboardClient, config?: Partial<import("oci-common/lib/waiter").WaiterConfigurationDetails> | undefined);
    /**
     ...
     */
    forDashboard(request: serviceRequests.GetDashboardRequest, ...targetStates: models.Dashboard.LifecycleState[]): Promise<serviceResponses.GetDashboardResponse | null>;
}

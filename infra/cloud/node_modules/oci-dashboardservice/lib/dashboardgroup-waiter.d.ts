...
export declare class DashboardGroupWaiter {
    private client;
    private readonly config?;
    constructor(client: DashboardGroupClient, config?: Partial<import("oci-common/lib/waiter").WaiterConfigurationDetails> | undefined);
    /**
     ...
     */
    forDashboardGroup(request: serviceRequests.GetDashboardGroupRequest, ...targetStates: models.DashboardGroup.LifecycleState[]): Promise<serviceResponses.GetDashboardGroupResponse | null>;
}

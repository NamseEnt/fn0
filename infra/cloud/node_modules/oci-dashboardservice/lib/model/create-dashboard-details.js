...
exports.CreateDashboardDetails = void 0;
const model = __importStar(require("../model"));
const common = require("oci-common");
var CreateDashboardDetails;
(function (CreateDashboardDetails) {
    function getJsonObj(obj) {
        const jsonObj = Object.assign(Object.assign({}, obj), {});
        if (obj && "schemaVersion" in obj && obj.schemaVersion) {
            switch (obj.schemaVersion) {
                case "V1":
                    return model.CreateV1DashboardDetails.getJsonObj(jsonObj, true);
                default:
                    if (common.LOG.logger)
                        common.LOG.logger.info(`Unknown value for: ${obj.schemaVersion}`);
            }
        }
        return jsonObj;
    }
    CreateDashboardDetails.getJsonObj = getJsonObj;
    function getDeserializedJsonObj(obj) {
        const jsonObj = Object.assign(Object.assign({}, obj), {});
        if (obj && "schemaVersion" in obj && obj.schemaVersion) {
            switch (obj.schemaVersion) {
                case "V1":
                    return model.CreateV1DashboardDetails.getDeserializedJsonObj(jsonObj, true);
                default:
                    if (common.LOG.logger)
                        common.LOG.logger.info(`Unknown value for: ${obj.schemaVersion}`);
            }
    ...
    CreateDashboardDetails.getDeserializedJsonObj = getDeserializedJsonObj;
})(CreateDashboardDetails = exports.CreateDashboardDetails || (exports.CreateDashboardDetails = {}));
//# sourceMappingURL=create-dashboard-details.js.map
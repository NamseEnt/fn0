...
export declare namespace CreateDashboardDetails {
    function getJsonObj(obj: CreateDashboardDetails): object;
    function getDeserializedJsonObj(obj: CreateDashboardDetails): object;
}

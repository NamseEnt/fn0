...
export declare namespace ChangeDashboardGroupCompartmentDetails {
    function getJsonObj(obj: ChangeDashboardGroupCompartmentDetails): object;
    function getDeserializedJsonObj(obj: ChangeDashboardGroupCompartmentDetails): object;
}

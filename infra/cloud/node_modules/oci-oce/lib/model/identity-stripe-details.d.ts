...
export declare namespace IdentityStripeDetails {
    function getJsonObj(obj: IdentityStripeDetails): object;
    function getDeserializedJsonObj(obj: IdentityStripeDetails): object;
}

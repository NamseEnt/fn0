...
export declare namespace OceInstance {
    enum UpgradeSchedule {
    ...
    function getJsonObj(obj: OceInstance): object;
    function getDeserializedJsonObj(obj: OceInstance): object;
}

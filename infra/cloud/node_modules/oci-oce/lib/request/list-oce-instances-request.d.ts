...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/oce/ListOceInstances.ts.html |here} to see how to use ListOceInstancesRequest.
 */
...
export declare namespace ListOceInstancesRequest {
    enum SortOrder {
        Asc = "ASC",
        Desc = "DESC"
    }

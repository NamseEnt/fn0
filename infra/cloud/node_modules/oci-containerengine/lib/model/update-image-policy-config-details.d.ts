...
export declare namespace UpdateImagePolicyConfigDetails {
    function getJsonObj(obj: UpdateImagePolicyConfigDetails): object;
    function getDeserializedJsonObj(obj: UpdateImagePolicyConfigDetails): object;
}

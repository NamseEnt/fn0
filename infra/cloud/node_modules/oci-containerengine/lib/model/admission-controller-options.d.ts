...
export declare namespace AdmissionControllerOptions {
    function getJsonObj(obj: AdmissionControllerOptions): object;
    function getDeserializedJsonObj(obj: AdmissionControllerOptions): object;
}

...
export declare namespace CredentialRotationStatus {
    enum Status {
    ...
    function getJsonObj(obj: CredentialRotationStatus): object;
    function getDeserializedJsonObj(obj: CredentialRotationStatus): object;
}

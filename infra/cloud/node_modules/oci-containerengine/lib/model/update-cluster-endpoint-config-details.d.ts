...
export declare namespace UpdateClusterEndpointConfigDetails {
    function getJsonObj(obj: UpdateClusterEndpointConfigDetails): object;
    function getDeserializedJsonObj(obj: UpdateClusterEndpointConfigDetails): object;
}

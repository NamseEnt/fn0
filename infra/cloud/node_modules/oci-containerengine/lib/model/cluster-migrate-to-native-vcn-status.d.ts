...
export declare namespace ClusterMigrateToNativeVcnStatus {
    enum State {
    ...
    function getJsonObj(obj: ClusterMigrateToNativeVcnStatus): object;
    function getDeserializedJsonObj(obj: ClusterMigrateToNativeVcnStatus): object;
}

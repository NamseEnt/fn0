 ...
 */
export interface ExtendEndpointDecommissionRollbackDeadlineDetails {
    /**
...
export declare namespace ExtendEndpointDecommissionRollbackDeadlineDetails {
    function getJsonObj(obj: ExtendEndpointDecommissionRollbackDeadlineDetails): object;
    function getDeserializedJsonObj(obj: ExtendEndpointDecommissionRollbackDeadlineDetails): object;
}

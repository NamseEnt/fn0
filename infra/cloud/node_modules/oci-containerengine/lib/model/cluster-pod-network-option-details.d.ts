...
export declare namespace ClusterPodNetworkOptionDetails {
    function getJsonObj(obj: ClusterPodNetworkOptionDetails): object;
    function getDeserializedJsonObj(obj: ClusterPodNetworkOptionDetails): object;
}

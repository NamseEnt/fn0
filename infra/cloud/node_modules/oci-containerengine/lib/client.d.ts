...
export declare class ContainerEngineClient {
     ...
     */
    extendEndpointDecommissionRollbackDeadline(extendEndpointDecommissionRollbackDeadlineRequest: requests.ExtendEndpointDecommissionRollbackDeadlineRequest): Promise<responses.ExtendEndpointDecommissionRollbackDeadlineResponse>;
    /**
     ...
     */
    getPublicApiEndpointDecommissionStatus(getPublicApiEndpointDecommissionStatusRequest: requests.GetPublicApiEndpointDecommissionStatusRequest): Promise<responses.GetPublicApiEndpointDecommissionStatusResponse>;
    /**
     ...
     */
    rollbackPublicApiEndpointDecommission(rollbackPublicApiEndpointDecommissionRequest: requests.RollbackPublicApiEndpointDecommissionRequest): Promise<responses.RollbackPublicApiEndpointDecommissionResponse>;
    /**
     ...
     */
    startPublicApiEndpointDecommission(startPublicApiEndpointDecommissionRequest: requests.StartPublicApiEndpointDecommissionRequest): Promise<responses.StartPublicApiEndpointDecommissionResponse>;
    /**

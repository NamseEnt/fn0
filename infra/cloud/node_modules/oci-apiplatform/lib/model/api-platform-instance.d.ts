...
export declare namespace ApiPlatformInstance {
    enum LifecycleState {
        Creating = "CREATING",
        Updating = "UPDATING",
        Active = "ACTIVE",
    ...
    function getJsonObj(obj: ApiPlatformInstance): object;
    function getDeserializedJsonObj(obj: ApiPlatformInstance): object;
}

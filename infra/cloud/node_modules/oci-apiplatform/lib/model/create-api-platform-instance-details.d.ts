 ...
 */
export interface CreateApiPlatformInstanceDetails {
    /**
...
export declare namespace CreateApiPlatformInstanceDetails {
    function getJsonObj(obj: CreateApiPlatformInstanceDetails): object;
    function getDeserializedJsonObj(obj: CreateApiPlatformInstanceDetails): object;
}

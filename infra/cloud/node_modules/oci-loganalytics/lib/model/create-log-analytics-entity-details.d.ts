...
export declare namespace CreateLogAnalyticsEntityDetails {
    function getJsonObj(obj: CreateLogAnalyticsEntityDetails): object;
    function getDeserializedJsonObj(obj: CreateLogAnalyticsEntityDetails): object;
}

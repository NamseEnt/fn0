...
export declare namespace AssociationProperty {
    function getJsonObj(obj: AssociationProperty): object;
    function getDeserializedJsonObj(obj: AssociationProperty): object;
}

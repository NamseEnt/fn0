...
export declare namespace LogAnalyticsObjectCollectionRuleSummary {
    function getJsonObj(obj: LogAnalyticsObjectCollectionRuleSummary): object;
    function getDeserializedJsonObj(obj: LogAnalyticsObjectCollectionRuleSummary): object;
}

...
export interface EndpointCredentials {
     ...
     *
     */
    "credentialType"?: EndpointCredentials.CredentialType;
    /**
...
export declare namespace EndpointCredentials {
    enum CredentialType {
        None = "NONE",
    ...
    function getJsonObj(obj: EndpointCredentials): object;
    function getDeserializedJsonObj(obj: EndpointCredentials): object;
}

...
export declare namespace LogAnalyticsLookupFields {
    function getJsonObj(obj: LogAnalyticsLookupFields): object;
    function getDeserializedJsonObj(obj: LogAnalyticsLookupFields): object;
}

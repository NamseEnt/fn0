 ...
 *
 **/
export declare enum StorageOperationType {
...
export declare namespace StorageOperationType {
    function getJsonObj(obj: StorageOperationType): StorageOperationType;
    function getDeserializedJsonObj(obj: StorageOperationType): StorageOperationType;
}

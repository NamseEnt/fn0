...
export declare namespace LogAnalyticsPatternFilter {
    function getJsonObj(obj: LogAnalyticsPatternFilter): object;
    function getDeserializedJsonObj(obj: LogAnalyticsPatternFilter): object;
}

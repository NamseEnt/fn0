...
export declare namespace FileValidationResponse {
    function getJsonObj(obj: FileValidationResponse): object;
    function getDeserializedJsonObj(obj: FileValidationResponse): object;
}

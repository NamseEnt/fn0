...
export declare namespace LogAnalyticsParserFunction {
    function getJsonObj(obj: LogAnalyticsParserFunction): object;
    function getDeserializedJsonObj(obj: LogAnalyticsParserFunction): object;
}

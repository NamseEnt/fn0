...
export declare namespace LogAnalyticsResourceCategoryCollection {
    function getJsonObj(obj: LogAnalyticsResourceCategoryCollection): object;
    function getDeserializedJsonObj(obj: LogAnalyticsResourceCategoryCollection): object;
}

...
export declare namespace LogAnalyticsEmBridge {
    function getJsonObj(obj: LogAnalyticsEmBridge): object;
    function getDeserializedJsonObj(obj: LogAnalyticsEmBridge): object;
}

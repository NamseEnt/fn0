...
export declare namespace EffectivePropertySummary {
    function getJsonObj(obj: EffectivePropertySummary): object;
    function getDeserializedJsonObj(obj: EffectivePropertySummary): object;
}

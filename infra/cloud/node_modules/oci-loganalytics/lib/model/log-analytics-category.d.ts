...
export declare namespace LogAnalyticsCategory {
    function getJsonObj(obj: LogAnalyticsCategory): object;
    function getDeserializedJsonObj(obj: LogAnalyticsCategory): object;
}

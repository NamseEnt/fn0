...
export declare namespace LogAnalyticsParserSummary {
    enum Type {
        Xml = "XML",
        Json = "JSON",
        Regex = "REGEX",
    ...
    function getJsonObj(obj: LogAnalyticsParserSummary): object;
    function getDeserializedJsonObj(obj: LogAnalyticsParserSummary): object;
}

...
export declare namespace StreamAction {
    function getJsonObj(obj: StreamAction, isParentJsonObj?: boolean): object;
    const type = "STREAM";
    function getDeserializedJsonObj(obj: StreamAction, isParentJsonObj?: boolean): object;
}

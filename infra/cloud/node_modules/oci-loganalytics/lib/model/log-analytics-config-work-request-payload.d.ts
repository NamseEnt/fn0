...
export declare namespace LogAnalyticsConfigWorkRequestPayload {
    function getJsonObj(obj: LogAnalyticsConfigWorkRequestPayload): object;
    function getDeserializedJsonObj(obj: LogAnalyticsConfigWorkRequestPayload): object;
}

...
export declare namespace ArchivingConfiguration {
    function getJsonObj(obj: ArchivingConfiguration): object;
    function getDeserializedJsonObj(obj: ArchivingConfiguration): object;
}

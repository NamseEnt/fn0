...
export declare namespace TimeStatsCommandDescriptor {
    function getJsonObj(obj: TimeStatsCommandDescriptor, isParentJsonObj?: boolean): object;
    const name = "TIME_STATS";
    function getDeserializedJsonObj(obj: TimeStatsCommandDescriptor, isParentJsonObj?: boolean): object;
}

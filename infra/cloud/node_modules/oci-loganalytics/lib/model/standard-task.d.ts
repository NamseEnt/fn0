...
export declare namespace StandardTask {
    ...
    function getJsonObj(obj: StandardTask, isParentJsonObj?: boolean): object;
    const kind = "STANDARD";
    function getDeserializedJsonObj(obj: StandardTask, isParentJsonObj?: boolean): object;
}

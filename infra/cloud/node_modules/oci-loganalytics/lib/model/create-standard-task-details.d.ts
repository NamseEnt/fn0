...
export declare namespace CreateStandardTaskDetails {
    function getJsonObj(obj: CreateStandardTaskDetails, isParentJsonObj?: boolean): object;
    const kind = "STANDARD";
    function getDeserializedJsonObj(obj: CreateStandardTaskDetails, isParentJsonObj?: boolean): object;
}

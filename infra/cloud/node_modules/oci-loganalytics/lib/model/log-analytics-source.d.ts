...
export declare namespace LogAnalyticsSource {
    enum LifecycleState {
        Active = "ACTIVE",
        Deleted = "DELETED",
        /**
    ...
    function getJsonObj(obj: LogAnalyticsSource): object;
    function getDeserializedJsonObj(obj: LogAnalyticsSource): object;
}

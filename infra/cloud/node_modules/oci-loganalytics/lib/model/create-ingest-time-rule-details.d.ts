...
export declare namespace CreateIngestTimeRuleDetails {
    function getJsonObj(obj: CreateIngestTimeRuleDetails): object;
    function getDeserializedJsonObj(obj: CreateIngestTimeRuleDetails): object;
}

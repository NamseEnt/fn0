...
export declare namespace ChartDataColumn {
    function getJsonObj(obj: ChartDataColumn, isParentJsonObj?: boolean): object;
    const type = "CHART_DATA_COLUMN";
    function getDeserializedJsonObj(obj: ChartDataColumn, isParentJsonObj?: boolean): object;
}

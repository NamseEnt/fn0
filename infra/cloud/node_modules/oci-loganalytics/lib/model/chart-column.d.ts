...
export declare namespace ChartColumn {
    function getJsonObj(obj: ChartColumn, isParentJsonObj?: boolean): object;
    const type = "CHART_COLUMN";
    function getDeserializedJsonObj(obj: ChartColumn, isParentJsonObj?: boolean): object;
}

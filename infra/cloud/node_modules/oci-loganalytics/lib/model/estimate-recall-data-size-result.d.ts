...
export declare namespace EstimateRecallDataSizeResult {
    function getJsonObj(obj: EstimateRecallDataSizeResult): object;
    function getDeserializedJsonObj(obj: EstimateRecallDataSizeResult): object;
}

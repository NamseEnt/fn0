...
export declare namespace FieldSummaryReport {
    function getJsonObj(obj: FieldSummaryReport): object;
    function getDeserializedJsonObj(obj: FieldSummaryReport): object;
}

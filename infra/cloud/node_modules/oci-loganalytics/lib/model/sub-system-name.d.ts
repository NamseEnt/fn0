 ...
 *
 **/
export declare enum SubSystemName {
    Log = "LOG",
    /**
...
export declare namespace SubSystemName {
    function getJsonObj(obj: SubSystemName): SubSystemName;
    function getDeserializedJsonObj(obj: SubSystemName): SubSystemName;
}

...
export declare namespace LogListTypeEndpoint {
    function getJsonObj(obj: LogListTypeEndpoint, isParentJsonObj?: boolean): object;
    const endpointType = "LOG_LIST";
    function getDeserializedJsonObj(obj: LogListTypeEndpoint, isParentJsonObj?: boolean): object;
}

...
export declare namespace LogAnalyticsMetaSourceType {
    function getJsonObj(obj: LogAnalyticsMetaSourceType): object;
    function getDeserializedJsonObj(obj: LogAnalyticsMetaSourceType): object;
}

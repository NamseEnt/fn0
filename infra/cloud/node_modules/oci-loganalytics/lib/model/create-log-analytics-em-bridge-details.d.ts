 ...
 */
export interface CreateLogAnalyticsEmBridgeDetails {
    /**
...
export declare namespace CreateLogAnalyticsEmBridgeDetails {
    function getJsonObj(obj: CreateLogAnalyticsEmBridgeDetails): object;
    function getDeserializedJsonObj(obj: CreateLogAnalyticsEmBridgeDetails): object;
}

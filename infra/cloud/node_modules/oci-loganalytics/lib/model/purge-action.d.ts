...
export declare namespace PurgeAction {
    function getJsonObj(obj: PurgeAction, isParentJsonObj?: boolean): object;
    const type = "PURGE";
    function getDeserializedJsonObj(obj: PurgeAction, isParentJsonObj?: boolean): object;
}

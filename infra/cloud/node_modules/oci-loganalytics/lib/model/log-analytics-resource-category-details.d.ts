...
export declare namespace LogAnalyticsResourceCategoryDetails {
    function getJsonObj(obj: LogAnalyticsResourceCategoryDetails): object;
    function getDeserializedJsonObj(obj: LogAnalyticsResourceCategoryDetails): object;
}

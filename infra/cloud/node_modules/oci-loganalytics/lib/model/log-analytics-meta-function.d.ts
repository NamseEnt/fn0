...
export declare namespace LogAnalyticsMetaFunction {
    function getJsonObj(obj: LogAnalyticsMetaFunction): object;
    function getDeserializedJsonObj(obj: LogAnalyticsMetaFunction): object;
}

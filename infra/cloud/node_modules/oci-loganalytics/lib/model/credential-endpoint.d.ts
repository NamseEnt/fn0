...
export declare namespace CredentialEndpoint {
    function getJsonObj(obj: CredentialEndpoint): object;
    function getDeserializedJsonObj(obj: CredentialEndpoint): object;
}

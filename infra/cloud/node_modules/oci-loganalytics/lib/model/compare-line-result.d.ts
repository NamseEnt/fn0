...
export declare namespace CompareLineResult {
    function getJsonObj(obj: CompareLineResult): object;
    function getDeserializedJsonObj(obj: CompareLineResult): object;
}

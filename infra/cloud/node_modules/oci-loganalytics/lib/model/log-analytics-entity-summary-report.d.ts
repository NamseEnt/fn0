...
export declare namespace LogAnalyticsEntitySummaryReport {
    function getJsonObj(obj: LogAnalyticsEntitySummaryReport): object;
    function getDeserializedJsonObj(obj: LogAnalyticsEntitySummaryReport): object;
}

...
export interface ClassifyColumn extends model.AbstractColumn {
     ...
     *
     */
    "classifyCorrelateResult"?: Array<{
        [key: string]: any;
    }>;
    "type": string;
}
export declare namespace ClassifyColumn {
    function getJsonObj(obj: ClassifyColumn, isParentJsonObj?: boolean): object;
    const type = "CLASSIFY_COLUMN";
    function getDeserializedJsonObj(obj: ClassifyColumn, isParentJsonObj?: boolean): object;
}

...
export declare namespace UpsertLogAnalyticsAssociationDetails {
    function getJsonObj(obj: UpsertLogAnalyticsAssociationDetails): object;
    function getDeserializedJsonObj(obj: UpsertLogAnalyticsAssociationDetails): object;
}

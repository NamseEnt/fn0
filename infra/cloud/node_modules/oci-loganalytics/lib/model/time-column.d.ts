...
export declare namespace TimeColumn {
    function getJsonObj(obj: TimeColumn, isParentJsonObj?: boolean): object;
    const type = "TIME_COLUMN";
    function getDeserializedJsonObj(obj: TimeColumn, isParentJsonObj?: boolean): object;
}

...
export declare namespace LogAnalyticsLabelView {
    enum Priority {
        None = "NONE",
        Low = "LOW",
        Medium = "MEDIUM",
    ...
    function getJsonObj(obj: LogAnalyticsLabelView): object;
    function getDeserializedJsonObj(obj: LogAnalyticsLabelView): object;
}

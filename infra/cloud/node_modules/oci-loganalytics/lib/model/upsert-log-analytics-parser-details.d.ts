...
export declare namespace UpsertLogAnalyticsParserDetails {
    enum Type {
        Xml = "XML",
        Json = "JSON",
        Regex = "REGEX",
    ...
    function getJsonObj(obj: UpsertLogAnalyticsParserDetails): object;
    function getDeserializedJsonObj(obj: UpsertLogAnalyticsParserDetails): object;
}

...
export declare namespace EventTypeCollection {
    function getJsonObj(obj: EventTypeCollection): object;
    function getDeserializedJsonObj(obj: EventTypeCollection): object;
}

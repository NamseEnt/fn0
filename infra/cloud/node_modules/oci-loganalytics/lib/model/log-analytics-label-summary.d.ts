...
export declare namespace LogAnalyticsLabelSummary {
    enum Priority {
        None = "NONE",
        Low = "LOW",
        Medium = "MEDIUM",
    ...
    function getJsonObj(obj: LogAnalyticsLabelSummary): object;
    function getDeserializedJsonObj(obj: LogAnalyticsLabelSummary): object;
}

...
export interface ListConfigWorkRequestsResponse {
    ...
    "opcRequestId": string;
    /**
     * The returned model.LogAnalyticsConfigWorkRequestCollection instance.
     */
    "logAnalyticsConfigWorkRequestCollection": model.LogAnalyticsConfigWorkRequestCollection;
}

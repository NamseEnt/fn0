...
export interface BatchGetBasicInfoResponse {
    /**
    ...
    "opcRequestId": string;
    /**
     * The returned model.LogAnalyticsLabelCollection instance.
     */
    "logAnalyticsLabelCollection": model.LogAnalyticsLabelCollection;
}

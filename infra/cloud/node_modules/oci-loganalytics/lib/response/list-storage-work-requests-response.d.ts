...
export interface ListStorageWorkRequestsResponse {
    /**
    ...
    "opcPrevPage": string;
    /**
     * The returned model.StorageWorkRequestCollection instance.
     */
    "storageWorkRequestCollection": model.StorageWorkRequestCollection;
}

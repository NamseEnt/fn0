...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/loganalytics/ListRecalledData.ts.html |here} to see how to use ListRecalledDataRequest.
 */
...
export declare namespace ListRecalledDataRequest {
    enum SortBy {

...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/loganalytics/ListEffectiveProperties.ts.html |here} to see how to use ListEffectivePropertiesRequest.
 */
...
export declare namespace ListEffectivePropertiesRequest {
    enum SortOrder {
        Asc = "ASC",
        Desc = "DESC"
    }

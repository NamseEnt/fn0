...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/loganalytics/ListQueryWorkRequests.ts.html |here} to see how to use ListQueryWorkRequestsRequest.
 */
...
export declare namespace ListQueryWorkRequestsRequest {
    enum SortOrder {
        Asc = "ASC",
        Desc = "DESC"
    }

...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/loganalytics/ListSourceEventTypes.ts.html |here} to see how to use ListSourceEventTypesRequest.
 */
...
export declare namespace ListSourceEventTypesRequest {
    enum IsSystem {
        All = "ALL",
        Custom = "CUSTOM",
        BuiltIn = "BUILT_IN"

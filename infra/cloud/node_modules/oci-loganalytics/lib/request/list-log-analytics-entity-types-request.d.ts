...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/loganalytics/ListLogAnalyticsEntityTypes.ts.html |here} to see how to use ListLogAnalyticsEntityTypesRequest.
 */
...
export declare namespace ListLogAnalyticsEntityTypesRequest {
    enum SortOrder {
        Asc = "ASC",
        Desc = "DESC"
    }

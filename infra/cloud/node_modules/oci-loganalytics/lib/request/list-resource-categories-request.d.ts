...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/loganalytics/ListResourceCategories.ts.html |here} to see how to use ListResourceCategoriesRequest.
 */
export interface ListResourceCategoriesRequest extends common.BaseRequest {
    /**
...
export declare namespace ListResourceCategoriesRequest {
    enum SortOrder {
        Asc = "ASC",
        Desc = "DESC"
    }

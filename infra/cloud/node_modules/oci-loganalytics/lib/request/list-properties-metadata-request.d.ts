...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/loganalytics/ListPropertiesMetadata.ts.html |here} to see how to use ListPropertiesMetadataRequest.
 */
...
export declare namespace ListPropertiesMetadataRequest {
    enum SortOrder {
        Asc = "ASC",
        Desc = "DESC"
    }

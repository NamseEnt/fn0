...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/loganalytics/ListLogAnalyticsEmBridges.ts.html |here} to see how to use ListLogAnalyticsEmBridgesRequest.
 */
...
export declare namespace ListLogAnalyticsEmBridgesRequest {
    enum SortOrder {
        Asc = "ASC",
        Desc = "DESC"
    }

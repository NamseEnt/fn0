...
export declare namespace ApplianceImageSummary {
    enum LifecycleState {
        Creating = "CREATING",
        Updating = "UPDATING",
        Active = "ACTIVE",
    ...
    function getJsonObj(obj: ApplianceImageSummary): object;
    function getDeserializedJsonObj(obj: ApplianceImageSummary): object;
}

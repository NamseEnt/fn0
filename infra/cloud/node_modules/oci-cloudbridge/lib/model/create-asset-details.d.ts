...
export declare namespace CreateAssetDetails {
    function getJsonObj(obj: CreateAssetDetails): object;
    function getDeserializedJsonObj(obj: CreateAssetDetails): object;
}

 ...
 */
export interface CreateInventoryDetails {
    /**
...
export declare namespace CreateInventoryDetails {
    function getJsonObj(obj: CreateInventoryDetails): object;
    function getDeserializedJsonObj(obj: CreateInventoryDetails): object;
}

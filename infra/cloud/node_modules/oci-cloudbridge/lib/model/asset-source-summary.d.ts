...
export declare namespace AssetSourceSummary {
    function getJsonObj(obj: AssetSourceSummary): object;
    function getDeserializedJsonObj(obj: AssetSourceSummary): object;
}

 ...
 */
export interface ImportInventoryDetails {
    /**
...
export declare namespace ImportInventoryDetails {
    function getJsonObj(obj: ImportInventoryDetails): object;
    function getDeserializedJsonObj(obj: ImportInventoryDetails): object;
}

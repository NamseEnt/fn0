...
(function (Agent) {
    let AgentType;
    (function (AgentType) {
        AgentType["Appliance"] = "APPLIANCE";
        /**
         * This value is used if a service returns a value for this enum that is not recognized by this
         * version of the SDK.
         */
        AgentType["UnknownValue"] = "UNKNOWN_VALUE";
    ...
    (function (HeartBeatStatus) {
         ...
         * version of the SDK.
         */
        HeartBeatStatus["UnknownValue"] = "UNKNOWN_VALUE";
    })(HeartBeatStatus = Agent.HeartBeatStatus || (Agent.HeartBeatStatus = {}));
    let LifecycleState;

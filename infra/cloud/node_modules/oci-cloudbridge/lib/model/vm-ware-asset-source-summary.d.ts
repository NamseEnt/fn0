...
export declare namespace VmWareAssetSourceSummary {
    function getJsonObj(obj: VmWareAssetSourceSummary, isParentJsonObj?: boolean): object;
    const type = "VMWARE";
    function getDeserializedJsonObj(obj: VmWareAssetSourceSummary, isParentJsonObj?: boolean): object;
}

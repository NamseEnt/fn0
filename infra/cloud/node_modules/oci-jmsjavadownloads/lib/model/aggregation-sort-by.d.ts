...
export declare namespace AggregationSortBy {
    function getJsonObj(obj: AggregationSortBy): AggregationSortBy;
    function getDeserializedJsonObj(obj: AggregationSortBy): AggregationSortBy;
}

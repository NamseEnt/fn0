 ...
 **/
export declare enum TokenLifecycleDetails {
    Expired = "EXPIRED",
    Revoking = "REVOKING",
    Revoked = "REVOKED",
    /**
...
export declare namespace TokenLifecycleDetails {
    function getJsonObj(obj: TokenLifecycleDetails): TokenLifecycleDetails;
    function getDeserializedJsonObj(obj: TokenLifecycleDetails): TokenLifecycleDetails;
}

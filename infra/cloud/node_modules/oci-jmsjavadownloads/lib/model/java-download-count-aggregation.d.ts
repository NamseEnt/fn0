...
export declare namespace JavaDownloadCountAggregation {
    function getJsonObj(obj: JavaDownloadCountAggregation): object;
    function getDeserializedJsonObj(obj: JavaDownloadCountAggregation): object;
}

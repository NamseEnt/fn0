 ...
 **/
export declare enum DownloadUrlType {
    Oss = "OSS",
    Cdn = "CDN",
    /**
...
export declare namespace DownloadUrlType {
    function getJsonObj(obj: DownloadUrlType): DownloadUrlType;
    function getDeserializedJsonObj(obj: DownloadUrlType): DownloadUrlType;
}

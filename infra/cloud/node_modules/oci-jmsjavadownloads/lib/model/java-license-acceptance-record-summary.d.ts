...
export declare namespace JavaLicenseAcceptanceRecordSummary {
    function getJsonObj(obj: JavaLicenseAcceptanceRecordSummary): object;
    function getDeserializedJsonObj(obj: JavaLicenseAcceptanceRecordSummary): object;
}

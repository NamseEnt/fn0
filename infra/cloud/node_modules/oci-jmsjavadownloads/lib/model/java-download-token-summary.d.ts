...
export declare namespace JavaDownloadTokenSummary {
    function getJsonObj(obj: JavaDownloadTokenSummary): object;
    function getDeserializedJsonObj(obj: JavaDownloadTokenSummary): object;
}

...
export declare namespace CreateJavaDownloadReportDetails {
    function getJsonObj(obj: CreateJavaDownloadReportDetails): object;
    function getDeserializedJsonObj(obj: CreateJavaDownloadReportDetails): object;
}

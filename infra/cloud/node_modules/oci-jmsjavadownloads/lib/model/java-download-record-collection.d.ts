 ...
 *
 */
export interface JavaDownloadRecordCollection {
    /**
     * A list of Java download records in a tenancy.
     */
    "items": Array<model.JavaDownloadRecordSummary>;
}
export declare namespace JavaDownloadRecordCollection {
    function getJsonObj(obj: JavaDownloadRecordCollection): object;
    function getDeserializedJsonObj(obj: JavaDownloadRecordCollection): object;
}

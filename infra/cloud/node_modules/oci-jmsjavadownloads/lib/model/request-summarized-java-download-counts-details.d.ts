...
export declare namespace RequestSummarizedJavaDownloadCountsDetails {
    function getJsonObj(obj: RequestSummarizedJavaDownloadCountsDetails): object;
    function getDeserializedJsonObj(obj: RequestSummarizedJavaDownloadCountsDetails): object;
}

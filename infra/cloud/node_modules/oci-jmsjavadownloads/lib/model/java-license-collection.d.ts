 ...
 *
 */
export interface JavaLicenseCollection {
    /**
     * A list of JavaLicenseSummary objects.
     */
    "items": Array<model.JavaLicenseSummary>;
}
export declare namespace JavaLicenseCollection {
    function getJsonObj(obj: JavaLicenseCollection): object;
    function getDeserializedJsonObj(obj: JavaLicenseCollection): object;
}

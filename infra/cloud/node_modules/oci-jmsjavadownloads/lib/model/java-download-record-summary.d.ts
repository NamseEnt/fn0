...
export declare namespace JavaDownloadRecordSummary {
    function getJsonObj(obj: JavaDownloadRecordSummary): object;
    function getDeserializedJsonObj(obj: JavaDownloadRecordSummary): object;
}

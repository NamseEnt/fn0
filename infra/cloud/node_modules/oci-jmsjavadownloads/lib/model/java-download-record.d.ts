 ...
 */
export interface JavaDownloadRecord {
    /**
...
export declare namespace JavaDownloadRecord {
    function getJsonObj(obj: JavaDownloadRecord): object;
    function getDeserializedJsonObj(obj: JavaDownloadRecord): object;
}

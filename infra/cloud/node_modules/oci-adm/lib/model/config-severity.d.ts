 ...
 **/
export declare enum ConfigSeverity {
    Unset = "UNSET",
    None = "NONE",
    Low = "LOW",
    Medium = "MEDIUM",
...
export declare namespace ConfigSeverity {
    function getJsonObj(obj: ConfigSeverity): ConfigSeverity;
    function getDeserializedJsonObj(obj: ConfigSeverity): ConfigSeverity;
}

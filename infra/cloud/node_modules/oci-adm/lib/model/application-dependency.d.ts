...
export declare namespace ApplicationDependency {
    function getJsonObj(obj: ApplicationDependency): object;
    function getDeserializedJsonObj(obj: ApplicationDependency): object;
}

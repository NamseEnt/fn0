...
exports.OracleDBAzureBlobMountWaiter = void 0;
const models = __importStar(require("./model"));
const oci_common_1 = require("oci-common");
class OracleDBAzureBlobMountWaiter {
     ...
     */
    forOracleDbAzureBlobMount(request, ...targetStates) {
        return __awaiter(this, void 0, void 0, function* () {
            return oci_common_1.genericTerminalConditionWaiter(this.config, () => this.client.getOracleDbAzureBlobMount(request), response => targetStates.includes(response.oracleDbAzureBlobMount.lifecycleState), targetStates.includes(models.OracleDbAzureBlobMount.LifecycleState.Deleted));
        });
    }
}
exports.OracleDBAzureBlobMountWaiter = OracleDBAzureBlobMountWaiter;
//# sourceMappingURL=oracledbazureblobmount-waiter.js.map
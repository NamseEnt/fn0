...
exports.OracleDbAzureVaultAssociationWaiter = void 0;
const models = __importStar(require("./model"));
const oci_common_1 = require("oci-common");
class OracleDbAzureVaultAssociationWaiter {
     ...
     */
    forOracleDbAzureVaultAssociation(request, ...targetStates) {
        return __awaiter(this, void 0, void 0, function* () {
            return oci_common_1.genericTerminalConditionWaiter(this.config, () => this.client.getOracleDbAzureVaultAssociation(request), response => targetStates.includes(response.oracleDbAzureVaultAssociation.lifecycleState), targetStates.includes(models.OracleDbAzureVaultAssociation.LifecycleState.Deleted));
        });
    }
}
exports.OracleDbAzureVaultAssociationWaiter = OracleDbAzureVaultAssociationWaiter;
//# sourceMappingURL=oracledbazurevaultassociation-waiter.js.map
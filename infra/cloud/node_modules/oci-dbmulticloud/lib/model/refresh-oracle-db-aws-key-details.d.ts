 ...
 */
export interface RefreshOracleDbAwsKeyDetails {
    /**
...
export declare namespace RefreshOracleDbAwsKeyDetails {
    function getJsonObj(obj: RefreshOracleDbAwsKeyDetails): object;
    function getDeserializedJsonObj(obj: RefreshOracleDbAwsKeyDetails): object;
}

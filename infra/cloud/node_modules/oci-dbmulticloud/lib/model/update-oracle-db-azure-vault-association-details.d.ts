 ...
 *
 */
export interface UpdateOracleDbAzureVaultAssociationDetails {
    /**
...
export declare namespace UpdateOracleDbAzureVaultAssociationDetails {
    function getJsonObj(obj: UpdateOracleDbAzureVaultAssociationDetails): object;
    function getDeserializedJsonObj(obj: UpdateOracleDbAzureVaultAssociationDetails): object;
}

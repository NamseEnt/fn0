...
export declare namespace CreateOracleDbAzureBlobContainerDetails {
    function getJsonObj(obj: CreateOracleDbAzureBlobContainerDetails): object;
    function getDeserializedJsonObj(obj: CreateOracleDbAzureBlobContainerDetails): object;
}

 ...
 *
 */
export interface CreateOracleDbAzureBlobMountDetails {
    /**
...
export declare namespace CreateOracleDbAzureBlobMountDetails {
    function getJsonObj(obj: CreateOracleDbAzureBlobMountDetails): object;
    function getDeserializedJsonObj(obj: CreateOracleDbAzureBlobMountDetails): object;
}

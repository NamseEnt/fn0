...
/**
 * List of OracleDbAzureVaultSummary resources.
 */
export interface OracleDbAzureVaultSummaryCollection {
    /**
     * This list contains the summary of DB Azure Vault resources.
     */
    "items": Array<model.OracleDbAzureVaultSummary>;
}
export declare namespace OracleDbAzureVaultSummaryCollection {
    function getJsonObj(obj: OracleDbAzureVaultSummaryCollection): object;
    function getDeserializedJsonObj(obj: OracleDbAzureVaultSummaryCollection): object;
}

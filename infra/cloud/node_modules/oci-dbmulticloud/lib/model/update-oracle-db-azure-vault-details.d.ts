 ...
 *
 */
export interface UpdateOracleDbAzureVaultDetails {
    /**
...
export declare namespace UpdateOracleDbAzureVaultDetails {
    function getJsonObj(obj: UpdateOracleDbAzureVaultDetails): object;
    function getDeserializedJsonObj(obj: UpdateOracleDbAzureVaultDetails): object;
}

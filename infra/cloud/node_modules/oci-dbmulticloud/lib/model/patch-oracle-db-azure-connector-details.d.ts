 ...
 */
export interface PatchOracleDbAzureConnectorDetails {
    /**
...
export declare namespace PatchOracleDbAzureConnectorDetails {
    function getJsonObj(obj: PatchOracleDbAzureConnectorDetails): object;
    function getDeserializedJsonObj(obj: PatchOracleDbAzureConnectorDetails): object;
}

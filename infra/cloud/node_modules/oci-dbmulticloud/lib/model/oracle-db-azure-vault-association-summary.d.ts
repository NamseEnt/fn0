 ...
 *
 */
export interface OracleDbAzureVaultAssociationSummary {
    /**
...
export declare namespace OracleDbAzureVaultAssociationSummary {
    function getJsonObj(obj: OracleDbAzureVaultAssociationSummary): object;
    function getDeserializedJsonObj(obj: OracleDbAzureVaultAssociationSummary): object;
}

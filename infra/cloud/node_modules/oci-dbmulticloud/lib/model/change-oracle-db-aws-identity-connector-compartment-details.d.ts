 ...
 */
export interface ChangeOracleDbAwsIdentityConnectorCompartmentDetails {
    /**
...
export declare namespace ChangeOracleDbAwsIdentityConnectorCompartmentDetails {
    function getJsonObj(obj: ChangeOracleDbAwsIdentityConnectorCompartmentDetails): object;
    function getDeserializedJsonObj(obj: ChangeOracleDbAwsIdentityConnectorCompartmentDetails): object;
}

...
export declare namespace AwsNodes {
    enum Status {
        Connected = "CONNECTED",
    ...
    function getJsonObj(obj: AwsNodes): object;
    function getDeserializedJsonObj(obj: AwsNodes): object;
}

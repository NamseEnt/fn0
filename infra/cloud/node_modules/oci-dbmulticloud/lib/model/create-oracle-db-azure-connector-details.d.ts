 ...
 *
 */
export interface CreateOracleDbAzureConnectorDetails {
    /**
...
export declare namespace CreateOracleDbAzureConnectorDetails {
    function getJsonObj(obj: CreateOracleDbAzureConnectorDetails): object;
    function getDeserializedJsonObj(obj: CreateOracleDbAzureConnectorDetails): object;
}

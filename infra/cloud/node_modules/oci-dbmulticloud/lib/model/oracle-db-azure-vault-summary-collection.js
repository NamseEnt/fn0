...
exports.OracleDbAzureVaultSummaryCollection = void 0;
const model = __importStar(require("../model"));
var OracleDbAzureVaultSummaryCollection;
(function (OracleDbAzureVaultSummaryCollection) {
    function getJsonObj(obj) {
        const jsonObj = Object.assign(Object.assign({}, obj), {
            "items": obj.items
                ? obj.items.map(item => {
                    return model.OracleDbAzureVaultSummary.getJsonObj(item);
                })
                : undefined
        });
        return jsonObj;
    }
    OracleDbAzureVaultSummaryCollection.getJsonObj = getJsonObj;
    function getDeserializedJsonObj(obj) {
        const jsonObj = Object.assign(Object.assign({}, obj), {
            "items": obj.items
                ? obj.items.map(item => {
                    return model.OracleDbAzureVaultSummary.getDeserializedJsonObj(item);
                })
                : undefined
        });
        return jsonObj;
    }
    OracleDbAzureVaultSummaryCollection.getDeserializedJsonObj = getDeserializedJsonObj;
})(OracleDbAzureVaultSummaryCollection = exports.OracleDbAzureVaultSummaryCollection || (exports.OracleDbAzureVaultSummaryCollection = {}));
//# sourceMappingURL=oracle-db-azure-vault-summary-collection.js.map
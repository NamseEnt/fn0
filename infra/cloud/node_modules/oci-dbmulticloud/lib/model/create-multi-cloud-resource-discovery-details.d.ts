 ...
 *
 */
export interface CreateMultiCloudResourceDiscoveryDetails {
    /**
...
export declare namespace CreateMultiCloudResourceDiscoveryDetails {
    function getJsonObj(obj: CreateMultiCloudResourceDiscoveryDetails): object;
    function getDeserializedJsonObj(obj: CreateMultiCloudResourceDiscoveryDetails): object;
}

 ...
 *
 */
export interface CreateOracleDbGcpIdentityConnectorDetails {
    /**
...
export declare namespace CreateOracleDbGcpIdentityConnectorDetails {
    function getJsonObj(obj: CreateOracleDbGcpIdentityConnectorDetails): object;
    function getDeserializedJsonObj(obj: CreateOracleDbGcpIdentityConnectorDetails): object;
}

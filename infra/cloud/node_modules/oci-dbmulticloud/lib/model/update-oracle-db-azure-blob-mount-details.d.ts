 ...
 *
 */
export interface UpdateOracleDbAzureBlobMountDetails {
    /**
...
export declare namespace UpdateOracleDbAzureBlobMountDetails {
    function getJsonObj(obj: UpdateOracleDbAzureBlobMountDetails): object;
    function getDeserializedJsonObj(obj: UpdateOracleDbAzureBlobMountDetails): object;
}

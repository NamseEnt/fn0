 ...
 *
 */
export interface UpdateMultiCloudResourceDiscoveryDetails {
    /**
...
export declare namespace UpdateMultiCloudResourceDiscoveryDetails {
    function getJsonObj(obj: UpdateMultiCloudResourceDiscoveryDetails): object;
    function getDeserializedJsonObj(obj: UpdateMultiCloudResourceDiscoveryDetails): object;
}

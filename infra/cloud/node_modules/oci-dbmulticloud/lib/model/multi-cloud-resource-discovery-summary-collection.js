...
exports.MultiCloudResourceDiscoverySummaryCollection = void 0;
const model = __importStar(require("../model"));
var MultiCloudResourceDiscoverySummaryCollection;
(function (MultiCloudResourceDiscoverySummaryCollection) {
    function getJsonObj(obj) {
        const jsonObj = Object.assign(Object.assign({}, obj), {
            "items": obj.items
                ? obj.items.map(item => {
                    return model.MultiCloudResourceDiscoverySummary.getJsonObj(item);
                })
                : undefined
        });
        return jsonObj;
    }
    MultiCloudResourceDiscoverySummaryCollection.getJsonObj = getJsonObj;
    function getDeserializedJsonObj(obj) {
        const jsonObj = Object.assign(Object.assign({}, obj), {
            "items": obj.items
                ? obj.items.map(item => {
                    return model.MultiCloudResourceDiscoverySummary.getDeserializedJsonObj(item);
                })
                : undefined
        });
        return jsonObj;
    }
    MultiCloudResourceDiscoverySummaryCollection.getDeserializedJsonObj = getDeserializedJsonObj;
})(MultiCloudResourceDiscoverySummaryCollection = exports.MultiCloudResourceDiscoverySummaryCollection || (exports.MultiCloudResourceDiscoverySummaryCollection = {}));
//# sourceMappingURL=multi-cloud-resource-discovery-summary-collection.js.map
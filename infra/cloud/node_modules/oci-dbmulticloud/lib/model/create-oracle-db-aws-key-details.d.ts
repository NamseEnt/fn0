 ...
 *
 */
export interface CreateOracleDbAwsKeyDetails {
    /**
...
export declare namespace CreateOracleDbAwsKeyDetails {
    function getJsonObj(obj: CreateOracleDbAwsKeyDetails): object;
    function getDeserializedJsonObj(obj: CreateOracleDbAwsKeyDetails): object;
}

 ...
 *
 */
export interface CreateOracleDbGcpKeyRingDetails {
    /**
...
export declare namespace CreateOracleDbGcpKeyRingDetails {
    function getJsonObj(obj: CreateOracleDbGcpKeyRingDetails): object;
    function getDeserializedJsonObj(obj: CreateOracleDbGcpKeyRingDetails): object;
}

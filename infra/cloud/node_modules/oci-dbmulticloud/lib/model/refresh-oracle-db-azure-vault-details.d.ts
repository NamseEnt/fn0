 ...
 */
export interface RefreshOracleDbAzureVaultDetails {
    /**
...
export declare namespace RefreshOracleDbAzureVaultDetails {
    function getJsonObj(obj: RefreshOracleDbAzureVaultDetails): object;
    function getDeserializedJsonObj(obj: RefreshOracleDbAzureVaultDetails): object;
}

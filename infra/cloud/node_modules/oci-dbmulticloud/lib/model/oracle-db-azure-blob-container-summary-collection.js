...
exports.OracleDbAzureBlobContainerSummaryCollection = void 0;
const model = __importStar(require("../model"));
var OracleDbAzureBlobContainerSummaryCollection;
(function (OracleDbAzureBlobContainerSummaryCollection) {
    function getJsonObj(obj) {
        const jsonObj = Object.assign(Object.assign({}, obj), {
            "items": obj.items
                ? obj.items.map(item => {
                    return model.OracleDbAzureBlobContainerSummary.getJsonObj(item);
                })
                : undefined
        });
        return jsonObj;
    }
    OracleDbAzureBlobContainerSummaryCollection.getJsonObj = getJsonObj;
    function getDeserializedJsonObj(obj) {
        const jsonObj = Object.assign(Object.assign({}, obj), {
            "items": obj.items
                ? obj.items.map(item => {
                    return model.OracleDbAzureBlobContainerSummary.getDeserializedJsonObj(item);
                })
                : undefined
        });
        return jsonObj;
    }
    OracleDbAzureBlobContainerSummaryCollection.getDeserializedJsonObj = getDeserializedJsonObj;
})(OracleDbAzureBlobContainerSummaryCollection = exports.OracleDbAzureBlobContainerSummaryCollection || (exports.OracleDbAzureBlobContainerSummaryCollection = {}));
//# sourceMappingURL=oracle-db-azure-blob-container-summary-collection.js.map
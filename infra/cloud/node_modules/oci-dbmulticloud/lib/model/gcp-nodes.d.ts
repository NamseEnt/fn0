...
export declare namespace GcpNodes {
    enum Status {
        Connected = "CONNECTED",
    ...
    function getJsonObj(obj: GcpNodes): object;
    function getDeserializedJsonObj(obj: GcpNodes): object;
}

...
export declare namespace MultiCloudResourceDiscovery {
    enum ResourceType {
        Vaults = "VAULTS",
        Storage = "STORAGE",
    ...
    function getJsonObj(obj: MultiCloudResourceDiscovery): object;
    function getDeserializedJsonObj(obj: MultiCloudResourceDiscovery): object;
}

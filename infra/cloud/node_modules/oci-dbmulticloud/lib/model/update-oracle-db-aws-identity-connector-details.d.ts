 ...
 *
 */
export interface UpdateOracleDbAwsIdentityConnectorDetails {
    /**
...
export declare namespace UpdateOracleDbAwsIdentityConnectorDetails {
    function getJsonObj(obj: UpdateOracleDbAwsIdentityConnectorDetails): object;
    function getDeserializedJsonObj(obj: UpdateOracleDbAwsIdentityConnectorDetails): object;
}

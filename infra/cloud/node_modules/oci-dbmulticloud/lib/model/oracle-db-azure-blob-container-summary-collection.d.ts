 ...
 */
export interface OracleDbAzureBlobContainerSummaryCollection {
    /**
     * This list contains the summary of Oracle DB Azure Blob Container resources.
     */
    "items": Array<model.OracleDbAzureBlobContainerSummary>;
}
export declare namespace OracleDbAzureBlobContainerSummaryCollection {
    function getJsonObj(obj: OracleDbAzureBlobContainerSummaryCollection): object;
    function getDeserializedJsonObj(obj: OracleDbAzureBlobContainerSummaryCollection): object;
}

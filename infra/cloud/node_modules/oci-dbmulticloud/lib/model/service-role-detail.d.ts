 ...
 */
export interface ServiceRoleDetail {
    /**
     ...
     * Type of service.
     */
    "serviceType": ServiceRoleDetail.ServiceType;
}
export declare namespace ServiceRoleDetail {
    enum ServiceType {
        Kms = "KMS"
    }
    function getJsonObj(obj: ServiceRoleDetail): object;
    function getDeserializedJsonObj(obj: ServiceRoleDetail): object;
}

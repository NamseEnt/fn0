 ...
 */
export interface ChangeOracleDbAzureVaultAssociationCompartmentDetails {
    /**
...
export declare namespace ChangeOracleDbAzureVaultAssociationCompartmentDetails {
    function getJsonObj(obj: ChangeOracleDbAzureVaultAssociationCompartmentDetails): object;
    function getDeserializedJsonObj(obj: ChangeOracleDbAzureVaultAssociationCompartmentDetails): object;
}

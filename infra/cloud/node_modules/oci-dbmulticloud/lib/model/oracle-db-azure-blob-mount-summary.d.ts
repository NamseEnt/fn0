...
export declare namespace OracleDbAzureBlobMountSummary {
    function getJsonObj(obj: OracleDbAzureBlobMountSummary): object;
    function getDeserializedJsonObj(obj: OracleDbAzureBlobMountSummary): object;
}

 ...
 *
 */
export interface UpdateOracleDbAzureBlobContainerDetails {
    /**
...
export declare namespace UpdateOracleDbAzureBlobContainerDetails {
    function getJsonObj(obj: UpdateOracleDbAzureBlobContainerDetails): object;
    function getDeserializedJsonObj(obj: UpdateOracleDbAzureBlobContainerDetails): object;
}

 ...
 *
 */
export interface OracleDbAzureVault {
    /**
     ...
     */
    "lifecycleState"?: OracleDbAzureVault.LifecycleState;
    /**
...
export declare namespace OracleDbAzureVault {
    enum LifecycleState {
        Creating = "CREATING",
        Active = "ACTIVE",
        Updating = "UPDATING",
    ...
    function getJsonObj(obj: OracleDbAzureVault): object;
    function getDeserializedJsonObj(obj: OracleDbAzureVault): object;
}

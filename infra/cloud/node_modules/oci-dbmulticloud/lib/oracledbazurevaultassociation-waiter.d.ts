...
export declare class OracleDbAzureVaultAssociationWaiter {
    private client;
    private readonly config?;
    constructor(client: OracleDbAzureVaultAssociationClient, config?: Partial<import("oci-common/lib/waiter").WaiterConfigurationDetails> | undefined);
    /**
     ...
     */
    forOracleDbAzureVaultAssociation(request: serviceRequests.GetOracleDbAzureVaultAssociationRequest, ...targetStates: models.OracleDbAzureVaultAssociation.LifecycleState[]): Promise<serviceResponses.GetOracleDbAzureVaultAssociationResponse | null>;
}

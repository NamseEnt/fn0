...
export declare class OracleDbAzureKeyWaiter {
    private client;
    private readonly config?;
    constructor(client: OracleDbAzureKeyClient, config?: Partial<import("oci-common/lib/waiter").WaiterConfigurationDetails> | undefined);
    /**
     ...
     */
    forOracleDbAzureKey(request: serviceRequests.GetOracleDbAzureKeyRequest, ...targetStates: models.OracleDbAzureKey.LifecycleState[]): Promise<serviceResponses.GetOracleDbAzureKeyResponse | null>;
}

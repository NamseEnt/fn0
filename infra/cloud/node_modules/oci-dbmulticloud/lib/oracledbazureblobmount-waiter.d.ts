...
export declare class OracleDBAzureBlobMountWaiter {
    private client;
    private readonly config?;
    constructor(client: OracleDBAzureBlobMountClient, config?: Partial<import("oci-common/lib/waiter").WaiterConfigurationDetails> | undefined);
    /**
     ...
     */
    forOracleDbAzureBlobMount(request: serviceRequests.GetOracleDbAzureBlobMountRequest, ...targetStates: models.OracleDbAzureBlobMount.LifecycleState[]): Promise<serviceResponses.GetOracleDbAzureBlobMountResponse | null>;
}

...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/dbmulticloud/CreateOracleDbAzureBlobContainer.ts.html |here} to see how to use CreateOracleDbAzureBlobContainerRequest.
 */
export interface CreateOracleDbAzureBlobContainerRequest extends common.BaseRequest {
    /**
     * Details for to mount Azure Container in OCI Database resource.
     */
    "createOracleDbAzureBlobContainerDetails": model.CreateOracleDbAzureBlobContainerDetails;
    /**

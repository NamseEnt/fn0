...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/dbmulticloud/DeleteOracleDbAzureVault.ts.html |here} to see how to use DeleteOracleDbAzureVaultRequest.
 */

...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/dbmulticloud/CreateOracleDbAwsKey.ts.html |here} to see how to use CreateOracleDbAwsKeyRequest.
 */
export interface CreateOracleDbAwsKeyRequest extends common.BaseRequest {
    /**
     * Details for to create AWS Key details.
     */
    "createOracleDbAwsKeyDetails": model.CreateOracleDbAwsKeyDetails;
    /**

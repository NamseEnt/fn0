...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/dbmulticloud/ListOracleDbAzureKeys.ts.html |here} to see how to use ListOracleDbAzureKeysRequest.
 */
export interface ListOracleDbAzureKeysRequest extends common.BaseRequest {
    /**
...
export declare namespace ListOracleDbAzureKeysRequest {
    enum SortBy {

...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/dbmulticloud/ListOracleDbAwsIdentityConnectors.ts.html |here} to see how to use ListOracleDbAwsIdentityConnectorsRequest.
 */
export interface ListOracleDbAwsIdentityConnectorsRequest extends common.BaseRequest {
    /**
...
export declare namespace ListOracleDbAwsIdentityConnectorsRequest {
    enum SortBy {

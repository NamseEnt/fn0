...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/dbmulticloud/ChangeOracleDbAzureVaultCompartment.ts.html |here} to see how to use ChangeOracleDbAzureVaultCompartmentRequest.
 */
export interface ChangeOracleDbAzureVaultCompartmentRequest extends common.BaseRequest {
    /**
     ...
     */
    "changeOracleDbAzureVaultCompartmentDetails": model.ChangeOracleDbAzureVaultCompartmentDetails;
    /**

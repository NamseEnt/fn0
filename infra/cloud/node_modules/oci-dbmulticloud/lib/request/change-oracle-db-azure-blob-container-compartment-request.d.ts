...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/dbmulticloud/ChangeOracleDbAzureBlobContainerCompartment.ts.html |here} to see how to use ChangeOracleDbAzureBlobContainerCompartmentRequest.
 */
export interface ChangeOracleDbAzureBlobContainerCompartmentRequest extends common.BaseRequest {
    /**
     ...
     */
    "changeOracleDbAzureBlobContainerCompartmentDetails": model.ChangeOracleDbAzureBlobContainerCompartmentDetails;
    /**

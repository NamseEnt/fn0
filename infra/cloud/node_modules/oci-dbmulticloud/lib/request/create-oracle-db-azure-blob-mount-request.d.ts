...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/dbmulticloud/CreateOracleDbAzureBlobMount.ts.html |here} to see how to use CreateOracleDbAzureBlobMountRequest.
 */
export interface CreateOracleDbAzureBlobMountRequest extends common.BaseRequest {
    /**

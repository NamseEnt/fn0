...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/dbmulticloud/RefreshOracleDbAwsIdentityConnector.ts.html |here} to see how to use RefreshOracleDbAwsIdentityConnectorRequest.
 */
export interface RefreshOracleDbAwsIdentityConnectorRequest extends common.BaseRequest {
    /**

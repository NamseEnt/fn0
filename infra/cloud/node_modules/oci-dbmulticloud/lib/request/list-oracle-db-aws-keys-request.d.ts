...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/dbmulticloud/ListOracleDbAwsKeys.ts.html |here} to see how to use ListOracleDbAwsKeysRequest.
 */
export interface ListOracleDbAwsKeysRequest extends common.BaseRequest {
    /**
...
export declare namespace ListOracleDbAwsKeysRequest {
    enum SortBy {

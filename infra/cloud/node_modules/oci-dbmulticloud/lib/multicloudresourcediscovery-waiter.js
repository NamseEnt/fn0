...
exports.MultiCloudResourceDiscoveryWaiter = void 0;
const oci_common_1 = require("oci-common");
class MultiCloudResourceDiscoveryWaiter {
     ...
     */
    forMultiCloudResourceDiscovery(request, ...targetStates) {
        return __awaiter(this, void 0, void 0, function* () {
            return oci_common_1.genericWaiter(this.config, () => this.client.getMultiCloudResourceDiscovery(request), response => targetStates.includes(response.multiCloudResourceDiscovery.lifecycleState));
        });
    }
}
exports.MultiCloudResourceDiscoveryWaiter = MultiCloudResourceDiscoveryWaiter;
//# sourceMappingURL=multicloudresourcediscovery-waiter.js.map
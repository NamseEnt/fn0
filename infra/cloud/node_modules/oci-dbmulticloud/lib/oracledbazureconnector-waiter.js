...
exports.OracleDBAzureConnectorWaiter = void 0;
const models = __importStar(require("./model"));
const oci_common_1 = require("oci-common");
class OracleDBAzureConnectorWaiter {
     ...
     */
    forOracleDbAzureConnector(request, ...targetStates) {
        return __awaiter(this, void 0, void 0, function* () {
            return oci_common_1.genericTerminalConditionWaiter(this.config, () => this.client.getOracleDbAzureConnector(request), response => targetStates.includes(response.oracleDbAzureConnector.lifecycleState), targetStates.includes(models.OracleDbAzureConnector.LifecycleState.Deleted));
        });
    }
}
exports.OracleDBAzureConnectorWaiter = OracleDBAzureConnectorWaiter;
//# sourceMappingURL=oracledbazureconnector-waiter.js.map
...
import { DbMulticloudAwsProviderClient } from "./client";
export declare class DbMulticloudAwsProviderWaiter {
    private client;
    private readonly config?;
    constructor(client: DbMulticloudAwsProviderClient, config?: Partial<import("oci-common/lib/waiter").WaiterConfigurationDetails> | undefined);
    /**
     ...
     */
    forOracleDbAwsIdentityConnector(request: serviceRequests.GetOracleDbAwsIdentityConnectorRequest, ...targetStates: models.OracleDbAwsIdentityConnector.LifecycleState[]): Promise<serviceResponses.GetOracleDbAwsIdentityConnectorResponse | null>;
    /**
     ...
     */
    forOracleDbAwsKey(request: serviceRequests.GetOracleDbAwsKeyRequest, ...targetStates: models.OracleDbAwsKey.LifecycleState[]): Promise<serviceResponses.GetOracleDbAwsKeyResponse | null>;
}

...
export declare namespace AvailableMaintenanceScheduleStartTimeSummary {
    enum DayOfWeek {
        Monday = "MONDAY",
        Tuesday = "TUESDAY",
        Wednesday = "WEDNESDAY",
    ...
    function getJsonObj(obj: AvailableMaintenanceScheduleStartTimeSummary): object;
    function getDeserializedJsonObj(obj: AvailableMaintenanceScheduleStartTimeSummary): object;
}

...
export declare namespace NetworkSecurityGroup {
    function getJsonObj(obj: NetworkSecurityGroup): object;
    function getDeserializedJsonObj(obj: NetworkSecurityGroup): object;
}

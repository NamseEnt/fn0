 ...
 */
export interface AvailableMaintenanceScheduleStartTimeCollection {
    /**
     * List of available start times on every day of the week
     */
    "items": Array<model.AvailableMaintenanceScheduleStartTimeSummary>;
}
export declare namespace AvailableMaintenanceScheduleStartTimeCollection {
    function getJsonObj(obj: AvailableMaintenanceScheduleStartTimeCollection): object;
    function getDeserializedJsonObj(obj: AvailableMaintenanceScheduleStartTimeCollection): object;
}

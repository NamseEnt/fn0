...
export declare namespace CreateLustreFileSystemDetails {
    ...
    function getJsonObj(obj: CreateLustreFileSystemDetails): object;
    function getDeserializedJsonObj(obj: CreateLustreFileSystemDetails): object;
}

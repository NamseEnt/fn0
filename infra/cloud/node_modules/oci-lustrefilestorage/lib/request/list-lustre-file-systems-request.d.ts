...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/lustrefilestorage/ListLustreFileSystems.ts.html |here} to see how to use ListLustreFileSystemsRequest.
 */
export interface ListLustreFileSystemsRequest extends common.BaseRequest {
    /**
...
export declare namespace ListLustreFileSystemsRequest {
    enum SortBy {

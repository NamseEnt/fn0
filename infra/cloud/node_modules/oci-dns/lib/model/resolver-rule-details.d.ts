...
export declare namespace ResolverRuleDetails {
    function getJsonObj(obj: ResolverRuleDetails): object;
    function getDeserializedJsonObj(obj: ResolverRuleDetails): object;
}

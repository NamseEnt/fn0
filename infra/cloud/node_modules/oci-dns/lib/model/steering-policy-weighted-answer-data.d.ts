...
export declare namespace SteeringPolicyWeightedAnswerData {
    function getJsonObj(obj: SteeringPolicyWeightedAnswerData): object;
    function getDeserializedJsonObj(obj: SteeringPolicyWeightedAnswerData): object;
}

...
export interface SteeringPolicyPriorityRule extends model.SteeringPolicyRule {
     ...
     *
     */
    "defaultAnswerData"?: Array<model.SteeringPolicyPriorityAnswerData>;
    "ruleType": string;
}
export declare namespace SteeringPolicyPriorityRule {
    function getJsonObj(obj: SteeringPolicyPriorityRule, isParentJsonObj?: boolean): object;
    const ruleType = "PRIORITY";
    function getDeserializedJsonObj(obj: SteeringPolicyPriorityRule, isParentJsonObj?: boolean): object;
}

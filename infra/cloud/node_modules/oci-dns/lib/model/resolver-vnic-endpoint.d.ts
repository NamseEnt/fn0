...
export declare namespace ResolverVnicEndpoint {
    function getJsonObj(obj: ResolverVnicEndpoint, isParentJsonObj?: boolean): object;
    const endpointType = "VNIC";
    function getDeserializedJsonObj(obj: ResolverVnicEndpoint, isParentJsonObj?: boolean): object;
}

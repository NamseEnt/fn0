...
export interface SteeringPolicyFilterRule extends model.SteeringPolicyRule {
     ...
     *
     */
    "defaultAnswerData"?: Array<model.SteeringPolicyFilterAnswerData>;
    "ruleType": string;
}
export declare namespace SteeringPolicyFilterRule {
    function getJsonObj(obj: SteeringPolicyFilterRule, isParentJsonObj?: boolean): object;
    const ruleType = "FILTER";
    function getDeserializedJsonObj(obj: SteeringPolicyFilterRule, isParentJsonObj?: boolean): object;
}

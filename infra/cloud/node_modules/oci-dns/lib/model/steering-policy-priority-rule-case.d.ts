...
export interface SteeringPolicyPriorityRuleCase {
    /**
...
export declare namespace SteeringPolicyPriorityRuleCase {
    function getJsonObj(obj: SteeringPolicyPriorityRuleCase): object;
    function getDeserializedJsonObj(obj: SteeringPolicyPriorityRuleCase): object;
}

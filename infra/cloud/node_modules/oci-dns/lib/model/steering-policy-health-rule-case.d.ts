...
export declare namespace SteeringPolicyHealthRuleCase {
    function getJsonObj(obj: SteeringPolicyHealthRuleCase): object;
    function getDeserializedJsonObj(obj: SteeringPolicyHealthRuleCase): object;
}

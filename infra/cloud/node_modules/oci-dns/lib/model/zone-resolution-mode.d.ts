...
*
**/
export declare enum ZoneResolutionMode {
    Static = "STATIC",
...
export declare namespace ZoneResolutionMode {
    function getJsonObj(obj: ZoneResolutionMode): ZoneResolutionMode;
    function getDeserializedJsonObj(obj: ZoneResolutionMode): ZoneResolutionMode;
}

...
export declare namespace UpdateResolverDetails {
    function getJsonObj(obj: UpdateResolverDetails): object;
    function getDeserializedJsonObj(obj: UpdateResolverDetails): object;
}

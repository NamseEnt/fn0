...
export declare namespace SteeringPolicyLimitRuleCase {
    function getJsonObj(obj: SteeringPolicyLimitRuleCase): object;
    function getDeserializedJsonObj(obj: SteeringPolicyLimitRuleCase): object;
}

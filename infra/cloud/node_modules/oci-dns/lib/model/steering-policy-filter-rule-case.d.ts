...
export declare namespace SteeringPolicyFilterRuleCase {
    function getJsonObj(obj: SteeringPolicyFilterRuleCase): object;
    function getDeserializedJsonObj(obj: SteeringPolicyFilterRuleCase): object;
}

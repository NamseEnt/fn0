...
export declare namespace SteeringPolicyHealthRule {
    function getJsonObj(obj: SteeringPolicyHealthRule, isParentJsonObj?: boolean): object;
    const ruleType = "HEALTH";
    function getDeserializedJsonObj(obj: SteeringPolicyHealthRule, isParentJsonObj?: boolean): object;
}

...
export declare namespace SteeringPolicyAttachment {
    enum LifecycleState {
        Creating = "CREATING",
        Active = "ACTIVE",
        Deleting = "DELETING",
    ...
    function getJsonObj(obj: SteeringPolicyAttachment): object;
    function getDeserializedJsonObj(obj: SteeringPolicyAttachment): object;
}

...
export declare namespace ChangeResolverCompartmentDetails {
    function getJsonObj(obj: ChangeResolverCompartmentDetails): object;
    function getDeserializedJsonObj(obj: ChangeResolverCompartmentDetails): object;
}

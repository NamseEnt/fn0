...
export declare namespace PrivateApplication {
    enum LifecycleState {
        Creating = "CREATING",
        Updating = "UPDATING",
        Active = "ACTIVE",
    ...
    function getJsonObj(obj: PrivateApplication): object;
    function getDeserializedJsonObj(obj: PrivateApplication): object;
}

...
export declare namespace CreatePrivateApplicationDetails {
    function getJsonObj(obj: CreatePrivateApplicationDetails): object;
    function getDeserializedJsonObj(obj: CreatePrivateApplicationDetails): object;
}

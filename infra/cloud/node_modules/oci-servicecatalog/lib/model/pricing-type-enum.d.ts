...
export declare namespace PricingTypeEnum {
    function getJsonObj(obj: PricingTypeEnum): PricingTypeEnum;
    function getDeserializedJsonObj(obj: PricingTypeEnum): PricingTypeEnum;
}

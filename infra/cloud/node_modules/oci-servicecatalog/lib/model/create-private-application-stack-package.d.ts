 ...
 */
export interface CreatePrivateApplicationStackPackage extends model.CreatePrivateApplicationPackage {
    /**
...
export declare namespace CreatePrivateApplicationStackPackage {
    function getJsonObj(obj: CreatePrivateApplicationStackPackage, isParentJsonObj?: boolean): object;
    const packageType = "STACK";
    function getDeserializedJsonObj(obj: CreatePrivateApplicationStackPackage, isParentJsonObj?: boolean): object;
}

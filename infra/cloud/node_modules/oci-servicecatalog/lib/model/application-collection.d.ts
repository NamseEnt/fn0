...
export declare namespace ApplicationCollection {
    function getJsonObj(obj: ApplicationCollection): object;
    function getDeserializedJsonObj(obj: ApplicationCollection): object;
}

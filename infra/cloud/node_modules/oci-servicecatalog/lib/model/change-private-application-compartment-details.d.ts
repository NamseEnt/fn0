...
export declare namespace ChangePrivateApplicationCompartmentDetails {
    function getJsonObj(obj: ChangePrivateApplicationCompartmentDetails): object;
    function getDeserializedJsonObj(obj: ChangePrivateApplicationCompartmentDetails): object;
}

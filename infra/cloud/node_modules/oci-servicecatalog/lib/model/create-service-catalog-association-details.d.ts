 ...
 */
export interface CreateServiceCatalogAssociationDetails {
    /**
...
export declare namespace CreateServiceCatalogAssociationDetails {
    function getJsonObj(obj: CreateServiceCatalogAssociationDetails): object;
    function getDeserializedJsonObj(obj: CreateServiceCatalogAssociationDetails): object;
}

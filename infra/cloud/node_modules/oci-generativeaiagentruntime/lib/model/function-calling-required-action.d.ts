 ...
 *
 */
export interface FunctionCallingRequiredAction extends model.RequiredAction {
    "functionCall": model.FunctionCall;
    "requiredActionType": string;
}
export declare namespace FunctionCallingRequiredAction {
    function getJsonObj(obj: FunctionCallingRequiredAction, isParentJsonObj?: boolean): object;
    const requiredActionType = "FUNCTION_CALLING_REQUIRED_ACTION";
    function getDeserializedJsonObj(obj: FunctionCallingRequiredAction, isParentJsonObj?: boolean): object;
}

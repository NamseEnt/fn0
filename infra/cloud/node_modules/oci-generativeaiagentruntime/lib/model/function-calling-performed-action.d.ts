 ...
 *
 */
export interface FunctionCallingPerformedAction extends model.PerformedAction {
    /**
...
export declare namespace FunctionCallingPerformedAction {
    function getJsonObj(obj: FunctionCallingPerformedAction, isParentJsonObj?: boolean): object;
    const performedActionType = "FUNCTION_CALLING_PERFORMED_ACTION";
    function getDeserializedJsonObj(obj: FunctionCallingPerformedAction, isParentJsonObj?: boolean): object;
}

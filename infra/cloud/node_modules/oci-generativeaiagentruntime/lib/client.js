...
class GenerativeAiAgentRuntimeClient {
  ...
  *
     ...
     */
    retrieveMetadata(retrieveMetadataRequest) {
        return __awaiter(this, void 0, void 0, function* () {
            if (this.logger)
            ...
            const specRetryConfiguration = common.OciSdkDefaultRetryConfiguration;
            const retrier = oci_common_1.GenericRetrier.createPreferredRetrier(this._clientConfiguration ? this._clientConfiguration.retryConfiguration : undefined, retrieveMetadataRequest.retryConfiguration, specRetryConfiguration);
            if (this.logger)
                retrier.logger = this.logger;
            const request = yield oci_common_1.composeRequest({
                baseEndpoint: this._endpoint,
                ...
                method: "POST",
                bodyContent: common.ObjectSerializer.serialize(retrieveMetadataRequest.retrieveMetadataDetails, "RetrieveMetadataDetails", model.RetrieveMetadataDetails.getJsonObj),
                pathParams: pathParams,
                headerParams: headerParams,
                queryParams: queryParams
            });
...
GenerativeAiAgentRuntimeClient.serviceEndpointTemplate = "https://agent-runtime.generativeai.{region}.oci.{secondLevelDomain}";

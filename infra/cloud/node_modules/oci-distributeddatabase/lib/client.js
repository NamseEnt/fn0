...
class DistributedAutonomousDbServiceClient {
     ...
     */
    changeDistributedAutonomousDbBackupConfig(changeDistributedAutonomousDbBackupConfigRequest) {
        return __awaiter(this, void 0, void 0, function* () {
            if (this.logger)
                this.logger.debug("Calling operation DistributedAutonomousDbServiceClient#changeDistributedAutonomousDbBackupConfig.");
            const operationName = "changeDistributedAutonomousDbBackupConfig";
            const apiReferenceLink = "";
            const pathParams = {
                "{distributedAutonomousDatabaseId}": changeDistributedAutonomousDbBackupConfigRequest.distributedAutonomousDatabaseId
            };
            const queryParams = {};
            let headerParams = {
                "Content-Type": common.Constants.APPLICATION_JSON,
            ...
            const specRetryConfiguration = common.OciSdkDefaultRetryConfiguration;
            const retrier = oci_common_1.GenericRetrier.createPreferredRetrier(this._clientConfiguration ? this._clientConfiguration.retryConfiguration : undefined, changeDistributedAutonomousDbBackupConfigRequest.retryConfiguration, specRetryConfiguration);
            if (this.logger)
                retrier.logger = this.logger;
            const request = yield oci_common_1.composeRequest({
                baseEndpoint: this._endpoint,
                defaultHeaders: this._defaultHeaders,
                path: "/distributedAutonomousDatabases/{distributedAutonomousDatabaseId}/actions/changeDbBackupConfig",
                method: "POST",
                bodyContent: common.ObjectSerializer.serialize(changeDistributedAutonomousDbBackupConfigRequest.changeDistributedAutonomousDbBackupConfigDetails, "ChangeDistributedAutonomousDbBackupConfigDetails", model.ChangeDistributedAutonomousDbBackupConfigDetails.getJsonObj),
                pathParams: pathParams,
                headerParams: headerParams,
                queryParams: queryParams
            });
     ...
     */
    configureDistributedAutonomousDatabaseGsmWallet(configureDistributedAutonomousDatabaseGsmWalletRequest) {
        return __awaiter(this, void 0, void 0, function* () {
            if (this.logger)
                this.logger.debug("Calling operation DistributedAutonomousDbServiceClient#configureDistributedAutonomousDatabaseGsmWallet.");
            const operationName = "configureDistributedAutonomousDatabaseGsmWallet";
            const apiReferenceLink = "";
            const pathParams = {
                "{distributedAutonomousDatabaseId}": configureDistributedAutonomousDatabaseGsmWalletRequest.distributedAutonomousDatabaseId
            };
            const queryParams = {};
            let headerParams = {
                "Content-Type": common.Constants.APPLICATION_JSON,
            ...
            const specRetryConfiguration = common.OciSdkDefaultRetryConfiguration;
            const retrier = oci_common_1.GenericRetrier.createPreferredRetrier(this._clientConfiguration ? this._clientConfiguration.retryConfiguration : undefined, configureDistributedAutonomousDatabaseGsmWalletRequest.retryConfiguration, specRetryConfiguration);
            if (this.logger)
                retrier.logger = this.logger;
            const request = yield oci_common_1.composeRequest({
                baseEndpoint: this._endpoint,
                defaultHeaders: this._defaultHeaders,
                path: "/distributedAutonomousDatabases/{distributedAutonomousDatabaseId}/actions/configureGsmWallet",
                method: "POST",
                bodyContent: common.ObjectSerializer.serialize(configureDistributedAutonomousDatabaseGsmWalletRequest.configureDistributedAutonomousDatabaseGsmWalletDetails, "ConfigureDistributedAutonomousDatabaseGsmWalletDetails", model.ConfigureDistributedAutonomousDatabaseGsmWalletDetails.getJsonObj),
                pathParams: pathParams,
                headerParams: headerParams,
                queryParams: queryParams
            });
     ...
     */
    getDistributedAutonomousDatabaseRaftMetric(getDistributedAutonomousDatabaseRaftMetricRequest) {
        return __awaiter(this, void 0, void 0, function* () {
            if (this.logger)
                this.logger.debug("Calling operation DistributedAutonomousDbServiceClient#getDistributedAutonomousDatabaseRaftMetric.");
            const operationName = "getDistributedAutonomousDatabaseRaftMetric";
            const apiReferenceLink = "";
            const pathParams = {
                "{distributedAutonomousDatabaseId}": getDistributedAutonomousDatabaseRaftMetricRequest.distributedAutonomousDatabaseId
            };
            const queryParams = {};
            let headerParams = {
                "Content-Type": common.Constants.APPLICATION_JSON,
            ...
            const specRetryConfiguration = common.OciSdkDefaultRetryConfiguration;
            const retrier = oci_common_1.GenericRetrier.createPreferredRetrier(this._clientConfiguration ? this._clientConfiguration.retryConfiguration : undefined, getDistributedAutonomousDatabaseRaftMetricRequest.retryConfiguration, specRetryConfiguration);
            if (this.logger)
                retrier.logger = this.logger;
            const request = yield oci_common_1.composeRequest({
                baseEndpoint: this._endpoint,
     ...
     */
    moveDistributedAutonomousDatabaseReplicationUnit(moveDistributedAutonomousDatabaseReplicationUnitRequest) {
        return __awaiter(this, void 0, void 0, function* () {
            if (this.logger)
                this.logger.debug("Calling operation DistributedAutonomousDbServiceClient#moveDistributedAutonomousDatabaseReplicationUnit.");
            const operationName = "moveDistributedAutonomousDatabaseReplicationUnit";
            const apiReferenceLink = "";
            const pathParams = {
                "{distributedAutonomousDatabaseId}": moveDistributedAutonomousDatabaseReplicationUnitRequest.distributedAutonomousDatabaseId
            };
            const queryParams = {};
            let headerParams = {
                "Content-Type": common.Constants.APPLICATION_JSON,
            ...
            const specRetryConfiguration = common.OciSdkDefaultRetryConfiguration;
            const retrier = oci_common_1.GenericRetrier.createPreferredRetrier(this._clientConfiguration ? this._clientConfiguration.retryConfiguration : undefined, moveDistributedAutonomousDatabaseReplicationUnitRequest.retryConfiguration, specRetryConfiguration);
            if (this.logger)
                retrier.logger = this.logger;
            const request = yield oci_common_1.composeRequest({
                baseEndpoint: this._endpoint,
                defaultHeaders: this._defaultHeaders,
                path: "/distributedAutonomousDatabases/{distributedAutonomousDatabaseId}/actions/moveReplicationUnit",
                method: "POST",
                bodyContent: common.ObjectSerializer.serialize(moveDistributedAutonomousDatabaseReplicationUnitRequest.moveDistributedAutonomousDatabaseReplicationUnitDetails, "MoveDistributedAutonomousDatabaseReplicationUnitDetails", model.MoveDistributedAutonomousDatabaseReplicationUnitDetails.getJsonObj),
                pathParams: pathParams,
                headerParams: headerParams,
                queryParams: queryParams
            });
     ...
     */
    recreateFailedDistributedAutonomousDatabaseResource(recreateFailedDistributedAutonomousDatabaseResourceRequest) {
        return __awaiter(this, void 0, void 0, function* () {
            if (this.logger)
                this.logger.debug("Calling operation DistributedAutonomousDbServiceClient#recreateFailedDistributedAutonomousDatabaseResource.");
            const operationName = "recreateFailedDistributedAutonomousDatabaseResource";
            const apiReferenceLink = "";
            const pathParams = {
                "{distributedAutonomousDatabaseId}": recreateFailedDistributedAutonomousDatabaseResourceRequest.distributedAutonomousDatabaseId
            };
            const queryParams = {
            ...
            const specRetryConfiguration = common.OciSdkDefaultRetryConfiguration;
            const retrier = oci_common_1.GenericRetrier.createPreferredRetrier(this._clientConfiguration ? this._clientConfiguration.retryConfiguration : undefined, recreateFailedDistributedAutonomousDatabaseResourceRequest.retryConfiguration, specRetryConfiguration);
            if (this.logger)
                retrier.logger = this.logger;
            const request = yield oci_common_1.composeRequest({
                baseEndpoint: this._endpoint,
                defaultHeaders: this._defaultHeaders,
                path: "/distributedAutonomousDatabases/{distributedAutonomousDatabaseId}/actions/recreateFailedResource",
                method: "POST",
                pathParams: pathParams,
                headerParams: headerParams,
                queryParams: queryParams
    ...
    validateDistributedAutonomousDatabaseCaBundle(validateDistributedAutonomousDatabaseCaBundleRequest) {
        return __awaiter(this, void 0, void 0, function* () {
            if (this.logger)
                this.logger.debug("Calling operation DistributedAutonomousDbServiceClient#validateDistributedAutonomousDatabaseCaBundle.");
            const operationName = "validateDistributedAutonomousDatabaseCaBundle";
            const apiReferenceLink = "";
            const pathParams = {
                "{distributedAutonomousDatabaseId}": validateDistributedAutonomousDatabaseCaBundleRequest.distributedAutonomousDatabaseId
            };
            const queryParams = {};
            let headerParams = {
                "Content-Type": common.Constants.APPLICATION_JSON,
            ...
            const specRetryConfiguration = common.OciSdkDefaultRetryConfiguration;
            const retrier = oci_common_1.GenericRetrier.createPreferredRetrier(this._clientConfiguration ? this._clientConfiguration.retryConfiguration : undefined, validateDistributedAutonomousDatabaseCaBundleRequest.retryConfiguration, specRetryConfiguration);
            if (this.logger)
                retrier.logger = this.logger;
            const request = yield oci_common_1.composeRequest({
                baseEndpoint: this._endpoint,
                defaultHeaders: this._defaultHeaders,
                path: "/distributedAutonomousDatabases/{distributedAutonomousDatabaseId}/actions/validateCaBundle",
                method: "POST",
                pathParams: pathParams,
                headerParams: headerParams,
                queryParams: queryParams
...
class DistributedDbServiceClient {
     ...
     */
    getDistributedDatabaseRaftMetric(getDistributedDatabaseRaftMetricRequest) {
        return __awaiter(this, void 0, void 0, function* () {
            if (this.logger)
                this.logger.debug("Calling operation DistributedDbServiceClient#getDistributedDatabaseRaftMetric.");
            ...
            const specRetryConfiguration = common.OciSdkDefaultRetryConfiguration;
            const retrier = oci_common_1.GenericRetrier.createPreferredRetrier(this._clientConfiguration ? this._clientConfiguration.retryConfiguration : undefined, getDistributedDatabaseRaftMetricRequest.retryConfiguration, specRetryConfiguration);
            if (this.logger)
                retrier.logger = this.logger;
            const request = yield oci_common_1.composeRequest({
                baseEndpoint: this._endpoint,
     ...
     */
    moveDistributedDatabaseReplicationUnit(moveDistributedDatabaseReplicationUnitRequest) {
        return __awaiter(this, void 0, void 0, function* () {
            if (this.logger)
                this.logger.debug("Calling operation DistributedDbServiceClient#moveDistributedDatabaseReplicationUnit.");
            ...
            const specRetryConfiguration = common.OciSdkDefaultRetryConfiguration;
            const retrier = oci_common_1.GenericRetrier.createPreferredRetrier(this._clientConfiguration ? this._clientConfiguration.retryConfiguration : undefined, moveDistributedDatabaseReplicationUnitRequest.retryConfiguration, specRetryConfiguration);
            if (this.logger)
                retrier.logger = this.logger;
            const request = yield oci_common_1.composeRequest({
                baseEndpoint: this._endpoint,
                ...
                method: "POST",
                bodyContent: common.ObjectSerializer.serialize(moveDistributedDatabaseReplicationUnitRequest.moveDistributedDatabaseReplicationUnitDetails, "MoveDistributedDatabaseReplicationUnitDetails", model.MoveDistributedDatabaseReplicationUnitDetails.getJsonObj),
                pathParams: pathParams,
                headerParams: headerParams,
                queryParams: queryParams
            });
     ...
     */
    recreateFailedDistributedDatabaseResource(recreateFailedDistributedDatabaseResourceRequest) {
        return __awaiter(this, void 0, void 0, function* () {
            if (this.logger)
                this.logger.debug("Calling operation DistributedDbServiceClient#recreateFailedDistributedDatabaseResource.");
            const operationName = "recreateFailedDistributedDatabaseResource";
            const apiReferenceLink = "";
            const pathParams = {
                "{distributedDatabaseId}": recreateFailedDistributedDatabaseResourceRequest.distributedDatabaseId
            };
            const queryParams = {
            ...
            const specRetryConfiguration = common.OciSdkDefaultRetryConfiguration;
            const retrier = oci_common_1.GenericRetrier.createPreferredRetrier(this._clientConfiguration ? this._clientConfiguration.retryConfiguration : undefined, recreateFailedDistributedDatabaseResourceRequest.retryConfiguration, specRetryConfiguration);
            if (this.logger)
                retrier.logger = this.logger;
            const request = yield oci_common_1.composeRequest({
                baseEndpoint: this._endpoint,

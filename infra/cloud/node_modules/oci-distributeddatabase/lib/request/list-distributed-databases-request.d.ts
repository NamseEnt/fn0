...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/distributeddatabase/ListDistributedDatabases.ts.html |here} to see how to use ListDistributedDatabasesRequest.
 */
export interface ListDistributedDatabasesRequest extends common.BaseRequest {
    /**
...
export declare namespace ListDistributedDatabasesRequest {
    enum SortBy {

...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/distributeddatabase/ListDistributedAutonomousDatabases.ts.html |here} to see how to use ListDistributedAutonomousDatabasesRequest.
 */
...
export declare namespace ListDistributedAutonomousDatabasesRequest {
    enum SortBy {

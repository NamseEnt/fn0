...
export declare namespace CatalogPeerWithExadbXs {
    enum Status {
        Failed = "FAILED",
        Deleting = "DELETING",
        Deleted = "DELETED",
    ...
    function getJsonObj(obj: CatalogPeerWithExadbXs): object;
    function getDeserializedJsonObj(obj: CatalogPeerWithExadbXs): object;
}

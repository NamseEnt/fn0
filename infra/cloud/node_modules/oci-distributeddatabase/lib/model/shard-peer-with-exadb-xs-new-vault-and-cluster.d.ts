 ...
 */
export interface ShardPeerWithExadbXsNewVaultAndCluster {
    /**
     ...
     */
    "status": ShardPeerWithExadbXsNewVaultAndCluster.Status;
    /**
...
export declare namespace ShardPeerWithExadbXsNewVaultAndCluster {
    enum Status {
        Failed = "FAILED",
        Deleting = "DELETING",
        Deleted = "DELETED",
    ...
    function getJsonObj(obj: ShardPeerWithExadbXsNewVaultAndCluster): object;
    function getDeserializedJsonObj(obj: ShardPeerWithExadbXsNewVaultAndCluster): object;
}

...
export declare namespace ShardPeerWithDedicatedInfra {
    enum Status {
        Failed = "FAILED",
        Deleting = "DELETING",
        Deleted = "DELETED",
    ...
    function getJsonObj(obj: ShardPeerWithDedicatedInfra): object;
    function getDeserializedJsonObj(obj: ShardPeerWithDedicatedInfra): object;
}

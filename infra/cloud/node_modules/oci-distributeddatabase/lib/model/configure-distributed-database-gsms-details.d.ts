 ...
 *
 */
export interface ConfigureDistributedDatabaseGsmsDetails {
    /**
...
export declare namespace ConfigureDistributedDatabaseGsmsDetails {
    function getJsonObj(obj: ConfigureDistributedDatabaseGsmsDetails): object;
    function getDeserializedJsonObj(obj: ConfigureDistributedDatabaseGsmsDetails): object;
}

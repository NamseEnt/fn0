 ...
 */
export interface DistributedAutonomousDatabaseShardWithDedicatedInfra extends model.DistributedAutonomousDatabaseShard {
    /**
...
export declare namespace DistributedAutonomousDatabaseShardWithDedicatedInfra {
    enum Status {
        Failed = "FAILED",
        Deleting = "DELETING",
        Deleted = "DELETED",
    ...
    function getJsonObj(obj: DistributedAutonomousDatabaseShardWithDedicatedInfra, isParentJsonObj?: boolean): object;
    const source = "ADB_D";
    function getDeserializedJsonObj(obj: DistributedAutonomousDatabaseShardWithDedicatedInfra, isParentJsonObj?: boolean): object;
}

 ...
 *
 */
export interface AddDistributedAutonomousDatabaseGdsControlNodeDetails {
    /**
...
export declare namespace AddDistributedAutonomousDatabaseGdsControlNodeDetails {
    function getJsonObj(obj: AddDistributedAutonomousDatabaseGdsControlNodeDetails): object;
    function getDeserializedJsonObj(obj: AddDistributedAutonomousDatabaseGdsControlNodeDetails): object;
}

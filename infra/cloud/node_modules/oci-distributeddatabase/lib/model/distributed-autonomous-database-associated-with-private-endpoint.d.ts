...
export declare namespace DistributedAutonomousDatabaseAssociatedWithPrivateEndpoint {
    function getJsonObj(obj: DistributedAutonomousDatabaseAssociatedWithPrivateEndpoint): object;
    function getDeserializedJsonObj(obj: DistributedAutonomousDatabaseAssociatedWithPrivateEndpoint): object;
}

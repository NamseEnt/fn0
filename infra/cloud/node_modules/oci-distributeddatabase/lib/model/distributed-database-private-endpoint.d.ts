...
export interface DistributedDatabasePrivateEndpoint {
     ...
     *
     */
    "globallyDistributedAutonomousDatabases"?: Array<model.DistributedAutonomousDatabaseAssociatedWithPrivateEndpoint>;
    /**
...
export declare namespace DistributedDatabasePrivateEndpoint {
    enum LifecycleState {
        Active = "ACTIVE",
        Failed = "FAILED",
        Inactive = "INACTIVE",
    ...
    function getJsonObj(obj: DistributedDatabasePrivateEndpoint): object;
    function getDeserializedJsonObj(obj: DistributedDatabasePrivateEndpoint): object;
}

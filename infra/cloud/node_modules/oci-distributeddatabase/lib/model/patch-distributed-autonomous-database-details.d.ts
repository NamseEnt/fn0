 ...
 *
 */
export interface PatchDistributedAutonomousDatabaseDetails {
    /**
     * List of patch instructions.
     */
    "items"?: Array<model.PatchInstruction>;
}
export declare namespace PatchDistributedAutonomousDatabaseDetails {
    function getJsonObj(obj: PatchDistributedAutonomousDatabaseDetails): object;
    function getDeserializedJsonObj(obj: PatchDistributedAutonomousDatabaseDetails): object;
}

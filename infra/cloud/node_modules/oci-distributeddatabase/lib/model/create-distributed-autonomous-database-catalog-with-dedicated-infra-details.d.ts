 ...
 */
export interface CreateDistributedAutonomousDatabaseCatalogWithDedicatedInfraDetails extends model.CreateDistributedAutonomousDatabaseCatalogDetails {
    /**
...
export declare namespace CreateDistributedAutonomousDatabaseCatalogWithDedicatedInfraDetails {
    function getJsonObj(obj: CreateDistributedAutonomousDatabaseCatalogWithDedicatedInfraDetails, isParentJsonObj?: boolean): object;
    const source = "ADB_D";
    function getDeserializedJsonObj(obj: CreateDistributedAutonomousDatabaseCatalogWithDedicatedInfraDetails, isParentJsonObj?: boolean): object;
}

 ...
 *
 */
export interface AddDistributedDatabaseGdsControlNodeDetails {
    /**
...
export declare namespace AddDistributedDatabaseGdsControlNodeDetails {
    function getJsonObj(obj: AddDistributedDatabaseGdsControlNodeDetails): object;
    function getDeserializedJsonObj(obj: AddDistributedDatabaseGdsControlNodeDetails): object;
}

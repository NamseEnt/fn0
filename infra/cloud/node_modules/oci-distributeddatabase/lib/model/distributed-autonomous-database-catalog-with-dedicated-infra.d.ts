 ...
 */
export interface DistributedAutonomousDatabaseCatalogWithDedicatedInfra extends model.DistributedAutonomousDatabaseCatalog {
    /**
...
export declare namespace DistributedAutonomousDatabaseCatalogWithDedicatedInfra {
    enum Status {
        Failed = "FAILED",
        Deleting = "DELETING",
        Deleted = "DELETED",
    ...
    function getJsonObj(obj: DistributedAutonomousDatabaseCatalogWithDedicatedInfra, isParentJsonObj?: boolean): object;
    const source = "ADB_D";
    function getDeserializedJsonObj(obj: DistributedAutonomousDatabaseCatalogWithDedicatedInfra, isParentJsonObj?: boolean): object;
}

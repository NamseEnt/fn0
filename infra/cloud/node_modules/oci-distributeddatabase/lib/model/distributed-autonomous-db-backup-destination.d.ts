 ...
 */
export interface DistributedAutonomousDbBackupDestination {
    /**
     * Type of the database backup destination.
     */
    "type": DistributedAutonomousDbBackupDestination.Type;
    /**
...
export declare namespace DistributedAutonomousDbBackupDestination {
    enum Type {
        Nfs = "NFS",
    ...
    function getJsonObj(obj: DistributedAutonomousDbBackupDestination): object;
    function getDeserializedJsonObj(obj: DistributedAutonomousDbBackupDestination): object;
}

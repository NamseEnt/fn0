 ...
 */
export interface DistributedDatabaseShardWithExadbXsNewVaultAndCluster extends model.DistributedDatabaseShard {
    /**
     ...
     */
    "status": DistributedDatabaseShardWithExadbXsNewVaultAndCluster.Status;
    /**
     ...
     */
    "peerDetails"?: Array<model.ShardPeerWithExadbXsNewVaultAndCluster>;
    "metadata"?: model.DistributedDbMetadata;
    "source": string;
}
export declare namespace DistributedDatabaseShardWithExadbXsNewVaultAndCluster {
    enum Status {
        Failed = "FAILED",
        Deleting = "DELETING",
        Deleted = "DELETED",
    ...
    function getJsonObj(obj: DistributedDatabaseShardWithExadbXsNewVaultAndCluster, isParentJsonObj?: boolean): object;
    const source = "NEW_VAULT_AND_CLUSTER";
    function getDeserializedJsonObj(obj: DistributedDatabaseShardWithExadbXsNewVaultAndCluster, isParentJsonObj?: boolean): object;
}

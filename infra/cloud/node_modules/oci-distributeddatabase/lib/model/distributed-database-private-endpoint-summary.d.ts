...
export declare namespace DistributedDatabasePrivateEndpointSummary {
    function getJsonObj(obj: DistributedDatabasePrivateEndpointSummary): object;
    function getDeserializedJsonObj(obj: DistributedDatabasePrivateEndpointSummary): object;
}

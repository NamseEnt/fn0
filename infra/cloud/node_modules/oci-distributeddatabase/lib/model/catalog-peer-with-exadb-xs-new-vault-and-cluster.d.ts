...
export declare namespace CatalogPeerWithExadbXsNewVaultAndCluster {
    enum Status {
        Failed = "FAILED",
        Deleting = "DELETING",
        Deleted = "DELETED",
    ...
    function getJsonObj(obj: CatalogPeerWithExadbXsNewVaultAndCluster): object;
    function getDeserializedJsonObj(obj: CatalogPeerWithExadbXsNewVaultAndCluster): object;
}

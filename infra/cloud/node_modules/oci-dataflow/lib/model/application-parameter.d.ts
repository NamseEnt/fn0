...
export declare namespace ApplicationParameter {
    function getJsonObj(obj: ApplicationParameter): object;
    function getDeserializedJsonObj(obj: ApplicationParameter): object;
}

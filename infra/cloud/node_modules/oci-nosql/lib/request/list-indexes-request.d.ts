...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/nosql/ListIndexes.ts.html |here} to see how to use ListIndexesRequest.
 */
...
export declare namespace ListIndexesRequest {
    enum LifecycleState {
        All = "ALL",
        Creating = "CREATING",
        Updating = "UPDATING",

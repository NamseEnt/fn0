...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/nosql/CreateTable.ts.html |here} to see how to use CreateTableRequest.
 */
export interface CreateTableRequest extends common.BaseRequest {
    /**
     * Specifications for the new table.
     */
    "createTableDetails": model.CreateTableDetails;
    /**

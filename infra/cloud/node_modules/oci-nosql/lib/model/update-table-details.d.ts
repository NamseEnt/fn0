...
export declare namespace UpdateTableDetails {
    function getJsonObj(obj: UpdateTableDetails): object;
    function getDeserializedJsonObj(obj: UpdateTableDetails): object;
}

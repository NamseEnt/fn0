...
exports.VbInstanceWaiter = void 0;
const models = __importStar(require("./model"));
const oci_common_1 = require("oci-common");
class VbInstanceWaiter {
     ...
     */
    forVbInstance(request, ...targetStates) {
        return __awaiter(this, void 0, void 0, function* () {
            return oci_common_1.genericTerminalConditionWaiter(this.config, () => this.client.getVbInstance(request), response => targetStates.includes(response.vbInstance.lifecycleState), targetStates.includes(models.VbInstance.LifecycleState.Deleted));
        });
    }
    /**
...
exports.VbInstanceWaiter = VbInstanceWaiter;
//# sourceMappingURL=vbinstance-waiter.js.map
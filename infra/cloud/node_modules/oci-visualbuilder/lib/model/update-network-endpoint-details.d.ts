 ...
 *
 */
export interface UpdateNetworkEndpointDetails {
    "networkEndpointType": string;
}
export declare namespace UpdateNetworkEndpointDetails {
    function getJsonObj(obj: UpdateNetworkEndpointDetails): object;
    function getDeserializedJsonObj(obj: UpdateNetworkEndpointDetails): object;
}

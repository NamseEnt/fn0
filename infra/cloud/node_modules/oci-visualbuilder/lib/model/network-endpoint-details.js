...
(function (NetworkEndpointDetails) {
    function getJsonObj(obj) {
        ...
        if (obj && "networkEndpointType" in obj && obj.networkEndpointType) {
            switch (obj.networkEndpointType) {
                case "PRIVATE":
                    return model.PrivateEndpointDetails.getJsonObj(jsonObj, true);
                case "PUBLIC":
    ...
    function getDeserializedJsonObj(obj) {
        ...
        if (obj && "networkEndpointType" in obj && obj.networkEndpointType) {
            switch (obj.networkEndpointType) {
                case "PRIVATE":
                    return model.PrivateEndpointDetails.getDeserializedJsonObj(jsonObj, true);
                case "PUBLIC":
    ...
    NetworkEndpointDetails.getDeserializedJsonObj = getDeserializedJsonObj;
})(NetworkEndpointDetails = exports.NetworkEndpointDetails || (exports.NetworkEndpointDetails = {}));
//# sourceMappingURL=network-endpoint-details.js.map
 ...
 */
export interface VbInstanceSummary {
    /**
     ...
     */
    "lifecycleState": VbInstanceSummary.LifecycleState;
    /**
     ...
     */
    "consumptionModel"?: VbInstanceSummary.ConsumptionModel;
    /**
...
export declare namespace VbInstanceSummary {
    enum LifecycleState {
        Creating = "CREATING",
        Updating = "UPDATING",
        Active = "ACTIVE",
    ...
    function getJsonObj(obj: VbInstanceSummary): object;
    function getDeserializedJsonObj(obj: VbInstanceSummary): object;
}

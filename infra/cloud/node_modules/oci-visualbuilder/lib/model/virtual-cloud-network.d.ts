 ...
 *
 */
export interface VirtualCloudNetwork {
    /**
     ...
     *
     */
    "allowlistedIpCidrs"?: Array<string>;
}
export declare namespace VirtualCloudNetwork {
    function getJsonObj(obj: VirtualCloudNetwork): object;
    function getDeserializedJsonObj(obj: VirtualCloudNetwork): object;
}

 ...
 */
export interface ChangeVbInstanceCompartmentDetails {
    /**
     * Compartment Identifier.
     */
    "compartmentId": string;
}
export declare namespace ChangeVbInstanceCompartmentDetails {
    function getJsonObj(obj: ChangeVbInstanceCompartmentDetails): object;
    function getDeserializedJsonObj(obj: ChangeVbInstanceCompartmentDetails): object;
}

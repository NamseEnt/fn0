 ...
 */
export interface VbInstanceSummaryCollection {
    /**
     * The collection of VbInstanceSummary objects.
     */
    "items": Array<model.VbInstanceSummary>;
}
export declare namespace VbInstanceSummaryCollection {
    function getJsonObj(obj: VbInstanceSummaryCollection): object;
    function getDeserializedJsonObj(obj: VbInstanceSummaryCollection): object;
}

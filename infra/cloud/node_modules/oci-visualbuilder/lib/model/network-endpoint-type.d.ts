 ...
 *
 **/
export declare enum NetworkEndpointType {
    Public = "PUBLIC",
    Private = "PRIVATE",
    /**
...
export declare namespace NetworkEndpointType {
    function getJsonObj(obj: NetworkEndpointType): NetworkEndpointType;
    function getDeserializedJsonObj(obj: NetworkEndpointType): NetworkEndpointType;
}

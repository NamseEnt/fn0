 ...
 */
export interface PrivilegedApiRequestOperationDetails {
    /**
...
export declare namespace PrivilegedApiRequestOperationDetails {
    function getJsonObj(obj: PrivilegedApiRequestOperationDetails): object;
    function getDeserializedJsonObj(obj: PrivilegedApiRequestOperationDetails): object;
}

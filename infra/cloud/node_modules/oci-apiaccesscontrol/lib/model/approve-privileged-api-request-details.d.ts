...
export declare namespace ApprovePrivilegedApiRequestDetails {
    function getJsonObj(obj: ApprovePrivilegedApiRequestDetails): object;
    function getDeserializedJsonObj(obj: ApprovePrivilegedApiRequestDetails): object;
}

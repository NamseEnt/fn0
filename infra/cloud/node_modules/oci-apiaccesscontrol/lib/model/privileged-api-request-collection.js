...
exports.PrivilegedApiRequestCollection = void 0;
const model = __importStar(require("../model"));
var PrivilegedApiRequestCollection;
(function (PrivilegedApiRequestCollection) {
    function getJsonObj(obj) {
        const jsonObj = Object.assign(Object.assign({}, obj), {
            "items": obj.items
                ? obj.items.map(item => {
                    return model.PrivilegedApiRequestSummary.getJsonObj(item);
                })
                : undefined
        });
        return jsonObj;
    }
    PrivilegedApiRequestCollection.getJsonObj = getJsonObj;
    function getDeserializedJsonObj(obj) {
        const jsonObj = Object.assign(Object.assign({}, obj), {
            "items": obj.items
                ? obj.items.map(item => {
                    return model.PrivilegedApiRequestSummary.getDeserializedJsonObj(item);
                })
                : undefined
        });
        return jsonObj;
    }
    PrivilegedApiRequestCollection.getDeserializedJsonObj = getDeserializedJsonObj;
})(PrivilegedApiRequestCollection = exports.PrivilegedApiRequestCollection || (exports.PrivilegedApiRequestCollection = {}));
//# sourceMappingURL=privileged-api-request-collection.js.map
 ...
 */
export interface PrivilegedApiDetails {
    /**
...
export declare namespace PrivilegedApiDetails {
    function getJsonObj(obj: PrivilegedApiDetails): object;
    function getDeserializedJsonObj(obj: PrivilegedApiDetails): object;
}

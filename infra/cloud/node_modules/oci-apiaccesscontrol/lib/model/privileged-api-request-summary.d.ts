...
export declare namespace PrivilegedApiRequestSummary {
    function getJsonObj(obj: PrivilegedApiRequestSummary): object;
    function getDeserializedJsonObj(obj: PrivilegedApiRequestSummary): object;
}

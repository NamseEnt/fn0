...
exports.ApiMetadataByEntityTypeCollection = void 0;
const model = __importStar(require("../model"));
var ApiMetadataByEntityTypeCollection;
(function (ApiMetadataByEntityTypeCollection) {
    function getJsonObj(obj) {
        const jsonObj = Object.assign(Object.assign({}, obj), {
            "items": obj.items
                ? obj.items.map(item => {
                    return model.ApiMetadataByEntityTypeSummary.getJsonObj(item);
                })
                : undefined
        });
        return jsonObj;
    }
    ApiMetadataByEntityTypeCollection.getJsonObj = getJsonObj;
    function getDeserializedJsonObj(obj) {
        const jsonObj = Object.assign(Object.assign({}, obj), {
            "items": obj.items
                ? obj.items.map(item => {
                    return model.ApiMetadataByEntityTypeSummary.getDeserializedJsonObj(item);
                })
                : undefined
        });
        return jsonObj;
    }
    ApiMetadataByEntityTypeCollection.getDeserializedJsonObj = getDeserializedJsonObj;
})(ApiMetadataByEntityTypeCollection = exports.ApiMetadataByEntityTypeCollection || (exports.ApiMetadataByEntityTypeCollection = {}));
//# sourceMappingURL=api-metadata-by-entity-type-collection.js.map
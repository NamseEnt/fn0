 ...
 */
export interface ApiMetadataByEntityTypeCollection {
    /**
     * List of apiMetadataByEntityTypeSummary.
     */
    "items": Array<model.ApiMetadataByEntityTypeSummary>;
}
export declare namespace ApiMetadataByEntityTypeCollection {
    function getJsonObj(obj: ApiMetadataByEntityTypeCollection): object;
    function getDeserializedJsonObj(obj: ApiMetadataByEntityTypeCollection): object;
}

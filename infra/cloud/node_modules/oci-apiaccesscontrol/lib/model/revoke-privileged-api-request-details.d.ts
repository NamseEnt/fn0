 ...
 */
export interface RevokePrivilegedApiRequestDetails {
    /**
     * Comment specified by the approver explaining why the approval is revoked.
     */
    "approverComment"?: string;
}
export declare namespace RevokePrivilegedApiRequestDetails {
    function getJsonObj(obj: RevokePrivilegedApiRequestDetails): object;
    function getDeserializedJsonObj(obj: RevokePrivilegedApiRequestDetails): object;
}

 ...
 */
export interface ApiMetadataCollection {
    /**
     * List of apiMetadataSummary.
     */
    "items": Array<model.ApiMetadataSummary>;
}
export declare namespace ApiMetadataCollection {
    function getJsonObj(obj: ApiMetadataCollection): object;
    function getDeserializedJsonObj(obj: ApiMetadataCollection): object;
}

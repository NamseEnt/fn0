 ...
 */
export interface UpdatePrivilegedApiControlDetails {
    /**
...
export declare namespace UpdatePrivilegedApiControlDetails {
    function getJsonObj(obj: UpdatePrivilegedApiControlDetails): object;
    function getDeserializedJsonObj(obj: UpdatePrivilegedApiControlDetails): object;
}

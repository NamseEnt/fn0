 ...
 */
export interface RejectPrivilegedApiRequestDetails {
    /**
     * Comment by the approver explaining why the request is rejected.
     */
    "approverComment"?: string;
}
export declare namespace RejectPrivilegedApiRequestDetails {
    function getJsonObj(obj: RejectPrivilegedApiRequestDetails): object;
    function getDeserializedJsonObj(obj: RejectPrivilegedApiRequestDetails): object;
}

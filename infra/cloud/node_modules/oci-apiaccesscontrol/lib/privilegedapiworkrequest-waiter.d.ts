...
export declare class PrivilegedApiWorkRequestWaiter {
    private client;
    private readonly config?;
    constructor(client: PrivilegedApiWorkRequestClient, config?: Partial<import("oci-common/lib/waiter").WaiterConfigurationDetails> | undefined);
    /**

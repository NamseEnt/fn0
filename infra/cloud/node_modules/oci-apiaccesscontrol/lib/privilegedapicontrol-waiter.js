...
exports.PrivilegedApiControlWaiter = void 0;
const models = __importStar(require("./model"));
const oci_common_1 = require("oci-common");
class PrivilegedApiControlWaiter {
    constructor(client, config) {
        this.client = client;
        this.config = config;
    }
    /**
     * Waits forPrivilegedApiControl till it reaches any of the provided states
     *
     * @param request the request to send
     * @param targetStates the desired states to wait for. The waiter will return once the resource reaches any of the provided states
     * @return response returns GetPrivilegedApiControlResponse | null (null in case of 404 response)
     */
    forPrivilegedApiControl(request, ...targetStates) {
        return __awaiter(this, void 0, void 0, function* () {
            return oci_common_1.genericTerminalConditionWaiter(this.config, () => this.client.getPrivilegedApiControl(request), response => targetStates.includes(response.privilegedApiControl.lifecycleState), targetStates.includes(models.PrivilegedApiControl.LifecycleState.Deleted));
        });
    }
}
exports.PrivilegedApiControlWaiter = PrivilegedApiControlWaiter;
//# sourceMappingURL=privilegedapicontrol-waiter.js.map
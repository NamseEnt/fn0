...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/apiaccesscontrol/ListPrivilegedApiRequests.ts.html |here} to see how to use ListPrivilegedApiRequestsRequest.
 */
export interface ListPrivilegedApiRequestsRequest extends common.BaseRequest {
    /**
...
export declare namespace ListPrivilegedApiRequestsRequest {
    enum SortBy {

...
export declare class ApiMetadataWaiter {
    private client;
    private readonly config?;
    constructor(client: ApiMetadataClient, config?: Partial<import("oci-common/lib/waiter").WaiterConfigurationDetails> | undefined);
    /**
     ...
     */
    forApiMetadata(request: serviceRequests.GetApiMetadataRequest, ...targetStates: models.ApiMetadata.LifecycleState[]): Promise<serviceResponses.GetApiMetadataResponse | null>;
}

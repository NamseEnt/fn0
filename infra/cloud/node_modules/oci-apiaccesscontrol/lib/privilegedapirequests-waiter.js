...
exports.PrivilegedApiRequestsWaiter = void 0;
const oci_common_1 = require("oci-common");
class PrivilegedApiRequestsWaiter {
     ...
     */
    forPrivilegedApiRequest(request, ...targetStates) {
        return __awaiter(this, void 0, void 0, function* () {
            return oci_common_1.genericWaiter(this.config, () => this.client.getPrivilegedApiRequest(request), response => targetStates.includes(response.privilegedApiRequest.lifecycleState));
        });
    }
}
exports.PrivilegedApiRequestsWaiter = PrivilegedApiRequestsWaiter;
//# sourceMappingURL=privilegedapirequests-waiter.js.map
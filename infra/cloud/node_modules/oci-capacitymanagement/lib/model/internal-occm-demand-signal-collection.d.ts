 ...
 *
 */
export interface InternalOccmDemandSignalCollection {
    /**
     * An array of demand signal
     *
     */
    "items": Array<model.InternalOccmDemandSignalSummary>;
}
export declare namespace InternalOccmDemandSignalCollection {
    function getJsonObj(obj: InternalOccmDemandSignalCollection): object;
    function getDeserializedJsonObj(obj: InternalOccmDemandSignalCollection): object;
}

...
export declare namespace UpdateInternalOccCapacityRequestDetails {
    enum RequestState {
        Resolved = "RESOLVED",
        Rejected = "REJECTED",
        InProgress = "IN_PROGRESS"
    }
    function getJsonObj(obj: UpdateInternalOccCapacityRequestDetails): object;
    function getDeserializedJsonObj(obj: UpdateInternalOccCapacityRequestDetails): object;
}

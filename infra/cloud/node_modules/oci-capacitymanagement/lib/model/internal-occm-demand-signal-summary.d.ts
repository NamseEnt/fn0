...
export declare namespace InternalOccmDemandSignalSummary {
    function getJsonObj(obj: InternalOccmDemandSignalSummary): object;
    function getDeserializedJsonObj(obj: InternalOccmDemandSignalSummary): object;
}

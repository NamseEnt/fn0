...
export declare namespace OccOverviewSummary {
    function getJsonObj(obj: OccOverviewSummary): object;
    function getDeserializedJsonObj(obj: OccOverviewSummary): object;
}

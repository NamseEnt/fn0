...
export declare namespace UpdateOccmDemandSignalItemDetails {
    function getJsonObj(obj: UpdateOccmDemandSignalItemDetails): object;
    function getDeserializedJsonObj(obj: UpdateOccmDemandSignalItemDetails): object;
}

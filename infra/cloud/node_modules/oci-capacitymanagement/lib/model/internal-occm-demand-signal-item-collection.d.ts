 ...
 *
 */
export interface InternalOccmDemandSignalItemCollection {
    /**
     * An array of items containing detailed information about different resource demanded as part of a demand signal.
     *
     */
    "items": Array<model.InternalOccmDemandSignalItemSummary>;
}
export declare namespace InternalOccmDemandSignalItemCollection {
    function getJsonObj(obj: InternalOccmDemandSignalItemCollection): object;
    function getDeserializedJsonObj(obj: InternalOccmDemandSignalItemCollection): object;
}

...
export declare namespace OccHandoverResourceBlockDetailCollection {
    function getJsonObj(obj: OccHandoverResourceBlockDetailCollection): object;
    function getDeserializedJsonObj(obj: OccHandoverResourceBlockDetailCollection): object;
}

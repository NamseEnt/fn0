 ...
 *
 */
export interface InternalOccmDemandSignalItemSummary {
    /**
...
export declare namespace InternalOccmDemandSignalItemSummary {
    function getJsonObj(obj: InternalOccmDemandSignalItemSummary): object;
    function getDeserializedJsonObj(obj: InternalOccmDemandSignalItemSummary): object;
}

 ...
 *
 */
export interface InternalOccmDemandSignal {
    /**
...
export declare namespace InternalOccmDemandSignal {
    function getJsonObj(obj: InternalOccmDemandSignal): object;
    function getDeserializedJsonObj(obj: InternalOccmDemandSignal): object;
}

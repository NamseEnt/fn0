...
export declare namespace AssociatedOccHandoverResourceBlock {
    function getJsonObj(obj: AssociatedOccHandoverResourceBlock): object;
    function getDeserializedJsonObj(obj: AssociatedOccHandoverResourceBlock): object;
}

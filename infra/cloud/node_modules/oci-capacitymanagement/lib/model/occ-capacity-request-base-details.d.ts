...
export declare namespace OccCapacityRequestBaseDetails {
    function getJsonObj(obj: OccCapacityRequestBaseDetails): object;
    function getDeserializedJsonObj(obj: OccCapacityRequestBaseDetails): object;
}

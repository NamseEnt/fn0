...
export declare namespace OccmDemandSignalResourcePropertiesSummary {
    function getJsonObj(obj: OccmDemandSignalResourcePropertiesSummary): object;
    function getDeserializedJsonObj(obj: OccmDemandSignalResourcePropertiesSummary): object;
}

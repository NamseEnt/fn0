...
export declare namespace UpdateInternalOccmDemandSignalDetails {
    enum LifecycleDetails {
        InProgress = "IN_PROGRESS",
        Completed = "COMPLETED",
        Rejected = "REJECTED"
    }
    function getJsonObj(obj: UpdateInternalOccmDemandSignalDetails): object;
    function getDeserializedJsonObj(obj: UpdateInternalOccmDemandSignalDetails): object;
}

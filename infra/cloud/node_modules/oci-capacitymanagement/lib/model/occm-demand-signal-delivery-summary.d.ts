...
export declare namespace OccmDemandSignalDeliverySummary {
    enum LifecycleState {
        Creating = "CREATING",
        Active = "ACTIVE",
        Updating = "UPDATING",
    ...
    function getJsonObj(obj: OccmDemandSignalDeliverySummary): object;
    function getDeserializedJsonObj(obj: OccmDemandSignalDeliverySummary): object;
}

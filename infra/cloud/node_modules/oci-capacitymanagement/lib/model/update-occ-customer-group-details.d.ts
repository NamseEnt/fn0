...
export declare namespace UpdateOccCustomerGroupDetails {
    enum Status {
        Enabled = "ENABLED",
        Disabled = "DISABLED"
    }
    function getJsonObj(obj: UpdateOccCustomerGroupDetails): object;
    function getDeserializedJsonObj(obj: UpdateOccCustomerGroupDetails): object;
}

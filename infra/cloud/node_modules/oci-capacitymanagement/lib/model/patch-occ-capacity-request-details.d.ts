...
export declare namespace PatchOccCapacityRequestDetails {
    function getJsonObj(obj: PatchOccCapacityRequestDetails): object;
    function getDeserializedJsonObj(obj: PatchOccCapacityRequestDetails): object;
}

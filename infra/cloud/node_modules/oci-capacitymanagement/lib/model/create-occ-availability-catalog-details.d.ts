...
export declare namespace CreateOccAvailabilityCatalogDetails {
    function getJsonObj(obj: CreateOccAvailabilityCatalogDetails): object;
    function getDeserializedJsonObj(obj: CreateOccAvailabilityCatalogDetails): object;
}

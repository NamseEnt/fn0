 ...
 */
export interface OccAvailabilityCatalogCollection {
    /**
     * An array of availability catalogs.
     */
    "items": Array<model.OccAvailabilityCatalogSummary>;
}
export declare namespace OccAvailabilityCatalogCollection {
    function getJsonObj(obj: OccAvailabilityCatalogCollection): object;
    function getDeserializedJsonObj(obj: OccAvailabilityCatalogCollection): object;
}

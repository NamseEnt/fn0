 ...
 *
 */
export interface InternalOccmDemandSignalDeliveryCollection {
    /**
     * An array of items containing detailed information about demand signal delivery resources.
     *
     */
    "items": Array<model.InternalOccmDemandSignalDeliverySummary>;
}
export declare namespace InternalOccmDemandSignalDeliveryCollection {
    function getJsonObj(obj: InternalOccmDemandSignalDeliveryCollection): object;
    function getDeserializedJsonObj(obj: InternalOccmDemandSignalDeliveryCollection): object;
}

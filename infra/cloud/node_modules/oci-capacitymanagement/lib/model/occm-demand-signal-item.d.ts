...
export declare namespace OccmDemandSignalItem {
    enum LifecycleState {
        Creating = "CREATING",
        Updating = "UPDATING",
        Active = "ACTIVE",
    ...
    function getJsonObj(obj: OccmDemandSignalItem): object;
    function getDeserializedJsonObj(obj: OccmDemandSignalItem): object;
}

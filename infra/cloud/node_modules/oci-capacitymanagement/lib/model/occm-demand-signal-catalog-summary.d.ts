...
export declare namespace OccmDemandSignalCatalogSummary {
    function getJsonObj(obj: OccmDemandSignalCatalogSummary): object;
    function getDeserializedJsonObj(obj: OccmDemandSignalCatalogSummary): object;
}

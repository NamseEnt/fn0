...
export declare namespace BulkCreateOccmDemandSignalItem {
    function getJsonObj(obj: BulkCreateOccmDemandSignalItem): object;
    function getDeserializedJsonObj(obj: BulkCreateOccmDemandSignalItem): object;
}

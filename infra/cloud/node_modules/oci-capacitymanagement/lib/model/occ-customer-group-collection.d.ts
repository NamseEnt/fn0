 ...
 */
export interface OccCustomerGroupCollection {
    /**
     * An array of customer groups.
     */
    "items": Array<model.OccCustomerGroupSummary>;
}
export declare namespace OccCustomerGroupCollection {
    function getJsonObj(obj: OccCustomerGroupCollection): object;
    function getDeserializedJsonObj(obj: OccCustomerGroupCollection): object;
}

 ...
 *
 */
export interface OccmDemandSignalItemSummary {
    /**
...
export declare namespace OccmDemandSignalItemSummary {
    function getJsonObj(obj: OccmDemandSignalItemSummary): object;
    function getDeserializedJsonObj(obj: OccmDemandSignalItemSummary): object;
}

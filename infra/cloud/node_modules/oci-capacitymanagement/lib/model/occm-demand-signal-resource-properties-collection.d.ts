 ...
 */
export interface OccmDemandSignalResourcePropertiesCollection {
    /**
     * An array of items containing detailed information about a resource's properties.
     *
     */
    "items": Array<model.OccmDemandSignalResourcePropertiesSummary>;
}
export declare namespace OccmDemandSignalResourcePropertiesCollection {
    function getJsonObj(obj: OccmDemandSignalResourcePropertiesCollection): object;
    function getDeserializedJsonObj(obj: OccmDemandSignalResourcePropertiesCollection): object;
}

 ...
 */
export interface OccmDemandSignalResourcePropertyConstraintsCollection {
    /**
     * An array of items containing detailed information about a resource's property dependecies.
     *
     */
    "items": Array<model.OccmDemandSignalResourcePropertyConstraintsSummary>;
}
export declare namespace OccmDemandSignalResourcePropertyConstraintsCollection {
    function getJsonObj(obj: OccmDemandSignalResourcePropertyConstraintsCollection): object;
    function getDeserializedJsonObj(obj: OccmDemandSignalResourcePropertyConstraintsCollection): object;
}

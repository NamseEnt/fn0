...
export declare namespace UpdateOccCapacityRequestDetails {
    enum RequestState {
        Submitted = "SUBMITTED",
        Cancelled = "CANCELLED"
    }
    function getJsonObj(obj: UpdateOccCapacityRequestDetails): object;
    function getDeserializedJsonObj(obj: UpdateOccCapacityRequestDetails): object;
}

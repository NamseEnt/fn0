...
export declare namespace OccCapacityRequestSummary {
    function getJsonObj(obj: OccCapacityRequestSummary): object;
    function getDeserializedJsonObj(obj: OccCapacityRequestSummary): object;
}

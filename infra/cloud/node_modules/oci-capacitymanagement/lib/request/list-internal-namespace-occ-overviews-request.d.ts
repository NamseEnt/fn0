...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/capacitymanagement/ListInternalNamespaceOccOverviews.ts.html |here} to see how to use ListInternalNamespaceOccOverviewsRequest.
 */
...
export declare namespace ListInternalNamespaceOccOverviewsRequest {
    enum SortBy {

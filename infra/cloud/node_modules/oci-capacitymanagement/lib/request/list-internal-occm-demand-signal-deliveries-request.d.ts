...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/capacitymanagement/ListInternalOccmDemandSignalDeliveries.ts.html |here} to see how to use ListInternalOccmDemandSignalDeliveriesRequest.
 */
export interface ListInternalOccmDemandSignalDeliveriesRequest extends common.BaseRequest {
    /**
...
export declare namespace ListInternalOccmDemandSignalDeliveriesRequest {
    enum SortBy {

...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/capacitymanagement/ListInternalOccmDemandSignalCatalogResources.ts.html |here} to see how to use ListInternalOccmDemandSignalCatalogResourcesRequest.
 */
export interface ListInternalOccmDemandSignalCatalogResourcesRequest extends common.BaseRequest {
    /**
...
export declare namespace ListInternalOccmDemandSignalCatalogResourcesRequest {
    enum SortBy {
        Name = "name"
    }
}

...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/capacitymanagement/ListOccmDemandSignalCatalogResources.ts.html |here} to see how to use ListOccmDemandSignalCatalogResourcesRequest.
 */
export interface ListOccmDemandSignalCatalogResourcesRequest extends common.BaseRequest {
    /**
...
export declare namespace ListOccmDemandSignalCatalogResourcesRequest {
    enum SortBy {
        Name = "name"
    }
}

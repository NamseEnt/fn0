...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/capacitymanagement/ListInternalOccmDemandSignalCatalogs.ts.html |here} to see how to use ListInternalOccmDemandSignalCatalogsRequest.
 */
export interface ListInternalOccmDemandSignalCatalogsRequest extends common.BaseRequest {
    /**
...
export declare namespace ListInternalOccmDemandSignalCatalogsRequest {
    enum SortBy {
        Name = "name"
    }
}

...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/capacitymanagement/ListOccAvailabilityCatalogsInternal.ts.html |here} to see how to use ListOccAvailabilityCatalogsInternalRequest.
 */
export interface ListOccAvailabilityCatalogsInternalRequest extends common.BaseRequest {
    /**
...
export declare namespace ListOccAvailabilityCatalogsInternalRequest {
    enum SortBy {

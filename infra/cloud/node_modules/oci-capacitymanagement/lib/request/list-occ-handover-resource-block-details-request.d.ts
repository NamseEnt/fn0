...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/capacitymanagement/ListOccHandoverResourceBlockDetails.ts.html |here} to see how to use ListOccHandoverResourceBlockDetailsRequest.
 */
export interface ListOccHandoverResourceBlockDetailsRequest extends common.BaseRequest {
    /**
...
export declare namespace ListOccHandoverResourceBlockDetailsRequest {
    enum SortBy {

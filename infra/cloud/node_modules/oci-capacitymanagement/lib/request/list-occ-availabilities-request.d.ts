...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/capacitymanagement/ListOccAvailabilities.ts.html |here} to see how to use ListOccAvailabilitiesRequest.
 */
export interface ListOccAvailabilitiesRequest extends common.BaseRequest {
    /**
...
export declare namespace ListOccAvailabilitiesRequest {
    enum SortBy {

...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/capacitymanagement/PatchInternalOccCapacityRequest.ts.html |here} to see how to use PatchInternalOccCapacityRequestRequest.
 */
export interface PatchInternalOccCapacityRequestRequest extends common.BaseRequest {
    /**

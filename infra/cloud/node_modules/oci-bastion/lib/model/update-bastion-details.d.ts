...
export declare namespace UpdateBastionDetails {
    function getJsonObj(obj: UpdateBastionDetails): object;
    function getDeserializedJsonObj(obj: UpdateBastionDetails): object;
}

 ...
 **/
export declare enum BastionLifecycleState {
    Creating = "CREATING",
    Updating = "UPDATING",
    Active = "ACTIVE",
    Deleting = "DELETING",
...
export declare namespace BastionLifecycleState {
    function getJsonObj(obj: BastionLifecycleState): BastionLifecycleState;
    function getDeserializedJsonObj(obj: BastionLifecycleState): BastionLifecycleState;
}

...
export declare namespace ChangeBastionCompartmentDetails {
    function getJsonObj(obj: ChangeBastionCompartmentDetails): object;
    function getDeserializedJsonObj(obj: ChangeBastionCompartmentDetails): object;
}

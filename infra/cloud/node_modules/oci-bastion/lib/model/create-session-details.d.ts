...
export interface CreateSessionDetails {
     ...
     */
    "bastionId": string;
    "targetResourceDetails": model.CreateManagedSshSessionTargetResourceDetails | model.CreateDynamicPortForwardingSessionTargetResourceDetails | model.CreatePortForwardingSessionTargetResourceDetails;
    /**
...
export declare namespace CreateSessionDetails {
    enum KeyType {
        Pub = "PUB"
    }
    function getJsonObj(obj: CreateSessionDetails): object;
    function getDeserializedJsonObj(obj: CreateSessionDetails): object;
}

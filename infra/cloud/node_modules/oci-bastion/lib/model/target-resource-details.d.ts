...
export declare namespace TargetResourceDetails {
    function getJsonObj(obj: TargetResourceDetails): object;
    function getDeserializedJsonObj(obj: TargetResourceDetails): object;
}

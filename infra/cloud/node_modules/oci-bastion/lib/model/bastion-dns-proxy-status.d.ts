 ...
 **/
export declare enum BastionDnsProxyStatus {
    Disabled = "DISABLED",
    Enabled = "ENABLED",
    /**
...
export declare namespace BastionDnsProxyStatus {
    function getJsonObj(obj: BastionDnsProxyStatus): BastionDnsProxyStatus;
    function getDeserializedJsonObj(obj: BastionDnsProxyStatus): BastionDnsProxyStatus;
}

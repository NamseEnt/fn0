...
export declare namespace SessionLifecycleState {
    function getJsonObj(obj: SessionLifecycleState): SessionLifecycleState;
    function getDeserializedJsonObj(obj: SessionLifecycleState): SessionLifecycleState;
}

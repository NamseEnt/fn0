...
export declare namespace FleetMetricDefinition {
    function getJsonObj(obj: FleetMetricDefinition): object;
    function getDeserializedJsonObj(obj: FleetMetricDefinition): object;
}

 ...
 *
 */
export interface CreateCloudDbSystemMacsConnectorDetails extends model.CreateCloudDbSystemConnectorDetails {
    /**
...
export declare namespace CreateCloudDbSystemMacsConnectorDetails {
    function getJsonObj(obj: CreateCloudDbSystemMacsConnectorDetails, isParentJsonObj?: boolean): object;
    const connectorType = "MACS";
    function getDeserializedJsonObj(obj: CreateCloudDbSystemMacsConnectorDetails, isParentJsonObj?: boolean): object;
}

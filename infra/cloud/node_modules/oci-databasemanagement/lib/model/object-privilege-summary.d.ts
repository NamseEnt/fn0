...
export declare namespace ObjectPrivilegeSummary {
    enum Hierarchy {
        Yes = "YES",
        No = "NO",
        /**
    ...
    function getJsonObj(obj: ObjectPrivilegeSummary): object;
    function getDeserializedJsonObj(obj: ObjectPrivilegeSummary): object;
}

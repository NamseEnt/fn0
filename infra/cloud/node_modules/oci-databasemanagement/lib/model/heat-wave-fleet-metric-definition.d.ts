 ...
 */
export interface HeatWaveFleetMetricDefinition {
    /**
...
export declare namespace HeatWaveFleetMetricDefinition {
    function getJsonObj(obj: HeatWaveFleetMetricDefinition): object;
    function getDeserializedJsonObj(obj: HeatWaveFleetMetricDefinition): object;
}

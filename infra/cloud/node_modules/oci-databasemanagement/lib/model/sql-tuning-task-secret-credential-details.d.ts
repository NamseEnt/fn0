...
export declare namespace SqlTuningTaskSecretCredentialDetails {
    function getJsonObj(obj: SqlTuningTaskSecretCredentialDetails, isParentJsonObj?: boolean): object;
    const sqlTuningTaskCredentialType = "SECRET";
    function getDeserializedJsonObj(obj: SqlTuningTaskSecretCredentialDetails, isParentJsonObj?: boolean): object;
}

 ...
 */
export interface CreateCloudDbSystemDiscoveryDetails {
    /**
...
export declare namespace CreateCloudDbSystemDiscoveryDetails {
    function getJsonObj(obj: CreateCloudDbSystemDiscoveryDetails): object;
    function getDeserializedJsonObj(obj: CreateCloudDbSystemDiscoveryDetails): object;
}

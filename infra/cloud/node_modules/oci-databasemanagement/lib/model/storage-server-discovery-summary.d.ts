 ...
 */
export interface StorageServerDiscoverySummary extends model.EntityDiscovered {
    /**
...
export declare namespace StorageServerDiscoverySummary {
    function getJsonObj(obj: StorageServerDiscoverySummary, isParentJsonObj?: boolean): object;
    const entityType = "MANAGED_STORAGE_SERVER_DISCOVER_SUMMARY";
    function getDeserializedJsonObj(obj: StorageServerDiscoverySummary, isParentJsonObj?: boolean): object;
}

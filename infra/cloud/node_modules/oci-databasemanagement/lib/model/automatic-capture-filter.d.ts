...
export declare namespace AutomaticCaptureFilter {
    enum Name {
    ...
    function getJsonObj(obj: AutomaticCaptureFilter): object;
    function getDeserializedJsonObj(obj: AutomaticCaptureFilter): object;
}

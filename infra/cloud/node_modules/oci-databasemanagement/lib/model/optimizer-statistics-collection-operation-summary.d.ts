...
export declare namespace OptimizerStatisticsCollectionOperationSummary {
    enum Status {
    ...
    function getJsonObj(obj: OptimizerStatisticsCollectionOperationSummary): object;
    function getDeserializedJsonObj(obj: OptimizerStatisticsCollectionOperationSummary): object;
}

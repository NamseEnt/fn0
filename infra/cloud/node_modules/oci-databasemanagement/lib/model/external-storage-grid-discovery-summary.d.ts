...
export declare namespace ExternalStorageGridDiscoverySummary {
    function getJsonObj(obj: ExternalStorageGridDiscoverySummary, isParentJsonObj?: boolean): object;
    const entityType = "STORAGE_GRID_DISCOVER_SUMMARY";
    function getDeserializedJsonObj(obj: ExternalStorageGridDiscoverySummary, isParentJsonObj?: boolean): object;
}

...
export declare namespace ManagedDatabaseCredential {
    enum Role {
        Normal = "NORMAL",
        Sysdba = "SYSDBA"
    }
    function getJsonObj(obj: ManagedDatabaseCredential): object;
    function getDeserializedJsonObj(obj: ManagedDatabaseCredential): object;
}

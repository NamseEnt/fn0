 ...
 */
export interface TablespaceAdminStatus {
    /**
     * The status of a tablespace admin action.
     *
     */
    "status": TablespaceAdminStatus.Status;
    /**
...
export declare namespace TablespaceAdminStatus {
    enum Status {
        Succeeded = "SUCCEEDED",
        Failed = "FAILED",
        /**
    ...
    function getJsonObj(obj: TablespaceAdminStatus): object;
    function getDeserializedJsonObj(obj: TablespaceAdminStatus): object;
}

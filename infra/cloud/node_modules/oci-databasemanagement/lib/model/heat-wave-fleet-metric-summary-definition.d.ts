...
export declare namespace HeatWaveFleetMetricSummaryDefinition {
    function getJsonObj(obj: HeatWaveFleetMetricSummaryDefinition): object;
    function getDeserializedJsonObj(obj: HeatWaveFleetMetricSummaryDefinition): object;
}

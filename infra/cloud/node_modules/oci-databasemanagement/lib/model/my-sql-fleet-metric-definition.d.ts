...
export declare namespace MySqlFleetMetricDefinition {
    function getJsonObj(obj: MySqlFleetMetricDefinition): object;
    function getDeserializedJsonObj(obj: MySqlFleetMetricDefinition): object;
}

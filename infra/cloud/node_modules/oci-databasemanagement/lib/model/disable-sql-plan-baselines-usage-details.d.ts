 ...
 *
 */
export interface DisableSqlPlanBaselinesUsageDetails {
...
export declare namespace DisableSqlPlanBaselinesUsageDetails {
    function getJsonObj(obj: DisableSqlPlanBaselinesUsageDetails): object;
    function getDeserializedJsonObj(obj: DisableSqlPlanBaselinesUsageDetails): object;
}

...
export declare namespace EnableAutomaticInitialPlanCaptureDetails {
    function getJsonObj(obj: EnableAutomaticInitialPlanCaptureDetails): object;
    function getDeserializedJsonObj(obj: EnableAutomaticInitialPlanCaptureDetails): object;
}

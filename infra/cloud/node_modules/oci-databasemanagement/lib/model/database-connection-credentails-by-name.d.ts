...
export declare namespace DatabaseConnectionCredentailsByName {
    function getJsonObj(obj: DatabaseConnectionCredentailsByName, isParentJsonObj?: boolean): object;
    const credentialType = "NAME_REFERENCE";
    function getDeserializedJsonObj(obj: DatabaseConnectionCredentailsByName, isParentJsonObj?: boolean): object;
}

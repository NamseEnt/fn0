...
export declare namespace ExternalDbSystemDiscoverySummary {
    function getJsonObj(obj: ExternalDbSystemDiscoverySummary): object;
    function getDeserializedJsonObj(obj: ExternalDbSystemDiscoverySummary): object;
}

...
export declare namespace AssociatedDatabaseSummary {
    function getJsonObj(obj: AssociatedDatabaseSummary): object;
    function getDeserializedJsonObj(obj: AssociatedDatabaseSummary): object;
}

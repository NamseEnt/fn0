...
export declare namespace EnableSqlPlanBaselinesUsageDetails {
    function getJsonObj(obj: EnableSqlPlanBaselinesUsageDetails): object;
    function getDeserializedJsonObj(obj: EnableSqlPlanBaselinesUsageDetails): object;
}

...
export declare namespace CreateCloudDbSystemDetails {
    function getJsonObj(obj: CreateCloudDbSystemDetails): object;
    function getDeserializedJsonObj(obj: CreateCloudDbSystemDetails): object;
}

...
export declare namespace TestNamedCredentialStatus {
    enum Status {
        Succeeded = "SUCCEEDED",
        Failed = "FAILED",
        /**
    ...
    function getJsonObj(obj: TestNamedCredentialStatus): object;
    function getDeserializedJsonObj(obj: TestNamedCredentialStatus): object;
}

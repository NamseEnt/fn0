...
export declare namespace ResetDatabaseParametersDetails {
    function getJsonObj(obj: ResetDatabaseParametersDetails): object;
    function getDeserializedJsonObj(obj: ResetDatabaseParametersDetails): object;
}

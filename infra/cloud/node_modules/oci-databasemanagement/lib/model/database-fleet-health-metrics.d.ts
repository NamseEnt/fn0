...
export declare namespace DatabaseFleetHealthMetrics {
    function getJsonObj(obj: DatabaseFleetHealthMetrics): object;
    function getDeserializedJsonObj(obj: DatabaseFleetHealthMetrics): object;
}

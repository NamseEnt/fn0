...
export declare namespace DropSqlTuningSetDetails {
    function getJsonObj(obj: DropSqlTuningSetDetails): object;
    function getDeserializedJsonObj(obj: DropSqlTuningSetDetails): object;
}

...
export declare namespace DatabaseManagementConfig {
    ...
    function getJsonObj(obj: DatabaseManagementConfig): object;
    function getDeserializedJsonObj(obj: DatabaseManagementConfig): object;
}

...
export interface HeatWaveNode {
     ...
     */
    "status": model.HeatWaveNodeStatus;
    /**
     * The date and time the HeatWave node was created.
     */
    "timeCreated": Date;
}
export declare namespace HeatWaveNode {
    function getJsonObj(obj: HeatWaveNode): object;
    function getDeserializedJsonObj(obj: HeatWaveNode): object;
}

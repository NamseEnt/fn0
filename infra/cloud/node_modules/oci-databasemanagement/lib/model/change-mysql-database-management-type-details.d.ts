...
export declare namespace ChangeMysqlDatabaseManagementTypeDetails {
    enum Operation {
        EnableDbmgmt = "ENABLE_DBMGMT",
        UpdateDbmgmtType = "UPDATE_DBMGMT_TYPE",
        DisableDbmgmt = "DISABLE_DBMGMT"
    }
    function getJsonObj(obj: ChangeMysqlDatabaseManagementTypeDetails): object;
    function getDeserializedJsonObj(obj: ChangeMysqlDatabaseManagementTypeDetails): object;
}

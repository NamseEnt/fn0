 ...
 */
export interface AwrDbSnapshotRangeSummary {
    /**
...
export declare namespace AwrDbSnapshotRangeSummary {
    function getJsonObj(obj: AwrDbSnapshotRangeSummary): object;
    function getDeserializedJsonObj(obj: AwrDbSnapshotRangeSummary): object;
}

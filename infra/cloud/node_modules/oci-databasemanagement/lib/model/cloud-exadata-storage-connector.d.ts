 ...
 */
export interface CloudExadataStorageConnector extends model.DbmResource {
    /**
...
export declare namespace CloudExadataStorageConnector {
    function getJsonObj(obj: CloudExadataStorageConnector, isParentJsonObj?: boolean): object;
    const resourceType = "CLOUD_STORAGE_CONNECTOR";
    function getDeserializedJsonObj(obj: CloudExadataStorageConnector, isParentJsonObj?: boolean): object;
}

...
export declare namespace EnableAutomaticSpmEvolveAdvisorTaskDetails {
    function getJsonObj(obj: EnableAutomaticSpmEvolveAdvisorTaskDetails): object;
    function getDeserializedJsonObj(obj: EnableAutomaticSpmEvolveAdvisorTaskDetails): object;
}

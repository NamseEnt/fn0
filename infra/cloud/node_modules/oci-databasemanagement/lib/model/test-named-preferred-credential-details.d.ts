...
export declare namespace TestNamedPreferredCredentialDetails {
    function getJsonObj(obj: TestNamedPreferredCredentialDetails, isParentJsonObj?: boolean): object;
    const type = "NAMED_CREDENTIAL";
    function getDeserializedJsonObj(obj: TestNamedPreferredCredentialDetails, isParentJsonObj?: boolean): object;
}

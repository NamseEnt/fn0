...
export declare namespace AwrDbCpuUsageCollection {
    function getJsonObj(obj: AwrDbCpuUsageCollection, isParentJsonObj?: boolean): object;
    const awrResultType = "AWRDB_ASH_CPU_USAGE_SET";
    function getDeserializedJsonObj(obj: AwrDbCpuUsageCollection, isParentJsonObj?: boolean): object;
}

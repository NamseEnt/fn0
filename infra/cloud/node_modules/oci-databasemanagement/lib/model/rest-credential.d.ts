...
export declare namespace RestCredential {
    enum SslTrustStoreType {
        Jks = "JKS",
        Bcfks = "BCFKS"
    }
    function getJsonObj(obj: RestCredential): object;
    function getDeserializedJsonObj(obj: RestCredential): object;
}

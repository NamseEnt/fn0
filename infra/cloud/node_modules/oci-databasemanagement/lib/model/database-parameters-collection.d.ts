...
export declare namespace DatabaseParametersCollection {
    function getJsonObj(obj: DatabaseParametersCollection): object;
    function getDeserializedJsonObj(obj: DatabaseParametersCollection): object;
}

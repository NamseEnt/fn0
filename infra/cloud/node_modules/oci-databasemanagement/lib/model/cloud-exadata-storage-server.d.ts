 ...
 */
export interface CloudExadataStorageServer extends model.DbmResource {
    /**
    ...
    "connector"?: model.CloudExadataStorageConnectorSummary;
    /**
...
export declare namespace CloudExadataStorageServer {
    function getJsonObj(obj: CloudExadataStorageServer, isParentJsonObj?: boolean): object;
    const resourceType = "CLOUD_STORAGE_SERVER";
    function getDeserializedJsonObj(obj: CloudExadataStorageServer, isParentJsonObj?: boolean): object;
}

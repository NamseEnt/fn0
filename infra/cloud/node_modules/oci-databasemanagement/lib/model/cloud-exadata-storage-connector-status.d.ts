...
export declare namespace CloudExadataStorageConnectorStatus {
    enum Status {
        Succeeded = "SUCCEEDED",
        Failed = "FAILED",
        /**
    ...
    function getJsonObj(obj: CloudExadataStorageConnectorStatus): object;
    function getDeserializedJsonObj(obj: CloudExadataStorageConnectorStatus): object;
}

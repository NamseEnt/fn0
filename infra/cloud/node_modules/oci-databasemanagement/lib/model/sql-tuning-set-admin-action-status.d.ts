...
export declare namespace SqlTuningSetAdminActionStatus {
    enum Status {
        Succeeded = "SUCCEEDED",
        Failed = "FAILED",
        /**
    ...
    function getJsonObj(obj: SqlTuningSetAdminActionStatus): object;
    function getDeserializedJsonObj(obj: SqlTuningSetAdminActionStatus): object;
}

...
export declare namespace DropSqlTuningTaskDetails {
    function getJsonObj(obj: DropSqlTuningTaskDetails): object;
    function getDeserializedJsonObj(obj: DropSqlTuningTaskDetails): object;
}

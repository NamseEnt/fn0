...
export declare namespace ChangeSqlPlanBaselinesAttributesDetails {
    function getJsonObj(obj: ChangeSqlPlanBaselinesAttributesDetails): object;
    function getDeserializedJsonObj(obj: ChangeSqlPlanBaselinesAttributesDetails): object;
}

...
export declare namespace MySqlFleetMetrics {
    function getJsonObj(obj: MySqlFleetMetrics): object;
    function getDeserializedJsonObj(obj: MySqlFleetMetrics): object;
}

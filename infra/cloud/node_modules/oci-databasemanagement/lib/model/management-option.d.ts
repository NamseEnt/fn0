...
*
**/
export declare enum ManagementOption {
    Basic = "BASIC",
    Advanced = "ADVANCED",
    /**
...
export declare namespace ManagementOption {
    function getJsonObj(obj: ManagementOption): ManagementOption;
    function getDeserializedJsonObj(obj: ManagementOption): ManagementOption;
}

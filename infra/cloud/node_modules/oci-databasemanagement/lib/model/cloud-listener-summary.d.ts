 ...
 */
export interface CloudListenerSummary {
    /**
...
export declare namespace CloudListenerSummary {
    function getJsonObj(obj: CloudListenerSummary): object;
    function getDeserializedJsonObj(obj: CloudListenerSummary): object;
}

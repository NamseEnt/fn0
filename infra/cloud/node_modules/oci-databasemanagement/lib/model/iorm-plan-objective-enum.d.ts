 ...
 *
 **/
export declare enum IormPlanObjectiveEnum {
    Auto = "AUTO",
...
export declare namespace IormPlanObjectiveEnum {
    function getJsonObj(obj: IormPlanObjectiveEnum): IormPlanObjectiveEnum;
    function getDeserializedJsonObj(obj: IormPlanObjectiveEnum): IormPlanObjectiveEnum;
}

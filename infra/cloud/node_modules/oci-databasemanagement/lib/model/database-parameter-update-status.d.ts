...
export declare namespace DatabaseParameterUpdateStatus {
    enum Status {
        Succeeded = "SUCCEEDED",
        Failed = "FAILED",
        /**
    ...
    function getJsonObj(obj: DatabaseParameterUpdateStatus): object;
    function getDeserializedJsonObj(obj: DatabaseParameterUpdateStatus): object;
}

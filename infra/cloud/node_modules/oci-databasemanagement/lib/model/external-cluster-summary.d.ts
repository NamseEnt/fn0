...
export declare namespace ExternalClusterSummary {
    function getJsonObj(obj: ExternalClusterSummary): object;
    function getDeserializedJsonObj(obj: ExternalClusterSummary): object;
}

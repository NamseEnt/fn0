...
export declare namespace CreateExternalDbSystemConnectorDetails {
    function getJsonObj(obj: CreateExternalDbSystemConnectorDetails): object;
    function getDeserializedJsonObj(obj: CreateExternalDbSystemConnectorDetails): object;
}

 ...
 */
export interface CloudClusterScanListenerConfiguration {
    /**
     ...
     */
    "scanProtocol"?: CloudClusterScanListenerConfiguration.ScanProtocol;
}
export declare namespace CloudClusterScanListenerConfiguration {
    enum ScanProtocol {
        Tcp = "TCP",
        Tcps = "TCPS",
        /**
    ...
    function getJsonObj(obj: CloudClusterScanListenerConfiguration): object;
    function getDeserializedJsonObj(obj: CloudClusterScanListenerConfiguration): object;
}

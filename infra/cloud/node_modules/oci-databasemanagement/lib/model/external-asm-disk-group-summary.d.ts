 ...
 */
export interface ExternalAsmDiskGroupSummary {
    /**
     ...
     */
    "redundancyType"?: ExternalAsmDiskGroupSummary.RedundancyType;
    /**
...
export declare namespace ExternalAsmDiskGroupSummary {
    enum RedundancyType {
        Extend = "EXTEND",
        Extern = "EXTERN",
        Flex = "FLEX",
    ...
    function getJsonObj(obj: ExternalAsmDiskGroupSummary): object;
    function getDeserializedJsonObj(obj: ExternalAsmDiskGroupSummary): object;
}

 ...
 **/
export declare enum SqlTuningSetStatusTypes {
    Disabled = "DISABLED",
...
export declare namespace SqlTuningSetStatusTypes {
    function getJsonObj(obj: SqlTuningSetStatusTypes): SqlTuningSetStatusTypes;
    function getDeserializedJsonObj(obj: SqlTuningSetStatusTypes): SqlTuningSetStatusTypes;
}

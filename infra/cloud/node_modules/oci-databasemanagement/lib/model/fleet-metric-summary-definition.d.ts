...
export declare namespace FleetMetricSummaryDefinition {
    function getJsonObj(obj: FleetMetricSummaryDefinition): object;
    function getDeserializedJsonObj(obj: FleetMetricSummaryDefinition): object;
}

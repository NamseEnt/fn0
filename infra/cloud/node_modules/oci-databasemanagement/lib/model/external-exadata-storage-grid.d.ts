...
export declare namespace ExternalExadataStorageGrid {
    function getJsonObj(obj: ExternalExadataStorageGrid, isParentJsonObj?: boolean): object;
    const resourceType = "STORAGE_GRID";
    function getDeserializedJsonObj(obj: ExternalExadataStorageGrid, isParentJsonObj?: boolean): object;
}

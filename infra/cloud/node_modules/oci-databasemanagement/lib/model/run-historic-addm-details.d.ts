...
export declare namespace RunHistoricAddmDetails {
    function getJsonObj(obj: RunHistoricAddmDetails): object;
    function getDeserializedJsonObj(obj: RunHistoricAddmDetails): object;
}

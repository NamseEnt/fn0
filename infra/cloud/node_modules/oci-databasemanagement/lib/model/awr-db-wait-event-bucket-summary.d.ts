...
export declare namespace AwrDbWaitEventBucketSummary {
    function getJsonObj(obj: AwrDbWaitEventBucketSummary): object;
    function getDeserializedJsonObj(obj: AwrDbWaitEventBucketSummary): object;
}

 ...
 */
export interface OptimizerStatisticsCollectionOperation {
    "database"?: model.OptimizerDatabase;
    /**
     * An array of Optimizer Statistics Collection task details.
     */
    "tasks"?: Array<model.OptimizerStatisticsOperationTask>;
    /**
     ...
     */
    "status": OptimizerStatisticsCollectionOperation.Status;
    /**
...
export declare namespace OptimizerStatisticsCollectionOperation {
    enum Status {
    ...
    function getJsonObj(obj: OptimizerStatisticsCollectionOperation): object;
    function getDeserializedJsonObj(obj: OptimizerStatisticsCollectionOperation): object;
}

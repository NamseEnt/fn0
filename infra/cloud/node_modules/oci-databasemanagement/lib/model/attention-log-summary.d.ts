...
export declare namespace AttentionLogSummary {
    enum MessageUrgency {
        Immediate = "IMMEDIATE",
        Soon = "SOON",
    ...
    function getJsonObj(obj: AttentionLogSummary): object;
    function getDeserializedJsonObj(obj: AttentionLogSummary): object;
}

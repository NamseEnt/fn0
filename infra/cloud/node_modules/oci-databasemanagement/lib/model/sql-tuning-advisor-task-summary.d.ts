...
export interface SqlTuningAdvisorTaskSummary {
    ...
    /**
     * The instance ID of the SQL Tuning Advisor task. This is not the [OCID](https://docs.oracle.com/iaas/Content/General/Concepts/identifiers.htm). Note: Numbers greater than Number.MAX_SAFE_INTEGER will result in rounding issues.
     */
    "instanceId"?: number;
    /**
...
export declare namespace SqlTuningAdvisorTaskSummary {
    function getJsonObj(obj: SqlTuningAdvisorTaskSummary): object;
    function getDeserializedJsonObj(obj: SqlTuningAdvisorTaskSummary): object;
}

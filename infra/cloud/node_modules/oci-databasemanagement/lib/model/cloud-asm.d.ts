...
export interface CloudAsm {
     ...
     */
    "lifecycleState": CloudAsm.LifecycleState;
    /**
     ...
     */
    "servicedDatabases"?: Array<model.CloudAsmServicedDatabase>;
    /**
...
export declare namespace CloudAsm {
    enum LifecycleState {
        Creating = "CREATING",
    ...
    function getJsonObj(obj: CloudAsm): object;
    function getDeserializedJsonObj(obj: CloudAsm): object;
}

...
export declare namespace AwrDbParameterChangeSummary {
    function getJsonObj(obj: AwrDbParameterChangeSummary): object;
    function getDeserializedJsonObj(obj: AwrDbParameterChangeSummary): object;
}

...
export declare namespace CreateManagedDatabaseGroupDetails {
    function getJsonObj(obj: CreateManagedDatabaseGroupDetails): object;
    function getDeserializedJsonObj(obj: CreateManagedDatabaseGroupDetails): object;
}

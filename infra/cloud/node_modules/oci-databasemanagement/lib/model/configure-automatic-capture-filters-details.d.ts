...
export declare namespace ConfigureAutomaticCaptureFiltersDetails {
    function getJsonObj(obj: ConfigureAutomaticCaptureFiltersDetails): object;
    function getDeserializedJsonObj(obj: ConfigureAutomaticCaptureFiltersDetails): object;
}

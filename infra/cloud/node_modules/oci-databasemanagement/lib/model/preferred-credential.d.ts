...
export declare namespace PreferredCredential {
    function getJsonObj(obj: PreferredCredential): object;
    function getDeserializedJsonObj(obj: PreferredCredential): object;
}

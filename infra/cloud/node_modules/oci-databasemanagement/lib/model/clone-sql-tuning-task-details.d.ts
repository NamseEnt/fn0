...
export declare namespace CloneSqlTuningTaskDetails {
    function getJsonObj(obj: CloneSqlTuningTaskDetails): object;
    function getDeserializedJsonObj(obj: CloneSqlTuningTaskDetails): object;
}

...
export declare namespace DbManagementPrivateEndpoint {
    function getJsonObj(obj: DbManagementPrivateEndpoint): object;
    function getDeserializedJsonObj(obj: DbManagementPrivateEndpoint): object;
}

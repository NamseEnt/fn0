 ...
 */
export interface AwrDbTopWaitEventSummary {
    /**
...
export declare namespace AwrDbTopWaitEventSummary {
    function getJsonObj(obj: AwrDbTopWaitEventSummary): object;
    function getDeserializedJsonObj(obj: AwrDbTopWaitEventSummary): object;
}

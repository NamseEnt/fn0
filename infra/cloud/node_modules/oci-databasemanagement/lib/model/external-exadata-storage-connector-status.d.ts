...
export declare namespace ExternalExadataStorageConnectorStatus {
    enum Status {
        Succeeded = "SUCCEEDED",
        Failed = "FAILED",
        /**
    ...
    function getJsonObj(obj: ExternalExadataStorageConnectorStatus): object;
    function getDeserializedJsonObj(obj: ExternalExadataStorageConnectorStatus): object;
}

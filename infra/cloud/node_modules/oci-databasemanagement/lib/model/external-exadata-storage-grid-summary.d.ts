...
export declare namespace ExternalExadataStorageGridSummary {
    function getJsonObj(obj: ExternalExadataStorageGridSummary, isParentJsonObj?: boolean): object;
    const resourceType = "STORAGE_GRID_SUMMARY";
    function getDeserializedJsonObj(obj: ExternalExadataStorageGridSummary, isParentJsonObj?: boolean): object;
}

 ...
 */
export interface CreateCloudExadataStorageConnectorDetails {
    /**
...
export declare namespace CreateCloudExadataStorageConnectorDetails {
    function getJsonObj(obj: CreateCloudExadataStorageConnectorDetails): object;
    function getDeserializedJsonObj(obj: CreateCloudExadataStorageConnectorDetails): object;
}

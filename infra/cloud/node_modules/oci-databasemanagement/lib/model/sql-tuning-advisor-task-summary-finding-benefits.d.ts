...
export declare namespace SqlTuningAdvisorTaskSummaryFindingBenefits {
    function getJsonObj(obj: SqlTuningAdvisorTaskSummaryFindingBenefits): object;
    function getDeserializedJsonObj(obj: SqlTuningAdvisorTaskSummaryFindingBenefits): object;
}

...
export declare namespace DropSqlsInSqlTuningSetDetails {
    function getJsonObj(obj: DropSqlsInSqlTuningSetDetails): object;
    function getDeserializedJsonObj(obj: DropSqlsInSqlTuningSetDetails): object;
}

...
export declare namespace OptimizerStatisticsAdvisorExecutionSummary {
    enum Status {
        Executing = "EXECUTING",
        Completed = "COMPLETED",
    ...
    function getJsonObj(obj: OptimizerStatisticsAdvisorExecutionSummary): object;
    function getDeserializedJsonObj(obj: OptimizerStatisticsAdvisorExecutionSummary): object;
}

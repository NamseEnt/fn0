...
export declare namespace FetchSqlTuningSetDetails {
    enum RecursiveSql {
        HasRecursiveSql = "HAS_RECURSIVE_SQL",
        NoRecursiveSql = "NO_RECURSIVE_SQL"
    }
    function getJsonObj(obj: FetchSqlTuningSetDetails): object;
    function getDeserializedJsonObj(obj: FetchSqlTuningSetDetails): object;
}

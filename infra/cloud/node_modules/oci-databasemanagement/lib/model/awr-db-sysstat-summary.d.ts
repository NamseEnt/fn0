 ...
 */
export interface AwrDbSysstatSummary {
    /**
...
export declare namespace AwrDbSysstatSummary {
    function getJsonObj(obj: AwrDbSysstatSummary): object;
    function getDeserializedJsonObj(obj: AwrDbSysstatSummary): object;
}

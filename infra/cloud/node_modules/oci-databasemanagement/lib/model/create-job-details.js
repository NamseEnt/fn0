...
exports.CreateJobDetails = void 0;
const model = __importStar(require("../model"));
const common = require("oci-common");
var CreateJobDetails;
(function (CreateJobDetails) {
    function getJsonObj(obj) {
        ...
        if (obj && "jobType" in obj && obj.jobType) {
            switch (obj.jobType) {
                case "SQL":
                    return model.CreateSqlJobDetails.getJsonObj(jsonObj, true);
                default:
    ...
    CreateJobDetails.getJsonObj = getJsonObj;
    function getDeserializedJsonObj(obj) {
        ...
        if (obj && "jobType" in obj && obj.jobType) {
            switch (obj.jobType) {
                case "SQL":
                    return model.CreateSqlJobDetails.getDeserializedJsonObj(jsonObj, true);
                default:
                    if (common.LOG.logger)
                        common.LOG.logger.info(`Unknown value for: ${obj.jobType}`);
            }
    ...
    CreateJobDetails.getDeserializedJsonObj = getDeserializedJsonObj;
})(CreateJobDetails = exports.CreateJobDetails || (exports.CreateJobDetails = {}));
//# sourceMappingURL=create-job-details.js.map
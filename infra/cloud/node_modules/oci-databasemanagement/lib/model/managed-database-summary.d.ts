...
export declare namespace ManagedDatabaseSummary {
    function getJsonObj(obj: ManagedDatabaseSummary): object;
    function getDeserializedJsonObj(obj: ManagedDatabaseSummary): object;
}

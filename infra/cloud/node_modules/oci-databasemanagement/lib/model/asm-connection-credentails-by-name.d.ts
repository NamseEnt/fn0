 ...
 *
 */
export interface AsmConnectionCredentailsByName extends model.AsmConnectionCredentials {
    /**
...
export declare namespace AsmConnectionCredentailsByName {
    function getJsonObj(obj: AsmConnectionCredentailsByName, isParentJsonObj?: boolean): object;
    const credentialType = "NAME_REFERENCE";
    function getDeserializedJsonObj(obj: AsmConnectionCredentailsByName, isParentJsonObj?: boolean): object;
}

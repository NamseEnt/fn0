...
export declare namespace DbManagementPrivateEndpointSummary {
    function getJsonObj(obj: DbManagementPrivateEndpointSummary): object;
    function getDeserializedJsonObj(obj: DbManagementPrivateEndpointSummary): object;
}

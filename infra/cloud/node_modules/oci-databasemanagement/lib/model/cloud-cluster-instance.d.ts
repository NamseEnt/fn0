...
export declare namespace CloudClusterInstance {
    enum NodeRole {
        Hub = "HUB",
        Leaf = "LEAF",
        /**
    ...
    function getJsonObj(obj: CloudClusterInstance): object;
    function getDeserializedJsonObj(obj: CloudClusterInstance): object;
}

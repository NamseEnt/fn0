...
export declare namespace ExternalDatabaseConnectionInfo {
    function getJsonObj(obj: ExternalDatabaseConnectionInfo, isParentJsonObj?: boolean): object;
    const componentType = "DATABASE";
    function getDeserializedJsonObj(obj: ExternalDatabaseConnectionInfo, isParentJsonObj?: boolean): object;
}

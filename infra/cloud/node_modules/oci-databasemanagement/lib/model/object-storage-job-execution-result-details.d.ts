...
export declare namespace ObjectStorageJobExecutionResultDetails {
    function getJsonObj(obj: ObjectStorageJobExecutionResultDetails, isParentJsonObj?: boolean): object;
    const type = "OBJECT_STORAGE";
    function getDeserializedJsonObj(obj: ObjectStorageJobExecutionResultDetails, isParentJsonObj?: boolean): object;
}

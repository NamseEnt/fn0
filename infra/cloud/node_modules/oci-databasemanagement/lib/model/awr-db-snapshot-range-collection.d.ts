...
export declare namespace AwrDbSnapshotRangeCollection {
    function getJsonObj(obj: AwrDbSnapshotRangeCollection, isParentJsonObj?: boolean): object;
    const awrResultType = "AWRDB_SNAPSHOT_RANGE_SET";
    function getDeserializedJsonObj(obj: AwrDbSnapshotRangeCollection, isParentJsonObj?: boolean): object;
}

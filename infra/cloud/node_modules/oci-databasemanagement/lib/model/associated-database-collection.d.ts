...
export declare namespace AssociatedDatabaseCollection {
    function getJsonObj(obj: AssociatedDatabaseCollection): object;
    function getDeserializedJsonObj(obj: AssociatedDatabaseCollection): object;
}

...
export declare namespace ExternalExadataInfrastructureDiscovery {
    enum LicenseModel {
    ...
    function getJsonObj(obj: ExternalExadataInfrastructureDiscovery, isParentJsonObj?: boolean): object;
    const entityType = "INFRASTRUCTURE_DISCOVER";
    function getDeserializedJsonObj(obj: ExternalExadataInfrastructureDiscovery, isParentJsonObj?: boolean): object;
}

...
export declare namespace ExternalStorageServerDiscoverySummary {
    function getJsonObj(obj: ExternalStorageServerDiscoverySummary, isParentJsonObj?: boolean): object;
    const entityType = "STORAGE_SERVER_DISCOVER_SUMMARY";
    function getDeserializedJsonObj(obj: ExternalStorageServerDiscoverySummary, isParentJsonObj?: boolean): object;
}

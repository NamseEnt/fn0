...
export declare namespace ExternalDbSystemDiscovery {
    enum LifecycleState {
        Creating = "CREATING",
        Active = "ACTIVE",
        Inactive = "INACTIVE",
    ...
    function getJsonObj(obj: ExternalDbSystemDiscovery): object;
    function getDeserializedJsonObj(obj: ExternalDbSystemDiscovery): object;
}

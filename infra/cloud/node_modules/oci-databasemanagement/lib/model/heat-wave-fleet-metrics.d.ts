...
export declare namespace HeatWaveFleetMetrics {
    function getJsonObj(obj: HeatWaveFleetMetrics): object;
    function getDeserializedJsonObj(obj: HeatWaveFleetMetrics): object;
}

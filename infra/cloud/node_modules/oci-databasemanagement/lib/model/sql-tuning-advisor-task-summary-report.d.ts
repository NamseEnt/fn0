...
export declare namespace SqlTuningAdvisorTaskSummaryReport {
    function getJsonObj(obj: SqlTuningAdvisorTaskSummaryReport): object;
    function getDeserializedJsonObj(obj: SqlTuningAdvisorTaskSummaryReport): object;
}

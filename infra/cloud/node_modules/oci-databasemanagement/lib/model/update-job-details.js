...
exports.UpdateJobDetails = void 0;
...
(function (UpdateJobDetails) {
    function getJsonObj(obj) {
        ...
        if (obj && "jobType" in obj && obj.jobType) {
            switch (obj.jobType) {
                case "SQL":
                    return model.UpdateSqlJobDetails.getJsonObj(jsonObj, true);
                default:
    ...
    UpdateJobDetails.getJsonObj = getJsonObj;
    function getDeserializedJsonObj(obj) {
        ...
        if (obj && "jobType" in obj && obj.jobType) {
            switch (obj.jobType) {
                case "SQL":
                    return model.UpdateSqlJobDetails.getDeserializedJsonObj(jsonObj, true);
                default:
                    if (common.LOG.logger)
                        common.LOG.logger.info(`Unknown value for: ${obj.jobType}`);
            }
    ...
    UpdateJobDetails.getDeserializedJsonObj = getDeserializedJsonObj;
})(UpdateJobDetails = exports.UpdateJobDetails || (exports.UpdateJobDetails = {}));
//# sourceMappingURL=update-job-details.js.map
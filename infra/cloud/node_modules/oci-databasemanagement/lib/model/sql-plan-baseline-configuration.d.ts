...
export declare namespace SqlPlanBaselineConfiguration {
    function getJsonObj(obj: SqlPlanBaselineConfiguration): object;
    function getDeserializedJsonObj(obj: SqlPlanBaselineConfiguration): object;
}

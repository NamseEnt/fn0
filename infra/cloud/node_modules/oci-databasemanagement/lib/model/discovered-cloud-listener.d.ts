...
export declare namespace DiscoveredCloudListener {
    enum ListenerType {
        Asm = "ASM",
        Local = "LOCAL",
        Scan = "SCAN",
    ...
    function getJsonObj(obj: DiscoveredCloudListener, isParentJsonObj?: boolean): object;
    const componentType = "LISTENER";
    function getDeserializedJsonObj(obj: DiscoveredCloudListener, isParentJsonObj?: boolean): object;
}

...
export declare namespace DiscoveredCloudDatabase {
    enum DbRole {
    ...
    function getJsonObj(obj: DiscoveredCloudDatabase, isParentJsonObj?: boolean): object;
    const componentType = "DATABASE";
    function getDeserializedJsonObj(obj: DiscoveredCloudDatabase, isParentJsonObj?: boolean): object;
}

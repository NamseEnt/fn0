...
export declare namespace TimeSeriesMetricDefinition {
    function getJsonObj(obj: TimeSeriesMetricDefinition): object;
    function getDeserializedJsonObj(obj: TimeSeriesMetricDefinition): object;
}

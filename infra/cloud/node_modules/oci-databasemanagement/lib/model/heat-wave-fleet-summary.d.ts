...
export declare namespace HeatWaveFleetSummary {
    function getJsonObj(obj: HeatWaveFleetSummary): object;
    function getDeserializedJsonObj(obj: HeatWaveFleetSummary): object;
}

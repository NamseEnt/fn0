...
export declare namespace ModifyDatabaseManagementFeatureDetails {
    function getJsonObj(obj: ModifyDatabaseManagementFeatureDetails): object;
    function getDeserializedJsonObj(obj: ModifyDatabaseManagementFeatureDetails): object;
}

...
export declare namespace AsmConnectionCredentials {
    function getJsonObj(obj: AsmConnectionCredentials): object;
    function getDeserializedJsonObj(obj: AsmConnectionCredentials): object;
}

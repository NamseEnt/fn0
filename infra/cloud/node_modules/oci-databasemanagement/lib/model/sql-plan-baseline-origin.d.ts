 ...
 **/
export declare enum SqlPlanBaselineOrigin {
...
export declare namespace SqlPlanBaselineOrigin {
    function getJsonObj(obj: SqlPlanBaselineOrigin): SqlPlanBaselineOrigin;
    function getDeserializedJsonObj(obj: SqlPlanBaselineOrigin): SqlPlanBaselineOrigin;
}

...
export declare namespace JobExecutionsStatusSummary {
    enum Status {
        Succeeded = "SUCCEEDED",
        Failed = "FAILED",
    ...
    function getJsonObj(obj: JobExecutionsStatusSummary): object;
    function getDeserializedJsonObj(obj: JobExecutionsStatusSummary): object;
}

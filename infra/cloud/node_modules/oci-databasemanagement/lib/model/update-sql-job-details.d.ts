 ...
 */
export interface UpdateSqlJobDetails extends model.UpdateJobDetails {
    /**
...
export declare namespace UpdateSqlJobDetails {
    function getJsonObj(obj: UpdateSqlJobDetails, isParentJsonObj?: boolean): object;
    const jobType = "SQL";
    function getDeserializedJsonObj(obj: UpdateSqlJobDetails, isParentJsonObj?: boolean): object;
}

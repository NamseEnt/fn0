...
export declare namespace OptimizerDatabase {
    function getJsonObj(obj: OptimizerDatabase): object;
    function getDeserializedJsonObj(obj: OptimizerDatabase): object;
}

 ...
 */
export interface DisableDatabaseManagementFeatureDetails {
    /**
...
export declare namespace DisableDatabaseManagementFeatureDetails {
    function getJsonObj(obj: DisableDatabaseManagementFeatureDetails): object;
    function getDeserializedJsonObj(obj: DisableDatabaseManagementFeatureDetails): object;
}

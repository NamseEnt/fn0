 ...
 */
export interface ExternalListenerSummary {
    /**
...
export declare namespace ExternalListenerSummary {
    function getJsonObj(obj: ExternalListenerSummary): object;
    function getDeserializedJsonObj(obj: ExternalListenerSummary): object;
}

 ...
 */
export interface CloudAsmInstance {
    /**
     ...
     */
    "lifecycleState": CloudAsmInstance.LifecycleState;
    /**
...
export declare namespace CloudAsmInstance {
    enum LifecycleState {
        Creating = "CREATING",
        Active = "ACTIVE",
        Inactive = "INACTIVE",
    ...
    function getJsonObj(obj: CloudAsmInstance): object;
    function getDeserializedJsonObj(obj: CloudAsmInstance): object;
}

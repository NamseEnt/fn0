...
export declare namespace CloudDbHomeSummary {
    function getJsonObj(obj: CloudDbHomeSummary): object;
    function getDeserializedJsonObj(obj: CloudDbHomeSummary): object;
}

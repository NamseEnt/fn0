...
export declare namespace ExternalAsmInstanceParameters {
    function getJsonObj(obj: ExternalAsmInstanceParameters): object;
    function getDeserializedJsonObj(obj: ExternalAsmInstanceParameters): object;
}

 ...
 */
export interface DatabaseBackupMetrics {
    /**
     ...
     */
    "timeSeriesMetrics": Array<model.MetricsAggregationRange>;
    /**
...
export declare namespace DatabaseBackupMetrics {
    function getJsonObj(obj: DatabaseBackupMetrics): object;
    function getDeserializedJsonObj(obj: DatabaseBackupMetrics): object;
}

...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/databasemanagement/ListSqlPlanBaselines.ts.html |here} to see how to use ListSqlPlanBaselinesRequest.
 */
...
export declare namespace ListSqlPlanBaselinesRequest {
    enum SortBy {

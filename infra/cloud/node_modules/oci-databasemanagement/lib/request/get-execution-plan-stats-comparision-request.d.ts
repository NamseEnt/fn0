...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/databasemanagement/GetExecutionPlanStatsComparision.ts.html |here} to see how to use GetExecutionPlanStatsComparisionRequest.
 */
export interface GetExecutionPlanStatsComparisionRequest extends common.BaseRequest {
    /**

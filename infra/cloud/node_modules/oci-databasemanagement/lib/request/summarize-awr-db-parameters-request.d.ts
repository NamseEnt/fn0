...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/databasemanagement/SummarizeAwrDbParameters.ts.html |here} to see how to use SummarizeAwrDbParametersRequest.
 */
...
export declare namespace SummarizeAwrDbParametersRequest {
    enum ValueChanged {
        Y = "Y",
        N = "N"
    }

...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/databasemanagement/ListExternalDbNodes.ts.html |here} to see how to use ListExternalDbNodesRequest.
 */
export interface ListExternalDbNodesRequest extends common.BaseRequest {
    /**
...
export declare namespace ListExternalDbNodesRequest {
    enum SortBy {

...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/databasemanagement/ListExternalAsms.ts.html |here} to see how to use ListExternalAsmsRequest.
 */
export interface ListExternalAsmsRequest extends common.BaseRequest {
    /**
...
export declare namespace ListExternalAsmsRequest {
    enum SortBy {

...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/databasemanagement/SummarizeExternalDbNodeMetrics.ts.html |here} to see how to use SummarizeExternalDbNodeMetricsRequest.
 */
export interface SummarizeExternalDbNodeMetricsRequest extends common.BaseRequest {
    /**

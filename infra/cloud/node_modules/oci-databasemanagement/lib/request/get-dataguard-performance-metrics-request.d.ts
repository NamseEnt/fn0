...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/databasemanagement/GetDataguardPerformanceMetrics.ts.html |here} to see how to use GetDataguardPerformanceMetricsRequest.
 */
export interface GetDataguardPerformanceMetricsRequest extends common.BaseRequest {
    /**
     ...
     *
     */
    "peerDatabaseCompartmentId"?: string;
    /**

...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/databasemanagement/SummarizeCloudListenerMetrics.ts.html |here} to see how to use SummarizeCloudListenerMetricsRequest.
 */
export interface SummarizeCloudListenerMetricsRequest extends common.BaseRequest {
    /**

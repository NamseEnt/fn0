...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/databasemanagement/ListExternalClusters.ts.html |here} to see how to use ListExternalClustersRequest.
 */
export interface ListExternalClustersRequest extends common.BaseRequest {
    /**
...
export declare namespace ListExternalClustersRequest {
    enum SortBy {

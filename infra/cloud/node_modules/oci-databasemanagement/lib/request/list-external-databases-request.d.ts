...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/databasemanagement/ListExternalDatabases.ts.html |here} to see how to use ListExternalDatabasesRequest.
 */
export interface ListExternalDatabasesRequest extends common.BaseRequest {
    /**
...
export declare namespace ListExternalDatabasesRequest {
    enum SortBy {

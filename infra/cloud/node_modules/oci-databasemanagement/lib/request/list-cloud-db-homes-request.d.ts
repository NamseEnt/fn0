...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/databasemanagement/ListCloudDbHomes.ts.html |here} to see how to use ListCloudDbHomesRequest.
 */
export interface ListCloudDbHomesRequest extends common.BaseRequest {
    /**
...
export declare namespace ListCloudDbHomesRequest {
    enum SortBy {

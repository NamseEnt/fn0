...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/databasemanagement/SummarizeCloudAsmMetrics.ts.html |here} to see how to use SummarizeCloudAsmMetricsRequest.
 */
export interface SummarizeCloudAsmMetricsRequest extends common.BaseRequest {
    /**

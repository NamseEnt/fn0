...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/databasemanagement/SummarizeAwrDbWaitEventBuckets.ts.html |here} to see how to use SummarizeAwrDbWaitEventBucketsRequest.
 */
...
export declare namespace SummarizeAwrDbWaitEventBucketsRequest {
    enum SortBy {
        Category = "CATEGORY",

...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/databasemanagement/GetSqlTuningAdvisorTaskSummaryReport.ts.html |here} to see how to use GetSqlTuningAdvisorTaskSummaryReportRequest.
 */
...
export declare namespace GetSqlTuningAdvisorTaskSummaryReportRequest {
    enum SearchPeriod {
        Last24Hr = "LAST_24HR",
        Last7Day = "LAST_7DAY",

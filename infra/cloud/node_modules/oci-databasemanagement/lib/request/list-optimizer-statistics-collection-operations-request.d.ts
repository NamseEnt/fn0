...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/databasemanagement/ListOptimizerStatisticsCollectionOperations.ts.html |here} to see how to use ListOptimizerStatisticsCollectionOperationsRequest.
 */
export interface ListOptimizerStatisticsCollectionOperationsRequest extends common.BaseRequest {
    /**
...
export declare namespace ListOptimizerStatisticsCollectionOperationsRequest {
    enum SortBy {

...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/databasemanagement/GetAwrDbSqlReport.ts.html |here} to see how to use GetAwrDbSqlReportRequest.
 */
...
export declare namespace GetAwrDbSqlReportRequest {
    enum ReportFormat {
        Html = "HTML",
        Text = "TEXT"
    }

...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/databasemanagement/ListCloudDbNodes.ts.html |here} to see how to use ListCloudDbNodesRequest.
 */
export interface ListCloudDbNodesRequest extends common.BaseRequest {
    /**
...
export declare namespace ListCloudDbNodesRequest {
    enum SortBy {

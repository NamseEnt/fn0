...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/databasemanagement/SummarizeAlertLogCounts.ts.html |here} to see how to use SummarizeAlertLogCountsRequest.
 */
...
export declare namespace SummarizeAlertLogCountsRequest {
    enum LevelFilter {
        Critical = "CRITICAL",
        Severe = "SEVERE",
        Important = "IMPORTANT",

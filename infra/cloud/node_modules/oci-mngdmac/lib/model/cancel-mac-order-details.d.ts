 ...
 */
export interface CancelMacOrderDetails {
    /**
     * The reason for the MacOrder cancellation.
     */
    "cancelReason"?: string;
}
export declare namespace CancelMacOrderDetails {
    function getJsonObj(obj: CancelMacOrderDetails): object;
    function getDeserializedJsonObj(obj: CancelMacOrderDetails): object;
}

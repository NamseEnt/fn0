...
export declare namespace ChangeMacOrderCompartmentDetails {
    function getJsonObj(obj: ChangeMacOrderCompartmentDetails): object;
    function getDeserializedJsonObj(obj: ChangeMacOrderCompartmentDetails): object;
}

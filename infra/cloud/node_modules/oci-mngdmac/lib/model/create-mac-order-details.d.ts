 ...
 */
export interface CreateMacOrderDetails {
    /**
...
export declare namespace CreateMacOrderDetails {
    function getJsonObj(obj: CreateMacOrderDetails): object;
    function getDeserializedJsonObj(obj: CreateMacOrderDetails): object;
}

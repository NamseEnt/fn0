...
export declare namespace InvoicingPaymentTerm {
    function getJsonObj(obj: InvoicingPaymentTerm): object;
    function getDeserializedJsonObj(obj: InvoicingPaymentTerm): object;
}

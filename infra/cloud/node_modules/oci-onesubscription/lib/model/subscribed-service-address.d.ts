...
export declare namespace SubscribedServiceAddress {
    function getJsonObj(obj: SubscribedServiceAddress): object;
    function getDeserializedJsonObj(obj: SubscribedServiceAddress): object;
}

...
export declare namespace CommitmentService {
    function getJsonObj(obj: CommitmentService): object;
    function getDeserializedJsonObj(obj: CommitmentService): object;
}

...
export declare namespace AggregatedComputedUsageSummary {
    enum PricingModel {
    ...
    function getJsonObj(obj: AggregatedComputedUsageSummary): object;
    function getDeserializedJsonObj(obj: AggregatedComputedUsageSummary): object;
}

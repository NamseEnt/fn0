...
export declare namespace BulkEditTagsDetails {
    function getJsonObj(obj: BulkEditTagsDetails): object;
    function getDeserializedJsonObj(obj: BulkEditTagsDetails): object;
}

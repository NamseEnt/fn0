...
export declare namespace UpdateStateDetails {
    function getJsonObj(obj: UpdateStateDetails): object;
    function getDeserializedJsonObj(obj: UpdateStateDetails): object;
}

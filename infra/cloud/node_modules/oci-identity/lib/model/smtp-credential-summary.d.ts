...
export declare namespace SmtpCredentialSummary {
    enum LifecycleState {
        Creating = "CREATING",
        Active = "ACTIVE",
        Inactive = "INACTIVE",
    ...
    function getJsonObj(obj: SmtpCredentialSummary): object;
    function getDeserializedJsonObj(obj: SmtpCredentialSummary): object;
}

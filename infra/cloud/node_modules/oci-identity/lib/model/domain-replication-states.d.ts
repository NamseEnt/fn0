...
export declare namespace DomainReplicationStates {
    enum State {
    ...
    function getJsonObj(obj: DomainReplicationStates): object;
    function getDeserializedJsonObj(obj: DomainReplicationStates): object;
}

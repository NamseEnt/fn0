 ...
 *
 */
export interface ChangeTagNamespaceCompartmentDetail {
    /**
     * The Oracle Cloud ID (OCID) of the destination compartment.
     */
    "compartmentId": string;
}
export declare namespace ChangeTagNamespaceCompartmentDetail {
    function getJsonObj(obj: ChangeTagNamespaceCompartmentDetail): object;
    function getDeserializedJsonObj(obj: ChangeTagNamespaceCompartmentDetail): object;
}

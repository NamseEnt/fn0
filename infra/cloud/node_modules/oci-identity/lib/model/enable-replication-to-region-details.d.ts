...
export declare namespace EnableReplicationToRegionDetails {
    function getJsonObj(obj: EnableReplicationToRegionDetails): object;
    function getDeserializedJsonObj(obj: EnableReplicationToRegionDetails): object;
}

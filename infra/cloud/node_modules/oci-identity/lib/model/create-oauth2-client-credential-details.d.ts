...
export declare namespace CreateOAuth2ClientCredentialDetails {
    function getJsonObj(obj: CreateOAuth2ClientCredentialDetails): object;
    function getDeserializedJsonObj(obj: CreateOAuth2ClientCredentialDetails): object;
}

...
export declare namespace UpdatePolicyDetails {
    function getJsonObj(obj: UpdatePolicyDetails): object;
    function getDeserializedJsonObj(obj: UpdatePolicyDetails): object;
}

 ...
 */
export interface StandardTagNamespaceTemplate {
    /**
     ...
     */
    "tagDefinitionTemplates": Array<model.StandardTagDefinitionTemplate>;
    /**
     * The status of the standard tag namespace
     */
    "status": string;
}
export declare namespace StandardTagNamespaceTemplate {
    function getJsonObj(obj: StandardTagNamespaceTemplate): object;
    function getDeserializedJsonObj(obj: StandardTagNamespaceTemplate): object;
}

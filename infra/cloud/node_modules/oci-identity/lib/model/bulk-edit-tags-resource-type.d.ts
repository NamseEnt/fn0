...
export declare namespace BulkEditTagsResourceType {
    function getJsonObj(obj: BulkEditTagsResourceType): object;
    function getDeserializedJsonObj(obj: BulkEditTagsResourceType): object;
}

...
export declare namespace ReplicatedRegionDetails {
    enum State {
    ...
    function getJsonObj(obj: ReplicatedRegionDetails): object;
    function getDeserializedJsonObj(obj: ReplicatedRegionDetails): object;
}

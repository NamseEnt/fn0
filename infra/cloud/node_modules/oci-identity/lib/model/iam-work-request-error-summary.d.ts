...
export declare namespace IamWorkRequestErrorSummary {
    function getJsonObj(obj: IamWorkRequestErrorSummary): object;
    function getDeserializedJsonObj(obj: IamWorkRequestErrorSummary): object;
}

...
export declare namespace DefaultTagDefinitionValidator {
    function getJsonObj(obj: DefaultTagDefinitionValidator, isParentJsonObj?: boolean): object;
    const validatorType = "DEFAULT";
    function getDeserializedJsonObj(obj: DefaultTagDefinitionValidator, isParentJsonObj?: boolean): object;
}

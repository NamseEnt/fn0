...
*
*/
export interface UIPasswordInformation {
    /**
  ...
  *
     ...
     *
     */
    "lifecycleState"?: UIPasswordInformation.LifecycleState;
}
export declare namespace UIPasswordInformation {
    enum LifecycleState {
        Creating = "CREATING",
        Active = "ACTIVE",
        Inactive = "INACTIVE",
    ...
    function getJsonObj(obj: UIPasswordInformation): object;
    function getDeserializedJsonObj(obj: UIPasswordInformation): object;
}

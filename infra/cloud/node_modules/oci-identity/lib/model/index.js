...
const ChangeDomainCompartmentDetails = __importStar(require("./change-domain-compartment-details"));
exports.ChangeDomainCompartmentDetails = ChangeDomainCompartmentDetails.ChangeDomainCompartmentDetails;
const ChangeDomainLicenseTypeDetails = __importStar(require("./change-domain-license-type-details"));
...
const ChangeTasDomainLicenseTypeDetails = __importStar(require("./change-tas-domain-license-type-details"));
...
const DomainReplicationStates = __importStar(require("./domain-replication-states"));
...
const EnableReplicationToRegionDetails = __importStar(require("./enable-replication-to-region-details"));
...
const IamWorkRequest = __importStar(require("./iam-work-request"));
exports.IamWorkRequest = IamWorkRequest.IamWorkRequest;
const IamWorkRequestErrorSummary = __importStar(require("./iam-work-request-error-summary"));
exports.IamWorkRequestErrorSummary = IamWorkRequestErrorSummary.IamWorkRequestErrorSummary;
const IamWorkRequestLogSummary = __importStar(require("./iam-work-request-log-summary"));
exports.IamWorkRequestLogSummary = IamWorkRequestLogSummary.IamWorkRequestLogSummary;
const IamWorkRequestResource = __importStar(require("./iam-work-request-resource"));
exports.IamWorkRequestResource = IamWorkRequestResource.IamWorkRequestResource;
const IamWorkRequestSummary = __importStar(require("./iam-work-request-summary"));
...
const ReplicatedRegionDetails = __importStar(require("./replicated-region-details"));

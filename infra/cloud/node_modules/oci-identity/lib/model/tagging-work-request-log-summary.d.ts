...
export declare namespace TaggingWorkRequestLogSummary {
    function getJsonObj(obj: TaggingWorkRequestLogSummary): object;
    function getDeserializedJsonObj(obj: TaggingWorkRequestLogSummary): object;
}

...
export declare namespace UpdateDynamicGroupDetails {
    function getJsonObj(obj: UpdateDynamicGroupDetails): object;
    function getDeserializedJsonObj(obj: UpdateDynamicGroupDetails): object;
}

...
export declare namespace MfaTotpDeviceSummary {
    enum LifecycleState {
        Creating = "CREATING",
        Active = "ACTIVE",
        Inactive = "INACTIVE",
    ...
    function getJsonObj(obj: MfaTotpDeviceSummary): object;
    function getDeserializedJsonObj(obj: MfaTotpDeviceSummary): object;
}

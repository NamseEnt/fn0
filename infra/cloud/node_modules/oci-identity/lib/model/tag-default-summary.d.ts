...
export declare namespace TagDefaultSummary {
    enum LifecycleState {
        Active = "ACTIVE",
        /**
    ...
    function getJsonObj(obj: TagDefaultSummary): object;
    function getDeserializedJsonObj(obj: TagDefaultSummary): object;
}

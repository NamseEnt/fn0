...
export declare namespace CustomerSecretKeySummary {
    enum LifecycleState {
        Creating = "CREATING",
        Active = "ACTIVE",
        Inactive = "INACTIVE",
    ...
    function getJsonObj(obj: CustomerSecretKeySummary): object;
    function getDeserializedJsonObj(obj: CustomerSecretKeySummary): object;
}

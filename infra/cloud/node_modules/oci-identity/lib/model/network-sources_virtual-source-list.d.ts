 ...
 */
export interface NetworkSourcesVirtualSourceList {
    "vcnId"?: string;
    "ipRanges"?: Array<string>;
}
export declare namespace NetworkSourcesVirtualSourceList {
    function getJsonObj(obj: NetworkSourcesVirtualSourceList): object;
    function getDeserializedJsonObj(obj: NetworkSourcesVirtualSourceList): object;
}

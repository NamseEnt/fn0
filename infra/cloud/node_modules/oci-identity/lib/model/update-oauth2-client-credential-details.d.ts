...
export interface UpdateOAuth2ClientCredentialDetails {
    /**
...
export declare namespace UpdateOAuth2ClientCredentialDetails {
    function getJsonObj(obj: UpdateOAuth2ClientCredentialDetails): object;
    function getDeserializedJsonObj(obj: UpdateOAuth2ClientCredentialDetails): object;
}

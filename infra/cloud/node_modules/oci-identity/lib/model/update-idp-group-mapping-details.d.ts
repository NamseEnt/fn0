...
export declare namespace UpdateIdpGroupMappingDetails {
    function getJsonObj(obj: UpdateIdpGroupMappingDetails): object;
    function getDeserializedJsonObj(obj: UpdateIdpGroupMappingDetails): object;
}

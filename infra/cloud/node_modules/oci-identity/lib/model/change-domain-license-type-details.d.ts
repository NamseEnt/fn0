...
export declare namespace ChangeDomainLicenseTypeDetails {
    function getJsonObj(obj: ChangeDomainLicenseTypeDetails): object;
    function getDeserializedJsonObj(obj: ChangeDomainLicenseTypeDetails): object;
}

...
export declare namespace Saml2IdentityProvider {
    function getJsonObj(obj: Saml2IdentityProvider, isParentJsonObj?: boolean): object;
    const protocol = "SAML2";
    function getDeserializedJsonObj(obj: Saml2IdentityProvider, isParentJsonObj?: boolean): object;
}

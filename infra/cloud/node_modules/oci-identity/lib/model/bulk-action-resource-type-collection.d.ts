...
export declare namespace BulkActionResourceTypeCollection {
    function getJsonObj(obj: BulkActionResourceTypeCollection): object;
    function getDeserializedJsonObj(obj: BulkActionResourceTypeCollection): object;
}

...
export declare namespace TaggingWorkRequestSummary {
    enum OperationType {
    ...
    function getJsonObj(obj: TaggingWorkRequestSummary): object;
    function getDeserializedJsonObj(obj: TaggingWorkRequestSummary): object;
}

 ...
 */
export interface MoveCompartmentDetails {
    /**
...
export declare namespace MoveCompartmentDetails {
    function getJsonObj(obj: MoveCompartmentDetails): object;
    function getDeserializedJsonObj(obj: MoveCompartmentDetails): object;
}

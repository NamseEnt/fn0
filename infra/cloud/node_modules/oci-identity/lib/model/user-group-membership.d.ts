...
export declare namespace UserGroupMembership {
    enum LifecycleState {
        Creating = "CREATING",
        Active = "ACTIVE",
        Inactive = "INACTIVE",
    ...
    function getJsonObj(obj: UserGroupMembership): object;
    function getDeserializedJsonObj(obj: UserGroupMembership): object;
}

 ...
 */
export interface AddUserToGroupDetails {
    /**
...
export declare namespace AddUserToGroupDetails {
    function getJsonObj(obj: AddUserToGroupDetails): object;
    function getDeserializedJsonObj(obj: AddUserToGroupDetails): object;
}

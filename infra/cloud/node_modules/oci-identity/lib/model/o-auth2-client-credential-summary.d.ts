...
export declare namespace OAuth2ClientCredentialSummary {
    enum LifecycleState {
        Creating = "CREATING",
        Active = "ACTIVE",
        Inactive = "INACTIVE",
    ...
    function getJsonObj(obj: OAuth2ClientCredentialSummary): object;
    function getDeserializedJsonObj(obj: OAuth2ClientCredentialSummary): object;
}

...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/fleetappsmanagement/ListExecutions.ts.html |here} to see how to use ListExecutionsRequest.
 */
export interface ListExecutionsRequest extends common.BaseRequest {
    /**

...
export declare namespace SchedulerJobSummary {
    function getJsonObj(obj: SchedulerJobSummary): object;
    function getDeserializedJsonObj(obj: SchedulerJobSummary): object;
}

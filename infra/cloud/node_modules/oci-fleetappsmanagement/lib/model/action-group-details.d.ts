...
export declare namespace ActionGroupDetails {
    function getJsonObj(obj: ActionGroupDetails): object;
    function getDeserializedJsonObj(obj: ActionGroupDetails): object;
}

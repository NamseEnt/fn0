...
export declare namespace TaskNotificationPreferences {
    function getJsonObj(obj: TaskNotificationPreferences): object;
    function getDeserializedJsonObj(obj: TaskNotificationPreferences): object;
}

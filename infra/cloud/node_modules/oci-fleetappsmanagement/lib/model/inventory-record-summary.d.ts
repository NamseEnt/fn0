...
export declare namespace InventoryRecordSummary {
    function getJsonObj(obj: InventoryRecordSummary): object;
    function getDeserializedJsonObj(obj: InventoryRecordSummary): object;
}

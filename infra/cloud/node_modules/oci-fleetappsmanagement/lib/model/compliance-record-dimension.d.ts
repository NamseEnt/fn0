 ...
 */
export interface ComplianceRecordDimension {
    /**
...
export declare namespace ComplianceRecordDimension {
    function getJsonObj(obj: ComplianceRecordDimension): object;
    function getDeserializedJsonObj(obj: ComplianceRecordDimension): object;
}

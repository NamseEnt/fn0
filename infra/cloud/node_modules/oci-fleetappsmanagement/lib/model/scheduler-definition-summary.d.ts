...
export declare namespace SchedulerDefinitionSummary {
    function getJsonObj(obj: SchedulerDefinitionSummary): object;
    function getDeserializedJsonObj(obj: SchedulerDefinitionSummary): object;
}

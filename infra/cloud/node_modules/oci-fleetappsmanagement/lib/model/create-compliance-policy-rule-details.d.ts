...
export declare namespace CreateCompliancePolicyRuleDetails {
    enum Severity {
        Critical = "CRITICAL",
        High = "HIGH",
        Medium = "MEDIUM",
    ...
    function getJsonObj(obj: CreateCompliancePolicyRuleDetails): object;
    function getDeserializedJsonObj(obj: CreateCompliancePolicyRuleDetails): object;
}

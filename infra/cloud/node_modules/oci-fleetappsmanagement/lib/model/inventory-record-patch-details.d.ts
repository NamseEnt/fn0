...
export declare namespace InventoryRecordPatchDetails {
    function getJsonObj(obj: InventoryRecordPatchDetails): object;
    function getDeserializedJsonObj(obj: InventoryRecordPatchDetails): object;
}

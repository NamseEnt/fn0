...
export declare namespace ProductVersionDetails {
    function getJsonObj(obj: ProductVersionDetails): object;
    function getDeserializedJsonObj(obj: ProductVersionDetails): object;
}

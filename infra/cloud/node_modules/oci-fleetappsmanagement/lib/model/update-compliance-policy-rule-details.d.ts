 ...
 */
export interface UpdateCompliancePolicyRuleDetails {
     ...
     */
    "severity"?: Array<UpdateCompliancePolicyRuleDetails.Severity>;
...
export declare namespace UpdateCompliancePolicyRuleDetails {
    enum Severity {
        Critical = "CRITICAL",
        High = "HIGH",
        Medium = "MEDIUM",
    ...
    function getJsonObj(obj: UpdateCompliancePolicyRuleDetails): object;
    function getDeserializedJsonObj(obj: UpdateCompliancePolicyRuleDetails): object;
}

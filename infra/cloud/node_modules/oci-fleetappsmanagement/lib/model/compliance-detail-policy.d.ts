 ...
 */
export interface ComplianceDetailPolicy {
    /**
...
export declare namespace ComplianceDetailPolicy {
    function getJsonObj(obj: ComplianceDetailPolicy): object;
    function getDeserializedJsonObj(obj: ComplianceDetailPolicy): object;
}

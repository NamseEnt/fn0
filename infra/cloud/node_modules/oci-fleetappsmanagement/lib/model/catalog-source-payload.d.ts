...
export declare namespace CatalogSourcePayload {
    function getJsonObj(obj: CatalogSourcePayload): object;
    function getDeserializedJsonObj(obj: CatalogSourcePayload): object;
}

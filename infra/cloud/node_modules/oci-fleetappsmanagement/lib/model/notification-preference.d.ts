...
export declare namespace NotificationPreference {
    function getJsonObj(obj: NotificationPreference): object;
    function getDeserializedJsonObj(obj: NotificationPreference): object;
}

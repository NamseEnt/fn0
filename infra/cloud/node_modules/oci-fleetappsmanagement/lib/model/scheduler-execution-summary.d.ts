...
export declare namespace SchedulerExecutionSummary {
    enum LifecycleState {
        Active = "ACTIVE",
        Deleted = "DELETED",
        Failed = "FAILED",
    ...
    function getJsonObj(obj: SchedulerExecutionSummary): object;
    function getDeserializedJsonObj(obj: SchedulerExecutionSummary): object;
}

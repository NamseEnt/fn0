...
export declare namespace ScheduledFleetSummary {
    function getJsonObj(obj: ScheduledFleetSummary): object;
    function getDeserializedJsonObj(obj: ScheduledFleetSummary): object;
}

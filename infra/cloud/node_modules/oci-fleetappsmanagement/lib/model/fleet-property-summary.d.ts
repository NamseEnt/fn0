...
export declare namespace FleetPropertySummary {
    function getJsonObj(obj: FleetPropertySummary): object;
    function getDeserializedJsonObj(obj: FleetPropertySummary): object;
}

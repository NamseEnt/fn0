...
export declare namespace UpdateRunbookDetails {
    function getJsonObj(obj: UpdateRunbookDetails): object;
    function getDeserializedJsonObj(obj: UpdateRunbookDetails): object;
}

...
(function (ActionGroup) {
        ...
        if (obj && "kind" in obj && obj.kind) {
            switch (obj.kind) {
                case "FLEET_USING_RUNBOOK":
                    return model.FleetBasedActionGroup.getJsonObj(jsonObj, true);
                default:
    ...
    ActionGroup.getJsonObj = getJsonObj;
    function getDeserializedJsonObj(obj) {
        const jsonObj = Object.assign(Object.assign({}, obj), {});
        if (obj && "kind" in obj && obj.kind) {
            switch (obj.kind) {
                case "FLEET_USING_RUNBOOK":
                    return model.FleetBasedActionGroup.getDeserializedJsonObj(jsonObj, true);
                default:
                    if (common.LOG.logger)
                        common.LOG.logger.info(`Unknown value for: ${obj.kind}`);
            }
    ...
    ActionGroup.getDeserializedJsonObj = getDeserializedJsonObj;

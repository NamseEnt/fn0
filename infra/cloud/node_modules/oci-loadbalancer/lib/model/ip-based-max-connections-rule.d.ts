...
export declare namespace IpBasedMaxConnectionsRule {
    function getJsonObj(obj: IpBasedMaxConnectionsRule, isParentJsonObj?: boolean): object;
    const action = "IP_BASED_MAX_CONNECTIONS";
    function getDeserializedJsonObj(obj: IpBasedMaxConnectionsRule, isParentJsonObj?: boolean): object;
}

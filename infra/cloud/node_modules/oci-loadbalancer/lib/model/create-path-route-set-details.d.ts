...
export declare namespace CreatePathRouteSetDetails {
    function getJsonObj(obj: CreatePathRouteSetDetails): object;
    function getDeserializedJsonObj(obj: CreatePathRouteSetDetails): object;
}

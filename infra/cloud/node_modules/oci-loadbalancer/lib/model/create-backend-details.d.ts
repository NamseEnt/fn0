...
export declare namespace CreateBackendDetails {
    function getJsonObj(obj: CreateBackendDetails): object;
    function getDeserializedJsonObj(obj: CreateBackendDetails): object;
}

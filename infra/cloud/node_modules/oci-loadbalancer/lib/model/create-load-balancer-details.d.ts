...
export interface CreateLoadBalancerDetails {
  ...
  *
    ...
    "listeners"?: {
        [key: string]: model.ListenerDetails;
    };
    "hostnames"?: {
        [key: string]: model.HostnameDetails;
    };
    "backendSets"?: {
        [key: string]: model.BackendSetDetails;
    };
    /**
  ...
  *
    ...
    "certificates"?: {
        [key: string]: model.CertificateDetails;
    };
    "sslCipherSuites"?: {
        [key: string]: model.SSLCipherSuiteDetails;
    };
    "pathRouteSets"?: {
        [key: string]: model.PathRouteSetDetails;
    };
    /**
  ...
  *
    ...
    "ruleSets"?: {
        [key: string]: model.RuleSetDetails;
    };
}
export declare namespace CreateLoadBalancerDetails {
    enum IpMode {
        Ipv4 = "IPV4",
        Ipv6 = "IPV6"
    }
    function getJsonObj(obj: CreateLoadBalancerDetails): object;
    function getDeserializedJsonObj(obj: CreateLoadBalancerDetails): object;
}

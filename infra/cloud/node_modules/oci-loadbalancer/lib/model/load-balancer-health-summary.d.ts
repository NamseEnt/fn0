...
export declare namespace LoadBalancerHealthSummary {
    enum Status {
        Ok = "OK",
        Warning = "WARNING",
        Critical = "CRITICAL",
    ...
    function getJsonObj(obj: LoadBalancerHealthSummary): object;
    function getDeserializedJsonObj(obj: LoadBalancerHealthSummary): object;
}

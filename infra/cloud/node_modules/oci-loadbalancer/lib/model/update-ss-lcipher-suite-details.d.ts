...
export declare namespace UpdateSSLCipherSuiteDetails {
    function getJsonObj(obj: UpdateSSLCipherSuiteDetails): object;
    function getDeserializedJsonObj(obj: UpdateSSLCipherSuiteDetails): object;
}

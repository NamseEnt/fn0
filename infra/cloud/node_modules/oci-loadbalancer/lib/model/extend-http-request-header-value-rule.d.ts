...
export declare namespace ExtendHttpRequestHeaderValueRule {
    function getJsonObj(obj: ExtendHttpRequestHeaderValueRule, isParentJsonObj?: boolean): object;
    const action = "EXTEND_HTTP_REQUEST_HEADER_VALUE";
    function getDeserializedJsonObj(obj: ExtendHttpRequestHeaderValueRule, isParentJsonObj?: boolean): object;
}

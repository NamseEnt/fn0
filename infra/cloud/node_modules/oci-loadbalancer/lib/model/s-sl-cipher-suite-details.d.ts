...
*
*/
export interface SSLCipherSuiteDetails {
    /**
...
export declare namespace SSLCipherSuiteDetails {
    function getJsonObj(obj: SSLCipherSuiteDetails): object;
    function getDeserializedJsonObj(obj: SSLCipherSuiteDetails): object;
}

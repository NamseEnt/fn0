...
export declare namespace LoadBalancerHealth {
    enum Status {
        Ok = "OK",
        Warning = "WARNING",
        Critical = "CRITICAL",
    ...
    function getJsonObj(obj: LoadBalancerHealth): object;
    function getDeserializedJsonObj(obj: LoadBalancerHealth): object;
}

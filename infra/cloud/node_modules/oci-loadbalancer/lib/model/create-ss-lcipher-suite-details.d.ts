...
*
*/
export interface CreateSSLCipherSuiteDetails {
    /**
...
export declare namespace CreateSSLCipherSuiteDetails {
    function getJsonObj(obj: CreateSSLCipherSuiteDetails): object;
    function getDeserializedJsonObj(obj: CreateSSLCipherSuiteDetails): object;
}

...
export declare namespace ContainerCapabilities {
    enum AddCapabilities {
        CapChown = "CAP_CHOWN",
    ...
    function getJsonObj(obj: ContainerCapabilities): object;
    function getDeserializedJsonObj(obj: ContainerCapabilities): object;
}

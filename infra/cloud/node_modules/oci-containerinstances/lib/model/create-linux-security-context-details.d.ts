 ...
 */
export interface CreateLinuxSecurityContextDetails extends model.CreateSecurityContextDetails {
    /**
...
export declare namespace CreateLinuxSecurityContextDetails {
    function getJsonObj(obj: CreateLinuxSecurityContextDetails, isParentJsonObj?: boolean): object;
    const securityContextType = "LINUX";
    function getDeserializedJsonObj(obj: CreateLinuxSecurityContextDetails, isParentJsonObj?: boolean): object;
}

...
export declare namespace ContainerTcpHealthCheck {
    function getJsonObj(obj: ContainerTcpHealthCheck, isParentJsonObj?: boolean): object;
    const healthCheckType = "TCP";
    function getDeserializedJsonObj(obj: ContainerTcpHealthCheck, isParentJsonObj?: boolean): object;
}

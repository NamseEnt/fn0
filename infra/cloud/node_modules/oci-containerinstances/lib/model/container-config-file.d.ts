...
export declare namespace ContainerConfigFile {
    function getJsonObj(obj: ContainerConfigFile): object;
    function getDeserializedJsonObj(obj: ContainerConfigFile): object;
}

...
export declare namespace CreateContainerHealthCheckDetails {
    function getJsonObj(obj: CreateContainerHealthCheckDetails): object;
    function getDeserializedJsonObj(obj: CreateContainerHealthCheckDetails): object;
}

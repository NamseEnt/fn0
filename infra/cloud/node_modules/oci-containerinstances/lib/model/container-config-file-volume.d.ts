...
export declare namespace ContainerConfigFileVolume {
    function getJsonObj(obj: ContainerConfigFileVolume, isParentJsonObj?: boolean): object;
    const volumeType = "CONFIGFILE";
    function getDeserializedJsonObj(obj: ContainerConfigFileVolume, isParentJsonObj?: boolean): object;
}

 ...
 *
 */
export interface CreateVolumeMountDetails {
    /**
...
export declare namespace CreateVolumeMountDetails {
    function getJsonObj(obj: CreateVolumeMountDetails): object;
    function getDeserializedJsonObj(obj: CreateVolumeMountDetails): object;
}

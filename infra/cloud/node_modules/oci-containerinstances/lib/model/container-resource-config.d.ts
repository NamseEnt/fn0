...
export declare namespace ContainerResourceConfig {
    function getJsonObj(obj: ContainerResourceConfig): object;
    function getDeserializedJsonObj(obj: ContainerResourceConfig): object;
}

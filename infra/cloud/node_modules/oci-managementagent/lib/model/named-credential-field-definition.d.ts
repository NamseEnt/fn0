...
export declare namespace NamedCredentialFieldDefinition {
    enum ValueCategory {
    ...
    function getJsonObj(obj: NamedCredentialFieldDefinition): object;
    function getDeserializedJsonObj(obj: NamedCredentialFieldDefinition): object;
}

...
export declare namespace PlatformTypes {
    function getJsonObj(obj: PlatformTypes): PlatformTypes;
    function getDeserializedJsonObj(obj: PlatformTypes): PlatformTypes;
}

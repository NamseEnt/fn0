...
export declare namespace CreateManagementAgentInstallKeyDetails {
    function getJsonObj(obj: CreateManagementAgentInstallKeyDetails): object;
    function getDeserializedJsonObj(obj: CreateManagementAgentInstallKeyDetails): object;
}

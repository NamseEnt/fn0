 ...
 */
export interface SetAutoUpgradableConfigDetails {
    /**
...
export declare namespace SetAutoUpgradableConfigDetails {
    function getJsonObj(obj: SetAutoUpgradableConfigDetails): object;
    function getDeserializedJsonObj(obj: SetAutoUpgradableConfigDetails): object;
}

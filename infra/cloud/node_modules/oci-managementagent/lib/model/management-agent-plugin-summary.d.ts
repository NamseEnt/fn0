...
export declare namespace ManagementAgentPluginSummary {
    ...
    function getJsonObj(obj: ManagementAgentPluginSummary): object;
    function getDeserializedJsonObj(obj: ManagementAgentPluginSummary): object;
}

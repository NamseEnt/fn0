...
export declare namespace AutoUpgradableConfig {
    function getJsonObj(obj: AutoUpgradableConfig): object;
    function getDeserializedJsonObj(obj: AutoUpgradableConfig): object;
}

...
export declare class ManagementAgentWaiter {
    private client;
    private readonly config?;
    constructor(client: ManagementAgentClient, config?: Partial<import("oci-common/lib/waiter").WaiterConfigurationDetails> | undefined);
    /**
     ...
     */
    forManagementAgent(request: serviceRequests.GetManagementAgentRequest, ...targetStates: models.LifecycleStates[]): Promise<serviceResponses.GetManagementAgentResponse | null>;
    /**
     ...
     */
    forManagementAgentInstallKey(request: serviceRequests.GetManagementAgentInstallKeyRequest, ...targetStates: models.LifecycleStates[]): Promise<serviceResponses.GetManagementAgentInstallKeyResponse | null>;
    /**
     ...
     */
    forNamedCredential(request: serviceRequests.GetNamedCredentialRequest, ...targetStates: models.NamedCredential.LifecycleState[]): Promise<serviceResponses.GetNamedCredentialResponse | null>;
    /**

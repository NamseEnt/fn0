...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/managementagent/ListManagementAgentInstallKeys.ts.html |here} to see how to use ListManagementAgentInstallKeysRequest.
 */
...
export declare namespace ListManagementAgentInstallKeysRequest {
    enum SortOrder {
        Asc = "ASC",
        Desc = "DESC"
    }

...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/managementagent/ListAvailabilityHistories.ts.html |here} to see how to use ListAvailabilityHistoriesRequest.
 */
...
export declare namespace ListAvailabilityHistoriesRequest {
    enum SortOrder {
        Asc = "ASC",
        Desc = "DESC"
    }

...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/databasemigration/ListMigrationObjectTypes.ts.html |here} to see how to use ListMigrationObjectTypesRequest.
 */
...
export declare namespace ListMigrationObjectTypesRequest {
    enum SortBy {
        Name = "name"
    }
}

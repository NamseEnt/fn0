...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/databasemigration/ListMigrations.ts.html |here} to see how to use ListMigrationsRequest.
 */
...
export declare namespace ListMigrationsRequest {
    enum SortBy {

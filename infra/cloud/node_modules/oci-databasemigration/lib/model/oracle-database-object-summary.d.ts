 ...
 */
export interface OracleDatabaseObjectSummary {
    /**
     * Object status.
     */
...
export declare namespace OracleDatabaseObjectSummary {
    function getJsonObj(obj: OracleDatabaseObjectSummary): object;
    function getDeserializedJsonObj(obj: OracleDatabaseObjectSummary): object;
}

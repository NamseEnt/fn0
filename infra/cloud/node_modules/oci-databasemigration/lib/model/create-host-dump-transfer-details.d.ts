...
export declare namespace CreateHostDumpTransferDetails {
    function getJsonObj(obj: CreateHostDumpTransferDetails): object;
    function getDeserializedJsonObj(obj: CreateHostDumpTransferDetails): object;
}

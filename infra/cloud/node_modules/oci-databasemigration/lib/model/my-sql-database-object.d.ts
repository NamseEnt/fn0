 ...
 */
export interface MySqlDatabaseObject {
    /**
...
export declare namespace MySqlDatabaseObject {
    function getJsonObj(obj: MySqlDatabaseObject): object;
    function getDeserializedJsonObj(obj: MySqlDatabaseObject): object;
}

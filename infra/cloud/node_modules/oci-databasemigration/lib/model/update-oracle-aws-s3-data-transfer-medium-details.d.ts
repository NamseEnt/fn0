 ...
 *
 */
export interface UpdateOracleAwsS3DataTransferMediumDetails extends model.UpdateOracleDataTransferMediumDetails {
    /**
     * S3 bucket name.
     */
    "name"?: string;
...
export declare namespace UpdateOracleAwsS3DataTransferMediumDetails {
    function getJsonObj(obj: UpdateOracleAwsS3DataTransferMediumDetails, isParentJsonObj?: boolean): object;
    const type = "AWS_S3";
    function getDeserializedJsonObj(obj: UpdateOracleAwsS3DataTransferMediumDetails, isParentJsonObj?: boolean): object;
}

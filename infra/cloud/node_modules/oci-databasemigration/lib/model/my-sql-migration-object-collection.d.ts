...
export declare namespace MySqlMigrationObjectCollection {
    function getJsonObj(obj: MySqlMigrationObjectCollection, isParentJsonObj?: boolean): object;
    const databaseCombination = "MYSQL";
    function getDeserializedJsonObj(obj: MySqlMigrationObjectCollection, isParentJsonObj?: boolean): object;
}

 ...
 *
 */
export interface CreateOracleAwsS3DataTransferMediumDetails extends model.CreateOracleDataTransferMediumDetails {
    /**
     * S3 bucket name.
     */
    "name"?: string;
...
export declare namespace CreateOracleAwsS3DataTransferMediumDetails {
    function getJsonObj(obj: CreateOracleAwsS3DataTransferMediumDetails, isParentJsonObj?: boolean): object;
    const type = "AWS_S3";
    function getDeserializedJsonObj(obj: CreateOracleAwsS3DataTransferMediumDetails, isParentJsonObj?: boolean): object;
}

...
export declare namespace CreateMigrationDetails {
    function getJsonObj(obj: CreateMigrationDetails): object;
    function getDeserializedJsonObj(obj: CreateMigrationDetails): object;
}

 ...
 *
 */
export interface CreateDirectoryObject {
    /**
...
export declare namespace CreateDirectoryObject {
    function getJsonObj(obj: CreateDirectoryObject): object;
    function getDeserializedJsonObj(obj: CreateDirectoryObject): object;
}

...
export declare namespace OracleConnection {
    enum TechnologyType {
    ...
    function getJsonObj(obj: OracleConnection, isParentJsonObj?: boolean): object;
    const connectionType = "ORACLE";
    function getDeserializedJsonObj(obj: OracleConnection, isParentJsonObj?: boolean): object;
}

 ...
 */
export interface OracleDatabaseObject {
    /**
...
export declare namespace OracleDatabaseObject {
    function getJsonObj(obj: OracleDatabaseObject): object;
    function getDeserializedJsonObj(obj: OracleDatabaseObject): object;
}

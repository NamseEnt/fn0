...
export declare namespace MigrationJobProgressSummary {
    function getJsonObj(obj: MigrationJobProgressSummary): object;
    function getDeserializedJsonObj(obj: MigrationJobProgressSummary): object;
}

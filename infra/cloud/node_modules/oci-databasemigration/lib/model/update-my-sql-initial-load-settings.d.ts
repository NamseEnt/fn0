...
export declare namespace UpdateMySqlInitialLoadSettings {
    function getJsonObj(obj: UpdateMySqlInitialLoadSettings): object;
    function getDeserializedJsonObj(obj: UpdateMySqlInitialLoadSettings): object;
}

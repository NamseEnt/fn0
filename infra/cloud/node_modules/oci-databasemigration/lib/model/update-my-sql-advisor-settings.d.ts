 ...
 */
export interface UpdateMySqlAdvisorSettings {
    /**
...
export declare namespace UpdateMySqlAdvisorSettings {
    function getJsonObj(obj: UpdateMySqlAdvisorSettings): object;
    function getDeserializedJsonObj(obj: UpdateMySqlAdvisorSettings): object;
}

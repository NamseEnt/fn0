...
export declare namespace DiagnosticsResult {
    function getJsonObj(obj: DiagnosticsResult): object;
    function getDeserializedJsonObj(obj: DiagnosticsResult): object;
}

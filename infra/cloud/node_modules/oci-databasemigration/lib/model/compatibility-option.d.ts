 ...
 *
 **/
export declare enum CompatibilityOption {
...
export declare namespace CompatibilityOption {
    function getJsonObj(obj: CompatibilityOption): CompatibilityOption;
    function getDeserializedJsonObj(obj: CompatibilityOption): CompatibilityOption;
}

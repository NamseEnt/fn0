...
export declare namespace UpdateMigrationDetails {
    function getJsonObj(obj: UpdateMigrationDetails): object;
    function getDeserializedJsonObj(obj: UpdateMigrationDetails): object;
}

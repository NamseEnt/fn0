 ...
 */
export interface UpdateMysqlConnectionDetails extends model.UpdateConnectionDetails {
    /**
...
export declare namespace UpdateMysqlConnectionDetails {
    function getJsonObj(obj: UpdateMysqlConnectionDetails, isParentJsonObj?: boolean): object;
    const connectionType = "MYSQL";
    function getDeserializedJsonObj(obj: UpdateMysqlConnectionDetails, isParentJsonObj?: boolean): object;
}

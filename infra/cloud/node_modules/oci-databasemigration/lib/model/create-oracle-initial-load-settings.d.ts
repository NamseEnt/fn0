...
export declare namespace CreateOracleInitialLoadSettings {
    function getJsonObj(obj: CreateOracleInitialLoadSettings): object;
    function getDeserializedJsonObj(obj: CreateOracleInitialLoadSettings): object;
}

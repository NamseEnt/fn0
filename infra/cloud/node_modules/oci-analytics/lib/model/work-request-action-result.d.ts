 ...
 *
 **/
export declare enum WorkRequestActionResult {
...
export declare namespace WorkRequestActionResult {
    function getJsonObj(obj: WorkRequestActionResult): WorkRequestActionResult;
    function getDeserializedJsonObj(obj: WorkRequestActionResult): WorkRequestActionResult;
}

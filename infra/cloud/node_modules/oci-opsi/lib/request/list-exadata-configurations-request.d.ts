...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/opsi/ListExadataConfigurations.ts.html |here} to see how to use ListExadataConfigurationsRequest.
 */
...
export declare namespace ListExadataConfigurationsRequest {
    enum SortBy {

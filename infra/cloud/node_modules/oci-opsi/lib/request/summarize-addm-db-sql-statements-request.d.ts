...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/opsi/SummarizeAddmDbSqlStatements.ts.html |here} to see how to use SummarizeAddmDbSqlStatementsRequest.
 */
export interface SummarizeAddmDbSqlStatementsRequest extends common.BaseRequest {
    /**

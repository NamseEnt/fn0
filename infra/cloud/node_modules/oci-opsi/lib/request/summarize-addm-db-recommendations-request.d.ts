...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/opsi/SummarizeAddmDbRecommendations.ts.html |here} to see how to use SummarizeAddmDbRecommendationsRequest.
 */
export interface SummarizeAddmDbRecommendationsRequest extends common.BaseRequest {
    /**
...
export declare namespace SummarizeAddmDbRecommendationsRequest {
    enum SortBy {

...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/opsi/GetAwrDatabaseReport.ts.html |here} to see how to use GetAwrDatabaseReportRequest.
 */
...
export declare namespace GetAwrDatabaseReportRequest {
    enum ReportType {
        Awr = "AWR",
        Ash = "ASH"
    }

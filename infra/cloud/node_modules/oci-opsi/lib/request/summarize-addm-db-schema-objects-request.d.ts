...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/opsi/SummarizeAddmDbSchemaObjects.ts.html |here} to see how to use SummarizeAddmDbSchemaObjectsRequest.
 */
export interface SummarizeAddmDbSchemaObjectsRequest extends common.BaseRequest {
    /**

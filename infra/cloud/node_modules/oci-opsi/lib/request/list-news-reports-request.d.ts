...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/opsi/ListNewsReports.ts.html |here} to see how to use ListNewsReportsRequest.
 */
...
export declare namespace ListNewsReportsRequest {
    enum SortBy {
        Name = "name",

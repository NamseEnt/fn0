...
class OperationsInsightsWaiter {
     ...
     */
    forChargebackPlan(request, ...targetStates) {
        return __awaiter(this, void 0, void 0, function* () {
            return oci_common_1.genericTerminalConditionWaiter(this.config, () => this.client.getChargebackPlan(request), response => targetStates.includes(response.chargebackPlan.lifecycleState), targetStates.includes(models.LifecycleState.Deleted));
        });
    }
    /**

...
export declare namespace HostResourceAllocation {
    function getJsonObj(obj: HostResourceAllocation, isParentJsonObj?: boolean): object;
    const metricName = "HOST_RESOURCE_ALLOCATION";
    function getDeserializedJsonObj(obj: HostResourceAllocation, isParentJsonObj?: boolean): object;
}

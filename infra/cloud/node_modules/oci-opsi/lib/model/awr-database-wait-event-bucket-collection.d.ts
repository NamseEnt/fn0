...
export declare namespace AwrDatabaseWaitEventBucketCollection {
    function getJsonObj(obj: AwrDatabaseWaitEventBucketCollection, isParentJsonObj?: boolean): object;
    const awrResultType = "AWRDB_EVENT_HISTOGRAM_SET";
    function getDeserializedJsonObj(obj: AwrDatabaseWaitEventBucketCollection, isParentJsonObj?: boolean): object;
}

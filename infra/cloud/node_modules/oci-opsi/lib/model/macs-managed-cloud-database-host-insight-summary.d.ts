 ...
 */
export interface MacsManagedCloudDatabaseHostInsightSummary extends model.HostInsightSummary {
    /**
     ...
     *
     */
    "platformType"?: MacsManagedCloudDatabaseHostInsightSummary.PlatformType;
    "entitySource": string;
}
export declare namespace MacsManagedCloudDatabaseHostInsightSummary {
    enum PlatformType {
        Linux = "LINUX",
        Solaris = "SOLARIS",
        Sunos = "SUNOS",
    ...
    function getJsonObj(obj: MacsManagedCloudDatabaseHostInsightSummary, isParentJsonObj?: boolean): object;
    const entitySource = "MACS_MANAGED_CLOUD_DB_HOST";
    function getDeserializedJsonObj(obj: MacsManagedCloudDatabaseHostInsightSummary, isParentJsonObj?: boolean): object;
}

 ...
 *
 **/
export declare enum NewsFrequency {
    Weekly = "WEEKLY",
    Daily = "DAILY",
    Hourly = "HOURLY",
    /**
...
export declare namespace NewsFrequency {
    function getJsonObj(obj: NewsFrequency): NewsFrequency;
    function getDeserializedJsonObj(obj: NewsFrequency): NewsFrequency;
}

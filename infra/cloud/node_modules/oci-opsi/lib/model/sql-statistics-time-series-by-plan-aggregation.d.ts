...
export declare namespace SqlStatisticsTimeSeriesByPlanAggregation {
    function getJsonObj(obj: SqlStatisticsTimeSeriesByPlanAggregation): object;
    function getDeserializedJsonObj(obj: SqlStatisticsTimeSeriesByPlanAggregation): object;
}

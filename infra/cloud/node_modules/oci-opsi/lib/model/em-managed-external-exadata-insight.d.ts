...
export declare namespace EmManagedExternalExadataInsight {
    function getJsonObj(obj: EmManagedExternalExadataInsight, isParentJsonObj?: boolean): object;
    const entitySource = "EM_MANAGED_EXTERNAL_EXADATA";
    function getDeserializedJsonObj(obj: EmManagedExternalExadataInsight, isParentJsonObj?: boolean): object;
}

...
export declare namespace SummarizeDatabaseInsightResourceStatisticsAggregationCollection {
    enum ResourceMetric {
        Cpu = "CPU",
        Storage = "STORAGE",
        Io = "IO",
    ...
    function getJsonObj(obj: SummarizeDatabaseInsightResourceStatisticsAggregationCollection): object;
    function getDeserializedJsonObj(obj: SummarizeDatabaseInsightResourceStatisticsAggregationCollection): object;
}

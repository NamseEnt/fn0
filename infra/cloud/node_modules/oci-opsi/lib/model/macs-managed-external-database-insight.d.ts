...
export declare namespace MacsManagedExternalDatabaseInsight {
    function getJsonObj(obj: MacsManagedExternalDatabaseInsight, isParentJsonObj?: boolean): object;
    const entitySource = "MACS_MANAGED_EXTERNAL_DATABASE";
    function getDeserializedJsonObj(obj: MacsManagedExternalDatabaseInsight, isParentJsonObj?: boolean): object;
}

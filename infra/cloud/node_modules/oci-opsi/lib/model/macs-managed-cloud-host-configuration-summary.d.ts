...
export declare namespace MacsManagedCloudHostConfigurationSummary {
    function getJsonObj(obj: MacsManagedCloudHostConfigurationSummary, isParentJsonObj?: boolean): object;
    const entitySource = "MACS_MANAGED_CLOUD_HOST";
    function getDeserializedJsonObj(obj: MacsManagedCloudHostConfigurationSummary, isParentJsonObj?: boolean): object;
}

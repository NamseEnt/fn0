 ...
 */
export interface SqlInsightAggregation {
    /**
     * Insight text.
...
export declare namespace SqlInsightAggregation {
    function getJsonObj(obj: SqlInsightAggregation): object;
    function getDeserializedJsonObj(obj: SqlInsightAggregation): object;
}

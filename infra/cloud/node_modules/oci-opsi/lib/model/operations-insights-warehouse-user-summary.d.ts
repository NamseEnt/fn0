 ...
 */
export interface OperationsInsightsWarehouseUserSummary {
    /**
     * OPSI Warehouse OCID
     */
     ...
     */
    "lifecycleState": model.OperationsInsightsWarehouseUserLifecycleState;
    /**
     * A message describing the current state in more detail. For example, can be used to provide actionable information for a resource in Failed state.
     */
    "lifecycleDetails"?: string;
}
export declare namespace OperationsInsightsWarehouseUserSummary {
    function getJsonObj(obj: OperationsInsightsWarehouseUserSummary): object;
    function getDeserializedJsonObj(obj: OperationsInsightsWarehouseUserSummary): object;
}

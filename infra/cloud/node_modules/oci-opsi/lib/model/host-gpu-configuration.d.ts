...
export declare namespace HostGpuConfiguration {
    function getJsonObj(obj: HostGpuConfiguration, isParentJsonObj?: boolean): object;
    const metricName = "HOST_GPU_CONFIGURATION";
    function getDeserializedJsonObj(obj: HostGpuConfiguration, isParentJsonObj?: boolean): object;
}

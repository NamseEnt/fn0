...
export declare namespace MacsManagedCloudHostInsight {
    enum PlatformType {
        Linux = "LINUX",
        Solaris = "SOLARIS",
        Sunos = "SUNOS",
    ...
    function getJsonObj(obj: MacsManagedCloudHostInsight, isParentJsonObj?: boolean): object;
    const entitySource = "MACS_MANAGED_CLOUD_HOST";
    function getDeserializedJsonObj(obj: MacsManagedCloudHostInsight, isParentJsonObj?: boolean): object;
}

...
export declare namespace MacsManagedCloudHostInsightSummary {
    enum PlatformType {
        Linux = "LINUX",
        Solaris = "SOLARIS",
        Sunos = "SUNOS",
    ...
    function getJsonObj(obj: MacsManagedCloudHostInsightSummary, isParentJsonObj?: boolean): object;
    const entitySource = "MACS_MANAGED_CLOUD_HOST";
    function getDeserializedJsonObj(obj: MacsManagedCloudHostInsightSummary, isParentJsonObj?: boolean): object;
}

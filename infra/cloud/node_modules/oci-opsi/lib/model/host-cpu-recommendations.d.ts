...
export declare namespace HostCpuRecommendations {
    enum Burstable {
    ...
    function getJsonObj(obj: HostCpuRecommendations, isParentJsonObj?: boolean): object;
    const metricRecommendationName = "HOST_CPU_RECOMMENDATIONS";
    function getDeserializedJsonObj(obj: HostCpuRecommendations, isParentJsonObj?: boolean): object;
}

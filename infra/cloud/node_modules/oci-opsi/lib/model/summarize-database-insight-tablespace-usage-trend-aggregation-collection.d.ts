...
export declare namespace SummarizeDatabaseInsightTablespaceUsageTrendAggregationCollection {
    enum UsageUnit {
        Cores = "CORES",
        Gb = "GB",
        Mbps = "MBPS",
    ...
    function getJsonObj(obj: SummarizeDatabaseInsightTablespaceUsageTrendAggregationCollection): object;
    function getDeserializedJsonObj(obj: SummarizeDatabaseInsightTablespaceUsageTrendAggregationCollection): object;
}

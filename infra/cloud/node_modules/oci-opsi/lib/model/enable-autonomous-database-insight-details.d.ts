...
export declare namespace EnableAutonomousDatabaseInsightDetails {
    function getJsonObj(obj: EnableAutonomousDatabaseInsightDetails, isParentJsonObj?: boolean): object;
    const entitySource = "AUTONOMOUS_DATABASE";
    function getDeserializedJsonObj(obj: EnableAutonomousDatabaseInsightDetails, isParentJsonObj?: boolean): object;
}

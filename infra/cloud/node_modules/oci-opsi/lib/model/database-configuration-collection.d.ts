...
export declare namespace DatabaseConfigurationCollection {
    function getJsonObj(obj: DatabaseConfigurationCollection): object;
    function getDeserializedJsonObj(obj: DatabaseConfigurationCollection): object;
}

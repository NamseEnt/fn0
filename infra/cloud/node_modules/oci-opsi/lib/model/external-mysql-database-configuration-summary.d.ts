 ...
 */
export interface ExternalMysqlDatabaseConfigurationSummary extends model.DatabaseConfigurationSummary {
    /**
...
export declare namespace ExternalMysqlDatabaseConfigurationSummary {
    function getJsonObj(obj: ExternalMysqlDatabaseConfigurationSummary, isParentJsonObj?: boolean): object;
    const entitySource = "EXTERNAL_MYSQL_DATABASE_SYSTEM";
    function getDeserializedJsonObj(obj: ExternalMysqlDatabaseConfigurationSummary, isParentJsonObj?: boolean): object;
}

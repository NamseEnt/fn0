...
export declare namespace AddmDbFindingsTimeSeriesSummary {
    function getJsonObj(obj: AddmDbFindingsTimeSeriesSummary): object;
    function getDeserializedJsonObj(obj: AddmDbFindingsTimeSeriesSummary): object;
}

...
export declare namespace ChargebackPlanReportSummary {
    enum ResourceType {
    ...
    function getJsonObj(obj: ChargebackPlanReportSummary): object;
    function getDeserializedJsonObj(obj: ChargebackPlanReportSummary): object;
}

...
export declare namespace ChargebackPlanSummary {
    function getJsonObj(obj: ChargebackPlanSummary): object;
    function getDeserializedJsonObj(obj: ChargebackPlanSummary): object;
}

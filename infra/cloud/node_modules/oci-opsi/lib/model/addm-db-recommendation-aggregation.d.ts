...
export declare namespace AddmDbRecommendationAggregation {
    function getJsonObj(obj: AddmDbRecommendationAggregation): object;
    function getDeserializedJsonObj(obj: AddmDbRecommendationAggregation): object;
}

...
export declare namespace OpsiDataObjectDetailsInQuery {
    function getJsonObj(obj: OpsiDataObjectDetailsInQuery): object;
    function getDeserializedJsonObj(obj: OpsiDataObjectDetailsInQuery): object;
}

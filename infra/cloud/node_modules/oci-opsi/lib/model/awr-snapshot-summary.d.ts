...
export declare namespace AwrSnapshotSummary {
    function getJsonObj(obj: AwrSnapshotSummary): object;
    function getDeserializedJsonObj(obj: AwrSnapshotSummary): object;
}

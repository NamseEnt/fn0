...
export declare namespace HostMemoryRecommendations {
    enum UnusedInstance {
        InUse = "IN_USE",
        NotInUse = "NOT_IN_USE",
    ...
    function getJsonObj(obj: HostMemoryRecommendations, isParentJsonObj?: boolean): object;
    const metricRecommendationName = "HOST_MEMORY_RECOMMENDATIONS";
    function getDeserializedJsonObj(obj: HostMemoryRecommendations, isParentJsonObj?: boolean): object;
}

 ...
 *
 */
export interface HostIoUsage extends model.HostPerformanceMetricGroup {
    /**
     * Mount point
     */
    "mountPoint"?: string;
...
export declare namespace HostIoUsage {
    function getJsonObj(obj: HostIoUsage, isParentJsonObj?: boolean): object;
    const metricName = "HOST_IO_USAGE";
    function getDeserializedJsonObj(obj: HostIoUsage, isParentJsonObj?: boolean): object;
}

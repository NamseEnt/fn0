...
exports.DatabaseInsight = void 0;
...
(function (DatabaseInsight) {
        ...
        if (obj && "entitySource" in obj && obj.entitySource) {
            switch (obj.entitySource) {
                ...
                case "MDS_MYSQL_DATABASE_SYSTEM":
                    return model.MdsMySqlDatabaseInsight.getJsonObj(jsonObj, true);
                default:
    ...
    function getDeserializedJsonObj(obj) {
        ...
        if (obj && "entitySource" in obj && obj.entitySource) {
            switch (obj.entitySource) {
                ...
                case "MDS_MYSQL_DATABASE_SYSTEM":
                    return model.MdsMySqlDatabaseInsight.getDeserializedJsonObj(jsonObj, true);
                default:
                    if (common.LOG.logger)
                        common.LOG.logger.info(`Unknown value for: ${obj.entitySource}`);
            }
    ...
    DatabaseInsight.getDeserializedJsonObj = getDeserializedJsonObj;
})(DatabaseInsight = exports.DatabaseInsight || (exports.DatabaseInsight = {}));
//# sourceMappingURL=database-insight.js.map
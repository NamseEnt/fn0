...
(function (HostConfigurationMetricGroup) {
        ...
        if (obj && "metricName" in obj && obj.metricName) {
            switch (obj.metricName) {
                ...
                case "HOST_CONTAINERS":
                    return model.HostContainers.getJsonObj(jsonObj, true);
                ...
                case "HOST_GPU_CONFIGURATION":
                    return model.HostGpuConfiguration.getJsonObj(jsonObj, true);
    ...
    function getDeserializedJsonObj(obj) {
        ...
        if (obj && "metricName" in obj && obj.metricName) {
            switch (obj.metricName) {
                ...
                case "HOST_CONTAINERS":
                    return model.HostContainers.getDeserializedJsonObj(jsonObj, true);
                case "HOST_NETWORK_CONFIGURATION":
                    return model.HostNetworkConfiguration.getDeserializedJsonObj(jsonObj, true);
                case "HOST_ENTITIES":
                    return model.HostEntities.getDeserializedJsonObj(jsonObj, true);
                case "HOST_MEMORY_CONFIGURATION":
                    return model.HostMemoryConfiguration.getDeserializedJsonObj(jsonObj, true);
                case "HOST_CPU_HARDWARE_CONFIGURATION":
                    return model.HostCpuHardwareConfiguration.getDeserializedJsonObj(jsonObj, true);
                case "HOST_GPU_CONFIGURATION":
                    return model.HostGpuConfiguration.getDeserializedJsonObj(jsonObj, true);
                case "HOST_HARDWARE_CONFIGURATION":
                    return model.HostHardwareConfiguration.getDeserializedJsonObj(jsonObj, true);
                default:
                    if (common.LOG.logger)
                        common.LOG.logger.info(`Unknown value for: ${obj.metricName}`);
            }
    ...
    HostConfigurationMetricGroup.getDeserializedJsonObj = getDeserializedJsonObj;

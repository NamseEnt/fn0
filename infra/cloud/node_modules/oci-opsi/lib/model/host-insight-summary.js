...
exports.HostInsightSummary = void 0;
const model = __importStar(require("../model"));
const common = require("oci-common");
var HostInsightSummary;
(function (HostInsightSummary) {
        ...
        if (obj && "entitySource" in obj && obj.entitySource) {
            switch (obj.entitySource) {
                ...
                case "PE_COMANAGED_HOST":
                    return model.PeComanagedHostInsightSummary.getJsonObj(jsonObj, true);
                case "MACS_MANAGED_CLOUD_HOST":
                    return model.MacsManagedCloudHostInsightSummary.getJsonObj(jsonObj, true);
                default:
    ...
    function getDeserializedJsonObj(obj) {
        ...
        if (obj && "entitySource" in obj && obj.entitySource) {
            switch (obj.entitySource) {
                ...
                case "PE_COMANAGED_HOST":
                    return model.PeComanagedHostInsightSummary.getDeserializedJsonObj(jsonObj, true);
                case "MACS_MANAGED_CLOUD_HOST":
                    return model.MacsManagedCloudHostInsightSummary.getDeserializedJsonObj(jsonObj, true);
                default:
                    if (common.LOG.logger)
                        common.LOG.logger.info(`Unknown value for: ${obj.entitySource}`);
            }
    ...
    HostInsightSummary.getDeserializedJsonObj = getDeserializedJsonObj;
})(HostInsightSummary = exports.HostInsightSummary || (exports.HostInsightSummary = {}));
//# sourceMappingURL=host-insight-summary.js.map
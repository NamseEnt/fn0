...
export declare namespace EmManagedExternalHostInsightSummary {
    enum PlatformType {
        Linux = "LINUX",
        Solaris = "SOLARIS",
        Sunos = "SUNOS",
    ...
    function getJsonObj(obj: EmManagedExternalHostInsightSummary, isParentJsonObj?: boolean): object;
    const entitySource = "EM_MANAGED_EXTERNAL_HOST";
    function getDeserializedJsonObj(obj: EmManagedExternalHostInsightSummary, isParentJsonObj?: boolean): object;
}

...
export declare namespace AddmDbSchemaObjectSummary {
    function getJsonObj(obj: AddmDbSchemaObjectSummary): object;
    function getDeserializedJsonObj(obj: AddmDbSchemaObjectSummary): object;
}

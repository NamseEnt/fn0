...
export declare namespace SummarizeDatabaseInsightResourceForecastTrendAggregation {
    enum ResourceMetric {
        Cpu = "CPU",
        Storage = "STORAGE",
        Io = "IO",
    ...
    function getJsonObj(obj: SummarizeDatabaseInsightResourceForecastTrendAggregation): object;
    function getDeserializedJsonObj(obj: SummarizeDatabaseInsightResourceForecastTrendAggregation): object;
}

...
export declare namespace CreatePlanCustomItemDetails {
    function getJsonObj(obj: CreatePlanCustomItemDetails): object;
    function getDeserializedJsonObj(obj: CreatePlanCustomItemDetails): object;
}

...
export declare namespace SqlPlanCollection {
    function getJsonObj(obj: SqlPlanCollection): object;
    function getDeserializedJsonObj(obj: SqlPlanCollection): object;
}

...
export declare namespace AwrDatabaseWaitEventBucketSummary {
    function getJsonObj(obj: AwrDatabaseWaitEventBucketSummary): object;
    function getDeserializedJsonObj(obj: AwrDatabaseWaitEventBucketSummary): object;
}

 ...
 **/
export declare enum DatabaseEntitySourceAll {
...
export declare namespace DatabaseEntitySourceAll {
    function getJsonObj(obj: DatabaseEntitySourceAll): DatabaseEntitySourceAll;
    function getDeserializedJsonObj(obj: DatabaseEntitySourceAll): DatabaseEntitySourceAll;
}

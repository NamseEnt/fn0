...
export declare namespace HostCpuStatistics {
    function getJsonObj(obj: HostCpuStatistics, isParentJsonObj?: boolean): object;
    const resourceName = "HOST_CPU_STATISTICS";
    function getDeserializedJsonObj(obj: HostCpuStatistics, isParentJsonObj?: boolean): object;
}

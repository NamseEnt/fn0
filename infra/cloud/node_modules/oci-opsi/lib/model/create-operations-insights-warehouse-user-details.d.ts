 ...
 */
export interface CreateOperationsInsightsWarehouseUserDetails {
    /**
     * OPSI Warehouse OCID
     */
...
export declare namespace CreateOperationsInsightsWarehouseUserDetails {
    function getJsonObj(obj: CreateOperationsInsightsWarehouseUserDetails): object;
    function getDeserializedJsonObj(obj: CreateOperationsInsightsWarehouseUserDetails): object;
}

...
export declare namespace ExadataInsightSummary {
    function getJsonObj(obj: ExadataInsightSummary): object;
    function getDeserializedJsonObj(obj: ExadataInsightSummary): object;
}

 ...
 */
export interface ChargebackPlan {
    /**
...
export declare namespace ChargebackPlan {
    function getJsonObj(obj: ChargebackPlan): object;
    function getDeserializedJsonObj(obj: ChargebackPlan): object;
}

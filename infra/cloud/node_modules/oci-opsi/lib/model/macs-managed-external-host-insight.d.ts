 ...
 */
export interface MacsManagedExternalHostInsight extends model.HostInsight {
    /**
...
export declare namespace MacsManagedExternalHostInsight {
    enum PlatformType {
        Linux = "LINUX",
        Solaris = "SOLARIS",
        Sunos = "SUNOS",
    ...
    function getJsonObj(obj: MacsManagedExternalHostInsight, isParentJsonObj?: boolean): object;
    const entitySource = "MACS_MANAGED_EXTERNAL_HOST";
    function getDeserializedJsonObj(obj: MacsManagedExternalHostInsight, isParentJsonObj?: boolean): object;
}

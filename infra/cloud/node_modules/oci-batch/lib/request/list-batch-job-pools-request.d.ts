...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/batch/ListBatchJobPools.ts.html |here} to see how to use ListBatchJobPoolsRequest.
 */
export interface ListBatchJobPoolsRequest extends common.BaseRequest {
    /**

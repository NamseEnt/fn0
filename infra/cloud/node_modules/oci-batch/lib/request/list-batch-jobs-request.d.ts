...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/batch/ListBatchJobs.ts.html |here} to see how to use ListBatchJobsRequest.
 */
export interface ListBatchJobsRequest extends common.BaseRequest {
    /**

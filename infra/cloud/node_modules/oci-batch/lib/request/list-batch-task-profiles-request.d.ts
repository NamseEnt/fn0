...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/batch/ListBatchTaskProfiles.ts.html |here} to see how to use ListBatchTaskProfilesRequest.
 */
export interface ListBatchTaskProfilesRequest extends common.BaseRequest {
    /**

 ...
 */
export interface CreateComputeTaskDetails extends model.CreateBatchTaskDetails {
    /**
...
export declare namespace CreateComputeTaskDetails {
    function getJsonObj(obj: CreateComputeTaskDetails, isParentJsonObj?: boolean): object;
    const type = "COMPUTE";
    function getDeserializedJsonObj(obj: CreateComputeTaskDetails, isParentJsonObj?: boolean): object;
}

...
export interface BatchJobPool {
  ...
  *
     ...
     *
     */
    "lifecycleState": BatchJobPool.LifecycleState;
    /**
...
export declare namespace BatchJobPool {
    enum LifecycleState {
        Active = "ACTIVE",
        Inactive = "INACTIVE",
        Updating = "UPDATING",
    ...
    function getJsonObj(obj: BatchJobPool): object;
    function getDeserializedJsonObj(obj: BatchJobPool): object;
}

 ...
 */
export interface BatchJobPoolSummary {
    /**
...
export declare namespace BatchJobPoolSummary {
    function getJsonObj(obj: BatchJobPoolSummary): object;
    function getDeserializedJsonObj(obj: BatchJobPoolSummary): object;
}

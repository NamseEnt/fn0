...
export declare namespace CreateBatchTaskEnvironmentDetails {
    function getJsonObj(obj: CreateBatchTaskEnvironmentDetails): object;
    function getDeserializedJsonObj(obj: CreateBatchTaskEnvironmentDetails): object;
}

 ...
 */
export interface BatchContextSummary {
    /**
...
export declare namespace BatchContextSummary {
    function getJsonObj(obj: BatchContextSummary): object;
    function getDeserializedJsonObj(obj: BatchContextSummary): object;
}

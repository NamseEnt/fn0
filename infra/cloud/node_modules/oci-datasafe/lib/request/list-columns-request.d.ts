...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/datasafe/ListColumns.ts.html |here} to see how to use ListColumnsRequest.
 */
...
export declare namespace ListColumnsRequest {
    enum SortOrder {
        Asc = "ASC",
        Desc = "DESC"
    }

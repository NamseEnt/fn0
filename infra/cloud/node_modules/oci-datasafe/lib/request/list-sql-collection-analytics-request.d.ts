...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/datasafe/ListSqlCollectionAnalytics.ts.html |here} to see how to use ListSqlCollectionAnalyticsRequest.
 */
...
export declare namespace ListSqlCollectionAnalyticsRequest {
    enum AccessLevel {

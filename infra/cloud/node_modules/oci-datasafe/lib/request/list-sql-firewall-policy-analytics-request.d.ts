...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/datasafe/ListSqlFirewallPolicyAnalytics.ts.html |here} to see how to use ListSqlFirewallPolicyAnalyticsRequest.
 */
export interface ListSqlFirewallPolicyAnalyticsRequest extends common.BaseRequest {
    /**
...
export declare namespace ListSqlFirewallPolicyAnalyticsRequest {
    enum AccessLevel {

...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/datasafe/ListUserAssessments.ts.html |here} to see how to use ListUserAssessmentsRequest.
 */
...
export declare namespace ListUserAssessmentsRequest {
    enum AccessLevel {

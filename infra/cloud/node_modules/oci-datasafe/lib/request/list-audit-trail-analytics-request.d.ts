...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/datasafe/ListAuditTrailAnalytics.ts.html |here} to see how to use ListAuditTrailAnalyticsRequest.
 */
...
export declare namespace ListAuditTrailAnalyticsRequest {
    enum AccessLevel {

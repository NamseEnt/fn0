...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/datasafe/ListTemplateAnalytics.ts.html |here} to see how to use ListTemplateAnalyticsRequest.
 */
export interface ListTemplateAnalyticsRequest extends common.BaseRequest {
    /**
...
export declare namespace ListTemplateAnalyticsRequest {
    enum AccessLevel {

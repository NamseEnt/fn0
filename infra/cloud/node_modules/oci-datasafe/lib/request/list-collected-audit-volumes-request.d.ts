...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/datasafe/ListCollectedAuditVolumes.ts.html |here} to see how to use ListCollectedAuditVolumesRequest.
 */
...
export declare namespace ListCollectedAuditVolumesRequest {
    enum SortOrder {
        Asc = "ASC",
        Desc = "DESC"
    }

...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/datasafe/ListSqlCollectionLogInsights.ts.html |here} to see how to use ListSqlCollectionLogInsightsRequest.
 */
...
export declare namespace ListSqlCollectionLogInsightsRequest {
    enum GroupBy {
        ClientIp = "clientIp",

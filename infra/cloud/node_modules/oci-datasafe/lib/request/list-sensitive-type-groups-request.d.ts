...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/datasafe/ListSensitiveTypeGroups.ts.html |here} to see how to use ListSensitiveTypeGroupsRequest.
 */
export interface ListSensitiveTypeGroupsRequest extends common.BaseRequest {
    /**
...
export declare namespace ListSensitiveTypeGroupsRequest {
    enum AccessLevel {

...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/datasafe/ListSensitiveColumns.ts.html |here} to see how to use ListSensitiveColumnsRequest.
 */
...
export declare namespace ListSensitiveColumnsRequest {
    enum ColumnDataCountFilter {

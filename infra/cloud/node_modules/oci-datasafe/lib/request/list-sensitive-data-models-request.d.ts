...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/datasafe/ListSensitiveDataModels.ts.html |here} to see how to use ListSensitiveDataModelsRequest.
 */
export interface ListSensitiveDataModelsRequest extends common.BaseRequest {
    /**
...
export declare namespace ListSensitiveDataModelsRequest {
    enum AccessLevel {

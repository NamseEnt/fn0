...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/datasafe/ListAuditProfileAnalytics.ts.html |here} to see how to use ListAuditProfileAnalyticsRequest.
 */
export interface ListAuditProfileAnalyticsRequest extends common.BaseRequest {
    /**
...
export declare namespace ListAuditProfileAnalyticsRequest {
    enum AccessLevel {

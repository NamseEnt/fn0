...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/datasafe/ListSqlFirewallViolations.ts.html |here} to see how to use ListSqlFirewallViolationsRequest.
 */
...
export declare namespace ListSqlFirewallViolationsRequest {
    enum AccessLevel {

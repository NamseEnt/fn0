...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/datasafe/ListSqlFirewallPolicies.ts.html |here} to see how to use ListSqlFirewallPoliciesRequest.
 */
...
export declare namespace ListSqlFirewallPoliciesRequest {
    enum AccessLevel {

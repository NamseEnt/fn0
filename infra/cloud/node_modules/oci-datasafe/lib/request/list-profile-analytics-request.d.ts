...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/datasafe/ListProfileAnalytics.ts.html |here} to see how to use ListProfileAnalyticsRequest.
 */
...
export declare namespace ListProfileAnalyticsRequest {
    enum AccessLevel {

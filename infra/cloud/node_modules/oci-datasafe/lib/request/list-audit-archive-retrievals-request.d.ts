...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/datasafe/ListAuditArchiveRetrievals.ts.html |here} to see how to use ListAuditArchiveRetrievalsRequest.
 */
...
export declare namespace ListAuditArchiveRetrievalsRequest {
    enum AccessLevel {

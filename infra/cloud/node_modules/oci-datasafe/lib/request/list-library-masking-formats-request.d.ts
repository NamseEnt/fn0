...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/datasafe/ListLibraryMaskingFormats.ts.html |here} to see how to use ListLibraryMaskingFormatsRequest.
 */
export interface ListLibraryMaskingFormatsRequest extends common.BaseRequest {
    /**
     ...
     */
    "libraryMaskingFormatSource"?: model.LibraryMaskingFormatSource;
    /**
...
export declare namespace ListLibraryMaskingFormatsRequest {
    enum AccessLevel {

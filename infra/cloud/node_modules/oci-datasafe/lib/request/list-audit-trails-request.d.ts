...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/datasafe/ListAuditTrails.ts.html |here} to see how to use ListAuditTrailsRequest.
 */
export interface ListAuditTrailsRequest extends common.BaseRequest {
    /**
...
export declare namespace ListAuditTrailsRequest {
    enum AccessLevel {

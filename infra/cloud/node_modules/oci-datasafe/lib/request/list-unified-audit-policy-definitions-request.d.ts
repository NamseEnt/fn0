...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/datasafe/ListUnifiedAuditPolicyDefinitions.ts.html |here} to see how to use ListUnifiedAuditPolicyDefinitionsRequest.
 */
export interface ListUnifiedAuditPolicyDefinitionsRequest extends common.BaseRequest {
    /**
...
export declare namespace ListUnifiedAuditPolicyDefinitionsRequest {
    enum AccessLevel {

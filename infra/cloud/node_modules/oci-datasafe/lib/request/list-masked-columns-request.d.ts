...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/datasafe/ListMaskedColumns.ts.html |here} to see how to use ListMaskedColumnsRequest.
 */
...
export declare namespace ListMaskedColumnsRequest {
    enum SortOrder {
        Asc = "ASC",
        Desc = "DESC"
    }

...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/datasafe/AlertsUpdate.ts.html |here} to see how to use AlertsUpdateRequest.
 */
...
export declare namespace AlertsUpdateRequest {
    enum AccessLevel {

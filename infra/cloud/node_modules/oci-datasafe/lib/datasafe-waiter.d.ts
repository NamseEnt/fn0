...
export declare class DataSafeWaiter {
     ...
     */
    forAttributeSet(request: serviceRequests.GetAttributeSetRequest, ...targetStates: models.AttributeSet.LifecycleState[]): Promise<serviceResponses.GetAttributeSetResponse>;
    /**
     ...
     */
    forOnPremConnector(request: serviceRequests.GetOnPremConnectorRequest, ...targetStates: models.OnPremConnectorLifecycleState[]): Promise<serviceResponses.GetOnPremConnectorResponse | null>;
    /**
     ...
     */
    forSecurityAssessmentComparison(request: serviceRequests.GetSecurityAssessmentComparisonRequest, ...targetStates: models.SecurityAssessmentComparison.LifecycleState[]): Promise<serviceResponses.GetSecurityAssessmentComparisonResponse | null>;
    /**
     ...
     */
    forSecurityPolicyConfig(request: serviceRequests.GetSecurityPolicyConfigRequest, ...targetStates: models.SecurityPolicyConfigLifecycleState[]): Promise<serviceResponses.GetSecurityPolicyConfigResponse | null>;
    /**
     ...
     */
    forTargetDatabaseGroup(request: serviceRequests.GetTargetDatabaseGroupRequest, ...targetStates: models.TargetDatabaseGroupLifecycleState[]): Promise<serviceResponses.GetTargetDatabaseGroupResponse | null>;
    /**
     ...
     */
    forUnifiedAuditPolicy(request: serviceRequests.GetUnifiedAuditPolicyRequest, ...targetStates: models.UnifiedAuditPolicyLifecycleState[]): Promise<serviceResponses.GetUnifiedAuditPolicyResponse | null>;
    /**
     ...
     */
    forUnifiedAuditPolicyDefinition(request: serviceRequests.GetUnifiedAuditPolicyDefinitionRequest, ...targetStates: models.UnifiedAuditPolicyDefinitionLifecycleState[]): Promise<serviceResponses.GetUnifiedAuditPolicyDefinitionResponse>;
    /**

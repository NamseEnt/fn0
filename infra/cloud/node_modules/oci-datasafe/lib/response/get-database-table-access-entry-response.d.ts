...
export interface GetDatabaseTableAccessEntryResponse {
    /**
    ...
    "opcRequestId": string;
    /**
     * The returned model.DatabaseTableAccessEntry instance.
     */
    "databaseTableAccessEntry": model.DatabaseTableAccessEntry;
}

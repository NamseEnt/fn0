...
export interface CreateSecurityPolicyDeploymentResponse {
    /**
    ...
    "location": string;
    /**
     * The returned model.SecurityPolicyDeployment instance.
     */
    "securityPolicyDeployment": model.SecurityPolicyDeployment;
}

...
export interface GetMaskingPolicyHealthReportResponse {
    /**
    ...
    "opcRequestId": string;
    /**
     * The returned model.MaskingPolicyHealthReport instance.
     */
    "maskingPolicyHealthReport": model.MaskingPolicyHealthReport;
}

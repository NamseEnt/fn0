...
export interface GetDatabaseViewAccessEntryResponse {
    /**
    ...
    "opcRequestId": string;
    /**
     * The returned model.DatabaseViewAccessEntry instance.
     */
    "databaseViewAccessEntry": model.DatabaseViewAccessEntry;
}

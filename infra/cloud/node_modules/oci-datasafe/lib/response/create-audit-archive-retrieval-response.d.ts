...
export interface CreateAuditArchiveRetrievalResponse {
    /**
    ...
    "opcRequestId": string;
    /**
     * The returned model.AuditArchiveRetrieval instance.
     */
    "auditArchiveRetrieval": model.AuditArchiveRetrieval;
}

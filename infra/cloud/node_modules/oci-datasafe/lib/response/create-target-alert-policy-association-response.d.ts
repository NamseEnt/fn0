...
export interface CreateTargetAlertPolicyAssociationResponse {
    /**
    ...
    "location": string;
    /**
     * The returned model.TargetAlertPolicyAssociation instance.
     */
    "targetAlertPolicyAssociation": model.TargetAlertPolicyAssociation;
}

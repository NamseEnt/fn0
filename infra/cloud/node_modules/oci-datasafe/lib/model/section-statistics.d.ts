...
export declare namespace SectionStatistics {
    function getJsonObj(obj: SectionStatistics): object;
    function getDeserializedJsonObj(obj: SectionStatistics): object;
}

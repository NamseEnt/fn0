...
export declare namespace AuditTrailSummary {
    function getJsonObj(obj: AuditTrailSummary): object;
    function getDeserializedJsonObj(obj: AuditTrailSummary): object;
}

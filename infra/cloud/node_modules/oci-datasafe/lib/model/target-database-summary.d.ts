 ...
 */
export interface TargetDatabaseSummary {
    /**
...
export declare namespace TargetDatabaseSummary {
    function getJsonObj(obj: TargetDatabaseSummary): object;
    function getDeserializedJsonObj(obj: TargetDatabaseSummary): object;
}

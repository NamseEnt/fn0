...
export declare namespace AuditTrailDimensions {
    function getJsonObj(obj: AuditTrailDimensions): object;
    function getDeserializedJsonObj(obj: AuditTrailDimensions): object;
}

...
export declare namespace MaskingPolicySummary {
    function getJsonObj(obj: MaskingPolicySummary): object;
    function getDeserializedJsonObj(obj: MaskingPolicySummary): object;
}

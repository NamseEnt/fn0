...
export declare namespace DatabaseViewAccessEntry {
    function getJsonObj(obj: DatabaseViewAccessEntry): object;
    function getDeserializedJsonObj(obj: DatabaseViewAccessEntry): object;
}

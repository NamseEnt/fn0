...
export declare namespace SecurityPolicyDeployment {
    enum TargetType {
    ...
    function getJsonObj(obj: SecurityPolicyDeployment): object;
    function getDeserializedJsonObj(obj: SecurityPolicyDeployment): object;
}

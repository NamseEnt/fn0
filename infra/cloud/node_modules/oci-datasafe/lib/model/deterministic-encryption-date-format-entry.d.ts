...
export declare namespace DeterministicEncryptionDateFormatEntry {
    function getJsonObj(obj: DeterministicEncryptionDateFormatEntry, isParentJsonObj?: boolean): object;
    const type = "DETERMINISTIC_ENCRYPTION_DATE";

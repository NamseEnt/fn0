 ...
 */
export interface AuditConditions {
    /**
...
export declare namespace AuditConditions {
    function getJsonObj(obj: AuditConditions): object;
    function getDeserializedJsonObj(obj: AuditConditions): object;
}

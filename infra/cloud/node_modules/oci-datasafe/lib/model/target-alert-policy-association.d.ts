...
export declare namespace TargetAlertPolicyAssociation {
    function getJsonObj(obj: TargetAlertPolicyAssociation): object;
    function getDeserializedJsonObj(obj: TargetAlertPolicyAssociation): object;
}

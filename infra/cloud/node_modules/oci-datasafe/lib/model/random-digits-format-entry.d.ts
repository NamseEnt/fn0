...
export declare namespace RandomDigitsFormatEntry {
    function getJsonObj(obj: RandomDigitsFormatEntry, isParentJsonObj?: boolean): object;
    const type = "RANDOM_DIGITS";
    function getDeserializedJsonObj(obj: RandomDigitsFormatEntry, isParentJsonObj?: boolean): object;
}

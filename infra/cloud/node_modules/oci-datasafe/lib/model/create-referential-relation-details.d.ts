 ...
 *
 */
export interface CreateReferentialRelationDetails {
    /**
     ...
     *
     */
    "relationType": CreateReferentialRelationDetails.RelationType;
...
export declare namespace CreateReferentialRelationDetails {
    enum RelationType {
        AppDefined = "APP_DEFINED",
        DbDefined = "DB_DEFINED"
    }
    function getJsonObj(obj: CreateReferentialRelationDetails): object;
    function getDeserializedJsonObj(obj: CreateReferentialRelationDetails): object;
}

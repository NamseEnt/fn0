...
export declare namespace SqlCollectionSummary {
    enum Status {
        Enabled = "ENABLED",
        Disabled = "DISABLED",
        /**
    ...
    function getJsonObj(obj: SqlCollectionSummary): object;
    function getDeserializedJsonObj(obj: SqlCollectionSummary): object;
}

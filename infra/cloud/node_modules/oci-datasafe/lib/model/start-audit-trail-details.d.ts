...
export declare namespace StartAuditTrailDetails {
    function getJsonObj(obj: StartAuditTrailDetails): object;
    function getDeserializedJsonObj(obj: StartAuditTrailDetails): object;
}

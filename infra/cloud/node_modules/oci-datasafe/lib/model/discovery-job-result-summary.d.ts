...
export declare namespace DiscoveryJobResultSummary {
    enum ObjectType {
        Table = "TABLE",
    ...
    function getJsonObj(obj: DiscoveryJobResultSummary): object;
    function getDeserializedJsonObj(obj: DiscoveryJobResultSummary): object;
}

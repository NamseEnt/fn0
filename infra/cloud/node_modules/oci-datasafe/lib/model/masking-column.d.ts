 ...
 *
 */
export interface MaskingColumn {
    /**
...
export declare namespace MaskingColumn {
    function getJsonObj(obj: MaskingColumn): object;
    function getDeserializedJsonObj(obj: MaskingColumn): object;
}

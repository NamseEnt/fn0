 ...
 */
export interface MaskingObjectSummary {
    /**
...
export declare namespace MaskingObjectSummary {
    function getJsonObj(obj: MaskingObjectSummary): object;
    function getDeserializedJsonObj(obj: MaskingObjectSummary): object;
}

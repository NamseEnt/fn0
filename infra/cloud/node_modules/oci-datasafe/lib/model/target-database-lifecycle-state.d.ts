 ...
 *
 **/
export declare enum TargetDatabaseLifecycleState {
    Creating = "CREATING",
    Updating = "UPDATING",
    Active = "ACTIVE",
    Inactive = "INACTIVE",
...
export declare namespace TargetDatabaseLifecycleState {
    function getJsonObj(obj: TargetDatabaseLifecycleState): TargetDatabaseLifecycleState;
    function getDeserializedJsonObj(obj: TargetDatabaseLifecycleState): TargetDatabaseLifecycleState;
}

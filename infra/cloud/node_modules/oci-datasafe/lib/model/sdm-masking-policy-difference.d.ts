...
export declare namespace SdmMaskingPolicyDifference {
    enum DifferenceType {
        All = "ALL",
        New = "NEW",
        Modified = "MODIFIED",
    ...
    function getJsonObj(obj: SdmMaskingPolicyDifference): object;
    function getDeserializedJsonObj(obj: SdmMaskingPolicyDifference): object;
}

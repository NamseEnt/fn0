...
export declare namespace SqlFirewallAllowedSql {
    enum SqlLevel {
    ...
    function getJsonObj(obj: SqlFirewallAllowedSql): object;
    function getDeserializedJsonObj(obj: SqlFirewallAllowedSql): object;
}

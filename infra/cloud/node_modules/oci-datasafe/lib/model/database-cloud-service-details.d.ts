...
export declare namespace DatabaseCloudServiceDetails {
    function getJsonObj(obj: DatabaseCloudServiceDetails, isParentJsonObj?: boolean): object;
    const databaseType = "DATABASE_CLOUD_SERVICE";
    function getDeserializedJsonObj(obj: DatabaseCloudServiceDetails, isParentJsonObj?: boolean): object;
}

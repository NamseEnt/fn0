...
export declare namespace CalculateAuditVolumeAvailableDetails {
    function getJsonObj(obj: CalculateAuditVolumeAvailableDetails): object;
    function getDeserializedJsonObj(obj: CalculateAuditVolumeAvailableDetails): object;
}

...
export declare namespace SensitiveColumnSummary {
    enum ObjectType {
        Table = "TABLE",
    ...
    function getJsonObj(obj: SensitiveColumnSummary): object;
    function getDeserializedJsonObj(obj: SensitiveColumnSummary): object;
}

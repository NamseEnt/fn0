...
export declare namespace CreateSecurityAssessmentDetails {
    enum Type {
        Latest = "LATEST",
        Saved = "SAVED",
    ...
    function getJsonObj(obj: CreateSecurityAssessmentDetails): object;
    function getDeserializedJsonObj(obj: CreateSecurityAssessmentDetails): object;
}

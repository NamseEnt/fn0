...
export interface SqlCollection {
     ...
     *
     */
    "sqlLevel"?: SqlCollection.SqlLevel;
    /**
...
export declare namespace SqlCollection {
    enum Status {
        Enabled = "ENABLED",
        Disabled = "DISABLED",
        /**
    ...
    function getJsonObj(obj: SqlCollection): object;
    function getDeserializedJsonObj(obj: SqlCollection): object;
}

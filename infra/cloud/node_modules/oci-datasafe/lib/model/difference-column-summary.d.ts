...
export declare namespace DifferenceColumnSummary {
    function getJsonObj(obj: DifferenceColumnSummary): object;
    function getDeserializedJsonObj(obj: DifferenceColumnSummary): object;
}

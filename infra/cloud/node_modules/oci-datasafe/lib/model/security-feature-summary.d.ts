...
export declare namespace SecurityFeatureSummary {
    enum UnifiedAudit {
        Enabled = "ENABLED",
        Disabled = "DISABLED",
        None = "NONE",
    ...
    function getJsonObj(obj: SecurityFeatureSummary): object;
    function getDeserializedJsonObj(obj: SecurityFeatureSummary): object;
}

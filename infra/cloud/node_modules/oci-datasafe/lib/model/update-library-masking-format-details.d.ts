...
export declare namespace UpdateLibraryMaskingFormatDetails {
    function getJsonObj(obj: UpdateLibraryMaskingFormatDetails): object;
    function getDeserializedJsonObj(obj: UpdateLibraryMaskingFormatDetails): object;
}

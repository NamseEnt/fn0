...
export declare namespace SqlFirewallConfig {
    enum Status {
        Enabled = "ENABLED",
        Disabled = "DISABLED",
        /**
    ...
    function getJsonObj(obj: SqlFirewallConfig): object;
    function getDeserializedJsonObj(obj: SqlFirewallConfig): object;
}

...
export declare namespace CreateLibraryMaskingFormatDetails {
    function getJsonObj(obj: CreateLibraryMaskingFormatDetails): object;
    function getDeserializedJsonObj(obj: CreateLibraryMaskingFormatDetails): object;
}

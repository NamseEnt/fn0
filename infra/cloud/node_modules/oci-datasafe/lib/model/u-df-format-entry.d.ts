...
export declare namespace UDFFormatEntry {
    function getJsonObj(obj: UDFFormatEntry, isParentJsonObj?: boolean): object;
    const type = "USER_DEFINED_FUNCTION";
    function getDeserializedJsonObj(obj: UDFFormatEntry, isParentJsonObj?: boolean): object;
}

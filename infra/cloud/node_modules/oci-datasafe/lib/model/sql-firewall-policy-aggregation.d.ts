...
export declare namespace SqlFirewallPolicyAggregation {
    function getJsonObj(obj: SqlFirewallPolicyAggregation): object;
    function getDeserializedJsonObj(obj: SqlFirewallPolicyAggregation): object;
}

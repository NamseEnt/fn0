...
export declare namespace CreateOnPremConnectorDetails {
    function getJsonObj(obj: CreateOnPremConnectorDetails): object;
    function getDeserializedJsonObj(obj: CreateOnPremConnectorDetails): object;
}

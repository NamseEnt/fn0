...
export declare namespace FindingsChangeAuditLogSummary {
    function getJsonObj(obj: FindingsChangeAuditLogSummary): object;
    function getDeserializedJsonObj(obj: FindingsChangeAuditLogSummary): object;
}

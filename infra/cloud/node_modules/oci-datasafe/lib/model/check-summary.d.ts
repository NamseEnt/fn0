...
export interface CheckSummary {
     ...
     */
    "suggestedSeverity"?: CheckSummary.SuggestedSeverity;
}
export declare namespace CheckSummary {
    enum SuggestedSeverity {
        High = "HIGH",
        Medium = "MEDIUM",
        Low = "LOW",
        Evaluate = "EVALUATE",
    ...
    function getJsonObj(obj: CheckSummary): object;
    function getDeserializedJsonObj(obj: CheckSummary): object;
}

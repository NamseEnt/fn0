 ...
 *
 **/
export declare enum TargetDatabaseGroupLifecycleState {
    Creating = "CREATING",
    Updating = "UPDATING",
    Active = "ACTIVE",
    Deleting = "DELETING",
...
export declare namespace TargetDatabaseGroupLifecycleState {
    function getJsonObj(obj: TargetDatabaseGroupLifecycleState): TargetDatabaseGroupLifecycleState;
    function getDeserializedJsonObj(obj: TargetDatabaseGroupLifecycleState): TargetDatabaseGroupLifecycleState;
}

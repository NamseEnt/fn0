...
export declare namespace ProfileAggregation {
    function getJsonObj(obj: ProfileAggregation): object;
    function getDeserializedJsonObj(obj: ProfileAggregation): object;
}

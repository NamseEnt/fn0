...
export declare namespace SecurityAssessmentComparison {
    enum LifecycleState {
        Creating = "CREATING",
        Succeeded = "SUCCEEDED",
        Failed = "FAILED",
    ...
    function getJsonObj(obj: SecurityAssessmentComparison): object;
    function getDeserializedJsonObj(obj: SecurityAssessmentComparison): object;
}

...
export declare namespace SensitiveTypesExport {
    function getJsonObj(obj: SensitiveTypesExport): object;
    function getDeserializedJsonObj(obj: SensitiveTypesExport): object;
}

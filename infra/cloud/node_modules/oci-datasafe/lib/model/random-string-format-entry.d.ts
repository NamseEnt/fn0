...
export declare namespace RandomStringFormatEntry {
    function getJsonObj(obj: RandomStringFormatEntry, isParentJsonObj?: boolean): object;
    const type = "RANDOM_STRING";
    function getDeserializedJsonObj(obj: RandomStringFormatEntry, isParentJsonObj?: boolean): object;
}

...
export declare namespace TargetAlertPolicyAssociationSummary {
    function getJsonObj(obj: TargetAlertPolicyAssociationSummary): object;
    function getDeserializedJsonObj(obj: TargetAlertPolicyAssociationSummary): object;
}

...
export declare namespace GenerateReportDetails {
    enum MimeType {
        Pdf = "PDF",
        Xls = "XLS",
        Json = "JSON"
    }
    function getJsonObj(obj: GenerateReportDetails): object;
    function getDeserializedJsonObj(obj: GenerateReportDetails): object;
}

...
export declare namespace DatabaseSecurityConfig {
    function getJsonObj(obj: DatabaseSecurityConfig): object;
    function getDeserializedJsonObj(obj: DatabaseSecurityConfig): object;
}

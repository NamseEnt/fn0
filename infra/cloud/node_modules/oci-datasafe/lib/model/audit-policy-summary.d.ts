...
export declare namespace AuditPolicySummary {
    function getJsonObj(obj: AuditPolicySummary): object;
    function getDeserializedJsonObj(obj: AuditPolicySummary): object;
}

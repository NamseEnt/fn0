...
export declare namespace UpdateTargetAlertPolicyAssociationDetails {
    function getJsonObj(obj: UpdateTargetAlertPolicyAssociationDetails): object;
    function getDeserializedJsonObj(obj: UpdateTargetAlertPolicyAssociationDetails): object;
}

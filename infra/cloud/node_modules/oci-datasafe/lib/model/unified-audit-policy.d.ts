...
export declare namespace UnifiedAuditPolicy {
    enum Status {
        Enabled = "ENABLED",
        Disabled = "DISABLED",
        /**
    ...
    function getJsonObj(obj: UnifiedAuditPolicy): object;
    function getDeserializedJsonObj(obj: UnifiedAuditPolicy): object;
}

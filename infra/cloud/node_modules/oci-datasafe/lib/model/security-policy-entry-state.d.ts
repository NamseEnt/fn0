...
export declare namespace SecurityPolicyEntryState {
    enum EntryType {
    ...
    function getJsonObj(obj: SecurityPolicyEntryState): object;
    function getDeserializedJsonObj(obj: SecurityPolicyEntryState): object;
}

...
export declare namespace UnifiedAuditPolicySummary {
    function getJsonObj(obj: UnifiedAuditPolicySummary): object;
    function getDeserializedJsonObj(obj: UnifiedAuditPolicySummary): object;
}

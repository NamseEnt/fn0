...
export declare namespace BulkCreateUnifiedAuditPolicyDetails {
    function getJsonObj(obj: BulkCreateUnifiedAuditPolicyDetails): object;
    function getDeserializedJsonObj(obj: BulkCreateUnifiedAuditPolicyDetails): object;
}

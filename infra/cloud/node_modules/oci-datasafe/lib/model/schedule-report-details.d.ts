...
export declare namespace ScheduleReportDetails {
    enum MimeType {
        Pdf = "PDF",
        Xls = "XLS",
        Json = "JSON"
    }
    function getJsonObj(obj: ScheduleReportDetails): object;
    function getDeserializedJsonObj(obj: ScheduleReportDetails): object;
}

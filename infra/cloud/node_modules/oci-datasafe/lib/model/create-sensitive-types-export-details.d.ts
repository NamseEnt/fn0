...
export declare namespace CreateSensitiveTypesExportDetails {
    function getJsonObj(obj: CreateSensitiveTypesExportDetails): object;
    function getDeserializedJsonObj(obj: CreateSensitiveTypesExportDetails): object;
}

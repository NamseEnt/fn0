...
export declare namespace TemplateAnalyticsDimensions {
    function getJsonObj(obj: TemplateAnalyticsDimensions): object;
    function getDeserializedJsonObj(obj: TemplateAnalyticsDimensions): object;
}

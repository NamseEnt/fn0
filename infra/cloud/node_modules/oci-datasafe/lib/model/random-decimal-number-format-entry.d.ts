 ...
 *
 */
export interface RandomDecimalNumberFormatEntry extends model.FormatEntry {
    /**
...
export declare namespace RandomDecimalNumberFormatEntry {
    function getJsonObj(obj: RandomDecimalNumberFormatEntry, isParentJsonObj?: boolean): object;
    const type = "RANDOM_DECIMAL_NUMBER";
    function getDeserializedJsonObj(obj: RandomDecimalNumberFormatEntry, isParentJsonObj?: boolean): object;
}

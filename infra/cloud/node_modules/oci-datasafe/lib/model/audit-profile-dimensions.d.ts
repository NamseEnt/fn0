...
export declare namespace AuditProfileDimensions {
    function getJsonObj(obj: AuditProfileDimensions): object;
    function getDeserializedJsonObj(obj: AuditProfileDimensions): object;
}

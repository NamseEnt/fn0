...
export declare namespace PreserveOriginalDataFormatEntry {
    function getJsonObj(obj: PreserveOriginalDataFormatEntry, isParentJsonObj?: boolean): object;
    const type = "PRESERVE_ORIGINAL_DATA";
    function getDeserializedJsonObj(obj: PreserveOriginalDataFormatEntry, isParentJsonObj?: boolean): object;
}

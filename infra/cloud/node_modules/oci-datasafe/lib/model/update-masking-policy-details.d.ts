...
export declare namespace UpdateMaskingPolicyDetails {
    function getJsonObj(obj: UpdateMaskingPolicyDetails): object;
    function getDeserializedJsonObj(obj: UpdateMaskingPolicyDetails): object;
}

 ...
 **/
export declare enum AuditPolicyCategory {
...
export declare namespace AuditPolicyCategory {
    function getJsonObj(obj: AuditPolicyCategory): AuditPolicyCategory;
    function getDeserializedJsonObj(obj: AuditPolicyCategory): AuditPolicyCategory;
}

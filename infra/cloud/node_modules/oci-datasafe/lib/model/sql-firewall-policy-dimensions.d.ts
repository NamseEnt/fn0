...
export declare namespace SqlFirewallPolicyDimensions {
    ...
    function getJsonObj(obj: SqlFirewallPolicyDimensions): object;
    function getDeserializedJsonObj(obj: SqlFirewallPolicyDimensions): object;
}

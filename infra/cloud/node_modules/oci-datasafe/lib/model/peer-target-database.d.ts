...
export declare namespace PeerTargetDatabase {
    function getJsonObj(obj: PeerTargetDatabase): object;
    function getDeserializedJsonObj(obj: PeerTargetDatabase): object;
}

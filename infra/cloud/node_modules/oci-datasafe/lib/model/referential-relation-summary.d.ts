...
export declare namespace ReferentialRelationSummary {
    enum RelationType {
        None = "NONE",
    ...
    function getJsonObj(obj: ReferentialRelationSummary): object;
    function getDeserializedJsonObj(obj: ReferentialRelationSummary): object;
}

...
export declare namespace ShuffleFormatEntry {
    function getJsonObj(obj: ShuffleFormatEntry, isParentJsonObj?: boolean): object;
    const type = "SHUFFLE";
    function getDeserializedJsonObj(obj: ShuffleFormatEntry, isParentJsonObj?: boolean): object;
}

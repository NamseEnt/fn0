...
export declare namespace RoleGrantPathSummary {
    function getJsonObj(obj: RoleGrantPathSummary): object;
    function getDeserializedJsonObj(obj: RoleGrantPathSummary): object;
}

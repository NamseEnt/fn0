...
export interface AttributeSetSummary {
     ...
     */
    "inUse"?: AttributeSetSummary.InUse;
    /**
...
export declare namespace AttributeSetSummary {
    enum InUse {
        Yes = "YES",
        No = "NO",
        /**
    ...
    function getJsonObj(obj: AttributeSetSummary): object;
    function getDeserializedJsonObj(obj: AttributeSetSummary): object;
}

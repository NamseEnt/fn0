...
export declare namespace SQLExpressionFormatEntry {
    function getJsonObj(obj: SQLExpressionFormatEntry, isParentJsonObj?: boolean): object;
    const type = "SQL_EXPRESSION";
    function getDeserializedJsonObj(obj: SQLExpressionFormatEntry, isParentJsonObj?: boolean): object;
}

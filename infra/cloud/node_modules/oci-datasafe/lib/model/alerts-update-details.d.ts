...
export declare namespace AlertsUpdateDetails {
    function getJsonObj(obj: AlertsUpdateDetails): object;
    function getDeserializedJsonObj(obj: AlertsUpdateDetails): object;
}

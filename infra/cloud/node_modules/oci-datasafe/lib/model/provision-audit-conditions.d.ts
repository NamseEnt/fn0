 ...
 */
export interface ProvisionAuditConditions {
    /**
     ...
     *
     */
    "enableConditions"?: Array<model.EnableConditions>;
}
export declare namespace ProvisionAuditConditions {
    function getJsonObj(obj: ProvisionAuditConditions): object;
    function getDeserializedJsonObj(obj: ProvisionAuditConditions): object;
}

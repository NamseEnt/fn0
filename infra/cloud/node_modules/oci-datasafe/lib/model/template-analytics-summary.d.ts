...
export interface TemplateAnalyticsSummary {
     ...
     */
    "metricName": TemplateAnalyticsSummary.MetricName;
    "dimensions"?: model.TemplateAnalyticsDimensions;
    /**
...
export declare namespace TemplateAnalyticsSummary {
    enum MetricName {
    ...
    function getJsonObj(obj: TemplateAnalyticsSummary): object;
    function getDeserializedJsonObj(obj: TemplateAnalyticsSummary): object;
}

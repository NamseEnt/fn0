...
export declare namespace ScheduleAuditReportDetails {
    function getJsonObj(obj: ScheduleAuditReportDetails, isParentJsonObj?: boolean): object;
    const reportType = "AUDIT";
    function getDeserializedJsonObj(obj: ScheduleAuditReportDetails, isParentJsonObj?: boolean): object;
}

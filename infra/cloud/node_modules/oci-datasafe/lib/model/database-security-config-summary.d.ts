 ...
 *
 */
export interface DatabaseSecurityConfigSummary {
    /**
...
export declare namespace DatabaseSecurityConfigSummary {
    function getJsonObj(obj: DatabaseSecurityConfigSummary): object;
    function getDeserializedJsonObj(obj: DatabaseSecurityConfigSummary): object;
}

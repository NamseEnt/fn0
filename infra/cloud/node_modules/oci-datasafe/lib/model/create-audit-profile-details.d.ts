...
export declare namespace CreateAuditProfileDetails {
    function getJsonObj(obj: CreateAuditProfileDetails): object;
    function getDeserializedJsonObj(obj: CreateAuditProfileDetails): object;
}

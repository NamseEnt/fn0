...
export declare namespace AlertPolicySummary {
    function getJsonObj(obj: AlertPolicySummary): object;
    function getDeserializedJsonObj(obj: AlertPolicySummary): object;
}

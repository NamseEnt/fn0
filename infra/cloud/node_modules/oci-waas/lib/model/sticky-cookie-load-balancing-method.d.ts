...
export declare namespace StickyCookieLoadBalancingMethod {
    function getJsonObj(obj: StickyCookieLoadBalancingMethod, isParentJsonObj?: boolean): object;
    const method = "STICKY_COOKIE";
    function getDeserializedJsonObj(obj: StickyCookieLoadBalancingMethod, isParentJsonObj?: boolean): object;
}

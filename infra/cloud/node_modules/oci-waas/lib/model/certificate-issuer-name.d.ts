...
export declare namespace CertificateIssuerName {
    function getJsonObj(obj: CertificateIssuerName): object;
    function getDeserializedJsonObj(obj: CertificateIssuerName): object;
}

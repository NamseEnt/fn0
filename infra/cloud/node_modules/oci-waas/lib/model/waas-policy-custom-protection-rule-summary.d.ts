...
export declare namespace WaasPolicyCustomProtectionRuleSummary {
    enum Action {
        Detect = "DETECT",
        Block = "BLOCK",
        /**
    ...
    function getJsonObj(obj: WaasPolicyCustomProtectionRuleSummary): object;
    function getDeserializedJsonObj(obj: WaasPolicyCustomProtectionRuleSummary): object;
}

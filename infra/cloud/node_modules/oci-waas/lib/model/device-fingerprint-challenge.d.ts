...
export declare namespace DeviceFingerprintChallenge {
    enum Action {
        Detect = "DETECT",
        Block = "BLOCK",
        /**
    ...
    function getJsonObj(obj: DeviceFingerprintChallenge): object;
    function getDeserializedJsonObj(obj: DeviceFingerprintChallenge): object;
}

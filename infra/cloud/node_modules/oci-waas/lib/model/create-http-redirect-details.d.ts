...
export declare namespace CreateHttpRedirectDetails {
    function getJsonObj(obj: CreateHttpRedirectDetails): object;
    function getDeserializedJsonObj(obj: CreateHttpRedirectDetails): object;
}

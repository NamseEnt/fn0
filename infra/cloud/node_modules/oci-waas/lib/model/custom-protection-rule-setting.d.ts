...
export declare namespace CustomProtectionRuleSetting {
    enum Action {
        Detect = "DETECT",
        Block = "BLOCK",
        /**
    ...
    function getJsonObj(obj: CustomProtectionRuleSetting): object;
    function getDeserializedJsonObj(obj: CustomProtectionRuleSetting): object;
}

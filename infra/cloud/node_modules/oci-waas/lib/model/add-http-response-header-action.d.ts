...
export declare namespace AddHttpResponseHeaderAction {
    function getJsonObj(obj: AddHttpResponseHeaderAction, isParentJsonObj?: boolean): object;
    const action = "ADD_HTTP_RESPONSE_HEADER";
    function getDeserializedJsonObj(obj: AddHttpResponseHeaderAction, isParentJsonObj?: boolean): object;
}

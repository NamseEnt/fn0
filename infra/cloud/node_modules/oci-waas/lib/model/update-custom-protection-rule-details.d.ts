 ...
 */
export interface UpdateCustomProtectionRuleDetails {
    /**
...
export declare namespace UpdateCustomProtectionRuleDetails {
    function getJsonObj(obj: UpdateCustomProtectionRuleDetails): object;
    function getDeserializedJsonObj(obj: UpdateCustomProtectionRuleDetails): object;
}

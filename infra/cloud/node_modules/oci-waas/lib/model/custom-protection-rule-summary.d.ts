...
export declare namespace CustomProtectionRuleSummary {
    function getJsonObj(obj: CustomProtectionRuleSummary): object;
    function getDeserializedJsonObj(obj: CustomProtectionRuleSummary): object;
}

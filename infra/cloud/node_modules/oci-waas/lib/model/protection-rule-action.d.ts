...
export declare namespace ProtectionRuleAction {
    enum Action {
        Off = "OFF",
        Detect = "DETECT",
        Block = "BLOCK"
    }
    function getJsonObj(obj: ProtectionRuleAction): object;
    function getDeserializedJsonObj(obj: ProtectionRuleAction): object;
}

...
export declare namespace CustomProtectionRule {
    function getJsonObj(obj: CustomProtectionRule): object;
    function getDeserializedJsonObj(obj: CustomProtectionRule): object;
}

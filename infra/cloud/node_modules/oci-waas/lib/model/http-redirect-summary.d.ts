...
export declare namespace HttpRedirectSummary {
    function getJsonObj(obj: HttpRedirectSummary): object;
    function getDeserializedJsonObj(obj: HttpRedirectSummary): object;
}

...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/apigateway/ListApis.ts.html |here} to see how to use ListApisRequest.
 */
...
export declare namespace ListApisRequest {
    enum SortOrder {
        Asc = "ASC",
        Desc = "DESC"
    }

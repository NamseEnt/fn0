...
exports.ApiGatewayWaiter = void 0;
...
class ApiGatewayWaiter {
     ...
     */
    forSdk(request, ...targetStates) {
        return __awaiter(this, void 0, void 0, function* () {
            return oci_common_1.genericTerminalConditionWaiter(this.config, () => this.client.getSdk(request), response => targetStates.includes(response.sdk.lifecycleState), targetStates.includes(models.Sdk.LifecycleState.Deleted));
        });
    }
}
exports.ApiGatewayWaiter = ApiGatewayWaiter;
//# sourceMappingURL=apigateway-waiter.js.map
...
export declare class ApiGatewayWaiter {
    private client;
    private readonly config?;
    constructor(client: ApiGatewayClient, config?: Partial<import("oci-common/lib/waiter").WaiterConfigurationDetails> | undefined);
    /**
     ...
     */
    forCertificate(request: serviceRequests.GetCertificateRequest, ...targetStates: models.Certificate.LifecycleState[]): Promise<serviceResponses.GetCertificateResponse | null>;
    /**
     ...
     */
    forSdk(request: serviceRequests.GetSdkRequest, ...targetStates: models.Sdk.LifecycleState[]): Promise<serviceResponses.GetSdkResponse | null>;
}

...
export declare class DeploymentWaiter {
    ...
    constructor(client: DeploymentClient, config?: Partial<import("oci-common/lib/waiter").WaiterConfigurationDetails> | undefined);
    /**
     ...
     */
    forDeployment(request: serviceRequests.GetDeploymentRequest, ...targetStates: models.Deployment.LifecycleState[]): Promise<serviceResponses.GetDeploymentResponse | null>;
}

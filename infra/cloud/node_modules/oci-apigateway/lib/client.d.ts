...
export declare class ApiGatewayClient {
     ...
     */
    createWaiters(config?: common.WaiterConfiguration): ApiGatewayWaiter;
    /**
     ...
     */
    addApiLock(addApiLockRequest: requests.AddApiLockRequest): Promise<responses.AddApiLockResponse>;
    /**
     ...
     */
    addCertificateLock(addCertificateLockRequest: requests.AddCertificateLockRequest): Promise<responses.AddCertificateLockResponse>;
    /**
     ...
     */
    addSdkLock(addSdkLockRequest: requests.AddSdkLockRequest): Promise<responses.AddSdkLockResponse>;
    /**
     ...
     */
    removeApiLock(removeApiLockRequest: requests.RemoveApiLockRequest): Promise<responses.RemoveApiLockResponse>;
    /**
     ...
     */
    removeCertificateLock(removeCertificateLockRequest: requests.RemoveCertificateLockRequest): Promise<responses.RemoveCertificateLockResponse>;
    /**
     ...
     */
    removeSdkLock(removeSdkLockRequest: requests.RemoveSdkLockRequest): Promise<responses.RemoveSdkLockResponse>;
    /**
...
export declare class DeploymentClient {
     ...
     * @return The service waiters.
     */
    createWaiters(config?: common.WaiterConfiguration): DeploymentWaiter;
    /**
     * Gets the waiters available for resources for this service.
     *
     * @return The service waiters.
...
export declare class GatewayClient {
     ...
     * @return The service waiters.
     */
    createWaiters(config?: common.WaiterConfiguration): GatewayWaiter;
    /**
     * Gets the waiters available for resources for this service.
     *
     * @return The service waiters.
     ...
     */
    addGatewayLock(addGatewayLockRequest: requests.AddGatewayLockRequest): Promise<responses.AddGatewayLockResponse>;
    /**
     ...
     */
    removeGatewayLock(removeGatewayLockRequest: requests.RemoveGatewayLockRequest): Promise<responses.RemoveGatewayLockResponse>;
    /**
...
export declare class SubscribersClient {
     ...
     */
    addSubscriberLock(addSubscriberLockRequest: requests.AddSubscriberLockRequest): Promise<responses.AddSubscriberLockResponse>;
    /**
     ...
     */
    removeSubscriberLock(removeSubscriberLockRequest: requests.RemoveSubscriberLockRequest): Promise<responses.RemoveSubscriberLockResponse>;
    /**
...
export declare class UsagePlansClient {
     ...
     */
    addUsagePlanLock(addUsagePlanLockRequest: requests.AddUsagePlanLockRequest): Promise<responses.AddUsagePlanLockResponse>;
    /**
     ...
     */
    removeUsagePlanLock(removeUsagePlanLockRequest: requests.RemoveUsagePlanLockRequest): Promise<responses.RemoveUsagePlanLockResponse>;
    /**

...
export interface ApiSpecificationRouteRequestPolicies {
    "authorization"?: model.AnyOfRouteAuthorizationPolicy | model.AnonymousRouteAuthorizationPolicy | model.AuthenticationOnlyRouteAuthorizationPolicy;
...
export declare namespace ApiSpecificationRouteRequestPolicies {
    function getJsonObj(obj: ApiSpecificationRouteRequestPolicies): object;
    function getDeserializedJsonObj(obj: ApiSpecificationRouteRequestPolicies): object;
}

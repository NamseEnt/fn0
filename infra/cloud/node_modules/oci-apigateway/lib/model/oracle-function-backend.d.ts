...
export declare namespace OracleFunctionBackend {
    function getJsonObj(obj: OracleFunctionBackend, isParentJsonObj?: boolean): object;
    const type = "ORACLE_FUNCTIONS_BACKEND";
    function getDeserializedJsonObj(obj: OracleFunctionBackend, isParentJsonObj?: boolean): object;
}

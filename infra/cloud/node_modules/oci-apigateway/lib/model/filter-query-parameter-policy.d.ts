...
export declare namespace FilterQueryParameterPolicy {
    enum Type {
        Allow = "ALLOW",
        Block = "BLOCK",
        /**
    ...
    function getJsonObj(obj: FilterQueryParameterPolicy): object;
    function getDeserializedJsonObj(obj: FilterQueryParameterPolicy): object;
}

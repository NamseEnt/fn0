...
export declare namespace CustomAuthenticationPolicy {
    function getJsonObj(obj: CustomAuthenticationPolicy, isParentJsonObj?: boolean): object;
    const type = "CUSTOM_AUTHENTICATION";
    function getDeserializedJsonObj(obj: CustomAuthenticationPolicy, isParentJsonObj?: boolean): object;
}

...
export declare namespace FilterQueryParameterPolicyItem {
    function getJsonObj(obj: FilterQueryParameterPolicyItem): object;
    function getDeserializedJsonObj(obj: FilterQueryParameterPolicyItem): object;
}

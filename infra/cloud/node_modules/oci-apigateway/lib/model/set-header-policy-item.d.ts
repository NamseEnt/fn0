...
export declare namespace SetHeaderPolicyItem {
    enum IfExists {
        Overwrite = "OVERWRITE",
        Append = "APPEND",
        Skip = "SKIP",
    ...
    function getJsonObj(obj: SetHeaderPolicyItem): object;
    function getDeserializedJsonObj(obj: SetHeaderPolicyItem): object;
}

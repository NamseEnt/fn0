 ...
 */
export interface ChangeUsagePlanCompartmentDetails {
    /**
...
export declare namespace ChangeUsagePlanCompartmentDetails {
    function getJsonObj(obj: ChangeUsagePlanCompartmentDetails): object;
    function getDeserializedJsonObj(obj: ChangeUsagePlanCompartmentDetails): object;
}

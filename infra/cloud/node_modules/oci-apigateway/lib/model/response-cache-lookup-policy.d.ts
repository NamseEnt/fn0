...
export declare namespace ResponseCacheLookupPolicy {
    function getJsonObj(obj: ResponseCacheLookupPolicy): object;
    function getDeserializedJsonObj(obj: ResponseCacheLookupPolicy): object;
}

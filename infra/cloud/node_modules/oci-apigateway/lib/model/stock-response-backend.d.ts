...
export declare namespace StockResponseBackend {
    function getJsonObj(obj: StockResponseBackend, isParentJsonObj?: boolean): object;
    const type = "STOCK_RESPONSE_BACKEND";
    function getDeserializedJsonObj(obj: StockResponseBackend, isParentJsonObj?: boolean): object;
}

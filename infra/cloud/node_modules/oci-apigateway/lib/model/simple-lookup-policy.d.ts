...
export declare namespace SimpleLookupPolicy {
    function getJsonObj(obj: SimpleLookupPolicy, isParentJsonObj?: boolean): object;
    const type = "SIMPLE_LOOKUP_POLICY";
    function getDeserializedJsonObj(obj: SimpleLookupPolicy, isParentJsonObj?: boolean): object;
}

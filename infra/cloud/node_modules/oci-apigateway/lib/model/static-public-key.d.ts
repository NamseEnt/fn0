 ...
 */
export interface StaticPublicKey {
    /**
...
export declare namespace StaticPublicKey {
    function getJsonObj(obj: StaticPublicKey): object;
    function getDeserializedJsonObj(obj: StaticPublicKey): object;
}

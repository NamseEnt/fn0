...
export declare namespace ValidationRequestPolicy {
    enum ValidationMode {
        Enforcing = "ENFORCING",
    ...
    function getJsonObj(obj: ValidationRequestPolicy): object;
    function getDeserializedJsonObj(obj: ValidationRequestPolicy): object;
}

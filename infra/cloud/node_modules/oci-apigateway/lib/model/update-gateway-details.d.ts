 ...
 */
export interface UpdateGatewayDetails {
    /**
...
export declare namespace UpdateGatewayDetails {
    function getJsonObj(obj: UpdateGatewayDetails): object;
    function getDeserializedJsonObj(obj: UpdateGatewayDetails): object;
}

...
export declare namespace JsonWebTokenClaim {
    function getJsonObj(obj: JsonWebTokenClaim): object;
    function getDeserializedJsonObj(obj: JsonWebTokenClaim): object;
}

...
export declare namespace HTTPBackend {
    function getJsonObj(obj: HTTPBackend, isParentJsonObj?: boolean): object;
    const type = "HTTP_BACKEND";
    function getDeserializedJsonObj(obj: HTTPBackend, isParentJsonObj?: boolean): object;
}

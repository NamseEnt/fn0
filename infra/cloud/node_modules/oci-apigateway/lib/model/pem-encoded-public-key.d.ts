...
export declare namespace PemEncodedPublicKey {
    function getJsonObj(obj: PemEncodedPublicKey, isParentJsonObj?: boolean): object;
    const format = "PEM";
    function getDeserializedJsonObj(obj: PemEncodedPublicKey, isParentJsonObj?: boolean): object;
}

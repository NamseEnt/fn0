...
export declare namespace DeploymentCollection {
    function getJsonObj(obj: DeploymentCollection): object;
    function getDeserializedJsonObj(obj: DeploymentCollection): object;
}

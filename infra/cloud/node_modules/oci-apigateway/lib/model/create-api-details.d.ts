 ...
 */
export interface CreateApiDetails {
    /**
...
export declare namespace CreateApiDetails {
    function getJsonObj(obj: CreateApiDetails): object;
    function getDeserializedJsonObj(obj: CreateApiDetails): object;
}

...
export declare namespace ChangeGatewayCompartmentDetails {
    function getJsonObj(obj: ChangeGatewayCompartmentDetails): object;
    function getDeserializedJsonObj(obj: ChangeGatewayCompartmentDetails): object;
}

 ...
 * ```
 */
class BackendSet extends pulumi.CustomResource {
    /**
    ...
    static get(name, id, state, opts) {
        return new BackendSet(name, state, { ...opts, id: id });
    }
    /**
...
exports.BackendSet = BackendSet;
/** @internal */
BackendSet.__pulumiType = 'oci:NetworkLoadBalancer/backendSet:BackendSet';
//# sourceMappingURL=backendSet.js.map
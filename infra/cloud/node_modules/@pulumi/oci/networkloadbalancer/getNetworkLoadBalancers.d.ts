 ...
 * ```
 */
export declare function getNetworkLoadBalancersOutput(args: GetNetworkLoadBalancersOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetNetworkLoadBalancersResult>;
/**
 * A collection of arguments for invoking getNetworkLoadBalancers.
 */

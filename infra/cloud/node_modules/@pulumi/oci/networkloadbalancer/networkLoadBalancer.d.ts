...
export declare class NetworkLoadBalancer extends pulumi.CustomResource {
     ...
     */
    readonly assignedIpv6: pulumi.Output<string | undefined>;
    /**
     ...
     */
    readonly assignedPrivateIpv4: pulumi.Output<string | undefined>;
    /**
     ...
     */
    readonly ipAddresses: pulumi.Output<outputs.NetworkLoadBalancer.NetworkLoadBalancerIpAddress[]>;
    /**
     ...
     */
    readonly isPreserveSourceDestination: pulumi.Output<boolean>;
    /**
     ...
     * Example: `true`
     */
    readonly isSymmetricHashEnabled: pulumi.Output<boolean>;
    /**
     ...
     */
    readonly networkSecurityGroupIds: pulumi.Output<string[] | undefined>;
    /**
     * (Updatable) IP version associated with the NLB.
     */
    readonly nlbIpVersion: pulumi.Output<string>;
    /**
     ...
     */
    readonly reservedIps: pulumi.Output<outputs.NetworkLoadBalancer.NetworkLoadBalancerReservedIp[] | undefined>;
    /**
     ...
     */
    readonly subnetIpv6cidr: pulumi.Output<string | undefined>;
    /**

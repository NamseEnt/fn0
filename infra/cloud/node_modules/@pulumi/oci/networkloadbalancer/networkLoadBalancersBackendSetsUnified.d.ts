 ...
 * ```
 */
export declare class NetworkLoadBalancersBackendSetsUnified extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: NetworkLoadBalancersBackendSetsUnifiedState, opts?: pulumi.CustomResourceOptions): NetworkLoadBalancersBackendSetsUnified;
    /**
     ...
     */
    static isInstance(obj: any): obj is NetworkLoadBalancersBackendSetsUnified;
    /**
     ...
     */
    readonly areOperationallyActiveBackendsPreferred: pulumi.Output<boolean>;
    /**
     * (Updatable) An array of backends to be associated with the backend set.
     */
    readonly backends: pulumi.Output<outputs.NetworkLoadBalancer.NetworkLoadBalancersBackendSetsUnifiedBackend[]>;
    /**
     ...
     */
    readonly healthChecker: pulumi.Output<outputs.NetworkLoadBalancer.NetworkLoadBalancersBackendSetsUnifiedHealthChecker>;
    /**
     ...
     */
    readonly isFailOpen: pulumi.Output<boolean>;
    /**
     ...
     */
    readonly isInstantFailoverEnabled: pulumi.Output<boolean>;
    /**
     ...
     */
    readonly isInstantFailoverTcpResetEnabled: pulumi.Output<boolean>;
    /**
     ...
     */
    readonly isPreserveSource: pulumi.Output<boolean>;
    /**
     ...
     */
    readonly networkLoadBalancerId: pulumi.Output<string>;
    /**

 ...
 * ```
 */
export declare function getLogAnalyticsObjectCollectionRule(args: GetLogAnalyticsObjectCollectionRuleArgs, opts?: pulumi.InvokeOptions): Promise<GetLogAnalyticsObjectCollectionRuleResult>;
/**
 ...
 * ```
 */
export declare function getLogAnalyticsObjectCollectionRuleOutput(args: GetLogAnalyticsObjectCollectionRuleOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetLogAnalyticsObjectCollectionRuleResult>;
/**
 * A collection of arguments for invoking getLogAnalyticsObjectCollectionRule.
 */

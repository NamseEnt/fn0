 ...
 * ```
 */
export declare function getNamespaceTemplate(args: GetNamespaceTemplateArgs, opts?: pulumi.InvokeOptions): Promise<GetNamespaceTemplateResult>;
/**
 ...
 * ```
 */
export declare function getNamespaceTemplateOutput(args: GetNamespaceTemplateOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetNamespaceTemplateResult>;
/**
 * A collection of arguments for invoking getNamespaceTemplate.
 */

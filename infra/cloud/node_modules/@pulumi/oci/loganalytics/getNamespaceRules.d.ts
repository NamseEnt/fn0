 ...
 * ```
 */
export declare function getNamespaceRules(args: GetNamespaceRulesArgs, opts?: pulumi.InvokeOptions): Promise<GetNamespaceRulesResult>;
/**
 ...
 * ```
 */
export declare function getNamespaceRulesOutput(args: GetNamespaceRulesOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetNamespaceRulesResult>;
/**
 * A collection of arguments for invoking getNamespaceRules.
 */

 ...
 * ```
 */
export declare function getLogAnalyticsObjectCollectionRules(args: GetLogAnalyticsObjectCollectionRulesArgs, opts?: pulumi.InvokeOptions): Promise<GetLogAnalyticsObjectCollectionRulesResult>;
/**
 ...
 * ```
 */
export declare function getLogAnalyticsObjectCollectionRulesOutput(args: GetLogAnalyticsObjectCollectionRulesOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetLogAnalyticsObjectCollectionRulesResult>;
/**
 * A collection of arguments for invoking getLogAnalyticsObjectCollectionRules.
 */

 ...
 */
export declare class NamespaceLookupsAppendDataManagement extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: NamespaceLookupsAppendDataManagementState, opts?: pulumi.CustomResourceOptions): NamespaceLookupsAppendDataManagement;
    /**
     ...
     */
    static isInstance(obj: any): obj is NamespaceLookupsAppendDataManagement;
    /**
     * Path to the file containing data for the lookup append.
     */
    readonly appendLookupFile: pulumi.Output<string>;
    /**
     ...
     * is force
     */
    readonly isForce: pulumi.Output<boolean>;
    /**

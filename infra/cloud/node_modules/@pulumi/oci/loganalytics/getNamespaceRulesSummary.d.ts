 ...
 * ```
 */
export declare function getNamespaceRulesSummary(args: GetNamespaceRulesSummaryArgs, opts?: pulumi.InvokeOptions): Promise<GetNamespaceRulesSummaryResult>;
/**
 ...
 * ```
 */
export declare function getNamespaceRulesSummaryOutput(args: GetNamespaceRulesSummaryOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetNamespaceRulesSummaryResult>;
/**
 * A collection of arguments for invoking getNamespaceRulesSummary.
 */

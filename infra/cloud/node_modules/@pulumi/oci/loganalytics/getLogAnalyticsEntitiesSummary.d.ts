 ...
 * ```
 */
export declare function getLogAnalyticsEntitiesSummary(args: GetLogAnalyticsEntitiesSummaryArgs, opts?: pulumi.InvokeOptions): Promise<GetLogAnalyticsEntitiesSummaryResult>;
/**
 ...
 * ```
 */
export declare function getLogAnalyticsEntitiesSummaryOutput(args: GetLogAnalyticsEntitiesSummaryOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetLogAnalyticsEntitiesSummaryResult>;
/**
 * A collection of arguments for invoking getLogAnalyticsEntitiesSummary.
 */

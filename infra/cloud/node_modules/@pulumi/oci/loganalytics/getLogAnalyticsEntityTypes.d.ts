 ...
 * ```
 */
export declare function getLogAnalyticsEntityTypes(args: GetLogAnalyticsEntityTypesArgs, opts?: pulumi.InvokeOptions): Promise<GetLogAnalyticsEntityTypesResult>;
/**
 ...
 * ```
 */
export declare function getLogAnalyticsEntityTypesOutput(args: GetLogAnalyticsEntityTypesOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetLogAnalyticsEntityTypesResult>;
/**
 * A collection of arguments for invoking getLogAnalyticsEntityTypes.
 */

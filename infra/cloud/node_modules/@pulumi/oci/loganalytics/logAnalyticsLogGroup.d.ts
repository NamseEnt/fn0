 ...
 * ```
 */
export declare class LogAnalyticsLogGroup extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: LogAnalyticsLogGroupState, opts?: pulumi.CustomResourceOptions): LogAnalyticsLogGroup;
    /**
     * Returns true if the given object is an instance of LogAnalyticsLogGroup.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is LogAnalyticsLogGroup;
    /**

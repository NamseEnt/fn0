...
exports.NamespaceStorageArchivalConfig = void 0;
 ...
 * ```
 */
class NamespaceStorageArchivalConfig extends pulumi.CustomResource {
    /**
    ...
    static get(name, id, state, opts) {
        return new NamespaceStorageArchivalConfig(name, state, { ...opts, id: id });
    }
    /**
...
exports.NamespaceStorageArchivalConfig = NamespaceStorageArchivalConfig;
/** @internal */
NamespaceStorageArchivalConfig.__pulumiType = 'oci:LogAnalytics/namespaceStorageArchivalConfig:NamespaceStorageArchivalConfig';
//# sourceMappingURL=namespaceStorageArchivalConfig.js.map
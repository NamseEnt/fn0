 ...
 */
export declare class LogAnalyticsImportCustomContent extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: LogAnalyticsImportCustomContentState, opts?: pulumi.CustomResourceOptions): LogAnalyticsImportCustomContent;
    /**
     ...
     */
    static isInstance(obj: any): obj is LogAnalyticsImportCustomContent;
    /**
     * LogAnalyticsImportCustomChangeList
     */
    readonly changeLists: pulumi.Output<outputs.LogAnalytics.LogAnalyticsImportCustomContentChangeList[]>;
    /**
     * The content name.
     */
    readonly contentName: pulumi.Output<string>;
    /**
     ...
     */
    readonly expect: pulumi.Output<string>;
    /**
     * The field names.
     */
    readonly fieldNames: pulumi.Output<string[]>;
    /**
     * Path to the file to upload which contains the custom content.
     */
    readonly importCustomContentFile: pulumi.Output<string>;
    /**
     ...
     * The parser names.
     */
    readonly parserNames: pulumi.Output<string[]>;
    /**
     * The source names.
     */
    readonly sourceNames: pulumi.Output<string[]>;
    /**

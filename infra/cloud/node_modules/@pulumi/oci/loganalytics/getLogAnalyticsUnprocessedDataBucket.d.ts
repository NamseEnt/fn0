 ...
 * ```
 */
export declare function getLogAnalyticsUnprocessedDataBucket(args: GetLogAnalyticsUnprocessedDataBucketArgs, opts?: pulumi.InvokeOptions): Promise<GetLogAnalyticsUnprocessedDataBucketResult>;
/**
 ...
 * ```
 */
export declare function getLogAnalyticsUnprocessedDataBucketOutput(args: GetLogAnalyticsUnprocessedDataBucketOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetLogAnalyticsUnprocessedDataBucketResult>;
/**
 * A collection of arguments for invoking getLogAnalyticsUnprocessedDataBucket.
 */

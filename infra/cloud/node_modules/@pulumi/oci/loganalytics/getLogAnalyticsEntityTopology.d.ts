 ...
 * ```
 */
export declare function getLogAnalyticsEntityTopology(args: GetLogAnalyticsEntityTopologyArgs, opts?: pulumi.InvokeOptions): Promise<GetLogAnalyticsEntityTopologyResult>;
/**
 ...
 * ```
 */
export declare function getLogAnalyticsEntityTopologyOutput(args: GetLogAnalyticsEntityTopologyOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetLogAnalyticsEntityTopologyResult>;
/**
 * A collection of arguments for invoking getLogAnalyticsEntityTopology.
 */

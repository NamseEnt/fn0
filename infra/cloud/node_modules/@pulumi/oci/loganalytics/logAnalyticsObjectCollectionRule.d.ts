 ...
 * ```
 */
export declare class LogAnalyticsObjectCollectionRule extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: LogAnalyticsObjectCollectionRuleState, opts?: pulumi.CustomResourceOptions): LogAnalyticsObjectCollectionRule;
    /**
     ...
     */
    static isInstance(obj: any): obj is LogAnalyticsObjectCollectionRule;
    /**
     * (Updatable) An optional character encoding to aid in detecting the character encoding of the contents of the objects while processing. It is recommended to set this value as ISO_8589_1 when configuring content of the objects having more numeric characters, and very few alphabets. For e.g. this applies when configuring VCN Flow Logs.
     */
    readonly charEncoding: pulumi.Output<string>;
    /**
     ...
     */
    readonly isForceHistoricCollection: pulumi.Output<boolean>;
    /**
     * Last Collected Object for the rule
     */
    readonly lastCollectedObject: pulumi.Output<string>;
    /**
     ...
     */
    readonly logSetKey: pulumi.Output<string>;
    /**
     * (Updatable) Name of the Log Analytics Source to use for the processing.
     */
    readonly logSourceName: pulumi.Output<string>;
    /**
     ...
     */
    readonly objectNameFilters: pulumi.Output<string[] | undefined>;
    /**
     * Name of the Object Storage bucket.
     */
    readonly osBucketName: pulumi.Output<string>;
    /**
     * Object Storage namespace.
     */
    readonly osNamespace: pulumi.Output<string>;
    /**
     ...
     */
    readonly overrides: pulumi.Output<outputs.LogAnalytics.LogAnalyticsObjectCollectionRuleOverride[]>;
    /**
     * The oldest time of the file in the bucket to consider for collection. Accepted values are: BEGINNING or CURRENT_TIME or RFC3339 formatted datetime string. Use this for HISTORIC or HISTORIC_LIVE collection types. When collectionType is LIVE, specifying pollSince value other than CURRENT_TIME will result in error.
     */
    readonly pollSince: pulumi.Output<string>;
    /**
     ...
     */
    readonly pollTill: pulumi.Output<string>;
    /**
     ...
     */
    readonly streamCursorTime: pulumi.Output<string>;
    /**
     ...
     */
    readonly streamCursorType: pulumi.Output<string>;
    /**

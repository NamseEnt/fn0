 ...
 * ```
 */
export declare function getLogAnalyticsEntityType(args: GetLogAnalyticsEntityTypeArgs, opts?: pulumi.InvokeOptions): Promise<GetLogAnalyticsEntityTypeResult>;
/**
 ...
 * ```
 */
export declare function getLogAnalyticsEntityTypeOutput(args: GetLogAnalyticsEntityTypeOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetLogAnalyticsEntityTypeResult>;
/**
 * A collection of arguments for invoking getLogAnalyticsEntityType.
 */

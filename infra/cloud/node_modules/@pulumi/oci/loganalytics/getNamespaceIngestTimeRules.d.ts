 ...
 * ```
 */
export declare function getNamespaceIngestTimeRules(args: GetNamespaceIngestTimeRulesArgs, opts?: pulumi.InvokeOptions): Promise<GetNamespaceIngestTimeRulesResult>;
/**
 ...
 * ```
 */
export declare function getNamespaceIngestTimeRulesOutput(args: GetNamespaceIngestTimeRulesOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetNamespaceIngestTimeRulesResult>;
/**
 * A collection of arguments for invoking getNamespaceIngestTimeRules.
 */

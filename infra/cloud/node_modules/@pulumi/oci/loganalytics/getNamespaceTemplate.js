...
exports.getNamespaceTemplateOutput = exports.getNamespaceTemplate = void 0;
 ...
 * ```
 */
function getNamespaceTemplate(args, opts) {
...
exports.getNamespaceTemplate = getNamespaceTemplate;
/**
 * This data source provides details about a specific Namespace Template resource in Oracle Cloud Infrastructure Log Analytics service.
 *
 * Gets detailed information about the template with the specified ocid.
 ...
 * ```
 */
function getNamespaceTemplateOutput(args, opts) {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
...
exports.getNamespaceTemplateOutput = getNamespaceTemplateOutput;
//# sourceMappingURL=getNamespaceTemplate.js.map
 ...
 * ```
 */
class LogAnalyticsEntityType extends pulumi.CustomResource {
    /**
    ...
    static get(name, id, state, opts) {
        return new LogAnalyticsEntityType(name, state, { ...opts, id: id });
    }
    /**
...
exports.LogAnalyticsEntityType = LogAnalyticsEntityType;
/** @internal */
LogAnalyticsEntityType.__pulumiType = 'oci:LogAnalytics/logAnalyticsEntityType:LogAnalyticsEntityType';
//# sourceMappingURL=logAnalyticsEntityType.js.map
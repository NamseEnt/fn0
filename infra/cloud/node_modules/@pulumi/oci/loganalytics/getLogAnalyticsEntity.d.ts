 ...
 * ```
 */
export declare function getLogAnalyticsEntity(args: GetLogAnalyticsEntityArgs, opts?: pulumi.InvokeOptions): Promise<GetLogAnalyticsEntityResult>;
/**
 ...
 * ```
 */
export declare function getLogAnalyticsEntityOutput(args: GetLogAnalyticsEntityOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetLogAnalyticsEntityResult>;
/**
 * A collection of arguments for invoking getLogAnalyticsEntity.
 */

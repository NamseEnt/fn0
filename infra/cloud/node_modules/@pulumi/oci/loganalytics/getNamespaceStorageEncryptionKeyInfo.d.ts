 ...
 * ```
 */
export declare function getNamespaceStorageEncryptionKeyInfo(args: GetNamespaceStorageEncryptionKeyInfoArgs, opts?: pulumi.InvokeOptions): Promise<GetNamespaceStorageEncryptionKeyInfoResult>;
/**
 ...
 * ```
 */
export declare function getNamespaceStorageEncryptionKeyInfoOutput(args: GetNamespaceStorageEncryptionKeyInfoOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetNamespaceStorageEncryptionKeyInfoResult>;
/**
 * A collection of arguments for invoking getNamespaceStorageEncryptionKeyInfo.
 */

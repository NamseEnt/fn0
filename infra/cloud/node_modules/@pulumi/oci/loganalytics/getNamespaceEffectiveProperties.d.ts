 ...
 * ```
 */
export declare function getNamespaceEffectiveProperties(args: GetNamespaceEffectivePropertiesArgs, opts?: pulumi.InvokeOptions): Promise<GetNamespaceEffectivePropertiesResult>;
/**
 ...
 * ```
 */
export declare function getNamespaceEffectivePropertiesOutput(args: GetNamespaceEffectivePropertiesOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetNamespaceEffectivePropertiesResult>;
/**
 * A collection of arguments for invoking getNamespaceEffectiveProperties.
 */

 ...
 * ```
 */
export declare function getChannels(args: GetChannelsArgs, opts?: pulumi.InvokeOptions): Promise<GetChannelsResult>;
/**
 ...
 * ```
 */
export declare function getChannelsOutput(args: GetChannelsOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetChannelsResult>;
/**
 * A collection of arguments for invoking getChannels.
 */

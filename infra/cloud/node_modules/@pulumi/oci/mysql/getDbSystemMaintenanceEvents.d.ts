 ...
 * ```
 */
export declare function getDbSystemMaintenanceEvents(args: GetDbSystemMaintenanceEventsArgs, opts?: pulumi.InvokeOptions): Promise<GetDbSystemMaintenanceEventsResult>;
/**
 ...
 * ```
 */
export declare function getDbSystemMaintenanceEventsOutput(args: GetDbSystemMaintenanceEventsOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetDbSystemMaintenanceEventsResult>;
/**
 * A collection of arguments for invoking getDbSystemMaintenanceEvents.
 */

 ...
 * ```
 */
class MysqlDbSystem extends pulumi.CustomResource {
    /**
    ...
    static get(name, id, state, opts) {
        return new MysqlDbSystem(name, state, { ...opts, id: id });
    }
    /**
...
exports.MysqlDbSystem = MysqlDbSystem;
/** @internal */
MysqlDbSystem.__pulumiType = 'oci:Mysql/mysqlDbSystem:MysqlDbSystem';
//# sourceMappingURL=mysqlDbSystem.js.map
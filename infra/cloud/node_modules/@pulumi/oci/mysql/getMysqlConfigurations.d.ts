 ...
 * ```
 */
export declare function getMysqlConfigurations(args: GetMysqlConfigurationsArgs, opts?: pulumi.InvokeOptions): Promise<GetMysqlConfigurationsResult>;
/**
 ...
 * ```
 */
export declare function getMysqlConfigurationsOutput(args: GetMysqlConfigurationsOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetMysqlConfigurationsResult>;
/**
 * A collection of arguments for invoking getMysqlConfigurations.
 */

 ...
 * ```
 */
class MysqlBackup extends pulumi.CustomResource {
    /**
    ...
    static get(name, id, state, opts) {
        return new MysqlBackup(name, state, { ...opts, id: id });
    }
    /**
...
exports.MysqlBackup = MysqlBackup;
/** @internal */
MysqlBackup.__pulumiType = 'oci:Mysql/mysqlBackup:MysqlBackup';
//# sourceMappingURL=mysqlBackup.js.map
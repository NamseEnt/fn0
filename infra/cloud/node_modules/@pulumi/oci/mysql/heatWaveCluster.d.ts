 ...
 * ```
 */
export declare class HeatWaveCluster extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: HeatWaveClusterState, opts?: pulumi.CustomResourceOptions): HeatWaveCluster;
    /**
     * Returns true if the given object is an instance of HeatWaveCluster.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is HeatWaveCluster;
    /**
     * A HeatWave node is a compute host that is part of a HeatWave cluster.
     */
    readonly clusterNodes: pulumi.Output<outputs.Mysql.HeatWaveClusterClusterNode[]>;
    /**
     ...
     */
    readonly isLakehouseEnabled: pulumi.Output<boolean>;
    /**

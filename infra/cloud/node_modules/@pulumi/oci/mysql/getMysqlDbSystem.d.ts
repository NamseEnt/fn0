 ...
 * ```
 */
export declare function getMysqlDbSystem(args: GetMysqlDbSystemArgs, opts?: pulumi.InvokeOptions): Promise<GetMysqlDbSystemResult>;
/**
 ...
 * ```
 */
export declare function getMysqlDbSystemOutput(args: GetMysqlDbSystemOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetMysqlDbSystemResult>;
/**
 * A collection of arguments for invoking getMysqlDbSystem.
 */

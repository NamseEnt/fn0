 ...
 * ```
 */
export declare function getReplicas(args: GetReplicasArgs, opts?: pulumi.InvokeOptions): Promise<GetReplicasResult>;
/**
 ...
 * ```
 */
export declare function getReplicasOutput(args: GetReplicasOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetReplicasResult>;
/**
 * A collection of arguments for invoking getReplicas.
 */

 ...
 * ```
 */
class FsuCycle extends pulumi.CustomResource {
    /**
    ...
    static get(name, id, state, opts) {
        return new FsuCycle(name, state, { ...opts, id: id });
    }
    /**
...
exports.FsuCycle = FsuCycle;
/** @internal */
FsuCycle.__pulumiType = 'oci:FleetSoftwareUpdate/fsuCycle:FsuCycle';
//# sourceMappingURL=fsuCycle.js.map
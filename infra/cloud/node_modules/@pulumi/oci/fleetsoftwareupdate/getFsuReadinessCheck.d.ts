 ...
 * ```
 */
export declare function getFsuReadinessCheck(args: GetFsuReadinessCheckArgs, opts?: pulumi.InvokeOptions): Promise<GetFsuReadinessCheckResult>;
/**
 ...
 * ```
 */
export declare function getFsuReadinessCheckOutput(args: GetFsuReadinessCheckOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetFsuReadinessCheckResult>;
/**
 * A collection of arguments for invoking getFsuReadinessCheck.
 */

 ...
 * ```
 */
class FsuCollection extends pulumi.CustomResource {
    /**
    ...
    static get(name, id, state, opts) {
        return new FsuCollection(name, state, { ...opts, id: id });
    }
    /**
...
exports.FsuCollection = FsuCollection;
/** @internal */
FsuCollection.__pulumiType = 'oci:FleetSoftwareUpdate/fsuCollection:FsuCollection';
//# sourceMappingURL=fsuCollection.js.map
 ...
 * ```
 */
export declare function getFsuReadinessChecks(args: GetFsuReadinessChecksArgs, opts?: pulumi.InvokeOptions): Promise<GetFsuReadinessChecksResult>;
/**
 ...
 * ```
 */
export declare function getFsuReadinessChecksOutput(args: GetFsuReadinessChecksOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetFsuReadinessChecksResult>;
/**
 * A collection of arguments for invoking getFsuReadinessChecks.
 */

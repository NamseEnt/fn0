 ...
 * ```
 */
export declare class FsuCollection extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: FsuCollectionState, opts?: pulumi.CustomResourceOptions): FsuCollection;
    /**
     * Returns true if the given object is an instance of FsuCollection.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is FsuCollection;
    /**
     * Active Exadata Fleet Update Cycle resource for this Collection. Object would be null if there is no active Cycle.
     */
    readonly activeFsuCycles: pulumi.Output<outputs.FleetSoftwareUpdate.FsuCollectionActiveFsuCycle[]>;
    /**
     ...
     */
    readonly components: pulumi.Output<outputs.FleetSoftwareUpdate.FsuCollectionComponent[]>;
    /**
     ...
     */
    readonly fleetDiscovery: pulumi.Output<outputs.FleetSoftwareUpdate.FsuCollectionFleetDiscovery>;
    /**
     ...
     */
    readonly lastCompletedFsuCycleId: pulumi.Output<string>;
    /**
     ...
     */
    readonly sourceMajorVersion: pulumi.Output<string>;
    /**
     ...
     */
    readonly targetCount: pulumi.Output<number>;
    /**

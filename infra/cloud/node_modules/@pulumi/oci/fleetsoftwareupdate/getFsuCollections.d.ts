 ...
 * ```
 */
export declare function getFsuCollections(args: GetFsuCollectionsArgs, opts?: pulumi.InvokeOptions): Promise<GetFsuCollectionsResult>;
/**
 ...
 * ```
 */
export declare function getFsuCollectionsOutput(args: GetFsuCollectionsOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetFsuCollectionsResult>;
/**
 * A collection of arguments for invoking getFsuCollections.
 */

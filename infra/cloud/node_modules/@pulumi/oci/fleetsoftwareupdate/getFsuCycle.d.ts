 ...
 * ```
 */
export declare function getFsuCycle(args: GetFsuCycleArgs, opts?: pulumi.InvokeOptions): Promise<GetFsuCycleResult>;
/**
 ...
 * ```
 */
export declare function getFsuCycleOutput(args: GetFsuCycleOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetFsuCycleResult>;
/**
 * A collection of arguments for invoking getFsuCycle.
 */

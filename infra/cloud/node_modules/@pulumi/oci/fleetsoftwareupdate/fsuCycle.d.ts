 ...
 * ```
 */
export declare class FsuCycle extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: FsuCycleState, opts?: pulumi.CustomResourceOptions): FsuCycle;
    /**
     * Returns true if the given object is an instance of FsuCycle.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is FsuCycle;
    /**
     ...
     */
    readonly applyActionSchedule: pulumi.Output<outputs.FleetSoftwareUpdate.FsuCycleApplyActionSchedule>;
    /**
     * (Updatable) Batching strategy details to use during PRECHECK and APPLY Cycle Actions.
     */
    readonly batchingStrategy: pulumi.Output<outputs.FleetSoftwareUpdate.FsuCycleBatchingStrategy>;
    /**
     * Type of Exadata Fleet Update collection being upgraded.
     */
    readonly collectionType: pulumi.Output<string>;
    /**
     ...
     */
    readonly diagnosticsCollection: pulumi.Output<outputs.FleetSoftwareUpdate.FsuCycleDiagnosticsCollection>;
    /**
     ...
     */
    readonly executingFsuActionId: pulumi.Output<string>;
    /**
     ...
     */
    readonly fsuCollectionId: pulumi.Output<string>;
    /**
     * (Updatable) Goal version or image details for the Exadata Fleet Update Cycle.
     */
    readonly goalVersionDetails: pulumi.Output<outputs.FleetSoftwareUpdate.FsuCycleGoalVersionDetails>;
    /**
     ...
     */
    readonly isIgnoreMissingPatches: pulumi.Output<string[]>;
    /**
     ...
     */
    readonly lastCompletedAction: pulumi.Output<string>;
    /**
     ...
     */
    readonly lastCompletedActionId: pulumi.Output<string>;
    /**
     ...
     */
    readonly maxDrainTimeoutInSeconds: pulumi.Output<number>;
    /**
     * All possible Exadata Fleet Update Actions will be listed. The first element is the suggested Exadata Fleet Update Action.
     */
    readonly nextActionToExecutes: pulumi.Output<outputs.FleetSoftwareUpdate.FsuCycleNextActionToExecute[]>;
    /**
     ...
     */
    readonly rollbackCycleState: pulumi.Output<string>;
    /**
     * Scheduling related details for the Exadata Fleet Update Action during create operations. The specified time should not conflict with existing Exadata Infrastructure maintenance windows. Null scheduleDetails for Stage and Apply Actions in Exadata Fleet Update Cycle creation would not create Actions. Null scheduleDetails for CreateAction would execute the Exadata Fleet Update Action as soon as possible.
     */
    readonly stageActionSchedule: pulumi.Output<outputs.FleetSoftwareUpdate.FsuCycleStageActionSchedule>;
    /**
     ...
     */
    readonly upgradeDetails: pulumi.Output<outputs.FleetSoftwareUpdate.FsuCycleUpgradeDetails>;
    /**

 ...
 * ```
 */
class FsuReadinessCheck extends pulumi.CustomResource {
    /**
    ...
    static get(name, id, state, opts) {
        return new FsuReadinessCheck(name, state, { ...opts, id: id });
    }
    /**
...
exports.FsuReadinessCheck = FsuReadinessCheck;
/** @internal */
FsuReadinessCheck.__pulumiType = 'oci:FleetSoftwareUpdate/fsuReadinessCheck:FsuReadinessCheck';
//# sourceMappingURL=fsuReadinessCheck.js.map
 ...
 * ```
 */
export declare class FsuReadinessCheck extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: FsuReadinessCheckState, opts?: pulumi.CustomResourceOptions): FsuReadinessCheck;
    /**
     * Returns true if the given object is an instance of FsuReadinessCheck.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is FsuReadinessCheck;
    /**
     ...
     */
    readonly issueCount: pulumi.Output<number>;
    /**
     * Issues found during the Exadata Fleet Update Readiness Check run.
     */
    readonly issues: pulumi.Output<outputs.FleetSoftwareUpdate.FsuReadinessCheckIssue[]>;
    /**
     ...
     */
    readonly targets: pulumi.Output<outputs.FleetSoftwareUpdate.FsuReadinessCheckTarget[]>;
    /**

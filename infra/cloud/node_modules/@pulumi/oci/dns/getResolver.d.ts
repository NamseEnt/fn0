 ...
 * ```
 */
export declare function getResolver(args: GetResolverArgs, opts?: pulumi.InvokeOptions): Promise<GetResolverResult>;
/**
 ...
 * ```
 */
export declare function getResolverOutput(args: GetResolverOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetResolverResult>;
/**
 * A collection of arguments for invoking getResolver.
 */

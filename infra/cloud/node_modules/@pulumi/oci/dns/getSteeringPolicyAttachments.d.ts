 ...
 * ```
 */
export declare function getSteeringPolicyAttachments(args: GetSteeringPolicyAttachmentsArgs, opts?: pulumi.InvokeOptions): Promise<GetSteeringPolicyAttachmentsResult>;
/**
 ...
 * ```
 */
export declare function getSteeringPolicyAttachmentsOutput(args: GetSteeringPolicyAttachmentsOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetSteeringPolicyAttachmentsResult>;
/**
 * A collection of arguments for invoking getSteeringPolicyAttachments.
 */

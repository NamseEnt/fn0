 ...
 */
export declare class Rrset extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: RrsetState, opts?: pulumi.CustomResourceOptions): Rrset;
    /**
     * Returns true if the given object is an instance of Rrset.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is Rrset;
    /**
     ...
     */
    readonly compartmentId: pulumi.Output<string | undefined>;
    /**
     ...
     */
    readonly items: pulumi.Output<outputs.Dns.RrsetItem[]>;
    /**
     * The type of the target RRSet within the target zone.
     */
    readonly rtype: pulumi.Output<string>;
    /**
     ...
     */
    readonly zoneNameOrId: pulumi.Output<string>;
    /**

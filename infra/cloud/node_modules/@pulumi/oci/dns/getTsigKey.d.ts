 ...
 * ```
 */
export declare function getTsigKey(args: GetTsigKeyArgs, opts?: pulumi.InvokeOptions): Promise<GetTsigKeyResult>;
/**
 ...
 * ```
 */
export declare function getTsigKeyOutput(args: GetTsigKeyOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetTsigKeyResult>;
/**
 * A collection of arguments for invoking getTsigKey.
 */

 ...
 * ```
 */
class SteeringPolicyAttachment extends pulumi.CustomResource {
    /**
    ...
    static get(name, id, state, opts) {
        return new SteeringPolicyAttachment(name, state, { ...opts, id: id });
    }
    /**
...
exports.SteeringPolicyAttachment = SteeringPolicyAttachment;
/** @internal */
SteeringPolicyAttachment.__pulumiType = 'oci:Dns/steeringPolicyAttachment:SteeringPolicyAttachment';
//# sourceMappingURL=steeringPolicyAttachment.js.map
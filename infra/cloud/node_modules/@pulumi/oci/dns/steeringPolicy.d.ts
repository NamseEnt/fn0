 ...
 * ```
 */
export declare class SteeringPolicy extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: SteeringPolicyState, opts?: pulumi.CustomResourceOptions): SteeringPolicy;
    /**
     * Returns true if the given object is an instance of SteeringPolicy.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is SteeringPolicy;
    /**
     * The set of all answers that can potentially issue from the steering policy.
     */
    readonly answers: pulumi.Output<outputs.Dns.SteeringPolicyAnswer[]>;
    /**
     ...
     */
    readonly healthCheckMonitorId: pulumi.Output<string>;
    /**
     ...
     */
    readonly rules: pulumi.Output<outputs.Dns.SteeringPolicyRule[]>;
    /**

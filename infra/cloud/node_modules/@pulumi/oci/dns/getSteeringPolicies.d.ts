 ...
 * ```
 */
export declare function getSteeringPolicies(args: GetSteeringPoliciesArgs, opts?: pulumi.InvokeOptions): Promise<GetSteeringPoliciesResult>;
/**
 ...
 * ```
 */
export declare function getSteeringPoliciesOutput(args: GetSteeringPoliciesOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetSteeringPoliciesResult>;
/**
 * A collection of arguments for invoking getSteeringPolicies.
 */

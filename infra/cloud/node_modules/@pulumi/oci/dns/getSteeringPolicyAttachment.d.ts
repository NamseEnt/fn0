 ...
 * ```
 */
export declare function getSteeringPolicyAttachment(args: GetSteeringPolicyAttachmentArgs, opts?: pulumi.InvokeOptions): Promise<GetSteeringPolicyAttachmentResult>;
/**
 ...
 * ```
 */
export declare function getSteeringPolicyAttachmentOutput(args: GetSteeringPolicyAttachmentOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetSteeringPolicyAttachmentResult>;
/**
 * A collection of arguments for invoking getSteeringPolicyAttachment.
 */

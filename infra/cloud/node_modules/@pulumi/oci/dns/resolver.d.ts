...
export declare class Resolver extends pulumi.CustomResource {
     ...
     */
    readonly attachedVcnId: pulumi.Output<string>;
    /**
     * (Updatable) The attached views. Views are evaluated in order.
     */
    readonly attachedViews: pulumi.Output<outputs.Dns.ResolverAttachedView[] | undefined>;
    /**
     ...
     */
    readonly defaultViewId: pulumi.Output<string>;
    /**
     ...
     */
    readonly endpoints: pulumi.Output<outputs.Dns.ResolverEndpoint[]>;
    /**
     ...
     */
    readonly resolverId: pulumi.Output<string>;
    /**
     ...
     */
    readonly rules: pulumi.Output<outputs.Dns.ResolverRule[] | undefined>;
    /**

 ...
 * ```
 */
class DesktopPool extends pulumi.CustomResource {
    /**
    ...
    static get(name, id, state, opts) {
        return new DesktopPool(name, state, { ...opts, id: id });
    }
    /**
...
exports.DesktopPool = DesktopPool;
/** @internal */
DesktopPool.__pulumiType = 'oci:Desktops/desktopPool:DesktopPool';
//# sourceMappingURL=desktopPool.js.map
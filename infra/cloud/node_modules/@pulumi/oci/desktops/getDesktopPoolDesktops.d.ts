 ...
 * ```
 */
export declare function getDesktopPoolDesktops(args: GetDesktopPoolDesktopsArgs, opts?: pulumi.InvokeOptions): Promise<GetDesktopPoolDesktopsResult>;
/**
 ...
 * ```
 */
export declare function getDesktopPoolDesktopsOutput(args: GetDesktopPoolDesktopsOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetDesktopPoolDesktopsResult>;
/**
 * A collection of arguments for invoking getDesktopPoolDesktops.
 */

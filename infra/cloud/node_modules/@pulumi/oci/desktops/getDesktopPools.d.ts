 ...
 * ```
 */
export declare function getDesktopPools(args: GetDesktopPoolsArgs, opts?: pulumi.InvokeOptions): Promise<GetDesktopPoolsResult>;
/**
 ...
 * ```
 */
export declare function getDesktopPoolsOutput(args: GetDesktopPoolsOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetDesktopPoolsResult>;
/**
 * A collection of arguments for invoking getDesktopPools.
 */

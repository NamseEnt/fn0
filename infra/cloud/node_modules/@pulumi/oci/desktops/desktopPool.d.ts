 ...
 * ```
 */
export declare class DesktopPool extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: DesktopPoolState, opts?: pulumi.CustomResourceOptions): DesktopPool;
    /**
     * Returns true if the given object is an instance of DesktopPool.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is DesktopPool;
    /**
     * The number of active desktops in the desktop pool.
     */
    readonly activeDesktops: pulumi.Output<number>;
    /**
     * Indicates whether desktop pool users have administrative privileges on their desktop.
     */
    readonly arePrivilegedUsers: pulumi.Output<boolean>;
    /**
     ...
     */
    readonly areVolumesPreserved: pulumi.Output<boolean | undefined>;
    /**
     ...
     */
    readonly availabilityPolicy: pulumi.Output<outputs.Desktops.DesktopPoolAvailabilityPolicy>;
    /**
     * (Updatable) The size in GBs of the boot volume for the desktop pool.
     */
    readonly bootVolumeSizeInGbs: pulumi.Output<number>;
    /**
     ...
     */
    readonly contactDetails: pulumi.Output<string>;
    /**
     ...
     */
    readonly devicePolicy: pulumi.Output<outputs.Desktops.DesktopPoolDevicePolicy>;
    /**
     ...
     */
    readonly image: pulumi.Output<outputs.Desktops.DesktopPoolImage>;
    /**
     * Indicates whether storage is enabled for the desktop pool.
     */
    readonly isStorageEnabled: pulumi.Output<boolean>;
    /**
     * (Updatable) The maximum number of desktops permitted in the desktop pool.
     */
    readonly maximumSize: pulumi.Output<number>;
    /**
     * Provides information about the network configuration of the desktop pool.
     */
    readonly networkConfiguration: pulumi.Output<outputs.Desktops.DesktopPoolNetworkConfiguration>;
    /**
     ...
     */
    readonly privateAccessDetails: pulumi.Output<outputs.Desktops.DesktopPoolPrivateAccessDetails>;
    /**
     * The details of action to be triggered in case of inactivity or disconnect
     */
    readonly sessionLifecycleActions: pulumi.Output<outputs.Desktops.DesktopPoolSessionLifecycleActions | undefined>;
    /**
     * The compute instance shape configuration requested for each desktop in the desktop pool.
     */
    readonly shapeConfig: pulumi.Output<outputs.Desktops.DesktopPoolShapeConfig>;
    /**
     ...
     */
    readonly standbySize: pulumi.Output<number>;
    /**
     ...
     */
    readonly storageBackupPolicyId: pulumi.Output<string>;
    /**
     ...
     */
    readonly timeStartScheduled: pulumi.Output<string | undefined>;
    /**
     * (Updatable) The stop time of the desktop pool.
     */
    readonly timeStopScheduled: pulumi.Output<string | undefined>;
    /**
     * Indicates whether the desktop pool uses dedicated virtual machine hosts.
     */
    readonly useDedicatedVmHost: pulumi.Output<string>;
    /**

 ...
 * ```
 */
export declare function getDesktopPool(args: GetDesktopPoolArgs, opts?: pulumi.InvokeOptions): Promise<GetDesktopPoolResult>;
/**
 ...
 * ```
 */
export declare function getDesktopPoolOutput(args: GetDesktopPoolOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetDesktopPoolResult>;
/**
 * A collection of arguments for invoking getDesktopPool.
 */

 ...
 * ```
 */
export declare function getNodePools(args: GetNodePoolsArgs, opts?: pulumi.InvokeOptions): Promise<GetNodePoolsResult>;
/**
 ...
 * ```
 */
export declare function getNodePoolsOutput(args: GetNodePoolsOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetNodePoolsResult>;
/**
 * A collection of arguments for invoking getNodePools.
 */

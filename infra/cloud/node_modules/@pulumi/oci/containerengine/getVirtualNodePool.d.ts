 ...
 * ```
 */
export declare function getVirtualNodePoolOutput(args: GetVirtualNodePoolOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetVirtualNodePoolResult>;
/**
 * A collection of arguments for invoking getVirtualNodePool.
 */

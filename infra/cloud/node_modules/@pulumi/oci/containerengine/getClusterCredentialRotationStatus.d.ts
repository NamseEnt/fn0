 ...
 * ```
 */
export declare function getClusterCredentialRotationStatus(args: GetClusterCredentialRotationStatusArgs, opts?: pulumi.InvokeOptions): Promise<GetClusterCredentialRotationStatusResult>;
/**
 ...
 * ```
 */
export declare function getClusterCredentialRotationStatusOutput(args: GetClusterCredentialRotationStatusOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetClusterCredentialRotationStatusResult>;
/**
 * A collection of arguments for invoking getClusterCredentialRotationStatus.
 */

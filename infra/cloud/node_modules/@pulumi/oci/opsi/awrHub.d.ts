 ...
 * ```
 */
export declare class AwrHub extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: AwrHubState, opts?: pulumi.CustomResourceOptions): AwrHub;
    /**
     * Returns true if the given object is an instance of AwrHub.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is AwrHub;
    /**
     * Mailbox URL required for AWR hub and AWR source setup.
     */
    readonly awrMailboxUrl: pulumi.Output<string>;
    /**
     ...
     */
    readonly hubDstTimezoneVersion: pulumi.Output<string>;
    /**

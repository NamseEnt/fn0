 ...
 * ```
 */
export declare class NewsReport extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: NewsReportState, opts?: pulumi.CustomResourceOptions): NewsReport;
    /**
     ...
     */
    readonly matchRule: pulumi.Output<string>;
    /**
     ...
     */
    readonly newsFrequency: pulumi.Output<string>;
    /**
     ...
     */
    readonly tagFilters: pulumi.Output<string[]>;
    /**

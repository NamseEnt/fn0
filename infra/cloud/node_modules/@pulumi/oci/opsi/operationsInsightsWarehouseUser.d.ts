 ...
 * ```
 */
export declare class OperationsInsightsWarehouseUser extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: OperationsInsightsWarehouseUserState, opts?: pulumi.CustomResourceOptions): OperationsInsightsWarehouseUser;
    /**
     ...
     */
    static isInstance(obj: any): obj is OperationsInsightsWarehouseUser;
    /**
     ...
     */
    readonly connectionPassword: pulumi.Output<string>;
    /**
     ...
     */
    readonly isAwrDataAccess: pulumi.Output<boolean>;
    /**
     * (Updatable) Indicate whether user has access to EM data.
     */
    readonly isEmDataAccess: pulumi.Output<boolean>;
    /**
     * (Updatable) Indicate whether user has access to OPSI data.
     */
    readonly isOpsiDataAccess: pulumi.Output<boolean>;
    /**

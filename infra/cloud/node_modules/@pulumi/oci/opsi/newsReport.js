 ...
 * ```
 */
class NewsReport extends pulumi.CustomResource {
    /**
    ...
    static get(name, id, state, opts) {
        return new NewsReport(name, state, { ...opts, id: id });
    }
    /**
...
exports.NewsReport = NewsReport;
/** @internal */
NewsReport.__pulumiType = 'oci:Opsi/newsReport:NewsReport';
//# sourceMappingURL=newsReport.js.map
 ...
 * ```
 */
export declare function getOpsiConfigurations(args: GetOpsiConfigurationsArgs, opts?: pulumi.InvokeOptions): Promise<GetOpsiConfigurationsResult>;
/**
 ...
 * ```
 */
export declare function getOpsiConfigurationsOutput(args: GetOpsiConfigurationsOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetOpsiConfigurationsResult>;
/**
 * A collection of arguments for invoking getOpsiConfigurations.
 */

 ...
 * ```
 */
export declare function getChargebackPlan(args: GetChargebackPlanArgs, opts?: pulumi.InvokeOptions): Promise<GetChargebackPlanResult>;
/**
 ...
 * ```
 */
export declare function getChargebackPlanOutput(args: GetChargebackPlanOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetChargebackPlanResult>;
/**
 * A collection of arguments for invoking getChargebackPlan.
 */

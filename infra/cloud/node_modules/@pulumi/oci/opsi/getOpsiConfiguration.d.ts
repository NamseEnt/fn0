 ...
 * ```
 */
export declare function getOpsiConfiguration(args: GetOpsiConfigurationArgs, opts?: pulumi.InvokeOptions): Promise<GetOpsiConfigurationResult>;
/**
 ...
 * ```
 */
export declare function getOpsiConfigurationOutput(args: GetOpsiConfigurationOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetOpsiConfigurationResult>;
/**
 * A collection of arguments for invoking getOpsiConfiguration.
 */

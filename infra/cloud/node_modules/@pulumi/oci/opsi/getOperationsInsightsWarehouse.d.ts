 ...
 * ```
 */
export declare function getOperationsInsightsWarehouse(args: GetOperationsInsightsWarehouseArgs, opts?: pulumi.InvokeOptions): Promise<GetOperationsInsightsWarehouseResult>;
/**
 ...
 * ```
 */
export declare function getOperationsInsightsWarehouseOutput(args: GetOperationsInsightsWarehouseOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetOperationsInsightsWarehouseResult>;
/**
 * A collection of arguments for invoking getOperationsInsightsWarehouse.
 */

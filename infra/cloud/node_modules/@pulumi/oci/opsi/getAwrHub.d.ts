 ...
 * ```
 */
export declare function getAwrHub(args: GetAwrHubArgs, opts?: pulumi.InvokeOptions): Promise<GetAwrHubResult>;
/**
 ...
 * ```
 */
export declare function getAwrHubOutput(args: GetAwrHubOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetAwrHubResult>;
/**
 * A collection of arguments for invoking getAwrHub.
 */

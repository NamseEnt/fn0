 ...
 * ```
 */
class OperationsInsightsWarehouseUser extends pulumi.CustomResource {
    /**
    ...
    static get(name, id, state, opts) {
        return new OperationsInsightsWarehouseUser(name, state, { ...opts, id: id });
    }
    /**
...
exports.OperationsInsightsWarehouseUser = OperationsInsightsWarehouseUser;
/** @internal */
OperationsInsightsWarehouseUser.__pulumiType = 'oci:Opsi/operationsInsightsWarehouseUser:OperationsInsightsWarehouseUser';
//# sourceMappingURL=operationsInsightsWarehouseUser.js.map
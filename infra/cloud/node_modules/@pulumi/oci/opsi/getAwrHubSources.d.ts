 ...
 * ```
 */
export declare function getAwrHubSources(args: GetAwrHubSourcesArgs, opts?: pulumi.InvokeOptions): Promise<GetAwrHubSourcesResult>;
/**
 ...
 * ```
 */
export declare function getAwrHubSourcesOutput(args: GetAwrHubSourcesOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetAwrHubSourcesResult>;
/**
 * A collection of arguments for invoking getAwrHubSources.
 */

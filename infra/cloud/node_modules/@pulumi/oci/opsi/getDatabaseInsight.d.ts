 ...
 * ```
 */
export declare function getDatabaseInsight(args: GetDatabaseInsightArgs, opts?: pulumi.InvokeOptions): Promise<GetDatabaseInsightResult>;
/**
 ...
 * ```
 */
export declare function getDatabaseInsightOutput(args: GetDatabaseInsightOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetDatabaseInsightResult>;
/**
 * A collection of arguments for invoking getDatabaseInsight.
 */

 ...
 * ```
 */
export declare function getExadataInsight(args: GetExadataInsightArgs, opts?: pulumi.InvokeOptions): Promise<GetExadataInsightResult>;
/**
 ...
 * ```
 */
export declare function getExadataInsightOutput(args: GetExadataInsightOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetExadataInsightResult>;
/**
 * A collection of arguments for invoking getExadataInsight.
 */

 ...
 * ```
 */
export declare function getBucketSummaries(args: GetBucketSummariesArgs, opts?: pulumi.InvokeOptions): Promise<GetBucketSummariesResult>;
/**
 ...
 * ```
 */
export declare function getBucketSummariesOutput(args: GetBucketSummariesOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetBucketSummariesResult>;
/**
 * A collection of arguments for invoking getBucketSummaries.
 */

 ...
 * ```
 */
class StorageObject extends pulumi.CustomResource {
    /**
    ...
    static get(name, id, state, opts) {
        return new StorageObject(name, state, { ...opts, id: id });
    }
    /**
...
/** @internal */
StorageObject.__pulumiType = 'oci:ObjectStorage/storageObject:StorageObject';

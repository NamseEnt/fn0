 ...
 * ```
 */
export declare function getPreauthrequest(args: GetPreauthrequestArgs, opts?: pulumi.InvokeOptions): Promise<GetPreauthrequestResult>;
/**
 ...
 * ```
 */
export declare function getPreauthrequestOutput(args: GetPreauthrequestOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetPreauthrequestResult>;
/**
 * A collection of arguments for invoking getPreauthrequest.
 */

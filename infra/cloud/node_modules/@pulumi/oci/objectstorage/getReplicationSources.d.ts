 ...
 * ```
 */
export declare function getReplicationSources(args: GetReplicationSourcesArgs, opts?: pulumi.InvokeOptions): Promise<GetReplicationSourcesResult>;
/**
 ...
 * ```
 */
export declare function getReplicationSourcesOutput(args: GetReplicationSourcesOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetReplicationSourcesResult>;
/**
 * A collection of arguments for invoking getReplicationSources.
 */

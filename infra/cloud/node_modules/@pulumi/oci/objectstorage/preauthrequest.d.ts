 ...
 * ```
 */
export declare class Preauthrequest extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: PreauthrequestState, opts?: pulumi.CustomResourceOptions): Preauthrequest;
    /**
     * Returns true if the given object is an instance of Preauthrequest.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is Preauthrequest;
    /**
     ...
     */
    readonly accessUri: pulumi.Output<string>;
    /**
     ...
     */
    readonly bucketListingAction: pulumi.Output<string>;
    /**
     ...
     */
    readonly parId: pulumi.Output<string>;
    /**

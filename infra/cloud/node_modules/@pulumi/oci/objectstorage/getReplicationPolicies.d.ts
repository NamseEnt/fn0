 ...
 * ```
 */
export declare function getReplicationPolicies(args: GetReplicationPoliciesArgs, opts?: pulumi.InvokeOptions): Promise<GetReplicationPoliciesResult>;
/**
 ...
 * ```
 */
export declare function getReplicationPoliciesOutput(args: GetReplicationPoliciesOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetReplicationPoliciesResult>;
/**
 * A collection of arguments for invoking getReplicationPolicies.
 */

 ...
 * ```
 */
export declare function getObjectVersions(args: GetObjectVersionsArgs, opts?: pulumi.InvokeOptions): Promise<GetObjectVersionsResult>;
/**
 ...
 * ```
 */
export declare function getObjectVersionsOutput(args: GetObjectVersionsOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetObjectVersionsResult>;
/**
 * A collection of arguments for invoking getObjectVersions.
 */

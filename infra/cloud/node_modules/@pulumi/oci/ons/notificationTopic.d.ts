 ...
 * ```
 */
export declare class NotificationTopic extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: NotificationTopicState, opts?: pulumi.CustomResourceOptions): NotificationTopic;
    /**
     * Returns true if the given object is an instance of NotificationTopic.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is NotificationTopic;
    /**
     ...
     */
    readonly shortTopicId: pulumi.Output<string>;
    /**

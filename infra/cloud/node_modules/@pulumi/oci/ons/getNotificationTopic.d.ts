 ...
 * ```
 */
export declare function getNotificationTopic(args: GetNotificationTopicArgs, opts?: pulumi.InvokeOptions): Promise<GetNotificationTopicResult>;
/**
 ...
 * ```
 */
export declare function getNotificationTopicOutput(args: GetNotificationTopicOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetNotificationTopicResult>;
/**
 * A collection of arguments for invoking getNotificationTopic.
 */

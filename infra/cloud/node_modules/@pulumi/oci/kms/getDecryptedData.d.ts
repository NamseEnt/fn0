 ...
 * ```
 */
export declare function getDecryptedData(args: GetDecryptedDataArgs, opts?: pulumi.InvokeOptions): Promise<GetDecryptedDataResult>;
/**
 ...
 * ```
 */
export declare function getDecryptedDataOutput(args: GetDecryptedDataOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetDecryptedDataResult>;
/**
 * A collection of arguments for invoking getDecryptedData.
 */

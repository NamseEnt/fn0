 ...
 * ```
 */
export declare function getKeyVersion(args: GetKeyVersionArgs, opts?: pulumi.InvokeOptions): Promise<GetKeyVersionResult>;
/**
 ...
 * ```
 */
export declare function getKeyVersionOutput(args: GetKeyVersionOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetKeyVersionResult>;
/**
 * A collection of arguments for invoking getKeyVersion.
 */

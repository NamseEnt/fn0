 ...
 */
export declare class GeneratedKey extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: GeneratedKeyState, opts?: pulumi.CustomResourceOptions): GeneratedKey;
    /**
     * Returns true if the given object is an instance of GeneratedKey.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is GeneratedKey;
    /**
     * Information that can be used to provide an encryption context for the encrypted data. The length of the string representation of the associated data must be fewer than 4096 characters.
     */
    readonly associatedData: pulumi.Output<{
        [key: string]: string;
    } | undefined>;
    /**
     ...
     */
    readonly includePlaintextKey: pulumi.Output<boolean>;
    /**
     ...
     */
    readonly keyShape: pulumi.Output<outputs.Kms.GeneratedKeyKeyShape>;
    /**
     ...
     */
    readonly loggingContext: pulumi.Output<{
        [key: string]: string;
    } | undefined>;
    /**
     ...
     */
    readonly plaintextChecksum: pulumi.Output<string>;
    /**

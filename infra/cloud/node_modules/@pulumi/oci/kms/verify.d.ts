 ...
 * ```
 */
export declare class Verify extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: VerifyState, opts?: pulumi.CustomResourceOptions): Verify;
    /**
     * Returns true if the given object is an instance of Verify.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is Verify;
    /**
     ...
     */
    readonly isSignatureValid: pulumi.Output<boolean>;
    /**

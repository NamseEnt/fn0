...
export declare class Vault extends pulumi.CustomResource {
     ...
     */
    readonly cryptoEndpoint: pulumi.Output<string>;
    /**
     ...
     */
    readonly externalKeyManagerMetadata: pulumi.Output<outputs.Kms.VaultExternalKeyManagerMetadata>;
    /**
     * Summary about metadata of external key manager to be returned to the customer as a response.
     */
    readonly externalKeyManagerMetadataSummaries: pulumi.Output<outputs.Kms.VaultExternalKeyManagerMetadataSummary[]>;
    /**
     ...
     */
    readonly isVaultReplicable: pulumi.Output<boolean>;
    /**
     ...
     */
    readonly replicaDetails: pulumi.Output<outputs.Kms.VaultReplicaDetail[]>;
    /**
     * (Updatable) Details where vault was backed up.
     */
    readonly restoreFromFile: pulumi.Output<outputs.Kms.VaultRestoreFromFile | undefined>;
    /**
     * (Updatable) Details where vault was backed up
     */
    readonly restoreFromObjectStore: pulumi.Output<outputs.Kms.VaultRestoreFromObjectStore | undefined>;
    readonly restoreTrigger: pulumi.Output<boolean | undefined>;
    /**
     * The OCID of the vault from which this vault was restored, if it was restored from a backup file. If you restore a vault to the same region, the vault retains the same OCID that it had when you backed up the vault.
     */
    readonly restoredFromVaultId: pulumi.Output<string>;
    /**

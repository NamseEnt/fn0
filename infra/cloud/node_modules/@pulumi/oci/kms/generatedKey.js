 ...
 */
class GeneratedKey extends pulumi.CustomResource {
    /**
    ...
    static get(name, id, state, opts) {
        return new GeneratedKey(name, state, { ...opts, id: id });
    }
    /**
...
exports.GeneratedKey = GeneratedKey;
/** @internal */
GeneratedKey.__pulumiType = 'oci:Kms/generatedKey:GeneratedKey';

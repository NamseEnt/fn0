 ...
 * ```
 */
export declare class ZprPolicy extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ZprPolicyState, opts?: pulumi.CustomResourceOptions): ZprPolicy;
    /**
     * Returns true if the given object is an instance of ZprPolicy.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is ZprPolicy;
    /**
     ...
     */
    readonly statements: pulumi.Output<string[]>;
    /**

 ...
 * ```
 */
class ZprPolicy extends pulumi.CustomResource {
    /**
    ...
    static get(name, id, state, opts) {
        return new ZprPolicy(name, state, { ...opts, id: id });
    }
    /**
...
exports.ZprPolicy = ZprPolicy;
/** @internal */
ZprPolicy.__pulumiType = 'oci:Zpr/zprPolicy:ZprPolicy';
//# sourceMappingURL=zprPolicy.js.map
 ...
 * ```
 */
export declare function getRecommendation(args: GetRecommendationArgs, opts?: pulumi.InvokeOptions): Promise<GetRecommendationResult>;
/**
 ...
 * ```
 */
export declare function getRecommendationOutput(args: GetRecommendationOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetRecommendationResult>;
/**
 * A collection of arguments for invoking getRecommendation.
 */

 ...
 * ```
 */
export declare function getRecommendationsOutput(args: GetRecommendationsOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetRecommendationsResult>;
/**
 * A collection of arguments for invoking getRecommendations.
 */

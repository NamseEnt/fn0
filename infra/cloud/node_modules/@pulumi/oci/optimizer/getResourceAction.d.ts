 ...
 * ```
 */
export declare function getResourceAction(args: GetResourceActionArgs, opts?: pulumi.InvokeOptions): Promise<GetResourceActionResult>;
/**
 ...
 * ```
 */
export declare function getResourceActionOutput(args: GetResourceActionOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetResourceActionResult>;
/**
 * A collection of arguments for invoking getResourceAction.
 */

 ...
 * ```
 */
export declare function getProfileLevels(args: GetProfileLevelsArgs, opts?: pulumi.InvokeOptions): Promise<GetProfileLevelsResult>;
/**
 ...
 * ```
 */
export declare function getProfileLevelsOutput(args: GetProfileLevelsOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetProfileLevelsResult>;
/**
 * A collection of arguments for invoking getProfileLevels.
 */

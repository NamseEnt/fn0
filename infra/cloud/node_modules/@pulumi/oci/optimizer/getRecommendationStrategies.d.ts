 ...
 * ```
 */
export declare function getRecommendationStrategies(args: GetRecommendationStrategiesArgs, opts?: pulumi.InvokeOptions): Promise<GetRecommendationStrategiesResult>;
/**
 ...
 * ```
 */
export declare function getRecommendationStrategiesOutput(args: GetRecommendationStrategiesOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetRecommendationStrategiesResult>;
/**
 * A collection of arguments for invoking getRecommendationStrategies.
 */

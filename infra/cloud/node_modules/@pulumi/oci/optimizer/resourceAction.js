 ...
 * ```
 */
class ResourceAction extends pulumi.CustomResource {
    /**
    ...
    static get(name, id, state, opts) {
        return new ResourceAction(name, state, { ...opts, id: id });
    }
    /**
...
/** @internal */
ResourceAction.__pulumiType = 'oci:Optimizer/resourceAction:ResourceAction';

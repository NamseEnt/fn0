 ...
 * ```
 */
export declare function getStreamPackagingConfig(args: GetStreamPackagingConfigArgs, opts?: pulumi.InvokeOptions): Promise<GetStreamPackagingConfigResult>;
/**
 ...
 * ```
 */
export declare function getStreamPackagingConfigOutput(args: GetStreamPackagingConfigOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetStreamPackagingConfigResult>;
/**
 * A collection of arguments for invoking getStreamPackagingConfig.
 */

 ...
 * ```
 */
export declare function getMediaWorkflowJobFacts(args: GetMediaWorkflowJobFactsArgs, opts?: pulumi.InvokeOptions): Promise<GetMediaWorkflowJobFactsResult>;
/**
 ...
 * ```
 */
export declare function getMediaWorkflowJobFactsOutput(args: GetMediaWorkflowJobFactsOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetMediaWorkflowJobFactsResult>;
/**
 * A collection of arguments for invoking getMediaWorkflowJobFacts.
 */

 ...
 * ```
 */
export declare class StreamPackagingConfig extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: StreamPackagingConfigState, opts?: pulumi.CustomResourceOptions): StreamPackagingConfig;
    /**
     * Returns true if the given object is an instance of StreamPackagingConfig.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is StreamPackagingConfig;
    /**
     ...
     */
    readonly distributionChannelId: pulumi.Output<string>;
    /**
     * The encryption used by the stream packaging configuration.
     */
    readonly encryption: pulumi.Output<outputs.MediaServices.StreamPackagingConfigEncryption>;
    /**
     ...
     */
    readonly locks: pulumi.Output<outputs.MediaServices.StreamPackagingConfigLock[]>;
    /**
     * The duration in seconds for each fragment.
     */
    readonly segmentTimeInSeconds: pulumi.Output<number>;
    /**
     ...
     */
    readonly streamPackagingFormat: pulumi.Output<string>;
    /**

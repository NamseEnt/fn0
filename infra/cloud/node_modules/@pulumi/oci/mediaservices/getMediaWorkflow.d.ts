 ...
 * ```
 */
export declare function getMediaWorkflow(args: GetMediaWorkflowArgs, opts?: pulumi.InvokeOptions): Promise<GetMediaWorkflowResult>;
/**
 ...
 * ```
 */
export declare function getMediaWorkflowOutput(args: GetMediaWorkflowOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetMediaWorkflowResult>;
/**
 * A collection of arguments for invoking getMediaWorkflow.
 */

 ...
 * ```
 */
export declare function getMediaAsset(args: GetMediaAssetArgs, opts?: pulumi.InvokeOptions): Promise<GetMediaAssetResult>;
/**
 ...
 * ```
 */
export declare function getMediaAssetOutput(args: GetMediaAssetOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetMediaAssetResult>;
/**
 * A collection of arguments for invoking getMediaAsset.
 */

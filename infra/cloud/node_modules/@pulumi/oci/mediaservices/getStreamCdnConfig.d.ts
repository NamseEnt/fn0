 ...
 * ```
 */
export declare function getStreamCdnConfig(args: GetStreamCdnConfigArgs, opts?: pulumi.InvokeOptions): Promise<GetStreamCdnConfigResult>;
/**
 ...
 * ```
 */
export declare function getStreamCdnConfigOutput(args: GetStreamCdnConfigOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetStreamCdnConfigResult>;
/**
 * A collection of arguments for invoking getStreamCdnConfig.
 */

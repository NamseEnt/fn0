 ...
 * ```
 */
class MediaWorkflow extends pulumi.CustomResource {
    /**
    ...
    static get(name, id, state, opts) {
        return new MediaWorkflow(name, state, { ...opts, id: id });
    }
    /**
...
/** @internal */
MediaWorkflow.__pulumiType = 'oci:MediaServices/mediaWorkflow:MediaWorkflow';
//# sourceMappingURL=mediaWorkflow.js.map
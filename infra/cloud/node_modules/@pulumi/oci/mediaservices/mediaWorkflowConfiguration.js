 ...
 * ```
 */
class MediaWorkflowConfiguration extends pulumi.CustomResource {
    /**
    ...
    static get(name, id, state, opts) {
        return new MediaWorkflowConfiguration(name, state, { ...opts, id: id });
    }
    /**
...
exports.MediaWorkflowConfiguration = MediaWorkflowConfiguration;
/** @internal */
MediaWorkflowConfiguration.__pulumiType = 'oci:MediaServices/mediaWorkflowConfiguration:MediaWorkflowConfiguration';
//# sourceMappingURL=mediaWorkflowConfiguration.js.map
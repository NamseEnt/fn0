 ...
 * ```
 */
class StreamPackagingConfig extends pulumi.CustomResource {
    /**
    ...
    static get(name, id, state, opts) {
        return new StreamPackagingConfig(name, state, { ...opts, id: id });
    }
    /**
...
exports.StreamPackagingConfig = StreamPackagingConfig;
/** @internal */
StreamPackagingConfig.__pulumiType = 'oci:MediaServices/streamPackagingConfig:StreamPackagingConfig';
//# sourceMappingURL=streamPackagingConfig.js.map
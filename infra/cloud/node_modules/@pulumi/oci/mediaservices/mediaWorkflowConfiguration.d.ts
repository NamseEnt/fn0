 ...
 * ```
 */
export declare class MediaWorkflowConfiguration extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: MediaWorkflowConfigurationState, opts?: pulumi.CustomResourceOptions): MediaWorkflowConfiguration;
    /**
     ...
     */
    static isInstance(obj: any): obj is MediaWorkflowConfiguration;
    /**
     ...
     */
    readonly locks: pulumi.Output<outputs.MediaServices.MediaWorkflowConfigurationLock[]>;
    /**

 ...
 * ```
 */
export declare function getManagementAgentImages(args: GetManagementAgentImagesArgs, opts?: pulumi.InvokeOptions): Promise<GetManagementAgentImagesResult>;
/**
 ...
 * ```
 */
export declare function getManagementAgentImagesOutput(args: GetManagementAgentImagesOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetManagementAgentImagesResult>;
/**
 * A collection of arguments for invoking getManagementAgentImages.
 */

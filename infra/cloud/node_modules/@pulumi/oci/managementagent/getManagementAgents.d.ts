 ...
 * ```
 */
export declare function getManagementAgents(args: GetManagementAgentsArgs, opts?: pulumi.InvokeOptions): Promise<GetManagementAgentsResult>;
/**
 ...
 * ```
 */
export declare function getManagementAgentsOutput(args: GetManagementAgentsOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetManagementAgentsResult>;
/**
 * A collection of arguments for invoking getManagementAgents.
 */

 ...
 * ```
 */
export declare function getManagementAgent(args: GetManagementAgentArgs, opts?: pulumi.InvokeOptions): Promise<GetManagementAgentResult>;
/**
 ...
 * ```
 */
export declare function getManagementAgentOutput(args: GetManagementAgentOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetManagementAgentResult>;
/**
 * A collection of arguments for invoking getManagementAgent.
 */

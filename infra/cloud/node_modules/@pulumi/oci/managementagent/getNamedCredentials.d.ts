 ...
 * ```
 */
export declare function getNamedCredentials(args: GetNamedCredentialsArgs, opts?: pulumi.InvokeOptions): Promise<GetNamedCredentialsResult>;
/**
 ...
 * ```
 */
export declare function getNamedCredentialsOutput(args: GetNamedCredentialsOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetNamedCredentialsResult>;
/**
 * A collection of arguments for invoking getNamedCredentials.
 */

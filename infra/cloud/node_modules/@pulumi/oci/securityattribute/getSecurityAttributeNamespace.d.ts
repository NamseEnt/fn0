 ...
 * ```
 */
export declare function getSecurityAttributeNamespace(args: GetSecurityAttributeNamespaceArgs, opts?: pulumi.InvokeOptions): Promise<GetSecurityAttributeNamespaceResult>;
/**
 ...
 * ```
 */
export declare function getSecurityAttributeNamespaceOutput(args: GetSecurityAttributeNamespaceOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetSecurityAttributeNamespaceResult>;
/**
 * A collection of arguments for invoking getSecurityAttributeNamespace.
 */

 ...
 * ```
 */
export declare function getSecurityAttributes(args: GetSecurityAttributesArgs, opts?: pulumi.InvokeOptions): Promise<GetSecurityAttributesResult>;
/**
 ...
 * ```
 */
export declare function getSecurityAttributesOutput(args: GetSecurityAttributesOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetSecurityAttributesResult>;
/**
 * A collection of arguments for invoking getSecurityAttributes.
 */

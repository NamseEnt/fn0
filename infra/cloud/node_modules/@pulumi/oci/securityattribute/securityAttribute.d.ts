 ...
 * ```
 */
export declare class SecurityAttribute extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: SecurityAttributeState, opts?: pulumi.CustomResourceOptions): SecurityAttribute;
    /**
     * Returns true if the given object is an instance of SecurityAttribute.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is SecurityAttribute;
    /**
     ...
     */
    readonly isRetired: pulumi.Output<boolean>;
    /**
     ...
     */
    readonly securityAttributeNamespaceId: pulumi.Output<string>;
    /**
     * The name of the security attribute namespace that contains the security attribute.
     */
    readonly securityAttributeNamespaceName: pulumi.Output<string>;
    /**
     ...
     */
    readonly validator: pulumi.Output<outputs.SecurityAttribute.SecurityAttributeValidator | undefined>;
    /**

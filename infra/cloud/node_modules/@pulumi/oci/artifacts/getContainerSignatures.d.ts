 ...
 * ```
 */
export declare function getContainerSignatures(args: GetContainerSignaturesArgs, opts?: pulumi.InvokeOptions): Promise<GetContainerSignaturesResult>;
/**
 ...
 * ```
 */
export declare function getContainerSignaturesOutput(args: GetContainerSignaturesOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetContainerSignaturesResult>;
/**
 * A collection of arguments for invoking getContainerSignatures.
 */

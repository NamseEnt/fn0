 ...
 * ```
 */
export declare function getGenericArtifacts(args: GetGenericArtifactsArgs, opts?: pulumi.InvokeOptions): Promise<GetGenericArtifactsResult>;
/**
 ...
 * ```
 */
export declare function getGenericArtifactsOutput(args: GetGenericArtifactsOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetGenericArtifactsResult>;
/**
 * A collection of arguments for invoking getGenericArtifacts.
 */

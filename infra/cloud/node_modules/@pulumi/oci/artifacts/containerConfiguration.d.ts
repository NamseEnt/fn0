 ...
 * ```
 */
export declare class ContainerConfiguration extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ContainerConfigurationState, opts?: pulumi.CustomResourceOptions): ContainerConfiguration;
    /**
     * Returns true if the given object is an instance of ContainerConfiguration.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is ContainerConfiguration;
     ...
     */
    readonly isRepositoryCreatedOnFirstPush: pulumi.Output<boolean>;
    /**

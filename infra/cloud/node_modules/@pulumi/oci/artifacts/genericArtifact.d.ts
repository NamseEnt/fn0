 ...
 * ```
 */
export declare class GenericArtifact extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: GenericArtifactState, opts?: pulumi.CustomResourceOptions): GenericArtifact;
    /**
     * Returns true if the given object is an instance of GenericArtifact.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is GenericArtifact;
    /**
     ...
     */
    readonly artifactPath: pulumi.Output<string>;
    /**

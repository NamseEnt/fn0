 ...
 * ```
 */
export declare class SensitiveType extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: SensitiveTypeState, opts?: pulumi.CustomResourceOptions): SensitiveType;
    /**
     * Returns true if the given object is an instance of SensitiveType.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is SensitiveType;
    /**
     * (Updatable) A regular expression to be used by data discovery for matching column comments.
     */
    readonly commentPattern: pulumi.Output<string>;
    /**
     ...
     */
    readonly dataPattern: pulumi.Output<string>;
    /**
     ...
     */
    readonly defaultMaskingFormatId: pulumi.Output<string>;
    /**

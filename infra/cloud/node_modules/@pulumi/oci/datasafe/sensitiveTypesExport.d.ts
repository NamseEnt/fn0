 ...
 * ```
 */
export declare class SensitiveTypesExport extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: SensitiveTypesExportState, opts?: pulumi.CustomResourceOptions): SensitiveTypesExport;
    /**
     * Returns true if the given object is an instance of SensitiveTypesExport.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is SensitiveTypesExport;
    /**
     ...
     */
    readonly sensitiveTypeIdsForExports: pulumi.Output<string[]>;
    /**

 ...
 * ```
 */
export declare class SdmMaskingPolicyDifference extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: SdmMaskingPolicyDifferenceState, opts?: pulumi.CustomResourceOptions): SdmMaskingPolicyDifference;
    /**
     ...
     */
    static isInstance(obj: any): obj is SdmMaskingPolicyDifference;
    /**
     ...
     */
    readonly differenceType: pulumi.Output<string>;
    /**
     ...
     */
    readonly timeCreationStarted: pulumi.Output<string>;
    /**

 ...
 * ```
 */
export declare function getSensitiveDataModelsSensitiveColumn(args: GetSensitiveDataModelsSensitiveColumnArgs, opts?: pulumi.InvokeOptions): Promise<GetSensitiveDataModelsSensitiveColumnResult>;
/**
 ...
 * ```
 */
export declare function getSensitiveDataModelsSensitiveColumnOutput(args: GetSensitiveDataModelsSensitiveColumnOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetSensitiveDataModelsSensitiveColumnResult>;
/**
 * A collection of arguments for invoking getSensitiveDataModelsSensitiveColumn.
 */

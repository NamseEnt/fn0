 ...
 * ```
 */
export declare function getTargetDatabasePeerTargetDatabase(args: GetTargetDatabasePeerTargetDatabaseArgs, opts?: pulumi.InvokeOptions): Promise<GetTargetDatabasePeerTargetDatabaseResult>;
/**
 ...
 * ```
 */
export declare function getTargetDatabasePeerTargetDatabaseOutput(args: GetTargetDatabasePeerTargetDatabaseOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetTargetDatabasePeerTargetDatabaseResult>;
/**
 * A collection of arguments for invoking getTargetDatabasePeerTargetDatabase.
 */

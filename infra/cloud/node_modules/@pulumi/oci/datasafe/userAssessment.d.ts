 ...
 * ```
 */
export declare class UserAssessment extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: UserAssessmentState, opts?: pulumi.CustomResourceOptions): UserAssessment;
    /**
     * Returns true if the given object is an instance of UserAssessment.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is UserAssessment;
    /**
     ...
     */
    readonly ignoredAssessmentIds: pulumi.Output<string[]>;
    /**
     * List containing maps as values. Example: `{"Operations": [ {"CostCenter": "42"} ] }`
     */
    readonly ignoredTargets: pulumi.Output<outputs.DataSafe.UserAssessmentIgnoredTarget[]>;
    /**
     * (Updatable) Indicates whether the assessment is scheduled to run.
     */
    readonly isAssessmentScheduled: pulumi.Output<boolean>;
    /**
     * Indicates if the user assessment is set as a baseline. This is applicable only to saved user assessments.
     */
    readonly isBaseline: pulumi.Output<boolean>;
    /**
     * Indicates if the user assessment deviates from the baseline.
     */
    readonly isDeviatedFromBaseline: pulumi.Output<boolean>;
    /**
     * The OCID of the last user assessment baseline against which the latest assessment was compared.
     */
    readonly lastComparedBaselineId: pulumi.Output<string>;
    /**
     ...
     */
    readonly scheduleAssessmentId: pulumi.Output<string>;
    /**
     ...
     */
    readonly statistics: pulumi.Output<string>;
    /**
     ...
     */
    readonly timeLastAssessed: pulumi.Output<string>;
    /**

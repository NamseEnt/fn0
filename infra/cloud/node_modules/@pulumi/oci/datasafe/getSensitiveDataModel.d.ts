 ...
 * ```
 */
export declare function getSensitiveDataModel(args: GetSensitiveDataModelArgs, opts?: pulumi.InvokeOptions): Promise<GetSensitiveDataModelResult>;
/**
 ...
 * ```
 */
export declare function getSensitiveDataModelOutput(args: GetSensitiveDataModelOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetSensitiveDataModelResult>;
/**
 * A collection of arguments for invoking getSensitiveDataModel.
 */

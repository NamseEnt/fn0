 ...
 * ```
 */
export declare function getUserAssessmentProfiles(args: GetUserAssessmentProfilesArgs, opts?: pulumi.InvokeOptions): Promise<GetUserAssessmentProfilesResult>;
/**
 ...
 * ```
 */
export declare function getUserAssessmentProfilesOutput(args: GetUserAssessmentProfilesOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetUserAssessmentProfilesResult>;
/**
 * A collection of arguments for invoking getUserAssessmentProfiles.
 */

 ...
 * ```
 */
export declare function getAuditEvents(args: GetAuditEventsArgs, opts?: pulumi.InvokeOptions): Promise<GetAuditEventsResult>;
/**
 ...
 * ```
 */
export declare function getAuditEventsOutput(args: GetAuditEventsOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetAuditEventsResult>;
/**
 * A collection of arguments for invoking getAuditEvents.
 */

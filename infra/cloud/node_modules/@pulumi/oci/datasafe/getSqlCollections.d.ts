 ...
 * ```
 */
export declare function getSqlCollectionsOutput(args: GetSqlCollectionsOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetSqlCollectionsResult>;
/**
 * A collection of arguments for invoking getSqlCollections.
 */

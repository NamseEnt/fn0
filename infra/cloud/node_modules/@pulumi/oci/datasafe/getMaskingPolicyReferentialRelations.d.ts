 ...
 * ```
 */
export declare function getMaskingPolicyReferentialRelations(args: GetMaskingPolicyReferentialRelationsArgs, opts?: pulumi.InvokeOptions): Promise<GetMaskingPolicyReferentialRelationsResult>;
/**
 ...
 * ```
 */
export declare function getMaskingPolicyReferentialRelationsOutput(args: GetMaskingPolicyReferentialRelationsOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetMaskingPolicyReferentialRelationsResult>;
/**
 * A collection of arguments for invoking getMaskingPolicyReferentialRelations.
 */

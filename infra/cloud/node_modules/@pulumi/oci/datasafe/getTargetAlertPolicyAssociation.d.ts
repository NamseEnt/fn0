 ...
 * ```
 */
export declare function getTargetAlertPolicyAssociation(args: GetTargetAlertPolicyAssociationArgs, opts?: pulumi.InvokeOptions): Promise<GetTargetAlertPolicyAssociationResult>;
/**
 ...
 * ```
 */
export declare function getTargetAlertPolicyAssociationOutput(args: GetTargetAlertPolicyAssociationOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetTargetAlertPolicyAssociationResult>;
/**
 * A collection of arguments for invoking getTargetAlertPolicyAssociation.
 */

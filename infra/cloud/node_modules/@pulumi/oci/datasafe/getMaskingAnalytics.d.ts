 ...
 * ```
 */
export declare function getMaskingAnalytics(args: GetMaskingAnalyticsArgs, opts?: pulumi.InvokeOptions): Promise<GetMaskingAnalyticsResult>;
/**
 ...
 * ```
 */
export declare function getMaskingAnalyticsOutput(args: GetMaskingAnalyticsOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetMaskingAnalyticsResult>;
/**
 * A collection of arguments for invoking getMaskingAnalytics.
 */

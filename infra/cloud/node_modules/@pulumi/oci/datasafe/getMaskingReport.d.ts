 ...
 * ```
 */
export declare function getMaskingReport(args: GetMaskingReportArgs, opts?: pulumi.InvokeOptions): Promise<GetMaskingReportResult>;
/**
 ...
 * ```
 */
export declare function getMaskingReportOutput(args: GetMaskingReportOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetMaskingReportResult>;
/**
 * A collection of arguments for invoking getMaskingReport.
 */

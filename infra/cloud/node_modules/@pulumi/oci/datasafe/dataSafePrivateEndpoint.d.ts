 ...
 * ```
 */
export declare class DataSafePrivateEndpoint extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: DataSafePrivateEndpointState, opts?: pulumi.CustomResourceOptions): DataSafePrivateEndpoint;
    /**
     * Returns true if the given object is an instance of DataSafePrivateEndpoint.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is DataSafePrivateEndpoint;
    /**

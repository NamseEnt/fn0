 ...
 * ```
 */
export declare class AuditProfileManagement extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: AuditProfileManagementState, opts?: pulumi.CustomResourceOptions): AuditProfileManagement;
    /**
     * Returns true if the given object is an instance of AuditProfileManagement.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is AuditProfileManagement;
    /**
     ...
     */
    readonly auditTrails: pulumi.Output<outputs.DataSafe.AuditProfileManagementAuditTrail[]>;
    /**
     ...
     */
    readonly isPaidUsageEnabled: pulumi.Output<boolean>;
    /**

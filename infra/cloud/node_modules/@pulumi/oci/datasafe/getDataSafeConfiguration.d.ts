 ...
 * ```
 */
export declare function getDataSafeConfiguration(args: GetDataSafeConfigurationArgs, opts?: pulumi.InvokeOptions): Promise<GetDataSafeConfigurationResult>;
/**
 ...
 * ```
 */
export declare function getDataSafeConfigurationOutput(args: GetDataSafeConfigurationOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetDataSafeConfigurationResult>;
/**
 * A collection of arguments for invoking getDataSafeConfiguration.
 */

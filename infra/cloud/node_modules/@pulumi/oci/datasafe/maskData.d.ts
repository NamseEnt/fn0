...
export declare class MaskData extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: MaskDataState, opts?: pulumi.CustomResourceOptions): MaskData;
    /**
     * Returns true if the given object is an instance of MaskData.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is MaskData;
    readonly maskingPolicyId: pulumi.Output<string>;
    readonly targetCredentials: pulumi.Output<outputs.DataSafe.MaskDataTargetCredentials | undefined>;
     ...
     */
    constructor(name: string, args: MaskDataArgs, opts?: pulumi.CustomResourceOptions);
}
/**

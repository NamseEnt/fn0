 ...
 * ```
 */
export declare function getSqlFirewallAllowedSql(args: GetSqlFirewallAllowedSqlArgs, opts?: pulumi.InvokeOptions): Promise<GetSqlFirewallAllowedSqlResult>;
/**
 ...
 * ```
 */
export declare function getSqlFirewallAllowedSqlOutput(args: GetSqlFirewallAllowedSqlOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetSqlFirewallAllowedSqlResult>;
/**
 * A collection of arguments for invoking getSqlFirewallAllowedSql.
 */

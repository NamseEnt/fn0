 ...
 * ```
 */
export declare function getDiscoveryAnalytic(args: GetDiscoveryAnalyticArgs, opts?: pulumi.InvokeOptions): Promise<GetDiscoveryAnalyticResult>;
/**
 ...
 * ```
 */
export declare function getDiscoveryAnalyticOutput(args: GetDiscoveryAnalyticOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetDiscoveryAnalyticResult>;
/**
 * A collection of arguments for invoking getDiscoveryAnalytic.
 */

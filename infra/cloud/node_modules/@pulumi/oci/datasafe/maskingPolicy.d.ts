...
export declare class MaskingPolicy extends pulumi.CustomResource {
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: MaskingPolicyState, opts?: pulumi.CustomResourceOptions): MaskingPolicy;
    /**
     ...
     */
    readonly addMaskingColumnsFromSdmTrigger: pulumi.Output<number | undefined>;
    /**
     * Specifies whether target database credentials are required to perform masking with this policy
     */
    readonly areTargetCredentialsRequired: pulumi.Output<boolean>;
    /**
     * (Updatable) Details to associate a column source with a masking policy.
     */
    readonly columnSources: pulumi.Output<outputs.DataSafe.MaskingPolicyColumnSource[]>;
    /**
     ...
     */
    readonly generateHealthReportTrigger: pulumi.Output<number | undefined>;
    /**
     ...
     */
    readonly isDropTempTablesEnabled: pulumi.Output<boolean>;
    /**
     ...
     */
    readonly isRedoLoggingEnabled: pulumi.Output<boolean>;
    /**
     ...
     */
    readonly postMaskingScript: pulumi.Output<string>;
    /**

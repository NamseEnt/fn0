 ...
 * ```
 */
export declare function getAuditPolicy(args: GetAuditPolicyArgs, opts?: pulumi.InvokeOptions): Promise<GetAuditPolicyResult>;
/**
 ...
 * ```
 */
export declare function getAuditPolicyOutput(args: GetAuditPolicyOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetAuditPolicyResult>;
/**
 * A collection of arguments for invoking getAuditPolicy.
 */

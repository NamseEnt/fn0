 ...
 * ```
 */
export declare function getMaskingReports(args: GetMaskingReportsArgs, opts?: pulumi.InvokeOptions): Promise<GetMaskingReportsResult>;
/**
 ...
 * ```
 */
export declare function getMaskingReportsOutput(args: GetMaskingReportsOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetMaskingReportsResult>;
/**
 * A collection of arguments for invoking getMaskingReports.
 */

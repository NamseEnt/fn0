 ...
 * ```
 */
export declare function getOnpremConnector(args: GetOnpremConnectorArgs, opts?: pulumi.InvokeOptions): Promise<GetOnpremConnectorResult>;
/**
 ...
 * ```
 */
export declare function getOnpremConnectorOutput(args: GetOnpremConnectorOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetOnpremConnectorResult>;
/**
 * A collection of arguments for invoking getOnpremConnector.
 */

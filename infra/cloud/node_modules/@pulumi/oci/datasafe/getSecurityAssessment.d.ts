 ...
 * ```
 */
export declare function getSecurityAssessment(args: GetSecurityAssessmentArgs, opts?: pulumi.InvokeOptions): Promise<GetSecurityAssessmentResult>;
/**
 ...
 * ```
 */
export declare function getSecurityAssessmentOutput(args: GetSecurityAssessmentOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetSecurityAssessmentResult>;
/**
 * A collection of arguments for invoking getSecurityAssessment.
 */

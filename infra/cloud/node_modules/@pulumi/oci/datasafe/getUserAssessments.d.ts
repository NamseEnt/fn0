 ...
 * ```
 */
export declare function getUserAssessments(args: GetUserAssessmentsArgs, opts?: pulumi.InvokeOptions): Promise<GetUserAssessmentsResult>;
/**
 ...
 * ```
 */
export declare function getUserAssessmentsOutput(args: GetUserAssessmentsOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetUserAssessmentsResult>;
/**
 * A collection of arguments for invoking getUserAssessments.
 */

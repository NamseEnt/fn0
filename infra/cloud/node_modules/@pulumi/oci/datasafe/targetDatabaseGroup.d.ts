 ...
 * ```
 */
export declare class TargetDatabaseGroup extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: TargetDatabaseGroupState, opts?: pulumi.CustomResourceOptions): TargetDatabaseGroup;
    /**
     * Returns true if the given object is an instance of TargetDatabaseGroup.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is TargetDatabaseGroup;
    /**
     ...
     */
    readonly matchingCriteria: pulumi.Output<outputs.DataSafe.TargetDatabaseGroupMatchingCriteria>;
    /**
     * The number of target databases in the specified target database group.
     */
    readonly membershipCount: pulumi.Output<number>;
    /**
     ...
     */
    readonly membershipUpdateTime: pulumi.Output<string>;
    /**

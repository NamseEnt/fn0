 ...
 * ```
 */
export declare class UnsetSecurityAssessmentBaseline extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: UnsetSecurityAssessmentBaselineState, opts?: pulumi.CustomResourceOptions): UnsetSecurityAssessmentBaseline;
    /**
     ...
     */
    static isInstance(obj: any): obj is UnsetSecurityAssessmentBaseline;
    /**

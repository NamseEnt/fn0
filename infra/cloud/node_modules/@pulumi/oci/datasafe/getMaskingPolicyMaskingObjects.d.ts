 ...
 * ```
 */
export declare function getMaskingPolicyMaskingObjects(args: GetMaskingPolicyMaskingObjectsArgs, opts?: pulumi.InvokeOptions): Promise<GetMaskingPolicyMaskingObjectsResult>;
/**
 ...
 * ```
 */
export declare function getMaskingPolicyMaskingObjectsOutput(args: GetMaskingPolicyMaskingObjectsOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetMaskingPolicyMaskingObjectsResult>;
/**
 * A collection of arguments for invoking getMaskingPolicyMaskingObjects.
 */

...
exports.MaskData = void 0;
const pulumi = require("@pulumi/pulumi");
const utilities = require("../utilities");
class MaskData extends pulumi.CustomResource {
    /**
    ...
    static get(name, id, state, opts) {
        return new MaskData(name, state, { ...opts, id: id });
    }
    /**
...
/** @internal */
MaskData.__pulumiType = 'oci:DataSafe/maskData:MaskData';

 ...
 * ```
 */
export declare function getAuditArchiveRetrieval(args: GetAuditArchiveRetrievalArgs, opts?: pulumi.InvokeOptions): Promise<GetAuditArchiveRetrievalResult>;
/**
 ...
 * ```
 */
export declare function getAuditArchiveRetrievalOutput(args: GetAuditArchiveRetrievalOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetAuditArchiveRetrievalResult>;
/**
 * A collection of arguments for invoking getAuditArchiveRetrieval.
 */

 ...
 * ```
 */
export declare class SensitiveTypeGroup extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: SensitiveTypeGroupState, opts?: pulumi.CustomResourceOptions): SensitiveTypeGroup;
    /**
     * Returns true if the given object is an instance of SensitiveTypeGroup.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is SensitiveTypeGroup;
    /**
     ...
     */
    readonly sensitiveTypeCount: pulumi.Output<number>;
    /**

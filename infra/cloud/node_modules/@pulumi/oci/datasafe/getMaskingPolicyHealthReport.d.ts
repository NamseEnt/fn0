 ...
 * ```
 */
export declare function getMaskingPolicyHealthReport(args: GetMaskingPolicyHealthReportArgs, opts?: pulumi.InvokeOptions): Promise<GetMaskingPolicyHealthReportResult>;
/**
 ...
 * ```
 */
export declare function getMaskingPolicyHealthReportOutput(args: GetMaskingPolicyHealthReportOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetMaskingPolicyHealthReportResult>;
/**
 * A collection of arguments for invoking getMaskingPolicyHealthReport.
 */

 ...
 * ```
 */
export declare class SensitiveDataModel extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: SensitiveDataModelState, opts?: pulumi.CustomResourceOptions): SensitiveDataModel;
    /**
     * Returns true if the given object is an instance of SensitiveDataModel.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is SensitiveDataModel;
    /**
     ...
     */
    readonly appSuiteName: pulumi.Output<string>;
    /**
     ...
     */
    readonly tablesForDiscoveries: pulumi.Output<outputs.DataSafe.SensitiveDataModelTablesForDiscovery[]>;
    /**

 ...
 * ```
 */
export declare function getAlertPolicyRules(args: GetAlertPolicyRulesArgs, opts?: pulumi.InvokeOptions): Promise<GetAlertPolicyRulesResult>;
/**
 ...
 * ```
 */
export declare function getAlertPolicyRulesOutput(args: GetAlertPolicyRulesOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetAlertPolicyRulesResult>;
/**
 * A collection of arguments for invoking getAlertPolicyRules.
 */

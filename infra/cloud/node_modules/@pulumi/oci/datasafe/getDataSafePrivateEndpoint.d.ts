 ...
 * ```
 */
export declare function getDataSafePrivateEndpoint(args: GetDataSafePrivateEndpointArgs, opts?: pulumi.InvokeOptions): Promise<GetDataSafePrivateEndpointResult>;
/**
 ...
 * ```
 */
export declare function getDataSafePrivateEndpointOutput(args: GetDataSafePrivateEndpointOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetDataSafePrivateEndpointResult>;
/**
 * A collection of arguments for invoking getDataSafePrivateEndpoint.
 */

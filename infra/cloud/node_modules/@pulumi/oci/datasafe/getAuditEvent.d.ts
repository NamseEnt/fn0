 ...
 * ```
 */
export declare function getAuditEvent(args: GetAuditEventArgs, opts?: pulumi.InvokeOptions): Promise<GetAuditEventResult>;
/**
 ...
 * ```
 */
export declare function getAuditEventOutput(args: GetAuditEventOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetAuditEventResult>;
/**
 * A collection of arguments for invoking getAuditEvent.
 */

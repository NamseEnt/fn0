 ...
 * ```
 */
export declare function getTargetDatabasesTables(args: GetTargetDatabasesTablesArgs, opts?: pulumi.InvokeOptions): Promise<GetTargetDatabasesTablesResult>;
/**
 ...
 * ```
 */
export declare function getTargetDatabasesTablesOutput(args: GetTargetDatabasesTablesOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetTargetDatabasesTablesResult>;
/**
 * A collection of arguments for invoking getTargetDatabasesTables.
 */

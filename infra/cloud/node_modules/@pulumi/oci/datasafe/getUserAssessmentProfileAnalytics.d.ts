 ...
 * ```
 */
export declare function getUserAssessmentProfileAnalytics(args: GetUserAssessmentProfileAnalyticsArgs, opts?: pulumi.InvokeOptions): Promise<GetUserAssessmentProfileAnalyticsResult>;
/**
 ...
 * ```
 */
export declare function getUserAssessmentProfileAnalyticsOutput(args: GetUserAssessmentProfileAnalyticsOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetUserAssessmentProfileAnalyticsResult>;
/**
 * A collection of arguments for invoking getUserAssessmentProfileAnalytics.
 */

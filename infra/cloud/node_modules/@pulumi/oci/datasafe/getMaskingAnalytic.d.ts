 ...
 * ```
 */
export declare function getMaskingAnalytic(args: GetMaskingAnalyticArgs, opts?: pulumi.InvokeOptions): Promise<GetMaskingAnalyticResult>;
/**
 ...
 * ```
 */
export declare function getMaskingAnalyticOutput(args: GetMaskingAnalyticOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetMaskingAnalyticResult>;
/**
 * A collection of arguments for invoking getMaskingAnalytic.
 */

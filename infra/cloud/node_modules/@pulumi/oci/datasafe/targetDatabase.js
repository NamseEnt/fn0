 ...
 * ```
 */
class TargetDatabase extends pulumi.CustomResource {
    /**
    ...
    static get(name, id, state, opts) {
        return new TargetDatabase(name, state, { ...opts, id: id });
    }
    /**
...
exports.TargetDatabase = TargetDatabase;
/** @internal */
TargetDatabase.__pulumiType = 'oci:DataSafe/targetDatabase:TargetDatabase';
//# sourceMappingURL=targetDatabase.js.map
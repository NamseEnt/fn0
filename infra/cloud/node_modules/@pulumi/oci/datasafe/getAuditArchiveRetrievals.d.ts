 ...
 * ```
 */
export declare function getAuditArchiveRetrievals(args: GetAuditArchiveRetrievalsArgs, opts?: pulumi.InvokeOptions): Promise<GetAuditArchiveRetrievalsResult>;
/**
 ...
 * ```
 */
export declare function getAuditArchiveRetrievalsOutput(args: GetAuditArchiveRetrievalsOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetAuditArchiveRetrievalsResult>;
/**
 * A collection of arguments for invoking getAuditArchiveRetrievals.
 */

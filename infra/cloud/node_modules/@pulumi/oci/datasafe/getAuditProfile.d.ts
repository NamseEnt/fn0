 ...
 * ```
 */
export declare function getAuditProfile(args: GetAuditProfileArgs, opts?: pulumi.InvokeOptions): Promise<GetAuditProfileResult>;
/**
 ...
 * ```
 */
export declare function getAuditProfileOutput(args: GetAuditProfileOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetAuditProfileResult>;
/**
 * A collection of arguments for invoking getAuditProfile.
 */

 ...
 * ```
 */
export declare function getTargetDatabase(args: GetTargetDatabaseArgs, opts?: pulumi.InvokeOptions): Promise<GetTargetDatabaseResult>;
/**
 ...
 * ```
 */
export declare function getTargetDatabaseOutput(args: GetTargetDatabaseOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetTargetDatabaseResult>;
/**
 * A collection of arguments for invoking getTargetDatabase.
 */

 ...
 * ```
 */
export declare class TargetDatabase extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: TargetDatabaseState, opts?: pulumi.CustomResourceOptions): TargetDatabase;
    /**
     * Returns true if the given object is an instance of TargetDatabase.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is TargetDatabase;
    /**
     ...
     */
    readonly connectionOption: pulumi.Output<outputs.DataSafe.TargetDatabaseConnectionOption>;
    /**
     * (Updatable) The database credentials required for Data Safe to connect to the database.
     */
    readonly credentials: pulumi.Output<outputs.DataSafe.TargetDatabaseCredentials>;
    /**
     * (Updatable) Details of the database for the registration in Data Safe.
     */
    readonly databaseDetails: pulumi.Output<outputs.DataSafe.TargetDatabaseDatabaseDetails>;
    /**
     ...
     */
    readonly peerTargetDatabaseDetails: pulumi.Output<outputs.DataSafe.TargetDatabasePeerTargetDatabaseDetail[]>;
    /**
     * The OCIDs of associated resources like Database, Data Safe private endpoint etc.
     */
    readonly peerTargetDatabases: pulumi.Output<outputs.DataSafe.TargetDatabasePeerTargetDatabase[]>;
    /**
     ...
     */
    readonly tlsConfig: pulumi.Output<outputs.DataSafe.TargetDatabaseTlsConfig>;
    /**

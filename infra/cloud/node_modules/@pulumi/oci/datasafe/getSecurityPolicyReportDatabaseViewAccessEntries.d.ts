 ...
 * ```
 */
export declare function getSecurityPolicyReportDatabaseViewAccessEntries(args: GetSecurityPolicyReportDatabaseViewAccessEntriesArgs, opts?: pulumi.InvokeOptions): Promise<GetSecurityPolicyReportDatabaseViewAccessEntriesResult>;
/**
 ...
 * ```
 */
export declare function getSecurityPolicyReportDatabaseViewAccessEntriesOutput(args: GetSecurityPolicyReportDatabaseViewAccessEntriesOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetSecurityPolicyReportDatabaseViewAccessEntriesResult>;
/**
 * A collection of arguments for invoking getSecurityPolicyReportDatabaseViewAccessEntries.
 */

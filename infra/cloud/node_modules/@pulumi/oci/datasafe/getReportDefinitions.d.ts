 ...
 * ```
 */
export declare function getReportDefinitions(args: GetReportDefinitionsArgs, opts?: pulumi.InvokeOptions): Promise<GetReportDefinitionsResult>;
/**
 ...
 * ```
 */
export declare function getReportDefinitionsOutput(args: GetReportDefinitionsOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetReportDefinitionsResult>;
/**
 * A collection of arguments for invoking getReportDefinitions.
 */

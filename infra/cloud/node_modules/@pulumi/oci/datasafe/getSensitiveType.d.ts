 ...
 * ```
 */
export declare function getSensitiveType(args: GetSensitiveTypeArgs, opts?: pulumi.InvokeOptions): Promise<GetSensitiveTypeResult>;
/**
 ...
 * ```
 */
export declare function getSensitiveTypeOutput(args: GetSensitiveTypeOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetSensitiveTypeResult>;
/**
 * A collection of arguments for invoking getSensitiveType.
 */

...
exports.getAuditProfileAnalyticOutput = exports.getAuditProfileAnalytic = void 0;
 ...
 * ```
 */
function getAuditProfileAnalytic(args, opts) {
...
exports.getAuditProfileAnalytic = getAuditProfileAnalytic;
/**
 * This data source provides details about a specific Audit Profile Analytic resource in Oracle Cloud Infrastructure Data Safe service.
 *
 * Gets a list of audit profile aggregated details . A audit profile  aggregation helps understand the overall  state of audit profile profiles.
 ...
 * ```
 */
function getAuditProfileAnalyticOutput(args, opts) {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
...
exports.getAuditProfileAnalyticOutput = getAuditProfileAnalyticOutput;
//# sourceMappingURL=getAuditProfileAnalytic.js.map
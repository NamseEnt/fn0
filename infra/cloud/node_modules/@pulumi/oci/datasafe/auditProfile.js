 ...
 * ```
 */
class AuditProfile extends pulumi.CustomResource {
    /**
    ...
    static get(name, id, state, opts) {
        return new AuditProfile(name, state, { ...opts, id: id });
    }
    /**
...
exports.AuditProfile = AuditProfile;
/** @internal */
AuditProfile.__pulumiType = 'oci:DataSafe/auditProfile:AuditProfile';
//# sourceMappingURL=auditProfile.js.map
 ...
 * ```
 */
export declare function getSecurityPoliciesOutput(args: GetSecurityPoliciesOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetSecurityPoliciesResult>;
/**
 * A collection of arguments for invoking getSecurityPolicies.
 */

 ...
 * ```
 */
export declare function getListUserGrants(args: GetListUserGrantsArgs, opts?: pulumi.InvokeOptions): Promise<GetListUserGrantsResult>;
/**
 ...
 * ```
 */
export declare function getListUserGrantsOutput(args: GetListUserGrantsOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetListUserGrantsResult>;
/**
 * A collection of arguments for invoking getListUserGrants.
 */

 ...
 * ```
 */
export declare function getCompatibleFormatsForSensitiveType(args: GetCompatibleFormatsForSensitiveTypeArgs, opts?: pulumi.InvokeOptions): Promise<GetCompatibleFormatsForSensitiveTypeResult>;
/**
 ...
 * ```
 */
export declare function getCompatibleFormatsForSensitiveTypeOutput(args: GetCompatibleFormatsForSensitiveTypeOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetCompatibleFormatsForSensitiveTypeResult>;
/**
 * A collection of arguments for invoking getCompatibleFormatsForSensitiveType.
 */

 ...
 * ```
 */
export declare function getSensitiveDataModelSensitiveTypes(args: GetSensitiveDataModelSensitiveTypesArgs, opts?: pulumi.InvokeOptions): Promise<GetSensitiveDataModelSensitiveTypesResult>;
/**
 ...
 * ```
 */
export declare function getSensitiveDataModelSensitiveTypesOutput(args: GetSensitiveDataModelSensitiveTypesOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetSensitiveDataModelSensitiveTypesResult>;
/**
 * A collection of arguments for invoking getSensitiveDataModelSensitiveTypes.
 */

 ...
 * ```
 */
export declare class SensitiveDataModelReferentialRelation extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: SensitiveDataModelReferentialRelationState, opts?: pulumi.CustomResourceOptions): SensitiveDataModelReferentialRelation;
    /**
     ...
     */
    static isInstance(obj: any): obj is SensitiveDataModelReferentialRelation;
    /**
     * columnsInfo object has details of column group with schema details.
     */
    readonly child: pulumi.Output<outputs.DataSafe.SensitiveDataModelReferentialRelationChild>;
    /**
     ...
     */
    readonly isSensitive: pulumi.Output<boolean>;
    /**
     ...
     * columnsInfo object has details of column group with schema details.
     */
    readonly parent: pulumi.Output<outputs.DataSafe.SensitiveDataModelReferentialRelationParent>;
    /**

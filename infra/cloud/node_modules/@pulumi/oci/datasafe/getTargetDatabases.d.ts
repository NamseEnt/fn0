 ...
 * ```
 */
export declare function getTargetDatabases(args: GetTargetDatabasesArgs, opts?: pulumi.InvokeOptions): Promise<GetTargetDatabasesResult>;
/**
 ...
 * ```
 */
export declare function getTargetDatabasesOutput(args: GetTargetDatabasesOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetTargetDatabasesResult>;
/**
 * A collection of arguments for invoking getTargetDatabases.
 */

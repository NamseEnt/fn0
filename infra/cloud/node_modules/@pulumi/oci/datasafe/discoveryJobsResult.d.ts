 ...
 * ```
 */
export declare class DiscoveryJobsResult extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: DiscoveryJobsResultState, opts?: pulumi.CustomResourceOptions): DiscoveryJobsResult;
    /**
     * Returns true if the given object is an instance of DiscoveryJobsResult.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is DiscoveryJobsResult;
    /**
     * Unique keys identifying the columns that are application-level (non-dictionary) children of the sensitive column.
     */
    readonly appDefinedChildColumnKeys: pulumi.Output<string[]>;
    /**
     ...
     */
    readonly estimatedDataValueCount: pulumi.Output<string>;
    /**
     ...
     */
    readonly isResultApplied: pulumi.Output<boolean>;
    /**
     ...
     */
    readonly modifiedAttributes: pulumi.Output<outputs.DataSafe.DiscoveryJobsResultModifiedAttribute[]>;
    /**
     ...
     */
    readonly parentColumnKeys: pulumi.Output<string[]>;
    /**
     ...
     */
    readonly plannedAction: pulumi.Output<string>;
    /**
     ...
     */
    readonly sampleDataValues: pulumi.Output<string[]>;
    /**
     ...
     */
    readonly sensitiveColumnkey: pulumi.Output<string>;
    /**
     * The OCID of the sensitive type associated with the sensitive column.
     */
    readonly sensitiveTypeId: pulumi.Output<string>;
    /**

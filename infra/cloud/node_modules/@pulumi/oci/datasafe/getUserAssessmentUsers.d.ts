 ...
 * ```
 */
export declare function getUserAssessmentUsers(args: GetUserAssessmentUsersArgs, opts?: pulumi.InvokeOptions): Promise<GetUserAssessmentUsersResult>;
/**
 ...
 * ```
 */
export declare function getUserAssessmentUsersOutput(args: GetUserAssessmentUsersOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetUserAssessmentUsersResult>;
/**
 * A collection of arguments for invoking getUserAssessmentUsers.
 */

 ...
 * ```
 */
export declare function getSensitiveTypes(args: GetSensitiveTypesArgs, opts?: pulumi.InvokeOptions): Promise<GetSensitiveTypesResult>;
/**
 ...
 * ```
 */
export declare function getSensitiveTypesOutput(args: GetSensitiveTypesOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetSensitiveTypesResult>;
/**
 * A collection of arguments for invoking getSensitiveTypes.
 */

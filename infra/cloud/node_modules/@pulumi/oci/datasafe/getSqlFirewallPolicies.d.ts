 ...
 * ```
 */
export declare function getSqlFirewallPoliciesOutput(args: GetSqlFirewallPoliciesOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetSqlFirewallPoliciesResult>;
/**
 * A collection of arguments for invoking getSqlFirewallPolicies.
 */

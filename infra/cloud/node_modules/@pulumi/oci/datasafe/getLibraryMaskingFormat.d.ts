 ...
 * ```
 */
export declare function getLibraryMaskingFormat(args: GetLibraryMaskingFormatArgs, opts?: pulumi.InvokeOptions): Promise<GetLibraryMaskingFormatResult>;
/**
 ...
 * ```
 */
export declare function getLibraryMaskingFormatOutput(args: GetLibraryMaskingFormatOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetLibraryMaskingFormatResult>;
/**
 * A collection of arguments for invoking getLibraryMaskingFormat.
 */

 ...
 * ```
 */
export declare function getAuditTrails(args: GetAuditTrailsArgs, opts?: pulumi.InvokeOptions): Promise<GetAuditTrailsResult>;
/**
 ...
 * ```
 */
export declare function getAuditTrailsOutput(args: GetAuditTrailsOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetAuditTrailsResult>;
/**
 * A collection of arguments for invoking getAuditTrails.
 */

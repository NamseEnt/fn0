 ...
 * ```
 */
export declare function getAlertAnalytic(args: GetAlertAnalyticArgs, opts?: pulumi.InvokeOptions): Promise<GetAlertAnalyticResult>;
/**
 ...
 * ```
 */
export declare function getAlertAnalyticOutput(args: GetAlertAnalyticOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetAlertAnalyticResult>;
/**
 * A collection of arguments for invoking getAlertAnalytic.
 */

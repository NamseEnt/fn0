 ...
 * ```
 */
export declare function getRunStatement(args: GetRunStatementArgs, opts?: pulumi.InvokeOptions): Promise<GetRunStatementResult>;
/**
 ...
 * ```
 */
export declare function getRunStatementOutput(args: GetRunStatementOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetRunStatementResult>;
/**
 * A collection of arguments for invoking getRunStatement.
 */

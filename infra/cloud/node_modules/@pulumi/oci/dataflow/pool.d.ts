...
export declare class Pool extends pulumi.CustomResource {
     ...
     */
    readonly configurations: pulumi.Output<outputs.DataFlow.PoolConfiguration[]>;
    /**
     ...
     */
    readonly poolMetrics: pulumi.Output<outputs.DataFlow.PoolPoolMetric[]>;
    /**
     * (Updatable) A list of schedules for pool to auto start and stop.
     */
    readonly schedules: pulumi.Output<outputs.DataFlow.PoolSchedule[]>;
    /**

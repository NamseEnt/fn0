 ...
 * ```
 */
class RunStatement extends pulumi.CustomResource {
    /**
    ...
    static get(name, id, state, opts) {
        return new RunStatement(name, state, { ...opts, id: id });
    }
    /**
...
/** @internal */
RunStatement.__pulumiType = 'oci:DataFlow/runStatement:RunStatement';

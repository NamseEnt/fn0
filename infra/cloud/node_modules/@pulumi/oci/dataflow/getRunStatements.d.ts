 ...
 * ```
 */
export declare function getRunStatements(args: GetRunStatementsArgs, opts?: pulumi.InvokeOptions): Promise<GetRunStatementsResult>;
/**
 ...
 * ```
 */
export declare function getRunStatementsOutput(args: GetRunStatementsOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetRunStatementsResult>;
/**
 * A collection of arguments for invoking getRunStatements.
 */

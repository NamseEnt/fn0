 ...
 * ```
 */
export declare function getFusionEnvironmentRefreshActivityOutput(args: GetFusionEnvironmentRefreshActivityOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetFusionEnvironmentRefreshActivityResult>;
/**
 * A collection of arguments for invoking getFusionEnvironmentRefreshActivity.
 */

 ...
 * ```
 */
export declare function getFusionEnvironmentScheduledActivityOutput(args: GetFusionEnvironmentScheduledActivityOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetFusionEnvironmentScheduledActivityResult>;
/**
 * A collection of arguments for invoking getFusionEnvironmentScheduledActivity.
 */

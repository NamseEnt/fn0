 ...
 * ```
 */
export declare function getFusionEnvironmentScheduledActivitiesOutput(args: GetFusionEnvironmentScheduledActivitiesOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetFusionEnvironmentScheduledActivitiesResult>;
/**
 * A collection of arguments for invoking getFusionEnvironmentScheduledActivities.
 */

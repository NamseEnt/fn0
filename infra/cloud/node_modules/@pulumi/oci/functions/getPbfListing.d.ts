 ...
 * ```
 */
export declare function getPbfListing(args: GetPbfListingArgs, opts?: pulumi.InvokeOptions): Promise<GetPbfListingResult>;
/**
 ...
 * ```
 */
export declare function getPbfListingOutput(args: GetPbfListingOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetPbfListingResult>;
/**
 * A collection of arguments for invoking getPbfListing.
 */

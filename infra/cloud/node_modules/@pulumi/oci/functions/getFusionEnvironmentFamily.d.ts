 ...
 * ```
 */
export declare function getFusionEnvironmentFamilyOutput(args: GetFusionEnvironmentFamilyOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetFusionEnvironmentFamilyResult>;
/**
 * A collection of arguments for invoking getFusionEnvironmentFamily.
 */

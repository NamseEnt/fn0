 ...
 */
class InvokeFunction extends pulumi.CustomResource {
    /**
    ...
    static get(name, id, state, opts) {
        return new InvokeFunction(name, state, { ...opts, id: id });
    }
    /**
...
/** @internal */
InvokeFunction.__pulumiType = 'oci:Functions/invokeFunction:InvokeFunction';

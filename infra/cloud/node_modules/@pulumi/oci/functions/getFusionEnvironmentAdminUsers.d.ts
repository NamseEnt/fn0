 ...
 * ```
 */
export declare function getFusionEnvironmentAdminUsers(args: GetFusionEnvironmentAdminUsersArgs, opts?: pulumi.InvokeOptions): Promise<GetFusionEnvironmentAdminUsersResult>;
/**
 ...
 * ```
 */
export declare function getFusionEnvironmentAdminUsersOutput(args: GetFusionEnvironmentAdminUsersOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetFusionEnvironmentAdminUsersResult>;
/**
 * A collection of arguments for invoking getFusionEnvironmentAdminUsers.
 */

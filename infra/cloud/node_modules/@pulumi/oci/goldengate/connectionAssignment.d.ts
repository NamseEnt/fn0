 ...
 * ```
 */
export declare class ConnectionAssignment extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ConnectionAssignmentState, opts?: pulumi.CustomResourceOptions): ConnectionAssignment;
    /**
     * Returns true if the given object is an instance of ConnectionAssignment.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is ConnectionAssignment;
    /**

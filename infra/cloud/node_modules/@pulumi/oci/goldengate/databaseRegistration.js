 ...
 * ```
 */
class DatabaseRegistration extends pulumi.CustomResource {
    /**
    ...
    static get(name, id, state, opts) {
        return new DatabaseRegistration(name, state, { ...opts, id: id });
    }
    /**
...
exports.DatabaseRegistration = DatabaseRegistration;
/** @internal */
DatabaseRegistration.__pulumiType = 'oci:GoldenGate/databaseRegistration:DatabaseRegistration';
//# sourceMappingURL=databaseRegistration.js.map
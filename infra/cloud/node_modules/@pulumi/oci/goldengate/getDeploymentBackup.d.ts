 ...
 * ```
 */
export declare function getDeploymentBackup(args: GetDeploymentBackupArgs, opts?: pulumi.InvokeOptions): Promise<GetDeploymentBackupResult>;
/**
 ...
 * ```
 */
export declare function getDeploymentBackupOutput(args: GetDeploymentBackupOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetDeploymentBackupResult>;
/**
 * A collection of arguments for invoking getDeploymentBackup.
 */

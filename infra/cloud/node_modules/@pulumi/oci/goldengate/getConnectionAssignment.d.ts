 ...
 * ```
 */
export declare function getConnectionAssignment(args: GetConnectionAssignmentArgs, opts?: pulumi.InvokeOptions): Promise<GetConnectionAssignmentResult>;
/**
 ...
 * ```
 */
export declare function getConnectionAssignmentOutput(args: GetConnectionAssignmentOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetConnectionAssignmentResult>;
/**
 * A collection of arguments for invoking getConnectionAssignment.
 */

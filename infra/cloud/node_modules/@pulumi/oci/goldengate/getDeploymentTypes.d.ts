 ...
 * ```
 */
export declare function getDeploymentTypes(args: GetDeploymentTypesArgs, opts?: pulumi.InvokeOptions): Promise<GetDeploymentTypesResult>;
/**
 ...
 * ```
 */
export declare function getDeploymentTypesOutput(args: GetDeploymentTypesOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetDeploymentTypesResult>;
/**
 * A collection of arguments for invoking getDeploymentTypes.
 */

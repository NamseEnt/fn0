 ...
 * ```
 */
export declare function getDeploymentUpgrades(args: GetDeploymentUpgradesArgs, opts?: pulumi.InvokeOptions): Promise<GetDeploymentUpgradesResult>;
/**
 ...
 * ```
 */
export declare function getDeploymentUpgradesOutput(args: GetDeploymentUpgradesOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetDeploymentUpgradesResult>;
/**
 * A collection of arguments for invoking getDeploymentUpgrades.
 */

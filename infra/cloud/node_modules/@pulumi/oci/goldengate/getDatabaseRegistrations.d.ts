 ...
 * ```
 */
export declare function getDatabaseRegistrations(args: GetDatabaseRegistrationsArgs, opts?: pulumi.InvokeOptions): Promise<GetDatabaseRegistrationsResult>;
/**
 ...
 * ```
 */
export declare function getDatabaseRegistrationsOutput(args: GetDatabaseRegistrationsOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetDatabaseRegistrationsResult>;
/**
 * A collection of arguments for invoking getDatabaseRegistrations.
 */

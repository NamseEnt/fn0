 ...
 * ```
 */
export declare function getPipelineSchemaTables(args: GetPipelineSchemaTablesArgs, opts?: pulumi.InvokeOptions): Promise<GetPipelineSchemaTablesResult>;
/**
 ...
 * ```
 */
export declare function getPipelineSchemaTablesOutput(args: GetPipelineSchemaTablesOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetPipelineSchemaTablesResult>;
/**
 * A collection of arguments for invoking getPipelineSchemaTables.
 */

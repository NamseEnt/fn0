 ...
 * ```
 */
export declare function getDeploymentBackups(args: GetDeploymentBackupsArgs, opts?: pulumi.InvokeOptions): Promise<GetDeploymentBackupsResult>;
/**
 ...
 * ```
 */
export declare function getDeploymentBackupsOutput(args: GetDeploymentBackupsOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetDeploymentBackupsResult>;
/**
 * A collection of arguments for invoking getDeploymentBackups.
 */

 ...
 * ```
 */
export declare function getDeploymentCertificate(args: GetDeploymentCertificateArgs, opts?: pulumi.InvokeOptions): Promise<GetDeploymentCertificateResult>;
/**
 ...
 * ```
 */
export declare function getDeploymentCertificateOutput(args: GetDeploymentCertificateOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetDeploymentCertificateResult>;
/**
 * A collection of arguments for invoking getDeploymentCertificate.
 */

 ...
 * ```
 */
export declare function getRecipes(args: GetRecipesArgs, opts?: pulumi.InvokeOptions): Promise<GetRecipesResult>;
/**
 ...
 * ```
 */
export declare function getRecipesOutput(args: GetRecipesOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetRecipesResult>;
/**
 * A collection of arguments for invoking getRecipes.
 */

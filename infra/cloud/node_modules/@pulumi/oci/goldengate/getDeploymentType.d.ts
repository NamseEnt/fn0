 ...
 * ```
 */
export declare function getDeploymentType(args: GetDeploymentTypeArgs, opts?: pulumi.InvokeOptions): Promise<GetDeploymentTypeResult>;
/**
 ...
 * ```
 */
export declare function getDeploymentTypeOutput(args: GetDeploymentTypeOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetDeploymentTypeResult>;
/**
 * A collection of arguments for invoking getDeploymentType.
 */

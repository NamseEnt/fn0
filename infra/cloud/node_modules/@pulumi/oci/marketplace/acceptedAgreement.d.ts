 ...
 * ```
 */
export declare class AcceptedAgreement extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: AcceptedAgreementState, opts?: pulumi.CustomResourceOptions): AcceptedAgreement;
    /**
     * Returns true if the given object is an instance of AcceptedAgreement.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is AcceptedAgreement;
    /**

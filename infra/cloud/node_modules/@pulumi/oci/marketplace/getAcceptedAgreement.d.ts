 ...
 * ```
 */
export declare function getAcceptedAgreement(args: GetAcceptedAgreementArgs, opts?: pulumi.InvokeOptions): Promise<GetAcceptedAgreementResult>;
/**
 ...
 * ```
 */
export declare function getAcceptedAgreementOutput(args: GetAcceptedAgreementOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetAcceptedAgreementResult>;
/**
 * A collection of arguments for invoking getAcceptedAgreement.
 */

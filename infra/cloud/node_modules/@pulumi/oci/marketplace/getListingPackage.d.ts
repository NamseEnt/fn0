 ...
 * ```
 */
export declare function getListingPackage(args: GetListingPackageArgs, opts?: pulumi.InvokeOptions): Promise<GetListingPackageResult>;
/**
 ...
 * ```
 */
export declare function getListingPackageOutput(args: GetListingPackageOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetListingPackageResult>;
/**
 * A collection of arguments for invoking getListingPackage.
 */

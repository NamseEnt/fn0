 ...
 * ```
 */
export declare function getPublication(args: GetPublicationArgs, opts?: pulumi.InvokeOptions): Promise<GetPublicationResult>;
/**
 ...
 * ```
 */
export declare function getPublicationOutput(args: GetPublicationOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetPublicationResult>;
/**
 * A collection of arguments for invoking getPublication.
 */

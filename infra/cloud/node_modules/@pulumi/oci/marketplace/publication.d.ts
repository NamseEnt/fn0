...
export declare class Publication extends pulumi.CustomResource {
     ...
     */
    readonly icons: pulumi.Output<outputs.Marketplace.PublicationIcon[]>;
    /**
     ...
     */
    readonly isAgreementAcknowledged: pulumi.Output<boolean>;
    /**
     * The publisher category to which the publication belongs. The publisher category informs where the listing appears for use.
     */
    readonly listingType: pulumi.Output<string>;
    /**
     ...
     */
    readonly packageDetails: pulumi.Output<outputs.Marketplace.PublicationPackageDetails>;
    /**
     ...
     */
    readonly supportContacts: pulumi.Output<outputs.Marketplace.PublicationSupportContact[]>;
    /**
     * The list of operating systems supported by the listing.
     */
    readonly supportedOperatingSystems: pulumi.Output<outputs.Marketplace.PublicationSupportedOperatingSystem[]>;
    /**

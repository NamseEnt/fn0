 ...
 * ```
 */
export declare function getEmailReturnPath(args: GetEmailReturnPathArgs, opts?: pulumi.InvokeOptions): Promise<GetEmailReturnPathResult>;
/**
 ...
 * ```
 */
export declare function getEmailReturnPathOutput(args: GetEmailReturnPathOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetEmailReturnPathResult>;
/**
 * A collection of arguments for invoking getEmailReturnPath.
 */

 ...
 * ```
 */
export declare class Sender extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: SenderState, opts?: pulumi.CustomResourceOptions): Sender;
    /**
     * Returns true if the given object is an instance of Sender.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is Sender;
    /**
     ...
     */
    readonly emailIpPoolId: pulumi.Output<string>;
    /**
     ...
     */
    readonly locks: pulumi.Output<outputs.Email.SenderLock[]>;
    /**

 ...
 * ```
 */
export declare function getSenders(args: GetSendersArgs, opts?: pulumi.InvokeOptions): Promise<GetSendersResult>;
/**
 ...
 * ```
 */
export declare function getSendersOutput(args: GetSendersOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetSendersResult>;
/**
 * A collection of arguments for invoking getSenders.
 */

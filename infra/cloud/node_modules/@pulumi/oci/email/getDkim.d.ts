 ...
 * ```
 */
export declare function getDkim(args: GetDkimArgs, opts?: pulumi.InvokeOptions): Promise<GetDkimResult>;
/**
 ...
 * ```
 */
export declare function getDkimOutput(args: GetDkimOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetDkimResult>;
/**
 * A collection of arguments for invoking getDkim.
 */

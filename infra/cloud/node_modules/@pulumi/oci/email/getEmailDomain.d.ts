 ...
 * ```
 */
export declare function getEmailDomain(args: GetEmailDomainArgs, opts?: pulumi.InvokeOptions): Promise<GetEmailDomainResult>;
/**
 ...
 * ```
 */
export declare function getEmailDomainOutput(args: GetEmailDomainOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetEmailDomainResult>;
/**
 * A collection of arguments for invoking getEmailDomain.
 */

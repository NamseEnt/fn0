 ...
 * ```
 */
export declare class EmailIpPool extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: EmailIpPoolState, opts?: pulumi.CustomResourceOptions): EmailIpPool;
    /**
     * Returns true if the given object is an instance of EmailIpPool.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is EmailIpPool;
    /**
     ...
     */
    readonly lastIpDrainPeriodInHours: pulumi.Output<number>;
    /**
     ...
     */
    readonly locks: pulumi.Output<outputs.Email.EmailIpPoolLock[]>;
    /**
    ...
    readonly outboundIpsResponses: pulumi.Output<outputs.Email.EmailIpPoolOutboundIpsResponse[]>;
    /**

 ...
 * ```
 */
class VbInstance extends pulumi.CustomResource {
    /**
    ...
    static get(name, id, state, opts) {
        return new VbInstance(name, state, { ...opts, id: id });
    }
    /**
...
exports.VbInstance = VbInstance;
/** @internal */
VbInstance.__pulumiType = 'oci:VisualBuilder/vbInstance:VbInstance';
//# sourceMappingURL=vbInstance.js.map
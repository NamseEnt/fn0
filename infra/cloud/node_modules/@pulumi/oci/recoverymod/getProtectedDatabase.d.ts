 ...
 * ```
 */
export declare function getProtectedDatabase(args: GetProtectedDatabaseArgs, opts?: pulumi.InvokeOptions): Promise<GetProtectedDatabaseResult>;
/**
 ...
 * ```
 */
export declare function getProtectedDatabaseOutput(args: GetProtectedDatabaseOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetProtectedDatabaseResult>;
/**
 * A collection of arguments for invoking getProtectedDatabase.
 */

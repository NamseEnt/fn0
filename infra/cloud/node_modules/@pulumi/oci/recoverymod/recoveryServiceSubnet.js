 ...
 * ```
 */
class RecoveryServiceSubnet extends pulumi.CustomResource {
    /**
    ...
    static get(name, id, state, opts) {
        return new RecoveryServiceSubnet(name, state, { ...opts, id: id });
    }
    /**
...
exports.RecoveryServiceSubnet = RecoveryServiceSubnet;
/** @internal */
RecoveryServiceSubnet.__pulumiType = 'oci:RecoveryMod/recoveryServiceSubnet:RecoveryServiceSubnet';
//# sourceMappingURL=recoveryServiceSubnet.js.map
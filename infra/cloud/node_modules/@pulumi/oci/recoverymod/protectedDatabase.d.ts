 ...
 * ```
 */
export declare class ProtectedDatabase extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ProtectedDatabaseState, opts?: pulumi.CustomResourceOptions): ProtectedDatabase;
    /**
     * Returns true if the given object is an instance of ProtectedDatabase.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is ProtectedDatabase;
    /**
     ...
     */
    readonly databaseSize: pulumi.Output<string>;
    /**
     ...
     */
    readonly deletionSchedule: pulumi.Output<string>;
    /**
     ...
     */
    readonly healthDetails: pulumi.Output<string>;
    /**
     ...
     */
    readonly isReadOnlyResource: pulumi.Output<boolean>;
    /**
     ...
     */
    readonly isRedoLogsShipped: pulumi.Output<boolean>;
    /**
     ...
     */
    readonly metrics: pulumi.Output<outputs.RecoveryMod.ProtectedDatabaseMetric[]>;
    /**
     ...
     */
    readonly policyLockedDateTime: pulumi.Output<string>;
    /**
     * (Updatable) The OCID of the protection policy associated with the protected database.
     */
    readonly protectionPolicyId: pulumi.Output<string>;
    /**
     * (Updatable) List of recovery service subnet resources associated with the protected database.
     */
    readonly recoveryServiceSubnets: pulumi.Output<outputs.RecoveryMod.ProtectedDatabaseRecoveryServiceSubnet[]>;
    /**
     ...
     */
    readonly vpcUserName: pulumi.Output<string>;
    /**

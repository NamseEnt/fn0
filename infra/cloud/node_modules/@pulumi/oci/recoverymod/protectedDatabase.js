 ...
 * ```
 */
class ProtectedDatabase extends pulumi.CustomResource {
    /**
    ...
    static get(name, id, state, opts) {
        return new ProtectedDatabase(name, state, { ...opts, id: id });
    }
    /**
...
exports.ProtectedDatabase = ProtectedDatabase;
/** @internal */
ProtectedDatabase.__pulumiType = 'oci:RecoveryMod/protectedDatabase:ProtectedDatabase';
//# sourceMappingURL=protectedDatabase.js.map
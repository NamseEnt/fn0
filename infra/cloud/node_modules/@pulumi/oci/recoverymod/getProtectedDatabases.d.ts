 ...
 * ```
 */
export declare function getProtectedDatabases(args: GetProtectedDatabasesArgs, opts?: pulumi.InvokeOptions): Promise<GetProtectedDatabasesResult>;
/**
 ...
 * ```
 */
export declare function getProtectedDatabasesOutput(args: GetProtectedDatabasesOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetProtectedDatabasesResult>;
/**
 * A collection of arguments for invoking getProtectedDatabases.
 */

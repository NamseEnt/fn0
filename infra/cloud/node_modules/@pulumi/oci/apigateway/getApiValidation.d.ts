 ...
 * ```
 */
export declare function getApiValidation(args: GetApiValidationArgs, opts?: pulumi.InvokeOptions): Promise<GetApiValidationResult>;
/**
 ...
 * ```
 */
export declare function getApiValidationOutput(args: GetApiValidationOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetApiValidationResult>;
/**
 * A collection of arguments for invoking getApiValidation.
 */

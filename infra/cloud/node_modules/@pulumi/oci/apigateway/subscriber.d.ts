...
export declare class Subscriber extends pulumi.CustomResource {
     ...
     */
    readonly clients: pulumi.Output<outputs.ApiGateway.SubscriberClient[]>;
    /**
     ...
     */
    readonly locks: pulumi.Output<outputs.ApiGateway.SubscriberLock[]>;
    /**
     ...
     */
    readonly usagePlans: pulumi.Output<string[]>;
    /**

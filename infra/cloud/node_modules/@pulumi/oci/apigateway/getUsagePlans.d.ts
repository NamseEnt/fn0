 ...
 * ```
 */
export declare function getUsagePlans(args: GetUsagePlansArgs, opts?: pulumi.InvokeOptions): Promise<GetUsagePlansResult>;
/**
 ...
 * ```
 */
export declare function getUsagePlansOutput(args: GetUsagePlansOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetUsagePlansResult>;
/**
 * A collection of arguments for invoking getUsagePlans.
 */

 ...
 * ```
 */
export declare function getContainerInstances(args: GetContainerInstancesArgs, opts?: pulumi.InvokeOptions): Promise<GetContainerInstancesResult>;
/**
 ...
 * ```
 */
export declare function getContainerInstancesOutput(args: GetContainerInstancesOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetContainerInstancesResult>;
/**
 * A collection of arguments for invoking getContainerInstances.
 */

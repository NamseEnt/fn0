 ...
 * ```
 */
export declare function getContainerInstance(args: GetContainerInstanceArgs, opts?: pulumi.InvokeOptions): Promise<GetContainerInstanceResult>;
/**
 ...
 * ```
 */
export declare function getContainerInstanceOutput(args: GetContainerInstanceOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetContainerInstanceResult>;
/**
 * A collection of arguments for invoking getContainerInstance.
 */

 ...
 * ```
 */
export declare function getBdsInstances(args: GetBdsInstancesArgs, opts?: pulumi.InvokeOptions): Promise<GetBdsInstancesResult>;
/**
 ...
 * ```
 */
export declare function getBdsInstancesOutput(args: GetBdsInstancesOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetBdsInstancesResult>;
/**
 * A collection of arguments for invoking getBdsInstances.
 */

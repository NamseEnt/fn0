...
export declare class AutoScalingConfiguration extends pulumi.CustomResource {
     ...
     */
    readonly policy: pulumi.Output<outputs.BigDataService.AutoScalingConfigurationPolicy>;
    /**
     ...
     */
    readonly policyDetails: pulumi.Output<outputs.BigDataService.AutoScalingConfigurationPolicyDetails>;
    /**

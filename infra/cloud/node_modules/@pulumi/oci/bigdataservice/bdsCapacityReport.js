 ...
 * ```
 */
class BdsCapacityReport extends pulumi.CustomResource {
    /**
    ...
    static get(name, id, state, opts) {
        return new BdsCapacityReport(name, state, { ...opts, id: id });
    }
    /**
...
exports.BdsCapacityReport = BdsCapacityReport;
/** @internal */
BdsCapacityReport.__pulumiType = 'oci:BigDataService/bdsCapacityReport:BdsCapacityReport';
//# sourceMappingURL=bdsCapacityReport.js.map
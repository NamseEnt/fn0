 ...
 * ```
 */
class BdsInstance extends pulumi.CustomResource {
    /**
    ...
    static get(name, id, state, opts) {
        return new BdsInstance(name, state, { ...opts, id: id });
    }
    /**
...
exports.BdsInstance = BdsInstance;
/** @internal */
BdsInstance.__pulumiType = 'oci:BigDataService/bdsInstance:BdsInstance';
//# sourceMappingURL=bdsInstance.js.map
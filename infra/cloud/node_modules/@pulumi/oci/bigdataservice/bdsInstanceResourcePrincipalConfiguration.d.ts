 ...
 * ```
 */
export declare class BdsInstanceResourcePrincipalConfiguration extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: BdsInstanceResourcePrincipalConfigurationState, opts?: pulumi.CustomResourceOptions): BdsInstanceResourcePrincipalConfiguration;
    /**
     ...
     */
    static isInstance(obj: any): obj is BdsInstanceResourcePrincipalConfiguration;
    /**
     ...
     */
    readonly forceRefreshResourcePrincipalTrigger: pulumi.Output<number | undefined>;
    /**
     * (Updatable) Life span in hours for the resource principal session token.
     */
    readonly sessionTokenLifeSpanDurationInHours: pulumi.Output<number>;
    /**

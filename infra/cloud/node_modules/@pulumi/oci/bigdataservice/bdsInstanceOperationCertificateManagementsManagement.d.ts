 ...
 * ```
 */
export declare class BdsInstanceOperationCertificateManagementsManagement extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: BdsInstanceOperationCertificateManagementsManagementState, opts?: pulumi.CustomResourceOptions): BdsInstanceOperationCertificateManagementsManagement;
    /**
     ...
     */
    static isInstance(obj: any): obj is BdsInstanceOperationCertificateManagementsManagement;
    /**
     ...
     */
    readonly enableOperationCertificateManagement: pulumi.Output<boolean>;
    /**
     ...
     */
    readonly hostCertDetails: pulumi.Output<outputs.BigDataService.BdsInstanceOperationCertificateManagementsManagementHostCertDetail[]>;
    /**
     ...
     */
    readonly renewOperationCertificateManagement: pulumi.Output<boolean>;
    /**
     ...
     */
    readonly rootCertificate: pulumi.Output<string>;
    /**
     * Base-64 encoded password for CA certificate's private key. This value can be empty.
     */
    readonly serverKeyPassword: pulumi.Output<string>;
    /**

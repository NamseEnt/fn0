 ...
 * ```
 */
export declare function getBdsInstance(args: GetBdsInstanceArgs, opts?: pulumi.InvokeOptions): Promise<GetBdsInstanceResult>;
/**
 ...
 * ```
 */
export declare function getBdsInstanceOutput(args: GetBdsInstanceOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetBdsInstanceResult>;
/**
 * A collection of arguments for invoking getBdsInstance.
 */

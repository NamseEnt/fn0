 ...
 * ```
 */
export declare function getBdsInstanceApiKey(args: GetBdsInstanceApiKeyArgs, opts?: pulumi.InvokeOptions): Promise<GetBdsInstanceApiKeyResult>;
/**
 ...
 * ```
 */
export declare function getBdsInstanceApiKeyOutput(args: GetBdsInstanceApiKeyOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetBdsInstanceApiKeyResult>;
/**
 * A collection of arguments for invoking getBdsInstanceApiKey.
 */

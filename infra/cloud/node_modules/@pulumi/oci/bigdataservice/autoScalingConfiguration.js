 ...
 * ```
 */
class AutoScalingConfiguration extends pulumi.CustomResource {
    /**
    ...
    static get(name, id, state, opts) {
        return new AutoScalingConfiguration(name, state, { ...opts, id: id });
    }
    /**
...
/** @internal */
AutoScalingConfiguration.__pulumiType = 'oci:BigDataService/autoScalingConfiguration:AutoScalingConfiguration';

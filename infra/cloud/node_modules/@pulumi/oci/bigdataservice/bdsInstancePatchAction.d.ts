 ...
 */
export declare class BdsInstancePatchAction extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: BdsInstancePatchActionState, opts?: pulumi.CustomResourceOptions): BdsInstancePatchAction;
    /**
     * Returns true if the given object is an instance of BdsInstancePatchAction.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is BdsInstancePatchAction;
    /**
     ...
     */
    readonly patchingConfig: pulumi.Output<outputs.BigDataService.BdsInstancePatchActionPatchingConfig>;
    /**

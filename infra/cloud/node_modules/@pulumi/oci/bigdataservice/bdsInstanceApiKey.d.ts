 ...
 * ```
 */
export declare class BdsInstanceApiKey extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: BdsInstanceApiKeyState, opts?: pulumi.CustomResourceOptions): BdsInstanceApiKey;
    /**
     ...
     */
    readonly defaultRegion: pulumi.Output<string>;
    /**
     ...
     */
    readonly pemfilepath: pulumi.Output<string>;
    /**

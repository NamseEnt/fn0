 ...
 * ```
 */
class StreamPool extends pulumi.CustomResource {
    /**
    ...
    static get(name, id, state, opts) {
        return new StreamPool(name, state, { ...opts, id: id });
    }
    /**
...
/** @internal */
StreamPool.__pulumiType = 'oci:Streaming/streamPool:StreamPool';
//# sourceMappingURL=streamPool.js.map
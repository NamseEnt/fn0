 ...
 * ```
 */
export declare function getStreamPools(args: GetStreamPoolsArgs, opts?: pulumi.InvokeOptions): Promise<GetStreamPoolsResult>;
/**
 ...
 * ```
 */
export declare function getStreamPoolsOutput(args: GetStreamPoolsOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetStreamPoolsResult>;
/**
 * A collection of arguments for invoking getStreamPools.
 */

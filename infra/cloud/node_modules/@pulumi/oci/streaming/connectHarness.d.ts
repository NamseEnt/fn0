 ...
 * ```
 */
export declare class ConnectHarness extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ConnectHarnessState, opts?: pulumi.CustomResourceOptions): ConnectHarness;
    /**
     * Returns true if the given object is an instance of ConnectHarness.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is ConnectHarness;
    /**

 ...
 * ```
 */
export declare function getConnectHarness(args: GetConnectHarnessArgs, opts?: pulumi.InvokeOptions): Promise<GetConnectHarnessResult>;
/**
 ...
 * ```
 */
export declare function getConnectHarnessOutput(args: GetConnectHarnessOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetConnectHarnessResult>;
/**
 * A collection of arguments for invoking getConnectHarness.
 */

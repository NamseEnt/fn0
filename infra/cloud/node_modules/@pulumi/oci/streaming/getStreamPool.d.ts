 ...
 * ```
 */
export declare function getStreamPool(args: GetStreamPoolArgs, opts?: pulumi.InvokeOptions): Promise<GetStreamPoolResult>;
/**
 ...
 * ```
 */
export declare function getStreamPoolOutput(args: GetStreamPoolOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetStreamPoolResult>;
/**
 * A collection of arguments for invoking getStreamPool.
 */

 ...
 * ```
 */
export declare function getWorkspaceFolders(args: GetWorkspaceFoldersArgs, opts?: pulumi.InvokeOptions): Promise<GetWorkspaceFoldersResult>;
/**
 ...
 * ```
 */
export declare function getWorkspaceFoldersOutput(args: GetWorkspaceFoldersOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetWorkspaceFoldersResult>;
/**
 * A collection of arguments for invoking getWorkspaceFolders.
 */

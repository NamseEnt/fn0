 ...
 * ```
 */
export declare class WorkspaceTask extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: WorkspaceTaskState, opts?: pulumi.CustomResourceOptions): WorkspaceTask;
    /**
     * Returns true if the given object is an instance of WorkspaceTask.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is WorkspaceTask;
    /**
     ...
     */
    readonly apiCallMode: pulumi.Output<string>;
    /**
     * (Updatable) Authentication configuration for Generic REST invocation.
     */
    readonly authConfig: pulumi.Output<outputs.DataIntegration.WorkspaceTaskAuthConfig>;
    /**
     * (Updatable) The REST API configuration for cancelling the task.
     */
    readonly cancelRestCallConfig: pulumi.Output<outputs.DataIntegration.WorkspaceTaskCancelRestCallConfig>;
    /**
     * (Updatable) The type to create a config provider.
     */
    readonly configProviderDelegate: pulumi.Output<outputs.DataIntegration.WorkspaceTaskConfigProviderDelegate>;
    /**
     ...
     */
    readonly executeRestCallConfig: pulumi.Output<outputs.DataIntegration.WorkspaceTaskExecuteRestCallConfig>;
    /**
     ...
     */
    readonly inputPorts: pulumi.Output<outputs.DataIntegration.WorkspaceTaskInputPort[]>;
    /**
     * (Updatable) Defines whether Data Loader task is used for single load or multiple
     */
    readonly isSingleLoad: pulumi.Output<boolean>;
    /**
     ...
     */
    readonly keyMap: pulumi.Output<{
        [key: string]: string;
    }>;
    /**
     * A summary type containing information about the object including its key, name and when/who created/updated it.
     */
    readonly metadatas: pulumi.Output<outputs.DataIntegration.WorkspaceTaskMetadata[]>;
    /**
     ...
     */
    readonly objectStatus: pulumi.Output<number>;
    /**
     * This is used by the service for optimistic locking of the object, to prevent multiple users from simultaneously updating the object.
     */
    readonly objectVersion: pulumi.Output<number>;
    /**
     * (Updatable) Configuration values can be string, objects, or parameters.
     */
    readonly opConfigValues: pulumi.Output<outputs.DataIntegration.WorkspaceTaskOpConfigValues>;
    /**
     ...
     */
    readonly outputPorts: pulumi.Output<outputs.DataIntegration.WorkspaceTaskOutputPort[]>;
    /**
     * (Updatable) Defines the number of entities being loaded in parallel at a time for a Data Loader task
     */
    readonly parallelLoadLimit: pulumi.Output<number>;
    /**
     * (Updatable) An array of parameters.
     */
    readonly parameters: pulumi.Output<outputs.DataIntegration.WorkspaceTaskParameter[]>;
    /**
     * (Updatable) A reference to the object's parent.
     */
    readonly parentRef: pulumi.Output<outputs.DataIntegration.WorkspaceTaskParentRef>;
    /**
     * (Updatable) The REST API configuration for polling.
     */
    readonly pollRestCallConfig: pulumi.Output<outputs.DataIntegration.WorkspaceTaskPollRestCallConfig>;
    /**
     * (Updatable) Information about the object and its parent.
     */
    readonly registryMetadata: pulumi.Output<outputs.DataIntegration.WorkspaceTaskRegistryMetadata>;
    /**
     * (Updatable) List of typed expressions.
     */
    readonly typedExpressions: pulumi.Output<outputs.DataIntegration.WorkspaceTaskTypedExpression[]>;
    /**
     * The workspace ID.
     *
     *

 ...
 * ```
 */
export declare function getWorkspaceFolder(args: GetWorkspaceFolderArgs, opts?: pulumi.InvokeOptions): Promise<GetWorkspaceFolderResult>;
/**
 ...
 * ```
 */
export declare function getWorkspaceFolderOutput(args: GetWorkspaceFolderOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetWorkspaceFolderResult>;
/**
 * A collection of arguments for invoking getWorkspaceFolder.
 */

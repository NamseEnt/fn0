 ...
 * ```
 */
export declare class WorkspaceImportRequest extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: WorkspaceImportRequestState, opts?: pulumi.CustomResourceOptions): WorkspaceImportRequest;
    /**
     * Returns true if the given object is an instance of WorkspaceImportRequest.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is WorkspaceImportRequest;
    /**
     * This field controls if the data asset references will be included during import.
     */
    readonly areDataAssetReferencesIncluded: pulumi.Output<boolean>;
    /**
     ...
     */
    readonly importConflictResolution: pulumi.Output<outputs.DataIntegration.WorkspaceImportRequestImportConflictResolution>;
    /**
     * The array of imported object details.
     */
    readonly importedObjects: pulumi.Output<outputs.DataIntegration.WorkspaceImportRequestImportedObject[]>;
    /**
     ...
     */
    readonly objectKeyForImport: pulumi.Output<string>;
    /**
     * Region of the object storage (if using object storage of different region)
     */
    readonly objectStorageRegion: pulumi.Output<string>;
    /**
     * Optional parameter to point to object storage tenancy (if using Object Storage of different tenancy)
     */
    readonly objectStorageTenancyId: pulumi.Output<string>;
    /**
     ...
     */
    readonly timeEndedInMillis: pulumi.Output<string>;
    /**
     * Time at which the request started getting processed.
     */
    readonly timeStartedInMillis: pulumi.Output<string>;
    /**
     * Number of objects that are imported.
     */
    readonly totalImportedObjectCount: pulumi.Output<number>;
    /**
     * The workspace ID.
     *
     *

 ...
 * ```
 */
export declare function getWorkspaceExportRequest(args: GetWorkspaceExportRequestArgs, opts?: pulumi.InvokeOptions): Promise<GetWorkspaceExportRequestResult>;
/**
 ...
 * ```
 */
export declare function getWorkspaceExportRequestOutput(args: GetWorkspaceExportRequestOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetWorkspaceExportRequestResult>;
/**
 * A collection of arguments for invoking getWorkspaceExportRequest.
 */

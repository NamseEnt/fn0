 ...
 * ```
 */
export declare function getWorkspaceImportRequests(args: GetWorkspaceImportRequestsArgs, opts?: pulumi.InvokeOptions): Promise<GetWorkspaceImportRequestsResult>;
/**
 ...
 * ```
 */
export declare function getWorkspaceImportRequestsOutput(args: GetWorkspaceImportRequestsOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetWorkspaceImportRequestsResult>;
/**
 * A collection of arguments for invoking getWorkspaceImportRequests.
 */

 ...
 * ```
 */
class OpaInstance extends pulumi.CustomResource {
    /**
    ...
    static get(name, id, state, opts) {
        return new OpaInstance(name, state, { ...opts, id: id });
    }
    /**
...
exports.OpaInstance = OpaInstance;
/** @internal */
OpaInstance.__pulumiType = 'oci:Opa/opaInstance:OpaInstance';
//# sourceMappingURL=opaInstance.js.map
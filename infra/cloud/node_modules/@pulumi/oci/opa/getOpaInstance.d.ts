 ...
 * ```
 */
export declare function getOpaInstance(args: GetOpaInstanceArgs, opts?: pulumi.InvokeOptions): Promise<GetOpaInstanceResult>;
/**
 ...
 * ```
 */
export declare function getOpaInstanceOutput(args: GetOpaInstanceOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetOpaInstanceResult>;
/**
 * A collection of arguments for invoking getOpaInstance.
 */

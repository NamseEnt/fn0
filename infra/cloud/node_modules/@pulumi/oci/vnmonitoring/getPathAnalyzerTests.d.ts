 ...
 * ```
 */
export declare function getPathAnalyzerTests(args: GetPathAnalyzerTestsArgs, opts?: pulumi.InvokeOptions): Promise<GetPathAnalyzerTestsResult>;
/**
 ...
 * ```
 */
export declare function getPathAnalyzerTestsOutput(args: GetPathAnalyzerTestsOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetPathAnalyzerTestsResult>;
/**
 * A collection of arguments for invoking GetPathAnalyzerTests.
 */

 ...
 * ```
 */
export declare class PathAnalysi extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: PathAnalysiState, opts?: pulumi.CustomResourceOptions): PathAnalysi;
    /**
     * Returns true if the given object is an instance of PathAnalysi.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is PathAnalysi;
    /**
     ...
     */
    readonly destinationEndpoint: pulumi.Output<outputs.VnMonitoring.PathAnalysiDestinationEndpoint>;
    /**
     * The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the `PathAnalyzerTest` resource.
     */
    readonly pathAnalyzerTestId: pulumi.Output<string>;
    /**
     ...
     */
    readonly protocolParameters: pulumi.Output<outputs.VnMonitoring.PathAnalysiProtocolParameters>;
    /**
     * Defines the query options required for a `PathAnalyzerTest` resource.
     */
    readonly queryOptions: pulumi.Output<outputs.VnMonitoring.PathAnalysiQueryOptions>;
    /**
     * Information describing a source or destination in a `PathAnalyzerTest` resource.
     */
    readonly sourceEndpoint: pulumi.Output<outputs.VnMonitoring.PathAnalysiSourceEndpoint>;
    /**

 ...
 * ```
 */
class PathAnalyzerTest extends pulumi.CustomResource {
    /**
    ...
    static get(name, id, state, opts) {
        return new PathAnalyzerTest(name, state, { ...opts, id: id });
    }
    /**
...
exports.PathAnalyzerTest = PathAnalyzerTest;
/** @internal */
PathAnalyzerTest.__pulumiType = 'oci:VnMonitoring/pathAnalyzerTest:PathAnalyzerTest';
//# sourceMappingURL=pathAnalyzerTest.js.map
 ...
 * ```
 */
class PathAnalysi extends pulumi.CustomResource {
    /**
    ...
    static get(name, id, state, opts) {
        return new PathAnalysi(name, state, { ...opts, id: id });
    }
    /**
...
exports.PathAnalysi = PathAnalysi;
/** @internal */
PathAnalysi.__pulumiType = 'oci:VnMonitoring/pathAnalysi:PathAnalysi';
//# sourceMappingURL=pathAnalysi.js.map
 ...
 * ```
 */
export declare function getJmsPlugin(args: GetJmsPluginArgs, opts?: pulumi.InvokeOptions): Promise<GetJmsPluginResult>;
/**
 ...
 * ```
 */
export declare function getJmsPluginOutput(args: GetJmsPluginOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetJmsPluginResult>;
/**
 * A collection of arguments for invoking getJmsPlugin.
 */

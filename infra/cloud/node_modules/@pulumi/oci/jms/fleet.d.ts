...
export declare class Fleet extends pulumi.CustomResource {
     ...
     */
    readonly approximateApplicationCount: pulumi.Output<number>;
    /**
     ...
     */
    readonly approximateInstallationCount: pulumi.Output<number>;
    /**
     ...
     */
    readonly approximateJavaServerCount: pulumi.Output<number>;
    /**
     ...
     */
    readonly approximateManagedInstanceCount: pulumi.Output<number>;
    /**
     ...
     */
    readonly inventoryLog: pulumi.Output<outputs.Jms.FleetInventoryLog>;
    /**
     ...
     */
    readonly isExportSettingEnabled: pulumi.Output<boolean>;
    /**
     * (Updatable) Custom Log for inventory or operation log.
     */
    readonly operationLog: pulumi.Output<outputs.Jms.FleetOperationLog>;
    /**

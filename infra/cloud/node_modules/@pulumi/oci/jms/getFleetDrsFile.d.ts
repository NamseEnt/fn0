 ...
 * ```
 */
export declare function getFleetDrsFile(args: GetFleetDrsFileArgs, opts?: pulumi.InvokeOptions): Promise<GetFleetDrsFileResult>;
/**
 ...
 * ```
 */
export declare function getFleetDrsFileOutput(args: GetFleetDrsFileOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetFleetDrsFileResult>;
/**
 * A collection of arguments for invoking getFleetDrsFile.
 */

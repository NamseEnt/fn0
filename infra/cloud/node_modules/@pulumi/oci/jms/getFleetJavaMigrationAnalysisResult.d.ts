 ...
 * ```
 */
export declare function getFleetJavaMigrationAnalysisResult(args: GetFleetJavaMigrationAnalysisResultArgs, opts?: pulumi.InvokeOptions): Promise<GetFleetJavaMigrationAnalysisResultResult>;
/**
 ...
 * ```
 */
export declare function getFleetJavaMigrationAnalysisResultOutput(args: GetFleetJavaMigrationAnalysisResultOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetFleetJavaMigrationAnalysisResultResult>;
/**
 * A collection of arguments for invoking getFleetJavaMigrationAnalysisResult.
 */

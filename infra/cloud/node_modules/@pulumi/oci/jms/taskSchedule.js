 ...
 * ```
 */
class TaskSchedule extends pulumi.CustomResource {
    /**
    ...
    static get(name, id, state, opts) {
        return new TaskSchedule(name, state, { ...opts, id: id });
    }
    /**
...
/** @internal */
TaskSchedule.__pulumiType = 'oci:Jms/taskSchedule:TaskSchedule';
//# sourceMappingURL=taskSchedule.js.map
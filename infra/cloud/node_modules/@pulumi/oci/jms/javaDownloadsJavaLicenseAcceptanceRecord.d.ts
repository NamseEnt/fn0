 ...
 */
export declare class JavaDownloadsJavaLicenseAcceptanceRecord extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: JavaDownloadsJavaLicenseAcceptanceRecordState, opts?: pulumi.CustomResourceOptions): JavaDownloadsJavaLicenseAcceptanceRecord;
    /**
     ...
     */
    static isInstance(obj: any): obj is JavaDownloadsJavaLicenseAcceptanceRecord;
    /**
     ...
     */
    readonly createdBies: pulumi.Output<outputs.Jms.JavaDownloadsJavaLicenseAcceptanceRecordCreatedBy[]>;
    /**
     ...
     * An authorized principal.
     */
    readonly lastUpdatedBies: pulumi.Output<outputs.Jms.JavaDownloadsJavaLicenseAcceptanceRecordLastUpdatedBy[]>;
    /**
     * (Updatable) Status of license acceptance.
     */
    readonly licenseAcceptanceStatus: pulumi.Output<string>;
    /**
     ...
     */
    readonly timeLastUpdated: pulumi.Output<string>;
    /**

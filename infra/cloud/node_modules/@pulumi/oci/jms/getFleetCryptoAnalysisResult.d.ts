 ...
 * ```
 */
export declare function getFleetCryptoAnalysisResult(args: GetFleetCryptoAnalysisResultArgs, opts?: pulumi.InvokeOptions): Promise<GetFleetCryptoAnalysisResultResult>;
/**
 ...
 * ```
 */
export declare function getFleetCryptoAnalysisResultOutput(args: GetFleetCryptoAnalysisResultOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetFleetCryptoAnalysisResultResult>;
/**
 * A collection of arguments for invoking getFleetCryptoAnalysisResult.
 */

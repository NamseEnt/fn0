 ...
 * ```
 */
export declare function getFleetBlocklists(args: GetFleetBlocklistsArgs, opts?: pulumi.InvokeOptions): Promise<GetFleetBlocklistsResult>;
/**
 ...
 * ```
 */
export declare function getFleetBlocklistsOutput(args: GetFleetBlocklistsOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetFleetBlocklistsResult>;
/**
 * A collection of arguments for invoking getFleetBlocklists.
 */

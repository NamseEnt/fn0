 ...
 * ```
 */
export declare class JmsPlugin extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: JmsPluginState, opts?: pulumi.CustomResourceOptions): JmsPlugin;
    /**
     * Returns true if the given object is an instance of JmsPlugin.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is JmsPlugin;
    /**
     ...
     */
    readonly osArchitecture: pulumi.Output<string>;
    /**
     * The distribution of the operating system of the plugin.
     */
    readonly osDistribution: pulumi.Output<string>;
    /**
     ...
     */
    readonly timeLastSeen: pulumi.Output<string>;
    /**
     * The date and time the plugin was registered.
     */
    readonly timeRegistered: pulumi.Output<string>;
    /**

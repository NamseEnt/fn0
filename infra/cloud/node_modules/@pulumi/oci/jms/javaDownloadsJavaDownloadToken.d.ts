...
export declare class JavaDownloadsJavaDownloadToken extends pulumi.CustomResource {
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: JavaDownloadsJavaDownloadTokenState, opts?: pulumi.CustomResourceOptions): JavaDownloadsJavaDownloadToken;
    /**
     ...
     */
    readonly createdBies: pulumi.Output<outputs.Jms.JavaDownloadsJavaDownloadTokenCreatedBy[]>;
    /**
     ...
     */
    readonly javaVersion: pulumi.Output<string>;
    /**
     * An authorized principal.
     */
    readonly lastUpdatedBies: pulumi.Output<outputs.Jms.JavaDownloadsJavaDownloadTokenLastUpdatedBy[]>;
    /**
     * (Updatable) The license type(s) associated with the JavaDownloadToken.
     */
    readonly licenseTypes: pulumi.Output<string[]>;
    /**
     ...
     */
    readonly timeLastUsed: pulumi.Output<string>;
    /**

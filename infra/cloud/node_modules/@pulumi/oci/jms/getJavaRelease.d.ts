 ...
 * ```
 */
export declare function getJavaRelease(args: GetJavaReleaseArgs, opts?: pulumi.InvokeOptions): Promise<GetJavaReleaseResult>;
/**
 ...
 * ```
 */
export declare function getJavaReleaseOutput(args: GetJavaReleaseOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetJavaReleaseResult>;
/**
 * A collection of arguments for invoking getJavaRelease.
 */

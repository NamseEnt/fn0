 ...
 * ```
 */
export declare function getInstallationSite(args: GetInstallationSiteArgs, opts?: pulumi.InvokeOptions): Promise<GetInstallationSiteResult>;
/**
 ...
 * ```
 */
export declare function getInstallationSiteOutput(args: GetInstallationSiteOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetInstallationSiteResult>;
/**
 * A collection of arguments for invoking getInstallationSite.
 */

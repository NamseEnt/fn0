 ...
 * ```
 */
export declare class FleetAdvancedFeatureConfiguration extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: FleetAdvancedFeatureConfigurationState, opts?: pulumi.CustomResourceOptions): FleetAdvancedFeatureConfiguration;
    /**
     ...
     */
    static isInstance(obj: any): obj is FleetAdvancedFeatureConfiguration;
    /**
     * (Updatable) AdvancedUsageTracking configuration
     */
    readonly advancedUsageTracking: pulumi.Output<outputs.Jms.FleetAdvancedFeatureConfigurationAdvancedUsageTracking>;
    /**
     * (Updatable) Bucket name required to store JFR and related data.
     */
    readonly analyticBucketName: pulumi.Output<string>;
    /**
     * (Updatable) Namespace for the Fleet advanced feature.
     */
    readonly analyticNamespace: pulumi.Output<string>;
    /**
     * (Updatable) CryptoEventAnalysis configuration
     */
    readonly cryptoEventAnalysis: pulumi.Output<outputs.Jms.FleetAdvancedFeatureConfigurationCryptoEventAnalysis>;
    /**
     ...
     */
    readonly javaMigrationAnalysis: pulumi.Output<outputs.Jms.FleetAdvancedFeatureConfigurationJavaMigrationAnalysis>;
    /**
     * (Updatable) JfrRecording configuration
     */
    readonly jfrRecording: pulumi.Output<outputs.Jms.FleetAdvancedFeatureConfigurationJfrRecording>;
    /**
     * (Updatable) Enable lifecycle management and set post action configurations.
     */
    readonly lcm: pulumi.Output<outputs.Jms.FleetAdvancedFeatureConfigurationLcm>;
    /**
     * (Updatable) Performance tuning analysis configuration
     */
    readonly performanceTuningAnalysis: pulumi.Output<outputs.Jms.FleetAdvancedFeatureConfigurationPerformanceTuningAnalysis>;
    /**

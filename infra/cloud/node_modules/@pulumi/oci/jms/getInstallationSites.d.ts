 ...
 * ```
 */
export declare function getInstallationSites(args: GetInstallationSitesArgs, opts?: pulumi.InvokeOptions): Promise<GetInstallationSitesResult>;
/**
 ...
 * ```
 */
export declare function getInstallationSitesOutput(args: GetInstallationSitesOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetInstallationSitesResult>;
/**
 * A collection of arguments for invoking getInstallationSites.
 */

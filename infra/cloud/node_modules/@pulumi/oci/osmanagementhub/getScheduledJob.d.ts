 ...
 * ```
 */
export declare function getScheduledJob(args: GetScheduledJobArgs, opts?: pulumi.InvokeOptions): Promise<GetScheduledJobResult>;
/**
 ...
 * ```
 */
export declare function getScheduledJobOutput(args: GetScheduledJobOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetScheduledJobResult>;
/**
 * A collection of arguments for invoking getScheduledJob.
 */

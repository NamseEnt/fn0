 ...
 * ```
 */
export declare function getEntitlements(args: GetEntitlementsArgs, opts?: pulumi.InvokeOptions): Promise<GetEntitlementsResult>;
/**
 ...
 * ```
 */
export declare function getEntitlementsOutput(args: GetEntitlementsOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetEntitlementsResult>;
/**
 * A collection of arguments for invoking getEntitlements.
 */

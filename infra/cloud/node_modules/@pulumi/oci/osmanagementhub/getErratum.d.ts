 ...
 * ```
 */
export declare function getErratum(args: GetErratumArgs, opts?: pulumi.InvokeOptions): Promise<GetErratumResult>;
/**
 ...
 * ```
 */
export declare function getErratumOutput(args: GetErratumOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetErratumResult>;
/**
 * A collection of arguments for invoking getErratum.
 */

 ...
 * ```
 */
export declare class ManagementStationRefreshManagement extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ManagementStationRefreshManagementState, opts?: pulumi.CustomResourceOptions): ManagementStationRefreshManagement;
    /**
     ...
     */
    static isInstance(obj: any): obj is ManagementStationRefreshManagement;
    /**

 ...
 * ```
 */
export declare class ManagedInstanceGroup extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ManagedInstanceGroupState, opts?: pulumi.CustomResourceOptions): ManagedInstanceGroup;
    /**
     * Returns true if the given object is an instance of ManagedInstanceGroup.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is ManagedInstanceGroup;
    /**
     ...
     */
    readonly autonomousSettings: pulumi.Output<outputs.OsManagementHub.ManagedInstanceGroupAutonomousSettings>;
    /**
     ...
     */
    readonly managedInstanceCount: pulumi.Output<number>;
    /**
     ...
     */
    readonly pendingJobCount: pulumi.Output<number>;
    /**
     ...
     */
    readonly softwareSourceIds: pulumi.Output<string[]>;
    /**
     * The list of software sources that the managed instance group will use.
     */
    readonly softwareSources: pulumi.Output<outputs.OsManagementHub.ManagedInstanceGroupSoftwareSource[]>;
    /**

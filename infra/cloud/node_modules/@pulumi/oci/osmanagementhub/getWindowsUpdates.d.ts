 ...
 * ```
 */
export declare function getWindowsUpdates(args: GetWindowsUpdatesArgs, opts?: pulumi.InvokeOptions): Promise<GetWindowsUpdatesResult>;
/**
 ...
 * ```
 */
export declare function getWindowsUpdatesOutput(args: GetWindowsUpdatesOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetWindowsUpdatesResult>;
/**
 * A collection of arguments for invoking getWindowsUpdates.
 */

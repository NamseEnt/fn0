 ...
 * ```
 */
export declare class ManagedInstanceGroupRebootManagement extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ManagedInstanceGroupRebootManagementState, opts?: pulumi.CustomResourceOptions): ManagedInstanceGroupRebootManagement;
    /**
     ...
     */
    static isInstance(obj: any): obj is ManagedInstanceGroupRebootManagement;
    /**
     ...
     */
    readonly rebootTimeoutInMins: pulumi.Output<number>;
    /**
     * Provides the name and description of the job.
     */
    readonly workRequestDetails: pulumi.Output<outputs.OsManagementHub.ManagedInstanceGroupRebootManagementWorkRequestDetails>;
    /**

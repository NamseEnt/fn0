 ...
 * ```
 */
class SoftwareSource extends pulumi.CustomResource {
    /**
    ...
    static get(name, id, state, opts) {
        return new SoftwareSource(name, state, { ...opts, id: id });
    }
    /**
...
exports.SoftwareSource = SoftwareSource;
/** @internal */
SoftwareSource.__pulumiType = 'oci:OsManagementHub/softwareSource:SoftwareSource';
//# sourceMappingURL=softwareSource.js.map
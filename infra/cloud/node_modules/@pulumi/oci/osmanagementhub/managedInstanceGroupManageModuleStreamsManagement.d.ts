 ...
 * ```
 */
export declare class ManagedInstanceGroupManageModuleStreamsManagement extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ManagedInstanceGroupManageModuleStreamsManagementState, opts?: pulumi.CustomResourceOptions): ManagedInstanceGroupManageModuleStreamsManagement;
    /**
     ...
     */
    static isInstance(obj: any): obj is ManagedInstanceGroupManageModuleStreamsManagement;
    /**
     * The set of module streams to disable.
     */
    readonly disables: pulumi.Output<outputs.OsManagementHub.ManagedInstanceGroupManageModuleStreamsManagementDisable[]>;
    /**
     * The set of module streams to enable.
     */
    readonly enables: pulumi.Output<outputs.OsManagementHub.ManagedInstanceGroupManageModuleStreamsManagementEnable[]>;
    /**
     * The set of module stream profiles to install.
     */
    readonly installs: pulumi.Output<outputs.OsManagementHub.ManagedInstanceGroupManageModuleStreamsManagementInstall[]>;
    /**
     ...
     */
    readonly isDryRun: pulumi.Output<boolean>;
    /**
     * The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the managed instance group.
     */
    readonly managedInstanceGroupId: pulumi.Output<string>;
    /**
     * The set of module stream profiles to remove.
     */
    readonly removes: pulumi.Output<outputs.OsManagementHub.ManagedInstanceGroupManageModuleStreamsManagementRemove[]>;
    /**
     * Provides the name and description of the job.
     */
    readonly workRequestDetails: pulumi.Output<outputs.OsManagementHub.ManagedInstanceGroupManageModuleStreamsManagementWorkRequestDetails>;
    /**

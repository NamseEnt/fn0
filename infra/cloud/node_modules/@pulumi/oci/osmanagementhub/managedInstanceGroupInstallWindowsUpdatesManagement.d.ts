 ...
 * ```
 */
export declare class ManagedInstanceGroupInstallWindowsUpdatesManagement extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ManagedInstanceGroupInstallWindowsUpdatesManagementState, opts?: pulumi.CustomResourceOptions): ManagedInstanceGroupInstallWindowsUpdatesManagement;
    /**
     ...
     */
    static isInstance(obj: any): obj is ManagedInstanceGroupInstallWindowsUpdatesManagement;
    /**
     ...
     */
    readonly windowsUpdateTypes: pulumi.Output<string[]>;
    /**
     * Provides the name and description of the job.
     */
    readonly workRequestDetails: pulumi.Output<outputs.OsManagementHub.ManagedInstanceGroupInstallWindowsUpdatesManagementWorkRequestDetails>;
    /**

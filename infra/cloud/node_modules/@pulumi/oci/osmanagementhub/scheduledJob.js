 ...
 * ```
 */
class ScheduledJob extends pulumi.CustomResource {
    /**
    ...
    static get(name, id, state, opts) {
        return new ScheduledJob(name, state, { ...opts, id: id });
    }
    /**
...
/** @internal */
ScheduledJob.__pulumiType = 'oci:OsManagementHub/scheduledJob:ScheduledJob';

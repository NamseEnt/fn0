 ...
 * ```
 */
export declare function getManagementStationMirrors(args: GetManagementStationMirrorsArgs, opts?: pulumi.InvokeOptions): Promise<GetManagementStationMirrorsResult>;
/**
 ...
 * ```
 */
export declare function getManagementStationMirrorsOutput(args: GetManagementStationMirrorsOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetManagementStationMirrorsResult>;
/**
 * A collection of arguments for invoking getManagementStationMirrors.
 */

 ...
 */
export declare function getManagedInstances(args?: GetManagedInstancesArgs, opts?: pulumi.InvokeOptions): Promise<GetManagedInstancesResult>;
/**
 ...
 * Lists managed instances that match the specified compartment or managed instance OCID. Filter the list against a variety of criteria including but not limited to its name, status, architecture, and OS version.
 */
export declare function getManagedInstancesOutput(args?: GetManagedInstancesOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetManagedInstancesResult>;
/**
 * A collection of arguments for invoking getManagedInstances.
 */

 ...
 * ```
 */
export declare function getSoftwareSourcePackageGroup(args: GetSoftwareSourcePackageGroupArgs, opts?: pulumi.InvokeOptions): Promise<GetSoftwareSourcePackageGroupResult>;
/**
 ...
 * ```
 */
export declare function getSoftwareSourcePackageGroupOutput(args: GetSoftwareSourcePackageGroupOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetSoftwareSourcePackageGroupResult>;
/**
 * A collection of arguments for invoking getSoftwareSourcePackageGroup.
 */

 ...
 * ```
 */
export declare function getSoftwareSource(args: GetSoftwareSourceArgs, opts?: pulumi.InvokeOptions): Promise<GetSoftwareSourceResult>;
/**
 ...
 * ```
 */
export declare function getSoftwareSourceOutput(args: GetSoftwareSourceOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetSoftwareSourceResult>;
/**
 * A collection of arguments for invoking getSoftwareSource.
 */

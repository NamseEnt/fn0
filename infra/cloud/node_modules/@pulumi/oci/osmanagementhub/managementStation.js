 ...
 * ```
 */
class ManagementStation extends pulumi.CustomResource {
    /**
    ...
    static get(name, id, state, opts) {
        return new ManagementStation(name, state, { ...opts, id: id });
    }
    /**
...
exports.ManagementStation = ManagementStation;
/** @internal */
ManagementStation.__pulumiType = 'oci:OsManagementHub/managementStation:ManagementStation';
//# sourceMappingURL=managementStation.js.map
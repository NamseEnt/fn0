 ...
 * ```
 */
export declare class ManagedInstanceRebootManagement extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ManagedInstanceRebootManagementState, opts?: pulumi.CustomResourceOptions): ManagedInstanceRebootManagement;
    /**
     ...
     */
    static isInstance(obj: any): obj is ManagedInstanceRebootManagement;
    /**
     ...
     */
    readonly workRequestDetails: pulumi.Output<outputs.OsManagementHub.ManagedInstanceRebootManagementWorkRequestDetails>;
    /**

 ...
 * ```
 */
export declare class ManagedInstanceGroupAttachManagedInstancesManagement extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ManagedInstanceGroupAttachManagedInstancesManagementState, opts?: pulumi.CustomResourceOptions): ManagedInstanceGroupAttachManagedInstancesManagement;
    /**
     ...
     */
    static isInstance(obj: any): obj is ManagedInstanceGroupAttachManagedInstancesManagement;
    /**
     ...
     */
    readonly workRequestDetails: pulumi.Output<outputs.OsManagementHub.ManagedInstanceGroupAttachManagedInstancesManagementWorkRequestDetails>;
    /**

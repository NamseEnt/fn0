 ...
 * ```
 */
export declare function getManagedInstanceErrata(args: GetManagedInstanceErrataArgs, opts?: pulumi.InvokeOptions): Promise<GetManagedInstanceErrataResult>;
/**
 ...
 * ```
 */
export declare function getManagedInstanceErrataOutput(args: GetManagedInstanceErrataOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetManagedInstanceErrataResult>;
/**
 * A collection of arguments for invoking getManagedInstanceErrata.
 */

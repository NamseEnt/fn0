 ...
 * ```
 */
export declare class LifecycleStagePromoteSoftwareSourceManagement extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: LifecycleStagePromoteSoftwareSourceManagementState, opts?: pulumi.CustomResourceOptions): LifecycleStagePromoteSoftwareSourceManagement;
    /**
     ...
     */
    static isInstance(obj: any): obj is LifecycleStagePromoteSoftwareSourceManagement;
    /**
     ...
     */
    readonly softwareSourceId: pulumi.Output<string>;
    /**
     * Provides the name and description of the job.
     */
    readonly workRequestDetails: pulumi.Output<outputs.OsManagementHub.LifecycleStagePromoteSoftwareSourceManagementWorkRequestDetails>;
    /**

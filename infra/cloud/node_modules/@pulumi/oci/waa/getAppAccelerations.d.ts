 ...
 * ```
 */
export declare function getAppAccelerations(args: GetAppAccelerationsArgs, opts?: pulumi.InvokeOptions): Promise<GetAppAccelerationsResult>;
/**
 ...
 * ```
 */
export declare function getAppAccelerationsOutput(args: GetAppAccelerationsOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetAppAccelerationsResult>;
/**
 * A collection of arguments for invoking getAppAccelerations.
 */

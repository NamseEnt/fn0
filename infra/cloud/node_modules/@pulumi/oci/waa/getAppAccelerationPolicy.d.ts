 ...
 * ```
 */
export declare function getAppAccelerationPolicy(args: GetAppAccelerationPolicyArgs, opts?: pulumi.InvokeOptions): Promise<GetAppAccelerationPolicyResult>;
/**
 ...
 * ```
 */
export declare function getAppAccelerationPolicyOutput(args: GetAppAccelerationPolicyOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetAppAccelerationPolicyResult>;
/**
 * A collection of arguments for invoking getAppAccelerationPolicy.
 */

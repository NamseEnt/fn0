 ...
 * ```
 */
export declare function getAtCustomerCccUpgradeSchedule(args: GetAtCustomerCccUpgradeScheduleArgs, opts?: pulumi.InvokeOptions): Promise<GetAtCustomerCccUpgradeScheduleResult>;
/**
 ...
 * ```
 */
export declare function getAtCustomerCccUpgradeScheduleOutput(args: GetAtCustomerCccUpgradeScheduleOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetAtCustomerCccUpgradeScheduleResult>;
/**
 * A collection of arguments for invoking getAtCustomerCccUpgradeSchedule.
 */

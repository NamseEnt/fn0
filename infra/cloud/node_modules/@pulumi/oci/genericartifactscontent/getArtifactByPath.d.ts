 ...
 * ```
 */
export declare function getArtifactByPath(args: GetArtifactByPathArgs, opts?: pulumi.InvokeOptions): Promise<GetArtifactByPathResult>;
/**
 ...
 * ```
 */
export declare function getArtifactByPathOutput(args: GetArtifactByPathOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetArtifactByPathResult>;
/**
 * A collection of arguments for invoking getArtifactByPath.
 */

 ...
 * ```
 */
export declare function getInvoice(args: GetInvoiceArgs, opts?: pulumi.InvokeOptions): Promise<GetInvoiceResult>;
/**
 ...
 * ```
 */
export declare function getInvoiceOutput(args: GetInvoiceOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetInvoiceResult>;
/**
 * A collection of arguments for invoking getInvoice.
 */

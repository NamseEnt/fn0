 ...
 * ```
 */
export declare function getSubscriptionProducts(args: GetSubscriptionProductsArgs, opts?: pulumi.InvokeOptions): Promise<GetSubscriptionProductsResult>;
/**
 ...
 * ```
 */
export declare function getSubscriptionProductsOutput(args: GetSubscriptionProductsOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetSubscriptionProductsResult>;
/**
 * A collection of arguments for invoking getSubscriptionProducts.
 */

 ...
 * ```
 */
class TargetAsset extends pulumi.CustomResource {
    /**
    ...
    static get(name, id, state, opts) {
        return new TargetAsset(name, state, { ...opts, id: id });
    }
    /**
...
exports.TargetAsset = TargetAsset;
/** @internal */
TargetAsset.__pulumiType = 'oci:CloudMigrations/targetAsset:TargetAsset';
//# sourceMappingURL=targetAsset.js.map
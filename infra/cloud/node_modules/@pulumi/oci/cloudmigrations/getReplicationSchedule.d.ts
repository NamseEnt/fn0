 ...
 * ```
 */
export declare function getReplicationSchedule(args: GetReplicationScheduleArgs, opts?: pulumi.InvokeOptions): Promise<GetReplicationScheduleResult>;
/**
 ...
 * ```
 */
export declare function getReplicationScheduleOutput(args: GetReplicationScheduleOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetReplicationScheduleResult>;
/**
 * A collection of arguments for invoking getReplicationSchedule.
 */

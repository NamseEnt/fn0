 ...
 * ```
 */
export declare class ReplicationSchedule extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ReplicationScheduleState, opts?: pulumi.CustomResourceOptions): ReplicationSchedule;
    /**
     * Returns true if the given object is an instance of ReplicationSchedule.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is ReplicationSchedule;
    /**

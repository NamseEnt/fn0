 ...
 * ```
 */
class MigrationAsset extends pulumi.CustomResource {
    /**
    ...
    static get(name, id, state, opts) {
        return new MigrationAsset(name, state, { ...opts, id: id });
    }
    /**
...
exports.MigrationAsset = MigrationAsset;
/** @internal */
MigrationAsset.__pulumiType = 'oci:CloudMigrations/migrationAsset:MigrationAsset';
//# sourceMappingURL=migrationAsset.js.map
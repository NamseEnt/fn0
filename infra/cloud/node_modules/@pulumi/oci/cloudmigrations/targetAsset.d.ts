 ...
 * ```
 */
export declare class TargetAsset extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: TargetAssetState, opts?: pulumi.CustomResourceOptions): TargetAsset;
    /**
     * Returns true if the given object is an instance of TargetAsset.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is TargetAsset;
    /**
     * (Updatable) Performance of the block volumes.
     */
    readonly blockVolumesPerformance: pulumi.Output<number>;
    /**
     ...
     */
    readonly compatibilityMessages: pulumi.Output<outputs.CloudMigrations.TargetAssetCompatibilityMessage[]>;
    /**
     * Created resource identifier
     */
    readonly createdResourceId: pulumi.Output<string>;
    /**
     ...
     */
    readonly estimatedCosts: pulumi.Output<outputs.CloudMigrations.TargetAssetEstimatedCost[]>;
    /**
     * (Updatable) A boolean indicating whether the asset should be migrated.
     */
    readonly isExcludedFromExecution: pulumi.Output<boolean>;
    /**
     ...
     */
    readonly migrationAssets: pulumi.Output<outputs.CloudMigrations.TargetAssetMigrationAsset[]>;
    /**
     * OCID of the associated migration plan.
     */
    readonly migrationPlanId: pulumi.Output<string>;
    /**
     * (Updatable) Microsoft license for the VM configuration.
     */
    readonly msLicense: pulumi.Output<string>;
    /**
     * (Updatable) Preferred VM shape type that you provide.
     */
    readonly preferredShapeType: pulumi.Output<string>;
    /**
     ...
     */
    readonly recommendedSpecs: pulumi.Output<outputs.CloudMigrations.TargetAssetRecommendedSpec[]>;
    /**
     ...
     * Instance launch details. Use the `sourceDetails` parameter to specify whether a boot volume or an image should be used to launch a new instance.
     */
    readonly testSpecs: pulumi.Output<outputs.CloudMigrations.TargetAssetTestSpec[]>;
    /**
     * The time when the assessment was done. An RFC3339 formatted datetime string.
     */
    readonly timeAssessed: pulumi.Output<string>;
    /**
     ...
     */
    readonly userSpec: pulumi.Output<outputs.CloudMigrations.TargetAssetUserSpec>;
    /**

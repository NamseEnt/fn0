 ...
 * ```
 */
export declare function getResourceAvailability(args: GetResourceAvailabilityArgs, opts?: pulumi.InvokeOptions): Promise<GetResourceAvailabilityResult>;
/**
 ...
 * ```
 */
export declare function getResourceAvailabilityOutput(args: GetResourceAvailabilityOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetResourceAvailabilityResult>;
/**
 * A collection of arguments for invoking getResourceAvailability.
 */

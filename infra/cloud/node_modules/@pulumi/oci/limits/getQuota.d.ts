 ...
 * ```
 */
export declare function getQuota(args: GetQuotaArgs, opts?: pulumi.InvokeOptions): Promise<GetQuotaResult>;
/**
 ...
 * ```
 */
export declare function getQuotaOutput(args: GetQuotaOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetQuotaResult>;
/**
 * A collection of arguments for invoking getQuota.
 */

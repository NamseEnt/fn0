 ...
 * ```
 */
export declare function getKnowledgebasesOutput(args?: GetKnowledgebasesOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetKnowledgebasesResult>;
/**
 * A collection of arguments for invoking getKnowledgebases.
 */

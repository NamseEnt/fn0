 ...
 * ```
 */
export declare function getRemediationRunStage(args: GetRemediationRunStageArgs, opts?: pulumi.InvokeOptions): Promise<GetRemediationRunStageResult>;
/**
 ...
 * ```
 */
export declare function getRemediationRunStageOutput(args: GetRemediationRunStageOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetRemediationRunStageResult>;
/**
 * A collection of arguments for invoking getRemediationRunStage.
 */

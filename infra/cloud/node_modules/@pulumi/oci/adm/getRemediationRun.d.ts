 ...
 * ```
 */
export declare function getRemediationRun(args: GetRemediationRunArgs, opts?: pulumi.InvokeOptions): Promise<GetRemediationRunResult>;
/**
 ...
 * ```
 */
export declare function getRemediationRunOutput(args: GetRemediationRunOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetRemediationRunResult>;
/**
 * A collection of arguments for invoking getRemediationRun.
 */

...
export interface GetMonitoredResourceTypeResult {
     ...
     */
    readonly additionalNamespaceMap: {
        [key: string]: string;
    };
    /**
 ...
 * ```
 */
export declare function getMonitoredResourceTypeOutput(args: GetMonitoredResourceTypeOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetMonitoredResourceTypeResult>;
/**
 * A collection of arguments for invoking getMonitoredResourceType.
 */

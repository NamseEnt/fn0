 ...
 * ```
 */
export declare function getDiscoveryJobs(args: GetDiscoveryJobsArgs, opts?: pulumi.InvokeOptions): Promise<GetDiscoveryJobsResult>;
/**
 ...
 * ```
 */
export declare function getDiscoveryJobsOutput(args: GetDiscoveryJobsOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetDiscoveryJobsResult>;
/**
 * A collection of arguments for invoking getDiscoveryJobs.
 */

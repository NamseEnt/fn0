 ...
 * ```
 */
export declare class MonitoringTemplateMonitoringTemplateOnGivenResourcesManagement extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: MonitoringTemplateMonitoringTemplateOnGivenResourcesManagementState, opts?: pulumi.CustomResourceOptions): MonitoringTemplateMonitoringTemplateOnGivenResourcesManagement;
    /**
     ...
     */
    static isInstance(obj: any): obj is MonitoringTemplateMonitoringTemplateOnGivenResourcesManagement;
    /**
     ...
     */
    readonly enableMonitoringTemplateOnGivenResources: pulumi.Output<boolean>;
    /**
     * The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the monitoring template.
     */
    readonly monitoringTemplateId: pulumi.Output<string>;
    /**

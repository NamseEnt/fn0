 ...
 * ```
 */
export declare function getProcessSet(args: GetProcessSetArgs, opts?: pulumi.InvokeOptions): Promise<GetProcessSetResult>;
/**
 ...
 * ```
 */
export declare function getProcessSetOutput(args: GetProcessSetOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetProcessSetResult>;
/**
 * A collection of arguments for invoking getProcessSet.
 */

 ...
 * ```
 */
export declare class MetricExtensionMetricExtensionOnGivenResourcesManagement extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: MetricExtensionMetricExtensionOnGivenResourcesManagementState, opts?: pulumi.CustomResourceOptions): MetricExtensionMetricExtensionOnGivenResourcesManagement;
    /**
     ...
     */
    static isInstance(obj: any): obj is MetricExtensionMetricExtensionOnGivenResourcesManagement;
    /**
     ...
     */
    readonly enableMetricExtensionOnGivenResources: pulumi.Output<boolean>;
    /**

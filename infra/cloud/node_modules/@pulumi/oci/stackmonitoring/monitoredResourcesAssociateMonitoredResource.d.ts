 ...
 * ```
 */
export declare class MonitoredResourcesAssociateMonitoredResource extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: MonitoredResourcesAssociateMonitoredResourceState, opts?: pulumi.CustomResourceOptions): MonitoredResourcesAssociateMonitoredResource;
    /**
     ...
     */
    static isInstance(obj: any): obj is MonitoredResourcesAssociateMonitoredResource;
    /**
     ...
     */
    readonly destinationResourceDetails: pulumi.Output<outputs.StackMonitoring.MonitoredResourcesAssociateMonitoredResourceDestinationResourceDetail[]>;
    /**
     ...
     * Association Resource Details.
     */
    readonly sourceResourceDetails: pulumi.Output<outputs.StackMonitoring.MonitoredResourcesAssociateMonitoredResourceSourceResourceDetail[]>;
    /**

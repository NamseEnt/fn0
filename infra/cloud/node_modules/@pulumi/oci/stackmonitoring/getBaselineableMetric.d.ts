 ...
 * ```
 */
export declare function getBaselineableMetric(args: GetBaselineableMetricArgs, opts?: pulumi.InvokeOptions): Promise<GetBaselineableMetricResult>;
/**
 ...
 * ```
 */
export declare function getBaselineableMetricOutput(args: GetBaselineableMetricOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetBaselineableMetricResult>;
/**
 * A collection of arguments for invoking getBaselineableMetric.
 */

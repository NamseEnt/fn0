 ...
 * ```
 */
class MonitoringTemplate extends pulumi.CustomResource {
    /**
    ...
    static get(name, id, state, opts) {
        return new MonitoringTemplate(name, state, { ...opts, id: id });
    }
    /**
...
/** @internal */
MonitoringTemplate.__pulumiType = 'oci:StackMonitoring/monitoringTemplate:MonitoringTemplate';
//# sourceMappingURL=monitoringTemplate.js.map
 ...
 * ```
 */
export declare function getMonitoringTemplateAlarmCondition(args: GetMonitoringTemplateAlarmConditionArgs, opts?: pulumi.InvokeOptions): Promise<GetMonitoringTemplateAlarmConditionResult>;
/**
 ...
 * ```
 */
export declare function getMonitoringTemplateAlarmConditionOutput(args: GetMonitoringTemplateAlarmConditionOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetMonitoringTemplateAlarmConditionResult>;
/**
 * A collection of arguments for invoking getMonitoringTemplateAlarmCondition.
 */

 ...
 * ```
 */
export declare class OdaPrivateEndpoint extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: OdaPrivateEndpointState, opts?: pulumi.CustomResourceOptions): OdaPrivateEndpoint;
    /**
     * Returns true if the given object is an instance of OdaPrivateEndpoint.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is OdaPrivateEndpoint;
    /**

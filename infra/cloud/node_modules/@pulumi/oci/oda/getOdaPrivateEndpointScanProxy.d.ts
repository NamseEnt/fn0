 ...
 * ```
 */
export declare function getOdaPrivateEndpointScanProxy(args: GetOdaPrivateEndpointScanProxyArgs, opts?: pulumi.InvokeOptions): Promise<GetOdaPrivateEndpointScanProxyResult>;
/**
 ...
 * ```
 */
export declare function getOdaPrivateEndpointScanProxyOutput(args: GetOdaPrivateEndpointScanProxyOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetOdaPrivateEndpointScanProxyResult>;
/**
 * A collection of arguments for invoking getOdaPrivateEndpointScanProxy.
 */

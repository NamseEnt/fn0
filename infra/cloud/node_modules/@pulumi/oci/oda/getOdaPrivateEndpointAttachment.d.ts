 ...
 * ```
 */
export declare function getOdaPrivateEndpointAttachment(args: GetOdaPrivateEndpointAttachmentArgs, opts?: pulumi.InvokeOptions): Promise<GetOdaPrivateEndpointAttachmentResult>;
/**
 ...
 * ```
 */
export declare function getOdaPrivateEndpointAttachmentOutput(args: GetOdaPrivateEndpointAttachmentOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetOdaPrivateEndpointAttachmentResult>;
/**
 * A collection of arguments for invoking getOdaPrivateEndpointAttachment.
 */

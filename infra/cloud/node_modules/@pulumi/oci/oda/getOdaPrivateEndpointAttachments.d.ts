 ...
 * ```
 */
export declare function getOdaPrivateEndpointAttachments(args: GetOdaPrivateEndpointAttachmentsArgs, opts?: pulumi.InvokeOptions): Promise<GetOdaPrivateEndpointAttachmentsResult>;
/**
 ...
 * ```
 */
export declare function getOdaPrivateEndpointAttachmentsOutput(args: GetOdaPrivateEndpointAttachmentsOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetOdaPrivateEndpointAttachmentsResult>;
/**
 * A collection of arguments for invoking getOdaPrivateEndpointAttachments.
 */

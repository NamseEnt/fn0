 ...
 * ```
 */
export declare function getOdaInstance(args: GetOdaInstanceArgs, opts?: pulumi.InvokeOptions): Promise<GetOdaInstanceResult>;
/**
 ...
 * ```
 */
export declare function getOdaInstanceOutput(args: GetOdaInstanceOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetOdaInstanceResult>;
/**
 * A collection of arguments for invoking getOdaInstance.
 */

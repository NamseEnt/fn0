 ...
 * ```
 */
export declare function getLicenseMetric(args: GetLicenseMetricArgs, opts?: pulumi.InvokeOptions): Promise<GetLicenseMetricResult>;
/**
 ...
 * ```
 */
export declare function getLicenseMetricOutput(args: GetLicenseMetricOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetLicenseMetricResult>;
/**
 * A collection of arguments for invoking getLicenseMetric.
 */

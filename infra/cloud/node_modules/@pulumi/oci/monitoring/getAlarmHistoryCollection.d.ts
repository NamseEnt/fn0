 ...
 * ```
 */
export declare function getAlarmHistoryCollection(args: GetAlarmHistoryCollectionArgs, opts?: pulumi.InvokeOptions): Promise<GetAlarmHistoryCollectionResult>;
/**
 ...
 * ```
 */
export declare function getAlarmHistoryCollectionOutput(args: GetAlarmHistoryCollectionOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetAlarmHistoryCollectionResult>;
/**
 * A collection of arguments for invoking getAlarmHistoryCollection.
 */

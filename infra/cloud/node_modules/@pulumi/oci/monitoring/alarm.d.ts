...
export declare class Alarm extends pulumi.CustomResource {
     ...
     */
    readonly alarmSummary: pulumi.Output<string>;
    /**
     ...
     */
    readonly evaluationSlackDuration: pulumi.Output<string>;
    /**
     ...
     */
    readonly isNotificationsPerMetricDimensionEnabled: pulumi.Output<boolean>;
    /**
     ...
     */
    readonly messageFormat: pulumi.Output<string>;
    /**
     ...
     */
    readonly metricCompartmentId: pulumi.Output<string>;
    /**
     ...
     */
    readonly metricCompartmentIdInSubtree: pulumi.Output<boolean>;
    /**
     ...
     */
    readonly notificationTitle: pulumi.Output<string>;
    /**
     ...
     */
    readonly notificationVersion: pulumi.Output<string>;
    /**
     ...
     */
    readonly overrides: pulumi.Output<outputs.Monitoring.AlarmOverride[]>;
    /**
     ...
     * Example: `PT5M`
     */
    readonly pendingDuration: pulumi.Output<string>;
    /**
     ...
     * Example: `PT2H`
     */
    readonly repeatNotificationDuration: pulumi.Output<string>;
    /**
     ...
     */
    readonly suppression: pulumi.Output<outputs.Monitoring.AlarmSuppression>;
    /**

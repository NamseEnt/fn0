 ...
 * ```
 */
export declare class DrProtectionGroup extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: DrProtectionGroupState, opts?: pulumi.CustomResourceOptions): DrProtectionGroup;
    /**

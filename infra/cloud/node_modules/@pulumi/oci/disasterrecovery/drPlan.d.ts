 ...
 * ```
 */
export declare class DrPlan extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: DrPlanState, opts?: pulumi.CustomResourceOptions): DrPlan;
    /**
     * Returns true if the given object is an instance of DrPlan.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is DrPlan;
    /**
     ...
     */
    readonly planGroups: pulumi.Output<outputs.DisasterRecovery.DrPlanPlanGroup[]>;
    /**
     ...
     */
    readonly sourcePlanId: pulumi.Output<string>;
    /**
     * The current state of the DR plan.
     */
     ...
     */
    readonly verifyTrigger: pulumi.Output<number | undefined>;
    /**

 ...
 * ```
 */
export declare class DrPlanExecution extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: DrPlanExecutionState, opts?: pulumi.CustomResourceOptions): DrPlanExecution;
    /**
     ...
     */
    readonly automaticExecutionDetails: pulumi.Output<outputs.DisasterRecovery.DrPlanExecutionAutomaticExecutionDetail[]>;
    /**

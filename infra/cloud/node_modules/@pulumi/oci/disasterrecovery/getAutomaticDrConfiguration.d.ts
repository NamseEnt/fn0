 ...
 * ```
 */
export declare function getAutomaticDrConfiguration(args: GetAutomaticDrConfigurationArgs, opts?: pulumi.InvokeOptions): Promise<GetAutomaticDrConfigurationResult>;
/**
 ...
 * ```
 */
export declare function getAutomaticDrConfigurationOutput(args: GetAutomaticDrConfigurationOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetAutomaticDrConfigurationResult>;
/**
 * A collection of arguments for invoking getAutomaticDrConfiguration.
 */

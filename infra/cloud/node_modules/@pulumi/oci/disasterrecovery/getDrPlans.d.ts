 ...
 * ```
 */
export declare function getDrPlans(args: GetDrPlansArgs, opts?: pulumi.InvokeOptions): Promise<GetDrPlansResult>;
/**
 ...
 * ```
 */
export declare function getDrPlansOutput(args: GetDrPlansOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetDrPlansResult>;
/**
 * A collection of arguments for invoking getDrPlans.
 */

 ...
 * ```
 */
export declare function getDrPlanExecutions(args: GetDrPlanExecutionsArgs, opts?: pulumi.InvokeOptions): Promise<GetDrPlanExecutionsResult>;
/**
 ...
 * ```
 */
export declare function getDrPlanExecutionsOutput(args: GetDrPlanExecutionsOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetDrPlanExecutionsResult>;
/**
 * A collection of arguments for invoking getDrPlanExecutions.
 */

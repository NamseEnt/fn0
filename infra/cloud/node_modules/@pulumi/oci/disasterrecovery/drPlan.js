 ...
 * ```
 */
class DrPlan extends pulumi.CustomResource {
    /**
    ...
    static get(name, id, state, opts) {
        return new DrPlan(name, state, { ...opts, id: id });
    }
    /**
...
exports.DrPlan = DrPlan;
/** @internal */
DrPlan.__pulumiType = 'oci:DisasterRecovery/drPlan:DrPlan';
//# sourceMappingURL=drPlan.js.map
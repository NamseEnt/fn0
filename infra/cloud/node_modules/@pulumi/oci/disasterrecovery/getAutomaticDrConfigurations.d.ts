 ...
 * ```
 */
export declare function getAutomaticDrConfigurations(args: GetAutomaticDrConfigurationsArgs, opts?: pulumi.InvokeOptions): Promise<GetAutomaticDrConfigurationsResult>;
/**
 ...
 * ```
 */
export declare function getAutomaticDrConfigurationsOutput(args: GetAutomaticDrConfigurationsOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetAutomaticDrConfigurationsResult>;
/**
 * A collection of arguments for invoking getAutomaticDrConfigurations.
 */

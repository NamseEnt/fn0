 ...
 * ```
 */
export declare function getAutoScalingConfigurations(args: GetAutoScalingConfigurationsArgs, opts?: pulumi.InvokeOptions): Promise<GetAutoScalingConfigurationsResult>;
/**
 ...
 * ```
 */
export declare function getAutoScalingConfigurationsOutput(args: GetAutoScalingConfigurationsOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetAutoScalingConfigurationsResult>;
/**
 * A collection of arguments for invoking getAutoScalingConfigurations.
 */

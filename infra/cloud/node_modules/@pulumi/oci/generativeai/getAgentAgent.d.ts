 ...
 * ```
 */
export declare function getAgentAgent(args: GetAgentAgentArgs, opts?: pulumi.InvokeOptions): Promise<GetAgentAgentResult>;
/**
 ...
 * ```
 */
export declare function getAgentAgentOutput(args: GetAgentAgentOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetAgentAgentResult>;
/**
 * A collection of arguments for invoking getAgentAgent.
 */

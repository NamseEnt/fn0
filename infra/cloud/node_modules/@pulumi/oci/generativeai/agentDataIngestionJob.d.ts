 ...
 * ```
 */
export declare class AgentDataIngestionJob extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: AgentDataIngestionJobState, opts?: pulumi.CustomResourceOptions): AgentDataIngestionJob;
    /**
     * Returns true if the given object is an instance of AgentDataIngestionJob.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is AgentDataIngestionJob;
    /**
     ...
     */
    readonly dataIngestionJobStatistics: pulumi.Output<outputs.GenerativeAi.AgentDataIngestionJobDataIngestionJobStatistic[]>;
    /**
     * DataIngestionJob type.
     */
    readonly dataIngestionJobTypes: pulumi.Output<outputs.GenerativeAi.AgentDataIngestionJobDataIngestionJobType[]>;
    /**

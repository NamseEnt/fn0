 ...
 * ```
 */
export declare class AgentTool extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: AgentToolState, opts?: pulumi.CustomResourceOptions): AgentTool;
    /**
     * Returns true if the given object is an instance of AgentTool.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is AgentTool;
    /**
     ...
     */
    readonly toolConfig: pulumi.Output<outputs.GenerativeAi.AgentToolToolConfig>;
    /**

 ...
 * ```
 */
export declare function getGenerativeAiPrivateEndpoints(args: GetGenerativeAiPrivateEndpointsArgs, opts?: pulumi.InvokeOptions): Promise<GetGenerativeAiPrivateEndpointsResult>;
/**
 ...
 * ```
 */
export declare function getGenerativeAiPrivateEndpointsOutput(args: GetGenerativeAiPrivateEndpointsOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetGenerativeAiPrivateEndpointsResult>;
/**
 * A collection of arguments for invoking getGenerativeAiPrivateEndpoints.
 */

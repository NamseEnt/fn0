 ...
 * ```
 */
export declare function getAgentProvisionedCapacity(args: GetAgentProvisionedCapacityArgs, opts?: pulumi.InvokeOptions): Promise<GetAgentProvisionedCapacityResult>;
/**
 ...
 * ```
 */
export declare function getAgentProvisionedCapacityOutput(args: GetAgentProvisionedCapacityOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetAgentProvisionedCapacityResult>;
/**
 * A collection of arguments for invoking getAgentProvisionedCapacity.
 */

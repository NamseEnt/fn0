 ...
 * ```
 */
export declare function getAgentAgentEndpoint(args: GetAgentAgentEndpointArgs, opts?: pulumi.InvokeOptions): Promise<GetAgentAgentEndpointResult>;
/**
 ...
 * ```
 */
export declare function getAgentAgentEndpointOutput(args: GetAgentAgentEndpointOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetAgentAgentEndpointResult>;
/**
 * A collection of arguments for invoking getAgentAgentEndpoint.
 */

 ...
 * ```
 */
export declare function getDedicatedAiClusters(args: GetDedicatedAiClustersArgs, opts?: pulumi.InvokeOptions): Promise<GetDedicatedAiClustersResult>;
/**
 ...
 * ```
 */
export declare function getDedicatedAiClustersOutput(args: GetDedicatedAiClustersOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetDedicatedAiClustersResult>;
/**
 * A collection of arguments for invoking getDedicatedAiClusters.
 */

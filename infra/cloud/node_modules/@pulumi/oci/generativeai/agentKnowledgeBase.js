...
class AgentKnowledgeBase extends pulumi.CustomResource {
    ...
    constructor(name, argsOrState, opts) {
        ...
        if (opts.id) {
            ...
            resourceInputs["knowledgeBaseStatistics"] = state?.knowledgeBaseStatistics;
            ...
            if (args?.indexConfig === undefined && !opts.urn) {
...
/** @internal */
AgentKnowledgeBase.__pulumiType = 'oci:GenerativeAi/agentKnowledgeBase:AgentKnowledgeBase';

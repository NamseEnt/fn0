 ...
 * ```
 */
export declare class HttpRedirect extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: HttpRedirectState, opts?: pulumi.CustomResourceOptions): HttpRedirect;
    /**
     * Returns true if the given object is an instance of HttpRedirect.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is HttpRedirect;
    /**
     ...
     */
    readonly responseCode: pulumi.Output<number>;
    /**
     ...
     */
    readonly target: pulumi.Output<outputs.Waas.HttpRedirectTarget>;
    /**

 ...
 * ```
 */
export declare function getAddressLists(args: GetAddressListsArgs, opts?: pulumi.InvokeOptions): Promise<GetAddressListsResult>;
/**
 ...
 * ```
 */
export declare function getAddressListsOutput(args: GetAddressListsOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetAddressListsResult>;
/**
 * A collection of arguments for invoking getAddressLists.
 */

 ...
 * ```
 */
export declare function getWaasPolicy(args: GetWaasPolicyArgs, opts?: pulumi.InvokeOptions): Promise<GetWaasPolicyResult>;
/**
 ...
 * ```
 */
export declare function getWaasPolicyOutput(args: GetWaasPolicyOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetWaasPolicyResult>;
/**
 * A collection of arguments for invoking getWaasPolicy.
 */

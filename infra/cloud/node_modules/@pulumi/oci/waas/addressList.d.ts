 ...
 * ```
 */
export declare class AddressList extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: AddressListState, opts?: pulumi.CustomResourceOptions): AddressList;
    /**
     * Returns true if the given object is an instance of AddressList.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is AddressList;
    /**
     * The total number of unique IP addresses in the address list.
     */
    readonly addressCount: pulumi.Output<number>;
    /**

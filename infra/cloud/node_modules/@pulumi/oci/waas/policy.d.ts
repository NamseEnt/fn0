...
export declare class Policy extends pulumi.CustomResource {
     ...
     */
    readonly additionalDomains: pulumi.Output<string[]>;
    /**
     ...
     */
    readonly originGroups: pulumi.Output<outputs.Waas.PolicyOriginGroup[]>;
    /**
     ...
     */
    readonly origins: pulumi.Output<outputs.Waas.PolicyOrigin[]>;
    /**
     * (Updatable) The configuration details for the WAAS policy.
     */
    readonly policyConfig: pulumi.Output<outputs.Waas.PolicyPolicyConfig>;
    /**
     ...
     */
    readonly wafConfig: pulumi.Output<outputs.Waas.PolicyWafConfig>;
    /**

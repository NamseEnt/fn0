 ...
 * ```
 */
export declare class ProtectionRule extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ProtectionRuleState, opts?: pulumi.CustomResourceOptions): ProtectionRule;
    /**
     * Returns true if the given object is an instance of ProtectionRule.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is ProtectionRule;
    /**
     ...
     * (Updatable)
     */
    readonly exclusions: pulumi.Output<outputs.Waas.ProtectionRuleExclusion[]>;
    /**
     ...
     */
    readonly modSecurityRuleIds: pulumi.Output<string[]>;
    /**
     ...
     */
    readonly waasPolicyId: pulumi.Output<string>;
    /**

 ...
 * ```
 */
export declare class CustomProtectionRule extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: CustomProtectionRuleState, opts?: pulumi.CustomResourceOptions): CustomProtectionRule;
    /**
     * Returns true if the given object is an instance of CustomProtectionRule.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is CustomProtectionRule;
    /**

 ...
 * ```
 */
export declare function getFileStorageLustreFileSystems(args?: GetFileStorageLustreFileSystemsArgs, opts?: pulumi.InvokeOptions): Promise<GetFileStorageLustreFileSystemsResult>;
/**
 * A collection of arguments for invoking getFileStorageLustreFileSystems.
 */
export interface GetFileStorageLustreFileSystemsArgs {
    /**
     ...
     */
    displayName?: string;
    filters?: inputs.Lustre.GetFileStorageLustreFileSystemsFilter[];
    /**
 ...
 */
export interface GetFileStorageLustreFileSystemsResult {
    /**
    ...
    readonly filters?: outputs.Lustre.GetFileStorageLustreFileSystemsFilter[];
    /**
     * The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the Lustre file system.
     */
    readonly id?: string;
     ...
     */
    readonly lustreFileSystemCollections: outputs.Lustre.GetFileStorageLustreFileSystemsLustreFileSystemCollection[];
    /**
 ...
 * ```
 */
export declare function getFileStorageLustreFileSystemsOutput(args?: GetFileStorageLustreFileSystemsOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetFileStorageLustreFileSystemsResult>;
/**
 * A collection of arguments for invoking getFileStorageLustreFileSystems.
 */
export interface GetFileStorageLustreFileSystemsOutputArgs {
    /**
     * The name of the availability domain.  Example: `Uocm:PHX-AD-1`
     */

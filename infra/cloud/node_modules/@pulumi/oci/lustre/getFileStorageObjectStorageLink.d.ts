 ...
 * ```
 */
export declare function getFileStorageObjectStorageLink(args: GetFileStorageObjectStorageLinkArgs, opts?: pulumi.InvokeOptions): Promise<GetFileStorageObjectStorageLinkResult>;
/**
 ...
 * ```
 */
export declare function getFileStorageObjectStorageLinkOutput(args: GetFileStorageObjectStorageLinkOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetFileStorageObjectStorageLinkResult>;
/**
 * A collection of arguments for invoking getFileStorageObjectStorageLink.
 */

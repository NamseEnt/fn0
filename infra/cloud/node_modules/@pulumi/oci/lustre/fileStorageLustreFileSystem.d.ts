 ...
 * ```
 */
export declare class FileStorageLustreFileSystem extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: FileStorageLustreFileSystemState, opts?: pulumi.CustomResourceOptions): FileStorageLustreFileSystem;
    /**
     ...
     */
    static isInstance(obj: any): obj is FileStorageLustreFileSystem;
    /**
     ...
     */
    readonly capacityInGbs: pulumi.Output<number>;
    /**
    ...
    readonly dateTimeDetails: pulumi.Output<outputs.Lustre.FileStorageLustreFileSystemDateTimeDetails | undefined>;
    /**
     ...
     */
    readonly fileSystemDescription: pulumi.Output<string>;
    /**
     ...
     */
    readonly lnet: pulumi.Output<string>;
    /**
     * The meta-data for maintenance window.
     */
    readonly maintenanceWindowMetadatas: pulumi.Output<outputs.Lustre.FileStorageLustreFileSystemMaintenanceWindowMetadata[]>;
    /**
     * (Updatable) The preferred day and time to perform maintenance.
     */
    readonly maintenanceWindows: pulumi.Output<outputs.Lustre.FileStorageLustreFileSystemMaintenanceWindow[]>;
    /**
     * Major version of Lustre running in the Lustre file system.  Example: `2.15`
     */
    readonly majorVersion: pulumi.Output<string>;
    /**
     * The IPv4 address of MGS (Lustre Management Service) used by clients to mount the file system. For example '10.0.0.4'.
     */
    readonly managementServiceAddress: pulumi.Output<string>;
    /**
     ...
     */
    readonly rootSquashConfiguration: pulumi.Output<outputs.Lustre.FileStorageLustreFileSystemRootSquashConfiguration>;
    /**

...
exports.FileStorageLustreFileSystem = void 0;
 ...
 * ```
 */
class FileStorageLustreFileSystem extends pulumi.CustomResource {
    /**
    ...
    static get(name, id, state, opts) {
        return new FileStorageLustreFileSystem(name, state, { ...opts, id: id });
    }
    /**
    ...
    constructor(name, argsOrState, opts) {
        ...
        if (opts.id) {
            ...
            if (args?.capacityInGbs === undefined && !opts.urn) {
            ...
            if (args?.performanceTier === undefined && !opts.urn) {
                throw new Error("Missing required property 'performanceTier'");
            }
            if (args?.rootSquashConfiguration === undefined && !opts.urn) {
...
exports.FileStorageLustreFileSystem = FileStorageLustreFileSystem;
/** @internal */
FileStorageLustreFileSystem.__pulumiType = 'oci:Lustre/fileStorageLustreFileSystem:FileStorageLustreFileSystem';
//# sourceMappingURL=fileStorageLustreFileSystem.js.map
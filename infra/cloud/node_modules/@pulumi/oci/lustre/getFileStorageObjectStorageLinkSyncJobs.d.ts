 ...
 * ```
 */
export declare function getFileStorageObjectStorageLinkSyncJobs(args: GetFileStorageObjectStorageLinkSyncJobsArgs, opts?: pulumi.InvokeOptions): Promise<GetFileStorageObjectStorageLinkSyncJobsResult>;
/**
 ...
 * ```
 */
export declare function getFileStorageObjectStorageLinkSyncJobsOutput(args: GetFileStorageObjectStorageLinkSyncJobsOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetFileStorageObjectStorageLinkSyncJobsResult>;
/**
 * A collection of arguments for invoking getFileStorageObjectStorageLinkSyncJobs.
 */

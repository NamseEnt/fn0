 ...
 * ```
 */
export declare function getFileStorageLustreFileSystem(args: GetFileStorageLustreFileSystemArgs, opts?: pulumi.InvokeOptions): Promise<GetFileStorageLustreFileSystemResult>;
/**
 ...
 * ```
 */
export declare function getFileStorageLustreFileSystemOutput(args: GetFileStorageLustreFileSystemOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetFileStorageLustreFileSystemResult>;
/**
 * A collection of arguments for invoking getFileStorageLustreFileSystem.
 */

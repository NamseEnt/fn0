 ...
 * ```
 */
export declare class FileStorageObjectStorageLink extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: FileStorageObjectStorageLinkState, opts?: pulumi.CustomResourceOptions): FileStorageObjectStorageLink;
    /**
     ...
     */
    static isInstance(obj: any): obj is FileStorageObjectStorageLink;
    /**
     ...
     */
    readonly currentJobId: pulumi.Output<string>;
    /**
     ...
     */
    readonly isOverwrite: pulumi.Output<boolean>;
    /**
     ...
     */
    readonly lastJobId: pulumi.Output<string>;
    /**
     ...
     */
    readonly lustreFileSystemId: pulumi.Output<string>;
    /**
     ...
     */
    readonly stopExportToObjectTrigger: pulumi.Output<number | undefined>;
    /**
     ...
     */
    readonly stopImportFromObjectTrigger: pulumi.Output<number | undefined>;
    /**

 ...
 * ```
 */
export declare function getServiceConnectors(args: GetServiceConnectorsArgs, opts?: pulumi.InvokeOptions): Promise<GetServiceConnectorsResult>;
/**
 ...
 * ```
 */
export declare function getServiceConnectorsOutput(args: GetServiceConnectorsOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetServiceConnectorsResult>;
/**
 * A collection of arguments for invoking getServiceConnectors.
 */

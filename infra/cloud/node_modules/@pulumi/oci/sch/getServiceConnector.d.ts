 ...
 * ```
 */
export declare function getServiceConnector(args: GetServiceConnectorArgs, opts?: pulumi.InvokeOptions): Promise<GetServiceConnectorResult>;
/**
 ...
 * ```
 */
export declare function getServiceConnectorOutput(args: GetServiceConnectorOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetServiceConnectorResult>;
/**
 * A collection of arguments for invoking getServiceConnector.
 */

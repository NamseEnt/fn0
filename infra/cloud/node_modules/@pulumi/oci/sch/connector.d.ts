...
export declare class Connector extends pulumi.CustomResource {
     ...
     * (Updatable)
     */
    readonly source: pulumi.Output<outputs.Sch.ConnectorSource>;
    /**
     ...
     * (Updatable)
     */
    readonly target: pulumi.Output<outputs.Sch.ConnectorTarget>;
    /**
     * (Updatable) The list of tasks.
     */
    readonly tasks: pulumi.Output<outputs.Sch.ConnectorTask[]>;
    /**

 ...
 * ```
 */
export declare class CompliancePolicyRule extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: CompliancePolicyRuleState, opts?: pulumi.CustomResourceOptions): CompliancePolicyRule;
    /**
     * Returns true if the given object is an instance of CompliancePolicyRule.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is CompliancePolicyRule;
    /**
     ...
     */
    readonly compliancePolicyId: pulumi.Output<string>;
    /**
     ...
     */
    readonly patchSelection: pulumi.Output<outputs.FleetAppsManagement.CompliancePolicyRulePatchSelection>;
    /**
     * (Updatable) PlatformConfiguration OCID for the patch type to which this CompliancePolicyRule applies.
     */
    readonly patchTypeIds: pulumi.Output<string[]>;
    /**
     ...
     */
    readonly productVersion: pulumi.Output<outputs.FleetAppsManagement.CompliancePolicyRuleProductVersion>;
    /**
     ...
     */
    readonly severities: pulumi.Output<string[]>;
    /**

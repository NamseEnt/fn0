 ...
 * ```
 */
export declare class Onboarding extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: OnboardingState, opts?: pulumi.CustomResourceOptions): Onboarding;
    /**
     * Returns true if the given object is an instance of Onboarding.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is Onboarding;
    /**
     * Summary of the Fleet Application Management Onboard Policy.
     */
    readonly appliedPolicies: pulumi.Output<outputs.FleetAppsManagement.OnboardingAppliedPolicy[]>;
    /**
     * Tenancy OCID
     * <<<<<<< ours
     */
     ...
     */
    readonly discoveryFrequency: pulumi.Output<string>;
    /**
     ...
     */
    readonly isCostTrackingTagEnabled: pulumi.Output<boolean>;
    /**
     ...
     * new property values
     */
    readonly isFamsTagEnabled: pulumi.Output<boolean>;
    /**
     * Associated region
     */

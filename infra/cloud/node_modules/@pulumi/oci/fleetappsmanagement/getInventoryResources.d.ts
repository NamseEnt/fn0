 ...
 * ```
 */
export declare function getInventoryResources(args: GetInventoryResourcesArgs, opts?: pulumi.InvokeOptions): Promise<GetInventoryResourcesResult>;
/**
 ...
 * ```
 */
export declare function getInventoryResourcesOutput(args: GetInventoryResourcesOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetInventoryResourcesResult>;
/**
 * A collection of arguments for invoking getInventoryResources.
 */

 ...
 * ```
 */
export declare function getCatalogItem(args: GetCatalogItemArgs, opts?: pulumi.InvokeOptions): Promise<GetCatalogItemResult>;
/**
 ...
 * ```
 */
export declare function getCatalogItemOutput(args: GetCatalogItemOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetCatalogItemResult>;
/**
 * A collection of arguments for invoking getCatalogItem.
 */

 ...
 * ```
 */
export declare function getFleetProperty(args: GetFleetPropertyArgs, opts?: pulumi.InvokeOptions): Promise<GetFleetPropertyResult>;
/**
 ...
 * ```
 */
export declare function getFleetPropertyOutput(args: GetFleetPropertyOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetFleetPropertyResult>;
/**
 * A collection of arguments for invoking getFleetProperty.
 */

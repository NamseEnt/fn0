 ...
 * ```
 */
export declare function getSchedulerDefinition(args: GetSchedulerDefinitionArgs, opts?: pulumi.InvokeOptions): Promise<GetSchedulerDefinitionResult>;
/**
 ...
 * ```
 */
export declare function getSchedulerDefinitionOutput(args: GetSchedulerDefinitionOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetSchedulerDefinitionResult>;
/**
 * A collection of arguments for invoking getSchedulerDefinition.
 */

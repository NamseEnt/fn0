 ...
 * ```
 */
export declare class PlatformConfiguration extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: PlatformConfigurationState, opts?: pulumi.CustomResourceOptions): PlatformConfiguration;
    /**
     * Returns true if the given object is an instance of PlatformConfiguration.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is PlatformConfiguration;
    /**
     ...
     */
    readonly configCategoryDetails: pulumi.Output<outputs.FleetAppsManagement.PlatformConfigurationConfigCategoryDetails>;
    /**

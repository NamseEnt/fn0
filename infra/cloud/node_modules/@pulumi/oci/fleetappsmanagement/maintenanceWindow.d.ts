...
export declare class MaintenanceWindow extends pulumi.CustomResource {
     ...
     */
    readonly isOutage: pulumi.Output<boolean>;
    /**
     * (Updatable) Is this a recurring maintenance window?
     */
    readonly isRecurring: pulumi.Output<boolean>;
    /**
     ...
     */
    readonly recurrences: pulumi.Output<string>;
    /**
     * Associated region
     */
     ...
     */
    readonly timeScheduleStart: pulumi.Output<string>;
    /**

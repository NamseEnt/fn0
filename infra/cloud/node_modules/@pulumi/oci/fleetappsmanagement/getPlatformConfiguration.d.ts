 ...
 * ```
 */
export declare function getPlatformConfiguration(args: GetPlatformConfigurationArgs, opts?: pulumi.InvokeOptions): Promise<GetPlatformConfigurationResult>;
/**
 ...
 * ```
 */
export declare function getPlatformConfigurationOutput(args: GetPlatformConfigurationOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetPlatformConfigurationResult>;
/**
 * A collection of arguments for invoking getPlatformConfiguration.
 */

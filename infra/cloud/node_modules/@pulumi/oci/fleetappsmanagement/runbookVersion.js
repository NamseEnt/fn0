 ...
 * ```
 */
class RunbookVersion extends pulumi.CustomResource {
    /**
    ...
    static get(name, id, state, opts) {
        return new RunbookVersion(name, state, { ...opts, id: id });
    }
    /**
...
exports.RunbookVersion = RunbookVersion;
/** @internal */
RunbookVersion.__pulumiType = 'oci:FleetAppsManagement/runbookVersion:RunbookVersion';
//# sourceMappingURL=runbookVersion.js.map
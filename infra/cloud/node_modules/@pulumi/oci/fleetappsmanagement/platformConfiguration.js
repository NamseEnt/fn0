 ...
 * ```
 */
class PlatformConfiguration extends pulumi.CustomResource {
    /**
    ...
    static get(name, id, state, opts) {
        return new PlatformConfiguration(name, state, { ...opts, id: id });
    }
    /**
...
/** @internal */
PlatformConfiguration.__pulumiType = 'oci:FleetAppsManagement/platformConfiguration:PlatformConfiguration';

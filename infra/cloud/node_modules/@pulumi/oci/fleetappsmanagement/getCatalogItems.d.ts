 ...
 * ```
 */
export declare function getCatalogItems(args: GetCatalogItemsArgs, opts?: pulumi.InvokeOptions): Promise<GetCatalogItemsResult>;
/**
 ...
 * ```
 */
export declare function getCatalogItemsOutput(args: GetCatalogItemsOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetCatalogItemsResult>;
/**
 * A collection of arguments for invoking getCatalogItems.
 */

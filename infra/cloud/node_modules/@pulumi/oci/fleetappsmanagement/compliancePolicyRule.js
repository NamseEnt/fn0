 ...
 * ```
 */
class CompliancePolicyRule extends pulumi.CustomResource {
    /**
    ...
    static get(name, id, state, opts) {
        return new CompliancePolicyRule(name, state, { ...opts, id: id });
    }
    /**
...
exports.CompliancePolicyRule = CompliancePolicyRule;
/** @internal */
CompliancePolicyRule.__pulumiType = 'oci:FleetAppsManagement/compliancePolicyRule:CompliancePolicyRule';
//# sourceMappingURL=compliancePolicyRule.js.map
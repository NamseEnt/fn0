 ...
 * ```
 */
class Onboarding extends pulumi.CustomResource {
    /**
    ...
    static get(name, id, state, opts) {
        return new Onboarding(name, state, { ...opts, id: id });
    }
    /**
...
/** @internal */
Onboarding.__pulumiType = 'oci:FleetAppsManagement/onboarding:Onboarding';

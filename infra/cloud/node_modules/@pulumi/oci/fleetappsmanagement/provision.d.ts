 ...
 * ```
 */
export declare class Provision extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ProvisionState, opts?: pulumi.CustomResourceOptions): Provision;
    /**
     * Returns true if the given object is an instance of Provision.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is Provision;
    /**
     ...
     */
    readonly configCatalogItemDisplayName: pulumi.Output<string>;
    /**
     ...
     */
    readonly configCatalogItemId: pulumi.Output<string>;
    /**
     * A listing ID of the Catalog Item in the Catalog.
     */
    readonly configCatalogItemListingId: pulumi.Output<string>;
    /**
     * A listing version of the Catalog Item in the Catalog.
     */
    readonly configCatalogItemListingVersion: pulumi.Output<string>;
    /**
     ...
     */
    readonly deployedResources: pulumi.Output<outputs.FleetAppsManagement.ProvisionDeployedResource[]>;
    /**
     ...
     * A display Name of the Catalog Item in the Catalog.
     */
    readonly packageCatalogItemDisplayName: pulumi.Output<string>;
    /**
     * The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the Catalog Item.
     */
    readonly packageCatalogItemId: pulumi.Output<string>;
    /**
     * A listing ID of the Catalog Item in the Catalog.
     */
    readonly packageCatalogItemListingId: pulumi.Output<string>;
    /**
     * A listing version of the Catalog Item in the Catalog.
     */
    readonly packageCatalogItemListingVersion: pulumi.Output<string>;
    /**
     * (Updatable) A description of the provision.
     */
    readonly provisionDescription: pulumi.Output<string>;
    /**
     * The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the RMS APPLY Job.
     */
    readonly rmsApplyJobId: pulumi.Output<string>;
    /**
     ...
     */
    readonly tfOutputs: pulumi.Output<outputs.FleetAppsManagement.ProvisionTfOutput[]>;
    /**
     ...
     */
    readonly tfVariableCompartmentId: pulumi.Output<string>;
    /**
     * An optional variable added to a list of RMS variables for createStack API. Overrides the one supplied in configuration file.
     */
    readonly tfVariableCurrentUserId: pulumi.Output<string>;
    /**
     ...
     */
    readonly tfVariableRegionId: pulumi.Output<string>;
    /**
     * A mandatory variable added to a list of RMS variables for createStack API. Overrides the one supplied in configuration file.
     *
     *
     ...
     */
    readonly tfVariableTenancyId: pulumi.Output<string>;
    /**

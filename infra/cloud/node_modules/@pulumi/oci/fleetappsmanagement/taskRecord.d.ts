 ...
 * ```
 */
export declare class TaskRecord extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: TaskRecordState, opts?: pulumi.CustomResourceOptions): TaskRecord;
    /**
     * Returns true if the given object is an instance of TaskRecord.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is TaskRecord;
    /**
     * (Updatable)
     */
     ...
     */
    readonly details: pulumi.Output<outputs.FleetAppsManagement.TaskRecordDetails>;
    /**

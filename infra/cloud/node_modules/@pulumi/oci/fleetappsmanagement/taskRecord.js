 ...
 * ```
 */
class TaskRecord extends pulumi.CustomResource {
    /**
    ...
    static get(name, id, state, opts) {
        return new TaskRecord(name, state, { ...opts, id: id });
    }
    /**
...
/** @internal */
TaskRecord.__pulumiType = 'oci:FleetAppsManagement/taskRecord:TaskRecord';

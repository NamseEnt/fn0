 ...
 * ```
 */
export declare function getComplianceRecords(args: GetComplianceRecordsArgs, opts?: pulumi.InvokeOptions): Promise<GetComplianceRecordsResult>;
/**
 ...
 * ```
 */
export declare function getComplianceRecordsOutput(args: GetComplianceRecordsOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetComplianceRecordsResult>;
/**
 * A collection of arguments for invoking getComplianceRecords.
 */

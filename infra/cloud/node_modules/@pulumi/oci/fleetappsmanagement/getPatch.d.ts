 ...
 * ```
 */
export declare function getPatch(args: GetPatchArgs, opts?: pulumi.InvokeOptions): Promise<GetPatchResult>;
/**
 ...
 * ```
 */
export declare function getPatchOutput(args: GetPatchOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetPatchResult>;
/**
 * A collection of arguments for invoking getPatch.
 */

 ...
 */
export declare class FleetProperty extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: FleetPropertyState, opts?: pulumi.CustomResourceOptions): FleetProperty;
    /**
     * Returns true if the given object is an instance of FleetProperty.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is FleetProperty;
    /**
     ...
     */
    readonly propertyId: pulumi.Output<string>;
    /**
     * Text selection of the property.
     */
    readonly selectionType: pulumi.Output<string>;
    /**

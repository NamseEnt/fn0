 ...
 * ```
 */
export declare function getFleetResource(args: GetFleetResourceArgs, opts?: pulumi.InvokeOptions): Promise<GetFleetResourceResult>;
/**
 ...
 * ```
 */
export declare function getFleetResourceOutput(args: GetFleetResourceOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetFleetResourceResult>;
/**
 * A collection of arguments for invoking getFleetResource.
 */

 ...
 * ```
 */
export declare function getSecurityZone(args: GetSecurityZoneArgs, opts?: pulumi.InvokeOptions): Promise<GetSecurityZoneResult>;
/**
 ...
 * ```
 */
export declare function getSecurityZoneOutput(args: GetSecurityZoneOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetSecurityZoneResult>;
/**
 * A collection of arguments for invoking getSecurityZone.
 */

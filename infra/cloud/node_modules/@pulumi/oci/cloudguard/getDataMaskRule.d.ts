 ...
 * ```
 */
export declare function getDataMaskRule(args: GetDataMaskRuleArgs, opts?: pulumi.InvokeOptions): Promise<GetDataMaskRuleResult>;
/**
 ...
 * ```
 */
export declare function getDataMaskRuleOutput(args: GetDataMaskRuleOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetDataMaskRuleResult>;
/**
 * A collection of arguments for invoking getDataMaskRule.
 */

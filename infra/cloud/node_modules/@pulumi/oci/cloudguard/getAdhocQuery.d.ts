 ...
 * ```
 */
export declare function getAdhocQuery(args: GetAdhocQueryArgs, opts?: pulumi.InvokeOptions): Promise<GetAdhocQueryResult>;
/**
 ...
 * ```
 */
export declare function getAdhocQueryOutput(args: GetAdhocQueryOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetAdhocQueryResult>;
/**
 * A collection of arguments for invoking getAdhocQuery.
 */

 ...
 * ```
 */
class WlpAgent extends pulumi.CustomResource {
    /**
    ...
    static get(name, id, state, opts) {
        return new WlpAgent(name, state, { ...opts, id: id });
    }
    /**
...
exports.WlpAgent = WlpAgent;
/** @internal */
WlpAgent.__pulumiType = 'oci:CloudGuard/wlpAgent:WlpAgent';
//# sourceMappingURL=wlpAgent.js.map
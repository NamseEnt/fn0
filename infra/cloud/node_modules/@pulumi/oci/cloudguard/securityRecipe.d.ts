 ...
 * ```
 */
export declare class SecurityRecipe extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: SecurityRecipeState, opts?: pulumi.CustomResourceOptions): SecurityRecipe;
    /**
     * Returns true if the given object is an instance of SecurityRecipe.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is SecurityRecipe;
    /**
     ...
     */
    readonly securityPolicies: pulumi.Output<string[]>;
    /**

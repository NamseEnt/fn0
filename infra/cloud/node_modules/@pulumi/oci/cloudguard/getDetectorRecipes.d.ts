 ...
 * ```
 */
export declare function getDetectorRecipes(args: GetDetectorRecipesArgs, opts?: pulumi.InvokeOptions): Promise<GetDetectorRecipesResult>;
/**
 ...
 * ```
 */
export declare function getDetectorRecipesOutput(args: GetDetectorRecipesOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetDetectorRecipesResult>;
/**
 * A collection of arguments for invoking getDetectorRecipes.
 */

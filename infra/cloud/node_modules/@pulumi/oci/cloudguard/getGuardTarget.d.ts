 ...
 * ```
 */
export declare function getGuardTarget(args: GetGuardTargetArgs, opts?: pulumi.InvokeOptions): Promise<GetGuardTargetResult>;
/**
 ...
 * ```
 */
export declare function getGuardTargetOutput(args: GetGuardTargetOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetGuardTargetResult>;
/**
 * A collection of arguments for invoking getGuardTarget.
 */

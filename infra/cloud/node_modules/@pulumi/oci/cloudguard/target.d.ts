...
export declare class Target extends pulumi.CustomResource {
     ...
     */
    readonly inheritedByCompartments: pulumi.Output<string[]>;
    /**
     ...
     */
    readonly recipeCount: pulumi.Output<number>;
    /**
     ...
     */
    readonly targetDetails: pulumi.Output<outputs.CloudGuard.TargetTargetDetail[]>;
    /**
     * (Updatable) List of detector recipes to attach to target
     */
    readonly targetDetectorRecipes: pulumi.Output<outputs.CloudGuard.TargetTargetDetectorRecipe[]>;
    /**
     ...
     */
    readonly targetResponderRecipes: pulumi.Output<outputs.CloudGuard.TargetTargetResponderRecipe[]>;
    /**

...
export declare class Queue extends pulumi.CustomResource {
     ...
     */
    readonly capabilities: pulumi.Output<outputs.Queue.QueueCapability[]>;
    /**
     ...
     */
    readonly channelConsumptionLimit: pulumi.Output<number>;
    /**
     ...
     */
    readonly customEncryptionKeyId: pulumi.Output<string>;
    /**
     ...
     */
    readonly deadLetterQueueDeliveryCount: pulumi.Output<number>;
    /**
     ...
     */
    readonly messagesEndpoint: pulumi.Output<string>;
    /**
     * (Updatable) An optional property when incremented triggers Purge. Could be set to any integer value.
     */
    readonly purgeTrigger: pulumi.Output<number | undefined>;
    /**
     ...
     */
    readonly purgeType: pulumi.Output<string | undefined>;
    /**
     * The retention period of messages in the queue, in seconds.
     */
    readonly retentionInSeconds: pulumi.Output<number>;
    /**
     ...
     */
    readonly visibilityInSeconds: pulumi.Output<number>;
    /**

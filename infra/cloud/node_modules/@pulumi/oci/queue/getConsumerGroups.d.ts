 ...
 * ```
 */
export declare function getConsumerGroupsOutput(args?: GetConsumerGroupsOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetConsumerGroupsResult>;
/**
 * A collection of arguments for invoking getConsumerGroups.
 */

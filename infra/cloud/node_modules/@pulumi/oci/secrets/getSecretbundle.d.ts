 ...
 * ```
 */
export declare function getSecretbundle(args: GetSecretbundleArgs, opts?: pulumi.InvokeOptions): Promise<GetSecretbundleResult>;
/**
 ...
 * ```
 */
export declare function getSecretbundleOutput(args: GetSecretbundleOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetSecretbundleResult>;
/**
 * A collection of arguments for invoking getSecretbundle.
 */

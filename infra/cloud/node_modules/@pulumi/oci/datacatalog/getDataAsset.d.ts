 ...
 * ```
 */
export declare function getDataAsset(args: GetDataAssetArgs, opts?: pulumi.InvokeOptions): Promise<GetDataAssetResult>;
/**
 ...
 * ```
 */
export declare function getDataAssetOutput(args: GetDataAssetOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetDataAssetResult>;
/**
 * A collection of arguments for invoking getDataAsset.
 */

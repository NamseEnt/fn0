...
export declare class Metastore extends pulumi.CustomResource {
     ...
     */
    readonly defaultExternalTableLocation: pulumi.Output<string>;
    /**
     ...
     */
    readonly defaultManagedTableLocation: pulumi.Output<string>;
    /**
     ...
     */
    readonly locks: pulumi.Output<outputs.DataCatalog.MetastoreLock[]>;
    /**

 ...
 */
export declare class MonitorPluginManagement extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: MonitorPluginManagementState, opts?: pulumi.CustomResourceOptions): MonitorPluginManagement;
    /**
     * Returns true if the given object is an instance of MonitorPluginManagement.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is MonitorPluginManagement;
    readonly compartmentId: pulumi.Output<string>;
    readonly monitoredInstanceDescription: pulumi.Output<string>;
    readonly monitoredInstanceDisplayName: pulumi.Output<string>;
    /**
     ...
     */
    readonly monitoredInstanceId: pulumi.Output<string>;
    readonly monitoredInstanceManagementAgentId: pulumi.Output<string>;

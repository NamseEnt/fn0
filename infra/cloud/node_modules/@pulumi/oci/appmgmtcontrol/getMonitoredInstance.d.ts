 ...
 * ```
 */
export declare function getMonitoredInstance(args: GetMonitoredInstanceArgs, opts?: pulumi.InvokeOptions): Promise<GetMonitoredInstanceResult>;
/**
 ...
 * ```
 */
export declare function getMonitoredInstanceOutput(args: GetMonitoredInstanceOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetMonitoredInstanceResult>;
/**
 * A collection of arguments for invoking getMonitoredInstance.
 */

 ...
 * ```
 */
export declare function getMlApplicationInstance(args: GetMlApplicationInstanceArgs, opts?: pulumi.InvokeOptions): Promise<GetMlApplicationInstanceResult>;
/**
 ...
 * ```
 */
export declare function getMlApplicationInstanceOutput(args: GetMlApplicationInstanceOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetMlApplicationInstanceResult>;
/**
 * A collection of arguments for invoking getMlApplicationInstance.
 */

 ...
 * ```
 */
export declare class ModelVersionSet extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ModelVersionSetState, opts?: pulumi.CustomResourceOptions): ModelVersionSet;
    /**
     * Returns true if the given object is an instance of ModelVersionSet.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is ModelVersionSet;
    /**

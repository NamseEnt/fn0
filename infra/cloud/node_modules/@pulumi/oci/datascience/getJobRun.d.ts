 ...
 * ```
 */
export declare function getJobRun(args: GetJobRunArgs, opts?: pulumi.InvokeOptions): Promise<GetJobRunResult>;
/**
 ...
 * ```
 */
export declare function getJobRunOutput(args: GetJobRunOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetJobRunResult>;
/**
 * A collection of arguments for invoking getJobRun.
 */

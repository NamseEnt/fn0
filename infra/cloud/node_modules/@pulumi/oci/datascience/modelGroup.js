 ...
 * ```
 */
class ModelGroup extends pulumi.CustomResource {
    /**
    ...
    static get(name, id, state, opts) {
        return new ModelGroup(name, state, { ...opts, id: id });
    }
    /**
...
/** @internal */
ModelGroup.__pulumiType = 'oci:DataScience/modelGroup:ModelGroup';

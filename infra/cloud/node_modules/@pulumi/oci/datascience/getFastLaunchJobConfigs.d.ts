 ...
 * ```
 */
export declare function getFastLaunchJobConfigs(args: GetFastLaunchJobConfigsArgs, opts?: pulumi.InvokeOptions): Promise<GetFastLaunchJobConfigsResult>;
/**
 ...
 * ```
 */
export declare function getFastLaunchJobConfigsOutput(args: GetFastLaunchJobConfigsOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetFastLaunchJobConfigsResult>;
/**
 * A collection of arguments for invoking getFastLaunchJobConfigs.
 */

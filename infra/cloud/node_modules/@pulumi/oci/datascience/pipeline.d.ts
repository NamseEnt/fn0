...
export declare class Pipeline extends pulumi.CustomResource {
     ...
     */
    readonly configurationDetails: pulumi.Output<outputs.DataScience.PipelineConfigurationDetails>;
    /**
    ...
    readonly deleteRelatedPipelineRuns: pulumi.Output<boolean | undefined>;
    /**
     ...
     */
    readonly infrastructureConfigurationDetails: pulumi.Output<outputs.DataScience.PipelineInfrastructureConfigurationDetails>;
    /**
     ...
     */
    readonly logConfigurationDetails: pulumi.Output<outputs.DataScience.PipelineLogConfigurationDetails>;
    /**
    ...
    readonly stepArtifacts: pulumi.Output<outputs.DataScience.PipelineStepArtifact[]>;
    /**
     * (Updatable) Array of step details for each step.
     */
    readonly stepDetails: pulumi.Output<outputs.DataScience.PipelineStepDetail[]>;
    /**
     * (Updatable) The storage mount details to mount to the instance running the pipeline step.
     */
    readonly storageMountConfigurationDetailsLists: pulumi.Output<outputs.DataScience.PipelineStorageMountConfigurationDetailsList[]>;
    /**

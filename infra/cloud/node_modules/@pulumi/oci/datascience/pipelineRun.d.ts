...
export declare class PipelineRun extends pulumi.CustomResource {
     ...
     */
    readonly infrastructureConfigurationOverrideDetails: pulumi.Output<outputs.DataScience.PipelineRunInfrastructureConfigurationOverrideDetails>;
    /**
     ...
     */
    readonly parametersOverride: pulumi.Output<{
        [key: string]: string;
    }>;
    /**
     ...
     */
    readonly storageMountConfigurationOverrideDetailsLists: pulumi.Output<outputs.DataScience.PipelineRunStorageMountConfigurationOverrideDetailsList[]>;
    /**
...
export interface PipelineRunState {
     ...
     * Parameters override used in the pipeline run.
     */
    parametersOverride?: pulumi.Input<{
        [key: string]: pulumi.Input<string>;
    }>;
    /**
     * The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the pipeline for which pipeline run is created.

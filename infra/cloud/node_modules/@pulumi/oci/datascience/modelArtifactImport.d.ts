...
export declare class ModelArtifactImport extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ModelArtifactImportState, opts?: pulumi.CustomResourceOptions): ModelArtifactImport;
    /**
     * Returns true if the given object is an instance of ModelArtifactImport.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is ModelArtifactImport;
    readonly artifactSourceType: pulumi.Output<string>;
    readonly destinationBucket: pulumi.Output<string>;
    readonly destinationObjectName: pulumi.Output<string>;

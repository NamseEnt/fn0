 ...
 * ```
 */
class NotebookSession extends pulumi.CustomResource {
    /**
    ...
    static get(name, id, state, opts) {
        return new NotebookSession(name, state, { ...opts, id: id });
    }
    /**
...
/** @internal */
NotebookSession.__pulumiType = 'oci:DataScience/notebookSession:NotebookSession';
//# sourceMappingURL=notebookSession.js.map
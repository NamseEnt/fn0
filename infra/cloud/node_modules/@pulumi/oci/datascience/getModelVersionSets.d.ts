 ...
 * ```
 */
export declare function getModelVersionSets(args: GetModelVersionSetsArgs, opts?: pulumi.InvokeOptions): Promise<GetModelVersionSetsResult>;
/**
 ...
 * ```
 */
export declare function getModelVersionSetsOutput(args: GetModelVersionSetsOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetModelVersionSetsResult>;
/**
 * A collection of arguments for invoking getModelVersionSets.
 */

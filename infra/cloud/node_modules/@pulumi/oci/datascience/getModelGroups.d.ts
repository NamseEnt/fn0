 ...
 * ```
 */
export declare function getModelGroups(args: GetModelGroupsArgs, opts?: pulumi.InvokeOptions): Promise<GetModelGroupsResult>;
/**
 ...
 * ```
 */
export declare function getModelGroupsOutput(args: GetModelGroupsOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetModelGroupsResult>;
/**
 * A collection of arguments for invoking getModelGroups.
 */

 ...
 * ```
 */
export declare function getPrivateEndpoints(args: GetPrivateEndpointsArgs, opts?: pulumi.InvokeOptions): Promise<GetPrivateEndpointsResult>;
/**
 ...
 * ```
 */
export declare function getPrivateEndpointsOutput(args: GetPrivateEndpointsOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetPrivateEndpointsResult>;
/**
 * A collection of arguments for invoking getPrivateEndpoints.
 */

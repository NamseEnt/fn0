...
export declare class Model extends pulumi.CustomResource {
     ...
     */
    readonly artifactContentDisposition: pulumi.Output<string>;
    /**
     ...
     */
    readonly artifactContentLength: pulumi.Output<string>;
    readonly artifactContentMd5: pulumi.Output<string>;
    readonly artifactLastModified: pulumi.Output<string>;
    /**
     * Backup operation details of the model.
     */
    readonly backupOperationDetails: pulumi.Output<outputs.DataScience.ModelBackupOperationDetail[]>;
    /**
     * (Updatable) Back up setting details of the model.
     */
    readonly backupSetting: pulumi.Output<outputs.DataScience.ModelBackupSetting>;
    /**
     ...
     */
    readonly customMetadataLists: pulumi.Output<outputs.DataScience.ModelCustomMetadataList[]>;
    /**
     * (Updatable) An array of defined metadata details for the model.
     */
    readonly definedMetadataLists: pulumi.Output<outputs.DataScience.ModelDefinedMetadataList[]>;
    /**
    ...
    readonly emptyModel: pulumi.Output<boolean>;
    /**
     ...
     */
    readonly isModelByReference: pulumi.Output<boolean>;
    /**
     ...
     */
    readonly modelArtifact: pulumi.Output<string>;
    /**
     * The OCID of the model version set that the model is associated to.
     */
    readonly modelVersionSetId: pulumi.Output<string>;
    /**
     * The name of the model version set that the model is associated to.
     */
    readonly modelVersionSetName: pulumi.Output<string>;
    /**
     * Output schema file content in String format
     */
    readonly outputSchema: pulumi.Output<string>;
    /**
     ...
     */
    readonly retentionOperationDetails: pulumi.Output<outputs.DataScience.ModelRetentionOperationDetail[]>;
    /**
     * (Updatable) Retention setting details of the model.
     */
    readonly retentionSetting: pulumi.Output<outputs.DataScience.ModelRetentionSetting>;
    /**
     ...
     */
    readonly versionLabel: pulumi.Output<string>;
    /**

 ...
 * ```
 */
export declare class Log extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: LogState, opts?: pulumi.CustomResourceOptions): Log;
    /**
     * Returns true if the given object is an instance of Log.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is Log;
    /**
     ...
     */
    readonly configuration: pulumi.Output<outputs.Logging.LogConfiguration>;
    /**

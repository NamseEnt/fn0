 ...
 * ```
 */
export declare class UnifiedAgentConfiguration extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: UnifiedAgentConfigurationState, opts?: pulumi.CustomResourceOptions): UnifiedAgentConfiguration;
    /**
     ...
     */
    static isInstance(obj: any): obj is UnifiedAgentConfiguration;
    /**
     ...
     */
    readonly groupAssociation: pulumi.Output<outputs.Logging.UnifiedAgentConfigurationGroupAssociation>;
    /**
     ...
     */
    readonly serviceConfiguration: pulumi.Output<outputs.Logging.UnifiedAgentConfigurationServiceConfiguration>;
    /**
     * The pipeline state.
     */

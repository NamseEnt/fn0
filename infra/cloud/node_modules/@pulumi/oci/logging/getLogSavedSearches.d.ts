 ...
 * ```
 */
export declare function getLogSavedSearches(args: GetLogSavedSearchesArgs, opts?: pulumi.InvokeOptions): Promise<GetLogSavedSearchesResult>;
/**
 ...
 * ```
 */
export declare function getLogSavedSearchesOutput(args: GetLogSavedSearchesOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetLogSavedSearchesResult>;
/**
 * A collection of arguments for invoking getLogSavedSearches.
 */

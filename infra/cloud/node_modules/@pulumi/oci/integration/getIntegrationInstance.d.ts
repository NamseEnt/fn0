 ...
 * ```
 */
export declare function getIntegrationInstance(args: GetIntegrationInstanceArgs, opts?: pulumi.InvokeOptions): Promise<GetIntegrationInstanceResult>;
/**
 ...
 * ```
 */
export declare function getIntegrationInstanceOutput(args: GetIntegrationInstanceOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetIntegrationInstanceResult>;
/**
 * A collection of arguments for invoking getIntegrationInstance.
 */

 ...
 * ```
 */
export declare function getOnPremiseVantagePoint(args: GetOnPremiseVantagePointArgs, opts?: pulumi.InvokeOptions): Promise<GetOnPremiseVantagePointResult>;
/**
 ...
 * ```
 */
export declare function getOnPremiseVantagePointOutput(args: GetOnPremiseVantagePointOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetOnPremiseVantagePointResult>;
/**
 * A collection of arguments for invoking getOnPremiseVantagePoint.
 */

 ...
 * ```
 */
export declare class OnPremiseVantagePoint extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: OnPremiseVantagePointState, opts?: pulumi.CustomResourceOptions): OnPremiseVantagePoint;
    /**
     * Returns true if the given object is an instance of OnPremiseVantagePoint.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is OnPremiseVantagePoint;
    /**
     ...
     */
    readonly workersSummaries: pulumi.Output<outputs.ApmSynthetics.OnPremiseVantagePointWorkersSummary[]>;
    /**

 ...
 * ```
 */
export declare function getOnPremiseVantagePointWorker(args: GetOnPremiseVantagePointWorkerArgs, opts?: pulumi.InvokeOptions): Promise<GetOnPremiseVantagePointWorkerResult>;
/**
 ...
 * ```
 */
export declare function getOnPremiseVantagePointWorkerOutput(args: GetOnPremiseVantagePointWorkerOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetOnPremiseVantagePointWorkerResult>;
/**
 * A collection of arguments for invoking getOnPremiseVantagePointWorker.
 */

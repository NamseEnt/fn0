 ...
 * ```
 */
export declare function getMonitors(args: GetMonitorsArgs, opts?: pulumi.InvokeOptions): Promise<GetMonitorsResult>;
/**
 ...
 * ```
 */
export declare function getMonitorsOutput(args: GetMonitorsOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetMonitorsResult>;
/**
 * A collection of arguments for invoking getMonitors.
 */

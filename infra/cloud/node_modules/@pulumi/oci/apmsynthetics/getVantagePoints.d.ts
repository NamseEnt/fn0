 ...
 * ```
 */
export declare function getVantagePoints(args: GetVantagePointsArgs, opts?: pulumi.InvokeOptions): Promise<GetVantagePointsResult>;
/**
 ...
 * ```
 */
export declare function getVantagePointsOutput(args: GetVantagePointsOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetVantagePointsResult>;
/**
 * A collection of arguments for invoking getVantagePoints.
 */

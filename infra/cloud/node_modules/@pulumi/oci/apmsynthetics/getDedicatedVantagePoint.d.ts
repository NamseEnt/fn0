 ...
 * ```
 */
export declare function getDedicatedVantagePoint(args: GetDedicatedVantagePointArgs, opts?: pulumi.InvokeOptions): Promise<GetDedicatedVantagePointResult>;
/**
 ...
 * ```
 */
export declare function getDedicatedVantagePointOutput(args: GetDedicatedVantagePointOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetDedicatedVantagePointResult>;
/**
 * A collection of arguments for invoking getDedicatedVantagePoint.
 */

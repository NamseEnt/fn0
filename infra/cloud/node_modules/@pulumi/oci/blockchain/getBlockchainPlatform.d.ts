 ...
 * ```
 */
export declare function getBlockchainPlatform(args: GetBlockchainPlatformArgs, opts?: pulumi.InvokeOptions): Promise<GetBlockchainPlatformResult>;
/**
 ...
 * ```
 */
export declare function getBlockchainPlatformOutput(args: GetBlockchainPlatformOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetBlockchainPlatformResult>;
/**
 * A collection of arguments for invoking getBlockchainPlatform.
 */

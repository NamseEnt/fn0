 ...
 * ```
 */
export declare class Osn extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: OsnState, opts?: pulumi.CustomResourceOptions): Osn;
    /**
     * Returns true if the given object is an instance of Osn.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is Osn;
    /**
     * Availability Domain to place new OSN
     */
    readonly ad: pulumi.Output<string>;
    /**
     * Unique service identifier.
     */
    readonly blockchainPlatformId: pulumi.Output<string>;
    /**
     * (Updatable) OCPU allocation parameter
     */
    readonly ocpuAllocationParam: pulumi.Output<outputs.Blockchain.OsnOcpuAllocationParam>;
    /**
     * OSN identifier
     */
    readonly osnKey: pulumi.Output<string>;
    /**

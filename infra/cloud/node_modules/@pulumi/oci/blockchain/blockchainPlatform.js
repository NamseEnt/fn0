 ...
 * ```
 */
class BlockchainPlatform extends pulumi.CustomResource {
    /**
    ...
    static get(name, id, state, opts) {
        return new BlockchainPlatform(name, state, { ...opts, id: id });
    }
    /**
...
exports.BlockchainPlatform = BlockchainPlatform;
/** @internal */
BlockchainPlatform.__pulumiType = 'oci:Blockchain/blockchainPlatform:BlockchainPlatform';

 ...
 * ```
 */
export declare function getServiceEnvironments(args: GetServiceEnvironmentsArgs, opts?: pulumi.InvokeOptions): Promise<GetServiceEnvironmentsResult>;
/**
 ...
 * ```
 */
export declare function getServiceEnvironmentsOutput(args: GetServiceEnvironmentsOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetServiceEnvironmentsResult>;
/**
 * A collection of arguments for invoking getServiceEnvironments.
 */

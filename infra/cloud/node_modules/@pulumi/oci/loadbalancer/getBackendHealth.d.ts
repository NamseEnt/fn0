 ...
 * ```
 */
export declare function getBackendHealth(args: GetBackendHealthArgs, opts?: pulumi.InvokeOptions): Promise<GetBackendHealthResult>;
/**
 ...
 * ```
 */
export declare function getBackendHealthOutput(args: GetBackendHealthOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetBackendHealthResult>;
/**
 * A collection of arguments for invoking getBackendHealth.
 */

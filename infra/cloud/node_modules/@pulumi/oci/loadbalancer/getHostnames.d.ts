 ...
 * ```
 */
export declare function getHostnames(args: GetHostnamesArgs, opts?: pulumi.InvokeOptions): Promise<GetHostnamesResult>;
/**
 ...
 * ```
 */
export declare function getHostnamesOutput(args: GetHostnamesOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetHostnamesResult>;
/**
 * A collection of arguments for invoking getHostnames.
 */

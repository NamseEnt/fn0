 ...
 * ```
 */
export declare class BackendSet extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: BackendSetState, opts?: pulumi.CustomResourceOptions): BackendSet;
    /**
     * Returns true if the given object is an instance of BackendSet.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is BackendSet;
    /**
     ...
     * Example: `300`
     */
    readonly backendMaxConnections: pulumi.Output<number>;
    /**
     * (Updatable)
     */
    readonly backends: pulumi.Output<outputs.LoadBalancer.BackendSetBackend[]>;
    /**
     * (Updatable) The health check policy's configuration details.
     */
    readonly healthChecker: pulumi.Output<outputs.LoadBalancer.BackendSetHealthChecker>;
    /**
     ...
     */
    readonly lbCookieSessionPersistenceConfiguration: pulumi.Output<outputs.LoadBalancer.BackendSetLbCookieSessionPersistenceConfiguration>;
    /**
     ...
     * **Warning:** Oracle recommends that you avoid using any confidential information when you supply string values using the API.
     */
    readonly sessionPersistenceConfiguration: pulumi.Output<outputs.LoadBalancer.BackendSetSessionPersistenceConfiguration>;
    /**
     * (Updatable) The load balancer's SSL handling configuration details.
     *
     * **Warning:** Oracle recommends that you avoid using any confidential information when you supply string values using the API.
     */
    readonly sslConfiguration: pulumi.Output<outputs.LoadBalancer.BackendSetSslConfiguration | undefined>;

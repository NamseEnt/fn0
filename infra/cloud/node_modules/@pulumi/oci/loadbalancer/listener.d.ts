...
export declare class Listener extends pulumi.CustomResource {
     ...
     */
    readonly connectionConfiguration: pulumi.Output<outputs.LoadBalancer.ListenerConnectionConfiguration>;
    /**
     * (Updatable) The name of the associated backend set.  Example: `exampleBackendSet`
     */
    readonly defaultBackendSetName: pulumi.Output<string>;
    /**
     * (Updatable) An array of hostname resource names.
     */
    readonly hostnameNames: pulumi.Output<string[]>;
    /**
     ...
     */
    readonly pathRouteSetName: pulumi.Output<string | undefined>;
    /**
     ...
     */
    readonly routingPolicyName: pulumi.Output<string | undefined>;
    /**
     ...
     */
    readonly ruleSetNames: pulumi.Output<string[]>;
    /**
     * (Updatable) The load balancer's SSL handling configuration details.
     *
     * **Warning:** Oracle recommends that you avoid using any confidential information when you supply string values using the API.
     */
    readonly sslConfiguration: pulumi.Output<outputs.LoadBalancer.ListenerSslConfiguration | undefined>;

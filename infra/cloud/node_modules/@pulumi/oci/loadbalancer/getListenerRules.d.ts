 ...
 * ```
 */
export declare function getListenerRules(args: GetListenerRulesArgs, opts?: pulumi.InvokeOptions): Promise<GetListenerRulesResult>;
/**
 ...
 * ```
 */
export declare function getListenerRulesOutput(args: GetListenerRulesOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetListenerRulesResult>;
/**
 * A collection of arguments for invoking getListenerRules.
 */

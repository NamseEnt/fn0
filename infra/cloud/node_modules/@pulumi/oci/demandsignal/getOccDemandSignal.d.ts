 ...
 * ```
 */
export declare function getOccDemandSignal(args: GetOccDemandSignalArgs, opts?: pulumi.InvokeOptions): Promise<GetOccDemandSignalResult>;
/**
 ...
 * ```
 */
export declare function getOccDemandSignalOutput(args: GetOccDemandSignalOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetOccDemandSignalResult>;
/**
 * A collection of arguments for invoking getOccDemandSignal.
 */

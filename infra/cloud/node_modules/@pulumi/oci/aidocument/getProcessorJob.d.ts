 ...
 * ```
 */
export declare function getProcessorJob(args: GetProcessorJobArgs, opts?: pulumi.InvokeOptions): Promise<GetProcessorJobResult>;
/**
 ...
 * ```
 */
export declare function getProcessorJobOutput(args: GetProcessorJobOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetProcessorJobResult>;
/**
 * A collection of arguments for invoking getProcessorJob.
 */

 ...
 * ```
 */
export declare function getSupportedSkus(args: GetSupportedSkusArgs, opts?: pulumi.InvokeOptions): Promise<GetSupportedSkusResult>;
/**
 ...
 * ```
 */
export declare function getSupportedSkusOutput(args: GetSupportedSkusOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetSupportedSkusResult>;
/**
 * A collection of arguments for invoking getSupportedSkus.
 */

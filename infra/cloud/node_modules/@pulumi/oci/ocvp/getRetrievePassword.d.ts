 ...
 * ```
 */
export declare function getRetrievePassword(args: GetRetrievePasswordArgs, opts?: pulumi.InvokeOptions): Promise<GetRetrievePasswordResult>;
/**
 ...
 * ```
 */
export declare function getRetrievePasswordOutput(args: GetRetrievePasswordOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetRetrievePasswordResult>;
/**
 * A collection of arguments for invoking getRetrievePassword.
 */

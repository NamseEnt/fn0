 ...
 * ```
 */
export declare function getManagementAppliance(args: GetManagementApplianceArgs, opts?: pulumi.InvokeOptions): Promise<GetManagementApplianceResult>;
/**
 ...
 * ```
 */
export declare function getManagementApplianceOutput(args: GetManagementApplianceOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetManagementApplianceResult>;
/**
 * A collection of arguments for invoking getManagementAppliance.
 */

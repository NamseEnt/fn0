 ...
 * ```
 */
export declare function getSupportedHostShapes(args: GetSupportedHostShapesArgs, opts?: pulumi.InvokeOptions): Promise<GetSupportedHostShapesResult>;
/**
 ...
 * ```
 */
export declare function getSupportedHostShapesOutput(args: GetSupportedHostShapesOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetSupportedHostShapesResult>;
/**
 * A collection of arguments for invoking getSupportedHostShapes.
 */

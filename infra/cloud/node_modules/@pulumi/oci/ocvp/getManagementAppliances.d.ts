 ...
 * ```
 */
export declare function getManagementAppliances(args: GetManagementAppliancesArgs, opts?: pulumi.InvokeOptions): Promise<GetManagementAppliancesResult>;
/**
 ...
 * ```
 */
export declare function getManagementAppliancesOutput(args: GetManagementAppliancesOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetManagementAppliancesResult>;
/**
 * A collection of arguments for invoking getManagementAppliances.
 */

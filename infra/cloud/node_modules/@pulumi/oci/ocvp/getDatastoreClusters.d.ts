 ...
 * ```
 */
export declare function getDatastoreClusters(args: GetDatastoreClustersArgs, opts?: pulumi.InvokeOptions): Promise<GetDatastoreClustersResult>;
/**
 ...
 * ```
 */
export declare function getDatastoreClustersOutput(args: GetDatastoreClustersOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetDatastoreClustersResult>;
/**
 * A collection of arguments for invoking getDatastoreClusters.
 */

 ...
 * ```
 */
export declare function getTrace(args: GetTraceArgs, opts?: pulumi.InvokeOptions): Promise<GetTraceResult>;
/**
 ...
 * ```
 */
export declare function getTraceOutput(args: GetTraceOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetTraceResult>;
/**
 * A collection of arguments for invoking getTrace.
 */

 ...
 * ```
 */
export declare function getHttpMonitor(args: GetHttpMonitorArgs, opts?: pulumi.InvokeOptions): Promise<GetHttpMonitorResult>;
/**
 ...
 * ```
 */
export declare function getHttpMonitorOutput(args: GetHttpMonitorOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetHttpMonitorResult>;
/**
 * A collection of arguments for invoking getHttpMonitor.
 */

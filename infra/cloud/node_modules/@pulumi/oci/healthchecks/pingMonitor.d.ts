 ...
 * ```
 */
export declare class PingMonitor extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: PingMonitorState, opts?: pulumi.CustomResourceOptions): PingMonitor;
    /**
     * Returns true if the given object is an instance of PingMonitor.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is PingMonitor;
    /**
     ...
     */
    readonly resultsUrl: pulumi.Output<string>;
    /**
     ...
     */
    readonly vantagePointNames: pulumi.Output<string[]>;
    /**

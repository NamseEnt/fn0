 ...
 * ```
 */
class HttpProbe extends pulumi.CustomResource {
    /**
    ...
    static get(name, id, state, opts) {
        return new HttpProbe(name, state, { ...opts, id: id });
    }
    /**
...
/** @internal */
HttpProbe.__pulumiType = 'oci:HealthChecks/httpProbe:HttpProbe';
//# sourceMappingURL=httpProbe.js.map
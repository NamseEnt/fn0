 ...
 * ```
 */
export declare function getPingProbeResults(args: GetPingProbeResultsArgs, opts?: pulumi.InvokeOptions): Promise<GetPingProbeResultsResult>;
/**
 ...
 * ```
 */
export declare function getPingProbeResultsOutput(args: GetPingProbeResultsOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetPingProbeResultsResult>;
/**
 * A collection of arguments for invoking getPingProbeResults.
 */

 ...
 * ```
 */
class HttpMonitor extends pulumi.CustomResource {
    /**
    ...
    static get(name, id, state, opts) {
        return new HttpMonitor(name, state, { ...opts, id: id });
    }
    /**
...
/** @internal */
HttpMonitor.__pulumiType = 'oci:HealthChecks/httpMonitor:HttpMonitor';
//# sourceMappingURL=httpMonitor.js.map
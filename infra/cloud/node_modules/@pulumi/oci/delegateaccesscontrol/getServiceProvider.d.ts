 ...
 * ```
 */
export declare function getServiceProvider(args: GetServiceProviderArgs, opts?: pulumi.InvokeOptions): Promise<GetServiceProviderResult>;
/**
 ...
 * ```
 */
export declare function getServiceProviderOutput(args: GetServiceProviderOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetServiceProviderResult>;
/**
 * A collection of arguments for invoking getServiceProvider.
 */

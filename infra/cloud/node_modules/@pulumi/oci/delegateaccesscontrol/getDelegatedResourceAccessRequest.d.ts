 ...
 * ```
 */
export declare function getDelegatedResourceAccessRequest(args: GetDelegatedResourceAccessRequestArgs, opts?: pulumi.InvokeOptions): Promise<GetDelegatedResourceAccessRequestResult>;
/**
 ...
 * ```
 */
export declare function getDelegatedResourceAccessRequestOutput(args: GetDelegatedResourceAccessRequestOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetDelegatedResourceAccessRequestResult>;
/**
 * A collection of arguments for invoking getDelegatedResourceAccessRequest.
 */

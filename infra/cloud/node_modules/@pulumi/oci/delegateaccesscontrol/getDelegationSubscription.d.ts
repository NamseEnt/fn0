 ...
 * ```
 */
export declare function getDelegationSubscription(args: GetDelegationSubscriptionArgs, opts?: pulumi.InvokeOptions): Promise<GetDelegationSubscriptionResult>;
/**
 ...
 * ```
 */
export declare function getDelegationSubscriptionOutput(args: GetDelegationSubscriptionOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetDelegationSubscriptionResult>;
/**
 * A collection of arguments for invoking getDelegationSubscription.
 */

...
export declare class DbSystem extends pulumi.CustomResource {
     ...
     */
    readonly applyConfig: pulumi.Output<string | undefined>;
    /**
     ...
     */
    readonly credentials: pulumi.Output<outputs.Psql.DbSystemCredentials | undefined>;
    /**
     ...
     */
    readonly instanceMemorySizeInGbs: pulumi.Output<number>;
    /**
     * (Updatable) The total number of OCPUs available to each database instance node.
     */
    readonly instanceOcpuCount: pulumi.Output<number>;
    /**
     * The list of instances, or nodes, in the database system.
     */
    readonly instances: pulumi.Output<outputs.Psql.DbSystemInstance[]>;
    /**
     ...
     */
    readonly instancesDetails: pulumi.Output<outputs.Psql.DbSystemInstancesDetail[]>;
    /**
     ...
     */
    readonly managementPolicy: pulumi.Output<outputs.Psql.DbSystemManagementPolicy>;
    /**
     * (Updatable) Network details for the database system.
     */
    readonly networkDetails: pulumi.Output<outputs.Psql.DbSystemNetworkDetails>;
    /**
     ...
     */
    readonly patchOperations: pulumi.Output<outputs.Psql.DbSystemPatchOperation[] | undefined>;
    /**
     ...
     */
    readonly storageDetails: pulumi.Output<outputs.Psql.DbSystemStorageDetails>;
    /**

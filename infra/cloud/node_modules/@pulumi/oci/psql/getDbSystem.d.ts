 ...
 * ```
 */
export declare function getDbSystem(args: GetDbSystemArgs, opts?: pulumi.InvokeOptions): Promise<GetDbSystemResult>;
/**
 ...
 * ```
 */
export declare function getDbSystemOutput(args: GetDbSystemOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetDbSystemResult>;
/**
 * A collection of arguments for invoking getDbSystem.
 */

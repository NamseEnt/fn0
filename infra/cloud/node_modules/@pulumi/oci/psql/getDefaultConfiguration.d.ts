 ...
 * ```
 */
export declare function getDefaultConfiguration(args: GetDefaultConfigurationArgs, opts?: pulumi.InvokeOptions): Promise<GetDefaultConfigurationResult>;
/**
 ...
 * ```
 */
export declare function getDefaultConfigurationOutput(args: GetDefaultConfigurationOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetDefaultConfigurationResult>;
/**
 * A collection of arguments for invoking getDefaultConfiguration.
 */

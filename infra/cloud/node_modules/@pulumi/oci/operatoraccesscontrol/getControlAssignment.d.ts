 ...
 * ```
 */
export declare function getControlAssignment(args: GetControlAssignmentArgs, opts?: pulumi.InvokeOptions): Promise<GetControlAssignmentResult>;
/**
 ...
 * ```
 */
export declare function getControlAssignmentOutput(args: GetControlAssignmentOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetControlAssignmentResult>;
/**
 * A collection of arguments for invoking getControlAssignment.
 */

 ...
 * ```
 */
export declare function getControlAssignments(args: GetControlAssignmentsArgs, opts?: pulumi.InvokeOptions): Promise<GetControlAssignmentsResult>;
/**
 ...
 * ```
 */
export declare function getControlAssignmentsOutput(args: GetControlAssignmentsOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetControlAssignmentsResult>;
/**
 * A collection of arguments for invoking getControlAssignments.
 */

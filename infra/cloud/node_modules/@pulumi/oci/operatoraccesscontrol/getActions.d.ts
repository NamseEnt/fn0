 ...
 * ```
 */
export declare function getActions(args: GetActionsArgs, opts?: pulumi.InvokeOptions): Promise<GetActionsResult>;
/**
 ...
 * ```
 */
export declare function getActionsOutput(args: GetActionsOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetActionsResult>;
/**
 * A collection of arguments for invoking getActions.
 */

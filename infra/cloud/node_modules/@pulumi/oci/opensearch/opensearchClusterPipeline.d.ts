 ...
 * ```
 */
export declare class OpensearchClusterPipeline extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: OpensearchClusterPipelineState, opts?: pulumi.CustomResourceOptions): OpensearchClusterPipeline;
    /**
     ...
     */
    static isInstance(obj: any): obj is OpensearchClusterPipeline;
    /**
     ...
     */
    readonly dataPrepperConfigurationBody: pulumi.Output<string>;
    /**
     ...
     */
    readonly opcDryRun: pulumi.Output<boolean>;
    /**
     * The fully qualified domain name (FQDN) for the cluster's API endpoint.
     */
    readonly opensearchPipelineFqdn: pulumi.Output<string>;
    /**
     * The pipeline's private IP address.
     */
    readonly opensearchPipelinePrivateIp: pulumi.Output<string>;
    /**
     ...
     */
    readonly pipelineMode: pulumi.Output<string>;
    /**
     * (Updatable) The customer IP and the corresponding fully qualified domain name that the pipeline will connect to.
     */
    readonly reverseConnectionEndpoints: pulumi.Output<outputs.Opensearch.OpensearchClusterPipelineReverseConnectionEndpoint[]>;
    /**

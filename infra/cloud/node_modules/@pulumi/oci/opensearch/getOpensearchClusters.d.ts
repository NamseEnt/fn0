 ...
 * ```
 */
export declare function getOpensearchClusters(args: GetOpensearchClustersArgs, opts?: pulumi.InvokeOptions): Promise<GetOpensearchClustersResult>;
/**
 ...
 * ```
 */
export declare function getOpensearchClustersOutput(args: GetOpensearchClustersOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetOpensearchClustersResult>;
/**
 * A collection of arguments for invoking getOpensearchClusters.
 */

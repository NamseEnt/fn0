 ...
 * ```
 */
class OpensearchClusterPipeline extends pulumi.CustomResource {
    /**
    ...
    static get(name, id, state, opts) {
        return new OpensearchClusterPipeline(name, state, { ...opts, id: id });
    }
    /**
...
exports.OpensearchClusterPipeline = OpensearchClusterPipeline;
/** @internal */
OpensearchClusterPipeline.__pulumiType = 'oci:Opensearch/opensearchClusterPipeline:OpensearchClusterPipeline';
//# sourceMappingURL=opensearchClusterPipeline.js.map
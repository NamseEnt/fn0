 ...
 * ```
 */
export declare function getOpensearchVersion(args: GetOpensearchVersionArgs, opts?: pulumi.InvokeOptions): Promise<GetOpensearchVersionResult>;
/**
 ...
 * ```
 */
export declare function getOpensearchVersionOutput(args: GetOpensearchVersionOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetOpensearchVersionResult>;
/**
 * A collection of arguments for invoking getOpensearchVersion.
 */

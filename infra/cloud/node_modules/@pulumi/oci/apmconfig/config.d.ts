...
export declare class Config extends pulumi.CustomResource {
     ...
     */
    readonly dimensions: pulumi.Output<outputs.ApmConfig.ConfigDimension[]>;
    /**
     ...
     */
    readonly filterText: pulumi.Output<string>;
    /**
     ...
     */
    readonly metrics: pulumi.Output<outputs.ApmConfig.ConfigMetric[]>;
    /**

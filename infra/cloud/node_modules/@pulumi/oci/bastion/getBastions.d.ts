 ...
 * ```
 */
export declare function getBastions(args: GetBastionsArgs, opts?: pulumi.InvokeOptions): Promise<GetBastionsResult>;
/**
 ...
 * ```
 */
export declare function getBastionsOutput(args: GetBastionsOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetBastionsResult>;
/**
 * A collection of arguments for invoking getBastions.
 */

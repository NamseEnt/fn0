 ...
 * ```
 */
export declare class ExportSet extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ExportSetState, opts?: pulumi.CustomResourceOptions): ExportSet;
    /**
     * Returns true if the given object is an instance of ExportSet.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is ExportSet;
    /**
     ...
     */
    readonly maxFsStatBytes: pulumi.Output<string>;
    /**
     ...
     */
    readonly maxFsStatFiles: pulumi.Output<string>;
    /**

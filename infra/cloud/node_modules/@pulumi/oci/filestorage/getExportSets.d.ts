 ...
 * ```
 */
export declare function getExportSets(args: GetExportSetsArgs, opts?: pulumi.InvokeOptions): Promise<GetExportSetsResult>;
/**
 ...
 * ```
 */
export declare function getExportSetsOutput(args: GetExportSetsOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetExportSetsResult>;
/**
 * A collection of arguments for invoking getExportSets.
 */

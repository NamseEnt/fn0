 ...
 * ```
 */
export declare function getFileSystemQuotaRule(args: GetFileSystemQuotaRuleArgs, opts?: pulumi.InvokeOptions): Promise<GetFileSystemQuotaRuleResult>;
/**
 ...
 * ```
 */
export declare function getFileSystemQuotaRuleOutput(args: GetFileSystemQuotaRuleOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetFileSystemQuotaRuleResult>;
/**
 * A collection of arguments for invoking getFileSystemQuotaRule.
 */

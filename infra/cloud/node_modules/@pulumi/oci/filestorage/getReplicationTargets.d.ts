 ...
 * ```
 */
export declare function getReplicationTargets(args: GetReplicationTargetsArgs, opts?: pulumi.InvokeOptions): Promise<GetReplicationTargetsResult>;
/**
 ...
 * ```
 */
export declare function getReplicationTargetsOutput(args: GetReplicationTargetsOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetReplicationTargetsResult>;
/**
 * A collection of arguments for invoking getReplicationTargets.
 */

 ...
 * ```
 */
export declare function getFileSystems(args: GetFileSystemsArgs, opts?: pulumi.InvokeOptions): Promise<GetFileSystemsResult>;
/**
 ...
 * ```
 */
export declare function getFileSystemsOutput(args: GetFileSystemsOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetFileSystemsResult>;
/**
 * A collection of arguments for invoking getFileSystems.
 */

...
export declare class Snapshot extends pulumi.CustomResource {
     ...
     */
    readonly filesystemSnapshotPolicyId: pulumi.Output<string>;
    /**
     ...
     */
    readonly isCloneSource: pulumi.Output<boolean>;
     ...
     */
    readonly locks: pulumi.Output<outputs.FileStorage.SnapshotLock[]>;
    /**
     ...
     */
    readonly provenanceId: pulumi.Output<string>;
    /**

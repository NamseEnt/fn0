 ...
 * ```
 */
export declare function getOutboundConnector(args: GetOutboundConnectorArgs, opts?: pulumi.InvokeOptions): Promise<GetOutboundConnectorResult>;
/**
 ...
 * ```
 */
export declare function getOutboundConnectorOutput(args: GetOutboundConnectorOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetOutboundConnectorResult>;
/**
 * A collection of arguments for invoking getOutboundConnector.
 */

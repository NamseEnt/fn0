 ...
 * ```
 */
export declare function getReplicationTarget(args: GetReplicationTargetArgs, opts?: pulumi.InvokeOptions): Promise<GetReplicationTargetResult>;
/**
 ...
 * ```
 */
export declare function getReplicationTargetOutput(args: GetReplicationTargetOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetReplicationTargetResult>;
/**
 * A collection of arguments for invoking getReplicationTarget.
 */

 ...
 * ```
 */
export declare class FileSystemQuotaRule extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: FileSystemQuotaRuleState, opts?: pulumi.CustomResourceOptions): FileSystemQuotaRule;
    /**
     * Returns true if the given object is an instance of FileSystemQuotaRule.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is FileSystemQuotaRule;
    readonly areViolatorsOnly: pulumi.Output<boolean | undefined>;
    /**
     ...
     */
    readonly isHardQuota: pulumi.Output<boolean>;
    /**
     ...
     */
    readonly quotaLimitInGigabytes: pulumi.Output<number>;
    readonly quotaRuleId: pulumi.Output<string>;
    /**

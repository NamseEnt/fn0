 ...
 * ```
 */
export declare function getDomainsRule(args: GetDomainsRuleArgs, opts?: pulumi.InvokeOptions): Promise<GetDomainsRuleResult>;
/**
 ...
 * ```
 */
export declare function getDomainsRuleOutput(args: GetDomainsRuleOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetDomainsRuleResult>;
/**
 * A collection of arguments for invoking getDomainsRule.
 */

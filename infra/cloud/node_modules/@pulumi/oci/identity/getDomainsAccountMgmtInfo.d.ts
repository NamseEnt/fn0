 ...
 * ```
 */
export declare function getDomainsAccountMgmtInfo(args: GetDomainsAccountMgmtInfoArgs, opts?: pulumi.InvokeOptions): Promise<GetDomainsAccountMgmtInfoResult>;
/**
 ...
 * ```
 */
export declare function getDomainsAccountMgmtInfoOutput(args: GetDomainsAccountMgmtInfoOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetDomainsAccountMgmtInfoResult>;
/**
 * A collection of arguments for invoking getDomainsAccountMgmtInfo.
 */

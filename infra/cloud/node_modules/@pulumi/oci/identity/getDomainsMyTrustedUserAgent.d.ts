 ...
 * ```
 */
export declare function getDomainsMyTrustedUserAgentOutput(args: GetDomainsMyTrustedUserAgentOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetDomainsMyTrustedUserAgentResult>;
/**
 * A collection of arguments for invoking getDomainsMyTrustedUserAgent.
 */

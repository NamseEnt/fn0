 ...
 * ```
 */
export declare class Compartment extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: CompartmentState, opts?: pulumi.CustomResourceOptions): Compartment;
    /**
     * Returns true if the given object is an instance of Compartment.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is Compartment;
    /**
     ...
     */
    readonly enableDelete: pulumi.Output<boolean | undefined>;
    /**
     ...
     */
    readonly isAccessible: pulumi.Output<boolean>;
    /**

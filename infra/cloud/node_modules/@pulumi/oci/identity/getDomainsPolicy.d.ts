 ...
 * ```
 */
export declare function getDomainsPolicy(args: GetDomainsPolicyArgs, opts?: pulumi.InvokeOptions): Promise<GetDomainsPolicyResult>;
/**
 ...
 * ```
 */
export declare function getDomainsPolicyOutput(args: GetDomainsPolicyOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetDomainsPolicyResult>;
/**
 * A collection of arguments for invoking getDomainsPolicy.
 */

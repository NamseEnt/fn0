 ...
 * ```
 */
export declare function getDomainsGrant(args: GetDomainsGrantArgs, opts?: pulumi.InvokeOptions): Promise<GetDomainsGrantResult>;
/**
 ...
 * ```
 */
export declare function getDomainsGrantOutput(args: GetDomainsGrantOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetDomainsGrantResult>;
/**
 * A collection of arguments for invoking getDomainsGrant.
 */

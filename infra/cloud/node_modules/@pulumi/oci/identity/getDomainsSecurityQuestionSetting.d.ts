 ...
 * ```
 */
export declare function getDomainsSecurityQuestionSetting(args: GetDomainsSecurityQuestionSettingArgs, opts?: pulumi.InvokeOptions): Promise<GetDomainsSecurityQuestionSettingResult>;
/**
 * A collection of arguments for invoking getDomainsSecurityQuestionSetting.
 */
export interface GetDomainsSecurityQuestionSettingArgs {
    /**
 ...
 */
export interface GetDomainsSecurityQuestionSettingResult {
     ...
     */
    readonly idcsCreatedBies: outputs.Identity.GetDomainsSecurityQuestionSettingIdcsCreatedBy[];
    readonly idcsEndpoint: string;
    /**
     * The User or App who modified the Resource
     */
    readonly idcsLastModifiedBies: outputs.Identity.GetDomainsSecurityQuestionSettingIdcsLastModifiedBy[];
    /**
     ...
     */
    readonly metas: outputs.Identity.GetDomainsSecurityQuestionSettingMeta[];
    /**
     ...
     */
    readonly tags: outputs.Identity.GetDomainsSecurityQuestionSettingTag[];
    /**
 ...
 * ```
 */
export declare function getDomainsSecurityQuestionSettingOutput(args: GetDomainsSecurityQuestionSettingOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetDomainsSecurityQuestionSettingResult>;
/**
 * A collection of arguments for invoking getDomainsSecurityQuestionSetting.
 */
export interface GetDomainsSecurityQuestionSettingOutputArgs {
    /**
     * A multi-valued list of strings indicating the return type of attribute definition. The specified set of attributes can be fetched by the return type of the attribute. One or more values can be given together to fetch more than one group of attributes. If 'attributes' query parameter is also available, union of the two is fetched. Valid values - all, always, never, request, default. Values are case-insensitive.
     */

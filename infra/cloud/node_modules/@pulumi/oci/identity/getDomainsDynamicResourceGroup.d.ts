 ...
 * ```
 */
export declare function getDomainsDynamicResourceGroup(args: GetDomainsDynamicResourceGroupArgs, opts?: pulumi.InvokeOptions): Promise<GetDomainsDynamicResourceGroupResult>;
/**
 ...
 * ```
 */
export declare function getDomainsDynamicResourceGroupOutput(args: GetDomainsDynamicResourceGroupOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetDomainsDynamicResourceGroupResult>;
/**
 * A collection of arguments for invoking getDomainsDynamicResourceGroup.
 */

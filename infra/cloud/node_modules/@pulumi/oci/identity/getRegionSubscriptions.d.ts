 ...
 * ```
 */
export declare function getRegionSubscriptions(args: GetRegionSubscriptionsArgs, opts?: pulumi.InvokeOptions): Promise<GetRegionSubscriptionsResult>;
/**
 ...
 * ```
 */
export declare function getRegionSubscriptionsOutput(args: GetRegionSubscriptionsOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetRegionSubscriptionsResult>;
/**
 * A collection of arguments for invoking getRegionSubscriptions.
 */

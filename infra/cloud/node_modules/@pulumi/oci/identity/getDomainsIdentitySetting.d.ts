 ...
 * ```
 */
export declare function getDomainsIdentitySetting(args: GetDomainsIdentitySettingArgs, opts?: pulumi.InvokeOptions): Promise<GetDomainsIdentitySettingResult>;
/**
 ...
 * ```
 */
export declare function getDomainsIdentitySettingOutput(args: GetDomainsIdentitySettingOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetDomainsIdentitySettingResult>;
/**
 * A collection of arguments for invoking getDomainsIdentitySetting.
 */

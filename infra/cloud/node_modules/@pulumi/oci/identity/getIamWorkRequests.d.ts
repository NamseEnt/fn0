 ...
 * ```
 */
export declare function getIamWorkRequests(args: GetIamWorkRequestsArgs, opts?: pulumi.InvokeOptions): Promise<GetIamWorkRequestsResult>;
/**
 ...
 * ```
 */
export declare function getIamWorkRequestsOutput(args: GetIamWorkRequestsOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetIamWorkRequestsResult>;
/**
 * A collection of arguments for invoking getIamWorkRequests.
 */

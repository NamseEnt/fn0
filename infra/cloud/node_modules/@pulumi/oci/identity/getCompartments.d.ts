 ...
 * ```
 */
export declare function getCompartments(args: GetCompartmentsArgs, opts?: pulumi.InvokeOptions): Promise<GetCompartmentsResult>;
/**
 ...
 * ```
 */
export declare function getCompartmentsOutput(args: GetCompartmentsOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetCompartmentsResult>;
/**
 * A collection of arguments for invoking getCompartments.
 */

 ...
 * ```
 */
export declare function getIamWorkRequestLogs(args: GetIamWorkRequestLogsArgs, opts?: pulumi.InvokeOptions): Promise<GetIamWorkRequestLogsResult>;
/**
 ...
 * ```
 */
export declare function getIamWorkRequestLogsOutput(args: GetIamWorkRequestLogsOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetIamWorkRequestLogsResult>;
/**
 * A collection of arguments for invoking getIamWorkRequestLogs.
 */

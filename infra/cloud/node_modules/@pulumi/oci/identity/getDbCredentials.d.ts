 ...
 * ```
 */
export declare function getDbCredentials(args: GetDbCredentialsArgs, opts?: pulumi.InvokeOptions): Promise<GetDbCredentialsResult>;
/**
 ...
 * ```
 */
export declare function getDbCredentialsOutput(args: GetDbCredentialsOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetDbCredentialsResult>;
/**
 * A collection of arguments for invoking getDbCredentials.
 */

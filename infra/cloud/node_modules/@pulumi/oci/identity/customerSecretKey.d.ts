 ...
 * ```
 */
export declare class CustomerSecretKey extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: CustomerSecretKeyState, opts?: pulumi.CustomResourceOptions): CustomerSecretKey;
    /**
     * Returns true if the given object is an instance of CustomerSecretKey.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is CustomerSecretKey;
    /**

...
export declare class Domain extends pulumi.CustomResource {
     ...
     */
    readonly adminFirstName: pulumi.Output<string>;
    /**
     * The admin last name
     */
    readonly adminLastName: pulumi.Output<string>;
    /**
     * The admin user name
     */
     ...
     */
    readonly homeRegionUrl: pulumi.Output<string>;
    /**
     * (Updatable) Indicates whether domain is hidden on login screen or not.
     */
    readonly isHiddenOnLogin: pulumi.Output<boolean>;
    /**
     ...
     */
    readonly isNotificationBypassed: pulumi.Output<boolean>;
    /**
     ...
     */
    readonly isPrimaryEmailRequired: pulumi.Output<boolean>;
    /**
     ...
     */
    readonly replicaRegions: pulumi.Output<outputs.Identity.DomainReplicaRegion[]>;
    /**
     * The current state.
     */

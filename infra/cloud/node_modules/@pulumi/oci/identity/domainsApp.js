 ...
 * ```
 */
class DomainsApp extends pulumi.CustomResource {
    /**
    ...
    static get(name, id, state, opts) {
        return new DomainsApp(name, state, { ...opts, id: id });
    }
    /**
...
exports.DomainsApp = DomainsApp;
/** @internal */
DomainsApp.__pulumiType = 'oci:Identity/domainsApp:DomainsApp';
//# sourceMappingURL=domainsApp.js.map
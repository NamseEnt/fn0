...
exports.DomainsSmtpCredential = void 0;
 ...
 * ```
 */
class DomainsSmtpCredential extends pulumi.CustomResource {
    /**
    ...
    static get(name, id, state, opts) {
        return new DomainsSmtpCredential(name, state, { ...opts, id: id });
    }
    /**
    ...
    static isInstance(obj) {
        ...
        return obj['__pulumiType'] === DomainsSmtpCredential.__pulumiType;
    }
    constructor(name, argsOrState, opts) {
        ...
        super(DomainsSmtpCredential.__pulumiType, name, resourceInputs, opts);
    }
}
exports.DomainsSmtpCredential = DomainsSmtpCredential;
/** @internal */
DomainsSmtpCredential.__pulumiType = 'oci:Identity/domainsSmtpCredential:DomainsSmtpCredential';
//# sourceMappingURL=domainsSmtpCredential.js.map
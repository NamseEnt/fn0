 ...
 * ```
 */
export declare function getDomainsSmtpCredentials(args: GetDomainsSmtpCredentialsArgs, opts?: pulumi.InvokeOptions): Promise<GetDomainsSmtpCredentialsResult>;
/**
 ...
 * ```
 */
export declare function getDomainsSmtpCredentialsOutput(args: GetDomainsSmtpCredentialsOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetDomainsSmtpCredentialsResult>;
/**
 * A collection of arguments for invoking getDomainsSmtpCredentials.
 */

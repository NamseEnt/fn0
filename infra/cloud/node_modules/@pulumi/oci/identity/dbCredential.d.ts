 ...
 */
export declare class DbCredential extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: DbCredentialState, opts?: pulumi.CustomResourceOptions): DbCredential;
    /**
     * Returns true if the given object is an instance of DbCredential.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is DbCredential;
    /**

 ...
 * ```
 */
class DomainsSetting extends pulumi.CustomResource {
    /**
    ...
    static get(name, id, state, opts) {
        return new DomainsSetting(name, state, { ...opts, id: id });
    }
    /**
...
exports.DomainsSetting = DomainsSetting;
/** @internal */
DomainsSetting.__pulumiType = 'oci:Identity/domainsSetting:DomainsSetting';
//# sourceMappingURL=domainsSetting.js.map
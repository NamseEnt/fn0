 ...
 * ```
 */
export declare function getNetworkSource(args: GetNetworkSourceArgs, opts?: pulumi.InvokeOptions): Promise<GetNetworkSourceResult>;
/**
 ...
 * ```
 */
export declare function getNetworkSourceOutput(args: GetNetworkSourceOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetNetworkSourceResult>;
/**
 * A collection of arguments for invoking getNetworkSource.
 */

 ...
 * ```
 */
export declare function getDomainsMyDevicesOutput(args: GetDomainsMyDevicesOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetDomainsMyDevicesResult>;
/**
 * A collection of arguments for invoking getDomainsMyDevices.
 */

 ...
 * ```
 */
export declare class DomainsOauth2clientCredential extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: DomainsOauth2clientCredentialState, opts?: pulumi.CustomResourceOptions): DomainsOauth2clientCredential;
    /**
     ...
     */
    static isInstance(obj: any): obj is DomainsOauth2clientCredential;
    /**
     ...
     * * type: complex
     */
    readonly idcsCreatedBies: pulumi.Output<outputs.Identity.DomainsOauth2clientCredentialIdcsCreatedBy[]>;
    /**
     ...
     * * type: complex
     */
    readonly idcsLastModifiedBies: pulumi.Output<outputs.Identity.DomainsOauth2clientCredentialIdcsLastModifiedBy[]>;
    /**
     ...
     * * uniqueness: none
     */
    readonly isResetSecret: pulumi.Output<boolean>;
    /**
     ...
     * * type: complex
     */
    readonly metas: pulumi.Output<outputs.Identity.DomainsOauth2clientCredentialMeta[]>;
    /**
     * Name
     *
     * **SCIM++ Properties:**
     ...
     * * returned: default
     */
    readonly scopes: pulumi.Output<outputs.Identity.DomainsOauth2clientCredentialScope[]>;
    /**
     * (Updatable) Secret
     *
     * **SCIM++ Properties:**
     ...
     * * uniqueness: none
     */
    readonly tags: pulumi.Output<outputs.Identity.DomainsOauth2clientCredentialTag[]>;
    /**
     ...
     */
    readonly urnietfparamsscimschemasoracleidcsextensionselfChangeUser: pulumi.Output<outputs.Identity.DomainsOauth2clientCredentialUrnietfparamsscimschemasoracleidcsextensionselfChangeUser>;
    /**
     ...
     * * uniqueness: none
     */
    readonly user: pulumi.Output<outputs.Identity.DomainsOauth2clientCredentialUser>;
    /**

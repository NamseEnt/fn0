 ...
 * ```
 */
export declare function getDomainsSocialIdentityProviders(args: GetDomainsSocialIdentityProvidersArgs, opts?: pulumi.InvokeOptions): Promise<GetDomainsSocialIdentityProvidersResult>;
/**
 * A collection of arguments for invoking getDomainsSocialIdentityProviders.
 */
export interface GetDomainsSocialIdentityProvidersArgs {
    /**
 ...
 */
export interface GetDomainsSocialIdentityProvidersResult {
     ...
     */
    readonly socialIdentityProviders: outputs.Identity.GetDomainsSocialIdentityProvidersSocialIdentityProvider[];
 ...
 * ```
 */
export declare function getDomainsSocialIdentityProvidersOutput(args: GetDomainsSocialIdentityProvidersOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetDomainsSocialIdentityProvidersResult>;
/**
 * A collection of arguments for invoking getDomainsSocialIdentityProviders.
 */
export interface GetDomainsSocialIdentityProvidersOutputArgs {
    /**
     * The Authorization field value consists of credentials containing the authentication information of the user agent for the realm of the resource being requested.
     */

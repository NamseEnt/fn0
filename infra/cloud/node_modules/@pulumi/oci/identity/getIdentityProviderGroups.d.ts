 ...
 * ```
 */
export declare function getIdentityProviderGroups(args: GetIdentityProviderGroupsArgs, opts?: pulumi.InvokeOptions): Promise<GetIdentityProviderGroupsResult>;
/**
 ...
 * ```
 */
export declare function getIdentityProviderGroupsOutput(args: GetIdentityProviderGroupsOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetIdentityProviderGroupsResult>;
/**
 * A collection of arguments for invoking getIdentityProviderGroups.
 */

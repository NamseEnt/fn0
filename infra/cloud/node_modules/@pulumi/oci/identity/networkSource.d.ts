 ...
 * ```
 */
export declare class NetworkSource extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: NetworkSourceState, opts?: pulumi.CustomResourceOptions): NetworkSource;
    /**
     * Returns true if the given object is an instance of NetworkSource.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is NetworkSource;
    /**
     ...
     */
    readonly inactiveState: pulumi.Output<string>;
    /**
     ...
     */
    readonly publicSourceLists: pulumi.Output<string[]>;
    /**
     ...
     */
    readonly virtualSourceLists: pulumi.Output<outputs.Identity.NetworkSourceVirtualSourceList[]>;
    /**

 ...
 * ```
 */
export declare class SmtpCredential extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: SmtpCredentialState, opts?: pulumi.CustomResourceOptions): SmtpCredential;
    /**
     * Returns true if the given object is an instance of SmtpCredential.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is SmtpCredential;
    /**

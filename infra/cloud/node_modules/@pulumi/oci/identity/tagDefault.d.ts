 ...
 * ```
 */
export declare class TagDefault extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: TagDefaultState, opts?: pulumi.CustomResourceOptions): TagDefault;
    /**
     * Returns true if the given object is an instance of TagDefault.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is TagDefault;
    /**
     ...
     * Example: `false`
     */
    readonly isRequired: pulumi.Output<boolean>;
    /**
     ...
     */
    readonly tagDefinitionId: pulumi.Output<string>;
    /**
     * The name used in the tag definition. This field is informational in the context of the tag default.
     */
    readonly tagDefinitionName: pulumi.Output<string>;
    /**
     * The OCID of the tag namespace that contains the tag definition.
     */
    readonly tagNamespaceId: pulumi.Output<string>;
    /**

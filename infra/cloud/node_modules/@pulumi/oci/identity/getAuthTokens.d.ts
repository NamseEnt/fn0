 ...
 * ```
 */
export declare function getAuthTokens(args: GetAuthTokensArgs, opts?: pulumi.InvokeOptions): Promise<GetAuthTokensResult>;
/**
 ...
 * ```
 */
export declare function getAuthTokensOutput(args: GetAuthTokensOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetAuthTokensResult>;
/**
 * A collection of arguments for invoking getAuthTokens.
 */

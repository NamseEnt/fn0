 ...
 * ```
 */
export declare function getDomainsSetting(args: GetDomainsSettingArgs, opts?: pulumi.InvokeOptions): Promise<GetDomainsSettingResult>;
/**
 ...
 * ```
 */
export declare function getDomainsSettingOutput(args: GetDomainsSettingOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetDomainsSettingResult>;
/**
 * A collection of arguments for invoking getDomainsSetting.
 */

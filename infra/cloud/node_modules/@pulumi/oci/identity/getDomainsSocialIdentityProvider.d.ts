 ...
 * ```
 */
export declare function getDomainsSocialIdentityProvider(args: GetDomainsSocialIdentityProviderArgs, opts?: pulumi.InvokeOptions): Promise<GetDomainsSocialIdentityProviderResult>;
/**
 ...
 * ```
 */
export declare function getDomainsSocialIdentityProviderOutput(args: GetDomainsSocialIdentityProviderOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetDomainsSocialIdentityProviderResult>;
/**
 * A collection of arguments for invoking getDomainsSocialIdentityProvider.
 */

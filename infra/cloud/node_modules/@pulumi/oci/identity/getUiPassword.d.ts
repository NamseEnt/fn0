 ...
 * ```
 */
export declare function getUiPassword(args: GetUiPasswordArgs, opts?: pulumi.InvokeOptions): Promise<GetUiPasswordResult>;
/**
 ...
 * ```
 */
export declare function getUiPasswordOutput(args: GetUiPasswordOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetUiPasswordResult>;
/**
 * A collection of arguments for invoking getUiPassword.
 */

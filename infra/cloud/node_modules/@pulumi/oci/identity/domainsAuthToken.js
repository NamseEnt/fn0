...
exports.DomainsAuthToken = void 0;
 ...
 * ```
 */
class DomainsAuthToken extends pulumi.CustomResource {
    /**
    ...
    static get(name, id, state, opts) {
        return new DomainsAuthToken(name, state, { ...opts, id: id });
    }
    /**
...
exports.DomainsAuthToken = DomainsAuthToken;
/** @internal */
DomainsAuthToken.__pulumiType = 'oci:Identity/domainsAuthToken:DomainsAuthToken';
//# sourceMappingURL=domainsAuthToken.js.map
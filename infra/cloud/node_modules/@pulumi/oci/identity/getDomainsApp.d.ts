 ...
 * ```
 */
export declare function getDomainsApp(args: GetDomainsAppArgs, opts?: pulumi.InvokeOptions): Promise<GetDomainsAppResult>;
/**
 ...
 * ```
 */
export declare function getDomainsAppOutput(args: GetDomainsAppOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetDomainsAppResult>;
/**
 * A collection of arguments for invoking getDomainsApp.
 */

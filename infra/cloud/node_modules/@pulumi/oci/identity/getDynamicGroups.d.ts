 ...
 * ```
 */
export declare function getDynamicGroups(args: GetDynamicGroupsArgs, opts?: pulumi.InvokeOptions): Promise<GetDynamicGroupsResult>;
/**
 ...
 * ```
 */
export declare function getDynamicGroupsOutput(args: GetDynamicGroupsOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetDynamicGroupsResult>;
/**
 * A collection of arguments for invoking getDynamicGroups.
 */

 ...
 * ```
 */
class DomainsUser extends pulumi.CustomResource {
    /**
    ...
    static get(name, id, state, opts) {
        return new DomainsUser(name, state, { ...opts, id: id });
    }
    /**
...
exports.DomainsUser = DomainsUser;
/** @internal */
DomainsUser.__pulumiType = 'oci:Identity/domainsUser:DomainsUser';
//# sourceMappingURL=domainsUser.js.map
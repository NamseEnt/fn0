 ...
 * ```
 */
export declare class AuthToken extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: AuthTokenState, opts?: pulumi.CustomResourceOptions): AuthToken;
    /**
     * Returns true if the given object is an instance of AuthToken.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is AuthToken;
    /**

 ...
 * ```
 */
export declare function getDomainsBrandingSetting(args: GetDomainsBrandingSettingArgs, opts?: pulumi.InvokeOptions): Promise<GetDomainsBrandingSettingResult>;
/**
 ...
 * ```
 */
export declare function getDomainsBrandingSettingOutput(args: GetDomainsBrandingSettingOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetDomainsBrandingSettingResult>;
/**
 * A collection of arguments for invoking getDomainsBrandingSetting.
 */

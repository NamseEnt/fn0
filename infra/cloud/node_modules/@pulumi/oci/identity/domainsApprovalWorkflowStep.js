...
exports.DomainsApprovalWorkflowStep = void 0;
 ...
 * ```
 */
class DomainsApprovalWorkflowStep extends pulumi.CustomResource {
    /**
    ...
    static get(name, id, state, opts) {
        return new DomainsApprovalWorkflowStep(name, state, { ...opts, id: id });
    }
    /**
...
exports.DomainsApprovalWorkflowStep = DomainsApprovalWorkflowStep;
/** @internal */
DomainsApprovalWorkflowStep.__pulumiType = 'oci:Identity/domainsApprovalWorkflowStep:DomainsApprovalWorkflowStep';
//# sourceMappingURL=domainsApprovalWorkflowStep.js.map
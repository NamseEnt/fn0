 ...
 * ```
 */
export declare function getTagStandardTagNamespaceTemplate(args: GetTagStandardTagNamespaceTemplateArgs, opts?: pulumi.InvokeOptions): Promise<GetTagStandardTagNamespaceTemplateResult>;
/**
 ...
 * ```
 */
export declare function getTagStandardTagNamespaceTemplateOutput(args: GetTagStandardTagNamespaceTemplateOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetTagStandardTagNamespaceTemplateResult>;
/**
 * A collection of arguments for invoking getTagStandardTagNamespaceTemplate.
 */

...
exports.DomainsSocialIdentityProvider = void 0;
 ...
 * ```
 */
class DomainsSocialIdentityProvider extends pulumi.CustomResource {
    /**
    ...
    static get(name, id, state, opts) {
        return new DomainsSocialIdentityProvider(name, state, { ...opts, id: id });
    }
    /**
...
exports.DomainsSocialIdentityProvider = DomainsSocialIdentityProvider;
/** @internal */
DomainsSocialIdentityProvider.__pulumiType = 'oci:Identity/domainsSocialIdentityProvider:DomainsSocialIdentityProvider';
//# sourceMappingURL=domainsSocialIdentityProvider.js.map
 ...
 * ```
 */
export declare function getDomainsMyGroupsOutput(args: GetDomainsMyGroupsOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetDomainsMyGroupsResult>;
/**
 * A collection of arguments for invoking getDomainsMyGroups.
 */

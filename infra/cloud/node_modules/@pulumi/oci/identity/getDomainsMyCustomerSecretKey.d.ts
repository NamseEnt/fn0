 ...
 * ```
 */
export declare function getDomainsMyCustomerSecretKey(args: GetDomainsMyCustomerSecretKeyArgs, opts?: pulumi.InvokeOptions): Promise<GetDomainsMyCustomerSecretKeyResult>;
/**
 ...
 * ```
 */
export declare function getDomainsMyCustomerSecretKeyOutput(args: GetDomainsMyCustomerSecretKeyOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetDomainsMyCustomerSecretKeyResult>;
/**
 * A collection of arguments for invoking getDomainsMyCustomerSecretKey.
 */

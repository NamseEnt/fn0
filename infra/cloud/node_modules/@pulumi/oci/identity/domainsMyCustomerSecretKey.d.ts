 ...
 * ```
 */
export declare class DomainsMyCustomerSecretKey extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: DomainsMyCustomerSecretKeyState, opts?: pulumi.CustomResourceOptions): DomainsMyCustomerSecretKey;
    /**
     ...
     */
    static isInstance(obj: any): obj is DomainsMyCustomerSecretKey;
    /**
     ...
     * * type: complex
     */
    readonly idcsCreatedBies: pulumi.Output<outputs.Identity.DomainsMyCustomerSecretKeyIdcsCreatedBy[]>;
    /**
     ...
     * * type: complex
     */
    readonly idcsLastModifiedBies: pulumi.Output<outputs.Identity.DomainsMyCustomerSecretKeyIdcsLastModifiedBy[]>;
    /**
     ...
     * * type: complex
     */
    readonly metas: pulumi.Output<outputs.Identity.DomainsMyCustomerSecretKeyMeta[]>;
    /**
     ...
     * * uniqueness: none
     */
    readonly tags: pulumi.Output<outputs.Identity.DomainsMyCustomerSecretKeyTag[]>;
    /**
     ...
     * * uniqueness: none
     */
    readonly user: pulumi.Output<outputs.Identity.DomainsMyCustomerSecretKeyUser>;
    /**

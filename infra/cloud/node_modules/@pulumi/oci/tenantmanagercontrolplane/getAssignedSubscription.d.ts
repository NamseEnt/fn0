 ...
 * ```
 */
export declare function getAssignedSubscription(args: GetAssignedSubscriptionArgs, opts?: pulumi.InvokeOptions): Promise<GetAssignedSubscriptionResult>;
/**
 ...
 * ```
 */
export declare function getAssignedSubscriptionOutput(args: GetAssignedSubscriptionOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetAssignedSubscriptionResult>;
/**
 * A collection of arguments for invoking getAssignedSubscription.
 */

 ...
 * ```
 */
export declare function getSubscriptionMapping(args: GetSubscriptionMappingArgs, opts?: pulumi.InvokeOptions): Promise<GetSubscriptionMappingResult>;
/**
 ...
 * ```
 */
export declare function getSubscriptionMappingOutput(args: GetSubscriptionMappingOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetSubscriptionMappingResult>;
/**
 * A collection of arguments for invoking getSubscriptionMapping.
 */

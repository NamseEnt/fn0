 ...
 * ```
 */
export declare function getDomainGovernances(args: GetDomainGovernancesArgs, opts?: pulumi.InvokeOptions): Promise<GetDomainGovernancesResult>;
/**
 ...
 * ```
 */
export declare function getDomainGovernancesOutput(args: GetDomainGovernancesOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetDomainGovernancesResult>;
/**
 * A collection of arguments for invoking getDomainGovernances.
 */

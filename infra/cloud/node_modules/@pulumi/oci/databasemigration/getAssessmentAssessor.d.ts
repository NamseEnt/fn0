 ...
 * ```
 */
export declare function getAssessmentAssessor(args: GetAssessmentAssessorArgs, opts?: pulumi.InvokeOptions): Promise<GetAssessmentAssessorResult>;
/**
 ...
 * ```
 */
export declare function getAssessmentAssessorOutput(args: GetAssessmentAssessorOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetAssessmentAssessorResult>;
/**
 * A collection of arguments for invoking getAssessmentAssessor.
 */

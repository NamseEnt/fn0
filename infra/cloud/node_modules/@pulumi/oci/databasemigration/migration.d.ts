...
export declare class Migration extends pulumi.CustomResource {
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: MigrationState, opts?: pulumi.CustomResourceOptions): Migration;
    /**
     ...
     */
    readonly advancedParameters: pulumi.Output<outputs.DatabaseMigration.MigrationAdvancedParameter[]>;
    /**
     * (Updatable) Optional Pre-Migration advisor settings.
     */
    readonly advisorSettings: pulumi.Output<outputs.DatabaseMigration.MigrationAdvisorSettings>;
    /**
     ...
     */
    readonly bulkIncludeExcludeData: pulumi.Output<string>;
    /**
     ...
     */
    readonly dataTransferMediumDetails: pulumi.Output<outputs.DatabaseMigration.MigrationDataTransferMediumDetails>;
    /**
     ...
     */
    readonly databaseCombination: pulumi.Output<string>;
    /**
     ...
     */
    readonly excludeObjects: pulumi.Output<outputs.DatabaseMigration.MigrationExcludeObject[]>;
    /**
     * The OCID of the resource being referenced.
     */
    readonly executingJobId: pulumi.Output<string>;
    /**
     ...
     */
    readonly ggsDetails: pulumi.Output<outputs.DatabaseMigration.MigrationGgsDetails>;
    /**
     * (Updatable) Details about Oracle GoldenGate Microservices.
     */
    readonly hubDetails: pulumi.Output<outputs.DatabaseMigration.MigrationHubDetails>;
    /**
     * Database objects to include from migration, cannot be specified alongside 'excludeObjects'
     */
    readonly includeObjects: pulumi.Output<outputs.DatabaseMigration.MigrationIncludeObject[]>;
    /**
     * (Updatable) Optional settings for Data Pump Export and Import jobs
     */
    readonly initialLoadSettings: pulumi.Output<outputs.DatabaseMigration.MigrationInitialLoadSettings>;
    /**
     ...
     * (Updatable) The OCID of the resource being referenced.
     */
    readonly sourceContainerDatabaseConnectionId: pulumi.Output<string>;
    /**
     * (Updatable) The OCID of the resource being referenced.
     */
    readonly sourceDatabaseConnectionId: pulumi.Output<string>;
    /**
     * (Updatable) The OCID of the resource being referenced.
     */
    readonly sourceStandbyDatabaseConnectionId: pulumi.Output<string | undefined>;
    /**
     ...
     * (Updatable) The OCID of the resource being referenced.
     */
    readonly targetDatabaseConnectionId: pulumi.Output<string>;
    /**
     ...
     * An RFC3339 formatted datetime string such as `2016-08-25T21:10:29.600Z`.
     */
    readonly timeLastMigration: pulumi.Output<string>;
    /**
     * An RFC3339 formatted datetime string such as `2016-08-25T21:10:29.600Z`.
     */
     ...
     */
    readonly waitAfter: pulumi.Output<string>;
    /**

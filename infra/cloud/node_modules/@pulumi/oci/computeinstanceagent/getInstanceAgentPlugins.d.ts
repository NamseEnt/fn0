 ...
 * ```
 */
export declare function getInstanceAgentPlugins(args: GetInstanceAgentPluginsArgs, opts?: pulumi.InvokeOptions): Promise<GetInstanceAgentPluginsResult>;
/**
 ...
 * ```
 */
export declare function getInstanceAgentPluginsOutput(args: GetInstanceAgentPluginsOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetInstanceAgentPluginsResult>;
/**
 * A collection of arguments for invoking getInstanceAgentPlugins.
 */

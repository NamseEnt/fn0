 ...
 * ```
 */
export declare function getCertificateVersions(args: GetCertificateVersionsArgs, opts?: pulumi.InvokeOptions): Promise<GetCertificateVersionsResult>;
/**
 ...
 * ```
 */
export declare function getCertificateVersionsOutput(args: GetCertificateVersionsOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetCertificateVersionsResult>;
/**
 * A collection of arguments for invoking getCertificateVersions.
 */

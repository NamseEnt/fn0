 ...
 * ```
 */
export declare function getCertificateVersion(args: GetCertificateVersionArgs, opts?: pulumi.InvokeOptions): Promise<GetCertificateVersionResult>;
/**
 ...
 * ```
 */
export declare function getCertificateVersionOutput(args: GetCertificateVersionOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetCertificateVersionResult>;
/**
 * A collection of arguments for invoking getCertificateVersion.
 */

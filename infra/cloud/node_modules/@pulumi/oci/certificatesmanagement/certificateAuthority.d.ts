...
export declare class CertificateAuthority extends pulumi.CustomResource {
     ...
     */
    readonly certificateAuthorityConfig: pulumi.Output<outputs.CertificatesManagement.CertificateAuthorityCertificateAuthorityConfig>;
    /**
     * (Updatable) A list of rules that control how the CA is used and managed.
     */
    readonly certificateAuthorityRules: pulumi.Output<outputs.CertificatesManagement.CertificateAuthorityCertificateAuthorityRule[] | undefined>;
    /**
     * (Updatable) The details of the certificate revocation list (CRL).
     */
    readonly certificateRevocationListDetails: pulumi.Output<outputs.CertificatesManagement.CertificateAuthorityCertificateRevocationListDetails | undefined>;
    /**
     ...
     */
    readonly currentVersions: pulumi.Output<outputs.CertificatesManagement.CertificateAuthorityCurrentVersion[]>;
    /**
     ...
     */
    readonly externalKeyDescription: pulumi.Output<string | undefined>;
    /**
     ...
     */
    readonly subjects: pulumi.Output<outputs.CertificatesManagement.CertificateAuthoritySubject[]>;
    /**

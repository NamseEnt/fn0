 ...
 * ```
 */
export declare function getCaBundle(args: GetCaBundleArgs, opts?: pulumi.InvokeOptions): Promise<GetCaBundleResult>;
/**
 ...
 * ```
 */
export declare function getCaBundleOutput(args: GetCaBundleOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetCaBundleResult>;
/**
 * A collection of arguments for invoking getCaBundle.
 */

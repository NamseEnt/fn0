 ...
 * ```
 */
export declare function getSubscribedServices(args: GetSubscribedServicesArgs, opts?: pulumi.InvokeOptions): Promise<GetSubscribedServicesResult>;
/**
 ...
 * ```
 */
export declare function getSubscribedServicesOutput(args: GetSubscribedServicesOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetSubscribedServicesResult>;
/**
 * A collection of arguments for invoking getSubscribedServices.
 */

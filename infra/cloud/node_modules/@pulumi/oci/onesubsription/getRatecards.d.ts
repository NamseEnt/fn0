 ...
 * ```
 */
export declare function getRatecards(args: GetRatecardsArgs, opts?: pulumi.InvokeOptions): Promise<GetRatecardsResult>;
/**
 ...
 * ```
 */
export declare function getRatecardsOutput(args: GetRatecardsOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetRatecardsResult>;
/**
 * A collection of arguments for invoking getRatecards.
 */

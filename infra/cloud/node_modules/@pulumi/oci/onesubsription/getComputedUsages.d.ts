 ...
 */
export declare function getComputedUsages(args: GetComputedUsagesArgs, opts?: pulumi.InvokeOptions): Promise<GetComputedUsagesResult>;
/**
...
export interface GetComputedUsagesArgs {
    ...
    filters?: inputs.OneSubsription.GetComputedUsagesFilter[];
    /**
 ...
 * This is a collection API which returns a list of Computed Usages for given filters.
 */
export declare function getComputedUsagesOutput(args: GetComputedUsagesOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetComputedUsagesResult>;
/**
 * A collection of arguments for invoking getComputedUsages.
 */

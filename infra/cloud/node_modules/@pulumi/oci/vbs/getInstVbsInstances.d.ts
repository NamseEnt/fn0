 ...
 * ```
 */
export declare function getInstVbsInstances(args: GetInstVbsInstancesArgs, opts?: pulumi.InvokeOptions): Promise<GetInstVbsInstancesResult>;
/**
 ...
 * ```
 */
export declare function getInstVbsInstancesOutput(args: GetInstVbsInstancesOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetInstVbsInstancesResult>;
/**
 * A collection of arguments for invoking getInstVbsInstances.
 */

 ...
 * ```
 */
export declare function getInstVbsInstance(args: GetInstVbsInstanceArgs, opts?: pulumi.InvokeOptions): Promise<GetInstVbsInstanceResult>;
/**
 ...
 * ```
 */
export declare function getInstVbsInstanceOutput(args: GetInstVbsInstanceOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetInstVbsInstanceResult>;
/**
 * A collection of arguments for invoking getInstVbsInstance.
 */

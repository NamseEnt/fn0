 ...
 * ```
 */
class UsageCarbonEmissionsQuery extends pulumi.CustomResource {
    /**
    ...
    static get(name, id, state, opts) {
        return new UsageCarbonEmissionsQuery(name, state, { ...opts, id: id });
    }
    /**
...
exports.UsageCarbonEmissionsQuery = UsageCarbonEmissionsQuery;
/** @internal */
UsageCarbonEmissionsQuery.__pulumiType = 'oci:MeteringComputation/usageCarbonEmissionsQuery:UsageCarbonEmissionsQuery';
//# sourceMappingURL=usageCarbonEmissionsQuery.js.map
 ...
 * ```
 */
export declare function getSchedules(args: GetSchedulesArgs, opts?: pulumi.InvokeOptions): Promise<GetSchedulesResult>;
/**
 ...
 * ```
 */
export declare function getSchedulesOutput(args: GetSchedulesOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetSchedulesResult>;
/**
 * A collection of arguments for invoking getSchedules.
 */

 ...
 * ```
 */
export declare function getCustomTables(args: GetCustomTablesArgs, opts?: pulumi.InvokeOptions): Promise<GetCustomTablesResult>;
/**
 ...
 * ```
 */
export declare function getCustomTablesOutput(args: GetCustomTablesOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetCustomTablesResult>;
/**
 * A collection of arguments for invoking getCustomTables.
 */

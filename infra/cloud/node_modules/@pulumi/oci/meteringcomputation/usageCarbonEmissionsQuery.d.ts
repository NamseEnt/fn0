 ...
 * ```
 */
export declare class UsageCarbonEmissionsQuery extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: UsageCarbonEmissionsQueryState, opts?: pulumi.CustomResourceOptions): UsageCarbonEmissionsQuery;
    /**
     ...
     */
    static isInstance(obj: any): obj is UsageCarbonEmissionsQuery;
    /**
     ...
     */
    readonly queryDefinition: pulumi.Output<outputs.MeteringComputation.UsageCarbonEmissionsQueryQueryDefinition>;
    /**

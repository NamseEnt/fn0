 ...
 * ```
 */
export declare function getUsageStatementEmailRecipientsGroup(args: GetUsageStatementEmailRecipientsGroupArgs, opts?: pulumi.InvokeOptions): Promise<GetUsageStatementEmailRecipientsGroupResult>;
/**
 ...
 * ```
 */
export declare function getUsageStatementEmailRecipientsGroupOutput(args: GetUsageStatementEmailRecipientsGroupOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetUsageStatementEmailRecipientsGroupResult>;
/**
 * A collection of arguments for invoking getUsageStatementEmailRecipientsGroup.
 */

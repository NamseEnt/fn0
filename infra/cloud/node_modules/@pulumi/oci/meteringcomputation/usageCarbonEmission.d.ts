 ...
 * ```
 */
export declare class UsageCarbonEmission extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: UsageCarbonEmissionState, opts?: pulumi.CustomResourceOptions): UsageCarbonEmission;
    /**
     * Returns true if the given object is an instance of UsageCarbonEmission.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is UsageCarbonEmission;
    /**
     * The compartment depth level.
     */
    readonly compartmentDepth: pulumi.Output<number>;
    /**
     * Specifies the method used for emission calculation, such as POWER_BASED or SPEND_BASED
     */
    readonly emissionCalculationMethod: pulumi.Output<string>;
    /**
     * Specifies the type of emission, such as MARKET_BASED or LOCATION_BASED.
     */
    readonly emissionType: pulumi.Output<string>;
    /**
     ...
     */
    readonly groupByTags: pulumi.Output<outputs.MeteringComputation.UsageCarbonEmissionGroupByTag[]>;
    /**
     ...
     */
    readonly isAggregateByTime: pulumi.Output<boolean>;
    /**
     * A list of carbon emission usage items.
     */
    readonly items: pulumi.Output<outputs.MeteringComputation.UsageCarbonEmissionItem[]>;
    /**
     * Tenant ID.
     */
     ...
     * The usage end time.
     */
    readonly timeUsageEnded: pulumi.Output<string>;
    /**
     * The usage start time.
     */
    readonly timeUsageStarted: pulumi.Output<string>;
    /**
     ...
     */
    readonly usageCarbonEmissionFilter: pulumi.Output<string>;
    /**

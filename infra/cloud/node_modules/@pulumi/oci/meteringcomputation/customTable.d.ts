 ...
 * ```
 */
export declare class CustomTable extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: CustomTableState, opts?: pulumi.CustomResourceOptions): CustomTable;
    /**
     * Returns true if the given object is an instance of CustomTable.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is CustomTable;
    /**
     ...
     */
    readonly savedCustomTable: pulumi.Output<outputs.MeteringComputation.CustomTableSavedCustomTable>;
    /**

 ...
 */
export declare function getCommitmentAggregateds(args: GetCommitmentAggregatedsArgs, opts?: pulumi.InvokeOptions): Promise<GetCommitmentAggregatedsResult>;
/**
 ...
 * This is a collection API which returns a list of aggregated computed usage details (there can be multiple Parent Products under a given SubID each of which is represented under Subscription Service Line # in SPM).
 */
export declare function getCommitmentAggregatedsOutput(args: GetCommitmentAggregatedsOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetCommitmentAggregatedsResult>;
/**
 * A collection of arguments for invoking getCommitmentAggregateds.
 */

 ...
 * ```
 */
export declare function getServiceCatalog(args: GetServiceCatalogArgs, opts?: pulumi.InvokeOptions): Promise<GetServiceCatalogResult>;
/**
 ...
 * ```
 */
export declare function getServiceCatalogOutput(args: GetServiceCatalogOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetServiceCatalogResult>;
/**
 * A collection of arguments for invoking getServiceCatalog.
 */

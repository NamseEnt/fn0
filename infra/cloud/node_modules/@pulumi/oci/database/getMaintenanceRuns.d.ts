 ...
 * ```
 */
export declare function getMaintenanceRuns(args: GetMaintenanceRunsArgs, opts?: pulumi.InvokeOptions): Promise<GetMaintenanceRunsResult>;
/**
 ...
 * ```
 */
export declare function getMaintenanceRunsOutput(args: GetMaintenanceRunsOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetMaintenanceRunsResult>;
/**
 * A collection of arguments for invoking getMaintenanceRuns.
 */

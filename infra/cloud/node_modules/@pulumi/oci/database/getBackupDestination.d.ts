 ...
 * ```
 */
export declare function getBackupDestination(args: GetBackupDestinationArgs, opts?: pulumi.InvokeOptions): Promise<GetBackupDestinationResult>;
/**
 ...
 * ```
 */
export declare function getBackupDestinationOutput(args: GetBackupDestinationOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetBackupDestinationResult>;
/**
 * A collection of arguments for invoking getBackupDestination.
 */

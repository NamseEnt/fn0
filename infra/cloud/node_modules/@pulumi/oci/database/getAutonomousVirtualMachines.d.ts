 ...
 * ```
 */
export declare function getAutonomousVirtualMachines(args: GetAutonomousVirtualMachinesArgs, opts?: pulumi.InvokeOptions): Promise<GetAutonomousVirtualMachinesResult>;
/**
 ...
 * ```
 */
export declare function getAutonomousVirtualMachinesOutput(args: GetAutonomousVirtualMachinesOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetAutonomousVirtualMachinesResult>;
/**
 * A collection of arguments for invoking getAutonomousVirtualMachines.
 */

 ...
 * ```
 */
export declare class AutonomousExadataInfrastructure extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: AutonomousExadataInfrastructureState, opts?: pulumi.CustomResourceOptions): AutonomousExadataInfrastructure;
    /**
     ...
     */
    static isInstance(obj: any): obj is AutonomousExadataInfrastructure;
    /**
     ...
     */
    readonly maintenanceWindowDetails: pulumi.Output<outputs.Database.AutonomousExadataInfrastructureMaintenanceWindowDetails | undefined>;
    /**
     * The scheduling details for the quarterly maintenance window. Patching and system updates take place during the maintenance window.
     */
    readonly maintenanceWindows: pulumi.Output<outputs.Database.AutonomousExadataInfrastructureMaintenanceWindow[]>;
    /**

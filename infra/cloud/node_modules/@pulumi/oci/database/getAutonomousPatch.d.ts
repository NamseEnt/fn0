 ...
 * ```
 */
export declare function getAutonomousPatch(args: GetAutonomousPatchArgs, opts?: pulumi.InvokeOptions): Promise<GetAutonomousPatchResult>;
/**
 ...
 * ```
 */
export declare function getAutonomousPatchOutput(args: GetAutonomousPatchOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetAutonomousPatchResult>;
/**
 * A collection of arguments for invoking getAutonomousPatch.
 */

...
export declare class ScheduledAction extends pulumi.CustomResource {
     ...
     */
    readonly actionMembers: pulumi.Output<outputs.Database.ScheduledActionActionMember[]>;
    /**
     * The order of the scheduled action.
     */
    readonly actionOrder: pulumi.Output<number>;
    /**
     * (Updatable) Map<ParamName, ParamValue> where a key value pair describes the specific action parameter. Example: `{"count": "3"}`
     */
    readonly actionParams: pulumi.Output<{
        [key: string]: string;
    }>;
    /**
     ...
     */
    readonly estimatedTimeInMins: pulumi.Output<number>;
    /**
     ...
     */
    readonly schedulingPlanId: pulumi.Output<string>;
    /**
     ...
     */
    readonly schedulingWindowId: pulumi.Output<string>;
    /**

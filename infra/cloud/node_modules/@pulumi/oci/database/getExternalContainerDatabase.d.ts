 ...
 * ```
 */
export declare function getExternalContainerDatabase(args: GetExternalContainerDatabaseArgs, opts?: pulumi.InvokeOptions): Promise<GetExternalContainerDatabaseResult>;
/**
 ...
 * ```
 */
export declare function getExternalContainerDatabaseOutput(args: GetExternalContainerDatabaseOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetExternalContainerDatabaseResult>;
/**
 * A collection of arguments for invoking getExternalContainerDatabase.
 */

 ...
 * ```
 */
export declare function getVmClusterNetworkDownloadConfigFile(args: GetVmClusterNetworkDownloadConfigFileArgs, opts?: pulumi.InvokeOptions): Promise<GetVmClusterNetworkDownloadConfigFileResult>;
/**
 ...
 * ```
 */
export declare function getVmClusterNetworkDownloadConfigFileOutput(args: GetVmClusterNetworkDownloadConfigFileOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetVmClusterNetworkDownloadConfigFileResult>;
/**
 * A collection of arguments for invoking getVmClusterNetworkDownloadConfigFile.
 */

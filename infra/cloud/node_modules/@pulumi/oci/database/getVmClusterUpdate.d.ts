 ...
 * ```
 */
export declare function getVmClusterUpdate(args: GetVmClusterUpdateArgs, opts?: pulumi.InvokeOptions): Promise<GetVmClusterUpdateResult>;
/**
 ...
 * ```
 */
export declare function getVmClusterUpdateOutput(args: GetVmClusterUpdateOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetVmClusterUpdateResult>;
/**
 * A collection of arguments for invoking getVmClusterUpdate.
 */

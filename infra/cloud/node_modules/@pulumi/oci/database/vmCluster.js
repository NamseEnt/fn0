 ...
 * ```
 */
class VmCluster extends pulumi.CustomResource {
    /**
    ...
    static get(name, id, state, opts) {
        return new VmCluster(name, state, { ...opts, id: id });
    }
    /**
...
exports.VmCluster = VmCluster;
/** @internal */
VmCluster.__pulumiType = 'oci:Database/vmCluster:VmCluster';
//# sourceMappingURL=vmCluster.js.map
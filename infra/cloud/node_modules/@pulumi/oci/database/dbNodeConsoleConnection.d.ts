 ...
 * ```
 */
export declare class DbNodeConsoleConnection extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: DbNodeConsoleConnectionState, opts?: pulumi.CustomResourceOptions): DbNodeConsoleConnection;
    /**
     * Returns true if the given object is an instance of DbNodeConsoleConnection.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is DbNodeConsoleConnection;
    /**

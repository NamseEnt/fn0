 ...
 * ```
 */
export declare function getAutonomousContainerDatabase(args: GetAutonomousContainerDatabaseArgs, opts?: pulumi.InvokeOptions): Promise<GetAutonomousContainerDatabaseResult>;
/**
 ...
 * ```
 */
export declare function getAutonomousContainerDatabaseOutput(args: GetAutonomousContainerDatabaseOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetAutonomousContainerDatabaseResult>;
/**
 * A collection of arguments for invoking getAutonomousContainerDatabase.
 */

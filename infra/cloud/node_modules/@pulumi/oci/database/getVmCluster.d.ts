 ...
 * ```
 */
export declare function getVmCluster(args: GetVmClusterArgs, opts?: pulumi.InvokeOptions): Promise<GetVmClusterResult>;
/**
 ...
 * ```
 */
export declare function getVmClusterOutput(args: GetVmClusterOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetVmClusterResult>;
/**
 * A collection of arguments for invoking getVmCluster.
 */

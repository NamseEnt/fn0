 ...
 * ```
 */
export declare function getKeyStores(args: GetKeyStoresArgs, opts?: pulumi.InvokeOptions): Promise<GetKeyStoresResult>;
/**
 ...
 * ```
 */
export declare function getKeyStoresOutput(args: GetKeyStoresOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetKeyStoresResult>;
/**
 * A collection of arguments for invoking getKeyStores.
 */

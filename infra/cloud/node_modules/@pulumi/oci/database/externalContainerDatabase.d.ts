 ...
 * ```
 */
export declare class ExternalContainerDatabase extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ExternalContainerDatabaseState, opts?: pulumi.CustomResourceOptions): ExternalContainerDatabase;
    /**
     ...
     */
    static isInstance(obj: any): obj is ExternalContainerDatabase;
    /**
     ...
     */
    readonly databaseManagementConfigs: pulumi.Output<outputs.Database.ExternalContainerDatabaseDatabaseManagementConfig[]>;
    /**
     ...
     */
    readonly stackMonitoringConfigs: pulumi.Output<outputs.Database.ExternalContainerDatabaseStackMonitoringConfig[]>;
    /**

 ...
 * ```
 */
export declare class DbNodeConsoleHistory extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: DbNodeConsoleHistoryState, opts?: pulumi.CustomResourceOptions): DbNodeConsoleHistory;
    /**
     * Returns true if the given object is an instance of DbNodeConsoleHistory.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is DbNodeConsoleHistory;
    /**

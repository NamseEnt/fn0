 ...
 * ```
 */
export declare function getSchedulingPlan(args: GetSchedulingPlanArgs, opts?: pulumi.InvokeOptions): Promise<GetSchedulingPlanResult>;
/**
 ...
 * ```
 */
export declare function getSchedulingPlanOutput(args: GetSchedulingPlanOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetSchedulingPlanResult>;
/**
 * A collection of arguments for invoking getSchedulingPlan.
 */

 ...
 * ```
 */
export declare class AutonomousContainerDatabase extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: AutonomousContainerDatabaseState, opts?: pulumi.CustomResourceOptions): AutonomousContainerDatabase;
    /**
     ...
     */
    static isInstance(obj: any): obj is AutonomousContainerDatabase;
    /**
     ...
     */
    readonly associatedBackupConfigurationDetails: pulumi.Output<outputs.Database.AutonomousContainerDatabaseAssociatedBackupConfigurationDetail[]>;
    /**
     ...
     */
    readonly autonomousContainerDatabaseBackupId: pulumi.Output<string>;
    /**
     ...
     */
    readonly backupConfig: pulumi.Output<outputs.Database.AutonomousContainerDatabaseBackupConfig>;
    /**
     ...
     */
    readonly backupDestinationPropertiesLists: pulumi.Output<outputs.Database.AutonomousContainerDatabaseBackupDestinationPropertiesList[]>;
    /**
     ...
     */
    readonly customerContacts: pulumi.Output<outputs.Database.AutonomousContainerDatabaseCustomerContact[]>;
    /**
     * The Autonomous AI Database Software Image [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm).
     */
    readonly databaseSoftwareImageId: pulumi.Output<string>;
    /**
     * Array of Dg associations.
     */
    readonly dataguardGroupMembers: pulumi.Output<outputs.Database.AutonomousContainerDatabaseDataguardGroupMember[]>;
    /**
     * The properties that define Autonomous Container Databases Dataguard.
     */
    readonly dataguards: pulumi.Output<outputs.Database.AutonomousContainerDatabaseDataguard[]>;
    /**
     ...
     */
    readonly encryptionKeyLocationDetails: pulumi.Output<outputs.Database.AutonomousContainerDatabaseEncryptionKeyLocationDetails>;
    /**
     * (Updatable) An optional property when incremented triggers Failover. Could be set to any integer value.
     */
    readonly failoverTrigger: pulumi.Output<number | undefined>;
    /**
     ...
     * Key History Entry.
     */
    readonly keyHistoryEntries: pulumi.Output<outputs.Database.AutonomousContainerDatabaseKeyHistoryEntry[]>;
    /**
     ...
     */
    readonly maintenanceWindowDetails: pulumi.Output<outputs.Database.AutonomousContainerDatabaseMaintenanceWindowDetails | undefined>;
    /**
     * The scheduling details for the quarterly maintenance window. Patching and system updates take place during the maintenance window.
     */
    readonly maintenanceWindows: pulumi.Output<outputs.Database.AutonomousContainerDatabaseMaintenanceWindow[]>;
    /**
     ...
     */
    readonly okvEndPointGroupName: pulumi.Output<string>;
    /**
     ...
     */
    readonly peerAutonomousContainerDatabaseBackupConfig: pulumi.Output<outputs.Database.AutonomousContainerDatabasePeerAutonomousContainerDatabaseBackupConfig>;
    /**
     ...
     */
    readonly peerAutonomousExadataInfrastructureId: pulumi.Output<string>;
    /**
     ...
     */
    readonly recoveryApplianceDetails: pulumi.Output<outputs.Database.AutonomousContainerDatabaseRecoveryApplianceDetail[]>;
    /**
     * (Updatable) An optional property when incremented triggers Reinstate. Could be set to any integer value.
     */
    readonly reinstateTrigger: pulumi.Output<number | undefined>;
    /**
     ...
     */
    readonly switchoverTrigger: pulumi.Output<number | undefined>;
    /**

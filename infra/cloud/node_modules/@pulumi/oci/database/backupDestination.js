 ...
 * ```
 */
class BackupDestination extends pulumi.CustomResource {
    /**
    ...
    static get(name, id, state, opts) {
        return new BackupDestination(name, state, { ...opts, id: id });
    }
    /**
...
exports.BackupDestination = BackupDestination;
/** @internal */
BackupDestination.__pulumiType = 'oci:Database/backupDestination:BackupDestination';
//# sourceMappingURL=backupDestination.js.map
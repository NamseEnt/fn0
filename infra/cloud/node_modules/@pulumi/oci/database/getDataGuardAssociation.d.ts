 ...
 * ```
 */
export declare function getDataGuardAssociation(args: GetDataGuardAssociationArgs, opts?: pulumi.InvokeOptions): Promise<GetDataGuardAssociationResult>;
/**
...
export interface GetDataGuardAssociationResult {
    ...
    readonly databaseDefinedTags: {
        [key: string]: string;
    };
    readonly databaseFreeformTags: {
        [key: string]: string;
    };
    /**
    ...
    readonly dbSystemDefinedTags: {
        [key: string]: string;
    };
    readonly dbSystemFreeformTags: {
        [key: string]: string;
    };
    readonly dbSystemSecurityAttributes: {
        [key: string]: string;
    };
 ...
 * ```
 */
export declare function getDataGuardAssociationOutput(args: GetDataGuardAssociationOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetDataGuardAssociationResult>;
/**
 * A collection of arguments for invoking getDataGuardAssociation.
 */

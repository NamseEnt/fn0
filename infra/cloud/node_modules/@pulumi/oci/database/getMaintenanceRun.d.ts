 ...
 * ```
 */
export declare function getMaintenanceRun(args: GetMaintenanceRunArgs, opts?: pulumi.InvokeOptions): Promise<GetMaintenanceRunResult>;
/**
 ...
 * ```
 */
export declare function getMaintenanceRunOutput(args: GetMaintenanceRunOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetMaintenanceRunResult>;
/**
 * A collection of arguments for invoking getMaintenanceRun.
 */

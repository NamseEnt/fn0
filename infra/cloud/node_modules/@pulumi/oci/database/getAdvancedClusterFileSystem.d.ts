 ...
 * ```
 */
export declare function getAdvancedClusterFileSystem(args: GetAdvancedClusterFileSystemArgs, opts?: pulumi.InvokeOptions): Promise<GetAdvancedClusterFileSystemResult>;
/**
 ...
 * ```
 */
export declare function getAdvancedClusterFileSystemOutput(args: GetAdvancedClusterFileSystemOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetAdvancedClusterFileSystemResult>;
/**
 * A collection of arguments for invoking getAdvancedClusterFileSystem.
 */

 ...
 * ```
 */
export declare class OneoffPatch extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: OneoffPatchState, opts?: pulumi.CustomResourceOptions): OneoffPatch;
    /**
     * Returns true if the given object is an instance of OneoffPatch.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is OneoffPatch;
    /**
     ...
     */
    readonly downloadOneoffPatchTrigger: pulumi.Output<number | undefined>;
    /**
     ...
     */
    readonly oneOffPatches: pulumi.Output<string[]>;
    /**
     ...
     */
    readonly releaseUpdate: pulumi.Output<string>;
    /**
     * SHA-256 checksum of the one-off patch.
     */
    readonly sha256sum: pulumi.Output<string>;
    /**
     * The size of one-off patch in kilobytes.
     */
    readonly sizeInKbs: pulumi.Output<number>;
    /**
     ...
     */
    readonly timeOfExpiration: pulumi.Output<string>;
    /**

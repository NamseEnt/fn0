 ...
 * ```
 */
export declare class VmCluster extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: VmClusterState, opts?: pulumi.CustomResourceOptions): VmCluster;
    /**
     * Returns true if the given object is an instance of VmCluster.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is VmCluster;
    /**
     ...
     */
    readonly cloudAutomationUpdateDetails: pulumi.Output<outputs.Database.VmClusterCloudAutomationUpdateDetails>;
    /**
     ...
     */
    readonly dataCollectionOptions: pulumi.Output<outputs.Database.VmClusterDataCollectionOptions>;
    /**
     ...
     */
    readonly fileSystemConfigurationDetails: pulumi.Output<outputs.Database.VmClusterFileSystemConfigurationDetail[]>;
    /**
     ...
     */
    readonly vmBackupStorageType: pulumi.Output<string>;
    /**
     ...
     */
    readonly vmFileSystemStorageType: pulumi.Output<string>;
    /**

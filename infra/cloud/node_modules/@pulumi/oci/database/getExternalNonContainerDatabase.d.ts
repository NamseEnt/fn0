 ...
 * ```
 */
export declare function getExternalNonContainerDatabase(args: GetExternalNonContainerDatabaseArgs, opts?: pulumi.InvokeOptions): Promise<GetExternalNonContainerDatabaseResult>;
/**
 ...
 * ```
 */
export declare function getExternalNonContainerDatabaseOutput(args: GetExternalNonContainerDatabaseOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetExternalNonContainerDatabaseResult>;
/**
 * A collection of arguments for invoking getExternalNonContainerDatabase.
 */

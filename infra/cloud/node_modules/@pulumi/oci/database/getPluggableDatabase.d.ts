 ...
 * ```
 */
export declare function getPluggableDatabase(args: GetPluggableDatabaseArgs, opts?: pulumi.InvokeOptions): Promise<GetPluggableDatabaseResult>;
/**
 ...
 * ```
 */
export declare function getPluggableDatabaseOutput(args: GetPluggableDatabaseOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetPluggableDatabaseResult>;
/**
 * A collection of arguments for invoking getPluggableDatabase.
 */

 ...
 * ```
 */
export declare function getExecutionActions(args: GetExecutionActionsArgs, opts?: pulumi.InvokeOptions): Promise<GetExecutionActionsResult>;
/**
 ...
 * ```
 */
export declare function getExecutionActionsOutput(args: GetExecutionActionsOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetExecutionActionsResult>;
/**
 * A collection of arguments for invoking getExecutionActions.
 */

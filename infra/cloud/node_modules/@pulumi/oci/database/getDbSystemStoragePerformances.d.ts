 ...
 * ```
 */
export declare function getDbSystemStoragePerformances(args: GetDbSystemStoragePerformancesArgs, opts?: pulumi.InvokeOptions): Promise<GetDbSystemStoragePerformancesResult>;
/**
 ...
 * ```
 */
export declare function getDbSystemStoragePerformancesOutput(args: GetDbSystemStoragePerformancesOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetDbSystemStoragePerformancesResult>;
/**
 * A collection of arguments for invoking getDbSystemStoragePerformances.
 */

 ...
 * ```
 */
export declare function getDbNodeConsoleConnection(args: GetDbNodeConsoleConnectionArgs, opts?: pulumi.InvokeOptions): Promise<GetDbNodeConsoleConnectionResult>;
/**
 ...
 * ```
 */
export declare function getDbNodeConsoleConnectionOutput(args: GetDbNodeConsoleConnectionOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetDbNodeConsoleConnectionResult>;
/**
 * A collection of arguments for invoking getDbNodeConsoleConnection.
 */

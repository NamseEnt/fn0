 ...
 * ```
 */
export declare function getExternalPluggableDatabases(args: GetExternalPluggableDatabasesArgs, opts?: pulumi.InvokeOptions): Promise<GetExternalPluggableDatabasesResult>;
/**
 ...
 * ```
 */
export declare function getExternalPluggableDatabasesOutput(args: GetExternalPluggableDatabasesOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetExternalPluggableDatabasesResult>;
/**
 * A collection of arguments for invoking getExternalPluggableDatabases.
 */

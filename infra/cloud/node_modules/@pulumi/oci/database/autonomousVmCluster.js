 ...
 * ```
 */
class AutonomousVmCluster extends pulumi.CustomResource {
    /**
    ...
    static get(name, id, state, opts) {
        return new AutonomousVmCluster(name, state, { ...opts, id: id });
    }
    /**
...
exports.AutonomousVmCluster = AutonomousVmCluster;
/** @internal */
AutonomousVmCluster.__pulumiType = 'oci:Database/autonomousVmCluster:AutonomousVmCluster';
//# sourceMappingURL=autonomousVmCluster.js.map
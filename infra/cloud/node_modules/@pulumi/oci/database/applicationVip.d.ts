 ...
 * ```
 */
export declare class ApplicationVip extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ApplicationVipState, opts?: pulumi.CustomResourceOptions): ApplicationVip;
    /**
     * Returns true if the given object is an instance of ApplicationVip.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is ApplicationVip;
    /**
     ...
     */
    readonly timeAssigned: pulumi.Output<string>;
    /**

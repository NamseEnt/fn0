 ...
 * ```
 */
export declare function getVmClusterNetwork(args: GetVmClusterNetworkArgs, opts?: pulumi.InvokeOptions): Promise<GetVmClusterNetworkResult>;
/**
 ...
 * ```
 */
export declare function getVmClusterNetworkOutput(args: GetVmClusterNetworkOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetVmClusterNetworkResult>;
/**
 * A collection of arguments for invoking getVmClusterNetwork.
 */

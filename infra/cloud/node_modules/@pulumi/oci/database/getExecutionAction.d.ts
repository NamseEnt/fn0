 ...
 * ```
 */
export declare function getExecutionAction(args: GetExecutionActionArgs, opts?: pulumi.InvokeOptions): Promise<GetExecutionActionResult>;
/**
 ...
 * ```
 */
export declare function getExecutionActionOutput(args: GetExecutionActionOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetExecutionActionResult>;
/**
 * A collection of arguments for invoking getExecutionAction.
 */

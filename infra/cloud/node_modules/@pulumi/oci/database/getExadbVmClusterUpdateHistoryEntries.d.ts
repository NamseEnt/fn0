 ...
 * ```
 */
export declare function getExadbVmClusterUpdateHistoryEntries(args: GetExadbVmClusterUpdateHistoryEntriesArgs, opts?: pulumi.InvokeOptions): Promise<GetExadbVmClusterUpdateHistoryEntriesResult>;
/**
 ...
 * ```
 */
export declare function getExadbVmClusterUpdateHistoryEntriesOutput(args: GetExadbVmClusterUpdateHistoryEntriesOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetExadbVmClusterUpdateHistoryEntriesResult>;
/**
 * A collection of arguments for invoking getExadbVmClusterUpdateHistoryEntries.
 */

...
exports.PluggableDatabasesRemoteClone = void 0;
 ...
 */
class PluggableDatabasesRemoteClone extends pulumi.CustomResource {
    /**
    ...
    static get(name, id, state, opts) {
        return new PluggableDatabasesRemoteClone(name, state, { ...opts, id: id });
    }
    /**
    ...
    constructor(name, argsOrState, opts) {
        ...
        if (opts.id) {
            ...
            resourceInputs["sourceContainerDbAdminPassword"] = state?.sourceContainerDbAdminPassword;
            resourceInputs["state"] = state?.state;
            resourceInputs["systemTags"] = state?.systemTags;
            resourceInputs["targetContainerDatabaseId"] = state?.targetContainerDatabaseId;
            ...
            if (args?.sourceContainerDbAdminPassword === undefined && !opts.urn) {
                throw new Error("Missing required property 'sourceContainerDbAdminPassword'");
            }
            if (args?.targetContainerDatabaseId === undefined && !opts.urn) {
            ...
            resourceInputs["targetContainerDatabaseId"] = args?.targetContainerDatabaseId;
...
exports.PluggableDatabasesRemoteClone = PluggableDatabasesRemoteClone;
/** @internal */
PluggableDatabasesRemoteClone.__pulumiType = 'oci:Database/pluggableDatabasesRemoteClone:PluggableDatabasesRemoteClone';
//# sourceMappingURL=pluggableDatabasesRemoteClone.js.map
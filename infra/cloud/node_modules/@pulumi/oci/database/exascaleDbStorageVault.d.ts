...
export declare class ExascaleDbStorageVault extends pulumi.CustomResource {
     ...
     */
    readonly additionalFlashCacheInPercent: pulumi.Output<number>;
    /**
     * The shapeAttribute of the Exadata VM cluster(s) associated with the Exadata Database Storage Vault.
     */
    readonly attachedShapeAttributes: pulumi.Output<string[]>;
    /**
     ...
     */
    readonly autoscaleLimitInGbs: pulumi.Output<number>;
    /**
     ...
     */
    readonly highCapacityDatabaseStorage: pulumi.Output<outputs.Database.ExascaleDbStorageVaultHighCapacityDatabaseStorage>;
    /**
     * (Updatable) Indicates if autoscale feature is enabled for the Database Storage Vault. The default value is `FALSE`.
     */
    readonly isAutoscaleEnabled: pulumi.Output<boolean>;
    /**
     ...
     */
    readonly vmClusterCount: pulumi.Output<number>;
    /**

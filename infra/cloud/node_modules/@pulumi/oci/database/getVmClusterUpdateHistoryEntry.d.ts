 ...
 * ```
 */
export declare function getVmClusterUpdateHistoryEntry(args: GetVmClusterUpdateHistoryEntryArgs, opts?: pulumi.InvokeOptions): Promise<GetVmClusterUpdateHistoryEntryResult>;
/**
 ...
 * ```
 */
export declare function getVmClusterUpdateHistoryEntryOutput(args: GetVmClusterUpdateHistoryEntryOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetVmClusterUpdateHistoryEntryResult>;
/**
 * A collection of arguments for invoking getVmClusterUpdateHistoryEntry.
 */

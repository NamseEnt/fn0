 ...
 * ```
 */
export declare function getAutonomousExadataInfrastructure(args: GetAutonomousExadataInfrastructureArgs, opts?: pulumi.InvokeOptions): Promise<GetAutonomousExadataInfrastructureResult>;
/**
 ...
 * ```
 */
export declare function getAutonomousExadataInfrastructureOutput(args: GetAutonomousExadataInfrastructureOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetAutonomousExadataInfrastructureResult>;
/**
 * A collection of arguments for invoking getAutonomousExadataInfrastructure.
 */

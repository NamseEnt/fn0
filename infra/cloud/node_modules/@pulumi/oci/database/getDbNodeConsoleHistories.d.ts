 ...
 * ```
 */
export declare function getDbNodeConsoleHistories(args: GetDbNodeConsoleHistoriesArgs, opts?: pulumi.InvokeOptions): Promise<GetDbNodeConsoleHistoriesResult>;
/**
 ...
 * ```
 */
export declare function getDbNodeConsoleHistoriesOutput(args: GetDbNodeConsoleHistoriesOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetDbNodeConsoleHistoriesResult>;
/**
 * A collection of arguments for invoking getDbNodeConsoleHistories.
 */

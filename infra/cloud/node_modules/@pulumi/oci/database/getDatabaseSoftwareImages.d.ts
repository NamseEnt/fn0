 ...
 * ```
 */
export declare function getDatabaseSoftwareImages(args: GetDatabaseSoftwareImagesArgs, opts?: pulumi.InvokeOptions): Promise<GetDatabaseSoftwareImagesResult>;
/**
 ...
 * ```
 */
export declare function getDatabaseSoftwareImagesOutput(args: GetDatabaseSoftwareImagesOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetDatabaseSoftwareImagesResult>;
/**
 * A collection of arguments for invoking getDatabaseSoftwareImages.
 */

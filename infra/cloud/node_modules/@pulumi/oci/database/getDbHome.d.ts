 ...
 * ```
 */
export declare function getDbHome(args: GetDbHomeArgs, opts?: pulumi.InvokeOptions): Promise<GetDbHomeResult>;
/**
 ...
 * ```
 */
export declare function getDbHomeOutput(args: GetDbHomeOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetDbHomeResult>;
/**
 * A collection of arguments for invoking getDbHome.
 */

 ...
 * ```
 */
export declare function getVmClusterPatch(args: GetVmClusterPatchArgs, opts?: pulumi.InvokeOptions): Promise<GetVmClusterPatchResult>;
/**
 ...
 * ```
 */
export declare function getVmClusterPatchOutput(args: GetVmClusterPatchOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetVmClusterPatchResult>;
/**
 * A collection of arguments for invoking getVmClusterPatch.
 */

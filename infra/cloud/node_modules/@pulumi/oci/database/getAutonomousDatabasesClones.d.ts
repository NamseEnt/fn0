 ...
 * ```
 */
export declare function getAutonomousDatabasesClones(args: GetAutonomousDatabasesClonesArgs, opts?: pulumi.InvokeOptions): Promise<GetAutonomousDatabasesClonesResult>;
/**
 ...
 * ```
 */
export declare function getAutonomousDatabasesClonesOutput(args: GetAutonomousDatabasesClonesOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetAutonomousDatabasesClonesResult>;
/**
 * A collection of arguments for invoking getAutonomousDatabasesClones.
 */

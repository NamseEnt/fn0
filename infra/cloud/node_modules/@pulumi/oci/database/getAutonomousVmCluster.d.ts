 ...
 * ```
 */
export declare function getAutonomousVmCluster(args: GetAutonomousVmClusterArgs, opts?: pulumi.InvokeOptions): Promise<GetAutonomousVmClusterResult>;
/**
 ...
 * ```
 */
export declare function getAutonomousVmClusterOutput(args: GetAutonomousVmClusterOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetAutonomousVmClusterResult>;
/**
 * A collection of arguments for invoking getAutonomousVmCluster.
 */

 ...
 * ```
 */
class AutonomousContainerDatabase extends pulumi.CustomResource {
    /**
    ...
    static get(name, id, state, opts) {
        return new AutonomousContainerDatabase(name, state, { ...opts, id: id });
    }
    /**
...
exports.AutonomousContainerDatabase = AutonomousContainerDatabase;
/** @internal */
AutonomousContainerDatabase.__pulumiType = 'oci:Database/autonomousContainerDatabase:AutonomousContainerDatabase';
//# sourceMappingURL=autonomousContainerDatabase.js.map
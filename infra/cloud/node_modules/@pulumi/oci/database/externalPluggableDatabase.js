 ...
 * ```
 */
class ExternalPluggableDatabase extends pulumi.CustomResource {
    /**
    ...
    static get(name, id, state, opts) {
        return new ExternalPluggableDatabase(name, state, { ...opts, id: id });
    }
    /**
...
exports.ExternalPluggableDatabase = ExternalPluggableDatabase;
/** @internal */
ExternalPluggableDatabase.__pulumiType = 'oci:Database/externalPluggableDatabase:ExternalPluggableDatabase';
//# sourceMappingURL=externalPluggableDatabase.js.map
 ...
 * ```
 */
export declare function getExternalDatabaseConnector(args: GetExternalDatabaseConnectorArgs, opts?: pulumi.InvokeOptions): Promise<GetExternalDatabaseConnectorResult>;
/**
 ...
 * ```
 */
export declare function getExternalDatabaseConnectorOutput(args: GetExternalDatabaseConnectorOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetExternalDatabaseConnectorResult>;
/**
 * A collection of arguments for invoking getExternalDatabaseConnector.
 */

 ...
 * ```
 */
export declare function getDatabaseMaintenanceRunHistories(args: GetDatabaseMaintenanceRunHistoriesArgs, opts?: pulumi.InvokeOptions): Promise<GetDatabaseMaintenanceRunHistoriesResult>;
/**
 ...
 * ```
 */
export declare function getDatabaseMaintenanceRunHistoriesOutput(args: GetDatabaseMaintenanceRunHistoriesOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetDatabaseMaintenanceRunHistoriesResult>;
/**
 * A collection of arguments for invoking getDatabaseMaintenanceRunHistories.
 */

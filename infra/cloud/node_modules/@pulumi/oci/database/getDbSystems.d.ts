 ...
 * ```
 */
export declare function getDbSystems(args: GetDbSystemsArgs, opts?: pulumi.InvokeOptions): Promise<GetDbSystemsResult>;
/**
 ...
 * ```
 */
export declare function getDbSystemsOutput(args: GetDbSystemsOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetDbSystemsResult>;
/**
 * A collection of arguments for invoking getDbSystems.
 */

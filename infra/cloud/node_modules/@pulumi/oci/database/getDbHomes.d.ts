 ...
 */
export declare function getDbHomes(args: GetDbHomesArgs, opts?: pulumi.InvokeOptions): Promise<GetDbHomesResult>;
/**
 ...
 * Lists the Database Homes in the specified DB system and compartment. A Database Home is a directory where Oracle Database software is installed.
 */
export declare function getDbHomesOutput(args: GetDbHomesOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetDbHomesResult>;
/**
 * A collection of arguments for invoking getDbHomes.
 */

 ...
 * ```
 */
export declare function getInfrastructureTargetVersion(args: GetInfrastructureTargetVersionArgs, opts?: pulumi.InvokeOptions): Promise<GetInfrastructureTargetVersionResult>;
/**
 ...
 * ```
 */
export declare function getInfrastructureTargetVersionOutput(args: GetInfrastructureTargetVersionOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetInfrastructureTargetVersionResult>;
/**
 * A collection of arguments for invoking getInfrastructureTargetVersion.
 */

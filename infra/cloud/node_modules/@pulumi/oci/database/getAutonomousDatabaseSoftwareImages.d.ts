 ...
 * ```
 */
export declare function getAutonomousDatabaseSoftwareImages(args: GetAutonomousDatabaseSoftwareImagesArgs, opts?: pulumi.InvokeOptions): Promise<GetAutonomousDatabaseSoftwareImagesResult>;
/**
 ...
 * ```
 */
export declare function getAutonomousDatabaseSoftwareImagesOutput(args: GetAutonomousDatabaseSoftwareImagesOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetAutonomousDatabaseSoftwareImagesResult>;
/**
 * A collection of arguments for invoking getAutonomousDatabaseSoftwareImages.
 */

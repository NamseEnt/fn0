 ...
 * ```
 */
export declare function getRepositoryDiff(args: GetRepositoryDiffArgs, opts?: pulumi.InvokeOptions): Promise<GetRepositoryDiffResult>;
/**
 ...
 * ```
 */
export declare function getRepositoryDiffOutput(args: GetRepositoryDiffOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetRepositoryDiffResult>;
/**
 * A collection of arguments for invoking getRepositoryDiff.
 */

 ...
 * ```
 */
export declare function getDeployStage(args: GetDeployStageArgs, opts?: pulumi.InvokeOptions): Promise<GetDeployStageResult>;
/**
 ...
 * ```
 */
export declare function getDeployStageOutput(args: GetDeployStageOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetDeployStageResult>;
/**
 * A collection of arguments for invoking getDeployStage.
 */

 ...
 * ```
 */
export declare class BuildRun extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: BuildRunState, opts?: pulumi.CustomResourceOptions): BuildRun;
    /**
     * Returns true if the given object is an instance of BuildRun.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is BuildRun;
    /**
     * Outputs from the build.
     */
    readonly buildOutputs: pulumi.Output<outputs.DevOps.BuildRunBuildOutput[]>;
    /**
     ...
     */
    readonly buildRunArguments: pulumi.Output<outputs.DevOps.BuildRunBuildRunArguments>;
    /**
     * The run progress details of a build run.
     */
    readonly buildRunProgresses: pulumi.Output<outputs.DevOps.BuildRunBuildRunProgress[]>;
    /**
     * The source from which the build run is triggered.
     */
    readonly buildRunSources: pulumi.Output<outputs.DevOps.BuildRunBuildRunSource[]>;
    /**
     * Commit details that need to be used for the build run.
     */
    readonly commitInfo: pulumi.Output<outputs.DevOps.BuildRunCommitInfo>;
    /**

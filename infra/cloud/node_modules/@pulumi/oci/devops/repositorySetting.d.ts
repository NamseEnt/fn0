 ...
 * ```
 */
export declare class RepositorySetting extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: RepositorySettingState, opts?: pulumi.CustomResourceOptions): RepositorySetting;
    /**
     * Returns true if the given object is an instance of RepositorySetting.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is RepositorySetting;
    /**
     * (Updatable) List of approval rules which must be statisfied before pull requests which match the rules can be merged
     */
    readonly approvalRules: pulumi.Output<outputs.DevOps.RepositorySettingApprovalRules>;
    /**
     * (Updatable) Criteria which must be satisfied to merge a pull request.
     */
    readonly mergeChecks: pulumi.Output<outputs.DevOps.RepositorySettingMergeChecks>;
    /**
     * (Updatable) Enabled and disabled merge strategies for a project or repository, also contains a default strategy.
     */
    readonly mergeSettings: pulumi.Output<outputs.DevOps.RepositorySettingMergeSettings>;
    /**

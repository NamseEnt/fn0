...
export declare class Connection extends pulumi.CustomResource {
     ...
     */
    readonly appPassword: pulumi.Output<string>;
    /**
     ...
     */
    readonly lastConnectionValidationResults: pulumi.Output<outputs.DevOps.ConnectionLastConnectionValidationResult[]>;
    /**
     ...
     */
    readonly tlsVerifyConfig: pulumi.Output<outputs.DevOps.ConnectionTlsVerifyConfig>;
    /**

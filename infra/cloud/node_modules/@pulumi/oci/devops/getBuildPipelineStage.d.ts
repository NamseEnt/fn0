 ...
 * ```
 */
export declare function getBuildPipelineStage(args: GetBuildPipelineStageArgs, opts?: pulumi.InvokeOptions): Promise<GetBuildPipelineStageResult>;
/**
 ...
 * ```
 */
export declare function getBuildPipelineStageOutput(args: GetBuildPipelineStageOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetBuildPipelineStageResult>;
/**
 * A collection of arguments for invoking getBuildPipelineStage.
 */

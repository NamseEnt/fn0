 ...
 * ```
 */
export declare class DeployArtifact extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: DeployArtifactState, opts?: pulumi.CustomResourceOptions): DeployArtifact;
    /**
     * Returns true if the given object is an instance of DeployArtifact.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is DeployArtifact;
    /**
     ...
     */
    readonly argumentSubstitutionMode: pulumi.Output<string>;
    /**
     ...
     */
    readonly deployArtifactSource: pulumi.Output<outputs.DevOps.DeployArtifactDeployArtifactSource>;
    /**
     * (Updatable) Type of the deployment artifact.
     */
    readonly deployArtifactType: pulumi.Output<string>;
    /**

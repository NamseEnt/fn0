 ...
 * ```
 */
export declare class ProjectRepositorySetting extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ProjectRepositorySettingState, opts?: pulumi.CustomResourceOptions): ProjectRepositorySetting;
    /**
     * Returns true if the given object is an instance of ProjectRepositorySetting.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is ProjectRepositorySetting;
    /**
     * (Updatable) List of approval rules which must be statisfied before pull requests which match the rules can be merged
     */
    readonly approvalRules: pulumi.Output<outputs.DevOps.ProjectRepositorySettingApprovalRules>;
    /**
     * (Updatable) Enabled and disabled merge strategies for a project or repository, also contains a default strategy.
     */
    readonly mergeSettings: pulumi.Output<outputs.DevOps.ProjectRepositorySettingMergeSettings>;
    /**

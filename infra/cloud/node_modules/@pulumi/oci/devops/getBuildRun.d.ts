 ...
 * ```
 */
export declare function getBuildRun(args: GetBuildRunArgs, opts?: pulumi.InvokeOptions): Promise<GetBuildRunResult>;
/**
 ...
 * ```
 */
export declare function getBuildRunOutput(args: GetBuildRunOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetBuildRunResult>;
/**
 * A collection of arguments for invoking getBuildRun.
 */

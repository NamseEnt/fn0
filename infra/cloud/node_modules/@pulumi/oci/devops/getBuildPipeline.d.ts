 ...
 * ```
 */
export declare function getBuildPipeline(args: GetBuildPipelineArgs, opts?: pulumi.InvokeOptions): Promise<GetBuildPipelineResult>;
/**
 ...
 * ```
 */
export declare function getBuildPipelineOutput(args: GetBuildPipelineOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetBuildPipelineResult>;
/**
 * A collection of arguments for invoking getBuildPipeline.
 */

 ...
 * ```
 */
export declare class DeployPipeline extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: DeployPipelineState, opts?: pulumi.CustomResourceOptions): DeployPipeline;
    /**
     * Returns true if the given object is an instance of DeployPipeline.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is DeployPipeline;
    /**
     ...
     */
    readonly deployPipelineArtifacts: pulumi.Output<outputs.DevOps.DeployPipelineDeployPipelineArtifact[]>;
    /**
     * List of all environments used in the pipeline.
     */
    readonly deployPipelineEnvironments: pulumi.Output<outputs.DevOps.DeployPipelineDeployPipelineEnvironment[]>;
    /**
     ...
     */
    readonly deployPipelineParameters: pulumi.Output<outputs.DevOps.DeployPipelineDeployPipelineParameters>;
    /**

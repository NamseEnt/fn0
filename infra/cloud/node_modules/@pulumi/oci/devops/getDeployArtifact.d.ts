 ...
 * ```
 */
export declare function getDeployArtifact(args: GetDeployArtifactArgs, opts?: pulumi.InvokeOptions): Promise<GetDeployArtifactResult>;
/**
 ...
 * ```
 */
export declare function getDeployArtifactOutput(args: GetDeployArtifactOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetDeployArtifactResult>;
/**
 * A collection of arguments for invoking getDeployArtifact.
 */

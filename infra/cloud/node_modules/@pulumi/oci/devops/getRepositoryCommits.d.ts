 ...
 * ```
 */
export declare function getRepositoryCommits(args: GetRepositoryCommitsArgs, opts?: pulumi.InvokeOptions): Promise<GetRepositoryCommitsResult>;
/**
 ...
 * ```
 */
export declare function getRepositoryCommitsOutput(args: GetRepositoryCommitsOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetRepositoryCommitsResult>;
/**
 * A collection of arguments for invoking getRepositoryCommits.
 */

 ...
 * ```
 */
class DeployArtifact extends pulumi.CustomResource {
    /**
    ...
    static get(name, id, state, opts) {
        return new DeployArtifact(name, state, { ...opts, id: id });
    }
    /**
...
/** @internal */
DeployArtifact.__pulumiType = 'oci:DevOps/deployArtifact:DeployArtifact';
//# sourceMappingURL=deployArtifact.js.map
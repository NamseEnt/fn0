 ...
 * ```
 */
class BuildPipelineStage extends pulumi.CustomResource {
    /**
    ...
    static get(name, id, state, opts) {
        return new BuildPipelineStage(name, state, { ...opts, id: id });
    }
    /**
...
exports.BuildPipelineStage = BuildPipelineStage;
/** @internal */
BuildPipelineStage.__pulumiType = 'oci:DevOps/buildPipelineStage:BuildPipelineStage';
//# sourceMappingURL=buildPipelineStage.js.map
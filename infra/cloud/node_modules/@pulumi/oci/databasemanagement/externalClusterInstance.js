 ...
 * ```
 */
class ExternalClusterInstance extends pulumi.CustomResource {
    /**
    ...
    static get(name, id, state, opts) {
        return new ExternalClusterInstance(name, state, { ...opts, id: id });
    }
    /**
...
exports.ExternalClusterInstance = ExternalClusterInstance;
/** @internal */
ExternalClusterInstance.__pulumiType = 'oci:DatabaseManagement/externalClusterInstance:ExternalClusterInstance';
//# sourceMappingURL=externalClusterInstance.js.map
 ...
 * ```
 */
export declare function getJobExecutionsStatuses(args: GetJobExecutionsStatusesArgs, opts?: pulumi.InvokeOptions): Promise<GetJobExecutionsStatusesResult>;
/**
 ...
 * ```
 */
export declare function getJobExecutionsStatusesOutput(args: GetJobExecutionsStatusesOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetJobExecutionsStatusesResult>;
/**
 * A collection of arguments for invoking getJobExecutionsStatuses.
 */

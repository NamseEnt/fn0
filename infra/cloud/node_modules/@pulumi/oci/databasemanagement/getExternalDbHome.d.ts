 ...
 * ```
 */
export declare function getExternalDbHome(args: GetExternalDbHomeArgs, opts?: pulumi.InvokeOptions): Promise<GetExternalDbHomeResult>;
/**
 ...
 * ```
 */
export declare function getExternalDbHomeOutput(args: GetExternalDbHomeOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetExternalDbHomeResult>;
/**
 * A collection of arguments for invoking getExternalDbHome.
 */

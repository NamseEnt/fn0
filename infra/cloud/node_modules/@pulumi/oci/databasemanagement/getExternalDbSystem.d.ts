 ...
 * ```
 */
export declare function getExternalDbSystem(args: GetExternalDbSystemArgs, opts?: pulumi.InvokeOptions): Promise<GetExternalDbSystemResult>;
/**
 ...
 * ```
 */
export declare function getExternalDbSystemOutput(args: GetExternalDbSystemOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetExternalDbSystemResult>;
/**
 * A collection of arguments for invoking getExternalDbSystem.
 */

 ...
 * ```
 */
export declare function getCloudCluster(args: GetCloudClusterArgs, opts?: pulumi.InvokeOptions): Promise<GetCloudClusterResult>;
/**
 ...
 * ```
 */
export declare function getCloudClusterOutput(args: GetCloudClusterOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetCloudClusterResult>;
/**
 * A collection of arguments for invoking getCloudCluster.
 */

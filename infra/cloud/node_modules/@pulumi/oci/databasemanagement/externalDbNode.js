 ...
 * ```
 */
class ExternalDbNode extends pulumi.CustomResource {
    /**
    ...
    static get(name, id, state, opts) {
        return new ExternalDbNode(name, state, { ...opts, id: id });
    }
    /**
...
exports.ExternalDbNode = ExternalDbNode;
/** @internal */
ExternalDbNode.__pulumiType = 'oci:DatabaseManagement/externalDbNode:ExternalDbNode';
//# sourceMappingURL=externalDbNode.js.map
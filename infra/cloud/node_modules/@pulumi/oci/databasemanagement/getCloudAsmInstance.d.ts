 ...
 * ```
 */
export declare function getCloudAsmInstance(args: GetCloudAsmInstanceArgs, opts?: pulumi.InvokeOptions): Promise<GetCloudAsmInstanceResult>;
/**
 ...
 * ```
 */
export declare function getCloudAsmInstanceOutput(args: GetCloudAsmInstanceOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetCloudAsmInstanceResult>;
/**
 * A collection of arguments for invoking getCloudAsmInstance.
 */

 ...
 * ```
 */
export declare class ExternalMySqlDatabase extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ExternalMySqlDatabaseState, opts?: pulumi.CustomResourceOptions): ExternalMySqlDatabase;
    /**
     * Returns true if the given object is an instance of ExternalMySqlDatabase.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is ExternalMySqlDatabase;
    /**

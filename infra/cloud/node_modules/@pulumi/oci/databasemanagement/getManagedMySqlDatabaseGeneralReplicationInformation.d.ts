 ...
 * ```
 */
export declare function getManagedMySqlDatabaseGeneralReplicationInformation(args: GetManagedMySqlDatabaseGeneralReplicationInformationArgs, opts?: pulumi.InvokeOptions): Promise<GetManagedMySqlDatabaseGeneralReplicationInformationResult>;
/**
 ...
 * ```
 */
export declare function getManagedMySqlDatabaseGeneralReplicationInformationOutput(args: GetManagedMySqlDatabaseGeneralReplicationInformationOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetManagedMySqlDatabaseGeneralReplicationInformationResult>;
/**
 * A collection of arguments for invoking getManagedMySqlDatabaseGeneralReplicationInformation.
 */

 ...
 */
export declare class ManagedDatabasesChangeDatabaseParameter extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ManagedDatabasesChangeDatabaseParameterState, opts?: pulumi.CustomResourceOptions): ManagedDatabasesChangeDatabaseParameter;
    /**
     ...
     */
    static isInstance(obj: any): obj is ManagedDatabasesChangeDatabaseParameter;
    /**
     ...
     */
    readonly credentials: pulumi.Output<outputs.DatabaseManagement.ManagedDatabasesChangeDatabaseParameterCredentials>;
    /**
     * The credential to connect to the database to perform tablespace administration tasks.
     */
    readonly databaseCredential: pulumi.Output<outputs.DatabaseManagement.ManagedDatabasesChangeDatabaseParameterDatabaseCredential>;
    /**
     * The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the Managed Database.
     */
    readonly managedDatabaseId: pulumi.Output<string>;
    /**
     * A list of database parameters and their values.
     */
    readonly parameters: pulumi.Output<outputs.DatabaseManagement.ManagedDatabasesChangeDatabaseParameterParameter[]>;
    /**

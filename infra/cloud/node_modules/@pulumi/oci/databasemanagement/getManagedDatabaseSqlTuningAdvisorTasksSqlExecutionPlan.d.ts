 ...
 * ```
 */
export declare function getManagedDatabaseSqlTuningAdvisorTasksSqlExecutionPlan(args: GetManagedDatabaseSqlTuningAdvisorTasksSqlExecutionPlanArgs, opts?: pulumi.InvokeOptions): Promise<GetManagedDatabaseSqlTuningAdvisorTasksSqlExecutionPlanResult>;
/**
 ...
 * ```
 */
export declare function getManagedDatabaseSqlTuningAdvisorTasksSqlExecutionPlanOutput(args: GetManagedDatabaseSqlTuningAdvisorTasksSqlExecutionPlanOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetManagedDatabaseSqlTuningAdvisorTasksSqlExecutionPlanResult>;
/**
 * A collection of arguments for invoking getManagedDatabaseSqlTuningAdvisorTasksSqlExecutionPlan.
 */

 ...
 * ```
 */
export declare function getManagedDatabaseUserObjectPrivilege(args: GetManagedDatabaseUserObjectPrivilegeArgs, opts?: pulumi.InvokeOptions): Promise<GetManagedDatabaseUserObjectPrivilegeResult>;
/**
 ...
 * ```
 */
export declare function getManagedDatabaseUserObjectPrivilegeOutput(args: GetManagedDatabaseUserObjectPrivilegeOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetManagedDatabaseUserObjectPrivilegeResult>;
/**
 * A collection of arguments for invoking getManagedDatabaseUserObjectPrivilege.
 */

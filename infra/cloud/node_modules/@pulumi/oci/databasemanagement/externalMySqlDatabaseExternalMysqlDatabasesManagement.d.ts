 ...
 * ```
 */
export declare class ExternalMySqlDatabaseExternalMysqlDatabasesManagement extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ExternalMySqlDatabaseExternalMysqlDatabasesManagementState, opts?: pulumi.CustomResourceOptions): ExternalMySqlDatabaseExternalMysqlDatabasesManagement;
    /**
     ...
     */
    static isInstance(obj: any): obj is ExternalMySqlDatabaseExternalMysqlDatabasesManagement;
    /**
     ...
     */
    readonly enableExternalMysqlDatabase: pulumi.Output<boolean>;
    /**
     * The OCID of the External MySQL Database.
     */
    readonly externalMySqlDatabaseId: pulumi.Output<string>;
    /**

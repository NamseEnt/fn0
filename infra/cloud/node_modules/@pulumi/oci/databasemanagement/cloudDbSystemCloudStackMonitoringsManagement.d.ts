 ...
 * ```
 */
export declare class CloudDbSystemCloudStackMonitoringsManagement extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: CloudDbSystemCloudStackMonitoringsManagementState, opts?: pulumi.CustomResourceOptions): CloudDbSystemCloudStackMonitoringsManagement;
    /**
     ...
     */
    static isInstance(obj: any): obj is CloudDbSystemCloudStackMonitoringsManagement;
    /**
     ...
     */
    readonly enableCloudStackMonitoring: pulumi.Output<boolean>;
    /**

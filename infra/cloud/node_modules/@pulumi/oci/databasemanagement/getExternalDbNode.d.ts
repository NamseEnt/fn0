 ...
 * ```
 */
export declare function getExternalDbNode(args: GetExternalDbNodeArgs, opts?: pulumi.InvokeOptions): Promise<GetExternalDbNodeResult>;
/**
 ...
 * ```
 */
export declare function getExternalDbNodeOutput(args: GetExternalDbNodeOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetExternalDbNodeResult>;
/**
 * A collection of arguments for invoking getExternalDbNode.
 */

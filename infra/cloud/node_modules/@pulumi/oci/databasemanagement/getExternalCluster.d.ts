 ...
 * ```
 */
export declare function getExternalCluster(args: GetExternalClusterArgs, opts?: pulumi.InvokeOptions): Promise<GetExternalClusterResult>;
/**
 ...
 * ```
 */
export declare function getExternalClusterOutput(args: GetExternalClusterOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetExternalClusterResult>;
/**
 * A collection of arguments for invoking getExternalCluster.
 */

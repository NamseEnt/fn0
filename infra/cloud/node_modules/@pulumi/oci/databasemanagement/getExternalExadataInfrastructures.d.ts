 ...
 * ```
 */
export declare function getExternalExadataInfrastructures(args: GetExternalExadataInfrastructuresArgs, opts?: pulumi.InvokeOptions): Promise<GetExternalExadataInfrastructuresResult>;
/**
 ...
 * ```
 */
export declare function getExternalExadataInfrastructuresOutput(args: GetExternalExadataInfrastructuresOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetExternalExadataInfrastructuresResult>;
/**
 * A collection of arguments for invoking getExternalExadataInfrastructures.
 */

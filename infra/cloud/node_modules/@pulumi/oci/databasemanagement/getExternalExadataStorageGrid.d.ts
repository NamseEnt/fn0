 ...
 * ```
 */
export declare function getExternalExadataStorageGrid(args: GetExternalExadataStorageGridArgs, opts?: pulumi.InvokeOptions): Promise<GetExternalExadataStorageGridResult>;
/**
 ...
 * ```
 */
export declare function getExternalExadataStorageGridOutput(args: GetExternalExadataStorageGridOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetExternalExadataStorageGridResult>;
/**
 * A collection of arguments for invoking getExternalExadataStorageGrid.
 */

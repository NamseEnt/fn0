 ...
 * ```
 */
export declare function getDbManagementPrivateEndpointAssociatedDatabases(args: GetDbManagementPrivateEndpointAssociatedDatabasesArgs, opts?: pulumi.InvokeOptions): Promise<GetDbManagementPrivateEndpointAssociatedDatabasesResult>;
/**
 ...
 * ```
 */
export declare function getDbManagementPrivateEndpointAssociatedDatabasesOutput(args: GetDbManagementPrivateEndpointAssociatedDatabasesOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetDbManagementPrivateEndpointAssociatedDatabasesResult>;
/**
 * A collection of arguments for invoking getDbManagementPrivateEndpointAssociatedDatabases.
 */

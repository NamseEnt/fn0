 ...
 * ```
 */
export declare function getCloudExadataStorageServer(args: GetCloudExadataStorageServerArgs, opts?: pulumi.InvokeOptions): Promise<GetCloudExadataStorageServerResult>;
/**
 ...
 * ```
 */
export declare function getCloudExadataStorageServerOutput(args: GetCloudExadataStorageServerOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetCloudExadataStorageServerResult>;
/**
 * A collection of arguments for invoking getCloudExadataStorageServer.
 */

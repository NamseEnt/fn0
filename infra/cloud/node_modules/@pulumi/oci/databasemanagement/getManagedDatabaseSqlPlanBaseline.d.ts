 ...
 * ```
 */
export declare function getManagedDatabaseSqlPlanBaseline(args: GetManagedDatabaseSqlPlanBaselineArgs, opts?: pulumi.InvokeOptions): Promise<GetManagedDatabaseSqlPlanBaselineResult>;
/**
 ...
 * ```
 */
export declare function getManagedDatabaseSqlPlanBaselineOutput(args: GetManagedDatabaseSqlPlanBaselineOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetManagedDatabaseSqlPlanBaselineResult>;
/**
 * A collection of arguments for invoking getManagedDatabaseSqlPlanBaseline.
 */

 ...
 * ```
 */
export declare function getManagedDatabasesAsmProperties(args: GetManagedDatabasesAsmPropertiesArgs, opts?: pulumi.InvokeOptions): Promise<GetManagedDatabasesAsmPropertiesResult>;
/**
 ...
 * ```
 */
export declare function getManagedDatabasesAsmPropertiesOutput(args: GetManagedDatabasesAsmPropertiesOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetManagedDatabasesAsmPropertiesResult>;
/**
 * A collection of arguments for invoking getManagedDatabasesAsmProperties.
 */

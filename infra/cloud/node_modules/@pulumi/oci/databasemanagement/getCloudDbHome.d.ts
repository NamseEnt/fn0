 ...
 * ```
 */
export declare function getCloudDbHome(args: GetCloudDbHomeArgs, opts?: pulumi.InvokeOptions): Promise<GetCloudDbHomeResult>;
/**
 ...
 * ```
 */
export declare function getCloudDbHomeOutput(args: GetCloudDbHomeOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetCloudDbHomeResult>;
/**
 * A collection of arguments for invoking getCloudDbHome.
 */

 ...
 * ```
 */
export declare class ExternalDbNode extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ExternalDbNodeState, opts?: pulumi.CustomResourceOptions): ExternalDbNode;
    /**
     * Returns true if the given object is an instance of ExternalDbNode.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is ExternalDbNode;
    /**

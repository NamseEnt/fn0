 ...
 * ```
 */
export declare class CloudDbHome extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: CloudDbHomeState, opts?: pulumi.CustomResourceOptions): CloudDbHome;
    /**
     * Returns true if the given object is an instance of CloudDbHome.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is CloudDbHome;
    /**

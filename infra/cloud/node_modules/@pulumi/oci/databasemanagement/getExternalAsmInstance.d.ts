 ...
 * ```
 */
export declare function getExternalAsmInstance(args: GetExternalAsmInstanceArgs, opts?: pulumi.InvokeOptions): Promise<GetExternalAsmInstanceResult>;
/**
 ...
 * ```
 */
export declare function getExternalAsmInstanceOutput(args: GetExternalAsmInstanceOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetExternalAsmInstanceResult>;
/**
 * A collection of arguments for invoking getExternalAsmInstance.
 */

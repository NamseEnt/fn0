 ...
 * ```
 */
export declare function getCloudDbNode(args: GetCloudDbNodeArgs, opts?: pulumi.InvokeOptions): Promise<GetCloudDbNodeResult>;
/**
 ...
 * ```
 */
export declare function getCloudDbNodeOutput(args: GetCloudDbNodeOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetCloudDbNodeResult>;
/**
 * A collection of arguments for invoking getCloudDbNode.
 */

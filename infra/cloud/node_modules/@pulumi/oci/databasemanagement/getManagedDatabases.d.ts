 ...
 * ```
 */
export declare function getManagedDatabases(args: GetManagedDatabasesArgs, opts?: pulumi.InvokeOptions): Promise<GetManagedDatabasesResult>;
/**
 ...
 * ```
 */
export declare function getManagedDatabasesOutput(args: GetManagedDatabasesOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetManagedDatabasesResult>;
/**
 * A collection of arguments for invoking getManagedDatabases.
 */

 ...
 * ```
 */
export declare class CloudAsmInstance extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: CloudAsmInstanceState, opts?: pulumi.CustomResourceOptions): CloudAsmInstance;
    /**
     * Returns true if the given object is an instance of CloudAsmInstance.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is CloudAsmInstance;
    /**
     ...
     */
    constructor(name: string, args: CloudAsmInstanceArgs, opts?: pulumi.CustomResourceOptions);
}
/**
 * Input properties used for looking up and filtering CloudAsmInstance resources.
 */
export interface CloudAsmInstanceState {
    /**
     * The Automatic Diagnostic Repository (ADR) home directory for the ASM instance.
     */
 ...
 */
export interface CloudAsmInstanceArgs {
    /**
     * The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the cloud ASM instance.
     */
    cloudAsmInstanceId: pulumi.Input<string>;

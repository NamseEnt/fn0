 ...
 * ```
 */
export declare class ExternalAsmInstance extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ExternalAsmInstanceState, opts?: pulumi.CustomResourceOptions): ExternalAsmInstance;
    /**
     * Returns true if the given object is an instance of ExternalAsmInstance.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is ExternalAsmInstance;
    /**
     ...
     */
    readonly externalAsmInstanceId: pulumi.Output<string>;
    /**

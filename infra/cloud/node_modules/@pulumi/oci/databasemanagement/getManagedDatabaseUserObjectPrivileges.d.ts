 ...
 * ```
 */
export declare function getManagedDatabaseUserObjectPrivileges(args: GetManagedDatabaseUserObjectPrivilegesArgs, opts?: pulumi.InvokeOptions): Promise<GetManagedDatabaseUserObjectPrivilegesResult>;
/**
 ...
 * ```
 */
export declare function getManagedDatabaseUserObjectPrivilegesOutput(args: GetManagedDatabaseUserObjectPrivilegesOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetManagedDatabaseUserObjectPrivilegesResult>;
/**
 * A collection of arguments for invoking getManagedDatabaseUserObjectPrivileges.
 */

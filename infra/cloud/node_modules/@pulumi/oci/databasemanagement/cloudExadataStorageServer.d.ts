 ...
 * ```
 */
export declare class CloudExadataStorageServer extends pulumi.CustomResource {
    /**
     * Get an existing CloudExadataStorageServer resource's state with the given name, ID, and optional extra
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: CloudExadataStorageServerState, opts?: pulumi.CustomResourceOptions): CloudExadataStorageServer;
    /**
     * Returns true if the given object is an instance of CloudExadataStorageServer.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is CloudExadataStorageServer;
    /**
     ...
     */
    readonly cloudExadataStorageServerId: pulumi.Output<string>;
    /**
     * The connector of the Exadata storage server.
     */
    readonly connectors: pulumi.Output<outputs.DatabaseManagement.CloudExadataStorageServerConnector[]>;
    /**
     ...
     */
    readonly storageGridId: pulumi.Output<string>;
    /**
    ...
    /**
     * Create a CloudExadataStorageServer resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: CloudExadataStorageServerArgs, opts?: pulumi.CustomResourceOptions);
}
/**
 * Input properties used for looking up and filtering CloudExadataStorageServer resources.
 */
export interface CloudExadataStorageServerState {
    /**
     * The additional details of the resource defined in `{"key": "value"}` format. Example: `{"bar-key": "value"}`
     */
 ...
 */
export interface CloudExadataStorageServerArgs {
    /**
     * The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the Exadata storage server.
     */
    cloudExadataStorageServerId: pulumi.Input<string>;

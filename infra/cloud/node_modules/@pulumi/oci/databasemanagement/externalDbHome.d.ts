 ...
 * ```
 */
export declare class ExternalDbHome extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ExternalDbHomeState, opts?: pulumi.CustomResourceOptions): ExternalDbHome;
    /**
     * Returns true if the given object is an instance of ExternalDbHome.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is ExternalDbHome;
    /**

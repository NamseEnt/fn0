 ...
 * ```
 */
export declare class ExternalDbSystem extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ExternalDbSystemState, opts?: pulumi.CustomResourceOptions): ExternalDbSystem;
    /**
     * Returns true if the given object is an instance of ExternalDbSystem.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is ExternalDbSystem;
    /**
     ...
     */
    readonly databaseManagementConfig: pulumi.Output<outputs.DatabaseManagement.ExternalDbSystemDatabaseManagementConfig>;
    /**
     * The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the DB system discovery.
     */
    readonly dbSystemDiscoveryId: pulumi.Output<string>;
    /**
     ...
     */
    readonly discoveryAgentId: pulumi.Output<string>;
    /**
     ...
     */
    readonly isCluster: pulumi.Output<boolean>;
    /**
     ...
     */
    readonly stackMonitoringConfig: pulumi.Output<outputs.DatabaseManagement.ExternalDbSystemStackMonitoringConfig>;
    /**

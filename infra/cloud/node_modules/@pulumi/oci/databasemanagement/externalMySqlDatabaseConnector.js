 ...
 * ```
 */
class ExternalMySqlDatabaseConnector extends pulumi.CustomResource {
    /**
    ...
    static get(name, id, state, opts) {
        return new ExternalMySqlDatabaseConnector(name, state, { ...opts, id: id });
    }
    /**
...
exports.ExternalMySqlDatabaseConnector = ExternalMySqlDatabaseConnector;
/** @internal */
ExternalMySqlDatabaseConnector.__pulumiType = 'oci:DatabaseManagement/externalMySqlDatabaseConnector:ExternalMySqlDatabaseConnector';
//# sourceMappingURL=externalMySqlDatabaseConnector.js.map
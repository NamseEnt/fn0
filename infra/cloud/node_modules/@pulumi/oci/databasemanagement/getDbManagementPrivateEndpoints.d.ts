 ...
 * ```
 */
export declare function getDbManagementPrivateEndpoints(args: GetDbManagementPrivateEndpointsArgs, opts?: pulumi.InvokeOptions): Promise<GetDbManagementPrivateEndpointsResult>;
/**
 ...
 * ```
 */
export declare function getDbManagementPrivateEndpointsOutput(args: GetDbManagementPrivateEndpointsOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetDbManagementPrivateEndpointsResult>;
/**
 * A collection of arguments for invoking getDbManagementPrivateEndpoints.
 */

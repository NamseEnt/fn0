 ...
 * ```
 */
export declare function getManagedMySqlDatabaseOutput(args: GetManagedMySqlDatabaseOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetManagedMySqlDatabaseResult>;
/**
 * A collection of arguments for invoking getManagedMySqlDatabase.
 */

 ...
 * ```
 */
class ExternalAsmInstance extends pulumi.CustomResource {
    /**
    ...
    static get(name, id, state, opts) {
        return new ExternalAsmInstance(name, state, { ...opts, id: id });
    }
    /**
...
exports.ExternalAsmInstance = ExternalAsmInstance;
/** @internal */
ExternalAsmInstance.__pulumiType = 'oci:DatabaseManagement/externalAsmInstance:ExternalAsmInstance';
//# sourceMappingURL=externalAsmInstance.js.map
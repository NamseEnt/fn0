 ...
 * ```
 */
class ExternalAsm extends pulumi.CustomResource {
    /**
    ...
    static get(name, id, state, opts) {
        return new ExternalAsm(name, state, { ...opts, id: id });
    }
    /**
...
exports.ExternalAsm = ExternalAsm;
/** @internal */
ExternalAsm.__pulumiType = 'oci:DatabaseManagement/externalAsm:ExternalAsm';
//# sourceMappingURL=externalAsm.js.map
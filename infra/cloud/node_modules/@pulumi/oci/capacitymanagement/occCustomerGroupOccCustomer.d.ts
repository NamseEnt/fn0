 ...
 * ```
 */
export declare class OccCustomerGroupOccCustomer extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: OccCustomerGroupOccCustomerState, opts?: pulumi.CustomResourceOptions): OccCustomerGroupOccCustomer;
    /**
     ...
     */
    static isInstance(obj: any): obj is OccCustomerGroupOccCustomer;
    /**

 ...
 * ```
 */
class OccCapacityRequest extends pulumi.CustomResource {
    /**
    ...
    static get(name, id, state, opts) {
        return new OccCapacityRequest(name, state, { ...opts, id: id });
    }
    /**
...
exports.OccCapacityRequest = OccCapacityRequest;
/** @internal */
OccCapacityRequest.__pulumiType = 'oci:CapacityManagement/occCapacityRequest:OccCapacityRequest';
//# sourceMappingURL=occCapacityRequest.js.map
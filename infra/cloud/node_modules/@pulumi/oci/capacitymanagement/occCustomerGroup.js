 ...
 * ```
 */
class OccCustomerGroup extends pulumi.CustomResource {
    /**
    ...
    static get(name, id, state, opts) {
        return new OccCustomerGroup(name, state, { ...opts, id: id });
    }
    /**
...
exports.OccCustomerGroup = OccCustomerGroup;
/** @internal */
OccCustomerGroup.__pulumiType = 'oci:CapacityManagement/occCustomerGroup:OccCustomerGroup';
//# sourceMappingURL=occCustomerGroup.js.map
 ...
 * ```
 */
export declare class InternalOccmDemandSignalDelivery extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: InternalOccmDemandSignalDeliveryState, opts?: pulumi.CustomResourceOptions): InternalOccmDemandSignalDelivery;
    /**
     ...
     */
    static isInstance(obj: any): obj is InternalOccmDemandSignalDelivery;
    /**
     * (Updatable) The quantity of the resource that Oracle Cloud Infrastructure will supply to the customer.
     */
    readonly acceptedQuantity: pulumi.Output<string>;
    /**
     ...
     */
    readonly demandSignalItemId: pulumi.Output<string>;
    /**
     ...
     */
    readonly timeDelivered: pulumi.Output<string>;
    /**

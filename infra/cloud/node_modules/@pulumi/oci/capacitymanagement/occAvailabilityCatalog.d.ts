 ...
 * ```
 */
export declare class OccAvailabilityCatalog extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: OccAvailabilityCatalogState, opts?: pulumi.CustomResourceOptions): OccAvailabilityCatalog;
    /**
     * Returns true if the given object is an instance of OccAvailabilityCatalog.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is OccAvailabilityCatalog;
    /**
     * The base 64 encoded string corresponding to the catalog file contents.
     */
    readonly base64encodedCatalogDetails: pulumi.Output<string>;
    /**
     * The different states associated with the availability catalog.
     */
    readonly catalogState: pulumi.Output<string>;
    /**
     ...
     */
    readonly details: pulumi.Output<outputs.CapacityManagement.OccAvailabilityCatalogDetail[]>;
    /**
     ...
     */
    readonly metadataDetails: pulumi.Output<outputs.CapacityManagement.OccAvailabilityCatalogMetadataDetails>;
    /**

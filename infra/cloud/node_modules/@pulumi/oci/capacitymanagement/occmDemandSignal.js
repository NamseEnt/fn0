 ...
 * ```
 */
class OccmDemandSignal extends pulumi.CustomResource {
    /**
    ...
    static get(name, id, state, opts) {
        return new OccmDemandSignal(name, state, { ...opts, id: id });
    }
    /**
...
exports.OccmDemandSignal = OccmDemandSignal;
/** @internal */
OccmDemandSignal.__pulumiType = 'oci:CapacityManagement/occmDemandSignal:OccmDemandSignal';
//# sourceMappingURL=occmDemandSignal.js.map
 ...
 * ```
 */
export declare function getOccCapacityRequest(args: GetOccCapacityRequestArgs, opts?: pulumi.InvokeOptions): Promise<GetOccCapacityRequestResult>;
/**
 ...
 * ```
 */
export declare function getOccCapacityRequestOutput(args: GetOccCapacityRequestOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetOccCapacityRequestResult>;
/**
 * A collection of arguments for invoking getOccCapacityRequest.
 */

 ...
 * ```
 */
export declare function getOccmDemandSignalCatalogResources(args: GetOccmDemandSignalCatalogResourcesArgs, opts?: pulumi.InvokeOptions): Promise<GetOccmDemandSignalCatalogResourcesResult>;
/**
 ...
 * ```
 */
export declare function getOccmDemandSignalCatalogResourcesOutput(args: GetOccmDemandSignalCatalogResourcesOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetOccmDemandSignalCatalogResourcesResult>;
/**
 * A collection of arguments for invoking getOccmDemandSignalCatalogResources.
 */

 ...
 * ```
 */
export declare function getInternalOccAvailabilityCatalogs(args: GetInternalOccAvailabilityCatalogsArgs, opts?: pulumi.InvokeOptions): Promise<GetInternalOccAvailabilityCatalogsResult>;
/**
 ...
 * ```
 */
export declare function getInternalOccAvailabilityCatalogsOutput(args: GetInternalOccAvailabilityCatalogsOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetInternalOccAvailabilityCatalogsResult>;
/**
 * A collection of arguments for invoking getInternalOccAvailabilityCatalogs.
 */

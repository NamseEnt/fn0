 ...
 * ```
 */
export declare function getOccmDemandSignal(args: GetOccmDemandSignalArgs, opts?: pulumi.InvokeOptions): Promise<GetOccmDemandSignalResult>;
/**
 ...
 * ```
 */
export declare function getOccmDemandSignalOutput(args: GetOccmDemandSignalOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetOccmDemandSignalResult>;
/**
 * A collection of arguments for invoking getOccmDemandSignal.
 */

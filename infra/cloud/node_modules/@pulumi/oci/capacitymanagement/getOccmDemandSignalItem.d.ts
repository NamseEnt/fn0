 ...
 * ```
 */
export declare function getOccmDemandSignalItem(args: GetOccmDemandSignalItemArgs, opts?: pulumi.InvokeOptions): Promise<GetOccmDemandSignalItemResult>;
/**
 ...
 * ```
 */
export declare function getOccmDemandSignalItemOutput(args: GetOccmDemandSignalItemOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetOccmDemandSignalItemResult>;
/**
 * A collection of arguments for invoking getOccmDemandSignalItem.
 */

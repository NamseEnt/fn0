 ...
 * ```
 */
export declare function getInternalOccHandoverResourceBlocks(args: GetInternalOccHandoverResourceBlocksArgs, opts?: pulumi.InvokeOptions): Promise<GetInternalOccHandoverResourceBlocksResult>;
/**
 ...
 * ```
 */
export declare function getInternalOccHandoverResourceBlocksOutput(args: GetInternalOccHandoverResourceBlocksOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetInternalOccHandoverResourceBlocksResult>;
/**
 * A collection of arguments for invoking getInternalOccHandoverResourceBlocks.
 */

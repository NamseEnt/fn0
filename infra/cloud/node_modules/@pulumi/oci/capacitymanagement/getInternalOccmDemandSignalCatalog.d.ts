 ...
 * ```
 */
export declare function getInternalOccmDemandSignalCatalog(args: GetInternalOccmDemandSignalCatalogArgs, opts?: pulumi.InvokeOptions): Promise<GetInternalOccmDemandSignalCatalogResult>;
/**
 ...
 * ```
 */
export declare function getInternalOccmDemandSignalCatalogOutput(args: GetInternalOccmDemandSignalCatalogOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetInternalOccmDemandSignalCatalogResult>;
/**
 * A collection of arguments for invoking getInternalOccmDemandSignalCatalog.
 */

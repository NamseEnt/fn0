 ...
 * ```
 */
export declare function getOccCustomerGroups(args: GetOccCustomerGroupsArgs, opts?: pulumi.InvokeOptions): Promise<GetOccCustomerGroupsResult>;
/**
 ...
 * ```
 */
export declare function getOccCustomerGroupsOutput(args: GetOccCustomerGroupsOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetOccCustomerGroupsResult>;
/**
 * A collection of arguments for invoking getOccCustomerGroups.
 */

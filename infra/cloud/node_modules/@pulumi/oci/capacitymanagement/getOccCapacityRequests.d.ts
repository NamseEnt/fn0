 ...
 * ```
 */
export declare function getOccCapacityRequests(args: GetOccCapacityRequestsArgs, opts?: pulumi.InvokeOptions): Promise<GetOccCapacityRequestsResult>;
/**
 ...
 * ```
 */
export declare function getOccCapacityRequestsOutput(args: GetOccCapacityRequestsOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetOccCapacityRequestsResult>;
/**
 * A collection of arguments for invoking getOccCapacityRequests.
 */

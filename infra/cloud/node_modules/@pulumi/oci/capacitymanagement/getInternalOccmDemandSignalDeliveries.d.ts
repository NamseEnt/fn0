 ...
 * ```
 */
export declare function getInternalOccmDemandSignalDeliveries(args: GetInternalOccmDemandSignalDeliveriesArgs, opts?: pulumi.InvokeOptions): Promise<GetInternalOccmDemandSignalDeliveriesResult>;
/**
 ...
 * ```
 */
export declare function getInternalOccmDemandSignalDeliveriesOutput(args: GetInternalOccmDemandSignalDeliveriesOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetInternalOccmDemandSignalDeliveriesResult>;
/**
 * A collection of arguments for invoking getInternalOccmDemandSignalDeliveries.
 */

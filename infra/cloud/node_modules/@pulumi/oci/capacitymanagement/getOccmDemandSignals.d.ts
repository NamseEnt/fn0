 ...
 * ```
 */
export declare function getOccmDemandSignals(args: GetOccmDemandSignalsArgs, opts?: pulumi.InvokeOptions): Promise<GetOccmDemandSignalsResult>;
/**
 ...
 * ```
 */
export declare function getOccmDemandSignalsOutput(args: GetOccmDemandSignalsOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetOccmDemandSignalsResult>;
/**
 * A collection of arguments for invoking getOccmDemandSignals.
 */

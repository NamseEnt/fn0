 ...
 * ```
 */
export declare function getNamespaceOccOverviews(args: GetNamespaceOccOverviewsArgs, opts?: pulumi.InvokeOptions): Promise<GetNamespaceOccOverviewsResult>;
/**
 ...
 * ```
 */
export declare function getNamespaceOccOverviewsOutput(args: GetNamespaceOccOverviewsOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetNamespaceOccOverviewsResult>;
/**
 * A collection of arguments for invoking getNamespaceOccOverviews.
 */

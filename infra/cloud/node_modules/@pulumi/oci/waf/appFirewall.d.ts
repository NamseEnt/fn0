 ...
 * ```
 */
export declare class AppFirewall extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: AppFirewallState, opts?: pulumi.CustomResourceOptions): AppFirewall;
    /**
     * Returns true if the given object is an instance of AppFirewall.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is AppFirewall;
    /**
     ...
     */
    readonly webAppFirewallPolicyId: pulumi.Output<string>;
    /**

 ...
 * ```
 */
export declare function getProtectionCapabilities(args: GetProtectionCapabilitiesArgs, opts?: pulumi.InvokeOptions): Promise<GetProtectionCapabilitiesResult>;
/**
 ...
 * ```
 */
export declare function getProtectionCapabilitiesOutput(args: GetProtectionCapabilitiesOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetProtectionCapabilitiesResult>;
/**
 * A collection of arguments for invoking getProtectionCapabilities.
 */

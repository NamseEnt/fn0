 ...
 * ```
 */
export declare class AppFirewallPolicy extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: AppFirewallPolicyState, opts?: pulumi.CustomResourceOptions): AppFirewallPolicy;
    /**
     * Returns true if the given object is an instance of AppFirewallPolicy.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is AppFirewallPolicy;
    /**
     ...
     */
    readonly actions: pulumi.Output<outputs.Waf.AppFirewallPolicyAction[]>;
    /**
     ...
     */
    readonly requestAccessControl: pulumi.Output<outputs.Waf.AppFirewallPolicyRequestAccessControl>;
    /**
     * (Updatable) Module that allows to enable OCI-managed protection capabilities for incoming HTTP requests.
     */
    readonly requestProtection: pulumi.Output<outputs.Waf.AppFirewallPolicyRequestProtection>;
    /**
     * (Updatable) Module that allows inspection of HTTP connection properties and to limit requests frequency for a given key.
     */
    readonly requestRateLimiting: pulumi.Output<outputs.Waf.AppFirewallPolicyRequestRateLimiting>;
    /**
     * (Updatable) Module that allows inspection of HTTP response properties and to return a defined HTTP response.
     */
    readonly responseAccessControl: pulumi.Output<outputs.Waf.AppFirewallPolicyResponseAccessControl>;
    /**
     * (Updatable) Module that allows to enable OCI-managed protection capabilities for HTTP responses.
     */
    readonly responseProtection: pulumi.Output<outputs.Waf.AppFirewallPolicyResponseProtection>;
    /**

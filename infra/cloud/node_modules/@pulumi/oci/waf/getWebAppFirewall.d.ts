 ...
 * ```
 */
export declare function getWebAppFirewall(args: GetWebAppFirewallArgs, opts?: pulumi.InvokeOptions): Promise<GetWebAppFirewallResult>;
/**
 ...
 * ```
 */
export declare function getWebAppFirewallOutput(args: GetWebAppFirewallOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetWebAppFirewallResult>;
/**
 * A collection of arguments for invoking getWebAppFirewall.
 */

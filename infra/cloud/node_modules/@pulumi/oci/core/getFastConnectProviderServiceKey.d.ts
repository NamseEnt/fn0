 ...
 * ```
 */
export declare function getFastConnectProviderServiceKey(args: GetFastConnectProviderServiceKeyArgs, opts?: pulumi.InvokeOptions): Promise<GetFastConnectProviderServiceKeyResult>;
/**
 ...
 * ```
 */
export declare function getFastConnectProviderServiceKeyOutput(args: GetFastConnectProviderServiceKeyOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetFastConnectProviderServiceKeyResult>;
/**
 * A collection of arguments for invoking getFastConnectProviderServiceKey.
 */

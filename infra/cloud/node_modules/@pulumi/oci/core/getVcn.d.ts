 ...
 * ```
 */
export declare function getVcn(args: GetVcnArgs, opts?: pulumi.InvokeOptions): Promise<GetVcnResult>;
/**
 ...
 * ```
 */
export declare function getVcnOutput(args: GetVcnOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetVcnResult>;
/**
 * A collection of arguments for invoking getVcn.
 */

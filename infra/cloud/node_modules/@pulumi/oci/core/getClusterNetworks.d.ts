 ...
 * ```
 */
export declare function getClusterNetworks(args: GetClusterNetworksArgs, opts?: pulumi.InvokeOptions): Promise<GetClusterNetworksResult>;
/**
 ...
 * ```
 */
export declare function getClusterNetworksOutput(args: GetClusterNetworksOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetClusterNetworksResult>;
/**
 * A collection of arguments for invoking getClusterNetworks.
 */

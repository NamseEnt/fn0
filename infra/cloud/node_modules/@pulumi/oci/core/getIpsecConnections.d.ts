 ...
 * ```
 */
export declare function getIpsecConnections(args: GetIpsecConnectionsArgs, opts?: pulumi.InvokeOptions): Promise<GetIpsecConnectionsResult>;
/**
 ...
 * ```
 */
export declare function getIpsecConnectionsOutput(args: GetIpsecConnectionsOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetIpsecConnectionsResult>;
/**
 * A collection of arguments for invoking getIpsecConnections.
 */

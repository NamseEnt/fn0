 ...
 * ```
 */
export declare function getVolumeGroupReplica(args: GetVolumeGroupReplicaArgs, opts?: pulumi.InvokeOptions): Promise<GetVolumeGroupReplicaResult>;
/**
 ...
 * ```
 */
export declare function getVolumeGroupReplicaOutput(args: GetVolumeGroupReplicaOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetVolumeGroupReplicaResult>;
/**
 * A collection of arguments for invoking getVolumeGroupReplica.
 */

...
exports.ListingResourceVersionAgreement = void 0;
 ...
 * ```
 */
class ListingResourceVersionAgreement extends pulumi.CustomResource {
    /**
    ...
    static get(name, id, state, opts) {
        return new ListingResourceVersionAgreement(name, state, { ...opts, id: id });
    }
    /**
...
exports.ListingResourceVersionAgreement = ListingResourceVersionAgreement;
/** @internal */
ListingResourceVersionAgreement.__pulumiType = 'oci:Core/listingResourceVersionAgreement:ListingResourceVersionAgreement';
//# sourceMappingURL=listingResourceVersionAgreement.js.map
...
exports.NetworkSecurityGroupSecurityRule = void 0;
 ...
 * ```
 */
class NetworkSecurityGroupSecurityRule extends pulumi.CustomResource {
    /**
    ...
    static get(name, id, state, opts) {
        return new NetworkSecurityGroupSecurityRule(name, state, { ...opts, id: id });
    }
    /**
...
exports.NetworkSecurityGroupSecurityRule = NetworkSecurityGroupSecurityRule;
/** @internal */
NetworkSecurityGroupSecurityRule.__pulumiType = 'oci:Core/networkSecurityGroupSecurityRule:NetworkSecurityGroupSecurityRule';
//# sourceMappingURL=networkSecurityGroupSecurityRule.js.map
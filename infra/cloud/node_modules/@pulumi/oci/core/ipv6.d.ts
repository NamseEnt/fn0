 ...
 * ```
 */
export declare class Ipv6 extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: Ipv6State, opts?: pulumi.CustomResourceOptions): Ipv6;
    /**
     * Returns true if the given object is an instance of Ipv6.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is Ipv6;
    /**

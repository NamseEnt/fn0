 ...
 * ```
 */
export declare function getFastConnectProviderServices(args: GetFastConnectProviderServicesArgs, opts?: pulumi.InvokeOptions): Promise<GetFastConnectProviderServicesResult>;
/**
 ...
 * ```
 */
export declare function getFastConnectProviderServicesOutput(args: GetFastConnectProviderServicesOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetFastConnectProviderServicesResult>;
/**
 * A collection of arguments for invoking getFastConnectProviderServices.
 */

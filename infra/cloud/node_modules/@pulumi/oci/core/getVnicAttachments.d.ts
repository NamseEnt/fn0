 ...
 * ```
 */
export declare function getVnicAttachments(args: GetVnicAttachmentsArgs, opts?: pulumi.InvokeOptions): Promise<GetVnicAttachmentsResult>;
/**
 ...
 * ```
 */
export declare function getVnicAttachmentsOutput(args: GetVnicAttachmentsOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetVnicAttachmentsResult>;
/**
 * A collection of arguments for invoking getVnicAttachments.
 */

 ...
 * ```
 */
export declare function getCrossConnectGroup(args: GetCrossConnectGroupArgs, opts?: pulumi.InvokeOptions): Promise<GetCrossConnectGroupResult>;
/**
 ...
 * ```
 */
export declare function getCrossConnectGroupOutput(args: GetCrossConnectGroupOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetCrossConnectGroupResult>;
/**
 * A collection of arguments for invoking getCrossConnectGroup.
 */

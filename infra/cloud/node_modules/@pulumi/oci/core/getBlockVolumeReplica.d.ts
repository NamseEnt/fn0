 ...
 * ```
 */
export declare function getBlockVolumeReplica(args: GetBlockVolumeReplicaArgs, opts?: pulumi.InvokeOptions): Promise<GetBlockVolumeReplicaResult>;
/**
 ...
 * ```
 */
export declare function getBlockVolumeReplicaOutput(args: GetBlockVolumeReplicaOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetBlockVolumeReplicaResult>;
/**
 * A collection of arguments for invoking getBlockVolumeReplica.
 */

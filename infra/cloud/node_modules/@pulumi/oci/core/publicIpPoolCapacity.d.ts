 ...
 * ```
 */
export declare class PublicIpPoolCapacity extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: PublicIpPoolCapacityState, opts?: pulumi.CustomResourceOptions): PublicIpPoolCapacity;
    /**
     * Returns true if the given object is an instance of PublicIpPoolCapacity.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is PublicIpPoolCapacity;
    /**
     * The OCID of the Byoip Range Id object to which the cidr block belongs.
     */
    readonly byoipId: pulumi.Output<string>;
    /**
     ...
     */
    readonly publicIpPoolId: pulumi.Output<string>;
    /**

 ...
 * ```
 */
export declare function getClusterNetworkInstances(args: GetClusterNetworkInstancesArgs, opts?: pulumi.InvokeOptions): Promise<GetClusterNetworkInstancesResult>;
/**
 ...
 * ```
 */
export declare function getClusterNetworkInstancesOutput(args: GetClusterNetworkInstancesOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetClusterNetworkInstancesResult>;
/**
 * A collection of arguments for invoking getClusterNetworkInstances.
 */

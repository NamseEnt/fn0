 ...
 * ```
 */
export declare class CrossConnectGroup extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: CrossConnectGroupState, opts?: pulumi.CustomResourceOptions): CrossConnectGroup;
    /**
     * Returns true if the given object is an instance of CrossConnectGroup.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is CrossConnectGroup;
    /**
     ...
     */
    readonly macsecProperties: pulumi.Output<outputs.Core.CrossConnectGroupMacsecProperties>;
    /**

 ...
 * ```
 */
export declare function getInstanceMaintenanceEvent(args: GetInstanceMaintenanceEventArgs, opts?: pulumi.InvokeOptions): Promise<GetInstanceMaintenanceEventResult>;
/**
 ...
 * ```
 */
export declare function getInstanceMaintenanceEventOutput(args: GetInstanceMaintenanceEventOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetInstanceMaintenanceEventResult>;
/**
 * A collection of arguments for invoking getInstanceMaintenanceEvent.
 */

 ...
 * ```
 */
export declare function getDrgRouteRule(args: GetDrgRouteRuleArgs, opts?: pulumi.InvokeOptions): Promise<GetDrgRouteRuleResult>;
/**
 ...
 * ```
 */
export declare function getDrgRouteRuleOutput(args: GetDrgRouteRuleOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetDrgRouteRuleResult>;
/**
 * A collection of arguments for invoking getDrgRouteRule.
 */

 ...
 * ```
 */
export declare function getComputeGlobalImageCapabilitySchema(args: GetComputeGlobalImageCapabilitySchemaArgs, opts?: pulumi.InvokeOptions): Promise<GetComputeGlobalImageCapabilitySchemaResult>;
/**
 ...
 * ```
 */
export declare function getComputeGlobalImageCapabilitySchemaOutput(args: GetComputeGlobalImageCapabilitySchemaOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetComputeGlobalImageCapabilitySchemaResult>;
/**
 * A collection of arguments for invoking getComputeGlobalImageCapabilitySchema.
 */

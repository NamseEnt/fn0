 ...
 * ```
 */
export declare function getInstanceDevices(args: GetInstanceDevicesArgs, opts?: pulumi.InvokeOptions): Promise<GetInstanceDevicesResult>;
/**
 ...
 * ```
 */
export declare function getInstanceDevicesOutput(args: GetInstanceDevicesOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetInstanceDevicesResult>;
/**
 * A collection of arguments for invoking getInstanceDevices.
 */

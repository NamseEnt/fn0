 ...
 * ```
 */
export declare function getComputeImageCapabilitySchema(args: GetComputeImageCapabilitySchemaArgs, opts?: pulumi.InvokeOptions): Promise<GetComputeImageCapabilitySchemaResult>;
/**
 ...
 * ```
 */
export declare function getComputeImageCapabilitySchemaOutput(args: GetComputeImageCapabilitySchemaOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetComputeImageCapabilitySchemaResult>;
/**
 * A collection of arguments for invoking getComputeImageCapabilitySchema.
 */

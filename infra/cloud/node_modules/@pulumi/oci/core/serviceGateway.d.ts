 ...
 * ```
 */
export declare class ServiceGateway extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ServiceGatewayState, opts?: pulumi.CustomResourceOptions): ServiceGateway;
    /**
     * Returns true if the given object is an instance of ServiceGateway.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is ServiceGateway;
    /**
     ...
     */
    readonly blockTraffic: pulumi.Output<boolean>;
    /**
     ...
     */
    readonly services: pulumi.Output<outputs.Core.ServiceGatewayService[]>;
    /**

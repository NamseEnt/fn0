 ...
 * ```
 */
export declare function getInstanceConfiguration(args: GetInstanceConfigurationArgs, opts?: pulumi.InvokeOptions): Promise<GetInstanceConfigurationResult>;
/**
 ...
 * ```
 */
export declare function getInstanceConfigurationOutput(args: GetInstanceConfigurationOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetInstanceConfigurationResult>;
/**
 * A collection of arguments for invoking getInstanceConfiguration.
 */

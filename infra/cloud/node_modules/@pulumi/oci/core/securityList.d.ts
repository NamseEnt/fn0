 ...
 * ```
 */
export declare class SecurityList extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: SecurityListState, opts?: pulumi.CustomResourceOptions): SecurityList;
    /**
     * Returns true if the given object is an instance of SecurityList.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is SecurityList;
    /**
     ...
     */
    readonly egressSecurityRules: pulumi.Output<outputs.Core.SecurityListEgressSecurityRule[] | undefined>;
    /**
     ...
     */
    readonly ingressSecurityRules: pulumi.Output<outputs.Core.SecurityListIngressSecurityRule[] | undefined>;
    /**

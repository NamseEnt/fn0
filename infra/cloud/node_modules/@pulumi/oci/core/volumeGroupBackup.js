 ...
 * ```
 */
class VolumeGroupBackup extends pulumi.CustomResource {
    /**
    ...
    static get(name, id, state, opts) {
        return new VolumeGroupBackup(name, state, { ...opts, id: id });
    }
    /**
...
exports.VolumeGroupBackup = VolumeGroupBackup;
/** @internal */
VolumeGroupBackup.__pulumiType = 'oci:Core/volumeGroupBackup:VolumeGroupBackup';
//# sourceMappingURL=volumeGroupBackup.js.map
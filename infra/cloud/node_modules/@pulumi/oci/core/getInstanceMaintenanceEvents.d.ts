 ...
 * ```
 */
export declare function getInstanceMaintenanceEvents(args: GetInstanceMaintenanceEventsArgs, opts?: pulumi.InvokeOptions): Promise<GetInstanceMaintenanceEventsResult>;
/**
 ...
 * ```
 */
export declare function getInstanceMaintenanceEventsOutput(args: GetInstanceMaintenanceEventsOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetInstanceMaintenanceEventsResult>;
/**
 * A collection of arguments for invoking getInstanceMaintenanceEvents.
 */

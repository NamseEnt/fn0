 ...
 * ```
 */
export declare class DhcpOptions extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: DhcpOptionsState, opts?: pulumi.CustomResourceOptions): DhcpOptions;
    /**
     * Returns true if the given object is an instance of DhcpOptions.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is DhcpOptions;
    /**
     ...
     */
    readonly domainNameType: pulumi.Output<string>;
    /**
     ...
     */
    readonly options: pulumi.Output<outputs.Core.DhcpOptionsOption[]>;
    /**

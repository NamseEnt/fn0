...
export declare class VolumeGroup extends pulumi.CustomResource {
    ...
    readonly preserveVolumeReplica: pulumi.Output<boolean | undefined>;
    /**
     ...
     */
    readonly sourceDetails: pulumi.Output<outputs.Core.VolumeGroupSourceDetails>;
    /**
     ...
     */
    readonly volumeGroupReplicas: pulumi.Output<outputs.Core.VolumeGroupVolumeGroupReplica[]>;
    readonly volumeGroupReplicasDeletion: pulumi.Output<boolean | undefined>;
    /**

 ...
 * ```
 */
export declare function getRemotePeeringConnections(args: GetRemotePeeringConnectionsArgs, opts?: pulumi.InvokeOptions): Promise<GetRemotePeeringConnectionsResult>;
/**
 ...
 * ```
 */
export declare function getRemotePeeringConnectionsOutput(args: GetRemotePeeringConnectionsOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetRemotePeeringConnectionsResult>;
/**
 * A collection of arguments for invoking getRemotePeeringConnections.
 */

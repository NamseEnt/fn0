 ...
 * ```
 */
export declare function getIpsecStatus(args: GetIpsecStatusArgs, opts?: pulumi.InvokeOptions): Promise<GetIpsecStatusResult>;
/**
 ...
 * ```
 */
export declare function getIpsecStatusOutput(args: GetIpsecStatusOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetIpsecStatusResult>;
/**
 * A collection of arguments for invoking getIpsecStatus.
 */

 ...
 * ```
 */
export declare class DrgAttachment extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: DrgAttachmentState, opts?: pulumi.CustomResourceOptions): DrgAttachment;
    /**
     * Returns true if the given object is an instance of DrgAttachment.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is DrgAttachment;
    /**
     ...
     * (Updatable)
     */
    readonly networkDetails: pulumi.Output<outputs.Core.DrgAttachmentNetworkDetails>;
    /**

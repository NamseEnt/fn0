 ...
 * ```
 */
export declare function getVirtualCircuitBandwidthShapes(args: GetVirtualCircuitBandwidthShapesArgs, opts?: pulumi.InvokeOptions): Promise<GetVirtualCircuitBandwidthShapesResult>;
/**
 ...
 * ```
 */
export declare function getVirtualCircuitBandwidthShapesOutput(args: GetVirtualCircuitBandwidthShapesOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetVirtualCircuitBandwidthShapesResult>;
/**
 * A collection of arguments for invoking getVirtualCircuitBandwidthShapes.
 */

 ...
 * ```
 */
export declare class ComputeHostGroup extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ComputeHostGroupState, opts?: pulumi.CustomResourceOptions): ComputeHostGroup;
    /**
     * Returns true if the given object is an instance of ComputeHostGroup.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is ComputeHostGroup;
    /**
     ...
     */
    readonly configurations: pulumi.Output<outputs.Core.ComputeHostGroupConfiguration[]>;
    /**
     ...
     */
    readonly isTargetedPlacementRequired: pulumi.Output<boolean>;
    /**

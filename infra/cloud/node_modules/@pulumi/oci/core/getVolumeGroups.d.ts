 ...
 * ```
 */
export declare function getVolumeGroups(args: GetVolumeGroupsArgs, opts?: pulumi.InvokeOptions): Promise<GetVolumeGroupsResult>;
/**
 ...
 * ```
 */
export declare function getVolumeGroupsOutput(args: GetVolumeGroupsOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetVolumeGroupsResult>;
/**
 * A collection of arguments for invoking getVolumeGroups.
 */

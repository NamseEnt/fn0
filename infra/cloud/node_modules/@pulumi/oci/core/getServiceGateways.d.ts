 ...
 * ```
 */
export declare function getServiceGateways(args: GetServiceGatewaysArgs, opts?: pulumi.InvokeOptions): Promise<GetServiceGatewaysResult>;
/**
 ...
 * ```
 */
export declare function getServiceGatewaysOutput(args: GetServiceGatewaysOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetServiceGatewaysResult>;
/**
 * A collection of arguments for invoking getServiceGateways.
 */

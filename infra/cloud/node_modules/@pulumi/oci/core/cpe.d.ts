 ...
 * ```
 */
export declare class Cpe extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: CpeState, opts?: pulumi.CustomResourceOptions): Cpe;
    /**
     * Returns true if the given object is an instance of Cpe.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is Cpe;
    /**
     ...
     */
    readonly cpeDeviceShapeId: pulumi.Output<string>;
    /**

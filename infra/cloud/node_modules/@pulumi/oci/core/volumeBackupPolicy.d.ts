 ...
 * ```
 */
export declare class VolumeBackupPolicy extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: VolumeBackupPolicyState, opts?: pulumi.CustomResourceOptions): VolumeBackupPolicy;
    /**
     * Returns true if the given object is an instance of VolumeBackupPolicy.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is VolumeBackupPolicy;
    /**
     ...
     */
    readonly schedules: pulumi.Output<outputs.Core.VolumeBackupPolicySchedule[] | undefined>;
    /**

 ...
 * ```
 */
export declare function getComputeCapacityTopologies(args: GetComputeCapacityTopologiesArgs, opts?: pulumi.InvokeOptions): Promise<GetComputeCapacityTopologiesResult>;
/**
 ...
 * ```
 */
export declare function getComputeCapacityTopologiesOutput(args: GetComputeCapacityTopologiesOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetComputeCapacityTopologiesResult>;
/**
 * A collection of arguments for invoking getComputeCapacityTopologies.
 */

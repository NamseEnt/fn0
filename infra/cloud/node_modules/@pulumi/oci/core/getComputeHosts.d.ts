 ...
 * ```
 */
export declare function getComputeHosts(args: GetComputeHostsArgs, opts?: pulumi.InvokeOptions): Promise<GetComputeHostsResult>;
/**
 ...
 * ```
 */
export declare function getComputeHostsOutput(args: GetComputeHostsOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetComputeHostsResult>;
/**
 * A collection of arguments for invoking getComputeHosts.
 */

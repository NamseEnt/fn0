 ...
 * ```
 */
export declare class VolumeBackup extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: VolumeBackupState, opts?: pulumi.CustomResourceOptions): VolumeBackup;
    /**
     * Returns true if the given object is an instance of VolumeBackup.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is VolumeBackup;
    /**
     ...
     */
    readonly sourceDetails: pulumi.Output<outputs.Core.VolumeBackupSourceDetails | undefined>;
    /**
     ...
     */
    readonly sourceVolumeBackupId: pulumi.Output<string>;
    /**

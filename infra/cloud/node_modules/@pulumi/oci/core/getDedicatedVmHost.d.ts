 ...
 * ```
 */
export declare function getDedicatedVmHost(args: GetDedicatedVmHostArgs, opts?: pulumi.InvokeOptions): Promise<GetDedicatedVmHostResult>;
/**
 ...
 * ```
 */
export declare function getDedicatedVmHostOutput(args: GetDedicatedVmHostOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetDedicatedVmHostResult>;
/**
 * A collection of arguments for invoking getDedicatedVmHost.
 */

...
exports.IpsecConnectionTunnelManagement = void 0;
 ...
 * ```
 */
class IpsecConnectionTunnelManagement extends pulumi.CustomResource {
    /**
    ...
    static get(name, id, state, opts) {
        return new IpsecConnectionTunnelManagement(name, state, { ...opts, id: id });
    }
    /**
...
exports.IpsecConnectionTunnelManagement = IpsecConnectionTunnelManagement;
/** @internal */
IpsecConnectionTunnelManagement.__pulumiType = 'oci:Core/ipsecConnectionTunnelManagement:IpsecConnectionTunnelManagement';
//# sourceMappingURL=ipsecConnectionTunnelManagement.js.map
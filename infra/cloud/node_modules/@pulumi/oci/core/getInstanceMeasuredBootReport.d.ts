 ...
 * ```
 */
export declare function getInstanceMeasuredBootReport(args: GetInstanceMeasuredBootReportArgs, opts?: pulumi.InvokeOptions): Promise<GetInstanceMeasuredBootReportResult>;
/**
 ...
 * ```
 */
export declare function getInstanceMeasuredBootReportOutput(args: GetInstanceMeasuredBootReportOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetInstanceMeasuredBootReportResult>;
/**
 * A collection of arguments for invoking getInstanceMeasuredBootReport.
 */

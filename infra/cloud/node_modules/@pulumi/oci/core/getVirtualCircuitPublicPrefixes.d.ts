 ...
 * ```
 */
export declare function getVirtualCircuitPublicPrefixes(args: GetVirtualCircuitPublicPrefixesArgs, opts?: pulumi.InvokeOptions): Promise<GetVirtualCircuitPublicPrefixesResult>;
/**
 ...
 * ```
 */
export declare function getVirtualCircuitPublicPrefixesOutput(args: GetVirtualCircuitPublicPrefixesOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetVirtualCircuitPublicPrefixesResult>;
/**
 * A collection of arguments for invoking getVirtualCircuitPublicPrefixes.
 */

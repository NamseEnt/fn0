 ...
 * ```
 */
export declare function getInstanceCredentials(args: GetInstanceCredentialsArgs, opts?: pulumi.InvokeOptions): Promise<GetInstanceCredentialsResult>;
/**
 ...
 * ```
 */
export declare function getInstanceCredentialsOutput(args: GetInstanceCredentialsOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetInstanceCredentialsResult>;
/**
 * A collection of arguments for invoking getInstanceCredentials.
 */

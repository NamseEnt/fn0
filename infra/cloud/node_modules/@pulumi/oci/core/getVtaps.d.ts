 ...
 * ```
 */
export declare function getVtaps(args: GetVtapsArgs, opts?: pulumi.InvokeOptions): Promise<GetVtapsResult>;
/**
 ...
 * ```
 */
export declare function getVtapsOutput(args: GetVtapsOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetVtapsResult>;
/**
 * A collection of arguments for invoking getVtaps.
 */

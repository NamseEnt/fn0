 ...
 * ```
 */
export declare class ComputeCapacityReservation extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ComputeCapacityReservationState, opts?: pulumi.CustomResourceOptions): ComputeCapacityReservation;
    /**
     ...
     */
    static isInstance(obj: any): obj is ComputeCapacityReservation;
    /**
     ...
     */
    readonly instanceReservationConfigs: pulumi.Output<outputs.Core.ComputeCapacityReservationInstanceReservationConfig[]>;
    /**
     ...
     */
    readonly isDefaultReservation: pulumi.Output<boolean>;
    /**
     ...
     */
    readonly reservedInstanceCount: pulumi.Output<string>;
    /**
     ...
     */
    readonly usedInstanceCount: pulumi.Output<string>;
    /**

 ...
 * ```
 */
export declare function getDrgRouteDistribution(args: GetDrgRouteDistributionArgs, opts?: pulumi.InvokeOptions): Promise<GetDrgRouteDistributionResult>;
/**
 ...
 * ```
 */
export declare function getDrgRouteDistributionOutput(args: GetDrgRouteDistributionOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetDrgRouteDistributionResult>;
/**
 * A collection of arguments for invoking getDrgRouteDistribution.
 */

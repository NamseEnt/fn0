...
export declare class Image extends pulumi.CustomResource {
     ...
     */
    readonly agentFeatures: pulumi.Output<outputs.Core.ImageAgentFeature[]>;
    /**
     * The OCID of the image originally used to launch the instance.
     */
    readonly baseImageId: pulumi.Output<string>;
    /**
     * The size of the internal storage for this image that is subject to billing (1 GB = 1,073,741,824 bytes).  Example: `100`
     */
    readonly billableSizeInGbs: pulumi.Output<string>;
    /**
     ...
     */
    readonly createImageAllowed: pulumi.Output<boolean>;
    /**
    ...
    readonly imageSourceDetails: pulumi.Output<outputs.Core.ImageImageSourceDetails | undefined>;
    /**
     ...
     */
    readonly launchOptions: pulumi.Output<outputs.Core.ImageLaunchOption[]>;
    /**
     ...
     */
    readonly operatingSystemVersion: pulumi.Output<string>;
    /**

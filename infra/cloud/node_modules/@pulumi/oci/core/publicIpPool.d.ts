 ...
 * ```
 */
export declare class PublicIpPool extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: PublicIpPoolState, opts?: pulumi.CustomResourceOptions): PublicIpPool;
    /**
     * Returns true if the given object is an instance of PublicIpPool.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is PublicIpPool;
    /**

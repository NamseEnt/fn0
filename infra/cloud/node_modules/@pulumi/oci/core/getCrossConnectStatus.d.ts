 ...
 * ```
 */
export declare function getCrossConnectStatus(args: GetCrossConnectStatusArgs, opts?: pulumi.InvokeOptions): Promise<GetCrossConnectStatusResult>;
/**
 ...
 * ```
 */
export declare function getCrossConnectStatusOutput(args: GetCrossConnectStatusOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetCrossConnectStatusResult>;
/**
 * A collection of arguments for invoking getCrossConnectStatus.
 */

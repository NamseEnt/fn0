 ...
 * ```
 */
class BootVolumeBackup extends pulumi.CustomResource {
    /**
    ...
    static get(name, id, state, opts) {
        return new BootVolumeBackup(name, state, { ...opts, id: id });
    }
    /**
...
exports.BootVolumeBackup = BootVolumeBackup;
/** @internal */
BootVolumeBackup.__pulumiType = 'oci:Core/bootVolumeBackup:BootVolumeBackup';
//# sourceMappingURL=bootVolumeBackup.js.map
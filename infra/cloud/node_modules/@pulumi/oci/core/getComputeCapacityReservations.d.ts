 ...
 * ```
 */
export declare function getComputeCapacityReservations(args: GetComputeCapacityReservationsArgs, opts?: pulumi.InvokeOptions): Promise<GetComputeCapacityReservationsResult>;
/**
 ...
 * ```
 */
export declare function getComputeCapacityReservationsOutput(args: GetComputeCapacityReservationsOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetComputeCapacityReservationsResult>;
/**
 * A collection of arguments for invoking getComputeCapacityReservations.
 */

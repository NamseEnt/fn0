 ...
 * ```
 */
export declare class ConsoleHistory extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ConsoleHistoryState, opts?: pulumi.CustomResourceOptions): ConsoleHistory;
    /**
     * Returns true if the given object is an instance of ConsoleHistory.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is ConsoleHistory;
    /**

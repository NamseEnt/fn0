 ...
 * ```
 */
export declare function getBootVolume(args: GetBootVolumeArgs, opts?: pulumi.InvokeOptions): Promise<GetBootVolumeResult>;
/**
 ...
 * ```
 */
export declare function getBootVolumeOutput(args: GetBootVolumeOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetBootVolumeResult>;
/**
 * A collection of arguments for invoking getBootVolume.
 */

 ...
 * ```
 */
class CaptureFilter extends pulumi.CustomResource {
    /**
    ...
    static get(name, id, state, opts) {
        return new CaptureFilter(name, state, { ...opts, id: id });
    }
    /**
...
exports.CaptureFilter = CaptureFilter;
/** @internal */
CaptureFilter.__pulumiType = 'oci:Core/captureFilter:CaptureFilter';
//# sourceMappingURL=captureFilter.js.map
 ...
 * ```
 */
export declare function getBootVolumeBackup(args: GetBootVolumeBackupArgs, opts?: pulumi.InvokeOptions): Promise<GetBootVolumeBackupResult>;
/**
 ...
 * ```
 */
export declare function getBootVolumeBackupOutput(args: GetBootVolumeBackupOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetBootVolumeBackupResult>;
/**
 * A collection of arguments for invoking getBootVolumeBackup.
 */

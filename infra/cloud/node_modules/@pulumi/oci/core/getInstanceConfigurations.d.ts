 ...
 * ```
 */
export declare function getInstanceConfigurations(args: GetInstanceConfigurationsArgs, opts?: pulumi.InvokeOptions): Promise<GetInstanceConfigurationsResult>;
/**
 ...
 * ```
 */
export declare function getInstanceConfigurationsOutput(args: GetInstanceConfigurationsOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetInstanceConfigurationsResult>;
/**
 * A collection of arguments for invoking getInstanceConfigurations.
 */

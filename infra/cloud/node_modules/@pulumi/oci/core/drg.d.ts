 ...
 * ```
 */
export declare class Drg extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: DrgState, opts?: pulumi.CustomResourceOptions): Drg;
    /**
     * Returns true if the given object is an instance of Drg.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is Drg;
    /**
     ...
     */
    readonly defaultDrgRouteTables: pulumi.Output<outputs.Core.DrgDefaultDrgRouteTable[]>;
    /**
     ...
     */
    readonly defaultExportDrgRouteDistributionId: pulumi.Output<string>;
    /**
     ...
     */
    readonly redundancyStatus: pulumi.Output<string>;
    /**

 ...
 * ```
 */
export declare function getComputeCapacityReservation(args: GetComputeCapacityReservationArgs, opts?: pulumi.InvokeOptions): Promise<GetComputeCapacityReservationResult>;
/**
 ...
 * ```
 */
export declare function getComputeCapacityReservationOutput(args: GetComputeCapacityReservationOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetComputeCapacityReservationResult>;
/**
 * A collection of arguments for invoking getComputeCapacityReservation.
 */

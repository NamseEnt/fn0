...
export declare class Volume extends pulumi.CustomResource {
     ...
     */
    readonly autotunePolicies: pulumi.Output<outputs.Core.VolumeAutotunePolicy[]>;
    /**
     ...
     */
    readonly blockVolumeReplicas: pulumi.Output<outputs.Core.VolumeBlockVolumeReplica[]>;
    readonly blockVolumeReplicasDeletion: pulumi.Output<boolean | undefined>;
    /**
     ...
     */
    readonly isReservationsEnabled: pulumi.Output<boolean>;
    /**
     ...
     */
    readonly volumeBackupId: pulumi.Output<string>;
    /**

 ...
 * ```
 */
export declare class DrgRouteDistributionStatement extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: DrgRouteDistributionStatementState, opts?: pulumi.CustomResourceOptions): DrgRouteDistributionStatement;
    /**
     ...
     */
    static isInstance(obj: any): obj is DrgRouteDistributionStatement;
    /**
     ...
     */
    readonly drgRouteDistributionId: pulumi.Output<string>;
    /**
     ...
     */
    readonly matchCriteria: pulumi.Output<outputs.Core.DrgRouteDistributionStatementMatchCriteria>;
    /**

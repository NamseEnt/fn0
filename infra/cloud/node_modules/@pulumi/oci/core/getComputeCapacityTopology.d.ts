 ...
 * ```
 */
export declare function getComputeCapacityTopology(args: GetComputeCapacityTopologyArgs, opts?: pulumi.InvokeOptions): Promise<GetComputeCapacityTopologyResult>;
/**
 ...
 * ```
 */
export declare function getComputeCapacityTopologyOutput(args: GetComputeCapacityTopologyOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetComputeCapacityTopologyResult>;
/**
 * A collection of arguments for invoking getComputeCapacityTopology.
 */

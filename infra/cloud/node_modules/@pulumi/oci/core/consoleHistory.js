 ...
 * ```
 */
class ConsoleHistory extends pulumi.CustomResource {
    /**
    ...
    static get(name, id, state, opts) {
        return new ConsoleHistory(name, state, { ...opts, id: id });
    }
    /**
...
/** @internal */
ConsoleHistory.__pulumiType = 'oci:Core/consoleHistory:ConsoleHistory';
//# sourceMappingURL=consoleHistory.js.map
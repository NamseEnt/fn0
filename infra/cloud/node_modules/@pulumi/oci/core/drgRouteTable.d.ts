 ...
 * ```
 */
export declare class DrgRouteTable extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: DrgRouteTableState, opts?: pulumi.CustomResourceOptions): DrgRouteTable;
    /**
     * Returns true if the given object is an instance of DrgRouteTable.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is DrgRouteTable;
    /**

 ...
 * ```
 */
export declare class DrgRouteTableRouteRule extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: DrgRouteTableRouteRuleState, opts?: pulumi.CustomResourceOptions): DrgRouteTableRouteRule;
    /**
     * Returns true if the given object is an instance of DrgRouteTableRouteRule.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is DrgRouteTableRouteRule;
    /**
     ...
     */
    readonly isBlackhole: pulumi.Output<boolean>;
    /**
     * Indicates that the route was not imported due to a conflict between route rules.
     */
    readonly isConflict: pulumi.Output<boolean>;
    /**
     ...
     */
    readonly nextHopDrgAttachmentId: pulumi.Output<string>;
    /**
     ...
     */
    readonly routeProvenance: pulumi.Output<string>;
    /**

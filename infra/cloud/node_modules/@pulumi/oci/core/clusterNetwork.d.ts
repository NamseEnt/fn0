 ...
 * ```
 */
export declare class ClusterNetwork extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ClusterNetworkState, opts?: pulumi.CustomResourceOptions): ClusterNetwork;
    /**
     * Returns true if the given object is an instance of ClusterNetwork.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is ClusterNetwork;
    /**
     ...
     */
    readonly clusterConfiguration: pulumi.Output<outputs.Core.ClusterNetworkClusterConfiguration>;
    /**
     ...
     */
    readonly placementConfiguration: pulumi.Output<outputs.Core.ClusterNetworkPlacementConfiguration>;
    /**

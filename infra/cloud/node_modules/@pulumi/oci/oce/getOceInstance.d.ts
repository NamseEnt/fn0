 ...
 * ```
 */
export declare function getOceInstance(args: GetOceInstanceArgs, opts?: pulumi.InvokeOptions): Promise<GetOceInstanceResult>;
/**
 ...
 * ```
 */
export declare function getOceInstanceOutput(args: GetOceInstanceOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetOceInstanceResult>;
/**
 * A collection of arguments for invoking getOceInstance.
 */

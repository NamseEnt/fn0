 ...
 * ```
 */
export declare class AgentDependency extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: AgentDependencyState, opts?: pulumi.CustomResourceOptions): AgentDependency;
    /**
     * Returns true if the given object is an instance of AgentDependency.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is AgentDependency;
    /**
     ...
     */
    readonly dependencyName: pulumi.Output<string>;
    /**
     * (Updatable) Version of the Agent dependency.
     */
    readonly dependencyVersion: pulumi.Output<string>;
    /**

 ...
 * ```
 */
export declare function getApplianceImages(args: GetApplianceImagesArgs, opts?: pulumi.InvokeOptions): Promise<GetApplianceImagesResult>;
/**
 ...
 * ```
 */
export declare function getApplianceImagesOutput(args: GetApplianceImagesOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetApplianceImagesResult>;
/**
 * A collection of arguments for invoking getApplianceImages.
 */

 ...
 * ```
 */
export declare function getAgents(args: GetAgentsArgs, opts?: pulumi.InvokeOptions): Promise<GetAgentsResult>;
/**
 ...
 * ```
 */
export declare function getAgentsOutput(args: GetAgentsOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetAgentsResult>;
/**
 * A collection of arguments for invoking getAgents.
 */

 ...
 * ```
 */
export declare function getAssetSource(args: GetAssetSourceArgs, opts?: pulumi.InvokeOptions): Promise<GetAssetSourceResult>;
/**
 ...
 * ```
 */
export declare function getAssetSourceOutput(args: GetAssetSourceOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetAssetSourceResult>;
/**
 * A collection of arguments for invoking getAssetSource.
 */

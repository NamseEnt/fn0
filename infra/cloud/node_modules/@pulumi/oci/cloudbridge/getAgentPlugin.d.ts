 ...
 * ```
 */
export declare function getAgentPlugin(args: GetAgentPluginArgs, opts?: pulumi.InvokeOptions): Promise<GetAgentPluginResult>;
/**
 ...
 * ```
 */
export declare function getAgentPluginOutput(args: GetAgentPluginOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetAgentPluginResult>;
/**
 * A collection of arguments for invoking getAgentPlugin.
 */

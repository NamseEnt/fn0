 ...
 * ```
 */
export declare function getApplianceImage(args: GetApplianceImageArgs, opts?: pulumi.InvokeOptions): Promise<GetApplianceImageResult>;
/**
 ...
 * ```
 */
export declare function getApplianceImageOutput(args: GetApplianceImageOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetApplianceImageResult>;
/**
 * A collection of arguments for invoking getApplianceImage.
 */

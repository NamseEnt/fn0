 ...
 * ```
 */
export declare function getIotIotDomainGroups(args: GetIotIotDomainGroupsArgs, opts?: pulumi.InvokeOptions): Promise<GetIotIotDomainGroupsResult>;
/**
 ...
 * ```
 */
export declare function getIotIotDomainGroupsOutput(args: GetIotIotDomainGroupsOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetIotIotDomainGroupsResult>;
/**
 * A collection of arguments for invoking getIotIotDomainGroups.
 */

 ...
 * ```
 */
export declare function getIotDigitalTwinModels(args: GetIotDigitalTwinModelsArgs, opts?: pulumi.InvokeOptions): Promise<GetIotDigitalTwinModelsResult>;
/**
 ...
 * ```
 */
export declare function getIotDigitalTwinModelsOutput(args: GetIotDigitalTwinModelsOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetIotDigitalTwinModelsResult>;
/**
 * A collection of arguments for invoking getIotDigitalTwinModels.
 */

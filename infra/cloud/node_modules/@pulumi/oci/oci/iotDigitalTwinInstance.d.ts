 ...
 * ```
 */
export declare class IotDigitalTwinInstance extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: IotDigitalTwinInstanceState, opts?: pulumi.CustomResourceOptions): IotDigitalTwinInstance;
    /**
     * Returns true if the given object is an instance of IotDigitalTwinInstance.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is IotDigitalTwinInstance;
    /**
     ...
     */
    readonly authId: pulumi.Output<string>;
    /**
     ...
     */
    readonly digitalTwinAdapterId: pulumi.Output<string>;
    /**

 ...
 * ```
 */
export declare function getDbmulticloudOracleDbGcpKey(args: GetDbmulticloudOracleDbGcpKeyArgs, opts?: pulumi.InvokeOptions): Promise<GetDbmulticloudOracleDbGcpKeyResult>;
/**
 ...
 * ```
 */
export declare function getDbmulticloudOracleDbGcpKeyOutput(args: GetDbmulticloudOracleDbGcpKeyOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetDbmulticloudOracleDbGcpKeyResult>;
/**
 * A collection of arguments for invoking getDbmulticloudOracleDbGcpKey.
 */

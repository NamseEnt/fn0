 ...
 * ```
 */
export declare function getWlmsWlsDomain(args: GetWlmsWlsDomainArgs, opts?: pulumi.InvokeOptions): Promise<GetWlmsWlsDomainResult>;
/**
 ...
 * ```
 */
export declare function getWlmsWlsDomainOutput(args: GetWlmsWlsDomainOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetWlmsWlsDomainResult>;
/**
 * A collection of arguments for invoking getWlmsWlsDomain.
 */

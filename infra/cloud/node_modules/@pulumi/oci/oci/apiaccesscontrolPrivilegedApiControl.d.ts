 ...
 * ```
 */
export declare class ApiaccesscontrolPrivilegedApiControl extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ApiaccesscontrolPrivilegedApiControlState, opts?: pulumi.CustomResourceOptions): ApiaccesscontrolPrivilegedApiControl;
    /**
     ...
     */
    static isInstance(obj: any): obj is ApiaccesscontrolPrivilegedApiControl;
    /**
     ...
     */
    readonly approverGroupIdLists: pulumi.Output<string[]>;
    /**
     ...
     */
    readonly privilegedOperationLists: pulumi.Output<outputs.oci.ApiaccesscontrolPrivilegedApiControlPrivilegedOperationList[]>;
    /**

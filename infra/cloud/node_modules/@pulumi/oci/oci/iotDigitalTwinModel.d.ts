 ...
 * ```
 */
export declare class IotDigitalTwinModel extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: IotDigitalTwinModelState, opts?: pulumi.CustomResourceOptions): IotDigitalTwinModel;
    /**
     * Returns true if the given object is an instance of IotDigitalTwinModel.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is IotDigitalTwinModel;
    /**
     ...
     */
    readonly specUri: pulumi.Output<string>;
    /**

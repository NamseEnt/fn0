 ...
 * ```
 */
export declare function getWlmsWlsDomainAgreementRecords(args: GetWlmsWlsDomainAgreementRecordsArgs, opts?: pulumi.InvokeOptions): Promise<GetWlmsWlsDomainAgreementRecordsResult>;
/**
 ...
 * ```
 */
export declare function getWlmsWlsDomainAgreementRecordsOutput(args: GetWlmsWlsDomainAgreementRecordsOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetWlmsWlsDomainAgreementRecordsResult>;
/**
 * A collection of arguments for invoking getWlmsWlsDomainAgreementRecords.
 */

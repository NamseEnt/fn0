 ...
 * ```
 */
export declare class DbmulticloudOracleDbAzureVaultAssociation extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: DbmulticloudOracleDbAzureVaultAssociationState, opts?: pulumi.CustomResourceOptions): DbmulticloudOracleDbAzureVaultAssociation;
    /**

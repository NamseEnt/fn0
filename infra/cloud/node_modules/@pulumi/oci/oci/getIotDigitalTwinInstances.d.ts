 ...
 * ```
 */
export declare function getIotDigitalTwinInstances(args: GetIotDigitalTwinInstancesArgs, opts?: pulumi.InvokeOptions): Promise<GetIotDigitalTwinInstancesResult>;
/**
 ...
 * ```
 */
export declare function getIotDigitalTwinInstancesOutput(args: GetIotDigitalTwinInstancesOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetIotDigitalTwinInstancesResult>;
/**
 * A collection of arguments for invoking getIotDigitalTwinInstances.
 */

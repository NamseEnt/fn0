 ...
 * ```
 */
export declare function getIotDigitalTwinAdapters(args: GetIotDigitalTwinAdaptersArgs, opts?: pulumi.InvokeOptions): Promise<GetIotDigitalTwinAdaptersResult>;
/**
 ...
 * ```
 */
export declare function getIotDigitalTwinAdaptersOutput(args: GetIotDigitalTwinAdaptersOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetIotDigitalTwinAdaptersResult>;
/**
 * A collection of arguments for invoking getIotDigitalTwinAdapters.
 */

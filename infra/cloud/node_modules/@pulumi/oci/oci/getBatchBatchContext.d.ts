 ...
 * ```
 */
export declare function getBatchBatchContext(args: GetBatchBatchContextArgs, opts?: pulumi.InvokeOptions): Promise<GetBatchBatchContextResult>;
/**
 ...
 * ```
 */
export declare function getBatchBatchContextOutput(args: GetBatchBatchContextOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetBatchBatchContextResult>;
/**
 * A collection of arguments for invoking getBatchBatchContext.
 */

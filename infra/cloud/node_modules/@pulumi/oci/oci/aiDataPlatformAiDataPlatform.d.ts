 ...
 * ```
 */
export declare class AiDataPlatformAiDataPlatform extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: AiDataPlatformAiDataPlatformState, opts?: pulumi.CustomResourceOptions): AiDataPlatformAiDataPlatform;
    /**
     ...
     */
    static isInstance(obj: any): obj is AiDataPlatformAiDataPlatform;
    /**
     * (Updatable) The AiDataPlatform type.
     */
    readonly aiDataPlatformType: pulumi.Output<string>;
    /**
     * The alias Id of the AiDataPlatform which is the short form of OCID.
     */
    readonly aliasKey: pulumi.Output<string>;
    /**
     ...
     */
    readonly defaultWorkspaceName: pulumi.Output<string>;
    /**
     ...
     */
    readonly webSocketEndpoint: pulumi.Output<string>;
    /**

 ...
 * ```
 */
export declare function getDbmulticloudOracleDbAzureBlobMounts(args: GetDbmulticloudOracleDbAzureBlobMountsArgs, opts?: pulumi.InvokeOptions): Promise<GetDbmulticloudOracleDbAzureBlobMountsResult>;
/**
 ...
 * ```
 */
export declare function getDbmulticloudOracleDbAzureBlobMountsOutput(args: GetDbmulticloudOracleDbAzureBlobMountsOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetDbmulticloudOracleDbAzureBlobMountsResult>;
/**
 * A collection of arguments for invoking getDbmulticloudOracleDbAzureBlobMounts.
 */

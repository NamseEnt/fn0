 ...
 * ```
 */
export declare class IotIotDomainGroup extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: IotIotDomainGroupState, opts?: pulumi.CustomResourceOptions): IotIotDomainGroup;
    /**
     * Returns true if the given object is an instance of IotIotDomainGroup.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is IotIotDomainGroup;
    /**
     ...
     */
    readonly dataHost: pulumi.Output<string>;
    /**
     ...
     */
    readonly dbTokenScope: pulumi.Output<string>;
    /**

 ...
 * ```
 */
export declare function getIotIotDomains(args: GetIotIotDomainsArgs, opts?: pulumi.InvokeOptions): Promise<GetIotIotDomainsResult>;
/**
 ...
 * ```
 */
export declare function getIotIotDomainsOutput(args: GetIotIotDomainsOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetIotIotDomainsResult>;
/**
 * A collection of arguments for invoking getIotIotDomains.
 */

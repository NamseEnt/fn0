 ...
 * ```
 */
export declare function getWlmsManagedInstanceServer(args: GetWlmsManagedInstanceServerArgs, opts?: pulumi.InvokeOptions): Promise<GetWlmsManagedInstanceServerResult>;
/**
 ...
 * ```
 */
export declare function getWlmsManagedInstanceServerOutput(args: GetWlmsManagedInstanceServerOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetWlmsManagedInstanceServerResult>;
/**
 * A collection of arguments for invoking getWlmsManagedInstanceServer.
 */

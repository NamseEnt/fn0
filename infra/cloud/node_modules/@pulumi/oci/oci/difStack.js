 ...
 * ```
 */
class DifStack extends pulumi.CustomResource {
    /**
    ...
    static get(name, id, state, opts) {
        return new DifStack(name, state, { ...opts, id: id });
    }
    /**
...
exports.DifStack = DifStack;
/** @internal */
DifStack.__pulumiType = 'oci:oci/difStack:DifStack';
//# sourceMappingURL=difStack.js.map
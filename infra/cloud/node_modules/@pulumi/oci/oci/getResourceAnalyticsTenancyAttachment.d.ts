 ...
 * ```
 */
export declare function getResourceAnalyticsTenancyAttachment(args: GetResourceAnalyticsTenancyAttachmentArgs, opts?: pulumi.InvokeOptions): Promise<GetResourceAnalyticsTenancyAttachmentResult>;
/**
 ...
 * ```
 */
export declare function getResourceAnalyticsTenancyAttachmentOutput(args: GetResourceAnalyticsTenancyAttachmentOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetResourceAnalyticsTenancyAttachmentResult>;
/**
 * A collection of arguments for invoking getResourceAnalyticsTenancyAttachment.
 */

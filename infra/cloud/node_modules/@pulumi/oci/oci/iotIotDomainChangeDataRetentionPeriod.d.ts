 ...
 */
export declare class IotIotDomainChangeDataRetentionPeriod extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: IotIotDomainChangeDataRetentionPeriodState, opts?: pulumi.CustomResourceOptions): IotIotDomainChangeDataRetentionPeriod;
    /**
     ...
     */
    static isInstance(obj: any): obj is IotIotDomainChangeDataRetentionPeriod;
    /**
     * The duration (in days) for which data will be retained in the IoT domain.
     */
    readonly dataRetentionPeriodInDays: pulumi.Output<number>;
    /**

 ...
 * ```
 */
export declare function getDbmulticloudOracleDbGcpKeyRing(args: GetDbmulticloudOracleDbGcpKeyRingArgs, opts?: pulumi.InvokeOptions): Promise<GetDbmulticloudOracleDbGcpKeyRingResult>;
/**
 ...
 * ```
 */
export declare function getDbmulticloudOracleDbGcpKeyRingOutput(args: GetDbmulticloudOracleDbGcpKeyRingOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetDbmulticloudOracleDbGcpKeyRingResult>;
/**
 * A collection of arguments for invoking getDbmulticloudOracleDbGcpKeyRing.
 */

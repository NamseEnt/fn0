 ...
 * ```
 */
export declare function getIotDigitalTwinAdapter(args: GetIotDigitalTwinAdapterArgs, opts?: pulumi.InvokeOptions): Promise<GetIotDigitalTwinAdapterResult>;
/**
 ...
 * ```
 */
export declare function getIotDigitalTwinAdapterOutput(args: GetIotDigitalTwinAdapterOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetIotDigitalTwinAdapterResult>;
/**
 * A collection of arguments for invoking getIotDigitalTwinAdapter.
 */

 ...
 * ```
 */
export declare function getSelfSubscription(args: GetSelfSubscriptionArgs, opts?: pulumi.InvokeOptions): Promise<GetSelfSubscriptionResult>;
/**
 ...
 * ```
 */
export declare function getSelfSubscriptionOutput(args: GetSelfSubscriptionOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetSelfSubscriptionResult>;
/**
 * A collection of arguments for invoking getSelfSubscription.
 */

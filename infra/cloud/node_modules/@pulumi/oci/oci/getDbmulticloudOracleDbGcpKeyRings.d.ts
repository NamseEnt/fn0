 ...
 * ```
 */
export declare function getDbmulticloudOracleDbGcpKeyRings(args: GetDbmulticloudOracleDbGcpKeyRingsArgs, opts?: pulumi.InvokeOptions): Promise<GetDbmulticloudOracleDbGcpKeyRingsResult>;
/**
 ...
 * ```
 */
export declare function getDbmulticloudOracleDbGcpKeyRingsOutput(args: GetDbmulticloudOracleDbGcpKeyRingsOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetDbmulticloudOracleDbGcpKeyRingsResult>;
/**
 * A collection of arguments for invoking getDbmulticloudOracleDbGcpKeyRings.
 */

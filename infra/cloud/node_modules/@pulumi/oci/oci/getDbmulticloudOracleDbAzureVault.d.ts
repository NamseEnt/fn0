 ...
 * ```
 */
export declare function getDbmulticloudOracleDbAzureVault(args: GetDbmulticloudOracleDbAzureVaultArgs, opts?: pulumi.InvokeOptions): Promise<GetDbmulticloudOracleDbAzureVaultResult>;
/**
 ...
 * ```
 */
export declare function getDbmulticloudOracleDbAzureVaultOutput(args: GetDbmulticloudOracleDbAzureVaultOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetDbmulticloudOracleDbAzureVaultResult>;
/**
 * A collection of arguments for invoking getDbmulticloudOracleDbAzureVault.
 */

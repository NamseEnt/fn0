 ...
 * ```
 */
export declare function getWlmsWlsDomainApplicablePatches(args: GetWlmsWlsDomainApplicablePatchesArgs, opts?: pulumi.InvokeOptions): Promise<GetWlmsWlsDomainApplicablePatchesResult>;
/**
 ...
 * ```
 */
export declare function getWlmsWlsDomainApplicablePatchesOutput(args: GetWlmsWlsDomainApplicablePatchesOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetWlmsWlsDomainApplicablePatchesResult>;
/**
 * A collection of arguments for invoking getWlmsWlsDomainApplicablePatches.
 */

 ...
 * ```
 */
export declare function getDbmulticloudOracleDbAzureKey(args: GetDbmulticloudOracleDbAzureKeyArgs, opts?: pulumi.InvokeOptions): Promise<GetDbmulticloudOracleDbAzureKeyResult>;
/**
 ...
 * ```
 */
export declare function getDbmulticloudOracleDbAzureKeyOutput(args: GetDbmulticloudOracleDbAzureKeyOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetDbmulticloudOracleDbAzureKeyResult>;
/**
 * A collection of arguments for invoking getDbmulticloudOracleDbAzureKey.
 */

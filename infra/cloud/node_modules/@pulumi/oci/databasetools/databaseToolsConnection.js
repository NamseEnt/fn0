 ...
 * ```
 */
class DatabaseToolsConnection extends pulumi.CustomResource {
    /**
    ...
    static get(name, id, state, opts) {
        return new DatabaseToolsConnection(name, state, { ...opts, id: id });
    }
    /**
...
exports.DatabaseToolsConnection = DatabaseToolsConnection;
/** @internal */
DatabaseToolsConnection.__pulumiType = 'oci:DatabaseTools/databaseToolsConnection:DatabaseToolsConnection';
//# sourceMappingURL=databaseToolsConnection.js.map
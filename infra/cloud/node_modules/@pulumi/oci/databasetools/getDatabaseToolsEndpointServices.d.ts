 ...
 * ```
 */
export declare function getDatabaseToolsEndpointServices(args: GetDatabaseToolsEndpointServicesArgs, opts?: pulumi.InvokeOptions): Promise<GetDatabaseToolsEndpointServicesResult>;
/**
 ...
 * ```
 */
export declare function getDatabaseToolsEndpointServicesOutput(args: GetDatabaseToolsEndpointServicesOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetDatabaseToolsEndpointServicesResult>;
/**
 * A collection of arguments for invoking getDatabaseToolsEndpointServices.
 */

 ...
 * ```
 */
export declare function getDatabaseToolsConnections(args: GetDatabaseToolsConnectionsArgs, opts?: pulumi.InvokeOptions): Promise<GetDatabaseToolsConnectionsResult>;
/**
 ...
 * ```
 */
export declare function getDatabaseToolsConnectionsOutput(args: GetDatabaseToolsConnectionsOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetDatabaseToolsConnectionsResult>;
/**
 * A collection of arguments for invoking getDatabaseToolsConnections.
 */

 ...
 * ```
 */
export declare class DatabaseToolsConnection extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: DatabaseToolsConnectionState, opts?: pulumi.CustomResourceOptions): DatabaseToolsConnection;
    /**
     * Returns true if the given object is an instance of DatabaseToolsConnection.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is DatabaseToolsConnection;
    /**
     * (Updatable) The advanced connection properties key-value pair (e.g., `oracle.net.ssl_server_dn_match`).
     */
    readonly advancedProperties: pulumi.Output<{
        [key: string]: string;
    }>;
    /**
     ...
     */
    readonly keyStores: pulumi.Output<outputs.DatabaseTools.DatabaseToolsConnectionKeyStore[]>;
    /**
     ...
     */
    readonly locks: pulumi.Output<outputs.DatabaseTools.DatabaseToolsConnectionLock[]>;
    /**
     ...
     */
    readonly proxyClient: pulumi.Output<outputs.DatabaseTools.DatabaseToolsConnectionProxyClient>;
    /**
     * (Updatable) The related resource
     */
    readonly relatedResource: pulumi.Output<outputs.DatabaseTools.DatabaseToolsConnectionRelatedResource>;
    /**
     * Specifies the Database Tools Runtime endpoint.
     */
    readonly runtimeEndpoint: pulumi.Output<string>;
    /**
     ...
     */
    readonly runtimeIdentity: pulumi.Output<string>;
    /**
     * Specifies whether this connection is supported by the Database Tools Runtime.
     */
    readonly runtimeSupport: pulumi.Output<string>;
    /**
     ...
     */
    readonly userPassword: pulumi.Output<outputs.DatabaseTools.DatabaseToolsConnectionUserPassword>;
    /**
...
export interface DatabaseToolsConnectionState {
     ...
     * (Updatable) The advanced connection properties key-value pair (e.g., `oracle.net.ssl_server_dn_match`).
     */
    advancedProperties?: pulumi.Input<{

 ...
 * ```
 */
export declare function getDatabaseToolsIdentities(args: GetDatabaseToolsIdentitiesArgs, opts?: pulumi.InvokeOptions): Promise<GetDatabaseToolsIdentitiesResult>;
/**
 ...
 * ```
 */
export declare function getDatabaseToolsIdentitiesOutput(args: GetDatabaseToolsIdentitiesOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetDatabaseToolsIdentitiesResult>;
/**
 * A collection of arguments for invoking getDatabaseToolsIdentities.
 */

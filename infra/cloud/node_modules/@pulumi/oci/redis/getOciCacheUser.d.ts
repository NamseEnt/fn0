 ...
 * ```
 */
export declare function getOciCacheUser(args: GetOciCacheUserArgs, opts?: pulumi.InvokeOptions): Promise<GetOciCacheUserResult>;
/**
 ...
 * ```
 */
export declare function getOciCacheUserOutput(args: GetOciCacheUserOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetOciCacheUserResult>;
/**
 * A collection of arguments for invoking getOciCacheUser.
 */

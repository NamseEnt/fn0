 ...
 */
export declare class RedisClusterAttachOciCacheUser extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: RedisClusterAttachOciCacheUserState, opts?: pulumi.CustomResourceOptions): RedisClusterAttachOciCacheUser;
    /**
     ...
     */
    static isInstance(obj: any): obj is RedisClusterAttachOciCacheUser;
    /**

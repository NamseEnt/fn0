...
export declare class RedisCluster extends pulumi.CustomResource {
     ...
     */
    readonly nodeCollections: pulumi.Output<outputs.Redis.RedisClusterNodeCollection[]>;
    /**
     ...
     */
    readonly nodeMemoryInGbs: pulumi.Output<number>;
    /**

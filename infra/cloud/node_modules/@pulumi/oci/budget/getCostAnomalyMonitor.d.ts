 ...
 * ```
 */
export declare function getCostAnomalyMonitor(args: GetCostAnomalyMonitorArgs, opts?: pulumi.InvokeOptions): Promise<GetCostAnomalyMonitorResult>;
/**
 ...
 * ```
 */
export declare function getCostAnomalyMonitorOutput(args: GetCostAnomalyMonitorOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetCostAnomalyMonitorResult>;
/**
 * A collection of arguments for invoking getCostAnomalyMonitor.
 */

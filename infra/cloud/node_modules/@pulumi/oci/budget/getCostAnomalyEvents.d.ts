 ...
 * ```
 */
export declare function getCostAnomalyEvents(args: GetCostAnomalyEventsArgs, opts?: pulumi.InvokeOptions): Promise<GetCostAnomalyEventsResult>;
/**
 ...
 * ```
 */
export declare function getCostAnomalyEventsOutput(args: GetCostAnomalyEventsOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetCostAnomalyEventsResult>;
/**
 * A collection of arguments for invoking getCostAnomalyEvents.
 */

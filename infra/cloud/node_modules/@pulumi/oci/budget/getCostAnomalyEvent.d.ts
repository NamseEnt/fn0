 ...
 * ```
 */
export declare function getCostAnomalyEvent(args: GetCostAnomalyEventArgs, opts?: pulumi.InvokeOptions): Promise<GetCostAnomalyEventResult>;
/**
 ...
 * ```
 */
export declare function getCostAnomalyEventOutput(args: GetCostAnomalyEventOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetCostAnomalyEventResult>;
/**
 * A collection of arguments for invoking getCostAnomalyEvent.
 */

 ...
 * ```
 */
export declare function getCostAlertSubscription(args: GetCostAlertSubscriptionArgs, opts?: pulumi.InvokeOptions): Promise<GetCostAlertSubscriptionResult>;
/**
 ...
 * ```
 */
export declare function getCostAlertSubscriptionOutput(args: GetCostAlertSubscriptionOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetCostAlertSubscriptionResult>;
/**
 * A collection of arguments for invoking getCostAlertSubscription.
 */

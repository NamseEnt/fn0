 ...
 * ```
 */
class FusionEnvironmentFamily extends pulumi.CustomResource {
    /**
    ...
    static get(name, id, state, opts) {
        return new FusionEnvironmentFamily(name, state, { ...opts, id: id });
    }
    /**
...
exports.FusionEnvironmentFamily = FusionEnvironmentFamily;
/** @internal */
FusionEnvironmentFamily.__pulumiType = 'oci:FusionApps/fusionEnvironmentFamily:FusionEnvironmentFamily';
//# sourceMappingURL=fusionEnvironmentFamily.js.map
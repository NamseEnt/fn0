...
export declare class FusionEnvironment extends pulumi.CustomResource {
     ...
     */
    readonly isIpv6dualStackEnabled: pulumi.Output<boolean>;
    /**
     ...
     * BYOK key info
     */
    readonly kmsKeyInfos: pulumi.Output<outputs.FusionApps.FusionEnvironmentKmsKeyInfo[]>;
    /**
     ...
     */
    readonly lockboxId: pulumi.Output<string>;
    /**

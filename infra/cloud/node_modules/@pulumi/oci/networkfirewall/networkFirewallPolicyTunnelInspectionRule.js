...
exports.NetworkFirewallPolicyTunnelInspectionRule = void 0;
 ...
 * ```
 */
class NetworkFirewallPolicyTunnelInspectionRule extends pulumi.CustomResource {
    /**
    ...
    static get(name, id, state, opts) {
        return new NetworkFirewallPolicyTunnelInspectionRule(name, state, { ...opts, id: id });
    }
    /**
...
exports.NetworkFirewallPolicyTunnelInspectionRule = NetworkFirewallPolicyTunnelInspectionRule;
/** @internal */
NetworkFirewallPolicyTunnelInspectionRule.__pulumiType = 'oci:NetworkFirewall/networkFirewallPolicyTunnelInspectionRule:NetworkFirewallPolicyTunnelInspectionRule';
//# sourceMappingURL=networkFirewallPolicyTunnelInspectionRule.js.map
 ...
 * ```
 */
export declare class NetworkFirewallPolicyDecryptionRule extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: NetworkFirewallPolicyDecryptionRuleState, opts?: pulumi.CustomResourceOptions): NetworkFirewallPolicyDecryptionRule;
    /**
     ...
     */
    static isInstance(obj: any): obj is NetworkFirewallPolicyDecryptionRule;
    /**
     * (Updatable) Action:
     ...
     */
    readonly condition: pulumi.Output<outputs.NetworkFirewall.NetworkFirewallPolicyDecryptionRuleCondition>;
    /**
     * (Updatable) The name of the decryption profile to use.
     */
    readonly decryptionProfile: pulumi.Output<string | undefined>;
    /**
     ...
     */
    readonly position: pulumi.Output<outputs.NetworkFirewall.NetworkFirewallPolicyDecryptionRulePosition>;
    readonly priorityOrder: pulumi.Output<string | undefined>;
    /**

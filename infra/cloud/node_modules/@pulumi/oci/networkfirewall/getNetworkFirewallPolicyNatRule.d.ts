 ...
 * ```
 */
export declare function getNetworkFirewallPolicyNatRule(args: GetNetworkFirewallPolicyNatRuleArgs, opts?: pulumi.InvokeOptions): Promise<GetNetworkFirewallPolicyNatRuleResult>;
/**
 ...
 * ```
 */
export declare function getNetworkFirewallPolicyNatRuleOutput(args: GetNetworkFirewallPolicyNatRuleOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetNetworkFirewallPolicyNatRuleResult>;
/**
 * A collection of arguments for invoking getNetworkFirewallPolicyNatRule.
 */

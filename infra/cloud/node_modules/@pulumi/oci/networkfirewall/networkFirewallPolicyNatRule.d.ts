 ...
 * ```
 */
export declare class NetworkFirewallPolicyNatRule extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: NetworkFirewallPolicyNatRuleState, opts?: pulumi.CustomResourceOptions): NetworkFirewallPolicyNatRule;
    /**
     ...
     */
    static isInstance(obj: any): obj is NetworkFirewallPolicyNatRule;
    /**
     * (Updatable) action:
     ...
     */
    readonly condition: pulumi.Output<outputs.NetworkFirewall.NetworkFirewallPolicyNatRuleCondition>;
    /**
     ...
     */
    readonly position: pulumi.Output<outputs.NetworkFirewall.NetworkFirewallPolicyNatRulePosition>;
    /**

 ...
 * ```
 */
export declare class NetworkFirewallPolicyTunnelInspectionRule extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: NetworkFirewallPolicyTunnelInspectionRuleState, opts?: pulumi.CustomResourceOptions): NetworkFirewallPolicyTunnelInspectionRule;
    /**
     ...
     */
    static isInstance(obj: any): obj is NetworkFirewallPolicyTunnelInspectionRule;
    /**
     ...
     */
    readonly condition: pulumi.Output<outputs.NetworkFirewall.NetworkFirewallPolicyTunnelInspectionRuleCondition>;
    /**
     ...
     */
    readonly position: pulumi.Output<outputs.NetworkFirewall.NetworkFirewallPolicyTunnelInspectionRulePosition>;
    /**
     * The priority order in which this rule should be evaluated
     */
    readonly priorityOrder: pulumi.Output<string>;
    /**
     * (Updatable) Vxlan Inspect profile used in Vxlan Tunnel Inspection Rules.
     */
    readonly profile: pulumi.Output<outputs.NetworkFirewall.NetworkFirewallPolicyTunnelInspectionRuleProfile>;
    /**

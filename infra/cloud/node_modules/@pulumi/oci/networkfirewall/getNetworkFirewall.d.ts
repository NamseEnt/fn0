 ...
 * ```
 */
export declare function getNetworkFirewall(args: GetNetworkFirewallArgs, opts?: pulumi.InvokeOptions): Promise<GetNetworkFirewallResult>;
/**
 ...
 * ```
 */
export declare function getNetworkFirewallOutput(args: GetNetworkFirewallOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetNetworkFirewallResult>;
/**
 * A collection of arguments for invoking getNetworkFirewall.
 */

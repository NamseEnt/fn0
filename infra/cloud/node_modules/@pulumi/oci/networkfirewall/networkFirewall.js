 ...
 * ```
 */
class NetworkFirewall extends pulumi.CustomResource {
    /**
    ...
    static get(name, id, state, opts) {
        return new NetworkFirewall(name, state, { ...opts, id: id });
    }
    /**
...
/** @internal */
NetworkFirewall.__pulumiType = 'oci:NetworkFirewall/networkFirewall:NetworkFirewall';

 ...
 * ```
 */
export declare class VectorsVectorBucketPolicy extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: VectorsVectorBucketPolicyState, opts?: pulumi.CustomResourceOptions): VectorsVectorBucketPolicy;
    /**
     ...
     */
    static isInstance(obj: any): obj is VectorsVectorBucketPolicy;
    /**
     * The policy document.
     */

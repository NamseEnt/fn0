...
exports.BucketAccelerateConfiguration = void 0;
 ...
 * ```
 */
class BucketAccelerateConfiguration extends pulumi.CustomResource {
    /**
    ...
    static get(name, id, state, opts) {
        return new BucketAccelerateConfiguration(name, state, { ...opts, id: id });
    }
    /**
...
exports.BucketAccelerateConfiguration = BucketAccelerateConfiguration;
/** @internal */
BucketAccelerateConfiguration.__pulumiType = 'aws:s3/bucketAccelerateConfiguration:BucketAccelerateConfiguration';
//# sourceMappingURL=bucketAccelerateConfiguration.js.map
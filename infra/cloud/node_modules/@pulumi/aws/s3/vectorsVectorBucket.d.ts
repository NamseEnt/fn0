 ...
 * ```
 */
export declare class VectorsVectorBucket extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: VectorsVectorBucketState, opts?: pulumi.CustomResourceOptions): VectorsVectorBucket;
    /**
     * Returns true if the given object is an instance of VectorsVectorBucket.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is VectorsVectorBucket;
    /**
     ...
     */
    readonly encryptionConfigurations: pulumi.Output<outputs.s3.VectorsVectorBucketEncryptionConfiguration[]>;
    /**

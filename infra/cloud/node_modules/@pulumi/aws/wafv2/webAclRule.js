 ...
 * ```
 */
class WebAclRule extends pulumi.CustomResource {
    /**
    ...
    static get(name, id, state, opts) {
        return new WebAclRule(name, state, { ...opts, id: id });
    }
    /**
...
exports.WebAclRule = WebAclRule;
/** @internal */
WebAclRule.__pulumiType = 'aws:wafv2/webAclRule:WebAclRule';
//# sourceMappingURL=webAclRule.js.map
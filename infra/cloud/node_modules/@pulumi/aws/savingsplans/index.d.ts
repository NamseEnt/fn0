...
export declare const getOfferings: typeof import("./getOfferings").getOfferings;
export declare const getOfferingsOutput: typeof import("./getOfferings").getOfferingsOutput;

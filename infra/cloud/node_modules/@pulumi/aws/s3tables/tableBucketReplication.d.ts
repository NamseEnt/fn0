 ...
 * ```
 */
export declare class TableBucketReplication extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: TableBucketReplicationState, opts?: pulumi.CustomResourceOptions): TableBucketReplication;
    /**
     * Returns true if the given object is an instance of TableBucketReplication.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is TableBucketReplication;
    /**
     ...
     */
    readonly rule: pulumi.Output<outputs.s3tables.TableBucketReplicationRule | undefined>;
    /**

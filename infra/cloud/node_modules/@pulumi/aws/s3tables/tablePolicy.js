...
class TablePolicy extends pulumi.CustomResource {
    ...
    static get(name, id, state, opts) {
        return new TablePolicy(name, state, { ...opts, id: id });
    }
    /**
...
exports.TablePolicy = TablePolicy;
/** @internal */
TablePolicy.__pulumiType = 'aws:s3tables/tablePolicy:TablePolicy';
//# sourceMappingURL=tablePolicy.js.map
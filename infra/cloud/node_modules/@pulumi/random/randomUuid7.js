...
class RandomUuid7 extends pulumi.CustomResource {
    ...
    static get(name, id, state, opts) {
        return new RandomUuid7(name, state, { ...opts, id: id });
    }
    /**
    ...
    static isInstance(obj) {
        ...
        return obj['__pulumiType'] === RandomUuid7.__pulumiType;
    }
    constructor(name, argsOrState, opts) {
        ...
        super(RandomUuid7.__pulumiType, name, resourceInputs, opts);
    }
}
exports.RandomUuid7 = RandomUuid7;
/** @internal */
RandomUuid7.__pulumiType = 'random:index/randomUuid7:RandomUuid7';
//# sourceMappingURL=randomUuid7.js.map
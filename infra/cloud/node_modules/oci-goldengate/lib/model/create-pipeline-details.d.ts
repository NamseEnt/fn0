...
export declare namespace CreatePipelineDetails {
    function getJsonObj(obj: CreatePipelineDetails): object;
    function getDeserializedJsonObj(obj: CreatePipelineDetails): object;
}

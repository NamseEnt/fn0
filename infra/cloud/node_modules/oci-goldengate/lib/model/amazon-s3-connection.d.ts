...
export declare namespace AmazonS3Connection {
    enum TechnologyType {
        AmazonS3 = "AMAZON_S3",
        /**
    ...
    function getJsonObj(obj: AmazonS3Connection, isParentJsonObj?: boolean): object;
    const connectionType = "AMAZON_S3";
    function getDeserializedJsonObj(obj: AmazonS3Connection, isParentJsonObj?: boolean): object;
}

...
export declare namespace OciObjectStorageConnectionSummary {
    function getJsonObj(obj: OciObjectStorageConnectionSummary, isParentJsonObj?: boolean): object;
    const connectionType = "OCI_OBJECT_STORAGE";
    function getDeserializedJsonObj(obj: OciObjectStorageConnectionSummary, isParentJsonObj?: boolean): object;
}

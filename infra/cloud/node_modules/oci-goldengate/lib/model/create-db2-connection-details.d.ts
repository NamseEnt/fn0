...
export declare namespace CreateDb2ConnectionDetails {
    function getJsonObj(obj: CreateDb2ConnectionDetails, isParentJsonObj?: boolean): object;
    const connectionType = "DB2";
    function getDeserializedJsonObj(obj: CreateDb2ConnectionDetails, isParentJsonObj?: boolean): object;
}

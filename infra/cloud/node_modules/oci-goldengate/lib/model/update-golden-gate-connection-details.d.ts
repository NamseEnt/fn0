...
export declare namespace UpdateGoldenGateConnectionDetails {
    function getJsonObj(obj: UpdateGoldenGateConnectionDetails, isParentJsonObj?: boolean): object;
    const connectionType = "GOLDENGATE";
    function getDeserializedJsonObj(obj: UpdateGoldenGateConnectionDetails, isParentJsonObj?: boolean): object;
}

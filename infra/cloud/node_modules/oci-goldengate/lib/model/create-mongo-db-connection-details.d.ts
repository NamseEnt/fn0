...
export declare namespace CreateMongoDbConnectionDetails {
    function getJsonObj(obj: CreateMongoDbConnectionDetails, isParentJsonObj?: boolean): object;
    const connectionType = "MONGODB";
    function getDeserializedJsonObj(obj: CreateMongoDbConnectionDetails, isParentJsonObj?: boolean): object;
}

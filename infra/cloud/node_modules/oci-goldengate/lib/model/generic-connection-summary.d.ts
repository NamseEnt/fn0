...
export declare namespace GenericConnectionSummary {
    function getJsonObj(obj: GenericConnectionSummary, isParentJsonObj?: boolean): object;
    const connectionType = "GENERIC";
    function getDeserializedJsonObj(obj: GenericConnectionSummary, isParentJsonObj?: boolean): object;
}

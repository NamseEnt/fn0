...
export declare namespace OracleNosqlConnection {
    enum TechnologyType {
    ...
    function getJsonObj(obj: OracleNosqlConnection, isParentJsonObj?: boolean): object;
    const connectionType = "ORACLE_NOSQL";
    function getDeserializedJsonObj(obj: OracleNosqlConnection, isParentJsonObj?: boolean): object;
}

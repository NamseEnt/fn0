...
export declare namespace CreateMicrosoftFabricConnectionDetails {
    function getJsonObj(obj: CreateMicrosoftFabricConnectionDetails, isParentJsonObj?: boolean): object;
    const connectionType = "MICROSOFT_FABRIC";
    function getDeserializedJsonObj(obj: CreateMicrosoftFabricConnectionDetails, isParentJsonObj?: boolean): object;
}

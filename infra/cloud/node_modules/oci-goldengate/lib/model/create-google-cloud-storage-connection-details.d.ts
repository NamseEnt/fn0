 ...
 *
 */
export interface CreateGoogleCloudStorageConnectionDetails extends model.CreateConnectionDetails {
    /**
...
export declare namespace CreateGoogleCloudStorageConnectionDetails {
    function getJsonObj(obj: CreateGoogleCloudStorageConnectionDetails, isParentJsonObj?: boolean): object;
    const connectionType = "GOOGLE_CLOUD_STORAGE";
    function getDeserializedJsonObj(obj: CreateGoogleCloudStorageConnectionDetails, isParentJsonObj?: boolean): object;
}

...
export declare namespace UpdateBackupScheduleDetails {
    enum FrequencyBackupScheduled {
        Daily = "DAILY",
        Weekly = "WEEKLY",
        Monthly = "MONTHLY"
    }
    function getJsonObj(obj: UpdateBackupScheduleDetails): object;
    function getDeserializedJsonObj(obj: UpdateBackupScheduleDetails): object;
}

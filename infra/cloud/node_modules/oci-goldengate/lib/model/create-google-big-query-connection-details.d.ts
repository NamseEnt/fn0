...
export declare namespace CreateGoogleBigQueryConnectionDetails {
    function getJsonObj(obj: CreateGoogleBigQueryConnectionDetails, isParentJsonObj?: boolean): object;
    const connectionType = "GOOGLE_BIGQUERY";
    function getDeserializedJsonObj(obj: CreateGoogleBigQueryConnectionDetails, isParentJsonObj?: boolean): object;
}

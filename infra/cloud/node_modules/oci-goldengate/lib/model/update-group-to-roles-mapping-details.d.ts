...
export declare namespace UpdateGroupToRolesMappingDetails {
    function getJsonObj(obj: UpdateGroupToRolesMappingDetails): object;
    function getDeserializedJsonObj(obj: UpdateGroupToRolesMappingDetails): object;
}

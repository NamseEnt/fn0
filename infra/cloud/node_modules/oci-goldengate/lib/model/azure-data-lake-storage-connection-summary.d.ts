...
export declare namespace AzureDataLakeStorageConnectionSummary {
    function getJsonObj(obj: AzureDataLakeStorageConnectionSummary, isParentJsonObj?: boolean): object;
    const connectionType = "AZURE_DATA_LAKE_STORAGE";
    function getDeserializedJsonObj(obj: AzureDataLakeStorageConnectionSummary, isParentJsonObj?: boolean): object;
}

...
export declare namespace CreateAmazonKinesisConnectionDetails {
    function getJsonObj(obj: CreateAmazonKinesisConnectionDetails, isParentJsonObj?: boolean): object;
    const connectionType = "AMAZON_KINESIS";
    function getDeserializedJsonObj(obj: CreateAmazonKinesisConnectionDetails, isParentJsonObj?: boolean): object;
}

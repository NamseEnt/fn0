...
export declare namespace DeploymentVersionSummary {
    function getJsonObj(obj: DeploymentVersionSummary): object;
    function getDeserializedJsonObj(obj: DeploymentVersionSummary): object;
}

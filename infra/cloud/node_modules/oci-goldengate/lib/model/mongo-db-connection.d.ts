...
export declare namespace MongoDbConnection {
    enum TechnologyType {
        Mongodb = "MONGODB",
    ...
    function getJsonObj(obj: MongoDbConnection, isParentJsonObj?: boolean): object;
    const connectionType = "MONGODB";
    function getDeserializedJsonObj(obj: MongoDbConnection, isParentJsonObj?: boolean): object;
}

...
export declare namespace TrailSequenceCollection {
    function getJsonObj(obj: TrailSequenceCollection): object;
    function getDeserializedJsonObj(obj: TrailSequenceCollection): object;
}

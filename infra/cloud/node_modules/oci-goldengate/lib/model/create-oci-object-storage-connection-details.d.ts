...
export declare namespace CreateOciObjectStorageConnectionDetails {
    function getJsonObj(obj: CreateOciObjectStorageConnectionDetails, isParentJsonObj?: boolean): object;
    const connectionType = "OCI_OBJECT_STORAGE";
    function getDeserializedJsonObj(obj: CreateOciObjectStorageConnectionDetails, isParentJsonObj?: boolean): object;
}

...
export declare namespace DatabaseRegistrationSummary {
    enum SessionMode {
        Direct = "DIRECT",
        Redirect = "REDIRECT",
        /**
    ...
    function getJsonObj(obj: DatabaseRegistrationSummary): object;
    function getDeserializedJsonObj(obj: DatabaseRegistrationSummary): object;
}

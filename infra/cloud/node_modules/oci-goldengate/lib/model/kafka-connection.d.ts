...
export declare namespace KafkaConnection {
    enum TechnologyType {
    ...
    function getJsonObj(obj: KafkaConnection, isParentJsonObj?: boolean): object;
    const connectionType = "KAFKA";
    function getDeserializedJsonObj(obj: KafkaConnection, isParentJsonObj?: boolean): object;
}

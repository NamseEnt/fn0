...
export declare namespace GoogleCloudStorageConnectionSummary {
    function getJsonObj(obj: GoogleCloudStorageConnectionSummary, isParentJsonObj?: boolean): object;
    const connectionType = "GOOGLE_CLOUD_STORAGE";
    function getDeserializedJsonObj(obj: GoogleCloudStorageConnectionSummary, isParentJsonObj?: boolean): object;
}

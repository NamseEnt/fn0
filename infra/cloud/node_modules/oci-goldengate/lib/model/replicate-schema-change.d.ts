...
export declare namespace ReplicateSchemaChange {
    enum CanReplicateSchemaChange {
        Enabled = "ENABLED",
        Disabled = "DISABLED",
        /**
    ...
    function getJsonObj(obj: ReplicateSchemaChange): object;
    function getDeserializedJsonObj(obj: ReplicateSchemaChange): object;
}

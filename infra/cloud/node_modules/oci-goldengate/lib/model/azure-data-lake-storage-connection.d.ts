...
export declare namespace AzureDataLakeStorageConnection {
    enum TechnologyType {
    ...
    function getJsonObj(obj: AzureDataLakeStorageConnection, isParentJsonObj?: boolean): object;
    const connectionType = "AZURE_DATA_LAKE_STORAGE";
    function getDeserializedJsonObj(obj: AzureDataLakeStorageConnection, isParentJsonObj?: boolean): object;
}

...
export declare namespace Db2Connection {
    enum TechnologyType {
        Db2I = "DB2_I",
        Db2Zos = "DB2_ZOS",
        /**
    ...
    function getJsonObj(obj: Db2Connection, isParentJsonObj?: boolean): object;
    const connectionType = "DB2";
    function getDeserializedJsonObj(obj: Db2Connection, isParentJsonObj?: boolean): object;
}

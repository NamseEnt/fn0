 ...
 *
 */
export interface MicrosoftSqlserverConnectionSummary extends model.ConnectionSummary {
    /**
...
export declare namespace MicrosoftSqlserverConnectionSummary {
    function getJsonObj(obj: MicrosoftSqlserverConnectionSummary, isParentJsonObj?: boolean): object;
    const connectionType = "MICROSOFT_SQLSERVER";
    function getDeserializedJsonObj(obj: MicrosoftSqlserverConnectionSummary, isParentJsonObj?: boolean): object;
}

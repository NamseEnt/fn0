 ...
 *
 */
export interface UpdateOracleAiDataPlatformConnectionDetails extends model.UpdateConnectionDetails {
    /**
     * Connection URL.
...
export declare namespace UpdateOracleAiDataPlatformConnectionDetails {
    function getJsonObj(obj: UpdateOracleAiDataPlatformConnectionDetails, isParentJsonObj?: boolean): object;
    const connectionType = "ORACLE_AI_DATA_PLATFORM";
    function getDeserializedJsonObj(obj: UpdateOracleAiDataPlatformConnectionDetails, isParentJsonObj?: boolean): object;
}

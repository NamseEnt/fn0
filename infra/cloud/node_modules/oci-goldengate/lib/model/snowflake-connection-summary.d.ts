...
export declare namespace SnowflakeConnectionSummary {
    function getJsonObj(obj: SnowflakeConnectionSummary, isParentJsonObj?: boolean): object;
    const connectionType = "SNOWFLAKE";
    function getDeserializedJsonObj(obj: SnowflakeConnectionSummary, isParentJsonObj?: boolean): object;
}

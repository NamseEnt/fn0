...
export declare namespace GroupToRolesMappingDetails {
    function getJsonObj(obj: GroupToRolesMappingDetails): object;
    function getDeserializedJsonObj(obj: GroupToRolesMappingDetails): object;
}

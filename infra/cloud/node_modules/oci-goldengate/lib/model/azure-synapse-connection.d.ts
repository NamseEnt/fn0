...
export declare namespace AzureSynapseConnection {
    enum TechnologyType {
    ...
    function getJsonObj(obj: AzureSynapseConnection, isParentJsonObj?: boolean): object;
    const connectionType = "AZURE_SYNAPSE_ANALYTICS";
    function getDeserializedJsonObj(obj: AzureSynapseConnection, isParentJsonObj?: boolean): object;
}

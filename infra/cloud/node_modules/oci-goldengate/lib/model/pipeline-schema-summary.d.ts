...
export declare namespace PipelineSchemaSummary {
    function getJsonObj(obj: PipelineSchemaSummary): object;
    function getDeserializedJsonObj(obj: PipelineSchemaSummary): object;
}

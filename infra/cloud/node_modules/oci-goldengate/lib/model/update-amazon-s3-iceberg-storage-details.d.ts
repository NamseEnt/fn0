...
export declare namespace UpdateAmazonS3IcebergStorageDetails {
    function getJsonObj(obj: UpdateAmazonS3IcebergStorageDetails, isParentJsonObj?: boolean): object;
    const storageType = "AMAZON_S3";
    function getDeserializedJsonObj(obj: UpdateAmazonS3IcebergStorageDetails, isParentJsonObj?: boolean): object;
}

...
export declare namespace OciObjectStorageConnection {
    enum TechnologyType {
    ...
    function getJsonObj(obj: OciObjectStorageConnection, isParentJsonObj?: boolean): object;
    const connectionType = "OCI_OBJECT_STORAGE";
    function getDeserializedJsonObj(obj: OciObjectStorageConnection, isParentJsonObj?: boolean): object;
}

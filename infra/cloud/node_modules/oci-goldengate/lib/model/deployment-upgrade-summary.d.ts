...
export declare namespace DeploymentUpgradeSummary {
    function getJsonObj(obj: DeploymentUpgradeSummary): object;
    function getDeserializedJsonObj(obj: DeploymentUpgradeSummary): object;
}

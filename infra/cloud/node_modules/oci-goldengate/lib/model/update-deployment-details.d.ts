...
export declare namespace UpdateDeploymentDetails {
    function getJsonObj(obj: UpdateDeploymentDetails): object;
    function getDeserializedJsonObj(obj: UpdateDeploymentDetails): object;
}

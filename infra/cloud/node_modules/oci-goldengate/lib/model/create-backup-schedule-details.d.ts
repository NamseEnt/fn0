...
export declare namespace CreateBackupScheduleDetails {
    enum FrequencyBackupScheduled {
        Daily = "DAILY",
        Weekly = "WEEKLY",
        Monthly = "MONTHLY"
    }
    function getJsonObj(obj: CreateBackupScheduleDetails): object;
    function getDeserializedJsonObj(obj: CreateBackupScheduleDetails): object;
}

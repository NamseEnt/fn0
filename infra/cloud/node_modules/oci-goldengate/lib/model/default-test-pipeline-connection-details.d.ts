...
export declare namespace DefaultTestPipelineConnectionDetails {
    function getJsonObj(obj: DefaultTestPipelineConnectionDetails, isParentJsonObj?: boolean): object;
    const type = "DEFAULT";
    function getDeserializedJsonObj(obj: DefaultTestPipelineConnectionDetails, isParentJsonObj?: boolean): object;
}

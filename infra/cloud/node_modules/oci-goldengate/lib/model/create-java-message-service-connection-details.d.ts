...
export declare namespace CreateJavaMessageServiceConnectionDetails {
    function getJsonObj(obj: CreateJavaMessageServiceConnectionDetails, isParentJsonObj?: boolean): object;
    const connectionType = "JAVA_MESSAGE_SERVICE";
    function getDeserializedJsonObj(obj: CreateJavaMessageServiceConnectionDetails, isParentJsonObj?: boolean): object;
}

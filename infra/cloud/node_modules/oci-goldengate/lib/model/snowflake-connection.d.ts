...
export declare namespace SnowflakeConnection {
    enum TechnologyType {
        Snowflake = "SNOWFLAKE",
        /**
    ...
    function getJsonObj(obj: SnowflakeConnection, isParentJsonObj?: boolean): object;
    const connectionType = "SNOWFLAKE";
    function getDeserializedJsonObj(obj: SnowflakeConnection, isParentJsonObj?: boolean): object;
}

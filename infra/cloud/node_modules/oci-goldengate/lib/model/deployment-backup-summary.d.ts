...
export declare namespace DeploymentBackupSummary {
    ...
    function getJsonObj(obj: DeploymentBackupSummary): object;
    function getDeserializedJsonObj(obj: DeploymentBackupSummary): object;
}

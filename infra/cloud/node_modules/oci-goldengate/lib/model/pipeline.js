...
(function (Pipeline) {
    ...
    })(LifecycleState = Pipeline.LifecycleState || (Pipeline.LifecycleState = {}));
    function getJsonObj(obj) {
        ...
        if (obj && "recipeType" in obj && obj.recipeType) {
            switch (obj.recipeType) {
                case "ZERO_ETL":
                    return model.ZeroEtlPipeline.getJsonObj(jsonObj, true);
                default:
    ...
    Pipeline.getJsonObj = getJsonObj;
    function getDeserializedJsonObj(obj) {
        ...
        if (obj && "recipeType" in obj && obj.recipeType) {
            switch (obj.recipeType) {
                case "ZERO_ETL":
                    return model.ZeroEtlPipeline.getDeserializedJsonObj(jsonObj, true);
                default:
                    if (common.LOG.logger)
                        common.LOG.logger.info(`Unknown value for: ${obj.recipeType}`);
            }
    ...
    Pipeline.getDeserializedJsonObj = getDeserializedJsonObj;

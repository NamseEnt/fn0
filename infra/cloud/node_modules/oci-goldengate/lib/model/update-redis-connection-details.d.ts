...
export declare namespace UpdateRedisConnectionDetails {
    function getJsonObj(obj: UpdateRedisConnectionDetails, isParentJsonObj?: boolean): object;
    const connectionType = "REDIS";
    function getDeserializedJsonObj(obj: UpdateRedisConnectionDetails, isParentJsonObj?: boolean): object;
}

 ...
 *
 **/
export declare enum DeploymentCategory {
...
export declare namespace DeploymentCategory {
    function getJsonObj(obj: DeploymentCategory): DeploymentCategory;
    function getDeserializedJsonObj(obj: DeploymentCategory): DeploymentCategory;
}

...
export declare namespace RestIcebergCatalog {
    function getJsonObj(obj: RestIcebergCatalog, isParentJsonObj?: boolean): object;
    const catalogType = "REST";
    function getDeserializedJsonObj(obj: RestIcebergCatalog, isParentJsonObj?: boolean): object;
}

 ...
 *
 */
export interface PolarisIcebergCatalog extends model.IcebergCatalog {
    /**
...
export declare namespace PolarisIcebergCatalog {
    function getJsonObj(obj: PolarisIcebergCatalog, isParentJsonObj?: boolean): object;
    const catalogType = "POLARIS";
    function getDeserializedJsonObj(obj: PolarisIcebergCatalog, isParentJsonObj?: boolean): object;
}

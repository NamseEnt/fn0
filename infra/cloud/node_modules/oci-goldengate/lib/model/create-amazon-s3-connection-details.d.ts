...
export declare namespace CreateAmazonS3ConnectionDetails {
    function getJsonObj(obj: CreateAmazonS3ConnectionDetails, isParentJsonObj?: boolean): object;
    const connectionType = "AMAZON_S3";
    function getDeserializedJsonObj(obj: CreateAmazonS3ConnectionDetails, isParentJsonObj?: boolean): object;
}

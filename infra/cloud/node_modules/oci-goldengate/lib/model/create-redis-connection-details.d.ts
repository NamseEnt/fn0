...
export declare namespace CreateRedisConnectionDetails {
    function getJsonObj(obj: CreateRedisConnectionDetails, isParentJsonObj?: boolean): object;
    const connectionType = "REDIS";
    function getDeserializedJsonObj(obj: CreateRedisConnectionDetails, isParentJsonObj?: boolean): object;
}

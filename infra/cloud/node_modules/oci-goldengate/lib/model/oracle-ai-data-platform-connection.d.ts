 ...
 *
 */
export interface OracleAiDataPlatformConnection extends model.Connection {
    /**
     * The Oracle AI Data Platform technology type.
     */
    "technologyType": OracleAiDataPlatformConnection.TechnologyType;
    /**
     * Connection URL.
...
export declare namespace OracleAiDataPlatformConnection {
    enum TechnologyType {
    ...
    function getJsonObj(obj: OracleAiDataPlatformConnection, isParentJsonObj?: boolean): object;
    const connectionType = "ORACLE_AI_DATA_PLATFORM";
    function getDeserializedJsonObj(obj: OracleAiDataPlatformConnection, isParentJsonObj?: boolean): object;
}

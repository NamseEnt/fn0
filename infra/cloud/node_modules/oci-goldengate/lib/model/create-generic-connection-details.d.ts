...
export declare namespace CreateGenericConnectionDetails {
    function getJsonObj(obj: CreateGenericConnectionDetails, isParentJsonObj?: boolean): object;
    const connectionType = "GENERIC";
    function getDeserializedJsonObj(obj: CreateGenericConnectionDetails, isParentJsonObj?: boolean): object;
}

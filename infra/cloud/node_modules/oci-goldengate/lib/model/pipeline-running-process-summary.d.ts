...
export declare namespace PipelineRunningProcessSummary {
    function getJsonObj(obj: PipelineRunningProcessSummary): object;
    function getDeserializedJsonObj(obj: PipelineRunningProcessSummary): object;
}

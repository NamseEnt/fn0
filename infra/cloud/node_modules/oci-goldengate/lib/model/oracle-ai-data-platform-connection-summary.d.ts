...
export declare namespace OracleAiDataPlatformConnectionSummary {
    function getJsonObj(obj: OracleAiDataPlatformConnectionSummary, isParentJsonObj?: boolean): object;
    const connectionType = "ORACLE_AI_DATA_PLATFORM";
    function getDeserializedJsonObj(obj: OracleAiDataPlatformConnectionSummary, isParentJsonObj?: boolean): object;
}

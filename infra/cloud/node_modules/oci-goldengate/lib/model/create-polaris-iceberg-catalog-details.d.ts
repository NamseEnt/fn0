...
export declare namespace CreatePolarisIcebergCatalogDetails {
    function getJsonObj(obj: CreatePolarisIcebergCatalogDetails, isParentJsonObj?: boolean): object;
    const catalogType = "POLARIS";
    function getDeserializedJsonObj(obj: CreatePolarisIcebergCatalogDetails, isParentJsonObj?: boolean): object;
}

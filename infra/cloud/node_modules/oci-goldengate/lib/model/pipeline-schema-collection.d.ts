...
export declare namespace PipelineSchemaCollection {
    function getJsonObj(obj: PipelineSchemaCollection): object;
    function getDeserializedJsonObj(obj: PipelineSchemaCollection): object;
}

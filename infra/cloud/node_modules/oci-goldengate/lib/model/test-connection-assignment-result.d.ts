...
export declare namespace TestConnectionAssignmentResult {
    enum ResultType {
        Succeeded = "SUCCEEDED",
        Failed = "FAILED",
        TimedOut = "TIMED_OUT",
    ...
    function getJsonObj(obj: TestConnectionAssignmentResult): object;
    function getDeserializedJsonObj(obj: TestConnectionAssignmentResult): object;
}

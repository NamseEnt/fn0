...
export declare namespace UpdateRestIcebergCatalogDetails {
    function getJsonObj(obj: UpdateRestIcebergCatalogDetails, isParentJsonObj?: boolean): object;
    const catalogType = "REST";
    function getDeserializedJsonObj(obj: UpdateRestIcebergCatalogDetails, isParentJsonObj?: boolean): object;
}

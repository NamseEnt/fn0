...
export declare namespace CreateOggDeploymentDetails {
    function getJsonObj(obj: CreateOggDeploymentDetails): object;
    function getDeserializedJsonObj(obj: CreateOggDeploymentDetails): object;
}

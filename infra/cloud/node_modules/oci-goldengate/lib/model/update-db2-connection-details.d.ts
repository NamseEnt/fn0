...
export declare namespace UpdateDb2ConnectionDetails {
    function getJsonObj(obj: UpdateDb2ConnectionDetails, isParentJsonObj?: boolean): object;
    const connectionType = "DB2";
    function getDeserializedJsonObj(obj: UpdateDb2ConnectionDetails, isParentJsonObj?: boolean): object;
}

...
export declare namespace UpdateGooglePubSubConnectionDetails {
    function getJsonObj(obj: UpdateGooglePubSubConnectionDetails, isParentJsonObj?: boolean): object;
    const connectionType = "GOOGLE_PUBSUB";
    function getDeserializedJsonObj(obj: UpdateGooglePubSubConnectionDetails, isParentJsonObj?: boolean): object;
}

 ...
 *
 */
export interface GoogleCloudStorageIcebergStorageSummary extends model.IcebergStorageSummary {
    /**
...
export declare namespace GoogleCloudStorageIcebergStorageSummary {
    function getJsonObj(obj: GoogleCloudStorageIcebergStorageSummary, isParentJsonObj?: boolean): object;
    const storageType = "GOOGLE_CLOUD_STORAGE";
    function getDeserializedJsonObj(obj: GoogleCloudStorageIcebergStorageSummary, isParentJsonObj?: boolean): object;
}

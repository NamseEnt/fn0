...
export declare namespace UpdateOracleNosqlConnectionDetails {
    function getJsonObj(obj: UpdateOracleNosqlConnectionDetails, isParentJsonObj?: boolean): object;
    const connectionType = "ORACLE_NOSQL";
    function getDeserializedJsonObj(obj: UpdateOracleNosqlConnectionDetails, isParentJsonObj?: boolean): object;
}

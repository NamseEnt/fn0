 ...
 *
 */
export interface CreateGoogleCloudStorageIcebergStorageDetails extends model.CreateIcebergStorageDetails {
    /**
...
export declare namespace CreateGoogleCloudStorageIcebergStorageDetails {
    function getJsonObj(obj: CreateGoogleCloudStorageIcebergStorageDetails, isParentJsonObj?: boolean): object;
    const storageType = "GOOGLE_CLOUD_STORAGE";
    function getDeserializedJsonObj(obj: CreateGoogleCloudStorageIcebergStorageDetails, isParentJsonObj?: boolean): object;
}

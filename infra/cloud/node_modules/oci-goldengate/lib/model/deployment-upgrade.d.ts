...
export declare namespace DeploymentUpgrade {
    function getJsonObj(obj: DeploymentUpgrade): object;
    function getDeserializedJsonObj(obj: DeploymentUpgrade): object;
}

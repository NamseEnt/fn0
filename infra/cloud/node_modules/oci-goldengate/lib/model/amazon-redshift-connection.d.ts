...
export declare namespace AmazonRedshiftConnection {
    enum TechnologyType {
    ...
    function getJsonObj(obj: AmazonRedshiftConnection, isParentJsonObj?: boolean): object;
    const connectionType = "AMAZON_REDSHIFT";
    function getDeserializedJsonObj(obj: AmazonRedshiftConnection, isParentJsonObj?: boolean): object;
}

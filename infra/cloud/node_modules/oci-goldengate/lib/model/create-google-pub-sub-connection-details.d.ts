...
export declare namespace CreateGooglePubSubConnectionDetails {
    function getJsonObj(obj: CreateGooglePubSubConnectionDetails, isParentJsonObj?: boolean): object;
    const connectionType = "GOOGLE_PUBSUB";
    function getDeserializedJsonObj(obj: CreateGooglePubSubConnectionDetails, isParentJsonObj?: boolean): object;
}

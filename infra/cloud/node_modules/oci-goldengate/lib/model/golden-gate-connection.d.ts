...
export declare namespace GoldenGateConnection {
    enum TechnologyType {
    ...
    function getJsonObj(obj: GoldenGateConnection, isParentJsonObj?: boolean): object;
    const connectionType = "GOLDENGATE";
    function getDeserializedJsonObj(obj: GoldenGateConnection, isParentJsonObj?: boolean): object;
}

...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/goldengate/DeploymentWalletExists.ts.html |here} to see how to use DeploymentWalletExistsRequest.
 */
export interface DeploymentWalletExistsRequest extends common.BaseRequest {
    /**
     ...
     *
     */
    "deploymentWalletExistsDetails": model.DefaultDeploymentWalletExistsDetails;
    /**

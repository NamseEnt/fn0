...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/goldengate/StopDeployment.ts.html |here} to see how to use StopDeploymentRequest.
 */
export interface StopDeploymentRequest extends common.BaseRequest {
    /**
     ...
     *
     */
    "stopDeploymentDetails": model.DefaultStopDeploymentDetails;
    /**

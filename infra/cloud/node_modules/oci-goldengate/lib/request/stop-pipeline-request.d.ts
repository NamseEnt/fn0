...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/goldengate/StopPipeline.ts.html |here} to see how to use StopPipelineRequest.
 */
export interface StopPipelineRequest extends common.BaseRequest {
    /**
     ...
     *
     */
    "stopPipelineDetails": model.DefaultStopPipelineDetails;
    /**

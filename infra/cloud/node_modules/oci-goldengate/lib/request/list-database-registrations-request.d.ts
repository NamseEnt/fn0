...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/goldengate/ListDatabaseRegistrations.ts.html |here} to see how to use ListDatabaseRegistrationsRequest.
 */
...
export declare namespace ListDatabaseRegistrationsRequest {
    enum SortBy {

...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/goldengate/RollbackDeploymentUpgrade.ts.html |here} to see how to use RollbackDeploymentUpgradeRequest.
 */
export interface RollbackDeploymentUpgradeRequest extends common.BaseRequest {
    /**
     ...
     *
     */
    "rollbackDeploymentUpgradeDetails": model.DefaultRollbackDeploymentUpgradeDetails;
    /**

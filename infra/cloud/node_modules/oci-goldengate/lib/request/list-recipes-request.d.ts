...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/goldengate/ListRecipes.ts.html |here} to see how to use ListRecipesRequest.
 */
export interface ListRecipesRequest extends common.BaseRequest {
    /**

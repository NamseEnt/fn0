...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/goldengate/StartPipeline.ts.html |here} to see how to use StartPipelineRequest.
 */
export interface StartPipelineRequest extends common.BaseRequest {
    /**
     ...
     *
     */
    "startPipelineDetails": model.DefaultStartPipelineDetails;
    /**

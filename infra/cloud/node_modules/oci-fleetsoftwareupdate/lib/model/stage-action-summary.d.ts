 ...
 *
 */
export interface StageActionSummary extends model.FsuActionSummary {
    /**
...
export declare namespace StageActionSummary {
    function getJsonObj(obj: StageActionSummary, isParentJsonObj?: boolean): object;
    const type = "STAGE";
    function getDeserializedJsonObj(obj: StageActionSummary, isParentJsonObj?: boolean): object;
}

...
export declare namespace DatabaseTargetSummary {
    function getJsonObj(obj: DatabaseTargetSummary, isParentJsonObj?: boolean): object;
    const entityType = "DATABASE";
    function getDeserializedJsonObj(obj: DatabaseTargetSummary, isParentJsonObj?: boolean): object;
}

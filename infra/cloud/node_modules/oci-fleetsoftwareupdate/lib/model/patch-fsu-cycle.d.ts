...
export declare namespace PatchFsuCycle {
    function getJsonObj(obj: PatchFsuCycle, isParentJsonObj?: boolean): object;
    const type = "PATCH";
    function getDeserializedJsonObj(obj: PatchFsuCycle, isParentJsonObj?: boolean): object;
}

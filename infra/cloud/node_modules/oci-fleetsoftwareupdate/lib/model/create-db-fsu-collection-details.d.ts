...
export interface CreateDbFsuCollectionDetails extends model.CreateFsuCollectionDetails {
    ...
    "fleetDiscovery"?: model.DbDiscoveryResults | model.DbSearchQueryDiscovery | model.DbTargetListDiscovery | model.DbFiltersDiscovery;
    "type": string;
}
export declare namespace CreateDbFsuCollectionDetails {
    function getJsonObj(obj: CreateDbFsuCollectionDetails, isParentJsonObj?: boolean): object;
    const type = "DB";
    function getDeserializedJsonObj(obj: CreateDbFsuCollectionDetails, isParentJsonObj?: boolean): object;
}

 ...
 *
 */
export interface UpdateStartTimeScheduleDetails extends model.UpdateScheduleDetails {
    /**
...
export declare namespace UpdateStartTimeScheduleDetails {
    function getJsonObj(obj: UpdateStartTimeScheduleDetails, isParentJsonObj?: boolean): object;
    const type = "START_TIME";
    function getDeserializedJsonObj(obj: UpdateStartTimeScheduleDetails, isParentJsonObj?: boolean): object;
}

 ...
 *
 **/
export declare enum DataCollectionModes {
    Enable = "ENABLE",
...
export declare namespace DataCollectionModes {
    function getJsonObj(obj: DataCollectionModes): DataCollectionModes;
    function getDeserializedJsonObj(obj: DataCollectionModes): DataCollectionModes;
}

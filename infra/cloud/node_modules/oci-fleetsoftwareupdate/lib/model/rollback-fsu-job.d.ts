 ...
 *
 */
export interface RollbackFsuJob extends model.FsuJob {
    /**
...
export declare namespace RollbackFsuJob {
    function getJsonObj(obj: RollbackFsuJob, isParentJsonObj?: boolean): object;
    const type = "ROLLBACK_AND_REMOVE_TARGET";
    function getDeserializedJsonObj(obj: RollbackFsuJob, isParentJsonObj?: boolean): object;
}

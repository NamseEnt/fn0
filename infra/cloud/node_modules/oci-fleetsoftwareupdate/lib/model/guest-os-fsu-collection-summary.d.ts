...
export declare namespace GuestOsFsuCollectionSummary {
    function getJsonObj(obj: GuestOsFsuCollectionSummary, isParentJsonObj?: boolean): object;
    const type = "GUEST_OS";
    function getDeserializedJsonObj(obj: GuestOsFsuCollectionSummary, isParentJsonObj?: boolean): object;
}

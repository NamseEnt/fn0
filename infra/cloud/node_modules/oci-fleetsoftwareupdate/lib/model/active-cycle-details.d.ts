...
export declare namespace ActiveCycleDetails {
    function getJsonObj(obj: ActiveCycleDetails): object;
    function getDeserializedJsonObj(obj: ActiveCycleDetails): object;
}

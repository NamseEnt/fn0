...
export declare namespace CleanupAction {
    function getJsonObj(obj: CleanupAction, isParentJsonObj?: boolean): object;
    const type = "CLEANUP";
    function getDeserializedJsonObj(obj: CleanupAction, isParentJsonObj?: boolean): object;
}

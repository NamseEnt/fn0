...
export declare namespace StageFsuJobSummary {
    function getJsonObj(obj: StageFsuJobSummary, isParentJsonObj?: boolean): object;
    const type = "STAGE";
    function getDeserializedJsonObj(obj: StageFsuJobSummary, isParentJsonObj?: boolean): object;
}

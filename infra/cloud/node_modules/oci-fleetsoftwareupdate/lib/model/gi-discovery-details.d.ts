...
export interface GiDiscoveryDetails extends model.DiscoveryDetails {
    ...
    "criteria": model.GiFiltersDiscovery | model.GiSearchQueryDiscovery | model.GiDiscoveryResults | model.GiTargetListDiscovery;
    "type": string;
}
export declare namespace GiDiscoveryDetails {
    function getJsonObj(obj: GiDiscoveryDetails, isParentJsonObj?: boolean): object;
    const type = "GI";
    function getDeserializedJsonObj(obj: GiDiscoveryDetails, isParentJsonObj?: boolean): object;
}

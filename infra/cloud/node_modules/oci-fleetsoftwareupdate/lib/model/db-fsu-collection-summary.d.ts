...
export declare namespace DbFsuCollectionSummary {
    function getJsonObj(obj: DbFsuCollectionSummary, isParentJsonObj?: boolean): object;
    const type = "DB";
    function getDeserializedJsonObj(obj: DbFsuCollectionSummary, isParentJsonObj?: boolean): object;
}

...
export declare namespace CloudVmClusterTargetSummary {
    function getJsonObj(obj: CloudVmClusterTargetSummary, isParentJsonObj?: boolean): object;
    const entityType = "CLOUDVMCLUSTER";
    function getDeserializedJsonObj(obj: CloudVmClusterTargetSummary, isParentJsonObj?: boolean): object;
}

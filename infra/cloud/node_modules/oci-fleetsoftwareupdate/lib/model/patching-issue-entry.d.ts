...
export declare namespace PatchingIssueEntry {
    function getJsonObj(obj: PatchingIssueEntry): object;
    function getDeserializedJsonObj(obj: PatchingIssueEntry): object;
}

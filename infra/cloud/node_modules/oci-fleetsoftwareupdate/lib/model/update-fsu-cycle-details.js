...
exports.UpdateFsuCycleDetails = void 0;
const model = __importStar(require("../model"));
const common = require("oci-common");
var UpdateFsuCycleDetails;
(function (UpdateFsuCycleDetails) {
    function getJsonObj(obj) {
        ...
        if (obj && "type" in obj && obj.type) {
            switch (obj.type) {
                case "PATCH":
                    return model.UpdatePatchFsuCycle.getJsonObj(jsonObj, true);
                case "UPGRADE":
                    return model.UpdateUpgradeFsuCycle.getJsonObj(jsonObj, true);
                default:
    ...
    UpdateFsuCycleDetails.getJsonObj = getJsonObj;
    function getDeserializedJsonObj(obj) {
        ...
        if (obj && "type" in obj && obj.type) {
            switch (obj.type) {
                case "PATCH":
                    return model.UpdatePatchFsuCycle.getDeserializedJsonObj(jsonObj, true);
                case "UPGRADE":
                    return model.UpdateUpgradeFsuCycle.getDeserializedJsonObj(jsonObj, true);
                default:
                    if (common.LOG.logger)
                        common.LOG.logger.info(`Unknown value for: ${obj.type}`);
            }
    ...
    UpdateFsuCycleDetails.getDeserializedJsonObj = getDeserializedJsonObj;
})(UpdateFsuCycleDetails = exports.UpdateFsuCycleDetails || (exports.UpdateFsuCycleDetails = {}));
//# sourceMappingURL=update-fsu-cycle-details.js.map
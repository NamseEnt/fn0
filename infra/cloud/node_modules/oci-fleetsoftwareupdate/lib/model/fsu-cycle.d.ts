...
export interface FsuCycle {
    ...
    "batchingStrategy"?: model.NonRollingBatchingStrategyDetails | model.ServiceAvailabilityFactorBatchingStrategyDetails | model.SequentialBatchingStrategyDetails | model.FiftyFiftyBatchingStrategyDetails;
...
export declare namespace FsuCycle {
    function getJsonObj(obj: FsuCycle): object;
    function getDeserializedJsonObj(obj: FsuCycle): object;
}

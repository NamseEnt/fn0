...
export declare namespace AddFsuCollectionTargetsDetails {
    function getJsonObj(obj: AddFsuCollectionTargetsDetails): object;
    function getDeserializedJsonObj(obj: AddFsuCollectionTargetsDetails): object;
}

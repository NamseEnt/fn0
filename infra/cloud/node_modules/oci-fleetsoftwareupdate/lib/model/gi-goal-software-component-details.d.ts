...
export declare namespace GiGoalSoftwareComponentDetails {
    enum HomePolicy {
    ...
    function getJsonObj(obj: GiGoalSoftwareComponentDetails, isParentJsonObj?: boolean): object;
    const componentType = "GI";
    function getDeserializedJsonObj(obj: GiGoalSoftwareComponentDetails, isParentJsonObj?: boolean): object;
}

...
exports.CreateFsuCycleDetails = void 0;
const model = __importStar(require("../model"));
const common = require("oci-common");
var CreateFsuCycleDetails;
(function (CreateFsuCycleDetails) {
    function getJsonObj(obj) {
        ...
        if (obj && "type" in obj && obj.type) {
            switch (obj.type) {
                case "PATCH":
                    return model.CreatePatchFsuCycle.getJsonObj(jsonObj, true);
                case "UPGRADE":
                    return model.CreateUpgradeFsuCycle.getJsonObj(jsonObj, true);
                default:
    ...
    CreateFsuCycleDetails.getJsonObj = getJsonObj;
    function getDeserializedJsonObj(obj) {
        ...
        if (obj && "type" in obj && obj.type) {
            switch (obj.type) {
                case "PATCH":
                    return model.CreatePatchFsuCycle.getDeserializedJsonObj(jsonObj, true);
                case "UPGRADE":
                    return model.CreateUpgradeFsuCycle.getDeserializedJsonObj(jsonObj, true);
                default:
                    if (common.LOG.logger)
                        common.LOG.logger.info(`Unknown value for: ${obj.type}`);
            }
    ...
    CreateFsuCycleDetails.getDeserializedJsonObj = getDeserializedJsonObj;
})(CreateFsuCycleDetails = exports.CreateFsuCycleDetails || (exports.CreateFsuCycleDetails = {}));
//# sourceMappingURL=create-fsu-cycle-details.js.map
 ...
 *
 */
export interface CleanupFsuJobSummary extends model.FsuJobSummary {
    /**
...
export declare namespace CleanupFsuJobSummary {
    function getJsonObj(obj: CleanupFsuJobSummary, isParentJsonObj?: boolean): object;
    const type = "CLEANUP";
    function getDeserializedJsonObj(obj: CleanupFsuJobSummary, isParentJsonObj?: boolean): object;
}

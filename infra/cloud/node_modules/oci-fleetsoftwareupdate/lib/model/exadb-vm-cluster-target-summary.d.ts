...
export declare namespace ExadbVmClusterTargetSummary {
    function getJsonObj(obj: ExadbVmClusterTargetSummary, isParentJsonObj?: boolean): object;
    const entityType = "EXADBVMCLUSTER";
    function getDeserializedJsonObj(obj: ExadbVmClusterTargetSummary, isParentJsonObj?: boolean): object;
}

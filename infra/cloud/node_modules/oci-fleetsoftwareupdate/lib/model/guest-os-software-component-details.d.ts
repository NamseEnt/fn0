...
export declare namespace GuestOsSoftwareComponentDetails {
    function getJsonObj(obj: GuestOsSoftwareComponentDetails, isParentJsonObj?: boolean): object;
    const componentType = "GUEST_OS";
    function getDeserializedJsonObj(obj: GuestOsSoftwareComponentDetails, isParentJsonObj?: boolean): object;
}

...
export declare class FleetSoftwareUpdateWaiter {
     ...
     */
    forFsuReadinessCheck(request: serviceRequests.GetFsuReadinessCheckRequest, ...targetStates: models.FsuReadinessCheck.LifecycleState[]): Promise<serviceResponses.GetFsuReadinessCheckResponse | null>;
    /**

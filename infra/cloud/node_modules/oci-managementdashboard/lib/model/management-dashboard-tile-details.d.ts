...
export declare namespace ManagementDashboardTileDetails {
    enum State {
        Deleted = "DELETED",
    ...
    function getJsonObj(obj: ManagementDashboardTileDetails): object;
    function getDeserializedJsonObj(obj: ManagementDashboardTileDetails): object;
}

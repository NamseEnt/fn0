...
export declare namespace ChangeOccDemandSignalCompartmentDetails {
    function getJsonObj(obj: ChangeOccDemandSignalCompartmentDetails): object;
    function getDeserializedJsonObj(obj: ChangeOccDemandSignalCompartmentDetails): object;
}

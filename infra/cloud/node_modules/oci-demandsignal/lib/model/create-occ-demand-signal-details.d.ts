...
export declare namespace CreateOccDemandSignalDetails {
    function getJsonObj(obj: CreateOccDemandSignalDetails): object;
    function getDeserializedJsonObj(obj: CreateOccDemandSignalDetails): object;
}

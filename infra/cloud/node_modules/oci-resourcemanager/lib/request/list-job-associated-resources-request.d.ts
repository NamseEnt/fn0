...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/resourcemanager/ListJobAssociatedResources.ts.html |here} to see how to use ListJobAssociatedResourcesRequest.
 */
export interface ListJobAssociatedResourcesRequest extends common.BaseRequest {
    /**

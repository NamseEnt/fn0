...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/resourcemanager/DeleteTemplate.ts.html |here} to see how to use DeleteTemplateRequest.
 */
export interface DeleteTemplateRequest extends common.BaseRequest {
    /**

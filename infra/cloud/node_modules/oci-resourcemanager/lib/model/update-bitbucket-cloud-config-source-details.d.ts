 ...
 */
export interface UpdateBitbucketCloudConfigSourceDetails extends model.UpdateConfigSourceDetails {
    /**
...
export declare namespace UpdateBitbucketCloudConfigSourceDetails {
    function getJsonObj(obj: UpdateBitbucketCloudConfigSourceDetails, isParentJsonObj?: boolean): object;
    const configSourceType = "BITBUCKET_CLOUD_CONFIG_SOURCE";
    function getDeserializedJsonObj(obj: UpdateBitbucketCloudConfigSourceDetails, isParentJsonObj?: boolean): object;
}

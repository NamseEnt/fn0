...
export declare namespace UpdateConfigSourceDetails {
    function getJsonObj(obj: UpdateConfigSourceDetails): object;
    function getDeserializedJsonObj(obj: UpdateConfigSourceDetails): object;
}

...
export declare namespace ApplyRollbackJobOperationDetailsSummary {
    function getJsonObj(obj: ApplyRollbackJobOperationDetailsSummary, isParentJsonObj?: boolean): object;
    const operation = "APPLY_ROLLBACK";
    function getDeserializedJsonObj(obj: ApplyRollbackJobOperationDetailsSummary, isParentJsonObj?: boolean): object;
}

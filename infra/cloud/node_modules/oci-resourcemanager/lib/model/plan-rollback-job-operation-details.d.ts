 ...
 *
 */
export interface PlanRollbackJobOperationDetails extends model.JobOperationDetails {
...
export declare namespace PlanRollbackJobOperationDetails {
    function getJsonObj(obj: PlanRollbackJobOperationDetails, isParentJsonObj?: boolean): object;
    const operation = "PLAN_ROLLBACK";
    function getDeserializedJsonObj(obj: PlanRollbackJobOperationDetails, isParentJsonObj?: boolean): object;
}

...
export declare namespace CancellationDetails {
    function getJsonObj(obj: CancellationDetails): object;
    function getDeserializedJsonObj(obj: CancellationDetails): object;
}

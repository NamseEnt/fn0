 ...
 */
export interface UpdateDevOpsConfigSourceDetails extends model.UpdateConfigSourceDetails {
    /**
...
export declare namespace UpdateDevOpsConfigSourceDetails {
    function getJsonObj(obj: UpdateDevOpsConfigSourceDetails, isParentJsonObj?: boolean): object;
    const configSourceType = "DEVOPS_CONFIG_SOURCE";
    function getDeserializedJsonObj(obj: UpdateDevOpsConfigSourceDetails, isParentJsonObj?: boolean): object;
}

 ...
 *
 */
export interface CreateBitbucketServerConfigSourceDetails extends model.CreateConfigSourceDetails {
    /**
...
export declare namespace CreateBitbucketServerConfigSourceDetails {
    function getJsonObj(obj: CreateBitbucketServerConfigSourceDetails, isParentJsonObj?: boolean): object;
    const configSourceType = "BITBUCKET_SERVER_CONFIG_SOURCE";
    function getDeserializedJsonObj(obj: CreateBitbucketServerConfigSourceDetails, isParentJsonObj?: boolean): object;
}

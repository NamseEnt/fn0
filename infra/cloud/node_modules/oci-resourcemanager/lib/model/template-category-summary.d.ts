...
export declare namespace TemplateCategorySummary {
    function getJsonObj(obj: TemplateCategorySummary): object;
    function getDeserializedJsonObj(obj: TemplateCategorySummary): object;
}

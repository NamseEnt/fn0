...
export declare namespace CreateImportTfStateJobOperationDetails {
    function getJsonObj(obj: CreateImportTfStateJobOperationDetails, isParentJsonObj?: boolean): object;
    const operation = "IMPORT_TF_STATE";
    function getDeserializedJsonObj(obj: CreateImportTfStateJobOperationDetails, isParentJsonObj?: boolean): object;
}

...
export declare namespace CreatePlanJobOperationDetails {
    function getJsonObj(obj: CreatePlanJobOperationDetails, isParentJsonObj?: boolean): object;
    const operation = "PLAN";
    function getDeserializedJsonObj(obj: CreatePlanJobOperationDetails, isParentJsonObj?: boolean): object;
}

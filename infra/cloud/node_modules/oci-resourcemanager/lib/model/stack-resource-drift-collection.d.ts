...
export declare namespace StackResourceDriftCollection {
    function getJsonObj(obj: StackResourceDriftCollection): object;
    function getDeserializedJsonObj(obj: StackResourceDriftCollection): object;
}

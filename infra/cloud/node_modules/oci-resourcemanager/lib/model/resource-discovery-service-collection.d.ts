...
export declare namespace ResourceDiscoveryServiceCollection {
    function getJsonObj(obj: ResourceDiscoveryServiceCollection): object;
    function getDeserializedJsonObj(obj: ResourceDiscoveryServiceCollection): object;
}

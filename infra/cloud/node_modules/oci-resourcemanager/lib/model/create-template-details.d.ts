...
export interface CreateTemplateDetails {
    ...
    "templateConfigSource": model.CreateTemplateZipUploadConfigSourceDetails;
    /**
...
export declare namespace CreateTemplateDetails {
    function getJsonObj(obj: CreateTemplateDetails): object;
    function getDeserializedJsonObj(obj: CreateTemplateDetails): object;
}

...
export declare namespace CreateConfigSourceDetails {
    function getJsonObj(obj: CreateConfigSourceDetails): object;
    function getDeserializedJsonObj(obj: CreateConfigSourceDetails): object;
}

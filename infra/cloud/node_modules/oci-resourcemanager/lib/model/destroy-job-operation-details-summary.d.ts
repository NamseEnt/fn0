...
export declare namespace DestroyJobOperationDetailsSummary {
    function getJsonObj(obj: DestroyJobOperationDetailsSummary, isParentJsonObj?: boolean): object;
    const operation = "DESTROY";
    function getDeserializedJsonObj(obj: DestroyJobOperationDetailsSummary, isParentJsonObj?: boolean): object;
}

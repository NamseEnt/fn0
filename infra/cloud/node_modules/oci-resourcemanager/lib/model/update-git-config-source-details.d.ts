...
export declare namespace UpdateGitConfigSourceDetails {
    function getJsonObj(obj: UpdateGitConfigSourceDetails, isParentJsonObj?: boolean): object;
    const configSourceType = "GIT_CONFIG_SOURCE";
    function getDeserializedJsonObj(obj: UpdateGitConfigSourceDetails, isParentJsonObj?: boolean): object;
}

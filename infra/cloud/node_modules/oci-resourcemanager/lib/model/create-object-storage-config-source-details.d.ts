...
export declare namespace CreateObjectStorageConfigSourceDetails {
    function getJsonObj(obj: CreateObjectStorageConfigSourceDetails, isParentJsonObj?: boolean): object;
    const configSourceType = "OBJECT_STORAGE_CONFIG_SOURCE";
    function getDeserializedJsonObj(obj: CreateObjectStorageConfigSourceDetails, isParentJsonObj?: boolean): object;
}

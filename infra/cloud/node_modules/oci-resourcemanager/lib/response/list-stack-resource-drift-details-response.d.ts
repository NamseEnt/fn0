...
export interface ListStackResourceDriftDetailsResponse {
    /**
    ...
    "opcNextPage": string;
    /**
     * The returned model.StackResourceDriftCollection instance.
     */
    "stackResourceDriftCollection": model.StackResourceDriftCollection;
}

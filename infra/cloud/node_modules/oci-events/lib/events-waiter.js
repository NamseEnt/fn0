...
class EventsWaiter {
     ...
     */
    forRule(request, ...targetStates) {
        return __awaiter(this, void 0, void 0, function* () {
            return oci_common_1.genericTerminalConditionWaiter(this.config, () => this.client.getRule(request), response => targetStates.includes(response.rule.lifecycleState), targetStates.includes(models.Rule.LifecycleState.Deleted));
        });
    }
}
exports.EventsWaiter = EventsWaiter;
//# sourceMappingURL=events-waiter.js.map
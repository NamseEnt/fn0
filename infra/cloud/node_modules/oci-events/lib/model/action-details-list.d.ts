...
export declare namespace ActionDetailsList {
    function getJsonObj(obj: ActionDetailsList): object;
    function getDeserializedJsonObj(obj: ActionDetailsList): object;
}

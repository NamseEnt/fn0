...
export declare namespace NotificationServiceAction {
    function getJsonObj(obj: NotificationServiceAction, isParentJsonObj?: boolean): object;
    const actionType = "ONS";
    function getDeserializedJsonObj(obj: NotificationServiceAction, isParentJsonObj?: boolean): object;
}

...
export declare namespace StreamingServiceAction {
    function getJsonObj(obj: StreamingServiceAction, isParentJsonObj?: boolean): object;
    const actionType = "OSS";
    function getDeserializedJsonObj(obj: StreamingServiceAction, isParentJsonObj?: boolean): object;
}

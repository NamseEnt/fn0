...
export declare class EventsWaiter {
    private client;
    private readonly config?;
    constructor(client: EventsClient, config?: Partial<import("oci-common/lib/waiter").WaiterConfigurationDetails> | undefined);
    /**
     ...
     */
    forRule(request: serviceRequests.GetRuleRequest, ...targetStates: models.Rule.LifecycleState[]): Promise<serviceResponses.GetRuleResponse | null>;
}

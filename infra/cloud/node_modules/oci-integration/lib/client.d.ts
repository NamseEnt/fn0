...
export declare class IntegrationInstanceClient {
     ...
     */
    addLogAnalyticsLogGroup(addLogAnalyticsLogGroupRequest: requests.AddLogAnalyticsLogGroupRequest): Promise<responses.AddLogAnalyticsLogGroupResponse>;
    /**
     ...
     */
    convertInstance(convertInstanceRequest: requests.ConvertInstanceRequest): Promise<responses.ConvertInstanceResponse>;
    /**
     ...
     */
    disableProcessAutomation(disableProcessAutomationRequest: requests.DisableProcessAutomationRequest): Promise<responses.DisableProcessAutomationResponse>;
    /**
     ...
     */
    removeLogAnalyticsLogGroup(removeLogAnalyticsLogGroupRequest: requests.RemoveLogAnalyticsLogGroupRequest): Promise<responses.RemoveLogAnalyticsLogGroupResponse>;
    /**

...
(function (ConvertInstanceDetails) {
    ...
    (function (ConversionType) {
        ...
        ConversionType["DevelopmentShape"] = "DEVELOPMENT_SHAPE";
        ConversionType["ProductionShape"] = "PRODUCTION_SHAPE";
    })(ConversionType = ConvertInstanceDetails.ConversionType || (ConvertInstanceDetails.ConversionType = {}));
    let ConversionPhase;
    (function (ConversionPhase) {
        ConversionPhase["BeginMigration"] = "BEGIN_MIGRATION";
        ConversionPhase["CompleteMigration"] = "COMPLETE_MIGRATION";
        ConversionPhase["RollbackMigration"] = "ROLLBACK_MIGRATION";
    })(ConversionPhase = ConvertInstanceDetails.ConversionPhase || (ConvertInstanceDetails.ConversionPhase = {}));

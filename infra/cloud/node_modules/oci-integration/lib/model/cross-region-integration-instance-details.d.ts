...
export declare namespace CrossRegionIntegrationInstanceDetails {
    enum Role {
        Primary = "PRIMARY",
        Secondary = "SECONDARY",
        Unknown = "UNKNOWN",
    ...
    function getJsonObj(obj: CrossRegionIntegrationInstanceDetails): object;
    function getDeserializedJsonObj(obj: CrossRegionIntegrationInstanceDetails): object;
}

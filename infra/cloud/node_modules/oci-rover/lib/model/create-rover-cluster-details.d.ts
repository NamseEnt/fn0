...
export declare namespace CreateRoverClusterDetails {
    enum ShippingPreference {
        OracleShipped = "ORACLE_SHIPPED",
        CustomerPickup = "CUSTOMER_PICKUP"
    }
    function getJsonObj(obj: CreateRoverClusterDetails): object;
    function getDeserializedJsonObj(obj: CreateRoverClusterDetails): object;
}

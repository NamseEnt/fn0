...
export declare namespace UpdateRoverClusterDetails {
    enum ShippingPreference {
        OracleShipped = "ORACLE_SHIPPED",
        CustomerPickup = "CUSTOMER_PICKUP"
    }
    function getJsonObj(obj: UpdateRoverClusterDetails): object;
    function getDeserializedJsonObj(obj: UpdateRoverClusterDetails): object;
}

 ...
 **/
export declare enum CertSignatureAlgorithm {
...
export declare namespace CertSignatureAlgorithm {
    function getJsonObj(obj: CertSignatureAlgorithm): CertSignatureAlgorithm;
    function getDeserializedJsonObj(obj: CertSignatureAlgorithm): CertSignatureAlgorithm;
}

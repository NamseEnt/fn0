 ...
 */
export interface RoverNodeSummary {
    /**
...
export declare namespace RoverNodeSummary {
    function getJsonObj(obj: RoverNodeSummary): object;
    function getDeserializedJsonObj(obj: RoverNodeSummary): object;
}

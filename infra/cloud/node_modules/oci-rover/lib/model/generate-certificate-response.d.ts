...
export declare namespace GenerateCertificateResponse {
    function getJsonObj(obj: GenerateCertificateResponse): object;
    function getDeserializedJsonObj(obj: GenerateCertificateResponse): object;
}

...
export declare namespace CreateRoverNodeDetails {
    enum ShippingPreference {
        OracleShipped = "ORACLE_SHIPPED",
        CustomerPickup = "CUSTOMER_PICKUP"
    }
    function getJsonObj(obj: CreateRoverNodeDetails): object;
    function getDeserializedJsonObj(obj: CreateRoverNodeDetails): object;
}

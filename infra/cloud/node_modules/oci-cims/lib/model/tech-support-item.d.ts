...
export declare namespace TechSupportItem {
    function getJsonObj(obj: TechSupportItem, isParentJsonObj?: boolean): object;
    const type = "tech";
    function getDeserializedJsonObj(obj: TechSupportItem, isParentJsonObj?: boolean): object;
}

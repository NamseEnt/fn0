...
export declare namespace CmosUserGroupInfo {
    function getJsonObj(obj: CmosUserGroupInfo): object;
    function getDeserializedJsonObj(obj: CmosUserGroupInfo): object;
}

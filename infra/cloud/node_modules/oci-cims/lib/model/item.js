...
(function (Item) {
    function getJsonObj(obj) {
        ...
        if (obj && "type" in obj && obj.type) {
            switch (obj.type) {
                ...
                case "tech":
                    return model.TechSupportItem.getJsonObj(jsonObj, true);
                case "activity":
                    return model.ActivityItem.getJsonObj(jsonObj, true);
                default:
    ...
    function getDeserializedJsonObj(obj) {
        ...
        if (obj && "type" in obj && obj.type) {
            switch (obj.type) {
                ...
                case "tech":
                    return model.TechSupportItem.getDeserializedJsonObj(jsonObj, true);
                case "activity":
                    return model.ActivityItem.getDeserializedJsonObj(jsonObj, true);
                default:
                    if (common.LOG.logger)
                        common.LOG.logger.info(`Unknown value for: ${obj.type}`);
            }
    ...
    Item.getDeserializedJsonObj = getDeserializedJsonObj;

...
export declare namespace ValidationResponse {
    function getJsonObj(obj: ValidationResponse): object;
    function getDeserializedJsonObj(obj: ValidationResponse): object;
}

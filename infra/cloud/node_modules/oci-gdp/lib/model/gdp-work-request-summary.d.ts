...
export declare namespace GdpWorkRequestSummary {
    function getJsonObj(obj: GdpWorkRequestSummary): object;
    function getDeserializedJsonObj(obj: GdpWorkRequestSummary): object;
}

...
export declare namespace ChangeGdpPipelineCompartmentDetails {
    function getJsonObj(obj: ChangeGdpPipelineCompartmentDetails): object;
    function getDeserializedJsonObj(obj: ChangeGdpPipelineCompartmentDetails): object;
}

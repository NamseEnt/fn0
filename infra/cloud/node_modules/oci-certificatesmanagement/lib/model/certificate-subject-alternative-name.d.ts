...
export declare namespace CertificateSubjectAlternativeName {
    enum Type {
        Dns = "DNS",
        Ip = "IP",
        /**
    ...
    function getJsonObj(obj: CertificateSubjectAlternativeName): object;
    function getDeserializedJsonObj(obj: CertificateSubjectAlternativeName): object;
}

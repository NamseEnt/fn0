...
export declare namespace CaBundleCollection {
    function getJsonObj(obj: CaBundleCollection): object;
    function getDeserializedJsonObj(obj: CaBundleCollection): object;
}

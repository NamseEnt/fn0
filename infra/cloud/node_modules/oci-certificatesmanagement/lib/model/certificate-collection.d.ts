...
export declare namespace CertificateCollection {
    function getJsonObj(obj: CertificateCollection): object;
    function getDeserializedJsonObj(obj: CertificateCollection): object;
}

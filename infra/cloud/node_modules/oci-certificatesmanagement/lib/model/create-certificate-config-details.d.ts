...
export declare namespace CreateCertificateConfigDetails {
    function getJsonObj(obj: CreateCertificateConfigDetails): object;
    function getDeserializedJsonObj(obj: CreateCertificateConfigDetails): object;
}

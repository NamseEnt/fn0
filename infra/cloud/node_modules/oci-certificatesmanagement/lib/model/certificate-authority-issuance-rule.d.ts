...
export declare namespace CertificateAuthorityIssuanceRule {
    function getJsonObj(obj: CertificateAuthorityIssuanceRule, isParentJsonObj?: boolean): object;
    const ruleType = "CERTIFICATE_AUTHORITY_ISSUANCE_RULE";
    function getDeserializedJsonObj(obj: CertificateAuthorityIssuanceRule, isParentJsonObj?: boolean): object;
}

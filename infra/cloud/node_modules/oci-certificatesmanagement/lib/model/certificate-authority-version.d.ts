 ...
 */
export interface CertificateAuthorityVersion {
    /**
     * The OCID of the CA.
     */
    ...
    "timeCreated": Date;
    /**
     * The version number of this CA. Note: Numbers greater than Number.MAX_SAFE_INTEGER will result in rounding issues.
     */
...
export declare namespace CertificateAuthorityVersion {
    function getJsonObj(obj: CertificateAuthorityVersion): object;
    function getDeserializedJsonObj(obj: CertificateAuthorityVersion): object;
}

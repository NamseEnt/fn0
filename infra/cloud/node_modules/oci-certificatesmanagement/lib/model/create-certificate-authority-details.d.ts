...
export interface CreateCertificateAuthorityDetails {
    ...
    "certificateAuthorityConfig": model.CreateRootCaByGeneratingInternallyConfigDetails | model.CreateSubordinateCaIssuedByInternalCaConfigDetails | model.CreateRootCaManagedExternallyConfigDetails | model.CreateSubordinateCaManagedInternallyIssuedByExternalCaConfigDetails;
...
export declare namespace CreateCertificateAuthorityDetails {
    function getJsonObj(obj: CreateCertificateAuthorityDetails): object;
    function getDeserializedJsonObj(obj: CreateCertificateAuthorityDetails): object;
}

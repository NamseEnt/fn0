 ...
 **/
export declare enum NameConstraintType {
...
export declare namespace NameConstraintType {
    function getJsonObj(obj: NameConstraintType): NameConstraintType;
    function getDeserializedJsonObj(obj: NameConstraintType): NameConstraintType;
}

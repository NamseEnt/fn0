...
export declare namespace CertificateAuthoritySummary {
    function getJsonObj(obj: CertificateAuthoritySummary): object;
    function getDeserializedJsonObj(obj: CertificateAuthoritySummary): object;
}

 ...
 *
 **/
export declare enum CertificateAuthorityConfigType {
...
export declare namespace CertificateAuthorityConfigType {
    function getJsonObj(obj: CertificateAuthorityConfigType): CertificateAuthorityConfigType;
    function getDeserializedJsonObj(obj: CertificateAuthorityConfigType): CertificateAuthorityConfigType;
}

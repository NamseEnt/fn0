 ...
 *
 **/
export declare enum CertificateConfigType {
...
export declare namespace CertificateConfigType {
    function getJsonObj(obj: CertificateConfigType): CertificateConfigType;
    function getDeserializedJsonObj(obj: CertificateConfigType): CertificateConfigType;
}

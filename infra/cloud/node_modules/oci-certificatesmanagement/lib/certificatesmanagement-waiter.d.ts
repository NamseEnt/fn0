...
export declare class CertificatesManagementWaiter {
    private client;
    private readonly config?;
    constructor(client: CertificatesManagementClient, config?: Partial<import("oci-common/lib/waiter").WaiterConfigurationDetails> | undefined);
    /**
     ...
     */
    forAssociation(request: serviceRequests.GetAssociationRequest, ...targetStates: models.AssociationLifecycleState[]): Promise<serviceResponses.GetAssociationResponse>;
    /**
     ...
     */
    forCaBundle(request: serviceRequests.GetCaBundleRequest, ...targetStates: models.CaBundleLifecycleState[]): Promise<serviceResponses.GetCaBundleResponse | null>;
    /**
     ...
     */
    forCertificateAuthority(request: serviceRequests.GetCertificateAuthorityRequest, ...targetStates: models.CertificateAuthorityLifecycleState[]): Promise<serviceResponses.GetCertificateAuthorityResponse | null>;
}

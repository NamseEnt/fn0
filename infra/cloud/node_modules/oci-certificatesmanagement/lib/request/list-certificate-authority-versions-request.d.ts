...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/certificatesmanagement/ListCertificateAuthorityVersions.ts.html |here} to see how to use ListCertificateAuthorityVersionsRequest.
 */
export interface ListCertificateAuthorityVersionsRequest extends common.BaseRequest {
    /**
...
export declare namespace ListCertificateAuthorityVersionsRequest {
    enum SortBy {

...
export interface ListCertificateVersionsResponse {
    /**
    ...
    "opcRequestId": string;
    /**
     * The returned model.CertificateVersionCollection instance.
     */
    "certificateVersionCollection": model.CertificateVersionCollection;
}

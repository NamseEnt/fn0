...
export declare namespace OperationalMetricsDestination {
    function getJsonObj(obj: OperationalMetricsDestination): object;
    function getDeserializedJsonObj(obj: OperationalMetricsDestination): object;
}

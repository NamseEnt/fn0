...
export declare namespace UnifiedAgentCriParser {
    function getJsonObj(obj: UnifiedAgentCriParser, isParentJsonObj?: boolean): object;
    const parserType = "CRI";
    function getDeserializedJsonObj(obj: UnifiedAgentCriParser, isParentJsonObj?: boolean): object;
}

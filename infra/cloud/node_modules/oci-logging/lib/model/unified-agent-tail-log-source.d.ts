...
export declare namespace UnifiedAgentTailLogSource {
    function getJsonObj(obj: UnifiedAgentTailLogSource, isParentJsonObj?: boolean): object;
    const sourceType = "LOG_TAIL";
    function getDeserializedJsonObj(obj: UnifiedAgentTailLogSource, isParentJsonObj?: boolean): object;
}

...
export declare namespace UpdateUnifiedAgentConfigurationDetails {
    function getJsonObj(obj: UpdateUnifiedAgentConfigurationDetails): object;
    function getDeserializedJsonObj(obj: UpdateUnifiedAgentConfigurationDetails): object;
}

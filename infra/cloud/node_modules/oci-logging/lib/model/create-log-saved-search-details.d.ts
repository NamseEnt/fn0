...
export declare namespace CreateLogSavedSearchDetails {
    function getJsonObj(obj: CreateLogSavedSearchDetails): object;
    function getDeserializedJsonObj(obj: CreateLogSavedSearchDetails): object;
}

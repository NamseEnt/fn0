 ...
 *
 **/
export declare enum LogGroupLifecycleState {
    Creating = "CREATING",
    Active = "ACTIVE",
    Updating = "UPDATING",
    Inactive = "INACTIVE",
...
export declare namespace LogGroupLifecycleState {
    function getJsonObj(obj: LogGroupLifecycleState): LogGroupLifecycleState;
    function getDeserializedJsonObj(obj: LogGroupLifecycleState): LogGroupLifecycleState;
}

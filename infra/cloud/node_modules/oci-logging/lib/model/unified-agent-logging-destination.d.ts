...
export declare namespace UnifiedAgentLoggingDestination {
    function getJsonObj(obj: UnifiedAgentLoggingDestination): object;
    function getDeserializedJsonObj(obj: UnifiedAgentLoggingDestination): object;
}

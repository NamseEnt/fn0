...
export declare namespace UnifiedAgentMultilineGrokParser {
    function getJsonObj(obj: UnifiedAgentMultilineGrokParser, isParentJsonObj?: boolean): object;
    const parserType = "MULTILINE_GROK";
    function getDeserializedJsonObj(obj: UnifiedAgentMultilineGrokParser, isParentJsonObj?: boolean): object;
}

...
export declare namespace UpdateLogSavedSearchDetails {
    function getJsonObj(obj: UpdateLogSavedSearchDetails): object;
    function getDeserializedJsonObj(obj: UpdateLogSavedSearchDetails): object;
}

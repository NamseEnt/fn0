...
export declare namespace ChangeLogSavedSearchCompartmentDetails {
    function getJsonObj(obj: ChangeLogSavedSearchCompartmentDetails): object;
    function getDeserializedJsonObj(obj: ChangeLogSavedSearchCompartmentDetails): object;
}

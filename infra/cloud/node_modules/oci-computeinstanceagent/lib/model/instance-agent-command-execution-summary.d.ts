...
export declare namespace InstanceAgentCommandExecutionSummary {
    enum DeliveryState {
        Visible = "VISIBLE",
        Pending = "PENDING",
        Acked = "ACKED",
    ...
    function getJsonObj(obj: InstanceAgentCommandExecutionSummary): object;
    function getDeserializedJsonObj(obj: InstanceAgentCommandExecutionSummary): object;
}

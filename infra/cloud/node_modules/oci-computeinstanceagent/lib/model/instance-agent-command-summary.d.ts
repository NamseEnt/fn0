...
export declare namespace InstanceAgentCommandSummary {
    function getJsonObj(obj: InstanceAgentCommandSummary): object;
    function getDeserializedJsonObj(obj: InstanceAgentCommandSummary): object;
}

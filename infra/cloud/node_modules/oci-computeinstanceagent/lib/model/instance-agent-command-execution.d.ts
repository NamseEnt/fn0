...
export declare namespace InstanceAgentCommandExecution {
    enum DeliveryState {
        Visible = "VISIBLE",
        Pending = "PENDING",
        Acked = "ACKED",
    ...
    function getJsonObj(obj: InstanceAgentCommandExecution): object;
    function getDeserializedJsonObj(obj: InstanceAgentCommandExecution): object;
}

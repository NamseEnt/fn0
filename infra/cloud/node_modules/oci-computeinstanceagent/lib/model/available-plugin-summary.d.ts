...
export declare namespace AvailablePluginSummary {
    function getJsonObj(obj: AvailablePluginSummary): object;
    function getDeserializedJsonObj(obj: AvailablePluginSummary): object;
}

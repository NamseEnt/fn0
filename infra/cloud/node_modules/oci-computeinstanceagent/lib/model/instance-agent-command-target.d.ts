...
export declare namespace InstanceAgentCommandTarget {
    function getJsonObj(obj: InstanceAgentCommandTarget): object;
    function getDeserializedJsonObj(obj: InstanceAgentCommandTarget): object;
}

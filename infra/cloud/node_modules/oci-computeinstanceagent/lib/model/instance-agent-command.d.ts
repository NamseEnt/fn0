...
export declare namespace InstanceAgentCommand {
    function getJsonObj(obj: InstanceAgentCommand): object;
    function getDeserializedJsonObj(obj: InstanceAgentCommand): object;
}

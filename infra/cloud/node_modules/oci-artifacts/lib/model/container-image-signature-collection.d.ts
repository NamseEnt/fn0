...
export declare namespace ContainerImageSignatureCollection {
    function getJsonObj(obj: ContainerImageSignatureCollection): object;
    function getDeserializedJsonObj(obj: ContainerImageSignatureCollection): object;
}

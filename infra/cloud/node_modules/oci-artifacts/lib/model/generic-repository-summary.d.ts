...
export declare namespace GenericRepositorySummary {
    function getJsonObj(obj: GenericRepositorySummary, isParentJsonObj?: boolean): object;
    const repositoryType = "GENERIC";
    function getDeserializedJsonObj(obj: GenericRepositorySummary, isParentJsonObj?: boolean): object;
}

...
export declare namespace ContainerImageLayer {
    function getJsonObj(obj: ContainerImageLayer): object;
    function getDeserializedJsonObj(obj: ContainerImageLayer): object;
}

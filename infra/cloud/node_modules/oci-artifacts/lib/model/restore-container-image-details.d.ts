...
export declare namespace RestoreContainerImageDetails {
    function getJsonObj(obj: RestoreContainerImageDetails): object;
    function getDeserializedJsonObj(obj: RestoreContainerImageDetails): object;
}

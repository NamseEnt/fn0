...
export declare namespace ChangeRepositoryCompartmentDetails {
    function getJsonObj(obj: ChangeRepositoryCompartmentDetails): object;
    function getDeserializedJsonObj(obj: ChangeRepositoryCompartmentDetails): object;
}

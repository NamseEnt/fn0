...
export declare namespace UpdateContainerImageSignatureDetails {
    function getJsonObj(obj: UpdateContainerImageSignatureDetails): object;
    function getDeserializedJsonObj(obj: UpdateContainerImageSignatureDetails): object;
}

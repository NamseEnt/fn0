...
export declare namespace CreateRepositoryDetails {
    function getJsonObj(obj: CreateRepositoryDetails): object;
    function getDeserializedJsonObj(obj: CreateRepositoryDetails): object;
}

...
export declare namespace UpdateGenericArtifactByPathDetails {
    function getJsonObj(obj: UpdateGenericArtifactByPathDetails): object;
    function getDeserializedJsonObj(obj: UpdateGenericArtifactByPathDetails): object;
}

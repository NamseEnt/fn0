...
export declare namespace ContainerImageSummary {
    function getJsonObj(obj: ContainerImageSummary): object;
    function getDeserializedJsonObj(obj: ContainerImageSummary): object;
}

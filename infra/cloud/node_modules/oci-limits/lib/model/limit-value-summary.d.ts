...
export declare namespace LimitValueSummary {
    enum ScopeType {
        Global = "GLOBAL",
        Region = "REGION",
        Ad = "AD",
    ...
    function getJsonObj(obj: LimitValueSummary): object;
    function getDeserializedJsonObj(obj: LimitValueSummary): object;
}

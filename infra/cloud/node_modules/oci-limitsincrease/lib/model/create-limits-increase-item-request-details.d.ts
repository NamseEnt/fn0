...
export declare namespace CreateLimitsIncreaseItemRequestDetails {
    function getJsonObj(obj: CreateLimitsIncreaseItemRequestDetails): object;
    function getDeserializedJsonObj(obj: CreateLimitsIncreaseItemRequestDetails): object;
}

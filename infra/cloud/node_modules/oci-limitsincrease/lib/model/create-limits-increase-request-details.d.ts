...
export declare namespace CreateLimitsIncreaseRequestDetails {
    function getJsonObj(obj: CreateLimitsIncreaseRequestDetails): object;
    function getDeserializedJsonObj(obj: CreateLimitsIncreaseRequestDetails): object;
}

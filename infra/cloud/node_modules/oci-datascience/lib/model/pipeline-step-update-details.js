...
(function (PipelineStepUpdateDetails) {
    function getJsonObj(obj) {
        ...
        if (obj && "stepType" in obj && obj.stepType) {
            switch (obj.stepType) {
                case "DATAFLOW":
                    return model.PipelineDataflowStepUpdateDetails.getJsonObj(jsonObj, true);
                case "ML_JOB":
    ...
    function getDeserializedJsonObj(obj) {
        ...
        if (obj && "stepType" in obj && obj.stepType) {
            switch (obj.stepType) {
                case "DATAFLOW":
                    return model.PipelineDataflowStepUpdateDetails.getDeserializedJsonObj(jsonObj, true);
                case "ML_JOB":

 ...
 */
export interface CreateModelGroupVersionHistoryDetails {
    /**
     ...
     * Example: {@code My model version history}
     *
     */
    "displayName"?: string;
    /**
...
export declare namespace CreateModelGroupVersionHistoryDetails {
    function getJsonObj(obj: CreateModelGroupVersionHistoryDetails): object;
    function getDeserializedJsonObj(obj: CreateModelGroupVersionHistoryDetails): object;
}

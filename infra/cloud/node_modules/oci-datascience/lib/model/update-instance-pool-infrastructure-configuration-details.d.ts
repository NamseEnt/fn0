 ...
 */
export interface UpdateInstancePoolInfrastructureConfigurationDetails extends model.UpdateInfrastructureConfigurationDetails {
...
export declare namespace UpdateInstancePoolInfrastructureConfigurationDetails {
    function getJsonObj(obj: UpdateInstancePoolInfrastructureConfigurationDetails, isParentJsonObj?: boolean): object;
    const infrastructureType = "INSTANCE_POOL";
    function getDeserializedJsonObj(obj: UpdateInstancePoolInfrastructureConfigurationDetails, isParentJsonObj?: boolean): object;
}

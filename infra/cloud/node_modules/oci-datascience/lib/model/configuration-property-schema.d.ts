...
export declare namespace ConfigurationPropertySchema {
    enum ValueType {
        String = "STRING",
        Secret = "SECRET",
    ...
    function getJsonObj(obj: ConfigurationPropertySchema): object;
    function getDeserializedJsonObj(obj: ConfigurationPropertySchema): object;
}

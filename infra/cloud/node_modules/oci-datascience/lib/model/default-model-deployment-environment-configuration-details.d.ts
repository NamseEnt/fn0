 ...
 */
export interface DefaultModelDeploymentEnvironmentConfigurationDetails extends model.ModelDeploymentEnvironmentConfigurationDetails {
    /**
...
export declare namespace DefaultModelDeploymentEnvironmentConfigurationDetails {
    function getJsonObj(obj: DefaultModelDeploymentEnvironmentConfigurationDetails, isParentJsonObj?: boolean): object;
    const environmentConfigurationType = "DEFAULT";
    function getDeserializedJsonObj(obj: DefaultModelDeploymentEnvironmentConfigurationDetails, isParentJsonObj?: boolean): object;
}

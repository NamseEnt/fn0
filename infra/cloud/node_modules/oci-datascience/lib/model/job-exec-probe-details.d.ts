...
export declare namespace JobExecProbeDetails {
    function getJsonObj(obj: JobExecProbeDetails, isParentJsonObj?: boolean): object;
    const jobProbeCheckType = "EXEC";
    function getDeserializedJsonObj(obj: JobExecProbeDetails, isParentJsonObj?: boolean): object;
}

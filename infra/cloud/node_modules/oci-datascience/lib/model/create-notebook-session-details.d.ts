...
export declare namespace CreateNotebookSessionDetails {
    function getJsonObj(obj: CreateNotebookSessionDetails): object;
    function getDeserializedJsonObj(obj: CreateNotebookSessionDetails): object;
}

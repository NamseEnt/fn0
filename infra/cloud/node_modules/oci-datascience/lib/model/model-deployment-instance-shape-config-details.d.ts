...
export declare namespace ModelDeploymentInstanceShapeConfigDetails {
    enum CpuBaseline {
    ...
    function getJsonObj(obj: ModelDeploymentInstanceShapeConfigDetails): object;
    function getDeserializedJsonObj(obj: ModelDeploymentInstanceShapeConfigDetails): object;
}

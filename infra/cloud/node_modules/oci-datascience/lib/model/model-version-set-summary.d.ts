 ...
 */
export interface ModelVersionSetSummary {
    /**
...
export declare namespace ModelVersionSetSummary {
    function getJsonObj(obj: ModelVersionSetSummary): object;
    function getDeserializedJsonObj(obj: ModelVersionSetSummary): object;
}

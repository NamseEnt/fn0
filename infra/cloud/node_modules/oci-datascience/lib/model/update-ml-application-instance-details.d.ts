...
export declare namespace UpdateMlApplicationInstanceDetails {
    function getJsonObj(obj: UpdateMlApplicationInstanceDetails): object;
    function getDeserializedJsonObj(obj: UpdateMlApplicationInstanceDetails): object;
}

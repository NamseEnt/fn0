...
export declare namespace ScheduleLogDetails {
    function getJsonObj(obj: ScheduleLogDetails): object;
    function getDeserializedJsonObj(obj: ScheduleLogDetails): object;
}

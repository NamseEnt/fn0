 ...
 */
export interface ImplementationLogDetails {
    /**
...
export declare namespace ImplementationLogDetails {
    function getJsonObj(obj: ImplementationLogDetails): object;
    function getDeserializedJsonObj(obj: ImplementationLogDetails): object;
}

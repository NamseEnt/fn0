 ...
 */
export interface ModelGroupVersionHistory {
    /**
...
export declare namespace ModelGroupVersionHistory {
    function getJsonObj(obj: ModelGroupVersionHistory): object;
    function getDeserializedJsonObj(obj: ModelGroupVersionHistory): object;
}

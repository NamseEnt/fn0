...
export declare namespace JobShapeConfigDetails {
    enum CpuBaseline {
    ...
    function getJsonObj(obj: JobShapeConfigDetails): object;
    function getDeserializedJsonObj(obj: JobShapeConfigDetails): object;
}

...
export declare namespace ModelDeploymentModelStateSummary {
    enum State {
        Success = "SUCCESS",
        Failed = "FAILED",
    ...
    function getJsonObj(obj: ModelDeploymentModelStateSummary): object;
    function getDeserializedJsonObj(obj: ModelDeploymentModelStateSummary): object;
}

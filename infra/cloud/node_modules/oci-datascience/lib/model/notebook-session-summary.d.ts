...
export declare namespace NotebookSessionSummary {
    function getJsonObj(obj: NotebookSessionSummary): object;
    function getDeserializedJsonObj(obj: NotebookSessionSummary): object;
}

...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/datascience/CreateModelGroupArtifact.ts.html |here} to see how to use CreateModelGroupArtifactRequest.
 */
export interface CreateModelGroupArtifactRequest extends common.BaseRequest {
    /**
     ...
     */
    "modelGroupArtifact": Uint8Array | Buffer | Blob | stream.Readable | ReadableStream | string;
    /**

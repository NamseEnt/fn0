...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/datascience/ListModelDeployments.ts.html |here} to see how to use ListModelDeploymentsRequest.
 */
...
export declare namespace ListModelDeploymentsRequest {
    enum SortOrder {
        Asc = "ASC",
        Desc = "DESC"
    }

...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/datascience/ListNotebookSessions.ts.html |here} to see how to use ListNotebookSessionsRequest.
 */
...
export declare namespace ListNotebookSessionsRequest {
    enum SortOrder {
        Asc = "ASC",
        Desc = "DESC"
    }

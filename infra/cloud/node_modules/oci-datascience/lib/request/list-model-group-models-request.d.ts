...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/datascience/ListModelGroupModels.ts.html |here} to see how to use ListModelGroupModelsRequest.
 */
export interface ListModelGroupModelsRequest extends common.BaseRequest {
    /**
...
export declare namespace ListModelGroupModelsRequest {
    enum SortOrder {
        Asc = "ASC",
        Desc = "DESC"
    }

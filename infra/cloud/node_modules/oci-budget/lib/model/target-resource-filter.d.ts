...
export declare namespace TargetResourceFilter {
    enum Operator {
        And = "AND",
        Or = "OR",
        /**
    ...
    function getJsonObj(obj: TargetResourceFilter): object;
    function getDeserializedJsonObj(obj: TargetResourceFilter): object;
}

...
export declare namespace UpdateCostAlertSubscriptionDetails {
    function getJsonObj(obj: UpdateCostAlertSubscriptionDetails): object;
    function getDeserializedJsonObj(obj: UpdateCostAlertSubscriptionDetails): object;
}

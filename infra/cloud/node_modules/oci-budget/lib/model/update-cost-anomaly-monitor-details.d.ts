...
export declare namespace UpdateCostAnomalyMonitorDetails {
    function getJsonObj(obj: UpdateCostAnomalyMonitorDetails): object;
    function getDeserializedJsonObj(obj: UpdateCostAnomalyMonitorDetails): object;
}

 ...
 *
 */
export interface UpdateCostAnomalyEventDetails {
    /**
...
export declare namespace UpdateCostAnomalyEventDetails {
    function getJsonObj(obj: UpdateCostAnomalyEventDetails): object;
    function getDeserializedJsonObj(obj: UpdateCostAnomalyEventDetails): object;
}

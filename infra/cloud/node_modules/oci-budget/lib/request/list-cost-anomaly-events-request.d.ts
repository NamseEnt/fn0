...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/budget/ListCostAnomalyEvents.ts.html |here} to see how to use ListCostAnomalyEventsRequest.
 */
export interface ListCostAnomalyEventsRequest extends common.BaseRequest {
    /**

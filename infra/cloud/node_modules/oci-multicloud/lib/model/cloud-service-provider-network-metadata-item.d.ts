...
export declare namespace CloudServiceProviderNetworkMetadataItem {
    function getJsonObj(obj: CloudServiceProviderNetworkMetadataItem): object;
    function getDeserializedJsonObj(obj: CloudServiceProviderNetworkMetadataItem): object;
}

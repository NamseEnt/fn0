 ...
 */
export interface CreateOpensearchClusterPipelineDetails {
    /**
...
export declare namespace CreateOpensearchClusterPipelineDetails {
    function getJsonObj(obj: CreateOpensearchClusterPipelineDetails): object;
    function getDeserializedJsonObj(obj: CreateOpensearchClusterPipelineDetails): object;
}

...
export declare namespace CustomerLoggingDetails {
    function getJsonObj(obj: CustomerLoggingDetails): object;
    function getDeserializedJsonObj(obj: CustomerLoggingDetails): object;
}

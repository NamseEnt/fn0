...
export declare namespace CertificateConfig {
    function getJsonObj(obj: CertificateConfig): object;
    function getDeserializedJsonObj(obj: CertificateConfig): object;
}

...
export declare namespace MaintenanceNotificationDetails {
    function getJsonObj(obj: MaintenanceNotificationDetails): object;
    function getDeserializedJsonObj(obj: MaintenanceNotificationDetails): object;
}

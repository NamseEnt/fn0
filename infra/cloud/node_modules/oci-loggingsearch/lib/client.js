...
exports.LogSearchClient = exports.LogSearchApiKeys = void 0;
...
// ===============================================
var LogSearchApiKeys;
(function (LogSearchApiKeys) {
})(LogSearchApiKeys = exports.LogSearchApiKeys || (exports.LogSearchApiKeys = {}));
/**
...
class LogSearchClient {
    constructor(params, clientConfiguration) {
        ...
        if (!oci_common_1.developerToolConfiguration.isServiceEnabled("loggingsearch")) {
            let errmsg = "The developerToolConfiguration configuration disabled this service, this behavior is controlled by developerToolConfiguration.ociEnabledServiceSet variable. Please check if your local developer_tool_configuration file has configured the service you're targeting or contact the cloud provider on the availability of this service : ";
            throw errmsg.concat("loggingsearch");
        }
    ...
    set endpoint(endpoint) {
        ...
        if (this.logger)
            this.logger.info(`LogSearchClient endpoint set to ${this._endpoint}`);
    }
    get logger() {
    ...
    set useRealmSpecificEndpointTemplate(realmSpecificEndpointTemplateEnabled) {
        ...
        if (this._lastSetRegionOrRegionId === common.Region.REGION_STRING) {
            this.endpoint = common.EndpointBuilder.createEndpointFromRegion(LogSearchClient.serviceEndpointTemplate, this._region, LogSearchClient.endpointServiceName);
        }
        else if (this._lastSetRegionOrRegionId === common.Region.REGION_ID_STRING) {
            this.endpoint = common.EndpointBuilder.createEndpointFromRegionId(LogSearchClient.serviceEndpointTemplate, this._regionId, LogSearchClient.endpointServiceName);
        }
    }
    /**
    ...
    set region(region) {
        this._region = region;
        this.endpoint = common.EndpointBuilder.createEndpointFromRegion(LogSearchClient.serviceEndpointTemplate, region, LogSearchClient.endpointServiceName);
  ...
  *
    ...
    searchLogs(searchLogsRequest) {
        return __awaiter(this, void 0, void 0, function* () {
            if (this.logger)
                this.logger.debug("Calling operation LogSearchClient#searchLogs.");
            const operationName = "searchLogs";
            const apiReferenceLink = "https://docs.oracle.com/iaas/api/#/en/logging-search/20190909/SearchResult/SearchLogs";
            const pathParams = {};
            const queryParams = {
            ...
            const request = yield oci_common_1.composeRequest({
                ...
                path: "/search",
                method: "POST",
                bodyContent: common.ObjectSerializer.serialize(searchLogsRequest.searchLogsDetails, "SearchLogsDetails", model.SearchLogsDetails.getJsonObj),

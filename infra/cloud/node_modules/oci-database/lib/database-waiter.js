...
class DatabaseWaiter {
     ...
     */
    forAddDbnodeSnapshotsForExadbVmCluster(request) {
        return __awaiter(this, void 0, void 0, function* () {
            const addDbnodeSnapshotsForExadbVmClusterResponse = yield this.client.addDbnodeSnapshotsForExadbVmCluster(request);
            ...
            const getWorkRequestResponse = yield oci_workrequests_1.waitForWorkRequest(this.config, this.workRequestClient, addDbnodeSnapshotsForExadbVmClusterResponse.opcWorkRequestId);
            return {
                response: addDbnodeSnapshotsForExadbVmClusterResponse,
                workRequestResponse: getWorkRequestResponse
            };
     ...
     */
    forAddStandbyAutonomousContainerDatabase(request) {
        return __awaiter(this, void 0, void 0, function* () {
            const addStandbyAutonomousContainerDatabaseResponse = yield this.client.addStandbyAutonomousContainerDatabase(request);
            ...
            const getWorkRequestResponse = yield oci_workrequests_1.waitForWorkRequest(this.config, this.workRequestClient, addStandbyAutonomousContainerDatabaseResponse.opcWorkRequestId);
            return {
                response: addStandbyAutonomousContainerDatabaseResponse,
                workRequestResponse: getWorkRequestResponse
            };
     ...
     */
    forCancelExecutionWindow(request) {
        return __awaiter(this, void 0, void 0, function* () {
            const cancelExecutionWindowResponse = yield this.client.cancelExecutionWindow(request);
            if (cancelExecutionWindowResponse.opcWorkRequestId === undefined)
                return { response: cancelExecutionWindowResponse, workRequestResponse: undefined };
            const getWorkRequestResponse = yield oci_workrequests_1.waitForWorkRequest(this.config, this.workRequestClient, cancelExecutionWindowResponse.opcWorkRequestId);
     ...
     */
    forCascadingDeleteSchedulingPlan(request) {
        return __awaiter(this, void 0, void 0, function* () {
            const cascadingDeleteSchedulingPlanResponse = yield this.client.cascadingDeleteSchedulingPlan(request);
            if (cascadingDeleteSchedulingPlanResponse.opcWorkRequestId === undefined)
                return {
                    response: cascadingDeleteSchedulingPlanResponse,
                    workRequestResponse: undefined
                };
            const getWorkRequestResponse = yield oci_workrequests_1.waitForWorkRequest(this.config, this.workRequestClient, cascadingDeleteSchedulingPlanResponse.opcWorkRequestId);
            return {
                response: cascadingDeleteSchedulingPlanResponse,
                workRequestResponse: getWorkRequestResponse
            };
     ...
     */
    forChangeAutonomousDatabaseSubscription(request) {
        return __awaiter(this, void 0, void 0, function* () {
            const changeAutonomousDatabaseSubscriptionResponse = yield this.client.changeAutonomousDatabaseSubscription(request);
            ...
            const getWorkRequestResponse = yield oci_workrequests_1.waitForWorkRequest(this.config, this.workRequestClient, changeAutonomousDatabaseSubscriptionResponse.opcWorkRequestId);
            return {
                response: changeAutonomousDatabaseSubscriptionResponse,
                workRequestResponse: getWorkRequestResponse
            };
     ...
     */
    forChangeCloudAutonomousVmClusterSubscription(request) {
        return __awaiter(this, void 0, void 0, function* () {
            const changeCloudAutonomousVmClusterSubscriptionResponse = yield this.client.changeCloudAutonomousVmClusterSubscription(request);
            ...
            const getWorkRequestResponse = yield oci_workrequests_1.waitForWorkRequest(this.config, this.workRequestClient, changeCloudAutonomousVmClusterSubscriptionResponse.opcWorkRequestId);
            return {
                response: changeCloudAutonomousVmClusterSubscriptionResponse,
                workRequestResponse: getWorkRequestResponse
            };
     ...
     */
    forChangeCloudDbSystemSubscription(request) {
        return __awaiter(this, void 0, void 0, function* () {
            const changeCloudDbSystemSubscriptionResponse = yield this.client.changeCloudDbSystemSubscription(request);
            if (changeCloudDbSystemSubscriptionResponse.opcWorkRequestId === undefined)
                return {
                    response: changeCloudDbSystemSubscriptionResponse,
                    workRequestResponse: undefined
                };
            const getWorkRequestResponse = yield oci_workrequests_1.waitForWorkRequest(this.config, this.workRequestClient, changeCloudDbSystemSubscriptionResponse.opcWorkRequestId);
            return {
                response: changeCloudDbSystemSubscriptionResponse,
                workRequestResponse: getWorkRequestResponse
            };
     ...
     */
    forChangeCloudExadataInfrastructureSubscription(request) {
        return __awaiter(this, void 0, void 0, function* () {
            const changeCloudExadataInfrastructureSubscriptionResponse = yield this.client.changeCloudExadataInfrastructureSubscription(request);
            ...
            const getWorkRequestResponse = yield oci_workrequests_1.waitForWorkRequest(this.config, this.workRequestClient, changeCloudExadataInfrastructureSubscriptionResponse.opcWorkRequestId);
            return {
                response: changeCloudExadataInfrastructureSubscriptionResponse,
                workRequestResponse: getWorkRequestResponse
            };
     ...
     */
    forChangeCloudVmClusterSubscription(request) {
        return __awaiter(this, void 0, void 0, function* () {
            const changeCloudVmClusterSubscriptionResponse = yield this.client.changeCloudVmClusterSubscription(request);
            if (changeCloudVmClusterSubscriptionResponse.opcWorkRequestId === undefined)
                return {
                    response: changeCloudVmClusterSubscriptionResponse,
                    workRequestResponse: undefined
                };
            const getWorkRequestResponse = yield oci_workrequests_1.waitForWorkRequest(this.config, this.workRequestClient, changeCloudVmClusterSubscriptionResponse.opcWorkRequestId);
            return {
                response: changeCloudVmClusterSubscriptionResponse,
                workRequestResponse: getWorkRequestResponse
            };
     ...
     */
    forChangeEncryptionKeyLocation(request) {
        return __awaiter(this, void 0, void 0, function* () {
            const changeEncryptionKeyLocationResponse = yield this.client.changeEncryptionKeyLocation(request);
            if (changeEncryptionKeyLocationResponse.opcWorkRequestId === undefined)
                return {
                    response: changeEncryptionKeyLocationResponse,
                    workRequestResponse: undefined
                };
            const getWorkRequestResponse = yield oci_workrequests_1.waitForWorkRequest(this.config, this.workRequestClient, changeEncryptionKeyLocationResponse.opcWorkRequestId);
            return {
                response: changeEncryptionKeyLocationResponse,
                workRequestResponse: getWorkRequestResponse
            };
     ...
     */
    forChangeExadbVmClusterCompartment(request) {
        return __awaiter(this, void 0, void 0, function* () {
            const changeExadbVmClusterCompartmentResponse = yield this.client.changeExadbVmClusterCompartment(request);
            if (changeExadbVmClusterCompartmentResponse.opcWorkRequestId === undefined)
                return {
                    response: changeExadbVmClusterCompartmentResponse,
                    workRequestResponse: undefined
                };
            const getWorkRequestResponse = yield oci_workrequests_1.waitForWorkRequest(this.config, this.workRequestClient, changeExadbVmClusterCompartmentResponse.opcWorkRequestId);
            return {
                response: changeExadbVmClusterCompartmentResponse,
                workRequestResponse: getWorkRequestResponse
            };
     ...
     */
    forChangeExadbVmClusterSubscription(request) {
        return __awaiter(this, void 0, void 0, function* () {
            const changeExadbVmClusterSubscriptionResponse = yield this.client.changeExadbVmClusterSubscription(request);
            if (changeExadbVmClusterSubscriptionResponse.opcWorkRequestId === undefined)
                return {
                    response: changeExadbVmClusterSubscriptionResponse,
                    workRequestResponse: undefined
                };
            const getWorkRequestResponse = yield oci_workrequests_1.waitForWorkRequest(this.config, this.workRequestClient, changeExadbVmClusterSubscriptionResponse.opcWorkRequestId);
            return {
                response: changeExadbVmClusterSubscriptionResponse,
                workRequestResponse: getWorkRequestResponse
            };
     ...
     */
    forChangeExascaleDbStorageVaultCompartment(request) {
        return __awaiter(this, void 0, void 0, function* () {
            const changeExascaleDbStorageVaultCompartmentResponse = yield this.client.changeExascaleDbStorageVaultCompartment(request);
            ...
            const getWorkRequestResponse = yield oci_workrequests_1.waitForWorkRequest(this.config, this.workRequestClient, changeExascaleDbStorageVaultCompartmentResponse.opcWorkRequestId);
            return {
                response: changeExascaleDbStorageVaultCompartmentResponse,
                workRequestResponse: getWorkRequestResponse
            };
     ...
     */
    forChangeExascaleDbStorageVaultSubscription(request) {
        return __awaiter(this, void 0, void 0, function* () {
            const changeExascaleDbStorageVaultSubscriptionResponse = yield this.client.changeExascaleDbStorageVaultSubscription(request);
            ...
            const getWorkRequestResponse = yield oci_workrequests_1.waitForWorkRequest(this.config, this.workRequestClient, changeExascaleDbStorageVaultSubscriptionResponse.opcWorkRequestId);
            return {
                response: changeExascaleDbStorageVaultSubscriptionResponse,
                workRequestResponse: getWorkRequestResponse
            };
     ...
     */
    forChangeSchedulingPlanCompartment(request) {
        return __awaiter(this, void 0, void 0, function* () {
            const changeSchedulingPlanCompartmentResponse = yield this.client.changeSchedulingPlanCompartment(request);
            if (changeSchedulingPlanCompartmentResponse.opcWorkRequestId === undefined)
                return {
                    response: changeSchedulingPlanCompartmentResponse,
                    workRequestResponse: undefined
                };
            const getWorkRequestResponse = yield oci_workrequests_1.waitForWorkRequest(this.config, this.workRequestClient, changeSchedulingPlanCompartmentResponse.opcWorkRequestId);
            return {
                response: changeSchedulingPlanCompartmentResponse,
                workRequestResponse: getWorkRequestResponse
            };
     ...
     */
    forChangeSchedulingPolicyCompartment(request) {
        return __awaiter(this, void 0, void 0, function* () {
            const changeSchedulingPolicyCompartmentResponse = yield this.client.changeSchedulingPolicyCompartment(request);
            ...
            const getWorkRequestResponse = yield oci_workrequests_1.waitForWorkRequest(this.config, this.workRequestClient, changeSchedulingPolicyCompartmentResponse.opcWorkRequestId);
            return {
                response: changeSchedulingPolicyCompartmentResponse,
                workRequestResponse: getWorkRequestResponse
            };
     ...
     */
    forConfigureExascaleCloudExadataInfrastructure(request) {
        return __awaiter(this, void 0, void 0, function* () {
            const configureExascaleCloudExadataInfrastructureResponse = yield this.client.configureExascaleCloudExadataInfrastructure(request);
            ...
            const getWorkRequestResponse = yield oci_workrequests_1.waitForWorkRequest(this.config, this.workRequestClient, configureExascaleCloudExadataInfrastructureResponse.opcWorkRequestId);
            return {
                response: configureExascaleCloudExadataInfrastructureResponse,
                workRequestResponse: getWorkRequestResponse
            };
     ...
     */
    forConfigureExascaleExadataInfrastructure(request) {
        return __awaiter(this, void 0, void 0, function* () {
            const configureExascaleExadataInfrastructureResponse = yield this.client.configureExascaleExadataInfrastructure(request);
            ...
            const getWorkRequestResponse = yield oci_workrequests_1.waitForWorkRequest(this.config, this.workRequestClient, configureExascaleExadataInfrastructureResponse.opcWorkRequestId);
            return {
                response: configureExascaleExadataInfrastructureResponse,
                workRequestResponse: getWorkRequestResponse
            };
     ...
     */
    forConfirmKeyStoreDetailsAreCorrect(request) {
        return __awaiter(this, void 0, void 0, function* () {
            const confirmKeyStoreDetailsAreCorrectResponse = yield this.client.confirmKeyStoreDetailsAreCorrect(request);
            if (confirmKeyStoreDetailsAreCorrectResponse.opcWorkRequestId === undefined)
                return {
                    response: confirmKeyStoreDetailsAreCorrectResponse,
                    workRequestResponse: undefined
                };
            const getWorkRequestResponse = yield oci_workrequests_1.waitForWorkRequest(this.config, this.workRequestClient, confirmKeyStoreDetailsAreCorrectResponse.opcWorkRequestId);
            return {
                response: confirmKeyStoreDetailsAreCorrectResponse,
                workRequestResponse: getWorkRequestResponse
            };
     ...
     */
    forConvertStandbyAutonomousContainerDatabase(request) {
        return __awaiter(this, void 0, void 0, function* () {
            const convertStandbyAutonomousContainerDatabaseResponse = yield this.client.convertStandbyAutonomousContainerDatabase(request);
            ...
            const getWorkRequestResponse = yield oci_workrequests_1.waitForWorkRequest(this.config, this.workRequestClient, convertStandbyAutonomousContainerDatabaseResponse.opcWorkRequestId);
            return {
                response: convertStandbyAutonomousContainerDatabaseResponse,
                workRequestResponse: getWorkRequestResponse
            };
     ...
     */
    forConvertStandbyDatabaseType(request) {
        return __awaiter(this, void 0, void 0, function* () {
            const convertStandbyDatabaseTypeResponse = yield this.client.convertStandbyDatabaseType(request);
            if (convertStandbyDatabaseTypeResponse.opcWorkRequestId === undefined)
                return {
                    response: convertStandbyDatabaseTypeResponse,
                    workRequestResponse: undefined
                };
            const getWorkRequestResponse = yield oci_workrequests_1.waitForWorkRequest(this.config, this.workRequestClient, convertStandbyDatabaseTypeResponse.opcWorkRequestId);
            return {
                response: convertStandbyDatabaseTypeResponse,
                workRequestResponse: getWorkRequestResponse
            };
     ...
     */
    forConvertToStandalone(request) {
        return __awaiter(this, void 0, void 0, function* () {
            const convertToStandaloneResponse = yield this.client.convertToStandalone(request);
            if (convertToStandaloneResponse.opcWorkRequestId === undefined)
                return { response: convertToStandaloneResponse, workRequestResponse: undefined };
            const getWorkRequestResponse = yield oci_workrequests_1.waitForWorkRequest(this.config, this.workRequestClient, convertToStandaloneResponse.opcWorkRequestId);
     ...
     */
    forCreateAdvancedClusterFileSystem(request) {
        return __awaiter(this, void 0, void 0, function* () {
            const createAdvancedClusterFileSystemResponse = yield this.client.createAdvancedClusterFileSystem(request);
            if (createAdvancedClusterFileSystemResponse.opcWorkRequestId === undefined)
                return {
                    response: createAdvancedClusterFileSystemResponse,
                    workRequestResponse: undefined
                };
            const getWorkRequestResponse = yield oci_workrequests_1.waitForWorkRequest(this.config, this.workRequestClient, createAdvancedClusterFileSystemResponse.opcWorkRequestId);
            return {
                response: createAdvancedClusterFileSystemResponse,
                workRequestResponse: getWorkRequestResponse
            };
     ...
     */
    forCreateExadbVmCluster(request) {
        return __awaiter(this, void 0, void 0, function* () {
            const createExadbVmClusterResponse = yield this.client.createExadbVmCluster(request);
            if (createExadbVmClusterResponse.opcWorkRequestId === undefined)
                return { response: createExadbVmClusterResponse, workRequestResponse: undefined };
            const getWorkRequestResponse = yield oci_workrequests_1.waitForWorkRequest(this.config, this.workRequestClient, createExadbVmClusterResponse.opcWorkRequestId);
     ...
     */
    forCreateExascaleDbStorageVault(request) {
        return __awaiter(this, void 0, void 0, function* () {
            const createExascaleDbStorageVaultResponse = yield this.client.createExascaleDbStorageVault(request);
            if (createExascaleDbStorageVaultResponse.opcWorkRequestId === undefined)
                return {
                    response: createExascaleDbStorageVaultResponse,
                    workRequestResponse: undefined
                };
            const getWorkRequestResponse = yield oci_workrequests_1.waitForWorkRequest(this.config, this.workRequestClient, createExascaleDbStorageVaultResponse.opcWorkRequestId);
            return {
                response: createExascaleDbStorageVaultResponse,
                workRequestResponse: getWorkRequestResponse
            };
     ...
     */
    forCreateExecutionAction(request) {
        return __awaiter(this, void 0, void 0, function* () {
            const createExecutionActionResponse = yield this.client.createExecutionAction(request);
            if (createExecutionActionResponse.opcWorkRequestId === undefined)
                return { response: createExecutionActionResponse, workRequestResponse: undefined };
            const getWorkRequestResponse = yield oci_workrequests_1.waitForWorkRequest(this.config, this.workRequestClient, createExecutionActionResponse.opcWorkRequestId);
     ...
     */
    forCreateExecutionWindow(request) {
        return __awaiter(this, void 0, void 0, function* () {
            const createExecutionWindowResponse = yield this.client.createExecutionWindow(request);
            if (createExecutionWindowResponse.opcWorkRequestId === undefined)
                return { response: createExecutionWindowResponse, workRequestResponse: undefined };
            const getWorkRequestResponse = yield oci_workrequests_1.waitForWorkRequest(this.config, this.workRequestClient, createExecutionWindowResponse.opcWorkRequestId);
     ...
     */
    forCreatePluggableDatabaseSnapshot(request) {
        return __awaiter(this, void 0, void 0, function* () {
            const createPluggableDatabaseSnapshotResponse = yield this.client.createPluggableDatabaseSnapshot(request);
            if (createPluggableDatabaseSnapshotResponse.opcWorkRequestId === undefined)
                return {
                    response: createPluggableDatabaseSnapshotResponse,
                    workRequestResponse: undefined
                };
            const getWorkRequestResponse = yield oci_workrequests_1.waitForWorkRequest(this.config, this.workRequestClient, createPluggableDatabaseSnapshotResponse.opcWorkRequestId);
            return {
                response: createPluggableDatabaseSnapshotResponse,
                workRequestResponse: getWorkRequestResponse
            };
     ...
     */
    forCreateScheduledAction(request) {
        return __awaiter(this, void 0, void 0, function* () {
            const createScheduledActionResponse = yield this.client.createScheduledAction(request);
            if (createScheduledActionResponse.opcWorkRequestId === undefined)
                return { response: createScheduledActionResponse, workRequestResponse: undefined };
            const getWorkRequestResponse = yield oci_workrequests_1.waitForWorkRequest(this.config, this.workRequestClient, createScheduledActionResponse.opcWorkRequestId);
     ...
     */
    forCreateSchedulingPlan(request) {
        return __awaiter(this, void 0, void 0, function* () {
            const createSchedulingPlanResponse = yield this.client.createSchedulingPlan(request);
            if (createSchedulingPlanResponse.opcWorkRequestId === undefined)
                return { response: createSchedulingPlanResponse, workRequestResponse: undefined };
            const getWorkRequestResponse = yield oci_workrequests_1.waitForWorkRequest(this.config, this.workRequestClient, createSchedulingPlanResponse.opcWorkRequestId);
     ...
     */
    forCreateSchedulingPolicy(request) {
        return __awaiter(this, void 0, void 0, function* () {
            const createSchedulingPolicyResponse = yield this.client.createSchedulingPolicy(request);
            if (createSchedulingPolicyResponse.opcWorkRequestId === undefined)
                return { response: createSchedulingPolicyResponse, workRequestResponse: undefined };
            const getWorkRequestResponse = yield oci_workrequests_1.waitForWorkRequest(this.config, this.workRequestClient, createSchedulingPolicyResponse.opcWorkRequestId);
            return {
     ...
     */
    forCreateSchedulingWindow(request) {
        return __awaiter(this, void 0, void 0, function* () {
            const createSchedulingWindowResponse = yield this.client.createSchedulingWindow(request);
            if (createSchedulingWindowResponse.opcWorkRequestId === undefined)
                return { response: createSchedulingWindowResponse, workRequestResponse: undefined };
            const getWorkRequestResponse = yield oci_workrequests_1.waitForWorkRequest(this.config, this.workRequestClient, createSchedulingWindowResponse.opcWorkRequestId);
            return {
     ...
     */
    forDeleteAdvancedClusterFileSystem(request) {
        return __awaiter(this, void 0, void 0, function* () {
            const deleteAdvancedClusterFileSystemResponse = yield this.client.deleteAdvancedClusterFileSystem(request);
            if (deleteAdvancedClusterFileSystemResponse.opcWorkRequestId === undefined)
                return {
                    response: deleteAdvancedClusterFileSystemResponse,
                    workRequestResponse: undefined
                };
            const getWorkRequestResponse = yield oci_workrequests_1.waitForWorkRequest(this.config, this.workRequestClient, deleteAdvancedClusterFileSystemResponse.opcWorkRequestId);
            return {
                response: deleteAdvancedClusterFileSystemResponse,
                workRequestResponse: getWorkRequestResponse
            };
     ...
     */
    forDeleteDbnodeSnapshot(request) {
        return __awaiter(this, void 0, void 0, function* () {
            const deleteDbnodeSnapshotResponse = yield this.client.deleteDbnodeSnapshot(request);
            if (deleteDbnodeSnapshotResponse.opcWorkRequestId === undefined)
                return { response: deleteDbnodeSnapshotResponse, workRequestResponse: undefined };
            const getWorkRequestResponse = yield oci_workrequests_1.waitForWorkRequest(this.config, this.workRequestClient, deleteDbnodeSnapshotResponse.opcWorkRequestId);
     ...
     */
    forDeleteExadbVmCluster(request) {
        return __awaiter(this, void 0, void 0, function* () {
            const deleteExadbVmClusterResponse = yield this.client.deleteExadbVmCluster(request);
            if (deleteExadbVmClusterResponse.opcWorkRequestId === undefined)
                return { response: deleteExadbVmClusterResponse, workRequestResponse: undefined };
            const getWorkRequestResponse = yield oci_workrequests_1.waitForWorkRequest(this.config, this.workRequestClient, deleteExadbVmClusterResponse.opcWorkRequestId);
     ...
     */
    forDeleteExascaleDbStorageVault(request) {
        return __awaiter(this, void 0, void 0, function* () {
            const deleteExascaleDbStorageVaultResponse = yield this.client.deleteExascaleDbStorageVault(request);
            if (deleteExascaleDbStorageVaultResponse.opcWorkRequestId === undefined)
                return {
                    response: deleteExascaleDbStorageVaultResponse,
                    workRequestResponse: undefined
                };
            const getWorkRequestResponse = yield oci_workrequests_1.waitForWorkRequest(this.config, this.workRequestClient, deleteExascaleDbStorageVaultResponse.opcWorkRequestId);
            return {
                response: deleteExascaleDbStorageVaultResponse,
                workRequestResponse: getWorkRequestResponse
            };
     ...
     */
    forDeleteExecutionAction(request) {
        return __awaiter(this, void 0, void 0, function* () {
            const deleteExecutionActionResponse = yield this.client.deleteExecutionAction(request);
            if (deleteExecutionActionResponse.opcWorkRequestId === undefined)
                return { response: deleteExecutionActionResponse, workRequestResponse: undefined };
            const getWorkRequestResponse = yield oci_workrequests_1.waitForWorkRequest(this.config, this.workRequestClient, deleteExecutionActionResponse.opcWorkRequestId);
     ...
     */
    forDeletePluggableDatabaseSnapshot(request) {
        return __awaiter(this, void 0, void 0, function* () {
            const deletePluggableDatabaseSnapshotResponse = yield this.client.deletePluggableDatabaseSnapshot(request);
            if (deletePluggableDatabaseSnapshotResponse.opcWorkRequestId === undefined)
                return {
                    response: deletePluggableDatabaseSnapshotResponse,
                    workRequestResponse: undefined
                };
            const getWorkRequestResponse = yield oci_workrequests_1.waitForWorkRequest(this.config, this.workRequestClient, deletePluggableDatabaseSnapshotResponse.opcWorkRequestId);
            return {
                response: deletePluggableDatabaseSnapshotResponse,
                workRequestResponse: getWorkRequestResponse
            };
     ...
     */
    forDeleteScheduledAction(request) {
        return __awaiter(this, void 0, void 0, function* () {
            const deleteScheduledActionResponse = yield this.client.deleteScheduledAction(request);
            if (deleteScheduledActionResponse.opcWorkRequestId === undefined)
                return { response: deleteScheduledActionResponse, workRequestResponse: undefined };
            const getWorkRequestResponse = yield oci_workrequests_1.waitForWorkRequest(this.config, this.workRequestClient, deleteScheduledActionResponse.opcWorkRequestId);
     ...
     */
    forDeleteSchedulingPlan(request) {
        return __awaiter(this, void 0, void 0, function* () {
            const deleteSchedulingPlanResponse = yield this.client.deleteSchedulingPlan(request);
            if (deleteSchedulingPlanResponse.opcWorkRequestId === undefined)
                return { response: deleteSchedulingPlanResponse, workRequestResponse: undefined };
            const getWorkRequestResponse = yield oci_workrequests_1.waitForWorkRequest(this.config, this.workRequestClient, deleteSchedulingPlanResponse.opcWorkRequestId);
     ...
     */
    forEditAutonomousContainerDatabaseDataguard(request) {
        return __awaiter(this, void 0, void 0, function* () {
            const editAutonomousContainerDatabaseDataguardResponse = yield this.client.editAutonomousContainerDatabaseDataguard(request);
            ...
            const getWorkRequestResponse = yield oci_workrequests_1.waitForWorkRequest(this.config, this.workRequestClient, editAutonomousContainerDatabaseDataguardResponse.opcWorkRequestId);
            return {
                response: editAutonomousContainerDatabaseDataguardResponse,
                workRequestResponse: getWorkRequestResponse
            };
     ...
     */
    forExecuteDbSystemOsPatch(request) {
        return __awaiter(this, void 0, void 0, function* () {
            const executeDbSystemOsPatchResponse = yield this.client.executeDbSystemOsPatch(request);
            if (executeDbSystemOsPatchResponse.opcWorkRequestId === undefined)
                return { response: executeDbSystemOsPatchResponse, workRequestResponse: undefined };
            const getWorkRequestResponse = yield oci_workrequests_1.waitForWorkRequest(this.config, this.workRequestClient, executeDbSystemOsPatchResponse.opcWorkRequestId);
            return {
     ...
     */
    forFailoverAutonomousContainerDatabaseDataguard(request) {
        return __awaiter(this, void 0, void 0, function* () {
            const failoverAutonomousContainerDatabaseDataguardResponse = yield this.client.failoverAutonomousContainerDatabaseDataguard(request);
            ...
            const getWorkRequestResponse = yield oci_workrequests_1.waitForWorkRequest(this.config, this.workRequestClient, failoverAutonomousContainerDatabaseDataguardResponse.opcWorkRequestId);
            return {
                response: failoverAutonomousContainerDatabaseDataguardResponse,
                workRequestResponse: getWorkRequestResponse
            };
     ...
     */
    forFailoverDataGuard(request) {
        return __awaiter(this, void 0, void 0, function* () {
            const failoverDataGuardResponse = yield this.client.failoverDataGuard(request);
            if (failoverDataGuardResponse.opcWorkRequestId === undefined)
                return { response: failoverDataGuardResponse, workRequestResponse: undefined };
            const getWorkRequestResponse = yield oci_workrequests_1.waitForWorkRequest(this.config, this.workRequestClient, failoverDataGuardResponse.opcWorkRequestId);
     ...
     */
    forAdvancedClusterFileSystem(request, ...targetStates) {
        return __awaiter(this, void 0, void 0, function* () {
            return oci_common_1.genericTerminalConditionWaiter(this.config, () => this.client.getAdvancedClusterFileSystem(request), response => targetStates.includes(response.advancedClusterFileSystem.lifecycleState), targetStates.includes(models.AdvancedClusterFileSystem.LifecycleState.Deleted));
        });
    }
    /**
    ...
    /**
     * Waits forDbConnectionBundle till it reaches any of the provided states
     *
     * @param request the request to send
     * @param targetStates the desired states to wait for. The waiter will return once the resource reaches any of the provided states
     * @return response returns GetDbConnectionBundleResponse | null (null in case of 404 response)
     */
    forDbConnectionBundle(request, ...targetStates) {
        return __awaiter(this, void 0, void 0, function* () {
            return oci_common_1.genericTerminalConditionWaiter(this.config, () => this.client.getDbConnectionBundle(request), response => targetStates.includes(response.dbConnectionBundle.lifecycleState), targetStates.includes(models.DbConnectionBundle.LifecycleState.Deleted));
        });
    }
    /**
     ...
     */
    forDbSystemOsPatchHistoryEntry(request, ...targetStates) {
        return __awaiter(this, void 0, void 0, function* () {
            return oci_common_1.genericWaiter(this.config, () => this.client.getDbSystemOsPatchHistoryEntry(request), response => targetStates.includes(response.dbSystemOsPatchHistoryEntry.lifecycleState));
        });
    }
    /**
     ...
     */
    forDbnodeSnapshot(request, ...targetStates) {
        return __awaiter(this, void 0, void 0, function* () {
            return oci_common_1.genericTerminalConditionWaiter(this.config, () => this.client.getDbnodeSnapshot(request), response => targetStates.includes(response.dbnodeSnapshot.lifecycleState), targetStates.includes(models.DbnodeSnapshot.LifecycleState.Terminated));
        });
    }
    /**
     ...
     */
    forExadbVmCluster(request, ...targetStates) {
        return __awaiter(this, void 0, void 0, function* () {
            return oci_common_1.genericTerminalConditionWaiter(this.config, () => this.client.getExadbVmCluster(request), response => targetStates.includes(response.exadbVmCluster.lifecycleState), targetStates.includes(models.ExadbVmCluster.LifecycleState.Terminated));
        });
    }
    /**
     ...
     */
    forExadbVmClusterUpdate(request, ...targetStates) {
        return __awaiter(this, void 0, void 0, function* () {
            return oci_common_1.genericWaiter(this.config, () => this.client.getExadbVmClusterUpdate(request), response => targetStates.includes(response.exadbVmClusterUpdate.lifecycleState));
        });
    }
    /**
     ...
     */
    forExadbVmClusterUpdateHistoryEntry(request, ...targetStates) {
        return __awaiter(this, void 0, void 0, function* () {
            return oci_common_1.genericWaiter(this.config, () => this.client.getExadbVmClusterUpdateHistoryEntry(request), response => targetStates.includes(response.exadbVmClusterUpdateHistoryEntry.lifecycleState));
        });
    }
    /**
     ...
     */
    forExascaleDbStorageVault(request, ...targetStates) {
        return __awaiter(this, void 0, void 0, function* () {
            return oci_common_1.genericTerminalConditionWaiter(this.config, () => this.client.getExascaleDbStorageVault(request), response => targetStates.includes(response.exascaleDbStorageVault.lifecycleState), targetStates.includes(models.ExascaleDbStorageVault.LifecycleState.Terminated));
        });
    }
    /**
     ...
     */
    forExecutionAction(request, ...targetStates) {
        return __awaiter(this, void 0, void 0, function* () {
            return oci_common_1.genericTerminalConditionWaiter(this.config, () => this.client.getExecutionAction(request), response => targetStates.includes(response.executionAction.lifecycleState), targetStates.includes(models.ExecutionAction.LifecycleState.Deleted));
        });
    }
    /**
     ...
     */
    forExecutionWindow(request, ...targetStates) {
        return __awaiter(this, void 0, void 0, function* () {
            return oci_common_1.genericTerminalConditionWaiter(this.config, () => this.client.getExecutionWindow(request), response => targetStates.includes(response.executionWindow.lifecycleState), targetStates.includes(models.ExecutionWindow.LifecycleState.Deleted));
        });
    }
    /**
     ...
     */
    forPluggableDatabaseSnapshot(request, ...targetStates) {
        return __awaiter(this, void 0, void 0, function* () {
            return oci_common_1.genericTerminalConditionWaiter(this.config, () => this.client.getPluggableDatabaseSnapshot(request), response => targetStates.includes(response.pluggableDatabaseSnapshot.lifecycleState), targetStates.includes(models.PluggableDatabaseSnapshot.LifecycleState.Terminated));
        });
    }
    /**
     ...
     */
    forScheduledAction(request, ...targetStates) {
        return __awaiter(this, void 0, void 0, function* () {
            return oci_common_1.genericTerminalConditionWaiter(this.config, () => this.client.getScheduledAction(request), response => targetStates.includes(response.scheduledAction.lifecycleState), targetStates.includes(models.ScheduledAction.LifecycleState.Deleted));
        });
    }
    /**
     ...
     */
    forSchedulingPlan(request, ...targetStates) {
        return __awaiter(this, void 0, void 0, function* () {
            return oci_common_1.genericTerminalConditionWaiter(this.config, () => this.client.getSchedulingPlan(request), response => targetStates.includes(response.schedulingPlan.lifecycleState), targetStates.includes(models.SchedulingPlan.LifecycleState.Deleted));
        });
    }
    /**
     ...
     */
    forSchedulingPolicy(request, ...targetStates) {
        return __awaiter(this, void 0, void 0, function* () {
            return oci_common_1.genericTerminalConditionWaiter(this.config, () => this.client.getSchedulingPolicy(request), response => targetStates.includes(response.schedulingPolicy.lifecycleState), targetStates.includes(models.SchedulingPolicy.LifecycleState.Deleted));
        });
    }
    /**
     ...
     */
    forSchedulingWindow(request, ...targetStates) {
        return __awaiter(this, void 0, void 0, function* () {
            return oci_common_1.genericTerminalConditionWaiter(this.config, () => this.client.getSchedulingWindow(request), response => targetStates.includes(response.schedulingWindow.lifecycleState), targetStates.includes(models.SchedulingWindow.LifecycleState.Deleted));
        });
    }
    /**
    ...
    /**
     * Waits forImportTransportableTablespace
     *
     * @param request the request to send
     * @return response returns ImportTransportableTablespaceResponse, GetWorkRequestResponse tuple
     */
    forImportTransportableTablespace(request) {
        return __awaiter(this, void 0, void 0, function* () {
            const importTransportableTablespaceResponse = yield this.client.importTransportableTablespace(request);
            if (importTransportableTablespaceResponse.opcWorkRequestId === undefined)
                return {
                    response: importTransportableTablespaceResponse,
                    workRequestResponse: undefined
                };
            const getWorkRequestResponse = yield oci_workrequests_1.waitForWorkRequest(this.config, this.workRequestClient, importTransportableTablespaceResponse.opcWorkRequestId);
            return {
                response: importTransportableTablespaceResponse,
                workRequestResponse: getWorkRequestResponse
            };
     ...
     */
    forMigrateAutonomousContainerDatabaseDataguardAssociation(request) {
        return __awaiter(this, void 0, void 0, function* () {
            const migrateAutonomousContainerDatabaseDataguardAssociationResponse = yield this.client.migrateAutonomousContainerDatabaseDataguardAssociation(request);
            if (migrateAutonomousContainerDatabaseDataguardAssociationResponse.opcWorkRequestId === undefined)
                return {
                    response: migrateAutonomousContainerDatabaseDataguardAssociationResponse,
                    workRequestResponse: undefined
                };
            const getWorkRequestResponse = yield oci_workrequests_1.waitForWorkRequest(this.config, this.workRequestClient, migrateAutonomousContainerDatabaseDataguardAssociationResponse.opcWorkRequestId);
            return {
                response: migrateAutonomousContainerDatabaseDataguardAssociationResponse,
                workRequestResponse: getWorkRequestResponse
            };
     ...
     */
    forMigrateDataGuardAssociationToMultiDataGuards(request) {
        return __awaiter(this, void 0, void 0, function* () {
            const migrateDataGuardAssociationToMultiDataGuardsResponse = yield this.client.migrateDataGuardAssociationToMultiDataGuards(request);
            ...
            const getWorkRequestResponse = yield oci_workrequests_1.waitForWorkRequest(this.config, this.workRequestClient, migrateDataGuardAssociationToMultiDataGuardsResponse.opcWorkRequestId);
            return {
                response: migrateDataGuardAssociationToMultiDataGuardsResponse,
                workRequestResponse: getWorkRequestResponse
            };
     ...
     */
    forMountAdvancedClusterFileSystem(request) {
        return __awaiter(this, void 0, void 0, function* () {
            const mountAdvancedClusterFileSystemResponse = yield this.client.mountAdvancedClusterFileSystem(request);
            if (mountAdvancedClusterFileSystemResponse.opcWorkRequestId === undefined)
                return {
                    response: mountAdvancedClusterFileSystemResponse,
                    workRequestResponse: undefined
                };
            const getWorkRequestResponse = yield oci_workrequests_1.waitForWorkRequest(this.config, this.workRequestClient, mountAdvancedClusterFileSystemResponse.opcWorkRequestId);
            return {
                response: mountAdvancedClusterFileSystemResponse,
                workRequestResponse: getWorkRequestResponse
            };
     ...
     */
    forMountDbnodeSnapshot(request) {
        return __awaiter(this, void 0, void 0, function* () {
            const mountDbnodeSnapshotResponse = yield this.client.mountDbnodeSnapshot(request);
            if (mountDbnodeSnapshotResponse.opcWorkRequestId === undefined)
                return { response: mountDbnodeSnapshotResponse, workRequestResponse: undefined };
            const getWorkRequestResponse = yield oci_workrequests_1.waitForWorkRequest(this.config, this.workRequestClient, mountDbnodeSnapshotResponse.opcWorkRequestId);
     ...
     */
    forMoveExecutionActionMember(request) {
        return __awaiter(this, void 0, void 0, function* () {
            const moveExecutionActionMemberResponse = yield this.client.moveExecutionActionMember(request);
            if (moveExecutionActionMemberResponse.opcWorkRequestId === undefined)
                return { response: moveExecutionActionMemberResponse, workRequestResponse: undefined };
            const getWorkRequestResponse = yield oci_workrequests_1.waitForWorkRequest(this.config, this.workRequestClient, moveExecutionActionMemberResponse.opcWorkRequestId);
            return {
     ...
     */
    forRefreshDataGuardHealthStatus(request) {
        return __awaiter(this, void 0, void 0, function* () {
            const refreshDataGuardHealthStatusResponse = yield this.client.refreshDataGuardHealthStatus(request);
            if (refreshDataGuardHealthStatusResponse.opcWorkRequestId === undefined)
                return {
                    response: refreshDataGuardHealthStatusResponse,
                    workRequestResponse: undefined
                };
            const getWorkRequestResponse = yield oci_workrequests_1.waitForWorkRequest(this.config, this.workRequestClient, refreshDataGuardHealthStatusResponse.opcWorkRequestId);
            return {
                response: refreshDataGuardHealthStatusResponse,
                workRequestResponse: getWorkRequestResponse
            };
    ...
    /**
     * Waits forRegisterCloudAutonomousVmClusterPkcs
     *
     * @param request the request to send
     * @return response returns RegisterCloudAutonomousVmClusterPkcsResponse, GetWorkRequestResponse tuple
     */
    forRegisterCloudAutonomousVmClusterPkcs(request) {
        return __awaiter(this, void 0, void 0, function* () {
            const registerCloudAutonomousVmClusterPkcsResponse = yield this.client.registerCloudAutonomousVmClusterPkcs(request);
            if (registerCloudAutonomousVmClusterPkcsResponse.opcWorkRequestId === undefined)
                return {
                    response: registerCloudAutonomousVmClusterPkcsResponse,
                    workRequestResponse: undefined
                };
            const getWorkRequestResponse = yield oci_workrequests_1.waitForWorkRequest(this.config, this.workRequestClient, registerCloudAutonomousVmClusterPkcsResponse.opcWorkRequestId);
            return {
                response: registerCloudAutonomousVmClusterPkcsResponse,
                workRequestResponse: getWorkRequestResponse
            };
     ...
     */
    forRegisterCloudVmClusterPkcs(request) {
        return __awaiter(this, void 0, void 0, function* () {
            const registerCloudVmClusterPkcsResponse = yield this.client.registerCloudVmClusterPkcs(request);
            if (registerCloudVmClusterPkcsResponse.opcWorkRequestId === undefined)
                return {
                    response: registerCloudVmClusterPkcsResponse,
                    workRequestResponse: undefined
                };
            const getWorkRequestResponse = yield oci_workrequests_1.waitForWorkRequest(this.config, this.workRequestClient, registerCloudVmClusterPkcsResponse.opcWorkRequestId);
            return {
                response: registerCloudVmClusterPkcsResponse,
                workRequestResponse: getWorkRequestResponse
            };
     ...
     */
    forReinstateAutonomousContainerDatabaseDataguard(request) {
        return __awaiter(this, void 0, void 0, function* () {
            const reinstateAutonomousContainerDatabaseDataguardResponse = yield this.client.reinstateAutonomousContainerDatabaseDataguard(request);
            ...
            const getWorkRequestResponse = yield oci_workrequests_1.waitForWorkRequest(this.config, this.workRequestClient, reinstateAutonomousContainerDatabaseDataguardResponse.opcWorkRequestId);
            return {
                response: reinstateAutonomousContainerDatabaseDataguardResponse,
                workRequestResponse: getWorkRequestResponse
            };
     ...
     */
    forReinstateDataGuard(request) {
        return __awaiter(this, void 0, void 0, function* () {
            const reinstateDataGuardResponse = yield this.client.reinstateDataGuard(request);
            if (reinstateDataGuardResponse.opcWorkRequestId === undefined)
                return { response: reinstateDataGuardResponse, workRequestResponse: undefined };
            const getWorkRequestResponse = yield oci_workrequests_1.waitForWorkRequest(this.config, this.workRequestClient, reinstateDataGuardResponse.opcWorkRequestId);
     ...
     */
    forRemoveVirtualMachineFromExadbVmCluster(request) {
        return __awaiter(this, void 0, void 0, function* () {
            const removeVirtualMachineFromExadbVmClusterResponse = yield this.client.removeVirtualMachineFromExadbVmCluster(request);
            ...
            const getWorkRequestResponse = yield oci_workrequests_1.waitForWorkRequest(this.config, this.workRequestClient, removeVirtualMachineFromExadbVmClusterResponse.opcWorkRequestId);
            return {
                response: removeVirtualMachineFromExadbVmClusterResponse,
                workRequestResponse: getWorkRequestResponse
            };
     ...
     */
    forReorderExecutionActions(request) {
        return __awaiter(this, void 0, void 0, function* () {
            const reorderExecutionActionsResponse = yield this.client.reorderExecutionActions(request);
            if (reorderExecutionActionsResponse.opcWorkRequestId === undefined)
                return { response: reorderExecutionActionsResponse, workRequestResponse: undefined };
            const getWorkRequestResponse = yield oci_workrequests_1.waitForWorkRequest(this.config, this.workRequestClient, reorderExecutionActionsResponse.opcWorkRequestId);
            return {
     ...
     */
    forReorderScheduledActions(request) {
        return __awaiter(this, void 0, void 0, function* () {
            const reorderScheduledActionsResponse = yield this.client.reorderScheduledActions(request);
            if (reorderScheduledActionsResponse.opcWorkRequestId === undefined)
                return { response: reorderScheduledActionsResponse, workRequestResponse: undefined };
            const getWorkRequestResponse = yield oci_workrequests_1.waitForWorkRequest(this.config, this.workRequestClient, reorderScheduledActionsResponse.opcWorkRequestId);
            return {
    ...
    /**
     * Waits forRunDataPatch
     *
     * @param request the request to send
     * @return response returns RunDataPatchResponse, GetWorkRequestResponse tuple
     */
    forRunDataPatch(request) {
        return __awaiter(this, void 0, void 0, function* () {
            const runDataPatchResponse = yield this.client.runDataPatch(request);
            if (runDataPatchResponse.opcWorkRequestId === undefined)
                return { response: runDataPatchResponse, workRequestResponse: undefined };
            const getWorkRequestResponse = yield oci_workrequests_1.waitForWorkRequest(this.config, this.workRequestClient, runDataPatchResponse.opcWorkRequestId);
            return { response: runDataPatchResponse, workRequestResponse: getWorkRequestResponse };
        });
    }
    /**
     ...
     */
    forSetDbKeyVersion(request) {
        return __awaiter(this, void 0, void 0, function* () {
            const setDbKeyVersionResponse = yield this.client.setDbKeyVersion(request);
            if (setDbKeyVersionResponse.opcWorkRequestId === undefined)
                return { response: setDbKeyVersionResponse, workRequestResponse: undefined };
            const getWorkRequestResponse = yield oci_workrequests_1.waitForWorkRequest(this.config, this.workRequestClient, setDbKeyVersionResponse.opcWorkRequestId);
     ...
     */
    forSetPdbKeyVersion(request) {
        return __awaiter(this, void 0, void 0, function* () {
            const setPdbKeyVersionResponse = yield this.client.setPdbKeyVersion(request);
            if (setPdbKeyVersionResponse.opcWorkRequestId === undefined)
                return { response: setPdbKeyVersionResponse, workRequestResponse: undefined };
            const getWorkRequestResponse = yield oci_workrequests_1.waitForWorkRequest(this.config, this.workRequestClient, setPdbKeyVersionResponse.opcWorkRequestId);
     ...
     */
    forSwitchOverDataGuard(request) {
        return __awaiter(this, void 0, void 0, function* () {
            const switchOverDataGuardResponse = yield this.client.switchOverDataGuard(request);
            if (switchOverDataGuardResponse.opcWorkRequestId === undefined)
                return { response: switchOverDataGuardResponse, workRequestResponse: undefined };
            const getWorkRequestResponse = yield oci_workrequests_1.waitForWorkRequest(this.config, this.workRequestClient, switchOverDataGuardResponse.opcWorkRequestId);
     ...
     */
    forSwitchoverAutonomousContainerDatabaseDataguard(request) {
        return __awaiter(this, void 0, void 0, function* () {
            const switchoverAutonomousContainerDatabaseDataguardResponse = yield this.client.switchoverAutonomousContainerDatabaseDataguard(request);
            ...
            const getWorkRequestResponse = yield oci_workrequests_1.waitForWorkRequest(this.config, this.workRequestClient, switchoverAutonomousContainerDatabaseDataguardResponse.opcWorkRequestId);
            return {
                response: switchoverAutonomousContainerDatabaseDataguardResponse,
                workRequestResponse: getWorkRequestResponse
            };
     ...
     */
    forUnmountAdvancedClusterFileSystem(request) {
        return __awaiter(this, void 0, void 0, function* () {
            const unmountAdvancedClusterFileSystemResponse = yield this.client.unmountAdvancedClusterFileSystem(request);
            if (unmountAdvancedClusterFileSystemResponse.opcWorkRequestId === undefined)
                return {
                    response: unmountAdvancedClusterFileSystemResponse,
                    workRequestResponse: undefined
                };
            const getWorkRequestResponse = yield oci_workrequests_1.waitForWorkRequest(this.config, this.workRequestClient, unmountAdvancedClusterFileSystemResponse.opcWorkRequestId);
            return {
                response: unmountAdvancedClusterFileSystemResponse,
                workRequestResponse: getWorkRequestResponse
            };
     ...
     */
    forUnmountDbnodeSnapshot(request) {
        return __awaiter(this, void 0, void 0, function* () {
            const unmountDbnodeSnapshotResponse = yield this.client.unmountDbnodeSnapshot(request);
            if (unmountDbnodeSnapshotResponse.opcWorkRequestId === undefined)
                return { response: unmountDbnodeSnapshotResponse, workRequestResponse: undefined };
            const getWorkRequestResponse = yield oci_workrequests_1.waitForWorkRequest(this.config, this.workRequestClient, unmountDbnodeSnapshotResponse.opcWorkRequestId);
            return { response: unmountDbnodeSnapshotResponse, workRequestResponse: getWorkRequestResponse };
        });
    }
    /**
     * Waits forUnregisterCloudAutonomousVmClusterPkcs
     *
     * @param request the request to send
     * @return response returns UnregisterCloudAutonomousVmClusterPkcsResponse, GetWorkRequestResponse tuple
     */
    forUnregisterCloudAutonomousVmClusterPkcs(request) {
        return __awaiter(this, void 0, void 0, function* () {
            const unregisterCloudAutonomousVmClusterPkcsResponse = yield this.client.unregisterCloudAutonomousVmClusterPkcs(request);
            if (unregisterCloudAutonomousVmClusterPkcsResponse.opcWorkRequestId === undefined)
                return {
                    response: unregisterCloudAutonomousVmClusterPkcsResponse,
                    workRequestResponse: undefined
                };
            const getWorkRequestResponse = yield oci_workrequests_1.waitForWorkRequest(this.config, this.workRequestClient, unregisterCloudAutonomousVmClusterPkcsResponse.opcWorkRequestId);
            return {
                response: unregisterCloudAutonomousVmClusterPkcsResponse,
                workRequestResponse: getWorkRequestResponse
            };
     ...
     */
    forUnregisterCloudVmClusterPkcs(request) {
        return __awaiter(this, void 0, void 0, function* () {
            const unregisterCloudVmClusterPkcsResponse = yield this.client.unregisterCloudVmClusterPkcs(request);
            if (unregisterCloudVmClusterPkcsResponse.opcWorkRequestId === undefined)
                return {
                    response: unregisterCloudVmClusterPkcsResponse,
                    workRequestResponse: undefined
                };
            const getWorkRequestResponse = yield oci_workrequests_1.waitForWorkRequest(this.config, this.workRequestClient, unregisterCloudVmClusterPkcsResponse.opcWorkRequestId);
            return {
                response: unregisterCloudVmClusterPkcsResponse,
                workRequestResponse: getWorkRequestResponse
            };
     ...
     */
    forUpdateAdvancedClusterFileSystem(request) {
        return __awaiter(this, void 0, void 0, function* () {
            const updateAdvancedClusterFileSystemResponse = yield this.client.updateAdvancedClusterFileSystem(request);
            if (updateAdvancedClusterFileSystemResponse.opcWorkRequestId === undefined)
                return {
                    response: updateAdvancedClusterFileSystemResponse,
                    workRequestResponse: undefined
                };
            const getWorkRequestResponse = yield oci_workrequests_1.waitForWorkRequest(this.config, this.workRequestClient, updateAdvancedClusterFileSystemResponse.opcWorkRequestId);
            return {
                response: updateAdvancedClusterFileSystemResponse,
                workRequestResponse: getWorkRequestResponse
            };
     ...
     */
    forUpdateBackup(request) {
        return __awaiter(this, void 0, void 0, function* () {
            const updateBackupResponse = yield this.client.updateBackup(request);
            if (updateBackupResponse.opcWorkRequestId === undefined)
                return { response: updateBackupResponse, workRequestResponse: undefined };
            const getWorkRequestResponse = yield oci_workrequests_1.waitForWorkRequest(this.config, this.workRequestClient, updateBackupResponse.opcWorkRequestId);
     ...
     */
    forUpdateDataGuard(request) {
        return __awaiter(this, void 0, void 0, function* () {
            const updateDataGuardResponse = yield this.client.updateDataGuard(request);
            if (updateDataGuardResponse.opcWorkRequestId === undefined)
                return { response: updateDataGuardResponse, workRequestResponse: undefined };
            const getWorkRequestResponse = yield oci_workrequests_1.waitForWorkRequest(this.config, this.workRequestClient, updateDataGuardResponse.opcWorkRequestId);
     ...
     */
    forUpdateExadbVmCluster(request) {
        return __awaiter(this, void 0, void 0, function* () {
            const updateExadbVmClusterResponse = yield this.client.updateExadbVmCluster(request);
            if (updateExadbVmClusterResponse.opcWorkRequestId === undefined)
                return { response: updateExadbVmClusterResponse, workRequestResponse: undefined };
            const getWorkRequestResponse = yield oci_workrequests_1.waitForWorkRequest(this.config, this.workRequestClient, updateExadbVmClusterResponse.opcWorkRequestId);
     ...
     */
    forUpdateExascaleDbStorageVault(request) {
        return __awaiter(this, void 0, void 0, function* () {
            const updateExascaleDbStorageVaultResponse = yield this.client.updateExascaleDbStorageVault(request);
            if (updateExascaleDbStorageVaultResponse.opcWorkRequestId === undefined)
                return {
                    response: updateExascaleDbStorageVaultResponse,
                    workRequestResponse: undefined
                };
            const getWorkRequestResponse = yield oci_workrequests_1.waitForWorkRequest(this.config, this.workRequestClient, updateExascaleDbStorageVaultResponse.opcWorkRequestId);
            return {
                response: updateExascaleDbStorageVaultResponse,
                workRequestResponse: getWorkRequestResponse
            };
     ...
     */
    forUpdateExecutionAction(request) {
        return __awaiter(this, void 0, void 0, function* () {
            const updateExecutionActionResponse = yield this.client.updateExecutionAction(request);
            if (updateExecutionActionResponse.opcWorkRequestId === undefined)
                return { response: updateExecutionActionResponse, workRequestResponse: undefined };
            const getWorkRequestResponse = yield oci_workrequests_1.waitForWorkRequest(this.config, this.workRequestClient, updateExecutionActionResponse.opcWorkRequestId);
     ...
     */
    forUpdateExecutionWindow(request) {
        return __awaiter(this, void 0, void 0, function* () {
            const updateExecutionWindowResponse = yield this.client.updateExecutionWindow(request);
            if (updateExecutionWindowResponse.opcWorkRequestId === undefined)
                return { response: updateExecutionWindowResponse, workRequestResponse: undefined };
            const getWorkRequestResponse = yield oci_workrequests_1.waitForWorkRequest(this.config, this.workRequestClient, updateExecutionWindowResponse.opcWorkRequestId);
     ...
     */
    forUpdateScheduledAction(request) {
        return __awaiter(this, void 0, void 0, function* () {
            const updateScheduledActionResponse = yield this.client.updateScheduledAction(request);
            if (updateScheduledActionResponse.opcWorkRequestId === undefined)
                return { response: updateScheduledActionResponse, workRequestResponse: undefined };
            const getWorkRequestResponse = yield oci_workrequests_1.waitForWorkRequest(this.config, this.workRequestClient, updateScheduledActionResponse.opcWorkRequestId);
     ...
     */
    forUpdateSchedulingPolicy(request) {
        return __awaiter(this, void 0, void 0, function* () {
            const updateSchedulingPolicyResponse = yield this.client.updateSchedulingPolicy(request);
            if (updateSchedulingPolicyResponse.opcWorkRequestId === undefined)
                return { response: updateSchedulingPolicyResponse, workRequestResponse: undefined };
            const getWorkRequestResponse = yield oci_workrequests_1.waitForWorkRequest(this.config, this.workRequestClient, updateSchedulingPolicyResponse.opcWorkRequestId);
            return {
     ...
     */
    forUpdateSchedulingWindow(request) {
        return __awaiter(this, void 0, void 0, function* () {
            const updateSchedulingWindowResponse = yield this.client.updateSchedulingWindow(request);
            if (updateSchedulingWindowResponse.opcWorkRequestId === undefined)
                return { response: updateSchedulingWindowResponse, workRequestResponse: undefined };
            const getWorkRequestResponse = yield oci_workrequests_1.waitForWorkRequest(this.config, this.workRequestClient, updateSchedulingWindowResponse.opcWorkRequestId);
            return {

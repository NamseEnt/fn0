...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/database/ListDbSystemUpgradeHistoryEntries.ts.html |here} to see how to use ListDbSystemUpgradeHistoryEntriesRequest.
 */
...
export declare namespace ListDbSystemUpgradeHistoryEntriesRequest {
    enum SortOrder {
        Asc = "ASC",
        Desc = "DESC"
    }

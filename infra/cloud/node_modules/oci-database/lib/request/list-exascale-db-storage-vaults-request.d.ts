...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/database/ListExascaleDbStorageVaults.ts.html |here} to see how to use ListExascaleDbStorageVaultsRequest.
 */
export interface ListExascaleDbStorageVaultsRequest extends common.BaseRequest {
    /**
...
export declare namespace ListExascaleDbStorageVaultsRequest {
    enum SortBy {

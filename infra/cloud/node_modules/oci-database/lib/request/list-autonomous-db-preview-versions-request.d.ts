...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/database/ListAutonomousDbPreviewVersions.ts.html |here} to see how to use ListAutonomousDbPreviewVersionsRequest.
 */
...
export declare namespace ListAutonomousDbPreviewVersionsRequest {
    enum SortBy {

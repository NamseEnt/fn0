...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/database/ListMaintenanceRuns.ts.html |here} to see how to use ListMaintenanceRunsRequest.
 */
...
export declare namespace ListMaintenanceRunsRequest {
    enum SortBy {

...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/database/ListPluggableDatabases.ts.html |here} to see how to use ListPluggableDatabasesRequest.
 */
...
export declare namespace ListPluggableDatabasesRequest {
    enum SortBy {
        Pdbname = "PDBNAME",

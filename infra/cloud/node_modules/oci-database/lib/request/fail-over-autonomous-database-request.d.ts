...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/database/FailOverAutonomousDatabase.ts.html |here} to see how to use FailOverAutonomousDatabaseRequest.
 */
export interface FailOverAutonomousDatabaseRequest extends common.BaseRequest {
    /**

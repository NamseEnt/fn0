...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/database/ListAutonomousVmClusters.ts.html |here} to see how to use ListAutonomousVmClustersRequest.
 */
export interface ListAutonomousVmClustersRequest extends common.BaseRequest {
    /**
...
export declare namespace ListAutonomousVmClustersRequest {
    enum SortBy {

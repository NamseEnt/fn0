...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/database/ListVmClusterNetworks.ts.html |here} to see how to use ListVmClusterNetworksRequest.
 */
...
export declare namespace ListVmClusterNetworksRequest {
    enum SortBy {

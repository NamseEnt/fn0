...
import * as CancelExecutionWindowRequest from "./cancel-execution-window-request";
export import CancelExecutionWindowRequest = CancelExecutionWindowRequest.CancelExecutionWindowRequest;
import * as CascadingDeleteSchedulingPlanRequest from "./cascading-delete-scheduling-plan-request";
export import CascadingDeleteSchedulingPlanRequest = CascadingDeleteSchedulingPlanRequest.CascadingDeleteSchedulingPlanRequest;
...
import * as ChangeCloudAutonomousVmClusterSubscriptionRequest from "./change-cloud-autonomous-vm-cluster-subscription-request";
export import ChangeCloudAutonomousVmClusterSubscriptionRequest = ChangeCloudAutonomousVmClusterSubscriptionRequest.ChangeCloudAutonomousVmClusterSubscriptionRequest;
import * as ChangeCloudDbSystemSubscriptionRequest from "./change-cloud-db-system-subscription-request";
export import ChangeCloudDbSystemSubscriptionRequest = ChangeCloudDbSystemSubscriptionRequest.ChangeCloudDbSystemSubscriptionRequest;
...
import * as ChangeEncryptionKeyLocationRequest from "./change-encryption-key-location-request";
export import ChangeEncryptionKeyLocationRequest = ChangeEncryptionKeyLocationRequest.ChangeEncryptionKeyLocationRequest;
...
import * as ChangeSchedulingPlanCompartmentRequest from "./change-scheduling-plan-compartment-request";
export import ChangeSchedulingPlanCompartmentRequest = ChangeSchedulingPlanCompartmentRequest.ChangeSchedulingPlanCompartmentRequest;
import * as ChangeSchedulingPolicyCompartmentRequest from "./change-scheduling-policy-compartment-request";
export import ChangeSchedulingPolicyCompartmentRequest = ChangeSchedulingPolicyCompartmentRequest.ChangeSchedulingPolicyCompartmentRequest;
...
import * as CreateAutonomousContainerDatabaseDataguardAssociationRequest from "./create-autonomous-container-database-dataguard-association-request";
export import CreateAutonomousContainerDatabaseDataguardAssociationRequest = CreateAutonomousContainerDatabaseDataguardAssociationRequest.CreateAutonomousContainerDatabaseDataguardAssociationRequest;
...
import * as CreateExadbVmClusterRequest from "./create-exadb-vm-cluster-request";
export import CreateExadbVmClusterRequest = CreateExadbVmClusterRequest.CreateExadbVmClusterRequest;
import * as CreateExascaleDbStorageVaultRequest from "./create-exascale-db-storage-vault-request";
export import CreateExascaleDbStorageVaultRequest = CreateExascaleDbStorageVaultRequest.CreateExascaleDbStorageVaultRequest;
import * as CreateExecutionActionRequest from "./create-execution-action-request";
export import CreateExecutionActionRequest = CreateExecutionActionRequest.CreateExecutionActionRequest;
import * as CreateExecutionWindowRequest from "./create-execution-window-request";
export import CreateExecutionWindowRequest = CreateExecutionWindowRequest.CreateExecutionWindowRequest;
...
import * as CreatePluggableDatabaseSnapshotRequest from "./create-pluggable-database-snapshot-request";
export import CreatePluggableDatabaseSnapshotRequest = CreatePluggableDatabaseSnapshotRequest.CreatePluggableDatabaseSnapshotRequest;
import * as CreateScheduledActionRequest from "./create-scheduled-action-request";
export import CreateScheduledActionRequest = CreateScheduledActionRequest.CreateScheduledActionRequest;
import * as CreateSchedulingPlanRequest from "./create-scheduling-plan-request";
export import CreateSchedulingPlanRequest = CreateSchedulingPlanRequest.CreateSchedulingPlanRequest;
import * as CreateSchedulingPolicyRequest from "./create-scheduling-policy-request";
export import CreateSchedulingPolicyRequest = CreateSchedulingPolicyRequest.CreateSchedulingPolicyRequest;
import * as CreateSchedulingWindowRequest from "./create-scheduling-window-request";
export import CreateSchedulingWindowRequest = CreateSchedulingWindowRequest.CreateSchedulingWindowRequest;
...
export import DeleteExadbVmClusterRequest = DeleteExadbVmClusterRequest.DeleteExadbVmClusterRequest;
import * as DeleteExascaleDbStorageVaultRequest from "./delete-exascale-db-storage-vault-request";
export import DeleteExascaleDbStorageVaultRequest = DeleteExascaleDbStorageVaultRequest.DeleteExascaleDbStorageVaultRequest;
import * as DeleteExecutionActionRequest from "./delete-execution-action-request";
export import DeleteExecutionActionRequest = DeleteExecutionActionRequest.DeleteExecutionActionRequest;
import * as DeleteExecutionWindowRequest from "./delete-execution-window-request";
export import DeleteExecutionWindowRequest = DeleteExecutionWindowRequest.DeleteExecutionWindowRequest;
...
export import DeleteOneoffPatchRequest = DeleteOneoffPatchRequest.DeleteOneoffPatchRequest;
...
import * as DeletePluggableDatabaseSnapshotRequest from "./delete-pluggable-database-snapshot-request";
export import DeletePluggableDatabaseSnapshotRequest = DeletePluggableDatabaseSnapshotRequest.DeletePluggableDatabaseSnapshotRequest;
import * as DeleteScheduledActionRequest from "./delete-scheduled-action-request";
export import DeleteScheduledActionRequest = DeleteScheduledActionRequest.DeleteScheduledActionRequest;
import * as DeleteSchedulingPlanRequest from "./delete-scheduling-plan-request";
export import DeleteSchedulingPlanRequest = DeleteSchedulingPlanRequest.DeleteSchedulingPlanRequest;
import * as DeleteSchedulingPolicyRequest from "./delete-scheduling-policy-request";
export import DeleteSchedulingPolicyRequest = DeleteSchedulingPolicyRequest.DeleteSchedulingPolicyRequest;
import * as DeleteSchedulingWindowRequest from "./delete-scheduling-window-request";
export import DeleteSchedulingWindowRequest = DeleteSchedulingWindowRequest.DeleteSchedulingWindowRequest;
...
import * as DisablePluggableDatabaseManagementRequest from "./disable-pluggable-database-management-request";
export import DisablePluggableDatabaseManagementRequest = DisablePluggableDatabaseManagementRequest.DisablePluggableDatabaseManagementRequest;
import * as DownloadDbConnectionBundleRequest from "./download-db-connection-bundle-request";
export import DownloadDbConnectionBundleRequest = DownloadDbConnectionBundleRequest.DownloadDbConnectionBundleRequest;
...
import * as DownloadOneoffPatchRequest from "./download-oneoff-patch-request";
export import DownloadOneoffPatchRequest = DownloadOneoffPatchRequest.DownloadOneoffPatchRequest;
...
import * as EnablePluggableDatabaseManagementRequest from "./enable-pluggable-database-management-request";
...
import * as ExecuteDbSystemOsPatchRequest from "./execute-db-system-os-patch-request";
export import ExecuteDbSystemOsPatchRequest = ExecuteDbSystemOsPatchRequest.ExecuteDbSystemOsPatchRequest;
...
export import FailoverDataGuardRequest = FailoverDataGuardRequest.FailoverDataGuardRequest;
...
import * as GetAutonomousVirtualMachineRequest from "./get-autonomous-virtual-machine-request";
...
import * as GetDbConnectionBundleRequest from "./get-db-connection-bundle-request";
export import GetDbConnectionBundleRequest = GetDbConnectionBundleRequest.GetDbConnectionBundleRequest;
...
import * as GetDbSystemOsPatchHistoryEntryRequest from "./get-db-system-os-patch-history-entry-request";
export import GetDbSystemOsPatchHistoryEntryRequest = GetDbSystemOsPatchHistoryEntryRequest.GetDbSystemOsPatchHistoryEntryRequest;
...
import * as GetExadbVmClusterRequest from "./get-exadb-vm-cluster-request";
export import GetExadbVmClusterRequest = GetExadbVmClusterRequest.GetExadbVmClusterRequest;
import * as GetExadbVmClusterUpdateRequest from "./get-exadb-vm-cluster-update-request";
export import GetExadbVmClusterUpdateRequest = GetExadbVmClusterUpdateRequest.GetExadbVmClusterUpdateRequest;
import * as GetExadbVmClusterUpdateHistoryEntryRequest from "./get-exadb-vm-cluster-update-history-entry-request";
export import GetExadbVmClusterUpdateHistoryEntryRequest = GetExadbVmClusterUpdateHistoryEntryRequest.GetExadbVmClusterUpdateHistoryEntryRequest;
import * as GetExascaleDbStorageVaultRequest from "./get-exascale-db-storage-vault-request";
export import GetExascaleDbStorageVaultRequest = GetExascaleDbStorageVaultRequest.GetExascaleDbStorageVaultRequest;
import * as GetExecutionActionRequest from "./get-execution-action-request";
export import GetExecutionActionRequest = GetExecutionActionRequest.GetExecutionActionRequest;
import * as GetExecutionWindowRequest from "./get-execution-window-request";
export import GetExecutionWindowRequest = GetExecutionWindowRequest.GetExecutionWindowRequest;
...
import * as GetOneoffPatchRequest from "./get-oneoff-patch-request";
export import GetOneoffPatchRequest = GetOneoffPatchRequest.GetOneoffPatchRequest;
...
import * as GetPluggableDatabaseSnapshotRequest from "./get-pluggable-database-snapshot-request";
export import GetPluggableDatabaseSnapshotRequest = GetPluggableDatabaseSnapshotRequest.GetPluggableDatabaseSnapshotRequest;
import * as GetScheduledActionRequest from "./get-scheduled-action-request";
export import GetScheduledActionRequest = GetScheduledActionRequest.GetScheduledActionRequest;
import * as GetSchedulingPlanRequest from "./get-scheduling-plan-request";
export import GetSchedulingPlanRequest = GetSchedulingPlanRequest.GetSchedulingPlanRequest;
import * as GetSchedulingPolicyRequest from "./get-scheduling-policy-request";
export import GetSchedulingPolicyRequest = GetSchedulingPolicyRequest.GetSchedulingPolicyRequest;
import * as GetSchedulingWindowRequest from "./get-scheduling-window-request";
export import GetSchedulingWindowRequest = GetSchedulingWindowRequest.GetSchedulingWindowRequest;
...
import * as ImportTransportableTablespaceRequest from "./import-transportable-tablespace-request";
export import ImportTransportableTablespaceRequest = ImportTransportableTablespaceRequest.ImportTransportableTablespaceRequest;
...
import * as ListDbConnectionBundlesRequest from "./list-db-connection-bundles-request";
export import ListDbConnectionBundlesRequest = ListDbConnectionBundlesRequest.ListDbConnectionBundlesRequest;
...
import * as ListDbSystemOsPatchHistoryEntriesRequest from "./list-db-system-os-patch-history-entries-request";
export import ListDbSystemOsPatchHistoryEntriesRequest = ListDbSystemOsPatchHistoryEntriesRequest.ListDbSystemOsPatchHistoryEntriesRequest;
...
export import ListExadbVmClusterUpdateHistoryEntriesRequest = ListExadbVmClusterUpdateHistoryEntriesRequest.ListExadbVmClusterUpdateHistoryEntriesRequest;
import * as ListExadbVmClusterUpdatesRequest from "./list-exadb-vm-cluster-updates-request";
export import ListExadbVmClusterUpdatesRequest = ListExadbVmClusterUpdatesRequest.ListExadbVmClusterUpdatesRequest;
import * as ListExadbVmClustersRequest from "./list-exadb-vm-clusters-request";
export import ListExadbVmClustersRequest = ListExadbVmClustersRequest.ListExadbVmClustersRequest;
import * as ListExascaleDbStorageVaultsRequest from "./list-exascale-db-storage-vaults-request";
export import ListExascaleDbStorageVaultsRequest = ListExascaleDbStorageVaultsRequest.ListExascaleDbStorageVaultsRequest;
import * as ListExecutionActionsRequest from "./list-execution-actions-request";
export import ListExecutionActionsRequest = ListExecutionActionsRequest.ListExecutionActionsRequest;
import * as ListExecutionWindowsRequest from "./list-execution-windows-request";
export import ListExecutionWindowsRequest = ListExecutionWindowsRequest.ListExecutionWindowsRequest;
...
import * as ListOneoffPatchesRequest from "./list-oneoff-patches-request";
export import ListOneoffPatchesRequest = ListOneoffPatchesRequest.ListOneoffPatchesRequest;
import * as ListParamsForActionTypeRequest from "./list-params-for-action-type-request";
export import ListParamsForActionTypeRequest = ListParamsForActionTypeRequest.ListParamsForActionTypeRequest;
...
import * as ListPluggableDatabaseSnapshotsRequest from "./list-pluggable-database-snapshots-request";
export import ListPluggableDatabaseSnapshotsRequest = ListPluggableDatabaseSnapshotsRequest.ListPluggableDatabaseSnapshotsRequest;
...
import * as ListRecommendedScheduledActionsRequest from "./list-recommended-scheduled-actions-request";
export import ListRecommendedScheduledActionsRequest = ListRecommendedScheduledActionsRequest.ListRecommendedScheduledActionsRequest;
import * as ListResourcePoolMembersRequest from "./list-resource-pool-members-request";
export import ListResourcePoolMembersRequest = ListResourcePoolMembersRequest.ListResourcePoolMembersRequest;
import * as ListScheduledActionsRequest from "./list-scheduled-actions-request";
export import ListScheduledActionsRequest = ListScheduledActionsRequest.ListScheduledActionsRequest;
import * as ListSchedulingPlansRequest from "./list-scheduling-plans-request";
export import ListSchedulingPlansRequest = ListSchedulingPlansRequest.ListSchedulingPlansRequest;
import * as ListSchedulingPoliciesRequest from "./list-scheduling-policies-request";
...
import * as RegisterCloudAutonomousVmClusterPkcsRequest from "./register-cloud-autonomous-vm-cluster-pkcs-request";
export import RegisterCloudAutonomousVmClusterPkcsRequest = RegisterCloudAutonomousVmClusterPkcsRequest.RegisterCloudAutonomousVmClusterPkcsRequest;
import * as RegisterCloudVmClusterPkcsRequest from "./register-cloud-vm-cluster-pkcs-request";
export import RegisterCloudVmClusterPkcsRequest = RegisterCloudVmClusterPkcsRequest.RegisterCloudVmClusterPkcsRequest;
...
export import ReinstateDataGuardRequest = ReinstateDataGuardRequest.ReinstateDataGuardRequest;
...
import * as RemoveVirtualMachineFromExadbVmClusterRequest from "./remove-virtual-machine-from-exadb-vm-cluster-request";
export import RemoveVirtualMachineFromExadbVmClusterRequest = RemoveVirtualMachineFromExadbVmClusterRequest.RemoveVirtualMachineFromExadbVmClusterRequest;
...
import * as ReorderExecutionActionsRequest from "./reorder-execution-actions-request";
...
import * as RunDataPatchRequest from "./run-data-patch-request";
export import RunDataPatchRequest = RunDataPatchRequest.RunDataPatchRequest;
import * as SaasAdminUserStatusRequest from "./saas-admin-user-status-request";
export import SaasAdminUserStatusRequest = SaasAdminUserStatusRequest.SaasAdminUserStatusRequest;
...
import * as SetDbKeyVersionRequest from "./set-db-key-version-request";
export import SetDbKeyVersionRequest = SetDbKeyVersionRequest.SetDbKeyVersionRequest;
import * as SetPdbKeyVersionRequest from "./set-pdb-key-version-request";
export import SetPdbKeyVersionRequest = SetPdbKeyVersionRequest.SetPdbKeyVersionRequest;
...
import * as UpdateDataGuardRequest from "./update-data-guard-request";
export import UpdateDataGuardRequest = UpdateDataGuardRequest.UpdateDataGuardRequest;
...
import * as UpdateExadbVmClusterRequest from "./update-exadb-vm-cluster-request";
export import UpdateExadbVmClusterRequest = UpdateExadbVmClusterRequest.UpdateExadbVmClusterRequest;
import * as UpdateExascaleDbStorageVaultRequest from "./update-exascale-db-storage-vault-request";
export import UpdateExascaleDbStorageVaultRequest = UpdateExascaleDbStorageVaultRequest.UpdateExascaleDbStorageVaultRequest;
import * as UpdateExecutionActionRequest from "./update-execution-action-request";
export import UpdateExecutionActionRequest = UpdateExecutionActionRequest.UpdateExecutionActionRequest;
import * as UpdateExecutionWindowRequest from "./update-execution-window-request";
export import UpdateExecutionWindowRequest = UpdateExecutionWindowRequest.UpdateExecutionWindowRequest;
...
import * as UpdateOneoffPatchRequest from "./update-oneoff-patch-request";
export import UpdateOneoffPatchRequest = UpdateOneoffPatchRequest.UpdateOneoffPatchRequest;
...
import * as UpdateScheduledActionRequest from "./update-scheduled-action-request";
export import UpdateScheduledActionRequest = UpdateScheduledActionRequest.UpdateScheduledActionRequest;
import * as UpdateSchedulingPolicyRequest from "./update-scheduling-policy-request";
export import UpdateSchedulingPolicyRequest = UpdateSchedulingPolicyRequest.UpdateSchedulingPolicyRequest;
import * as UpdateSchedulingWindowRequest from "./update-scheduling-window-request";
export import UpdateSchedulingWindowRequest = UpdateSchedulingWindowRequest.UpdateSchedulingWindowRequest;

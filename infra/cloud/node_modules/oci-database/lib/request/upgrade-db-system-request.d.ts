...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/database/UpgradeDbSystem.ts.html |here} to see how to use UpgradeDbSystemRequest.
 */
export interface UpgradeDbSystemRequest extends common.BaseRequest {
    /**

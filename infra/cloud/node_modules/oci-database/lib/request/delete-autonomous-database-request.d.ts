...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/database/DeleteAutonomousDatabase.ts.html |here} to see how to use DeleteAutonomousDatabaseRequest.
 */
export interface DeleteAutonomousDatabaseRequest extends common.BaseRequest {
    /**

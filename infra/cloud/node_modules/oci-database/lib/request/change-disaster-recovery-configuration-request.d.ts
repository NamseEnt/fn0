...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/database/ChangeDisasterRecoveryConfiguration.ts.html |here} to see how to use ChangeDisasterRecoveryConfigurationRequest.
 */
export interface ChangeDisasterRecoveryConfigurationRequest extends common.BaseRequest {
    /**

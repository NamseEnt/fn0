...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/database/UpdateAutonomousDatabase.ts.html |here} to see how to use UpdateAutonomousDatabaseRequest.
 */
export interface UpdateAutonomousDatabaseRequest extends common.BaseRequest {
    /**

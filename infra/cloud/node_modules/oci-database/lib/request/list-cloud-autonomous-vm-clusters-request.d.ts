...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/database/ListCloudAutonomousVmClusters.ts.html |here} to see how to use ListCloudAutonomousVmClustersRequest.
 */
export interface ListCloudAutonomousVmClustersRequest extends common.BaseRequest {
    /**
...
export declare namespace ListCloudAutonomousVmClustersRequest {
    enum SortBy {

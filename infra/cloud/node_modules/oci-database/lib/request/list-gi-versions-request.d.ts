...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/database/ListGiVersions.ts.html |here} to see how to use ListGiVersionsRequest.
 */
export interface ListGiVersionsRequest extends common.BaseRequest {
    /**
...
export declare namespace ListGiVersionsRequest {
    enum SortOrder {
        Asc = "ASC",
        Desc = "DESC"
    }

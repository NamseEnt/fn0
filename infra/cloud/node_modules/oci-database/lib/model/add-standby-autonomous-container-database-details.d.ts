...
export declare namespace AddStandbyAutonomousContainerDatabaseDetails {
    enum ProtectionMode {
        MaximumAvailability = "MAXIMUM_AVAILABILITY",
        MaximumPerformance = "MAXIMUM_PERFORMANCE"
    }
    function getJsonObj(obj: AddStandbyAutonomousContainerDatabaseDetails): object;
    function getDeserializedJsonObj(obj: AddStandbyAutonomousContainerDatabaseDetails): object;
}

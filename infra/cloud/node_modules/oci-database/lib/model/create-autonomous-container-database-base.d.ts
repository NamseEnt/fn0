...
export declare namespace CreateAutonomousContainerDatabaseBase {
    ...
    function getJsonObj(obj: CreateAutonomousContainerDatabaseBase): object;
    function getDeserializedJsonObj(obj: CreateAutonomousContainerDatabaseBase): object;
}

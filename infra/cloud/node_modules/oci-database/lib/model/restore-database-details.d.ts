...
export declare namespace RestoreDatabaseDetails {
    function getJsonObj(obj: RestoreDatabaseDetails): object;
    function getDeserializedJsonObj(obj: RestoreDatabaseDetails): object;
}

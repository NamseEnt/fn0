...
export declare namespace ConvertToPdbDetails {
    enum Action {
        Precheck = "PRECHECK",
        Convert = "CONVERT",
        Sync = "SYNC",
    ...
    function getJsonObj(obj: ConvertToPdbDetails): object;
    function getDeserializedJsonObj(obj: ConvertToPdbDetails): object;
}

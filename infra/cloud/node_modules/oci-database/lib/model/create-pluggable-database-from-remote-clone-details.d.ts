 ...
 *
 */
export interface CreatePluggableDatabaseFromRemoteCloneDetails extends model.CreatePluggableDatabaseCreationTypeDetails {
    /**
...
export declare namespace CreatePluggableDatabaseFromRemoteCloneDetails {
    function getJsonObj(obj: CreatePluggableDatabaseFromRemoteCloneDetails, isParentJsonObj?: boolean): object;
    const creationType = "REMOTE_CLONE_PDB";
    function getDeserializedJsonObj(obj: CreatePluggableDatabaseFromRemoteCloneDetails, isParentJsonObj?: boolean): object;
}

...
export declare namespace RegisterAutonomousDatabaseDataSafeDetails {
    function getJsonObj(obj: RegisterAutonomousDatabaseDataSafeDetails): object;
    function getDeserializedJsonObj(obj: RegisterAutonomousDatabaseDataSafeDetails): object;
}

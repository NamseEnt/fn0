...
export declare namespace ChangeDisasterRecoveryConfigurationDetails {
    enum DisasterRecoveryType {
        Adg = "ADG",
        BackupBased = "BACKUP_BASED"
    }
    function getJsonObj(obj: ChangeDisasterRecoveryConfigurationDetails): object;
    function getDeserializedJsonObj(obj: ChangeDisasterRecoveryConfigurationDetails): object;
}

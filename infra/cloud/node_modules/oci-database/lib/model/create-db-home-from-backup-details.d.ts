...
export declare namespace CreateDbHomeFromBackupDetails {
    function getJsonObj(obj: CreateDbHomeFromBackupDetails): object;
    function getDeserializedJsonObj(obj: CreateDbHomeFromBackupDetails): object;
}

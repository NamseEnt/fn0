 ...
 */
export interface AcdAvmResourceStats {
    /**
...
export declare namespace AcdAvmResourceStats {
    function getJsonObj(obj: AcdAvmResourceStats): object;
    function getDeserializedJsonObj(obj: AcdAvmResourceStats): object;
}

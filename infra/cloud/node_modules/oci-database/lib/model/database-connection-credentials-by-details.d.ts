 ...
 *
 */
export interface DatabaseConnectionCredentialsByDetails extends model.DatabaseConnectionCredentials {
    /**
...
export declare namespace DatabaseConnectionCredentialsByDetails {
    enum Role {
        Sysdba = "SYSDBA",
        Normal = "NORMAL",
        Sysdg = "SYSDG",
    ...
    function getJsonObj(obj: DatabaseConnectionCredentialsByDetails, isParentJsonObj?: boolean): object;
    const credentialType = "DETAILS";
    function getDeserializedJsonObj(obj: DatabaseConnectionCredentialsByDetails, isParentJsonObj?: boolean): object;
}

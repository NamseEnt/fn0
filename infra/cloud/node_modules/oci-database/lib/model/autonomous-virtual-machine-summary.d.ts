...
export declare namespace AutonomousVirtualMachineSummary {
    enum LifecycleState {
    ...
    function getJsonObj(obj: AutonomousVirtualMachineSummary): object;
    function getDeserializedJsonObj(obj: AutonomousVirtualMachineSummary): object;
}

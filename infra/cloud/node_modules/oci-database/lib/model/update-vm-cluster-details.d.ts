...
export interface UpdateVmClusterDetails {
  ...
  *
     ...
     */
    "vmBackupStorageType"?: UpdateVmClusterDetails.VmBackupStorageType;
}
export declare namespace UpdateVmClusterDetails {
    enum LicenseModel {
    ...
    function getJsonObj(obj: UpdateVmClusterDetails): object;
    function getDeserializedJsonObj(obj: UpdateVmClusterDetails): object;
}

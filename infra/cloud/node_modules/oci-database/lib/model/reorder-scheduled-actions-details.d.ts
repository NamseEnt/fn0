 ...
 *
 */
export interface ReorderScheduledActionsDetails {
    /**
     ...
     *
     */
    "scheduledActionIdOrders": Array<model.ActionOrderDetails>;
}
export declare namespace ReorderScheduledActionsDetails {
    function getJsonObj(obj: ReorderScheduledActionsDetails): object;
    function getDeserializedJsonObj(obj: ReorderScheduledActionsDetails): object;
}

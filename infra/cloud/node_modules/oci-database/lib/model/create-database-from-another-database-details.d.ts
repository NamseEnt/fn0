...
export interface CreateDatabaseFromAnotherDatabaseDetails {
  ...
  *
     ...
     */
    "sidPrefix"?: string;
    "sourceEncryptionKeyLocationDetails"?: model.ExternalHsmEncryptionDetails | model.GoogleCloudProviderEncryptionKeyDetails | model.AzureEncryptionKeyDetails | model.AwsEncryptionKeyDetails;
...
export declare namespace CreateDatabaseFromAnotherDatabaseDetails {
    function getJsonObj(obj: CreateDatabaseFromAnotherDatabaseDetails): object;
    function getDeserializedJsonObj(obj: CreateDatabaseFromAnotherDatabaseDetails): object;
}

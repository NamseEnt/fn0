...
export declare namespace EnableExternalNonContainerDatabaseDatabaseManagementDetails {
    enum LicenseModel {
        LicenseIncluded = "LICENSE_INCLUDED",
        BringYourOwnLicense = "BRING_YOUR_OWN_LICENSE"
    }
    function getJsonObj(obj: EnableExternalNonContainerDatabaseDatabaseManagementDetails): object;
    function getDeserializedJsonObj(obj: EnableExternalNonContainerDatabaseDatabaseManagementDetails): object;
}

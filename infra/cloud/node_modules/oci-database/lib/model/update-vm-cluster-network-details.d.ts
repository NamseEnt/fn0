...
export declare namespace UpdateVmClusterNetworkDetails {
    function getJsonObj(obj: UpdateVmClusterNetworkDetails): object;
    function getDeserializedJsonObj(obj: UpdateVmClusterNetworkDetails): object;
}

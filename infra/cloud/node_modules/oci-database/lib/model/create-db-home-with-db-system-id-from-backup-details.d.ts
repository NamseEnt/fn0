...
export declare namespace CreateDbHomeWithDbSystemIdFromBackupDetails {
    function getJsonObj(obj: CreateDbHomeWithDbSystemIdFromBackupDetails, isParentJsonObj?: boolean): object;
    const source = "DB_BACKUP";
    function getDeserializedJsonObj(obj: CreateDbHomeWithDbSystemIdFromBackupDetails, isParentJsonObj?: boolean): object;
}

 ...
 *
 */
export interface DatabaseStorageSizeResponseDetails {
    /**
     ...
     *  Note: Numbers greater than Number.MAX_SAFE_INTEGER will result in rounding issues.
     */
    "redoLogStorageSizeInGBs": number;
}
export declare namespace DatabaseStorageSizeResponseDetails {
    function getJsonObj(obj: DatabaseStorageSizeResponseDetails): object;
    function getDeserializedJsonObj(obj: DatabaseStorageSizeResponseDetails): object;
}

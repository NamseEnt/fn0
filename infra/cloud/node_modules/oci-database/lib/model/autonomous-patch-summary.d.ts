...
export interface AutonomousPatchSummary {
     ...
     *
     */
    "autonomousPatchType"?: AutonomousPatchSummary.AutonomousPatchType;
}
export declare namespace AutonomousPatchSummary {
    enum LifecycleState {
        Available = "AVAILABLE",
        Success = "SUCCESS",
    ...
    function getJsonObj(obj: AutonomousPatchSummary): object;
    function getDeserializedJsonObj(obj: AutonomousPatchSummary): object;
}

...
export declare namespace CreateDatabaseBase {
    function getJsonObj(obj: CreateDatabaseBase): object;
    function getDeserializedJsonObj(obj: CreateDatabaseBase): object;
}

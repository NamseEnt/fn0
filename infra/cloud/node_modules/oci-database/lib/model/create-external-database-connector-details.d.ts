...
export declare namespace CreateExternalDatabaseConnectorDetails {
    function getJsonObj(obj: CreateExternalDatabaseConnectorDetails): object;
    function getDeserializedJsonObj(obj: CreateExternalDatabaseConnectorDetails): object;
}

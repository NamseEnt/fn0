 ...
 *
 */
export interface CreatePluggableDatabaseFromRelocateDetails extends model.CreatePluggableDatabaseCreationTypeDetails {
    /**
...
export declare namespace CreatePluggableDatabaseFromRelocateDetails {
    function getJsonObj(obj: CreatePluggableDatabaseFromRelocateDetails, isParentJsonObj?: boolean): object;
    const creationType = "RELOCATE_PDB";
    function getDeserializedJsonObj(obj: CreatePluggableDatabaseFromRelocateDetails, isParentJsonObj?: boolean): object;
}

 ...
 *
 */
export interface DatabaseStorageSizeDetails {
    /**
...
export declare namespace DatabaseStorageSizeDetails {
    function getJsonObj(obj: DatabaseStorageSizeDetails): object;
    function getDeserializedJsonObj(obj: DatabaseStorageSizeDetails): object;
}

...
export declare namespace CreateAutonomousDatabaseSoftwareImageDetails {
    enum ImageShapeFamily {
        ExadataShape = "EXADATA_SHAPE",
        ExaccShape = "EXACC_SHAPE"
    }
    function getJsonObj(obj: CreateAutonomousDatabaseSoftwareImageDetails): object;
    function getDeserializedJsonObj(obj: CreateAutonomousDatabaseSoftwareImageDetails): object;
}

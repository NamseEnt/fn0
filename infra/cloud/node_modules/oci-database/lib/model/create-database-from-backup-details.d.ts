...
export declare namespace CreateDatabaseFromBackupDetails {
    function getJsonObj(obj: CreateDatabaseFromBackupDetails): object;
    function getDeserializedJsonObj(obj: CreateDatabaseFromBackupDetails): object;
}

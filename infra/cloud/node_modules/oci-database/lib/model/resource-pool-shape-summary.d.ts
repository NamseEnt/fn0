...
export declare namespace ResourcePoolShapeSummary {
    function getJsonObj(obj: ResourcePoolShapeSummary): object;
    function getDeserializedJsonObj(obj: ResourcePoolShapeSummary): object;
}

...
export declare namespace OneoffPatchSummary {
    enum LifecycleState {
        Creating = "CREATING",
        Available = "AVAILABLE",
        Updating = "UPDATING",
    ...
    function getJsonObj(obj: OneoffPatchSummary): object;
    function getDeserializedJsonObj(obj: OneoffPatchSummary): object;
}

...
export declare namespace ChangeDataguardRoleDetails {
    enum Role {
        Primary = "PRIMARY",
        Standby = "STANDBY",
    ...
    function getJsonObj(obj: ChangeDataguardRoleDetails): object;
    function getDeserializedJsonObj(obj: ChangeDataguardRoleDetails): object;
}

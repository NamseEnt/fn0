...
export declare namespace OciKeyDetails {
    function getJsonObj(obj: OciKeyDetails, isParentJsonObj?: boolean): object;
    const provider = "OCI";
    function getDeserializedJsonObj(obj: OciKeyDetails, isParentJsonObj?: boolean): object;
}

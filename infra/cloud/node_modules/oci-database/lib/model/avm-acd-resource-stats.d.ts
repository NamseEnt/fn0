...
export interface AvmAcdResourceStats {
    ...
    "displayName": string;
    /**
     * CPUs/cores assigned to Autonomous AI Databases in the ACD instances. Note: Numbers greater than Number.MAX_SAFE_INTEGER will result in rounding issues.
     */
...
export declare namespace AvmAcdResourceStats {
    function getJsonObj(obj: AvmAcdResourceStats): object;
    function getDeserializedJsonObj(obj: AvmAcdResourceStats): object;
}

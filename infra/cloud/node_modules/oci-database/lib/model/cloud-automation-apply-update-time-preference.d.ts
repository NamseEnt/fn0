...
export declare namespace CloudAutomationApplyUpdateTimePreference {
    function getJsonObj(obj: CloudAutomationApplyUpdateTimePreference): object;
    function getDeserializedJsonObj(obj: CloudAutomationApplyUpdateTimePreference): object;
}

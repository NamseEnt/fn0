...
export declare namespace ChangeKeyStoreCompartmentDetails {
    function getJsonObj(obj: ChangeKeyStoreCompartmentDetails): object;
    function getDeserializedJsonObj(obj: ChangeKeyStoreCompartmentDetails): object;
}

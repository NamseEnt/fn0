...
export declare namespace AutonomousDatabaseBackup {
    enum Type {
    ...
    function getJsonObj(obj: AutonomousDatabaseBackup): object;
    function getDeserializedJsonObj(obj: AutonomousDatabaseBackup): object;
}

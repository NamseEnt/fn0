...
export declare namespace CreateStandbyDetails {
    enum ProtectionMode {
    ...
    function getJsonObj(obj: CreateStandbyDetails): object;
    function getDeserializedJsonObj(obj: CreateStandbyDetails): object;
}

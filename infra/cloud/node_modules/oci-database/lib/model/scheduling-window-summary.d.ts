...
export declare namespace SchedulingWindowSummary {
    enum LifecycleState {
        Creating = "CREATING",
        Available = "AVAILABLE",
        Updating = "UPDATING",
    ...
    function getJsonObj(obj: SchedulingWindowSummary): object;
    function getDeserializedJsonObj(obj: SchedulingWindowSummary): object;
}

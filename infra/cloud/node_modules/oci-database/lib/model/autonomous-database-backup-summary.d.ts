...
export declare namespace AutonomousDatabaseBackupSummary {
    enum Type {
    ...
    function getJsonObj(obj: AutonomousDatabaseBackupSummary): object;
    function getDeserializedJsonObj(obj: AutonomousDatabaseBackupSummary): object;
}

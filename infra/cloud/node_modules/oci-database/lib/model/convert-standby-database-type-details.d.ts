...
export declare namespace ConvertStandbyDatabaseTypeDetails {
    enum StandbyConversionType {
        Snapshot = "SNAPSHOT",
        Physical = "PHYSICAL"
    }
    function getJsonObj(obj: ConvertStandbyDatabaseTypeDetails): object;
    function getDeserializedJsonObj(obj: ConvertStandbyDatabaseTypeDetails): object;
}

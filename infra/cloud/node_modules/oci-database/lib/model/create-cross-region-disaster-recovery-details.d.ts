 ...
 *
 */
export interface CreateCrossRegionDisasterRecoveryDetails extends model.CreateAutonomousDatabaseBase {
    /**
...
export declare namespace CreateCrossRegionDisasterRecoveryDetails {
    function getJsonObj(obj: CreateCrossRegionDisasterRecoveryDetails, isParentJsonObj?: boolean): object;
    const source = "CROSS_REGION_DISASTER_RECOVERY";
    function getDeserializedJsonObj(obj: CreateCrossRegionDisasterRecoveryDetails, isParentJsonObj?: boolean): object;
}

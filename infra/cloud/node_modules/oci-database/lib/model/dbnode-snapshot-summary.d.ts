...
export declare namespace DbnodeSnapshotSummary {
    function getJsonObj(obj: DbnodeSnapshotSummary): object;
    function getDeserializedJsonObj(obj: DbnodeSnapshotSummary): object;
}

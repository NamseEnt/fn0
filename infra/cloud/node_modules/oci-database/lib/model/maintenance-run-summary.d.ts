...
export interface MaintenanceRunSummary {
     ...
     *
     */
    "patchingMode"?: MaintenanceRunSummary.PatchingMode;
    /**
     ...
     */
    "patchingStatus"?: MaintenanceRunSummary.PatchingStatus;
    /**
...
export declare namespace MaintenanceRunSummary {
    enum LifecycleState {
        Scheduled = "SCHEDULED",
    ...
    function getJsonObj(obj: MaintenanceRunSummary): object;
    function getDeserializedJsonObj(obj: MaintenanceRunSummary): object;
}

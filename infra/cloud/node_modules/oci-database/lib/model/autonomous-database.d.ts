...
export declare namespace AutonomousDatabase {
    enum LifecycleState {
    ...
    function getJsonObj(obj: AutonomousDatabase): object;
    function getDeserializedJsonObj(obj: AutonomousDatabase): object;
}

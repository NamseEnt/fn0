...
export declare namespace RunDataPatchDetails {
    enum Action {
        Apply = "APPLY",
        Precheck = "PRECHECK"
    }
    function getJsonObj(obj: RunDataPatchDetails): object;
    function getDeserializedJsonObj(obj: RunDataPatchDetails): object;
}

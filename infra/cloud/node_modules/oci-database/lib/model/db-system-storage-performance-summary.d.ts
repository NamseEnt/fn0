...
export declare namespace DbSystemStoragePerformanceSummary {
    enum ShapeType {
        Amd = "AMD",
        Intel = "INTEL",
    ...
    function getJsonObj(obj: DbSystemStoragePerformanceSummary): object;
    function getDeserializedJsonObj(obj: DbSystemStoragePerformanceSummary): object;
}

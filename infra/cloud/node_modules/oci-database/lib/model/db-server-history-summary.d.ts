...
export declare namespace DbServerHistorySummary {
    function getJsonObj(obj: DbServerHistorySummary): object;
    function getDeserializedJsonObj(obj: DbServerHistorySummary): object;
}

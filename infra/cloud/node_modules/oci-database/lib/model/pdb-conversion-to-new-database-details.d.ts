...
export declare namespace PdbConversionToNewDatabaseDetails {
    function getJsonObj(obj: PdbConversionToNewDatabaseDetails, isParentJsonObj?: boolean): object;
    const target = "NEW_DATABASE";
    function getDeserializedJsonObj(obj: PdbConversionToNewDatabaseDetails, isParentJsonObj?: boolean): object;
}

...
export declare namespace AutonomousContainerDatabaseDataguard {
    enum Role {
        Primary = "PRIMARY",
        Standby = "STANDBY",
    ...
    function getJsonObj(obj: AutonomousContainerDatabaseDataguard): object;
    function getDeserializedJsonObj(obj: AutonomousContainerDatabaseDataguard): object;
}

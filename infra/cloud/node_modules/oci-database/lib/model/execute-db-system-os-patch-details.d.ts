...
export declare namespace ExecuteDbSystemOsPatchDetails {
    enum Action {
        Precheck = "PRECHECK",
        Apply = "APPLY"
    }
    function getJsonObj(obj: ExecuteDbSystemOsPatchDetails): object;
    function getDeserializedJsonObj(obj: ExecuteDbSystemOsPatchDetails): object;
}

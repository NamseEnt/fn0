...
export declare namespace AutonomousContainerDatabase {
    ...
    function getJsonObj(obj: AutonomousContainerDatabase): object;
    function getDeserializedJsonObj(obj: AutonomousContainerDatabase): object;
}

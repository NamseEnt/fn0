...
export declare namespace VmClusterUpdateSummary {
    enum LastAction {
    ...
    function getJsonObj(obj: VmClusterUpdateSummary): object;
    function getDeserializedJsonObj(obj: VmClusterUpdateSummary): object;
}

...
*
*/
export interface CreateDataGuardAssociationToExistingDbSystemDetails extends model.CreateDataGuardAssociationDetails {
    /**
...
export declare namespace CreateDataGuardAssociationToExistingDbSystemDetails {
    function getJsonObj(obj: CreateDataGuardAssociationToExistingDbSystemDetails, isParentJsonObj?: boolean): object;
    const creationType = "ExistingDbSystem";
    function getDeserializedJsonObj(obj: CreateDataGuardAssociationToExistingDbSystemDetails, isParentJsonObj?: boolean): object;
}

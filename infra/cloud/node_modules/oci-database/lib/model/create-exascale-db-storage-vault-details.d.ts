 ...
 *
 */
export interface CreateExascaleDbStorageVaultDetails {
    /**
...
export declare namespace CreateExascaleDbStorageVaultDetails {
    function getJsonObj(obj: CreateExascaleDbStorageVaultDetails): object;
    function getDeserializedJsonObj(obj: CreateExascaleDbStorageVaultDetails): object;
}

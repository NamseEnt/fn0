...
export interface VmClusterSummary {
  ...
  *
     ...
     */
    "vmFileSystemStorageType"?: VmClusterSummary.VmFileSystemStorageType;
    /**
     ...
     */
    "vmBackupStorageType"?: VmClusterSummary.VmBackupStorageType;
}
export declare namespace VmClusterSummary {
    enum LifecycleState {
    ...
    function getJsonObj(obj: VmClusterSummary): object;
    function getDeserializedJsonObj(obj: VmClusterSummary): object;
}

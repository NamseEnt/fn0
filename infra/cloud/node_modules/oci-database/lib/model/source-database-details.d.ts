...
export declare namespace SourceDatabaseDetails {
    enum DbWorkload {
        Oltp = "OLTP",
        Dw = "DW",
        Ajd = "AJD",
    ...
    function getJsonObj(obj: SourceDatabaseDetails): object;
    function getDeserializedJsonObj(obj: SourceDatabaseDetails): object;
}

...
export declare namespace CreateMaintenanceRunDetails {
    enum PatchingMode {
        Rolling = "ROLLING",
    ...
    function getJsonObj(obj: CreateMaintenanceRunDetails): object;
    function getDeserializedJsonObj(obj: CreateMaintenanceRunDetails): object;
}

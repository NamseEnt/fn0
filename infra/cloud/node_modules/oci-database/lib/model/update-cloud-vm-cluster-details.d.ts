...
export declare namespace UpdateCloudVmClusterDetails {
    enum LicenseModel {
    ...
    function getJsonObj(obj: UpdateCloudVmClusterDetails): object;
    function getDeserializedJsonObj(obj: UpdateCloudVmClusterDetails): object;
}

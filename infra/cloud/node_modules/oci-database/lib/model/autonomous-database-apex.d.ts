...
export declare namespace AutonomousDatabaseApex {
    function getJsonObj(obj: AutonomousDatabaseApex): object;
    function getDeserializedJsonObj(obj: AutonomousDatabaseApex): object;
}

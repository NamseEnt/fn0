...
export declare namespace ExternalDatabaseConnector {
    enum LifecycleState {
    ...
    function getJsonObj(obj: ExternalDatabaseConnector): object;
    function getDeserializedJsonObj(obj: ExternalDatabaseConnector): object;
}

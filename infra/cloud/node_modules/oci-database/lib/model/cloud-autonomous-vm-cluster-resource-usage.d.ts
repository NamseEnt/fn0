...
export declare namespace CloudAutonomousVmClusterResourceUsage {
    function getJsonObj(obj: CloudAutonomousVmClusterResourceUsage): object;
    function getDeserializedJsonObj(obj: CloudAutonomousVmClusterResourceUsage): object;
}

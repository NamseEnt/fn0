...
export declare namespace DatabaseUpgradeSourceBase {
    function getJsonObj(obj: DatabaseUpgradeSourceBase): object;
    function getDeserializedJsonObj(obj: DatabaseUpgradeSourceBase): object;
}

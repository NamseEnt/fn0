...
export interface SchedulingPlan {
     ...
     *
     */
    "lifecycleState": SchedulingPlan.LifecycleState;
    /**
     ...
     */
    "serviceType": SchedulingPlan.ServiceType;
    /**
...
export declare namespace SchedulingPlan {
    enum LifecycleState {
        Creating = "CREATING",
    ...
    function getJsonObj(obj: SchedulingPlan): object;
    function getDeserializedJsonObj(obj: SchedulingPlan): object;
}

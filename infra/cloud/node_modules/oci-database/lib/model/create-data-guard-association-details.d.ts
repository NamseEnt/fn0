...
export declare namespace CreateDataGuardAssociationDetails {
    enum ProtectionMode {
    ...
    function getJsonObj(obj: CreateDataGuardAssociationDetails): object;
    function getDeserializedJsonObj(obj: CreateDataGuardAssociationDetails): object;
}

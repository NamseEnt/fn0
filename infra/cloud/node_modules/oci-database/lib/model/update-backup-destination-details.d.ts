...
export declare namespace UpdateBackupDestinationDetails {
    enum NfsMountType {
        SelfMount = "SELF_MOUNT",
        AutomatedMount = "AUTOMATED_MOUNT"
    }
    function getJsonObj(obj: UpdateBackupDestinationDetails): object;
    function getDeserializedJsonObj(obj: UpdateBackupDestinationDetails): object;
}

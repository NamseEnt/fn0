...
export declare namespace ExadbVmClusterUpdate {
    enum LastAction {
    ...
    function getJsonObj(obj: ExadbVmClusterUpdate): object;
    function getDeserializedJsonObj(obj: ExadbVmClusterUpdate): object;
}

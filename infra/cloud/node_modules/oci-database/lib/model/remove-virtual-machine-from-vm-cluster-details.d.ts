...
export declare namespace RemoveVirtualMachineFromVmClusterDetails {
    function getJsonObj(obj: RemoveVirtualMachineFromVmClusterDetails): object;
    function getDeserializedJsonObj(obj: RemoveVirtualMachineFromVmClusterDetails): object;
}

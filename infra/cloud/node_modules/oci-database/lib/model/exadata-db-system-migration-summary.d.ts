 ...
 *
 */
export interface ExadataDbSystemMigrationSummary {
    /**
...
export declare namespace ExadataDbSystemMigrationSummary {
    function getJsonObj(obj: ExadataDbSystemMigrationSummary): object;
    function getDeserializedJsonObj(obj: ExadataDbSystemMigrationSummary): object;
}

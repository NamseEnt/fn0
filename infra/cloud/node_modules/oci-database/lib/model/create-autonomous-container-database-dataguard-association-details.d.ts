...
export declare namespace CreateAutonomousContainerDatabaseDataguardAssociationDetails {
    enum ProtectionMode {
        MaximumAvailability = "MAXIMUM_AVAILABILITY",
        MaximumPerformance = "MAXIMUM_PERFORMANCE"
    }
    function getJsonObj(obj: CreateAutonomousContainerDatabaseDataguardAssociationDetails): object;
    function getDeserializedJsonObj(obj: CreateAutonomousContainerDatabaseDataguardAssociationDetails): object;
}

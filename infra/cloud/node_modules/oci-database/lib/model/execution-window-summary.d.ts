...
export declare namespace ExecutionWindowSummary {
    enum LifecycleState {
        Created = "CREATED",
        Scheduled = "SCHEDULED",
    ...
    function getJsonObj(obj: ExecutionWindowSummary): object;
    function getDeserializedJsonObj(obj: ExecutionWindowSummary): object;
}

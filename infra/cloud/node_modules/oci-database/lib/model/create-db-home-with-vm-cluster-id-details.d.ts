...
export declare namespace CreateDbHomeWithVmClusterIdDetails {
    function getJsonObj(obj: CreateDbHomeWithVmClusterIdDetails, isParentJsonObj?: boolean): object;
    const source = "VM_CLUSTER_NEW";
    function getDeserializedJsonObj(obj: CreateDbHomeWithVmClusterIdDetails, isParentJsonObj?: boolean): object;
}

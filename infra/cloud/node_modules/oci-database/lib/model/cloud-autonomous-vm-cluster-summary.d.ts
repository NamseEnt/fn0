...
export declare namespace CloudAutonomousVmClusterSummary {
    enum LifecycleState {
    ...
    function getJsonObj(obj: CloudAutonomousVmClusterSummary): object;
    function getDeserializedJsonObj(obj: CloudAutonomousVmClusterSummary): object;
}

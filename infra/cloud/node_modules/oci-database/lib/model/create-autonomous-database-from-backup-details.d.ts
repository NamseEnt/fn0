 ...
 *
 */
export interface CreateAutonomousDatabaseFromBackupDetails extends model.CreateAutonomousDatabaseBase {
    /**
...
export declare namespace CreateAutonomousDatabaseFromBackupDetails {
    enum CloneType {
        Full = "FULL",
        Metadata = "METADATA",
        Partial = "PARTIAL"
    }
    function getJsonObj(obj: CreateAutonomousDatabaseFromBackupDetails, isParentJsonObj?: boolean): object;
    const source = "BACKUP_FROM_ID";
    function getDeserializedJsonObj(obj: CreateAutonomousDatabaseFromBackupDetails, isParentJsonObj?: boolean): object;
}

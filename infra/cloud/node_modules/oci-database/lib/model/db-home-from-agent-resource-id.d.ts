...
export declare namespace DbHomeFromAgentResourceId {
    enum LifecycleState {
    ...
    function getJsonObj(obj: DbHomeFromAgentResourceId): object;
    function getDeserializedJsonObj(obj: DbHomeFromAgentResourceId): object;
}

...
export declare namespace AutonomousContainerDatabaseDataguardAssociation {
    enum Role {
        Primary = "PRIMARY",
        Standby = "STANDBY",
    ...
    function getJsonObj(obj: AutonomousContainerDatabaseDataguardAssociation): object;
    function getDeserializedJsonObj(obj: AutonomousContainerDatabaseDataguardAssociation): object;
}

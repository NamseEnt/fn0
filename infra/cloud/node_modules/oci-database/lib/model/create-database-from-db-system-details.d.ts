...
export declare namespace CreateDatabaseFromDbSystemDetails {
    function getJsonObj(obj: CreateDatabaseFromDbSystemDetails): object;
    function getDeserializedJsonObj(obj: CreateDatabaseFromDbSystemDetails): object;
}

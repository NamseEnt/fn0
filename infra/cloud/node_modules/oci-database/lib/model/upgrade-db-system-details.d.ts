...
export declare namespace UpgradeDbSystemDetails {
    enum Action {
        Precheck = "PRECHECK",
        Rollback = "ROLLBACK",
    ...
    function getJsonObj(obj: UpgradeDbSystemDetails): object;
    function getDeserializedJsonObj(obj: UpgradeDbSystemDetails): object;
}

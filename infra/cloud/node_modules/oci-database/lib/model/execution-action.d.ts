...
export declare namespace ExecutionAction {
    enum LifecycleState {
        Scheduled = "SCHEDULED",
    ...
    function getJsonObj(obj: ExecutionAction): object;
    function getDeserializedJsonObj(obj: ExecutionAction): object;
}

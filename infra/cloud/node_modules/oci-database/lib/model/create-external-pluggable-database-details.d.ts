 ...
 *
 */
export interface CreateExternalPluggableDatabaseDetails {
    /**
...
export declare namespace CreateExternalPluggableDatabaseDetails {
    function getJsonObj(obj: CreateExternalPluggableDatabaseDetails): object;
    function getDeserializedJsonObj(obj: CreateExternalPluggableDatabaseDetails): object;
}

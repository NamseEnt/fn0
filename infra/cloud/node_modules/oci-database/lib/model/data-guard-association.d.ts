...
export declare namespace DataGuardAssociation {
    enum Role {
        Primary = "PRIMARY",
        Standby = "STANDBY",
    ...
    function getJsonObj(obj: DataGuardAssociation): object;
    function getDeserializedJsonObj(obj: DataGuardAssociation): object;
}

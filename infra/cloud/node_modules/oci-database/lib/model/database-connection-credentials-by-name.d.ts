...
export declare namespace DatabaseConnectionCredentialsByName {
    function getJsonObj(obj: DatabaseConnectionCredentialsByName, isParentJsonObj?: boolean): object;
    const credentialType = "NAME_REFERENCE";
    function getDeserializedJsonObj(obj: DatabaseConnectionCredentialsByName, isParentJsonObj?: boolean): object;
}

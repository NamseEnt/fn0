...
export declare namespace AutonomousDatabaseSummary {
    enum LifecycleState {
    ...
    function getJsonObj(obj: AutonomousDatabaseSummary): object;
    function getDeserializedJsonObj(obj: AutonomousDatabaseSummary): object;
}

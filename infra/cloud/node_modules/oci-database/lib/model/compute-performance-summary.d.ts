...
export declare namespace ComputePerformanceSummary {
    enum ComputeModel {
        Ecpu = "ECPU",
        Ocpu = "OCPU",
        /**
    ...
    function getJsonObj(obj: ComputePerformanceSummary): object;
    function getDeserializedJsonObj(obj: ComputePerformanceSummary): object;
}

...
export declare namespace ExascaleDbStorageVaultSummary {
    enum AttachedShapeAttributes {
    ...
    function getJsonObj(obj: ExascaleDbStorageVaultSummary): object;
    function getDeserializedJsonObj(obj: ExascaleDbStorageVaultSummary): object;
}

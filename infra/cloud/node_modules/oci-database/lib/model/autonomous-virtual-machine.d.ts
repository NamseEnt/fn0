 ...
 */
export interface AutonomousVirtualMachine {
    /**
     ...
     */
    "lifecycleState": AutonomousVirtualMachine.LifecycleState;
    /**
     * Client IP Address.
     */
...
export declare namespace AutonomousVirtualMachine {
    enum LifecycleState {
    ...
    function getJsonObj(obj: AutonomousVirtualMachine): object;
    function getDeserializedJsonObj(obj: AutonomousVirtualMachine): object;
}

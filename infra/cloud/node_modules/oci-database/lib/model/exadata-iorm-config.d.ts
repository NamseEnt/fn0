...
export declare namespace ExadataIormConfig {
    enum LifecycleState {
    ...
    function getJsonObj(obj: ExadataIormConfig): object;
    function getDeserializedJsonObj(obj: ExadataIormConfig): object;
}

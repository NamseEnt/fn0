...
export declare namespace DataGuardAssociationSummary {
    enum Role {
        Primary = "PRIMARY",
        Standby = "STANDBY",
    ...
    function getJsonObj(obj: DataGuardAssociationSummary): object;
    function getDeserializedJsonObj(obj: DataGuardAssociationSummary): object;
}

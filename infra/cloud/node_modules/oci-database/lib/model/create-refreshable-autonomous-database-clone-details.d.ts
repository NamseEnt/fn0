 ...
 *
 */
export interface CreateRefreshableAutonomousDatabaseCloneDetails extends model.CreateAutonomousDatabaseBase {
    /**
...
export declare namespace CreateRefreshableAutonomousDatabaseCloneDetails {
    ...
    function getJsonObj(obj: CreateRefreshableAutonomousDatabaseCloneDetails, isParentJsonObj?: boolean): object;
    const source = "CLONE_TO_REFRESHABLE";
    function getDeserializedJsonObj(obj: CreateRefreshableAutonomousDatabaseCloneDetails, isParentJsonObj?: boolean): object;
}

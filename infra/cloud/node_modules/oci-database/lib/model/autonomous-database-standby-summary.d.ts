...
export declare namespace AutonomousDatabaseStandbySummary {
    enum LifecycleState {
    ...
    function getJsonObj(obj: AutonomousDatabaseStandbySummary): object;
    function getDeserializedJsonObj(obj: AutonomousDatabaseStandbySummary): object;
}

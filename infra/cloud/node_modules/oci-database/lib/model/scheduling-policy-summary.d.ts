...
export interface SchedulingPolicySummary {
     ...
     *
     */
    "lifecycleState": SchedulingPolicySummary.LifecycleState;
    /**
     ...
     * The cadence period.
     */
    "cadence": SchedulingPolicySummary.Cadence;
    /**
...
export declare namespace SchedulingPolicySummary {
    enum LifecycleState {
        Creating = "CREATING",
    ...
    function getJsonObj(obj: SchedulingPolicySummary): object;
    function getDeserializedJsonObj(obj: SchedulingPolicySummary): object;
}

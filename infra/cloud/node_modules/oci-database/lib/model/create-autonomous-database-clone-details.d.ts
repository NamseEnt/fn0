...
export declare namespace CreateAutonomousDatabaseCloneDetails {
    enum CloneType {
        Full = "FULL",
        Metadata = "METADATA",
        Partial = "PARTIAL"
    }
    function getJsonObj(obj: CreateAutonomousDatabaseCloneDetails, isParentJsonObj?: boolean): object;
    const source = "DATABASE";
    function getDeserializedJsonObj(obj: CreateAutonomousDatabaseCloneDetails, isParentJsonObj?: boolean): object;
}

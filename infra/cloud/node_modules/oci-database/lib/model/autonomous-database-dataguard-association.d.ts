...
export declare namespace AutonomousDatabaseDataguardAssociation {
    enum Role {
        Primary = "PRIMARY",
        Standby = "STANDBY",
    ...
    enum PeerAutonomousDatabaseLifeCycleState {
        Provisioning = "PROVISIONING",
        Available = "AVAILABLE",
        Stopping = "STOPPING",
        Stopped = "STOPPED",
    ...
    function getJsonObj(obj: AutonomousDatabaseDataguardAssociation): object;
    function getDeserializedJsonObj(obj: AutonomousDatabaseDataguardAssociation): object;
}

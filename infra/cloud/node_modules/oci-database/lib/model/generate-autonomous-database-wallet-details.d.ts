...
export declare namespace GenerateAutonomousDatabaseWalletDetails {
    enum GenerateType {
        All = "ALL",
        Single = "SINGLE"
    }
    function getJsonObj(obj: GenerateAutonomousDatabaseWalletDetails): object;
    function getDeserializedJsonObj(obj: GenerateAutonomousDatabaseWalletDetails): object;
}

...
export declare namespace AutonomousDatabaseManualRefreshDetails {
    function getJsonObj(obj: AutonomousDatabaseManualRefreshDetails): object;
    function getDeserializedJsonObj(obj: AutonomousDatabaseManualRefreshDetails): object;
}

 ...
 */
export interface DbConnectionBundleSummary {
    /**
     ...
     */
    "lifecycleState": DbConnectionBundleSummary.LifecycleState;
    /**
     * The type of the database connection bundle.
     */
    "dbConnectionBundleType": DbConnectionBundleSummary.DbConnectionBundleType;
}
export declare namespace DbConnectionBundleSummary {
    enum LifecycleState {
        Creating = "CREATING",
        Active = "ACTIVE",
        Inactive = "INACTIVE",
    ...
    function getJsonObj(obj: DbConnectionBundleSummary): object;
    function getDeserializedJsonObj(obj: DbConnectionBundleSummary): object;
}

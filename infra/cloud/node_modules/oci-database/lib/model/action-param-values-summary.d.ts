...
export declare namespace ActionParamValuesSummary {
    enum ParameterType {
        Boolean = "BOOLEAN",
        String = "STRING",
        Integer = "INTEGER",
    ...
    function getJsonObj(obj: ActionParamValuesSummary): object;
    function getDeserializedJsonObj(obj: ActionParamValuesSummary): object;
}

...
export interface CreatePluggableDatabaseSnapshotResponse {
    /**
    ...
    "opcRequestId": string;
    /**
     * The returned model.PluggableDatabaseSnapshot instance.
     */
    "pluggableDatabaseSnapshot": model.PluggableDatabaseSnapshot;
}

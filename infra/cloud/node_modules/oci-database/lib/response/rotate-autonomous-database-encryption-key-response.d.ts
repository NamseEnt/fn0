...
export interface RotateAutonomousDatabaseEncryptionKeyResponse {
    /**
    ...
    "opcRequestId": string;
    /**
     * The returned model.AutonomousDatabase instance.
     */
    "autonomousDatabase": model.AutonomousDatabase;
}

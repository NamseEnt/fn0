...
export interface CreateAutonomousDatabaseBackupResponse {
    /**
    ...
    /**
     * The returned model.AutonomousDatabaseBackup instance.
     */
    "autonomousDatabaseBackup": model.AutonomousDatabaseBackup;
}

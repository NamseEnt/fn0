...
export interface CreateDatabaseSoftwareImageResponse {
    /**
    ...
    "opcRequestId": string;
    /**
     * The returned model.DatabaseSoftwareImage instance.
     */
    "databaseSoftwareImage": model.DatabaseSoftwareImage;
}

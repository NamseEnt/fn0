...
export interface UpdateExascaleDbStorageVaultResponse {
    /**
    ...
    "opcRequestId": string;
    /**
     * The returned model.ExascaleDbStorageVault instance.
     */
    "exascaleDbStorageVault": model.ExascaleDbStorageVault;
}

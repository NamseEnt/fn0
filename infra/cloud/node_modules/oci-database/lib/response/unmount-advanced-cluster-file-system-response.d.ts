...
export interface UnmountAdvancedClusterFileSystemResponse {
    /**
    ...
    "etag": string;
    /**
     * The returned model.AdvancedClusterFileSystem instance.
     */
    "advancedClusterFileSystem": model.AdvancedClusterFileSystem;
}

...
export interface LaunchAutonomousExadataInfrastructureResponse {
    /**
    ...
    /**
     * The returned model.AutonomousExadataInfrastructure instance.
     */
    "autonomousExadataInfrastructure": model.AutonomousExadataInfrastructure;
}

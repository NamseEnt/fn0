...
export interface CreateCloudAutonomousVmClusterResponse {
    /**
    ...
    "opcRequestId": string;
    /**
     * The returned model.CloudAutonomousVmCluster instance.
     */
    "cloudAutonomousVmCluster": model.CloudAutonomousVmCluster;
}

...
export interface SwitchoverDataGuardAssociationResponse {
    /**
    ...
    "opcRequestId": string;
    /**
     * The returned model.DataGuardAssociation instance.
     */
    "dataGuardAssociation": model.DataGuardAssociation;
}

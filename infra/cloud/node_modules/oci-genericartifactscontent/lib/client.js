...
exports.GenericArtifactsContentClient = exports.GenericArtifactsContentApiKeys = void 0;
...
class GenericArtifactsContentClient {
    constructor(params, clientConfiguration) {
        ...
        this.targetService = "GenericArtifactsContent";
        this._regionId = "";
        ...
        if (!oci_common_1.developerToolConfiguration.isServiceEnabled("genericartifactscontent")) {
    ...
    set useRealmSpecificEndpointTemplate(realmSpecificEndpointTemplateEnabled) {
        ...
        if (this._lastSetRegionOrRegionId === common.Region.REGION_STRING) {
            this.endpoint = common.EndpointBuilder.createEndpointFromRegion(GenericArtifactsContentClient.serviceEndpointTemplate, this._region, GenericArtifactsContentClient.endpointServiceName);
        }
        else if (this._lastSetRegionOrRegionId === common.Region.REGION_ID_STRING) {
            this.endpoint = common.EndpointBuilder.createEndpointFromRegionId(GenericArtifactsContentClient.serviceEndpointTemplate, this._regionId, GenericArtifactsContentClient.endpointServiceName);
        }
    }
    /**
    ...
    set region(region) {
        this._region = region;
        this.endpoint = common.EndpointBuilder.createEndpointFromRegion(GenericArtifactsContentClient.serviceEndpointTemplate, region, GenericArtifactsContentClient.endpointServiceName);
    ...
    set regionId(regionId) {
        ...
        this.endpoint = common.EndpointBuilder.createEndpointFromRegionId(GenericArtifactsContentClient.serviceEndpointTemplate, regionId, GenericArtifactsContentClient.endpointServiceName);
    ...
    getGenericArtifactContent(getGenericArtifactContentRequest) {
        return __awaiter(this, void 0, void 0, function* () {
            if (this.logger)
                this.logger.debug("Calling operation GenericArtifactsContentClient#getGenericArtifactContent.");
            const operationName = "getGenericArtifactContent";
            const apiReferenceLink = "https://docs.oracle.com/iaas/api/#/en/generic/20160918/GenericArtifact/GetGenericArtifactContent";
            const pathParams = {
    ...
    getGenericArtifactContentByPath(getGenericArtifactContentByPathRequest) {
        return __awaiter(this, void 0, void 0, function* () {
            if (this.logger)
                this.logger.debug("Calling operation GenericArtifactsContentClient#getGenericArtifactContentByPath.");
            const operationName = "getGenericArtifactContentByPath";
            const apiReferenceLink = "https://docs.oracle.com/iaas/api/#/en/generic/20160918/GenericArtifact/GetGenericArtifactContentByPath";
            const pathParams = {
            ...
            const request = yield oci_common_1.composeRequest({
                baseEndpoint: this._endpoint,
                defaultHeaders: this._defaultHeaders,
                path: "/generic/repositories/{repositoryId}/artifactPaths/{artifactPath}/versions/{version}/content",
                method: "GET",
                pathParams: pathParams,
                headerParams: headerParams,
                queryParams: queryParams
    ...
    putGenericArtifactContentByPath(putGenericArtifactContentByPathRequest) {
        return __awaiter(this, void 0, void 0, function* () {
            if (this.logger)
                this.logger.debug("Calling operation GenericArtifactsContentClient#putGenericArtifactContentByPath.");
            const operationName = "putGenericArtifactContentByPath";
            const apiReferenceLink = "https://docs.oracle.com/iaas/api/#/en/generic/20160918/GenericArtifact/PutGenericArtifactContentByPath";
            const pathParams = {
...
exports.GenericArtifactsContentClient = GenericArtifactsContentClient;
GenericArtifactsContentClient.serviceEndpointTemplate = "https://generic.artifacts.{region}.oci.{secondLevelDomain}";

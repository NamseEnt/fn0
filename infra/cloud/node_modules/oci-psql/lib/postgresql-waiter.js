...
exports.PostgresqlWaiter = void 0;
const models = __importStar(require("./model"));
const oci_common_1 = require("oci-common");
class PostgresqlWaiter {
    ...
    forDbSystem(request, ...targetStates) {
        return __awaiter(this, void 0, void 0, function* () {
            return oci_common_1.genericTerminalConditionWaiter(this.config, () => this.client.getDbSystem(request), response => targetStates.includes(response.dbSystem.lifecycleState), targetStates.includes(models.DbSystem.LifecycleState.Deleted));
        });
    }
    /**
     ...
     */
    forDefaultConfiguration(request, ...targetStates) {
        return __awaiter(this, void 0, void 0, function* () {
            return oci_common_1.genericTerminalConditionWaiter(this.config, () => this.client.getDefaultConfiguration(request), response => targetStates.includes(response.defaultConfiguration.lifecycleState), targetStates.includes(models.DefaultConfiguration.LifecycleState.Deleted));
        });
    }
    /**
...
exports.PostgresqlWaiter = PostgresqlWaiter;
//# sourceMappingURL=postgresql-waiter.js.map
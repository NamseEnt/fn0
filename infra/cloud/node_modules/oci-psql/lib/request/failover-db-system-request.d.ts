...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/psql/FailoverDbSystem.ts.html |here} to see how to use FailoverDbSystemRequest.
 */
export interface FailoverDbSystemRequest extends common.BaseRequest {
    /**
     ...
     */
    "failoverDbSystemDetails": model.FailoverDbSystemDetails;
    /**

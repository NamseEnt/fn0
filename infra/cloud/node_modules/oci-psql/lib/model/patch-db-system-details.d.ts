...
export declare namespace PatchDbSystemDetails {
    function getJsonObj(obj: PatchDbSystemDetails): object;
    function getDeserializedJsonObj(obj: PatchDbSystemDetails): object;
}

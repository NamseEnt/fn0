...
export declare namespace DefaultConfigParams {
    function getJsonObj(obj: DefaultConfigParams): object;
    function getDeserializedJsonObj(obj: DefaultConfigParams): object;
}

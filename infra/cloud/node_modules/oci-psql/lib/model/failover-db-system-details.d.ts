...
export declare namespace FailoverDbSystemDetails {
    function getJsonObj(obj: FailoverDbSystemDetails): object;
    function getDeserializedJsonObj(obj: FailoverDbSystemDetails): object;
}

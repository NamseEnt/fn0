...
export declare namespace DefaultConfigurationSummary {
    function getJsonObj(obj: DefaultConfigurationSummary): object;
    function getDeserializedJsonObj(obj: DefaultConfigurationSummary): object;
}

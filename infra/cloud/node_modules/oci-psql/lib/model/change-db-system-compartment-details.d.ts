 ...
 */
export interface ChangeDbSystemCompartmentDetails {
    /**
...
export declare namespace ChangeDbSystemCompartmentDetails {
    function getJsonObj(obj: ChangeDbSystemCompartmentDetails): object;
    function getDeserializedJsonObj(obj: ChangeDbSystemCompartmentDetails): object;
}

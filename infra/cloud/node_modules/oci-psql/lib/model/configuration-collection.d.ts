...
export declare namespace ConfigurationCollection {
    function getJsonObj(obj: ConfigurationCollection): object;
    function getDeserializedJsonObj(obj: ConfigurationCollection): object;
}

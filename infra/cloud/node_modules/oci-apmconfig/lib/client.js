...
class ConfigClient {
     ...
     */
    getMatchAgentsWithAttributeKey(getMatchAgentsWithAttributeKeyRequest) {
        return __awaiter(this, void 0, void 0, function* () {
            if (this.logger)
            ...
            const apiReferenceLink = "https://docs.oracle.com/iaas/api/#/en/apm-config/20210201/MatchAgentsWithAttributeKey/GetMatchAgentsWithAttributeKey";
            const pathParams = {};
            const queryParams = {
            ...
            const specRetryConfiguration = common.OciSdkDefaultRetryConfiguration;
            const retrier = oci_common_1.GenericRetrier.createPreferredRetrier(this._clientConfiguration ? this._clientConfiguration.retryConfiguration : undefined, getMatchAgentsWithAttributeKeyRequest.retryConfiguration, specRetryConfiguration);
            if (this.logger)
                retrier.logger = this.logger;
            const request = yield oci_common_1.composeRequest({
                baseEndpoint: this._endpoint,
     ...
     */
    updateMatchAgentsWithAttributeKey(updateMatchAgentsWithAttributeKeyRequest) {
        return __awaiter(this, void 0, void 0, function* () {
            if (this.logger)
            ...
            const apiReferenceLink = "https://docs.oracle.com/iaas/api/#/en/apm-config/20210201/MatchAgentsWithAttributeKey/UpdateMatchAgentsWithAttributeKey";
            const pathParams = {};
            const queryParams = {
            ...
            const specRetryConfiguration = common.OciSdkDefaultRetryConfiguration;
            const retrier = oci_common_1.GenericRetrier.createPreferredRetrier(this._clientConfiguration ? this._clientConfiguration.retryConfiguration : undefined, updateMatchAgentsWithAttributeKeyRequest.retryConfiguration, specRetryConfiguration);
            if (this.logger)
                retrier.logger = this.logger;
            const request = yield oci_common_1.composeRequest({
                baseEndpoint: this._endpoint,
                ...
                path: "/actions/matchAgentsWithAttributeKey",
                method: "PUT",
                bodyContent: common.ObjectSerializer.serialize(updateMatchAgentsWithAttributeKeyRequest.updateMatchAgentsWithAttributeKeyDetails, "UpdateMatchAgentsWithAttributeKeyDetails", model.UpdateMatchAgentsWithAttributeKeyDetails.getJsonObj),
                pathParams: pathParams,
                headerParams: headerParams,
                queryParams: queryParams
            });

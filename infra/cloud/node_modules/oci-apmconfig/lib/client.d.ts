...
export declare class ConfigClient {
     ...
     */
    getMatchAgentsWithAttributeKey(getMatchAgentsWithAttributeKeyRequest: requests.GetMatchAgentsWithAttributeKeyRequest): Promise<responses.GetMatchAgentsWithAttributeKeyResponse>;
    /**
     ...
     */
    updateMatchAgentsWithAttributeKey(updateMatchAgentsWithAttributeKeyRequest: requests.UpdateMatchAgentsWithAttributeKeyRequest): Promise<responses.UpdateMatchAgentsWithAttributeKeyResponse>;
    /**

...
export declare namespace MatchAgentsWithAttributeKey {
    function getJsonObj(obj: MatchAgentsWithAttributeKey): object;
    function getDeserializedJsonObj(obj: MatchAgentsWithAttributeKey): object;
}

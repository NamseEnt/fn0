...
export declare namespace SpanFilterReference {
    function getJsonObj(obj: SpanFilterReference): object;
    function getDeserializedJsonObj(obj: SpanFilterReference): object;
}

 ...
 */
export interface CreateMacsApmExtensionDetails extends model.CreateConfigDetails {
    /**
...
export declare namespace CreateMacsApmExtensionDetails {
    function getJsonObj(obj: CreateMacsApmExtensionDetails, isParentJsonObj?: boolean): object;
    const configType = "MACS_APM_EXTENSION";
    function getDeserializedJsonObj(obj: CreateMacsApmExtensionDetails, isParentJsonObj?: boolean): object;
}

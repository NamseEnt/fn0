 ...
 */
export interface AccessContextAttributeCollection {
    /**
     * List of context attributes.
     */
    "items": Array<model.AccessContextAttribute>;
}
export declare namespace AccessContextAttributeCollection {
    function getJsonObj(obj: AccessContextAttributeCollection): object;
    function getDeserializedJsonObj(obj: AccessContextAttributeCollection): object;
}

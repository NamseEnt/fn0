 ...
 **/
export declare enum LockboxAutoApprovalState {
    Enabled = "ENABLED",
    Disabled = "DISABLED",
    /**
...
export declare namespace LockboxAutoApprovalState {
    function getJsonObj(obj: LockboxAutoApprovalState): LockboxAutoApprovalState;
    function getDeserializedJsonObj(obj: LockboxAutoApprovalState): LockboxAutoApprovalState;
}

...
export declare class LockboxWaiter {
    private client;
    private readonly config?;
    constructor(client: LockboxClient, config?: Partial<import("oci-common/lib/waiter").WaiterConfigurationDetails> | undefined);
    /**
     ...
     */
    forAccessRequest(request: serviceRequests.GetAccessRequestRequest, ...targetStates: models.AccessRequest.LifecycleState[]): Promise<serviceResponses.GetAccessRequestResponse>;
    /**
     ...
     */
    forApprovalTemplate(request: serviceRequests.GetApprovalTemplateRequest, ...targetStates: models.ApprovalTemplate.LifecycleState[]): Promise<serviceResponses.GetApprovalTemplateResponse | null>;
    /**
     ...
     */
    forLockbox(request: serviceRequests.GetLockboxRequest, ...targetStates: models.Lockbox.LifecycleState[]): Promise<serviceResponses.GetLockboxResponse | null>;
    /**

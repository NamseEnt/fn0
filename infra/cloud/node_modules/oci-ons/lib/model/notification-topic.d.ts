...
export interface NotificationTopic {
     ...
     *
     */
    "lifecycleState": NotificationTopic.LifecycleState;
    /**
...
export declare namespace NotificationTopic {
    enum LifecycleState {
        Active = "ACTIVE",
        Deleting = "DELETING",
        Creating = "CREATING",
    ...
    function getJsonObj(obj: NotificationTopic): object;
    function getDeserializedJsonObj(obj: NotificationTopic): object;
}

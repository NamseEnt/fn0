...
export declare namespace CreateTopicDetails {
    function getJsonObj(obj: CreateTopicDetails): object;
    function getDeserializedJsonObj(obj: CreateTopicDetails): object;
}

 ...
 *
 */
export interface TopicAttributesDetails {
    /**
...
export declare namespace TopicAttributesDetails {
    function getJsonObj(obj: TopicAttributesDetails): object;
    function getDeserializedJsonObj(obj: TopicAttributesDetails): object;
}

...
exports.AIServiceLanguageWaiter = void 0;
const models = __importStar(require("./model"));
const oci_common_1 = require("oci-common");
class AIServiceLanguageWaiter {
     ...
     */
    forEndpoint(request, ...targetStates) {
        return __awaiter(this, void 0, void 0, function* () {
            return oci_common_1.genericTerminalConditionWaiter(this.config, () => this.client.getEndpoint(request), response => targetStates.includes(response.endpoint.lifecycleState), targetStates.includes(models.Endpoint.LifecycleState.Deleted));
        });
    }
    /**
    ...
    forJob(request, ...targetStates) {
        return __awaiter(this, void 0, void 0, function* () {
            return oci_common_1.genericTerminalConditionWaiter(this.config, () => this.client.getJob(request), response => targetStates.includes(response.job.lifecycleState), targetStates.includes(models.Job.LifecycleState.Deleted));
        });
    }
    /**
...
exports.AIServiceLanguageWaiter = AIServiceLanguageWaiter;
//# sourceMappingURL=aiservicelanguage-waiter.js.map
...
export declare namespace TestAndValidationDatasetStrategy {
    function getJsonObj(obj: TestAndValidationDatasetStrategy, isParentJsonObj?: boolean): object;
    const strategyType = "TEST_AND_VALIDATION_DATASET";
    function getDeserializedJsonObj(obj: TestAndValidationDatasetStrategy, isParentJsonObj?: boolean): object;
}

...
export declare namespace EntityLabelErrorAnalysis {
    function getJsonObj(obj: EntityLabelErrorAnalysis): object;
    function getDeserializedJsonObj(obj: EntityLabelErrorAnalysis): object;
}

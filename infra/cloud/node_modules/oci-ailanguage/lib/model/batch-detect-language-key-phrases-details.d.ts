...
export declare namespace BatchDetectLanguageKeyPhrasesDetails {
    function getJsonObj(obj: BatchDetectLanguageKeyPhrasesDetails): object;
    function getDeserializedJsonObj(obj: BatchDetectLanguageKeyPhrasesDetails): object;
}

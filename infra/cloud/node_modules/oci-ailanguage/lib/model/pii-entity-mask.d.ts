...
export declare namespace PiiEntityMask {
    function getJsonObj(obj: PiiEntityMask, isParentJsonObj?: boolean): object;
    const mode = "MASK";
    function getDeserializedJsonObj(obj: PiiEntityMask, isParentJsonObj?: boolean): object;
}

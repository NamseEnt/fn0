...
export declare namespace BatchDetectLanguageEntitiesDetails {
    function getJsonObj(obj: BatchDetectLanguageEntitiesDetails): object;
    function getDeserializedJsonObj(obj: BatchDetectLanguageEntitiesDetails): object;
}

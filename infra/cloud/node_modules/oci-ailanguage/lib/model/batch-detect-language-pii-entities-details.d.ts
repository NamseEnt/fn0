...
export interface BatchDetectLanguagePiiEntitiesDetails {
     ...
     */
    "masking"?: {
        [key: string]: model.PiiEntityMasking;
    };
    "profile"?: model.Profile;
}
export declare namespace BatchDetectLanguagePiiEntitiesDetails {
    function getJsonObj(obj: BatchDetectLanguagePiiEntitiesDetails): object;
    function getDeserializedJsonObj(obj: BatchDetectLanguagePiiEntitiesDetails): object;
}

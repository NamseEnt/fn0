...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/cloudguard/ListResourceProfiles.ts.html |here} to see how to use ListResourceProfilesRequest.
 */
...
export declare namespace ListResourceProfilesRequest {
    enum AccessLevel {

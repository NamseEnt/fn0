...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/cloudguard/RequestSummarizedTrendProblems.ts.html |here} to see how to use RequestSummarizedTrendProblemsRequest.
 */
...
export declare namespace RequestSummarizedTrendProblemsRequest {
    enum AccessLevel {

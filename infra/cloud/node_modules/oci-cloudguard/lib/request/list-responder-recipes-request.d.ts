...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/cloudguard/ListResponderRecipes.ts.html |here} to see how to use ListResponderRecipesRequest.
 */
...
export declare namespace ListResponderRecipesRequest {
    enum AccessLevel {

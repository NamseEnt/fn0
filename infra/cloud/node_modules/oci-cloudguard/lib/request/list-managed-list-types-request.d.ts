...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/cloudguard/ListManagedListTypes.ts.html |here} to see how to use ListManagedListTypesRequest.
 */
...
export declare namespace ListManagedListTypesRequest {
    enum SortBy {

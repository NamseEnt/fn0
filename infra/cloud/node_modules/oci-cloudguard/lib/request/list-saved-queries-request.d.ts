...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/cloudguard/ListSavedQueries.ts.html |here} to see how to use ListSavedQueriesRequest.
 */
export interface ListSavedQueriesRequest extends common.BaseRequest {
    /**
...
export declare namespace ListSavedQueriesRequest {
    enum AccessLevel {

...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/cloudguard/ListDetectorRecipes.ts.html |here} to see how to use ListDetectorRecipesRequest.
 */
...
export declare namespace ListDetectorRecipesRequest {
    enum AccessLevel {

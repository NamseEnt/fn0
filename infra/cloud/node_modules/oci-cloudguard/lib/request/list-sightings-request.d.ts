...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/cloudguard/ListSightings.ts.html |here} to see how to use ListSightingsRequest.
 */
export interface ListSightingsRequest extends common.BaseRequest {
    /**
...
export declare namespace ListSightingsRequest {
    enum AccessLevel {

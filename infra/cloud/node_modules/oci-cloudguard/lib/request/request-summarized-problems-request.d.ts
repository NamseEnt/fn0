...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/cloudguard/RequestSummarizedProblems.ts.html |here} to see how to use RequestSummarizedProblemsRequest.
 */
export interface RequestSummarizedProblemsRequest extends common.BaseRequest {
     ...
     */
    "listDimensions": Array<model.ProblemDimension>;
    /**
...
export declare namespace RequestSummarizedProblemsRequest {
    enum AccessLevel {

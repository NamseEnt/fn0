...
export declare class CloudGuardWaiter {
     ...
     */
    forAdhocQuery(request: serviceRequests.GetAdhocQueryRequest, ...targetStates: models.LifecycleState[]): Promise<serviceResponses.GetAdhocQueryResponse | null>;
    /**
     ...
     */
    forDataSource(request: serviceRequests.GetDataSourceRequest, ...targetStates: models.LifecycleState[]): Promise<serviceResponses.GetDataSourceResponse | null>;
    /**
     ...
     */
    forSavedQuery(request: serviceRequests.GetSavedQueryRequest, ...targetStates: models.LifecycleState[]): Promise<serviceResponses.GetSavedQueryResponse | null>;
    /**
     ...
     */
    forSecurityPolicy(request: serviceRequests.GetSecurityPolicyRequest, ...targetStates: models.LifecycleState[]): Promise<serviceResponses.GetSecurityPolicyResponse | null>;
    /**
     ...
     */
    forSecurityRecipe(request: serviceRequests.GetSecurityRecipeRequest, ...targetStates: models.LifecycleState[]): Promise<serviceResponses.GetSecurityRecipeResponse | null>;
    /**
     ...
     */
    forSecurityZone(request: serviceRequests.GetSecurityZoneRequest, ...targetStates: models.LifecycleState[]): Promise<serviceResponses.GetSecurityZoneResponse | null>;
    /**

...
export declare namespace DetectorRuleSummary {
    ...
    function getJsonObj(obj: DetectorRuleSummary): object;
    function getDeserializedJsonObj(obj: DetectorRuleSummary): object;
}

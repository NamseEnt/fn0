 ...
 **/
export declare enum DetectorEnum {
...
export declare namespace DetectorEnum {
    function getJsonObj(obj: DetectorEnum): DetectorEnum;
    function getDeserializedJsonObj(obj: DetectorEnum): DetectorEnum;
}

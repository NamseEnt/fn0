...
export interface DataSourceEventSummary {
     ...
     */
    "status"?: model.DataSourceEventInfoStatus;
    /**
     * Data source event comments
     */
    "comments"?: string;
    "eventInfo": model.LoggingEventInfo;
}
export declare namespace DataSourceEventSummary {
    function getJsonObj(obj: DataSourceEventSummary): object;
    function getDeserializedJsonObj(obj: DataSourceEventSummary): object;
}

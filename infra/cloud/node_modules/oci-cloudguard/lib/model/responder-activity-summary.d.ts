...
export declare namespace ResponderActivitySummary {
    function getJsonObj(obj: ResponderActivitySummary): object;
    function getDeserializedJsonObj(obj: ResponderActivitySummary): object;
}

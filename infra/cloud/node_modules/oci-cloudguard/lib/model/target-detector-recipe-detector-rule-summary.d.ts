...
export declare namespace TargetDetectorRecipeDetectorRuleSummary {
    enum ManagedListTypes {
    ...
    function getJsonObj(obj: TargetDetectorRecipeDetectorRuleSummary): object;
    function getDeserializedJsonObj(obj: TargetDetectorRecipeDetectorRuleSummary): object;
}

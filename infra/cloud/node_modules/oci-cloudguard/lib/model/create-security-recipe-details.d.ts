...
export declare namespace CreateSecurityRecipeDetails {
    function getJsonObj(obj: CreateSecurityRecipeDetails): object;
    function getDeserializedJsonObj(obj: CreateSecurityRecipeDetails): object;
}

...
export declare namespace DetectorRecipeDetectorRuleSummary {
    ...
    function getJsonObj(obj: DetectorRecipeDetectorRuleSummary): object;
    function getDeserializedJsonObj(obj: DetectorRecipeDetectorRuleSummary): object;
}

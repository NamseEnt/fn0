...
const AdditionalConfigPropertyDefinition = __importStar(require("./additional-config-property-definition"));
exports.AdditionalConfigPropertyDefinition = AdditionalConfigPropertyDefinition.AdditionalConfigPropertyDefinition;
const AdhocQuery = __importStar(require("./adhoc-query"));
exports.AdhocQuery = AdhocQuery.AdhocQuery;
const AdhocQueryCollection = __importStar(require("./adhoc-query-collection"));
exports.AdhocQueryCollection = AdhocQueryCollection.AdhocQueryCollection;
const AdhocQueryDetails = __importStar(require("./adhoc-query-details"));
exports.AdhocQueryDetails = AdhocQueryDetails.AdhocQueryDetails;
const AdhocQueryRegionalDetails = __importStar(require("./adhoc-query-regional-details"));
exports.AdhocQueryRegionalDetails = AdhocQueryRegionalDetails.AdhocQueryRegionalDetails;
const AdhocQueryResource = __importStar(require("./adhoc-query-resource"));
exports.AdhocQueryResource = AdhocQueryResource.AdhocQueryResource;
const AdhocQueryResultCollection = __importStar(require("./adhoc-query-result-collection"));
exports.AdhocQueryResultCollection = AdhocQueryResultCollection.AdhocQueryResultCollection;
const AdhocQueryResultState = __importStar(require("./adhoc-query-result-state"));
exports.AdhocQueryResultState = AdhocQueryResultState.AdhocQueryResultState;
const AdhocQueryResultSummary = __importStar(require("./adhoc-query-result-summary"));
exports.AdhocQueryResultSummary = AdhocQueryResultSummary.AdhocQueryResultSummary;
const AdhocQueryStatus = __importStar(require("./adhoc-query-status"));
exports.AdhocQueryStatus = AdhocQueryStatus.AdhocQueryStatus;
const AdhocQuerySummary = __importStar(require("./adhoc-query-summary"));
exports.AdhocQuerySummary = AdhocQuerySummary.AdhocQuerySummary;
...
const ChangeSavedQueryCompartmentDetails = __importStar(require("./change-saved-query-compartment-details"));
exports.ChangeSavedQueryCompartmentDetails = ChangeSavedQueryCompartmentDetails.ChangeSavedQueryCompartmentDetails;
...
const ConfigurationLifecycleState = __importStar(require("./configuration-lifecycle-state"));
exports.ConfigurationLifecycleState = ConfigurationLifecycleState.ConfigurationLifecycleState;
...
const CreateAdhocQueryDetails = __importStar(require("./create-adhoc-query-details"));
exports.CreateAdhocQueryDetails = CreateAdhocQueryDetails.CreateAdhocQueryDetails;
...
exports.CreateSavedQueryDetails = CreateSavedQueryDetails.CreateSavedQueryDetails;
...
const CreateWlpAgentDetails = __importStar(require("./create-wlp-agent-details"));
exports.CreateWlpAgentDetails = CreateWlpAgentDetails.CreateWlpAgentDetails;
const CveRiskLevel = __importStar(require("./cve-risk-level"));
exports.CveRiskLevel = CveRiskLevel.CveRiskLevel;
...
const DetectorRecipeEnum = __importStar(require("./detector-recipe-enum"));
exports.DetectorRecipeEnum = DetectorRecipeEnum.DetectorRecipeEnum;
...
const PackageDetail = __importStar(require("./package-detail"));
exports.PackageDetail = PackageDetail.PackageDetail;
...
const PropertyTuple = __importStar(require("./property-tuple"));
exports.PropertyTuple = PropertyTuple.PropertyTuple;
...
const ResourceAdditionalDetails = __importStar(require("./resource-additional-details"));
exports.ResourceAdditionalDetails = ResourceAdditionalDetails.ResourceAdditionalDetails;
const ResourceCollection = __importStar(require("./resource-collection"));
exports.ResourceCollection = ResourceCollection.ResourceCollection;
const ResourceLock = __importStar(require("./resource-lock"));
exports.ResourceLock = ResourceLock.ResourceLock;
const ResourcePortCollection = __importStar(require("./resource-port-collection"));
exports.ResourcePortCollection = ResourcePortCollection.ResourcePortCollection;
const ResourcePortSummary = __importStar(require("./resource-port-summary"));
exports.ResourcePortSummary = ResourcePortSummary.ResourcePortSummary;
...
const ResourceVulnerability = __importStar(require("./resource-vulnerability"));
exports.ResourceVulnerability = ResourceVulnerability.ResourceVulnerability;
const ResourceVulnerabilityCollection = __importStar(require("./resource-vulnerability-collection"));
exports.ResourceVulnerabilityCollection = ResourceVulnerabilityCollection.ResourceVulnerabilityCollection;
const ResourceVulnerabilitySummary = __importStar(require("./resource-vulnerability-summary"));
exports.ResourceVulnerabilitySummary = ResourceVulnerabilitySummary.ResourceVulnerabilitySummary;
...
const SavedQuery = __importStar(require("./saved-query"));
exports.SavedQuery = SavedQuery.SavedQuery;
const SavedQueryCollection = __importStar(require("./saved-query-collection"));
exports.SavedQueryCollection = SavedQueryCollection.SavedQueryCollection;
const SavedQuerySummary = __importStar(require("./saved-query-summary"));
exports.SavedQuerySummary = SavedQuerySummary.SavedQuerySummary;
const ScheduledQueryScopeDetail = __importStar(require("./scheduled-query-scope-detail"));
exports.ScheduledQueryScopeDetail = ScheduledQueryScopeDetail.ScheduledQueryScopeDetail;
...
const UpdateSavedQueryDetails = __importStar(require("./update-saved-query-details"));
exports.UpdateSavedQueryDetails = UpdateSavedQueryDetails.UpdateSavedQueryDetails;
...
const UpdateWlpAgentDetails = __importStar(require("./update-wlp-agent-details"));
exports.UpdateWlpAgentDetails = UpdateWlpAgentDetails.UpdateWlpAgentDetails;
const WlpAgent = __importStar(require("./wlp-agent"));
exports.WlpAgent = WlpAgent.WlpAgent;
const WlpAgentCollection = __importStar(require("./wlp-agent-collection"));
exports.WlpAgentCollection = WlpAgentCollection.WlpAgentCollection;
const WlpAgentSummary = __importStar(require("./wlp-agent-summary"));
exports.WlpAgentSummary = WlpAgentSummary.WlpAgentSummary;
...
const InstanceSecurityServiceConfiguration = __importStar(require("./instance-security-service-configuration"));
exports.InstanceSecurityServiceConfiguration = InstanceSecurityServiceConfiguration.InstanceSecurityServiceConfiguration;
...
const ScheduledQueryDataSourceObjDetails = __importStar(require("./scheduled-query-data-source-obj-details"));
exports.ScheduledQueryDataSourceObjDetails = ScheduledQueryDataSourceObjDetails.ScheduledQueryDataSourceObjDetails;
const ScheduledQueryDataSourceSummaryObjDetails = __importStar(require("./scheduled-query-data-source-summary-obj-details"));
exports.ScheduledQueryDataSourceSummaryObjDetails = ScheduledQueryDataSourceSummaryObjDetails.ScheduledQueryDataSourceSummaryObjDetails;

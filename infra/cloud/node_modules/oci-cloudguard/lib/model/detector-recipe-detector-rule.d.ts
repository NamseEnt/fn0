...
export declare namespace DetectorRecipeDetectorRule {
    ...
    function getJsonObj(obj: DetectorRecipeDetectorRule): object;
    function getDeserializedJsonObj(obj: DetectorRecipeDetectorRule): object;
}

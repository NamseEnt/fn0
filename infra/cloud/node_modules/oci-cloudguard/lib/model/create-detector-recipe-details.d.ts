...
export declare namespace CreateDetectorRecipeDetails {
    function getJsonObj(obj: CreateDetectorRecipeDetails): object;
    function getDeserializedJsonObj(obj: CreateDetectorRecipeDetails): object;
}

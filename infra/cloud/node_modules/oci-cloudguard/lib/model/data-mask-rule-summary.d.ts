...
export declare namespace DataMaskRuleSummary {
    ...
    function getJsonObj(obj: DataMaskRuleSummary): object;
    function getDeserializedJsonObj(obj: DataMaskRuleSummary): object;
}

...
export declare namespace SavedQuerySummary {
    function getJsonObj(obj: SavedQuerySummary): object;
    function getDeserializedJsonObj(obj: SavedQuerySummary): object;
}

...
export declare namespace ResponderRecipeSummary {
    function getJsonObj(obj: ResponderRecipeSummary): object;
    function getDeserializedJsonObj(obj: ResponderRecipeSummary): object;
}

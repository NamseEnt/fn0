...
export declare namespace AdditionalConfigPropertyDefinition {
    enum PropertyType {
        Hint = "HINT",
        Range = "RANGE",
        /**
    ...
    function getJsonObj(obj: AdditionalConfigPropertyDefinition): object;
    function getDeserializedJsonObj(obj: AdditionalConfigPropertyDefinition): object;
}

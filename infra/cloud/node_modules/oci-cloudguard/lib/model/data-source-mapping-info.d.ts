...
export declare namespace DataSourceMappingInfo {
    function getJsonObj(obj: DataSourceMappingInfo): object;
    function getDeserializedJsonObj(obj: DataSourceMappingInfo): object;
}

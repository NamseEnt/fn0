...
export declare namespace ManagedListSummary {
    function getJsonObj(obj: ManagedListSummary): object;
    function getDeserializedJsonObj(obj: ManagedListSummary): object;
}

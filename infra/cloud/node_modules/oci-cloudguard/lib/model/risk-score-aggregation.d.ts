...
export declare namespace RiskScoreAggregation {
    function getJsonObj(obj: RiskScoreAggregation): object;
    function getDeserializedJsonObj(obj: RiskScoreAggregation): object;
}

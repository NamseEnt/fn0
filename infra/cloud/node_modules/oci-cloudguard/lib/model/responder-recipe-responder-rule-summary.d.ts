...
export declare namespace ResponderRecipeResponderRuleSummary {
    enum SupportedModes {
    ...
    function getJsonObj(obj: ResponderRecipeResponderRuleSummary): object;
    function getDeserializedJsonObj(obj: ResponderRecipeResponderRuleSummary): object;
}

...
export declare namespace UpdateTargetRecipeDetectorRuleDetails {
    function getJsonObj(obj: UpdateTargetRecipeDetectorRuleDetails): object;
    function getDeserializedJsonObj(obj: UpdateTargetRecipeDetectorRuleDetails): object;
}

...
export declare namespace ResourceProfileImpactedResourceCollection {
    function getJsonObj(obj: ResourceProfileImpactedResourceCollection): object;
    function getDeserializedJsonObj(obj: ResourceProfileImpactedResourceCollection): object;
}

...
export declare namespace CompositeCondition {
    ...
    function getJsonObj(obj: CompositeCondition, isParentJsonObj?: boolean): object;
    const kind = "COMPOSITE";
    function getDeserializedJsonObj(obj: CompositeCondition, isParentJsonObj?: boolean): object;
}

...
export declare namespace ResourceProfileRiskScoreAggregationSummary {
    function getJsonObj(obj: ResourceProfileRiskScoreAggregationSummary): object;
    function getDeserializedJsonObj(obj: ResourceProfileRiskScoreAggregationSummary): object;
}

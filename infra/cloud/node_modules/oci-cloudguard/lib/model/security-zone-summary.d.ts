...
export declare namespace SecurityZoneSummary {
    function getJsonObj(obj: SecurityZoneSummary): object;
    function getDeserializedJsonObj(obj: SecurityZoneSummary): object;
}

...
export declare namespace UpdateTargetResponderRuleDetails {
    function getJsonObj(obj: UpdateTargetResponderRuleDetails): object;
    function getDeserializedJsonObj(obj: UpdateTargetResponderRuleDetails): object;
}

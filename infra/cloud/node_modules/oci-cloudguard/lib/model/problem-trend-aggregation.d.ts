 ...
 */
export interface ProblemTrendAggregation {
    /**
...
export declare namespace ProblemTrendAggregation {
    function getJsonObj(obj: ProblemTrendAggregation): object;
    function getDeserializedJsonObj(obj: ProblemTrendAggregation): object;
}

...
export declare namespace ProblemHistorySummary {
    function getJsonObj(obj: ProblemHistorySummary): object;
    function getDeserializedJsonObj(obj: ProblemHistorySummary): object;
}

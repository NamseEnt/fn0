...
export declare namespace DetectorRecipeDetectorRuleCollection {
    function getJsonObj(obj: DetectorRecipeDetectorRuleCollection): object;
    function getDeserializedJsonObj(obj: DetectorRecipeDetectorRuleCollection): object;
}

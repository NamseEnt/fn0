...
export declare namespace AlarmSuppressionAlarmTarget {
    function getJsonObj(obj: AlarmSuppressionAlarmTarget, isParentJsonObj?: boolean): object;
    const targetType = "ALARM";
    function getDeserializedJsonObj(obj: AlarmSuppressionAlarmTarget, isParentJsonObj?: boolean): object;
}

...
export declare namespace AlarmDimensionStatesCollection {
    function getJsonObj(obj: AlarmDimensionStatesCollection): object;
    function getDeserializedJsonObj(obj: AlarmDimensionStatesCollection): object;
}

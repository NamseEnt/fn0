...
export declare namespace AlarmSuppressionCompartmentTarget {
    function getJsonObj(obj: AlarmSuppressionCompartmentTarget, isParentJsonObj?: boolean): object;
    const targetType = "COMPARTMENT";
    function getDeserializedJsonObj(obj: AlarmSuppressionCompartmentTarget, isParentJsonObj?: boolean): object;
}

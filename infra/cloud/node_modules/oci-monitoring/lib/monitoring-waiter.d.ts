...
export declare class MonitoringWaiter {
    private client;
    private readonly config?;
    constructor(client: MonitoringClient, config?: Partial<import("oci-common/lib/waiter").WaiterConfigurationDetails> | undefined);
    /**

...
export declare namespace WebAppAccelerationPolicySummary {
    function getJsonObj(obj: WebAppAccelerationPolicySummary): object;
    function getDeserializedJsonObj(obj: WebAppAccelerationPolicySummary): object;
}

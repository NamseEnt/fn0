...
export declare namespace WebAppAccelerationSummary {
    function getJsonObj(obj: WebAppAccelerationSummary): object;
    function getDeserializedJsonObj(obj: WebAppAccelerationSummary): object;
}

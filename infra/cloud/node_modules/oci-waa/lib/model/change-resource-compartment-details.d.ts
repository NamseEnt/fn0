...
export declare namespace ChangeResourceCompartmentDetails {
    function getJsonObj(obj: ChangeResourceCompartmentDetails): object;
    function getDeserializedJsonObj(obj: ChangeResourceCompartmentDetails): object;
}

 ...
 *
 */
export interface UpdateGenerativeAiPrivateEndpointDetails {
    /**
...
export declare namespace UpdateGenerativeAiPrivateEndpointDetails {
    function getJsonObj(obj: UpdateGenerativeAiPrivateEndpointDetails): object;
    function getDeserializedJsonObj(obj: UpdateGenerativeAiPrivateEndpointDetails): object;
}

...
(function (ConnectorConfiguration) {
        ...
        if (obj && "type" in obj && obj.type) {
            switch (obj.type) {
                case "OBJECT_STORAGE_FILES":
                    return model.OciObjectStorageConfiguration.getJsonObj(jsonObj, true);
                default:
    ...
    ConnectorConfiguration.getJsonObj = getJsonObj;
    function getDeserializedJsonObj(obj) {
        const jsonObj = Object.assign(Object.assign({}, obj), {});
        if (obj && "type" in obj && obj.type) {
            switch (obj.type) {
                case "OBJECT_STORAGE_FILES":
                    return model.OciObjectStorageConfiguration.getDeserializedJsonObj(jsonObj, true);
                default:
                    if (common.LOG.logger)
                        common.LOG.logger.info(`Unknown value for: ${obj.type}`);
            }
    ...
    ConnectorConfiguration.getDeserializedJsonObj = getDeserializedJsonObj;
})(ConnectorConfiguration = exports.ConnectorConfiguration || (exports.ConnectorConfiguration = {}));
//# sourceMappingURL=connector-configuration.js.map
 ...
 */
export interface RefreshScheduleDetails {
    "type": string;
}
export declare namespace RefreshScheduleDetails {
    function getJsonObj(obj: RefreshScheduleDetails): object;
    function getDeserializedJsonObj(obj: RefreshScheduleDetails): object;
}

...
export declare namespace CreateApiKeyDetails {
    function getJsonObj(obj: CreateApiKeyDetails): object;
    function getDeserializedJsonObj(obj: CreateApiKeyDetails): object;
}

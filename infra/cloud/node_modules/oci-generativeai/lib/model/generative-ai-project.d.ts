...
*
*/
export interface GenerativeAiProject {
    /**
     ...
     */
    "lifecycleState": GenerativeAiProject.LifecycleState;
    /**
...
export declare namespace GenerativeAiProject {
    enum LifecycleState {
        Active = "ACTIVE",
        Creating = "CREATING",
        Updating = "UPDATING",
    ...
    function getJsonObj(obj: GenerativeAiProject): object;
    function getDeserializedJsonObj(obj: GenerativeAiProject): object;
}

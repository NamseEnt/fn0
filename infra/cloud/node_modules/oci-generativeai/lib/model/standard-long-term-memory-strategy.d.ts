 ...
 */
export interface StandardLongTermMemoryStrategy {
    /**
     * Indicates whether long-term memory is enabled.
     */
    "isEnabled": boolean;
    "extractionConfig"?: model.ExtractionConfig;
    "embeddingConfig"?: model.EmbeddingConfig;
}
export declare namespace StandardLongTermMemoryStrategy {
    function getJsonObj(obj: StandardLongTermMemoryStrategy): object;
    function getDeserializedJsonObj(obj: StandardLongTermMemoryStrategy): object;
}

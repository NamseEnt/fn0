...
(function (ScheduleConfig) {
    ...
    })(State = ScheduleConfig.State || (ScheduleConfig.State = {}));
    function getJsonObj(obj) {
        const jsonObj = Object.assign(Object.assign({}, obj), {});
        if (obj && "configType" in obj && obj.configType) {
            switch (obj.configType) {
                case "CRON":
                    return model.ScheduleCronConfig.getJsonObj(jsonObj, true);
                case "INTERVAL":
                    return model.ScheduleIntervalConfig.getJsonObj(jsonObj, true);
                default:
    ...
    ScheduleConfig.getJsonObj = getJsonObj;
    function getDeserializedJsonObj(obj) {
        const jsonObj = Object.assign(Object.assign({}, obj), {});
        if (obj && "configType" in obj && obj.configType) {
            switch (obj.configType) {
                case "CRON":
                    return model.ScheduleCronConfig.getDeserializedJsonObj(jsonObj, true);
                case "INTERVAL":
                    return model.ScheduleIntervalConfig.getDeserializedJsonObj(jsonObj, true);
                default:
                    if (common.LOG.logger)
                        common.LOG.logger.info(`Unknown value for: ${obj.configType}`);
            }
    ...
    ScheduleConfig.getDeserializedJsonObj = getDeserializedJsonObj;

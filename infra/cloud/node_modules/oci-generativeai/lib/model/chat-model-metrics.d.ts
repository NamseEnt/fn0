 ...
 *
 */
export interface ChatModelMetrics extends model.ModelMetrics {
    /**
...
export declare namespace ChatModelMetrics {
    function getJsonObj(obj: ChatModelMetrics, isParentJsonObj?: boolean): object;
    const modelMetricsType = "CHAT_MODEL_METRICS";
    function getDeserializedJsonObj(obj: ChatModelMetrics, isParentJsonObj?: boolean): object;
}

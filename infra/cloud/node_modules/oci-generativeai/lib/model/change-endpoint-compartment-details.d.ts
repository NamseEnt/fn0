...
export declare namespace ChangeEndpointCompartmentDetails {
    function getJsonObj(obj: ChangeEndpointCompartmentDetails): object;
    function getDeserializedJsonObj(obj: ChangeEndpointCompartmentDetails): object;
}

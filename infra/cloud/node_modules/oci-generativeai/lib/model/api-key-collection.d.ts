...
export interface ApiKeyCollection {
     ...
     * List of apiKeys.
     */
    "items": Array<model.ApiKeySummary>;
}
export declare namespace ApiKeyCollection {
    function getJsonObj(obj: ApiKeyCollection): object;
    function getDeserializedJsonObj(obj: ApiKeyCollection): object;
}

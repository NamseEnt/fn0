...
export declare namespace DedicatedAiClusterSummary {
    function getJsonObj(obj: DedicatedAiClusterSummary): object;
    function getDeserializedJsonObj(obj: DedicatedAiClusterSummary): object;
}

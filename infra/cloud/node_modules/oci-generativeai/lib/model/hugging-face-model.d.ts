...
export declare namespace HuggingFaceModel {
    function getJsonObj(obj: HuggingFaceModel, isParentJsonObj?: boolean): object;
    const sourceType = "HUGGING_FACE_MODEL";
    function getDeserializedJsonObj(obj: HuggingFaceModel, isParentJsonObj?: boolean): object;
}

 ...
 */
export interface AddArtifactDetails {
    "artifact": model.CreateSingleDockerArtifactDetails;
    /**
...
export declare namespace AddArtifactDetails {
    function getJsonObj(obj: AddArtifactDetails): object;
    function getDeserializedJsonObj(obj: AddArtifactDetails): object;
}

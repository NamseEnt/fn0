 ...
 */
export interface ChangeHostedApplicationCompartmentDetails {
    /**
     * The OCID of the compartment to move the hosted application to.
     */
    "compartmentId": string;
}
export declare namespace ChangeHostedApplicationCompartmentDetails {
    function getJsonObj(obj: ChangeHostedApplicationCompartmentDetails): object;
    function getDeserializedJsonObj(obj: ChangeHostedApplicationCompartmentDetails): object;
}

 ...
 */
export interface ChangeSemanticStoreCompartmentDetails {
    /**
...
export declare namespace ChangeSemanticStoreCompartmentDetails {
    function getJsonObj(obj: ChangeSemanticStoreCompartmentDetails): object;
    function getDeserializedJsonObj(obj: ChangeSemanticStoreCompartmentDetails): object;
}

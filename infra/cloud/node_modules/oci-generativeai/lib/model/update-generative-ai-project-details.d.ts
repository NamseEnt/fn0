 ...
 */
export interface UpdateGenerativeAiProjectDetails {
    /**
...
export declare namespace UpdateGenerativeAiProjectDetails {
    function getJsonObj(obj: UpdateGenerativeAiProjectDetails): object;
    function getDeserializedJsonObj(obj: UpdateGenerativeAiProjectDetails): object;
}

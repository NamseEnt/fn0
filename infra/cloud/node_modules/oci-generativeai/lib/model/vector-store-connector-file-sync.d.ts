...
export declare namespace VectorStoreConnectorFileSync {
    enum LifecycleState {
        Accepted = "ACCEPTED",
    ...
    function getJsonObj(obj: VectorStoreConnectorFileSync): object;
    function getDeserializedJsonObj(obj: VectorStoreConnectorFileSync): object;
}

 ...
 */
export interface CreateSchemasDatabaseToolsConnectionDetails extends model.CreateSchemasDetails {
    /**
     ...
     *
     */
    "schemas": Array<model.SchemaItem>;
    "connectionType": string;
}
export declare namespace CreateSchemasDatabaseToolsConnectionDetails {
    function getJsonObj(obj: CreateSchemasDatabaseToolsConnectionDetails, isParentJsonObj?: boolean): object;
    const connectionType = "DATABASE_TOOLS_CONNECTION";
    function getDeserializedJsonObj(obj: CreateSchemasDatabaseToolsConnectionDetails, isParentJsonObj?: boolean): object;
}

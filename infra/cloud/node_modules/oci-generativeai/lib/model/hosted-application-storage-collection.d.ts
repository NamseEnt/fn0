 ...
 */
export interface HostedApplicationStorageCollection {
    /**
     * List of hosted application storages.
     */
    "items": Array<model.HostedApplicationStorageSummary>;
}
export declare namespace HostedApplicationStorageCollection {
    function getJsonObj(obj: HostedApplicationStorageCollection): object;
    function getDeserializedJsonObj(obj: HostedApplicationStorageCollection): object;
}

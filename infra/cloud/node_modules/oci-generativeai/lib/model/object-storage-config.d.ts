...
export declare namespace ObjectStorageConfig {
    function getJsonObj(obj: ObjectStorageConfig): object;
    function getDeserializedJsonObj(obj: ObjectStorageConfig): object;
}

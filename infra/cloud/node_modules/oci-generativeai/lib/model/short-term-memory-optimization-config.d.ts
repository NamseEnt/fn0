 ...
 */
export interface ShortTermMemoryOptimizationConfig {
    /**
     * Indicates whether short-term memory optimization is enabled.
     */
    "isEnabled": boolean;
    "condenserConfig"?: model.CondenserConfig;
}
export declare namespace ShortTermMemoryOptimizationConfig {
    function getJsonObj(obj: ShortTermMemoryOptimizationConfig): object;
    function getDeserializedJsonObj(obj: ShortTermMemoryOptimizationConfig): object;
}

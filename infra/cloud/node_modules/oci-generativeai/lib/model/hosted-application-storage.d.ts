...
*
*/
export interface HostedApplicationStorage {
    /**
     ...
     */
    "lifecycleState": HostedApplicationStorage.LifecycleState;
    /**
...
export declare namespace HostedApplicationStorage {
    enum StorageType {
        Cache = "CACHE",
    ...
    function getJsonObj(obj: HostedApplicationStorage): object;
    function getDeserializedJsonObj(obj: HostedApplicationStorage): object;
}

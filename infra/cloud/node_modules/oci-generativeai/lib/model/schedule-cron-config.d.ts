 ...
 */
export interface ScheduleCronConfig extends model.ScheduleConfig {
    /**
...
export declare namespace ScheduleCronConfig {
    function getJsonObj(obj: ScheduleCronConfig, isParentJsonObj?: boolean): object;
    const configType = "CRON";
    function getDeserializedJsonObj(obj: ScheduleCronConfig, isParentJsonObj?: boolean): object;
}

 ...
 */
export interface ChangeGenerativeAiProjectCompartmentDetails {
    /**
     * The OCID of the compartment to move the GenerativeAiProject to.
     */
    "compartmentId": string;
}
export declare namespace ChangeGenerativeAiProjectCompartmentDetails {
    function getJsonObj(obj: ChangeGenerativeAiProjectCompartmentDetails): object;
    function getDeserializedJsonObj(obj: ChangeGenerativeAiProjectCompartmentDetails): object;
}

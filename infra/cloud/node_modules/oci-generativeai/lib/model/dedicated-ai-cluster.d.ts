...
export declare namespace DedicatedAiCluster {
    enum Type {
        Hosting = "HOSTING",
    ...
    function getJsonObj(obj: DedicatedAiCluster): object;
    function getDeserializedJsonObj(obj: DedicatedAiCluster): object;
}

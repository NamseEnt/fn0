 ...
 */
export interface CreateVectorStoreConnectorFileSyncDetails {
    /**
...
export declare namespace CreateVectorStoreConnectorFileSyncDetails {
    function getJsonObj(obj: CreateVectorStoreConnectorFileSyncDetails): object;
    function getDeserializedJsonObj(obj: CreateVectorStoreConnectorFileSyncDetails): object;
}

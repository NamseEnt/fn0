 ...
 *
 */
export interface VectorStoreConnectorCollection {
    /**
     * List of VectorStoreConnector objects.
     */
    "items": Array<model.VectorStoreConnectorSummary>;
}
export declare namespace VectorStoreConnectorCollection {
    function getJsonObj(obj: VectorStoreConnectorCollection): object;
    function getDeserializedJsonObj(obj: VectorStoreConnectorCollection): object;
}

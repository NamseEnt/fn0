 ...
 *
 */
export interface GenerativeAiPrivateEndpointCollection {
    /**
     * The results of a GenerativeAiPrivateEndpoint list.
     *
     */
    "items": Array<model.GenerativeAiPrivateEndpointSummary>;
}
export declare namespace GenerativeAiPrivateEndpointCollection {
    function getJsonObj(obj: GenerativeAiPrivateEndpointCollection): object;
    function getDeserializedJsonObj(obj: GenerativeAiPrivateEndpointCollection): object;
}

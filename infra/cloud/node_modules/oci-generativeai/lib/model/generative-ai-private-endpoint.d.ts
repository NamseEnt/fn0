...
export declare namespace GenerativeAiPrivateEndpoint {
    enum LifecycleState {
        Creating = "CREATING",
        Active = "ACTIVE",
        Updating = "UPDATING",
    ...
    function getJsonObj(obj: GenerativeAiPrivateEndpoint): object;
    function getDeserializedJsonObj(obj: GenerativeAiPrivateEndpoint): object;
}

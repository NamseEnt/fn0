 ...
 */
export interface VectorStoreConnectorFileSyncCollection {
    /**
     * List of VectorStoreConnectorFileSync operations.
     */
    "items": Array<model.VectorStoreConnectorFileSyncSummary>;
}
export declare namespace VectorStoreConnectorFileSyncCollection {
    function getJsonObj(obj: VectorStoreConnectorFileSyncCollection): object;
    function getDeserializedJsonObj(obj: VectorStoreConnectorFileSyncCollection): object;
}

...
export interface FineTuneDetails {
    ...
    "trainingConfig"?: model.LoraTrainingConfig | model.VanillaTrainingConfig | model.TFewTrainingConfig;
}
export declare namespace FineTuneDetails {
    function getJsonObj(obj: FineTuneDetails): object;
    function getDeserializedJsonObj(obj: FineTuneDetails): object;
}

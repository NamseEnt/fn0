 ...
 */
export interface ChangeApiKeyCompartmentDetails {
    /**
     * The OCID of the compartment to move the APIKey to.
     */
    "compartmentId": string;
}
export declare namespace ChangeApiKeyCompartmentDetails {
    function getJsonObj(obj: ChangeApiKeyCompartmentDetails): object;
    function getDeserializedJsonObj(obj: ChangeApiKeyCompartmentDetails): object;
}

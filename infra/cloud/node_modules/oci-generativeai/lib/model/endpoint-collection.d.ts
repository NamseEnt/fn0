...
export declare namespace EndpointCollection {
    function getJsonObj(obj: EndpointCollection): object;
    function getDeserializedJsonObj(obj: EndpointCollection): object;
}

...
export declare namespace ModelCapability {
    function getJsonObj(obj: ModelCapability): ModelCapability;
    function getDeserializedJsonObj(obj: ModelCapability): ModelCapability;
}

 ...
 */
export interface FileSyncIngestionLogsCollection {
    /**
     * List of VectorStoreConnectorIngestionLogs objects.
     */
    "items": Array<model.FileSyncIngestionLogs>;
}
export declare namespace FileSyncIngestionLogsCollection {
    function getJsonObj(obj: FileSyncIngestionLogsCollection): object;
    function getDeserializedJsonObj(obj: FileSyncIngestionLogsCollection): object;
}

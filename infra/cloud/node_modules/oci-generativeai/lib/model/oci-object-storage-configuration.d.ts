 ...
 */
export interface OciObjectStorageConfiguration extends model.ConnectorConfiguration {
    /**
     * List of Object Storage Configurations for datasource.
     */
    "storageConfigList": Array<model.ObjectStorageConfig>;
    "type": string;
}
export declare namespace OciObjectStorageConfiguration {
    function getJsonObj(obj: OciObjectStorageConfiguration, isParentJsonObj?: boolean): object;
    const type = "OBJECT_STORAGE_FILES";
    function getDeserializedJsonObj(obj: OciObjectStorageConfiguration, isParentJsonObj?: boolean): object;
}

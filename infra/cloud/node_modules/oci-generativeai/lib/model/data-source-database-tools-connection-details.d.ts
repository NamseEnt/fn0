 ...
 */
export interface DataSourceDatabaseToolsConnectionDetails extends model.DataSourceDetails {
    /**
...
export declare namespace DataSourceDatabaseToolsConnectionDetails {
    function getJsonObj(obj: DataSourceDatabaseToolsConnectionDetails, isParentJsonObj?: boolean): object;
    const connectionType = "DATABASE_TOOLS_CONNECTION";
    function getDeserializedJsonObj(obj: DataSourceDatabaseToolsConnectionDetails, isParentJsonObj?: boolean): object;
}

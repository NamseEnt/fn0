...
export declare namespace ImportedModelSummary {
    enum Capabilities {
    ...
    function getJsonObj(obj: ImportedModelSummary): object;
    function getDeserializedJsonObj(obj: ImportedModelSummary): object;
}

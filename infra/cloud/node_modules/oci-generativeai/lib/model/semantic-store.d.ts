...
export interface SemanticStore {
     ...
     */
    "lifecycleState": SemanticStore.LifecycleState;
    /**
...
export declare namespace SemanticStore {
    enum LifecycleState {
        Active = "ACTIVE",
        Creating = "CREATING",
        Updating = "UPDATING",
    ...
    function getJsonObj(obj: SemanticStore): object;
    function getDeserializedJsonObj(obj: SemanticStore): object;
}

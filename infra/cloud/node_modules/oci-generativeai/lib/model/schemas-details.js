...
(function (SchemasDetails) {
    ...
    SchemasDetails.getJsonObj = getJsonObj;
    function getDeserializedJsonObj(obj) {
        const jsonObj = Object.assign(Object.assign({}, obj), {});
        if (obj && "connectionType" in obj && obj.connectionType) {
            switch (obj.connectionType) {
                case "DATABASE_TOOLS_CONNECTION":
                    return model.SchemasDatabaseToolsConnectionDetails.getDeserializedJsonObj(jsonObj, true);
                default:
                    if (common.LOG.logger)
                        common.LOG.logger.info(`Unknown value for: ${obj.connectionType}`);
            }
    ...
    SchemasDetails.getDeserializedJsonObj = getDeserializedJsonObj;
})(SchemasDetails = exports.SchemasDetails || (exports.SchemasDetails = {}));
//# sourceMappingURL=schemas-details.js.map
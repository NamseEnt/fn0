 ...
 *
 */
export interface TextGenerationModelMetrics extends model.ModelMetrics {
    /**
...
export declare namespace TextGenerationModelMetrics {
    function getJsonObj(obj: TextGenerationModelMetrics, isParentJsonObj?: boolean): object;
    const modelMetricsType = "TEXT_GENERATION_MODEL_METRICS";
    function getDeserializedJsonObj(obj: TextGenerationModelMetrics, isParentJsonObj?: boolean): object;
}

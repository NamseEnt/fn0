...
export declare namespace VanillaTrainingConfig {
    function getJsonObj(obj: VanillaTrainingConfig, isParentJsonObj?: boolean): object;
    const trainingConfigType = "VANILLA_TRAINING_CONFIG";
    function getDeserializedJsonObj(obj: VanillaTrainingConfig, isParentJsonObj?: boolean): object;
}

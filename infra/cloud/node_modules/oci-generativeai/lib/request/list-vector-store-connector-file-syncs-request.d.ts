...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/generativeai/ListVectorStoreConnectorFileSyncs.ts.html |here} to see how to use ListVectorStoreConnectorFileSyncsRequest.
 */
export interface ListVectorStoreConnectorFileSyncsRequest extends common.BaseRequest {
    /**
...
export declare namespace ListVectorStoreConnectorFileSyncsRequest {
    enum SortBy {

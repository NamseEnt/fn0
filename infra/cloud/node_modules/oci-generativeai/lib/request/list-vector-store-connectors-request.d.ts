...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/generativeai/ListVectorStoreConnectors.ts.html |here} to see how to use ListVectorStoreConnectorsRequest.
 */
export interface ListVectorStoreConnectorsRequest extends common.BaseRequest {
    /**
     ...
     * Default order for {@code name} is ascending.
     *
     */
...
export declare namespace ListVectorStoreConnectorsRequest {
    enum SortBy {
        Name = "name",

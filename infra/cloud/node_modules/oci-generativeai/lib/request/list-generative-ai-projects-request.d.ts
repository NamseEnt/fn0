...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/generativeai/ListGenerativeAiProjects.ts.html |here} to see how to use ListGenerativeAiProjectsRequest.
 */
export interface ListGenerativeAiProjectsRequest extends common.BaseRequest {
    /**
...
export declare namespace ListGenerativeAiProjectsRequest {
    enum SortBy {

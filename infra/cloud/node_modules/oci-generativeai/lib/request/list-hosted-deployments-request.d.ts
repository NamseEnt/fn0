...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/generativeai/ListHostedDeployments.ts.html |here} to see how to use ListHostedDeploymentsRequest.
 */
export interface ListHostedDeploymentsRequest extends common.BaseRequest {
    /**
...
export declare namespace ListHostedDeploymentsRequest {
    enum SortBy {

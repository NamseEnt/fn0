...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/generativeai/ListHostedApplications.ts.html |here} to see how to use ListHostedApplicationsRequest.
 */
export interface ListHostedApplicationsRequest extends common.BaseRequest {
    /**
...
export declare namespace ListHostedApplicationsRequest {
    enum SortBy {

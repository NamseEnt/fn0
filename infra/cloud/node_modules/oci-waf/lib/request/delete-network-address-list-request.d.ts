...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/waf/DeleteNetworkAddressList.ts.html |here} to see how to use DeleteNetworkAddressListRequest.
 */
export interface DeleteNetworkAddressListRequest extends common.BaseRequest {
    /**

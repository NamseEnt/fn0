...
export declare namespace WebAppFirewallPolicySummary {
    function getJsonObj(obj: WebAppFirewallPolicySummary): object;
    function getDeserializedJsonObj(obj: WebAppFirewallPolicySummary): object;
}

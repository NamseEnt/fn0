 ...
 */
export interface CreateWebAppFirewallPolicyDetails {
    /**
...
export declare namespace CreateWebAppFirewallPolicyDetails {
    function getJsonObj(obj: CreateWebAppFirewallPolicyDetails): object;
    function getDeserializedJsonObj(obj: CreateWebAppFirewallPolicyDetails): object;
}

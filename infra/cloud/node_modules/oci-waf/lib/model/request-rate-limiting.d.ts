...
export declare namespace RequestRateLimiting {
    function getJsonObj(obj: RequestRateLimiting): object;
    function getDeserializedJsonObj(obj: RequestRateLimiting): object;
}

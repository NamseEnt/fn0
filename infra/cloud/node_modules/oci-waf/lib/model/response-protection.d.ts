...
export declare namespace ResponseProtection {
    function getJsonObj(obj: ResponseProtection): object;
    function getDeserializedJsonObj(obj: ResponseProtection): object;
}

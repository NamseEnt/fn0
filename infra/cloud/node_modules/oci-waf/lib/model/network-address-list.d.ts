...
export interface NetworkAddressList {
     ...
     */
    "lifecycleState": NetworkAddressList.LifecycleState;
    /**
...
export declare namespace NetworkAddressList {
    enum LifecycleState {
        Creating = "CREATING",
        Updating = "UPDATING",
        Active = "ACTIVE",
    ...
    function getJsonObj(obj: NetworkAddressList): object;
    function getDeserializedJsonObj(obj: NetworkAddressList): object;
}

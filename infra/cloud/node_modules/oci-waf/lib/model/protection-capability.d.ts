...
export declare namespace ProtectionCapability {
    function getJsonObj(obj: ProtectionCapability): object;
    function getDeserializedJsonObj(obj: ProtectionCapability): object;
}

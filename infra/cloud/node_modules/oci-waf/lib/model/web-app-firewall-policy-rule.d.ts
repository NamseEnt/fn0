...
export declare namespace WebAppFirewallPolicyRule {
    ...
    function getJsonObj(obj: WebAppFirewallPolicyRule): object;
    function getDeserializedJsonObj(obj: WebAppFirewallPolicyRule): object;
}

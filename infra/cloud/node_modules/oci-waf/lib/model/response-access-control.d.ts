 ...
 */
export interface ResponseAccessControl {
    /**
...
export declare namespace ResponseAccessControl {
    function getJsonObj(obj: ResponseAccessControl): object;
    function getDeserializedJsonObj(obj: ResponseAccessControl): object;
}

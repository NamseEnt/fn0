 ...
 */
export interface UpdateMediaWorkflowDetails {
    /**
...
export declare namespace UpdateMediaWorkflowDetails {
    function getJsonObj(obj: UpdateMediaWorkflowDetails): object;
    function getDeserializedJsonObj(obj: UpdateMediaWorkflowDetails): object;
}

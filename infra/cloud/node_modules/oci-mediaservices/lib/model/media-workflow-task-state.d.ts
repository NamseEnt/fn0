...
export declare namespace MediaWorkflowTaskState {
    function getJsonObj(obj: MediaWorkflowTaskState): object;
    function getDeserializedJsonObj(obj: MediaWorkflowTaskState): object;
}

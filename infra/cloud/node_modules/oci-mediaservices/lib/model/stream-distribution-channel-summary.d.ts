 ...
 */
export interface StreamDistributionChannelSummary {
    /**
...
export declare namespace StreamDistributionChannelSummary {
    function getJsonObj(obj: StreamDistributionChannelSummary): object;
    function getDeserializedJsonObj(obj: StreamDistributionChannelSummary): object;
}

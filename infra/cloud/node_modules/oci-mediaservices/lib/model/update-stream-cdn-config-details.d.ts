 ...
 */
export interface UpdateStreamCdnConfigDetails {
    /**
...
export declare namespace UpdateStreamCdnConfigDetails {
    function getJsonObj(obj: UpdateStreamCdnConfigDetails): object;
    function getDeserializedJsonObj(obj: UpdateStreamCdnConfigDetails): object;
}

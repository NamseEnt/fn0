...
export declare namespace CreateMediaAssetDetails {
    function getJsonObj(obj: CreateMediaAssetDetails): object;
    function getDeserializedJsonObj(obj: CreateMediaAssetDetails): object;
}

...
export declare namespace UpdateMediaWorkflowConfigurationDetails {
    function getJsonObj(obj: UpdateMediaWorkflowConfigurationDetails): object;
    function getDeserializedJsonObj(obj: UpdateMediaWorkflowConfigurationDetails): object;
}

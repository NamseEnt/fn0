...
export declare namespace MediaWorkflowJobSummary {
    function getJsonObj(obj: MediaWorkflowJobSummary): object;
    function getDeserializedJsonObj(obj: MediaWorkflowJobSummary): object;
}

 ...
 *
 */
export interface MediaWorkflowJobCollection {
    /**
     * List of mediaWorkflowJob items.
     */
    "items": Array<model.MediaWorkflowJobSummary>;
}
export declare namespace MediaWorkflowJobCollection {
    function getJsonObj(obj: MediaWorkflowJobCollection): object;
    function getDeserializedJsonObj(obj: MediaWorkflowJobCollection): object;
}

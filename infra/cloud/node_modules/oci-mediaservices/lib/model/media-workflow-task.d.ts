...
export declare namespace MediaWorkflowTask {
    function getJsonObj(obj: MediaWorkflowTask): object;
    function getDeserializedJsonObj(obj: MediaWorkflowTask): object;
}

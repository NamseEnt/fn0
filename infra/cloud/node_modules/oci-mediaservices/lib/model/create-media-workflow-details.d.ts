...
export declare namespace CreateMediaWorkflowDetails {
    function getJsonObj(obj: CreateMediaWorkflowDetails): object;
    function getDeserializedJsonObj(obj: CreateMediaWorkflowDetails): object;
}

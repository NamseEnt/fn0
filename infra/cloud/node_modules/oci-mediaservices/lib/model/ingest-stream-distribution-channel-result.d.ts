...
export declare namespace IngestStreamDistributionChannelResult {
    function getJsonObj(obj: IngestStreamDistributionChannelResult): object;
    function getDeserializedJsonObj(obj: IngestStreamDistributionChannelResult): object;
}

...
export declare namespace StreamCdnConfigSection {
    function getJsonObj(obj: StreamCdnConfigSection): object;
    function getDeserializedJsonObj(obj: StreamCdnConfigSection): object;
}

 ...
 */
export interface CreateStreamCdnConfigDetails {
    /**
...
export declare namespace CreateStreamCdnConfigDetails {
    function getJsonObj(obj: CreateStreamCdnConfigDetails): object;
    function getDeserializedJsonObj(obj: CreateStreamCdnConfigDetails): object;
}

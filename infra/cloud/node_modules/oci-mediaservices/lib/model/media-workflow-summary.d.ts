...
export declare namespace MediaWorkflowSummary {
    function getJsonObj(obj: MediaWorkflowSummary): object;
    function getDeserializedJsonObj(obj: MediaWorkflowSummary): object;
}

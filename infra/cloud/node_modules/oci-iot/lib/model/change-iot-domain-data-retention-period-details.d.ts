...
export declare namespace ChangeIotDomainDataRetentionPeriodDetails {
    enum Type {
        RawData = "RAW_DATA",
    ...
    function getJsonObj(obj: ChangeIotDomainDataRetentionPeriodDetails): object;
    function getDeserializedJsonObj(obj: ChangeIotDomainDataRetentionPeriodDetails): object;
}

...
export declare namespace UpdateDigitalTwinInstanceDetails {
    function getJsonObj(obj: UpdateDigitalTwinInstanceDetails): object;
    function getDeserializedJsonObj(obj: UpdateDigitalTwinInstanceDetails): object;
}

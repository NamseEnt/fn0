...
export declare namespace CreateDigitalTwinAdapterDetails {
    function getJsonObj(obj: CreateDigitalTwinAdapterDetails): object;
    function getDeserializedJsonObj(obj: CreateDigitalTwinAdapterDetails): object;
}

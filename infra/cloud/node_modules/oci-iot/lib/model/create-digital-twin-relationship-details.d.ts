 ...
 */
export interface CreateDigitalTwinRelationshipDetails {
    /**
...
export declare namespace CreateDigitalTwinRelationshipDetails {
    function getJsonObj(obj: CreateDigitalTwinRelationshipDetails): object;
    function getDeserializedJsonObj(obj: CreateDigitalTwinRelationshipDetails): object;
}

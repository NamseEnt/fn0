 ...
 */
export interface ChangeIotDomainGroupCompartmentDetails {
    /**
...
export declare namespace ChangeIotDomainGroupCompartmentDetails {
    function getJsonObj(obj: ChangeIotDomainGroupCompartmentDetails): object;
    function getDeserializedJsonObj(obj: ChangeIotDomainGroupCompartmentDetails): object;
}

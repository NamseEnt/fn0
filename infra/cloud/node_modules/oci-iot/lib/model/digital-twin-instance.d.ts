...
export declare namespace DigitalTwinInstance {
    function getJsonObj(obj: DigitalTwinInstance): object;
    function getDeserializedJsonObj(obj: DigitalTwinInstance): object;
}

 ...
 */
export interface IotDomainGroupCollection {
    /**
     * List of IoT Domain Group.
     */
    "items": Array<model.IotDomainGroupSummary>;
}
export declare namespace IotDomainGroupCollection {
    function getJsonObj(obj: IotDomainGroupCollection): object;
    function getDeserializedJsonObj(obj: IotDomainGroupCollection): object;
}

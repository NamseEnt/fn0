...
*
*/
export interface DigitalTwinAdapter {
    /**
...
export declare namespace DigitalTwinAdapter {
    function getJsonObj(obj: DigitalTwinAdapter): object;
    function getDeserializedJsonObj(obj: DigitalTwinAdapter): object;
}

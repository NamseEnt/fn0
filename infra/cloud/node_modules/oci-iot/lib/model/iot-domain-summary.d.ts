 ...
 */
export interface IotDomainSummary {
    /**
...
export declare namespace IotDomainSummary {
    function getJsonObj(obj: IotDomainSummary): object;
    function getDeserializedJsonObj(obj: IotDomainSummary): object;
}

...
export declare namespace DigitalTwinAdapterInboundEnvelope {
    function getJsonObj(obj: DigitalTwinAdapterInboundEnvelope): object;
    function getDeserializedJsonObj(obj: DigitalTwinAdapterInboundEnvelope): object;
}

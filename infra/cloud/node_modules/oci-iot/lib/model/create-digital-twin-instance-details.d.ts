 ...
 */
export interface CreateDigitalTwinInstanceDetails {
    /**
...
export declare namespace CreateDigitalTwinInstanceDetails {
    function getJsonObj(obj: CreateDigitalTwinInstanceDetails): object;
    function getDeserializedJsonObj(obj: CreateDigitalTwinInstanceDetails): object;
}

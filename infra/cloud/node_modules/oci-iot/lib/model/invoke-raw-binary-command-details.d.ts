 ...
 */
export interface InvokeRawBinaryCommandDetails extends model.InvokeRawCommandDetails {
    /**
...
export declare namespace InvokeRawBinaryCommandDetails {
    function getJsonObj(obj: InvokeRawBinaryCommandDetails, isParentJsonObj?: boolean): object;
    const requestDataFormat = "BINARY";
    function getDeserializedJsonObj(obj: InvokeRawBinaryCommandDetails, isParentJsonObj?: boolean): object;
}

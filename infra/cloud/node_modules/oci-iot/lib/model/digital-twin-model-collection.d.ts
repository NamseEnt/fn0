 ...
 */
export interface DigitalTwinModelCollection {
    /**
     * List of digital twin models.
     */
    "items": Array<model.DigitalTwinModelSummary>;
}
export declare namespace DigitalTwinModelCollection {
    function getJsonObj(obj: DigitalTwinModelCollection): object;
    function getDeserializedJsonObj(obj: DigitalTwinModelCollection): object;
}

 ...
 */
export interface CreateIotDomainDetails {
    /**
...
export declare namespace CreateIotDomainDetails {
    function getJsonObj(obj: CreateIotDomainDetails): object;
    function getDeserializedJsonObj(obj: CreateIotDomainDetails): object;
}

...
export declare namespace InvokeRawCommandDetails {
    function getJsonObj(obj: InvokeRawCommandDetails): object;
    function getDeserializedJsonObj(obj: InvokeRawCommandDetails): object;
}

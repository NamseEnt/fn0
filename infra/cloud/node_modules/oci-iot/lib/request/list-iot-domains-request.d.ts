...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/iot/ListIotDomains.ts.html |here} to see how to use ListIotDomainsRequest.
 */
export interface ListIotDomainsRequest extends common.BaseRequest {
    /**
...
export declare namespace ListIotDomainsRequest {
    enum SortOrder {
        Asc = "ASC",
        Desc = "DESC"
    }

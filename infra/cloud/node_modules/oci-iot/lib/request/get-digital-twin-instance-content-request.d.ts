...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/iot/GetDigitalTwinInstanceContent.ts.html |here} to see how to use GetDigitalTwinInstanceContentRequest.
 */
export interface GetDigitalTwinInstanceContentRequest extends common.BaseRequest {
    /**

...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/iot/ListDigitalTwinAdapters.ts.html |here} to see how to use ListDigitalTwinAdaptersRequest.
 */
export interface ListDigitalTwinAdaptersRequest extends common.BaseRequest {
    /**
...
export declare namespace ListDigitalTwinAdaptersRequest {
    enum SortOrder {
        Asc = "ASC",
        Desc = "DESC"
    }

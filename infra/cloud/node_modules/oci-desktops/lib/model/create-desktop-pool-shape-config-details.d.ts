...
export declare namespace CreateDesktopPoolShapeConfigDetails {
    enum BaselineOcpuUtilization {
        Baseline18 = "BASELINE_1_8",
        Baseline12 = "BASELINE_1_2",
        Baseline11 = "BASELINE_1_1"
    }
    function getJsonObj(obj: CreateDesktopPoolShapeConfigDetails): object;
    function getDeserializedJsonObj(obj: CreateDesktopPoolShapeConfigDetails): object;
}

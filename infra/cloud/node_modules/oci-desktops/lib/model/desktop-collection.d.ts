...
export interface DesktopCollection {
     ...
     */
    "items": Array<model.DesktopSummary>;
}
export declare namespace DesktopCollection {
    function getJsonObj(obj: DesktopCollection): object;
    function getDeserializedJsonObj(obj: DesktopCollection): object;
}

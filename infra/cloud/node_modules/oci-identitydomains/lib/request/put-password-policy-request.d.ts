...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/identitydomains/PutPasswordPolicy.ts.html |here} to see how to use PutPasswordPolicyRequest.
 */
export interface PutPasswordPolicyRequest extends common.BaseRequest {
    /**
     * ID of the resource
     */

...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/identitydomains/ListResourceTypeSchemaAttributes.ts.html |here} to see how to use ListResourceTypeSchemaAttributesRequest.
 */
export interface ListResourceTypeSchemaAttributesRequest extends common.BaseRequest {
    /**

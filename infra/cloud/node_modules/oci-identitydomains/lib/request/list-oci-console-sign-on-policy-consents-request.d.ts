...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/identitydomains/ListOciConsoleSignOnPolicyConsents.ts.html |here} to see how to use ListOciConsoleSignOnPolicyConsentsRequest.
 */
export interface ListOciConsoleSignOnPolicyConsentsRequest extends common.BaseRequest {
    /**

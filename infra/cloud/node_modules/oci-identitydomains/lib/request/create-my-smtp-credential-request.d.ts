...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/identitydomains/CreateMySmtpCredential.ts.html |here} to see how to use CreateMySmtpCredentialRequest.
 */
export interface CreateMySmtpCredentialRequest extends common.BaseRequest {
    /**
  ...
  *
   */
    "mySmtpCredential"?: model.MySmtpCredential;
    /**

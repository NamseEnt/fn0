...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/identitydomains/CreateSocialIdentityProvider.ts.html |here} to see how to use CreateSocialIdentityProviderRequest.
 */
export interface CreateSocialIdentityProviderRequest extends common.BaseRequest {
    /**
  ...
  *
   */
    "socialIdentityProvider"?: model.SocialIdentityProvider;
    /**

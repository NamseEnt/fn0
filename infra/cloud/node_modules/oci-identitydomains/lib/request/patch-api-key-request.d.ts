...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/identitydomains/PatchApiKey.ts.html |here} to see how to use PatchApiKeyRequest.
 */
export interface PatchApiKeyRequest extends common.BaseRequest {
    /**
     * ID of the resource
     */
    "apiKeyId": string;

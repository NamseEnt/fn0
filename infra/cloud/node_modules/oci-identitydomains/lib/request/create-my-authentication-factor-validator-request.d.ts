...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/identitydomains/CreateMyAuthenticationFactorValidator.ts.html |here} to see how to use CreateMyAuthenticationFactorValidatorRequest.
 */
export interface CreateMyAuthenticationFactorValidatorRequest extends common.BaseRequest {
    /**
  ...
  *
   */
    "myAuthenticationFactorValidator"?: model.MyAuthenticationFactorValidator;
    /**

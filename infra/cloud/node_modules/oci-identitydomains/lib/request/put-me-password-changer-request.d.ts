...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/identitydomains/PutMePasswordChanger.ts.html |here} to see how to use PutMePasswordChangerRequest.
 */
export interface PutMePasswordChangerRequest extends common.BaseRequest {
    /**
  ...
  *
   */
    "mePasswordChanger"?: model.MePasswordChanger;
    /**

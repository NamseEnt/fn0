...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/identitydomains/PatchGroup.ts.html |here} to see how to use PatchGroupRequest.
 */
export interface PatchGroupRequest extends common.BaseRequest {
    /**
     * ID of the resource
     */
    "groupId": string;

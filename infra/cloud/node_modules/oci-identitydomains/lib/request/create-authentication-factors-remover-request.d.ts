...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/identitydomains/CreateAuthenticationFactorsRemover.ts.html |here} to see how to use CreateAuthenticationFactorsRemoverRequest.
 */
export interface CreateAuthenticationFactorsRemoverRequest extends common.BaseRequest {
    /**
  ...
  *
   */
    "authenticationFactorsRemover"?: model.AuthenticationFactorsRemover;
    /**

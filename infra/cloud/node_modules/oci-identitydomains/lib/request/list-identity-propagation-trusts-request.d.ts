...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/identitydomains/ListIdentityPropagationTrusts.ts.html |here} to see how to use ListIdentityPropagationTrustsRequest.
 */
export interface ListIdentityPropagationTrustsRequest extends common.BaseRequest {
    /**

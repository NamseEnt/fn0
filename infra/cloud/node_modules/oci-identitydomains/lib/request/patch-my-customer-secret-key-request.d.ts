...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/identitydomains/PatchMyCustomerSecretKey.ts.html |here} to see how to use PatchMyCustomerSecretKeyRequest.
 */
export interface PatchMyCustomerSecretKeyRequest extends common.BaseRequest {
    /**
     * ID of the resource
     */

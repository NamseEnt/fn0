...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/identitydomains/PatchSecurityQuestionSetting.ts.html |here} to see how to use PatchSecurityQuestionSettingRequest.
 */
export interface PatchSecurityQuestionSettingRequest extends common.BaseRequest {
    /**
     * ID of the resource
     */

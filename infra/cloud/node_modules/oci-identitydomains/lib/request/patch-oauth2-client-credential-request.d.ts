...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/identitydomains/PatchOAuth2ClientCredential.ts.html |here} to see how to use PatchOAuth2ClientCredentialRequest.
 */
export interface PatchOAuth2ClientCredentialRequest extends common.BaseRequest {
    /**
     * ID of the resource
     */

...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/identitydomains/PatchCustomerSecretKey.ts.html |here} to see how to use PatchCustomerSecretKeyRequest.
 */
export interface PatchCustomerSecretKeyRequest extends common.BaseRequest {
    /**
     * ID of the resource
     */

...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/identitydomains/PatchMySmtpCredential.ts.html |here} to see how to use PatchMySmtpCredentialRequest.
 */
export interface PatchMySmtpCredentialRequest extends common.BaseRequest {
    /**
     * ID of the resource
     */

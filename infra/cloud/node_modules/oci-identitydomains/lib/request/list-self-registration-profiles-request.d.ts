...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/identitydomains/ListSelfRegistrationProfiles.ts.html |here} to see how to use ListSelfRegistrationProfilesRequest.
 */
export interface ListSelfRegistrationProfilesRequest extends common.BaseRequest {
    /**

...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/identitydomains/PatchSchema.ts.html |here} to see how to use PatchSchemaRequest.
 */
export interface PatchSchemaRequest extends common.BaseRequest {
    /**
     * ID of the resource
     */
    "schemaId": string;

...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/identitydomains/CreateAppRole.ts.html |here} to see how to use CreateAppRoleRequest.
 */
export interface CreateAppRoleRequest extends common.BaseRequest {
    /**

...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/identitydomains/PatchAccountRecoverySetting.ts.html |here} to see how to use PatchAccountRecoverySettingRequest.
 */
export interface PatchAccountRecoverySettingRequest extends common.BaseRequest {
    /**
     * ID of the resource
     */

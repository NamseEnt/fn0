...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/identitydomains/CreateIdentityProofingProvider.ts.html |here} to see how to use CreateIdentityProofingProviderRequest.
 */
export interface CreateIdentityProofingProviderRequest extends common.BaseRequest {
    /**
  ...
  *
   */
    "identityProofingProvider"?: model.IdentityProofingProvider;
    /**

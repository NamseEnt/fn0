...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/identitydomains/ListIdentityProofingProviderTemplates.ts.html |here} to see how to use ListIdentityProofingProviderTemplatesRequest.
 */
export interface ListIdentityProofingProviderTemplatesRequest extends common.BaseRequest {
    /**

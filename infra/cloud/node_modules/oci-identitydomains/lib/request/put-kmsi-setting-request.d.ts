...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/identitydomains/PutKmsiSetting.ts.html |here} to see how to use PutKmsiSettingRequest.
 */
export interface PutKmsiSettingRequest extends common.BaseRequest {
    /**
     * ID of the resource
     */

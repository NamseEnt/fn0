...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/identitydomains/ListMyCompletedApprovals.ts.html |here} to see how to use ListMyCompletedApprovalsRequest.
 */
export interface ListMyCompletedApprovalsRequest extends common.BaseRequest {
    /**

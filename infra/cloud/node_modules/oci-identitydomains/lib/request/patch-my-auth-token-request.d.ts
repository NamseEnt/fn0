...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/identitydomains/PatchMyAuthToken.ts.html |here} to see how to use PatchMyAuthTokenRequest.
 */
export interface PatchMyAuthTokenRequest extends common.BaseRequest {
    /**
     * ID of the resource
     */

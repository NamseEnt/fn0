...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/identitydomains/PatchIdentityProofingProviderTemplate.ts.html |here} to see how to use PatchIdentityProofingProviderTemplateRequest.
 */
export interface PatchIdentityProofingProviderTemplateRequest extends common.BaseRequest {
    /**
     * ID of the resource.
     */

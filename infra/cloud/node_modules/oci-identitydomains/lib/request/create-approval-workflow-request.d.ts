...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/identitydomains/CreateApprovalWorkflow.ts.html |here} to see how to use CreateApprovalWorkflowRequest.
 */
export interface CreateApprovalWorkflowRequest extends common.BaseRequest {
    /**

...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/identitydomains/CreateCondition.ts.html |here} to see how to use CreateConditionRequest.
 */
export interface CreateConditionRequest extends common.BaseRequest {
    /**

...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/identitydomains/PatchCloudGateMapping.ts.html |here} to see how to use PatchCloudGateMappingRequest.
 */
export interface PatchCloudGateMappingRequest extends common.BaseRequest {
    /**
     * ID of the resource
     */

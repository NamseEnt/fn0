...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/identitydomains/PatchCloudGate.ts.html |here} to see how to use PatchCloudGateRequest.
 */
export interface PatchCloudGateRequest extends common.BaseRequest {
    /**
     * ID of the resource
     */
    "cloudGateId": string;

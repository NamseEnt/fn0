...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/identitydomains/CreatePasswordPolicy.ts.html |here} to see how to use CreatePasswordPolicyRequest.
 */
export interface CreatePasswordPolicyRequest extends common.BaseRequest {
    /**

...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/identitydomains/PatchPolicy.ts.html |here} to see how to use PatchPolicyRequest.
 */
export interface PatchPolicyRequest extends common.BaseRequest {
    /**
     * ID of the resource
     */
    "policyId": string;

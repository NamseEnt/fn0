...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/identitydomains/PatchSmtpCredential.ts.html |here} to see how to use PatchSmtpCredentialRequest.
 */
export interface PatchSmtpCredentialRequest extends common.BaseRequest {
    /**
     * ID of the resource
     */

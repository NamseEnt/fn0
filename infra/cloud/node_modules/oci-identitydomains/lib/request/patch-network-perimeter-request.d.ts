...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/identitydomains/PatchNetworkPerimeter.ts.html |here} to see how to use PatchNetworkPerimeterRequest.
 */
export interface PatchNetworkPerimeterRequest extends common.BaseRequest {
    /**
     * ID of the resource
     */

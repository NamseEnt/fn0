...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/identitydomains/PutNetworkPerimeter.ts.html |here} to see how to use PutNetworkPerimeterRequest.
 */
export interface PutNetworkPerimeterRequest extends common.BaseRequest {
    /**
     * ID of the resource
     */

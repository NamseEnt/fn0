...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/identitydomains/PatchMe.ts.html |here} to see how to use PatchMeRequest.
 */
export interface PatchMeRequest extends common.BaseRequest {
    /**

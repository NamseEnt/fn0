...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/identitydomains/ListMySmtpCredentials.ts.html |here} to see how to use ListMySmtpCredentialsRequest.
 */
export interface ListMySmtpCredentialsRequest extends common.BaseRequest {
    /**

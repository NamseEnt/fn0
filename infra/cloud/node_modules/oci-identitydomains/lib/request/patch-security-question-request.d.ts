...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/identitydomains/PatchSecurityQuestion.ts.html |here} to see how to use PatchSecurityQuestionRequest.
 */
export interface PatchSecurityQuestionRequest extends common.BaseRequest {
    /**
     * ID of the resource
     */

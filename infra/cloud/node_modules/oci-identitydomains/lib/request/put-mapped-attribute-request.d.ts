...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/identitydomains/PutMappedAttribute.ts.html |here} to see how to use PutMappedAttributeRequest.
 */
export interface PutMappedAttributeRequest extends common.BaseRequest {
    /**
     * ID of the resource
     */
  ...
  *
   */
    "mappedAttribute"?: model.MappedAttribute;
    /**

...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/identitydomains/PutSetting.ts.html |here} to see how to use PutSettingRequest.
 */
export interface PutSettingRequest extends common.BaseRequest {
    /**
     * ID of the resource
     */
    "settingId": string;

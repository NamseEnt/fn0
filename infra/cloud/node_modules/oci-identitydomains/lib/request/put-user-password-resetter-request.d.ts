...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/identitydomains/PutUserPasswordResetter.ts.html |here} to see how to use PutUserPasswordResetterRequest.
 */
export interface PutUserPasswordResetterRequest extends common.BaseRequest {
    /**
     * ID of the resource
     */
    "userPasswordResetterId": string;
    /**
  ...
  *
   */
    "userPasswordResetter"?: model.UserPasswordResetter;
    /**

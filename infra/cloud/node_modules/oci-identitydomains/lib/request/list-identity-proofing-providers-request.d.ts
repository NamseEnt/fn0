...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/identitydomains/ListIdentityProofingProviders.ts.html |here} to see how to use ListIdentityProofingProvidersRequest.
 */
export interface ListIdentityProofingProvidersRequest extends common.BaseRequest {
    /**

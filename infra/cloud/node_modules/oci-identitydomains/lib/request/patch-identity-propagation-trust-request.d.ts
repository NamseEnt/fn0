...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/identitydomains/PatchIdentityPropagationTrust.ts.html |here} to see how to use PatchIdentityPropagationTrustRequest.
 */
export interface PatchIdentityPropagationTrustRequest extends common.BaseRequest {
    /**
     * ID of the resource
     */

...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/identitydomains/PutCloudGateMapping.ts.html |here} to see how to use PutCloudGateMappingRequest.
 */
export interface PutCloudGateMappingRequest extends common.BaseRequest {
    /**
     * ID of the resource
     */

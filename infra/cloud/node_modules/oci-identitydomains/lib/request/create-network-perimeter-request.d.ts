...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/identitydomains/CreateNetworkPerimeter.ts.html |here} to see how to use CreateNetworkPerimeterRequest.
 */
export interface CreateNetworkPerimeterRequest extends common.BaseRequest {
    /**
  ...
  *
   */
    "networkPerimeter"?: model.NetworkPerimeter;
    /**

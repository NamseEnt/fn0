...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/identitydomains/CreateSmtpCredential.ts.html |here} to see how to use CreateSmtpCredentialRequest.
 */
export interface CreateSmtpCredentialRequest extends common.BaseRequest {
  ...
  *
   */
    "smtpCredential"?: model.SmtpCredential;
    /**

...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/identitydomains/CreateUserDbCredential.ts.html |here} to see how to use CreateUserDbCredentialRequest.
 */
export interface CreateUserDbCredentialRequest extends common.BaseRequest {
    /**
  ...
  *
   */
    "userDbCredential"?: model.UserDbCredential;
    /**

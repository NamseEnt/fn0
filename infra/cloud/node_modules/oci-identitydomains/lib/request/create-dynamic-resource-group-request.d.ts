...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/identitydomains/CreateDynamicResourceGroup.ts.html |here} to see how to use CreateDynamicResourceGroupRequest.
 */
export interface CreateDynamicResourceGroupRequest extends common.BaseRequest {
    /**

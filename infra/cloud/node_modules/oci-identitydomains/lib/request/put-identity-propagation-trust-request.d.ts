...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/identitydomains/PutIdentityPropagationTrust.ts.html |here} to see how to use PutIdentityPropagationTrustRequest.
 */
export interface PutIdentityPropagationTrustRequest extends common.BaseRequest {
    /**
     * ID of the resource
     */

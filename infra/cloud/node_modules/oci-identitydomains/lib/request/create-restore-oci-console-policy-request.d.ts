...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/identitydomains/CreateRestoreOciConsolePolicy.ts.html |here} to see how to use CreateRestoreOciConsolePolicyRequest.
 */
export interface CreateRestoreOciConsolePolicyRequest extends common.BaseRequest {
    /**
  ...
  *
   */
    "restoreOciConsolePolicy"?: model.RestoreOciConsolePolicy;
    /**

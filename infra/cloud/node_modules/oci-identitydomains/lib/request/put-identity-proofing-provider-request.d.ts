...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/identitydomains/PutIdentityProofingProvider.ts.html |here} to see how to use PutIdentityProofingProviderRequest.
 */
export interface PutIdentityProofingProviderRequest extends common.BaseRequest {
    /**
     * ID of the resource.
     */

...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/identitydomains/PatchIdentityProofingProvider.ts.html |here} to see how to use PatchIdentityProofingProviderRequest.
 */
export interface PatchIdentityProofingProviderRequest extends common.BaseRequest {
    /**
     * ID of the resource.
     */

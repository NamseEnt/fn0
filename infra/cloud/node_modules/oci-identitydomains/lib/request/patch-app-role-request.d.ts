...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/identitydomains/PatchAppRole.ts.html |here} to see how to use PatchAppRoleRequest.
 */
export interface PatchAppRoleRequest extends common.BaseRequest {
    /**
     * ID of the resource
     */
    "appRoleId": string;

...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/identitydomains/ListMyApiKeys.ts.html |here} to see how to use ListMyApiKeysRequest.
 */
export interface ListMyApiKeysRequest extends common.BaseRequest {
    /**

...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/identitydomains/PatchCloudGateServer.ts.html |here} to see how to use PatchCloudGateServerRequest.
 */
export interface PatchCloudGateServerRequest extends common.BaseRequest {
    /**
     * ID of the resource
     */

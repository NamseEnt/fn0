...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/identitydomains/PutIdentitySetting.ts.html |here} to see how to use PutIdentitySettingRequest.
 */
export interface PutIdentitySettingRequest extends common.BaseRequest {
    /**
     * ID of the resource
     */
  ...
  *
   */
    "identitySetting"?: model.IdentitySetting;
    /**

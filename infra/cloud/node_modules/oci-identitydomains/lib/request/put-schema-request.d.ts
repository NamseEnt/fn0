...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/identitydomains/PutSchema.ts.html |here} to see how to use PutSchemaRequest.
 */
export interface PutSchemaRequest extends common.BaseRequest {
    /**
     * ID of the resource
     */
    "schemaId": string;

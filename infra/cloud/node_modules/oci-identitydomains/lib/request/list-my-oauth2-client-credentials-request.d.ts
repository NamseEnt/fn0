...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/identitydomains/ListMyOAuth2ClientCredentials.ts.html |here} to see how to use ListMyOAuth2ClientCredentialsRequest.
 */
export interface ListMyOAuth2ClientCredentialsRequest extends common.BaseRequest {
    /**

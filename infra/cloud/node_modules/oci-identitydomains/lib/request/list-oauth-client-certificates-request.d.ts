...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/identitydomains/ListOAuthClientCertificates.ts.html |here} to see how to use ListOAuthClientCertificatesRequest.
 */
export interface ListOAuthClientCertificatesRequest extends common.BaseRequest {
    /**

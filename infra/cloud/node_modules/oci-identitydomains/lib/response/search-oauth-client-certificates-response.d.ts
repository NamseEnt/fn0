...
export interface SearchOAuthClientCertificatesResponse {
    /**
    ...
    "opcNextPage": string;
    /**
     * The returned model.OAuthClientCertificates instance.
     */
    "oAuthClientCertificates": model.OAuthClientCertificates;
}

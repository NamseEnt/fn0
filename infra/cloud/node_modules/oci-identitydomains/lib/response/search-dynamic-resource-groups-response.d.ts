...
export interface SearchDynamicResourceGroupsResponse {
    /**
    ...
    "opcNextPage": string;
    /**
     * The returned model.DynamicResourceGroups instance.
     */
    "dynamicResourceGroups": model.DynamicResourceGroups;
}

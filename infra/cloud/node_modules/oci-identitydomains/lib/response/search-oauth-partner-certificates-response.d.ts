...
export interface SearchOAuthPartnerCertificatesResponse {
    /**
    ...
    "opcNextPage": string;
    /**
     * The returned model.OAuthPartnerCertificates instance.
     */
    "oAuthPartnerCertificates": model.OAuthPartnerCertificates;
}

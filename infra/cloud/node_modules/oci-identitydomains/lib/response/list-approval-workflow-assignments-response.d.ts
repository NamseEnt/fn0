...
export interface ListApprovalWorkflowAssignmentsResponse {
    /**
    ...
    "opcNextPage": string;
    /**
     * The returned model.ApprovalWorkflowAssignments instance.
     */
    "approvalWorkflowAssignments": model.ApprovalWorkflowAssignments;
}

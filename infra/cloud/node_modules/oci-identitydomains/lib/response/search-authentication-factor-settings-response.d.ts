...
export interface SearchAuthenticationFactorSettingsResponse {
    /**
    ...
    "opcNextPage": string;
    /**
     * The returned model.AuthenticationFactorSettings instance.
     */
    "authenticationFactorSettings": model.AuthenticationFactorSettings;
}

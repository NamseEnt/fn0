...
export interface SearchUserAttributesSettingsResponse {
    /**
    ...
    "opcNextPage": string;
    /**
     * The returned model.UserAttributesSettings instance.
     */
    "userAttributesSettings": model.UserAttributesSettings;
}

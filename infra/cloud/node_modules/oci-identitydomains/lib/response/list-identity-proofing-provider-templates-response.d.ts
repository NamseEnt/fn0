...
export interface ListIdentityProofingProviderTemplatesResponse {
    /**
    ...
    "opcNextPage": string;
    /**
     * The returned model.IdentityProofingProviderTemplates instance.
     */
    "identityProofingProviderTemplates": model.IdentityProofingProviderTemplates;
}

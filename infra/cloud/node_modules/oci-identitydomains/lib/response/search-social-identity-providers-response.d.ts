...
export interface SearchSocialIdentityProvidersResponse {
    /**
    ...
    "opcNextPage": string;
    /**
     * The returned model.SocialIdentityProviders instance.
     */
    "socialIdentityProviders": model.SocialIdentityProviders;
}

...
export interface SearchOciConsoleSignOnPolicyConsentsResponse {
    /**
    ...
    "opcNextPage": string;
    /**
     * The returned model.OciConsoleSignOnPolicyConsents instance.
     */
    "ociConsoleSignOnPolicyConsents": model.OciConsoleSignOnPolicyConsents;
}

 ...
 *  - type: complex
 */
export interface AppTermsOfUse {
    /**
...
export declare namespace AppTermsOfUse {
    function getJsonObj(obj: AppTermsOfUse): object;
    function getDeserializedJsonObj(obj: AppTermsOfUse): object;
}

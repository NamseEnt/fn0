...
export declare namespace MyTrustedUserAgent {
    ...
    function getJsonObj(obj: MyTrustedUserAgent): object;
    function getDeserializedJsonObj(obj: MyTrustedUserAgent): object;
}

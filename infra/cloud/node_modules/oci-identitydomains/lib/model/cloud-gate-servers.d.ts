 ...
 */
export interface CloudGateServers {
    /**
     ...
     */
    "resources": Array<model.CloudGateServer>;
    /**
...
export declare namespace CloudGateServers {
    function getJsonObj(obj: CloudGateServers): object;
    function getDeserializedJsonObj(obj: CloudGateServers): object;
}

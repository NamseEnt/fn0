...
export declare namespace UserExtSocialAccounts {
    function getJsonObj(obj: UserExtSocialAccounts): object;
    function getDeserializedJsonObj(obj: UserExtSocialAccounts): object;
}

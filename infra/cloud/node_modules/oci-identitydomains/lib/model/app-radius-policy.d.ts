 ...
 *  - type: complex
 */
export interface AppRadiusPolicy {
    /**
...
export declare namespace AppRadiusPolicy {
    function getJsonObj(obj: AppRadiusPolicy): object;
    function getDeserializedJsonObj(obj: AppRadiusPolicy): object;
}

 ...
 *  - type: complex
 */
export interface VerificationClaimIdcsLockedBy {
    /**
     ...
     *  - uniqueness: none
     */
    "type"?: VerificationClaimIdcsLockedBy.Type;
    /**
...
export declare namespace VerificationClaimIdcsLockedBy {
    enum Type {
        User = "User",
        App = "App",
        /**
    ...
    function getJsonObj(obj: VerificationClaimIdcsLockedBy): object;
    function getDeserializedJsonObj(obj: VerificationClaimIdcsLockedBy): object;
}

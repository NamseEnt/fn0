...
export declare namespace IdentitySettingsPOSIXUid {
    function getJsonObj(obj: IdentitySettingsPOSIXUid): object;
    function getDeserializedJsonObj(obj: IdentitySettingsPOSIXUid): object;
}

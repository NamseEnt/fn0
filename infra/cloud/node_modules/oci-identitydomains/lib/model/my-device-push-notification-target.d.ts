...
export declare namespace MyDevicePushNotificationTarget {
    function getJsonObj(obj: MyDevicePushNotificationTarget): object;
    function getDeserializedJsonObj(obj: MyDevicePushNotificationTarget): object;
}

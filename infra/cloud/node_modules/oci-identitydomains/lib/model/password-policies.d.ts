...
export interface PasswordPolicies {
     ...
     */
    "resources": Array<model.PasswordPolicy>;
    /**
...
export declare namespace PasswordPolicies {
    function getJsonObj(obj: PasswordPolicies): object;
    function getDeserializedJsonObj(obj: PasswordPolicies): object;
}

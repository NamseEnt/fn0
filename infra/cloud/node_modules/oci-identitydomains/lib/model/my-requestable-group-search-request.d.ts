 ...
 */
export interface MyRequestableGroupSearchRequest {
    /**
     ...
     */
    "attributeSets"?: Array<MyRequestableGroupSearchRequest.AttributeSets>;
    /**
...
export declare namespace MyRequestableGroupSearchRequest {
    enum AttributeSets {
        All = "all",
        Always = "always",
        Never = "never",
    ...
    function getJsonObj(obj: MyRequestableGroupSearchRequest): object;
    function getDeserializedJsonObj(obj: MyRequestableGroupSearchRequest): object;
}

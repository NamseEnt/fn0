...
export declare namespace IdentityPropagationTrust {
    ...
    function getJsonObj(obj: IdentityPropagationTrust): object;
    function getDeserializedJsonObj(obj: IdentityPropagationTrust): object;
}

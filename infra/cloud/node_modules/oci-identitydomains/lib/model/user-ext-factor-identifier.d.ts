 ...
 *  - uniqueness: none
 */
export interface UserExtFactorIdentifier {
    /**
...
export declare namespace UserExtFactorIdentifier {
    function getJsonObj(obj: UserExtFactorIdentifier): object;
    function getDeserializedJsonObj(obj: UserExtFactorIdentifier): object;
}

 ...
 */
export interface UserAttributesSettingsSearchRequest {
    /**
     ...
     */
    "attributeSets"?: Array<UserAttributesSettingsSearchRequest.AttributeSets>;
}
export declare namespace UserAttributesSettingsSearchRequest {
    enum AttributeSets {
        All = "all",
        Always = "always",
        Never = "never",
    ...
    function getJsonObj(obj: UserAttributesSettingsSearchRequest): object;
    function getDeserializedJsonObj(obj: UserAttributesSettingsSearchRequest): object;
}

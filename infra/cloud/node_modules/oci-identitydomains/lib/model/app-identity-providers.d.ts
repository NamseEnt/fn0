 ...
 */
export interface AppIdentityProviders {
    /**
...
export declare namespace AppIdentityProviders {
    function getJsonObj(obj: AppIdentityProviders): object;
    function getDeserializedJsonObj(obj: AppIdentityProviders): object;
}

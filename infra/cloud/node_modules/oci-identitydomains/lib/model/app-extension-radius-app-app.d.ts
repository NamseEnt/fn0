...
export declare namespace AppExtensionRadiusAppApp {
    function getJsonObj(obj: AppExtensionRadiusAppApp): object;
    function getDeserializedJsonObj(obj: AppExtensionRadiusAppApp): object;
}

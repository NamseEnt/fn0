...
export declare namespace IdentitySettingsTokens {
    enum Type {
    ...
    function getJsonObj(obj: IdentitySettingsTokens): object;
    function getDeserializedJsonObj(obj: IdentitySettingsTokens): object;
}

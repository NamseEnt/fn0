...
export declare namespace UserExtOAuth2ClientCredentials {
    function getJsonObj(obj: UserExtOAuth2ClientCredentials): object;
    function getDeserializedJsonObj(obj: UserExtOAuth2ClientCredentials): object;
}

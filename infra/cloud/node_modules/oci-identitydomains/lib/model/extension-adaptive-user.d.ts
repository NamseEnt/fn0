...
export declare namespace ExtensionAdaptiveUser {
    enum RiskLevel {
        Low = "LOW",
        Medium = "MEDIUM",
        High = "HIGH",
    ...
    function getJsonObj(obj: ExtensionAdaptiveUser): object;
    function getDeserializedJsonObj(obj: ExtensionAdaptiveUser): object;
}

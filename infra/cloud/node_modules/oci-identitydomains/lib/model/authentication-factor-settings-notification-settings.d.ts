 ...
 *  - uniqueness: none
 */
export interface AuthenticationFactorSettingsNotificationSettings {
    /**
...
export declare namespace AuthenticationFactorSettingsNotificationSettings {
    function getJsonObj(obj: AuthenticationFactorSettingsNotificationSettings): object;
    function getDeserializedJsonObj(obj: AuthenticationFactorSettingsNotificationSettings): object;
}

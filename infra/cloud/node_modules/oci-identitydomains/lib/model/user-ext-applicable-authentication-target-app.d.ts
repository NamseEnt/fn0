...
export declare namespace UserExtApplicableAuthenticationTargetApp {
    function getJsonObj(obj: UserExtApplicableAuthenticationTargetApp): object;
    function getDeserializedJsonObj(obj: UserExtApplicableAuthenticationTargetApp): object;
}

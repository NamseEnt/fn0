...
export declare namespace ExtensionPasswordStateUser {
    function getJsonObj(obj: ExtensionPasswordStateUser): object;
    function getDeserializedJsonObj(obj: ExtensionPasswordStateUser): object;
}

...
export declare namespace GroupExtPasswordPolicy {
    function getJsonObj(obj: GroupExtPasswordPolicy): object;
    function getDeserializedJsonObj(obj: GroupExtPasswordPolicy): object;
}

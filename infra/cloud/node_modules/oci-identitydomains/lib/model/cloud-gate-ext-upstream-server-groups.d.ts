...
export declare namespace CloudGateExtUpstreamServerGroups {
    function getJsonObj(obj: CloudGateExtUpstreamServerGroups): object;
    function getDeserializedJsonObj(obj: CloudGateExtUpstreamServerGroups): object;
}

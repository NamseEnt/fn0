 ...
 */
export interface CloudGateSearchRequest {
    /**
     ...
     */
    "attributeSets"?: Array<CloudGateSearchRequest.AttributeSets>;
    /**
...
export declare namespace CloudGateSearchRequest {
    enum AttributeSets {
        All = "all",
        Always = "always",
        Never = "never",
    ...
    function getJsonObj(obj: CloudGateSearchRequest): object;
    function getDeserializedJsonObj(obj: CloudGateSearchRequest): object;
}

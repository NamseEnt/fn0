...
export interface SettingsSearchRequest {
     ...
     */
    "attributeSets"?: Array<SettingsSearchRequest.AttributeSets>;
}
export declare namespace SettingsSearchRequest {
    enum AttributeSets {
        All = "all",
        Always = "always",
        Never = "never",
    ...
    function getJsonObj(obj: SettingsSearchRequest): object;
    function getDeserializedJsonObj(obj: SettingsSearchRequest): object;
}

...
export interface SecurityQuestionSettings {
     ...
     */
    "resources": Array<model.SecurityQuestionSetting>;
    /**
...
export declare namespace SecurityQuestionSettings {
    function getJsonObj(obj: SecurityQuestionSettings): object;
    function getDeserializedJsonObj(obj: SecurityQuestionSettings): object;
}

...
export declare namespace AppAttrRenderingMetadata {
    enum Widget {
        Inputtext = "inputtext",
        Checkbox = "checkbox",
        Textarea = "textarea",
    ...
    function getJsonObj(obj: AppAttrRenderingMetadata): object;
    function getDeserializedJsonObj(obj: AppAttrRenderingMetadata): object;
}

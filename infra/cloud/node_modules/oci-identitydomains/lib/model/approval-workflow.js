...
(function (ApprovalWorkflow) {
    ...
    })(IdcsPreventedOperations = ApprovalWorkflow.IdcsPreventedOperations || (ApprovalWorkflow.IdcsPreventedOperations = {}));
    function getJsonObj(obj) {
        const jsonObj = Object.assign(Object.assign({}, obj), {
            ...
            "maxDuration": obj.maxDuration
                ? model.ApprovalWorkflowMaxDuration.getJsonObj(obj.maxDuration)
                : undefined,
            "approvalWorkflowSteps": obj.approvalWorkflowSteps
                ? obj.approvalWorkflowSteps.map(item => {
                    return model.ApprovalWorkflowApprovalWorkflowSteps.getJsonObj(item);
                })
                : undefined
        });
        return jsonObj;
    }
    ApprovalWorkflow.getJsonObj = getJsonObj;
    function getDeserializedJsonObj(obj) {
        const jsonObj = Object.assign(Object.assign({}, obj), {
            ...
            "tags": obj.tags
                ...
                : undefined,
            "maxDuration": obj.maxDuration
                ? model.ApprovalWorkflowMaxDuration.getDeserializedJsonObj(obj.maxDuration)
                : undefined,
            "approvalWorkflowSteps": obj.approvalWorkflowSteps
                ? obj.approvalWorkflowSteps.map(item => {
                    return model.ApprovalWorkflowApprovalWorkflowSteps.getDeserializedJsonObj(item);
                })
                : undefined
        });
        return jsonObj;
    }
    ApprovalWorkflow.getDeserializedJsonObj = getDeserializedJsonObj;
})(ApprovalWorkflow = exports.ApprovalWorkflow || (exports.ApprovalWorkflow = {}));

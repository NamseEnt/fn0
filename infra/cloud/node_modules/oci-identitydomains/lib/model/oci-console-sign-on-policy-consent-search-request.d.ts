 ...
 */
export interface OciConsoleSignOnPolicyConsentSearchRequest {
    /**
     ...
     */
    "attributeSets"?: Array<OciConsoleSignOnPolicyConsentSearchRequest.AttributeSets>;
    /**
...
export declare namespace OciConsoleSignOnPolicyConsentSearchRequest {
    enum AttributeSets {
        All = "all",
        Always = "always",
        Never = "never",
    ...
    function getJsonObj(obj: OciConsoleSignOnPolicyConsentSearchRequest): object;
    function getDeserializedJsonObj(obj: OciConsoleSignOnPolicyConsentSearchRequest): object;
}

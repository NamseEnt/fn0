 ...
 *  - uniqueness: none
 */
export interface IdentityProviderCorrelationPolicy {
    /**
     ...
     *  - uniqueness: none
     */
    "type": IdentityProviderCorrelationPolicy.Type;
    /**
     * Policy identifier
     * <p>
     **Added In:** 20.1.3
...
export declare namespace IdentityProviderCorrelationPolicy {
    enum Type {
        Policy = "Policy",
        /**
    ...
    function getJsonObj(obj: IdentityProviderCorrelationPolicy): object;
    function getDeserializedJsonObj(obj: IdentityProviderCorrelationPolicy): object;
}

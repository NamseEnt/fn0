...
export interface ApiKeySearchRequest {
     ...
     */
    "attributeSets"?: Array<ApiKeySearchRequest.AttributeSets>;
    /**
...
export declare namespace ApiKeySearchRequest {
    enum AttributeSets {
        All = "all",
        Always = "always",
        Never = "never",
    ...
    function getJsonObj(obj: ApiKeySearchRequest): object;
    function getDeserializedJsonObj(obj: ApiKeySearchRequest): object;
}

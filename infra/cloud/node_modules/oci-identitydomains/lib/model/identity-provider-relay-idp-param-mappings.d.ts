...
export declare namespace IdentityProviderRelayIdpParamMappings {
    function getJsonObj(obj: IdentityProviderRelayIdpParamMappings): object;
    function getDeserializedJsonObj(obj: IdentityProviderRelayIdpParamMappings): object;
}

 ...
 */
export interface SmtpCredentialSearchRequest {
    /**
     ...
     */
    "attributeSets"?: Array<SmtpCredentialSearchRequest.AttributeSets>;
    /**
...
export declare namespace SmtpCredentialSearchRequest {
    enum AttributeSets {
        All = "all",
        Always = "always",
        Never = "never",
    ...
    function getJsonObj(obj: SmtpCredentialSearchRequest): object;
    function getDeserializedJsonObj(obj: SmtpCredentialSearchRequest): object;
}

 ...
 */
export interface SecurityQuestionSearchRequest {
    /**
     ...
     */
    "attributeSets"?: Array<SecurityQuestionSearchRequest.AttributeSets>;
    /**
...
export declare namespace SecurityQuestionSearchRequest {
    enum AttributeSets {
        All = "all",
        Always = "always",
        Never = "never",
    ...
    function getJsonObj(obj: SecurityQuestionSearchRequest): object;
    function getDeserializedJsonObj(obj: SecurityQuestionSearchRequest): object;
}

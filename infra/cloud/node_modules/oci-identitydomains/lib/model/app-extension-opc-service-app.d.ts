...
export declare namespace AppExtensionOpcServiceApp {
    enum CurrentFederationMode {
        None = "None",
    ...
    enum CurrentSynchronizationMode {
        None = "None",
    ...
    function getJsonObj(obj: AppExtensionOpcServiceApp): object;
    function getDeserializedJsonObj(obj: AppExtensionOpcServiceApp): object;
}

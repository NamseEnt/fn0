...
export declare namespace NetworkPerimeterIpAddresses {
    enum Type {
        Cidr = "CIDR",
        Range = "RANGE",
        Exact = "EXACT",
    ...
    function getJsonObj(obj: NetworkPerimeterIpAddresses): object;
    function getDeserializedJsonObj(obj: NetworkPerimeterIpAddresses): object;
}

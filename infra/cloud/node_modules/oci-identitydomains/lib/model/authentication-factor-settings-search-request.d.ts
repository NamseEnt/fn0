 ...
 */
export interface AuthenticationFactorSettingsSearchRequest {
    /**
     ...
     */
    "attributeSets"?: Array<AuthenticationFactorSettingsSearchRequest.AttributeSets>;
}
export declare namespace AuthenticationFactorSettingsSearchRequest {
    enum AttributeSets {
        All = "all",
        Always = "always",
        Never = "never",
    ...
    function getJsonObj(obj: AuthenticationFactorSettingsSearchRequest): object;
    function getDeserializedJsonObj(obj: AuthenticationFactorSettingsSearchRequest): object;
}

...
export declare namespace MyRequestRequesting {
    enum Type {
        Group = "Group",
        App = "App",
        /**
    ...
    function getJsonObj(obj: MyRequestRequesting): object;
    function getDeserializedJsonObj(obj: MyRequestRequesting): object;
}

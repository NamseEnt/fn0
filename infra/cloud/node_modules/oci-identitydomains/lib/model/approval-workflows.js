...
exports.ApprovalWorkflows = void 0;
...
(function (ApprovalWorkflows) {
        ...
        const jsonObj = Object.assign(Object.assign({}, obj), {
            "Resources": obj.resources
                ? obj.resources.map(item => {
                    return model.ApprovalWorkflow.getJsonObj(item);
                })
                : undefined
        });
    ...
    ApprovalWorkflows.getJsonObj = getJsonObj;
    function getDeserializedJsonObj(obj) {
        const jsonObj = Object.assign(Object.assign({}, obj), {
            "resources": obj["Resources"]
                ? obj["Resources"].map((item) => {
                    return model.ApprovalWorkflow.getDeserializedJsonObj(item);
                })
                : undefined
        });
        delete jsonObj["Resources"];
    ...
    ApprovalWorkflows.getDeserializedJsonObj = getDeserializedJsonObj;
})(ApprovalWorkflows = exports.ApprovalWorkflows || (exports.ApprovalWorkflows = {}));

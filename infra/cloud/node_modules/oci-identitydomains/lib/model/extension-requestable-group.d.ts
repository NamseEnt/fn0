...
export declare namespace ExtensionRequestableGroup {
    function getJsonObj(obj: ExtensionRequestableGroup): object;
    function getDeserializedJsonObj(obj: ExtensionRequestableGroup): object;
}

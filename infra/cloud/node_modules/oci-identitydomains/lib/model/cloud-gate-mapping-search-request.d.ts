...
export declare namespace CloudGateMappingSearchRequest {
    enum AttributeSets {
        All = "all",
        Always = "always",
        Never = "never",
    ...
    function getJsonObj(obj: CloudGateMappingSearchRequest): object;
    function getDeserializedJsonObj(obj: CloudGateMappingSearchRequest): object;
}

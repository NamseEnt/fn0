...
export declare namespace SchemaIdcsComplexAttributeNameMappings {
    function getJsonObj(obj: SchemaIdcsComplexAttributeNameMappings): object;
    function getDeserializedJsonObj(obj: SchemaIdcsComplexAttributeNameMappings): object;
}

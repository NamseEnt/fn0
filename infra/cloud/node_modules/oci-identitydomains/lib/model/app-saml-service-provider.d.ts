 ...
 *  - uniqueness: none
 */
export interface AppSamlServiceProvider {
    /**
...
export declare namespace AppSamlServiceProvider {
    function getJsonObj(obj: AppSamlServiceProvider): object;
    function getDeserializedJsonObj(obj: AppSamlServiceProvider): object;
}

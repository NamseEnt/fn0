...
export declare namespace ExtensionUserCredentialsUser {
    function getJsonObj(obj: ExtensionUserCredentialsUser): object;
    function getDeserializedJsonObj(obj: ExtensionUserCredentialsUser): object;
}

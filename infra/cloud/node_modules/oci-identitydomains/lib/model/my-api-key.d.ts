...
export interface MyApiKey {
     ...
     *  - uniqueness: none
     */
    "idcsPreventedOperations"?: Array<MyApiKey.IdcsPreventedOperations>;
    /**
     ...
     */
    "key": string;
    "user"?: model.MyApiKeyUser;
}
export declare namespace MyApiKey {
    ...
    function getJsonObj(obj: MyApiKey): object;
    function getDeserializedJsonObj(obj: MyApiKey): object;
}

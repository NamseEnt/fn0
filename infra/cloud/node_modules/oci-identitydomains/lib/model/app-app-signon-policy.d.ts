 ...
 *  - type: complex
 */
export interface AppAppSignonPolicy {
    /**
...
export declare namespace AppAppSignonPolicy {
    function getJsonObj(obj: AppAppSignonPolicy): object;
    function getDeserializedJsonObj(obj: AppAppSignonPolicy): object;
}

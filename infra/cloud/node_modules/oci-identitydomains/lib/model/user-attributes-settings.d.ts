 ...
 */
export interface UserAttributesSettings {
    /**
     ...
     */
    "resources": Array<model.UserAttributesSetting>;
    /**
...
export declare namespace UserAttributesSettings {
    function getJsonObj(obj: UserAttributesSettings): object;
    function getDeserializedJsonObj(obj: UserAttributesSettings): object;
}

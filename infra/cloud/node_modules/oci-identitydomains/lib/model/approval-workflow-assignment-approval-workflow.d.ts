...
export declare namespace ApprovalWorkflowAssignmentApprovalWorkflow {
    enum Type {
    ...
    function getJsonObj(obj: ApprovalWorkflowAssignmentApprovalWorkflow): object;
    function getDeserializedJsonObj(obj: ApprovalWorkflowAssignmentApprovalWorkflow): object;
}

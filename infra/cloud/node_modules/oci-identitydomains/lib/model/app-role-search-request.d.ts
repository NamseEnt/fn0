 ...
 */
export interface AppRoleSearchRequest {
    /**
     ...
     */
    "attributeSets"?: Array<AppRoleSearchRequest.AttributeSets>;
    /**
...
export declare namespace AppRoleSearchRequest {
    enum AttributeSets {
        All = "all",
        Always = "always",
        Never = "never",
    ...
    function getJsonObj(obj: AppRoleSearchRequest): object;
    function getDeserializedJsonObj(obj: AppRoleSearchRequest): object;
}

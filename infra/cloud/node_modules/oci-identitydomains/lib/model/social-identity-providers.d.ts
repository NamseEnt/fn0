 ...
 */
export interface SocialIdentityProviders {
    /**
     ...
     */
    "resources": Array<model.SocialIdentityProvider>;
    /**
...
export declare namespace SocialIdentityProviders {
    function getJsonObj(obj: SocialIdentityProviders): object;
    function getDeserializedJsonObj(obj: SocialIdentityProviders): object;
}

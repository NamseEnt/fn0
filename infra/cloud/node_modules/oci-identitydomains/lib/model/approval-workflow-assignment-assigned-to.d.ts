...
export declare namespace ApprovalWorkflowAssignmentAssignedTo {
    enum Type {
        Group = "Group",
        /**
    ...
    function getJsonObj(obj: ApprovalWorkflowAssignmentAssignedTo): object;
    function getDeserializedJsonObj(obj: ApprovalWorkflowAssignmentAssignedTo): object;
}

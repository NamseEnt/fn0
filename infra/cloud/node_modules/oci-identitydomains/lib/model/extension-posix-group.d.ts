 ...
 */
export interface ExtensionPosixGroup {
    /**
...
export declare namespace ExtensionPosixGroup {
    function getJsonObj(obj: ExtensionPosixGroup): object;
    function getDeserializedJsonObj(obj: ExtensionPosixGroup): object;
}

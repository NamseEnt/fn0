 ...
 *  - uniqueness: none
 */
export interface CloudGateOauthClient {
    /**
...
export declare namespace CloudGateOauthClient {
    function getJsonObj(obj: CloudGateOauthClient): object;
    function getDeserializedJsonObj(obj: CloudGateOauthClient): object;
}

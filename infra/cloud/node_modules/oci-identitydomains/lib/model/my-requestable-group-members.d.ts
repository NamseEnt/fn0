 ...
 */
export interface MyRequestableGroupMembers {
    /**
     ...
     *  - uniqueness: none
     */
    "type": MyRequestableGroupMembers.Type;
    /**
     * The member's name.
     * <p>
     **SCIM++ Properties:**
...
export declare namespace MyRequestableGroupMembers {
    enum Type {
        User = "User",
        /**
    ...
    function getJsonObj(obj: MyRequestableGroupMembers): object;
    function getDeserializedJsonObj(obj: MyRequestableGroupMembers): object;
}

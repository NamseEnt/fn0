 ...
 */
export interface ApprovalWorkflowAssignments {
    /**
     ...
     */
    "resources": Array<model.ApprovalWorkflowAssignment>;
    /**
...
export declare namespace ApprovalWorkflowAssignments {
    function getJsonObj(obj: ApprovalWorkflowAssignments): object;
    function getDeserializedJsonObj(obj: ApprovalWorkflowAssignments): object;
}

...
export declare namespace SelfRegistrationProfileAfterSubmitText {
    function getJsonObj(obj: SelfRegistrationProfileAfterSubmitText): object;
    function getDeserializedJsonObj(obj: SelfRegistrationProfileAfterSubmitText): object;
}

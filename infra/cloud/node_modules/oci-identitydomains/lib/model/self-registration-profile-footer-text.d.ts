 ...
 * Footer text
 */
export interface SelfRegistrationProfileFooterText {
    /**
...
export declare namespace SelfRegistrationProfileFooterText {
    function getJsonObj(obj: SelfRegistrationProfileFooterText): object;
    function getDeserializedJsonObj(obj: SelfRegistrationProfileFooterText): object;
}

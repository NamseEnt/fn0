...
export declare namespace UserExtRiskScores {
    enum RiskLevel {
        Low = "LOW",
        Medium = "MEDIUM",
        High = "HIGH",
    ...
    function getJsonObj(obj: UserExtRiskScores): object;
    function getDeserializedJsonObj(obj: UserExtRiskScores): object;
}

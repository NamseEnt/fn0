...
export declare namespace ExtensionPasswordlessUser {
    enum FactorType {
        Email = "EMAIL",
        Sms = "SMS",
    ...
    function getJsonObj(obj: ExtensionPasswordlessUser): object;
    function getDeserializedJsonObj(obj: ExtensionPasswordlessUser): object;
}

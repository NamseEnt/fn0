 ...
 */
export interface SecurityQuestionSettingsSearchRequest {
    /**
     ...
     */
    "attributeSets"?: Array<SecurityQuestionSettingsSearchRequest.AttributeSets>;
}
export declare namespace SecurityQuestionSettingsSearchRequest {
    enum AttributeSets {
        All = "all",
        Always = "always",
        Never = "never",
    ...
    function getJsonObj(obj: SecurityQuestionSettingsSearchRequest): object;
    function getDeserializedJsonObj(obj: SecurityQuestionSettingsSearchRequest): object;
}

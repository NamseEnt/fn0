 ...
 *  - type: complex
 */
export interface IdcsCreatedBy {
    /**
...
export declare namespace IdcsCreatedBy {
    enum Type {
        User = "User",
        App = "App",
        /**
    ...
    function getJsonObj(obj: IdcsCreatedBy): object;
    function getDeserializedJsonObj(obj: IdcsCreatedBy): object;
}

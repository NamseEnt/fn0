...
export declare namespace AppExtensionSamlServiceProviderApp {
    ...
    function getJsonObj(obj: AppExtensionSamlServiceProviderApp): object;
    function getDeserializedJsonObj(obj: AppExtensionSamlServiceProviderApp): object;
}

 ...
 *  - uniqueness: none
 */
export interface MyAuthenticationFactorsRemoverUser {
    /**
...
export declare namespace MyAuthenticationFactorsRemoverUser {
    function getJsonObj(obj: MyAuthenticationFactorsRemoverUser): object;
    function getDeserializedJsonObj(obj: MyAuthenticationFactorsRemoverUser): object;
}

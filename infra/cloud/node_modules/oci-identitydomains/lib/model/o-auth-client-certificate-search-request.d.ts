 ...
 */
export interface OAuthClientCertificateSearchRequest {
    /**
     ...
     */
    "attributeSets"?: Array<OAuthClientCertificateSearchRequest.AttributeSets>;
    /**
...
export declare namespace OAuthClientCertificateSearchRequest {
    enum AttributeSets {
        All = "all",
        Always = "always",
        Never = "never",
    ...
    function getJsonObj(obj: OAuthClientCertificateSearchRequest): object;
    function getDeserializedJsonObj(obj: OAuthClientCertificateSearchRequest): object;
}

...
export interface ApprovalWorkflows {
     ...
     */
    "resources": Array<model.ApprovalWorkflow>;
    /**
...
export declare namespace ApprovalWorkflows {
    function getJsonObj(obj: ApprovalWorkflows): object;
    function getDeserializedJsonObj(obj: ApprovalWorkflows): object;
}

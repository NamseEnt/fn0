...
export declare namespace UserPasswordResetterUserToken {
    function getJsonObj(obj: UserPasswordResetterUserToken): object;
    function getDeserializedJsonObj(obj: UserPasswordResetterUserToken): object;
}

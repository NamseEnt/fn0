 ...
 *  - uniqueness: none
 */
export interface CloudGateServerCloudGate {
    /**
...
export declare namespace CloudGateServerCloudGate {
    function getJsonObj(obj: CloudGateServerCloudGate): object;
    function getDeserializedJsonObj(obj: CloudGateServerCloudGate): object;
}

...
export declare namespace MyDeviceThirdPartyFactor {
    function getJsonObj(obj: MyDeviceThirdPartyFactor): object;
    function getDeserializedJsonObj(obj: MyDeviceThirdPartyFactor): object;
}

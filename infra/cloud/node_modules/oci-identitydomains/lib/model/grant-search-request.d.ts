...
export interface GrantSearchRequest {
     ...
     */
    "attributeSets"?: Array<GrantSearchRequest.AttributeSets>;
    /**
...
export declare namespace GrantSearchRequest {
    enum AttributeSets {
        All = "all",
        Always = "always",
        Never = "never",
    ...
    function getJsonObj(obj: GrantSearchRequest): object;
    function getDeserializedJsonObj(obj: GrantSearchRequest): object;
}

 ...
 * Header text
 */
export interface SelfRegistrationProfileHeaderText {
    /**
...
export declare namespace SelfRegistrationProfileHeaderText {
    function getJsonObj(obj: SelfRegistrationProfileHeaderText): object;
    function getDeserializedJsonObj(obj: SelfRegistrationProfileHeaderText): object;
}

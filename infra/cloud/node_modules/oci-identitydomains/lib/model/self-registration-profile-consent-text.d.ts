 ...
 * Consent text
 */
export interface SelfRegistrationProfileConsentText {
    /**
...
export declare namespace SelfRegistrationProfileConsentText {
    function getJsonObj(obj: SelfRegistrationProfileConsentText): object;
    function getDeserializedJsonObj(obj: SelfRegistrationProfileConsentText): object;
}

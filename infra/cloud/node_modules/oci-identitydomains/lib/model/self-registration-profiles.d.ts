...
export declare namespace SelfRegistrationProfiles {
    function getJsonObj(obj: SelfRegistrationProfiles): object;
    function getDeserializedJsonObj(obj: SelfRegistrationProfiles): object;
}

 ...
 *  - uniqueness: none
 */
export interface RulePolicyType {
    /**
...
export declare namespace RulePolicyType {
    function getJsonObj(obj: RulePolicyType): object;
    function getDeserializedJsonObj(obj: RulePolicyType): object;
}

...
export interface AuthenticationFactorSettings {
     ...
     */
    "resources": Array<model.AuthenticationFactorSetting>;
    /**
...
export declare namespace AuthenticationFactorSettings {
    function getJsonObj(obj: AuthenticationFactorSettings): object;
    function getDeserializedJsonObj(obj: AuthenticationFactorSettings): object;
}

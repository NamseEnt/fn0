 ...
 */
export interface SelfRegistrationProfileDisplayName {
    /**
...
export declare namespace SelfRegistrationProfileDisplayName {
    function getJsonObj(obj: SelfRegistrationProfileDisplayName): object;
    function getDeserializedJsonObj(obj: SelfRegistrationProfileDisplayName): object;
}

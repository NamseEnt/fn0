 ...
 */
export interface IdentityProofingProviderSearchRequest {
    /**
     ...
     */
    "attributeSets"?: Array<IdentityProofingProviderSearchRequest.AttributeSets>;
    /**
...
export declare namespace IdentityProofingProviderSearchRequest {
    enum AttributeSets {
        All = "all",
        Always = "always",
        Never = "never",
    ...
    function getJsonObj(obj: IdentityProofingProviderSearchRequest): object;
    function getDeserializedJsonObj(obj: IdentityProofingProviderSearchRequest): object;
}

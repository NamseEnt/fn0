...
export declare namespace AppExtensionFormFillAppTemplateAppTemplate {
    enum FormType {
    ...
    function getJsonObj(obj: AppExtensionFormFillAppTemplateAppTemplate): object;
    function getDeserializedJsonObj(obj: AppExtensionFormFillAppTemplateAppTemplate): object;
}

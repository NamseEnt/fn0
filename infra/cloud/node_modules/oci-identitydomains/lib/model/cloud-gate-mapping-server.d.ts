 ...
 *  - uniqueness: none
 */
export interface CloudGateMappingServer {
    /**
...
export declare namespace CloudGateMappingServer {
    function getJsonObj(obj: CloudGateMappingServer): object;
    function getDeserializedJsonObj(obj: CloudGateMappingServer): object;
}

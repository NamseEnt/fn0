 ...
 *  - uniqueness: none
 */
export interface AuthenticationFactorSettingsEmailSettings {
    /**
...
export declare namespace AuthenticationFactorSettingsEmailSettings {
    function getJsonObj(obj: AuthenticationFactorSettingsEmailSettings): object;
    function getDeserializedJsonObj(obj: AuthenticationFactorSettingsEmailSettings): object;
}

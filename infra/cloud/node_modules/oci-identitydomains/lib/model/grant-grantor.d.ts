...
export declare namespace GrantGrantor {
    enum Type {
        User = "User",
        App = "App",
        Group = "Group",
    ...
    function getJsonObj(obj: GrantGrantor): object;
    function getDeserializedJsonObj(obj: GrantGrantor): object;
}

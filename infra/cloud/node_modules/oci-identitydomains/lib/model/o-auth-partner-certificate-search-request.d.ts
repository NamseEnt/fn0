 ...
 */
export interface OAuthPartnerCertificateSearchRequest {
    /**
     ...
     */
    "attributeSets"?: Array<OAuthPartnerCertificateSearchRequest.AttributeSets>;
    /**
...
export declare namespace OAuthPartnerCertificateSearchRequest {
    enum AttributeSets {
        All = "all",
        Always = "always",
        Never = "never",
    ...
    function getJsonObj(obj: OAuthPartnerCertificateSearchRequest): object;
    function getDeserializedJsonObj(obj: OAuthPartnerCertificateSearchRequest): object;
}

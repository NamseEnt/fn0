 ...
 * Event settings
 */
export interface NotificationSettingsEventSettings {
    /**
...
export declare namespace NotificationSettingsEventSettings {
    function getJsonObj(obj: NotificationSettingsEventSettings): object;
    function getDeserializedJsonObj(obj: NotificationSettingsEventSettings): object;
}

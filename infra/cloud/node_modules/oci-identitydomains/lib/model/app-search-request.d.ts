...
export interface AppSearchRequest {
     ...
     */
    "attributeSets"?: Array<AppSearchRequest.AttributeSets>;
    /**
...
export declare namespace AppSearchRequest {
    enum AttributeSets {
        All = "all",
        Always = "always",
        Never = "never",
    ...
    function getJsonObj(obj: AppSearchRequest): object;
    function getDeserializedJsonObj(obj: AppSearchRequest): object;
}

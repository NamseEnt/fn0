...
export declare namespace UserDbCredentialsUser {
    function getJsonObj(obj: UserDbCredentialsUser): object;
    function getDeserializedJsonObj(obj: UserDbCredentialsUser): object;
}

...
export declare namespace ExtensionSocialIdentityProvider {
    enum Status {
        Created = "created",
        Deleted = "deleted",
        /**
    ...
    function getJsonObj(obj: ExtensionSocialIdentityProvider): object;
    function getDeserializedJsonObj(obj: ExtensionSocialIdentityProvider): object;
}

...
export declare namespace AppIdentityBridges {
    function getJsonObj(obj: AppIdentityBridges): object;
    function getDeserializedJsonObj(obj: AppIdentityBridges): object;
}

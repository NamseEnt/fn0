 ...
 */
export interface OAuthClientCertificates {
    /**
     ...
     */
    "resources": Array<model.OAuthClientCertificate>;
    /**
...
export declare namespace OAuthClientCertificates {
    function getJsonObj(obj: OAuthClientCertificates): object;
    function getDeserializedJsonObj(obj: OAuthClientCertificates): object;
}

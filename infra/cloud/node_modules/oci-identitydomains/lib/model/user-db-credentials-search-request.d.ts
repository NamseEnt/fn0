 ...
 */
export interface UserDbCredentialsSearchRequest {
    /**
     ...
     */
    "attributeSets"?: Array<UserDbCredentialsSearchRequest.AttributeSets>;
    /**
...
export declare namespace UserDbCredentialsSearchRequest {
    enum AttributeSets {
        All = "all",
        Always = "always",
        Never = "never",
    ...
    function getJsonObj(obj: UserDbCredentialsSearchRequest): object;
    function getDeserializedJsonObj(obj: UserDbCredentialsSearchRequest): object;
}

 ...
 */
export interface CloudGateServer {
    /**
     ...
     *  - uniqueness: none
     */
    "idcsPreventedOperations"?: Array<CloudGateServer.IdcsPreventedOperations>;
    /**
    ...
    "cloudGate": model.CloudGateServerCloudGate;
}
export declare namespace CloudGateServer {
    ...
    function getJsonObj(obj: CloudGateServer): object;
    function getDeserializedJsonObj(obj: CloudGateServer): object;
}

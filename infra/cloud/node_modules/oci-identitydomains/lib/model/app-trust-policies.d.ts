 ...
 * Trust Policies.
 */
export interface AppTrustPolicies {
    /**
...
export declare namespace AppTrustPolicies {
    function getJsonObj(obj: AppTrustPolicies): object;
    function getDeserializedJsonObj(obj: AppTrustPolicies): object;
}

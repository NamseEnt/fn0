...
export interface ResourceTypeSchemaAttribute {
     ...
     *  - uniqueness: none
     */
    "endUserMutabilityAllowedValues"?: Array<ResourceTypeSchemaAttribute.EndUserMutabilityAllowedValues>;
    /**
...
export declare namespace ResourceTypeSchemaAttribute {
    ...
    enum EndUserMutabilityAllowedValues {
        ReadOnly = "readOnly",
        ReadWrite = "readWrite",
        Immutable = "immutable",
        Hidden = "hidden",
    ...
    function getJsonObj(obj: ResourceTypeSchemaAttribute): object;
    function getDeserializedJsonObj(obj: ResourceTypeSchemaAttribute): object;
}

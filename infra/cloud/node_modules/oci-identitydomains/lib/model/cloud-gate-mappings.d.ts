 ...
 */
export interface CloudGateMappings {
    /**
     ...
     */
    "resources": Array<model.CloudGateMapping>;
    /**
...
export declare namespace CloudGateMappings {
    function getJsonObj(obj: CloudGateMappings): object;
    function getDeserializedJsonObj(obj: CloudGateMappings): object;
}

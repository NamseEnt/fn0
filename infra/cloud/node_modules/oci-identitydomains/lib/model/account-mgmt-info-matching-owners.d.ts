...
export declare namespace AccountMgmtInfoMatchingOwners {
    function getJsonObj(obj: AccountMgmtInfoMatchingOwners): object;
    function getDeserializedJsonObj(obj: AccountMgmtInfoMatchingOwners): object;
}

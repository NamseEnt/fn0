 ...
 *  - type: complex
 */
export interface AppBasedOnTemplate {
    /**
...
export declare namespace AppBasedOnTemplate {
    function getJsonObj(obj: AppBasedOnTemplate): object;
    function getDeserializedJsonObj(obj: AppBasedOnTemplate): object;
}

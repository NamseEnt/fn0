...
export declare namespace UserExtAuthTokens {
    function getJsonObj(obj: UserExtAuthTokens): object;
    function getDeserializedJsonObj(obj: UserExtAuthTokens): object;
}

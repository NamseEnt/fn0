 ...
 */
export interface MyAuthenticationFactorValidatorSecurityQuestions {
    /**
...
export declare namespace MyAuthenticationFactorValidatorSecurityQuestions {
    function getJsonObj(obj: MyAuthenticationFactorValidatorSecurityQuestions): object;
    function getDeserializedJsonObj(obj: MyAuthenticationFactorValidatorSecurityQuestions): object;
}

 ...
 */
export interface SocialIdentityProviderSearchRequest {
    /**
     ...
     */
    "attributeSets"?: Array<SocialIdentityProviderSearchRequest.AttributeSets>;
    /**
...
export declare namespace SocialIdentityProviderSearchRequest {
    enum AttributeSets {
        All = "all",
        Always = "always",
        Never = "never",
    ...
    function getJsonObj(obj: SocialIdentityProviderSearchRequest): object;
    function getDeserializedJsonObj(obj: SocialIdentityProviderSearchRequest): object;
}

 ...
 *  - type: complex
 */
export interface AppAllowAuthzPolicy {
    /**
...
export declare namespace AppAllowAuthzPolicy {
    function getJsonObj(obj: AppAllowAuthzPolicy): object;
    function getDeserializedJsonObj(obj: AppAllowAuthzPolicy): object;
}

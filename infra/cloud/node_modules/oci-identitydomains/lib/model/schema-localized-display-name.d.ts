 ...
 *  - uniqueness: none
 */
export interface SchemaLocalizedDisplayName {
    /**
...
export declare namespace SchemaLocalizedDisplayName {
    function getJsonObj(obj: SchemaLocalizedDisplayName): object;
    function getDeserializedJsonObj(obj: SchemaLocalizedDisplayName): object;
}

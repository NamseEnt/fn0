...
export declare namespace MyCustomerSecretKeyUser {
    function getJsonObj(obj: MyCustomerSecretKeyUser): object;
    function getDeserializedJsonObj(obj: MyCustomerSecretKeyUser): object;
}

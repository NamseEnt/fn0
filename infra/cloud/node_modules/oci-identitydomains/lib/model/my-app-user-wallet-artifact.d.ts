 ...
 *  - uniqueness: none
 */
export interface MyAppUserWalletArtifact {
    /**
...
export declare namespace MyAppUserWalletArtifact {
    function getJsonObj(obj: MyAppUserWalletArtifact): object;
    function getDeserializedJsonObj(obj: MyAppUserWalletArtifact): object;
}

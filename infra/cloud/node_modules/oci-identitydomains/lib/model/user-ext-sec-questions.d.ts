...
export declare namespace UserExtSecQuestions {
    function getJsonObj(obj: UserExtSecQuestions): object;
    function getDeserializedJsonObj(obj: UserExtSecQuestions): object;
}

...
export declare namespace MyApiKeyUser {
    function getJsonObj(obj: MyApiKeyUser): object;
    function getDeserializedJsonObj(obj: MyApiKeyUser): object;
}

...
export declare namespace AppThreeLeggedOAuthCredential {
    function getJsonObj(obj: AppThreeLeggedOAuthCredential): object;
    function getDeserializedJsonObj(obj: AppThreeLeggedOAuthCredential): object;
}

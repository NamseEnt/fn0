 ...
 */
export interface SocialIdentityProviderRelayIdpParamMappings {
    /**
...
export declare namespace SocialIdentityProviderRelayIdpParamMappings {
    function getJsonObj(obj: SocialIdentityProviderRelayIdpParamMappings): object;
    function getDeserializedJsonObj(obj: SocialIdentityProviderRelayIdpParamMappings): object;
}

 ...
 */
export interface AccountMgmtInfoSearchRequest {
    /**
     ...
     */
    "attributeSets"?: Array<AccountMgmtInfoSearchRequest.AttributeSets>;
    /**
...
export declare namespace AccountMgmtInfoSearchRequest {
    enum AttributeSets {
        All = "all",
        Always = "always",
        Never = "never",
    ...
    function getJsonObj(obj: AccountMgmtInfoSearchRequest): object;
    function getDeserializedJsonObj(obj: AccountMgmtInfoSearchRequest): object;
}

...
(function (Settings) {
        ...
        const jsonObj = Object.assign(Object.assign({}, obj), {
            "Resources": obj.resources
                ? obj.resources.map(item => {
                    return model.Setting.getJsonObj(item);
                })
                : undefined
        });
    ...
    Settings.getJsonObj = getJsonObj;
    function getDeserializedJsonObj(obj) {
        const jsonObj = Object.assign(Object.assign({}, obj), {
            "resources": obj["Resources"]
                ? obj["Resources"].map((item) => {
                    return model.Setting.getDeserializedJsonObj(item);
                })
                : undefined
        });
        delete jsonObj["Resources"];
    ...
    Settings.getDeserializedJsonObj = getDeserializedJsonObj;

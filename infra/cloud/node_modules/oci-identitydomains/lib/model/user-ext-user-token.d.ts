 ...
 *  - uniqueness: none
 */
export interface UserExtUserToken {
    /**
...
export declare namespace UserExtUserToken {
    function getJsonObj(obj: UserExtUserToken): object;
    function getDeserializedJsonObj(obj: UserExtUserToken): object;
}

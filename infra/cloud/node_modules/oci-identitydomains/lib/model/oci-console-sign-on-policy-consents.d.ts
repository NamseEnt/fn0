 ...
 */
export interface OciConsoleSignOnPolicyConsents {
    /**
     ...
     */
    "resources": Array<model.OciConsoleSignOnPolicyConsent>;
    /**
...
export declare namespace OciConsoleSignOnPolicyConsents {
    function getJsonObj(obj: OciConsoleSignOnPolicyConsents): object;
    function getDeserializedJsonObj(obj: OciConsoleSignOnPolicyConsents): object;
}

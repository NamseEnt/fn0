...
export interface AuthenticationFactorSetting {
     ...
     *  - uniqueness: none
     */
    "userEnrollmentDisabledFactors"?: Array<AuthenticationFactorSetting.UserEnrollmentDisabledFactors>;
...
export declare namespace AuthenticationFactorSetting {
    ...
    enum UserEnrollmentDisabledFactors {
        Email = "EMAIL",
        Sms = "SMS",
        Totp = "TOTP",
        Push = "PUSH",
    ...
    function getJsonObj(obj: AuthenticationFactorSetting): object;
    function getDeserializedJsonObj(obj: AuthenticationFactorSetting): object;
}

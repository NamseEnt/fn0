 ...
 */
export interface MyGroupSearchRequest {
    /**
     ...
     */
    "attributeSets"?: Array<MyGroupSearchRequest.AttributeSets>;
    /**
...
export declare namespace MyGroupSearchRequest {
    enum AttributeSets {
        All = "all",
        Always = "always",
        Never = "never",
    ...
    function getJsonObj(obj: MyGroupSearchRequest): object;
    function getDeserializedJsonObj(obj: MyGroupSearchRequest): object;
}

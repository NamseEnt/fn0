...
export interface ExtensionKerberosUserUser {
     ...
     *  - uniqueness: none
     */
    "realmUsers"?: Array<model.UserExtRealmUsers>;
}
export declare namespace ExtensionKerberosUserUser {
    function getJsonObj(obj: ExtensionKerberosUserUser): object;
    function getDeserializedJsonObj(obj: ExtensionKerberosUserUser): object;
}

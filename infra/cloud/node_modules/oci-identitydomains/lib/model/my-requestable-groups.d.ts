 ...
 */
export interface MyRequestableGroups {
    /**
     ...
     */
    "resources": Array<model.MyRequestableGroup>;
    /**
...
export declare namespace MyRequestableGroups {
    function getJsonObj(obj: MyRequestableGroups): object;
    function getDeserializedJsonObj(obj: MyRequestableGroups): object;
}

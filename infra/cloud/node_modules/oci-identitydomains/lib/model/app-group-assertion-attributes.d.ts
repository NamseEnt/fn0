 ...
 *  - uniqueness: none
 */
export interface AppGroupAssertionAttributes {
    /**
...
export declare namespace AppGroupAssertionAttributes {
    function getJsonObj(obj: AppGroupAssertionAttributes): object;
    function getDeserializedJsonObj(obj: AppGroupAssertionAttributes): object;
}

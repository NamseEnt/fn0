...
export declare namespace SchemaSubAttributes {
    enum Type {
        String = "string",
        Complex = "complex",
        Boolean = "boolean",
    ...
    function getJsonObj(obj: SchemaSubAttributes): object;
    function getDeserializedJsonObj(obj: SchemaSubAttributes): object;
}

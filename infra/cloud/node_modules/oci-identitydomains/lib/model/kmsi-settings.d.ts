...
export interface KmsiSettings {
     ...
     */
    "resources": Array<model.KmsiSetting>;
    /**
...
export declare namespace KmsiSettings {
    function getJsonObj(obj: KmsiSettings): object;
    function getDeserializedJsonObj(obj: KmsiSettings): object;
}

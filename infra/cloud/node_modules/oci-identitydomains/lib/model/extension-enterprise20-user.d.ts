...
export declare namespace ExtensionEnterprise20User {
    function getJsonObj(obj: ExtensionEnterprise20User): object;
    function getDeserializedJsonObj(obj: ExtensionEnterprise20User): object;
}

...
export interface RuleSearchRequest {
     ...
     */
    "attributeSets"?: Array<RuleSearchRequest.AttributeSets>;
    /**
...
export declare namespace RuleSearchRequest {
    enum AttributeSets {
        All = "all",
        Always = "always",
        Never = "never",
    ...
    function getJsonObj(obj: RuleSearchRequest): object;
    function getDeserializedJsonObj(obj: RuleSearchRequest): object;
}

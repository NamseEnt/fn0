...
export interface ApprovalWorkflowSteps {
     ...
     */
    "resources": Array<model.ApprovalWorkflowStep>;
    /**
...
export declare namespace ApprovalWorkflowSteps {
    function getJsonObj(obj: ApprovalWorkflowSteps): object;
    function getDeserializedJsonObj(obj: ApprovalWorkflowSteps): object;
}

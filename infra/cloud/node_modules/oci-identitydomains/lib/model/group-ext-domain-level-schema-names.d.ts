...
export declare namespace GroupExtDomainLevelSchemaNames {
    function getJsonObj(obj: GroupExtDomainLevelSchemaNames): object;
    function getDeserializedJsonObj(obj: GroupExtDomainLevelSchemaNames): object;
}

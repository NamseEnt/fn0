...
export declare namespace UserExtCustomerSecretKeys {
    function getJsonObj(obj: UserExtCustomerSecretKeys): object;
    function getDeserializedJsonObj(obj: UserExtCustomerSecretKeys): object;
}

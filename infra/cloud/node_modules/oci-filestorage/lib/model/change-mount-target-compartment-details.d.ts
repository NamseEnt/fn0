...
export declare namespace ChangeMountTargetCompartmentDetails {
    function getJsonObj(obj: ChangeMountTargetCompartmentDetails): object;
    function getDeserializedJsonObj(obj: ChangeMountTargetCompartmentDetails): object;
}

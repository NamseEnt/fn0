...
export declare namespace UpdateExportDetails {
    function getJsonObj(obj: UpdateExportDetails): object;
    function getDeserializedJsonObj(obj: UpdateExportDetails): object;
}

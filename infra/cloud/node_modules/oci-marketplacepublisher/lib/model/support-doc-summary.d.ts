...
export declare namespace SupportDocSummary {
    function getJsonObj(obj: SupportDocSummary): object;
    function getDeserializedJsonObj(obj: SupportDocSummary): object;
}

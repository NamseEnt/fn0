...
export declare namespace StackArtifactDetails {
    function getJsonObj(obj: StackArtifactDetails): object;
    function getDeserializedJsonObj(obj: StackArtifactDetails): object;
}

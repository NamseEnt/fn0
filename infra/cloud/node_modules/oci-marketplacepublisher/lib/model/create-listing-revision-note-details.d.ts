...
export declare namespace CreateListingRevisionNoteDetails {
    function getJsonObj(obj: CreateListingRevisionNoteDetails): object;
    function getDeserializedJsonObj(obj: CreateListingRevisionNoteDetails): object;
}

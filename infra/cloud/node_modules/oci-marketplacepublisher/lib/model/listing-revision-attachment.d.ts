...
export declare namespace ListingRevisionAttachment {
    enum LifecycleState {
        Active = "ACTIVE",
        Inactive = "INACTIVE",
        Deleted = "DELETED",
    ...
    function getJsonObj(obj: ListingRevisionAttachment): object;
    function getDeserializedJsonObj(obj: ListingRevisionAttachment): object;
}

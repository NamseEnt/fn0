...
export declare namespace ListingRevisionPackageSummary {
    function getJsonObj(obj: ListingRevisionPackageSummary): object;
    function getDeserializedJsonObj(obj: ListingRevisionPackageSummary): object;
}

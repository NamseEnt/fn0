...
export declare namespace SubmitListingRevisionForReviewDetails {
    function getJsonObj(obj: SubmitListingRevisionForReviewDetails): object;
    function getDeserializedJsonObj(obj: SubmitListingRevisionForReviewDetails): object;
}

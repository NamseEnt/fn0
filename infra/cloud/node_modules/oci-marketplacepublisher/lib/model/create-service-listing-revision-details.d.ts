 ...
 */
export interface CreateServiceListingRevisionDetails extends model.CreateListingRevisionDetails {
    /**
...
export declare namespace CreateServiceListingRevisionDetails {
    function getJsonObj(obj: CreateServiceListingRevisionDetails, isParentJsonObj?: boolean): object;
    const listingType = "SERVICE";
    function getDeserializedJsonObj(obj: CreateServiceListingRevisionDetails, isParentJsonObj?: boolean): object;
}

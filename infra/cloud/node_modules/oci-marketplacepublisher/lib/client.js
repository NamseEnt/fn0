...
class MarketplacePublisherClient {
    ...
    set endpoint(endpoint) {
        ...
        this._endpoint = this._endpoint + "/20241201";
        if (this.logger)
  ...
  *
     ...
     *
     * This operation uses {@link common.OciSdkDefaultRetryConfiguration} by default if no retry configuration is defined by the user.
     * @param GetLeadRequest
     * @return GetLeadResponse
     * @throws OciError when an error occurs
     * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/marketplacepublisher/GetLead.ts.html |here} to see how to use GetLead API.
     */
    getLead(getLeadRequest) {
        return __awaiter(this, void 0, void 0, function* () {
            if (this.logger)
                this.logger.debug("Calling operation MarketplacePublisherClient#getLead.");
            const operationName = "getLead";
            const apiReferenceLink = "";
            const pathParams = {
                "{leadId}": getLeadRequest.leadId
            };
            const queryParams = {};
            let headerParams = {
                "Content-Type": common.Constants.APPLICATION_JSON,
                "opc-request-id": getLeadRequest.opcRequestId
            };
            const specRetryConfiguration = common.OciSdkDefaultRetryConfiguration;
            const retrier = oci_common_1.GenericRetrier.createPreferredRetrier(this._clientConfiguration ? this._clientConfiguration.retryConfiguration : undefined, getLeadRequest.retryConfiguration, specRetryConfiguration);
            if (this.logger)
                retrier.logger = this.logger;
            const request = yield oci_common_1.composeRequest({
                baseEndpoint: this._endpoint,
     ...
     *
     * This operation uses {@link common.OciSdkDefaultRetryConfiguration} by default if no retry configuration is defined by the user.
     * @param GetListingRevisionAttachmentContentRequest
     * @return GetListingRevisionAttachmentContentResponse
     * @throws OciError when an error occurs
     * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/marketplacepublisher/GetListingRevisionAttachmentContent.ts.html |here} to see how to use GetListingRevisionAttachmentContent API.
     */
    getListingRevisionAttachmentContent(getListingRevisionAttachmentContentRequest) {
        return __awaiter(this, void 0, void 0, function* () {
            if (this.logger)
                this.logger.debug("Calling operation MarketplacePublisherClient#getListingRevisionAttachmentContent.");
            const operationName = "getListingRevisionAttachmentContent";
            const apiReferenceLink = "";
            const pathParams = {
                "{listingRevisionAttachmentId}": getListingRevisionAttachmentContentRequest.listingRevisionAttachmentId
            };
            const queryParams = {};
            let headerParams = {
                "Content-Type": common.Constants.APPLICATION_JSON,
                "opc-request-id": getListingRevisionAttachmentContentRequest.opcRequestId
            };
            const specRetryConfiguration = common.OciSdkDefaultRetryConfiguration;
            const retrier = oci_common_1.GenericRetrier.createPreferredRetrier(this._clientConfiguration ? this._clientConfiguration.retryConfiguration : undefined, getListingRevisionAttachmentContentRequest.retryConfiguration, specRetryConfiguration);
            if (this.logger)
                retrier.logger = this.logger;
            const request = yield oci_common_1.composeRequest({
                baseEndpoint: this._endpoint,
     ...
     *
     * This operation uses {@link common.OciSdkDefaultRetryConfiguration} by default if no retry configuration is defined by the user.
     * @param GetListingRevisionIconContentRequest
     * @return GetListingRevisionIconContentResponse
     * @throws OciError when an error occurs
     * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/marketplacepublisher/GetListingRevisionIconContent.ts.html |here} to see how to use GetListingRevisionIconContent API.
     */
    getListingRevisionIconContent(getListingRevisionIconContentRequest) {
        return __awaiter(this, void 0, void 0, function* () {
            if (this.logger)
                this.logger.debug("Calling operation MarketplacePublisherClient#getListingRevisionIconContent.");
            const operationName = "getListingRevisionIconContent";
            const apiReferenceLink = "";
            const pathParams = {
                "{listingRevisionId}": getListingRevisionIconContentRequest.listingRevisionId
            };
            const queryParams = {};
            let headerParams = {
                "Content-Type": common.Constants.APPLICATION_JSON,
                "opc-request-id": getListingRevisionIconContentRequest.opcRequestId
            };
            const specRetryConfiguration = common.OciSdkDefaultRetryConfiguration;
            const retrier = oci_common_1.GenericRetrier.createPreferredRetrier(this._clientConfiguration ? this._clientConfiguration.retryConfiguration : undefined, getListingRevisionIconContentRequest.retryConfiguration, specRetryConfiguration);
            if (this.logger)
                retrier.logger = this.logger;
            const request = yield oci_common_1.composeRequest({
                baseEndpoint: this._endpoint,
     ...
     * This operation uses {@link common.OciSdkDefaultRetryConfiguration} by default if no retry configuration is defined by the user.
     * @param GetSupportDocRequest
     * @return GetSupportDocResponse
     * @throws OciError when an error occurs
     * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/marketplacepublisher/GetSupportDoc.ts.html |here} to see how to use GetSupportDoc API.
     */
    getSupportDoc(getSupportDocRequest) {
        return __awaiter(this, void 0, void 0, function* () {
            if (this.logger)
                this.logger.debug("Calling operation MarketplacePublisherClient#getSupportDoc.");
            const operationName = "getSupportDoc";
            const apiReferenceLink = "";
            const pathParams = {
                "{supportDocCode}": getSupportDocRequest.supportDocCode
            };
            const queryParams = {};
            let headerParams = {
                "Content-Type": common.Constants.APPLICATION_JSON,
                "opc-request-id": getSupportDocRequest.opcRequestId
            };
            const specRetryConfiguration = common.OciSdkDefaultRetryConfiguration;
            const retrier = oci_common_1.GenericRetrier.createPreferredRetrier(this._clientConfiguration ? this._clientConfiguration.retryConfiguration : undefined, getSupportDocRequest.retryConfiguration, specRetryConfiguration);
            if (this.logger)
                retrier.logger = this.logger;
            const request = yield oci_common_1.composeRequest({
                baseEndpoint: this._endpoint,
                defaultHeaders: this._defaultHeaders,
                path: "/supportDocs/{supportDocCode}",
                method: "GET",
                pathParams: pathParams,
                headerParams: headerParams,
                queryParams: queryParams
            ...
            try {
                ...
                const sdkResponse = oci_common_1.composeResponse({
                    ...
                    body: yield response.json(),
                    bodyKey: "supportDoc",
                    bodyModel: model.SupportDoc,
                    type: "model.SupportDoc",
                    responseHeaders: [
                        {
                            value: response.headers.get("etag"),
                            key: "etag",
     ...
     * This operation uses {@link common.OciSdkDefaultRetryConfiguration} by default if no retry configuration is defined by the user.
     * @param GetSupportDocContentRequest
     * @return GetSupportDocContentResponse
     * @throws OciError when an error occurs
     * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/marketplacepublisher/GetSupportDocContent.ts.html |here} to see how to use GetSupportDocContent API.
     */
    getSupportDocContent(getSupportDocContentRequest) {
        return __awaiter(this, void 0, void 0, function* () {
            if (this.logger)
                this.logger.debug("Calling operation MarketplacePublisherClient#getSupportDocContent.");
            const operationName = "getSupportDocContent";
            const apiReferenceLink = "";
            const pathParams = {
                "{supportDocCode}": getSupportDocContentRequest.supportDocCode
            };
            const queryParams = {};
            let headerParams = {
                "Content-Type": common.Constants.APPLICATION_JSON,
                "opc-request-id": getSupportDocContentRequest.opcRequestId
            };
            const specRetryConfiguration = common.OciSdkDefaultRetryConfiguration;
            const retrier = oci_common_1.GenericRetrier.createPreferredRetrier(this._clientConfiguration ? this._clientConfiguration.retryConfiguration : undefined, getSupportDocContentRequest.retryConfiguration, specRetryConfiguration);
            if (this.logger)
                retrier.logger = this.logger;
            const request = yield oci_common_1.composeRequest({
                baseEndpoint: this._endpoint,
                defaultHeaders: this._defaultHeaders,
                path: "/supportDocs/{supportDocCode}/content",
                method: "GET",
                pathParams: pathParams,
                headerParams: headerParams,
                queryParams: queryParams
     ...
     * This operation uses {@link common.OciSdkDefaultRetryConfiguration} by default if no retry configuration is defined by the user.
     * @param GetTermVersionContentRequest
     * @return GetTermVersionContentResponse
     * @throws OciError when an error occurs
     * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/marketplacepublisher/GetTermVersionContent.ts.html |here} to see how to use GetTermVersionContent API.
     */
    getTermVersionContent(getTermVersionContentRequest) {
        return __awaiter(this, void 0, void 0, function* () {
            if (this.logger)
                this.logger.debug("Calling operation MarketplacePublisherClient#getTermVersionContent.");
            const operationName = "getTermVersionContent";
            const apiReferenceLink = "";
            const pathParams = {
                "{termVersionId}": getTermVersionContentRequest.termVersionId
            };
            const queryParams = {};
            let headerParams = {
                "Content-Type": common.Constants.APPLICATION_JSON,
                "opc-request-id": getTermVersionContentRequest.opcRequestId
            };
            const specRetryConfiguration = common.OciSdkDefaultRetryConfiguration;
            const retrier = oci_common_1.GenericRetrier.createPreferredRetrier(this._clientConfiguration ? this._clientConfiguration.retryConfiguration : undefined, getTermVersionContentRequest.retryConfiguration, specRetryConfiguration);
            if (this.logger)
                retrier.logger = this.logger;
            const request = yield oci_common_1.composeRequest({
                baseEndpoint: this._endpoint,
     ...
     *
     * This operation uses {@link common.OciSdkDefaultRetryConfiguration} by default if no retry configuration is defined by the user.
     * @param ListAvailableServicesRequest
     * @return ListAvailableServicesResponse
     * @throws OciError when an error occurs
     * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/marketplacepublisher/ListAvailableServices.ts.html |here} to see how to use ListAvailableServices API.
     */
    listAvailableServices(listAvailableServicesRequest) {
        return __awaiter(this, void 0, void 0, function* () {
            if (this.logger)
                this.logger.debug("Calling operation MarketplacePublisherClient#listAvailableServices.");
            const operationName = "listAvailableServices";
            const apiReferenceLink = "";
            const pathParams = {};
            const queryParams = {
                "compartmentId": listAvailableServicesRequest.compartmentId,
                "name": listAvailableServicesRequest.name,
                "limit": listAvailableServicesRequest.limit,
                "page": listAvailableServicesRequest.page,
                "sortOrder": listAvailableServicesRequest.sortOrder,
                "sortBy": listAvailableServicesRequest.sortBy
            };
            let headerParams = {
                "Content-Type": common.Constants.APPLICATION_JSON,
                "opc-request-id": listAvailableServicesRequest.opcRequestId
            };
            const specRetryConfiguration = common.OciSdkDefaultRetryConfiguration;
            const retrier = oci_common_1.GenericRetrier.createPreferredRetrier(this._clientConfiguration ? this._clientConfiguration.retryConfiguration : undefined, listAvailableServicesRequest.retryConfiguration, specRetryConfiguration);
            if (this.logger)
                retrier.logger = this.logger;
            const request = yield oci_common_1.composeRequest({
                baseEndpoint: this._endpoint,
            ...
            try {
                ...
                const sdkResponse = oci_common_1.composeResponse({
                    responseObject: {},
                    body: yield response.json(),
                    bodyKey: "availableServiceCollection",
                    bodyModel: model.AvailableServiceCollection,
                    type: "model.AvailableServiceCollection",
                    responseHeaders: [
                        {
                            value: response.headers.get("opc-request-id"),
                            key: "opcRequestId",
     ...
     *
     * This operation uses {@link common.OciSdkDefaultRetryConfiguration} by default if no retry configuration is defined by the user.
     * @param ListCustomerInstanceReportRecordsRequest
     * @return ListCustomerInstanceReportRecordsResponse
     * @throws OciError when an error occurs
     * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/marketplacepublisher/ListCustomerInstanceReportRecords.ts.html |here} to see how to use ListCustomerInstanceReportRecords API.
     */
    listCustomerInstanceReportRecords(listCustomerInstanceReportRecordsRequest) {
        return __awaiter(this, void 0, void 0, function* () {
            if (this.logger)
                this.logger.debug("Calling operation MarketplacePublisherClient#listCustomerInstanceReportRecords.");
            const operationName = "listCustomerInstanceReportRecords";
            const apiReferenceLink = "";
            const pathParams = {};
            const queryParams = {
                "compartmentId": listCustomerInstanceReportRecordsRequest.compartmentId,
                "dateRange": listCustomerInstanceReportRecordsRequest.dateRange,
                "limit": listCustomerInstanceReportRecordsRequest.limit,
                "page": listCustomerInstanceReportRecordsRequest.page,
                "sortOrder": listCustomerInstanceReportRecordsRequest.sortOrder,
                "sortBy": listCustomerInstanceReportRecordsRequest.sortBy,
                "name": listCustomerInstanceReportRecordsRequest.name
            };
            let headerParams = {
                "Content-Type": common.Constants.APPLICATION_JSON,
                "opc-request-id": listCustomerInstanceReportRecordsRequest.opcRequestId
            };
            const specRetryConfiguration = common.OciSdkDefaultRetryConfiguration;
            const retrier = oci_common_1.GenericRetrier.createPreferredRetrier(this._clientConfiguration ? this._clientConfiguration.retryConfiguration : undefined, listCustomerInstanceReportRecordsRequest.retryConfiguration, specRetryConfiguration);
            if (this.logger)
                retrier.logger = this.logger;
            const request = yield oci_common_1.composeRequest({
                baseEndpoint: this._endpoint,
                defaultHeaders: this._defaultHeaders,
                path: "/customerInstanceReportRecords",
                method: "GET",
                pathParams: pathParams,
                headerParams: headerParams,
                queryParams: queryParams
            ...
            try {
                ...
                const sdkResponse = oci_common_1.composeResponse({
                    responseObject: {},
                    body: yield response.json(),
                    bodyKey: "customerInstanceReportRecordCollection",
                    bodyModel: model.CustomerInstanceReportRecordCollection,
                    type: "model.CustomerInstanceReportRecordCollection",
                    responseHeaders: [
                        {
                            value: response.headers.get("opc-request-id"),
                            key: "opcRequestId",
     ...
     *
     * This operation uses {@link common.OciSdkDefaultRetryConfiguration} by default if no retry configuration is defined by the user.
     * @param ListDisbursementReportRecordsRequest
     * @return ListDisbursementReportRecordsResponse
     * @throws OciError when an error occurs
     * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/marketplacepublisher/ListDisbursementReportRecords.ts.html |here} to see how to use ListDisbursementReportRecords API.
     */
    listDisbursementReportRecords(listDisbursementReportRecordsRequest) {
        return __awaiter(this, void 0, void 0, function* () {
            if (this.logger)
                this.logger.debug("Calling operation MarketplacePublisherClient#listDisbursementReportRecords.");
            const operationName = "listDisbursementReportRecords";
            const apiReferenceLink = "";
            const pathParams = {};
            const queryParams = {
                "compartmentId": listDisbursementReportRecordsRequest.compartmentId,
                "dateRange": listDisbursementReportRecordsRequest.dateRange,
                "limit": listDisbursementReportRecordsRequest.limit,
                "page": listDisbursementReportRecordsRequest.page,
                "sortOrder": listDisbursementReportRecordsRequest.sortOrder,
                "sortBy": listDisbursementReportRecordsRequest.sortBy,
                "name": listDisbursementReportRecordsRequest.name
            };
            let headerParams = {
                "Content-Type": common.Constants.APPLICATION_JSON,
                "opc-request-id": listDisbursementReportRecordsRequest.opcRequestId
            };
            const specRetryConfiguration = common.OciSdkDefaultRetryConfiguration;
            const retrier = oci_common_1.GenericRetrier.createPreferredRetrier(this._clientConfiguration ? this._clientConfiguration.retryConfiguration : undefined, listDisbursementReportRecordsRequest.retryConfiguration, specRetryConfiguration);
            if (this.logger)
                retrier.logger = this.logger;
            const request = yield oci_common_1.composeRequest({
                baseEndpoint: this._endpoint,
                defaultHeaders: this._defaultHeaders,
                path: "/disbursementReportRecords",
                method: "GET",
                pathParams: pathParams,
                headerParams: headerParams,
                queryParams: queryParams
            ...
            try {
                ...
                const sdkResponse = oci_common_1.composeResponse({
                    responseObject: {},
                    body: yield response.json(),
                    bodyKey: "disbursementReportRecordCollection",
                    bodyModel: model.DisbursementReportRecordCollection,
                    type: "model.DisbursementReportRecordCollection",
                    responseHeaders: [
                        {
                            value: response.headers.get("opc-request-id"),
                            key: "opcRequestId",
     ...
     *
     * This operation uses {@link common.OciSdkDefaultRetryConfiguration} by default if no retry configuration is defined by the user.
     * @param ListLeadsRequest
     * @return ListLeadsResponse
     * @throws OciError when an error occurs
     * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/marketplacepublisher/ListLeads.ts.html |here} to see how to use ListLeads API.
     */
    listLeads(listLeadsRequest) {
        return __awaiter(this, void 0, void 0, function* () {
            if (this.logger)
                this.logger.debug("Calling operation MarketplacePublisherClient#listLeads.");
            const operationName = "listLeads";
            const apiReferenceLink = "";
            const pathParams = {};
            const queryParams = {
                "listingId": listLeadsRequest.listingId,
                "compartmentId": listLeadsRequest.compartmentId,
                "limit": listLeadsRequest.limit,
                "page": listLeadsRequest.page,
                "sortOrder": listLeadsRequest.sortOrder,
                "sortBy": listLeadsRequest.sortBy
            };
            let headerParams = {
                "Content-Type": common.Constants.APPLICATION_JSON,
                "opc-request-id": listLeadsRequest.opcRequestId
            };
            const specRetryConfiguration = common.OciSdkDefaultRetryConfiguration;
            const retrier = oci_common_1.GenericRetrier.createPreferredRetrier(this._clientConfiguration ? this._clientConfiguration.retryConfiguration : undefined, listLeadsRequest.retryConfiguration, specRetryConfiguration);
            if (this.logger)
                retrier.logger = this.logger;
            const request = yield oci_common_1.composeRequest({
                baseEndpoint: this._endpoint,
            ...
            try {
                ...
                const sdkResponse = oci_common_1.composeResponse({
                    responseObject: {},
                    body: yield response.json(),
                    bodyKey: "leadCollection",
                    bodyModel: model.LeadCollection,
                    type: "model.LeadCollection",
                    responseHeaders: [
                        {
                            value: response.headers.get("opc-request-id"),
                            key: "opcRequestId",
  ...
  *
    ...
    listListings(listListingsRequest) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const queryParams = {
                ...
                "listingType": listListingsRequest.listingType,
    ...
    listMarkets(listMarketsRequest) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const queryParams = {
                ...
                "listingId": listMarketsRequest.listingId
            };
            let headerParams = {
                "Content-Type": common.Constants.APPLICATION_JSON,
    ...
    listProducts(listProductsRequest) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const queryParams = {
                ...
                "productGroup": listProductsRequest.productGroup,
     ...
     *
     * This operation uses {@link common.OciSdkDefaultRetryConfiguration} by default if no retry configuration is defined by the user.
     * @param ListSupportDocsRequest
     * @return ListSupportDocsResponse
     * @throws OciError when an error occurs
     * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/marketplacepublisher/ListSupportDocs.ts.html |here} to see how to use ListSupportDocs API.
     */
    listSupportDocs(listSupportDocsRequest) {
        return __awaiter(this, void 0, void 0, function* () {
            if (this.logger)
                this.logger.debug("Calling operation MarketplacePublisherClient#listSupportDocs.");
            const operationName = "listSupportDocs";
            const apiReferenceLink = "";
            const pathParams = {};
            const queryParams = {
                "limit": listSupportDocsRequest.limit,
                "page": listSupportDocsRequest.page,
                "compartmentId": listSupportDocsRequest.compartmentId,
                "sortOrder": listSupportDocsRequest.sortOrder,
                "sortBy": listSupportDocsRequest.sortBy,
                "supportDocGroup": listSupportDocsRequest.supportDocGroup,
                "name": listSupportDocsRequest.name
            };
            let headerParams = {
                "Content-Type": common.Constants.APPLICATION_JSON,
                "opc-request-id": listSupportDocsRequest.opcRequestId
            };
            const specRetryConfiguration = common.OciSdkDefaultRetryConfiguration;
            const retrier = oci_common_1.GenericRetrier.createPreferredRetrier(this._clientConfiguration ? this._clientConfiguration.retryConfiguration : undefined, listSupportDocsRequest.retryConfiguration, specRetryConfiguration);
            if (this.logger)
                retrier.logger = this.logger;
            const request = yield oci_common_1.composeRequest({
                baseEndpoint: this._endpoint,
            ...
            try {
                ...
                const sdkResponse = oci_common_1.composeResponse({
                    responseObject: {},
                    body: yield response.json(),
                    bodyKey: "supportDocCollection",
                    bodyModel: model.SupportDocCollection,
                    type: "model.SupportDocCollection",
                    responseHeaders: [
                        {
                            value: response.headers.get("opc-next-page"),
                            key: "opcNextPage",
     ...
     *
     * This operation uses {@link common.OciSdkDefaultRetryConfiguration} by default if no retry configuration is defined by the user.
     * @param ListSupportedCurrenciesRequest
     * @return ListSupportedCurrenciesResponse
     * @throws OciError when an error occurs
     * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/marketplacepublisher/ListSupportedCurrencies.ts.html |here} to see how to use ListSupportedCurrencies API.
     */
    listSupportedCurrencies(listSupportedCurrenciesRequest) {
        return __awaiter(this, void 0, void 0, function* () {
            if (this.logger)
                this.logger.debug("Calling operation MarketplacePublisherClient#listSupportedCurrencies.");
            const operationName = "listSupportedCurrencies";
            const apiReferenceLink = "";
            const pathParams = {};
            const queryParams = {
                "limit": listSupportedCurrenciesRequest.limit,
                "page": listSupportedCurrenciesRequest.page,
                "compartmentId": listSupportedCurrenciesRequest.compartmentId,
                "sortOrder": listSupportedCurrenciesRequest.sortOrder,
                "sortBy": listSupportedCurrenciesRequest.sortBy
            };
            let headerParams = {
                "Content-Type": common.Constants.APPLICATION_JSON,
                "opc-request-id": listSupportedCurrenciesRequest.opcRequestId
            };
            const specRetryConfiguration = common.OciSdkDefaultRetryConfiguration;
            const retrier = oci_common_1.GenericRetrier.createPreferredRetrier(this._clientConfiguration ? this._clientConfiguration.retryConfiguration : undefined, listSupportedCurrenciesRequest.retryConfiguration, specRetryConfiguration);
            if (this.logger)
                retrier.logger = this.logger;
            const request = yield oci_common_1.composeRequest({
                baseEndpoint: this._endpoint,
            ...
            try {
                ...
                const sdkResponse = oci_common_1.composeResponse({
                    responseObject: {},
                    body: yield response.json(),
                    bodyKey: "supportedCurrencyCollection",
                    bodyModel: model.SupportedCurrencyCollection,
                    type: "model.SupportedCurrencyCollection",
                    responseHeaders: [
                        {
                            value: response.headers.get("opc-next-page"),
                            key: "opcNextPage",
     ...
     *
     * This operation uses {@link common.OciSdkDefaultRetryConfiguration} by default if no retry configuration is defined by the user.
     * @param ListSupportedShapesRequest
     * @return ListSupportedShapesResponse
     * @throws OciError when an error occurs
     * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/marketplacepublisher/ListSupportedShapes.ts.html |here} to see how to use ListSupportedShapes API.
     */
    listSupportedShapes(listSupportedShapesRequest) {
        return __awaiter(this, void 0, void 0, function* () {
            if (this.logger)
                this.logger.debug("Calling operation MarketplacePublisherClient#listSupportedShapes.");
            const operationName = "listSupportedShapes";
            const apiReferenceLink = "";
            const pathParams = {};
            const queryParams = {
                "limit": listSupportedShapesRequest.limit,
                "page": listSupportedShapesRequest.page,
                "compartmentId": listSupportedShapesRequest.compartmentId,
                "sortOrder": listSupportedShapesRequest.sortOrder,
                "sortBy": listSupportedShapesRequest.sortBy,
                "name": listSupportedShapesRequest.name
            };
            let headerParams = {
                "Content-Type": common.Constants.APPLICATION_JSON,
                "opc-request-id": listSupportedShapesRequest.opcRequestId
            };
            const specRetryConfiguration = common.OciSdkDefaultRetryConfiguration;
            const retrier = oci_common_1.GenericRetrier.createPreferredRetrier(this._clientConfiguration ? this._clientConfiguration.retryConfiguration : undefined, listSupportedShapesRequest.retryConfiguration, specRetryConfiguration);
            if (this.logger)
                retrier.logger = this.logger;
            const request = yield oci_common_1.composeRequest({
                baseEndpoint: this._endpoint,
                defaultHeaders: this._defaultHeaders,
                path: "/supportedShapes",
                method: "GET",
                pathParams: pathParams,
                headerParams: headerParams,
                queryParams: queryParams
            ...
            try {
                ...
                const sdkResponse = oci_common_1.composeResponse({
                    responseObject: {},
                    body: yield response.json(),
                    bodyKey: "supportedShapeCollection",
                    bodyModel: model.SupportedShapeCollection,
                    type: "model.SupportedShapeCollection",
                    responseHeaders: [
                        {
                            value: response.headers.get("opc-next-page"),
                            key: "opcNextPage",
     ...
     * This operation uses {@link common.OciSdkDefaultRetryConfiguration} by default if no retry configuration is defined by the user.
     * @param UpdateListingRevisionNoteRequest
     * @return UpdateListingRevisionNoteResponse
     * @throws OciError when an error occurs
     * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/marketplacepublisher/UpdateListingRevisionNote.ts.html |here} to see how to use UpdateListingRevisionNote API.
     */
    updateListingRevisionNote(updateListingRevisionNoteRequest) {
        return __awaiter(this, void 0, void 0, function* () {
            if (this.logger)
                this.logger.debug("Calling operation MarketplacePublisherClient#updateListingRevisionNote.");
            const operationName = "updateListingRevisionNote";
            const apiReferenceLink = "";
            const pathParams = {
                "{listingRevisionNoteId}": updateListingRevisionNoteRequest.listingRevisionNoteId
            };
            const queryParams = {};
            let headerParams = {
                "Content-Type": common.Constants.APPLICATION_JSON,
                "if-match": updateListingRevisionNoteRequest.ifMatch,
                "opc-request-id": updateListingRevisionNoteRequest.opcRequestId
            };
            const specRetryConfiguration = common.OciSdkDefaultRetryConfiguration;
            const retrier = oci_common_1.GenericRetrier.createPreferredRetrier(this._clientConfiguration ? this._clientConfiguration.retryConfiguration : undefined, updateListingRevisionNoteRequest.retryConfiguration, specRetryConfiguration);
            if (this.logger)
                retrier.logger = this.logger;
            const request = yield oci_common_1.composeRequest({
                baseEndpoint: this._endpoint,
                ...
                path: "/listingRevisionNotes/{listingRevisionNoteId}",
                method: "PUT",
                bodyContent: common.ObjectSerializer.serialize(updateListingRevisionNoteRequest.updateListingRevisionNoteDetails, "UpdateListingRevisionNoteDetails", model.UpdateListingRevisionNoteDetails.getJsonObj),
                pathParams: pathParams,
                headerParams: headerParams,
                queryParams: queryParams
            });

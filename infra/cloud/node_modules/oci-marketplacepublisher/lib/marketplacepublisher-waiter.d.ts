...
export declare class MarketplacePublisherWaiter {
     ...
     */
    forLead(request: serviceRequests.GetLeadRequest, ...targetStates: models.Lead.LifecycleState[]): Promise<serviceResponses.GetLeadResponse | null>;
    /**
     ...
     */
    forSupportDoc(request: serviceRequests.GetSupportDocRequest, ...targetStates: models.SupportDoc.LifecycleState[]): Promise<serviceResponses.GetSupportDocResponse>;
    /**

...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/marketplacepublisher/ListListings.ts.html |here} to see how to use ListListingsRequest.
 */
...
export declare namespace ListListingsRequest {
    enum SortBy {

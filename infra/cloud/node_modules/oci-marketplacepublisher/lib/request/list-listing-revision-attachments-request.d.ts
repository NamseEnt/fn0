...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/marketplacepublisher/ListListingRevisionAttachments.ts.html |here} to see how to use ListListingRevisionAttachmentsRequest.
 */
...
export declare namespace ListListingRevisionAttachmentsRequest {
    enum SortBy {

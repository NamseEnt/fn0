...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/announcementsservice/ListAnnouncements.ts.html |here} to see how to use ListAnnouncementsRequest.
 */
...
export declare namespace ListAnnouncementsRequest {
    enum LifecycleState {
        Active = "ACTIVE",
        Inactive = "INACTIVE"
    }

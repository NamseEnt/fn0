...
export declare namespace BaseCreateAnnouncementsPreferencesDetails {
    enum PreferenceType {
    ...
    function getJsonObj(obj: BaseCreateAnnouncementsPreferencesDetails): object;
    function getDeserializedJsonObj(obj: BaseCreateAnnouncementsPreferencesDetails): object;
}

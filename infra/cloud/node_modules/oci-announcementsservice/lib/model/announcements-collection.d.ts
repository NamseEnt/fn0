...
export declare namespace AnnouncementsCollection {
    function getJsonObj(obj: AnnouncementsCollection): object;
    function getDeserializedJsonObj(obj: AnnouncementsCollection): object;
}

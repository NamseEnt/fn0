...
export declare namespace AccessibleCompartmentRequest {
    function getJsonObj(obj: AccessibleCompartmentRequest): object;
    function getDeserializedJsonObj(obj: AccessibleCompartmentRequest): object;
}

...
export declare namespace AccessibleCompartmentResponse {
    function getJsonObj(obj: AccessibleCompartmentResponse): object;
    function getDeserializedJsonObj(obj: AccessibleCompartmentResponse): object;
}

...
export declare namespace AssociationAuthorizationRequest {
    function getJsonObj(obj: AssociationAuthorizationRequest): object;
    function getDeserializedJsonObj(obj: AssociationAuthorizationRequest): object;
}

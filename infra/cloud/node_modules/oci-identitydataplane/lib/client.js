...
exports.DataplaneClient = exports.DataplaneApiKeys = void 0;
...
// ===============================================
var DataplaneApiKeys;
(function (DataplaneApiKeys) {
})(DataplaneApiKeys = exports.DataplaneApiKeys || (exports.DataplaneApiKeys = {}));
/**
...
class DataplaneClient {
    constructor(params, clientConfiguration) {
        ...
        if (!oci_common_1.developerToolConfiguration.isServiceEnabled("identitydataplane")) {
            let errmsg = "The developerToolConfiguration configuration disabled this service, this behavior is controlled by developerToolConfiguration.ociEnabledServiceSet variable. Please check if your local developer_tool_configuration file has configured the service you're targeting or contact the cloud provider on the availability of this service : ";
            throw errmsg.concat("identitydataplane");
        }
    ...
    set endpoint(endpoint) {
        ...
        if (this.logger)
            this.logger.info(`DataplaneClient endpoint set to ${this._endpoint}`);
    }
    get logger() {
    ...
    set useRealmSpecificEndpointTemplate(realmSpecificEndpointTemplateEnabled) {
        ...
        if (this._lastSetRegionOrRegionId === common.Region.REGION_STRING) {
            this.endpoint = common.EndpointBuilder.createEndpointFromRegion(DataplaneClient.serviceEndpointTemplate, this._region, DataplaneClient.endpointServiceName);
        }
        else if (this._lastSetRegionOrRegionId === common.Region.REGION_ID_STRING) {
            this.endpoint = common.EndpointBuilder.createEndpointFromRegionId(DataplaneClient.serviceEndpointTemplate, this._regionId, DataplaneClient.endpointServiceName);
        }
    }
    /**
    ...
    set region(region) {
        this._region = region;
        this.endpoint = common.EndpointBuilder.createEndpointFromRegion(DataplaneClient.serviceEndpointTemplate, region, DataplaneClient.endpointServiceName);
    ...
    set regionId(regionId) {
        ...
        this.endpoint = common.EndpointBuilder.createEndpointFromRegionId(DataplaneClient.serviceEndpointTemplate, regionId, DataplaneClient.endpointServiceName);
    ...
    generateScopedAccessToken(generateScopedAccessTokenRequest) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const retrier = oci_common_1.GenericRetrier.createPreferredRetrier(this._clientConfiguration ? this._clientConfiguration.retryConfiguration : undefined, generateScopedAccessTokenRequest.retryConfiguration, specRetryConfiguration);
            if (this.logger)
            ...
            const request = yield oci_common_1.composeRequest({
                ...
                method: "POST",
                bodyContent: common.ObjectSerializer.serialize(generateScopedAccessTokenRequest.generateScopedAccessTokenDetails, "GenerateScopedAccessTokenDetails", model.GenerateScopedAccessTokenDetails.getJsonObj),

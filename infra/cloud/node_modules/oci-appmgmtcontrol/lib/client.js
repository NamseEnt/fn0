...
exports.AppmgmtControlClient = exports.AppmgmtControlApiKeys = void 0;
const common = require("oci-common");
const model = __importStar(require("./model"));
const appmgmtcontrol_waiter_1 = require("./appmgmtcontrol-waiter");
const oci_common_1 = require("oci-common");
const Breaker = require("opossum");
// ===============================================
// This file is autogenerated - Please do not edit
// ===============================================
var AppmgmtControlApiKeys;
(function (AppmgmtControlApiKeys) {
})(AppmgmtControlApiKeys = exports.AppmgmtControlApiKeys || (exports.AppmgmtControlApiKeys = {}));
/**
 * This service client uses {@link common.CircuitBreaker.DefaultConfiguration} for all the operations by default if no circuit breaker configuration is defined by the user.
 */
class AppmgmtControlClient {
    constructor(params, clientConfiguration) {
        ...
        this.targetService = "AppmgmtControl";
        this._regionId = "";
        ...
        if (!oci_common_1.developerToolConfiguration.isServiceEnabled("appmgmtcontrol")) {
    ...
    set endpoint(endpoint) {
        ...
        if (this.logger)
            this.logger.info(`AppmgmtControlClient endpoint set to ${this._endpoint}`);
    }
    get logger() {
    ...
    set useRealmSpecificEndpointTemplate(realmSpecificEndpointTemplateEnabled) {
        ...
        if (this._lastSetRegionOrRegionId === common.Region.REGION_STRING) {
            this.endpoint = common.EndpointBuilder.createEndpointFromRegion(AppmgmtControlClient.serviceEndpointTemplate, this._region, AppmgmtControlClient.endpointServiceName);
        }
        else if (this._lastSetRegionOrRegionId === common.Region.REGION_ID_STRING) {
            this.endpoint = common.EndpointBuilder.createEndpointFromRegionId(AppmgmtControlClient.serviceEndpointTemplate, this._regionId, AppmgmtControlClient.endpointServiceName);
        }
    }
    /**
    ...
    set region(region) {
        this._region = region;
        this.endpoint = common.EndpointBuilder.createEndpointFromRegion(AppmgmtControlClient.serviceEndpointTemplate, region, AppmgmtControlClient.endpointServiceName);
    ...
    set regionId(regionId) {
        ...
        this.endpoint = common.EndpointBuilder.createEndpointFromRegionId(AppmgmtControlClient.serviceEndpointTemplate, regionId, AppmgmtControlClient.endpointServiceName);
    ...
    createWaiters(config) {
        this._waiters = new appmgmtcontrol_waiter_1.AppmgmtControlWaiter(this, config);
     ...
     */
    activateMonitoringPlugin(activateMonitoringPluginRequest) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const apiReferenceLink = "https://docs.oracle.com/iaas/api/#/en/resource-discovery-monitoring-control-api/20210330/MonitoredInstance/ActivateMonitoringPlugin";
            const pathParams = {
            ...
            const retrier = oci_common_1.GenericRetrier.createPreferredRetrier(this._clientConfiguration ? this._clientConfiguration.retryConfiguration : undefined, activateMonitoringPluginRequest.retryConfiguration, specRetryConfiguration);
            if (this.logger)
     ...
     */
    getMonitoredInstance(getMonitoredInstanceRequest) {
        return __awaiter(this, void 0, void 0, function* () {
            if (this.logger)
                this.logger.debug("Calling operation AppmgmtControlClient#getMonitoredInstance.");
            const operationName = "getMonitoredInstance";
            const apiReferenceLink = "https://docs.oracle.com/iaas/api/#/en/resource-discovery-monitoring-control-api/20210330/MonitoredInstance/GetMonitoredInstance";
            const pathParams = {
            ...
            const retrier = oci_common_1.GenericRetrier.createPreferredRetrier(this._clientConfiguration ? this._clientConfiguration.retryConfiguration : undefined, getMonitoredInstanceRequest.retryConfiguration, specRetryConfiguration);
            if (this.logger)
                retrier.logger = this.logger;
            const request = yield oci_common_1.composeRequest({
                baseEndpoint: this._endpoint,
    ...
    getWorkRequest(getWorkRequestRequest) {
        return __awaiter(this, void 0, void 0, function* () {
            if (this.logger)
                this.logger.debug("Calling operation AppmgmtControlClient#getWorkRequest.");
            const operationName = "getWorkRequest";
            const apiReferenceLink = "https://docs.oracle.com/iaas/api/#/en/resource-discovery-monitoring-control-api/20210330/WorkRequest/GetWorkRequest";
            const pathParams = {
    ...
    listMonitoredInstances(listMonitoredInstancesRequest) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const apiReferenceLink = "https://docs.oracle.com/iaas/api/#/en/resource-discovery-monitoring-control-api/20210330/MonitoredInstanceCollection/ListMonitoredInstances";
            const pathParams = {};
            const queryParams = {
            ...
            const specRetryConfiguration = common.OciSdkDefaultRetryConfiguration;
            const retrier = oci_common_1.GenericRetrier.createPreferredRetrier(this._clientConfiguration ? this._clientConfiguration.retryConfiguration : undefined, listMonitoredInstancesRequest.retryConfiguration, specRetryConfiguration);
            if (this.logger)
                retrier.logger = this.logger;
            const request = yield oci_common_1.composeRequest({
                baseEndpoint: this._endpoint,
    ...
    listWorkRequestErrors(listWorkRequestErrorsRequest) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const apiReferenceLink = "https://docs.oracle.com/iaas/api/#/en/resource-discovery-monitoring-control-api/20210330/WorkRequestError/ListWorkRequestErrors";
            const pathParams = {
    ...
    listWorkRequestLogs(listWorkRequestLogsRequest) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const apiReferenceLink = "https://docs.oracle.com/iaas/api/#/en/resource-discovery-monitoring-control-api/20210330/WorkRequestLogEntry/ListWorkRequestLogs";
            const pathParams = {
    ...
    listWorkRequests(listWorkRequestsRequest) {
        return __awaiter(this, void 0, void 0, function* () {
            if (this.logger)
                this.logger.debug("Calling operation AppmgmtControlClient#listWorkRequests.");
            const operationName = "listWorkRequests";
            const apiReferenceLink = "https://docs.oracle.com/iaas/api/#/en/resource-discovery-monitoring-control-api/20210330/WorkRequest/ListWorkRequests";
            const pathParams = {};
            const queryParams = {
     ...
     */
    publishTopProcessesMetrics(publishTopProcessesMetricsRequest) {
        return __awaiter(this, void 0, void 0, function* () {
            if (this.logger)
            ...
            const apiReferenceLink = "https://docs.oracle.com/iaas/api/#/en/resource-discovery-monitoring-control-api/20210330/MonitoredInstance/PublishTopProcessesMetrics";
            const pathParams = {
            ...
            const specRetryConfiguration = common.NoRetryConfigurationDetails;
            const retrier = oci_common_1.GenericRetrier.createPreferredRetrier(this._clientConfiguration ? this._clientConfiguration.retryConfiguration : undefined, publishTopProcessesMetricsRequest.retryConfiguration, specRetryConfiguration);
            if (this.logger)
                retrier.logger = this.logger;
            const request = yield oci_common_1.composeRequest({
                baseEndpoint: this._endpoint,
...
exports.AppmgmtControlClient = AppmgmtControlClient;
AppmgmtControlClient.serviceEndpointTemplate = "https://cp.appmgmt.{region}.oci.{secondLevelDomain}";

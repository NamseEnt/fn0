...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/ocvp/ListByolAllocations.ts.html |here} to see how to use ListByolAllocationsRequest.
 */
export interface ListByolAllocationsRequest extends common.BaseRequest {
    /**
     ...
     *
     */
    "sortBy"?: ListByolAllocationsRequest.SortBy;
    /**
...
export declare namespace ListByolAllocationsRequest {
    enum SortBy {

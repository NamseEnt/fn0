...
export declare class ClusterWaiter {
    private client;
    private readonly config?;
    constructor(client: ClusterClient, config?: Partial<import("oci-common/lib/waiter").WaiterConfigurationDetails> | undefined);
    /**
     ...
     */
    forCluster(request: serviceRequests.GetClusterRequest, ...targetStates: models.LifecycleStates[]): Promise<serviceResponses.GetClusterResponse | null>;
}

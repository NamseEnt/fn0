...
export declare class EsxiHostWaiter {
    private client;
    private readonly config?;
    constructor(client: EsxiHostClient, config?: Partial<import("oci-common/lib/waiter").WaiterConfigurationDetails> | undefined);
    /**
     ...
     */
    forEsxiHost(request: serviceRequests.GetEsxiHostRequest, ...targetStates: models.LifecycleStates[]): Promise<serviceResponses.GetEsxiHostResponse | null>;
}

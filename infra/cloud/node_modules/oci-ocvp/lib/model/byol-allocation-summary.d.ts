 ...
 *
 */
export interface ByolAllocationSummary {
    /**
...
export declare namespace ByolAllocationSummary {
    function getJsonObj(obj: ByolAllocationSummary): object;
    function getDeserializedJsonObj(obj: ByolAllocationSummary): object;
}

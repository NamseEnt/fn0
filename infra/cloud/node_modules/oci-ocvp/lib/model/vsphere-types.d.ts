 ...
 **/
export declare enum VsphereTypes {
...
export declare namespace VsphereTypes {
    function getJsonObj(obj: VsphereTypes): VsphereTypes;
    function getDeserializedJsonObj(obj: VsphereTypes): VsphereTypes;
}

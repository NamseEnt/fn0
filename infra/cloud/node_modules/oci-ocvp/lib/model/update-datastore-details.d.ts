 ...
 */
export interface UpdateDatastoreDetails {
    /**
...
export declare namespace UpdateDatastoreDetails {
    function getJsonObj(obj: UpdateDatastoreDetails): object;
    function getDeserializedJsonObj(obj: UpdateDatastoreDetails): object;
}

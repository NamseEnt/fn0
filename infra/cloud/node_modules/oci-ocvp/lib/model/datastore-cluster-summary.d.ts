...
*
*/
export interface DatastoreClusterSummary {
    /**
...
export declare namespace DatastoreClusterSummary {
    function getJsonObj(obj: DatastoreClusterSummary): object;
    function getDeserializedJsonObj(obj: DatastoreClusterSummary): object;
}

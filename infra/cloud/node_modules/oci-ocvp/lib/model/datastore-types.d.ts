 ...
 **/
export declare enum DatastoreTypes {
...
export declare namespace DatastoreTypes {
    function getJsonObj(obj: DatastoreTypes): DatastoreTypes;
    function getDeserializedJsonObj(obj: DatastoreTypes): DatastoreTypes;
}

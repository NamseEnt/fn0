 ...
 */
export interface SddcPassword {
    /**
     * SDDC password type.
     */
    "passwordType": model.PasswordTypes;
    /**
     * SDDC vCenter/NSX/HCX password context.
     */
    "value": string;
}
export declare namespace SddcPassword {
    function getJsonObj(obj: SddcPassword): object;
    function getDeserializedJsonObj(obj: SddcPassword): object;
}

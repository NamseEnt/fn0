...
export declare namespace ReplaceHostDetails {
    function getJsonObj(obj: ReplaceHostDetails): object;
    function getDeserializedJsonObj(obj: ReplaceHostDetails): object;
}

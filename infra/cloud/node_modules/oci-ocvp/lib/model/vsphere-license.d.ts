 ...
 *
 */
export interface VsphereLicense {
    /**
...
export declare namespace VsphereLicense {
    function getJsonObj(obj: VsphereLicense): object;
    function getDeserializedJsonObj(obj: VsphereLicense): object;
}

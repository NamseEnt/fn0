 ...
 *
 */
export interface SupportedEsxiSoftwareVersionSummary {
    /**
     ...
     */
    "supportedHostShapeNames": Array<string>;
}
export declare namespace SupportedEsxiSoftwareVersionSummary {
    function getJsonObj(obj: SupportedEsxiSoftwareVersionSummary): object;
    function getDeserializedJsonObj(obj: SupportedEsxiSoftwareVersionSummary): object;
}

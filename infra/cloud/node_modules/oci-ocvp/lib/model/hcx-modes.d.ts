...
export declare namespace HcxModes {
    function getJsonObj(obj: HcxModes): HcxModes;
    function getDeserializedJsonObj(obj: HcxModes): HcxModes;
}

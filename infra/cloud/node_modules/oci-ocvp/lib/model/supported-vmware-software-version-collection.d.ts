...
export declare namespace SupportedVmwareSoftwareVersionCollection {
    function getJsonObj(obj: SupportedVmwareSoftwareVersionCollection): object;
    function getDeserializedJsonObj(obj: SupportedVmwareSoftwareVersionCollection): object;
}

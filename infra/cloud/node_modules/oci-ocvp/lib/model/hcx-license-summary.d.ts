...
export declare namespace HcxLicenseSummary {
    function getJsonObj(obj: HcxLicenseSummary): object;
    function getDeserializedJsonObj(obj: HcxLicenseSummary): object;
}

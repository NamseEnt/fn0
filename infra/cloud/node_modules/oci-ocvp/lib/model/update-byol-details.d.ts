...
export declare namespace UpdateByolDetails {
    function getJsonObj(obj: UpdateByolDetails): object;
    function getDeserializedJsonObj(obj: UpdateByolDetails): object;
}

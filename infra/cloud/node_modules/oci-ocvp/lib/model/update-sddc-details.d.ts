...
export declare namespace UpdateSddcDetails {
    function getJsonObj(obj: UpdateSddcDetails): object;
    function getDeserializedJsonObj(obj: UpdateSddcDetails): object;
}

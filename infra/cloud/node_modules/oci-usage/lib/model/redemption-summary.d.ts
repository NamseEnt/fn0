...
export declare namespace RedemptionSummary {
    function getJsonObj(obj: RedemptionSummary): object;
    function getDeserializedJsonObj(obj: RedemptionSummary): object;
}

...
export declare namespace RedemptionCollection {
    function getJsonObj(obj: RedemptionCollection): object;
    function getDeserializedJsonObj(obj: RedemptionCollection): object;
}

...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/usage/ListRedemptions.ts.html |here} to see how to use ListRedemptionsRequest.
 */
...
export declare namespace ListRedemptionsRequest {
    enum SortOrder {
        Asc = "ASC",
        Desc = "DESC"
    }

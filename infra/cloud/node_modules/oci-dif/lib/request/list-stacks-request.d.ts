...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/dif/ListStacks.ts.html |here} to see how to use ListStacksRequest.
 */
...
export declare namespace ListStacksRequest {
    enum SortBy {

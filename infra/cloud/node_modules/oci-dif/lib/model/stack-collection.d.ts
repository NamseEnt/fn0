...
export interface StackCollection {
     ...
     * List of Stacks.
     */
    "items": Array<model.StackSummary>;
}
export declare namespace StackCollection {
    function getJsonObj(obj: StackCollection): object;
    function getDeserializedJsonObj(obj: StackCollection): object;
}

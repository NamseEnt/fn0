...
export declare namespace DbCredentialsDetail {
    function getJsonObj(obj: DbCredentialsDetail): object;
    function getDeserializedJsonObj(obj: DbCredentialsDetail): object;
}

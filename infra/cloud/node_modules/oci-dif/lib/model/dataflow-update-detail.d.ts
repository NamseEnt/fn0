 ...
 */
export interface DataflowUpdateDetail {
    /**
    ...
    "connections"?: model.UpdateDataflowConnections;
    /**
...
export declare namespace DataflowUpdateDetail {
    function getJsonObj(obj: DataflowUpdateDetail): object;
    function getDeserializedJsonObj(obj: DataflowUpdateDetail): object;
}

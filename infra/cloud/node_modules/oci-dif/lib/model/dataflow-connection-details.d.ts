...
export declare namespace DataflowConnectionDetails {
    function getJsonObj(obj: DataflowConnectionDetails): object;
    function getDeserializedJsonObj(obj: DataflowConnectionDetails): object;
}

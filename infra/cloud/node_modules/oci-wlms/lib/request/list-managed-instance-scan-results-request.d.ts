...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/wlms/ListManagedInstanceScanResults.ts.html |here} to see how to use ListManagedInstanceScanResultsRequest.
 */
export interface ListManagedInstanceScanResultsRequest extends common.BaseRequest {
    /**
...
export declare namespace ListManagedInstanceScanResultsRequest {
    enum SortOrder {
        Asc = "ASC",
        Desc = "DESC"
    }

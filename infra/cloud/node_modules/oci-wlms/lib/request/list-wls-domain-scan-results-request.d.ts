...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/wlms/ListWlsDomainScanResults.ts.html |here} to see how to use ListWlsDomainScanResultsRequest.
 */
export interface ListWlsDomainScanResultsRequest extends common.BaseRequest {
    /**
...
export declare namespace ListWlsDomainScanResultsRequest {
    enum SortOrder {
        Asc = "ASC",
        Desc = "DESC"
    }

...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/wlms/ListWlsDomainServers.ts.html |here} to see how to use ListWlsDomainServersRequest.
 */
export interface ListWlsDomainServersRequest extends common.BaseRequest {
    /**
...
export declare namespace ListWlsDomainServersRequest {
    enum SortOrder {
        Asc = "ASC",
        Desc = "DESC"
    }

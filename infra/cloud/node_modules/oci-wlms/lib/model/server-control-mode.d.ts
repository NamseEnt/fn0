 ...
 **/
export declare enum ServerControlMode {
...
export declare namespace ServerControlMode {
    function getJsonObj(obj: ServerControlMode): ServerControlMode;
    function getDeserializedJsonObj(obj: ServerControlMode): ServerControlMode;
}

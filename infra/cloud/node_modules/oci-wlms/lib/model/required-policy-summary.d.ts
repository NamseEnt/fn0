...
export declare namespace RequiredPolicySummary {
    function getJsonObj(obj: RequiredPolicySummary): object;
    function getDeserializedJsonObj(obj: RequiredPolicySummary): object;
}

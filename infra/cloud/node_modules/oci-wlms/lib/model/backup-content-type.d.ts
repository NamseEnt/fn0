 ...
 *
 **/
export declare enum BackupContentType {
    Binary = "BINARY",
    /**
...
export declare namespace BackupContentType {
    function getJsonObj(obj: BackupContentType): BackupContentType;
    function getDeserializedJsonObj(obj: BackupContentType): BackupContentType;
}

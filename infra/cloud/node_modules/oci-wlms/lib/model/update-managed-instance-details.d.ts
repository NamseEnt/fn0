...
export interface UpdateManagedInstanceDetails {
    "configuration"?: model.UpdateManagedInstanceConfigurationDetails;
}
export declare namespace UpdateManagedInstanceDetails {
    function getJsonObj(obj: UpdateManagedInstanceDetails): object;
    function getDeserializedJsonObj(obj: UpdateManagedInstanceDetails): object;
}

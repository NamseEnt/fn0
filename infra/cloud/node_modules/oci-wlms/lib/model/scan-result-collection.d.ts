 ...
 *
 */
export interface ScanResultCollection {
    /**
     * List of scan results.
     */
    "items": Array<model.ScanResultSummary>;
}
export declare namespace ScanResultCollection {
    function getJsonObj(obj: ScanResultCollection): object;
    function getDeserializedJsonObj(obj: ScanResultCollection): object;
}

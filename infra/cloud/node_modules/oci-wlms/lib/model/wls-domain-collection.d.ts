 ...
 *
 */
export interface WlsDomainCollection {
    /**
     * List of WebLogic domains.
     */
    "items": Array<model.WlsDomainSummary>;
}
export declare namespace WlsDomainCollection {
    function getJsonObj(obj: WlsDomainCollection): object;
    function getDeserializedJsonObj(obj: WlsDomainCollection): object;
}

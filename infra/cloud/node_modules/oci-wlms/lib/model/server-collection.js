...
(function (ServerCollection) {
    function getJsonObj(obj) {
        const jsonObj = Object.assign(Object.assign({}, obj), {
            "items": obj.items
                ? obj.items.map(item => {
                    return model.ServerSummary.getJsonObj(item);
                })
                : undefined
        });
        return jsonObj;
    }
    ServerCollection.getJsonObj = getJsonObj;
    function getDeserializedJsonObj(obj) {
        const jsonObj = Object.assign(Object.assign({}, obj), {
            "items": obj.items
                ? obj.items.map(item => {
                    return model.ServerSummary.getDeserializedJsonObj(item);
                })
                : undefined
        });
        return jsonObj;
    }
    ServerCollection.getDeserializedJsonObj = getDeserializedJsonObj;
})(ServerCollection = exports.ServerCollection || (exports.ServerCollection = {}));

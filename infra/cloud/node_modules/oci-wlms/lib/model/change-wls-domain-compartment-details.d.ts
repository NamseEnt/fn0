 ...
 *
 */
export interface ChangeWlsDomainCompartmentDetails {
    /**
...
export declare namespace ChangeWlsDomainCompartmentDetails {
    function getJsonObj(obj: ChangeWlsDomainCompartmentDetails): object;
    function getDeserializedJsonObj(obj: ChangeWlsDomainCompartmentDetails): object;
}

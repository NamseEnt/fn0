...
export declare namespace ScanResultSummary {
    ...
    function getJsonObj(obj: ScanResultSummary): object;
    function getDeserializedJsonObj(obj: ScanResultSummary): object;
}

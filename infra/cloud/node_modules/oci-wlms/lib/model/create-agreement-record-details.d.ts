 ...
 *
 */
export interface CreateAgreementRecordDetails {
    /**
...
export declare namespace CreateAgreementRecordDetails {
    function getJsonObj(obj: CreateAgreementRecordDetails): object;
    function getDeserializedJsonObj(obj: CreateAgreementRecordDetails): object;
}

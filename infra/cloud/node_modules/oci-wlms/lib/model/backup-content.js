...
(function (BackupContent) {
    function getJsonObj(obj) {
        ...
        if (obj && "contentType" in obj && obj.contentType) {
            switch (obj.contentType) {
                case "BINARY":
                    return model.BinaryBackupContent.getJsonObj(jsonObj, true);
                default:
    ...
    BackupContent.getJsonObj = getJsonObj;
    function getDeserializedJsonObj(obj) {
        const jsonObj = Object.assign(Object.assign({}, obj), {});
        if (obj && "contentType" in obj && obj.contentType) {
            switch (obj.contentType) {
                case "BINARY":
                    return model.BinaryBackupContent.getDeserializedJsonObj(jsonObj, true);
                default:
                    if (common.LOG.logger)
                        common.LOG.logger.info(`Unknown value for: ${obj.contentType}`);
            }
    ...
    BackupContent.getDeserializedJsonObj = getDeserializedJsonObj;
})(BackupContent = exports.BackupContent || (exports.BackupContent = {}));
//# sourceMappingURL=backup-content.js.map
...
export declare namespace OnPremiseVantagePoint {
    enum Type {
    ...
    function getJsonObj(obj: OnPremiseVantagePoint): object;
    function getDeserializedJsonObj(obj: OnPremiseVantagePoint): object;
}

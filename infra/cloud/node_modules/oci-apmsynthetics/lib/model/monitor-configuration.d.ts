...
export declare namespace MonitorConfiguration {
    function getJsonObj(obj: MonitorConfiguration): object;
    function getDeserializedJsonObj(obj: MonitorConfiguration): object;
}

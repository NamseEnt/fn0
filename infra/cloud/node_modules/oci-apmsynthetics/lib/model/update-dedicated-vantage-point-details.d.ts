 ...
 */
export interface UpdateDedicatedVantagePointDetails {
    /**
...
export declare namespace UpdateDedicatedVantagePointDetails {
    function getJsonObj(obj: UpdateDedicatedVantagePointDetails): object;
    function getDeserializedJsonObj(obj: UpdateDedicatedVantagePointDetails): object;
}

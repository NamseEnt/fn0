...
export declare namespace OracleRMStack {
    function getJsonObj(obj: OracleRMStack, isParentJsonObj?: boolean): object;
    const dvpStackType = "ORACLE_RM_STACK";
    function getDeserializedJsonObj(obj: OracleRMStack, isParentJsonObj?: boolean): object;
}

...
export declare namespace OnPremiseVantagePointCollection {
    function getJsonObj(obj: OnPremiseVantagePointCollection): object;
    function getDeserializedJsonObj(obj: OnPremiseVantagePointCollection): object;
}

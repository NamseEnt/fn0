...
export declare namespace RequestQueryParam {
    function getJsonObj(obj: RequestQueryParam): object;
    function getDeserializedJsonObj(obj: RequestQueryParam): object;
}

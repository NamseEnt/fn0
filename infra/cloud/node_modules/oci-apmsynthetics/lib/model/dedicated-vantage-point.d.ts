...
export declare namespace DedicatedVantagePoint {
    function getJsonObj(obj: DedicatedVantagePoint): object;
    function getDeserializedJsonObj(obj: DedicatedVantagePoint): object;
}

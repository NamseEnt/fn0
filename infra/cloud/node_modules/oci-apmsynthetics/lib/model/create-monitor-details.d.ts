...
export interface CreateMonitorDetails {
    ...
    "configuration"?: model.FtpMonitorConfiguration | model.DnsSecMonitorConfiguration | model.DnsTraceMonitorConfiguration | model.SqlMonitorConfiguration | model.ScriptedRestMonitorConfiguration | model.DnsServerMonitorConfiguration | model.ScriptedBrowserMonitorConfiguration | model.RestMonitorConfiguration | model.BrowserMonitorConfiguration | model.NetworkMonitorConfiguration;
...
export declare namespace CreateMonitorDetails {
    function getJsonObj(obj: CreateMonitorDetails): object;
    function getDeserializedJsonObj(obj: CreateMonitorDetails): object;
}

...
export declare namespace CreateDedicatedVantagePointDetails {
    function getJsonObj(obj: CreateDedicatedVantagePointDetails): object;
    function getDeserializedJsonObj(obj: CreateDedicatedVantagePointDetails): object;
}

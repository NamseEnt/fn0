...
export declare namespace VantagePointExecution {
    function getJsonObj(obj: VantagePointExecution): object;
    function getDeserializedJsonObj(obj: VantagePointExecution): object;
}

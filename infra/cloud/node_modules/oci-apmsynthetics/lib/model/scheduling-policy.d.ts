...
export declare namespace SchedulingPolicy {
    function getJsonObj(obj: SchedulingPolicy): SchedulingPolicy;
    function getDeserializedJsonObj(obj: SchedulingPolicy): SchedulingPolicy;
}

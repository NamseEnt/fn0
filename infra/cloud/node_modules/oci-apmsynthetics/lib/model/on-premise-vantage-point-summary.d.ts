...
export declare namespace OnPremiseVantagePointSummary {
    enum Type {
    ...
    function getJsonObj(obj: OnPremiseVantagePointSummary): object;
    function getDeserializedJsonObj(obj: OnPremiseVantagePointSummary): object;
}

 ...
 */
export interface WorkerMonitorList {
    /**
...
export declare namespace WorkerMonitorList {
    function getJsonObj(obj: WorkerMonitorList): object;
    function getDeserializedJsonObj(obj: WorkerMonitorList): object;
}

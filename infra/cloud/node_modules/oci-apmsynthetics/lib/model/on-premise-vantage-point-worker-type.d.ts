 ...
 **/
export declare enum OnPremiseVantagePointWorkerType {
    Docker = "DOCKER",
    /**
...
export declare namespace OnPremiseVantagePointWorkerType {
    function getJsonObj(obj: OnPremiseVantagePointWorkerType): OnPremiseVantagePointWorkerType;
    function getDeserializedJsonObj(obj: OnPremiseVantagePointWorkerType): OnPremiseVantagePointWorkerType;
}

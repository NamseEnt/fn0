...
export declare namespace DnsRecordType {
    function getJsonObj(obj: DnsRecordType): DnsRecordType;
    function getDeserializedJsonObj(obj: DnsRecordType): DnsRecordType;
}

...
export declare namespace UpdateScriptDetails {
    function getJsonObj(obj: UpdateScriptDetails): object;
    function getDeserializedJsonObj(obj: UpdateScriptDetails): object;
}

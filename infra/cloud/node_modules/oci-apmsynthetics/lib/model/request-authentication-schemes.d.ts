 ...
 **/
export declare enum RequestAuthenticationSchemes {
    Oauth = "OAUTH",
    None = "NONE",
    Basic = "BASIC",
    Bearer = "BEARER",
...
export declare namespace RequestAuthenticationSchemes {
    function getJsonObj(obj: RequestAuthenticationSchemes): RequestAuthenticationSchemes;
    function getDeserializedJsonObj(obj: RequestAuthenticationSchemes): RequestAuthenticationSchemes;
}

...
(function (Password) {
    function getJsonObj(obj) {
        ...
        if (obj && "passwordType" in obj && obj.passwordType) {
            switch (obj.passwordType) {
                case "IN_TEXT":
                    return model.PasswordInText.getJsonObj(jsonObj, true);
                case "VAULT_SECRET_ID":
                    return model.PasswordInVault.getJsonObj(jsonObj, true);
                default:
    ...
    Password.getJsonObj = getJsonObj;
    function getDeserializedJsonObj(obj) {
        const jsonObj = Object.assign(Object.assign({}, obj), {});
        if (obj && "passwordType" in obj && obj.passwordType) {
            switch (obj.passwordType) {
                case "IN_TEXT":
                    return model.PasswordInText.getDeserializedJsonObj(jsonObj, true);
                case "VAULT_SECRET_ID":
                    return model.PasswordInVault.getDeserializedJsonObj(jsonObj, true);
                default:
                    if (common.LOG.logger)
                        common.LOG.logger.info(`Unknown value for: ${obj.passwordType}`);
            }
    ...
    Password.getDeserializedJsonObj = getDeserializedJsonObj;

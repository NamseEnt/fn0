...
export declare namespace ClientCertificateDetails {
    function getJsonObj(obj: ClientCertificateDetails): object;
    function getDeserializedJsonObj(obj: ClientCertificateDetails): object;
}

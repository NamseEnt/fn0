 ...
 */
export interface OnPremiseVpWorkerVersionDetails {
    /**
...
export declare namespace OnPremiseVpWorkerVersionDetails {
    function getJsonObj(obj: OnPremiseVpWorkerVersionDetails): object;
    function getDeserializedJsonObj(obj: OnPremiseVpWorkerVersionDetails): object;
}

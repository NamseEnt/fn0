...
export declare namespace ProbeMode {
    function getJsonObj(obj: ProbeMode): ProbeMode;
    function getDeserializedJsonObj(obj: ProbeMode): ProbeMode;
}

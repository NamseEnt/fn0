...
export declare namespace DnsTraceMonitorConfiguration {
    function getJsonObj(obj: DnsTraceMonitorConfiguration, isParentJsonObj?: boolean): object;
    const configType = "DNS_TRACE_CONFIG";
    function getDeserializedJsonObj(obj: DnsTraceMonitorConfiguration, isParentJsonObj?: boolean): object;
}

 ...
 **/
export declare enum DnsTransportProtocol {
    Tcp = "TCP",
    Udp = "UDP",
    /**
...
export declare namespace DnsTransportProtocol {
    function getJsonObj(obj: DnsTransportProtocol): DnsTransportProtocol;
    function getDeserializedJsonObj(obj: DnsTransportProtocol): DnsTransportProtocol;
}

...
export declare namespace SqlMonitorConfiguration {
    function getJsonObj(obj: SqlMonitorConfiguration, isParentJsonObj?: boolean): object;
    const configType = "SQL_CONFIG";
    function getDeserializedJsonObj(obj: SqlMonitorConfiguration, isParentJsonObj?: boolean): object;
}

 ...
 */
export interface VerifyText {
    /**
     * Verification text in the response.
     */
    "text"?: string;
}
export declare namespace VerifyText {
    function getJsonObj(obj: VerifyText): object;
    function getDeserializedJsonObj(obj: VerifyText): object;
}

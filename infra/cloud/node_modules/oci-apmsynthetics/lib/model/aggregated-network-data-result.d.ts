 ...
 */
export interface AggregatedNetworkDataResult {
    "aggregatedNetworkData": model.AggregatedNetworkData;
}
export declare namespace AggregatedNetworkDataResult {
    function getJsonObj(obj: AggregatedNetworkDataResult): object;
    function getDeserializedJsonObj(obj: AggregatedNetworkDataResult): object;
}

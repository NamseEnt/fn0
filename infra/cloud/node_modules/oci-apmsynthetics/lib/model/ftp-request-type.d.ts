 ...
 **/
export declare enum FtpRequestType {
    List = "LIST",
    Upload = "UPLOAD",
    Download = "DOWNLOAD",
    /**
...
export declare namespace FtpRequestType {
    function getJsonObj(obj: FtpRequestType): FtpRequestType;
    function getDeserializedJsonObj(obj: FtpRequestType): FtpRequestType;
}

 ...
 **/
export declare enum OAuthSchemes {
    None = "NONE",
    Basic = "BASIC",
    /**
...
export declare namespace OAuthSchemes {
    function getJsonObj(obj: OAuthSchemes): OAuthSchemes;
    function getDeserializedJsonObj(obj: OAuthSchemes): OAuthSchemes;
}

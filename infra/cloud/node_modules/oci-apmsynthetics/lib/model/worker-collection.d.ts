...
export interface WorkerCollection {
     ...
     */
    "items": Array<model.WorkerSummary>;
}
export declare namespace WorkerCollection {
    function getJsonObj(obj: WorkerCollection): object;
    function getDeserializedJsonObj(obj: WorkerCollection): object;
}

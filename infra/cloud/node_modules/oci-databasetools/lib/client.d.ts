...
export declare class DatabaseToolsClient {
     ...
     */
    refreshDatabaseToolsIdentityCredential(refreshDatabaseToolsIdentityCredentialRequest: requests.RefreshDatabaseToolsIdentityCredentialRequest): Promise<responses.RefreshDatabaseToolsIdentityCredentialResponse>;
    /**
     ...
     */
    validateDatabaseToolsIdentityCredential(validateDatabaseToolsIdentityCredentialRequest: requests.ValidateDatabaseToolsIdentityCredentialRequest): Promise<responses.ValidateDatabaseToolsIdentityCredentialResponse>;
}
export {};

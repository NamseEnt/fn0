...
export declare namespace DatabaseToolsKeyStoreContentSecretId {
    function getJsonObj(obj: DatabaseToolsKeyStoreContentSecretId, isParentJsonObj?: boolean): object;
    const valueType = "SECRETID";
    function getDeserializedJsonObj(obj: DatabaseToolsKeyStoreContentSecretId, isParentJsonObj?: boolean): object;
}

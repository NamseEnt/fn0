...
export declare namespace ValidateDatabaseToolsConnectionMySqlResult {
    function getJsonObj(obj: ValidateDatabaseToolsConnectionMySqlResult, isParentJsonObj?: boolean): object;
    const type = "MYSQL";
    function getDeserializedJsonObj(obj: ValidateDatabaseToolsConnectionMySqlResult, isParentJsonObj?: boolean): object;
}

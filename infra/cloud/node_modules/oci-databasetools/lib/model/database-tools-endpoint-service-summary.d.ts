...
export declare namespace DatabaseToolsEndpointServiceSummary {
    function getJsonObj(obj: DatabaseToolsEndpointServiceSummary): object;
    function getDeserializedJsonObj(obj: DatabaseToolsEndpointServiceSummary): object;
}

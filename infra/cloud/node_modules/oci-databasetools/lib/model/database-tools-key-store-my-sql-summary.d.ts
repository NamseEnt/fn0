...
export declare namespace DatabaseToolsKeyStoreMySqlSummary {
    function getJsonObj(obj: DatabaseToolsKeyStoreMySqlSummary): object;
    function getDeserializedJsonObj(obj: DatabaseToolsKeyStoreMySqlSummary): object;
}

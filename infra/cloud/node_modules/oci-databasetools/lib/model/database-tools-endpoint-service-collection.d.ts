...
export declare namespace DatabaseToolsEndpointServiceCollection {
    function getJsonObj(obj: DatabaseToolsEndpointServiceCollection): object;
    function getDeserializedJsonObj(obj: DatabaseToolsEndpointServiceCollection): object;
}

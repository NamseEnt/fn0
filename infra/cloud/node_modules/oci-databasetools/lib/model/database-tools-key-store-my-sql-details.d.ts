...
export declare namespace DatabaseToolsKeyStoreMySqlDetails {
    function getJsonObj(obj: DatabaseToolsKeyStoreMySqlDetails): object;
    function getDeserializedJsonObj(obj: DatabaseToolsKeyStoreMySqlDetails): object;
}

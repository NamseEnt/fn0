 ...
 */
export interface DatabaseToolsConnectionPostgresqlSummary extends model.DatabaseToolsConnectionSummary {
...
export declare namespace DatabaseToolsConnectionPostgresqlSummary {
    function getJsonObj(obj: DatabaseToolsConnectionPostgresqlSummary, isParentJsonObj?: boolean): object;
    const type = "POSTGRESQL";
    function getDeserializedJsonObj(obj: DatabaseToolsConnectionPostgresqlSummary, isParentJsonObj?: boolean): object;
}

...
export declare namespace FusionEnvironmentFamilyLimitsAndUsage {
    function getJsonObj(obj: FusionEnvironmentFamilyLimitsAndUsage): object;
    function getDeserializedJsonObj(obj: FusionEnvironmentFamilyLimitsAndUsage): object;
}

...
export declare namespace MaintenancePolicy {
    enum MonthlyPatchingOverride {
        Enabled = "ENABLED",
        Disabled = "DISABLED",
        None = "NONE",
        /**
    ...
    enum EnvironmentMaintenanceOverride {
        Prod = "PROD",
        NonProd = "NON_PROD",
        None = "NONE",
        /**
    ...
    function getJsonObj(obj: MaintenancePolicy): object;
    function getDeserializedJsonObj(obj: MaintenancePolicy): object;
}

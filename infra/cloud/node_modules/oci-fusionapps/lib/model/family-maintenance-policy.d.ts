...
export declare namespace FamilyMaintenancePolicy {
    enum ConcurrentMaintenance {
        Prod = "PROD",
        NonProd = "NON_PROD",
        Disabled = "DISABLED",
        /**
    ...
    function getJsonObj(obj: FamilyMaintenancePolicy): object;
    function getDeserializedJsonObj(obj: FamilyMaintenancePolicy): object;
}

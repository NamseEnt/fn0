...
export declare namespace CreateFusionEnvironmentAdminUserDetails {
    function getJsonObj(obj: CreateFusionEnvironmentAdminUserDetails): object;
    function getDeserializedJsonObj(obj: CreateFusionEnvironmentAdminUserDetails): object;
}

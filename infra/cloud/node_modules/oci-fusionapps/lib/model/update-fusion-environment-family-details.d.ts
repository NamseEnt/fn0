...
export declare namespace UpdateFusionEnvironmentFamilyDetails {
    function getJsonObj(obj: UpdateFusionEnvironmentFamilyDetails): object;
    function getDeserializedJsonObj(obj: UpdateFusionEnvironmentFamilyDetails): object;
}

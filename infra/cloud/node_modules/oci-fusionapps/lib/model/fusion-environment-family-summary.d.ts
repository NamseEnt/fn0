...
export declare namespace FusionEnvironmentFamilySummary {
    function getJsonObj(obj: FusionEnvironmentFamilySummary): object;
    function getDeserializedJsonObj(obj: FusionEnvironmentFamilySummary): object;
}

 ...
 */
export interface TimeAvailableForRefresh {
    /**
     * refresh time.
     */
    "timeAvailableForRefresh": Date;
}
export declare namespace TimeAvailableForRefresh {
    function getJsonObj(obj: TimeAvailableForRefresh): object;
    function getDeserializedJsonObj(obj: TimeAvailableForRefresh): object;
}

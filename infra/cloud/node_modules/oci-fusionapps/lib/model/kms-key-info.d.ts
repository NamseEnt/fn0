...
export declare namespace KmsKeyInfo {
    enum ScheduledKeyStatus {
        Scheduling = "SCHEDULING",
        Updating = "UPDATING",
        Failed = "FAILED",
        None = "NONE"
    }
    function getJsonObj(obj: KmsKeyInfo): object;
    function getDeserializedJsonObj(obj: KmsKeyInfo): object;
}

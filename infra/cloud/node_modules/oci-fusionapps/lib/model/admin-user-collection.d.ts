...
export interface AdminUserCollection {
     ...
     */
    "items": Array<model.AdminUserSummary>;
}
export declare namespace AdminUserCollection {
    function getJsonObj(obj: AdminUserCollection): object;
    function getDeserializedJsonObj(obj: AdminUserCollection): object;
}

...
export declare namespace DataMaskingActivityCollection {
    function getJsonObj(obj: DataMaskingActivityCollection): object;
    function getDeserializedJsonObj(obj: DataMaskingActivityCollection): object;
}

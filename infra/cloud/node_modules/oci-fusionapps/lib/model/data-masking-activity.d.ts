...
export declare namespace DataMaskingActivity {
    enum LifecycleState {
        Accepted = "ACCEPTED",
    ...
    function getJsonObj(obj: DataMaskingActivity): object;
    function getDeserializedJsonObj(obj: DataMaskingActivity): object;
}

...
export declare namespace UpgradeAction {
    function getJsonObj(obj: UpgradeAction, isParentJsonObj?: boolean): object;
    const actionType = "QUARTERLY_UPGRADE";
    function getDeserializedJsonObj(obj: UpgradeAction, isParentJsonObj?: boolean): object;
}

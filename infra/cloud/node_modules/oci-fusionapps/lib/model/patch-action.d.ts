...
export declare namespace PatchAction {
    enum Mode {
        Hot = "HOT",
        Cold = "COLD",
        /**
    ...
    function getJsonObj(obj: PatchAction, isParentJsonObj?: boolean): object;
    const actionType = "PATCH";
    function getDeserializedJsonObj(obj: PatchAction, isParentJsonObj?: boolean): object;
}

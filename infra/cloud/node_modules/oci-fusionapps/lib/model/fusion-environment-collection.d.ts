 ...
 */
export interface FusionEnvironmentCollection {
    /**
     * A page of FusionEnvironmentSummary objects.
     */
    "items": Array<model.FusionEnvironmentSummary>;
}
export declare namespace FusionEnvironmentCollection {
    function getJsonObj(obj: FusionEnvironmentCollection): object;
    function getDeserializedJsonObj(obj: FusionEnvironmentCollection): object;
}

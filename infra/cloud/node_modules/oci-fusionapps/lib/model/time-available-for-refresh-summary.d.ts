 ...
 */
export interface TimeAvailableForRefreshSummary {
    /**
     * refresh time.
     */
    "timeAvailableForRefresh": Date;
}
export declare namespace TimeAvailableForRefreshSummary {
    function getJsonObj(obj: TimeAvailableForRefreshSummary): object;
    function getDeserializedJsonObj(obj: TimeAvailableForRefreshSummary): object;
}

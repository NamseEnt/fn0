...
export declare namespace TimeAvailableForRefreshCollection {
    function getJsonObj(obj: TimeAvailableForRefreshCollection): object;
    function getDeserializedJsonObj(obj: TimeAvailableForRefreshCollection): object;
}

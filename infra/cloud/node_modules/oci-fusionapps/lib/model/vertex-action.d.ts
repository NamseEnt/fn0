...
export declare namespace VertexAction {
    function getJsonObj(obj: VertexAction, isParentJsonObj?: boolean): object;
    const actionType = "VERTEX";
    function getDeserializedJsonObj(obj: VertexAction, isParentJsonObj?: boolean): object;
}

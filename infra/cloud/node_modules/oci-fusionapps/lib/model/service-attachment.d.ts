...
export declare namespace ServiceAttachment {
    ...
    function getJsonObj(obj: ServiceAttachment): object;
    function getDeserializedJsonObj(obj: ServiceAttachment): object;
}

...
export declare namespace EnvironmentRole {
    ...
    function getJsonObj(obj: EnvironmentRole): object;
    function getDeserializedJsonObj(obj: EnvironmentRole): object;
}

 ...
 */
export interface RefreshActivityCollection {
    /**
     * A page of refresh activity objects.
     */
    "items": Array<model.RefreshActivitySummary>;
}
export declare namespace RefreshActivityCollection {
    function getJsonObj(obj: RefreshActivityCollection): object;
    function getDeserializedJsonObj(obj: RefreshActivityCollection): object;
}

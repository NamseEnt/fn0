...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/fusionapps/ListRefreshActivities.ts.html |here} to see how to use ListRefreshActivitiesRequest.
 */
...
export declare namespace ListRefreshActivitiesRequest {
    enum SortOrder {
        Asc = "ASC",
        Desc = "DESC"
    }

...
export declare namespace UpdateVmWareAssetSourceDetails {
    function getJsonObj(obj: UpdateVmWareAssetSourceDetails, isParentJsonObj?: boolean): object;
    const type = "VMWARE";
    function getDeserializedJsonObj(obj: UpdateVmWareAssetSourceDetails, isParentJsonObj?: boolean): object;
}

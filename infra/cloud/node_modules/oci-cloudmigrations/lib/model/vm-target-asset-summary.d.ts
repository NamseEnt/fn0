...
export declare namespace VmTargetAssetSummary {
    function getJsonObj(obj: VmTargetAssetSummary, isParentJsonObj?: boolean): object;
    const type = "INSTANCE";
    function getDeserializedJsonObj(obj: VmTargetAssetSummary, isParentJsonObj?: boolean): object;
}

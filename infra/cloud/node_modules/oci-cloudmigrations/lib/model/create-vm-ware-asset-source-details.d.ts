...
export declare namespace CreateVmWareAssetSourceDetails {
    function getJsonObj(obj: CreateVmWareAssetSourceDetails, isParentJsonObj?: boolean): object;
    const type = "VMWARE";
    function getDeserializedJsonObj(obj: CreateVmWareAssetSourceDetails, isParentJsonObj?: boolean): object;
}

...
export declare namespace LaunchInstanceAgentConfigDetails {
    function getJsonObj(obj: LaunchInstanceAgentConfigDetails): object;
    function getDeserializedJsonObj(obj: LaunchInstanceAgentConfigDetails): object;
}

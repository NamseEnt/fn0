...
export declare namespace AverageResourceAssessmentStrategy {
    function getJsonObj(obj: AverageResourceAssessmentStrategy, isParentJsonObj?: boolean): object;
    const strategyType = "AVERAGE";
    function getDeserializedJsonObj(obj: AverageResourceAssessmentStrategy, isParentJsonObj?: boolean): object;
}

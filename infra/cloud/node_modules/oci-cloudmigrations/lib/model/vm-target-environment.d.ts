...
export declare namespace VmTargetEnvironment {
    function getJsonObj(obj: VmTargetEnvironment, isParentJsonObj?: boolean): object;
    const targetEnvironmentType = "VM_TARGET_ENV";
    function getDeserializedJsonObj(obj: VmTargetEnvironment, isParentJsonObj?: boolean): object;
}

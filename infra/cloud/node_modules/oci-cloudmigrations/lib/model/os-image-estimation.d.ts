...
export declare namespace OsImageEstimation {
    function getJsonObj(obj: OsImageEstimation): object;
    function getDeserializedJsonObj(obj: OsImageEstimation): object;
}

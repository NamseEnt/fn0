 ...
 */
export interface OlvmBootMenu {
    /**
     * Whether the boot menu is enabled for this virtual machine (or template), or not.
     */
    "isEnabled"?: boolean;
}
export declare namespace OlvmBootMenu {
    function getJsonObj(obj: OlvmBootMenu): object;
    function getDeserializedJsonObj(obj: OlvmBootMenu): object;
}

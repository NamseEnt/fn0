...
export declare namespace PercentileResourceAssessmentStrategy {
    enum Percentile {
        P50 = "P50",
        P90 = "P90",
        P95 = "P95",
    ...
    function getJsonObj(obj: PercentileResourceAssessmentStrategy, isParentJsonObj?: boolean): object;
    const strategyType = "PERCENTILE";
    function getDeserializedJsonObj(obj: PercentileResourceAssessmentStrategy, isParentJsonObj?: boolean): object;
}

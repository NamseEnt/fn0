...
export declare namespace UpdateMigrationAssetDetails {
    function getJsonObj(obj: UpdateMigrationAssetDetails): object;
    function getDeserializedJsonObj(obj: UpdateMigrationAssetDetails): object;
}

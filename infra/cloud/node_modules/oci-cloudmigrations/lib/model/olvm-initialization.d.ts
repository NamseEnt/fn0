...
export declare namespace OlvmInitialization {
    enum CloudInitNetworkProtocol {
        Eni = "ENI",
        OpenstackMetadata = "OPENSTACK_METADATA"
    }
    function getJsonObj(obj: OlvmInitialization): object;
    function getDeserializedJsonObj(obj: OlvmInitialization): object;
}

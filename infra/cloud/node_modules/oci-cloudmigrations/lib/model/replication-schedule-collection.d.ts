...
export declare namespace ReplicationScheduleCollection {
    function getJsonObj(obj: ReplicationScheduleCollection): object;
    function getDeserializedJsonObj(obj: ReplicationScheduleCollection): object;
}

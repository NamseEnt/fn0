...
export declare namespace ReplicationSchedule {
    enum LifecycleState {
        Creating = "CREATING",
        Updating = "UPDATING",
    ...
    function getJsonObj(obj: ReplicationSchedule): object;
    function getDeserializedJsonObj(obj: ReplicationSchedule): object;
}

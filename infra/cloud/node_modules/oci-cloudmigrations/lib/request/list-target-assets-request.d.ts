...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/cloudmigrations/ListTargetAssets.ts.html |here} to see how to use ListTargetAssetsRequest.
 */
export interface ListTargetAssetsRequest extends common.BaseRequest {
    /**
...
export declare namespace ListTargetAssetsRequest {
    enum SortBy {

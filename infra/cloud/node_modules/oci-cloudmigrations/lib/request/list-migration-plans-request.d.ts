...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/cloudmigrations/ListMigrationPlans.ts.html |here} to see how to use ListMigrationPlansRequest.
 */
export interface ListMigrationPlansRequest extends common.BaseRequest {
    /**
...
export declare namespace ListMigrationPlansRequest {
    enum SortBy {

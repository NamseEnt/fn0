...
(function (PaymentDetail) {
    function getJsonObj(obj) {
        ...
        if (obj && "paymentMethod" in obj && obj.paymentMethod) {
            switch (obj.paymentMethod) {
                case "ECHECK":
                    return model.EcheckPaymentDetail.getJsonObj(jsonObj, true);
                case "OTHER":
                ...
                default:
                    if (common.LOG.logger)
                        common.LOG.logger.info(`Unknown value for: ${obj.paymentMethod}`);
            }
        }
        return jsonObj;
    }
    ...
    function getDeserializedJsonObj(obj) {
        ...
        if (obj && "paymentMethod" in obj && obj.paymentMethod) {
            switch (obj.paymentMethod) {
                case "ECHECK":
                    return model.EcheckPaymentDetail.getDeserializedJsonObj(jsonObj, true);
                case "OTHER":

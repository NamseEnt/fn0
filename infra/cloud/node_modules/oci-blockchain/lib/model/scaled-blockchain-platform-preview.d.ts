...
export declare namespace ScaledBlockchainPlatformPreview {
    function getJsonObj(obj: ScaledBlockchainPlatformPreview): object;
    function getDeserializedJsonObj(obj: ScaledBlockchainPlatformPreview): object;
}

...
export declare namespace WorkRequestResourceSubTypeDetail {
    enum SubTypeStatus {
        Created = "CREATED",
        Updated = "UPDATED",
        Deleted = "DELETED",
    ...
    function getJsonObj(obj: WorkRequestResourceSubTypeDetail): object;
    function getDeserializedJsonObj(obj: WorkRequestResourceSubTypeDetail): object;
}

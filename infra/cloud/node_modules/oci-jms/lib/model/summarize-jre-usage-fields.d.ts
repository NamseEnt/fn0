 ...
 **/
export declare enum SummarizeJreUsageFields {
...
export declare namespace SummarizeJreUsageFields {
    function getJsonObj(obj: SummarizeJreUsageFields): SummarizeJreUsageFields;
    function getDeserializedJsonObj(obj: SummarizeJreUsageFields): SummarizeJreUsageFields;
}

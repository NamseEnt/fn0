...
export declare namespace JavaFamilyCollection {
    function getJsonObj(obj: JavaFamilyCollection): object;
    function getDeserializedJsonObj(obj: JavaFamilyCollection): object;
}

...
export declare namespace FleetAgentConfiguration {
    function getJsonObj(obj: FleetAgentConfiguration): object;
    function getDeserializedJsonObj(obj: FleetAgentConfiguration): object;
}

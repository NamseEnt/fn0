...
export declare namespace LibraryManagedInstanceUsageSummary {
    function getJsonObj(obj: LibraryManagedInstanceUsageSummary): object;
    function getDeserializedJsonObj(obj: LibraryManagedInstanceUsageSummary): object;
}

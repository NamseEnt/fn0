...
export declare namespace DisableDrsDetails {
    function getJsonObj(obj: DisableDrsDetails): object;
    function getDeserializedJsonObj(obj: DisableDrsDetails): object;
}

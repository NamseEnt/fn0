...
export declare namespace JavaMigrationApplicationWorkItemDetails {
    function getJsonObj(obj: JavaMigrationApplicationWorkItemDetails, isParentJsonObj?: boolean): object;
    const kind = "JAVA_MIGRATION_APPLICATION";
    function getDeserializedJsonObj(obj: JavaMigrationApplicationWorkItemDetails, isParentJsonObj?: boolean): object;
}

 ...
 */
export interface JavaMigrationAnalysisResultSummary {
    /**
...
export declare namespace JavaMigrationAnalysisResultSummary {
    function getJsonObj(obj: JavaMigrationAnalysisResultSummary): object;
    function getDeserializedJsonObj(obj: JavaMigrationAnalysisResultSummary): object;
}

...
export declare namespace FleetAgentOsConfiguration {
    function getJsonObj(obj: FleetAgentOsConfiguration): object;
    function getDeserializedJsonObj(obj: FleetAgentOsConfiguration): object;
}

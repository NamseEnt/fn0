...
export declare namespace GenerateLoadPipelineScriptDetails {
    function getJsonObj(obj: GenerateLoadPipelineScriptDetails): object;
    function getDeserializedJsonObj(obj: GenerateLoadPipelineScriptDetails): object;
}

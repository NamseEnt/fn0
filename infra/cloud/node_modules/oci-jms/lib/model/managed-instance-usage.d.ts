...
export declare namespace ManagedInstanceUsage {
    function getJsonObj(obj: ManagedInstanceUsage): object;
    function getDeserializedJsonObj(obj: ManagedInstanceUsage): object;
}

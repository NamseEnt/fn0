...
export declare namespace FleetDiagnosisSummary {
    enum ResourceType {
    ...
    function getJsonObj(obj: FleetDiagnosisSummary): object;
    function getDeserializedJsonObj(obj: FleetDiagnosisSummary): object;
}

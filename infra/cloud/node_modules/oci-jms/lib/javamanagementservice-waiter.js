...
exports.JavaManagementServiceWaiter = void 0;
const models = __importStar(require("./model"));
const oci_common_1 = require("oci-common");
class JavaManagementServiceWaiter {
     ...
     */
    forTaskSchedule(request, ...targetStates) {
        return __awaiter(this, void 0, void 0, function* () {
            return oci_common_1.genericWaiter(this.config, () => this.client.getTaskSchedule(request), response => targetStates.includes(response.taskSchedule.lifecycleState));
        });
    }
    /**
...
exports.JavaManagementServiceWaiter = JavaManagementServiceWaiter;
//# sourceMappingURL=javamanagementservice-waiter.js.map
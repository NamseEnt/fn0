...
export declare namespace GenerateSqlFromNlJob {
    function getJsonObj(obj: GenerateSqlFromNlJob): object;
    function getDeserializedJsonObj(obj: GenerateSqlFromNlJob): object;
}

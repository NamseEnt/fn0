...
export declare namespace ScheduleSecretDeletionDetails {
    function getJsonObj(obj: ScheduleSecretDeletionDetails): object;
    function getDeserializedJsonObj(obj: ScheduleSecretDeletionDetails): object;
}

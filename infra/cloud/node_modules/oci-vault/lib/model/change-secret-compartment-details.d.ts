...
export declare namespace ChangeSecretCompartmentDetails {
    function getJsonObj(obj: ChangeSecretCompartmentDetails): object;
    function getDeserializedJsonObj(obj: ChangeSecretCompartmentDetails): object;
}

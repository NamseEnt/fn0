...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/devops/ListDeployArtifacts.ts.html |here} to see how to use ListDeployArtifactsRequest.
 */
export interface ListDeployArtifactsRequest extends common.BaseRequest {
    /**
...
export declare namespace ListDeployArtifactsRequest {
    enum SortBy {

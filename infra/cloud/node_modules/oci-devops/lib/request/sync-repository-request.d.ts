...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/devops/SyncRepository.ts.html |here} to see how to use SyncRepositoryRequest.
 */
...
export declare namespace SyncRepositoryRequest {

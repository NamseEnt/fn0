...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/devops/ListBuildRuns.ts.html |here} to see how to use ListBuildRunsRequest.
 */
export interface ListBuildRunsRequest extends common.BaseRequest {
    /**
...
export declare namespace ListBuildRunsRequest {
    enum SortBy {

...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/devops/ListBuildRunSnapshots.ts.html |here} to see how to use ListBuildRunSnapshotsRequest.
 */
export interface ListBuildRunSnapshotsRequest extends common.BaseRequest {
    /**
...
export declare namespace ListBuildRunSnapshotsRequest {
    enum SortBy {

...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/devops/ListDeployEnvironments.ts.html |here} to see how to use ListDeployEnvironmentsRequest.
 */
export interface ListDeployEnvironmentsRequest extends common.BaseRequest {
    /**
...
export declare namespace ListDeployEnvironmentsRequest {
    enum SortBy {

...
import * as CancelScheduledCascadingProjectDeletionRequest from "./cancel-scheduled-cascading-project-deletion-request";
export import CancelScheduledCascadingProjectDeletionRequest = CancelScheduledCascadingProjectDeletionRequest.CancelScheduledCascadingProjectDeletionRequest;
...
import * as CreateOrUpdateGitRefRequest from "./create-or-update-git-ref-request";
export import CreateOrUpdateGitRefRequest = CreateOrUpdateGitRefRequest.CreateOrUpdateGitRefRequest;
import * as CreateOrUpdateProtectedBranchRequest from "./create-or-update-protected-branch-request";
export import CreateOrUpdateProtectedBranchRequest = CreateOrUpdateProtectedBranchRequest.CreateOrUpdateProtectedBranchRequest;
...
import * as CreatePullRequestRequest from "./create-pull-request-request";
export import CreatePullRequestRequest = CreatePullRequestRequest.CreatePullRequestRequest;
import * as CreatePullRequestAttachmentRequest from "./create-pull-request-attachment-request";
export import CreatePullRequestAttachmentRequest = CreatePullRequestAttachmentRequest.CreatePullRequestAttachmentRequest;
import * as CreatePullRequestCommentRequest from "./create-pull-request-comment-request";
export import CreatePullRequestCommentRequest = CreatePullRequestCommentRequest.CreatePullRequestCommentRequest;
...
import * as DeclinePullRequestRequest from "./decline-pull-request-request";
export import DeclinePullRequestRequest = DeclinePullRequestRequest.DeclinePullRequestRequest;
...
import * as DeleteGitRefRequest from "./delete-git-ref-request";
export import DeleteGitRefRequest = DeleteGitRefRequest.DeleteGitRefRequest;
...
import * as DeleteProjectRepositorySettingsRequest from "./delete-project-repository-settings-request";
export import DeleteProjectRepositorySettingsRequest = DeleteProjectRepositorySettingsRequest.DeleteProjectRepositorySettingsRequest;
import * as DeleteProtectedBranchRequest from "./delete-protected-branch-request";
export import DeleteProtectedBranchRequest = DeleteProtectedBranchRequest.DeleteProtectedBranchRequest;
import * as DeletePullRequestRequest from "./delete-pull-request-request";
export import DeletePullRequestRequest = DeletePullRequestRequest.DeletePullRequestRequest;
import * as DeletePullRequestAttachmentRequest from "./delete-pull-request-attachment-request";
export import DeletePullRequestAttachmentRequest = DeletePullRequestAttachmentRequest.DeletePullRequestAttachmentRequest;
import * as DeletePullRequestCommentRequest from "./delete-pull-request-comment-request";
export import DeletePullRequestCommentRequest = DeletePullRequestCommentRequest.DeletePullRequestCommentRequest;
...
import * as DeleteRepositorySettingsRequest from "./delete-repository-settings-request";
export import DeleteRepositorySettingsRequest = DeleteRepositorySettingsRequest.DeleteRepositorySettingsRequest;
...
import * as GetProjectNotificationPreferenceRequest from "./get-project-notification-preference-request";
export import GetProjectNotificationPreferenceRequest = GetProjectNotificationPreferenceRequest.GetProjectNotificationPreferenceRequest;
import * as GetProjectRepositorySettingsRequest from "./get-project-repository-settings-request";
export import GetProjectRepositorySettingsRequest = GetProjectRepositorySettingsRequest.GetProjectRepositorySettingsRequest;
import * as GetPullRequestRequest from "./get-pull-request-request";
export import GetPullRequestRequest = GetPullRequestRequest.GetPullRequestRequest;
import * as GetPullRequestAttachmentRequest from "./get-pull-request-attachment-request";
export import GetPullRequestAttachmentRequest = GetPullRequestAttachmentRequest.GetPullRequestAttachmentRequest;
import * as GetPullRequestAttachmentContentRequest from "./get-pull-request-attachment-content-request";
export import GetPullRequestAttachmentContentRequest = GetPullRequestAttachmentContentRequest.GetPullRequestAttachmentContentRequest;
import * as GetPullRequestCommentRequest from "./get-pull-request-comment-request";
export import GetPullRequestCommentRequest = GetPullRequestCommentRequest.GetPullRequestCommentRequest;
import * as GetPullRequestNotificationPreferenceRequest from "./get-pull-request-notification-preference-request";
export import GetPullRequestNotificationPreferenceRequest = GetPullRequestNotificationPreferenceRequest.GetPullRequestNotificationPreferenceRequest;
...
import * as GetRepositoryNotificationPreferenceRequest from "./get-repository-notification-preference-request";
export import GetRepositoryNotificationPreferenceRequest = GetRepositoryNotificationPreferenceRequest.GetRepositoryNotificationPreferenceRequest;
import * as GetRepositorySettingsRequest from "./get-repository-settings-request";
export import GetRepositorySettingsRequest = GetRepositorySettingsRequest.GetRepositorySettingsRequest;
...
import * as LikePullRequestCommentRequest from "./like-pull-request-comment-request";
export import LikePullRequestCommentRequest = LikePullRequestCommentRequest.LikePullRequestCommentRequest;
...
import * as ListBuildRunSnapshotsRequest from "./list-build-run-snapshots-request";
export import ListBuildRunSnapshotsRequest = ListBuildRunSnapshotsRequest.ListBuildRunSnapshotsRequest;
...
import * as ListForkSyncStatusesRequest from "./list-fork-sync-statuses-request";
export import ListForkSyncStatusesRequest = ListForkSyncStatusesRequest.ListForkSyncStatusesRequest;
...
import * as ListProjectCommitAnalyticsAuthorsRequest from "./list-project-commit-analytics-authors-request";
export import ListProjectCommitAnalyticsAuthorsRequest = ListProjectCommitAnalyticsAuthorsRequest.ListProjectCommitAnalyticsAuthorsRequest;
...
import * as ListProtectedBranchesRequest from "./list-protected-branches-request";
export import ListProtectedBranchesRequest = ListProtectedBranchesRequest.ListProtectedBranchesRequest;
import * as ListPullRequestActivitiesRequest from "./list-pull-request-activities-request";
export import ListPullRequestActivitiesRequest = ListPullRequestActivitiesRequest.ListPullRequestActivitiesRequest;
import * as ListPullRequestAttachmentsRequest from "./list-pull-request-attachments-request";
export import ListPullRequestAttachmentsRequest = ListPullRequestAttachmentsRequest.ListPullRequestAttachmentsRequest;
import * as ListPullRequestAuthorsRequest from "./list-pull-request-authors-request";
export import ListPullRequestAuthorsRequest = ListPullRequestAuthorsRequest.ListPullRequestAuthorsRequest;
import * as ListPullRequestCommentsRequest from "./list-pull-request-comments-request";
export import ListPullRequestCommentsRequest = ListPullRequestCommentsRequest.ListPullRequestCommentsRequest;
import * as ListPullRequestsRequest from "./list-pull-requests-request";
export import ListPullRequestsRequest = ListPullRequestsRequest.ListPullRequestsRequest;
...
import * as ListRepositoryCommitAnalyticsAuthorsRequest from "./list-repository-commit-analytics-authors-request";
export import ListRepositoryCommitAnalyticsAuthorsRequest = ListRepositoryCommitAnalyticsAuthorsRequest.ListRepositoryCommitAnalyticsAuthorsRequest;
...
import * as MergePullRequestRequest from "./merge-pull-request-request";
export import MergePullRequestRequest = MergePullRequestRequest.MergePullRequestRequest;
...
import * as PatchPullRequestRequest from "./patch-pull-request-request";
export import PatchPullRequestRequest = PatchPullRequestRequest.PatchPullRequestRequest;
...
import * as ReopenPullRequestRequest from "./reopen-pull-request-request";
export import ReopenPullRequestRequest = ReopenPullRequestRequest.ReopenPullRequestRequest;
import * as ReviewPullRequestRequest from "./review-pull-request-request";
export import ReviewPullRequestRequest = ReviewPullRequestRequest.ReviewPullRequestRequest;
import * as ScheduleCascadingProjectDeletionRequest from "./schedule-cascading-project-deletion-request";
export import ScheduleCascadingProjectDeletionRequest = ScheduleCascadingProjectDeletionRequest.ScheduleCascadingProjectDeletionRequest;
import * as SummarizeProjectRepositoryAnalyticsRequest from "./summarize-project-repository-analytics-request";
export import SummarizeProjectRepositoryAnalyticsRequest = SummarizeProjectRepositoryAnalyticsRequest.SummarizeProjectRepositoryAnalyticsRequest;
import * as SummarizeRepositoryAnalyticsRequest from "./summarize-repository-analytics-request";
...
export import UnsubscribePullRequestRequest = UnsubscribePullRequestRequest.UnsubscribePullRequestRequest;
...
import * as UpdateProjectNotificationPreferenceRequest from "./update-project-notification-preference-request";
export import UpdateProjectNotificationPreferenceRequest = UpdateProjectNotificationPreferenceRequest.UpdateProjectNotificationPreferenceRequest;
import * as UpdateProjectRepositorySettingsRequest from "./update-project-repository-settings-request";
export import UpdateProjectRepositorySettingsRequest = UpdateProjectRepositorySettingsRequest.UpdateProjectRepositorySettingsRequest;
import * as UpdatePullRequestRequest from "./update-pull-request-request";
export import UpdatePullRequestRequest = UpdatePullRequestRequest.UpdatePullRequestRequest;
import * as UpdatePullRequestCommentRequest from "./update-pull-request-comment-request";
export import UpdatePullRequestCommentRequest = UpdatePullRequestCommentRequest.UpdatePullRequestCommentRequest;
import * as UpdatePullRequestNotificationPreferenceRequest from "./update-pull-request-notification-preference-request";
export import UpdatePullRequestNotificationPreferenceRequest = UpdatePullRequestNotificationPreferenceRequest.UpdatePullRequestNotificationPreferenceRequest;
...
import * as UpdateRepositoryNotificationPreferenceRequest from "./update-repository-notification-preference-request";
export import UpdateRepositoryNotificationPreferenceRequest = UpdateRepositoryNotificationPreferenceRequest.UpdateRepositoryNotificationPreferenceRequest;
import * as UpdateRepositorySettingsRequest from "./update-repository-settings-request";
export import UpdateRepositorySettingsRequest = UpdateRepositorySettingsRequest.UpdateRepositorySettingsRequest;

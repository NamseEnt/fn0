...
export declare namespace UpdateFunctionDeployStageDetails {
    function getJsonObj(obj: UpdateFunctionDeployStageDetails, isParentJsonObj?: boolean): object;
    const deployStageType = "DEPLOY_FUNCTION";
    function getDeserializedJsonObj(obj: UpdateFunctionDeployStageDetails, isParentJsonObj?: boolean): object;
}

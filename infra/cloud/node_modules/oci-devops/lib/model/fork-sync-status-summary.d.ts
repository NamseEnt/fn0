...
export declare namespace ForkSyncStatusSummary {
    enum SyncStatus {
        InSync = "IN_SYNC",
    ...
    function getJsonObj(obj: ForkSyncStatusSummary): object;
    function getDeserializedJsonObj(obj: ForkSyncStatusSummary): object;
}

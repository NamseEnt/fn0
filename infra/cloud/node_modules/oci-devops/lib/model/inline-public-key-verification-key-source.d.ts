...
export declare namespace InlinePublicKeyVerificationKeySource {
    function getJsonObj(obj: InlinePublicKeyVerificationKeySource, isParentJsonObj?: boolean): object;
    const verificationKeySourceType = "INLINE_PUBLIC_KEY";
    function getDeserializedJsonObj(obj: InlinePublicKeyVerificationKeySource, isParentJsonObj?: boolean): object;
}

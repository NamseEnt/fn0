...
export declare namespace DiffResponseEntry {
    function getJsonObj(obj: DiffResponseEntry): object;
    function getDeserializedJsonObj(obj: DiffResponseEntry): object;
}

...
export declare namespace PullRequestAttachmentSummary {
    function getJsonObj(obj: PullRequestAttachmentSummary): object;
    function getDeserializedJsonObj(obj: PullRequestAttachmentSummary): object;
}

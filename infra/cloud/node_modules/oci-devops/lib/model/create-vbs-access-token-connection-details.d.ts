...
export declare namespace CreateVbsAccessTokenConnectionDetails {
    function getJsonObj(obj: CreateVbsAccessTokenConnectionDetails, isParentJsonObj?: boolean): object;
    const connectionType = "VBS_ACCESS_TOKEN";
    function getDeserializedJsonObj(obj: CreateVbsAccessTokenConnectionDetails, isParentJsonObj?: boolean): object;
}

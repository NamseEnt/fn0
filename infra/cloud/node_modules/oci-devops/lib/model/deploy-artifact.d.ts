...
export interface DeployArtifact {
    ...
    "deployArtifactSource": model.GenericDeployArtifactSource | model.HelmRepositoryDeployArtifactSource | model.OcirDeployArtifactSource | model.HelmCommandSpecArtifactSource | model.InlineDeployArtifactSource;
    /**
...
export declare namespace DeployArtifact {
    enum DeployArtifactType {
    ...
    function getJsonObj(obj: DeployArtifact): object;
    function getDeserializedJsonObj(obj: DeployArtifact): object;
}

...
export declare namespace UpdateDeployPipelineDetails {
    function getJsonObj(obj: UpdateDeployPipelineDetails): object;
    function getDeserializedJsonObj(obj: UpdateDeployPipelineDetails): object;
}

...
export declare namespace DeployArtifactSummary {
    function getJsonObj(obj: DeployArtifactSummary): object;
    function getDeserializedJsonObj(obj: DeployArtifactSummary): object;
}

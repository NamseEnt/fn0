...
export declare namespace DeployStageExecutionProgressDetails {
    function getJsonObj(obj: DeployStageExecutionProgressDetails): object;
    function getDeserializedJsonObj(obj: DeployStageExecutionProgressDetails): object;
}

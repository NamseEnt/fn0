 ...
 */
export interface CreateDeployPipelineDetails {
    /**
...
export declare namespace CreateDeployPipelineDetails {
    function getJsonObj(obj: CreateDeployPipelineDetails): object;
    function getDeserializedJsonObj(obj: CreateDeployPipelineDetails): object;
}

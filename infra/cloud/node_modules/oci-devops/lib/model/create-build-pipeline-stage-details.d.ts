...
export declare namespace CreateBuildPipelineStageDetails {
    function getJsonObj(obj: CreateBuildPipelineStageDetails): object;
    function getDeserializedJsonObj(obj: CreateBuildPipelineStageDetails): object;
}

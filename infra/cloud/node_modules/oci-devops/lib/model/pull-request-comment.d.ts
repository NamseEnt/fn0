...
export declare namespace PullRequestComment {
    enum FileType {
        Source = "SOURCE",
    ...
    function getJsonObj(obj: PullRequestComment): object;
    function getDeserializedJsonObj(obj: PullRequestComment): object;
}

...
export declare namespace CreateOkeCanaryApprovalDeployStageDetails {
    function getJsonObj(obj: CreateOkeCanaryApprovalDeployStageDetails, isParentJsonObj?: boolean): object;
    const deployStageType = "OKE_CANARY_APPROVAL";
    function getDeserializedJsonObj(obj: CreateOkeCanaryApprovalDeployStageDetails, isParentJsonObj?: boolean): object;
}

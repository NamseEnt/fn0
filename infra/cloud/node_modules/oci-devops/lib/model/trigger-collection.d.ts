...
export declare namespace TriggerCollection {
    function getJsonObj(obj: TriggerCollection): object;
    function getDeserializedJsonObj(obj: TriggerCollection): object;
}

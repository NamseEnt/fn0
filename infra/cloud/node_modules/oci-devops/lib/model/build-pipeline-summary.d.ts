...
export declare namespace BuildPipelineSummary {
    function getJsonObj(obj: BuildPipelineSummary): object;
    function getDeserializedJsonObj(obj: BuildPipelineSummary): object;
}

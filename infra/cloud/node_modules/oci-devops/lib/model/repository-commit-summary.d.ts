...
export declare namespace RepositoryCommitSummary {
    function getJsonObj(obj: RepositoryCommitSummary): object;
    function getDeserializedJsonObj(obj: RepositoryCommitSummary): object;
}

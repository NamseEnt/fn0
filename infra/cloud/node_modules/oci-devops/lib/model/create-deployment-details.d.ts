...
export declare namespace CreateDeploymentDetails {
    function getJsonObj(obj: CreateDeploymentDetails): object;
    function getDeserializedJsonObj(obj: CreateDeploymentDetails): object;
}

...
export declare namespace BuildStageRunProgress {
    enum Image {
    ...
    function getJsonObj(obj: BuildStageRunProgress, isParentJsonObj?: boolean): object;
    const buildPipelineStageType = "BUILD";
    function getDeserializedJsonObj(obj: BuildStageRunProgress, isParentJsonObj?: boolean): object;
}

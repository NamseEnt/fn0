...
export interface BuildRunProgress {
    ...
    "buildPipelineStageRunProgress"?: {
        [key: string]: model.BuildPipelineStageRunProgress;
    };
}
export declare namespace BuildRunProgress {
    function getJsonObj(obj: BuildRunProgress): object;
    function getDeserializedJsonObj(obj: BuildRunProgress): object;
}

...
export declare namespace ProtectedBranchSummary {
    ...
    function getJsonObj(obj: ProtectedBranchSummary): object;
    function getDeserializedJsonObj(obj: ProtectedBranchSummary): object;
}

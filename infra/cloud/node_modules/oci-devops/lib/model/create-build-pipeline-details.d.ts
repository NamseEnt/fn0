 ...
 */
export interface CreateBuildPipelineDetails {
    /**
...
export declare namespace CreateBuildPipelineDetails {
    function getJsonObj(obj: CreateBuildPipelineDetails): object;
    function getDeserializedJsonObj(obj: CreateBuildPipelineDetails): object;
}

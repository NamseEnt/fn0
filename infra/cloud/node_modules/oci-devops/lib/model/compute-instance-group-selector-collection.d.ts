...
export declare namespace ComputeInstanceGroupSelectorCollection {
    function getJsonObj(obj: ComputeInstanceGroupSelectorCollection): object;
    function getDeserializedJsonObj(obj: ComputeInstanceGroupSelectorCollection): object;
}

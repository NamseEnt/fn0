...
export declare namespace CreateDeployPipelineDeploymentDetails {
    function getJsonObj(obj: CreateDeployPipelineDeploymentDetails, isParentJsonObj?: boolean): object;
    const deploymentType = "PIPELINE_DEPLOYMENT";
    function getDeserializedJsonObj(obj: CreateDeployPipelineDeploymentDetails, isParentJsonObj?: boolean): object;
}

...
export declare namespace ContainerInstanceConfig {
    function getJsonObj(obj: ContainerInstanceConfig, isParentJsonObj?: boolean): object;
    const containerConfigType = "CONTAINER_INSTANCE_CONFIG";
    function getDeserializedJsonObj(obj: ContainerInstanceConfig, isParentJsonObj?: boolean): object;
}

 ...
 */
export interface CreateLoadBalancerTrafficShiftDeployStageDetails extends model.CreateDeployStageDetails {
...
export declare namespace CreateLoadBalancerTrafficShiftDeployStageDetails {
    function getJsonObj(obj: CreateLoadBalancerTrafficShiftDeployStageDetails, isParentJsonObj?: boolean): object;
    const deployStageType = "LOAD_BALANCER_TRAFFIC_SHIFT";
    function getDeserializedJsonObj(obj: CreateLoadBalancerTrafficShiftDeployStageDetails, isParentJsonObj?: boolean): object;
}

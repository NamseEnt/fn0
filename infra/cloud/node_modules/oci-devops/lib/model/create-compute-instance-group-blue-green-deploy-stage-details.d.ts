 ...
 */
export interface CreateComputeInstanceGroupBlueGreenDeployStageDetails extends model.CreateDeployStageDetails {
    /**
...
export declare namespace CreateComputeInstanceGroupBlueGreenDeployStageDetails {
    function getJsonObj(obj: CreateComputeInstanceGroupBlueGreenDeployStageDetails, isParentJsonObj?: boolean): object;
    const deployStageType = "COMPUTE_INSTANCE_GROUP_BLUE_GREEN_DEPLOYMENT";
    function getDeserializedJsonObj(obj: CreateComputeInstanceGroupBlueGreenDeployStageDetails, isParentJsonObj?: boolean): object;
}

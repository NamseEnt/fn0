...
export declare namespace ActualBuildRunnerShapeConfig {
    function getJsonObj(obj: ActualBuildRunnerShapeConfig): object;
    function getDeserializedJsonObj(obj: ActualBuildRunnerShapeConfig): object;
}

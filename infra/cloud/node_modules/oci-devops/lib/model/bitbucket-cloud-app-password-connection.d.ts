...
export declare namespace BitbucketCloudAppPasswordConnection {
    function getJsonObj(obj: BitbucketCloudAppPasswordConnection, isParentJsonObj?: boolean): object;
    const connectionType = "BITBUCKET_CLOUD_APP_PASSWORD";
    function getDeserializedJsonObj(obj: BitbucketCloudAppPasswordConnection, isParentJsonObj?: boolean): object;
}

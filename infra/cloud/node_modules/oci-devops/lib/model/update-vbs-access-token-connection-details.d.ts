...
export declare namespace UpdateVbsAccessTokenConnectionDetails {
    function getJsonObj(obj: UpdateVbsAccessTokenConnectionDetails, isParentJsonObj?: boolean): object;
    const connectionType = "VBS_ACCESS_TOKEN";
    function getDeserializedJsonObj(obj: UpdateVbsAccessTokenConnectionDetails, isParentJsonObj?: boolean): object;
}

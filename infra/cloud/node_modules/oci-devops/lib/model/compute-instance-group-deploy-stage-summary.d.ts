...
export declare namespace ComputeInstanceGroupDeployStageSummary {
    function getJsonObj(obj: ComputeInstanceGroupDeployStageSummary, isParentJsonObj?: boolean): object;
    const deployStageType = "COMPUTE_INSTANCE_GROUP_ROLLING_DEPLOYMENT";
    function getDeserializedJsonObj(obj: ComputeInstanceGroupDeployStageSummary, isParentJsonObj?: boolean): object;
}

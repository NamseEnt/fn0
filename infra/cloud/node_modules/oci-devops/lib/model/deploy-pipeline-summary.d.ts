...
export declare namespace DeployPipelineSummary {
    function getJsonObj(obj: DeployPipelineSummary): object;
    function getDeserializedJsonObj(obj: DeployPipelineSummary): object;
}

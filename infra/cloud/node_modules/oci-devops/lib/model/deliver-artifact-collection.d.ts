...
export declare namespace DeliverArtifactCollection {
    function getJsonObj(obj: DeliverArtifactCollection): object;
    function getDeserializedJsonObj(obj: DeliverArtifactCollection): object;
}

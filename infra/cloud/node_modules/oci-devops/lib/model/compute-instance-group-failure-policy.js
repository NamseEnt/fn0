...
(function (ComputeInstanceGroupFailurePolicy) {
        ...
        if (obj && "policyType" in obj && obj.policyType) {
            switch (obj.policyType) {
                case "COMPUTE_INSTANCE_GROUP_FAILURE_POLICY_BY_PERCENTAGE":
                    return model.ComputeInstanceGroupFailurePolicyByPercentage.getJsonObj(jsonObj, true);
    ...
    ComputeInstanceGroupFailurePolicy.getJsonObj = getJsonObj;
    function getDeserializedJsonObj(obj) {
        const jsonObj = Object.assign(Object.assign({}, obj), {});
        if (obj && "policyType" in obj && obj.policyType) {
            switch (obj.policyType) {
                case "COMPUTE_INSTANCE_GROUP_FAILURE_POLICY_BY_PERCENTAGE":
                    return model.ComputeInstanceGroupFailurePolicyByPercentage.getDeserializedJsonObj(jsonObj, true);
                case "COMPUTE_INSTANCE_GROUP_FAILURE_POLICY_BY_COUNT":
    ...
    ComputeInstanceGroupFailurePolicy.getDeserializedJsonObj = getDeserializedJsonObj;
})(ComputeInstanceGroupFailurePolicy = exports.ComputeInstanceGroupFailurePolicy || (exports.ComputeInstanceGroupFailurePolicy = {}));
//# sourceMappingURL=compute-instance-group-failure-policy.js.map
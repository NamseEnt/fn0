...
export declare namespace CreateOrUpdateGitRefDetails {
    function getJsonObj(obj: CreateOrUpdateGitRefDetails): object;
    function getDeserializedJsonObj(obj: CreateOrUpdateGitRefDetails): object;
}

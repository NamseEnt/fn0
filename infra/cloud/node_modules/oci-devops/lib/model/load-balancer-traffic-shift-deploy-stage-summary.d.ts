 ...
 */
export interface LoadBalancerTrafficShiftDeployStageSummary extends model.DeployStageSummary {
...
export declare namespace LoadBalancerTrafficShiftDeployStageSummary {
    function getJsonObj(obj: LoadBalancerTrafficShiftDeployStageSummary, isParentJsonObj?: boolean): object;
    const deployStageType = "LOAD_BALANCER_TRAFFIC_SHIFT";
    function getDeserializedJsonObj(obj: LoadBalancerTrafficShiftDeployStageSummary, isParentJsonObj?: boolean): object;
}

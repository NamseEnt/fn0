...
export declare namespace FunctionDeployStageSummary {
    function getJsonObj(obj: FunctionDeployStageSummary, isParentJsonObj?: boolean): object;
    const deployStageType = "DEPLOY_FUNCTION";
    function getDeserializedJsonObj(obj: FunctionDeployStageSummary, isParentJsonObj?: boolean): object;
}

...
export declare namespace DeployEnvironment {
    enum LifecycleState {
        Creating = "CREATING",
        Updating = "UPDATING",
        Active = "ACTIVE",
    ...
    function getJsonObj(obj: DeployEnvironment): object;
    function getDeserializedJsonObj(obj: DeployEnvironment): object;
}

...
export declare namespace WaitStage {
    function getJsonObj(obj: WaitStage, isParentJsonObj?: boolean): object;
    const buildPipelineStageType = "WAIT";
    function getDeserializedJsonObj(obj: WaitStage, isParentJsonObj?: boolean): object;
}

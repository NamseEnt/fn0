 ...
 */
export interface CreateShellDeployStageDetails extends model.CreateDeployStageDetails {
...
export declare namespace CreateShellDeployStageDetails {
    function getJsonObj(obj: CreateShellDeployStageDetails, isParentJsonObj?: boolean): object;
    const deployStageType = "SHELL";
    function getDeserializedJsonObj(obj: CreateShellDeployStageDetails, isParentJsonObj?: boolean): object;
}

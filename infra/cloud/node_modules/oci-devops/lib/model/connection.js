...
(function (Connection) {
        ...
        if (obj && "connectionType" in obj && obj.connectionType) {
            switch (obj.connectionType) {
                case "BITBUCKET_SERVER_ACCESS_TOKEN":
                    return model.BitbucketServerAccessTokenConnection.getJsonObj(jsonObj, true);
                case "GITLAB_ACCESS_TOKEN":
                    return model.GitlabAccessTokenConnection.getJsonObj(jsonObj, true);
                case "GITHUB_ACCESS_TOKEN":
                    return model.GithubAccessTokenConnection.getJsonObj(jsonObj, true);
                case "BITBUCKET_CLOUD_APP_PASSWORD":
                    return model.BitbucketCloudAppPasswordConnection.getJsonObj(jsonObj, true);
                ...
                case "VBS_ACCESS_TOKEN":
                    return model.VbsAccessTokenConnection.getJsonObj(jsonObj, true);
                default:
    ...
    function getDeserializedJsonObj(obj) {
        ...
        if (obj && "connectionType" in obj && obj.connectionType) {
            switch (obj.connectionType) {
                case "BITBUCKET_SERVER_ACCESS_TOKEN":
                    return model.BitbucketServerAccessTokenConnection.getDeserializedJsonObj(jsonObj, true);
                case "GITLAB_ACCESS_TOKEN":
                    return model.GitlabAccessTokenConnection.getDeserializedJsonObj(jsonObj, true);
                case "GITHUB_ACCESS_TOKEN":
                    return model.GithubAccessTokenConnection.getDeserializedJsonObj(jsonObj, true);
                case "BITBUCKET_CLOUD_APP_PASSWORD":
                    return model.BitbucketCloudAppPasswordConnection.getDeserializedJsonObj(jsonObj, true);
                case "GITLAB_SERVER_ACCESS_TOKEN":
                    return model.GitlabServerAccessTokenConnection.getDeserializedJsonObj(jsonObj, true);
                case "VBS_ACCESS_TOKEN":
                    return model.VbsAccessTokenConnection.getDeserializedJsonObj(jsonObj, true);
                default:
                    if (common.LOG.logger)
                        common.LOG.logger.info(`Unknown value for: ${obj.connectionType}`);
            }

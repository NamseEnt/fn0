 ...
 */
export interface CreateFunctionDeployStageDetails extends model.CreateDeployStageDetails {
    /**
...
export declare namespace CreateFunctionDeployStageDetails {
    function getJsonObj(obj: CreateFunctionDeployStageDetails, isParentJsonObj?: boolean): object;
    const deployStageType = "DEPLOY_FUNCTION";
    function getDeserializedJsonObj(obj: CreateFunctionDeployStageDetails, isParentJsonObj?: boolean): object;
}

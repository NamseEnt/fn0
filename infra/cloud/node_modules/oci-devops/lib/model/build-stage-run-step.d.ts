...
export declare namespace BuildStageRunStep {
    enum State {
        Waiting = "WAITING",
    ...
    function getJsonObj(obj: BuildStageRunStep): object;
    function getDeserializedJsonObj(obj: BuildStageRunStep): object;
}

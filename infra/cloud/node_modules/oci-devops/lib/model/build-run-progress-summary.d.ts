...
export declare namespace BuildRunProgressSummary {
    function getJsonObj(obj: BuildRunProgressSummary): object;
    function getDeserializedJsonObj(obj: BuildRunProgressSummary): object;
}

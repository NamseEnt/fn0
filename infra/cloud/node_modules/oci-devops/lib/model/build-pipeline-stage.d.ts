...
export declare namespace BuildPipelineStage {
    enum LifecycleState {
        Creating = "CREATING",
        Updating = "UPDATING",
        Active = "ACTIVE",
    ...
    function getJsonObj(obj: BuildPipelineStage): object;
    function getDeserializedJsonObj(obj: BuildPipelineStage): object;
}

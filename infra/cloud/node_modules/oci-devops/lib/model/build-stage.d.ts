...
export declare namespace BuildStage {
    enum Image {
    ...
    function getJsonObj(obj: BuildStage, isParentJsonObj?: boolean): object;
    const buildPipelineStageType = "BUILD";
    function getDeserializedJsonObj(obj: BuildStage, isParentJsonObj?: boolean): object;
}

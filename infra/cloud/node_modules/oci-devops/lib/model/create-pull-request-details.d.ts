...
export interface CreatePullRequestDetails {
     ...
     */
    "reviewers"?: Array<model.CreateReviewerDetails>;
    /**
...
export declare namespace CreatePullRequestDetails {
    function getJsonObj(obj: CreatePullRequestDetails): object;
    function getDeserializedJsonObj(obj: CreatePullRequestDetails): object;
}

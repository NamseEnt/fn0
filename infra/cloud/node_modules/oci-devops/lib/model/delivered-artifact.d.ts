...
export declare namespace DeliveredArtifact {
    function getJsonObj(obj: DeliveredArtifact): object;
    function getDeserializedJsonObj(obj: DeliveredArtifact): object;
}

...
export interface SummarizeProjectRepositoryAnalyticsResponse {
    /**
    ...
    "opcNextPage": string;
    /**
     * The returned model.RepositoryMetricAggregation instance.
     */
    "repositoryMetricAggregation": model.RepositoryMetricAggregation;
}

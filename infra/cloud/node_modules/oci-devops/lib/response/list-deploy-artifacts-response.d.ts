...
export interface ListDeployArtifactsResponse {
    /**
    ...
    "opcNextPage": string;
    /**
     * The returned model.DeployArtifactCollection instance.
     */
    "deployArtifactCollection": model.DeployArtifactCollection;
}

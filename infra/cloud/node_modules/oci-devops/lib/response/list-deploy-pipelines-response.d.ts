...
export interface ListDeployPipelinesResponse {
    /**
    ...
    "opcNextPage": string;
    /**
     * The returned model.DeployPipelineCollection instance.
     */
    "deployPipelineCollection": model.DeployPipelineCollection;
}

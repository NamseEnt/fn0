...
export declare namespace CreateSubscriptionDetails {
    function getJsonObj(obj: CreateSubscriptionDetails): object;
    function getDeserializedJsonObj(obj: CreateSubscriptionDetails): object;
}

...
export declare namespace LifecycleStateEnum {
    function getJsonObj(obj: LifecycleStateEnum): LifecycleStateEnum;
    function getDeserializedJsonObj(obj: LifecycleStateEnum): LifecycleStateEnum;
}

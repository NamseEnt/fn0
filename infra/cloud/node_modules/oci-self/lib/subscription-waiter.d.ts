...
export declare class SubscriptionWaiter {
     ...
     */
    forSubscription(request: serviceRequests.GetSubscriptionRequest, ...targetStates: models.LifecycleStateEnum[]): Promise<serviceResponses.GetSubscriptionResponse | null>;
    /**

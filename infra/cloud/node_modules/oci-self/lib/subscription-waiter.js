...
class SubscriptionWaiter {
    ...
    forSubscription(request, ...targetStates) {
        return __awaiter(this, void 0, void 0, function* () {
            return oci_common_1.genericTerminalConditionWaiter(this.config, () => this.client.getSubscription(request), response => targetStates.includes(response.subscription.lifecycleState), targetStates.includes(models.LifecycleStateEnum.Deleted));
        });
    }
    /**

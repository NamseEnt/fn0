...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/datacatalog/GetJobLog.ts.html |here} to see how to use GetJobLogRequest.
 */
...
export declare namespace GetJobLogRequest {
    enum Fields {
        Key = "key",

...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/datacatalog/ListTerms.ts.html |here} to see how to use ListTermsRequest.
 */
export interface ListTermsRequest extends common.BaseRequest {
     ...
     *
     */
    "fields"?: Array<ListTermsRequest.Fields>;
    /**
...
export declare namespace ListTermsRequest {
    enum Fields {
        Key = "key",

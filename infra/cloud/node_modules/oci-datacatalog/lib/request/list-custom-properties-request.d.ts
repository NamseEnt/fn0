...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/datacatalog/ListCustomProperties.ts.html |here} to see how to use ListCustomPropertiesRequest.
 */
...
export declare namespace ListCustomPropertiesRequest {
    enum TypeName {

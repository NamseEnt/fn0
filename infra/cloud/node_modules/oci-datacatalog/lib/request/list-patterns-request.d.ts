...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/datacatalog/ListPatterns.ts.html |here} to see how to use ListPatternsRequest.
 */
...
export declare namespace ListPatternsRequest {
    enum Fields {
        Key = "key",

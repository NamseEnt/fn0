...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/datacatalog/ListJobDefinitions.ts.html |here} to see how to use ListJobDefinitionsRequest.
 */
...
export declare namespace ListJobDefinitionsRequest {
    enum Fields {
        Key = "key",

...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/datacatalog/SearchCriteria.ts.html |here} to see how to use SearchCriteriaRequest.
 */
...
export declare namespace SearchCriteriaRequest {
    enum SortBy {

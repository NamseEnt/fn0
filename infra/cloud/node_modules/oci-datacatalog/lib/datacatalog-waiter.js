...
class DataCatalogWaiter {
     ...
     */
    forMetastore(request, ...targetStates) {
        return __awaiter(this, void 0, void 0, function* () {
            return oci_common_1.genericTerminalConditionWaiter(this.config, () => this.client.getMetastore(request), response => targetStates.includes(response.metastore.lifecycleState), targetStates.includes(models.LifecycleState.Deleted));
        });
    }
    /**

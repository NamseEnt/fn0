...
export interface ListTermRelationshipsResponse {
    /**
    ...
    "opcNextPage": string;
    /**
     * The returned model.TermRelationshipCollection instance.
     */
    "termRelationshipCollection": model.TermRelationshipCollection;
}

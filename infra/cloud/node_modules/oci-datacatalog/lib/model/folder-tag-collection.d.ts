...
export declare namespace FolderTagCollection {
    function getJsonObj(obj: FolderTagCollection): object;
    function getDeserializedJsonObj(obj: FolderTagCollection): object;
}

...
export declare namespace GlossaryCollection {
    function getJsonObj(obj: GlossaryCollection): object;
    function getDeserializedJsonObj(obj: GlossaryCollection): object;
}

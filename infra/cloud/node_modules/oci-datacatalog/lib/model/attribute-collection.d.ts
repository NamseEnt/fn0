...
export declare namespace AttributeCollection {
    function getJsonObj(obj: AttributeCollection): object;
    function getDeserializedJsonObj(obj: AttributeCollection): object;
}

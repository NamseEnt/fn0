 ...
 */
export interface ImportLineageJobResult {
    /**
...
export declare namespace ImportLineageJobResult {
    function getJsonObj(obj: ImportLineageJobResult): object;
    function getDeserializedJsonObj(obj: ImportLineageJobResult): object;
}

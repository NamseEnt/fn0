...
export declare namespace ProcessRecommendationDetails {
    function getJsonObj(obj: ProcessRecommendationDetails): object;
    function getDeserializedJsonObj(obj: ProcessRecommendationDetails): object;
}

...
export declare namespace JobDefinitionSummary {
    function getJsonObj(obj: JobDefinitionSummary): object;
    function getDeserializedJsonObj(obj: JobDefinitionSummary): object;
}

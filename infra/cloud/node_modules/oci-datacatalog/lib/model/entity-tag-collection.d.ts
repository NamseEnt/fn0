 ...
 *
 */
export interface EntityTagCollection {
    /**
     ...
     */
    "items": Array<model.EntityTagSummary>;
}
export declare namespace EntityTagCollection {
    function getJsonObj(obj: EntityTagCollection): object;
    function getDeserializedJsonObj(obj: EntityTagCollection): object;
}

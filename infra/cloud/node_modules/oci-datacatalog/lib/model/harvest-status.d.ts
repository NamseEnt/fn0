 ...
 *
 **/
export declare enum HarvestStatus {
    Complete = "COMPLETE",
    Error = "ERROR",
...
export declare namespace HarvestStatus {
    function getJsonObj(obj: HarvestStatus): HarvestStatus;
    function getDeserializedJsonObj(obj: HarvestStatus): HarvestStatus;
}

...
export declare namespace DetachCatalogPrivateEndpointDetails {
    function getJsonObj(obj: DetachCatalogPrivateEndpointDetails): object;
    function getDeserializedJsonObj(obj: DetachCatalogPrivateEndpointDetails): object;
}

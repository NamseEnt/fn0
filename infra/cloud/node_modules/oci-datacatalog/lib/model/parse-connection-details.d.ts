...
export declare namespace ParseConnectionDetails {
    function getJsonObj(obj: ParseConnectionDetails): object;
    function getDeserializedJsonObj(obj: ParseConnectionDetails): object;
}

...
export declare namespace AttributeTagCollection {
    function getJsonObj(obj: AttributeTagCollection): object;
    function getDeserializedJsonObj(obj: AttributeTagCollection): object;
}

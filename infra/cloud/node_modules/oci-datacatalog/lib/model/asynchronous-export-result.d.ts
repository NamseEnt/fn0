 ...
 */
export interface AsynchronousExportResult {
    /**
...
export declare namespace AsynchronousExportResult {
    function getJsonObj(obj: AsynchronousExportResult): object;
    function getDeserializedJsonObj(obj: AsynchronousExportResult): object;
}

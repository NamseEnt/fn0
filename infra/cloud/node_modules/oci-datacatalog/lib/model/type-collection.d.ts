...
export interface TypeCollection {
     ...
     * Collection of types.
     */
    "items": Array<model.TypeSummary>;
}
export declare namespace TypeCollection {
    function getJsonObj(obj: TypeCollection): object;
    function getDeserializedJsonObj(obj: TypeCollection): object;
}

...
export declare namespace JobDefinitionScope {
    function getJsonObj(obj: JobDefinitionScope): object;
    function getDeserializedJsonObj(obj: JobDefinitionScope): object;
}

...
export declare namespace UpdateFolderDetails {
    function getJsonObj(obj: UpdateFolderDetails): object;
    function getDeserializedJsonObj(obj: UpdateFolderDetails): object;
}

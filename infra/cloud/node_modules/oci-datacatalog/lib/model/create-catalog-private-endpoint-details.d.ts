...
export declare namespace CreateCatalogPrivateEndpointDetails {
    function getJsonObj(obj: CreateCatalogPrivateEndpointDetails): object;
    function getDeserializedJsonObj(obj: CreateCatalogPrivateEndpointDetails): object;
}

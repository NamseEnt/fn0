...
export declare namespace RecommendationDetails {
    function getJsonObj(obj: RecommendationDetails): object;
    function getDeserializedJsonObj(obj: RecommendationDetails): object;
}

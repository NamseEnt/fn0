...
export declare namespace OperatorControlAssignment {
    function getJsonObj(obj: OperatorControlAssignment): object;
    function getDeserializedJsonObj(obj: OperatorControlAssignment): object;
}

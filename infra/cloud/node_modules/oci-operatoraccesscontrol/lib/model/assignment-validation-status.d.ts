...
export declare namespace AssignmentValidationStatus {
    function getJsonObj(obj: AssignmentValidationStatus): object;
    function getDeserializedJsonObj(obj: AssignmentValidationStatus): object;
}

...
export declare namespace InteractionRequestDetails {
    function getJsonObj(obj: InteractionRequestDetails): object;
    function getDeserializedJsonObj(obj: InteractionRequestDetails): object;
}

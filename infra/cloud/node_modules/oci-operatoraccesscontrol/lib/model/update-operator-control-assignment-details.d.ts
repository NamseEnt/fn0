...
export declare namespace UpdateOperatorControlAssignmentDetails {
    function getJsonObj(obj: UpdateOperatorControlAssignmentDetails): object;
    function getDeserializedJsonObj(obj: UpdateOperatorControlAssignmentDetails): object;
}

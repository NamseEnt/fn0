...
export declare namespace InteractionSummary {
    function getJsonObj(obj: InteractionSummary): object;
    function getDeserializedJsonObj(obj: InteractionSummary): object;
}

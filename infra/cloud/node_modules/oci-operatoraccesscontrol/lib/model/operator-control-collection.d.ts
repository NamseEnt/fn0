...
export declare namespace OperatorControlCollection {
    function getJsonObj(obj: OperatorControlCollection): object;
    function getDeserializedJsonObj(obj: OperatorControlCollection): object;
}

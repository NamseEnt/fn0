...
export declare namespace OperatorControlSummary {
    function getJsonObj(obj: OperatorControlSummary): object;
    function getDeserializedJsonObj(obj: OperatorControlSummary): object;
}

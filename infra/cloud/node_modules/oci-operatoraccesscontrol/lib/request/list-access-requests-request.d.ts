...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/operatoraccesscontrol/ListAccessRequests.ts.html |here} to see how to use ListAccessRequestsRequest.
 */
...
export declare namespace ListAccessRequestsRequest {
    enum SortBy {

...
export declare class AIServiceVisionWaiter {
     ...
     */
    forStreamGroup(request: serviceRequests.GetStreamGroupRequest, ...targetStates: models.StreamGroup.LifecycleState[]): Promise<serviceResponses.GetStreamGroupResponse | null>;
    /**
     ...
     */
    forStreamJob(request: serviceRequests.GetStreamJobRequest, ...targetStates: models.StreamJob.LifecycleState[]): Promise<serviceResponses.GetStreamJobResponse | null>;
    /**
     ...
     */
    forStreamSource(request: serviceRequests.GetStreamSourceRequest, ...targetStates: models.StreamSource.LifecycleState[]): Promise<serviceResponses.GetStreamSourceResponse | null>;
    /**
     ...
     */
    forVisionPrivateEndpoint(request: serviceRequests.GetVisionPrivateEndpointRequest, ...targetStates: models.VisionPrivateEndpoint.LifecycleState[]): Promise<serviceResponses.GetVisionPrivateEndpointResponse | null>;
    /**

...
export declare namespace AnalyzeImageDetails {
    function getJsonObj(obj: AnalyzeImageDetails): object;
    function getDeserializedJsonObj(obj: AnalyzeImageDetails): object;
}

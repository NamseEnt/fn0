...
export declare namespace DocumentClassificationFeature {
    function getJsonObj(obj: DocumentClassificationFeature, isParentJsonObj?: boolean): object;
    const featureType = "DOCUMENT_CLASSIFICATION";
    function getDeserializedJsonObj(obj: DocumentClassificationFeature, isParentJsonObj?: boolean): object;
}

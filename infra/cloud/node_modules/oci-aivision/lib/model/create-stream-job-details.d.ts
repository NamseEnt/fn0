 ...
 */
export interface CreateStreamJobDetails {
    /**
...
export declare namespace CreateStreamJobDetails {
    function getJsonObj(obj: CreateStreamJobDetails): object;
    function getDeserializedJsonObj(obj: CreateStreamJobDetails): object;
}

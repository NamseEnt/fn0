...
exports.ModelCollection = exports.Model = exports.Line = exports.Landmark = exports.Label = exports.InputLocation = exports.ImageText = exports.ImageObject = exports.ImageJob = exports.ImageFeature = exports.ImageDetails = exports.FieldValue = exports.FieldName = exports.FieldLabel = exports.Face = exports.DocumentType = exports.DocumentMetadata = exports.DocumentLanguage = exports.DocumentJob = exports.DocumentField = exports.DocumentFeature = exports.DocumentDetails = exports.Dimensions = exports.DetectedLanguage = exports.DetectedDocumentType = exports.Dataset = exports.CreateVisionPrivateEndpointDetails = exports.CreateVideoJobDetails = exports.CreateStreamSourceDetails = exports.CreateStreamJobDetails = exports.CreateStreamGroupDetails = exports.CreateProjectDetails = exports.CreateModelDetails = exports.CreateImageJobDetails = exports.CreateDocumentJobDetails = exports.ChangeVisionPrivateEndpointCompartmentDetails = exports.ChangeStreamSourceCompartmentDetails = exports.ChangeStreamJobCompartmentDetails = exports.ChangeStreamGroupCompartmentDetails = exports.ChangeProjectCompartmentDetails = exports.ChangeModelCompartmentDetails = exports.Cell = exports.BoundingPolygon = exports.AnalyzeVideoStreamResult = exports.AnalyzeVideoResult = exports.AnalyzeImageResult = exports.AnalyzeImageDetails = exports.AnalyzeDocumentResult = exports.AnalyzeDocumentDetails = exports.ActionType = void 0;
exports.VideoSegment = exports.VideoObjectSegment = exports.VideoObjectFrame = exports.VideoObject = exports.VideoMetadata = exports.VideoLabelSegment = exports.VideoLabel = exports.VideoJob = exports.VideoFeature = exports.VideoFaceSegment = exports.VideoFaceFrame = exports.VideoFace = exports.UpdateVisionPrivateEndpointDetails = exports.UpdateStreamSourceDetails = exports.UpdateStreamJobDetails = exports.UpdateStreamGroupDetails = exports.UpdateProjectDetails = exports.UpdateModelDetails = exports.TrackingType = exports.TableRow = exports.Table = exports.StreamSourceSummary = exports.StreamSourceDetails = exports.StreamSourceCollection = exports.StreamSource = exports.StreamOutputLocation = exports.StreamNetworkAccessDetails = exports.StreamJobSummary = exports.StreamJobCollection = exports.StreamJob = exports.StreamGroupSummary = exports.StreamGroupOverlap = exports.StreamGroupCollection = exports.StreamGroup = exports.SortOrder = exports.ProjectSummary = exports.ProjectCollection = exports.Project = exports.ProcessingError = exports.Page = exports.OutputLocation = exports.OperationType = exports.OperationStatus = exports.OntologyClass = exports.ObjectProperty = exports.ObjectProperties = exports.ObjectLocation = exports.NormalizedVertex = exports.ModelVersionDetails = exports.ModelSummary = void 0;
exports.VideoFaceDetectionFeature = exports.ValueTime = exports.ValueString = exports.ValuePhoneNumber = exports.ValueNumber = exports.ValueInteger = exports.ValueDate = exports.ValueArray = exports.RtspSourceDetails = exports.PrivateStreamNetworkAccessDetails = exports.ObjectStorageOutputLocation = exports.ObjectStorageImageDetails = exports.ObjectStorageDocumentDetails = exports.ObjectStorageDataset = exports.ObjectListInlineInputLocation = exports.InlineImageDetails = exports.InlineDocumentDetails = exports.ImageTextDetectionFeature = exports.ImageObjectDetectionFeature = exports.ImageClassificationFeature = exports.FaceEmbeddingFeature = exports.FaceDetectionFeature = exports.DocumentTextDetectionFeature = exports.DocumentTableDetectionFeature = exports.DocumentLanguageClassificationFeature = exports.DocumentKeyValueDetectionFeature = exports.DocumentClassificationFeature = exports.DataScienceLabelingDataset = exports.WorkRequestSummaryCollection = exports.WorkRequestSummary = exports.WorkRequestResource = exports.WorkRequestLogEntryCollection = exports.WorkRequestLogEntry = exports.WorkRequestErrorCollection = exports.WorkRequestError = exports.WorkRequest = exports.Word = exports.VisionPrivateEndpointSummary = exports.VisionPrivateEndpointCollection = exports.VisionPrivateEndpoint = exports.VideoTrackingFrame = exports.VideoTrackedObjectSegment = exports.VideoTrackedObjectProperties = exports.VideoTrackedObject = exports.VideoTextSegment = exports.VideoTextFrame = exports.VideoText = exports.VideoStreamObject = exports.VideoStreamMetadata = exports.VideoStreamFeature = void 0;
exports.VideoTextDetectionFeature = exports.VideoStreamObjectTrackingFeature = exports.VideoStreamObjectDetectionFeature = exports.VideoStreamFaceDetectionFeature = exports.VideoObjectTrackingFeature = exports.VideoObjectDetectionFeature = exports.VideoLabelDetectionFeature = void 0;
...
const AnalyzeImageDetails = __importStar(require("./analyze-image-details"));
...
const AnalyzeVideoStreamResult = __importStar(require("./analyze-video-stream-result"));
exports.AnalyzeVideoStreamResult = AnalyzeVideoStreamResult.AnalyzeVideoStreamResult;
...
const ChangeStreamGroupCompartmentDetails = __importStar(require("./change-stream-group-compartment-details"));
exports.ChangeStreamGroupCompartmentDetails = ChangeStreamGroupCompartmentDetails.ChangeStreamGroupCompartmentDetails;
const ChangeStreamJobCompartmentDetails = __importStar(require("./change-stream-job-compartment-details"));
exports.ChangeStreamJobCompartmentDetails = ChangeStreamJobCompartmentDetails.ChangeStreamJobCompartmentDetails;
const ChangeStreamSourceCompartmentDetails = __importStar(require("./change-stream-source-compartment-details"));
exports.ChangeStreamSourceCompartmentDetails = ChangeStreamSourceCompartmentDetails.ChangeStreamSourceCompartmentDetails;
const ChangeVisionPrivateEndpointCompartmentDetails = __importStar(require("./change-vision-private-endpoint-compartment-details"));
exports.ChangeVisionPrivateEndpointCompartmentDetails = ChangeVisionPrivateEndpointCompartmentDetails.ChangeVisionPrivateEndpointCompartmentDetails;
const CreateDocumentJobDetails = __importStar(require("./create-document-job-details"));
exports.CreateDocumentJobDetails = CreateDocumentJobDetails.CreateDocumentJobDetails;
const CreateImageJobDetails = __importStar(require("./create-image-job-details"));
exports.CreateImageJobDetails = CreateImageJobDetails.CreateImageJobDetails;
...
const CreateStreamGroupDetails = __importStar(require("./create-stream-group-details"));
exports.CreateStreamGroupDetails = CreateStreamGroupDetails.CreateStreamGroupDetails;
const CreateStreamJobDetails = __importStar(require("./create-stream-job-details"));
exports.CreateStreamJobDetails = CreateStreamJobDetails.CreateStreamJobDetails;
const CreateStreamSourceDetails = __importStar(require("./create-stream-source-details"));
exports.CreateStreamSourceDetails = CreateStreamSourceDetails.CreateStreamSourceDetails;
...
const CreateVisionPrivateEndpointDetails = __importStar(require("./create-vision-private-endpoint-details"));
exports.CreateVisionPrivateEndpointDetails = CreateVisionPrivateEndpointDetails.CreateVisionPrivateEndpointDetails;
...
exports.DocumentField = DocumentField.DocumentField;
const DocumentJob = __importStar(require("./document-job"));
exports.DocumentJob = DocumentJob.DocumentJob;
const DocumentLanguage = __importStar(require("./document-language"));
exports.DocumentLanguage = DocumentLanguage.DocumentLanguage;
const DocumentMetadata = __importStar(require("./document-metadata"));
...
const ImageFeature = __importStar(require("./image-feature"));
exports.ImageFeature = ImageFeature.ImageFeature;
const ImageJob = __importStar(require("./image-job"));
exports.ImageJob = ImageJob.ImageJob;
const ImageObject = __importStar(require("./image-object"));
exports.ImageObject = ImageObject.ImageObject;
const ImageText = __importStar(require("./image-text"));
exports.ImageText = ImageText.ImageText;
...
const ModelVersionDetails = __importStar(require("./model-version-details"));
exports.ModelVersionDetails = ModelVersionDetails.ModelVersionDetails;
...
const ObjectProperties = __importStar(require("./object-properties"));
exports.ObjectProperties = ObjectProperties.ObjectProperties;
...
const StreamGroup = __importStar(require("./stream-group"));
exports.StreamGroup = StreamGroup.StreamGroup;
const StreamGroupCollection = __importStar(require("./stream-group-collection"));
exports.StreamGroupCollection = StreamGroupCollection.StreamGroupCollection;
const StreamGroupOverlap = __importStar(require("./stream-group-overlap"));
exports.StreamGroupOverlap = StreamGroupOverlap.StreamGroupOverlap;
const StreamGroupSummary = __importStar(require("./stream-group-summary"));
exports.StreamGroupSummary = StreamGroupSummary.StreamGroupSummary;
const StreamJob = __importStar(require("./stream-job"));
exports.StreamJob = StreamJob.StreamJob;
const StreamJobCollection = __importStar(require("./stream-job-collection"));
exports.StreamJobCollection = StreamJobCollection.StreamJobCollection;
const StreamJobSummary = __importStar(require("./stream-job-summary"));
exports.StreamJobSummary = StreamJobSummary.StreamJobSummary;
const StreamNetworkAccessDetails = __importStar(require("./stream-network-access-details"));
exports.StreamNetworkAccessDetails = StreamNetworkAccessDetails.StreamNetworkAccessDetails;
const StreamOutputLocation = __importStar(require("./stream-output-location"));
exports.StreamOutputLocation = StreamOutputLocation.StreamOutputLocation;
const StreamSource = __importStar(require("./stream-source"));
exports.StreamSource = StreamSource.StreamSource;
const StreamSourceCollection = __importStar(require("./stream-source-collection"));
exports.StreamSourceCollection = StreamSourceCollection.StreamSourceCollection;
const StreamSourceDetails = __importStar(require("./stream-source-details"));
exports.StreamSourceDetails = StreamSourceDetails.StreamSourceDetails;
const StreamSourceSummary = __importStar(require("./stream-source-summary"));
exports.StreamSourceSummary = StreamSourceSummary.StreamSourceSummary;
...
const TrackingType = __importStar(require("./tracking-type"));
exports.TrackingType = TrackingType.TrackingType;
...
const UpdateStreamGroupDetails = __importStar(require("./update-stream-group-details"));
exports.UpdateStreamGroupDetails = UpdateStreamGroupDetails.UpdateStreamGroupDetails;
const UpdateStreamJobDetails = __importStar(require("./update-stream-job-details"));
exports.UpdateStreamJobDetails = UpdateStreamJobDetails.UpdateStreamJobDetails;
const UpdateStreamSourceDetails = __importStar(require("./update-stream-source-details"));
exports.UpdateStreamSourceDetails = UpdateStreamSourceDetails.UpdateStreamSourceDetails;
const UpdateVisionPrivateEndpointDetails = __importStar(require("./update-vision-private-endpoint-details"));
exports.UpdateVisionPrivateEndpointDetails = UpdateVisionPrivateEndpointDetails.UpdateVisionPrivateEndpointDetails;
...
const VideoStreamFeature = __importStar(require("./video-stream-feature"));
exports.VideoStreamFeature = VideoStreamFeature.VideoStreamFeature;
const VideoStreamMetadata = __importStar(require("./video-stream-metadata"));
exports.VideoStreamMetadata = VideoStreamMetadata.VideoStreamMetadata;
const VideoStreamObject = __importStar(require("./video-stream-object"));
exports.VideoStreamObject = VideoStreamObject.VideoStreamObject;
...
const VisionPrivateEndpoint = __importStar(require("./vision-private-endpoint"));
exports.VisionPrivateEndpoint = VisionPrivateEndpoint.VisionPrivateEndpoint;
const VisionPrivateEndpointCollection = __importStar(require("./vision-private-endpoint-collection"));
exports.VisionPrivateEndpointCollection = VisionPrivateEndpointCollection.VisionPrivateEndpointCollection;
const VisionPrivateEndpointSummary = __importStar(require("./vision-private-endpoint-summary"));
exports.VisionPrivateEndpointSummary = VisionPrivateEndpointSummary.VisionPrivateEndpointSummary;
...
const DocumentKeyValueDetectionFeature = __importStar(require("./document-key-value-detection-feature"));
exports.DocumentKeyValueDetectionFeature = DocumentKeyValueDetectionFeature.DocumentKeyValueDetectionFeature;
const DocumentLanguageClassificationFeature = __importStar(require("./document-language-classification-feature"));
exports.DocumentLanguageClassificationFeature = DocumentLanguageClassificationFeature.DocumentLanguageClassificationFeature;
const DocumentTableDetectionFeature = __importStar(require("./document-table-detection-feature"));
...
const FaceEmbeddingFeature = __importStar(require("./face-embedding-feature"));
exports.FaceEmbeddingFeature = FaceEmbeddingFeature.FaceEmbeddingFeature;
...
exports.ImageObjectDetectionFeature = ImageObjectDetectionFeature.ImageObjectDetectionFeature;
const ImageTextDetectionFeature = __importStar(require("./image-text-detection-feature"));
exports.ImageTextDetectionFeature = ImageTextDetectionFeature.ImageTextDetectionFeature;
...
const InlineImageDetails = __importStar(require("./inline-image-details"));
exports.InlineImageDetails = InlineImageDetails.InlineImageDetails;
const ObjectListInlineInputLocation = __importStar(require("./object-list-inline-input-location"));
exports.ObjectListInlineInputLocation = ObjectListInlineInputLocation.ObjectListInlineInputLocation;
...
const ObjectStorageImageDetails = __importStar(require("./object-storage-image-details"));
exports.ObjectStorageImageDetails = ObjectStorageImageDetails.ObjectStorageImageDetails;
const ObjectStorageOutputLocation = __importStar(require("./object-storage-output-location"));
exports.ObjectStorageOutputLocation = ObjectStorageOutputLocation.ObjectStorageOutputLocation;
const PrivateStreamNetworkAccessDetails = __importStar(require("./private-stream-network-access-details"));
exports.PrivateStreamNetworkAccessDetails = PrivateStreamNetworkAccessDetails.PrivateStreamNetworkAccessDetails;
const RtspSourceDetails = __importStar(require("./rtsp-source-details"));
exports.RtspSourceDetails = RtspSourceDetails.RtspSourceDetails;
...
exports.ValueDate = ValueDate.ValueDate;
const ValueInteger = __importStar(require("./value-integer"));
exports.ValueInteger = ValueInteger.ValueInteger;
const ValueNumber = __importStar(require("./value-number"));
exports.ValueNumber = ValueNumber.ValueNumber;
const ValuePhoneNumber = __importStar(require("./value-phone-number"));
exports.ValuePhoneNumber = ValuePhoneNumber.ValuePhoneNumber;
const ValueString = __importStar(require("./value-string"));
...
const VideoStreamFaceDetectionFeature = __importStar(require("./video-stream-face-detection-feature"));
exports.VideoStreamFaceDetectionFeature = VideoStreamFaceDetectionFeature.VideoStreamFaceDetectionFeature;
const VideoStreamObjectDetectionFeature = __importStar(require("./video-stream-object-detection-feature"));
exports.VideoStreamObjectDetectionFeature = VideoStreamObjectDetectionFeature.VideoStreamObjectDetectionFeature;
const VideoStreamObjectTrackingFeature = __importStar(require("./video-stream-object-tracking-feature"));
exports.VideoStreamObjectTrackingFeature = VideoStreamObjectTrackingFeature.VideoStreamObjectTrackingFeature;

 ...
 */
export interface CreateVisionPrivateEndpointDetails {
    /**
...
export declare namespace CreateVisionPrivateEndpointDetails {
    function getJsonObj(obj: CreateVisionPrivateEndpointDetails): object;
    function getDeserializedJsonObj(obj: CreateVisionPrivateEndpointDetails): object;
}

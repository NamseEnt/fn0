...
export declare namespace CreateModelDetails {
    function getJsonObj(obj: CreateModelDetails): object;
    function getDeserializedJsonObj(obj: CreateModelDetails): object;
}

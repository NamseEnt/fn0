...
(function (InputLocation) {
        ...
        if (obj && "sourceType" in obj && obj.sourceType) {
            switch (obj.sourceType) {
                case "INLINE_DOCUMENT_CONTENT":
                    return model.InlineDocumentContent.getJsonObj(jsonObj, true);
                case "OBJECT_STORAGE_LOCATIONS":
                    return model.ObjectStorageLocations.getJsonObj(jsonObj, true);
                default:
    ...
    function getDeserializedJsonObj(obj) {
        ...
        if (obj && "sourceType" in obj && obj.sourceType) {
            switch (obj.sourceType) {
                case "INLINE_DOCUMENT_CONTENT":
                    return model.InlineDocumentContent.getDeserializedJsonObj(jsonObj, true);
                case "OBJECT_STORAGE_LOCATIONS":
                    return model.ObjectStorageLocations.getDeserializedJsonObj(jsonObj, true);
                default:
                    if (common.LOG.logger)
                        common.LOG.logger.info(`Unknown value for: ${obj.sourceType}`);
            }

...
export declare namespace GeneralProcessorConfig {
    function getJsonObj(obj: GeneralProcessorConfig, isParentJsonObj?: boolean): object;
    const processorType = "GENERAL";
    function getDeserializedJsonObj(obj: GeneralProcessorConfig, isParentJsonObj?: boolean): object;
}

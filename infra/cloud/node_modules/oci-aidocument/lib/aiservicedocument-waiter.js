...
exports.AIServiceDocumentWaiter = void 0;
const models = __importStar(require("./model"));
const oci_common_1 = require("oci-common");
class AIServiceDocumentWaiter {
     ...
     */
    forProcessorJob(request, ...targetStates) {
        return __awaiter(this, void 0, void 0, function* () {
            return oci_common_1.genericWaiter(this.config, () => this.client.getProcessorJob(request), response => targetStates.includes(response.processorJob.lifecycleState));
        });
    }
    /**
...
exports.AIServiceDocumentWaiter = AIServiceDocumentWaiter;
//# sourceMappingURL=aiservicedocument-waiter.js.map
...
export declare namespace ConnectHarnessSummary {
    enum LifecycleState {
        Creating = "CREATING",
        Active = "ACTIVE",
        Deleting = "DELETING",
    ...
    function getJsonObj(obj: ConnectHarnessSummary): object;
    function getDeserializedJsonObj(obj: ConnectHarnessSummary): object;
}

...
export declare namespace PutMessagesDetails {
    function getJsonObj(obj: PutMessagesDetails): object;
    function getDeserializedJsonObj(obj: PutMessagesDetails): object;
}

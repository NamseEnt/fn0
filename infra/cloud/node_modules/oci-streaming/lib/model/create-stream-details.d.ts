...
export declare namespace CreateStreamDetails {
    function getJsonObj(obj: CreateStreamDetails): object;
    function getDeserializedJsonObj(obj: CreateStreamDetails): object;
}

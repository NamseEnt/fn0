...
export declare namespace StreamPoolSummary {
    enum LifecycleState {
        Creating = "CREATING",
        Active = "ACTIVE",
        Deleting = "DELETING",
    ...
    function getJsonObj(obj: StreamPoolSummary): object;
    function getDeserializedJsonObj(obj: StreamPoolSummary): object;
}

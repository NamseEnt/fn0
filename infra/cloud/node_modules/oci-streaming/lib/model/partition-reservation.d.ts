...
export declare namespace PartitionReservation {
    function getJsonObj(obj: PartitionReservation): object;
    function getDeserializedJsonObj(obj: PartitionReservation): object;
}

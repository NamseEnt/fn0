...
(function (AuthenticationMode) {
    function getJsonObj(obj) {
        ...
        if (obj && "authenticationType" in obj && obj.authenticationType) {
            switch (obj.authenticationType) {
                case "IAM":
                    return model.IamAuthenticationMode.getJsonObj(jsonObj, true);
                case "PASSWORD":
                    return model.PasswordAuthenticationMode.getJsonObj(jsonObj, true);
                default:
    ...
    AuthenticationMode.getJsonObj = getJsonObj;
    function getDeserializedJsonObj(obj) {
        const jsonObj = Object.assign(Object.assign({}, obj), {});
        if (obj && "authenticationType" in obj && obj.authenticationType) {
            switch (obj.authenticationType) {
                case "IAM":
                    return model.IamAuthenticationMode.getDeserializedJsonObj(jsonObj, true);
                case "PASSWORD":
                    return model.PasswordAuthenticationMode.getDeserializedJsonObj(jsonObj, true);
                default:
                    if (common.LOG.logger)
                        common.LOG.logger.info(`Unknown value for: ${obj.authenticationType}`);
            }
    ...
    AuthenticationMode.getDeserializedJsonObj = getDeserializedJsonObj;
})(AuthenticationMode = exports.AuthenticationMode || (exports.AuthenticationMode = {}));
//# sourceMappingURL=authentication-mode.js.map
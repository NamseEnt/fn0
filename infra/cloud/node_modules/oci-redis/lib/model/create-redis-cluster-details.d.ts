...
export declare namespace CreateRedisClusterDetails {
    function getJsonObj(obj: CreateRedisClusterDetails): object;
    function getDeserializedJsonObj(obj: CreateRedisClusterDetails): object;
}

 ...
 */
export interface OciCacheEngineOptionSummary {
    /**
     * List of available engine versions
     */
    "engineVersions": Array<model.EngineVersion>;
}
export declare namespace OciCacheEngineOptionSummary {
    function getJsonObj(obj: OciCacheEngineOptionSummary): object;
    function getDeserializedJsonObj(obj: OciCacheEngineOptionSummary): object;
}

 ...
 */
export interface AttachOciCacheUsersDetails {
    /**
     * List of OCI cache user unique IDs (OCIDs).
     */
    "ociCacheUsers": Array<string>;
}
export declare namespace AttachOciCacheUsersDetails {
    function getJsonObj(obj: AttachOciCacheUsersDetails): object;
    function getDeserializedJsonObj(obj: AttachOciCacheUsersDetails): object;
}

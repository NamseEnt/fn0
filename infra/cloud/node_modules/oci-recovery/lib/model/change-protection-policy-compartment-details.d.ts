...
export declare namespace ChangeProtectionPolicyCompartmentDetails {
    function getJsonObj(obj: ChangeProtectionPolicyCompartmentDetails): object;
    function getDeserializedJsonObj(obj: ChangeProtectionPolicyCompartmentDetails): object;
}

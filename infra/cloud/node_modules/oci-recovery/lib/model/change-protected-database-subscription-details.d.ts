...
export declare namespace ChangeProtectedDatabaseSubscriptionDetails {
    function getJsonObj(obj: ChangeProtectedDatabaseSubscriptionDetails): object;
    function getDeserializedJsonObj(obj: ChangeProtectedDatabaseSubscriptionDetails): object;
}

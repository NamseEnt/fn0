...
export declare namespace LoadBalancerBackendSetMapping {
    function getJsonObj(obj: LoadBalancerBackendSetMapping): object;
    function getDeserializedJsonObj(obj: LoadBalancerBackendSetMapping): object;
}

...
export declare namespace CreateDrPlanDetails {
    function getJsonObj(obj: CreateDrPlanDetails): object;
    function getDeserializedJsonObj(obj: CreateDrPlanDetails): object;
}

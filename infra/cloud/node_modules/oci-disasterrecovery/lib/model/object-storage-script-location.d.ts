 ...
 */
export interface ObjectStorageScriptLocation {
    /**
...
export declare namespace ObjectStorageScriptLocation {
    function getJsonObj(obj: ObjectStorageScriptLocation): object;
    function getDeserializedJsonObj(obj: ObjectStorageScriptLocation): object;
}

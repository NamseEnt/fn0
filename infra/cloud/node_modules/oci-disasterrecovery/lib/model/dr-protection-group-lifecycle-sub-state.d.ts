...
export declare namespace DrProtectionGroupLifecycleSubState {
    function getJsonObj(obj: DrProtectionGroupLifecycleSubState): DrProtectionGroupLifecycleSubState;
    function getDeserializedJsonObj(obj: DrProtectionGroupLifecycleSubState): DrProtectionGroupLifecycleSubState;
}

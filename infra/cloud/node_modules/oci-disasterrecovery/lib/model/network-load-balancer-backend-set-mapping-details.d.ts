...
export declare namespace NetworkLoadBalancerBackendSetMappingDetails {
    function getJsonObj(obj: NetworkLoadBalancerBackendSetMappingDetails): object;
    function getDeserializedJsonObj(obj: NetworkLoadBalancerBackendSetMappingDetails): object;
}

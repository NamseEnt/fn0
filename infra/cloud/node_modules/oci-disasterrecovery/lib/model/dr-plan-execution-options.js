...
(function (DrPlanExecutionOptions) {
    function getJsonObj(obj) {
        ...
        if (obj && "planExecutionType" in obj && obj.planExecutionType) {
            switch (obj.planExecutionType) {
                case "STOP_DRILL":
                    return model.StopDrillExecutionOptions.getJsonObj(jsonObj, true);
                case "SWITCHOVER":
                ...
                case "START_DRILL":
                    return model.StartDrillExecutionOptions.getJsonObj(jsonObj, true);
                case "SWITCHOVER_PRECHECK":
                    return model.SwitchoverPrecheckExecutionOptions.getJsonObj(jsonObj, true);
                case "START_DRILL_PRECHECK":
                    return model.StartDrillPrecheckExecutionOptions.getJsonObj(jsonObj, true);
                case "STOP_DRILL_PRECHECK":
                    return model.StopDrillPrecheckExecutionOptions.getJsonObj(jsonObj, true);
                case "FAILOVER":
    ...
    function getDeserializedJsonObj(obj) {
        ...
        if (obj && "planExecutionType" in obj && obj.planExecutionType) {
            switch (obj.planExecutionType) {
                case "STOP_DRILL":
                    return model.StopDrillExecutionOptions.getDeserializedJsonObj(jsonObj, true);
                case "SWITCHOVER":
                ...
                case "START_DRILL":
                    return model.StartDrillExecutionOptions.getDeserializedJsonObj(jsonObj, true);
                case "SWITCHOVER_PRECHECK":
                    return model.SwitchoverPrecheckExecutionOptions.getDeserializedJsonObj(jsonObj, true);
                case "START_DRILL_PRECHECK":
                    return model.StartDrillPrecheckExecutionOptions.getDeserializedJsonObj(jsonObj, true);
                case "STOP_DRILL_PRECHECK":
                    return model.StopDrillPrecheckExecutionOptions.getDeserializedJsonObj(jsonObj, true);
                case "FAILOVER":

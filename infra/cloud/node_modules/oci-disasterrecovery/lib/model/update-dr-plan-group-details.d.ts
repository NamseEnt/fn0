...
export declare namespace UpdateDrPlanGroupDetails {
    function getJsonObj(obj: UpdateDrPlanGroupDetails): object;
    function getDeserializedJsonObj(obj: UpdateDrPlanGroupDetails): object;
}

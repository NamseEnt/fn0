 ...
 *
 **/
export declare enum AutonomousContainerDatabaseSnapshotStandbyConnectionStringType {
...
export declare namespace AutonomousContainerDatabaseSnapshotStandbyConnectionStringType {
    function getJsonObj(obj: AutonomousContainerDatabaseSnapshotStandbyConnectionStringType): AutonomousContainerDatabaseSnapshotStandbyConnectionStringType;
    function getDeserializedJsonObj(obj: AutonomousContainerDatabaseSnapshotStandbyConnectionStringType): AutonomousContainerDatabaseSnapshotStandbyConnectionStringType;
}

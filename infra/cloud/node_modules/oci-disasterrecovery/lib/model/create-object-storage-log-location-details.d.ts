...
export declare namespace CreateObjectStorageLogLocationDetails {
    function getJsonObj(obj: CreateObjectStorageLogLocationDetails): object;
    function getDeserializedJsonObj(obj: CreateObjectStorageLogLocationDetails): object;
}

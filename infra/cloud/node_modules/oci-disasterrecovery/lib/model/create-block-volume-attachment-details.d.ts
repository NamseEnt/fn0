...
export declare namespace CreateBlockVolumeAttachmentDetails {
    function getJsonObj(obj: CreateBlockVolumeAttachmentDetails): object;
    function getDeserializedJsonObj(obj: CreateBlockVolumeAttachmentDetails): object;
}

...
export declare namespace RetryDrPlanExecutionDetails {
    function getJsonObj(obj: RetryDrPlanExecutionDetails): object;
    function getDeserializedJsonObj(obj: RetryDrPlanExecutionDetails): object;
}

 ...
 *
 **/
export declare enum DrPlanExecutionLifecycleState {
    Accepted = "ACCEPTED",
...
export declare namespace DrPlanExecutionLifecycleState {
    function getJsonObj(obj: DrPlanExecutionLifecycleState): DrPlanExecutionLifecycleState;
    function getDeserializedJsonObj(obj: DrPlanExecutionLifecycleState): DrPlanExecutionLifecycleState;
}

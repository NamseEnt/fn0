 ...
 */
export interface CreateDrProtectionGroupMemberComputeInstanceMovableDetails extends model.CreateDrProtectionGroupMemberDetails {
    /**
  ...
  *
     ...
     *
     */
    "fileSystemOperations"?: Array<model.CreateComputeInstanceMovableFileSystemOperationDetails>;
    "memberType": string;
}
export declare namespace CreateDrProtectionGroupMemberComputeInstanceMovableDetails {
    function getJsonObj(obj: CreateDrProtectionGroupMemberComputeInstanceMovableDetails, isParentJsonObj?: boolean): object;
    const memberType = "COMPUTE_INSTANCE_MOVABLE";
    function getDeserializedJsonObj(obj: CreateDrProtectionGroupMemberComputeInstanceMovableDetails, isParentJsonObj?: boolean): object;
}

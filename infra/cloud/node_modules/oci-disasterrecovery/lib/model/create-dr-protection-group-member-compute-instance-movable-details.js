...
(function (CreateDrProtectionGroupMemberComputeInstanceMovableDetails) {
        ...
        const jsonObj = Object.assign(Object.assign({}, (isParentJsonObj
            ...
            "fileSystemOperations": obj.fileSystemOperations
                ? obj.fileSystemOperations.map(item => {
                    return model.CreateComputeInstanceMovableFileSystemOperationDetails.getJsonObj(item);
                })
                : undefined
        });
        return jsonObj;
    ...
    function getDeserializedJsonObj(obj, isParentJsonObj) {
        const jsonObj = Object.assign(Object.assign({}, (isParentJsonObj
            ...
            "fileSystemOperations": obj.fileSystemOperations
                ? obj.fileSystemOperations.map(item => {
                    return model.CreateComputeInstanceMovableFileSystemOperationDetails.getDeserializedJsonObj(item);
                })
                : undefined
        });
        return jsonObj;

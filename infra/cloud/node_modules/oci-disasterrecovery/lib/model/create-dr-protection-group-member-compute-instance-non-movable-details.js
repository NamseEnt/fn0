...
(function (CreateDrProtectionGroupMemberComputeInstanceNonMovableDetails) {
        ...
        const jsonObj = Object.assign(Object.assign({}, (isParentJsonObj
            ...
            "fileSystemOperations": obj.fileSystemOperations
                ? obj.fileSystemOperations.map(item => {
                    return model.CreateComputeInstanceNonMovableFileSystemOperationDetails.getJsonObj(item);
                })
                : undefined,
    ...
    function getDeserializedJsonObj(obj, isParentJsonObj) {
        const jsonObj = Object.assign(Object.assign({}, (isParentJsonObj
            ...
            "fileSystemOperations": obj.fileSystemOperations
                ? obj.fileSystemOperations.map(item => {
                    return model.CreateComputeInstanceNonMovableFileSystemOperationDetails.getDeserializedJsonObj(item);
                })
                : undefined,
            "blockVolumeOperations": obj.blockVolumeOperations
                ? obj.blockVolumeOperations.map(item => {

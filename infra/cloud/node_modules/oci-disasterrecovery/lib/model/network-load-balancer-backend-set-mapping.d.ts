...
export declare namespace NetworkLoadBalancerBackendSetMapping {
    function getJsonObj(obj: NetworkLoadBalancerBackendSetMapping): object;
    function getDeserializedJsonObj(obj: NetworkLoadBalancerBackendSetMapping): object;
}

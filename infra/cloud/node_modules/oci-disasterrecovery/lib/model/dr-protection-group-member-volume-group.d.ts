...
export declare namespace DrProtectionGroupMemberVolumeGroup {
    function getJsonObj(obj: DrProtectionGroupMemberVolumeGroup, isParentJsonObj?: boolean): object;
    const memberType = "VOLUME_GROUP";
    function getDeserializedJsonObj(obj: DrProtectionGroupMemberVolumeGroup, isParentJsonObj?: boolean): object;
}

...
export declare namespace DrProtectionGroupMemberComputeInstance {
    function getJsonObj(obj: DrProtectionGroupMemberComputeInstance, isParentJsonObj?: boolean): object;
    const memberType = "COMPUTE_INSTANCE";
    function getDeserializedJsonObj(obj: DrProtectionGroupMemberComputeInstance, isParentJsonObj?: boolean): object;
}

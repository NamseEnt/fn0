...
export declare namespace ComputeInstanceMovableVnicMappingDetails {
    function getJsonObj(obj: ComputeInstanceMovableVnicMappingDetails): object;
    function getDeserializedJsonObj(obj: ComputeInstanceMovableVnicMappingDetails): object;
}

...
export declare namespace FailoverExecutionOptionDetails {
    function getJsonObj(obj: FailoverExecutionOptionDetails, isParentJsonObj?: boolean): object;
    const planExecutionType = "FAILOVER";
    function getDeserializedJsonObj(obj: FailoverExecutionOptionDetails, isParentJsonObj?: boolean): object;
}

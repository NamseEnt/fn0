 ...
 */
export interface AutomaticDrConfigurationMemberAutonomousContainerDatabase extends model.AutomaticDrConfigurationMember {
    /**
...
export declare namespace AutomaticDrConfigurationMemberAutonomousContainerDatabase {
    function getJsonObj(obj: AutomaticDrConfigurationMemberAutonomousContainerDatabase, isParentJsonObj?: boolean): object;
    const memberType = "AUTONOMOUS_CONTAINER_DATABASE";
    function getDeserializedJsonObj(obj: AutomaticDrConfigurationMemberAutonomousContainerDatabase, isParentJsonObj?: boolean): object;
}

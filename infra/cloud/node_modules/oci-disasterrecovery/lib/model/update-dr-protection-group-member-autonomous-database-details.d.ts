 ...
 */
export interface UpdateDrProtectionGroupMemberAutonomousDatabaseDetails extends model.UpdateDrProtectionGroupMemberDetails {
    /**
...
export declare namespace UpdateDrProtectionGroupMemberAutonomousDatabaseDetails {
    function getJsonObj(obj: UpdateDrProtectionGroupMemberAutonomousDatabaseDetails, isParentJsonObj?: boolean): object;
    const memberType = "AUTONOMOUS_DATABASE";
    function getDeserializedJsonObj(obj: UpdateDrProtectionGroupMemberAutonomousDatabaseDetails, isParentJsonObj?: boolean): object;
}

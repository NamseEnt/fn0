 ...
 *
 */
export interface UpdateRunLocalScriptUserDefinedStepDetails extends model.UpdateDrPlanUserDefinedStepDetails {
    /**
...
export declare namespace UpdateRunLocalScriptUserDefinedStepDetails {
    function getJsonObj(obj: UpdateRunLocalScriptUserDefinedStepDetails, isParentJsonObj?: boolean): object;
    const stepType = "RUN_LOCAL_SCRIPT";
    function getDeserializedJsonObj(obj: UpdateRunLocalScriptUserDefinedStepDetails, isParentJsonObj?: boolean): object;
}

...
export declare namespace DrProtectionGroup {
    function getJsonObj(obj: DrProtectionGroup): object;
    function getDeserializedJsonObj(obj: DrProtectionGroup): object;
}

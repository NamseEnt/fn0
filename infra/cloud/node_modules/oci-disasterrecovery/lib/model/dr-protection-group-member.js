        ...
        if (obj && "memberType" in obj && obj.memberType) {
            switch (obj.memberType) {
                ...
                case "MYSQL_DB_SYSTEM":
                    return model.DrProtectionGroupMemberMySqlDbSystem.getJsonObj(jsonObj, true);
    ...
    function getDeserializedJsonObj(obj) {
        ...
        if (obj && "memberType" in obj && obj.memberType) {
            switch (obj.memberType) {
                ...
                case "MYSQL_DB_SYSTEM":
                    return model.DrProtectionGroupMemberMySqlDbSystem.getDeserializedJsonObj(jsonObj, true);
                case "AUTONOMOUS_DATABASE":

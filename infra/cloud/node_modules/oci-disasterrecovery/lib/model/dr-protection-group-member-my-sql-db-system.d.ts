...
export declare namespace DrProtectionGroupMemberMySqlDbSystem {
    function getJsonObj(obj: DrProtectionGroupMemberMySqlDbSystem, isParentJsonObj?: boolean): object;
    const memberType = "MYSQL_DB_SYSTEM";
    function getDeserializedJsonObj(obj: DrProtectionGroupMemberMySqlDbSystem, isParentJsonObj?: boolean): object;
}

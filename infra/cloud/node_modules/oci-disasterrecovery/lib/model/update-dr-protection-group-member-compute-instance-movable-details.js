...
(function (UpdateDrProtectionGroupMemberComputeInstanceMovableDetails) {
        ...
        const jsonObj = Object.assign(Object.assign({}, (isParentJsonObj
            ...
            "fileSystemOperations": obj.fileSystemOperations
                ? obj.fileSystemOperations.map(item => {
                    return model.UpdateComputeInstanceMovableFileSystemOperationDetails.getJsonObj(item);
                })
                : undefined
        });
        return jsonObj;
    ...
    function getDeserializedJsonObj(obj, isParentJsonObj) {
        const jsonObj = Object.assign(Object.assign({}, (isParentJsonObj
            ...
            "fileSystemOperations": obj.fileSystemOperations
                ? obj.fileSystemOperations.map(item => {
                    return model.UpdateComputeInstanceMovableFileSystemOperationDetails.getDeserializedJsonObj(item);
                })
                : undefined
        });
        return jsonObj;

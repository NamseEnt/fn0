...
export declare namespace GovernanceInstanceConfiguration {
    function getJsonObj(obj: GovernanceInstanceConfiguration): object;
    function getDeserializedJsonObj(obj: GovernanceInstanceConfiguration): object;
}

...
export declare namespace ChangeGovernanceInstanceCompartmentDetails {
    function getJsonObj(obj: ChangeGovernanceInstanceCompartmentDetails): object;
    function getDeserializedJsonObj(obj: ChangeGovernanceInstanceCompartmentDetails): object;
}

...
const ListMonitoredResourceTasksRequest = __importStar(require("./list-monitored-resource-tasks-request"));
...
const RequestMonitoredResourcesSummarizedCountRequest = __importStar(require("./request-monitored-resources-summarized-count-request"));
exports.RequestMonitoredResourcesSummarizedCountRequest = RequestMonitoredResourcesSummarizedCountRequest.RequestMonitoredResourcesSummarizedCountRequest;
const SearchMonitoredResourceMembersRequest = __importStar(require("./search-monitored-resource-members-request"));
exports.SearchMonitoredResourceMembersRequest = SearchMonitoredResourceMembersRequest.SearchMonitoredResourceMembersRequest;

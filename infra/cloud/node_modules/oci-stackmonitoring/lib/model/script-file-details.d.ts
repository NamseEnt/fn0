...
export declare namespace ScriptFileDetails {
    function getJsonObj(obj: ScriptFileDetails): object;
    function getDeserializedJsonObj(obj: ScriptFileDetails): object;
}

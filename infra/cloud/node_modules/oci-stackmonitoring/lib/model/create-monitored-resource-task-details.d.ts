...
export declare namespace CreateMonitoredResourceTaskDetails {
    function getJsonObj(obj: CreateMonitoredResourceTaskDetails): object;
    function getDeserializedJsonObj(obj: CreateMonitoredResourceTaskDetails): object;
}

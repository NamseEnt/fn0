...
export declare namespace AssociatedMonitoredResource {
    function getJsonObj(obj: AssociatedMonitoredResource): object;
    function getDeserializedJsonObj(obj: AssociatedMonitoredResource): object;
}

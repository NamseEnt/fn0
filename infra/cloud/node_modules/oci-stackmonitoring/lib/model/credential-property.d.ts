...
export declare namespace CredentialProperty {
    function getJsonObj(obj: CredentialProperty): object;
    function getDeserializedJsonObj(obj: CredentialProperty): object;
}

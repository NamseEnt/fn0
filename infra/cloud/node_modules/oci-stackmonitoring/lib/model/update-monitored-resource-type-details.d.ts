...
export declare namespace UpdateMonitoredResourceTypeDetails {
    function getJsonObj(obj: UpdateMonitoredResourceTypeDetails): object;
    function getDeserializedJsonObj(obj: UpdateMonitoredResourceTypeDetails): object;
}

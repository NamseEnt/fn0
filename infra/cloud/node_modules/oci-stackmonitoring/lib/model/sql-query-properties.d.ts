...
export declare namespace SqlQueryProperties {
    function getJsonObj(obj: SqlQueryProperties, isParentJsonObj?: boolean): object;
    const collectionMethod = "SQL";
    function getDeserializedJsonObj(obj: SqlQueryProperties, isParentJsonObj?: boolean): object;
}

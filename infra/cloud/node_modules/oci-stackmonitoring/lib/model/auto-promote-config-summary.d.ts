...
export declare namespace AutoPromoteConfigSummary {
    enum ResourceType {
        Host = "HOST",
        /**
    ...
    function getJsonObj(obj: AutoPromoteConfigSummary, isParentJsonObj?: boolean): object;
    const configType = "AUTO_PROMOTE";
    function getDeserializedJsonObj(obj: AutoPromoteConfigSummary, isParentJsonObj?: boolean): object;
}

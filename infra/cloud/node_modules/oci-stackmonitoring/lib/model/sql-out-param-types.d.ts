...
export declare namespace SqlOutParamTypes {
    function getJsonObj(obj: SqlOutParamTypes): SqlOutParamTypes;
    function getDeserializedJsonObj(obj: SqlOutParamTypes): SqlOutParamTypes;
}

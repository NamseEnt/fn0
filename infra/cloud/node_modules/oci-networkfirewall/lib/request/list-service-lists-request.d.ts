...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/networkfirewall/ListServiceLists.ts.html |here} to see how to use ListServiceListsRequest.
 */
...
export declare namespace ListServiceListsRequest {
    enum SortBy {

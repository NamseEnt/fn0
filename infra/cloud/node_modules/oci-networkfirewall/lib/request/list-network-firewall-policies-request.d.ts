...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/networkfirewall/ListNetworkFirewallPolicies.ts.html |here} to see how to use ListNetworkFirewallPoliciesRequest.
 */
...
export declare namespace ListNetworkFirewallPoliciesRequest {
    enum SortBy {

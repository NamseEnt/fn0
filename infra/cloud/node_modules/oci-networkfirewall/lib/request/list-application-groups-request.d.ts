...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/networkfirewall/ListApplicationGroups.ts.html |here} to see how to use ListApplicationGroupsRequest.
 */
...
export declare namespace ListApplicationGroupsRequest {
    enum SortBy {

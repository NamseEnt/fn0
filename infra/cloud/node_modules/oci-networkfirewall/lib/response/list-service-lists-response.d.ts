...
export interface ListServiceListsResponse {
    /**
    ...
    /**
     * The returned model.ServiceListSummaryCollection instance.
     */
    "serviceListSummaryCollection": model.ServiceListSummaryCollection;
}

 ...
 */
export interface IcmpApplicationSummary extends model.ApplicationSummary {
    /**
...
export declare namespace IcmpApplicationSummary {
    function getJsonObj(obj: IcmpApplicationSummary, isParentJsonObj?: boolean): object;
    const type = "ICMP";
    function getDeserializedJsonObj(obj: IcmpApplicationSummary, isParentJsonObj?: boolean): object;
}

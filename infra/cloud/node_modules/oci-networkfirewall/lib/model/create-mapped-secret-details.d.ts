...
export declare namespace CreateMappedSecretDetails {
    function getJsonObj(obj: CreateMappedSecretDetails): object;
    function getDeserializedJsonObj(obj: CreateMappedSecretDetails): object;
}

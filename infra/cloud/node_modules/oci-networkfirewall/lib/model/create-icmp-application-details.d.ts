 ...
 */
export interface CreateIcmpApplicationDetails extends model.CreateApplicationDetails {
    /**
...
export declare namespace CreateIcmpApplicationDetails {
    function getJsonObj(obj: CreateIcmpApplicationDetails, isParentJsonObj?: boolean): object;
    const type = "ICMP";
    function getDeserializedJsonObj(obj: CreateIcmpApplicationDetails, isParentJsonObj?: boolean): object;
}

 ...
 */
export interface DecryptionProfileSummary {
    /**
     * Name of the secret.
     */
    "name": string;
...
export declare namespace DecryptionProfileSummary {
    function getJsonObj(obj: DecryptionProfileSummary): object;
    function getDeserializedJsonObj(obj: DecryptionProfileSummary): object;
}

 ...
 */
export interface Icmp6ApplicationSummary extends model.ApplicationSummary {
    /**
...
export declare namespace Icmp6ApplicationSummary {
    function getJsonObj(obj: Icmp6ApplicationSummary, isParentJsonObj?: boolean): object;
    const type = "ICMP_V6";
    function getDeserializedJsonObj(obj: Icmp6ApplicationSummary, isParentJsonObj?: boolean): object;
}

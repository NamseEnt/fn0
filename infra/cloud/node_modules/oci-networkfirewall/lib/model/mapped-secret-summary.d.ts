 ...
 */
export interface MappedSecretSummary {
    /**
     * Name of the secret.
     */
    "name": string;
...
export declare namespace MappedSecretSummary {
    function getJsonObj(obj: MappedSecretSummary): object;
    function getDeserializedJsonObj(obj: MappedSecretSummary): object;
}

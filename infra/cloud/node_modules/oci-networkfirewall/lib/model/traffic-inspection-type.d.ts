...
export declare namespace TrafficInspectionType {
    function getJsonObj(obj: TrafficInspectionType): TrafficInspectionType;
    function getDeserializedJsonObj(obj: TrafficInspectionType): TrafficInspectionType;
}

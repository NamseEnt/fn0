...
export declare namespace CreateEmailRecipientsGroupDetails {
    function getJsonObj(obj: CreateEmailRecipientsGroupDetails): object;
    function getDeserializedJsonObj(obj: CreateEmailRecipientsGroupDetails): object;
}

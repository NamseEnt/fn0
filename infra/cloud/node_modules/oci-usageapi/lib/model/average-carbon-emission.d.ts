...
export interface AverageCarbonEmission {
    ...
    /**
     * The average carbon emissions by SKU. Note: Numbers greater than Number.MAX_SAFE_INTEGER will result in rounding issues.
     */
    "averageCarbonEmission": number;
}
export declare namespace AverageCarbonEmission {
    function getJsonObj(obj: AverageCarbonEmission): object;
    function getDeserializedJsonObj(obj: AverageCarbonEmission): object;
}

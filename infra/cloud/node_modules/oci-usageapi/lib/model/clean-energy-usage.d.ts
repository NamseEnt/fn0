 ...
 * Clean energy usage.
 */
export interface CleanEnergyUsage {
    /**
     * The region.
     */
    "region": string;
    ...
    "ad"?: string;
    /**
     * The percentage of clean enery used. Note: Numbers greater than Number.MAX_SAFE_INTEGER will result in rounding issues.
     */
    "usage": number;
}
export declare namespace CleanEnergyUsage {
    function getJsonObj(obj: CleanEnergyUsage): object;
    function getDeserializedJsonObj(obj: CleanEnergyUsage): object;
}

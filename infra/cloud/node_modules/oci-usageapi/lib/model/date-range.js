...
(function (DateRange) {
    function getJsonObj(obj) {
        ...
        if (obj && "dateRangeType" in obj && obj.dateRangeType) {
            switch (obj.dateRangeType) {
                ...
                case "DYNAMIC":
                    return model.DynamicDateRange.getJsonObj(jsonObj, true);
                default:
                    if (common.LOG.logger)
                        common.LOG.logger.info(`Unknown value for: ${obj.dateRangeType}`);
            }
        }
        return jsonObj;
    }
    ...
    function getDeserializedJsonObj(obj) {
        ...
        if (obj && "dateRangeType" in obj && obj.dateRangeType) {
            switch (obj.dateRangeType) {
                ...
                case "DYNAMIC":
                    return model.DynamicDateRange.getDeserializedJsonObj(jsonObj, true);
                default:
                    if (common.LOG.logger)
                        common.LOG.logger.info(`Unknown value for: ${obj.dateRangeType}`);
            }
    ...
    DateRange.getDeserializedJsonObj = getDeserializedJsonObj;

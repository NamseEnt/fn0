 ...
 */
export interface UpdateCustomTableDetails {
    "savedCustomTable": model.SavedCustomTable;
}
export declare namespace UpdateCustomTableDetails {
    function getJsonObj(obj: UpdateCustomTableDetails): object;
    function getDeserializedJsonObj(obj: UpdateCustomTableDetails): object;
}

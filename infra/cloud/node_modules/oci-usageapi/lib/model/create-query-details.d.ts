 ...
 */
export interface CreateQueryDetails {
    /**
...
export declare namespace CreateQueryDetails {
    function getJsonObj(obj: CreateQueryDetails): object;
    function getDeserializedJsonObj(obj: CreateQueryDetails): object;
}

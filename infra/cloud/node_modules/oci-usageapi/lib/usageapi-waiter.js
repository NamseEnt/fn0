...
class UsageapiWaiter {
    ...
    /**
     * Waits forEmailRecipientsGroup till it reaches any of the provided states
     *
     * @param request the request to send
     * @param targetStates the desired states to wait for. The waiter will return once the resource reaches any of the provided states
     * @return response returns GetEmailRecipientsGroupResponse
     */
    forEmailRecipientsGroup(request, ...targetStates) {
        return __awaiter(this, void 0, void 0, function* () {
            return oci_common_1.genericWaiter(this.config, () => this.client.getEmailRecipientsGroup(request), response => targetStates.includes(response.emailRecipientsGroup.lifecycleState));
        });
    }
    /**

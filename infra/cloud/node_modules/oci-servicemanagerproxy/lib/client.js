...
exports.ServiceManagerProxyClient = exports.ServiceManagerProxyApiKeys = void 0;
...
// ===============================================
var ServiceManagerProxyApiKeys;
(function (ServiceManagerProxyApiKeys) {
})(ServiceManagerProxyApiKeys = exports.ServiceManagerProxyApiKeys || (exports.ServiceManagerProxyApiKeys = {}));
/**
...
class ServiceManagerProxyClient {
    constructor(params, clientConfiguration) {
        ...
        this.targetService = "ServiceManagerProxy";
        this._regionId = "";
        ...
        if (!oci_common_1.developerToolConfiguration.isServiceEnabled("servicemanagerproxy")) {
    ...
    set useRealmSpecificEndpointTemplate(realmSpecificEndpointTemplateEnabled) {
        ...
        if (this._lastSetRegionOrRegionId === common.Region.REGION_STRING) {
            this.endpoint = common.EndpointBuilder.createEndpointFromRegion(ServiceManagerProxyClient.serviceEndpointTemplate, this._region, ServiceManagerProxyClient.endpointServiceName);
        }
        else if (this._lastSetRegionOrRegionId === common.Region.REGION_ID_STRING) {
            this.endpoint = common.EndpointBuilder.createEndpointFromRegionId(ServiceManagerProxyClient.serviceEndpointTemplate, this._regionId, ServiceManagerProxyClient.endpointServiceName);
        }
    }
    /**
    ...
    set region(region) {
        this._region = region;
        this.endpoint = common.EndpointBuilder.createEndpointFromRegion(ServiceManagerProxyClient.serviceEndpointTemplate, region, ServiceManagerProxyClient.endpointServiceName);
    ...
    set regionId(regionId) {
        ...
        this.endpoint = common.EndpointBuilder.createEndpointFromRegionId(ServiceManagerProxyClient.serviceEndpointTemplate, regionId, ServiceManagerProxyClient.endpointServiceName);
    ...
    getServiceEnvironment(getServiceEnvironmentRequest) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const apiReferenceLink = "https://docs.oracle.com/iaas/api/#/en/smp/20210914/ServiceEnvironment/GetServiceEnvironment";
            const pathParams = {
            ...
            const retrier = oci_common_1.GenericRetrier.createPreferredRetrier(this._clientConfiguration ? this._clientConfiguration.retryConfiguration : undefined, getServiceEnvironmentRequest.retryConfiguration, specRetryConfiguration);
            if (this.logger)
    ...
    listServiceEnvironments(listServiceEnvironmentsRequest) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const apiReferenceLink = "https://docs.oracle.com/iaas/api/#/en/smp/20210914/ServiceEnvironment/ListServiceEnvironments";
            const pathParams = {};
            const queryParams = {
            ...
            const specRetryConfiguration = common.NoRetryConfigurationDetails;
            const retrier = oci_common_1.GenericRetrier.createPreferredRetrier(this._clientConfiguration ? this._clientConfiguration.retryConfiguration : undefined, listServiceEnvironmentsRequest.retryConfiguration, specRetryConfiguration);
            if (this.logger)
                retrier.logger = this.logger;
            const request = yield oci_common_1.composeRequest({
                baseEndpoint: this._endpoint,
...
exports.ServiceManagerProxyClient = ServiceManagerProxyClient;
ServiceManagerProxyClient.serviceEndpointTemplate = "https://smproxy.{region}.ocs.{secondLevelDomain}";

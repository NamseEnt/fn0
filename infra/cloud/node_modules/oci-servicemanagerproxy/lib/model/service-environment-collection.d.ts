...
export declare namespace ServiceEnvironmentCollection {
    function getJsonObj(obj: ServiceEnvironmentCollection): object;
    function getDeserializedJsonObj(obj: ServiceEnvironmentCollection): object;
}

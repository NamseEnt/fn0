...
export declare namespace UpdateFunctionDetails {
    function getJsonObj(obj: UpdateFunctionDetails): object;
    function getDeserializedJsonObj(obj: UpdateFunctionDetails): object;
}

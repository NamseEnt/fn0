...
export declare namespace PbfListingVersion {
    enum LifecycleState {
        Active = "ACTIVE",
        Inactive = "INACTIVE",
        Deleted = "DELETED",
    ...
    function getJsonObj(obj: PbfListingVersion): object;
    function getDeserializedJsonObj(obj: PbfListingVersion): object;
}

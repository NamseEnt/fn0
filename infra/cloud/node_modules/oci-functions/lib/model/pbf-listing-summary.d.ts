...
export declare namespace PbfListingSummary {
    function getJsonObj(obj: PbfListingSummary): object;
    function getDeserializedJsonObj(obj: PbfListingSummary): object;
}

...
export declare namespace ImagePolicyConfig {
    function getJsonObj(obj: ImagePolicyConfig): object;
    function getDeserializedJsonObj(obj: ImagePolicyConfig): object;
}

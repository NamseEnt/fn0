...
export declare namespace CreateInclusionCriterionDetails {
    function getJsonObj(obj: CreateInclusionCriterionDetails): object;
    function getDeserializedJsonObj(obj: CreateInclusionCriterionDetails): object;
}

 ...
 **/
export declare enum CreationOption {
    Template = "TEMPLATE",
    Clone = "CLONE",
    /**
...
export declare namespace CreationOption {
    function getJsonObj(obj: CreationOption): CreationOption;
    function getDeserializedJsonObj(obj: CreationOption): CreationOption;
}

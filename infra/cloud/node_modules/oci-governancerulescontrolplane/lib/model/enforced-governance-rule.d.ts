 ...
 */
export interface EnforcedGovernanceRule {
    /**
...
export declare namespace EnforcedGovernanceRule {
    function getJsonObj(obj: EnforcedGovernanceRule): object;
    function getDeserializedJsonObj(obj: EnforcedGovernanceRule): object;
}

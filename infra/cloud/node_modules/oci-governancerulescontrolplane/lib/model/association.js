...
(function (Association) {
    function getJsonObj(obj) {
        ...
        if (obj && "type" in obj && obj.type) {
            switch (obj.type) {
                case "TENANCY":
                    return model.TenancyAssociation.getJsonObj(jsonObj, true);
                default:
    ...
    Association.getJsonObj = getJsonObj;
    function getDeserializedJsonObj(obj) {
        const jsonObj = Object.assign(Object.assign({}, obj), {});
        if (obj && "type" in obj && obj.type) {
            switch (obj.type) {
                case "TENANCY":
                    return model.TenancyAssociation.getDeserializedJsonObj(jsonObj, true);
                default:
                    if (common.LOG.logger)
                        common.LOG.logger.info(`Unknown value for: ${obj.type}`);
            }
    ...
    Association.getDeserializedJsonObj = getDeserializedJsonObj;

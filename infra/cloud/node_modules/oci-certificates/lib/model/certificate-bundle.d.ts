...
export declare namespace CertificateBundle {
    enum Stages {
        Current = "CURRENT",
        Pending = "PENDING",
    ...
    function getJsonObj(obj: CertificateBundle): object;
    function getDeserializedJsonObj(obj: CertificateBundle): object;
}

...
exports.ApmDomainClient = exports.ApmDomainApiKeys = void 0;
const common = require("oci-common");
const model = __importStar(require("./model"));
const oci_common_1 = require("oci-common");
const apmdomain_waiter_1 = require("./apmdomain-waiter");
const oci_common_2 = require("oci-common");
const Breaker = require("opossum");
// ===============================================
// This file is autogenerated - Please do not edit
// ===============================================
var ApmDomainApiKeys;
(function (ApmDomainApiKeys) {
})(ApmDomainApiKeys = exports.ApmDomainApiKeys || (exports.ApmDomainApiKeys = {}));
/**
...
class ApmDomainClient {
    constructor(params, clientConfiguration) {
        ...
        if (!oci_common_2.developerToolConfiguration.isServiceEnabled("apmcontrolplane")) {
    ...
    set endpoint(endpoint) {
        ...
        if (this.logger)
            this.logger.info(`ApmDomainClient endpoint set to ${this._endpoint}`);
    }
    get logger() {
    ...
    set useRealmSpecificEndpointTemplate(realmSpecificEndpointTemplateEnabled) {
        ...
        if (this._lastSetRegionOrRegionId === common.Region.REGION_STRING) {
            this.endpoint = common.EndpointBuilder.createEndpointFromRegion(ApmDomainClient.serviceEndpointTemplate, this._region, ApmDomainClient.endpointServiceName);
        }
        else if (this._lastSetRegionOrRegionId === common.Region.REGION_ID_STRING) {
            this.endpoint = common.EndpointBuilder.createEndpointFromRegionId(ApmDomainClient.serviceEndpointTemplate, this._regionId, ApmDomainClient.endpointServiceName);
        }
    }
    /**
    ...
    set region(region) {
        this._region = region;
        this.endpoint = common.EndpointBuilder.createEndpointFromRegion(ApmDomainClient.serviceEndpointTemplate, region, ApmDomainClient.endpointServiceName);
    ...
    set regionId(regionId) {
        ...
        this.endpoint = common.EndpointBuilder.createEndpointFromRegionId(ApmDomainClient.serviceEndpointTemplate, regionId, ApmDomainClient.endpointServiceName);
    ...
    createWaiters(config) {
        this._waiters = new apmdomain_waiter_1.ApmDomainWaiter(this, config);
     ...
     */
    changeApmDomainCompartment(changeApmDomainCompartmentRequest) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const apiReferenceLink = "https://docs.oracle.com/iaas/api/#/en/apm-control-plane/20200630/ApmDomain/ChangeApmDomainCompartment";
            const pathParams = {
     ...
     */
    createApmDomain(createApmDomainRequest) {
        return __awaiter(this, void 0, void 0, function* () {
            if (this.logger)
                this.logger.debug("Calling operation ApmDomainClient#createApmDomain.");
            const operationName = "createApmDomain";
            const apiReferenceLink = "https://docs.oracle.com/iaas/api/#/en/apm-control-plane/20200630/ApmDomain/CreateApmDomain";
            const pathParams = {};
            const queryParams = {};
            let headerParams = {
                "Content-Type": common.Constants.APPLICATION_JSON,
     ...
     */
    deleteApmDomain(deleteApmDomainRequest) {
        return __awaiter(this, void 0, void 0, function* () {
            if (this.logger)
                this.logger.debug("Calling operation ApmDomainClient#deleteApmDomain.");
            const operationName = "deleteApmDomain";
            const apiReferenceLink = "https://docs.oracle.com/iaas/api/#/en/apm-control-plane/20200630/ApmDomain/DeleteApmDomain";
            const pathParams = {
     ...
     */
    generateDataKeys(generateDataKeysRequest) {
        return __awaiter(this, void 0, void 0, function* () {
            if (this.logger)
                this.logger.debug("Calling operation ApmDomainClient#generateDataKeys.");
            const operationName = "generateDataKeys";
            const apiReferenceLink = "https://docs.oracle.com/iaas/api/#/en/apm-control-plane/20200630/DataKey/GenerateDataKeys";
            const pathParams = {
     ...
     */
    getApmDomain(getApmDomainRequest) {
        return __awaiter(this, void 0, void 0, function* () {
            if (this.logger)
                this.logger.debug("Calling operation ApmDomainClient#getApmDomain.");
            const operationName = "getApmDomain";
            const apiReferenceLink = "https://docs.oracle.com/iaas/api/#/en/apm-control-plane/20200630/ApmDomain/GetApmDomain";
            const pathParams = {
    ...
    getWorkRequest(getWorkRequestRequest) {
        return __awaiter(this, void 0, void 0, function* () {
            if (this.logger)
                this.logger.debug("Calling operation ApmDomainClient#getWorkRequest.");
            const operationName = "getWorkRequest";
            const apiReferenceLink = "https://docs.oracle.com/iaas/api/#/en/apm-control-plane/20200630/WorkRequest/GetWorkRequest";
            const pathParams = {
     ...
     */
    listApmDomainWorkRequests(listApmDomainWorkRequestsRequest) {
        return __awaiter(this, void 0, void 0, function* () {
            if (this.logger)
            ...
            const apiReferenceLink = "https://docs.oracle.com/iaas/api/#/en/apm-control-plane/20200630/WorkRequest/ListApmDomainWorkRequests";
            const pathParams = {
     ...
     */
    listAllApmDomainWorkRequests(request) {
        return oci_common_1.paginateRecords(request, req => this.listApmDomainWorkRequests(req));
    }
    /**
     ...
     * @param request a request which can be sent to the service operation
     */
    listAllApmDomainWorkRequestsResponses(request) {
        return oci_common_1.paginateResponses(request, req => this.listApmDomainWorkRequests(req));
    }
    /**
     * Creates a new async iterator which will iterate over the models.WorkRequest objects
     * contained in responses from the listApmDomainWorkRequests operation. This iterator will fetch more data from the
     ...
     * @param request a request which can be sent to the service operation
     */
    listApmDomainWorkRequestsRecordIterator(request) {
        return oci_common_1.paginateRecords(request, req => this.listApmDomainWorkRequests(req));
    }
    /**
     * Creates a new async iterator which will iterate over the responses received from the listApmDomainWorkRequests operation. This iterator
     ...
     * @param request a request which can be sent to the service operation
     */
    listApmDomainWorkRequestsResponseIterator(request) {
        return oci_common_1.paginateResponses(request, req => this.listApmDomainWorkRequests(req));
    }
    /**
     ...
     */
    listApmDomains(listApmDomainsRequest) {
        return __awaiter(this, void 0, void 0, function* () {
            if (this.logger)
                this.logger.debug("Calling operation ApmDomainClient#listApmDomains.");
            const operationName = "listApmDomains";
            const apiReferenceLink = "https://docs.oracle.com/iaas/api/#/en/apm-control-plane/20200630/ApmDomainSummary/ListApmDomains";
            const pathParams = {};
            const queryParams = {
     ...
     * @param request a request which can be sent to the service operation
     */
    listAllApmDomainsResponses(request) {
     ...
     */
    listDataKeys(listDataKeysRequest) {
        return __awaiter(this, void 0, void 0, function* () {
            if (this.logger)
                this.logger.debug("Calling operation ApmDomainClient#listDataKeys.");
            const operationName = "listDataKeys";
            const apiReferenceLink = "https://docs.oracle.com/iaas/api/#/en/apm-control-plane/20200630/DataKeySummary/ListDataKeys";
            const pathParams = {
    ...
    listWorkRequestErrors(listWorkRequestErrorsRequest) {
        return __awaiter(this, void 0, void 0, function* () {
            if (this.logger)
                this.logger.debug("Calling operation ApmDomainClient#listWorkRequestErrors.");
            const operationName = "listWorkRequestErrors";
            const apiReferenceLink = "https://docs.oracle.com/iaas/api/#/en/apm-control-plane/20200630/WorkRequestError/ListWorkRequestErrors";
            const pathParams = {
    ...
    listWorkRequestLogs(listWorkRequestLogsRequest) {
        return __awaiter(this, void 0, void 0, function* () {
            if (this.logger)
                this.logger.debug("Calling operation ApmDomainClient#listWorkRequestLogs.");
            const operationName = "listWorkRequestLogs";
            const apiReferenceLink = "https://docs.oracle.com/iaas/api/#/en/apm-control-plane/20200630/WorkRequestLogEntry/ListWorkRequestLogs";
            const pathParams = {
    ...
    listWorkRequests(listWorkRequestsRequest) {
        return __awaiter(this, void 0, void 0, function* () {
            if (this.logger)
                this.logger.debug("Calling operation ApmDomainClient#listWorkRequests.");
            const operationName = "listWorkRequests";
            const apiReferenceLink = "https://docs.oracle.com/iaas/api/#/en/apm-control-plane/20200630/WorkRequest/ListWorkRequests";
            const pathParams = {};
            const queryParams = {
     ...
     */
    removeDataKeys(removeDataKeysRequest) {
        return __awaiter(this, void 0, void 0, function* () {
            if (this.logger)
                this.logger.debug("Calling operation ApmDomainClient#removeDataKeys.");
            const operationName = "removeDataKeys";
            const apiReferenceLink = "https://docs.oracle.com/iaas/api/#/en/apm-control-plane/20200630/DataKey/RemoveDataKeys";
            const pathParams = {
     ...
     */
    updateApmDomain(updateApmDomainRequest) {
        return __awaiter(this, void 0, void 0, function* () {
            if (this.logger)
                this.logger.debug("Calling operation ApmDomainClient#updateApmDomain.");
            const operationName = "updateApmDomain";
            const apiReferenceLink = "https://docs.oracle.com/iaas/api/#/en/apm-control-plane/20200630/ApmDomain/UpdateApmDomain";
            const pathParams = {
...
exports.ApmDomainClient = ApmDomainClient;
ApmDomainClient.serviceEndpointTemplate = "https://apm-cp.{region}.oci.{secondLevelDomain}";

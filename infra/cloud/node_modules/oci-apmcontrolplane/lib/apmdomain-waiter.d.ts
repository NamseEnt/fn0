...
export declare class ApmDomainWaiter {
    private client;
    private readonly config?;
    constructor(client: ApmDomainClient, config?: Partial<import("oci-common/lib/waiter").WaiterConfigurationDetails> | undefined);
    /**
     ...
     */
    forApmDomain(request: serviceRequests.GetApmDomainRequest, ...targetStates: models.LifecycleStates[]): Promise<serviceResponses.GetApmDomainResponse | null>;
    /**

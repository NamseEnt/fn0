...
export declare namespace MetricPropertySummary {
    function getJsonObj(obj: MetricPropertySummary): object;
    function getDeserializedJsonObj(obj: MetricPropertySummary): object;
}

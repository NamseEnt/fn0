...
export declare namespace CreateKafkaClusterConfigDetails {
    function getJsonObj(obj: CreateKafkaClusterConfigDetails): object;
    function getDeserializedJsonObj(obj: CreateKafkaClusterConfigDetails): object;
}

 ...
 */
export interface ChangeKafkaClusterConfigCompartmentDetails {
    /**
...
export declare namespace ChangeKafkaClusterConfigCompartmentDetails {
    function getJsonObj(obj: ChangeKafkaClusterConfigCompartmentDetails): object;
    function getDeserializedJsonObj(obj: ChangeKafkaClusterConfigCompartmentDetails): object;
}

...
export declare namespace UpdateKafkaClusterDetails {
    function getJsonObj(obj: UpdateKafkaClusterDetails): object;
    function getDeserializedJsonObj(obj: UpdateKafkaClusterDetails): object;
}

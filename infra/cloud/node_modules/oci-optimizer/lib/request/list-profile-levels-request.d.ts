...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/optimizer/ListProfileLevels.ts.html |here} to see how to use ListProfileLevelsRequest.
 */
...
export declare namespace ListProfileLevelsRequest {
    enum SortBy {
        Name = "NAME",

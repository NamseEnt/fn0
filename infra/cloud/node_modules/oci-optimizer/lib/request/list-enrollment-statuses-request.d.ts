...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/optimizer/ListEnrollmentStatuses.ts.html |here} to see how to use ListEnrollmentStatusesRequest.
 */
export interface ListEnrollmentStatusesRequest extends common.BaseRequest {
    /**
...
export declare namespace ListEnrollmentStatusesRequest {
    enum SortBy {
        Name = "NAME",

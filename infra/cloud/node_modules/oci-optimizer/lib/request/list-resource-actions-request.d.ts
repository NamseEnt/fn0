...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/optimizer/ListResourceActions.ts.html |here} to see how to use ListResourceActionsRequest.
 */
export interface ListResourceActionsRequest extends common.BaseRequest {
    /**
...
export declare namespace ListResourceActionsRequest {
    enum SortBy {
        Name = "NAME",

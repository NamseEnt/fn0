...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/optimizer/ListRecommendationStrategies.ts.html |here} to see how to use ListRecommendationStrategiesRequest.
 */
export interface ListRecommendationStrategiesRequest extends common.BaseRequest {
    /**
...
export declare namespace ListRecommendationStrategiesRequest {
    enum SortBy {
        Name = "NAME",

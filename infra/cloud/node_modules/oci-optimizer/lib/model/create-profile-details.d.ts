...
export declare namespace CreateProfileDetails {
    function getJsonObj(obj: CreateProfileDetails): object;
    function getDeserializedJsonObj(obj: CreateProfileDetails): object;
}

...
export declare namespace LevelConfiguration {
    function getJsonObj(obj: LevelConfiguration): object;
    function getDeserializedJsonObj(obj: LevelConfiguration): object;
}

...
export declare namespace QueryableFieldSummary {
    enum FieldType {
        String = "STRING",
        Integer = "INTEGER",
        Boolean = "BOOLEAN",
    ...
    function getJsonObj(obj: QueryableFieldSummary): object;
    function getDeserializedJsonObj(obj: QueryableFieldSummary): object;
}

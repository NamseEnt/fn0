...
export declare namespace ResourceActionSummary {
    function getJsonObj(obj: ResourceActionSummary): object;
    function getDeserializedJsonObj(obj: ResourceActionSummary): object;
}

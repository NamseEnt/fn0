...
export declare namespace RecommendationStrategyCollection {
    function getJsonObj(obj: RecommendationStrategyCollection): object;
    function getDeserializedJsonObj(obj: RecommendationStrategyCollection): object;
}

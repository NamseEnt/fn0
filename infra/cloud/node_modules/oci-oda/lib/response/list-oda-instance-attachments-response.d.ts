...
export interface ListOdaInstanceAttachmentsResponse {
    /**
    ...
    /**
     * The returned model.OdaInstanceAttachmentCollection instance.
     */
    "odaInstanceAttachmentCollection": model.OdaInstanceAttachmentCollection;
}

...
export interface CreateOdaPrivateEndpointScanProxyResponse {
    /**
    ...
    "opcRequestId": string;
    /**
     * The returned model.OdaPrivateEndpointScanProxy instance.
     */
    "odaPrivateEndpointScanProxy": model.OdaPrivateEndpointScanProxy;
}

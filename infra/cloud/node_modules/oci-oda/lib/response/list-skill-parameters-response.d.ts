...
export interface ListSkillParametersResponse {
    /**
    ...
    /**
     * The returned model.SkillParameterCollection instance.
     */
    "skillParameterCollection": model.SkillParameterCollection;
}

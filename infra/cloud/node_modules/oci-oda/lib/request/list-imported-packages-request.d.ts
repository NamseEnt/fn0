...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/oda/ListImportedPackages.ts.html |here} to see how to use ListImportedPackagesRequest.
 */
...
export declare namespace ListImportedPackagesRequest {
    enum SortOrder {
        Asc = "ASC",
        Desc = "DESC"
    }

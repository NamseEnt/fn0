...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/oda/GetSkillParameter.ts.html |here} to see how to use GetSkillParameterRequest.
 */
export interface GetSkillParameterRequest extends common.BaseRequest {
    /**

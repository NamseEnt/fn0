...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/oda/ListAuthenticationProviders.ts.html |here} to see how to use ListAuthenticationProvidersRequest.
 */
export interface ListAuthenticationProvidersRequest extends common.BaseRequest {
    /**
...
export declare namespace ListAuthenticationProvidersRequest {
    enum SortOrder {
        Asc = "ASC",
        Desc = "DESC"
    }

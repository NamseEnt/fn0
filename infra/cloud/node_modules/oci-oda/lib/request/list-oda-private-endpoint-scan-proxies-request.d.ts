...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/oda/ListOdaPrivateEndpointScanProxies.ts.html |here} to see how to use ListOdaPrivateEndpointScanProxiesRequest.
 */
export interface ListOdaPrivateEndpointScanProxiesRequest extends common.BaseRequest {
    /**
...
export declare namespace ListOdaPrivateEndpointScanProxiesRequest {
    enum SortOrder {
        Asc = "ASC",
        Desc = "DESC"
    }

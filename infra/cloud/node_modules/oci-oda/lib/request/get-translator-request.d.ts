...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/oda/GetTranslator.ts.html |here} to see how to use GetTranslatorRequest.
 */
export interface GetTranslatorRequest extends common.BaseRequest {
    /**

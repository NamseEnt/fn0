 ...
 */
export interface CreateWebChannelResult extends model.CreateChannelResult {
    /**
...
export declare namespace CreateWebChannelResult {
    function getJsonObj(obj: CreateWebChannelResult, isParentJsonObj?: boolean): object;
    const type = "WEB";
    function getDeserializedJsonObj(obj: CreateWebChannelResult, isParentJsonObj?: boolean): object;
}

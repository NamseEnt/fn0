 ...
 */
export interface CreateIosChannelResult extends model.CreateChannelResult {
    /**
...
export declare namespace CreateIosChannelResult {
    function getJsonObj(obj: CreateIosChannelResult, isParentJsonObj?: boolean): object;
    const type = "IOS";
    function getDeserializedJsonObj(obj: CreateIosChannelResult, isParentJsonObj?: boolean): object;
}

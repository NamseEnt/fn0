...
export declare namespace RestrictedOperation {
    function getJsonObj(obj: RestrictedOperation): object;
    function getDeserializedJsonObj(obj: RestrictedOperation): object;
}

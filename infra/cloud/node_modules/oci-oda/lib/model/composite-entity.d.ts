...
export declare namespace CompositeEntity {
    function getJsonObj(obj: CompositeEntity, isParentJsonObj?: boolean): object;
    const type = "COMPOSITE";
    function getDeserializedJsonObj(obj: CompositeEntity, isParentJsonObj?: boolean): object;
}

...
export declare namespace CreateServiceCloudChannelResult {
    function getJsonObj(obj: CreateServiceCloudChannelResult, isParentJsonObj?: boolean): object;
    const type = "SERVICECLOUD";
    function getDeserializedJsonObj(obj: CreateServiceCloudChannelResult, isParentJsonObj?: boolean): object;
}

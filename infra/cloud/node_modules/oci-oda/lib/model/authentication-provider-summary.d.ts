...
export declare namespace AuthenticationProviderSummary {
    function getJsonObj(obj: AuthenticationProviderSummary): object;
    function getDeserializedJsonObj(obj: AuthenticationProviderSummary): object;
}

...
export declare namespace CreateSlackChannelResult {
    function getJsonObj(obj: CreateSlackChannelResult, isParentJsonObj?: boolean): object;
    const type = "SLACK";
    function getDeserializedJsonObj(obj: CreateSlackChannelResult, isParentJsonObj?: boolean): object;
}

...
export declare namespace CreateNewSkillDetails {
    function getJsonObj(obj: CreateNewSkillDetails, isParentJsonObj?: boolean): object;
    const kind = "NEW";
    function getDeserializedJsonObj(obj: CreateNewSkillDetails, isParentJsonObj?: boolean): object;
}

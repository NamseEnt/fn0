 ...
 */
export interface CreateOdaPrivateEndpointDetails {
    /**
...
export declare namespace CreateOdaPrivateEndpointDetails {
    function getJsonObj(obj: CreateOdaPrivateEndpointDetails): object;
    function getDeserializedJsonObj(obj: CreateOdaPrivateEndpointDetails): object;
}

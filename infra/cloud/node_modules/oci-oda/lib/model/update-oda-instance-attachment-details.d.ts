...
export declare namespace UpdateOdaInstanceAttachmentDetails {
    function getJsonObj(obj: UpdateOdaInstanceAttachmentDetails): object;
    function getDeserializedJsonObj(obj: UpdateOdaInstanceAttachmentDetails): object;
}

...
export declare namespace CreateOSSChannelResult {
    function getJsonObj(obj: CreateOSSChannelResult, isParentJsonObj?: boolean): object;
    const type = "OSS";
    function getDeserializedJsonObj(obj: CreateOSSChannelResult, isParentJsonObj?: boolean): object;
}

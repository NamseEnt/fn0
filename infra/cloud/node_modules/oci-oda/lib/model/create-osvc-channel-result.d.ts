...
export declare namespace CreateOsvcChannelResult {
    function getJsonObj(obj: CreateOsvcChannelResult, isParentJsonObj?: boolean): object;
    const type = "OSVC";
    function getDeserializedJsonObj(obj: CreateOsvcChannelResult, isParentJsonObj?: boolean): object;
}

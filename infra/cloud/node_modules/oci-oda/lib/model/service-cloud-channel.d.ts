...
export declare namespace ServiceCloudChannel {
    function getJsonObj(obj: ServiceCloudChannel, isParentJsonObj?: boolean): object;
    const type = "SERVICECLOUD";
    function getDeserializedJsonObj(obj: ServiceCloudChannel, isParentJsonObj?: boolean): object;
}

...
export declare namespace CreateAppEventChannelResult {
    function getJsonObj(obj: CreateAppEventChannelResult, isParentJsonObj?: boolean): object;
    const type = "APPEVENT";
    function getDeserializedJsonObj(obj: CreateAppEventChannelResult, isParentJsonObj?: boolean): object;
}

...
export declare namespace CreateOdaPrivateEndpointScanProxyDetails {
    function getJsonObj(obj: CreateOdaPrivateEndpointScanProxyDetails): object;
    function getDeserializedJsonObj(obj: CreateOdaPrivateEndpointScanProxyDetails): object;
}

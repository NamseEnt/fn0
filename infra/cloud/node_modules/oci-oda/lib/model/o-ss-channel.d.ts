 ...
 */
export interface OSSChannel extends model.Channel {
    /**
...
export declare namespace OSSChannel {
    function getJsonObj(obj: OSSChannel, isParentJsonObj?: boolean): object;
    const type = "OSS";
    function getDeserializedJsonObj(obj: OSSChannel, isParentJsonObj?: boolean): object;
}

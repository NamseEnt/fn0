...
export declare namespace ResourceTypeMetadata {
    function getJsonObj(obj: ResourceTypeMetadata): object;
    function getDeserializedJsonObj(obj: ResourceTypeMetadata): object;
}

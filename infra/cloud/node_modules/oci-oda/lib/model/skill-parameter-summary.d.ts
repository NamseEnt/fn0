 ...
 */
export interface SkillParameterSummary {
    /**
...
export declare namespace SkillParameterSummary {
    function getJsonObj(obj: SkillParameterSummary): object;
    function getDeserializedJsonObj(obj: SkillParameterSummary): object;
}

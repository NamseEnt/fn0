...
export declare namespace CreateSkillCompositeEntityDetails {
    function getJsonObj(obj: CreateSkillCompositeEntityDetails, isParentJsonObj?: boolean): object;
    const type = "COMPOSITE";
    function getDeserializedJsonObj(obj: CreateSkillCompositeEntityDetails, isParentJsonObj?: boolean): object;
}

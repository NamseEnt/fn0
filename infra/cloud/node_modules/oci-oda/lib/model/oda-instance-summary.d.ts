...
export declare namespace OdaInstanceSummary {
    enum ShapeName {
    ...
    function getJsonObj(obj: OdaInstanceSummary): object;
    function getDeserializedJsonObj(obj: OdaInstanceSummary): object;
}

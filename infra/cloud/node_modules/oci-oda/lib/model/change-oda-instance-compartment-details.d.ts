...
export declare namespace ChangeOdaInstanceCompartmentDetails {
    function getJsonObj(obj: ChangeOdaInstanceCompartmentDetails): object;
    function getDeserializedJsonObj(obj: ChangeOdaInstanceCompartmentDetails): object;
}

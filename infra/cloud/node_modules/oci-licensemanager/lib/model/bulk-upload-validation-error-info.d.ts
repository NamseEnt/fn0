...
export declare namespace BulkUploadValidationErrorInfo {
    function getJsonObj(obj: BulkUploadValidationErrorInfo): object;
    function getDeserializedJsonObj(obj: BulkUploadValidationErrorInfo): object;
}

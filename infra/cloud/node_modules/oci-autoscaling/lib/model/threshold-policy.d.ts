...
export declare namespace ThresholdPolicy {
    function getJsonObj(obj: ThresholdPolicy, isParentJsonObj?: boolean): object;
    const policyType = "threshold";
    function getDeserializedJsonObj(obj: ThresholdPolicy, isParentJsonObj?: boolean): object;
}

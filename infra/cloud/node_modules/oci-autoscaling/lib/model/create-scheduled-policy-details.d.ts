...
export declare namespace CreateScheduledPolicyDetails {
    function getJsonObj(obj: CreateScheduledPolicyDetails, isParentJsonObj?: boolean): object;
    const policyType = "scheduled";
    function getDeserializedJsonObj(obj: CreateScheduledPolicyDetails, isParentJsonObj?: boolean): object;
}

...
export declare namespace ChangeAutoScalingCompartmentDetails {
    function getJsonObj(obj: ChangeAutoScalingCompartmentDetails): object;
    function getDeserializedJsonObj(obj: ChangeAutoScalingCompartmentDetails): object;
}

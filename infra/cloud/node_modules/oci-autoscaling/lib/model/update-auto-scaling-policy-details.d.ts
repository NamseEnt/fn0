...
export declare namespace UpdateAutoScalingPolicyDetails {
    function getJsonObj(obj: UpdateAutoScalingPolicyDetails): object;
    function getDeserializedJsonObj(obj: UpdateAutoScalingPolicyDetails): object;
}

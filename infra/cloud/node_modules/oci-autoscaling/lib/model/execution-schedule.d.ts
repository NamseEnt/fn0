...
export declare namespace ExecutionSchedule {
    enum Timezone {
        Utc = "UTC",
        /**
    ...
    function getJsonObj(obj: ExecutionSchedule): object;
    function getDeserializedJsonObj(obj: ExecutionSchedule): object;
}

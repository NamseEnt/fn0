...
export declare namespace CreateAutoScalingConfigurationDetails {
    function getJsonObj(obj: CreateAutoScalingConfigurationDetails): object;
    function getDeserializedJsonObj(obj: CreateAutoScalingConfigurationDetails): object;
}

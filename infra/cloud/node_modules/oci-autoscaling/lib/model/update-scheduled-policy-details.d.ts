...
export declare namespace UpdateScheduledPolicyDetails {
    function getJsonObj(obj: UpdateScheduledPolicyDetails, isParentJsonObj?: boolean): object;
    const policyType = "scheduled";
    function getDeserializedJsonObj(obj: UpdateScheduledPolicyDetails, isParentJsonObj?: boolean): object;
}

...
export declare namespace ResourcePowerAction {
    ...
    function getJsonObj(obj: ResourcePowerAction, isParentJsonObj?: boolean): object;
    const actionType = "power";
    function getDeserializedJsonObj(obj: ResourcePowerAction, isParentJsonObj?: boolean): object;
}

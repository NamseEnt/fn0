...
export declare namespace IdcsSecret {
    function getJsonObj(obj: IdcsSecret, isParentJsonObj?: boolean): object;
    const type = "IDCS_SECRET";
    function getDeserializedJsonObj(obj: IdcsSecret, isParentJsonObj?: boolean): object;
}

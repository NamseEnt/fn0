...
export declare namespace OciObjectStorageDataSourceConfig {
    function getJsonObj(obj: OciObjectStorageDataSourceConfig, isParentJsonObj?: boolean): object;
    const dataSourceConfigType = "OCI_OBJECT_STORAGE";
    function getDeserializedJsonObj(obj: OciObjectStorageDataSourceConfig, isParentJsonObj?: boolean): object;
}

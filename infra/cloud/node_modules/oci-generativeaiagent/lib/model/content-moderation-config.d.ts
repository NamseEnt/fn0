...
export declare namespace ContentModerationConfig {
    function getJsonObj(obj: ContentModerationConfig): object;
    function getDeserializedJsonObj(obj: ContentModerationConfig): object;
}

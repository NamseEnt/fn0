 ...
 *
 */
export interface AgentEndpointCollection {
    /**
     * List of endpoints.
     */
    "items": Array<model.AgentEndpointSummary>;
}
export declare namespace AgentEndpointCollection {
    function getJsonObj(obj: AgentEndpointCollection): object;
    function getDeserializedJsonObj(obj: AgentEndpointCollection): object;
}

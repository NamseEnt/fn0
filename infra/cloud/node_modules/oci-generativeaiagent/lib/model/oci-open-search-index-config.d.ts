...
export declare namespace OciOpenSearchIndexConfig {
    function getJsonObj(obj: OciOpenSearchIndexConfig, isParentJsonObj?: boolean): object;
    const indexConfigType = "OCI_OPEN_SEARCH_INDEX_CONFIG";
    function getDeserializedJsonObj(obj: OciOpenSearchIndexConfig, isParentJsonObj?: boolean): object;
}

...
export interface ProvisionedCapacityConfig {
    ...
    "platformRuntimeConfig"?: model.PlatformRuntimeConfig;
    /**
     * RAG and SQL will be tools.
     */
    "toolRuntimeConfigs"?: Array<model.ToolRuntimeConfig>;
}
export declare namespace ProvisionedCapacityConfig {
    function getJsonObj(obj: ProvisionedCapacityConfig): object;
    function getDeserializedJsonObj(obj: ProvisionedCapacityConfig): object;
}

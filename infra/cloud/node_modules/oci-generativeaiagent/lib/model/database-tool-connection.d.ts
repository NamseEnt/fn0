...
export declare namespace DatabaseToolConnection {
    function getJsonObj(obj: DatabaseToolConnection, isParentJsonObj?: boolean): object;
    const connectionType = "DATABASE_TOOL_CONNECTION";
    function getDeserializedJsonObj(obj: DatabaseToolConnection, isParentJsonObj?: boolean): object;
}

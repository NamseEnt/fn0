...
export declare class GenerativeAiAgentWaiter {
     ...
     */
    forProvisionedCapacity(request: serviceRequests.GetProvisionedCapacityRequest, ...targetStates: models.ProvisionedCapacity.LifecycleState[]): Promise<serviceResponses.GetProvisionedCapacityResponse | null>;
    /**

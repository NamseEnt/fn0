...
class GenerativeAiAgentClient {
    ...
    changeProvisionedCapacityCompartment(changeProvisionedCapacityCompartmentRequest) {
        return __awaiter(this, void 0, void 0, function* () {
            if (this.logger)
                this.logger.debug("Calling operation GenerativeAiAgentClient#changeProvisionedCapacityCompartment.");
            ...
            const specRetryConfiguration = common.OciSdkDefaultRetryConfiguration;
            const retrier = oci_common_1.GenericRetrier.createPreferredRetrier(this._clientConfiguration ? this._clientConfiguration.retryConfiguration : undefined, changeProvisionedCapacityCompartmentRequest.retryConfiguration, specRetryConfiguration);
            if (this.logger)
                retrier.logger = this.logger;
            const request = yield oci_common_1.composeRequest({
                baseEndpoint: this._endpoint,
                ...
                method: "POST",
                bodyContent: common.ObjectSerializer.serialize(changeProvisionedCapacityCompartmentRequest.changeProvisionedCapacityCompartmentDetails, "ChangeProvisionedCapacityCompartmentDetails", model.ChangeProvisionedCapacityCompartmentDetails.getJsonObj),
                pathParams: pathParams,
                headerParams: headerParams,
                queryParams: queryParams
            });
     ...
     */
    createProvisionedCapacity(createProvisionedCapacityRequest) {
        return __awaiter(this, void 0, void 0, function* () {
            if (this.logger)
            ...
            const specRetryConfiguration = common.OciSdkDefaultRetryConfiguration;
            const retrier = oci_common_1.GenericRetrier.createPreferredRetrier(this._clientConfiguration ? this._clientConfiguration.retryConfiguration : undefined, createProvisionedCapacityRequest.retryConfiguration, specRetryConfiguration);
            if (this.logger)
                retrier.logger = this.logger;
            const request = yield oci_common_1.composeRequest({
                baseEndpoint: this._endpoint,
                ...
                method: "POST",
                bodyContent: common.ObjectSerializer.serialize(createProvisionedCapacityRequest.createProvisionedCapacityDetails, "CreateProvisionedCapacityDetails", model.CreateProvisionedCapacityDetails.getJsonObj),
                pathParams: pathParams,
                headerParams: headerParams,
                queryParams: queryParams
            });
     ...
     */
    deleteProvisionedCapacity(deleteProvisionedCapacityRequest) {
        return __awaiter(this, void 0, void 0, function* () {
            if (this.logger)
            ...
            const specRetryConfiguration = common.OciSdkDefaultRetryConfiguration;
            const retrier = oci_common_1.GenericRetrier.createPreferredRetrier(this._clientConfiguration ? this._clientConfiguration.retryConfiguration : undefined, deleteProvisionedCapacityRequest.retryConfiguration, specRetryConfiguration);
            if (this.logger)
                retrier.logger = this.logger;
            const request = yield oci_common_1.composeRequest({
                baseEndpoint: this._endpoint,
     ...
     */
    getProvisionedCapacity(getProvisionedCapacityRequest) {
        return __awaiter(this, void 0, void 0, function* () {
            if (this.logger)
            ...
            const specRetryConfiguration = common.OciSdkDefaultRetryConfiguration;
            const retrier = oci_common_1.GenericRetrier.createPreferredRetrier(this._clientConfiguration ? this._clientConfiguration.retryConfiguration : undefined, getProvisionedCapacityRequest.retryConfiguration, specRetryConfiguration);
            if (this.logger)
                retrier.logger = this.logger;
            const request = yield oci_common_1.composeRequest({
                baseEndpoint: this._endpoint,
     ...
     */
    listProvisionedCapacities(listProvisionedCapacitiesRequest) {
        return __awaiter(this, void 0, void 0, function* () {
            if (this.logger)
            ...
            const specRetryConfiguration = common.OciSdkDefaultRetryConfiguration;
            const retrier = oci_common_1.GenericRetrier.createPreferredRetrier(this._clientConfiguration ? this._clientConfiguration.retryConfiguration : undefined, listProvisionedCapacitiesRequest.retryConfiguration, specRetryConfiguration);
            if (this.logger)
                retrier.logger = this.logger;
            const request = yield oci_common_1.composeRequest({
                baseEndpoint: this._endpoint,
     ...
     */
    updateProvisionedCapacity(updateProvisionedCapacityRequest) {
        return __awaiter(this, void 0, void 0, function* () {
            if (this.logger)
            ...
            const specRetryConfiguration = common.OciSdkDefaultRetryConfiguration;
            const retrier = oci_common_1.GenericRetrier.createPreferredRetrier(this._clientConfiguration ? this._clientConfiguration.retryConfiguration : undefined, updateProvisionedCapacityRequest.retryConfiguration, specRetryConfiguration);
            if (this.logger)
                retrier.logger = this.logger;
            const request = yield oci_common_1.composeRequest({
                baseEndpoint: this._endpoint,
                ...
                path: "/provisionedCapacities/{provisionedCapacityId}",
                method: "PUT",
                bodyContent: common.ObjectSerializer.serialize(updateProvisionedCapacityRequest.updateProvisionedCapacityDetails, "UpdateProvisionedCapacityDetails", model.UpdateProvisionedCapacityDetails.getJsonObj),
                pathParams: pathParams,
                headerParams: headerParams,
                queryParams: queryParams
            });

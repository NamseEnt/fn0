...
export declare namespace DomainGovernanceCollection {
    function getJsonObj(obj: DomainGovernanceCollection): object;
    function getDeserializedJsonObj(obj: DomainGovernanceCollection): object;
}

...
export declare namespace AssignedSubscriptionLineItemCollection {
    function getJsonObj(obj: AssignedSubscriptionLineItemCollection): object;
    function getDeserializedJsonObj(obj: AssignedSubscriptionLineItemCollection): object;
}

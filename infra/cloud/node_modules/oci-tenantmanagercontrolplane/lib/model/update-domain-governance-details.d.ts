...
export declare namespace UpdateDomainGovernanceDetails {
    function getJsonObj(obj: UpdateDomainGovernanceDetails): object;
    function getDeserializedJsonObj(obj: UpdateDomainGovernanceDetails): object;
}

...
(function (Subscription) {
    function getJsonObj(obj) {
        ...
        if (obj && "entityVersion" in obj && obj.entityVersion) {
            switch (obj.entityVersion) {
                case "V1":
                    return model.ClassicSubscription.getJsonObj(jsonObj, true);
                case "V2":
                    return model.CloudSubscription.getJsonObj(jsonObj, true);
                default:
    ...
    function getDeserializedJsonObj(obj) {
        ...
        if (obj && "entityVersion" in obj && obj.entityVersion) {
            switch (obj.entityVersion) {
                case "V1":
                    return model.ClassicSubscription.getDeserializedJsonObj(jsonObj, true);
                case "V2":
                    return model.CloudSubscription.getDeserializedJsonObj(jsonObj, true);
                default:
                    if (common.LOG.logger)
                        common.LOG.logger.info(`Unknown value for: ${obj.entityVersion}`);
            }

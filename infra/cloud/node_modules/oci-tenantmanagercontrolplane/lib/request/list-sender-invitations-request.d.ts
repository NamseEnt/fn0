...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/tenantmanagercontrolplane/ListSenderInvitations.ts.html |here} to see how to use ListSenderInvitationsRequest.
 */
...
export declare namespace ListSenderInvitationsRequest {
    enum SortBy {

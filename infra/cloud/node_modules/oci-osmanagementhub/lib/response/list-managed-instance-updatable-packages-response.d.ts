...
export interface ListManagedInstanceUpdatablePackagesResponse {
    /**
    ...
    "opcNextPage": string;
    /**
     * The returned model.UpdatablePackageCollection instance.
     */
    "updatablePackageCollection": model.UpdatablePackageCollection;
}

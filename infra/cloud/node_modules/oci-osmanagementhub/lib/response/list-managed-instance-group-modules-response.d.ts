...
export interface ListManagedInstanceGroupModulesResponse {
    /**
    ...
    "opcNextPage": string;
    /**
     * The returned model.ManagedInstanceGroupModuleCollection instance.
     */
    "managedInstanceGroupModuleCollection": model.ManagedInstanceGroupModuleCollection;
}

...
export interface ListSoftwarePackageSoftwareSourcesResponse {
    /**
    ...
    "opcNextPage": string;
    /**
     * The returned model.SoftwareSourceCollection instance.
     */
    "softwareSourceCollection": model.SoftwareSourceCollection;
}

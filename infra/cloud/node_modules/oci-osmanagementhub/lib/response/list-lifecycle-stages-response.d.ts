...
export interface ListLifecycleStagesResponse {
    /**
    ...
    "opcNextPage": string;
    /**
     * The returned model.LifecycleStageCollection instance.
     */
    "lifecycleStageCollection": model.LifecycleStageCollection;
}

...
export interface ListManagedInstanceInstalledPackagesResponse {
    /**
    ...
    "opcNextPage": string;
    /**
     * The returned model.InstalledPackageCollection instance.
     */
    "installedPackageCollection": model.InstalledPackageCollection;
}

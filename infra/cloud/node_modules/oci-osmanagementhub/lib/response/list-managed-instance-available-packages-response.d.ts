...
export interface ListManagedInstanceAvailablePackagesResponse {
    /**
    ...
    "opcNextPage": string;
    /**
     * The returned model.AvailablePackageCollection instance.
     */
    "availablePackageCollection": model.AvailablePackageCollection;
}

...
export declare namespace ManagedInstanceGroup {
    enum LifecycleState {
        Creating = "CREATING",
        Updating = "UPDATING",
        Active = "ACTIVE",
    ...
    function getJsonObj(obj: ManagedInstanceGroup): object;
    function getDeserializedJsonObj(obj: ManagedInstanceGroup): object;
}

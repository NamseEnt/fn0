...
export declare namespace ManagedInstanceGroupAvailableModuleSummary {
    function getJsonObj(obj: ManagedInstanceGroupAvailableModuleSummary): object;
    function getDeserializedJsonObj(obj: ManagedInstanceGroupAvailableModuleSummary): object;
}

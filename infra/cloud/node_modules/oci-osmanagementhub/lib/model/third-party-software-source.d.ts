 ...
 */
export interface ThirdPartySoftwareSource extends model.SoftwareSource {
    /**
...
export declare namespace ThirdPartySoftwareSource {
    function getJsonObj(obj: ThirdPartySoftwareSource, isParentJsonObj?: boolean): object;
    const softwareSourceType = "THIRD_PARTY";
    function getDeserializedJsonObj(obj: ThirdPartySoftwareSource, isParentJsonObj?: boolean): object;
}

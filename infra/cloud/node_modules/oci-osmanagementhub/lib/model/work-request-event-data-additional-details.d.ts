 ...
 */
export interface WorkRequestEventDataAdditionalDetails {
    /**
...
export declare namespace WorkRequestEventDataAdditionalDetails {
    function getJsonObj(obj: WorkRequestEventDataAdditionalDetails): object;
    function getDeserializedJsonObj(obj: WorkRequestEventDataAdditionalDetails): object;
}

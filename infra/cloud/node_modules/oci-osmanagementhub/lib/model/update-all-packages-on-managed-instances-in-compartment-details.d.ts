...
export declare namespace UpdateAllPackagesOnManagedInstancesInCompartmentDetails {
    enum UpdateTypes {
        Security = "SECURITY",
        Bugfix = "BUGFIX",
    ...
    function getJsonObj(obj: UpdateAllPackagesOnManagedInstancesInCompartmentDetails): object;
    function getDeserializedJsonObj(obj: UpdateAllPackagesOnManagedInstancesInCompartmentDetails): object;
}

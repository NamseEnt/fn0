...
export declare namespace ManagementStation {
    enum LifecycleState {
        Creating = "CREATING",
        Updating = "UPDATING",
        Active = "ACTIVE",
    ...
    function getJsonObj(obj: ManagementStation): object;
    function getDeserializedJsonObj(obj: ManagementStation): object;
}

...
export declare namespace SoftwareSourceSummary {
    function getJsonObj(obj: SoftwareSourceSummary): object;
    function getDeserializedJsonObj(obj: SoftwareSourceSummary): object;
}

...
export declare namespace ModuleStreamProfileDetailsBody {
    function getJsonObj(obj: ModuleStreamProfileDetailsBody): object;
    function getDeserializedJsonObj(obj: ModuleStreamProfileDetailsBody): object;
}

...
export declare namespace UpdatePackagesOnManagedInstanceDetails {
    enum UpdateTypes {
        Security = "SECURITY",
        Bugfix = "BUGFIX",
    ...
    function getJsonObj(obj: UpdatePackagesOnManagedInstanceDetails): object;
    function getDeserializedJsonObj(obj: UpdatePackagesOnManagedInstanceDetails): object;
}

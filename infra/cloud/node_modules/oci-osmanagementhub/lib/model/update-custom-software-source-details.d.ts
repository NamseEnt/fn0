...
export declare namespace UpdateCustomSoftwareSourceDetails {
    function getJsonObj(obj: UpdateCustomSoftwareSourceDetails, isParentJsonObj?: boolean): object;
    const softwareSourceType = "CUSTOM";
    function getDeserializedJsonObj(obj: UpdateCustomSoftwareSourceDetails, isParentJsonObj?: boolean): object;
}

 ...
 */
export interface ChangeEventCompartmentDetails {
    /**
...
export declare namespace ChangeEventCompartmentDetails {
    function getJsonObj(obj: ChangeEventCompartmentDetails): object;
    function getDeserializedJsonObj(obj: ChangeEventCompartmentDetails): object;
}

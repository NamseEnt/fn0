...
export declare namespace ManageModuleStreamsInScheduledJobDetails {
    function getJsonObj(obj: ManageModuleStreamsInScheduledJobDetails): object;
    function getDeserializedJsonObj(obj: ManageModuleStreamsInScheduledJobDetails): object;
}

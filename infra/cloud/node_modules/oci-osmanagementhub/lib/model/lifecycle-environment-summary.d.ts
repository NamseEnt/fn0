...
export declare namespace LifecycleEnvironmentSummary {
    function getJsonObj(obj: LifecycleEnvironmentSummary): object;
    function getDeserializedJsonObj(obj: LifecycleEnvironmentSummary): object;
}

...
export declare namespace PackageGroupSummary {
    function getJsonObj(obj: PackageGroupSummary): object;
    function getDeserializedJsonObj(obj: PackageGroupSummary): object;
}

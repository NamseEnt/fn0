...
export declare namespace ManagementStationDetails {
    function getJsonObj(obj: ManagementStationDetails): object;
    function getDeserializedJsonObj(obj: ManagementStationDetails): object;
}

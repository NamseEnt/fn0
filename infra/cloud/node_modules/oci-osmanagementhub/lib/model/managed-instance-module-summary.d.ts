 ...
 */
export interface ManagedInstanceModuleSummary {
    /**
     * The module name.
     *
     */
...
export declare namespace ManagedInstanceModuleSummary {
    function getJsonObj(obj: ManagedInstanceModuleSummary): object;
    function getDeserializedJsonObj(obj: ManagedInstanceModuleSummary): object;
}

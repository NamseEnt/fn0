...
export declare namespace ModuleStreamProfile {
    function getJsonObj(obj: ModuleStreamProfile): object;
    function getDeserializedJsonObj(obj: ModuleStreamProfile): object;
}

...
export declare namespace SoftwarePackageCollection {
    function getJsonObj(obj: SoftwarePackageCollection): object;
    function getDeserializedJsonObj(obj: SoftwarePackageCollection): object;
}

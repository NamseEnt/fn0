...
export declare namespace ManagedInstanceGroupSummary {
    function getJsonObj(obj: ManagedInstanceGroupSummary): object;
    function getDeserializedJsonObj(obj: ManagedInstanceGroupSummary): object;
}

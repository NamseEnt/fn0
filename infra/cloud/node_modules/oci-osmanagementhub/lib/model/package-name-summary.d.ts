...
export declare namespace PackageNameSummary {
    function getJsonObj(obj: PackageNameSummary): object;
    function getDeserializedJsonObj(obj: PackageNameSummary): object;
}

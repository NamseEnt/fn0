...
export declare namespace ModuleStreamSummary {
    function getJsonObj(obj: ModuleStreamSummary): object;
    function getDeserializedJsonObj(obj: ModuleStreamSummary): object;
}

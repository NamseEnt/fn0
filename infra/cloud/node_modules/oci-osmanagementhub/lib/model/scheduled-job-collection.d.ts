...
export declare namespace ScheduledJobCollection {
    function getJsonObj(obj: ScheduledJobCollection): object;
    function getDeserializedJsonObj(obj: ScheduledJobCollection): object;
}

...
export declare namespace SoftwareUpdateEventData {
    enum OperationType {
    ...
    function getJsonObj(obj: SoftwareUpdateEventData): object;
    function getDeserializedJsonObj(obj: SoftwareUpdateEventData): object;
}

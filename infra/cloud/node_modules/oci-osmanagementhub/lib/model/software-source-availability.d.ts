...
export declare namespace SoftwareSourceAvailability {
    function getJsonObj(obj: SoftwareSourceAvailability): object;
    function getDeserializedJsonObj(obj: SoftwareSourceAvailability): object;
}

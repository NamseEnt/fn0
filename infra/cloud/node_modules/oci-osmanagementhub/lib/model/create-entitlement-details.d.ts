 ...
 */
export interface CreateEntitlementDetails {
    /**
...
export declare namespace CreateEntitlementDetails {
    function getJsonObj(obj: CreateEntitlementDetails): object;
    function getDeserializedJsonObj(obj: CreateEntitlementDetails): object;
}

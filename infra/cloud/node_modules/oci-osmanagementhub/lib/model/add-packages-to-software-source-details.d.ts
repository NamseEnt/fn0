...
export declare namespace AddPackagesToSoftwareSourceDetails {
    function getJsonObj(obj: AddPackagesToSoftwareSourceDetails): object;
    function getDeserializedJsonObj(obj: AddPackagesToSoftwareSourceDetails): object;
}

...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/osmanagementhub/ListManagedInstanceAvailableWindowsUpdates.ts.html |here} to see how to use ListManagedInstanceAvailableWindowsUpdatesRequest.
 */
export interface ListManagedInstanceAvailableWindowsUpdatesRequest extends common.BaseRequest {
    /**
...
export declare namespace ListManagedInstanceAvailableWindowsUpdatesRequest {
    enum SortBy {

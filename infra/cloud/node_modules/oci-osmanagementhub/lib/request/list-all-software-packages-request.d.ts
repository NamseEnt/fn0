...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/osmanagementhub/ListAllSoftwarePackages.ts.html |here} to see how to use ListAllSoftwarePackagesRequest.
 */
export interface ListAllSoftwarePackagesRequest extends common.BaseRequest {
    /**
...
export declare namespace ListAllSoftwarePackagesRequest {
    enum SortBy {

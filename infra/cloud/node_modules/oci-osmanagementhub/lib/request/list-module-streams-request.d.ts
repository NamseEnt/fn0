...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/osmanagementhub/ListModuleStreams.ts.html |here} to see how to use ListModuleStreamsRequest.
 */
...
export declare namespace ListModuleStreamsRequest {
    enum SortBy {

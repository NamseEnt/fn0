...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/osmanagementhub/ListManagedInstanceGroups.ts.html |here} to see how to use ListManagedInstanceGroupsRequest.
 */
...
export declare namespace ListManagedInstanceGroupsRequest {
    enum SortBy {

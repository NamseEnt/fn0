...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/osmanagementhub/ListLifecycleStages.ts.html |here} to see how to use ListLifecycleStagesRequest.
 */
...
export declare namespace ListLifecycleStagesRequest {
    enum SortBy {

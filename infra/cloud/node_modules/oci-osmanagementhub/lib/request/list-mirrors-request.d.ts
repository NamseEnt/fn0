...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/osmanagementhub/ListMirrors.ts.html |here} to see how to use ListMirrorsRequest.
 */
export interface ListMirrorsRequest extends common.BaseRequest {
  ...
  *
   */
     ...
     */
    "mirrorStates"?: Array<model.MirrorState>;
    /**
     * Unique Oracle-assigned identifier for the request. If you need to contact Oracle about a particular request, please provide the request ID.
     */
    "opcRequestId"?: string;
}
export declare namespace ListMirrorsRequest {
    enum SortBy {

...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/osmanagementhub/ListLifecycleEnvironments.ts.html |here} to see how to use ListLifecycleEnvironmentsRequest.
 */
...
export declare namespace ListLifecycleEnvironmentsRequest {
    enum SortBy {

 ...
 *
 */
export interface CreateSenderDetails {
    /**
...
export declare namespace CreateSenderDetails {
    function getJsonObj(obj: CreateSenderDetails): object;
    function getDeserializedJsonObj(obj: CreateSenderDetails): object;
}

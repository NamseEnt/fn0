...
export declare namespace CreateEmailReturnPathDetails {
    function getJsonObj(obj: CreateEmailReturnPathDetails): object;
    function getDeserializedJsonObj(obj: CreateEmailReturnPathDetails): object;
}

...
export declare namespace EmailReturnPathSummary {
    function getJsonObj(obj: EmailReturnPathSummary): object;
    function getDeserializedJsonObj(obj: EmailReturnPathSummary): object;
}

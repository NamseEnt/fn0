...
export declare namespace EmailIpPoolSummary {
    function getJsonObj(obj: EmailIpPoolSummary): object;
    function getDeserializedJsonObj(obj: EmailIpPoolSummary): object;
}

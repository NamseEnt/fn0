...
export declare namespace UpdateEmailDomainDetails {
    function getJsonObj(obj: UpdateEmailDomainDetails): object;
    function getDeserializedJsonObj(obj: UpdateEmailDomainDetails): object;
}

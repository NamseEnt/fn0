...
export declare namespace CreateEmailDomainDetails {
    function getJsonObj(obj: CreateEmailDomainDetails): object;
    function getDeserializedJsonObj(obj: CreateEmailDomainDetails): object;
}

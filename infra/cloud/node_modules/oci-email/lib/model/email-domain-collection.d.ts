...
export declare namespace EmailDomainCollection {
    function getJsonObj(obj: EmailDomainCollection): object;
    function getDeserializedJsonObj(obj: EmailDomainCollection): object;
}

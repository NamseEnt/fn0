 ...
 *
 */
export interface AddEmailOutboundIpDetails {
    /**
...
export declare namespace AddEmailOutboundIpDetails {
    function getJsonObj(obj: AddEmailOutboundIpDetails): object;
    function getDeserializedJsonObj(obj: AddEmailOutboundIpDetails): object;
}

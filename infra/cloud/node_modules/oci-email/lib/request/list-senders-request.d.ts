...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/email/ListSenders.ts.html |here} to see how to use ListSendersRequest.
 */
...
export declare namespace ListSendersRequest {
    enum SortBy {

...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/email/ListEmailDomains.ts.html |here} to see how to use ListEmailDomainsRequest.
 */
...
export declare namespace ListEmailDomainsRequest {
    enum SortBy {

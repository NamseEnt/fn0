...
exports.QueueAdminWaiter = void 0;
...
class QueueAdminWaiter {
     ...
     */
    forQueue(request, ...targetStates) {
        return __awaiter(this, void 0, void 0, function* () {
            return oci_common_1.genericTerminalConditionWaiter(this.config, () => this.client.getQueue(request), response => targetStates.includes(response.queue.lifecycleState), targetStates.includes(models.Queue.LifecycleState.Deleted));
        });
    }
    /**
...
exports.QueueAdminWaiter = QueueAdminWaiter;
//# sourceMappingURL=queueadmin-waiter.js.map
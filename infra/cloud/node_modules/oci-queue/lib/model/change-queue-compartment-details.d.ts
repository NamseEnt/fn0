...
export declare namespace ChangeQueueCompartmentDetails {
    function getJsonObj(obj: ChangeQueueCompartmentDetails): object;
    function getDeserializedJsonObj(obj: ChangeQueueCompartmentDetails): object;
}

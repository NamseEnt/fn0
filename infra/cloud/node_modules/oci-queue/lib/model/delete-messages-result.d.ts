...
export declare namespace DeleteMessagesResult {
    function getJsonObj(obj: DeleteMessagesResult): object;
    function getDeserializedJsonObj(obj: DeleteMessagesResult): object;
}

...
(function (CapabilityDetails) {
    function getJsonObj(obj) {
        ...
        if (obj && "type" in obj && obj.type) {
            switch (obj.type) {
                case "LARGE_MESSAGES":
                    return model.LargeMessagesCapabilityDetails.getJsonObj(jsonObj, true);
                case "CONSUMER_GROUPS":
                    return model.ConsumerGroupsCapabilityDetails.getJsonObj(jsonObj, true);
                default:
    ...
    function getDeserializedJsonObj(obj) {
        ...
        if (obj && "type" in obj && obj.type) {
            switch (obj.type) {
                case "LARGE_MESSAGES":
                    return model.LargeMessagesCapabilityDetails.getDeserializedJsonObj(jsonObj, true);
                case "CONSUMER_GROUPS":
                    return model.ConsumerGroupsCapabilityDetails.getDeserializedJsonObj(jsonObj, true);
                default:
                    if (common.LOG.logger)
                        common.LOG.logger.info(`Unknown value for: ${obj.type}`);
            }
...
})(CapabilityDetails = exports.CapabilityDetails || (exports.CapabilityDetails = {}));
//# sourceMappingURL=capability-details.js.map
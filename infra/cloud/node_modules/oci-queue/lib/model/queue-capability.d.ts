 ...
 **/
export declare enum QueueCapability {
...
export declare namespace QueueCapability {
    function getJsonObj(obj: QueueCapability): QueueCapability;
    function getDeserializedJsonObj(obj: QueueCapability): QueueCapability;
}

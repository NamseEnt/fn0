 ...
 **/
export declare enum DelegatedResourceAccessRequestStatus {
    Created = "CREATED",
...
export declare namespace DelegatedResourceAccessRequestStatus {
    function getJsonObj(obj: DelegatedResourceAccessRequestStatus): DelegatedResourceAccessRequestStatus;
    function getDeserializedJsonObj(obj: DelegatedResourceAccessRequestStatus): DelegatedResourceAccessRequestStatus;
}

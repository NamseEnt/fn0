...
*
*/
export interface CreateDelegationControlDetails {
    /**
...
export declare namespace CreateDelegationControlDetails {
    function getJsonObj(obj: CreateDelegationControlDetails): object;
    function getDeserializedJsonObj(obj: CreateDelegationControlDetails): object;
}

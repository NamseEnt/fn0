...
export declare namespace ServiceProviderInteractionSummary {
    enum UserType {
        Customer = "CUSTOMER",
        Operator = "OPERATOR",
        /**
    ...
    function getJsonObj(obj: ServiceProviderInteractionSummary): object;
    function getDeserializedJsonObj(obj: ServiceProviderInteractionSummary): object;
}

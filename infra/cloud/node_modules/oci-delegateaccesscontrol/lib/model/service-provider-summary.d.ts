...
export declare namespace ServiceProviderSummary {
    enum ServiceTypes {
    ...
    function getJsonObj(obj: ServiceProviderSummary): object;
    function getDeserializedJsonObj(obj: ServiceProviderSummary): object;
}

...
export declare namespace DelegationControlResourceSummary {
    enum ResourceStatus {
        Created = "CREATED",
        Applying = "APPLYING",
        Applied = "APPLIED",
    ...
    function getJsonObj(obj: DelegationControlResourceSummary): object;
    function getDeserializedJsonObj(obj: DelegationControlResourceSummary): object;
}

...
export declare namespace PublishedObjectFromPipelineTaskSummary {
    function getJsonObj(obj: PublishedObjectFromPipelineTaskSummary, isParentJsonObj?: boolean): object;
    const modelType = "PIPELINE_TASK";
    function getDeserializedJsonObj(obj: PublishedObjectFromPipelineTaskSummary, isParentJsonObj?: boolean): object;
}

...
(function (TaskSummary) {
        ...
        if (obj && "modelType" in obj && obj.modelType) {
            switch (obj.modelType) {
                case "INTEGRATION_TASK":
                    return model.TaskSummaryFromIntegrationTask.getJsonObj(jsonObj, true);
                case "SQL_TASK":
                    return model.TaskSummaryFromSQLTask.getJsonObj(jsonObj, true);
                case "OCI_DATAFLOW_TASK":
                    return model.TaskSummaryFromOCIDataflowTask.getJsonObj(jsonObj, true);
                case "REST_TASK":
                    return model.TaskSummaryFromRestTask.getJsonObj(jsonObj, true);
                case "PIPELINE_TASK":
                    return model.TaskSummaryFromPipelineTask.getJsonObj(jsonObj, true);
                case "DATA_LOADER_TASK":
                    return model.TaskSummaryFromDataLoaderTask.getJsonObj(jsonObj, true);
                default:
    ...
    TaskSummary.getJsonObj = getJsonObj;
    function getDeserializedJsonObj(obj) {
        ...
        if (obj && "modelType" in obj && obj.modelType) {
            switch (obj.modelType) {
                case "INTEGRATION_TASK":
                    return model.TaskSummaryFromIntegrationTask.getDeserializedJsonObj(jsonObj, true);
                case "SQL_TASK":
                    return model.TaskSummaryFromSQLTask.getDeserializedJsonObj(jsonObj, true);
                case "OCI_DATAFLOW_TASK":
                    return model.TaskSummaryFromOCIDataflowTask.getDeserializedJsonObj(jsonObj, true);
                case "REST_TASK":
                    return model.TaskSummaryFromRestTask.getDeserializedJsonObj(jsonObj, true);
                case "PIPELINE_TASK":
                    return model.TaskSummaryFromPipelineTask.getDeserializedJsonObj(jsonObj, true);
                case "DATA_LOADER_TASK":
                    return model.TaskSummaryFromDataLoaderTask.getDeserializedJsonObj(jsonObj, true);
                default:
                    if (common.LOG.logger)
                        common.LOG.logger.info(`Unknown value for: ${obj.modelType}`);
            }
    ...
    TaskSummary.getDeserializedJsonObj = getDeserializedJsonObj;
})(TaskSummary = exports.TaskSummary || (exports.TaskSummary = {}));

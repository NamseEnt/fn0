...
export declare namespace UpdateTaskFromRestTask {
    enum MethodType {
        Get = "GET",
        Post = "POST",
        Patch = "PATCH",
    ...
    function getJsonObj(obj: UpdateTaskFromRestTask, isParentJsonObj?: boolean): object;
    const modelType = "REST_TASK";
    function getDeserializedJsonObj(obj: UpdateTaskFromRestTask, isParentJsonObj?: boolean): object;
}

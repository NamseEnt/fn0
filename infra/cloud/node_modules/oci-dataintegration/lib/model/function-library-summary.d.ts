...
export interface FunctionLibrarySummary {
     ...
     */
    "modelType"?: FunctionLibrarySummary.ModelType;
    /**
...
export declare namespace FunctionLibrarySummary {
    enum ModelType {
    ...
    function getJsonObj(obj: FunctionLibrarySummary): object;
    function getDeserializedJsonObj(obj: FunctionLibrarySummary): object;
}

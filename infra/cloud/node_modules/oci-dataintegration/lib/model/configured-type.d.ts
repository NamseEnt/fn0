...
export declare namespace ConfiguredType {
    function getJsonObj(obj: ConfiguredType, isParentJsonObj?: boolean): object;
    const modelType = "CONFIGURED_TYPE";
    function getDeserializedJsonObj(obj: ConfiguredType, isParentJsonObj?: boolean): object;
}

...
export declare namespace InputProxyField {
    function getJsonObj(obj: InputProxyField, isParentJsonObj?: boolean): object;
    const modelType = "INPUT_PROXY_FIELD";
    function getDeserializedJsonObj(obj: InputProxyField, isParentJsonObj?: boolean): object;
}

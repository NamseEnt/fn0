...
export declare namespace RuleBasedFieldMap {
    enum MapType {
        Mapbyname = "MAPBYNAME",
    ...
    function getJsonObj(obj: RuleBasedFieldMap, isParentJsonObj?: boolean): object;
    const modelType = "RULE_BASED_FIELD_MAP";
    function getDeserializedJsonObj(obj: RuleBasedFieldMap, isParentJsonObj?: boolean): object;
}

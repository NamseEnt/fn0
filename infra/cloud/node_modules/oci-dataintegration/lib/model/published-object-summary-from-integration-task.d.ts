...
export declare namespace PublishedObjectSummaryFromIntegrationTask {
    function getJsonObj(obj: PublishedObjectSummaryFromIntegrationTask, isParentJsonObj?: boolean): object;
    const modelType = "INTEGRATION_TASK";
    function getDeserializedJsonObj(obj: PublishedObjectSummaryFromIntegrationTask, isParentJsonObj?: boolean): object;
}

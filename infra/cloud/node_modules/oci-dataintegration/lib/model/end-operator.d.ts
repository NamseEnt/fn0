...
export declare namespace EndOperator {
    enum TriggerRule {
    ...
    function getJsonObj(obj: EndOperator, isParentJsonObj?: boolean): object;
    const modelType = "END_OPERATOR";
    function getDeserializedJsonObj(obj: EndOperator, isParentJsonObj?: boolean): object;
}

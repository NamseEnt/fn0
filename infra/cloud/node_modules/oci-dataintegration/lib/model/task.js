...
(function (Task) {
    function getJsonObj(obj) {
        ...
        if (obj && "modelType" in obj && obj.modelType) {
            switch (obj.modelType) {
                case "PIPELINE_TASK":
                    return model.TaskFromPipelineTaskDetails.getJsonObj(jsonObj, true);
                case "INTEGRATION_TASK":
                    return model.TaskFromIntegrationTaskDetails.getJsonObj(jsonObj, true);
                case "SQL_TASK":
                    return model.TaskFromSQLTaskDetails.getJsonObj(jsonObj, true);
                case "REST_TASK":
                    return model.TaskFromRestTaskDetails.getJsonObj(jsonObj, true);
                case "OCI_DATAFLOW_TASK":
                    return model.TaskFromOCIDataflowTaskDetails.getJsonObj(jsonObj, true);
                case "DATA_LOADER_TASK":
                    return model.TaskFromDataLoaderTaskDetails.getJsonObj(jsonObj, true);
                default:
    ...
    function getDeserializedJsonObj(obj) {
        ...
        if (obj && "modelType" in obj && obj.modelType) {
            switch (obj.modelType) {
                case "PIPELINE_TASK":
                    return model.TaskFromPipelineTaskDetails.getDeserializedJsonObj(jsonObj, true);
                case "INTEGRATION_TASK":
                    return model.TaskFromIntegrationTaskDetails.getDeserializedJsonObj(jsonObj, true);
                case "SQL_TASK":
                    return model.TaskFromSQLTaskDetails.getDeserializedJsonObj(jsonObj, true);
                case "REST_TASK":
                    return model.TaskFromRestTaskDetails.getDeserializedJsonObj(jsonObj, true);
                case "OCI_DATAFLOW_TASK":
                    return model.TaskFromOCIDataflowTaskDetails.getDeserializedJsonObj(jsonObj, true);
                case "DATA_LOADER_TASK":
                    return model.TaskFromDataLoaderTaskDetails.getDeserializedJsonObj(jsonObj, true);
                default:
                    if (common.LOG.logger)
                        common.LOG.logger.info(`Unknown value for: ${obj.modelType}`);
            }
    ...
    Task.getDeserializedJsonObj = getDeserializedJsonObj;

...
export declare namespace BiccReadAttributes {
    ...
    function getJsonObj(obj: BiccReadAttributes, isParentJsonObj?: boolean): object;
    const modelType = "BICC_READ_ATTRIBUTE";
    function getDeserializedJsonObj(obj: BiccReadAttributes, isParentJsonObj?: boolean): object;
}

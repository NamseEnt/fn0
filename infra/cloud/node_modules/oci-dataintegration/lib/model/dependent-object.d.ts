...
export interface DependentObject {
     ...
     */
    "lifecycleState"?: DependentObject.LifecycleState;
...
export declare namespace DependentObject {
    enum LifecycleState {
        Creating = "CREATING",
        Active = "ACTIVE",
        Updating = "UPDATING",
    ...
    function getJsonObj(obj: DependentObject): object;
    function getDeserializedJsonObj(obj: DependentObject): object;
}

...
export declare namespace DynamicType {
    function getJsonObj(obj: DynamicType, isParentJsonObj?: boolean): object;
    const modelType = "DYNAMIC_TYPE";
    function getDeserializedJsonObj(obj: DynamicType, isParentJsonObj?: boolean): object;
}

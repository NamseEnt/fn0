...
export declare namespace SensitiveAttribute {
    function getJsonObj(obj: SensitiveAttribute): object;
    function getDeserializedJsonObj(obj: SensitiveAttribute): object;
}

...
export interface TaskFromRestTaskDetails extends model.Task {
     ...
     */
    "methodType"?: TaskFromRestTaskDetails.MethodType;
    /**
     ...
     */
    "apiCallMode"?: TaskFromRestTaskDetails.ApiCallMode;
...
export declare namespace TaskFromRestTaskDetails {
    enum MethodType {
        Get = "GET",
        Post = "POST",
        Patch = "PATCH",
    ...
    function getJsonObj(obj: TaskFromRestTaskDetails, isParentJsonObj?: boolean): object;
    const modelType = "REST_TASK";
    function getDeserializedJsonObj(obj: TaskFromRestTaskDetails, isParentJsonObj?: boolean): object;
}

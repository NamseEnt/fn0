...
export declare namespace PatchChangeSummary {
    enum Type {
    ...
    function getJsonObj(obj: PatchChangeSummary): object;
    function getDeserializedJsonObj(obj: PatchChangeSummary): object;
}

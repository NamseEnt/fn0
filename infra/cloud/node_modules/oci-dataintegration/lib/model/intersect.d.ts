...
export declare namespace Intersect {
    ...
    function getJsonObj(obj: Intersect, isParentJsonObj?: boolean): object;
    const modelType = "INTERSECT_OPERATOR";
    function getDeserializedJsonObj(obj: Intersect, isParentJsonObj?: boolean): object;
}

...
export declare namespace DynamicProxyField {
    function getJsonObj(obj: DynamicProxyField, isParentJsonObj?: boolean): object;
    const modelType = "DYNAMIC_PROXY_FIELD";
    function getDeserializedJsonObj(obj: DynamicProxyField, isParentJsonObj?: boolean): object;
}

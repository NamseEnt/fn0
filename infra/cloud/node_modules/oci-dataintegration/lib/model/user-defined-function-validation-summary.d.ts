 ...
 */
export interface UserDefinedFunctionValidationSummary {
    /**
     ...
     */
    "validationMessages"?: {
        [key: string]: Array<model.ValidationMessage>;
    };
    /**
...
export declare namespace UserDefinedFunctionValidationSummary {
    function getJsonObj(obj: UserDefinedFunctionValidationSummary): object;
    function getDeserializedJsonObj(obj: UserDefinedFunctionValidationSummary): object;
}

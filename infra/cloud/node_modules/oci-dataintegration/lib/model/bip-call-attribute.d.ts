...
export declare namespace BipCallAttribute {
    function getJsonObj(obj: BipCallAttribute, isParentJsonObj?: boolean): object;
    const modelType = "BIP_CALL_ATTRIBUTE";
    function getDeserializedJsonObj(obj: BipCallAttribute, isParentJsonObj?: boolean): object;
}

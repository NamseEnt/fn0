...
export declare namespace OperationFromApi {
    function getJsonObj(obj: OperationFromApi, isParentJsonObj?: boolean): object;
    const modelType = "API";
    function getDeserializedJsonObj(obj: OperationFromApi, isParentJsonObj?: boolean): object;
}

 ...
 */
export interface DynamicInputField extends model.TypedObject {
...
export declare namespace DynamicInputField {
    function getJsonObj(obj: DynamicInputField, isParentJsonObj?: boolean): object;
    const modelType = "DYNAMIC_INPUT_FIELD";
    function getDeserializedJsonObj(obj: DynamicInputField, isParentJsonObj?: boolean): object;
}

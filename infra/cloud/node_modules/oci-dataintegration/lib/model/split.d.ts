...
export declare namespace Split {
    ...
    function getJsonObj(obj: Split, isParentJsonObj?: boolean): object;
    const modelType = "SPLIT_OPERATOR";
    function getDeserializedJsonObj(obj: Split, isParentJsonObj?: boolean): object;
}

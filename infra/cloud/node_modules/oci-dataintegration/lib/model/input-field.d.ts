...
export declare namespace InputField {
    function getJsonObj(obj: InputField, isParentJsonObj?: boolean): object;
    const modelType = "INPUT_FIELD";
    function getDeserializedJsonObj(obj: InputField, isParentJsonObj?: boolean): object;
}

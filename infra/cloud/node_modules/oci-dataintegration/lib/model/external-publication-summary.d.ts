...
export declare namespace ExternalPublicationSummary {
    enum Status {
    ...
    function getJsonObj(obj: ExternalPublicationSummary): object;
    function getDeserializedJsonObj(obj: ExternalPublicationSummary): object;
}

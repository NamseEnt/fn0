...
export declare namespace DataEntityFromDataStore {
    enum EntityType {
        Table = "TABLE",
        View = "VIEW",
        File = "FILE",
    ...
    function getJsonObj(obj: DataEntityFromDataStore, isParentJsonObj?: boolean): object;
    const modelType = "DATA_STORE_ENTITY";
    function getDeserializedJsonObj(obj: DataEntityFromDataStore, isParentJsonObj?: boolean): object;
}

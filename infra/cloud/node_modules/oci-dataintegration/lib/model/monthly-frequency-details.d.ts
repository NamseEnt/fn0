...
export declare namespace MonthlyFrequencyDetails {
    function getJsonObj(obj: MonthlyFrequencyDetails, isParentJsonObj?: boolean): object;
    const modelType = "MONTHLY";
    function getDeserializedJsonObj(obj: MonthlyFrequencyDetails, isParentJsonObj?: boolean): object;
}

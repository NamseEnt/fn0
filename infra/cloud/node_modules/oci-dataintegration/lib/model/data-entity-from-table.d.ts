...
export declare namespace DataEntityFromTable {
    enum EntityType {
        Table = "TABLE",
        View = "VIEW",
        File = "FILE",
    ...
    function getJsonObj(obj: DataEntityFromTable, isParentJsonObj?: boolean): object;
    const modelType = "TABLE_ENTITY";
    function getDeserializedJsonObj(obj: DataEntityFromTable, isParentJsonObj?: boolean): object;
}

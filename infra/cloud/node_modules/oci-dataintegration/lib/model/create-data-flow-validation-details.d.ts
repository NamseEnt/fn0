 ...
 */
export interface CreateDataFlowValidationDetails {
    /**
     ...
     */
    "typedObjectMap"?: {
        [key: string]: model.TypedObjectWrapper;
    };
    /**
    ...
    "targetFieldMapSummary"?: {
        [key: string]: model.FieldMapWrapper;
    };
}
export declare namespace CreateDataFlowValidationDetails {
    function getJsonObj(obj: CreateDataFlowValidationDetails): object;
    function getDeserializedJsonObj(obj: CreateDataFlowValidationDetails): object;
}

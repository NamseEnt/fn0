...
export declare namespace OutputLink {
    function getJsonObj(obj: OutputLink, isParentJsonObj?: boolean): object;
    const modelType = "OUTPUT_LINK";
    function getDeserializedJsonObj(obj: OutputLink, isParentJsonObj?: boolean): object;
}

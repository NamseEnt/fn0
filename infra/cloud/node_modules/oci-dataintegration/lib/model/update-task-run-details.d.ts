...
export declare namespace UpdateTaskRunDetails {
    enum Status {
        Terminating = "TERMINATING"
    }
    function getJsonObj(obj: UpdateTaskRunDetails): object;
    function getDeserializedJsonObj(obj: UpdateTaskRunDetails): object;
}

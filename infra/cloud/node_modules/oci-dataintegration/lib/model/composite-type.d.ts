...
export declare namespace CompositeType {
    function getJsonObj(obj: CompositeType, isParentJsonObj?: boolean): object;
    const modelType = "COMPOSITE_TYPE";
    function getDeserializedJsonObj(obj: CompositeType, isParentJsonObj?: boolean): object;
}

...
export declare namespace DailyFrequencyDetails {
    function getJsonObj(obj: DailyFrequencyDetails, isParentJsonObj?: boolean): object;
    const modelType = "DAILY";
    function getDeserializedJsonObj(obj: DailyFrequencyDetails, isParentJsonObj?: boolean): object;
}

 ...
 */
export interface ConnectionFromHdfs extends model.Connection {
    /**
     * The HDFS principal.
     */
...
export declare namespace ConnectionFromHdfs {
    function getJsonObj(obj: ConnectionFromHdfs, isParentJsonObj?: boolean): object;
    const modelType = "HDFS_CONNECTION";
    function getDeserializedJsonObj(obj: ConnectionFromHdfs, isParentJsonObj?: boolean): object;
}

...
exports.CreateTaskValidationDetails = void 0;
const model = __importStar(require("../model"));
const common = require("oci-common");
var CreateTaskValidationDetails;
(function (CreateTaskValidationDetails) {
        ...
        if (obj && "modelType" in obj && obj.modelType) {
            switch (obj.modelType) {
                case "DATA_LOADER_TASK":
                    return model.CreateTaskValidationFromDataLoaderTask.getJsonObj(jsonObj, true);
                case "PIPELINE_TASK":
                    return model.CreateTaskValidationFromPipelineTask.getJsonObj(jsonObj, true);
                case "INTEGRATION_TASK":
                    return model.CreateTaskValidationFromIntegrationTask.getJsonObj(jsonObj, true);
                default:
    ...
    CreateTaskValidationDetails.getJsonObj = getJsonObj;
    function getDeserializedJsonObj(obj) {
        ...
        if (obj && "modelType" in obj && obj.modelType) {
            switch (obj.modelType) {
                case "DATA_LOADER_TASK":
                    return model.CreateTaskValidationFromDataLoaderTask.getDeserializedJsonObj(jsonObj, true);
                case "PIPELINE_TASK":
                    return model.CreateTaskValidationFromPipelineTask.getDeserializedJsonObj(jsonObj, true);
                case "INTEGRATION_TASK":
                    return model.CreateTaskValidationFromIntegrationTask.getDeserializedJsonObj(jsonObj, true);
                default:
                    if (common.LOG.logger)
                        common.LOG.logger.info(`Unknown value for: ${obj.modelType}`);
            }
    ...
    CreateTaskValidationDetails.getDeserializedJsonObj = getDeserializedJsonObj;
})(CreateTaskValidationDetails = exports.CreateTaskValidationDetails || (exports.CreateTaskValidationDetails = {}));
//# sourceMappingURL=create-task-validation-details.js.map
...
export declare namespace CreateEntityShapeFromFile {
    enum EntityType {
        Table = "TABLE",
        View = "VIEW",
        File = "FILE",
    ...
    function getJsonObj(obj: CreateEntityShapeFromFile, isParentJsonObj?: boolean): object;
    const modelType = "FILE_ENTITY";
    function getDeserializedJsonObj(obj: CreateEntityShapeFromFile, isParentJsonObj?: boolean): object;
}

...
export declare namespace CompositeState {
    enum CompositeStateAggregator {
    ...
    function getJsonObj(obj: CompositeState): object;
    function getDeserializedJsonObj(obj: CompositeState): object;
}

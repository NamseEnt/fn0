...
export declare namespace RuntimePipelineSummary {
    function getJsonObj(obj: RuntimePipelineSummary): object;
    function getDeserializedJsonObj(obj: RuntimePipelineSummary): object;
}

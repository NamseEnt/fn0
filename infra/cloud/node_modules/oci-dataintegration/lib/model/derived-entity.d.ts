...
export declare namespace DerivedEntity {
    enum Mode {
        In = "IN",
        Out = "OUT",
        /**
    ...
    function getJsonObj(obj: DerivedEntity, isParentJsonObj?: boolean): object;
    const modelType = "DERIVED_ENTITY";
    function getDeserializedJsonObj(obj: DerivedEntity, isParentJsonObj?: boolean): object;
}

...
export declare namespace CreateDataAssetFromMySQL {
    function getJsonObj(obj: CreateDataAssetFromMySQL, isParentJsonObj?: boolean): object;
    const modelType = "MYSQL_DATA_ASSET";
    function getDeserializedJsonObj(obj: CreateDataAssetFromMySQL, isParentJsonObj?: boolean): object;
}

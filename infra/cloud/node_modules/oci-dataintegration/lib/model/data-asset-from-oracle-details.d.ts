...
export declare namespace DataAssetFromOracleDetails {
    function getJsonObj(obj: DataAssetFromOracleDetails, isParentJsonObj?: boolean): object;
    const modelType = "ORACLE_DATA_ASSET";
    function getDeserializedJsonObj(obj: DataAssetFromOracleDetails, isParentJsonObj?: boolean): object;
}

 ...
 */
export interface DataEntitySummaryFromDataStore extends model.DataEntitySummary {
    /**
     * The object key.
     */
    "key"?: string;
     ...
     * The entity type.
     */
    "entityType"?: DataEntitySummaryFromDataStore.EntityType;
    /**
...
export declare namespace DataEntitySummaryFromDataStore {
    enum EntityType {
        Table = "TABLE",
        View = "VIEW",
        File = "FILE",
    ...
    function getJsonObj(obj: DataEntitySummaryFromDataStore, isParentJsonObj?: boolean): object;
    const modelType = "DATA_STORE_ENTITY";
    function getDeserializedJsonObj(obj: DataEntitySummaryFromDataStore, isParentJsonObj?: boolean): object;
}

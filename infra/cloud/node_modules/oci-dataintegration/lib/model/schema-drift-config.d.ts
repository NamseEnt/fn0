...
export declare namespace SchemaDriftConfig {
    enum ExtraColumnHandling {
        Allow = "ALLOW",
    ...
    function getJsonObj(obj: SchemaDriftConfig): object;
    function getDeserializedJsonObj(obj: SchemaDriftConfig): object;
}

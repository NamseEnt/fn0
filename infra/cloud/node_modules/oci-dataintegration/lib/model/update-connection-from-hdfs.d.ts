...
export declare namespace UpdateConnectionFromHdfs {
    function getJsonObj(obj: UpdateConnectionFromHdfs, isParentJsonObj?: boolean): object;
    const modelType = "HDFS_CONNECTION";
    function getDeserializedJsonObj(obj: UpdateConnectionFromHdfs, isParentJsonObj?: boolean): object;
}

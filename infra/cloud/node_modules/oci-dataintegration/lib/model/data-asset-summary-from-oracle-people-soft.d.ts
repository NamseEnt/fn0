...
export declare namespace DataAssetSummaryFromOraclePeopleSoft {
    function getJsonObj(obj: DataAssetSummaryFromOraclePeopleSoft, isParentJsonObj?: boolean): object;
    const modelType = "ORACLE_PEOPLESOFT_DATA_ASSET";
    function getDeserializedJsonObj(obj: DataAssetSummaryFromOraclePeopleSoft, isParentJsonObj?: boolean): object;
}

...
export declare namespace AbstractCallAttribute {
    function getJsonObj(obj: AbstractCallAttribute): object;
    function getDeserializedJsonObj(obj: AbstractCallAttribute): object;
}

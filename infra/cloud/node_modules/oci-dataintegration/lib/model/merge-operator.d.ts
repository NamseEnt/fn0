...
export declare namespace MergeOperator {
    enum TriggerRule {
    ...
    function getJsonObj(obj: MergeOperator, isParentJsonObj?: boolean): object;
    const modelType = "MERGE_OPERATOR";
    function getDeserializedJsonObj(obj: MergeOperator, isParentJsonObj?: boolean): object;
}

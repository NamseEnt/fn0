...
export declare namespace TypeListRule {
    ...
    function getJsonObj(obj: TypeListRule, isParentJsonObj?: boolean): object;
    const modelType = "TYPE_LIST_RULE";
    function getDeserializedJsonObj(obj: TypeListRule, isParentJsonObj?: boolean): object;
}

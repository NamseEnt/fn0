...
export declare namespace TaskSummaryFromSQLTask {
    enum SqlScriptType {
        StoredProcedure = "STORED_PROCEDURE",
        SqlCode = "SQL_CODE"
    }
    function getJsonObj(obj: TaskSummaryFromSQLTask, isParentJsonObj?: boolean): object;
    const modelType = "SQL_TASK";
    function getDeserializedJsonObj(obj: TaskSummaryFromSQLTask, isParentJsonObj?: boolean): object;
}

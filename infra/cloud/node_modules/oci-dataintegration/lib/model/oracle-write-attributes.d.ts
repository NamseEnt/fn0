...
export declare namespace OracleWriteAttributes {
    function getJsonObj(obj: OracleWriteAttributes, isParentJsonObj?: boolean): object;
    const modelType = "ORACLE_WRITE_ATTRIBUTE";
    function getDeserializedJsonObj(obj: OracleWriteAttributes, isParentJsonObj?: boolean): object;
}

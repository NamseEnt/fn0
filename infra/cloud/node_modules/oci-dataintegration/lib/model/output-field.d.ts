...
export declare namespace OutputField {
    function getJsonObj(obj: OutputField, isParentJsonObj?: boolean): object;
    const modelType = "OUTPUT_FIELD";
    function getDeserializedJsonObj(obj: OutputField, isParentJsonObj?: boolean): object;
}

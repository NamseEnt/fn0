...
export declare namespace ExternalPublication {
    enum Status {
    ...
    function getJsonObj(obj: ExternalPublication): object;
    function getDeserializedJsonObj(obj: ExternalPublication): object;
}

...
export declare namespace Pivot {
    function getJsonObj(obj: Pivot, isParentJsonObj?: boolean): object;
    const modelType = "PIVOT_OPERATOR";
    function getDeserializedJsonObj(obj: Pivot, isParentJsonObj?: boolean): object;
}

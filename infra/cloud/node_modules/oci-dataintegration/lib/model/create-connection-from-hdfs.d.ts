 ...
 */
export interface CreateConnectionFromHdfs extends model.CreateConnectionDetails {
    /**
     * The HDFS principal.
     */
...
export declare namespace CreateConnectionFromHdfs {
    function getJsonObj(obj: CreateConnectionFromHdfs, isParentJsonObj?: boolean): object;
    const modelType = "HDFS_CONNECTION";
    function getDeserializedJsonObj(obj: CreateConnectionFromHdfs, isParentJsonObj?: boolean): object;
}

...
export declare namespace PipelineValidation {
    function getJsonObj(obj: PipelineValidation): object;
    function getDeserializedJsonObj(obj: PipelineValidation): object;
}

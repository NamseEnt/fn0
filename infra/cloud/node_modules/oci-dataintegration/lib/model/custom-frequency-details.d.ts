...
export declare namespace CustomFrequencyDetails {
    function getJsonObj(obj: CustomFrequencyDetails, isParentJsonObj?: boolean): object;
    const modelType = "CUSTOM";
    function getDeserializedJsonObj(obj: CustomFrequencyDetails, isParentJsonObj?: boolean): object;
}

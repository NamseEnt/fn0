...
export declare namespace UpdateTaskDetails {
    function getJsonObj(obj: UpdateTaskDetails): object;
    function getDeserializedJsonObj(obj: UpdateTaskDetails): object;
}

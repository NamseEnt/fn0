...
export declare namespace UpdateReferenceDetails {
    function getJsonObj(obj: UpdateReferenceDetails): object;
    function getDeserializedJsonObj(obj: UpdateReferenceDetails): object;
}

...
export declare namespace PatchSummaryCollection {
    function getJsonObj(obj: PatchSummaryCollection): object;
    function getDeserializedJsonObj(obj: PatchSummaryCollection): object;
}

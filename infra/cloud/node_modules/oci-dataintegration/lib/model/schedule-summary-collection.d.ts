...
export declare namespace ScheduleSummaryCollection {
    function getJsonObj(obj: ScheduleSummaryCollection): object;
    function getDeserializedJsonObj(obj: ScheduleSummaryCollection): object;
}

...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/dataintegration/ListRuntimePipelines.ts.html |here} to see how to use ListRuntimePipelinesRequest.
 */
...
export declare namespace ListRuntimePipelinesRequest {
    enum SortOrder {
        Asc = "ASC",
        Desc = "DESC"
    }

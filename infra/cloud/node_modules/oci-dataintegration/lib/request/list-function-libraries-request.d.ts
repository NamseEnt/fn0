...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/dataintegration/ListFunctionLibraries.ts.html |here} to see how to use ListFunctionLibrariesRequest.
 */
...
export declare namespace ListFunctionLibrariesRequest {
    enum SortOrder {
        Asc = "ASC",
        Desc = "DESC"
    }

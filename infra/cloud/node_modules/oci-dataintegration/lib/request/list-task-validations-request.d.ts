...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/dataintegration/ListTaskValidations.ts.html |here} to see how to use ListTaskValidationsRequest.
 */
...
export declare namespace ListTaskValidationsRequest {
    enum SortBy {

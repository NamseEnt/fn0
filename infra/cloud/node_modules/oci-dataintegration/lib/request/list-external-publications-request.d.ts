...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/dataintegration/ListExternalPublications.ts.html |here} to see how to use ListExternalPublicationsRequest.
 */
...
export declare namespace ListExternalPublicationsRequest {
    enum SortOrder {
        Asc = "ASC",
        Desc = "DESC"
    }

...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/dataintegration/ListTaskRunLineages.ts.html |here} to see how to use ListTaskRunLineagesRequest.
 */
...
export declare namespace ListTaskRunLineagesRequest {
    enum SortOrder {
        Asc = "ASC",
        Desc = "DESC"
    }

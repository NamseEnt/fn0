...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/dataintegration/ListConnectionValidations.ts.html |here} to see how to use ListConnectionValidationsRequest.
 */
...
export declare namespace ListConnectionValidationsRequest {
    enum SortBy {

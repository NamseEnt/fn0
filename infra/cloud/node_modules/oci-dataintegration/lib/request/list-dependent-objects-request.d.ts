...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/dataintegration/ListDependentObjects.ts.html |here} to see how to use ListDependentObjectsRequest.
 */
...
export declare namespace ListDependentObjectsRequest {
    enum SortOrder {
        Asc = "ASC",
        Desc = "DESC"
    }

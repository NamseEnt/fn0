...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/dataintegration/ListExportRequests.ts.html |here} to see how to use ListExportRequestsRequest.
 */
...
export declare namespace ListExportRequestsRequest {
    enum SortOrder {
        Asc = "ASC",
        Desc = "DESC"
    }

...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/dataintegration/ListExternalPublicationValidations.ts.html |here} to see how to use ListExternalPublicationValidationsRequest.
 */
...
export declare namespace ListExternalPublicationValidationsRequest {
    enum SortOrder {
        Asc = "ASC",
        Desc = "DESC"
    }

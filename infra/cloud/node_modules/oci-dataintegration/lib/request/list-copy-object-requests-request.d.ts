...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/dataintegration/ListCopyObjectRequests.ts.html |here} to see how to use ListCopyObjectRequestsRequest.
 */
...
export declare namespace ListCopyObjectRequestsRequest {
    enum SortOrder {
        Asc = "ASC",
        Desc = "DESC"
    }

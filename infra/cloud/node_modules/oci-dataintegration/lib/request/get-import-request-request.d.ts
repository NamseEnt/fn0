...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/dataintegration/GetImportRequest.ts.html |here} to see how to use GetImportRequestRequest.
 */
export interface GetImportRequestRequest extends common.BaseRequest {
    /**
     * The workspace ID.
     */
    "workspaceId": string;

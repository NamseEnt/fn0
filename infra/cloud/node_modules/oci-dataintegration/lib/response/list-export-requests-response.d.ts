...
export interface ListExportRequestsResponse {
    /**
    ...
    "opcNextPage": string;
    /**
     * The returned model.ExportRequestSummaryCollection instance.
     */
    "exportRequestSummaryCollection": model.ExportRequestSummaryCollection;
}

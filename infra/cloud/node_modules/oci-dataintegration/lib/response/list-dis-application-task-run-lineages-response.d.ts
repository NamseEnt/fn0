...
export interface ListDisApplicationTaskRunLineagesResponse {
    /**
    ...
    "opcNextPage": string;
    /**
     * The returned model.TaskRunLineageSummaryCollection instance.
     */
    "taskRunLineageSummaryCollection": model.TaskRunLineageSummaryCollection;
}

...
export interface ListPatchChangesResponse {
    /**
    ...
    /**
     * The returned model.PatchChangeSummaryCollection instance.
     */
    "patchChangeSummaryCollection": model.PatchChangeSummaryCollection;
}

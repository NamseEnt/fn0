...
export interface ListUserDefinedFunctionsResponse {
    /**
    ...
    /**
     * The returned model.UserDefinedFunctionSummaryCollection instance.
     */
    "userDefinedFunctionSummaryCollection": model.UserDefinedFunctionSummaryCollection;
}

...
export interface ListDependentObjectsResponse {
    /**
    ...
    /**
     * The returned model.DependentObjectSummaryCollection instance.
     */
    "dependentObjectSummaryCollection": model.DependentObjectSummaryCollection;
}

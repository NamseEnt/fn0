...
export interface ListDisApplicationsResponse {
    /**
    ...
    /**
     * The returned model.DisApplicationSummaryCollection instance.
     */
    "disApplicationSummaryCollection": model.DisApplicationSummaryCollection;
}

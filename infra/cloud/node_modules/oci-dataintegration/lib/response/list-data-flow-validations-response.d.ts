...
export interface ListDataFlowValidationsResponse {
    /**
    ...
    /**
     * The returned model.DataFlowValidationSummaryCollection instance.
     */
    "dataFlowValidationSummaryCollection": model.DataFlowValidationSummaryCollection;
}

...
export interface ListCopyObjectRequestsResponse {
    /**
    ...
    "opcNextPage": string;
    /**
     * The returned model.CopyObjectRequestSummaryCollection instance.
     */
    "copyObjectRequestSummaryCollection": model.CopyObjectRequestSummaryCollection;
}

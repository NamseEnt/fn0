...
export interface ListFunctionLibrariesResponse {
    /**
    ...
    /**
     * The returned model.FunctionLibrarySummaryCollection instance.
     */
    "functionLibrarySummaryCollection": model.FunctionLibrarySummaryCollection;
}

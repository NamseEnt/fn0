...
export declare class EmWarehouseWaiter {
     ...
     */
    forEmWarehouse(request: serviceRequests.GetEmWarehouseRequest, ...targetStates: models.EmWarehouse.LifecycleState[]): Promise<serviceResponses.GetEmWarehouseResponse | null>;
    /**

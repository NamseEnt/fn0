...
export declare namespace HealthChecksVantagePointSummary {
    function getJsonObj(obj: HealthChecksVantagePointSummary): object;
    function getDeserializedJsonObj(obj: HealthChecksVantagePointSummary): object;
}

 ...
 */
export interface ChangeOpaInstanceCompartmentDetails {
    /**
...
export declare namespace ChangeOpaInstanceCompartmentDetails {
    function getJsonObj(obj: ChangeOpaInstanceCompartmentDetails): object;
    function getDeserializedJsonObj(obj: ChangeOpaInstanceCompartmentDetails): object;
}

 ...
 */
export interface OpaInstanceCollection {
    /**
     * List of opaInstances.
     */
    "items": Array<model.OpaInstanceSummary>;
}
export declare namespace OpaInstanceCollection {
    function getJsonObj(obj: OpaInstanceCollection): object;
    function getDeserializedJsonObj(obj: OpaInstanceCollection): object;
}

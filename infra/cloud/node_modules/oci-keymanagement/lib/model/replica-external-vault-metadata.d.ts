...
export declare namespace ReplicaExternalVaultMetadata {
    function getJsonObj(obj: ReplicaExternalVaultMetadata, isParentJsonObj?: boolean): object;
    const vaultType = "EXTERNAL";
    function getDeserializedJsonObj(obj: ReplicaExternalVaultMetadata, isParentJsonObj?: boolean): object;
}

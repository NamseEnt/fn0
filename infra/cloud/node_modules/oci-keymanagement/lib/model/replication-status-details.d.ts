...
export declare namespace ReplicationStatusDetails {
    function getJsonObj(obj: ReplicationStatusDetails): object;
    function getDeserializedJsonObj(obj: ReplicationStatusDetails): object;
}

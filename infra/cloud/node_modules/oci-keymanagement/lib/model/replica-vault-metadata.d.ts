...
export declare namespace ReplicaVaultMetadata {
    function getJsonObj(obj: ReplicaVaultMetadata): object;
    function getDeserializedJsonObj(obj: ReplicaVaultMetadata): object;
}

...
export declare namespace ScheduleKeyVersionDeletionDetails {
    function getJsonObj(obj: ScheduleKeyVersionDeletionDetails): object;
    function getDeserializedJsonObj(obj: ScheduleKeyVersionDeletionDetails): object;
}

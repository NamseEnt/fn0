...
export declare namespace AutoKeyRotationDetails {
    enum LastRotationStatus {
        Success = "SUCCESS",
        Failed = "FAILED",
    ...
    function getJsonObj(obj: AutoKeyRotationDetails): object;
    function getDeserializedJsonObj(obj: AutoKeyRotationDetails): object;
}

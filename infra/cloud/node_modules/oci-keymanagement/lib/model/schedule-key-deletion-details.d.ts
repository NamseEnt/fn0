...
export declare namespace ScheduleKeyDeletionDetails {
    function getJsonObj(obj: ScheduleKeyDeletionDetails): object;
    function getDeserializedJsonObj(obj: ScheduleKeyDeletionDetails): object;
}

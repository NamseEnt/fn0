...
export declare namespace VerifyDataDetails {
    enum MessageType {
        Raw = "RAW",
        Digest = "DIGEST"
    }
    ...
    function getJsonObj(obj: VerifyDataDetails): object;
    function getDeserializedJsonObj(obj: VerifyDataDetails): object;
}

...
export declare namespace BackupLocationBucket {
    function getJsonObj(obj: BackupLocationBucket, isParentJsonObj?: boolean): object;
    const destination = "BUCKET";
    function getDeserializedJsonObj(obj: BackupLocationBucket, isParentJsonObj?: boolean): object;
}

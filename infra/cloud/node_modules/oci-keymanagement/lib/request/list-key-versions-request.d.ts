...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/keymanagement/ListKeyVersions.ts.html |here} to see how to use ListKeyVersionsRequest.
 */
...
export declare namespace ListKeyVersionsRequest {
    enum SortBy {

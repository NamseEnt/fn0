...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/keymanagement/ListEkmsPrivateEndpoints.ts.html |here} to see how to use ListEkmsPrivateEndpointsRequest.
 */
...
export declare namespace ListEkmsPrivateEndpointsRequest {
    enum SortOrder {
        Asc = "ASC",
        Desc = "DESC"
    }

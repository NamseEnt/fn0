...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/keymanagement/ListVaultReplicas.ts.html |here} to see how to use ListVaultReplicasRequest.
 */
...
export declare namespace ListVaultReplicasRequest {
    enum SortBy {

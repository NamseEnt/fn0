...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/keymanagement/ListVaults.ts.html |here} to see how to use ListVaultsRequest.
 */
...
export declare namespace ListVaultsRequest {
    enum SortBy {

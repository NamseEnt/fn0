...
export declare namespace UpdateDrgRouteDistributionDetails {
    function getJsonObj(obj: UpdateDrgRouteDistributionDetails): object;
    function getDeserializedJsonObj(obj: UpdateDrgRouteDistributionDetails): object;
}

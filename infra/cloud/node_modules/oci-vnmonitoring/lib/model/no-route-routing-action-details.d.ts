 ...
 *
 */
export interface NoRouteRoutingActionDetails {
    /**
...
export declare namespace NoRouteRoutingActionDetails {
    function getJsonObj(obj: NoRouteRoutingActionDetails): object;
    function getDeserializedJsonObj(obj: NoRouteRoutingActionDetails): object;
}

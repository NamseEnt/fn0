...
import * as ChangeDrgAttachmentCompartmentDetails from "./change-drg-attachment-compartment-details";
export import ChangeDrgAttachmentCompartmentDetails = ChangeDrgAttachmentCompartmentDetails.ChangeDrgAttachmentCompartmentDetails;
import * as ChangeFlexTunnelCompartmentDetails from "./change-flex-tunnel-compartment-details";
export import ChangeFlexTunnelCompartmentDetails = ChangeFlexTunnelCompartmentDetails.ChangeFlexTunnelCompartmentDetails;
...
import * as CreateFlexTunnelBgpSessionDetails from "./create-flex-tunnel-bgp-session-details";
export import CreateFlexTunnelBgpSessionDetails = CreateFlexTunnelBgpSessionDetails.CreateFlexTunnelBgpSessionDetails;
import * as CreateFlexTunnelConfigurationDetails from "./create-flex-tunnel-configuration-details";
export import CreateFlexTunnelConfigurationDetails = CreateFlexTunnelConfigurationDetails.CreateFlexTunnelConfigurationDetails;
import * as CreateFlexTunnelDetails from "./create-flex-tunnel-details";
export import CreateFlexTunnelDetails = CreateFlexTunnelDetails.CreateFlexTunnelDetails;
...
import * as DrgCustomer from "./drg-customer";
export import DrgCustomer = DrgCustomer.DrgCustomer;
import * as DrgCustomerResource from "./drg-customer-resource";
export import DrgCustomerResource = DrgCustomerResource.DrgCustomerResource;
...
import * as FlexTunnel from "./flex-tunnel";
export import FlexTunnel = FlexTunnel.FlexTunnel;
import * as FlexTunnelBgpSession from "./flex-tunnel-bgp-session";
export import FlexTunnelBgpSession = FlexTunnelBgpSession.FlexTunnelBgpSession;
import * as FlexTunnelBgpStatus from "./flex-tunnel-bgp-status";
export import FlexTunnelBgpStatus = FlexTunnelBgpStatus.FlexTunnelBgpStatus;
import * as FlexTunnelCollection from "./flex-tunnel-collection";
export import FlexTunnelCollection = FlexTunnelCollection.FlexTunnelCollection;
import * as FlexTunnelConfiguration from "./flex-tunnel-configuration";
export import FlexTunnelConfiguration = FlexTunnelConfiguration.FlexTunnelConfiguration;
import * as FlexTunnelRouteSummary from "./flex-tunnel-route-summary";
export import FlexTunnelRouteSummary = FlexTunnelRouteSummary.FlexTunnelRouteSummary;
import * as FlexTunnelSummary from "./flex-tunnel-summary";
export import FlexTunnelSummary = FlexTunnelSummary.FlexTunnelSummary;
...
import * as SetDrgPeeringConnectionDetails from "./set-drg-peering-connection-details";
export import SetDrgPeeringConnectionDetails = SetDrgPeeringConnectionDetails.SetDrgPeeringConnectionDetails;
...
import * as UpdateFlexTunnelBgpSessionDetails from "./update-flex-tunnel-bgp-session-details";
export import UpdateFlexTunnelBgpSessionDetails = UpdateFlexTunnelBgpSessionDetails.UpdateFlexTunnelBgpSessionDetails;
import * as UpdateFlexTunnelConfigurationDetails from "./update-flex-tunnel-configuration-details";
export import UpdateFlexTunnelConfigurationDetails = UpdateFlexTunnelConfigurationDetails.UpdateFlexTunnelConfigurationDetails;
import * as UpdateFlexTunnelDetails from "./update-flex-tunnel-details";
export import UpdateFlexTunnelDetails = UpdateFlexTunnelDetails.UpdateFlexTunnelDetails;
...
import * as ZprAllowedSecurityActionDetails from "./zpr-allowed-security-action-details";
export import ZprAllowedSecurityActionDetails = ZprAllowedSecurityActionDetails.ZprAllowedSecurityActionDetails;
import * as ZprCidrUnsupportedSecurityActionDetails from "./zpr-cidr-unsupported-security-action-details";
export import ZprCidrUnsupportedSecurityActionDetails = ZprCidrUnsupportedSecurityActionDetails.ZprCidrUnsupportedSecurityActionDetails;
import * as ZprDeniedSecurityActionDetails from "./zpr-denied-security-action-details";
export import ZprDeniedSecurityActionDetails = ZprDeniedSecurityActionDetails.ZprDeniedSecurityActionDetails;
import * as ZprNsgUnsupportedSecurityActionDetails from "./zpr-nsg-unsupported-security-action-details";
export import ZprNsgUnsupportedSecurityActionDetails = ZprNsgUnsupportedSecurityActionDetails.ZprNsgUnsupportedSecurityActionDetails;
...
import * as CreateGreFlexTunnelConfigurationDetails from "./create-gre-flex-tunnel-configuration-details";
export import CreateGreFlexTunnelConfigurationDetails = CreateGreFlexTunnelConfigurationDetails.CreateGreFlexTunnelConfigurationDetails;
...
import * as FlexTunnelDrgAttachmentNetworkCreateDetails from "./flex-tunnel-drg-attachment-network-create-details";
export import FlexTunnelDrgAttachmentNetworkCreateDetails = FlexTunnelDrgAttachmentNetworkCreateDetails.FlexTunnelDrgAttachmentNetworkCreateDetails;
import * as FlexTunnelDrgAttachmentNetworkDetails from "./flex-tunnel-drg-attachment-network-details";
export import FlexTunnelDrgAttachmentNetworkDetails = FlexTunnelDrgAttachmentNetworkDetails.FlexTunnelDrgAttachmentNetworkDetails;
...
import * as GreFlexTunnelConfiguration from "./gre-flex-tunnel-configuration";
export import GreFlexTunnelConfiguration = GreFlexTunnelConfiguration.GreFlexTunnelConfiguration;
...
import * as InternetDrgAttachmentNetworkCreateDetails from "./internet-drg-attachment-network-create-details";
export import InternetDrgAttachmentNetworkCreateDetails = InternetDrgAttachmentNetworkCreateDetails.InternetDrgAttachmentNetworkCreateDetails;
import * as InternetDrgAttachmentNetworkDetails from "./internet-drg-attachment-network-details";
export import InternetDrgAttachmentNetworkDetails = InternetDrgAttachmentNetworkDetails.InternetDrgAttachmentNetworkDetails;
import * as InternetDrgAttachmentNetworkUpdateDetails from "./internet-drg-attachment-network-update-details";
export import InternetDrgAttachmentNetworkUpdateDetails = InternetDrgAttachmentNetworkUpdateDetails.InternetDrgAttachmentNetworkUpdateDetails;
import * as IpAddressEndpoint from "./ip-address-endpoint";
export import IpAddressEndpoint = IpAddressEndpoint.IpAddressEndpoint;
import * as IpsecTunnelDrgAttachmentNetworkCreateDetails from "./ipsec-tunnel-drg-attachment-network-create-details";
export import IpsecTunnelDrgAttachmentNetworkCreateDetails = IpsecTunnelDrgAttachmentNetworkCreateDetails.IpsecTunnelDrgAttachmentNetworkCreateDetails;
...
import * as LoopBackDrgAttachmentNetworkCreateDetails from "./loop-back-drg-attachment-network-create-details";
export import LoopBackDrgAttachmentNetworkCreateDetails = LoopBackDrgAttachmentNetworkCreateDetails.LoopBackDrgAttachmentNetworkCreateDetails;
...
import * as LoopbackDrgAttachmentNetworkUpdateDetails from "./loopback-drg-attachment-network-update-details";
export import LoopbackDrgAttachmentNetworkUpdateDetails = LoopbackDrgAttachmentNetworkUpdateDetails.LoopbackDrgAttachmentNetworkUpdateDetails;
...
import * as PrivateServiceAccessEndpoint from "./private-service-access-endpoint";
export import PrivateServiceAccessEndpoint = PrivateServiceAccessEndpoint.PrivateServiceAccessEndpoint;
import * as RemotePeeringConnectionDrgAttachmentNetworkCreateDetails from "./remote-peering-connection-drg-attachment-network-create-details";
export import RemotePeeringConnectionDrgAttachmentNetworkCreateDetails = RemotePeeringConnectionDrgAttachmentNetworkCreateDetails.RemotePeeringConnectionDrgAttachmentNetworkCreateDetails;
...
import * as StatefulZprConfiguration from "./stateful-zpr-configuration";
export import StatefulZprConfiguration = StatefulZprConfiguration.StatefulZprConfiguration;
...
import * as UpdateGreFlexTunnelConfigurationDetails from "./update-gre-flex-tunnel-configuration-details";
export import UpdateGreFlexTunnelConfigurationDetails = UpdateGreFlexTunnelConfigurationDetails.UpdateGreFlexTunnelConfigurationDetails;
...
import * as VirtualCircuitDrgAttachmentNetworkCreateDetails from "./virtual-circuit-drg-attachment-network-create-details";
export import VirtualCircuitDrgAttachmentNetworkCreateDetails = VirtualCircuitDrgAttachmentNetworkCreateDetails.VirtualCircuitDrgAttachmentNetworkCreateDetails;
...
import * as VirtualCircuitDrgAttachmentNetworkUpdateDetails from "./virtual-circuit-drg-attachment-network-update-details";
export import VirtualCircuitDrgAttachmentNetworkUpdateDetails = VirtualCircuitDrgAttachmentNetworkUpdateDetails.VirtualCircuitDrgAttachmentNetworkUpdateDetails;
...
import * as ZprAllowedSecurityAction from "./zpr-allowed-security-action";
export import ZprAllowedSecurityAction = ZprAllowedSecurityAction.ZprAllowedSecurityAction;
import * as ZprCidrUnsupportedSecurityAction from "./zpr-cidr-unsupported-security-action";
export import ZprCidrUnsupportedSecurityAction = ZprCidrUnsupportedSecurityAction.ZprCidrUnsupportedSecurityAction;
import * as ZprConfiguration from "./zpr-configuration";
export import ZprConfiguration = ZprConfiguration.ZprConfiguration;
import * as ZprDeniedSecurityAction from "./zpr-denied-security-action";
export import ZprDeniedSecurityAction = ZprDeniedSecurityAction.ZprDeniedSecurityAction;
import * as ZprMissingPolicySecurityAction from "./zpr-missing-policy-security-action";
export import ZprMissingPolicySecurityAction = ZprMissingPolicySecurityAction.ZprMissingPolicySecurityAction;
import * as ZprNsgUnsupportedSecurityAction from "./zpr-nsg-unsupported-security-action";
export import ZprNsgUnsupportedSecurityAction = ZprNsgUnsupportedSecurityAction.ZprNsgUnsupportedSecurityAction;
import * as ZprPolicyNotEvaluatedMissingRouteSecurityAction from "./zpr-policy-not-evaluated-missing-route-security-action";
export import ZprPolicyNotEvaluatedMissingRouteSecurityAction = ZprPolicyNotEvaluatedMissingRouteSecurityAction.ZprPolicyNotEvaluatedMissingRouteSecurityAction;
import * as ZprPolicyNotEvaluatedSlNsgDeniedSecurityAction from "./zpr-policy-not-evaluated-sl-nsg-denied-security-action";
export import ZprPolicyNotEvaluatedSlNsgDeniedSecurityAction = ZprPolicyNotEvaluatedSlNsgDeniedSecurityAction.ZprPolicyNotEvaluatedSlNsgDeniedSecurityAction;

...
export declare namespace IcmpProtocolParameters {
    function getJsonObj(obj: IcmpProtocolParameters, isParentJsonObj?: boolean): object;
    const type = "ICMP";
    function getDeserializedJsonObj(obj: IcmpProtocolParameters, isParentJsonObj?: boolean): object;
}

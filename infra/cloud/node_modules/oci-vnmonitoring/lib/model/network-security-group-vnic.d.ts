...
export declare namespace NetworkSecurityGroupVnic {
    function getJsonObj(obj: NetworkSecurityGroupVnic): object;
    function getDeserializedJsonObj(obj: NetworkSecurityGroupVnic): object;
}

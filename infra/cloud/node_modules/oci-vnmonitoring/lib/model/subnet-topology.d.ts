...
export declare namespace SubnetTopology {
    function getJsonObj(obj: SubnetTopology, isParentJsonObj?: boolean): object;
    const type = "SUBNET";
    function getDeserializedJsonObj(obj: SubnetTopology, isParentJsonObj?: boolean): object;
}

...
export declare namespace UdpProtocolParameters {
    function getJsonObj(obj: UdpProtocolParameters, isParentJsonObj?: boolean): object;
    const type = "UDP";
    function getDeserializedJsonObj(obj: UdpProtocolParameters, isParentJsonObj?: boolean): object;
}

...
export declare namespace FlexTunnelDrgAttachmentNetworkDetails {
    function getJsonObj(obj: FlexTunnelDrgAttachmentNetworkDetails, isParentJsonObj?: boolean): object;
    const type = "FLEX_TUNNEL";
    function getDeserializedJsonObj(obj: FlexTunnelDrgAttachmentNetworkDetails, isParentJsonObj?: boolean): object;
}

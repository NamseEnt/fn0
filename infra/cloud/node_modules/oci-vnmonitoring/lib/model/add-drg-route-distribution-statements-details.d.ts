...
export declare namespace AddDrgRouteDistributionStatementsDetails {
    function getJsonObj(obj: AddDrgRouteDistributionStatementsDetails): object;
    function getDeserializedJsonObj(obj: AddDrgRouteDistributionStatementsDetails): object;
}

...
export declare namespace FlexTunnelBgpSession {
    function getJsonObj(obj: FlexTunnelBgpSession): object;
    function getDeserializedJsonObj(obj: FlexTunnelBgpSession): object;
}

...
export declare namespace VnicEndpoint {
    function getJsonObj(obj: VnicEndpoint, isParentJsonObj?: boolean): object;
    const type = "VNIC";
    function getDeserializedJsonObj(obj: VnicEndpoint, isParentJsonObj?: boolean): object;
}

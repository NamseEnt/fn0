...
export interface DrgAttachment {
  ...
  *
    ...
    "networkDetails"?: model.VcnDrgAttachmentNetworkDetails | model.InternetDrgAttachmentNetworkDetails | model.LoopBackDrgAttachmentNetworkDetails | model.IpsecTunnelDrgAttachmentNetworkDetails | model.VirtualCircuitDrgAttachmentNetworkDetails | model.FlexTunnelDrgAttachmentNetworkDetails | model.RemotePeeringConnectionDrgAttachmentNetworkDetails;
    /**
     ...
     * This field is deprecated. Instead, use the {@code networkDetails} field to view the [OCID](https://docs.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the attached resource.
     *
     */
    "vcnId"?: string;
    /**
...
export declare namespace DrgAttachment {
    enum LifecycleState {
        Attaching = "ATTACHING",
        Attached = "ATTACHED",
        Detaching = "DETACHING",
    ...
    function getJsonObj(obj: DrgAttachment): object;
    function getDeserializedJsonObj(obj: DrgAttachment): object;
}

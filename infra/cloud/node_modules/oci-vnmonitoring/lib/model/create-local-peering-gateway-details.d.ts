...
export declare namespace CreateLocalPeeringGatewayDetails {
    function getJsonObj(obj: CreateLocalPeeringGatewayDetails): object;
    function getDeserializedJsonObj(obj: CreateLocalPeeringGatewayDetails): object;
}

...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/vnmonitoring/ListPathAnalyzerTests.ts.html |here} to see how to use ListPathAnalyzerTestsRequest.
 */
...
export declare namespace ListPathAnalyzerTestsRequest {
    enum SortOrder {
        Asc = "ASC",
        Desc = "DESC"
    }

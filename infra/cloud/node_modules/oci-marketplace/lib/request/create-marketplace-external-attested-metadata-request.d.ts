...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/marketplace/CreateMarketplaceExternalAttestedMetadata.ts.html |here} to see how to use CreateMarketplaceExternalAttestedMetadataRequest.
 */
export interface CreateMarketplaceExternalAttestedMetadataRequest extends common.BaseRequest {
    /**
     * Payload that customer will use to generate JWT for launched instance associated with Marketplace listing
     */
    "createMarketplaceExternalAttestedMetadataDetails": model.CreateMarketplaceExternalAttestedMetadataDetails;
    /**

...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/marketplace/ListAcceptedAgreements.ts.html |here} to see how to use ListAcceptedAgreementsRequest.
 */
...
export declare namespace ListAcceptedAgreementsRequest {
    enum SortBy {

...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/marketplace/ExportListing.ts.html |here} to see how to use ExportListingRequest.
 */
export interface ExportListingRequest extends common.BaseRequest {
    /**
     ...
     */
    "exportPackageDetails": model.ExportPackageDetails;
    /**

 ...
 **/
export declare enum WorkRequestActionType {
    Accepted = "ACCEPTED",
...
export declare namespace WorkRequestActionType {
    function getJsonObj(obj: WorkRequestActionType): WorkRequestActionType;
    function getDeserializedJsonObj(obj: WorkRequestActionType): WorkRequestActionType;
}

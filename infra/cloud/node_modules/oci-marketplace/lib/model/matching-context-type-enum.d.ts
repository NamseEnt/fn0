 ...
 *
 **/
export declare enum MatchingContextTypeEnum {
    None = "NONE",
    Highlights = "HIGHLIGHTS"
}
export declare namespace MatchingContextTypeEnum {
    function getJsonObj(obj: MatchingContextTypeEnum): MatchingContextTypeEnum;
    function getDeserializedJsonObj(obj: MatchingContextTypeEnum): MatchingContextTypeEnum;
}

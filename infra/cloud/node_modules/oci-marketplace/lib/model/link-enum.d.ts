...
export declare namespace LinkEnum {
    function getJsonObj(obj: LinkEnum): LinkEnum;
    function getDeserializedJsonObj(obj: LinkEnum): LinkEnum;
}

...
export declare namespace ImageListingPackage {
    function getJsonObj(obj: ImageListingPackage, isParentJsonObj?: boolean): object;
    const packageType = "IMAGE";
    function getDeserializedJsonObj(obj: ImageListingPackage, isParentJsonObj?: boolean): object;
}

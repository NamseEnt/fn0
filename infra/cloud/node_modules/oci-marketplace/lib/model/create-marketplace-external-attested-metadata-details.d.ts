 ...
 */
export interface CreateMarketplaceExternalAttestedMetadataDetails {
    /**
...
export declare namespace CreateMarketplaceExternalAttestedMetadataDetails {
    function getJsonObj(obj: CreateMarketplaceExternalAttestedMetadataDetails): object;
    function getDeserializedJsonObj(obj: CreateMarketplaceExternalAttestedMetadataDetails): object;
}

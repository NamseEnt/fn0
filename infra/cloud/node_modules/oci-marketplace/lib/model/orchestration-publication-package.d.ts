...
export declare namespace OrchestrationPublicationPackage {
    function getJsonObj(obj: OrchestrationPublicationPackage, isParentJsonObj?: boolean): object;
    const packageType = "ORCHESTRATION";
    function getDeserializedJsonObj(obj: OrchestrationPublicationPackage, isParentJsonObj?: boolean): object;
}

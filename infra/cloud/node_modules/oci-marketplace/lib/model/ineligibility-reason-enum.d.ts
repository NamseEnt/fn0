 ...
 **/
export declare enum IneligibilityReasonEnum {
    ...
    IneligibleAccountTenancyNotAllowedAccessImage = "INELIGIBLE_ACCOUNT_TENANCY_NOT_ALLOWED_ACCESS_IMAGE",
...
export declare namespace IneligibilityReasonEnum {
    function getJsonObj(obj: IneligibilityReasonEnum): IneligibilityReasonEnum;
    function getDeserializedJsonObj(obj: IneligibilityReasonEnum): IneligibilityReasonEnum;
}

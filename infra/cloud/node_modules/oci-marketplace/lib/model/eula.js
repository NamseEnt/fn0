...
(function (Eula) {
    function getJsonObj(obj) {
        ...
        if (obj && "eulaType" in obj && obj.eulaType) {
            switch (obj.eulaType) {
                case "TEXT":
                    return model.TextBasedEula.getJsonObj(jsonObj, true);
                default:
                    if (common.LOG.logger)
                        common.LOG.logger.info(`Unknown value for: ${obj.eulaType}`);
            }
        }
        return jsonObj;
    }
    Eula.getJsonObj = getJsonObj;
    function getDeserializedJsonObj(obj) {
        const jsonObj = Object.assign(Object.assign({}, obj), {});
        if (obj && "eulaType" in obj && obj.eulaType) {
            switch (obj.eulaType) {
                case "TEXT":
                    return model.TextBasedEula.getDeserializedJsonObj(jsonObj, true);
                default:
                    if (common.LOG.logger)
                        common.LOG.logger.info(`Unknown value for: ${obj.eulaType}`);
            }
    ...
    Eula.getDeserializedJsonObj = getDeserializedJsonObj;

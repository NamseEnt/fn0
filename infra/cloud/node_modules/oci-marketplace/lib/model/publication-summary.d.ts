...
export declare namespace PublicationSummary {
    function getJsonObj(obj: PublicationSummary): object;
    function getDeserializedJsonObj(obj: PublicationSummary): object;
}

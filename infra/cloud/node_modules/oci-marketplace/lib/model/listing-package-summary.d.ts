...
export declare namespace ListingPackageSummary {
    function getJsonObj(obj: ListingPackageSummary): object;
    function getDeserializedJsonObj(obj: ListingPackageSummary): object;
}

...
export declare namespace TextBasedEula {
    function getJsonObj(obj: TextBasedEula, isParentJsonObj?: boolean): object;
    const eulaType = "TEXT";
    function getDeserializedJsonObj(obj: TextBasedEula, isParentJsonObj?: boolean): object;
}

...
export declare namespace ReportTypeSummary {
    function getJsonObj(obj: ReportTypeSummary): object;
    function getDeserializedJsonObj(obj: ReportTypeSummary): object;
}

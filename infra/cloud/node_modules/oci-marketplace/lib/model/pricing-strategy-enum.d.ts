 ...
 **/
export declare enum PricingStrategyEnum {
...
export declare namespace PricingStrategyEnum {
    function getJsonObj(obj: PricingStrategyEnum): PricingStrategyEnum;
    function getDeserializedJsonObj(obj: PricingStrategyEnum): PricingStrategyEnum;
}

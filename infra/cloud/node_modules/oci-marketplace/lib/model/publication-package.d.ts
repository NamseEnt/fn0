...
export declare namespace PublicationPackage {
    function getJsonObj(obj: PublicationPackage): object;
    function getDeserializedJsonObj(obj: PublicationPackage): object;
}

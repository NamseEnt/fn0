...
export declare namespace CreatePublicationPackage {
    function getJsonObj(obj: CreatePublicationPackage): object;
    function getDeserializedJsonObj(obj: CreatePublicationPackage): object;
}

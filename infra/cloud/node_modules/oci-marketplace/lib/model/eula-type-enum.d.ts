 ...
 **/
export declare enum EulaTypeEnum {
    Text = "TEXT"
}
export declare namespace EulaTypeEnum {
    function getJsonObj(obj: EulaTypeEnum): EulaTypeEnum;
    function getDeserializedJsonObj(obj: EulaTypeEnum): EulaTypeEnum;
}

...
export declare class MarketplaceClient {
     ...
     */
    createMarketplaceExternalAttestedMetadata(createMarketplaceExternalAttestedMetadataRequest: requests.CreateMarketplaceExternalAttestedMetadataRequest): Promise<responses.CreateMarketplaceExternalAttestedMetadataResponse>;
    /**
  ...
  *
     ...
     */
    listMarketplaceMetadataPublicKeys(listMarketplaceMetadataPublicKeysRequest: requests.ListMarketplaceMetadataPublicKeysRequest): Promise<responses.ListMarketplaceMetadataPublicKeysResponse>;
    /**
     ...
     * @param request a request which can be sent to the service operation
     */
    listAllMarketplaceMetadataPublicKeys(request: requests.ListMarketplaceMetadataPublicKeysRequest): AsyncIterableIterator<model.MarketplaceMetadataPublicKeySummary>;
    /**
     ...
     * @param request a request which can be sent to the service operation
     */
    listAllMarketplaceMetadataPublicKeysResponses(request: requests.ListMarketplaceMetadataPublicKeysRequest): AsyncIterableIterator<responses.ListMarketplaceMetadataPublicKeysResponse>;
    /**
     * Creates a new async iterator which will iterate over the models.MarketplaceMetadataPublicKeySummary objects
     * contained in responses from the listMarketplaceMetadataPublicKeys operation. This iterator will fetch more data from the
     * server as needed.
     ...
     * @param request a request which can be sent to the service operation
     */
    listMarketplaceMetadataPublicKeysRecordIterator(request: requests.ListMarketplaceMetadataPublicKeysRequest): AsyncIterableIterator<model.MarketplaceMetadataPublicKeySummary>;
    /**
     * Creates a new async iterator which will iterate over the responses received from the listMarketplaceMetadataPublicKeys operation. This iterator
     * will fetch more data from the server as needed.
     *
     * @param request a request which can be sent to the service operation
     */
    listMarketplaceMetadataPublicKeysResponseIterator(request: requests.ListMarketplaceMetadataPublicKeysRequest): AsyncIterableIterator<responses.ListMarketplaceMetadataPublicKeysResponse>;
    /**

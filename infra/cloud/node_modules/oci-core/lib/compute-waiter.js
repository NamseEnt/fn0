...
class ComputeWaiter {
     ...
     */
    forApplyHostConfiguration(request) {
        return __awaiter(this, void 0, void 0, function* () {
            const applyHostConfigurationResponse = yield this.client.applyHostConfiguration(request);
            if (applyHostConfigurationResponse.opcWorkRequestId === undefined)
                return { response: applyHostConfigurationResponse, workRequestResponse: undefined };
            const getWorkRequestResponse = yield oci_workrequests_1.waitForWorkRequest(this.config, this.workRequestClient, applyHostConfigurationResponse.opcWorkRequestId);
            return {
     ...
     */
    forComputeImageCapabilitySchema(request, ...targetStates) {
        return __awaiter(this, void 0, void 0, function* () {
            return oci_common_1.genericTerminalConditionWaiter(this.config, () => this.client.getComputeImageCapabilitySchema(request), response => targetStates.includes(response.computeImageCapabilitySchema.lifecycleState), targetStates.includes(models.ComputeImageCapabilitySchema.LifecycleState.Deleted));
        });
    }
    /**
     ...
     */
    forFirmwareBundle(request, ...targetStates) {
        return __awaiter(this, void 0, void 0, function* () {
            return oci_common_1.genericWaiter(this.config, () => this.client.getFirmwareBundle(request), response => targetStates.includes(response.firmwareBundle.lifecycleState));
        });
    }
    /**
     ...
     */
    forUpdateComputeHosts(request) {
        return __awaiter(this, void 0, void 0, function* () {
            const updateComputeHostsResponse = yield this.client.updateComputeHosts(request);
            if (updateComputeHostsResponse.opcWorkRequestId === undefined)
                return { response: updateComputeHostsResponse, workRequestResponse: undefined };
            const getWorkRequestResponse = yield oci_workrequests_1.waitForWorkRequest(this.config, this.workRequestClient, updateComputeHostsResponse.opcWorkRequestId);

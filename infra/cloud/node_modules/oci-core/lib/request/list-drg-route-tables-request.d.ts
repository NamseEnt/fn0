...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/core/ListDrgRouteTables.ts.html |here} to see how to use ListDrgRouteTablesRequest.
 */
export interface ListDrgRouteTablesRequest extends common.BaseRequest {
    /**
...
export declare namespace ListDrgRouteTablesRequest {
    enum SortBy {

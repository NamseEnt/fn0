...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/core/ListNetworkSecurityGroups.ts.html |here} to see how to use ListNetworkSecurityGroupsRequest.
 */
export interface ListNetworkSecurityGroupsRequest extends common.BaseRequest {
    /**
...
export declare namespace ListNetworkSecurityGroupsRequest {
    enum SortBy {

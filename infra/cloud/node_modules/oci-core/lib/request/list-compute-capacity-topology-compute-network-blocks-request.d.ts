...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/core/ListComputeCapacityTopologyComputeNetworkBlocks.ts.html |here} to see how to use ListComputeCapacityTopologyComputeNetworkBlocksRequest.
 */
export interface ListComputeCapacityTopologyComputeNetworkBlocksRequest extends common.BaseRequest {
    /**
...
export declare namespace ListComputeCapacityTopologyComputeNetworkBlocksRequest {
    enum SortBy {

...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/core/ListDrgAttachments.ts.html |here} to see how to use ListDrgAttachmentsRequest.
 */
export interface ListDrgAttachmentsRequest extends common.BaseRequest {
    /**
...
export declare namespace ListDrgAttachmentsRequest {
    enum AttachmentType {
        Vcn = "VCN",

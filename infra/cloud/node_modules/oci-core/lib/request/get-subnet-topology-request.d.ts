...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/core/GetSubnetTopology.ts.html |here} to see how to use GetSubnetTopologyRequest.
 */
export interface GetSubnetTopologyRequest extends common.BaseRequest {
    /**
...
export declare namespace GetSubnetTopologyRequest {
    enum AccessLevel {
        Any = "ANY",

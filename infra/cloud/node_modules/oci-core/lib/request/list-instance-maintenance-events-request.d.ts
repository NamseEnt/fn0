...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/core/ListInstanceMaintenanceEvents.ts.html |here} to see how to use ListInstanceMaintenanceEventsRequest.
 */
export interface ListInstanceMaintenanceEventsRequest extends common.BaseRequest {
    /**
     ...
     */
    "timeWindowStartGreaterThanOrEqualTo"?: Date;
    /**
     ...
     */
    "timeWindowStartLessThanOrEqualTo"?: Date;
    /**
...
export declare namespace ListInstanceMaintenanceEventsRequest {
    enum SortBy {

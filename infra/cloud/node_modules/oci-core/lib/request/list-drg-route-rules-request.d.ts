...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/core/ListDrgRouteRules.ts.html |here} to see how to use ListDrgRouteRulesRequest.
 */
export interface ListDrgRouteRulesRequest extends common.BaseRequest {
    /**
...
export declare namespace ListDrgRouteRulesRequest {
    enum RouteType {
        Static = "STATIC",
        Dynamic = "DYNAMIC"
    }

...
export declare namespace ChangeComputeGpuMemoryFabricCompartmentDetails {
    function getJsonObj(obj: ChangeComputeGpuMemoryFabricCompartmentDetails): object;
    function getDeserializedJsonObj(obj: ChangeComputeGpuMemoryFabricCompartmentDetails): object;
}

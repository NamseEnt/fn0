...
export declare namespace VolumeSourceDetails {
    function getJsonObj(obj: VolumeSourceDetails): object;
    function getDeserializedJsonObj(obj: VolumeSourceDetails): object;
}

...
export declare namespace InstanceConfigurationLaunchOptions {
    enum BootVolumeType {
        Iscsi = "ISCSI",
        Scsi = "SCSI",
        Ide = "IDE",
    ...
    function getJsonObj(obj: InstanceConfigurationLaunchOptions): object;
    function getDeserializedJsonObj(obj: InstanceConfigurationLaunchOptions): object;
}

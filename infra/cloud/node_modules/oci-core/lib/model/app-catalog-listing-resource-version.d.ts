...
export declare namespace AppCatalogListingResourceVersion {
    enum AllowedActions {
        Snapshot = "SNAPSHOT",
    ...
    function getJsonObj(obj: AppCatalogListingResourceVersion): object;
    function getDeserializedJsonObj(obj: AppCatalogListingResourceVersion): object;
}

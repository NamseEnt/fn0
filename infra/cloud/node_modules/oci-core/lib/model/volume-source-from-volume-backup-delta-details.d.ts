 ...
 */
export interface VolumeSourceFromVolumeBackupDeltaDetails extends model.VolumeSourceDetails {
    /**
...
export declare namespace VolumeSourceFromVolumeBackupDeltaDetails {
    function getJsonObj(obj: VolumeSourceFromVolumeBackupDeltaDetails, isParentJsonObj?: boolean): object;
    const type = "volumeBackupDelta";
    function getDeserializedJsonObj(obj: VolumeSourceFromVolumeBackupDeltaDetails, isParentJsonObj?: boolean): object;
}

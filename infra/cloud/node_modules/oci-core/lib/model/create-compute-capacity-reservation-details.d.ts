...
export declare namespace CreateComputeCapacityReservationDetails {
    function getJsonObj(obj: CreateComputeCapacityReservationDetails): object;
    function getDeserializedJsonObj(obj: CreateComputeCapacityReservationDetails): object;
}

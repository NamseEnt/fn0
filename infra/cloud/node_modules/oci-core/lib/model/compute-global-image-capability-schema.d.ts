...
export declare namespace ComputeGlobalImageCapabilitySchema {
    function getJsonObj(obj: ComputeGlobalImageCapabilitySchema): object;
    function getDeserializedJsonObj(obj: ComputeGlobalImageCapabilitySchema): object;
}

...
export declare namespace InstancePoolPlacementSecondaryVnicSubnet {
    function getJsonObj(obj: InstancePoolPlacementSecondaryVnicSubnet): object;
    function getDeserializedJsonObj(obj: InstancePoolPlacementSecondaryVnicSubnet): object;
}

 ...
 *
 */
export interface ComputeBareMetalHost {
    /**
     ...
     */
    "lifecycleDetails"?: ComputeBareMetalHost.LifecycleDetails;
    /**
     * The current state of the compute bare metal host.
     */
    "lifecycleState": ComputeBareMetalHost.LifecycleState;
    /**
...
export declare namespace ComputeBareMetalHost {
    ...
    function getJsonObj(obj: ComputeBareMetalHost): object;
    function getDeserializedJsonObj(obj: ComputeBareMetalHost): object;
}

...
export declare namespace VirtualCircuitRedundancyMetadata {
    enum ConfiguredRedundancyLevel {
        Device = "DEVICE",
        Pop = "POP",
        Region = "REGION",
    ...
    enum Ipv4bgpSessionRedundancyStatus {
    ...
    enum Ipv6bgpSessionRedundancyStatus {
        ConfigurationMatch = "CONFIGURATION_MATCH",
        ConfigurationMismatch = "CONFIGURATION_MISMATCH",
        NotMetSla = "NOT_MET_SLA",
        /**
    ...
    function getJsonObj(obj: VirtualCircuitRedundancyMetadata): object;
    function getDeserializedJsonObj(obj: VirtualCircuitRedundancyMetadata): object;
}

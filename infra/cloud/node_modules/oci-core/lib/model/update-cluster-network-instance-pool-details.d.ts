 ...
 */
export interface UpdateClusterNetworkInstancePoolDetails {
    /**
...
export declare namespace UpdateClusterNetworkInstancePoolDetails {
    function getJsonObj(obj: UpdateClusterNetworkInstancePoolDetails): object;
    function getDeserializedJsonObj(obj: UpdateClusterNetworkInstancePoolDetails): object;
}

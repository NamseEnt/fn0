...
export declare namespace MeasuredBootEntry {
    function getJsonObj(obj: MeasuredBootEntry): object;
    function getDeserializedJsonObj(obj: MeasuredBootEntry): object;
}

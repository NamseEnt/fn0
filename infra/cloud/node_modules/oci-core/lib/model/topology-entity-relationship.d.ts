...
export declare namespace TopologyEntityRelationship {
    function getJsonObj(obj: TopologyEntityRelationship): object;
    function getDeserializedJsonObj(obj: TopologyEntityRelationship): object;
}

...
export declare namespace ChangeVtapCompartmentDetails {
    function getJsonObj(obj: ChangeVtapCompartmentDetails): object;
    function getDeserializedJsonObj(obj: ChangeVtapCompartmentDetails): object;
}

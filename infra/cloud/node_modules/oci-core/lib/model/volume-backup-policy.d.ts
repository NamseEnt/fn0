...
export declare namespace VolumeBackupPolicy {
    function getJsonObj(obj: VolumeBackupPolicy): object;
    function getDeserializedJsonObj(obj: VolumeBackupPolicy): object;
}

...
export declare namespace UpdateVtapDetails {
    ...
    function getJsonObj(obj: UpdateVtapDetails): object;
    function getDeserializedJsonObj(obj: UpdateVtapDetails): object;
}

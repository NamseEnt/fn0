 ...
 */
export interface CopyVolumeGroupBackupDetails {
    /**
...
export declare namespace CopyVolumeGroupBackupDetails {
    function getJsonObj(obj: CopyVolumeGroupBackupDetails): object;
    function getDeserializedJsonObj(obj: CopyVolumeGroupBackupDetails): object;
}

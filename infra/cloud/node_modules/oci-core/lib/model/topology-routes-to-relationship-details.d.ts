...
export declare namespace TopologyRoutesToRelationshipDetails {
    enum RouteType {
        Static = "STATIC",
        Dynamic = "DYNAMIC",
        /**
    ...
    function getJsonObj(obj: TopologyRoutesToRelationshipDetails): object;
    function getDeserializedJsonObj(obj: TopologyRoutesToRelationshipDetails): object;
}

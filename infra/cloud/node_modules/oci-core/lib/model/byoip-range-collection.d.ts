...
export declare namespace ByoipRangeCollection {
    function getJsonObj(obj: ByoipRangeCollection): object;
    function getDeserializedJsonObj(obj: ByoipRangeCollection): object;
}

 ...
 *
 */
export interface VcnTopology extends model.Topology {
    /**
...
export declare namespace VcnTopology {
    function getJsonObj(obj: VcnTopology, isParentJsonObj?: boolean): object;
    const type = "VCN";
    function getDeserializedJsonObj(obj: VcnTopology, isParentJsonObj?: boolean): object;
}

...
export declare namespace VolumeBackupPolicyAssignment {
    function getJsonObj(obj: VolumeBackupPolicyAssignment): object;
    function getDeserializedJsonObj(obj: VolumeBackupPolicyAssignment): object;
}

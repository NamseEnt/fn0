...
export declare namespace DetachLoadBalancerDetails {
    function getJsonObj(obj: DetachLoadBalancerDetails): object;
    function getDeserializedJsonObj(obj: DetachLoadBalancerDetails): object;
}

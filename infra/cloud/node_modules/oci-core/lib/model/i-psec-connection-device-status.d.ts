...
export declare namespace IPSecConnectionDeviceStatus {
    function getJsonObj(obj: IPSecConnectionDeviceStatus): object;
    function getDeserializedJsonObj(obj: IPSecConnectionDeviceStatus): object;
}

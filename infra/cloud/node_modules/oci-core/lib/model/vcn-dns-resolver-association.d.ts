 ...
 *
 */
export interface VcnDnsResolverAssociation {
    /**
     ...
     */
    "lifecycleState": VcnDnsResolverAssociation.LifecycleState;
}
export declare namespace VcnDnsResolverAssociation {
    enum LifecycleState {
    ...
    function getJsonObj(obj: VcnDnsResolverAssociation): object;
    function getDeserializedJsonObj(obj: VcnDnsResolverAssociation): object;
}

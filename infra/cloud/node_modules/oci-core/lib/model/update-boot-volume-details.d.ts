...
export declare namespace UpdateBootVolumeDetails {
    function getJsonObj(obj: UpdateBootVolumeDetails): object;
    function getDeserializedJsonObj(obj: UpdateBootVolumeDetails): object;
}

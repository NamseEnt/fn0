...
export declare namespace DrgPromotionStatusResponse {
    enum DrgPromotionStatus {
        Unpromoted = "UNPROMOTED",
        Promoting = "PROMOTING",
        Promoted = "PROMOTED",
        Unpromoting = "UNPROMOTING"
    }
    function getJsonObj(obj: DrgPromotionStatusResponse): object;
    function getDeserializedJsonObj(obj: DrgPromotionStatusResponse): object;
}

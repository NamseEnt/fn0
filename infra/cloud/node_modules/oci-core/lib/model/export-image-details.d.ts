...
export declare namespace ExportImageDetails {
    enum ExportFormat {
        Qcow2 = "QCOW2",
        Vmdk = "VMDK",
        Oci = "OCI",
    ...
    function getJsonObj(obj: ExportImageDetails): object;
    function getDeserializedJsonObj(obj: ExportImageDetails): object;
}

...
export declare namespace ComputeInstanceDetails {
    function getJsonObj(obj: ComputeInstanceDetails, isParentJsonObj?: boolean): object;
    const instanceType = "compute";
    function getDeserializedJsonObj(obj: ComputeInstanceDetails, isParentJsonObj?: boolean): object;
}

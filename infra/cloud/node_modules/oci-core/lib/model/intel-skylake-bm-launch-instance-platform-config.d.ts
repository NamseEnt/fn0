 ...
 *
 */
export interface IntelSkylakeBmLaunchInstancePlatformConfig extends model.LaunchInstancePlatformConfig {
    /**
...
export declare namespace IntelSkylakeBmLaunchInstancePlatformConfig {
    enum NumaNodesPerSocket {
        Nps1 = "NPS1",
        Nps2 = "NPS2"
    }
    function getJsonObj(obj: IntelSkylakeBmLaunchInstancePlatformConfig, isParentJsonObj?: boolean): object;
    const type = "INTEL_SKYLAKE_BM";
    function getDeserializedJsonObj(obj: IntelSkylakeBmLaunchInstancePlatformConfig, isParentJsonObj?: boolean): object;
}

...
export declare namespace AmdMilanBmLaunchInstancePlatformConfig {
    ...
    function getJsonObj(obj: AmdMilanBmLaunchInstancePlatformConfig, isParentJsonObj?: boolean): object;
    const type = "AMD_MILAN_BM";
    function getDeserializedJsonObj(obj: AmdMilanBmLaunchInstancePlatformConfig, isParentJsonObj?: boolean): object;
}

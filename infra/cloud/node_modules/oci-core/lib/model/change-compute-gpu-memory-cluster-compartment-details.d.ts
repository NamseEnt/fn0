...
export declare namespace ChangeComputeGpuMemoryClusterCompartmentDetails {
    function getJsonObj(obj: ChangeComputeGpuMemoryClusterCompartmentDetails): object;
    function getDeserializedJsonObj(obj: ChangeComputeGpuMemoryClusterCompartmentDetails): object;
}

...
export declare namespace ClusterConfigDetails {
    function getJsonObj(obj: ClusterConfigDetails): object;
    function getDeserializedJsonObj(obj: ClusterConfigDetails): object;
}

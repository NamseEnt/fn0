...
export declare namespace DrgRedundancyStatus {
    enum Status {
    ...
    function getJsonObj(obj: DrgRedundancyStatus): object;
    function getDeserializedJsonObj(obj: DrgRedundancyStatus): object;
}

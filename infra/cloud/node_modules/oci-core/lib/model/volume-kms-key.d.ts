...
export declare namespace VolumeKmsKey {
    function getJsonObj(obj: VolumeKmsKey): object;
    function getDeserializedJsonObj(obj: VolumeKmsKey): object;
}

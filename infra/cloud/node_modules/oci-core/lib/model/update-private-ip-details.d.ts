...
export declare namespace UpdatePrivateIpDetails {
    enum Lifetime {
        Ephemeral = "EPHEMERAL",
        Reserved = "RESERVED"
    }
    function getJsonObj(obj: UpdatePrivateIpDetails): object;
    function getDeserializedJsonObj(obj: UpdatePrivateIpDetails): object;
}

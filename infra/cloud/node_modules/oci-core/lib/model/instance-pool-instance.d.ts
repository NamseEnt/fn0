...
export declare namespace InstancePoolInstance {
    enum LifecycleState {
        Attaching = "ATTACHING",
        Active = "ACTIVE",
        Detaching = "DETACHING",
    ...
    function getJsonObj(obj: InstancePoolInstance): object;
    function getDeserializedJsonObj(obj: InstancePoolInstance): object;
}

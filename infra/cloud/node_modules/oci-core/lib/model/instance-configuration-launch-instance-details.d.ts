...
export interface InstanceConfigurationLaunchInstanceDetails {
  ...
  *
    ...
    "platformConfig"?: model.InstanceConfigurationAmdMilanBmLaunchInstancePlatformConfig | model.InstanceConfigurationIntelVmLaunchInstancePlatformConfig | model.InstanceConfigurationAmdMilanBmGpuLaunchInstancePlatformConfig | model.InstanceConfigurationIntelIcelakeBmLaunchInstancePlatformConfig | model.InstanceConfigurationGenericBmLaunchInstancePlatformConfig | model.InstanceConfigurationAmdRomeBmLaunchInstancePlatformConfig | model.InstanceConfigurationIntelSkylakeBmLaunchInstancePlatformConfig | model.InstanceConfigurationAmdRomeBmGpuLaunchInstancePlatformConfig | model.InstanceConfigurationAmdVmLaunchInstancePlatformConfig;
    "sourceDetails"?: model.InstanceConfigurationInstanceSourceViaImageDetails | model.InstanceConfigurationInstanceSourceViaBootVolumeDetails;
    /**
...
export declare namespace InstanceConfigurationLaunchInstanceDetails {
    enum LaunchMode {
        Native = "NATIVE",
        Emulated = "EMULATED",
    ...
    enum PreferredMaintenanceAction {
    ...
    function getJsonObj(obj: InstanceConfigurationLaunchInstanceDetails): object;
    function getDeserializedJsonObj(obj: InstanceConfigurationLaunchInstanceDetails): object;
}

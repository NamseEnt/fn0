...
export declare namespace LaunchAttachVolumeDetails {
    function getJsonObj(obj: LaunchAttachVolumeDetails): object;
    function getDeserializedJsonObj(obj: LaunchAttachVolumeDetails): object;
}

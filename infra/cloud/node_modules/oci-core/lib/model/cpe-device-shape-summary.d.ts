...
export declare namespace CpeDeviceShapeSummary {
    function getJsonObj(obj: CpeDeviceShapeSummary): object;
    function getDeserializedJsonObj(obj: CpeDeviceShapeSummary): object;
}

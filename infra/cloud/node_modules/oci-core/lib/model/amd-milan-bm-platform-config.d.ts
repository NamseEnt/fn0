...
export declare namespace AmdMilanBmPlatformConfig {
    ...
    function getJsonObj(obj: AmdMilanBmPlatformConfig, isParentJsonObj?: boolean): object;
    const type = "AMD_MILAN_BM";
    function getDeserializedJsonObj(obj: AmdMilanBmPlatformConfig, isParentJsonObj?: boolean): object;
}

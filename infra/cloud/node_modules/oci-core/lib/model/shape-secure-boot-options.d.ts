...
export declare namespace ShapeSecureBootOptions {
    function getJsonObj(obj: ShapeSecureBootOptions): object;
    function getDeserializedJsonObj(obj: ShapeSecureBootOptions): object;
}

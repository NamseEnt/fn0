...
export declare namespace InstanceReservationConfig {
    function getJsonObj(obj: InstanceReservationConfig): object;
    function getDeserializedJsonObj(obj: InstanceReservationConfig): object;
}

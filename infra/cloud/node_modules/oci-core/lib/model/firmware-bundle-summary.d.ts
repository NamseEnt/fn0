 ...
 */
export interface FirmwareBundleSummary {
    /**
...
export declare namespace FirmwareBundleSummary {
    function getJsonObj(obj: FirmwareBundleSummary): object;
    function getDeserializedJsonObj(obj: FirmwareBundleSummary): object;
}

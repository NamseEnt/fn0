...
export declare namespace ByoipRangeSummary {
    function getJsonObj(obj: ByoipRangeSummary): object;
    function getDeserializedJsonObj(obj: ByoipRangeSummary): object;
}

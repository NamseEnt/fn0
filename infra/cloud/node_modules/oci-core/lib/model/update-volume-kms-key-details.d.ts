...
export declare namespace UpdateVolumeKmsKeyDetails {
    function getJsonObj(obj: UpdateVolumeKmsKeyDetails): object;
    function getDeserializedJsonObj(obj: UpdateVolumeKmsKeyDetails): object;
}

...
export declare namespace ComputeImageCapabilitySchemaSummary {
    function getJsonObj(obj: ComputeImageCapabilitySchemaSummary): object;
    function getDeserializedJsonObj(obj: ComputeImageCapabilitySchemaSummary): object;
}

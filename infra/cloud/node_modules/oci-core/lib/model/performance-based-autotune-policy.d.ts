 ...
 *
 */
export interface PerformanceBasedAutotunePolicy extends model.AutotunePolicy {
    /**
...
export declare namespace PerformanceBasedAutotunePolicy {
    function getJsonObj(obj: PerformanceBasedAutotunePolicy, isParentJsonObj?: boolean): object;
    const autotuneType = "PERFORMANCE_BASED";
    function getDeserializedJsonObj(obj: PerformanceBasedAutotunePolicy, isParentJsonObj?: boolean): object;
}

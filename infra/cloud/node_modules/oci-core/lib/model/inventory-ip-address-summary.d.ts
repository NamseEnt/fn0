 ...
 *
 */
export interface InventoryIpAddressSummary {
    /**
...
export declare namespace InventoryIpAddressSummary {
    function getJsonObj(obj: InventoryIpAddressSummary): object;
    function getDeserializedJsonObj(obj: InventoryIpAddressSummary): object;
}

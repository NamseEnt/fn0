...
export declare namespace UpdateInstanceAvailabilityConfigDetails {
    enum RecoveryAction {
        RestoreInstance = "RESTORE_INSTANCE",
        StopInstance = "STOP_INSTANCE"
    }
    function getJsonObj(obj: UpdateInstanceAvailabilityConfigDetails): object;
    function getDeserializedJsonObj(obj: UpdateInstanceAvailabilityConfigDetails): object;
}

...
export declare namespace ImageOcpuConstraints {
    function getJsonObj(obj: ImageOcpuConstraints): object;
    function getDeserializedJsonObj(obj: ImageOcpuConstraints): object;
}

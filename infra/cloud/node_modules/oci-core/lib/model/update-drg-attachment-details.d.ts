...
export interface UpdateDrgAttachmentDetails {
    /**
...
export declare namespace UpdateDrgAttachmentDetails {
    function getJsonObj(obj: UpdateDrgAttachmentDetails): object;
    function getDeserializedJsonObj(obj: UpdateDrgAttachmentDetails): object;
}

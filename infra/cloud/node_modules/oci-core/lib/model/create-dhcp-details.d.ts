...
export interface CreateDhcpDetails {
    /**
...
export declare namespace CreateDhcpDetails {
    enum DomainNameType {
        SubnetDomain = "SUBNET_DOMAIN",
        VcnDomain = "VCN_DOMAIN",
        CustomDomain = "CUSTOM_DOMAIN"
    }
    function getJsonObj(obj: CreateDhcpDetails): object;
    function getDeserializedJsonObj(obj: CreateDhcpDetails): object;
}

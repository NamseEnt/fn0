...
export declare namespace ResetActionDetails {
    function getJsonObj(obj: ResetActionDetails, isParentJsonObj?: boolean): object;
    const actionType = "reset";
    function getDeserializedJsonObj(obj: ResetActionDetails, isParentJsonObj?: boolean): object;
}

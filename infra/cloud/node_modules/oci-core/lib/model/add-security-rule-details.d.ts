...
export declare namespace AddSecurityRuleDetails {
    ...
    function getJsonObj(obj: AddSecurityRuleDetails): object;
    function getDeserializedJsonObj(obj: AddSecurityRuleDetails): object;
}

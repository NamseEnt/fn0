...
export declare namespace ShapeNumaNodesPerSocketPlatformOptions {
    enum AllowedValues {
        Nps0 = "NPS0",
        Nps1 = "NPS1",
        Nps2 = "NPS2",
    ...
    function getJsonObj(obj: ShapeNumaNodesPerSocketPlatformOptions): object;
    function getDeserializedJsonObj(obj: ShapeNumaNodesPerSocketPlatformOptions): object;
}

...
export interface DedicatedVmHost {
  ...
  * <p>
  To get a list of fault domains, use the {@code ListFaultDomains} operation in the [Identity and Access Management Service API](https://docs.oracle.com/iaas/api/#/en/identity/20160918/).
  * <p>
...
export declare namespace DedicatedVmHost {
    enum LifecycleState {
        Creating = "CREATING",
        Active = "ACTIVE",
        Updating = "UPDATING",
    ...
    function getJsonObj(obj: DedicatedVmHost): object;
    function getDeserializedJsonObj(obj: DedicatedVmHost): object;
}

...
export interface InstanceConfigurationInstanceSourceViaImageDetails extends model.InstanceConfigurationInstanceSourceDetails {
    /**
...
export declare namespace InstanceConfigurationInstanceSourceViaImageDetails {
    function getJsonObj(obj: InstanceConfigurationInstanceSourceViaImageDetails, isParentJsonObj?: boolean): object;
    const sourceType = "image";
    function getDeserializedJsonObj(obj: InstanceConfigurationInstanceSourceViaImageDetails, isParentJsonObj?: boolean): object;
}

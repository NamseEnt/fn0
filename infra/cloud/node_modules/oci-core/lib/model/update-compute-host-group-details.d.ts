 ...
 *
 */
export interface UpdateComputeHostGroupDetails {
    /**
...
export declare namespace UpdateComputeHostGroupDetails {
    function getJsonObj(obj: UpdateComputeHostGroupDetails): object;
    function getDeserializedJsonObj(obj: UpdateComputeHostGroupDetails): object;
}

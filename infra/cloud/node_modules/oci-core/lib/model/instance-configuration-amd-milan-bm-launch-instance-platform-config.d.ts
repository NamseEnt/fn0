 ...
 *
 */
export interface InstanceConfigurationAmdMilanBmLaunchInstancePlatformConfig extends model.InstanceConfigurationLaunchInstancePlatformConfig {
    /**
...
export declare namespace InstanceConfigurationAmdMilanBmLaunchInstancePlatformConfig {
    ...
    function getJsonObj(obj: InstanceConfigurationAmdMilanBmLaunchInstancePlatformConfig, isParentJsonObj?: boolean): object;
    const type = "AMD_MILAN_BM";
    function getDeserializedJsonObj(obj: InstanceConfigurationAmdMilanBmLaunchInstancePlatformConfig, isParentJsonObj?: boolean): object;
}

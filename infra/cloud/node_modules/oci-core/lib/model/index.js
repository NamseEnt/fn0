...
const AddIpv4SubnetCidrDetails = __importStar(require("./add-ipv4-subnet-cidr-details"));
exports.AddIpv4SubnetCidrDetails = AddIpv4SubnetCidrDetails.AddIpv4SubnetCidrDetails;
...
const AddressType = __importStar(require("./address-type"));
exports.AddressType = AddressType.AddressType;
...
const AttachComputeHostGroupHostDetails = __importStar(require("./attach-compute-host-group-host-details"));
exports.AttachComputeHostGroupHostDetails = AttachComputeHostGroupHostDetails.AttachComputeHostGroupHostDetails;
...
const AutotunePolicy = __importStar(require("./autotune-policy"));
exports.AutotunePolicy = AutotunePolicy.AutotunePolicy;
...
const BulkCreateIpv6sDetails = __importStar(require("./bulk-create-ipv6s-details"));
exports.BulkCreateIpv6sDetails = BulkCreateIpv6sDetails.BulkCreateIpv6sDetails;
const BulkCreateIpv6sItem = __importStar(require("./bulk-create-ipv6s-item"));
exports.BulkCreateIpv6sItem = BulkCreateIpv6sItem.BulkCreateIpv6sItem;
const BulkCreatePrivateIpItem = __importStar(require("./bulk-create-private-ip-item"));
exports.BulkCreatePrivateIpItem = BulkCreatePrivateIpItem.BulkCreatePrivateIpItem;
const BulkCreatePrivateIpsDetails = __importStar(require("./bulk-create-private-ips-details"));
exports.BulkCreatePrivateIpsDetails = BulkCreatePrivateIpsDetails.BulkCreatePrivateIpsDetails;
const BulkDeleteIpv6sDetails = __importStar(require("./bulk-delete-ipv6s-details"));
exports.BulkDeleteIpv6sDetails = BulkDeleteIpv6sDetails.BulkDeleteIpv6sDetails;
const BulkDeleteIpv6sItem = __importStar(require("./bulk-delete-ipv6s-item"));
exports.BulkDeleteIpv6sItem = BulkDeleteIpv6sItem.BulkDeleteIpv6sItem;
const BulkDeletePrivateIpItem = __importStar(require("./bulk-delete-private-ip-item"));
exports.BulkDeletePrivateIpItem = BulkDeletePrivateIpItem.BulkDeletePrivateIpItem;
const BulkDeletePrivateIpsDetails = __importStar(require("./bulk-delete-private-ips-details"));
exports.BulkDeletePrivateIpsDetails = BulkDeletePrivateIpsDetails.BulkDeletePrivateIpsDetails;
...
const BulkDetachIpv6sDetails = __importStar(require("./bulk-detach-ipv6s-details"));
exports.BulkDetachIpv6sDetails = BulkDetachIpv6sDetails.BulkDetachIpv6sDetails;
const BulkDetachIpv6sItem = __importStar(require("./bulk-detach-ipv6s-item"));
exports.BulkDetachIpv6sItem = BulkDetachIpv6sItem.BulkDetachIpv6sItem;
const BulkDetachPrivateIpItem = __importStar(require("./bulk-detach-private-ip-item"));
exports.BulkDetachPrivateIpItem = BulkDetachPrivateIpItem.BulkDetachPrivateIpItem;
const BulkDetachPrivateIpsDetails = __importStar(require("./bulk-detach-private-ips-details"));
exports.BulkDetachPrivateIpsDetails = BulkDetachPrivateIpsDetails.BulkDetachPrivateIpsDetails;
const BulkUpdateIpv6sDetails = __importStar(require("./bulk-update-ipv6s-details"));
exports.BulkUpdateIpv6sDetails = BulkUpdateIpv6sDetails.BulkUpdateIpv6sDetails;
const BulkUpdateIpv6sItem = __importStar(require("./bulk-update-ipv6s-item"));
exports.BulkUpdateIpv6sItem = BulkUpdateIpv6sItem.BulkUpdateIpv6sItem;
const BulkUpdatePrivateIpItem = __importStar(require("./bulk-update-private-ip-item"));
exports.BulkUpdatePrivateIpItem = BulkUpdatePrivateIpItem.BulkUpdatePrivateIpItem;
const BulkUpdatePrivateIpsDetails = __importStar(require("./bulk-update-private-ips-details"));
exports.BulkUpdatePrivateIpsDetails = BulkUpdatePrivateIpsDetails.BulkUpdatePrivateIpsDetails;
const Byoasn = __importStar(require("./byoasn"));
exports.Byoasn = Byoasn.Byoasn;
const ByoasnByoipRange = __importStar(require("./byoasn-byoip-range"));
exports.ByoasnByoipRange = ByoasnByoipRange.ByoasnByoipRange;
const ByoasnCollection = __importStar(require("./byoasn-collection"));
exports.ByoasnCollection = ByoasnCollection.ByoasnCollection;
const ByoasnSummary = __importStar(require("./byoasn-summary"));
exports.ByoasnSummary = ByoasnSummary.ByoasnSummary;
...
const ByoipRangeOriginAsn = __importStar(require("./byoip-range-origin-asn"));
exports.ByoipRangeOriginAsn = ByoipRangeOriginAsn.ByoipRangeOriginAsn;
...
const CapacityBin = __importStar(require("./capacity-bin"));
exports.CapacityBin = CapacityBin.CapacityBin;
const CapacityBinPreview = __importStar(require("./capacity-bin-preview"));
exports.CapacityBinPreview = CapacityBinPreview.CapacityBinPreview;
const CapacityConfig = __importStar(require("./capacity-config"));
exports.CapacityConfig = CapacityConfig.CapacityConfig;
const CapacityReportInstanceShapeConfig = __importStar(require("./capacity-report-instance-shape-config"));
exports.CapacityReportInstanceShapeConfig = CapacityReportInstanceShapeConfig.CapacityReportInstanceShapeConfig;
...
const CapacitySource = __importStar(require("./capacity-source"));
exports.CapacitySource = CapacitySource.CapacitySource;
...
const ChangeByoasnCompartmentDetails = __importStar(require("./change-byoasn-compartment-details"));
exports.ChangeByoasnCompartmentDetails = ChangeByoasnCompartmentDetails.ChangeByoasnCompartmentDetails;
...
const ChangeComputeCapacityTopologyCompartmentDetails = __importStar(require("./change-compute-capacity-topology-compartment-details"));
exports.ChangeComputeCapacityTopologyCompartmentDetails = ChangeComputeCapacityTopologyCompartmentDetails.ChangeComputeCapacityTopologyCompartmentDetails;
const ChangeComputeClusterCompartmentDetails = __importStar(require("./change-compute-cluster-compartment-details"));
exports.ChangeComputeClusterCompartmentDetails = ChangeComputeClusterCompartmentDetails.ChangeComputeClusterCompartmentDetails;
const ChangeComputeGpuMemoryClusterCompartmentDetails = __importStar(require("./change-compute-gpu-memory-cluster-compartment-details"));
exports.ChangeComputeGpuMemoryClusterCompartmentDetails = ChangeComputeGpuMemoryClusterCompartmentDetails.ChangeComputeGpuMemoryClusterCompartmentDetails;
const ChangeComputeGpuMemoryFabricCompartmentDetails = __importStar(require("./change-compute-gpu-memory-fabric-compartment-details"));
exports.ChangeComputeGpuMemoryFabricCompartmentDetails = ChangeComputeGpuMemoryFabricCompartmentDetails.ChangeComputeGpuMemoryFabricCompartmentDetails;
const ChangeComputeHostCompartmentDetails = __importStar(require("./change-compute-host-compartment-details"));
exports.ChangeComputeHostCompartmentDetails = ChangeComputeHostCompartmentDetails.ChangeComputeHostCompartmentDetails;
const ChangeComputeHostGroupCompartmentDetails = __importStar(require("./change-compute-host-group-compartment-details"));
exports.ChangeComputeHostGroupCompartmentDetails = ChangeComputeHostGroupCompartmentDetails.ChangeComputeHostGroupCompartmentDetails;
...
const ClusterConfigDetails = __importStar(require("./cluster-config-details"));
exports.ClusterConfigDetails = ClusterConfigDetails.ClusterConfigDetails;
const ClusterConfigurationDetails = __importStar(require("./cluster-configuration-details"));
exports.ClusterConfigurationDetails = ClusterConfigurationDetails.ClusterConfigurationDetails;
...
const ComponentVersion = __importStar(require("./component-version"));
exports.ComponentVersion = ComponentVersion.ComponentVersion;
const ComputeBareMetalHost = __importStar(require("./compute-bare-metal-host"));
exports.ComputeBareMetalHost = ComputeBareMetalHost.ComputeBareMetalHost;
const ComputeBareMetalHostCollection = __importStar(require("./compute-bare-metal-host-collection"));
exports.ComputeBareMetalHostCollection = ComputeBareMetalHostCollection.ComputeBareMetalHostCollection;
const ComputeBareMetalHostSummary = __importStar(require("./compute-bare-metal-host-summary"));
exports.ComputeBareMetalHostSummary = ComputeBareMetalHostSummary.ComputeBareMetalHostSummary;
const ComputeCapacityReport = __importStar(require("./compute-capacity-report"));
exports.ComputeCapacityReport = ComputeCapacityReport.ComputeCapacityReport;
...
const ComputeCapacityTopology = __importStar(require("./compute-capacity-topology"));
exports.ComputeCapacityTopology = ComputeCapacityTopology.ComputeCapacityTopology;
const ComputeCapacityTopologyCollection = __importStar(require("./compute-capacity-topology-collection"));
exports.ComputeCapacityTopologyCollection = ComputeCapacityTopologyCollection.ComputeCapacityTopologyCollection;
const ComputeCapacityTopologySummary = __importStar(require("./compute-capacity-topology-summary"));
exports.ComputeCapacityTopologySummary = ComputeCapacityTopologySummary.ComputeCapacityTopologySummary;
const ComputeCluster = __importStar(require("./compute-cluster"));
exports.ComputeCluster = ComputeCluster.ComputeCluster;
const ComputeClusterCollection = __importStar(require("./compute-cluster-collection"));
exports.ComputeClusterCollection = ComputeClusterCollection.ComputeClusterCollection;
const ComputeClusterSummary = __importStar(require("./compute-cluster-summary"));
exports.ComputeClusterSummary = ComputeClusterSummary.ComputeClusterSummary;
...
const ComputeGpuMemoryCluster = __importStar(require("./compute-gpu-memory-cluster"));
exports.ComputeGpuMemoryCluster = ComputeGpuMemoryCluster.ComputeGpuMemoryCluster;
const ComputeGpuMemoryClusterCollection = __importStar(require("./compute-gpu-memory-cluster-collection"));
exports.ComputeGpuMemoryClusterCollection = ComputeGpuMemoryClusterCollection.ComputeGpuMemoryClusterCollection;
const ComputeGpuMemoryClusterInstanceCollection = __importStar(require("./compute-gpu-memory-cluster-instance-collection"));
exports.ComputeGpuMemoryClusterInstanceCollection = ComputeGpuMemoryClusterInstanceCollection.ComputeGpuMemoryClusterInstanceCollection;
const ComputeGpuMemoryClusterInstanceSummary = __importStar(require("./compute-gpu-memory-cluster-instance-summary"));
exports.ComputeGpuMemoryClusterInstanceSummary = ComputeGpuMemoryClusterInstanceSummary.ComputeGpuMemoryClusterInstanceSummary;
const ComputeGpuMemoryClusterScaleConfig = __importStar(require("./compute-gpu-memory-cluster-scale-config"));
exports.ComputeGpuMemoryClusterScaleConfig = ComputeGpuMemoryClusterScaleConfig.ComputeGpuMemoryClusterScaleConfig;
const ComputeGpuMemoryClusterSummary = __importStar(require("./compute-gpu-memory-cluster-summary"));
exports.ComputeGpuMemoryClusterSummary = ComputeGpuMemoryClusterSummary.ComputeGpuMemoryClusterSummary;
const ComputeGpuMemoryFabric = __importStar(require("./compute-gpu-memory-fabric"));
exports.ComputeGpuMemoryFabric = ComputeGpuMemoryFabric.ComputeGpuMemoryFabric;
const ComputeGpuMemoryFabricCollection = __importStar(require("./compute-gpu-memory-fabric-collection"));
exports.ComputeGpuMemoryFabricCollection = ComputeGpuMemoryFabricCollection.ComputeGpuMemoryFabricCollection;
const ComputeGpuMemoryFabricSummary = __importStar(require("./compute-gpu-memory-fabric-summary"));
exports.ComputeGpuMemoryFabricSummary = ComputeGpuMemoryFabricSummary.ComputeGpuMemoryFabricSummary;
const ComputeHost = __importStar(require("./compute-host"));
exports.ComputeHost = ComputeHost.ComputeHost;
const ComputeHostCollection = __importStar(require("./compute-host-collection"));
exports.ComputeHostCollection = ComputeHostCollection.ComputeHostCollection;
const ComputeHostConfigurationCheckDetails = __importStar(require("./compute-host-configuration-check-details"));
exports.ComputeHostConfigurationCheckDetails = ComputeHostConfigurationCheckDetails.ComputeHostConfigurationCheckDetails;
const ComputeHostConfigurationData = __importStar(require("./compute-host-configuration-data"));
exports.ComputeHostConfigurationData = ComputeHostConfigurationData.ComputeHostConfigurationData;
const ComputeHostGroup = __importStar(require("./compute-host-group"));
exports.ComputeHostGroup = ComputeHostGroup.ComputeHostGroup;
const ComputeHostGroupCollection = __importStar(require("./compute-host-group-collection"));
exports.ComputeHostGroupCollection = ComputeHostGroupCollection.ComputeHostGroupCollection;
const ComputeHostGroupSummary = __importStar(require("./compute-host-group-summary"));
exports.ComputeHostGroupSummary = ComputeHostGroupSummary.ComputeHostGroupSummary;
const ComputeHostSummary = __importStar(require("./compute-host-summary"));
exports.ComputeHostSummary = ComputeHostSummary.ComputeHostSummary;
const ComputeHpcIsland = __importStar(require("./compute-hpc-island"));
exports.ComputeHpcIsland = ComputeHpcIsland.ComputeHpcIsland;
const ComputeHpcIslandCollection = __importStar(require("./compute-hpc-island-collection"));
exports.ComputeHpcIslandCollection = ComputeHpcIslandCollection.ComputeHpcIslandCollection;
const ComputeHpcIslandSummary = __importStar(require("./compute-hpc-island-summary"));
exports.ComputeHpcIslandSummary = ComputeHpcIslandSummary.ComputeHpcIslandSummary;
...
const ComputeNetworkBlock = __importStar(require("./compute-network-block"));
exports.ComputeNetworkBlock = ComputeNetworkBlock.ComputeNetworkBlock;
const ComputeNetworkBlockCollection = __importStar(require("./compute-network-block-collection"));
exports.ComputeNetworkBlockCollection = ComputeNetworkBlockCollection.ComputeNetworkBlockCollection;
const ComputeNetworkBlockSummary = __importStar(require("./compute-network-block-summary"));
exports.ComputeNetworkBlockSummary = ComputeNetworkBlockSummary.ComputeNetworkBlockSummary;
const ConfigurationState = __importStar(require("./configuration-state"));
exports.ConfigurationState = ConfigurationState.ConfigurationState;
...
const CreateByoasnDetails = __importStar(require("./create-byoasn-details"));
exports.CreateByoasnDetails = CreateByoasnDetails.CreateByoasnDetails;
...
const CreateCapacitySourceDetails = __importStar(require("./create-capacity-source-details"));
exports.CreateCapacitySourceDetails = CreateCapacitySourceDetails.CreateCapacitySourceDetails;
...
const CreateComputeCapacityReportDetails = __importStar(require("./create-compute-capacity-report-details"));
exports.CreateComputeCapacityReportDetails = CreateComputeCapacityReportDetails.CreateComputeCapacityReportDetails;
...
const CreateComputeCapacityTopologyDetails = __importStar(require("./create-compute-capacity-topology-details"));
exports.CreateComputeCapacityTopologyDetails = CreateComputeCapacityTopologyDetails.CreateComputeCapacityTopologyDetails;
const CreateComputeClusterDetails = __importStar(require("./create-compute-cluster-details"));
exports.CreateComputeClusterDetails = CreateComputeClusterDetails.CreateComputeClusterDetails;
const CreateComputeGpuMemoryClusterDetails = __importStar(require("./create-compute-gpu-memory-cluster-details"));
exports.CreateComputeGpuMemoryClusterDetails = CreateComputeGpuMemoryClusterDetails.CreateComputeGpuMemoryClusterDetails;
const CreateComputeGpuMemoryClusterScaleConfig = __importStar(require("./create-compute-gpu-memory-cluster-scale-config"));
exports.CreateComputeGpuMemoryClusterScaleConfig = CreateComputeGpuMemoryClusterScaleConfig.CreateComputeGpuMemoryClusterScaleConfig;
const CreateComputeHostGroupDetails = __importStar(require("./create-compute-host-group-details"));
exports.CreateComputeHostGroupDetails = CreateComputeHostGroupDetails.CreateComputeHostGroupDetails;
...
const DetachComputeHostGroupHostDetails = __importStar(require("./detach-compute-host-group-host-details"));
exports.DetachComputeHostGroupHostDetails = DetachComputeHostGroupHostDetails.DetachComputeHostGroupHostDetails;
...
const DrgCustomer = __importStar(require("./drg-customer"));
exports.DrgCustomer = DrgCustomer.DrgCustomer;
const DrgCustomerResource = __importStar(require("./drg-customer-resource"));
exports.DrgCustomerResource = DrgCustomerResource.DrgCustomerResource;
const DrgPromotionStatusResponse = __importStar(require("./drg-promotion-status-response"));
exports.DrgPromotionStatusResponse = DrgPromotionStatusResponse.DrgPromotionStatusResponse;
...
const FirmwareBundle = __importStar(require("./firmware-bundle"));
exports.FirmwareBundle = FirmwareBundle.FirmwareBundle;
const FirmwareBundleSummary = __importStar(require("./firmware-bundle-summary"));
exports.FirmwareBundleSummary = FirmwareBundleSummary.FirmwareBundleSummary;
const FirmwareBundleTransitions = __importStar(require("./firmware-bundle-transitions"));
exports.FirmwareBundleTransitions = FirmwareBundleTransitions.FirmwareBundleTransitions;
const FirmwareBundlesCollection = __importStar(require("./firmware-bundles-collection"));
exports.FirmwareBundlesCollection = FirmwareBundlesCollection.FirmwareBundlesCollection;
...
const GetIpInventoryVcnOverlapDetails = __importStar(require("./get-ip-inventory-vcn-overlap-details"));
exports.GetIpInventoryVcnOverlapDetails = GetIpInventoryVcnOverlapDetails.GetIpInventoryVcnOverlapDetails;
...
const HostGroupConfiguration = __importStar(require("./host-group-configuration"));
exports.HostGroupConfiguration = HostGroupConfiguration.HostGroupConfiguration;
...
const InstanceConfigurationAutotunePolicy = __importStar(require("./instance-configuration-autotune-policy"));
exports.InstanceConfigurationAutotunePolicy = InstanceConfigurationAutotunePolicy.InstanceConfigurationAutotunePolicy;
...
const InstanceConfigurationBlockVolumeReplicaDetails = __importStar(require("./instance-configuration-block-volume-replica-details"));
exports.InstanceConfigurationBlockVolumeReplicaDetails = InstanceConfigurationBlockVolumeReplicaDetails.InstanceConfigurationBlockVolumeReplicaDetails;
...
const InstanceConfigurationInstanceSourceImageFilterDetails = __importStar(require("./instance-configuration-instance-source-image-filter-details"));
exports.InstanceConfigurationInstanceSourceImageFilterDetails = InstanceConfigurationInstanceSourceImageFilterDetails.InstanceConfigurationInstanceSourceImageFilterDetails;
const InstanceConfigurationIpv6AddressIpv6SubnetCidrPairDetails = __importStar(require("./instance-configuration-ipv6-address-ipv6-subnet-cidr-pair-details"));
exports.InstanceConfigurationIpv6AddressIpv6SubnetCidrPairDetails = InstanceConfigurationIpv6AddressIpv6SubnetCidrPairDetails.InstanceConfigurationIpv6AddressIpv6SubnetCidrPairDetails;
...
const InstanceConfigurationPlacementConstraintDetails = __importStar(require("./instance-configuration-placement-constraint-details"));
exports.InstanceConfigurationPlacementConstraintDetails = InstanceConfigurationPlacementConstraintDetails.InstanceConfigurationPlacementConstraintDetails;
...
const InstanceMaintenanceAlternativeResolutionActions = __importStar(require("./instance-maintenance-alternative-resolution-actions"));
exports.InstanceMaintenanceAlternativeResolutionActions = InstanceMaintenanceAlternativeResolutionActions.InstanceMaintenanceAlternativeResolutionActions;
const InstanceMaintenanceEvent = __importStar(require("./instance-maintenance-event"));
exports.InstanceMaintenanceEvent = InstanceMaintenanceEvent.InstanceMaintenanceEvent;
const InstanceMaintenanceEventSummary = __importStar(require("./instance-maintenance-event-summary"));
exports.InstanceMaintenanceEventSummary = InstanceMaintenanceEventSummary.InstanceMaintenanceEventSummary;
const InstanceMaintenanceReboot = __importStar(require("./instance-maintenance-reboot"));
exports.InstanceMaintenanceReboot = InstanceMaintenanceReboot.InstanceMaintenanceReboot;
...
const InstancePoolLifecycleActionsDetails = __importStar(require("./instance-pool-lifecycle-actions-details"));
exports.InstancePoolLifecycleActionsDetails = InstancePoolLifecycleActionsDetails.InstancePoolLifecycleActionsDetails;
const InstancePoolLifecycleManagementDetails = __importStar(require("./instance-pool-lifecycle-management-details"));
exports.InstancePoolLifecycleManagementDetails = InstancePoolLifecycleManagementDetails.InstancePoolLifecycleManagementDetails;
...
const InstancePoolPlacementIpv6AddressIpv6SubnetCidrDetails = __importStar(require("./instance-pool-placement-ipv6-address-ipv6-subnet-cidr-details"));
exports.InstancePoolPlacementIpv6AddressIpv6SubnetCidrDetails = InstancePoolPlacementIpv6AddressIpv6SubnetCidrDetails.InstancePoolPlacementIpv6AddressIpv6SubnetCidrDetails;
const InstancePoolPlacementPrimarySubnet = __importStar(require("./instance-pool-placement-primary-subnet"));
exports.InstancePoolPlacementPrimarySubnet = InstancePoolPlacementPrimarySubnet.InstancePoolPlacementPrimarySubnet;
...
const InstancePoolPlacementSubnetDetails = __importStar(require("./instance-pool-placement-subnet-details"));
exports.InstancePoolPlacementSubnetDetails = InstancePoolPlacementSubnetDetails.InstancePoolPlacementSubnetDetails;
const InstancePoolPreTerminationActionDetails = __importStar(require("./instance-pool-pre-termination-action-details"));
exports.InstancePoolPreTerminationActionDetails = InstancePoolPreTerminationActionDetails.InstancePoolPreTerminationActionDetails;
const InstancePoolPreTerminationActionHandleTimeoutDetails = __importStar(require("./instance-pool-pre-termination-action-handle-timeout-details"));
exports.InstancePoolPreTerminationActionHandleTimeoutDetails = InstancePoolPreTerminationActionHandleTimeoutDetails.InstancePoolPreTerminationActionHandleTimeoutDetails;
...
const InstanceSourceImageFilterDetails = __importStar(require("./instance-source-image-filter-details"));
exports.InstanceSourceImageFilterDetails = InstanceSourceImageFilterDetails.InstanceSourceImageFilterDetails;
...
const InventoryIpAddressSummary = __importStar(require("./inventory-ip-address-summary"));
exports.InventoryIpAddressSummary = InventoryIpAddressSummary.InventoryIpAddressSummary;
const InventoryResourceSummary = __importStar(require("./inventory-resource-summary"));
exports.InventoryResourceSummary = InventoryResourceSummary.InventoryResourceSummary;
const InventorySubnetCidrBlockSummary = __importStar(require("./inventory-subnet-cidr-block-summary"));
exports.InventorySubnetCidrBlockSummary = InventorySubnetCidrBlockSummary.InventorySubnetCidrBlockSummary;
const InventorySubnetSummary = __importStar(require("./inventory-subnet-summary"));
exports.InventorySubnetSummary = InventorySubnetSummary.InventorySubnetSummary;
const InventoryVcnCidrBlockSummary = __importStar(require("./inventory-vcn-cidr-block-summary"));
exports.InventoryVcnCidrBlockSummary = InventoryVcnCidrBlockSummary.InventoryVcnCidrBlockSummary;
const InventoryVcnSummary = __importStar(require("./inventory-vcn-summary"));
exports.InventoryVcnSummary = InventoryVcnSummary.InventoryVcnSummary;
const IpInventoryCidrUtilizationCollection = __importStar(require("./ip-inventory-cidr-utilization-collection"));
exports.IpInventoryCidrUtilizationCollection = IpInventoryCidrUtilizationCollection.IpInventoryCidrUtilizationCollection;
const IpInventoryCidrUtilizationSummary = __importStar(require("./ip-inventory-cidr-utilization-summary"));
exports.IpInventoryCidrUtilizationSummary = IpInventoryCidrUtilizationSummary.IpInventoryCidrUtilizationSummary;
const IpInventoryCollection = __importStar(require("./ip-inventory-collection"));
exports.IpInventoryCollection = IpInventoryCollection.IpInventoryCollection;
const IpInventorySubnetResourceCollection = __importStar(require("./ip-inventory-subnet-resource-collection"));
exports.IpInventorySubnetResourceCollection = IpInventorySubnetResourceCollection.IpInventorySubnetResourceCollection;
const IpInventorySubnetResourceSummary = __importStar(require("./ip-inventory-subnet-resource-summary"));
exports.IpInventorySubnetResourceSummary = IpInventorySubnetResourceSummary.IpInventorySubnetResourceSummary;
const IpInventoryVcnOverlapCollection = __importStar(require("./ip-inventory-vcn-overlap-collection"));
exports.IpInventoryVcnOverlapCollection = IpInventoryVcnOverlapCollection.IpInventoryVcnOverlapCollection;
const IpInventoryVcnOverlapSummary = __importStar(require("./ip-inventory-vcn-overlap-summary"));
exports.IpInventoryVcnOverlapSummary = IpInventoryVcnOverlapSummary.IpInventoryVcnOverlapSummary;
const Ipam = __importStar(require("./ipam"));
exports.Ipam = Ipam.Ipam;
const Ipv6 = __importStar(require("./ipv6"));
exports.Ipv6 = Ipv6.Ipv6;
const Ipv6AddressIpv6SubnetCidrPairDetails = __importStar(require("./ipv6-address-ipv6-subnet-cidr-pair-details"));
exports.Ipv6AddressIpv6SubnetCidrPairDetails = Ipv6AddressIpv6SubnetCidrPairDetails.Ipv6AddressIpv6SubnetCidrPairDetails;
const LaunchAttachVolumeDetails = __importStar(require("./launch-attach-volume-details"));
exports.LaunchAttachVolumeDetails = LaunchAttachVolumeDetails.LaunchAttachVolumeDetails;
const LaunchCreateVolumeDetails = __importStar(require("./launch-create-volume-details"));
exports.LaunchCreateVolumeDetails = LaunchCreateVolumeDetails.LaunchCreateVolumeDetails;
...
const LaunchInstanceLicensingConfig = __importStar(require("./launch-instance-licensing-config"));
exports.LaunchInstanceLicensingConfig = LaunchInstanceLicensingConfig.LaunchInstanceLicensingConfig;
...
const LicensingConfig = __importStar(require("./licensing-config"));
exports.LicensingConfig = LicensingConfig.LicensingConfig;
const ListIpInventoryDetails = __importStar(require("./list-ip-inventory-details"));
exports.ListIpInventoryDetails = ListIpInventoryDetails.ListIpInventoryDetails;
...
const MemoryFabricPreferencesDescriptor = __importStar(require("./memory-fabric-preferences-descriptor"));
exports.MemoryFabricPreferencesDescriptor = MemoryFabricPreferencesDescriptor.MemoryFabricPreferencesDescriptor;
const ModifyIpv4SubnetCidrDetails = __importStar(require("./modify-ipv4-subnet-cidr-details"));
exports.ModifyIpv4SubnetCidrDetails = ModifyIpv4SubnetCidrDetails.ModifyIpv4SubnetCidrDetails;
...
const PlacementConstraintDetails = __importStar(require("./placement-constraint-details"));
exports.PlacementConstraintDetails = PlacementConstraintDetails.PlacementConstraintDetails;
const PlatformConfig = __importStar(require("./platform-config"));
exports.PlatformConfig = PlatformConfig.PlatformConfig;
const PlatformVersions = __importStar(require("./platform-versions"));
exports.PlatformVersions = PlatformVersions.PlatformVersions;
...
const RecycleDetails = __importStar(require("./recycle-details"));
exports.RecycleDetails = RecycleDetails.RecycleDetails;
...
const RemoveIpv4SubnetCidrDetails = __importStar(require("./remove-ipv4-subnet-cidr-details"));
exports.RemoveIpv4SubnetCidrDetails = RemoveIpv4SubnetCidrDetails.RemoveIpv4SubnetCidrDetails;
...
const SetOriginAsnDetails = __importStar(require("./set-origin-asn-details"));
exports.SetOriginAsnDetails = SetOriginAsnDetails.SetOriginAsnDetails;
...
const ShapeMemoryEncryptionOptions = __importStar(require("./shape-memory-encryption-options"));
exports.ShapeMemoryEncryptionOptions = ShapeMemoryEncryptionOptions.ShapeMemoryEncryptionOptions;
...
const TerminationProceedInstancePoolInstanceDetails = __importStar(require("./termination-proceed-instance-pool-instance-details"));
exports.TerminationProceedInstancePoolInstanceDetails = TerminationProceedInstancePoolInstanceDetails.TerminationProceedInstancePoolInstanceDetails;
...
const UpdateByoasnDetails = __importStar(require("./update-byoasn-details"));
exports.UpdateByoasnDetails = UpdateByoasnDetails.UpdateByoasnDetails;
...
const UpdateCapacitySourceDetails = __importStar(require("./update-capacity-source-details"));
exports.UpdateCapacitySourceDetails = UpdateCapacitySourceDetails.UpdateCapacitySourceDetails;
...
const UpdateComputeCapacityTopologyDetails = __importStar(require("./update-compute-capacity-topology-details"));
exports.UpdateComputeCapacityTopologyDetails = UpdateComputeCapacityTopologyDetails.UpdateComputeCapacityTopologyDetails;
const UpdateComputeClusterDetails = __importStar(require("./update-compute-cluster-details"));
exports.UpdateComputeClusterDetails = UpdateComputeClusterDetails.UpdateComputeClusterDetails;
const UpdateComputeGpuMemoryClusterDetails = __importStar(require("./update-compute-gpu-memory-cluster-details"));
exports.UpdateComputeGpuMemoryClusterDetails = UpdateComputeGpuMemoryClusterDetails.UpdateComputeGpuMemoryClusterDetails;
const UpdateComputeGpuMemoryClusterScaleConfig = __importStar(require("./update-compute-gpu-memory-cluster-scale-config"));
exports.UpdateComputeGpuMemoryClusterScaleConfig = UpdateComputeGpuMemoryClusterScaleConfig.UpdateComputeGpuMemoryClusterScaleConfig;
const UpdateComputeGpuMemoryFabricDetails = __importStar(require("./update-compute-gpu-memory-fabric-details"));
exports.UpdateComputeGpuMemoryFabricDetails = UpdateComputeGpuMemoryFabricDetails.UpdateComputeGpuMemoryFabricDetails;
const UpdateComputeHostGroupDetails = __importStar(require("./update-compute-host-group-details"));
exports.UpdateComputeHostGroupDetails = UpdateComputeHostGroupDetails.UpdateComputeHostGroupDetails;
const UpdateComputeHostsDetails = __importStar(require("./update-compute-hosts-details"));
exports.UpdateComputeHostsDetails = UpdateComputeHostsDetails.UpdateComputeHostsDetails;
...
const UpdateInstanceLicensingConfig = __importStar(require("./update-instance-licensing-config"));
exports.UpdateInstanceLicensingConfig = UpdateInstanceLicensingConfig.UpdateInstanceLicensingConfig;
const UpdateInstanceMaintenanceEventDetails = __importStar(require("./update-instance-maintenance-event-details"));
exports.UpdateInstanceMaintenanceEventDetails = UpdateInstanceMaintenanceEventDetails.UpdateInstanceMaintenanceEventDetails;
const UpdateInstancePlatformConfig = __importStar(require("./update-instance-platform-config"));
exports.UpdateInstancePlatformConfig = UpdateInstancePlatformConfig.UpdateInstancePlatformConfig;
...
const UpdateInstanceSourceDetails = __importStar(require("./update-instance-source-details"));
exports.UpdateInstanceSourceDetails = UpdateInstanceSourceDetails.UpdateInstanceSourceDetails;
...
const AmdMilanBmGpuLaunchInstancePlatformConfig = __importStar(require("./amd-milan-bm-gpu-launch-instance-platform-config"));
exports.AmdMilanBmGpuLaunchInstancePlatformConfig = AmdMilanBmGpuLaunchInstancePlatformConfig.AmdMilanBmGpuLaunchInstancePlatformConfig;
const AmdMilanBmGpuPlatformConfig = __importStar(require("./amd-milan-bm-gpu-platform-config"));
exports.AmdMilanBmGpuPlatformConfig = AmdMilanBmGpuPlatformConfig.AmdMilanBmGpuPlatformConfig;
...
const AmdVmUpdateInstancePlatformConfig = __importStar(require("./amd-vm-update-instance-platform-config"));
exports.AmdVmUpdateInstancePlatformConfig = AmdVmUpdateInstancePlatformConfig.AmdVmUpdateInstancePlatformConfig;
...
const ComputeBareMetalHostPlacementConstraintDetails = __importStar(require("./compute-bare-metal-host-placement-constraint-details"));
exports.ComputeBareMetalHostPlacementConstraintDetails = ComputeBareMetalHostPlacementConstraintDetails.ComputeBareMetalHostPlacementConstraintDetails;
...
const ComputeInstanceOptions = __importStar(require("./compute-instance-options"));
exports.ComputeInstanceOptions = ComputeInstanceOptions.ComputeInstanceOptions;
const CreateDedicatedCapacitySourceDetails = __importStar(require("./create-dedicated-capacity-source-details"));
exports.CreateDedicatedCapacitySourceDetails = CreateDedicatedCapacitySourceDetails.CreateDedicatedCapacitySourceDetails;
...
const DedicatedCapacitySource = __importStar(require("./dedicated-capacity-source"));
exports.DedicatedCapacitySource = DedicatedCapacitySource.DedicatedCapacitySource;
const DetachedVolumeAutotunePolicy = __importStar(require("./detached-volume-autotune-policy"));
exports.DetachedVolumeAutotunePolicy = DetachedVolumeAutotunePolicy.DetachedVolumeAutotunePolicy;
...
const GenericBmLaunchInstancePlatformConfig = __importStar(require("./generic-bm-launch-instance-platform-config"));
exports.GenericBmLaunchInstancePlatformConfig = GenericBmLaunchInstancePlatformConfig.GenericBmLaunchInstancePlatformConfig;
const GenericBmPlatformConfig = __importStar(require("./generic-bm-platform-config"));
exports.GenericBmPlatformConfig = GenericBmPlatformConfig.GenericBmPlatformConfig;
const HostGroupPlacementConstraintDetails = __importStar(require("./host-group-placement-constraint-details"));
exports.HostGroupPlacementConstraintDetails = HostGroupPlacementConstraintDetails.HostGroupPlacementConstraintDetails;
...
const InstanceConfigurationAmdMilanBmGpuLaunchInstancePlatformConfig = __importStar(require("./instance-configuration-amd-milan-bm-gpu-launch-instance-platform-config"));
exports.InstanceConfigurationAmdMilanBmGpuLaunchInstancePlatformConfig = InstanceConfigurationAmdMilanBmGpuLaunchInstancePlatformConfig.InstanceConfigurationAmdMilanBmGpuLaunchInstancePlatformConfig;
...
const InstanceConfigurationDetachedVolumeAutotunePolicy = __importStar(require("./instance-configuration-detached-volume-autotune-policy"));
exports.InstanceConfigurationDetachedVolumeAutotunePolicy = InstanceConfigurationDetachedVolumeAutotunePolicy.InstanceConfigurationDetachedVolumeAutotunePolicy;
const InstanceConfigurationGenericBmLaunchInstancePlatformConfig = __importStar(require("./instance-configuration-generic-bm-launch-instance-platform-config"));
exports.InstanceConfigurationGenericBmLaunchInstancePlatformConfig = InstanceConfigurationGenericBmLaunchInstancePlatformConfig.InstanceConfigurationGenericBmLaunchInstancePlatformConfig;
const InstanceConfigurationHostGroupPlacementConstraintDetails = __importStar(require("./instance-configuration-host-group-placement-constraint-details"));
exports.InstanceConfigurationHostGroupPlacementConstraintDetails = InstanceConfigurationHostGroupPlacementConstraintDetails.InstanceConfigurationHostGroupPlacementConstraintDetails;
...
const InstanceConfigurationPerformanceBasedAutotunePolicy = __importStar(require("./instance-configuration-performance-based-autotune-policy"));
exports.InstanceConfigurationPerformanceBasedAutotunePolicy = InstanceConfigurationPerformanceBasedAutotunePolicy.InstanceConfigurationPerformanceBasedAutotunePolicy;
...
const IntelVmUpdateInstancePlatformConfig = __importStar(require("./intel-vm-update-instance-platform-config"));
exports.IntelVmUpdateInstancePlatformConfig = IntelVmUpdateInstancePlatformConfig.IntelVmUpdateInstancePlatformConfig;
...
const LaunchAttachIScsiVolumeDetails = __importStar(require("./launch-attach-iscsi-volume-details"));
exports.LaunchAttachIScsiVolumeDetails = LaunchAttachIScsiVolumeDetails.LaunchAttachIScsiVolumeDetails;
const LaunchAttachParavirtualizedVolumeDetails = __importStar(require("./launch-attach-paravirtualized-volume-details"));
exports.LaunchAttachParavirtualizedVolumeDetails = LaunchAttachParavirtualizedVolumeDetails.LaunchAttachParavirtualizedVolumeDetails;
const LaunchCreateVolumeFromAttributes = __importStar(require("./launch-create-volume-from-attributes"));
exports.LaunchCreateVolumeFromAttributes = LaunchCreateVolumeFromAttributes.LaunchCreateVolumeFromAttributes;
const LaunchInstanceWindowsLicensingConfig = __importStar(require("./launch-instance-windows-licensing-config"));
exports.LaunchInstanceWindowsLicensingConfig = LaunchInstanceWindowsLicensingConfig.LaunchInstanceWindowsLicensingConfig;
...
const PerformanceBasedAutotunePolicy = __importStar(require("./performance-based-autotune-policy"));
exports.PerformanceBasedAutotunePolicy = PerformanceBasedAutotunePolicy.PerformanceBasedAutotunePolicy;
const RebootMigrateActionDetails = __importStar(require("./reboot-migrate-action-details"));
exports.RebootMigrateActionDetails = RebootMigrateActionDetails.RebootMigrateActionDetails;
...
const UpdateDedicatedCapacitySourceDetails = __importStar(require("./update-dedicated-capacity-source-details"));
exports.UpdateDedicatedCapacitySourceDetails = UpdateDedicatedCapacitySourceDetails.UpdateDedicatedCapacitySourceDetails;
const UpdateInstanceSourceViaBootVolumeDetails = __importStar(require("./update-instance-source-via-boot-volume-details"));
exports.UpdateInstanceSourceViaBootVolumeDetails = UpdateInstanceSourceViaBootVolumeDetails.UpdateInstanceSourceViaBootVolumeDetails;
const UpdateInstanceSourceViaImageDetails = __importStar(require("./update-instance-source-via-image-details"));
exports.UpdateInstanceSourceViaImageDetails = UpdateInstanceSourceViaImageDetails.UpdateInstanceSourceViaImageDetails;
const UpdateInstanceWindowsLicensingConfig = __importStar(require("./update-instance-windows-licensing-config"));
exports.UpdateInstanceWindowsLicensingConfig = UpdateInstanceWindowsLicensingConfig.UpdateInstanceWindowsLicensingConfig;

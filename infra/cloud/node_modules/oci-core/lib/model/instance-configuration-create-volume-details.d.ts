...
export interface InstanceConfigurationCreateVolumeDetails {
  ...
  *  Note: Numbers greater than Number.MAX_SAFE_INTEGER will result in rounding issues.
     ...
     */
    "sizeInGBs"?: number;
    "sourceDetails"?: model.InstanceConfigurationVolumeSourceFromVolumeBackupDetails | model.InstanceConfigurationVolumeSourceFromVolumeDetails;
    /**
...
export declare namespace InstanceConfigurationCreateVolumeDetails {
    function getJsonObj(obj: InstanceConfigurationCreateVolumeDetails): object;
    function getDeserializedJsonObj(obj: InstanceConfigurationCreateVolumeDetails): object;
}

 ...
 *
 */
export interface ComputeCapacityTopologySummary {
    /**
...
export declare namespace ComputeCapacityTopologySummary {
    function getJsonObj(obj: ComputeCapacityTopologySummary): object;
    function getDeserializedJsonObj(obj: ComputeCapacityTopologySummary): object;
}

...
export declare namespace UpdateIPSecTunnelBgpSessionDetails {
    function getJsonObj(obj: UpdateIPSecTunnelBgpSessionDetails): object;
    function getDeserializedJsonObj(obj: UpdateIPSecTunnelBgpSessionDetails): object;
}

...
export declare namespace ImageMemoryConstraints {
    function getJsonObj(obj: ImageMemoryConstraints): object;
    function getDeserializedJsonObj(obj: ImageMemoryConstraints): object;
}

...
export declare namespace RemoveVcnIpv6CidrDetails {
    function getJsonObj(obj: RemoveVcnIpv6CidrDetails): object;
    function getDeserializedJsonObj(obj: RemoveVcnIpv6CidrDetails): object;
}

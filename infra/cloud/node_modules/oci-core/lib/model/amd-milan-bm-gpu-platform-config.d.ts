...
export interface AmdMilanBmGpuPlatformConfig extends model.PlatformConfig {
     ...
     *
     */
    "numaNodesPerSocket"?: AmdMilanBmGpuPlatformConfig.NumaNodesPerSocket;
    /**
...
export declare namespace AmdMilanBmGpuPlatformConfig {
    ...
    function getJsonObj(obj: AmdMilanBmGpuPlatformConfig, isParentJsonObj?: boolean): object;
    const type = "AMD_MILAN_BM_GPU";
    function getDeserializedJsonObj(obj: AmdMilanBmGpuPlatformConfig, isParentJsonObj?: boolean): object;
}

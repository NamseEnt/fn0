...
export declare namespace AppCatalogSubscriptionSummary {
    function getJsonObj(obj: AppCatalogSubscriptionSummary): object;
    function getDeserializedJsonObj(obj: AppCatalogSubscriptionSummary): object;
}

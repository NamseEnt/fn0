...
export declare namespace InstanceMaintenanceEvent {
    ...
    function getJsonObj(obj: InstanceMaintenanceEvent): object;
    function getDeserializedJsonObj(obj: InstanceMaintenanceEvent): object;
}

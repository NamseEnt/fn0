...
export declare namespace ImageShapeCompatibilitySummary {
    function getJsonObj(obj: ImageShapeCompatibilitySummary): object;
    function getDeserializedJsonObj(obj: ImageShapeCompatibilitySummary): object;
}

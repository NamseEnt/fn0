 ...
 *
 */
export interface ComputeHpcIsland {
    /**
     ...
     */
    "lifecycleState": ComputeHpcIsland.LifecycleState;
    /**
...
export declare namespace ComputeHpcIsland {
    enum LifecycleState {
        Active = "ACTIVE",
        Inactive = "INACTIVE",
        /**
    ...
    function getJsonObj(obj: ComputeHpcIsland): object;
    function getDeserializedJsonObj(obj: ComputeHpcIsland): object;
}

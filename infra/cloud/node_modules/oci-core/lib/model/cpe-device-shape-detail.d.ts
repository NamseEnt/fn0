...
export declare namespace CpeDeviceShapeDetail {
    function getJsonObj(obj: CpeDeviceShapeDetail): object;
    function getDeserializedJsonObj(obj: CpeDeviceShapeDetail): object;
}

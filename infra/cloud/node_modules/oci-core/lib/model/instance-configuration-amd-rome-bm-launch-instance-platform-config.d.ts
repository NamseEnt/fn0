 ...
 *
 */
export interface InstanceConfigurationAmdRomeBmLaunchInstancePlatformConfig extends model.InstanceConfigurationLaunchInstancePlatformConfig {
    /**
     * The number of NUMA nodes per socket (NPS).
     *
     */
    "numaNodesPerSocket"?: InstanceConfigurationAmdRomeBmLaunchInstancePlatformConfig.NumaNodesPerSocket;
    /**
...
export declare namespace InstanceConfigurationAmdRomeBmLaunchInstancePlatformConfig {
    ...
    function getJsonObj(obj: InstanceConfigurationAmdRomeBmLaunchInstancePlatformConfig, isParentJsonObj?: boolean): object;
    const type = "AMD_ROME_BM";
    function getDeserializedJsonObj(obj: InstanceConfigurationAmdRomeBmLaunchInstancePlatformConfig, isParentJsonObj?: boolean): object;
}

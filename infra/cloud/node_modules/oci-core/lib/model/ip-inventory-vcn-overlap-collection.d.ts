...
export declare namespace IpInventoryVcnOverlapCollection {
    function getJsonObj(obj: IpInventoryVcnOverlapCollection): object;
    function getDeserializedJsonObj(obj: IpInventoryVcnOverlapCollection): object;
}

...
export declare namespace UpdateInstanceAgentConfigDetails {
    function getJsonObj(obj: UpdateInstanceAgentConfigDetails): object;
    function getDeserializedJsonObj(obj: UpdateInstanceAgentConfigDetails): object;
}

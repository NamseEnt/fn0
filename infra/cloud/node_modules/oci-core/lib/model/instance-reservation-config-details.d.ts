...
export declare namespace InstanceReservationConfigDetails {
    function getJsonObj(obj: InstanceReservationConfigDetails): object;
    function getDeserializedJsonObj(obj: InstanceReservationConfigDetails): object;
}

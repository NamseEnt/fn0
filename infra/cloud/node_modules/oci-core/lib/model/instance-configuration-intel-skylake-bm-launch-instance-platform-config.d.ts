 ...
 *
 */
export interface InstanceConfigurationIntelSkylakeBmLaunchInstancePlatformConfig extends model.InstanceConfigurationLaunchInstancePlatformConfig {
    /**
...
export declare namespace InstanceConfigurationIntelSkylakeBmLaunchInstancePlatformConfig {
    ...
    function getJsonObj(obj: InstanceConfigurationIntelSkylakeBmLaunchInstancePlatformConfig, isParentJsonObj?: boolean): object;
    const type = "INTEL_SKYLAKE_BM";
    function getDeserializedJsonObj(obj: InstanceConfigurationIntelSkylakeBmLaunchInstancePlatformConfig, isParentJsonObj?: boolean): object;
}

...
export declare namespace AppCatalogListingResourceVersionAgreements {
    function getJsonObj(obj: AppCatalogListingResourceVersionAgreements): object;
    function getDeserializedJsonObj(obj: AppCatalogListingResourceVersionAgreements): object;
}

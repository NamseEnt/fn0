...
export declare namespace UpdateInstancePoolDetails {
    function getJsonObj(obj: UpdateInstancePoolDetails): object;
    function getDeserializedJsonObj(obj: UpdateInstancePoolDetails): object;
}

 ...
 *
 */
export interface InstanceConfigurationGenericBmLaunchInstancePlatformConfig extends model.InstanceConfigurationLaunchInstancePlatformConfig {
    /**
...
export declare namespace InstanceConfigurationGenericBmLaunchInstancePlatformConfig {
    ...
    function getJsonObj(obj: InstanceConfigurationGenericBmLaunchInstancePlatformConfig, isParentJsonObj?: boolean): object;
    const type = "GENERIC_BM";
    function getDeserializedJsonObj(obj: InstanceConfigurationGenericBmLaunchInstancePlatformConfig, isParentJsonObj?: boolean): object;
}

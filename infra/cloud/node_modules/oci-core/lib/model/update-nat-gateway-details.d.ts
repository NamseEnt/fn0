...
export declare namespace UpdateNatGatewayDetails {
    function getJsonObj(obj: UpdateNatGatewayDetails): object;
    function getDeserializedJsonObj(obj: UpdateNatGatewayDetails): object;
}

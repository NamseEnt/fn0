...
export declare namespace UpdateSubnetDetails {
    function getJsonObj(obj: UpdateSubnetDetails): object;
    function getDeserializedJsonObj(obj: UpdateSubnetDetails): object;
}

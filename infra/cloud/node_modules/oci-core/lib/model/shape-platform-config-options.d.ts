...
export declare namespace ShapePlatformConfigOptions {
    enum Type {
    ...
    function getJsonObj(obj: ShapePlatformConfigOptions): object;
    function getDeserializedJsonObj(obj: ShapePlatformConfigOptions): object;
}

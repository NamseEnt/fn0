...
export declare namespace UpdateBootVolumeKmsKeyDetails {
    function getJsonObj(obj: UpdateBootVolumeKmsKeyDetails): object;
    function getDeserializedJsonObj(obj: UpdateBootVolumeKmsKeyDetails): object;
}

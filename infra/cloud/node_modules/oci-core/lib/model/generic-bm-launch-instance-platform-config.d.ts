...
export declare namespace GenericBmLaunchInstancePlatformConfig {
    ...
    function getJsonObj(obj: GenericBmLaunchInstancePlatformConfig, isParentJsonObj?: boolean): object;
    const type = "GENERIC_BM";
    function getDeserializedJsonObj(obj: GenericBmLaunchInstancePlatformConfig, isParentJsonObj?: boolean): object;
}

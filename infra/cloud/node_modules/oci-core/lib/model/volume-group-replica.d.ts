...
export declare namespace VolumeGroupReplica {
    enum LifecycleState {
    ...
    function getJsonObj(obj: VolumeGroupReplica): object;
    function getDeserializedJsonObj(obj: VolumeGroupReplica): object;
}

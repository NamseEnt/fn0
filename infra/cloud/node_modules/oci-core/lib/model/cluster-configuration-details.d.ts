...
export declare namespace ClusterConfigurationDetails {
    function getJsonObj(obj: ClusterConfigurationDetails): object;
    function getDeserializedJsonObj(obj: ClusterConfigurationDetails): object;
}

...
export declare namespace CreateClusterNetworkDetails {
    function getJsonObj(obj: CreateClusterNetworkDetails): object;
    function getDeserializedJsonObj(obj: CreateClusterNetworkDetails): object;
}

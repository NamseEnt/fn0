...
export declare namespace ChangeBootVolumeBackupCompartmentDetails {
    function getJsonObj(obj: ChangeBootVolumeBackupCompartmentDetails): object;
    function getDeserializedJsonObj(obj: ChangeBootVolumeBackupCompartmentDetails): object;
}

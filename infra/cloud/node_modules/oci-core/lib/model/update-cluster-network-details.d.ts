 ...
 *
 */
export interface UpdateClusterNetworkDetails {
    /**
...
export declare namespace UpdateClusterNetworkDetails {
    function getJsonObj(obj: UpdateClusterNetworkDetails): object;
    function getDeserializedJsonObj(obj: UpdateClusterNetworkDetails): object;
}

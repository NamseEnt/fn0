...
export declare namespace AddDrgRouteDistributionStatementDetails {
    enum Action {
        Accept = "ACCEPT"
    }
    function getJsonObj(obj: AddDrgRouteDistributionStatementDetails): object;
    function getDeserializedJsonObj(obj: AddDrgRouteDistributionStatementDetails): object;
}

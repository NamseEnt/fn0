...
export declare namespace IpInventorySubnetResourceSummary {
    enum IpAddressLifetime {
        Ephemeral = "Ephemeral",
        Reserved = "Reserved",
        /**
    ...
    function getJsonObj(obj: IpInventorySubnetResourceSummary): object;
    function getDeserializedJsonObj(obj: IpInventorySubnetResourceSummary): object;
}

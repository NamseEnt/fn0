...
export declare namespace DhcpSearchDomainOption {
    function getJsonObj(obj: DhcpSearchDomainOption, isParentJsonObj?: boolean): object;
    const type = "SearchDomain";
    function getDeserializedJsonObj(obj: DhcpSearchDomainOption, isParentJsonObj?: boolean): object;
}

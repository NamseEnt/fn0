...
export declare namespace CreateSubnetDetails {
    function getJsonObj(obj: CreateSubnetDetails): object;
    function getDeserializedJsonObj(obj: CreateSubnetDetails): object;
}

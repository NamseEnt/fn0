 ...
 *
 */
export interface InstanceConfigurationAmdRomeBmGpuLaunchInstancePlatformConfig extends model.InstanceConfigurationLaunchInstancePlatformConfig {
    /**
...
export declare namespace InstanceConfigurationAmdRomeBmGpuLaunchInstancePlatformConfig {
    ...
    function getJsonObj(obj: InstanceConfigurationAmdRomeBmGpuLaunchInstancePlatformConfig, isParentJsonObj?: boolean): object;
    const type = "AMD_ROME_BM_GPU";
    function getDeserializedJsonObj(obj: InstanceConfigurationAmdRomeBmGpuLaunchInstancePlatformConfig, isParentJsonObj?: boolean): object;
}

 ...
 *
 */
export interface UpdateInstanceMaintenanceEventDetails {
    /**
...
export declare namespace UpdateInstanceMaintenanceEventDetails {
    function getJsonObj(obj: UpdateInstanceMaintenanceEventDetails): object;
    function getDeserializedJsonObj(obj: UpdateInstanceMaintenanceEventDetails): object;
}

...
export declare namespace IpInventoryVcnOverlapSummary {
    function getJsonObj(obj: IpInventoryVcnOverlapSummary): object;
    function getDeserializedJsonObj(obj: IpInventoryVcnOverlapSummary): object;
}

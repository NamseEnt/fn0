...
export declare namespace DefaultDrgRouteTables {
    function getJsonObj(obj: DefaultDrgRouteTables): object;
    function getDeserializedJsonObj(obj: DefaultDrgRouteTables): object;
}

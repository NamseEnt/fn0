...
export declare namespace AppCatalogListing {
    function getJsonObj(obj: AppCatalogListing): object;
    function getDeserializedJsonObj(obj: AppCatalogListing): object;
}

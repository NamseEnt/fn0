...
export declare namespace AppCatalogSubscription {
    function getJsonObj(obj: AppCatalogSubscription): object;
    function getDeserializedJsonObj(obj: AppCatalogSubscription): object;
}

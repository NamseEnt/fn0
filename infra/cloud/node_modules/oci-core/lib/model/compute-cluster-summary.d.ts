...
export declare namespace ComputeClusterSummary {
    function getJsonObj(obj: ComputeClusterSummary): object;
    function getDeserializedJsonObj(obj: ComputeClusterSummary): object;
}

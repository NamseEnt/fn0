...
export declare namespace TopologyAssociatedWithEntityRelationship {
    function getJsonObj(obj: TopologyAssociatedWithEntityRelationship, isParentJsonObj?: boolean): object;
    const type = "ASSOCIATED_WITH";
    function getDeserializedJsonObj(obj: TopologyAssociatedWithEntityRelationship, isParentJsonObj?: boolean): object;
}

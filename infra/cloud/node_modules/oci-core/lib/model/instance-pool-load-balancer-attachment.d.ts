...
export declare namespace InstancePoolLoadBalancerAttachment {
    enum LifecycleState {
        Attaching = "ATTACHING",
        Attached = "ATTACHED",
        Detaching = "DETACHING",
    ...
    function getJsonObj(obj: InstancePoolLoadBalancerAttachment): object;
    function getDeserializedJsonObj(obj: InstancePoolLoadBalancerAttachment): object;
}

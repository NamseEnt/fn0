...
export declare namespace StreamingTargetDetails {
    function getJsonObj(obj: StreamingTargetDetails, isParentJsonObj?: boolean): object;
    const kind = "streaming";
    function getDeserializedJsonObj(obj: StreamingTargetDetails, isParentJsonObj?: boolean): object;
}

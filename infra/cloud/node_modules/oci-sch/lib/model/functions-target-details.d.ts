...
export declare namespace FunctionsTargetDetails {
    function getJsonObj(obj: FunctionsTargetDetails, isParentJsonObj?: boolean): object;
    const kind = "functions";
    function getDeserializedJsonObj(obj: FunctionsTargetDetails, isParentJsonObj?: boolean): object;
}

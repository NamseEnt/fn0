...
export declare namespace LogRuleTaskDetails {
    function getJsonObj(obj: LogRuleTaskDetails, isParentJsonObj?: boolean): object;
    const kind = "logRule";
    function getDeserializedJsonObj(obj: LogRuleTaskDetails, isParentJsonObj?: boolean): object;
}

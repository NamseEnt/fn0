...
export declare namespace MonitoringSourceDetails {
    function getJsonObj(obj: MonitoringSourceDetails, isParentJsonObj?: boolean): object;
    const kind = "monitoring";
    function getDeserializedJsonObj(obj: MonitoringSourceDetails, isParentJsonObj?: boolean): object;
}

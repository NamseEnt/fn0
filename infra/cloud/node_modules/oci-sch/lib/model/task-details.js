...
(function (TaskDetails) {
    function getJsonObj(obj) {
        ...
        if (obj && "kind" in obj && obj.kind) {
            switch (obj.kind) {
                case "function":
                    return model.FunctionTaskDetails.getJsonObj(jsonObj, true);
                case "logRule":
    ...
    TaskDetails.getJsonObj = getJsonObj;
    function getDeserializedJsonObj(obj) {
        const jsonObj = Object.assign(Object.assign({}, obj), {});
        if (obj && "kind" in obj && obj.kind) {
            switch (obj.kind) {
                case "function":
                    return model.FunctionTaskDetails.getDeserializedJsonObj(jsonObj, true);
                case "logRule":
    ...
    TaskDetails.getDeserializedJsonObj = getDeserializedJsonObj;
})(TaskDetails = exports.TaskDetails || (exports.TaskDetails = {}));

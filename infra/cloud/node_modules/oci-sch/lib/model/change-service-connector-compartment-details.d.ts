...
export declare namespace ChangeServiceConnectorCompartmentDetails {
    function getJsonObj(obj: ChangeServiceConnectorCompartmentDetails): object;
    function getDeserializedJsonObj(obj: ChangeServiceConnectorCompartmentDetails): object;
}

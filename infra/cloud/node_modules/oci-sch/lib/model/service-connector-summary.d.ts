...
export declare namespace ServiceConnectorSummary {
    function getJsonObj(obj: ServiceConnectorSummary): object;
    function getDeserializedJsonObj(obj: ServiceConnectorSummary): object;
}

...
export declare namespace LatestStreamingCursor {
    function getJsonObj(obj: LatestStreamingCursor, isParentJsonObj?: boolean): object;
    const kind = "LATEST";
    function getDeserializedJsonObj(obj: LatestStreamingCursor, isParentJsonObj?: boolean): object;
}

...
export declare namespace StreamingCursorDetails {
    function getJsonObj(obj: StreamingCursorDetails): object;
    function getDeserializedJsonObj(obj: StreamingCursorDetails): object;
}

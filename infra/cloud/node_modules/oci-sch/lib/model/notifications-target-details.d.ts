...
export declare namespace NotificationsTargetDetails {
    function getJsonObj(obj: NotificationsTargetDetails, isParentJsonObj?: boolean): object;
    const kind = "notifications";
    function getDeserializedJsonObj(obj: NotificationsTargetDetails, isParentJsonObj?: boolean): object;
}

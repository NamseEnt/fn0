...
export declare namespace SecurityAttributeSummary {
    function getJsonObj(obj: SecurityAttributeSummary): object;
    function getDeserializedJsonObj(obj: SecurityAttributeSummary): object;
}

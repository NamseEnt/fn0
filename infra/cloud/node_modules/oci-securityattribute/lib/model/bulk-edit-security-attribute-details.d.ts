...
export interface BulkEditSecurityAttributeDetails {
    /**
     ...
     *
     */
    "bulkEditOperations": Array<model.BulkEditSecurityAttributeOperationDetails>;
}
export declare namespace BulkEditSecurityAttributeDetails {
    function getJsonObj(obj: BulkEditSecurityAttributeDetails): object;
    function getDeserializedJsonObj(obj: BulkEditSecurityAttributeDetails): object;
}

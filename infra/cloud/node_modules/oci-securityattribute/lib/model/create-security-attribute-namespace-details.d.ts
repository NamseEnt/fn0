 ...
 *
 */
export interface CreateSecurityAttributeNamespaceDetails {
    /**
...
export declare namespace CreateSecurityAttributeNamespaceDetails {
    function getJsonObj(obj: CreateSecurityAttributeNamespaceDetails): object;
    function getDeserializedJsonObj(obj: CreateSecurityAttributeNamespaceDetails): object;
}

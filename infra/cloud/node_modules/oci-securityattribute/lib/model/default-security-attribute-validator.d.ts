 ...
 *
 */
export interface DefaultSecurityAttributeValidator extends model.BaseSecurityAttributeValidator {
    "validatorType": string;
}
export declare namespace DefaultSecurityAttributeValidator {
    function getJsonObj(obj: DefaultSecurityAttributeValidator, isParentJsonObj?: boolean): object;
    const validatorType = "DEFAULT";
    function getDeserializedJsonObj(obj: DefaultSecurityAttributeValidator, isParentJsonObj?: boolean): object;
}

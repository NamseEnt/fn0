...
export declare namespace EnumSecurityAttributeValidator {
    function getJsonObj(obj: EnumSecurityAttributeValidator, isParentJsonObj?: boolean): object;
    const validatorType = "ENUM";
    function getDeserializedJsonObj(obj: EnumSecurityAttributeValidator, isParentJsonObj?: boolean): object;
}

...
export declare namespace SecurityAttributeNamespaceSummary {
    function getJsonObj(obj: SecurityAttributeNamespaceSummary): object;
    function getDeserializedJsonObj(obj: SecurityAttributeNamespaceSummary): object;
}

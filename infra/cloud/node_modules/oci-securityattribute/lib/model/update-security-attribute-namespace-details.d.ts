...
export declare namespace UpdateSecurityAttributeNamespaceDetails {
    function getJsonObj(obj: UpdateSecurityAttributeNamespaceDetails): object;
    function getDeserializedJsonObj(obj: UpdateSecurityAttributeNamespaceDetails): object;
}

...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/networkloadbalancer/GetBackendOperationalStatus.ts.html |here} to see how to use GetBackendOperationalStatusRequest.
 */
export interface GetBackendOperationalStatusRequest extends common.BaseRequest {
    /**

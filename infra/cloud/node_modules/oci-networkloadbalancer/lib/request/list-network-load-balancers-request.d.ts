...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/networkloadbalancer/ListNetworkLoadBalancers.ts.html |here} to see how to use ListNetworkLoadBalancersRequest.
 */
export interface ListNetworkLoadBalancersRequest extends common.BaseRequest {
    /**
...
export declare namespace ListNetworkLoadBalancersRequest {
    enum SortBy {

...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/networkloadbalancer/ListBackendSets.ts.html |here} to see how to use ListBackendSetsRequest.
 */
...
export declare namespace ListBackendSetsRequest {
    enum SortBy {

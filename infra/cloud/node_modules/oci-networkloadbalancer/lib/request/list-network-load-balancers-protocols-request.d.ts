...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/networkloadbalancer/ListNetworkLoadBalancersProtocols.ts.html |here} to see how to use ListNetworkLoadBalancersProtocolsRequest.
 */
export interface ListNetworkLoadBalancersProtocolsRequest extends common.BaseRequest {
    /**
...
export declare namespace ListNetworkLoadBalancersProtocolsRequest {
    enum SortBy {

...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/networkloadbalancer/ChangeNetworkLoadBalancerCompartment.ts.html |here} to see how to use ChangeNetworkLoadBalancerCompartmentRequest.
 */
export interface ChangeNetworkLoadBalancerCompartmentRequest extends common.BaseRequest {
    /**
     ...
     */
    "changeNetworkLoadBalancerCompartmentDetails": model.ChangeNetworkLoadBalancerCompartmentDetails;
    /**

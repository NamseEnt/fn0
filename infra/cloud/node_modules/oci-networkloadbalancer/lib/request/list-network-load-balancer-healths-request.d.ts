...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/networkloadbalancer/ListNetworkLoadBalancerHealths.ts.html |here} to see how to use ListNetworkLoadBalancerHealthsRequest.
 */
export interface ListNetworkLoadBalancerHealthsRequest extends common.BaseRequest {
    /**
...
export declare namespace ListNetworkLoadBalancerHealthsRequest {
    enum SortBy {

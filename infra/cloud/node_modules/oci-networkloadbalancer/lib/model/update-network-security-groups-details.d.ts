...
export declare namespace UpdateNetworkSecurityGroupsDetails {
    function getJsonObj(obj: UpdateNetworkSecurityGroupsDetails): object;
    function getDeserializedJsonObj(obj: UpdateNetworkSecurityGroupsDetails): object;
}

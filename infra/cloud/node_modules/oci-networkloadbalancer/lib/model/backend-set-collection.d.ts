...
export declare namespace BackendSetCollection {
    function getJsonObj(obj: BackendSetCollection): object;
    function getDeserializedJsonObj(obj: BackendSetCollection): object;
}

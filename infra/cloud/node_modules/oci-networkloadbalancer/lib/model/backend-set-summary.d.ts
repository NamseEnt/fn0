...
export declare namespace BackendSetSummary {
    function getJsonObj(obj: BackendSetSummary): object;
    function getDeserializedJsonObj(obj: BackendSetSummary): object;
}

...
export declare namespace AutoScalePolicyRule {
    enum Action {
    ...
    function getJsonObj(obj: AutoScalePolicyRule): object;
    function getDeserializedJsonObj(obj: AutoScalePolicyRule): object;
}

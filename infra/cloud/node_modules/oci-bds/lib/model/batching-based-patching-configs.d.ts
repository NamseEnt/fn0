...
export declare namespace BatchingBasedPatchingConfigs {
    function getJsonObj(obj: BatchingBasedPatchingConfigs, isParentJsonObj?: boolean): object;
    const patchingConfigStrategy = "BATCHING_BASED";
    function getDeserializedJsonObj(obj: BatchingBasedPatchingConfigs, isParentJsonObj?: boolean): object;
}

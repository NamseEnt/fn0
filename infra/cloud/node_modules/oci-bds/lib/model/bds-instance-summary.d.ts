...
export declare namespace BdsInstanceSummary {
    function getJsonObj(obj: BdsInstanceSummary): object;
    function getDeserializedJsonObj(obj: BdsInstanceSummary): object;
}

...
export declare namespace DowntimeBasedPatchingConfigs {
    function getJsonObj(obj: DowntimeBasedPatchingConfigs, isParentJsonObj?: boolean): object;
    const patchingConfigStrategy = "DOWNTIME_BASED";
    function getDeserializedJsonObj(obj: DowntimeBasedPatchingConfigs, isParentJsonObj?: boolean): object;
}

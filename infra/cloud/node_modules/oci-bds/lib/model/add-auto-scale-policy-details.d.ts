...
export declare namespace AddAutoScalePolicyDetails {
    function getJsonObj(obj: AddAutoScalePolicyDetails): object;
    function getDeserializedJsonObj(obj: AddAutoScalePolicyDetails): object;
}
